...
func (c *Client) HttpPayloadWithXmlName(ctx context.Context, params *HttpPayloadWithXmlNameInput, optFns ...func(*Options)) (*HttpPayloadWithXmlNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpPayloadWithXmlName", params, optFns, addOperationHttpPayloadWithXmlNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpPayloadWithXmlNameMiddleware(stack *middleware.Stack, options Options) (err error) {
