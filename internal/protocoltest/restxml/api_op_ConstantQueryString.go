...
func (c *Client) ConstantQueryString(ctx context.Context, params *ConstantQueryStringInput, optFns ...func(*Options)) (*ConstantQueryStringOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConstantQueryString", params, optFns, addOperationConstantQueryStringMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConstantQueryStringMiddleware(stack *middleware.Stack, options Options) (err error) {
