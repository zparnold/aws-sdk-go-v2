...
func (c *Client) XmlEmptyStrings(ctx context.Context, params *XmlEmptyStringsInput, optFns ...func(*Options)) (*XmlEmptyStringsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlEmptyStrings", params, optFns, addOperationXmlEmptyStringsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlEmptyStringsMiddleware(stack *middleware.Stack, options Options) (err error) {
