...
func (c *Client) InputAndOutputWithHeaders(ctx context.Context, params *InputAndOutputWithHeadersInput, optFns ...func(*Options)) (*InputAndOutputWithHeadersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InputAndOutputWithHeaders", params, optFns, addOperationInputAndOutputWithHeadersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInputAndOutputWithHeadersMiddleware(stack *middleware.Stack, options Options) (err error) {
