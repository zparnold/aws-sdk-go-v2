...
func (c *Client) XmlMapsXmlName(ctx context.Context, params *XmlMapsXmlNameInput, optFns ...func(*Options)) (*XmlMapsXmlNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlMapsXmlName", params, optFns, addOperationXmlMapsXmlNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlMapsXmlNameMiddleware(stack *middleware.Stack, options Options) (err error) {
