...
func (c *Client) HttpResponseCode(ctx context.Context, params *HttpResponseCodeInput, optFns ...func(*Options)) (*HttpResponseCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpResponseCode", params, optFns, addOperationHttpResponseCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpResponseCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
