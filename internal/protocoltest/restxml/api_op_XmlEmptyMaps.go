...
func (c *Client) XmlEmptyMaps(ctx context.Context, params *XmlEmptyMapsInput, optFns ...func(*Options)) (*XmlEmptyMapsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlEmptyMaps", params, optFns, addOperationXmlEmptyMapsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlEmptyMapsMiddleware(stack *middleware.Stack, options Options) (err error) {
