...
func (c *Client) XmlAttributes(ctx context.Context, params *XmlAttributesInput, optFns ...func(*Options)) (*XmlAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlAttributes", params, optFns, addOperationXmlAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
