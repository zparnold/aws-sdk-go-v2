...
func (c *Client) HttpPayloadWithXmlNamespace(ctx context.Context, params *HttpPayloadWithXmlNamespaceInput, optFns ...func(*Options)) (*HttpPayloadWithXmlNamespaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpPayloadWithXmlNamespace", params, optFns, addOperationHttpPayloadWithXmlNamespaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpPayloadWithXmlNamespaceMiddleware(stack *middleware.Stack, options Options) (err error) {
