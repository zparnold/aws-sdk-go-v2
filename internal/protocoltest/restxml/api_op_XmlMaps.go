...
func (c *Client) XmlMaps(ctx context.Context, params *XmlMapsInput, optFns ...func(*Options)) (*XmlMapsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlMaps", params, optFns, addOperationXmlMapsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlMapsMiddleware(stack *middleware.Stack, options Options) (err error) {
