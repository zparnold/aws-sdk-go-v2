...
func (c *Client) HttpPayloadWithXmlNamespaceAndPrefix(ctx context.Context, params *HttpPayloadWithXmlNamespaceAndPrefixInput, optFns ...func(*Options)) (*HttpPayloadWithXmlNamespaceAndPrefixOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpPayloadWithXmlNamespaceAndPrefix", params, optFns, addOperationHttpPayloadWithXmlNamespaceAndPrefixMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpPayloadWithXmlNamespaceAndPrefixMiddleware(stack *middleware.Stack, options Options) (err error) {
