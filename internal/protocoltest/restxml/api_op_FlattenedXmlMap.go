...
func (c *Client) FlattenedXmlMap(ctx context.Context, params *FlattenedXmlMapInput, optFns ...func(*Options)) (*FlattenedXmlMapOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FlattenedXmlMap", params, optFns, addOperationFlattenedXmlMapMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFlattenedXmlMapMiddleware(stack *middleware.Stack, options Options) (err error) {
