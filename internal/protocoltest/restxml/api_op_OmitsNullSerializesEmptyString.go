...
func (c *Client) OmitsNullSerializesEmptyString(ctx context.Context, params *OmitsNullSerializesEmptyStringInput, optFns ...func(*Options)) (*OmitsNullSerializesEmptyStringOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "OmitsNullSerializesEmptyString", params, optFns, addOperationOmitsNullSerializesEmptyStringMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationOmitsNullSerializesEmptyStringMiddleware(stack *middleware.Stack, options Options) (err error) {
