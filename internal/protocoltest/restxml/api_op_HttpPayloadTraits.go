...
func (c *Client) HttpPayloadTraits(ctx context.Context, params *HttpPayloadTraitsInput, optFns ...func(*Options)) (*HttpPayloadTraitsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpPayloadTraits", params, optFns, addOperationHttpPayloadTraitsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpPayloadTraitsMiddleware(stack *middleware.Stack, options Options) (err error) {
