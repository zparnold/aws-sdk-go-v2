...
func (c *Client) XmlAttributesOnPayload(ctx context.Context, params *XmlAttributesOnPayloadInput, optFns ...func(*Options)) (*XmlAttributesOnPayloadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlAttributesOnPayload", params, optFns, addOperationXmlAttributesOnPayloadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlAttributesOnPayloadMiddleware(stack *middleware.Stack, options Options) (err error) {
