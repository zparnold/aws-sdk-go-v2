...
func (c *Client) HttpPayloadWithStructure(ctx context.Context, params *HttpPayloadWithStructureInput, optFns ...func(*Options)) (*HttpPayloadWithStructureOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpPayloadWithStructure", params, optFns, addOperationHttpPayloadWithStructureMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpPayloadWithStructureMiddleware(stack *middleware.Stack, options Options) (err error) {
