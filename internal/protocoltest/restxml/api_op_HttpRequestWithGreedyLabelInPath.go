...
func (c *Client) HttpRequestWithGreedyLabelInPath(ctx context.Context, params *HttpRequestWithGreedyLabelInPathInput, optFns ...func(*Options)) (*HttpRequestWithGreedyLabelInPathOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpRequestWithGreedyLabelInPath", params, optFns, addOperationHttpRequestWithGreedyLabelInPathMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpRequestWithGreedyLabelInPathMiddleware(stack *middleware.Stack, options Options) (err error) {
