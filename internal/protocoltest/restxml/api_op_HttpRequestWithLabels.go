...
func (c *Client) HttpRequestWithLabels(ctx context.Context, params *HttpRequestWithLabelsInput, optFns ...func(*Options)) (*HttpRequestWithLabelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpRequestWithLabels", params, optFns, addOperationHttpRequestWithLabelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpRequestWithLabelsMiddleware(stack *middleware.Stack, options Options) (err error) {
