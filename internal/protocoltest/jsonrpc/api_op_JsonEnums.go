...
func (c *Client) JsonEnums(ctx context.Context, params *JsonEnumsInput, optFns ...func(*Options)) (*JsonEnumsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "JsonEnums", params, optFns, addOperationJsonEnumsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationJsonEnumsMiddleware(stack *middleware.Stack, options Options) (err error) {
