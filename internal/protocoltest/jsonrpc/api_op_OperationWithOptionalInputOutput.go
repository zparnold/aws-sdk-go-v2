...
func (c *Client) OperationWithOptionalInputOutput(ctx context.Context, params *OperationWithOptionalInputOutputInput, optFns ...func(*Options)) (*OperationWithOptionalInputOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "OperationWithOptionalInputOutput", params, optFns, addOperationOperationWithOptionalInputOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationOperationWithOptionalInputOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
