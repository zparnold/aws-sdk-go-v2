...
func (c *Client) PutAndGetInlineDocuments(ctx context.Context, params *PutAndGetInlineDocumentsInput, optFns ...func(*Options)) (*PutAndGetInlineDocumentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAndGetInlineDocuments", params, optFns, addOperationPutAndGetInlineDocumentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAndGetInlineDocumentsMiddleware(stack *middleware.Stack, options Options) (err error) {
