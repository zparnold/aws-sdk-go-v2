...
func (c *Client) JsonUnions(ctx context.Context, params *JsonUnionsInput, optFns ...func(*Options)) (*JsonUnionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "JsonUnions", params, optFns, addOperationJsonUnionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationJsonUnionsMiddleware(stack *middleware.Stack, options Options) (err error) {
