...
func (c *Client) EmptyOperation(ctx context.Context, params *EmptyOperationInput, optFns ...func(*Options)) (*EmptyOperationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EmptyOperation", params, optFns, addOperationEmptyOperationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEmptyOperationMiddleware(stack *middleware.Stack, options Options) (err error) {
