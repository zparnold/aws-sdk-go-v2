...
func (c *Client) KitchenSinkOperation(ctx context.Context, params *KitchenSinkOperationInput, optFns ...func(*Options)) (*KitchenSinkOperationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "KitchenSinkOperation", params, optFns, addOperationKitchenSinkOperationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationKitchenSinkOperationMiddleware(stack *middleware.Stack, options Options) (err error) {
