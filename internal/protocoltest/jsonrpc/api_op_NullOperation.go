...
func (c *Client) NullOperation(ctx context.Context, params *NullOperationInput, optFns ...func(*Options)) (*NullOperationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NullOperation", params, optFns, addOperationNullOperationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNullOperationMiddleware(stack *middleware.Stack, options Options) (err error) {
