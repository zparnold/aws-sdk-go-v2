...
func (c *Client) JsonMaps(ctx context.Context, params *JsonMapsInput, optFns ...func(*Options)) (*JsonMapsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "JsonMaps", params, optFns, addOperationJsonMapsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationJsonMapsMiddleware(stack *middleware.Stack, options Options) (err error) {
