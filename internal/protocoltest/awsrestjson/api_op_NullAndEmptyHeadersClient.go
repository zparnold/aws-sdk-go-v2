...
func (c *Client) NullAndEmptyHeadersClient(ctx context.Context, params *NullAndEmptyHeadersClientInput, optFns ...func(*Options)) (*NullAndEmptyHeadersClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NullAndEmptyHeadersClient", params, optFns, addOperationNullAndEmptyHeadersClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNullAndEmptyHeadersClientMiddleware(stack *middleware.Stack, options Options) (err error) {
