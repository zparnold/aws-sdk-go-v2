...
func (c *Client) JsonTimestamps(ctx context.Context, params *JsonTimestampsInput, optFns ...func(*Options)) (*JsonTimestampsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "JsonTimestamps", params, optFns, addOperationJsonTimestampsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationJsonTimestampsMiddleware(stack *middleware.Stack, options Options) (err error) {
