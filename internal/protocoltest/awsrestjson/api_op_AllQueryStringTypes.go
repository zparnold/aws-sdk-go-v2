...
func (c *Client) AllQueryStringTypes(ctx context.Context, params *AllQueryStringTypesInput, optFns ...func(*Options)) (*AllQueryStringTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllQueryStringTypes", params, optFns, addOperationAllQueryStringTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllQueryStringTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
