...
func (c *Client) TimestampFormatHeaders(ctx context.Context, params *TimestampFormatHeadersInput, optFns ...func(*Options)) (*TimestampFormatHeadersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TimestampFormatHeaders", params, optFns, addOperationTimestampFormatHeadersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTimestampFormatHeadersMiddleware(stack *middleware.Stack, options Options) (err error) {
