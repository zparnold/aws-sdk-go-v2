...
func (c *Client) HttpRequestWithLabelsAndTimestampFormat(ctx context.Context, params *HttpRequestWithLabelsAndTimestampFormatInput, optFns ...func(*Options)) (*HttpRequestWithLabelsAndTimestampFormatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpRequestWithLabelsAndTimestampFormat", params, optFns, addOperationHttpRequestWithLabelsAndTimestampFormatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpRequestWithLabelsAndTimestampFormatMiddleware(stack *middleware.Stack, options Options) (err error) {
