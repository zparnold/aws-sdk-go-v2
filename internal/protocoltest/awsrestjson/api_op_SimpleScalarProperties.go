...
func (c *Client) SimpleScalarProperties(ctx context.Context, params *SimpleScalarPropertiesInput, optFns ...func(*Options)) (*SimpleScalarPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SimpleScalarProperties", params, optFns, addOperationSimpleScalarPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSimpleScalarPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
