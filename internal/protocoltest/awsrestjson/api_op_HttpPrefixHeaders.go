...
func (c *Client) HttpPrefixHeaders(ctx context.Context, params *HttpPrefixHeadersInput, optFns ...func(*Options)) (*HttpPrefixHeadersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpPrefixHeaders", params, optFns, addOperationHttpPrefixHeadersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpPrefixHeadersMiddleware(stack *middleware.Stack, options Options) (err error) {
