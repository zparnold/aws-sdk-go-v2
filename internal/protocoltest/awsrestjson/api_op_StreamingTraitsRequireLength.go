...
func (c *Client) StreamingTraitsRequireLength(ctx context.Context, params *StreamingTraitsRequireLengthInput, optFns ...func(*Options)) (*StreamingTraitsRequireLengthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StreamingTraitsRequireLength", params, optFns, addOperationStreamingTraitsRequireLengthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStreamingTraitsRequireLengthMiddleware(stack *middleware.Stack, options Options) (err error) {
