...
func (c *Client) InlineDocument(ctx context.Context, params *InlineDocumentInput, optFns ...func(*Options)) (*InlineDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InlineDocument", params, optFns, addOperationInlineDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInlineDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
