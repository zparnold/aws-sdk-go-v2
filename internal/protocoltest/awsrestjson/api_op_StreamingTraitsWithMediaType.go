...
func (c *Client) StreamingTraitsWithMediaType(ctx context.Context, params *StreamingTraitsWithMediaTypeInput, optFns ...func(*Options)) (*StreamingTraitsWithMediaTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StreamingTraitsWithMediaType", params, optFns, addOperationStreamingTraitsWithMediaTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStreamingTraitsWithMediaTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
