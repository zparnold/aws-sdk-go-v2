...
func (c *Client) NullAndEmptyHeadersServer(ctx context.Context, params *NullAndEmptyHeadersServerInput, optFns ...func(*Options)) (*NullAndEmptyHeadersServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NullAndEmptyHeadersServer", params, optFns, addOperationNullAndEmptyHeadersServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNullAndEmptyHeadersServerMiddleware(stack *middleware.Stack, options Options) (err error) {
