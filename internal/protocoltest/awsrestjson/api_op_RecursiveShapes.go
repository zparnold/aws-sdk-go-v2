...
func (c *Client) RecursiveShapes(ctx context.Context, params *RecursiveShapesInput, optFns ...func(*Options)) (*RecursiveShapesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RecursiveShapes", params, optFns, addOperationRecursiveShapesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRecursiveShapesMiddleware(stack *middleware.Stack, options Options) (err error) {
