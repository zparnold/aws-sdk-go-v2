...
func (c *Client) JsonBlobs(ctx context.Context, params *JsonBlobsInput, optFns ...func(*Options)) (*JsonBlobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "JsonBlobs", params, optFns, addOperationJsonBlobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationJsonBlobsMiddleware(stack *middleware.Stack, options Options) (err error) {
