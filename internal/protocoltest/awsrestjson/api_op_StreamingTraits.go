...
func (c *Client) StreamingTraits(ctx context.Context, params *StreamingTraitsInput, optFns ...func(*Options)) (*StreamingTraitsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StreamingTraits", params, optFns, addOperationStreamingTraitsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStreamingTraitsMiddleware(stack *middleware.Stack, options Options) (err error) {
