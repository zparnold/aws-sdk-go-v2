...
func (c *Client) IgnoreQueryParamsInResponse(ctx context.Context, params *IgnoreQueryParamsInResponseInput, optFns ...func(*Options)) (*IgnoreQueryParamsInResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IgnoreQueryParamsInResponse", params, optFns, addOperationIgnoreQueryParamsInResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIgnoreQueryParamsInResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
