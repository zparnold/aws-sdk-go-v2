...
func (c *Client) MediaTypeHeader(ctx context.Context, params *MediaTypeHeaderInput, optFns ...func(*Options)) (*MediaTypeHeaderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MediaTypeHeader", params, optFns, addOperationMediaTypeHeaderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMediaTypeHeaderMiddleware(stack *middleware.Stack, options Options) (err error) {
