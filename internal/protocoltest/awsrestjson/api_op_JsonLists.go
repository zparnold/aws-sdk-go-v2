...
func (c *Client) JsonLists(ctx context.Context, params *JsonListsInput, optFns ...func(*Options)) (*JsonListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "JsonLists", params, optFns, addOperationJsonListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationJsonListsMiddleware(stack *middleware.Stack, options Options) (err error) {
