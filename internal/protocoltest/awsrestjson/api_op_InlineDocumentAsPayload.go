...
func (c *Client) InlineDocumentAsPayload(ctx context.Context, params *InlineDocumentAsPayloadInput, optFns ...func(*Options)) (*InlineDocumentAsPayloadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InlineDocumentAsPayload", params, optFns, addOperationInlineDocumentAsPayloadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInlineDocumentAsPayloadMiddleware(stack *middleware.Stack, options Options) (err error) {
