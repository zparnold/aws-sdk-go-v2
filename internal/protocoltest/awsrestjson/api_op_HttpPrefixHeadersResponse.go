...
func (c *Client) HttpPrefixHeadersResponse(ctx context.Context, params *HttpPrefixHeadersResponseInput, optFns ...func(*Options)) (*HttpPrefixHeadersResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HttpPrefixHeadersResponse", params, optFns, addOperationHttpPrefixHeadersResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHttpPrefixHeadersResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
