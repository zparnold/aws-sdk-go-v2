...
func (c *Client) NestedStructures(ctx context.Context, params *NestedStructuresInput, optFns ...func(*Options)) (*NestedStructuresOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NestedStructures", params, optFns, addOperationNestedStructuresMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNestedStructuresMiddleware(stack *middleware.Stack, options Options) (err error) {
