...
func (c *Client) XmlBlobs(ctx context.Context, params *XmlBlobsInput, optFns ...func(*Options)) (*XmlBlobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlBlobs", params, optFns, addOperationXmlBlobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlBlobsMiddleware(stack *middleware.Stack, options Options) (err error) {
