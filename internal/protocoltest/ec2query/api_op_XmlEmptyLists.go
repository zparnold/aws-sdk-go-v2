...
func (c *Client) XmlEmptyLists(ctx context.Context, params *XmlEmptyListsInput, optFns ...func(*Options)) (*XmlEmptyListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlEmptyLists", params, optFns, addOperationXmlEmptyListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlEmptyListsMiddleware(stack *middleware.Stack, options Options) (err error) {
