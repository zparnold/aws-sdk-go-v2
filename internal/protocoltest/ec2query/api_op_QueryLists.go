...
func (c *Client) QueryLists(ctx context.Context, params *QueryListsInput, optFns ...func(*Options)) (*QueryListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "QueryLists", params, optFns, addOperationQueryListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationQueryListsMiddleware(stack *middleware.Stack, options Options) (err error) {
