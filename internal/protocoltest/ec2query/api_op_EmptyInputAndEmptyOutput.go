...
func (c *Client) EmptyInputAndEmptyOutput(ctx context.Context, params *EmptyInputAndEmptyOutputInput, optFns ...func(*Options)) (*EmptyInputAndEmptyOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EmptyInputAndEmptyOutput", params, optFns, addOperationEmptyInputAndEmptyOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEmptyInputAndEmptyOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
