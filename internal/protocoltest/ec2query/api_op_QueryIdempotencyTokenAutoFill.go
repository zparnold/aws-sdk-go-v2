...
func (c *Client) QueryIdempotencyTokenAutoFill(ctx context.Context, params *QueryIdempotencyTokenAutoFillInput, optFns ...func(*Options)) (*QueryIdempotencyTokenAutoFillOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "QueryIdempotencyTokenAutoFill", params, optFns, addOperationQueryIdempotencyTokenAutoFillMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationQueryIdempotencyTokenAutoFillMiddleware(stack *middleware.Stack, options Options) (err error) {
