...
func (c *Client) XmlNamespaces(ctx context.Context, params *XmlNamespacesInput, optFns ...func(*Options)) (*XmlNamespacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlNamespaces", params, optFns, addOperationXmlNamespacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlNamespacesMiddleware(stack *middleware.Stack, options Options) (err error) {
