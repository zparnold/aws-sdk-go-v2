...
func (c *Client) QueryMaps(ctx context.Context, params *QueryMapsInput, optFns ...func(*Options)) (*QueryMapsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "QueryMaps", params, optFns, addOperationQueryMapsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationQueryMapsMiddleware(stack *middleware.Stack, options Options) (err error) {
