...
func (c *Client) XmlTimestamps(ctx context.Context, params *XmlTimestampsInput, optFns ...func(*Options)) (*XmlTimestampsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlTimestamps", params, optFns, addOperationXmlTimestampsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlTimestampsMiddleware(stack *middleware.Stack, options Options) (err error) {
