...
func (c *Client) QueryTimestamps(ctx context.Context, params *QueryTimestampsInput, optFns ...func(*Options)) (*QueryTimestampsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "QueryTimestamps", params, optFns, addOperationQueryTimestampsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationQueryTimestampsMiddleware(stack *middleware.Stack, options Options) (err error) {
