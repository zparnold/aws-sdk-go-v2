...
func (c *Client) SimpleScalarXmlProperties(ctx context.Context, params *SimpleScalarXmlPropertiesInput, optFns ...func(*Options)) (*SimpleScalarXmlPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SimpleScalarXmlProperties", params, optFns, addOperationSimpleScalarXmlPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSimpleScalarXmlPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
