...
func (c *Client) NoInputAndOutput(ctx context.Context, params *NoInputAndOutputInput, optFns ...func(*Options)) (*NoInputAndOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NoInputAndOutput", params, optFns, addOperationNoInputAndOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNoInputAndOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
