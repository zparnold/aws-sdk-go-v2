...
func (c *Client) FlattenedXmlMapWithXmlName(ctx context.Context, params *FlattenedXmlMapWithXmlNameInput, optFns ...func(*Options)) (*FlattenedXmlMapWithXmlNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FlattenedXmlMapWithXmlName", params, optFns, addOperationFlattenedXmlMapWithXmlNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFlattenedXmlMapWithXmlNameMiddleware(stack *middleware.Stack, options Options) (err error) {
