...
func (c *Client) SimpleInputParams(ctx context.Context, params *SimpleInputParamsInput, optFns ...func(*Options)) (*SimpleInputParamsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SimpleInputParams", params, optFns, addOperationSimpleInputParamsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSimpleInputParamsMiddleware(stack *middleware.Stack, options Options) (err error) {
