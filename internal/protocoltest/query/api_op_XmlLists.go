...
func (c *Client) XmlLists(ctx context.Context, params *XmlListsInput, optFns ...func(*Options)) (*XmlListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "XmlLists", params, optFns, addOperationXmlListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationXmlListsMiddleware(stack *middleware.Stack, options Options) (err error) {
