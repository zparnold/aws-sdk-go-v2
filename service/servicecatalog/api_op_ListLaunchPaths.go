...
func (c *Client) ListLaunchPaths(ctx context.Context, params *ListLaunchPathsInput, optFns ...func(*Options)) (*ListLaunchPathsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLaunchPaths", params, optFns, addOperationListLaunchPathsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLaunchPathsMiddleware(stack *middleware.Stack, options Options) (err error) {
