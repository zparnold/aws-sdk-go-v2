...
func (c *Client) AssociateBudgetWithResource(ctx context.Context, params *AssociateBudgetWithResourceInput, optFns ...func(*Options)) (*AssociateBudgetWithResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateBudgetWithResource", params, optFns, addOperationAssociateBudgetWithResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateBudgetWithResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
