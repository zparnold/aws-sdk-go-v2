...
func (c *Client) ListPortfolios(ctx context.Context, params *ListPortfoliosInput, optFns ...func(*Options)) (*ListPortfoliosOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPortfolios", params, optFns, addOperationListPortfoliosMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPortfoliosMiddleware(stack *middleware.Stack, options Options) (err error) {
