...
func (c *Client) ListProvisioningArtifactsForServiceAction(ctx context.Context, params *ListProvisioningArtifactsForServiceActionInput, optFns ...func(*Options)) (*ListProvisioningArtifactsForServiceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProvisioningArtifactsForServiceAction", params, optFns, addOperationListProvisioningArtifactsForServiceActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProvisioningArtifactsForServiceActionMiddleware(stack *middleware.Stack, options Options) (err error) {
