...
func (c *Client) EnableAWSOrganizationsAccess(ctx context.Context, params *EnableAWSOrganizationsAccessInput, optFns ...func(*Options)) (*EnableAWSOrganizationsAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableAWSOrganizationsAccess", params, optFns, addOperationEnableAWSOrganizationsAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableAWSOrganizationsAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
