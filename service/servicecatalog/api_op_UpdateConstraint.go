...
func (c *Client) UpdateConstraint(ctx context.Context, params *UpdateConstraintInput, optFns ...func(*Options)) (*UpdateConstraintOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConstraint", params, optFns, addOperationUpdateConstraintMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConstraintMiddleware(stack *middleware.Stack, options Options) (err error) {
