...
func (c *Client) ListTagOptions(ctx context.Context, params *ListTagOptionsInput, optFns ...func(*Options)) (*ListTagOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagOptions", params, optFns, addOperationListTagOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
