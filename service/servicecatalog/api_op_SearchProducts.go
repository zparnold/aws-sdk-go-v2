...
func (c *Client) SearchProducts(ctx context.Context, params *SearchProductsInput, optFns ...func(*Options)) (*SearchProductsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchProducts", params, optFns, addOperationSearchProductsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchProductsMiddleware(stack *middleware.Stack, options Options) (err error) {
