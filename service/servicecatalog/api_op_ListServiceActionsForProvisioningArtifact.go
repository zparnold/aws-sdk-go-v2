...
func (c *Client) ListServiceActionsForProvisioningArtifact(ctx context.Context, params *ListServiceActionsForProvisioningArtifactInput, optFns ...func(*Options)) (*ListServiceActionsForProvisioningArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServiceActionsForProvisioningArtifact", params, optFns, addOperationListServiceActionsForProvisioningArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServiceActionsForProvisioningArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
