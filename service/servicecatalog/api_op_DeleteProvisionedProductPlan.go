...
func (c *Client) DeleteProvisionedProductPlan(ctx context.Context, params *DeleteProvisionedProductPlanInput, optFns ...func(*Options)) (*DeleteProvisionedProductPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProvisionedProductPlan", params, optFns, addOperationDeleteProvisionedProductPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProvisionedProductPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
