...
func (c *Client) TerminateProvisionedProduct(ctx context.Context, params *TerminateProvisionedProductInput, optFns ...func(*Options)) (*TerminateProvisionedProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateProvisionedProduct", params, optFns, addOperationTerminateProvisionedProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateProvisionedProductMiddleware(stack *middleware.Stack, options Options) (err error) {
