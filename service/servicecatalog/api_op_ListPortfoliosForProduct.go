...
func (c *Client) ListPortfoliosForProduct(ctx context.Context, params *ListPortfoliosForProductInput, optFns ...func(*Options)) (*ListPortfoliosForProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPortfoliosForProduct", params, optFns, addOperationListPortfoliosForProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPortfoliosForProductMiddleware(stack *middleware.Stack, options Options) (err error) {
