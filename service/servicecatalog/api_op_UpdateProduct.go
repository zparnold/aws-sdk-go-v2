...
func (c *Client) UpdateProduct(ctx context.Context, params *UpdateProductInput, optFns ...func(*Options)) (*UpdateProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProduct", params, optFns, addOperationUpdateProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProductMiddleware(stack *middleware.Stack, options Options) (err error) {
