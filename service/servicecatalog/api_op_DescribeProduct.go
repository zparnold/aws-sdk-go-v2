...
func (c *Client) DescribeProduct(ctx context.Context, params *DescribeProductInput, optFns ...func(*Options)) (*DescribeProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProduct", params, optFns, addOperationDescribeProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProductMiddleware(stack *middleware.Stack, options Options) (err error) {
