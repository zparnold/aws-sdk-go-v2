...
func (c *Client) DescribePortfolioShareStatus(ctx context.Context, params *DescribePortfolioShareStatusInput, optFns ...func(*Options)) (*DescribePortfolioShareStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePortfolioShareStatus", params, optFns, addOperationDescribePortfolioShareStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePortfolioShareStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
