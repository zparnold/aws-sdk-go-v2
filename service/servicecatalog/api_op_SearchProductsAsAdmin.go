...
func (c *Client) SearchProductsAsAdmin(ctx context.Context, params *SearchProductsAsAdminInput, optFns ...func(*Options)) (*SearchProductsAsAdminOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchProductsAsAdmin", params, optFns, addOperationSearchProductsAsAdminMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchProductsAsAdminMiddleware(stack *middleware.Stack, options Options) (err error) {
