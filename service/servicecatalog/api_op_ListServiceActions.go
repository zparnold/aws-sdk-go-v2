...
func (c *Client) ListServiceActions(ctx context.Context, params *ListServiceActionsInput, optFns ...func(*Options)) (*ListServiceActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServiceActions", params, optFns, addOperationListServiceActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServiceActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
