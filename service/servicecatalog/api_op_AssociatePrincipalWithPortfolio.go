...
func (c *Client) AssociatePrincipalWithPortfolio(ctx context.Context, params *AssociatePrincipalWithPortfolioInput, optFns ...func(*Options)) (*AssociatePrincipalWithPortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociatePrincipalWithPortfolio", params, optFns, addOperationAssociatePrincipalWithPortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociatePrincipalWithPortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
