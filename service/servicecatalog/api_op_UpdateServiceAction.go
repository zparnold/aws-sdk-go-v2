...
func (c *Client) UpdateServiceAction(ctx context.Context, params *UpdateServiceActionInput, optFns ...func(*Options)) (*UpdateServiceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServiceAction", params, optFns, addOperationUpdateServiceActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServiceActionMiddleware(stack *middleware.Stack, options Options) (err error) {
