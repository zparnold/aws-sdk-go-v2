...
func (c *Client) DeleteProvisioningArtifact(ctx context.Context, params *DeleteProvisioningArtifactInput, optFns ...func(*Options)) (*DeleteProvisioningArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProvisioningArtifact", params, optFns, addOperationDeleteProvisioningArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProvisioningArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
