...
func (c *Client) DisassociateTagOptionFromResource(ctx context.Context, params *DisassociateTagOptionFromResourceInput, optFns ...func(*Options)) (*DisassociateTagOptionFromResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateTagOptionFromResource", params, optFns, addOperationDisassociateTagOptionFromResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateTagOptionFromResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
