...
func (c *Client) DescribeProvisioningArtifact(ctx context.Context, params *DescribeProvisioningArtifactInput, optFns ...func(*Options)) (*DescribeProvisioningArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProvisioningArtifact", params, optFns, addOperationDescribeProvisioningArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProvisioningArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
