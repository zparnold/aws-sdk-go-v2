...
func (c *Client) DisassociateProductFromPortfolio(ctx context.Context, params *DisassociateProductFromPortfolioInput, optFns ...func(*Options)) (*DisassociateProductFromPortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateProductFromPortfolio", params, optFns, addOperationDisassociateProductFromPortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateProductFromPortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
