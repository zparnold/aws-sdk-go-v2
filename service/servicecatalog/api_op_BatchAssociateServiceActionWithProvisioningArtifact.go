...
func (c *Client) BatchAssociateServiceActionWithProvisioningArtifact(ctx context.Context, params *BatchAssociateServiceActionWithProvisioningArtifactInput, optFns ...func(*Options)) (*BatchAssociateServiceActionWithProvisioningArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchAssociateServiceActionWithProvisioningArtifact", params, optFns, addOperationBatchAssociateServiceActionWithProvisioningArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchAssociateServiceActionWithProvisioningArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
