...
func (c *Client) ListAcceptedPortfolioShares(ctx context.Context, params *ListAcceptedPortfolioSharesInput, optFns ...func(*Options)) (*ListAcceptedPortfolioSharesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAcceptedPortfolioShares", params, optFns, addOperationListAcceptedPortfolioSharesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAcceptedPortfolioSharesMiddleware(stack *middleware.Stack, options Options) (err error) {
