...
func (c *Client) DeleteProduct(ctx context.Context, params *DeleteProductInput, optFns ...func(*Options)) (*DeleteProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProduct", params, optFns, addOperationDeleteProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProductMiddleware(stack *middleware.Stack, options Options) (err error) {
