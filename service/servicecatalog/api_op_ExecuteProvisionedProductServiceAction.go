...
func (c *Client) ExecuteProvisionedProductServiceAction(ctx context.Context, params *ExecuteProvisionedProductServiceActionInput, optFns ...func(*Options)) (*ExecuteProvisionedProductServiceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExecuteProvisionedProductServiceAction", params, optFns, addOperationExecuteProvisionedProductServiceActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExecuteProvisionedProductServiceActionMiddleware(stack *middleware.Stack, options Options) (err error) {
