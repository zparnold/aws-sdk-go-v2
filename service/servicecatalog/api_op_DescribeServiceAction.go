...
func (c *Client) DescribeServiceAction(ctx context.Context, params *DescribeServiceActionInput, optFns ...func(*Options)) (*DescribeServiceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeServiceAction", params, optFns, addOperationDescribeServiceActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeServiceActionMiddleware(stack *middleware.Stack, options Options) (err error) {
