...
func (c *Client) AssociateProductWithPortfolio(ctx context.Context, params *AssociateProductWithPortfolioInput, optFns ...func(*Options)) (*AssociateProductWithPortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateProductWithPortfolio", params, optFns, addOperationAssociateProductWithPortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateProductWithPortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
