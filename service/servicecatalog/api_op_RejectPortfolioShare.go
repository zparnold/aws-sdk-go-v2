...
func (c *Client) RejectPortfolioShare(ctx context.Context, params *RejectPortfolioShareInput, optFns ...func(*Options)) (*RejectPortfolioShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectPortfolioShare", params, optFns, addOperationRejectPortfolioShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectPortfolioShareMiddleware(stack *middleware.Stack, options Options) (err error) {
