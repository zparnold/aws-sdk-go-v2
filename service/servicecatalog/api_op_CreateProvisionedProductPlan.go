...
func (c *Client) CreateProvisionedProductPlan(ctx context.Context, params *CreateProvisionedProductPlanInput, optFns ...func(*Options)) (*CreateProvisionedProductPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProvisionedProductPlan", params, optFns, addOperationCreateProvisionedProductPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProvisionedProductPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
