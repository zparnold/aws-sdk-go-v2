...
func (c *Client) DeleteServiceAction(ctx context.Context, params *DeleteServiceActionInput, optFns ...func(*Options)) (*DeleteServiceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteServiceAction", params, optFns, addOperationDeleteServiceActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteServiceActionMiddleware(stack *middleware.Stack, options Options) (err error) {
