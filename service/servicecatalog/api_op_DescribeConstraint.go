...
func (c *Client) DescribeConstraint(ctx context.Context, params *DescribeConstraintInput, optFns ...func(*Options)) (*DescribeConstraintOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConstraint", params, optFns, addOperationDescribeConstraintMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConstraintMiddleware(stack *middleware.Stack, options Options) (err error) {
