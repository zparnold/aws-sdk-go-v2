...
func (c *Client) ListStackInstancesForProvisionedProduct(ctx context.Context, params *ListStackInstancesForProvisionedProductInput, optFns ...func(*Options)) (*ListStackInstancesForProvisionedProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStackInstancesForProvisionedProduct", params, optFns, addOperationListStackInstancesForProvisionedProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStackInstancesForProvisionedProductMiddleware(stack *middleware.Stack, options Options) (err error) {
