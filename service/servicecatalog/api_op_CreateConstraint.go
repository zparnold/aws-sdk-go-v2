...
func (c *Client) CreateConstraint(ctx context.Context, params *CreateConstraintInput, optFns ...func(*Options)) (*CreateConstraintOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConstraint", params, optFns, addOperationCreateConstraintMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConstraintMiddleware(stack *middleware.Stack, options Options) (err error) {
