...
func (c *Client) UpdatePortfolio(ctx context.Context, params *UpdatePortfolioInput, optFns ...func(*Options)) (*UpdatePortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePortfolio", params, optFns, addOperationUpdatePortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
