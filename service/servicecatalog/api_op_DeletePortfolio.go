...
func (c *Client) DeletePortfolio(ctx context.Context, params *DeletePortfolioInput, optFns ...func(*Options)) (*DeletePortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePortfolio", params, optFns, addOperationDeletePortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
