...
func (c *Client) ListProvisionedProductPlans(ctx context.Context, params *ListProvisionedProductPlansInput, optFns ...func(*Options)) (*ListProvisionedProductPlansOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProvisionedProductPlans", params, optFns, addOperationListProvisionedProductPlansMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProvisionedProductPlansMiddleware(stack *middleware.Stack, options Options) (err error) {
