...
func (c *Client) AssociateTagOptionWithResource(ctx context.Context, params *AssociateTagOptionWithResourceInput, optFns ...func(*Options)) (*AssociateTagOptionWithResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateTagOptionWithResource", params, optFns, addOperationAssociateTagOptionWithResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateTagOptionWithResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
