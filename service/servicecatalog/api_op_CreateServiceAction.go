...
func (c *Client) CreateServiceAction(ctx context.Context, params *CreateServiceActionInput, optFns ...func(*Options)) (*CreateServiceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateServiceAction", params, optFns, addOperationCreateServiceActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateServiceActionMiddleware(stack *middleware.Stack, options Options) (err error) {
