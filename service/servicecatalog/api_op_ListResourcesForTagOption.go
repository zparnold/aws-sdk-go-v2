...
func (c *Client) ListResourcesForTagOption(ctx context.Context, params *ListResourcesForTagOptionInput, optFns ...func(*Options)) (*ListResourcesForTagOptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourcesForTagOption", params, optFns, addOperationListResourcesForTagOptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourcesForTagOptionMiddleware(stack *middleware.Stack, options Options) (err error) {
