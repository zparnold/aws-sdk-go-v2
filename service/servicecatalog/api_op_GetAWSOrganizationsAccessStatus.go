...
func (c *Client) GetAWSOrganizationsAccessStatus(ctx context.Context, params *GetAWSOrganizationsAccessStatusInput, optFns ...func(*Options)) (*GetAWSOrganizationsAccessStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAWSOrganizationsAccessStatus", params, optFns, addOperationGetAWSOrganizationsAccessStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAWSOrganizationsAccessStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
