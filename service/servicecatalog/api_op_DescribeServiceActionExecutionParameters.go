...
func (c *Client) DescribeServiceActionExecutionParameters(ctx context.Context, params *DescribeServiceActionExecutionParametersInput, optFns ...func(*Options)) (*DescribeServiceActionExecutionParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeServiceActionExecutionParameters", params, optFns, addOperationDescribeServiceActionExecutionParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeServiceActionExecutionParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
