...
func (c *Client) CreatePortfolioShare(ctx context.Context, params *CreatePortfolioShareInput, optFns ...func(*Options)) (*CreatePortfolioShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePortfolioShare", params, optFns, addOperationCreatePortfolioShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePortfolioShareMiddleware(stack *middleware.Stack, options Options) (err error) {
