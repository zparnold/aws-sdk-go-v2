...
func (c *Client) ListProvisioningArtifacts(ctx context.Context, params *ListProvisioningArtifactsInput, optFns ...func(*Options)) (*ListProvisioningArtifactsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProvisioningArtifacts", params, optFns, addOperationListProvisioningArtifactsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProvisioningArtifactsMiddleware(stack *middleware.Stack, options Options) (err error) {
