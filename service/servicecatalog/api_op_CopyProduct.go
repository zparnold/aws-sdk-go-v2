...
func (c *Client) CopyProduct(ctx context.Context, params *CopyProductInput, optFns ...func(*Options)) (*CopyProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyProduct", params, optFns, addOperationCopyProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyProductMiddleware(stack *middleware.Stack, options Options) (err error) {
