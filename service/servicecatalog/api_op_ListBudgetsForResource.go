...
func (c *Client) ListBudgetsForResource(ctx context.Context, params *ListBudgetsForResourceInput, optFns ...func(*Options)) (*ListBudgetsForResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBudgetsForResource", params, optFns, addOperationListBudgetsForResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBudgetsForResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
