...
func (c *Client) DescribeRecord(ctx context.Context, params *DescribeRecordInput, optFns ...func(*Options)) (*DescribeRecordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRecord", params, optFns, addOperationDescribeRecordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRecordMiddleware(stack *middleware.Stack, options Options) (err error) {
