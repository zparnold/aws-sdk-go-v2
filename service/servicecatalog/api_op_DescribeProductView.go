...
func (c *Client) DescribeProductView(ctx context.Context, params *DescribeProductViewInput, optFns ...func(*Options)) (*DescribeProductViewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProductView", params, optFns, addOperationDescribeProductViewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProductViewMiddleware(stack *middleware.Stack, options Options) (err error) {
