...
func (c *Client) AssociateServiceActionWithProvisioningArtifact(ctx context.Context, params *AssociateServiceActionWithProvisioningArtifactInput, optFns ...func(*Options)) (*AssociateServiceActionWithProvisioningArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateServiceActionWithProvisioningArtifact", params, optFns, addOperationAssociateServiceActionWithProvisioningArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateServiceActionWithProvisioningArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
