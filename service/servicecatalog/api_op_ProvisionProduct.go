...
func (c *Client) ProvisionProduct(ctx context.Context, params *ProvisionProductInput, optFns ...func(*Options)) (*ProvisionProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ProvisionProduct", params, optFns, addOperationProvisionProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationProvisionProductMiddleware(stack *middleware.Stack, options Options) (err error) {
