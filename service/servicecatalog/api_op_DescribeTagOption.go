...
func (c *Client) DescribeTagOption(ctx context.Context, params *DescribeTagOptionInput, optFns ...func(*Options)) (*DescribeTagOptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTagOption", params, optFns, addOperationDescribeTagOptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTagOptionMiddleware(stack *middleware.Stack, options Options) (err error) {
