...
func (c *Client) SearchProvisionedProducts(ctx context.Context, params *SearchProvisionedProductsInput, optFns ...func(*Options)) (*SearchProvisionedProductsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchProvisionedProducts", params, optFns, addOperationSearchProvisionedProductsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchProvisionedProductsMiddleware(stack *middleware.Stack, options Options) (err error) {
