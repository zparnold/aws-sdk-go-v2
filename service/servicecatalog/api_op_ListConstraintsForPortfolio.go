...
func (c *Client) ListConstraintsForPortfolio(ctx context.Context, params *ListConstraintsForPortfolioInput, optFns ...func(*Options)) (*ListConstraintsForPortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConstraintsForPortfolio", params, optFns, addOperationListConstraintsForPortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConstraintsForPortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
