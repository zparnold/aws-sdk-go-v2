...
func (c *Client) ExecuteProvisionedProductPlan(ctx context.Context, params *ExecuteProvisionedProductPlanInput, optFns ...func(*Options)) (*ExecuteProvisionedProductPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExecuteProvisionedProductPlan", params, optFns, addOperationExecuteProvisionedProductPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExecuteProvisionedProductPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
