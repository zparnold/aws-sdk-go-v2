...
func (c *Client) DescribeProvisionedProductPlan(ctx context.Context, params *DescribeProvisionedProductPlanInput, optFns ...func(*Options)) (*DescribeProvisionedProductPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProvisionedProductPlan", params, optFns, addOperationDescribeProvisionedProductPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProvisionedProductPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
