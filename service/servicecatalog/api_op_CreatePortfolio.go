...
func (c *Client) CreatePortfolio(ctx context.Context, params *CreatePortfolioInput, optFns ...func(*Options)) (*CreatePortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePortfolio", params, optFns, addOperationCreatePortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
