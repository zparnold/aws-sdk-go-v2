...
func (c *Client) ListPortfolioAccess(ctx context.Context, params *ListPortfolioAccessInput, optFns ...func(*Options)) (*ListPortfolioAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPortfolioAccess", params, optFns, addOperationListPortfolioAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPortfolioAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
