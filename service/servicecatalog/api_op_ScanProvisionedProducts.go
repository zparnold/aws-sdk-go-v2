...
func (c *Client) ScanProvisionedProducts(ctx context.Context, params *ScanProvisionedProductsInput, optFns ...func(*Options)) (*ScanProvisionedProductsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ScanProvisionedProducts", params, optFns, addOperationScanProvisionedProductsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationScanProvisionedProductsMiddleware(stack *middleware.Stack, options Options) (err error) {
