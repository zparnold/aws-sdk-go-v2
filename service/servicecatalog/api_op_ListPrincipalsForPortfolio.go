...
func (c *Client) ListPrincipalsForPortfolio(ctx context.Context, params *ListPrincipalsForPortfolioInput, optFns ...func(*Options)) (*ListPrincipalsForPortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPrincipalsForPortfolio", params, optFns, addOperationListPrincipalsForPortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPrincipalsForPortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
