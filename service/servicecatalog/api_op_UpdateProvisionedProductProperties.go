...
func (c *Client) UpdateProvisionedProductProperties(ctx context.Context, params *UpdateProvisionedProductPropertiesInput, optFns ...func(*Options)) (*UpdateProvisionedProductPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProvisionedProductProperties", params, optFns, addOperationUpdateProvisionedProductPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProvisionedProductPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
