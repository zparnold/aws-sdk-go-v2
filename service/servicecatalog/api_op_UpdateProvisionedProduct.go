...
func (c *Client) UpdateProvisionedProduct(ctx context.Context, params *UpdateProvisionedProductInput, optFns ...func(*Options)) (*UpdateProvisionedProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProvisionedProduct", params, optFns, addOperationUpdateProvisionedProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProvisionedProductMiddleware(stack *middleware.Stack, options Options) (err error) {
