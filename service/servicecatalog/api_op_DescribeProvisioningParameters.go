...
func (c *Client) DescribeProvisioningParameters(ctx context.Context, params *DescribeProvisioningParametersInput, optFns ...func(*Options)) (*DescribeProvisioningParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProvisioningParameters", params, optFns, addOperationDescribeProvisioningParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProvisioningParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
