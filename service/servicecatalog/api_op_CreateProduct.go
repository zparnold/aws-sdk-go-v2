...
func (c *Client) CreateProduct(ctx context.Context, params *CreateProductInput, optFns ...func(*Options)) (*CreateProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProduct", params, optFns, addOperationCreateProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProductMiddleware(stack *middleware.Stack, options Options) (err error) {
