...
func (c *Client) DeletePortfolioShare(ctx context.Context, params *DeletePortfolioShareInput, optFns ...func(*Options)) (*DeletePortfolioShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePortfolioShare", params, optFns, addOperationDeletePortfolioShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePortfolioShareMiddleware(stack *middleware.Stack, options Options) (err error) {
