...
func (c *Client) DisassociatePrincipalFromPortfolio(ctx context.Context, params *DisassociatePrincipalFromPortfolioInput, optFns ...func(*Options)) (*DisassociatePrincipalFromPortfolioOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociatePrincipalFromPortfolio", params, optFns, addOperationDisassociatePrincipalFromPortfolioMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociatePrincipalFromPortfolioMiddleware(stack *middleware.Stack, options Options) (err error) {
