...
func (c *Client) UpdateProvisioningArtifact(ctx context.Context, params *UpdateProvisioningArtifactInput, optFns ...func(*Options)) (*UpdateProvisioningArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProvisioningArtifact", params, optFns, addOperationUpdateProvisioningArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProvisioningArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
