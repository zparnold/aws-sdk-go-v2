...
func (c *Client) AcceptPortfolioShare(ctx context.Context, params *AcceptPortfolioShareInput, optFns ...func(*Options)) (*AcceptPortfolioShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptPortfolioShare", params, optFns, addOperationAcceptPortfolioShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptPortfolioShareMiddleware(stack *middleware.Stack, options Options) (err error) {
