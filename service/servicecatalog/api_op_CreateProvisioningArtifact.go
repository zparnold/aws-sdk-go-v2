...
func (c *Client) CreateProvisioningArtifact(ctx context.Context, params *CreateProvisioningArtifactInput, optFns ...func(*Options)) (*CreateProvisioningArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProvisioningArtifact", params, optFns, addOperationCreateProvisioningArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProvisioningArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
