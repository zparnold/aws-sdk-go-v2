...
func (c *Client) UpdateTagOption(ctx context.Context, params *UpdateTagOptionInput, optFns ...func(*Options)) (*UpdateTagOptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTagOption", params, optFns, addOperationUpdateTagOptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTagOptionMiddleware(stack *middleware.Stack, options Options) (err error) {
