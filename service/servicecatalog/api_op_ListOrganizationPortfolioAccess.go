...
func (c *Client) ListOrganizationPortfolioAccess(ctx context.Context, params *ListOrganizationPortfolioAccessInput, optFns ...func(*Options)) (*ListOrganizationPortfolioAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOrganizationPortfolioAccess", params, optFns, addOperationListOrganizationPortfolioAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOrganizationPortfolioAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
