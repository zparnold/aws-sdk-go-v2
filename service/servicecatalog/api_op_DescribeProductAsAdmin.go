...
func (c *Client) DescribeProductAsAdmin(ctx context.Context, params *DescribeProductAsAdminInput, optFns ...func(*Options)) (*DescribeProductAsAdminOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProductAsAdmin", params, optFns, addOperationDescribeProductAsAdminMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProductAsAdminMiddleware(stack *middleware.Stack, options Options) (err error) {
