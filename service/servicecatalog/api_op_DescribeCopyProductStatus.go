...
func (c *Client) DescribeCopyProductStatus(ctx context.Context, params *DescribeCopyProductStatusInput, optFns ...func(*Options)) (*DescribeCopyProductStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCopyProductStatus", params, optFns, addOperationDescribeCopyProductStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCopyProductStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
