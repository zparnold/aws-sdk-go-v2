...
func (c *Client) DisableAWSOrganizationsAccess(ctx context.Context, params *DisableAWSOrganizationsAccessInput, optFns ...func(*Options)) (*DisableAWSOrganizationsAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableAWSOrganizationsAccess", params, optFns, addOperationDisableAWSOrganizationsAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableAWSOrganizationsAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
