...
func (c *Client) GrantPermissions(ctx context.Context, params *GrantPermissionsInput, optFns ...func(*Options)) (*GrantPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GrantPermissions", params, optFns, addOperationGrantPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGrantPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
