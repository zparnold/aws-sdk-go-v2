...
func (c *Client) BatchGrantPermissions(ctx context.Context, params *BatchGrantPermissionsInput, optFns ...func(*Options)) (*BatchGrantPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGrantPermissions", params, optFns, addOperationBatchGrantPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGrantPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
