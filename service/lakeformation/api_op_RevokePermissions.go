...
func (c *Client) RevokePermissions(ctx context.Context, params *RevokePermissionsInput, optFns ...func(*Options)) (*RevokePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokePermissions", params, optFns, addOperationRevokePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
