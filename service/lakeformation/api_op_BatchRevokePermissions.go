...
func (c *Client) BatchRevokePermissions(ctx context.Context, params *BatchRevokePermissionsInput, optFns ...func(*Options)) (*BatchRevokePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchRevokePermissions", params, optFns, addOperationBatchRevokePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchRevokePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
