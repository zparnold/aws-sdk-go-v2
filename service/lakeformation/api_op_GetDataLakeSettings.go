...
func (c *Client) GetDataLakeSettings(ctx context.Context, params *GetDataLakeSettingsInput, optFns ...func(*Options)) (*GetDataLakeSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataLakeSettings", params, optFns, addOperationGetDataLakeSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataLakeSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
