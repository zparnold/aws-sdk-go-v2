...
func (c *Client) ListPermissions(ctx context.Context, params *ListPermissionsInput, optFns ...func(*Options)) (*ListPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPermissions", params, optFns, addOperationListPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
