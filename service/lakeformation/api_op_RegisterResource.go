...
func (c *Client) RegisterResource(ctx context.Context, params *RegisterResourceInput, optFns ...func(*Options)) (*RegisterResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterResource", params, optFns, addOperationRegisterResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
