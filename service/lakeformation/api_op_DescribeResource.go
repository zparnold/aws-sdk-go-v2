...
func (c *Client) DescribeResource(ctx context.Context, params *DescribeResourceInput, optFns ...func(*Options)) (*DescribeResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeResource", params, optFns, addOperationDescribeResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
