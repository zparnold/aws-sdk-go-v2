...
func (c *Client) PutDataLakeSettings(ctx context.Context, params *PutDataLakeSettingsInput, optFns ...func(*Options)) (*PutDataLakeSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDataLakeSettings", params, optFns, addOperationPutDataLakeSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDataLakeSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
