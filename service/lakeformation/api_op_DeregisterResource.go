...
func (c *Client) DeregisterResource(ctx context.Context, params *DeregisterResourceInput, optFns ...func(*Options)) (*DeregisterResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterResource", params, optFns, addOperationDeregisterResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
