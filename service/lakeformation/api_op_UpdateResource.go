...
func (c *Client) UpdateResource(ctx context.Context, params *UpdateResourceInput, optFns ...func(*Options)) (*UpdateResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResource", params, optFns, addOperationUpdateResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
