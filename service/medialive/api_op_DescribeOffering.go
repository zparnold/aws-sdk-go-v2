...
func (c *Client) DescribeOffering(ctx context.Context, params *DescribeOfferingInput, optFns ...func(*Options)) (*DescribeOfferingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOffering", params, optFns, addOperationDescribeOfferingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOfferingMiddleware(stack *middleware.Stack, options Options) (err error) {
