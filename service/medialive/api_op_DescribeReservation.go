...
func (c *Client) DescribeReservation(ctx context.Context, params *DescribeReservationInput, optFns ...func(*Options)) (*DescribeReservationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservation", params, optFns, addOperationDescribeReservationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservationMiddleware(stack *middleware.Stack, options Options) (err error) {
