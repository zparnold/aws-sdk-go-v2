...
func (c *Client) DescribeMultiplex(ctx context.Context, params *DescribeMultiplexInput, optFns ...func(*Options)) (*DescribeMultiplexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMultiplex", params, optFns, addOperationDescribeMultiplexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMultiplexMiddleware(stack *middleware.Stack, options Options) (err error) {
