...
func (c *Client) DescribeInputDevice(ctx context.Context, params *DescribeInputDeviceInput, optFns ...func(*Options)) (*DescribeInputDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInputDevice", params, optFns, addOperationDescribeInputDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInputDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
