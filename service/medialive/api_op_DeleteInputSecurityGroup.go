...
func (c *Client) DeleteInputSecurityGroup(ctx context.Context, params *DeleteInputSecurityGroupInput, optFns ...func(*Options)) (*DeleteInputSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInputSecurityGroup", params, optFns, addOperationDeleteInputSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInputSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
