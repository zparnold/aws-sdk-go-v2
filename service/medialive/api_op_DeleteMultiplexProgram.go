...
func (c *Client) DeleteMultiplexProgram(ctx context.Context, params *DeleteMultiplexProgramInput, optFns ...func(*Options)) (*DeleteMultiplexProgramOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMultiplexProgram", params, optFns, addOperationDeleteMultiplexProgramMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMultiplexProgramMiddleware(stack *middleware.Stack, options Options) (err error) {
