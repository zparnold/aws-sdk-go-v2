...
func (c *Client) CreateMultiplex(ctx context.Context, params *CreateMultiplexInput, optFns ...func(*Options)) (*CreateMultiplexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMultiplex", params, optFns, addOperationCreateMultiplexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMultiplexMiddleware(stack *middleware.Stack, options Options) (err error) {
