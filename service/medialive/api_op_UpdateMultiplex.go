...
func (c *Client) UpdateMultiplex(ctx context.Context, params *UpdateMultiplexInput, optFns ...func(*Options)) (*UpdateMultiplexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMultiplex", params, optFns, addOperationUpdateMultiplexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMultiplexMiddleware(stack *middleware.Stack, options Options) (err error) {
