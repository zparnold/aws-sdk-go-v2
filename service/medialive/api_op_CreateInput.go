...
func (c *Client) CreateInput(ctx context.Context, params *CreateInputInput, optFns ...func(*Options)) (*CreateInputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInput", params, optFns, addOperationCreateInputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInputMiddleware(stack *middleware.Stack, options Options) (err error) {
