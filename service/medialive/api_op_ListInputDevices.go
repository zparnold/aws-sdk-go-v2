...
func (c *Client) ListInputDevices(ctx context.Context, params *ListInputDevicesInput, optFns ...func(*Options)) (*ListInputDevicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInputDevices", params, optFns, addOperationListInputDevicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInputDevicesMiddleware(stack *middleware.Stack, options Options) (err error) {
