...
func (c *Client) DescribeInputDeviceThumbnail(ctx context.Context, params *DescribeInputDeviceThumbnailInput, optFns ...func(*Options)) (*DescribeInputDeviceThumbnailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInputDeviceThumbnail", params, optFns, addOperationDescribeInputDeviceThumbnailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInputDeviceThumbnailMiddleware(stack *middleware.Stack, options Options) (err error) {
