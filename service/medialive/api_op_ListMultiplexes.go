...
func (c *Client) ListMultiplexes(ctx context.Context, params *ListMultiplexesInput, optFns ...func(*Options)) (*ListMultiplexesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMultiplexes", params, optFns, addOperationListMultiplexesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMultiplexesMiddleware(stack *middleware.Stack, options Options) (err error) {
