...
func (c *Client) ListMultiplexPrograms(ctx context.Context, params *ListMultiplexProgramsInput, optFns ...func(*Options)) (*ListMultiplexProgramsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMultiplexPrograms", params, optFns, addOperationListMultiplexProgramsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMultiplexProgramsMiddleware(stack *middleware.Stack, options Options) (err error) {
