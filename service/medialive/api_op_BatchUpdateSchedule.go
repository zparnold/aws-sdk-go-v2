...
func (c *Client) BatchUpdateSchedule(ctx context.Context, params *BatchUpdateScheduleInput, optFns ...func(*Options)) (*BatchUpdateScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchUpdateSchedule", params, optFns, addOperationBatchUpdateScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchUpdateScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
