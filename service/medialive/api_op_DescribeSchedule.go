...
func (c *Client) DescribeSchedule(ctx context.Context, params *DescribeScheduleInput, optFns ...func(*Options)) (*DescribeScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSchedule", params, optFns, addOperationDescribeScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
