...
func (c *Client) StopChannel(ctx context.Context, params *StopChannelInput, optFns ...func(*Options)) (*StopChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopChannel", params, optFns, addOperationStopChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
