...
func (c *Client) UpdateInputDevice(ctx context.Context, params *UpdateInputDeviceInput, optFns ...func(*Options)) (*UpdateInputDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateInputDevice", params, optFns, addOperationUpdateInputDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateInputDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
