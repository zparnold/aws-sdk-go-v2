...
func (c *Client) StartChannel(ctx context.Context, params *StartChannelInput, optFns ...func(*Options)) (*StartChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartChannel", params, optFns, addOperationStartChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
