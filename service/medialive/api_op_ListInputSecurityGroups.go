...
func (c *Client) ListInputSecurityGroups(ctx context.Context, params *ListInputSecurityGroupsInput, optFns ...func(*Options)) (*ListInputSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInputSecurityGroups", params, optFns, addOperationListInputSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInputSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
