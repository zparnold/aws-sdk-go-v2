...
func (c *Client) DeleteMultiplex(ctx context.Context, params *DeleteMultiplexInput, optFns ...func(*Options)) (*DeleteMultiplexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMultiplex", params, optFns, addOperationDeleteMultiplexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMultiplexMiddleware(stack *middleware.Stack, options Options) (err error) {
