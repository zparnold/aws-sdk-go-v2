...
func (c *Client) StartMultiplex(ctx context.Context, params *StartMultiplexInput, optFns ...func(*Options)) (*StartMultiplexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMultiplex", params, optFns, addOperationStartMultiplexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMultiplexMiddleware(stack *middleware.Stack, options Options) (err error) {
