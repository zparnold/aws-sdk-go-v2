...
func (c *Client) DeleteSchedule(ctx context.Context, params *DeleteScheduleInput, optFns ...func(*Options)) (*DeleteScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSchedule", params, optFns, addOperationDeleteScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
