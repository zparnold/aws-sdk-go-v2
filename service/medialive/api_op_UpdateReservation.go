...
func (c *Client) UpdateReservation(ctx context.Context, params *UpdateReservationInput, optFns ...func(*Options)) (*UpdateReservationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateReservation", params, optFns, addOperationUpdateReservationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateReservationMiddleware(stack *middleware.Stack, options Options) (err error) {
