...
func (c *Client) DescribeMultiplexProgram(ctx context.Context, params *DescribeMultiplexProgramInput, optFns ...func(*Options)) (*DescribeMultiplexProgramOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMultiplexProgram", params, optFns, addOperationDescribeMultiplexProgramMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMultiplexProgramMiddleware(stack *middleware.Stack, options Options) (err error) {
