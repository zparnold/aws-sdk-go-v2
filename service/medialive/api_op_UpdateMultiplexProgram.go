...
func (c *Client) UpdateMultiplexProgram(ctx context.Context, params *UpdateMultiplexProgramInput, optFns ...func(*Options)) (*UpdateMultiplexProgramOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMultiplexProgram", params, optFns, addOperationUpdateMultiplexProgramMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMultiplexProgramMiddleware(stack *middleware.Stack, options Options) (err error) {
