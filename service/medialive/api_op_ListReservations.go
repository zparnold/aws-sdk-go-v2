...
func (c *Client) ListReservations(ctx context.Context, params *ListReservationsInput, optFns ...func(*Options)) (*ListReservationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReservations", params, optFns, addOperationListReservationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReservationsMiddleware(stack *middleware.Stack, options Options) (err error) {
