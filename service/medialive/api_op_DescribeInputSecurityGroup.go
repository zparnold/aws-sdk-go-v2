...
func (c *Client) DescribeInputSecurityGroup(ctx context.Context, params *DescribeInputSecurityGroupInput, optFns ...func(*Options)) (*DescribeInputSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInputSecurityGroup", params, optFns, addOperationDescribeInputSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInputSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
