...
func (c *Client) StopMultiplex(ctx context.Context, params *StopMultiplexInput, optFns ...func(*Options)) (*StopMultiplexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopMultiplex", params, optFns, addOperationStopMultiplexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopMultiplexMiddleware(stack *middleware.Stack, options Options) (err error) {
