...
func (c *Client) CreateInputSecurityGroup(ctx context.Context, params *CreateInputSecurityGroupInput, optFns ...func(*Options)) (*CreateInputSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInputSecurityGroup", params, optFns, addOperationCreateInputSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInputSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
