...
func (c *Client) UpdateInputSecurityGroup(ctx context.Context, params *UpdateInputSecurityGroupInput, optFns ...func(*Options)) (*UpdateInputSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateInputSecurityGroup", params, optFns, addOperationUpdateInputSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateInputSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
