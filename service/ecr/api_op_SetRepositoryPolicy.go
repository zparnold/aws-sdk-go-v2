...
func (c *Client) SetRepositoryPolicy(ctx context.Context, params *SetRepositoryPolicyInput, optFns ...func(*Options)) (*SetRepositoryPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetRepositoryPolicy", params, optFns, addOperationSetRepositoryPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetRepositoryPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
