...
func (c *Client) ListImages(ctx context.Context, params *ListImagesInput, optFns ...func(*Options)) (*ListImagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListImages", params, optFns, addOperationListImagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListImagesMiddleware(stack *middleware.Stack, options Options) (err error) {
