...
func (c *Client) StartLifecyclePolicyPreview(ctx context.Context, params *StartLifecyclePolicyPreviewInput, optFns ...func(*Options)) (*StartLifecyclePolicyPreviewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartLifecyclePolicyPreview", params, optFns, addOperationStartLifecyclePolicyPreviewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartLifecyclePolicyPreviewMiddleware(stack *middleware.Stack, options Options) (err error) {
