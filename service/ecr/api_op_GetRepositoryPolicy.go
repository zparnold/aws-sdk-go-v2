...
func (c *Client) GetRepositoryPolicy(ctx context.Context, params *GetRepositoryPolicyInput, optFns ...func(*Options)) (*GetRepositoryPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRepositoryPolicy", params, optFns, addOperationGetRepositoryPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRepositoryPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
