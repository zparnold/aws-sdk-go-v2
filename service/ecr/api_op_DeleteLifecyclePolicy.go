...
func (c *Client) DeleteLifecyclePolicy(ctx context.Context, params *DeleteLifecyclePolicyInput, optFns ...func(*Options)) (*DeleteLifecyclePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLifecyclePolicy", params, optFns, addOperationDeleteLifecyclePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLifecyclePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
