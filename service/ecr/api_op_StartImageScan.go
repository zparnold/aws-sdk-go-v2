...
func (c *Client) StartImageScan(ctx context.Context, params *StartImageScanInput, optFns ...func(*Options)) (*StartImageScanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartImageScan", params, optFns, addOperationStartImageScanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartImageScanMiddleware(stack *middleware.Stack, options Options) (err error) {
