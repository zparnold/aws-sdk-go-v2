...
func (c *Client) DescribeImageScanFindings(ctx context.Context, params *DescribeImageScanFindingsInput, optFns ...func(*Options)) (*DescribeImageScanFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeImageScanFindings", params, optFns, addOperationDescribeImageScanFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeImageScanFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
