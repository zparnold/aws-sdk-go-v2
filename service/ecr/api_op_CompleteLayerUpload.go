...
func (c *Client) CompleteLayerUpload(ctx context.Context, params *CompleteLayerUploadInput, optFns ...func(*Options)) (*CompleteLayerUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CompleteLayerUpload", params, optFns, addOperationCompleteLayerUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCompleteLayerUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
