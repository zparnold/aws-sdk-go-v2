...
func (c *Client) DeleteRepositoryPolicy(ctx context.Context, params *DeleteRepositoryPolicyInput, optFns ...func(*Options)) (*DeleteRepositoryPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRepositoryPolicy", params, optFns, addOperationDeleteRepositoryPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRepositoryPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
