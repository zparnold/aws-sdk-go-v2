...
func (c *Client) DescribeImages(ctx context.Context, params *DescribeImagesInput, optFns ...func(*Options)) (*DescribeImagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeImages", params, optFns, addOperationDescribeImagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeImagesMiddleware(stack *middleware.Stack, options Options) (err error) {
