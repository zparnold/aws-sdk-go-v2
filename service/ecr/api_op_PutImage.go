...
func (c *Client) PutImage(ctx context.Context, params *PutImageInput, optFns ...func(*Options)) (*PutImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutImage", params, optFns, addOperationPutImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutImageMiddleware(stack *middleware.Stack, options Options) (err error) {
