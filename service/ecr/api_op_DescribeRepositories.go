...
func (c *Client) DescribeRepositories(ctx context.Context, params *DescribeRepositoriesInput, optFns ...func(*Options)) (*DescribeRepositoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRepositories", params, optFns, addOperationDescribeRepositoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRepositoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
