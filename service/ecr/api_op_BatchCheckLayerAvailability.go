...
func (c *Client) BatchCheckLayerAvailability(ctx context.Context, params *BatchCheckLayerAvailabilityInput, optFns ...func(*Options)) (*BatchCheckLayerAvailabilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchCheckLayerAvailability", params, optFns, addOperationBatchCheckLayerAvailabilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchCheckLayerAvailabilityMiddleware(stack *middleware.Stack, options Options) (err error) {
