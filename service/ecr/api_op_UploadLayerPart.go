...
func (c *Client) UploadLayerPart(ctx context.Context, params *UploadLayerPartInput, optFns ...func(*Options)) (*UploadLayerPartOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadLayerPart", params, optFns, addOperationUploadLayerPartMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadLayerPartMiddleware(stack *middleware.Stack, options Options) (err error) {
