...
func (c *Client) PutImageTagMutability(ctx context.Context, params *PutImageTagMutabilityInput, optFns ...func(*Options)) (*PutImageTagMutabilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutImageTagMutability", params, optFns, addOperationPutImageTagMutabilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutImageTagMutabilityMiddleware(stack *middleware.Stack, options Options) (err error) {
