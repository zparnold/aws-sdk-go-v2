...
func (c *Client) GetDownloadUrlForLayer(ctx context.Context, params *GetDownloadUrlForLayerInput, optFns ...func(*Options)) (*GetDownloadUrlForLayerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDownloadUrlForLayer", params, optFns, addOperationGetDownloadUrlForLayerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDownloadUrlForLayerMiddleware(stack *middleware.Stack, options Options) (err error) {
