...
func (c *Client) PutImageScanningConfiguration(ctx context.Context, params *PutImageScanningConfigurationInput, optFns ...func(*Options)) (*PutImageScanningConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutImageScanningConfiguration", params, optFns, addOperationPutImageScanningConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutImageScanningConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
