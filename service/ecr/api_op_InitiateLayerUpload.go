...
func (c *Client) InitiateLayerUpload(ctx context.Context, params *InitiateLayerUploadInput, optFns ...func(*Options)) (*InitiateLayerUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InitiateLayerUpload", params, optFns, addOperationInitiateLayerUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInitiateLayerUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
