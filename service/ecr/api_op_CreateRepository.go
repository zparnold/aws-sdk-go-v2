...
func (c *Client) CreateRepository(ctx context.Context, params *CreateRepositoryInput, optFns ...func(*Options)) (*CreateRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRepository", params, optFns, addOperationCreateRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
