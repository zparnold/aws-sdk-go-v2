...
func (c *Client) GetLifecyclePolicyPreview(ctx context.Context, params *GetLifecyclePolicyPreviewInput, optFns ...func(*Options)) (*GetLifecyclePolicyPreviewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLifecyclePolicyPreview", params, optFns, addOperationGetLifecyclePolicyPreviewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLifecyclePolicyPreviewMiddleware(stack *middleware.Stack, options Options) (err error) {
