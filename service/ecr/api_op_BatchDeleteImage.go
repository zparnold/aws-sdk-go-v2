...
func (c *Client) BatchDeleteImage(ctx context.Context, params *BatchDeleteImageInput, optFns ...func(*Options)) (*BatchDeleteImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeleteImage", params, optFns, addOperationBatchDeleteImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeleteImageMiddleware(stack *middleware.Stack, options Options) (err error) {
