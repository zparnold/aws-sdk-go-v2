...
func (c *Client) ListTaskDefinitions(ctx context.Context, params *ListTaskDefinitionsInput, optFns ...func(*Options)) (*ListTaskDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTaskDefinitions", params, optFns, addOperationListTaskDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTaskDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
