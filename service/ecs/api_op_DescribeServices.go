...
func (c *Client) DescribeServices(ctx context.Context, params *DescribeServicesInput, optFns ...func(*Options)) (*DescribeServicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeServices", params, optFns, addOperationDescribeServicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeServicesMiddleware(stack *middleware.Stack, options Options) (err error) {
