...
func (c *Client) ListTaskDefinitionFamilies(ctx context.Context, params *ListTaskDefinitionFamiliesInput, optFns ...func(*Options)) (*ListTaskDefinitionFamiliesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTaskDefinitionFamilies", params, optFns, addOperationListTaskDefinitionFamiliesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTaskDefinitionFamiliesMiddleware(stack *middleware.Stack, options Options) (err error) {
