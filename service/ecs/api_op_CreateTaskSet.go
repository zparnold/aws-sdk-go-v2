...
func (c *Client) CreateTaskSet(ctx context.Context, params *CreateTaskSetInput, optFns ...func(*Options)) (*CreateTaskSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTaskSet", params, optFns, addOperationCreateTaskSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTaskSetMiddleware(stack *middleware.Stack, options Options) (err error) {
