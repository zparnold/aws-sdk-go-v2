...
func (c *Client) UpdateTaskSet(ctx context.Context, params *UpdateTaskSetInput, optFns ...func(*Options)) (*UpdateTaskSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTaskSet", params, optFns, addOperationUpdateTaskSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTaskSetMiddleware(stack *middleware.Stack, options Options) (err error) {
