...
func (c *Client) UpdateClusterSettings(ctx context.Context, params *UpdateClusterSettingsInput, optFns ...func(*Options)) (*UpdateClusterSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClusterSettings", params, optFns, addOperationUpdateClusterSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClusterSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
