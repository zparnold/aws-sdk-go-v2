...
func (c *Client) DescribeContainerInstances(ctx context.Context, params *DescribeContainerInstancesInput, optFns ...func(*Options)) (*DescribeContainerInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeContainerInstances", params, optFns, addOperationDescribeContainerInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeContainerInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
