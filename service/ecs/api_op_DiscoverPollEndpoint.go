...
func (c *Client) DiscoverPollEndpoint(ctx context.Context, params *DiscoverPollEndpointInput, optFns ...func(*Options)) (*DiscoverPollEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DiscoverPollEndpoint", params, optFns, addOperationDiscoverPollEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDiscoverPollEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
