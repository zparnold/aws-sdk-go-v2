...
func (c *Client) DeleteAttributes(ctx context.Context, params *DeleteAttributesInput, optFns ...func(*Options)) (*DeleteAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAttributes", params, optFns, addOperationDeleteAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
