...
func (c *Client) CreateService(ctx context.Context, params *CreateServiceInput, optFns ...func(*Options)) (*CreateServiceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateService", params, optFns, addOperationCreateServiceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateServiceMiddleware(stack *middleware.Stack, options Options) (err error) {
