...
func (c *Client) PutClusterCapacityProviders(ctx context.Context, params *PutClusterCapacityProvidersInput, optFns ...func(*Options)) (*PutClusterCapacityProvidersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutClusterCapacityProviders", params, optFns, addOperationPutClusterCapacityProvidersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutClusterCapacityProvidersMiddleware(stack *middleware.Stack, options Options) (err error) {
