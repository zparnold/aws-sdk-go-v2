...
func (c *Client) DescribeCapacityProviders(ctx context.Context, params *DescribeCapacityProvidersInput, optFns ...func(*Options)) (*DescribeCapacityProvidersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCapacityProviders", params, optFns, addOperationDescribeCapacityProvidersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCapacityProvidersMiddleware(stack *middleware.Stack, options Options) (err error) {
