...
func (c *Client) ListContainerInstances(ctx context.Context, params *ListContainerInstancesInput, optFns ...func(*Options)) (*ListContainerInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListContainerInstances", params, optFns, addOperationListContainerInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListContainerInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
