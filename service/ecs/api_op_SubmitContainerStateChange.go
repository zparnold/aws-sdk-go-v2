...
func (c *Client) SubmitContainerStateChange(ctx context.Context, params *SubmitContainerStateChangeInput, optFns ...func(*Options)) (*SubmitContainerStateChangeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubmitContainerStateChange", params, optFns, addOperationSubmitContainerStateChangeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubmitContainerStateChangeMiddleware(stack *middleware.Stack, options Options) (err error) {
