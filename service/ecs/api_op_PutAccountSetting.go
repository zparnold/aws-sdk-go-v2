...
func (c *Client) PutAccountSetting(ctx context.Context, params *PutAccountSettingInput, optFns ...func(*Options)) (*PutAccountSettingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccountSetting", params, optFns, addOperationPutAccountSettingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccountSettingMiddleware(stack *middleware.Stack, options Options) (err error) {
