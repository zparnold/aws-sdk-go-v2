...
func (c *Client) DeregisterContainerInstance(ctx context.Context, params *DeregisterContainerInstanceInput, optFns ...func(*Options)) (*DeregisterContainerInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterContainerInstance", params, optFns, addOperationDeregisterContainerInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterContainerInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
