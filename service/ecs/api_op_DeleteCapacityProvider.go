...
func (c *Client) DeleteCapacityProvider(ctx context.Context, params *DeleteCapacityProviderInput, optFns ...func(*Options)) (*DeleteCapacityProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCapacityProvider", params, optFns, addOperationDeleteCapacityProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCapacityProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
