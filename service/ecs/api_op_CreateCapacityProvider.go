...
func (c *Client) CreateCapacityProvider(ctx context.Context, params *CreateCapacityProviderInput, optFns ...func(*Options)) (*CreateCapacityProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCapacityProvider", params, optFns, addOperationCreateCapacityProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCapacityProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
