...
func (c *Client) PutAccountSettingDefault(ctx context.Context, params *PutAccountSettingDefaultInput, optFns ...func(*Options)) (*PutAccountSettingDefaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccountSettingDefault", params, optFns, addOperationPutAccountSettingDefaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccountSettingDefaultMiddleware(stack *middleware.Stack, options Options) (err error) {
