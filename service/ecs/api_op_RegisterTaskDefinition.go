...
func (c *Client) RegisterTaskDefinition(ctx context.Context, params *RegisterTaskDefinitionInput, optFns ...func(*Options)) (*RegisterTaskDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterTaskDefinition", params, optFns, addOperationRegisterTaskDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterTaskDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
