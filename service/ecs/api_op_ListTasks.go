...
func (c *Client) ListTasks(ctx context.Context, params *ListTasksInput, optFns ...func(*Options)) (*ListTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTasks", params, optFns, addOperationListTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
