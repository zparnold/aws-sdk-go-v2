...
func (c *Client) SubmitTaskStateChange(ctx context.Context, params *SubmitTaskStateChangeInput, optFns ...func(*Options)) (*SubmitTaskStateChangeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubmitTaskStateChange", params, optFns, addOperationSubmitTaskStateChangeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubmitTaskStateChangeMiddleware(stack *middleware.Stack, options Options) (err error) {
