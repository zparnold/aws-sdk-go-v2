...
func (c *Client) StopTask(ctx context.Context, params *StopTaskInput, optFns ...func(*Options)) (*StopTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopTask", params, optFns, addOperationStopTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
