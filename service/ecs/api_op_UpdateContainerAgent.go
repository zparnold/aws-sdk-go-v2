...
func (c *Client) UpdateContainerAgent(ctx context.Context, params *UpdateContainerAgentInput, optFns ...func(*Options)) (*UpdateContainerAgentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateContainerAgent", params, optFns, addOperationUpdateContainerAgentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateContainerAgentMiddleware(stack *middleware.Stack, options Options) (err error) {
