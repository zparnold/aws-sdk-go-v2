...
func (c *Client) StartTask(ctx context.Context, params *StartTaskInput, optFns ...func(*Options)) (*StartTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartTask", params, optFns, addOperationStartTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
