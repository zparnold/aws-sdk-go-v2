...
func (c *Client) DescribeTaskSets(ctx context.Context, params *DescribeTaskSetsInput, optFns ...func(*Options)) (*DescribeTaskSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTaskSets", params, optFns, addOperationDescribeTaskSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTaskSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
