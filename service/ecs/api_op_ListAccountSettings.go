...
func (c *Client) ListAccountSettings(ctx context.Context, params *ListAccountSettingsInput, optFns ...func(*Options)) (*ListAccountSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccountSettings", params, optFns, addOperationListAccountSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccountSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
