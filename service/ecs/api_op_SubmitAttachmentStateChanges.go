...
func (c *Client) SubmitAttachmentStateChanges(ctx context.Context, params *SubmitAttachmentStateChangesInput, optFns ...func(*Options)) (*SubmitAttachmentStateChangesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubmitAttachmentStateChanges", params, optFns, addOperationSubmitAttachmentStateChangesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubmitAttachmentStateChangesMiddleware(stack *middleware.Stack, options Options) (err error) {
