...
func (c *Client) DescribeTasks(ctx context.Context, params *DescribeTasksInput, optFns ...func(*Options)) (*DescribeTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTasks", params, optFns, addOperationDescribeTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
