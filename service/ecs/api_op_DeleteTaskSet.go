...
func (c *Client) DeleteTaskSet(ctx context.Context, params *DeleteTaskSetInput, optFns ...func(*Options)) (*DeleteTaskSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTaskSet", params, optFns, addOperationDeleteTaskSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTaskSetMiddleware(stack *middleware.Stack, options Options) (err error) {
