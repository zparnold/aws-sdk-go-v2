...
func (c *Client) UpdateServicePrimaryTaskSet(ctx context.Context, params *UpdateServicePrimaryTaskSetInput, optFns ...func(*Options)) (*UpdateServicePrimaryTaskSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServicePrimaryTaskSet", params, optFns, addOperationUpdateServicePrimaryTaskSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServicePrimaryTaskSetMiddleware(stack *middleware.Stack, options Options) (err error) {
