...
func (c *Client) ListAttributes(ctx context.Context, params *ListAttributesInput, optFns ...func(*Options)) (*ListAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAttributes", params, optFns, addOperationListAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
