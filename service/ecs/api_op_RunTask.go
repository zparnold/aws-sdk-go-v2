...
func (c *Client) RunTask(ctx context.Context, params *RunTaskInput, optFns ...func(*Options)) (*RunTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RunTask", params, optFns, addOperationRunTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRunTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
