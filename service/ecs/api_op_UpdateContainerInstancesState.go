...
func (c *Client) UpdateContainerInstancesState(ctx context.Context, params *UpdateContainerInstancesStateInput, optFns ...func(*Options)) (*UpdateContainerInstancesStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateContainerInstancesState", params, optFns, addOperationUpdateContainerInstancesStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateContainerInstancesStateMiddleware(stack *middleware.Stack, options Options) (err error) {
