...
func (c *Client) PutAttributes(ctx context.Context, params *PutAttributesInput, optFns ...func(*Options)) (*PutAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAttributes", params, optFns, addOperationPutAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
