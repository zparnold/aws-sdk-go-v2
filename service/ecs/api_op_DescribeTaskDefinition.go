...
func (c *Client) DescribeTaskDefinition(ctx context.Context, params *DescribeTaskDefinitionInput, optFns ...func(*Options)) (*DescribeTaskDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTaskDefinition", params, optFns, addOperationDescribeTaskDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTaskDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
