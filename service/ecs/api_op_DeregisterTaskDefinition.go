...
func (c *Client) DeregisterTaskDefinition(ctx context.Context, params *DeregisterTaskDefinitionInput, optFns ...func(*Options)) (*DeregisterTaskDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterTaskDefinition", params, optFns, addOperationDeregisterTaskDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterTaskDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
