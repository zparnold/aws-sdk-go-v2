...
func (c *Client) DescribeIdentityProviderConfiguration(ctx context.Context, params *DescribeIdentityProviderConfigurationInput, optFns ...func(*Options)) (*DescribeIdentityProviderConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIdentityProviderConfiguration", params, optFns, addOperationDescribeIdentityProviderConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIdentityProviderConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
