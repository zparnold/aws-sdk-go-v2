...
func (c *Client) RestoreDomainAccess(ctx context.Context, params *RestoreDomainAccessInput, optFns ...func(*Options)) (*RestoreDomainAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreDomainAccess", params, optFns, addOperationRestoreDomainAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreDomainAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
