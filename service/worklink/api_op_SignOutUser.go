...
func (c *Client) SignOutUser(ctx context.Context, params *SignOutUserInput, optFns ...func(*Options)) (*SignOutUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SignOutUser", params, optFns, addOperationSignOutUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSignOutUserMiddleware(stack *middleware.Stack, options Options) (err error) {
