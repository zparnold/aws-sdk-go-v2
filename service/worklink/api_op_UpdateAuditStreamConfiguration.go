...
func (c *Client) UpdateAuditStreamConfiguration(ctx context.Context, params *UpdateAuditStreamConfigurationInput, optFns ...func(*Options)) (*UpdateAuditStreamConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAuditStreamConfiguration", params, optFns, addOperationUpdateAuditStreamConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAuditStreamConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
