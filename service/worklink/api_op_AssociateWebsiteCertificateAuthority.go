...
func (c *Client) AssociateWebsiteCertificateAuthority(ctx context.Context, params *AssociateWebsiteCertificateAuthorityInput, optFns ...func(*Options)) (*AssociateWebsiteCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateWebsiteCertificateAuthority", params, optFns, addOperationAssociateWebsiteCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateWebsiteCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
