...
func (c *Client) UpdateDevicePolicyConfiguration(ctx context.Context, params *UpdateDevicePolicyConfigurationInput, optFns ...func(*Options)) (*UpdateDevicePolicyConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDevicePolicyConfiguration", params, optFns, addOperationUpdateDevicePolicyConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDevicePolicyConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
