...
func (c *Client) UpdateIdentityProviderConfiguration(ctx context.Context, params *UpdateIdentityProviderConfigurationInput, optFns ...func(*Options)) (*UpdateIdentityProviderConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIdentityProviderConfiguration", params, optFns, addOperationUpdateIdentityProviderConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIdentityProviderConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
