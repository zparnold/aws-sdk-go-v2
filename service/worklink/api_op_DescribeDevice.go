...
func (c *Client) DescribeDevice(ctx context.Context, params *DescribeDeviceInput, optFns ...func(*Options)) (*DescribeDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDevice", params, optFns, addOperationDescribeDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
