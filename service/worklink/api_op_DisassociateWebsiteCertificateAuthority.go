...
func (c *Client) DisassociateWebsiteCertificateAuthority(ctx context.Context, params *DisassociateWebsiteCertificateAuthorityInput, optFns ...func(*Options)) (*DisassociateWebsiteCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateWebsiteCertificateAuthority", params, optFns, addOperationDisassociateWebsiteCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateWebsiteCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
