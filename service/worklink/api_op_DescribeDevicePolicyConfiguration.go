...
func (c *Client) DescribeDevicePolicyConfiguration(ctx context.Context, params *DescribeDevicePolicyConfigurationInput, optFns ...func(*Options)) (*DescribeDevicePolicyConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDevicePolicyConfiguration", params, optFns, addOperationDescribeDevicePolicyConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDevicePolicyConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
