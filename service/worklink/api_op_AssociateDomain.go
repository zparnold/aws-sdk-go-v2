...
func (c *Client) AssociateDomain(ctx context.Context, params *AssociateDomainInput, optFns ...func(*Options)) (*AssociateDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateDomain", params, optFns, addOperationAssociateDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
