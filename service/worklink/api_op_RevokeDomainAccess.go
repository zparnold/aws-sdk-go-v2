...
func (c *Client) RevokeDomainAccess(ctx context.Context, params *RevokeDomainAccessInput, optFns ...func(*Options)) (*RevokeDomainAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeDomainAccess", params, optFns, addOperationRevokeDomainAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeDomainAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
