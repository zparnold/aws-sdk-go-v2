...
func (c *Client) DescribeFleetMetadata(ctx context.Context, params *DescribeFleetMetadataInput, optFns ...func(*Options)) (*DescribeFleetMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetMetadata", params, optFns, addOperationDescribeFleetMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
