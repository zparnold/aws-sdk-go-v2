...
func (c *Client) UpdateDomainMetadata(ctx context.Context, params *UpdateDomainMetadataInput, optFns ...func(*Options)) (*UpdateDomainMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomainMetadata", params, optFns, addOperationUpdateDomainMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
