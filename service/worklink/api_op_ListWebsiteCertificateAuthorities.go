...
func (c *Client) ListWebsiteCertificateAuthorities(ctx context.Context, params *ListWebsiteCertificateAuthoritiesInput, optFns ...func(*Options)) (*ListWebsiteCertificateAuthoritiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWebsiteCertificateAuthorities", params, optFns, addOperationListWebsiteCertificateAuthoritiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWebsiteCertificateAuthoritiesMiddleware(stack *middleware.Stack, options Options) (err error) {
