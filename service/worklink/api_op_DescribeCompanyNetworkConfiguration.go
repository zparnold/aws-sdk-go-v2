...
func (c *Client) DescribeCompanyNetworkConfiguration(ctx context.Context, params *DescribeCompanyNetworkConfigurationInput, optFns ...func(*Options)) (*DescribeCompanyNetworkConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCompanyNetworkConfiguration", params, optFns, addOperationDescribeCompanyNetworkConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCompanyNetworkConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
