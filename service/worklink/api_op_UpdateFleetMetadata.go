...
func (c *Client) UpdateFleetMetadata(ctx context.Context, params *UpdateFleetMetadataInput, optFns ...func(*Options)) (*UpdateFleetMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFleetMetadata", params, optFns, addOperationUpdateFleetMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFleetMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
