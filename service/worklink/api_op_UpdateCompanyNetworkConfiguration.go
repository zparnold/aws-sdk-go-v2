...
func (c *Client) UpdateCompanyNetworkConfiguration(ctx context.Context, params *UpdateCompanyNetworkConfigurationInput, optFns ...func(*Options)) (*UpdateCompanyNetworkConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCompanyNetworkConfiguration", params, optFns, addOperationUpdateCompanyNetworkConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCompanyNetworkConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
