...
func (c *Client) DisassociateDomain(ctx context.Context, params *DisassociateDomainInput, optFns ...func(*Options)) (*DisassociateDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateDomain", params, optFns, addOperationDisassociateDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
