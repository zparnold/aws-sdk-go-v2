...
func (c *Client) ListWebsiteAuthorizationProviders(ctx context.Context, params *ListWebsiteAuthorizationProvidersInput, optFns ...func(*Options)) (*ListWebsiteAuthorizationProvidersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWebsiteAuthorizationProviders", params, optFns, addOperationListWebsiteAuthorizationProvidersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWebsiteAuthorizationProvidersMiddleware(stack *middleware.Stack, options Options) (err error) {
