...
func (c *Client) DescribeAuditStreamConfiguration(ctx context.Context, params *DescribeAuditStreamConfigurationInput, optFns ...func(*Options)) (*DescribeAuditStreamConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAuditStreamConfiguration", params, optFns, addOperationDescribeAuditStreamConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAuditStreamConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
