...
func (c *Client) StartDocumentTextDetection(ctx context.Context, params *StartDocumentTextDetectionInput, optFns ...func(*Options)) (*StartDocumentTextDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDocumentTextDetection", params, optFns, addOperationStartDocumentTextDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDocumentTextDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
