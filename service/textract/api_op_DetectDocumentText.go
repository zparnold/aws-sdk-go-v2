...
func (c *Client) DetectDocumentText(ctx context.Context, params *DetectDocumentTextInput, optFns ...func(*Options)) (*DetectDocumentTextOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectDocumentText", params, optFns, addOperationDetectDocumentTextMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectDocumentTextMiddleware(stack *middleware.Stack, options Options) (err error) {
