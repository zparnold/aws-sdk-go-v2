...
func (c *Client) StartDocumentAnalysis(ctx context.Context, params *StartDocumentAnalysisInput, optFns ...func(*Options)) (*StartDocumentAnalysisOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDocumentAnalysis", params, optFns, addOperationStartDocumentAnalysisMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDocumentAnalysisMiddleware(stack *middleware.Stack, options Options) (err error) {
