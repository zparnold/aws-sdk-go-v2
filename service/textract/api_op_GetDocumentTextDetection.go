...
func (c *Client) GetDocumentTextDetection(ctx context.Context, params *GetDocumentTextDetectionInput, optFns ...func(*Options)) (*GetDocumentTextDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocumentTextDetection", params, optFns, addOperationGetDocumentTextDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentTextDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
