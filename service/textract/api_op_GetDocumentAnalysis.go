...
func (c *Client) GetDocumentAnalysis(ctx context.Context, params *GetDocumentAnalysisInput, optFns ...func(*Options)) (*GetDocumentAnalysisOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocumentAnalysis", params, optFns, addOperationGetDocumentAnalysisMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentAnalysisMiddleware(stack *middleware.Stack, options Options) (err error) {
