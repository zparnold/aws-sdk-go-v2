...
func (c *Client) DescribeCertificateAuthority(ctx context.Context, params *DescribeCertificateAuthorityInput, optFns ...func(*Options)) (*DescribeCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCertificateAuthority", params, optFns, addOperationDescribeCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
