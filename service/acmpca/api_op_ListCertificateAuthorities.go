...
func (c *Client) ListCertificateAuthorities(ctx context.Context, params *ListCertificateAuthoritiesInput, optFns ...func(*Options)) (*ListCertificateAuthoritiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCertificateAuthorities", params, optFns, addOperationListCertificateAuthoritiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCertificateAuthoritiesMiddleware(stack *middleware.Stack, options Options) (err error) {
