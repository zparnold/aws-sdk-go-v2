...
func (c *Client) ImportCertificateAuthorityCertificate(ctx context.Context, params *ImportCertificateAuthorityCertificateInput, optFns ...func(*Options)) (*ImportCertificateAuthorityCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportCertificateAuthorityCertificate", params, optFns, addOperationImportCertificateAuthorityCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportCertificateAuthorityCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
