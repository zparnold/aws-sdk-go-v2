...
func (c *Client) CreateCertificateAuthorityAuditReport(ctx context.Context, params *CreateCertificateAuthorityAuditReportInput, optFns ...func(*Options)) (*CreateCertificateAuthorityAuditReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCertificateAuthorityAuditReport", params, optFns, addOperationCreateCertificateAuthorityAuditReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCertificateAuthorityAuditReportMiddleware(stack *middleware.Stack, options Options) (err error) {
