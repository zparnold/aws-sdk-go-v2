...
func (c *Client) CreateCertificateAuthority(ctx context.Context, params *CreateCertificateAuthorityInput, optFns ...func(*Options)) (*CreateCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCertificateAuthority", params, optFns, addOperationCreateCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
