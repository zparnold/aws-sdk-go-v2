...
func (c *Client) GetCertificateAuthorityCertificate(ctx context.Context, params *GetCertificateAuthorityCertificateInput, optFns ...func(*Options)) (*GetCertificateAuthorityCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCertificateAuthorityCertificate", params, optFns, addOperationGetCertificateAuthorityCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCertificateAuthorityCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
