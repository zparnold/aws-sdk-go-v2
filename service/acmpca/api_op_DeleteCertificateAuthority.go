...
func (c *Client) DeleteCertificateAuthority(ctx context.Context, params *DeleteCertificateAuthorityInput, optFns ...func(*Options)) (*DeleteCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCertificateAuthority", params, optFns, addOperationDeleteCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
