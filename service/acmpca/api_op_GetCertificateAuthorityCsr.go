...
func (c *Client) GetCertificateAuthorityCsr(ctx context.Context, params *GetCertificateAuthorityCsrInput, optFns ...func(*Options)) (*GetCertificateAuthorityCsrOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCertificateAuthorityCsr", params, optFns, addOperationGetCertificateAuthorityCsrMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCertificateAuthorityCsrMiddleware(stack *middleware.Stack, options Options) (err error) {
