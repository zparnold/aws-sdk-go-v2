...
func (c *Client) RestoreCertificateAuthority(ctx context.Context, params *RestoreCertificateAuthorityInput, optFns ...func(*Options)) (*RestoreCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreCertificateAuthority", params, optFns, addOperationRestoreCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
