...
func (c *Client) CreatePermission(ctx context.Context, params *CreatePermissionInput, optFns ...func(*Options)) (*CreatePermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePermission", params, optFns, addOperationCreatePermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
