...
func (c *Client) DescribeCertificateAuthorityAuditReport(ctx context.Context, params *DescribeCertificateAuthorityAuditReportInput, optFns ...func(*Options)) (*DescribeCertificateAuthorityAuditReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCertificateAuthorityAuditReport", params, optFns, addOperationDescribeCertificateAuthorityAuditReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCertificateAuthorityAuditReportMiddleware(stack *middleware.Stack, options Options) (err error) {
