...
func (c *Client) RevokeCertificate(ctx context.Context, params *RevokeCertificateInput, optFns ...func(*Options)) (*RevokeCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeCertificate", params, optFns, addOperationRevokeCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
