...
func (c *Client) DeletePermission(ctx context.Context, params *DeletePermissionInput, optFns ...func(*Options)) (*DeletePermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePermission", params, optFns, addOperationDeletePermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
