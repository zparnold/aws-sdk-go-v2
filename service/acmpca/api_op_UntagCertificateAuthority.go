...
func (c *Client) UntagCertificateAuthority(ctx context.Context, params *UntagCertificateAuthorityInput, optFns ...func(*Options)) (*UntagCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagCertificateAuthority", params, optFns, addOperationUntagCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
