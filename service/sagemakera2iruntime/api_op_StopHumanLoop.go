...
func (c *Client) StopHumanLoop(ctx context.Context, params *StopHumanLoopInput, optFns ...func(*Options)) (*StopHumanLoopOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopHumanLoop", params, optFns, addOperationStopHumanLoopMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopHumanLoopMiddleware(stack *middleware.Stack, options Options) (err error) {
