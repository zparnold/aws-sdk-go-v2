...
func (c *Client) StartHumanLoop(ctx context.Context, params *StartHumanLoopInput, optFns ...func(*Options)) (*StartHumanLoopOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartHumanLoop", params, optFns, addOperationStartHumanLoopMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartHumanLoopMiddleware(stack *middleware.Stack, options Options) (err error) {
