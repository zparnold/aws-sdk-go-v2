...
func (c *Client) DescribeHumanLoop(ctx context.Context, params *DescribeHumanLoopInput, optFns ...func(*Options)) (*DescribeHumanLoopOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHumanLoop", params, optFns, addOperationDescribeHumanLoopMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHumanLoopMiddleware(stack *middleware.Stack, options Options) (err error) {
