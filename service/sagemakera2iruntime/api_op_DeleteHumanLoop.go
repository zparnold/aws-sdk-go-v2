...
func (c *Client) DeleteHumanLoop(ctx context.Context, params *DeleteHumanLoopInput, optFns ...func(*Options)) (*DeleteHumanLoopOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHumanLoop", params, optFns, addOperationDeleteHumanLoopMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHumanLoopMiddleware(stack *middleware.Stack, options Options) (err error) {
