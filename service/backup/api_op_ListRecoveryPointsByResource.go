...
func (c *Client) ListRecoveryPointsByResource(ctx context.Context, params *ListRecoveryPointsByResourceInput, optFns ...func(*Options)) (*ListRecoveryPointsByResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRecoveryPointsByResource", params, optFns, addOperationListRecoveryPointsByResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRecoveryPointsByResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
