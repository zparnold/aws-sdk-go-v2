...
func (c *Client) DescribeBackupVault(ctx context.Context, params *DescribeBackupVaultInput, optFns ...func(*Options)) (*DescribeBackupVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBackupVault", params, optFns, addOperationDescribeBackupVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBackupVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
