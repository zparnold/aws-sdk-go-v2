...
func (c *Client) DeleteBackupPlan(ctx context.Context, params *DeleteBackupPlanInput, optFns ...func(*Options)) (*DeleteBackupPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBackupPlan", params, optFns, addOperationDeleteBackupPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBackupPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
