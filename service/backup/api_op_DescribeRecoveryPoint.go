...
func (c *Client) DescribeRecoveryPoint(ctx context.Context, params *DescribeRecoveryPointInput, optFns ...func(*Options)) (*DescribeRecoveryPointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRecoveryPoint", params, optFns, addOperationDescribeRecoveryPointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRecoveryPointMiddleware(stack *middleware.Stack, options Options) (err error) {
