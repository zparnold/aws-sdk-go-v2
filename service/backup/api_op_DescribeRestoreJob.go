...
func (c *Client) DescribeRestoreJob(ctx context.Context, params *DescribeRestoreJobInput, optFns ...func(*Options)) (*DescribeRestoreJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRestoreJob", params, optFns, addOperationDescribeRestoreJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRestoreJobMiddleware(stack *middleware.Stack, options Options) (err error) {
