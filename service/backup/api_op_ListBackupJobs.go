...
func (c *Client) ListBackupJobs(ctx context.Context, params *ListBackupJobsInput, optFns ...func(*Options)) (*ListBackupJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBackupJobs", params, optFns, addOperationListBackupJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBackupJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
