...
func (c *Client) PutBackupVaultAccessPolicy(ctx context.Context, params *PutBackupVaultAccessPolicyInput, optFns ...func(*Options)) (*PutBackupVaultAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBackupVaultAccessPolicy", params, optFns, addOperationPutBackupVaultAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBackupVaultAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
