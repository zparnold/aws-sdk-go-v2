...
func (c *Client) ListProtectedResources(ctx context.Context, params *ListProtectedResourcesInput, optFns ...func(*Options)) (*ListProtectedResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProtectedResources", params, optFns, addOperationListProtectedResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProtectedResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
