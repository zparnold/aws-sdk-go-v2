...
func (c *Client) GetBackupPlan(ctx context.Context, params *GetBackupPlanInput, optFns ...func(*Options)) (*GetBackupPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBackupPlan", params, optFns, addOperationGetBackupPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBackupPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
