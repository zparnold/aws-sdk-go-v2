...
func (c *Client) ExportBackupPlanTemplate(ctx context.Context, params *ExportBackupPlanTemplateInput, optFns ...func(*Options)) (*ExportBackupPlanTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportBackupPlanTemplate", params, optFns, addOperationExportBackupPlanTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportBackupPlanTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
