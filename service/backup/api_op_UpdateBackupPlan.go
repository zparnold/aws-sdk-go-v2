...
func (c *Client) UpdateBackupPlan(ctx context.Context, params *UpdateBackupPlanInput, optFns ...func(*Options)) (*UpdateBackupPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBackupPlan", params, optFns, addOperationUpdateBackupPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBackupPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
