...
func (c *Client) ListRestoreJobs(ctx context.Context, params *ListRestoreJobsInput, optFns ...func(*Options)) (*ListRestoreJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRestoreJobs", params, optFns, addOperationListRestoreJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRestoreJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
