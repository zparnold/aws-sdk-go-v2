...
func (c *Client) GetSupportedResourceTypes(ctx context.Context, params *GetSupportedResourceTypesInput, optFns ...func(*Options)) (*GetSupportedResourceTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSupportedResourceTypes", params, optFns, addOperationGetSupportedResourceTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSupportedResourceTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
