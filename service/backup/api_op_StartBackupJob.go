...
func (c *Client) StartBackupJob(ctx context.Context, params *StartBackupJobInput, optFns ...func(*Options)) (*StartBackupJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartBackupJob", params, optFns, addOperationStartBackupJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartBackupJobMiddleware(stack *middleware.Stack, options Options) (err error) {
