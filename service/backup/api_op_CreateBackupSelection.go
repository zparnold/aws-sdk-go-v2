...
func (c *Client) CreateBackupSelection(ctx context.Context, params *CreateBackupSelectionInput, optFns ...func(*Options)) (*CreateBackupSelectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBackupSelection", params, optFns, addOperationCreateBackupSelectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBackupSelectionMiddleware(stack *middleware.Stack, options Options) (err error) {
