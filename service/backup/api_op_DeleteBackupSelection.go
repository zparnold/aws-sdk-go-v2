...
func (c *Client) DeleteBackupSelection(ctx context.Context, params *DeleteBackupSelectionInput, optFns ...func(*Options)) (*DeleteBackupSelectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBackupSelection", params, optFns, addOperationDeleteBackupSelectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBackupSelectionMiddleware(stack *middleware.Stack, options Options) (err error) {
