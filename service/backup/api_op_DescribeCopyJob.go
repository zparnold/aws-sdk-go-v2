...
func (c *Client) DescribeCopyJob(ctx context.Context, params *DescribeCopyJobInput, optFns ...func(*Options)) (*DescribeCopyJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCopyJob", params, optFns, addOperationDescribeCopyJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCopyJobMiddleware(stack *middleware.Stack, options Options) (err error) {
