...
func (c *Client) GetRecoveryPointRestoreMetadata(ctx context.Context, params *GetRecoveryPointRestoreMetadataInput, optFns ...func(*Options)) (*GetRecoveryPointRestoreMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRecoveryPointRestoreMetadata", params, optFns, addOperationGetRecoveryPointRestoreMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRecoveryPointRestoreMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
