...
func (c *Client) PutBackupVaultNotifications(ctx context.Context, params *PutBackupVaultNotificationsInput, optFns ...func(*Options)) (*PutBackupVaultNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBackupVaultNotifications", params, optFns, addOperationPutBackupVaultNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBackupVaultNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
