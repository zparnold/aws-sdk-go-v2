...
func (c *Client) DescribeBackupJob(ctx context.Context, params *DescribeBackupJobInput, optFns ...func(*Options)) (*DescribeBackupJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBackupJob", params, optFns, addOperationDescribeBackupJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBackupJobMiddleware(stack *middleware.Stack, options Options) (err error) {
