...
func (c *Client) DeleteRecoveryPoint(ctx context.Context, params *DeleteRecoveryPointInput, optFns ...func(*Options)) (*DeleteRecoveryPointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRecoveryPoint", params, optFns, addOperationDeleteRecoveryPointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRecoveryPointMiddleware(stack *middleware.Stack, options Options) (err error) {
