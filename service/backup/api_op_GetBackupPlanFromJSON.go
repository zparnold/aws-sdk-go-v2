...
func (c *Client) GetBackupPlanFromJSON(ctx context.Context, params *GetBackupPlanFromJSONInput, optFns ...func(*Options)) (*GetBackupPlanFromJSONOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBackupPlanFromJSON", params, optFns, addOperationGetBackupPlanFromJSONMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBackupPlanFromJSONMiddleware(stack *middleware.Stack, options Options) (err error) {
