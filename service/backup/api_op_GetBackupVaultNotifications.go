...
func (c *Client) GetBackupVaultNotifications(ctx context.Context, params *GetBackupVaultNotificationsInput, optFns ...func(*Options)) (*GetBackupVaultNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBackupVaultNotifications", params, optFns, addOperationGetBackupVaultNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBackupVaultNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
