...
func (c *Client) DescribeRegionSettings(ctx context.Context, params *DescribeRegionSettingsInput, optFns ...func(*Options)) (*DescribeRegionSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRegionSettings", params, optFns, addOperationDescribeRegionSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRegionSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
