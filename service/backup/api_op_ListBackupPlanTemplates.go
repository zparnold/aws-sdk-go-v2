...
func (c *Client) ListBackupPlanTemplates(ctx context.Context, params *ListBackupPlanTemplatesInput, optFns ...func(*Options)) (*ListBackupPlanTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBackupPlanTemplates", params, optFns, addOperationListBackupPlanTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBackupPlanTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
