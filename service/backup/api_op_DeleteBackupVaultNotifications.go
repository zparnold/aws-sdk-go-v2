...
func (c *Client) DeleteBackupVaultNotifications(ctx context.Context, params *DeleteBackupVaultNotificationsInput, optFns ...func(*Options)) (*DeleteBackupVaultNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBackupVaultNotifications", params, optFns, addOperationDeleteBackupVaultNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBackupVaultNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
