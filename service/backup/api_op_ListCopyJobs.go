...
func (c *Client) ListCopyJobs(ctx context.Context, params *ListCopyJobsInput, optFns ...func(*Options)) (*ListCopyJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCopyJobs", params, optFns, addOperationListCopyJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCopyJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
