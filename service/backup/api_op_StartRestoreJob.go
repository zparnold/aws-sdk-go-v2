...
func (c *Client) StartRestoreJob(ctx context.Context, params *StartRestoreJobInput, optFns ...func(*Options)) (*StartRestoreJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartRestoreJob", params, optFns, addOperationStartRestoreJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartRestoreJobMiddleware(stack *middleware.Stack, options Options) (err error) {
