...
func (c *Client) GetBackupPlanFromTemplate(ctx context.Context, params *GetBackupPlanFromTemplateInput, optFns ...func(*Options)) (*GetBackupPlanFromTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBackupPlanFromTemplate", params, optFns, addOperationGetBackupPlanFromTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBackupPlanFromTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
