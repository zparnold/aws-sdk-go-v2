...
func (c *Client) ListRecoveryPointsByBackupVault(ctx context.Context, params *ListRecoveryPointsByBackupVaultInput, optFns ...func(*Options)) (*ListRecoveryPointsByBackupVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRecoveryPointsByBackupVault", params, optFns, addOperationListRecoveryPointsByBackupVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRecoveryPointsByBackupVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
