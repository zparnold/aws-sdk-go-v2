...
func (c *Client) GetBackupSelection(ctx context.Context, params *GetBackupSelectionInput, optFns ...func(*Options)) (*GetBackupSelectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBackupSelection", params, optFns, addOperationGetBackupSelectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBackupSelectionMiddleware(stack *middleware.Stack, options Options) (err error) {
