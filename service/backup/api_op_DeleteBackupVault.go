...
func (c *Client) DeleteBackupVault(ctx context.Context, params *DeleteBackupVaultInput, optFns ...func(*Options)) (*DeleteBackupVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBackupVault", params, optFns, addOperationDeleteBackupVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBackupVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
