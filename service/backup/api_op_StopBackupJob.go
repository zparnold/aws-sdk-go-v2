...
func (c *Client) StopBackupJob(ctx context.Context, params *StopBackupJobInput, optFns ...func(*Options)) (*StopBackupJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopBackupJob", params, optFns, addOperationStopBackupJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopBackupJobMiddleware(stack *middleware.Stack, options Options) (err error) {
