...
func (c *Client) ListBackupVaults(ctx context.Context, params *ListBackupVaultsInput, optFns ...func(*Options)) (*ListBackupVaultsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBackupVaults", params, optFns, addOperationListBackupVaultsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBackupVaultsMiddleware(stack *middleware.Stack, options Options) (err error) {
