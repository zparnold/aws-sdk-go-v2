...
func (c *Client) ListBackupPlans(ctx context.Context, params *ListBackupPlansInput, optFns ...func(*Options)) (*ListBackupPlansOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBackupPlans", params, optFns, addOperationListBackupPlansMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBackupPlansMiddleware(stack *middleware.Stack, options Options) (err error) {
