...
func (c *Client) CreateBackupPlan(ctx context.Context, params *CreateBackupPlanInput, optFns ...func(*Options)) (*CreateBackupPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBackupPlan", params, optFns, addOperationCreateBackupPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBackupPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
