...
func (c *Client) StartCopyJob(ctx context.Context, params *StartCopyJobInput, optFns ...func(*Options)) (*StartCopyJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartCopyJob", params, optFns, addOperationStartCopyJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartCopyJobMiddleware(stack *middleware.Stack, options Options) (err error) {
