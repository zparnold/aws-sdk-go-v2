...
func (c *Client) DeleteBackupVaultAccessPolicy(ctx context.Context, params *DeleteBackupVaultAccessPolicyInput, optFns ...func(*Options)) (*DeleteBackupVaultAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBackupVaultAccessPolicy", params, optFns, addOperationDeleteBackupVaultAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBackupVaultAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
