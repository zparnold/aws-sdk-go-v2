...
func (c *Client) UpdateRecoveryPointLifecycle(ctx context.Context, params *UpdateRecoveryPointLifecycleInput, optFns ...func(*Options)) (*UpdateRecoveryPointLifecycleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRecoveryPointLifecycle", params, optFns, addOperationUpdateRecoveryPointLifecycleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRecoveryPointLifecycleMiddleware(stack *middleware.Stack, options Options) (err error) {
