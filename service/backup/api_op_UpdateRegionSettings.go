...
func (c *Client) UpdateRegionSettings(ctx context.Context, params *UpdateRegionSettingsInput, optFns ...func(*Options)) (*UpdateRegionSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRegionSettings", params, optFns, addOperationUpdateRegionSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRegionSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
