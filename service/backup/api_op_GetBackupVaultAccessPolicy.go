...
func (c *Client) GetBackupVaultAccessPolicy(ctx context.Context, params *GetBackupVaultAccessPolicyInput, optFns ...func(*Options)) (*GetBackupVaultAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBackupVaultAccessPolicy", params, optFns, addOperationGetBackupVaultAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBackupVaultAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
