...
func (c *Client) DescribeServers(ctx context.Context, params *DescribeServersInput, optFns ...func(*Options)) (*DescribeServersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeServers", params, optFns, addOperationDescribeServersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeServersMiddleware(stack *middleware.Stack, options Options) (err error) {
