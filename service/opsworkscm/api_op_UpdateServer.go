...
func (c *Client) UpdateServer(ctx context.Context, params *UpdateServerInput, optFns ...func(*Options)) (*UpdateServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServer", params, optFns, addOperationUpdateServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServerMiddleware(stack *middleware.Stack, options Options) (err error) {
