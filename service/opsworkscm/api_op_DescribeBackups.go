...
func (c *Client) DescribeBackups(ctx context.Context, params *DescribeBackupsInput, optFns ...func(*Options)) (*DescribeBackupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBackups", params, optFns, addOperationDescribeBackupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBackupsMiddleware(stack *middleware.Stack, options Options) (err error) {
