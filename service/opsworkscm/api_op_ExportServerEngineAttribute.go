...
func (c *Client) ExportServerEngineAttribute(ctx context.Context, params *ExportServerEngineAttributeInput, optFns ...func(*Options)) (*ExportServerEngineAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportServerEngineAttribute", params, optFns, addOperationExportServerEngineAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportServerEngineAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
