...
func (c *Client) UpdateServerEngineAttributes(ctx context.Context, params *UpdateServerEngineAttributesInput, optFns ...func(*Options)) (*UpdateServerEngineAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServerEngineAttributes", params, optFns, addOperationUpdateServerEngineAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServerEngineAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
