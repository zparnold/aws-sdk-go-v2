...
func (c *Client) RestoreServer(ctx context.Context, params *RestoreServerInput, optFns ...func(*Options)) (*RestoreServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreServer", params, optFns, addOperationRestoreServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreServerMiddleware(stack *middleware.Stack, options Options) (err error) {
