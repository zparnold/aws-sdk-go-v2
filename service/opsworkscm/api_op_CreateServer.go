...
func (c *Client) CreateServer(ctx context.Context, params *CreateServerInput, optFns ...func(*Options)) (*CreateServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateServer", params, optFns, addOperationCreateServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateServerMiddleware(stack *middleware.Stack, options Options) (err error) {
