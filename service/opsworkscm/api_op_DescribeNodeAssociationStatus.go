...
func (c *Client) DescribeNodeAssociationStatus(ctx context.Context, params *DescribeNodeAssociationStatusInput, optFns ...func(*Options)) (*DescribeNodeAssociationStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNodeAssociationStatus", params, optFns, addOperationDescribeNodeAssociationStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNodeAssociationStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
