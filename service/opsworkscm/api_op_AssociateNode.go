...
func (c *Client) AssociateNode(ctx context.Context, params *AssociateNodeInput, optFns ...func(*Options)) (*AssociateNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateNode", params, optFns, addOperationAssociateNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
