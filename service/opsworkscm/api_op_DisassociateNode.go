...
func (c *Client) DisassociateNode(ctx context.Context, params *DisassociateNodeInput, optFns ...func(*Options)) (*DisassociateNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateNode", params, optFns, addOperationDisassociateNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
