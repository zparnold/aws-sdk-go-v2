...
func (c *Client) SendCommand(ctx context.Context, params *SendCommandInput, optFns ...func(*Options)) (*SendCommandOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendCommand", params, optFns, addOperationSendCommandMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendCommandMiddleware(stack *middleware.Stack, options Options) (err error) {
