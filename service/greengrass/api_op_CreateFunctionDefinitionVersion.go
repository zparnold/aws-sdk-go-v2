...
func (c *Client) CreateFunctionDefinitionVersion(ctx context.Context, params *CreateFunctionDefinitionVersionInput, optFns ...func(*Options)) (*CreateFunctionDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFunctionDefinitionVersion", params, optFns, addOperationCreateFunctionDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFunctionDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
