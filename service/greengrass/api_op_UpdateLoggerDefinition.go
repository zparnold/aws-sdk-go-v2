...
func (c *Client) UpdateLoggerDefinition(ctx context.Context, params *UpdateLoggerDefinitionInput, optFns ...func(*Options)) (*UpdateLoggerDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLoggerDefinition", params, optFns, addOperationUpdateLoggerDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLoggerDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
