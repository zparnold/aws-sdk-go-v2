...
func (c *Client) UpdateFunctionDefinition(ctx context.Context, params *UpdateFunctionDefinitionInput, optFns ...func(*Options)) (*UpdateFunctionDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFunctionDefinition", params, optFns, addOperationUpdateFunctionDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFunctionDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
