...
func (c *Client) DeleteResourceDefinition(ctx context.Context, params *DeleteResourceDefinitionInput, optFns ...func(*Options)) (*DeleteResourceDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResourceDefinition", params, optFns, addOperationDeleteResourceDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResourceDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
