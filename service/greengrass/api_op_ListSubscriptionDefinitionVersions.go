...
func (c *Client) ListSubscriptionDefinitionVersions(ctx context.Context, params *ListSubscriptionDefinitionVersionsInput, optFns ...func(*Options)) (*ListSubscriptionDefinitionVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSubscriptionDefinitionVersions", params, optFns, addOperationListSubscriptionDefinitionVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSubscriptionDefinitionVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
