...
func (c *Client) CreateSubscriptionDefinitionVersion(ctx context.Context, params *CreateSubscriptionDefinitionVersionInput, optFns ...func(*Options)) (*CreateSubscriptionDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSubscriptionDefinitionVersion", params, optFns, addOperationCreateSubscriptionDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSubscriptionDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
