...
func (c *Client) GetResourceDefinitionVersion(ctx context.Context, params *GetResourceDefinitionVersionInput, optFns ...func(*Options)) (*GetResourceDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResourceDefinitionVersion", params, optFns, addOperationGetResourceDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourceDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
