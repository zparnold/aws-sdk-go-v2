...
func (c *Client) GetServiceRoleForAccount(ctx context.Context, params *GetServiceRoleForAccountInput, optFns ...func(*Options)) (*GetServiceRoleForAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServiceRoleForAccount", params, optFns, addOperationGetServiceRoleForAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServiceRoleForAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
