...
func (c *Client) ListResourceDefinitions(ctx context.Context, params *ListResourceDefinitionsInput, optFns ...func(*Options)) (*ListResourceDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceDefinitions", params, optFns, addOperationListResourceDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
