...
func (c *Client) ListFunctionDefinitions(ctx context.Context, params *ListFunctionDefinitionsInput, optFns ...func(*Options)) (*ListFunctionDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFunctionDefinitions", params, optFns, addOperationListFunctionDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFunctionDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
