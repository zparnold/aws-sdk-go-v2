...
func (c *Client) ListLoggerDefinitionVersions(ctx context.Context, params *ListLoggerDefinitionVersionsInput, optFns ...func(*Options)) (*ListLoggerDefinitionVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLoggerDefinitionVersions", params, optFns, addOperationListLoggerDefinitionVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLoggerDefinitionVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
