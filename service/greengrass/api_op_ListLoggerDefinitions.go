...
func (c *Client) ListLoggerDefinitions(ctx context.Context, params *ListLoggerDefinitionsInput, optFns ...func(*Options)) (*ListLoggerDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLoggerDefinitions", params, optFns, addOperationListLoggerDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLoggerDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
