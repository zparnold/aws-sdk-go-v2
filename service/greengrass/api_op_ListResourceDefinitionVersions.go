...
func (c *Client) ListResourceDefinitionVersions(ctx context.Context, params *ListResourceDefinitionVersionsInput, optFns ...func(*Options)) (*ListResourceDefinitionVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceDefinitionVersions", params, optFns, addOperationListResourceDefinitionVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceDefinitionVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
