...
func (c *Client) ListCoreDefinitions(ctx context.Context, params *ListCoreDefinitionsInput, optFns ...func(*Options)) (*ListCoreDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCoreDefinitions", params, optFns, addOperationListCoreDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCoreDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
