...
func (c *Client) ListGroupCertificateAuthorities(ctx context.Context, params *ListGroupCertificateAuthoritiesInput, optFns ...func(*Options)) (*ListGroupCertificateAuthoritiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGroupCertificateAuthorities", params, optFns, addOperationListGroupCertificateAuthoritiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGroupCertificateAuthoritiesMiddleware(stack *middleware.Stack, options Options) (err error) {
