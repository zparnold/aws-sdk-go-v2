...
func (c *Client) CreateLoggerDefinitionVersion(ctx context.Context, params *CreateLoggerDefinitionVersionInput, optFns ...func(*Options)) (*CreateLoggerDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLoggerDefinitionVersion", params, optFns, addOperationCreateLoggerDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLoggerDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
