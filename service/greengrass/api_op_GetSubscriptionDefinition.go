...
func (c *Client) GetSubscriptionDefinition(ctx context.Context, params *GetSubscriptionDefinitionInput, optFns ...func(*Options)) (*GetSubscriptionDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSubscriptionDefinition", params, optFns, addOperationGetSubscriptionDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSubscriptionDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
