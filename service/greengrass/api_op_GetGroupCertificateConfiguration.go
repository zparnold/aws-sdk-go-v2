...
func (c *Client) GetGroupCertificateConfiguration(ctx context.Context, params *GetGroupCertificateConfigurationInput, optFns ...func(*Options)) (*GetGroupCertificateConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroupCertificateConfiguration", params, optFns, addOperationGetGroupCertificateConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupCertificateConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
