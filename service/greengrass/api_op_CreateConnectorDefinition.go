...
func (c *Client) CreateConnectorDefinition(ctx context.Context, params *CreateConnectorDefinitionInput, optFns ...func(*Options)) (*CreateConnectorDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConnectorDefinition", params, optFns, addOperationCreateConnectorDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConnectorDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
