...
func (c *Client) CreateConnectorDefinitionVersion(ctx context.Context, params *CreateConnectorDefinitionVersionInput, optFns ...func(*Options)) (*CreateConnectorDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConnectorDefinitionVersion", params, optFns, addOperationCreateConnectorDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConnectorDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
