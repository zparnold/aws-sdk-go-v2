...
func (c *Client) ListConnectorDefinitionVersions(ctx context.Context, params *ListConnectorDefinitionVersionsInput, optFns ...func(*Options)) (*ListConnectorDefinitionVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConnectorDefinitionVersions", params, optFns, addOperationListConnectorDefinitionVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConnectorDefinitionVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
