...
func (c *Client) ListDeviceDefinitionVersions(ctx context.Context, params *ListDeviceDefinitionVersionsInput, optFns ...func(*Options)) (*ListDeviceDefinitionVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeviceDefinitionVersions", params, optFns, addOperationListDeviceDefinitionVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeviceDefinitionVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
