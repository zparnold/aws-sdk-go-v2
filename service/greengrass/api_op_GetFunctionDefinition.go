...
func (c *Client) GetFunctionDefinition(ctx context.Context, params *GetFunctionDefinitionInput, optFns ...func(*Options)) (*GetFunctionDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFunctionDefinition", params, optFns, addOperationGetFunctionDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFunctionDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
