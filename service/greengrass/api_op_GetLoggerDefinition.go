...
func (c *Client) GetLoggerDefinition(ctx context.Context, params *GetLoggerDefinitionInput, optFns ...func(*Options)) (*GetLoggerDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoggerDefinition", params, optFns, addOperationGetLoggerDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoggerDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
