...
func (c *Client) CreateCoreDefinitionVersion(ctx context.Context, params *CreateCoreDefinitionVersionInput, optFns ...func(*Options)) (*CreateCoreDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCoreDefinitionVersion", params, optFns, addOperationCreateCoreDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCoreDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
