...
func (c *Client) GetConnectivityInfo(ctx context.Context, params *GetConnectivityInfoInput, optFns ...func(*Options)) (*GetConnectivityInfoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConnectivityInfo", params, optFns, addOperationGetConnectivityInfoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConnectivityInfoMiddleware(stack *middleware.Stack, options Options) (err error) {
