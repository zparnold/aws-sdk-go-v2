...
func (c *Client) DeleteLoggerDefinition(ctx context.Context, params *DeleteLoggerDefinitionInput, optFns ...func(*Options)) (*DeleteLoggerDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLoggerDefinition", params, optFns, addOperationDeleteLoggerDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLoggerDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
