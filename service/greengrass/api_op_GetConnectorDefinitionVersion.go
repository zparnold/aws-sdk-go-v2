...
func (c *Client) GetConnectorDefinitionVersion(ctx context.Context, params *GetConnectorDefinitionVersionInput, optFns ...func(*Options)) (*GetConnectorDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConnectorDefinitionVersion", params, optFns, addOperationGetConnectorDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConnectorDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
