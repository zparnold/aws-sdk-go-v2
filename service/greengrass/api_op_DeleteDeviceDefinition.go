...
func (c *Client) DeleteDeviceDefinition(ctx context.Context, params *DeleteDeviceDefinitionInput, optFns ...func(*Options)) (*DeleteDeviceDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeviceDefinition", params, optFns, addOperationDeleteDeviceDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeviceDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
