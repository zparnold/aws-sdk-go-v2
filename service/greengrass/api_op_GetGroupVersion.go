...
func (c *Client) GetGroupVersion(ctx context.Context, params *GetGroupVersionInput, optFns ...func(*Options)) (*GetGroupVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroupVersion", params, optFns, addOperationGetGroupVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
