...
func (c *Client) DeleteConnectorDefinition(ctx context.Context, params *DeleteConnectorDefinitionInput, optFns ...func(*Options)) (*DeleteConnectorDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConnectorDefinition", params, optFns, addOperationDeleteConnectorDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConnectorDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
