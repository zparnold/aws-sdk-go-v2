...
func (c *Client) GetDeploymentStatus(ctx context.Context, params *GetDeploymentStatusInput, optFns ...func(*Options)) (*GetDeploymentStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeploymentStatus", params, optFns, addOperationGetDeploymentStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeploymentStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
