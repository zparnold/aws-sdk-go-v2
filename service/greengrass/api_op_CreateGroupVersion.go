...
func (c *Client) CreateGroupVersion(ctx context.Context, params *CreateGroupVersionInput, optFns ...func(*Options)) (*CreateGroupVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGroupVersion", params, optFns, addOperationCreateGroupVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGroupVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
