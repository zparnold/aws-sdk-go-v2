...
func (c *Client) GetFunctionDefinitionVersion(ctx context.Context, params *GetFunctionDefinitionVersionInput, optFns ...func(*Options)) (*GetFunctionDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFunctionDefinitionVersion", params, optFns, addOperationGetFunctionDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFunctionDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
