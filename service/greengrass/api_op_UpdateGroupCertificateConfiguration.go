...
func (c *Client) UpdateGroupCertificateConfiguration(ctx context.Context, params *UpdateGroupCertificateConfigurationInput, optFns ...func(*Options)) (*UpdateGroupCertificateConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGroupCertificateConfiguration", params, optFns, addOperationUpdateGroupCertificateConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGroupCertificateConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
