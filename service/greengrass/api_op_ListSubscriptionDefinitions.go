...
func (c *Client) ListSubscriptionDefinitions(ctx context.Context, params *ListSubscriptionDefinitionsInput, optFns ...func(*Options)) (*ListSubscriptionDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSubscriptionDefinitions", params, optFns, addOperationListSubscriptionDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSubscriptionDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
