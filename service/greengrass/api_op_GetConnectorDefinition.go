...
func (c *Client) GetConnectorDefinition(ctx context.Context, params *GetConnectorDefinitionInput, optFns ...func(*Options)) (*GetConnectorDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConnectorDefinition", params, optFns, addOperationGetConnectorDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConnectorDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
