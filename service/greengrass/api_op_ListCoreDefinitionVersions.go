...
func (c *Client) ListCoreDefinitionVersions(ctx context.Context, params *ListCoreDefinitionVersionsInput, optFns ...func(*Options)) (*ListCoreDefinitionVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCoreDefinitionVersions", params, optFns, addOperationListCoreDefinitionVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCoreDefinitionVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
