...
func (c *Client) CreateFunctionDefinition(ctx context.Context, params *CreateFunctionDefinitionInput, optFns ...func(*Options)) (*CreateFunctionDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFunctionDefinition", params, optFns, addOperationCreateFunctionDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFunctionDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
