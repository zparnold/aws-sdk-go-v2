...
func (c *Client) GetSubscriptionDefinitionVersion(ctx context.Context, params *GetSubscriptionDefinitionVersionInput, optFns ...func(*Options)) (*GetSubscriptionDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSubscriptionDefinitionVersion", params, optFns, addOperationGetSubscriptionDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSubscriptionDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
