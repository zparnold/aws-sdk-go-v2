...
func (c *Client) GetCoreDefinition(ctx context.Context, params *GetCoreDefinitionInput, optFns ...func(*Options)) (*GetCoreDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCoreDefinition", params, optFns, addOperationGetCoreDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCoreDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
