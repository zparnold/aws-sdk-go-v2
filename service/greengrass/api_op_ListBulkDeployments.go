...
func (c *Client) ListBulkDeployments(ctx context.Context, params *ListBulkDeploymentsInput, optFns ...func(*Options)) (*ListBulkDeploymentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBulkDeployments", params, optFns, addOperationListBulkDeploymentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBulkDeploymentsMiddleware(stack *middleware.Stack, options Options) (err error) {
