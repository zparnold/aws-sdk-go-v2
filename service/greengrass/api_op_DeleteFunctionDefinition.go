...
func (c *Client) DeleteFunctionDefinition(ctx context.Context, params *DeleteFunctionDefinitionInput, optFns ...func(*Options)) (*DeleteFunctionDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFunctionDefinition", params, optFns, addOperationDeleteFunctionDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFunctionDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
