...
func (c *Client) DeleteCoreDefinition(ctx context.Context, params *DeleteCoreDefinitionInput, optFns ...func(*Options)) (*DeleteCoreDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCoreDefinition", params, optFns, addOperationDeleteCoreDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCoreDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
