...
func (c *Client) CreateResourceDefinitionVersion(ctx context.Context, params *CreateResourceDefinitionVersionInput, optFns ...func(*Options)) (*CreateResourceDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResourceDefinitionVersion", params, optFns, addOperationCreateResourceDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResourceDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
