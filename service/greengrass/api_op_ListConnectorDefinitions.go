...
func (c *Client) ListConnectorDefinitions(ctx context.Context, params *ListConnectorDefinitionsInput, optFns ...func(*Options)) (*ListConnectorDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConnectorDefinitions", params, optFns, addOperationListConnectorDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConnectorDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
