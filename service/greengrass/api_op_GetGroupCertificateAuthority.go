...
func (c *Client) GetGroupCertificateAuthority(ctx context.Context, params *GetGroupCertificateAuthorityInput, optFns ...func(*Options)) (*GetGroupCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroupCertificateAuthority", params, optFns, addOperationGetGroupCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
