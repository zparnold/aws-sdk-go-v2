...
func (c *Client) AssociateServiceRoleToAccount(ctx context.Context, params *AssociateServiceRoleToAccountInput, optFns ...func(*Options)) (*AssociateServiceRoleToAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateServiceRoleToAccount", params, optFns, addOperationAssociateServiceRoleToAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateServiceRoleToAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
