...
func (c *Client) DeleteGroup(ctx context.Context, params *DeleteGroupInput, optFns ...func(*Options)) (*DeleteGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGroup", params, optFns, addOperationDeleteGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
