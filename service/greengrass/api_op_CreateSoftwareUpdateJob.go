...
func (c *Client) CreateSoftwareUpdateJob(ctx context.Context, params *CreateSoftwareUpdateJobInput, optFns ...func(*Options)) (*CreateSoftwareUpdateJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSoftwareUpdateJob", params, optFns, addOperationCreateSoftwareUpdateJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSoftwareUpdateJobMiddleware(stack *middleware.Stack, options Options) (err error) {
