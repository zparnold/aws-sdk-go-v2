...
func (c *Client) GetDeviceDefinitionVersion(ctx context.Context, params *GetDeviceDefinitionVersionInput, optFns ...func(*Options)) (*GetDeviceDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeviceDefinitionVersion", params, optFns, addOperationGetDeviceDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeviceDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
