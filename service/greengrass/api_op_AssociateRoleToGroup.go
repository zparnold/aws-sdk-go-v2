...
func (c *Client) AssociateRoleToGroup(ctx context.Context, params *AssociateRoleToGroupInput, optFns ...func(*Options)) (*AssociateRoleToGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateRoleToGroup", params, optFns, addOperationAssociateRoleToGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateRoleToGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
