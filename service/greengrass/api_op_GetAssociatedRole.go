...
func (c *Client) GetAssociatedRole(ctx context.Context, params *GetAssociatedRoleInput, optFns ...func(*Options)) (*GetAssociatedRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssociatedRole", params, optFns, addOperationGetAssociatedRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssociatedRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
