...
func (c *Client) StartBulkDeployment(ctx context.Context, params *StartBulkDeploymentInput, optFns ...func(*Options)) (*StartBulkDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartBulkDeployment", params, optFns, addOperationStartBulkDeploymentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartBulkDeploymentMiddleware(stack *middleware.Stack, options Options) (err error) {
