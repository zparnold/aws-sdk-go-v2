...
func (c *Client) StopBulkDeployment(ctx context.Context, params *StopBulkDeploymentInput, optFns ...func(*Options)) (*StopBulkDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopBulkDeployment", params, optFns, addOperationStopBulkDeploymentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopBulkDeploymentMiddleware(stack *middleware.Stack, options Options) (err error) {
