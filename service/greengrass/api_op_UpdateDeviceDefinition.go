...
func (c *Client) UpdateDeviceDefinition(ctx context.Context, params *UpdateDeviceDefinitionInput, optFns ...func(*Options)) (*UpdateDeviceDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDeviceDefinition", params, optFns, addOperationUpdateDeviceDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDeviceDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
