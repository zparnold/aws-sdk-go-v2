...
func (c *Client) DisassociateRoleFromGroup(ctx context.Context, params *DisassociateRoleFromGroupInput, optFns ...func(*Options)) (*DisassociateRoleFromGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateRoleFromGroup", params, optFns, addOperationDisassociateRoleFromGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateRoleFromGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
