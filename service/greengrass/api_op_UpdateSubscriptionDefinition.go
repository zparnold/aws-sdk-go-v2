...
func (c *Client) UpdateSubscriptionDefinition(ctx context.Context, params *UpdateSubscriptionDefinitionInput, optFns ...func(*Options)) (*UpdateSubscriptionDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSubscriptionDefinition", params, optFns, addOperationUpdateSubscriptionDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSubscriptionDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
