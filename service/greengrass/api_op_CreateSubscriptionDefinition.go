...
func (c *Client) CreateSubscriptionDefinition(ctx context.Context, params *CreateSubscriptionDefinitionInput, optFns ...func(*Options)) (*CreateSubscriptionDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSubscriptionDefinition", params, optFns, addOperationCreateSubscriptionDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSubscriptionDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
