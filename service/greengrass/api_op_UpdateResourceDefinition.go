...
func (c *Client) UpdateResourceDefinition(ctx context.Context, params *UpdateResourceDefinitionInput, optFns ...func(*Options)) (*UpdateResourceDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResourceDefinition", params, optFns, addOperationUpdateResourceDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResourceDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
