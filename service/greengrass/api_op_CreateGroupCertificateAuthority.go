...
func (c *Client) CreateGroupCertificateAuthority(ctx context.Context, params *CreateGroupCertificateAuthorityInput, optFns ...func(*Options)) (*CreateGroupCertificateAuthorityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGroupCertificateAuthority", params, optFns, addOperationCreateGroupCertificateAuthorityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGroupCertificateAuthorityMiddleware(stack *middleware.Stack, options Options) (err error) {
