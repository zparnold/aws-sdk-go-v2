...
func (c *Client) GetCoreDefinitionVersion(ctx context.Context, params *GetCoreDefinitionVersionInput, optFns ...func(*Options)) (*GetCoreDefinitionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCoreDefinitionVersion", params, optFns, addOperationGetCoreDefinitionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCoreDefinitionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
