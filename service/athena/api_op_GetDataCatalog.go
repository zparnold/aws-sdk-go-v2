...
func (c *Client) GetDataCatalog(ctx context.Context, params *GetDataCatalogInput, optFns ...func(*Options)) (*GetDataCatalogOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataCatalog", params, optFns, addOperationGetDataCatalogMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataCatalogMiddleware(stack *middleware.Stack, options Options) (err error) {
