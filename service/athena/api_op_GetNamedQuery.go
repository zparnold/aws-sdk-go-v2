...
func (c *Client) GetNamedQuery(ctx context.Context, params *GetNamedQueryInput, optFns ...func(*Options)) (*GetNamedQueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetNamedQuery", params, optFns, addOperationGetNamedQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetNamedQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
