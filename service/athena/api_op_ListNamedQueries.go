...
func (c *Client) ListNamedQueries(ctx context.Context, params *ListNamedQueriesInput, optFns ...func(*Options)) (*ListNamedQueriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNamedQueries", params, optFns, addOperationListNamedQueriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNamedQueriesMiddleware(stack *middleware.Stack, options Options) (err error) {
