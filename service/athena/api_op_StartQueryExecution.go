...
func (c *Client) StartQueryExecution(ctx context.Context, params *StartQueryExecutionInput, optFns ...func(*Options)) (*StartQueryExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartQueryExecution", params, optFns, addOperationStartQueryExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartQueryExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
