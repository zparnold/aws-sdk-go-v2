...
func (c *Client) GetTableMetadata(ctx context.Context, params *GetTableMetadataInput, optFns ...func(*Options)) (*GetTableMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTableMetadata", params, optFns, addOperationGetTableMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTableMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
