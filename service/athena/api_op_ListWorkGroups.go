...
func (c *Client) ListWorkGroups(ctx context.Context, params *ListWorkGroupsInput, optFns ...func(*Options)) (*ListWorkGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWorkGroups", params, optFns, addOperationListWorkGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWorkGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
