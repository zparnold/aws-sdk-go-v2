...
func (c *Client) GetWorkGroup(ctx context.Context, params *GetWorkGroupInput, optFns ...func(*Options)) (*GetWorkGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWorkGroup", params, optFns, addOperationGetWorkGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWorkGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
