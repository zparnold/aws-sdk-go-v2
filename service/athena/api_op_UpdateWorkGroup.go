...
func (c *Client) UpdateWorkGroup(ctx context.Context, params *UpdateWorkGroupInput, optFns ...func(*Options)) (*UpdateWorkGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateWorkGroup", params, optFns, addOperationUpdateWorkGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateWorkGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
