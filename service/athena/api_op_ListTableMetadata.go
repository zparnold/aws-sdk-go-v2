...
func (c *Client) ListTableMetadata(ctx context.Context, params *ListTableMetadataInput, optFns ...func(*Options)) (*ListTableMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTableMetadata", params, optFns, addOperationListTableMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTableMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
