...
func (c *Client) ListDatabases(ctx context.Context, params *ListDatabasesInput, optFns ...func(*Options)) (*ListDatabasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDatabases", params, optFns, addOperationListDatabasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDatabasesMiddleware(stack *middleware.Stack, options Options) (err error) {
