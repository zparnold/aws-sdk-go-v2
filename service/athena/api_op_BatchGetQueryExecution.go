...
func (c *Client) BatchGetQueryExecution(ctx context.Context, params *BatchGetQueryExecutionInput, optFns ...func(*Options)) (*BatchGetQueryExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetQueryExecution", params, optFns, addOperationBatchGetQueryExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetQueryExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
