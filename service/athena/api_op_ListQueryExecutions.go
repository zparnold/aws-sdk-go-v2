...
func (c *Client) ListQueryExecutions(ctx context.Context, params *ListQueryExecutionsInput, optFns ...func(*Options)) (*ListQueryExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListQueryExecutions", params, optFns, addOperationListQueryExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListQueryExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
