...
func (c *Client) ListDataCatalogs(ctx context.Context, params *ListDataCatalogsInput, optFns ...func(*Options)) (*ListDataCatalogsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDataCatalogs", params, optFns, addOperationListDataCatalogsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDataCatalogsMiddleware(stack *middleware.Stack, options Options) (err error) {
