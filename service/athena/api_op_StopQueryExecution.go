...
func (c *Client) StopQueryExecution(ctx context.Context, params *StopQueryExecutionInput, optFns ...func(*Options)) (*StopQueryExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopQueryExecution", params, optFns, addOperationStopQueryExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopQueryExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
