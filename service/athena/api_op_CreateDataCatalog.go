...
func (c *Client) CreateDataCatalog(ctx context.Context, params *CreateDataCatalogInput, optFns ...func(*Options)) (*CreateDataCatalogOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDataCatalog", params, optFns, addOperationCreateDataCatalogMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDataCatalogMiddleware(stack *middleware.Stack, options Options) (err error) {
