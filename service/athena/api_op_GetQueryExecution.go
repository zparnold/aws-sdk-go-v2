...
func (c *Client) GetQueryExecution(ctx context.Context, params *GetQueryExecutionInput, optFns ...func(*Options)) (*GetQueryExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQueryExecution", params, optFns, addOperationGetQueryExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQueryExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
