...
func (c *Client) DeleteWorkGroup(ctx context.Context, params *DeleteWorkGroupInput, optFns ...func(*Options)) (*DeleteWorkGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWorkGroup", params, optFns, addOperationDeleteWorkGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWorkGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
