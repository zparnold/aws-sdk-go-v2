...
func (c *Client) DeleteNamedQuery(ctx context.Context, params *DeleteNamedQueryInput, optFns ...func(*Options)) (*DeleteNamedQueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNamedQuery", params, optFns, addOperationDeleteNamedQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNamedQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
