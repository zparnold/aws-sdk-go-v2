...
func (c *Client) DeleteDataCatalog(ctx context.Context, params *DeleteDataCatalogInput, optFns ...func(*Options)) (*DeleteDataCatalogOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDataCatalog", params, optFns, addOperationDeleteDataCatalogMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDataCatalogMiddleware(stack *middleware.Stack, options Options) (err error) {
