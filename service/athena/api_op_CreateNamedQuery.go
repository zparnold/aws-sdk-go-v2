...
func (c *Client) CreateNamedQuery(ctx context.Context, params *CreateNamedQueryInput, optFns ...func(*Options)) (*CreateNamedQueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNamedQuery", params, optFns, addOperationCreateNamedQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNamedQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
