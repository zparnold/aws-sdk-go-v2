...
func (c *Client) BatchGetNamedQuery(ctx context.Context, params *BatchGetNamedQueryInput, optFns ...func(*Options)) (*BatchGetNamedQueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetNamedQuery", params, optFns, addOperationBatchGetNamedQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetNamedQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
