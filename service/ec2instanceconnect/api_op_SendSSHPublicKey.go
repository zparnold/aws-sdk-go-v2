...
func (c *Client) SendSSHPublicKey(ctx context.Context, params *SendSSHPublicKeyInput, optFns ...func(*Options)) (*SendSSHPublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendSSHPublicKey", params, optFns, addOperationSendSSHPublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendSSHPublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
