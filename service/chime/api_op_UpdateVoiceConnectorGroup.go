...
func (c *Client) UpdateVoiceConnectorGroup(ctx context.Context, params *UpdateVoiceConnectorGroupInput, optFns ...func(*Options)) (*UpdateVoiceConnectorGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVoiceConnectorGroup", params, optFns, addOperationUpdateVoiceConnectorGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVoiceConnectorGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
