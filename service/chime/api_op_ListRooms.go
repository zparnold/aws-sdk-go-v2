...
func (c *Client) ListRooms(ctx context.Context, params *ListRoomsInput, optFns ...func(*Options)) (*ListRoomsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRooms", params, optFns, addOperationListRoomsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRoomsMiddleware(stack *middleware.Stack, options Options) (err error) {
