...
func (c *Client) GetUserSettings(ctx context.Context, params *GetUserSettingsInput, optFns ...func(*Options)) (*GetUserSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUserSettings", params, optFns, addOperationGetUserSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
