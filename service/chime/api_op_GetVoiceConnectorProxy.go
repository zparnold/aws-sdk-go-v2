...
func (c *Client) GetVoiceConnectorProxy(ctx context.Context, params *GetVoiceConnectorProxyInput, optFns ...func(*Options)) (*GetVoiceConnectorProxyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceConnectorProxy", params, optFns, addOperationGetVoiceConnectorProxyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceConnectorProxyMiddleware(stack *middleware.Stack, options Options) (err error) {
