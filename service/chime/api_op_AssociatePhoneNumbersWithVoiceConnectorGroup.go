...
func (c *Client) AssociatePhoneNumbersWithVoiceConnectorGroup(ctx context.Context, params *AssociatePhoneNumbersWithVoiceConnectorGroupInput, optFns ...func(*Options)) (*AssociatePhoneNumbersWithVoiceConnectorGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociatePhoneNumbersWithVoiceConnectorGroup", params, optFns, addOperationAssociatePhoneNumbersWithVoiceConnectorGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociatePhoneNumbersWithVoiceConnectorGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
