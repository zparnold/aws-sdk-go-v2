...
func (c *Client) ListVoiceConnectorTerminationCredentials(ctx context.Context, params *ListVoiceConnectorTerminationCredentialsInput, optFns ...func(*Options)) (*ListVoiceConnectorTerminationCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVoiceConnectorTerminationCredentials", params, optFns, addOperationListVoiceConnectorTerminationCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVoiceConnectorTerminationCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
