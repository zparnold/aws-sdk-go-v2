...
func (c *Client) BatchSuspendUser(ctx context.Context, params *BatchSuspendUserInput, optFns ...func(*Options)) (*BatchSuspendUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchSuspendUser", params, optFns, addOperationBatchSuspendUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchSuspendUserMiddleware(stack *middleware.Stack, options Options) (err error) {
