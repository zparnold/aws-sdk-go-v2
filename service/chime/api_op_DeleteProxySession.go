...
func (c *Client) DeleteProxySession(ctx context.Context, params *DeleteProxySessionInput, optFns ...func(*Options)) (*DeleteProxySessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProxySession", params, optFns, addOperationDeleteProxySessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProxySessionMiddleware(stack *middleware.Stack, options Options) (err error) {
