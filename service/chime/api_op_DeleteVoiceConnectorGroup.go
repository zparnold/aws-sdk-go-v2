...
func (c *Client) DeleteVoiceConnectorGroup(ctx context.Context, params *DeleteVoiceConnectorGroupInput, optFns ...func(*Options)) (*DeleteVoiceConnectorGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnectorGroup", params, optFns, addOperationDeleteVoiceConnectorGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
