...
func (c *Client) UpdateVoiceConnector(ctx context.Context, params *UpdateVoiceConnectorInput, optFns ...func(*Options)) (*UpdateVoiceConnectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVoiceConnector", params, optFns, addOperationUpdateVoiceConnectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVoiceConnectorMiddleware(stack *middleware.Stack, options Options) (err error) {
