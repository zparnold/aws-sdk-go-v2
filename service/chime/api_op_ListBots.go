...
func (c *Client) ListBots(ctx context.Context, params *ListBotsInput, optFns ...func(*Options)) (*ListBotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBots", params, optFns, addOperationListBotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBotsMiddleware(stack *middleware.Stack, options Options) (err error) {
