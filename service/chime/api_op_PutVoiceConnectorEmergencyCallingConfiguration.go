...
func (c *Client) PutVoiceConnectorEmergencyCallingConfiguration(ctx context.Context, params *PutVoiceConnectorEmergencyCallingConfigurationInput, optFns ...func(*Options)) (*PutVoiceConnectorEmergencyCallingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutVoiceConnectorEmergencyCallingConfiguration", params, optFns, addOperationPutVoiceConnectorEmergencyCallingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutVoiceConnectorEmergencyCallingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
