...
func (c *Client) PutRetentionSettings(ctx context.Context, params *PutRetentionSettingsInput, optFns ...func(*Options)) (*PutRetentionSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRetentionSettings", params, optFns, addOperationPutRetentionSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRetentionSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
