...
func (c *Client) CreateAttendee(ctx context.Context, params *CreateAttendeeInput, optFns ...func(*Options)) (*CreateAttendeeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAttendee", params, optFns, addOperationCreateAttendeeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAttendeeMiddleware(stack *middleware.Stack, options Options) (err error) {
