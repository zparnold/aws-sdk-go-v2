...
func (c *Client) CreateMeetingWithAttendees(ctx context.Context, params *CreateMeetingWithAttendeesInput, optFns ...func(*Options)) (*CreateMeetingWithAttendeesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMeetingWithAttendees", params, optFns, addOperationCreateMeetingWithAttendeesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMeetingWithAttendeesMiddleware(stack *middleware.Stack, options Options) (err error) {
