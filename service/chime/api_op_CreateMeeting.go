...
func (c *Client) CreateMeeting(ctx context.Context, params *CreateMeetingInput, optFns ...func(*Options)) (*CreateMeetingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMeeting", params, optFns, addOperationCreateMeetingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMeetingMiddleware(stack *middleware.Stack, options Options) (err error) {
