...
func (c *Client) BatchDeletePhoneNumber(ctx context.Context, params *BatchDeletePhoneNumberInput, optFns ...func(*Options)) (*BatchDeletePhoneNumberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeletePhoneNumber", params, optFns, addOperationBatchDeletePhoneNumberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeletePhoneNumberMiddleware(stack *middleware.Stack, options Options) (err error) {
