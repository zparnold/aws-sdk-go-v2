...
func (c *Client) AssociatePhoneNumbersWithVoiceConnector(ctx context.Context, params *AssociatePhoneNumbersWithVoiceConnectorInput, optFns ...func(*Options)) (*AssociatePhoneNumbersWithVoiceConnectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociatePhoneNumbersWithVoiceConnector", params, optFns, addOperationAssociatePhoneNumbersWithVoiceConnectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociatePhoneNumbersWithVoiceConnectorMiddleware(stack *middleware.Stack, options Options) (err error) {
