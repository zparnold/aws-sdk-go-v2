...
func (c *Client) UpdateBot(ctx context.Context, params *UpdateBotInput, optFns ...func(*Options)) (*UpdateBotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBot", params, optFns, addOperationUpdateBotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBotMiddleware(stack *middleware.Stack, options Options) (err error) {
