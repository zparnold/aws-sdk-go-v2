...
func (c *Client) RegenerateSecurityToken(ctx context.Context, params *RegenerateSecurityTokenInput, optFns ...func(*Options)) (*RegenerateSecurityTokenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegenerateSecurityToken", params, optFns, addOperationRegenerateSecurityTokenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegenerateSecurityTokenMiddleware(stack *middleware.Stack, options Options) (err error) {
