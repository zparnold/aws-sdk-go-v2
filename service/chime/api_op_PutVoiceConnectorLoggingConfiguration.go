...
func (c *Client) PutVoiceConnectorLoggingConfiguration(ctx context.Context, params *PutVoiceConnectorLoggingConfigurationInput, optFns ...func(*Options)) (*PutVoiceConnectorLoggingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutVoiceConnectorLoggingConfiguration", params, optFns, addOperationPutVoiceConnectorLoggingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutVoiceConnectorLoggingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
