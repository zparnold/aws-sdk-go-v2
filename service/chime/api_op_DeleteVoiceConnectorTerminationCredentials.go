...
func (c *Client) DeleteVoiceConnectorTerminationCredentials(ctx context.Context, params *DeleteVoiceConnectorTerminationCredentialsInput, optFns ...func(*Options)) (*DeleteVoiceConnectorTerminationCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnectorTerminationCredentials", params, optFns, addOperationDeleteVoiceConnectorTerminationCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorTerminationCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
