...
func (c *Client) DeleteVoiceConnectorEmergencyCallingConfiguration(ctx context.Context, params *DeleteVoiceConnectorEmergencyCallingConfigurationInput, optFns ...func(*Options)) (*DeleteVoiceConnectorEmergencyCallingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnectorEmergencyCallingConfiguration", params, optFns, addOperationDeleteVoiceConnectorEmergencyCallingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorEmergencyCallingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
