...
func (c *Client) GetMeeting(ctx context.Context, params *GetMeetingInput, optFns ...func(*Options)) (*GetMeetingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMeeting", params, optFns, addOperationGetMeetingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMeetingMiddleware(stack *middleware.Stack, options Options) (err error) {
