...
func (c *Client) UpdateProxySession(ctx context.Context, params *UpdateProxySessionInput, optFns ...func(*Options)) (*UpdateProxySessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProxySession", params, optFns, addOperationUpdateProxySessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProxySessionMiddleware(stack *middleware.Stack, options Options) (err error) {
