...
func (c *Client) ResetPersonalPIN(ctx context.Context, params *ResetPersonalPINInput, optFns ...func(*Options)) (*ResetPersonalPINOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetPersonalPIN", params, optFns, addOperationResetPersonalPINMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetPersonalPINMiddleware(stack *middleware.Stack, options Options) (err error) {
