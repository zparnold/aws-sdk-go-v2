...
func (c *Client) SearchAvailablePhoneNumbers(ctx context.Context, params *SearchAvailablePhoneNumbersInput, optFns ...func(*Options)) (*SearchAvailablePhoneNumbersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchAvailablePhoneNumbers", params, optFns, addOperationSearchAvailablePhoneNumbersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchAvailablePhoneNumbersMiddleware(stack *middleware.Stack, options Options) (err error) {
