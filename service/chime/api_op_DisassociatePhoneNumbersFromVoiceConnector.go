...
func (c *Client) DisassociatePhoneNumbersFromVoiceConnector(ctx context.Context, params *DisassociatePhoneNumbersFromVoiceConnectorInput, optFns ...func(*Options)) (*DisassociatePhoneNumbersFromVoiceConnectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociatePhoneNumbersFromVoiceConnector", params, optFns, addOperationDisassociatePhoneNumbersFromVoiceConnectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociatePhoneNumbersFromVoiceConnectorMiddleware(stack *middleware.Stack, options Options) (err error) {
