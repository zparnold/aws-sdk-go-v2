...
func (c *Client) CreateBot(ctx context.Context, params *CreateBotInput, optFns ...func(*Options)) (*CreateBotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBot", params, optFns, addOperationCreateBotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBotMiddleware(stack *middleware.Stack, options Options) (err error) {
