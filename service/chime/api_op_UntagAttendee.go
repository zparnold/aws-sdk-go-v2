...
func (c *Client) UntagAttendee(ctx context.Context, params *UntagAttendeeInput, optFns ...func(*Options)) (*UntagAttendeeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagAttendee", params, optFns, addOperationUntagAttendeeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagAttendeeMiddleware(stack *middleware.Stack, options Options) (err error) {
