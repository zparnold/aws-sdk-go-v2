...
func (c *Client) BatchUpdateUser(ctx context.Context, params *BatchUpdateUserInput, optFns ...func(*Options)) (*BatchUpdateUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchUpdateUser", params, optFns, addOperationBatchUpdateUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchUpdateUserMiddleware(stack *middleware.Stack, options Options) (err error) {
