...
func (c *Client) UpdateRoomMembership(ctx context.Context, params *UpdateRoomMembershipInput, optFns ...func(*Options)) (*UpdateRoomMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRoomMembership", params, optFns, addOperationUpdateRoomMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRoomMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
