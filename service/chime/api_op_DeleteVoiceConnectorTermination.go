...
func (c *Client) DeleteVoiceConnectorTermination(ctx context.Context, params *DeleteVoiceConnectorTerminationInput, optFns ...func(*Options)) (*DeleteVoiceConnectorTerminationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnectorTermination", params, optFns, addOperationDeleteVoiceConnectorTerminationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorTerminationMiddleware(stack *middleware.Stack, options Options) (err error) {
