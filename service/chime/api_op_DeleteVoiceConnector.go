...
func (c *Client) DeleteVoiceConnector(ctx context.Context, params *DeleteVoiceConnectorInput, optFns ...func(*Options)) (*DeleteVoiceConnectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnector", params, optFns, addOperationDeleteVoiceConnectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorMiddleware(stack *middleware.Stack, options Options) (err error) {
