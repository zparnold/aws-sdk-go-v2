...
func (c *Client) DeletePhoneNumber(ctx context.Context, params *DeletePhoneNumberInput, optFns ...func(*Options)) (*DeletePhoneNumberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePhoneNumber", params, optFns, addOperationDeletePhoneNumberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePhoneNumberMiddleware(stack *middleware.Stack, options Options) (err error) {
