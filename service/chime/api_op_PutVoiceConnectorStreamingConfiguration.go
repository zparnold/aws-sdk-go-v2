...
func (c *Client) PutVoiceConnectorStreamingConfiguration(ctx context.Context, params *PutVoiceConnectorStreamingConfigurationInput, optFns ...func(*Options)) (*PutVoiceConnectorStreamingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutVoiceConnectorStreamingConfiguration", params, optFns, addOperationPutVoiceConnectorStreamingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutVoiceConnectorStreamingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
