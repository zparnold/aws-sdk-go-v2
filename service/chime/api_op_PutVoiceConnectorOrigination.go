...
func (c *Client) PutVoiceConnectorOrigination(ctx context.Context, params *PutVoiceConnectorOriginationInput, optFns ...func(*Options)) (*PutVoiceConnectorOriginationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutVoiceConnectorOrigination", params, optFns, addOperationPutVoiceConnectorOriginationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutVoiceConnectorOriginationMiddleware(stack *middleware.Stack, options Options) (err error) {
