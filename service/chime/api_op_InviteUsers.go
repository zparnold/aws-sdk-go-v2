...
func (c *Client) InviteUsers(ctx context.Context, params *InviteUsersInput, optFns ...func(*Options)) (*InviteUsersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InviteUsers", params, optFns, addOperationInviteUsersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInviteUsersMiddleware(stack *middleware.Stack, options Options) (err error) {
