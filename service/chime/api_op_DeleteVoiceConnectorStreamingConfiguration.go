...
func (c *Client) DeleteVoiceConnectorStreamingConfiguration(ctx context.Context, params *DeleteVoiceConnectorStreamingConfigurationInput, optFns ...func(*Options)) (*DeleteVoiceConnectorStreamingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnectorStreamingConfiguration", params, optFns, addOperationDeleteVoiceConnectorStreamingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorStreamingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
