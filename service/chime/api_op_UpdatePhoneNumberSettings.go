...
func (c *Client) UpdatePhoneNumberSettings(ctx context.Context, params *UpdatePhoneNumberSettingsInput, optFns ...func(*Options)) (*UpdatePhoneNumberSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePhoneNumberSettings", params, optFns, addOperationUpdatePhoneNumberSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePhoneNumberSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
