...
func (c *Client) GetAttendee(ctx context.Context, params *GetAttendeeInput, optFns ...func(*Options)) (*GetAttendeeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAttendee", params, optFns, addOperationGetAttendeeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAttendeeMiddleware(stack *middleware.Stack, options Options) (err error) {
