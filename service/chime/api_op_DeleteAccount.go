...
func (c *Client) DeleteAccount(ctx context.Context, params *DeleteAccountInput, optFns ...func(*Options)) (*DeleteAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccount", params, optFns, addOperationDeleteAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
