...
func (c *Client) LogoutUser(ctx context.Context, params *LogoutUserInput, optFns ...func(*Options)) (*LogoutUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "LogoutUser", params, optFns, addOperationLogoutUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLogoutUserMiddleware(stack *middleware.Stack, options Options) (err error) {
