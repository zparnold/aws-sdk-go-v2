...
func (c *Client) DeleteRoomMembership(ctx context.Context, params *DeleteRoomMembershipInput, optFns ...func(*Options)) (*DeleteRoomMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRoomMembership", params, optFns, addOperationDeleteRoomMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRoomMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
