...
func (c *Client) GetVoiceConnectorLoggingConfiguration(ctx context.Context, params *GetVoiceConnectorLoggingConfigurationInput, optFns ...func(*Options)) (*GetVoiceConnectorLoggingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceConnectorLoggingConfiguration", params, optFns, addOperationGetVoiceConnectorLoggingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceConnectorLoggingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
