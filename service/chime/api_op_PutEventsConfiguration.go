...
func (c *Client) PutEventsConfiguration(ctx context.Context, params *PutEventsConfigurationInput, optFns ...func(*Options)) (*PutEventsConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEventsConfiguration", params, optFns, addOperationPutEventsConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEventsConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
