...
func (c *Client) PutVoiceConnectorTermination(ctx context.Context, params *PutVoiceConnectorTerminationInput, optFns ...func(*Options)) (*PutVoiceConnectorTerminationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutVoiceConnectorTermination", params, optFns, addOperationPutVoiceConnectorTerminationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutVoiceConnectorTerminationMiddleware(stack *middleware.Stack, options Options) (err error) {
