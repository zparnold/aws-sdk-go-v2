...
func (c *Client) PutVoiceConnectorTerminationCredentials(ctx context.Context, params *PutVoiceConnectorTerminationCredentialsInput, optFns ...func(*Options)) (*PutVoiceConnectorTerminationCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutVoiceConnectorTerminationCredentials", params, optFns, addOperationPutVoiceConnectorTerminationCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutVoiceConnectorTerminationCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
