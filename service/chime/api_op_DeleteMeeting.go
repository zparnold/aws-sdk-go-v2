...
func (c *Client) DeleteMeeting(ctx context.Context, params *DeleteMeetingInput, optFns ...func(*Options)) (*DeleteMeetingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMeeting", params, optFns, addOperationDeleteMeetingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMeetingMiddleware(stack *middleware.Stack, options Options) (err error) {
