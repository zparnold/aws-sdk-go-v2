...
func (c *Client) UpdateUser(ctx context.Context, params *UpdateUserInput, optFns ...func(*Options)) (*UpdateUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUser", params, optFns, addOperationUpdateUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserMiddleware(stack *middleware.Stack, options Options) (err error) {
