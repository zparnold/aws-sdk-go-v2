...
func (c *Client) GetProxySession(ctx context.Context, params *GetProxySessionInput, optFns ...func(*Options)) (*GetProxySessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetProxySession", params, optFns, addOperationGetProxySessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetProxySessionMiddleware(stack *middleware.Stack, options Options) (err error) {
