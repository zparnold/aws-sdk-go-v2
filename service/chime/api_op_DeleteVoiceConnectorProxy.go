...
func (c *Client) DeleteVoiceConnectorProxy(ctx context.Context, params *DeleteVoiceConnectorProxyInput, optFns ...func(*Options)) (*DeleteVoiceConnectorProxyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnectorProxy", params, optFns, addOperationDeleteVoiceConnectorProxyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorProxyMiddleware(stack *middleware.Stack, options Options) (err error) {
