...
func (c *Client) RedactConversationMessage(ctx context.Context, params *RedactConversationMessageInput, optFns ...func(*Options)) (*RedactConversationMessageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RedactConversationMessage", params, optFns, addOperationRedactConversationMessageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRedactConversationMessageMiddleware(stack *middleware.Stack, options Options) (err error) {
