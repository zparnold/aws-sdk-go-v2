...
func (c *Client) DisassociateSigninDelegateGroupsFromAccount(ctx context.Context, params *DisassociateSigninDelegateGroupsFromAccountInput, optFns ...func(*Options)) (*DisassociateSigninDelegateGroupsFromAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateSigninDelegateGroupsFromAccount", params, optFns, addOperationDisassociateSigninDelegateGroupsFromAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateSigninDelegateGroupsFromAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
