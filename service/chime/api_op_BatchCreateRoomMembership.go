...
func (c *Client) BatchCreateRoomMembership(ctx context.Context, params *BatchCreateRoomMembershipInput, optFns ...func(*Options)) (*BatchCreateRoomMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchCreateRoomMembership", params, optFns, addOperationBatchCreateRoomMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchCreateRoomMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
