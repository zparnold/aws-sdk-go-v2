...
func (c *Client) CreateProxySession(ctx context.Context, params *CreateProxySessionInput, optFns ...func(*Options)) (*CreateProxySessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProxySession", params, optFns, addOperationCreateProxySessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProxySessionMiddleware(stack *middleware.Stack, options Options) (err error) {
