...
func (c *Client) UpdateUserSettings(ctx context.Context, params *UpdateUserSettingsInput, optFns ...func(*Options)) (*UpdateUserSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserSettings", params, optFns, addOperationUpdateUserSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
