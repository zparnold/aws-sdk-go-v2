...
func (c *Client) BatchUnsuspendUser(ctx context.Context, params *BatchUnsuspendUserInput, optFns ...func(*Options)) (*BatchUnsuspendUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchUnsuspendUser", params, optFns, addOperationBatchUnsuspendUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchUnsuspendUserMiddleware(stack *middleware.Stack, options Options) (err error) {
