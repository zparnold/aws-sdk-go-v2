...
func (c *Client) GetEventsConfiguration(ctx context.Context, params *GetEventsConfigurationInput, optFns ...func(*Options)) (*GetEventsConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEventsConfiguration", params, optFns, addOperationGetEventsConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEventsConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
