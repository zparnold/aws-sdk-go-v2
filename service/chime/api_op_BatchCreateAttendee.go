...
func (c *Client) BatchCreateAttendee(ctx context.Context, params *BatchCreateAttendeeInput, optFns ...func(*Options)) (*BatchCreateAttendeeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchCreateAttendee", params, optFns, addOperationBatchCreateAttendeeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchCreateAttendeeMiddleware(stack *middleware.Stack, options Options) (err error) {
