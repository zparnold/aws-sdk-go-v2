...
func (c *Client) UpdatePhoneNumber(ctx context.Context, params *UpdatePhoneNumberInput, optFns ...func(*Options)) (*UpdatePhoneNumberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePhoneNumber", params, optFns, addOperationUpdatePhoneNumberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePhoneNumberMiddleware(stack *middleware.Stack, options Options) (err error) {
