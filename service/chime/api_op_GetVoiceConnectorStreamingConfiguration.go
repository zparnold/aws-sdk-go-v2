...
func (c *Client) GetVoiceConnectorStreamingConfiguration(ctx context.Context, params *GetVoiceConnectorStreamingConfigurationInput, optFns ...func(*Options)) (*GetVoiceConnectorStreamingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceConnectorStreamingConfiguration", params, optFns, addOperationGetVoiceConnectorStreamingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceConnectorStreamingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
