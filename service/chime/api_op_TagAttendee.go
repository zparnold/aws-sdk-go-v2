...
func (c *Client) TagAttendee(ctx context.Context, params *TagAttendeeInput, optFns ...func(*Options)) (*TagAttendeeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagAttendee", params, optFns, addOperationTagAttendeeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagAttendeeMiddleware(stack *middleware.Stack, options Options) (err error) {
