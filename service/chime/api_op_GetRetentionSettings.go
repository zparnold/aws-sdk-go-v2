...
func (c *Client) GetRetentionSettings(ctx context.Context, params *GetRetentionSettingsInput, optFns ...func(*Options)) (*GetRetentionSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRetentionSettings", params, optFns, addOperationGetRetentionSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRetentionSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
