...
func (c *Client) GetGlobalSettings(ctx context.Context, params *GetGlobalSettingsInput, optFns ...func(*Options)) (*GetGlobalSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGlobalSettings", params, optFns, addOperationGetGlobalSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGlobalSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
