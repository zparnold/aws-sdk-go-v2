...
func (c *Client) GetVoiceConnectorGroup(ctx context.Context, params *GetVoiceConnectorGroupInput, optFns ...func(*Options)) (*GetVoiceConnectorGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceConnectorGroup", params, optFns, addOperationGetVoiceConnectorGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceConnectorGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
