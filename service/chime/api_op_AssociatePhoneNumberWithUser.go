...
func (c *Client) AssociatePhoneNumberWithUser(ctx context.Context, params *AssociatePhoneNumberWithUserInput, optFns ...func(*Options)) (*AssociatePhoneNumberWithUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociatePhoneNumberWithUser", params, optFns, addOperationAssociatePhoneNumberWithUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociatePhoneNumberWithUserMiddleware(stack *middleware.Stack, options Options) (err error) {
