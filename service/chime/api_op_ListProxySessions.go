...
func (c *Client) ListProxySessions(ctx context.Context, params *ListProxySessionsInput, optFns ...func(*Options)) (*ListProxySessionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProxySessions", params, optFns, addOperationListProxySessionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProxySessionsMiddleware(stack *middleware.Stack, options Options) (err error) {
