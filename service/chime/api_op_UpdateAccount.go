...
func (c *Client) UpdateAccount(ctx context.Context, params *UpdateAccountInput, optFns ...func(*Options)) (*UpdateAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAccount", params, optFns, addOperationUpdateAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
