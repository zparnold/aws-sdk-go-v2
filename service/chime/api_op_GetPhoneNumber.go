...
func (c *Client) GetPhoneNumber(ctx context.Context, params *GetPhoneNumberInput, optFns ...func(*Options)) (*GetPhoneNumberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPhoneNumber", params, optFns, addOperationGetPhoneNumberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPhoneNumberMiddleware(stack *middleware.Stack, options Options) (err error) {
