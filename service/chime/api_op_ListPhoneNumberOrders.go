...
func (c *Client) ListPhoneNumberOrders(ctx context.Context, params *ListPhoneNumberOrdersInput, optFns ...func(*Options)) (*ListPhoneNumberOrdersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPhoneNumberOrders", params, optFns, addOperationListPhoneNumberOrdersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPhoneNumberOrdersMiddleware(stack *middleware.Stack, options Options) (err error) {
