...
func (c *Client) DisassociatePhoneNumbersFromVoiceConnectorGroup(ctx context.Context, params *DisassociatePhoneNumbersFromVoiceConnectorGroupInput, optFns ...func(*Options)) (*DisassociatePhoneNumbersFromVoiceConnectorGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociatePhoneNumbersFromVoiceConnectorGroup", params, optFns, addOperationDisassociatePhoneNumbersFromVoiceConnectorGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociatePhoneNumbersFromVoiceConnectorGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
