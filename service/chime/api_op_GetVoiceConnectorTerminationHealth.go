...
func (c *Client) GetVoiceConnectorTerminationHealth(ctx context.Context, params *GetVoiceConnectorTerminationHealthInput, optFns ...func(*Options)) (*GetVoiceConnectorTerminationHealthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceConnectorTerminationHealth", params, optFns, addOperationGetVoiceConnectorTerminationHealthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceConnectorTerminationHealthMiddleware(stack *middleware.Stack, options Options) (err error) {
