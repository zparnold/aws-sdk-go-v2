...
func (c *Client) CreateVoiceConnectorGroup(ctx context.Context, params *CreateVoiceConnectorGroupInput, optFns ...func(*Options)) (*CreateVoiceConnectorGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVoiceConnectorGroup", params, optFns, addOperationCreateVoiceConnectorGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVoiceConnectorGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
