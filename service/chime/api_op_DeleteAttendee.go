...
func (c *Client) DeleteAttendee(ctx context.Context, params *DeleteAttendeeInput, optFns ...func(*Options)) (*DeleteAttendeeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAttendee", params, optFns, addOperationDeleteAttendeeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAttendeeMiddleware(stack *middleware.Stack, options Options) (err error) {
