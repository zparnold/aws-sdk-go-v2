...
func (c *Client) CreateVoiceConnector(ctx context.Context, params *CreateVoiceConnectorInput, optFns ...func(*Options)) (*CreateVoiceConnectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVoiceConnector", params, optFns, addOperationCreateVoiceConnectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVoiceConnectorMiddleware(stack *middleware.Stack, options Options) (err error) {
