...
func (c *Client) GetPhoneNumberOrder(ctx context.Context, params *GetPhoneNumberOrderInput, optFns ...func(*Options)) (*GetPhoneNumberOrderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPhoneNumberOrder", params, optFns, addOperationGetPhoneNumberOrderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPhoneNumberOrderMiddleware(stack *middleware.Stack, options Options) (err error) {
