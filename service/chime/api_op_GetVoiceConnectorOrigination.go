...
func (c *Client) GetVoiceConnectorOrigination(ctx context.Context, params *GetVoiceConnectorOriginationInput, optFns ...func(*Options)) (*GetVoiceConnectorOriginationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceConnectorOrigination", params, optFns, addOperationGetVoiceConnectorOriginationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceConnectorOriginationMiddleware(stack *middleware.Stack, options Options) (err error) {
