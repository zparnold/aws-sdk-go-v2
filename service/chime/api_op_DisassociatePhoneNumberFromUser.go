...
func (c *Client) DisassociatePhoneNumberFromUser(ctx context.Context, params *DisassociatePhoneNumberFromUserInput, optFns ...func(*Options)) (*DisassociatePhoneNumberFromUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociatePhoneNumberFromUser", params, optFns, addOperationDisassociatePhoneNumberFromUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociatePhoneNumberFromUserMiddleware(stack *middleware.Stack, options Options) (err error) {
