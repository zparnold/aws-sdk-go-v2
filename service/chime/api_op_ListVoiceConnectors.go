...
func (c *Client) ListVoiceConnectors(ctx context.Context, params *ListVoiceConnectorsInput, optFns ...func(*Options)) (*ListVoiceConnectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVoiceConnectors", params, optFns, addOperationListVoiceConnectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVoiceConnectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
