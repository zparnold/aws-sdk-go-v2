...
func (c *Client) GetVoiceConnector(ctx context.Context, params *GetVoiceConnectorInput, optFns ...func(*Options)) (*GetVoiceConnectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceConnector", params, optFns, addOperationGetVoiceConnectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceConnectorMiddleware(stack *middleware.Stack, options Options) (err error) {
