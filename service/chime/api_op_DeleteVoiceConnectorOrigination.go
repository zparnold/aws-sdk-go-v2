...
func (c *Client) DeleteVoiceConnectorOrigination(ctx context.Context, params *DeleteVoiceConnectorOriginationInput, optFns ...func(*Options)) (*DeleteVoiceConnectorOriginationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceConnectorOrigination", params, optFns, addOperationDeleteVoiceConnectorOriginationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceConnectorOriginationMiddleware(stack *middleware.Stack, options Options) (err error) {
