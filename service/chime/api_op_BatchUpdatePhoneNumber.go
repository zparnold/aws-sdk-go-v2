...
func (c *Client) BatchUpdatePhoneNumber(ctx context.Context, params *BatchUpdatePhoneNumberInput, optFns ...func(*Options)) (*BatchUpdatePhoneNumberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchUpdatePhoneNumber", params, optFns, addOperationBatchUpdatePhoneNumberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchUpdatePhoneNumberMiddleware(stack *middleware.Stack, options Options) (err error) {
