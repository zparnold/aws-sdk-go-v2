...
func (c *Client) ListVoiceConnectorGroups(ctx context.Context, params *ListVoiceConnectorGroupsInput, optFns ...func(*Options)) (*ListVoiceConnectorGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVoiceConnectorGroups", params, optFns, addOperationListVoiceConnectorGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVoiceConnectorGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
