...
func (c *Client) DescribeHapg(ctx context.Context, params *DescribeHapgInput, optFns ...func(*Options)) (*DescribeHapgOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHapg", params, optFns, addOperationDescribeHapgMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHapgMiddleware(stack *middleware.Stack, options Options) (err error) {
