...
func (c *Client) ModifyHsm(ctx context.Context, params *ModifyHsmInput, optFns ...func(*Options)) (*ModifyHsmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyHsm", params, optFns, addOperationModifyHsmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyHsmMiddleware(stack *middleware.Stack, options Options) (err error) {
