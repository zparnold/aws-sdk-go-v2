...
func (c *Client) ListLunaClients(ctx context.Context, params *ListLunaClientsInput, optFns ...func(*Options)) (*ListLunaClientsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLunaClients", params, optFns, addOperationListLunaClientsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLunaClientsMiddleware(stack *middleware.Stack, options Options) (err error) {
