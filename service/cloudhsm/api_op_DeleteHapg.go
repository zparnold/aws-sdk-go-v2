...
func (c *Client) DeleteHapg(ctx context.Context, params *DeleteHapgInput, optFns ...func(*Options)) (*DeleteHapgOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHapg", params, optFns, addOperationDeleteHapgMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHapgMiddleware(stack *middleware.Stack, options Options) (err error) {
