...
func (c *Client) DeleteHsm(ctx context.Context, params *DeleteHsmInput, optFns ...func(*Options)) (*DeleteHsmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHsm", params, optFns, addOperationDeleteHsmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHsmMiddleware(stack *middleware.Stack, options Options) (err error) {
