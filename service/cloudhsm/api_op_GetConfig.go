...
func (c *Client) GetConfig(ctx context.Context, params *GetConfigInput, optFns ...func(*Options)) (*GetConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConfig", params, optFns, addOperationGetConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
