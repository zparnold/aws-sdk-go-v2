...
func (c *Client) CreateLunaClient(ctx context.Context, params *CreateLunaClientInput, optFns ...func(*Options)) (*CreateLunaClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLunaClient", params, optFns, addOperationCreateLunaClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLunaClientMiddleware(stack *middleware.Stack, options Options) (err error) {
