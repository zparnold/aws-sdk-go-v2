...
func (c *Client) DeleteLunaClient(ctx context.Context, params *DeleteLunaClientInput, optFns ...func(*Options)) (*DeleteLunaClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLunaClient", params, optFns, addOperationDeleteLunaClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLunaClientMiddleware(stack *middleware.Stack, options Options) (err error) {
