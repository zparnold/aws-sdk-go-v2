...
func (c *Client) ListHapgs(ctx context.Context, params *ListHapgsInput, optFns ...func(*Options)) (*ListHapgsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHapgs", params, optFns, addOperationListHapgsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHapgsMiddleware(stack *middleware.Stack, options Options) (err error) {
