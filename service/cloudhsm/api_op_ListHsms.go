...
func (c *Client) ListHsms(ctx context.Context, params *ListHsmsInput, optFns ...func(*Options)) (*ListHsmsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHsms", params, optFns, addOperationListHsmsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHsmsMiddleware(stack *middleware.Stack, options Options) (err error) {
