...
func (c *Client) DescribeHsm(ctx context.Context, params *DescribeHsmInput, optFns ...func(*Options)) (*DescribeHsmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHsm", params, optFns, addOperationDescribeHsmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHsmMiddleware(stack *middleware.Stack, options Options) (err error) {
