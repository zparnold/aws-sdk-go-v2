...
func (c *Client) CreateHsm(ctx context.Context, params *CreateHsmInput, optFns ...func(*Options)) (*CreateHsmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHsm", params, optFns, addOperationCreateHsmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHsmMiddleware(stack *middleware.Stack, options Options) (err error) {
