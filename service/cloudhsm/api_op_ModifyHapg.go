...
func (c *Client) ModifyHapg(ctx context.Context, params *ModifyHapgInput, optFns ...func(*Options)) (*ModifyHapgOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyHapg", params, optFns, addOperationModifyHapgMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyHapgMiddleware(stack *middleware.Stack, options Options) (err error) {
