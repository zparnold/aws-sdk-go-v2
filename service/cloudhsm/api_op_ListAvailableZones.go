...
func (c *Client) ListAvailableZones(ctx context.Context, params *ListAvailableZonesInput, optFns ...func(*Options)) (*ListAvailableZonesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAvailableZones", params, optFns, addOperationListAvailableZonesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAvailableZonesMiddleware(stack *middleware.Stack, options Options) (err error) {
