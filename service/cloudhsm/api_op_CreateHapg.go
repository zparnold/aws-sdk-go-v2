...
func (c *Client) CreateHapg(ctx context.Context, params *CreateHapgInput, optFns ...func(*Options)) (*CreateHapgOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHapg", params, optFns, addOperationCreateHapgMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHapgMiddleware(stack *middleware.Stack, options Options) (err error) {
