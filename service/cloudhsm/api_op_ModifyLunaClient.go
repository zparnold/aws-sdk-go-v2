...
func (c *Client) ModifyLunaClient(ctx context.Context, params *ModifyLunaClientInput, optFns ...func(*Options)) (*ModifyLunaClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyLunaClient", params, optFns, addOperationModifyLunaClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyLunaClientMiddleware(stack *middleware.Stack, options Options) (err error) {
