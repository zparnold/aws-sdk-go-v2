...
func (c *Client) CreatePresignedNotebookInstanceUrl(ctx context.Context, params *CreatePresignedNotebookInstanceUrlInput, optFns ...func(*Options)) (*CreatePresignedNotebookInstanceUrlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePresignedNotebookInstanceUrl", params, optFns, addOperationCreatePresignedNotebookInstanceUrlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePresignedNotebookInstanceUrlMiddleware(stack *middleware.Stack, options Options) (err error) {
