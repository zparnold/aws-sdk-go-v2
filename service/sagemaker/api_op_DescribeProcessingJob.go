...
func (c *Client) DescribeProcessingJob(ctx context.Context, params *DescribeProcessingJobInput, optFns ...func(*Options)) (*DescribeProcessingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProcessingJob", params, optFns, addOperationDescribeProcessingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProcessingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
