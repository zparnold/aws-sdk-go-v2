...
func (c *Client) CreateEndpointConfig(ctx context.Context, params *CreateEndpointConfigInput, optFns ...func(*Options)) (*CreateEndpointConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEndpointConfig", params, optFns, addOperationCreateEndpointConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEndpointConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
