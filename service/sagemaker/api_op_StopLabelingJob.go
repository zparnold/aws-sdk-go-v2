...
func (c *Client) StopLabelingJob(ctx context.Context, params *StopLabelingJobInput, optFns ...func(*Options)) (*StopLabelingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopLabelingJob", params, optFns, addOperationStopLabelingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopLabelingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
