...
func (c *Client) ListCodeRepositories(ctx context.Context, params *ListCodeRepositoriesInput, optFns ...func(*Options)) (*ListCodeRepositoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCodeRepositories", params, optFns, addOperationListCodeRepositoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCodeRepositoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
