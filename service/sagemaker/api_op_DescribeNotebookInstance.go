...
func (c *Client) DescribeNotebookInstance(ctx context.Context, params *DescribeNotebookInstanceInput, optFns ...func(*Options)) (*DescribeNotebookInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNotebookInstance", params, optFns, addOperationDescribeNotebookInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNotebookInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
