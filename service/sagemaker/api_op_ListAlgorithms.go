...
func (c *Client) ListAlgorithms(ctx context.Context, params *ListAlgorithmsInput, optFns ...func(*Options)) (*ListAlgorithmsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAlgorithms", params, optFns, addOperationListAlgorithmsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAlgorithmsMiddleware(stack *middleware.Stack, options Options) (err error) {
