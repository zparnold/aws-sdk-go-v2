...
func (c *Client) DescribeUserProfile(ctx context.Context, params *DescribeUserProfileInput, optFns ...func(*Options)) (*DescribeUserProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUserProfile", params, optFns, addOperationDescribeUserProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUserProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
