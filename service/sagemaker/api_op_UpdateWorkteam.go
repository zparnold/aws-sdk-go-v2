...
func (c *Client) UpdateWorkteam(ctx context.Context, params *UpdateWorkteamInput, optFns ...func(*Options)) (*UpdateWorkteamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateWorkteam", params, optFns, addOperationUpdateWorkteamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateWorkteamMiddleware(stack *middleware.Stack, options Options) (err error) {
