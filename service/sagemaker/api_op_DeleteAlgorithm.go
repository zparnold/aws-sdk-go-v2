...
func (c *Client) DeleteAlgorithm(ctx context.Context, params *DeleteAlgorithmInput, optFns ...func(*Options)) (*DeleteAlgorithmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAlgorithm", params, optFns, addOperationDeleteAlgorithmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAlgorithmMiddleware(stack *middleware.Stack, options Options) (err error) {
