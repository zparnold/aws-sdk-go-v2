...
func (c *Client) ListEndpointConfigs(ctx context.Context, params *ListEndpointConfigsInput, optFns ...func(*Options)) (*ListEndpointConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEndpointConfigs", params, optFns, addOperationListEndpointConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEndpointConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
