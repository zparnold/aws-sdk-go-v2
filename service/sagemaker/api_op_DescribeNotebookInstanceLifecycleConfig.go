...
func (c *Client) DescribeNotebookInstanceLifecycleConfig(ctx context.Context, params *DescribeNotebookInstanceLifecycleConfigInput, optFns ...func(*Options)) (*DescribeNotebookInstanceLifecycleConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNotebookInstanceLifecycleConfig", params, optFns, addOperationDescribeNotebookInstanceLifecycleConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNotebookInstanceLifecycleConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
