...
func (c *Client) DisassociateTrialComponent(ctx context.Context, params *DisassociateTrialComponentInput, optFns ...func(*Options)) (*DisassociateTrialComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateTrialComponent", params, optFns, addOperationDisassociateTrialComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateTrialComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
