...
func (c *Client) DeleteTrialComponent(ctx context.Context, params *DeleteTrialComponentInput, optFns ...func(*Options)) (*DeleteTrialComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrialComponent", params, optFns, addOperationDeleteTrialComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrialComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
