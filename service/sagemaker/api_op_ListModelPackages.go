...
func (c *Client) ListModelPackages(ctx context.Context, params *ListModelPackagesInput, optFns ...func(*Options)) (*ListModelPackagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListModelPackages", params, optFns, addOperationListModelPackagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListModelPackagesMiddleware(stack *middleware.Stack, options Options) (err error) {
