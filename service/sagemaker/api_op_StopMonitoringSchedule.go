...
func (c *Client) StopMonitoringSchedule(ctx context.Context, params *StopMonitoringScheduleInput, optFns ...func(*Options)) (*StopMonitoringScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopMonitoringSchedule", params, optFns, addOperationStopMonitoringScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopMonitoringScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
