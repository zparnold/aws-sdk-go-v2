...
func (c *Client) CreateCompilationJob(ctx context.Context, params *CreateCompilationJobInput, optFns ...func(*Options)) (*CreateCompilationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCompilationJob", params, optFns, addOperationCreateCompilationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCompilationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
