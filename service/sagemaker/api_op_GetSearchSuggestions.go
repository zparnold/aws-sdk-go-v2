...
func (c *Client) GetSearchSuggestions(ctx context.Context, params *GetSearchSuggestionsInput, optFns ...func(*Options)) (*GetSearchSuggestionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSearchSuggestions", params, optFns, addOperationGetSearchSuggestionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSearchSuggestionsMiddleware(stack *middleware.Stack, options Options) (err error) {
