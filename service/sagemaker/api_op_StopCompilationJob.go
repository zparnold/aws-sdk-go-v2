...
func (c *Client) StopCompilationJob(ctx context.Context, params *StopCompilationJobInput, optFns ...func(*Options)) (*StopCompilationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopCompilationJob", params, optFns, addOperationStopCompilationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopCompilationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
