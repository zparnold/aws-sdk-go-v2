...
func (c *Client) ListDomains(ctx context.Context, params *ListDomainsInput, optFns ...func(*Options)) (*ListDomainsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDomains", params, optFns, addOperationListDomainsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDomainsMiddleware(stack *middleware.Stack, options Options) (err error) {
