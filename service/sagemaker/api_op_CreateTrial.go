...
func (c *Client) CreateTrial(ctx context.Context, params *CreateTrialInput, optFns ...func(*Options)) (*CreateTrialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrial", params, optFns, addOperationCreateTrialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrialMiddleware(stack *middleware.Stack, options Options) (err error) {
