...
func (c *Client) DescribeWorkteam(ctx context.Context, params *DescribeWorkteamInput, optFns ...func(*Options)) (*DescribeWorkteamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkteam", params, optFns, addOperationDescribeWorkteamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkteamMiddleware(stack *middleware.Stack, options Options) (err error) {
