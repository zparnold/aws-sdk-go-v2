...
func (c *Client) DescribeCodeRepository(ctx context.Context, params *DescribeCodeRepositoryInput, optFns ...func(*Options)) (*DescribeCodeRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCodeRepository", params, optFns, addOperationDescribeCodeRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCodeRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
