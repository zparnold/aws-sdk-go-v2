...
func (c *Client) ListUserProfiles(ctx context.Context, params *ListUserProfilesInput, optFns ...func(*Options)) (*ListUserProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserProfiles", params, optFns, addOperationListUserProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
