...
func (c *Client) CreateWorkforce(ctx context.Context, params *CreateWorkforceInput, optFns ...func(*Options)) (*CreateWorkforceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateWorkforce", params, optFns, addOperationCreateWorkforceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateWorkforceMiddleware(stack *middleware.Stack, options Options) (err error) {
