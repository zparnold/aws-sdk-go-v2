...
func (c *Client) DescribeTrial(ctx context.Context, params *DescribeTrialInput, optFns ...func(*Options)) (*DescribeTrialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrial", params, optFns, addOperationDescribeTrialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrialMiddleware(stack *middleware.Stack, options Options) (err error) {
