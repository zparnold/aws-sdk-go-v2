...
func (c *Client) DeleteNotebookInstanceLifecycleConfig(ctx context.Context, params *DeleteNotebookInstanceLifecycleConfigInput, optFns ...func(*Options)) (*DeleteNotebookInstanceLifecycleConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNotebookInstanceLifecycleConfig", params, optFns, addOperationDeleteNotebookInstanceLifecycleConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNotebookInstanceLifecycleConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
