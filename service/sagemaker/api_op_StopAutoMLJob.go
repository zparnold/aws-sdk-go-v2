...
func (c *Client) StopAutoMLJob(ctx context.Context, params *StopAutoMLJobInput, optFns ...func(*Options)) (*StopAutoMLJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopAutoMLJob", params, optFns, addOperationStopAutoMLJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopAutoMLJobMiddleware(stack *middleware.Stack, options Options) (err error) {
