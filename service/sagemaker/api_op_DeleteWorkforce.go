...
func (c *Client) DeleteWorkforce(ctx context.Context, params *DeleteWorkforceInput, optFns ...func(*Options)) (*DeleteWorkforceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWorkforce", params, optFns, addOperationDeleteWorkforceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWorkforceMiddleware(stack *middleware.Stack, options Options) (err error) {
