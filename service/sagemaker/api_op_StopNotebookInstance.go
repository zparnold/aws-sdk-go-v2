...
func (c *Client) StopNotebookInstance(ctx context.Context, params *StopNotebookInstanceInput, optFns ...func(*Options)) (*StopNotebookInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopNotebookInstance", params, optFns, addOperationStopNotebookInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopNotebookInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
