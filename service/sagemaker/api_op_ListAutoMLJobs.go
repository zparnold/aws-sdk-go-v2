...
func (c *Client) ListAutoMLJobs(ctx context.Context, params *ListAutoMLJobsInput, optFns ...func(*Options)) (*ListAutoMLJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAutoMLJobs", params, optFns, addOperationListAutoMLJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAutoMLJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
