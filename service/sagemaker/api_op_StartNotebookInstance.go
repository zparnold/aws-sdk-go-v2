...
func (c *Client) StartNotebookInstance(ctx context.Context, params *StartNotebookInstanceInput, optFns ...func(*Options)) (*StartNotebookInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartNotebookInstance", params, optFns, addOperationStartNotebookInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartNotebookInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
