...
func (c *Client) ListHumanTaskUis(ctx context.Context, params *ListHumanTaskUisInput, optFns ...func(*Options)) (*ListHumanTaskUisOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHumanTaskUis", params, optFns, addOperationListHumanTaskUisMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHumanTaskUisMiddleware(stack *middleware.Stack, options Options) (err error) {
