...
func (c *Client) RenderUiTemplate(ctx context.Context, params *RenderUiTemplateInput, optFns ...func(*Options)) (*RenderUiTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RenderUiTemplate", params, optFns, addOperationRenderUiTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRenderUiTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
