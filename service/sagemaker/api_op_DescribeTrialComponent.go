...
func (c *Client) DescribeTrialComponent(ctx context.Context, params *DescribeTrialComponentInput, optFns ...func(*Options)) (*DescribeTrialComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrialComponent", params, optFns, addOperationDescribeTrialComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrialComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
