...
func (c *Client) CreateHumanTaskUi(ctx context.Context, params *CreateHumanTaskUiInput, optFns ...func(*Options)) (*CreateHumanTaskUiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHumanTaskUi", params, optFns, addOperationCreateHumanTaskUiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHumanTaskUiMiddleware(stack *middleware.Stack, options Options) (err error) {
