...
func (c *Client) DeleteHumanTaskUi(ctx context.Context, params *DeleteHumanTaskUiInput, optFns ...func(*Options)) (*DeleteHumanTaskUiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHumanTaskUi", params, optFns, addOperationDeleteHumanTaskUiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHumanTaskUiMiddleware(stack *middleware.Stack, options Options) (err error) {
