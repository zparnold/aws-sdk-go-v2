...
func (c *Client) ListCandidatesForAutoMLJob(ctx context.Context, params *ListCandidatesForAutoMLJobInput, optFns ...func(*Options)) (*ListCandidatesForAutoMLJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCandidatesForAutoMLJob", params, optFns, addOperationListCandidatesForAutoMLJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCandidatesForAutoMLJobMiddleware(stack *middleware.Stack, options Options) (err error) {
