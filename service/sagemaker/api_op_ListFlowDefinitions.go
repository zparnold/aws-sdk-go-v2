...
func (c *Client) ListFlowDefinitions(ctx context.Context, params *ListFlowDefinitionsInput, optFns ...func(*Options)) (*ListFlowDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFlowDefinitions", params, optFns, addOperationListFlowDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFlowDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
