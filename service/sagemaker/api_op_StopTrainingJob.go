...
func (c *Client) StopTrainingJob(ctx context.Context, params *StopTrainingJobInput, optFns ...func(*Options)) (*StopTrainingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopTrainingJob", params, optFns, addOperationStopTrainingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopTrainingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
