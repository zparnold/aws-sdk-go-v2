...
func (c *Client) ListLabelingJobs(ctx context.Context, params *ListLabelingJobsInput, optFns ...func(*Options)) (*ListLabelingJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLabelingJobs", params, optFns, addOperationListLabelingJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLabelingJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
