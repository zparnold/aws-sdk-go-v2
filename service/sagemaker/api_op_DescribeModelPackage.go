...
func (c *Client) DescribeModelPackage(ctx context.Context, params *DescribeModelPackageInput, optFns ...func(*Options)) (*DescribeModelPackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeModelPackage", params, optFns, addOperationDescribeModelPackageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeModelPackageMiddleware(stack *middleware.Stack, options Options) (err error) {
