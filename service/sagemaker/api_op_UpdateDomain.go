...
func (c *Client) UpdateDomain(ctx context.Context, params *UpdateDomainInput, optFns ...func(*Options)) (*UpdateDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomain", params, optFns, addOperationUpdateDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
