...
func (c *Client) DescribeModel(ctx context.Context, params *DescribeModelInput, optFns ...func(*Options)) (*DescribeModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeModel", params, optFns, addOperationDescribeModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeModelMiddleware(stack *middleware.Stack, options Options) (err error) {
