...
func (c *Client) ListTrials(ctx context.Context, params *ListTrialsInput, optFns ...func(*Options)) (*ListTrialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrials", params, optFns, addOperationListTrialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrialsMiddleware(stack *middleware.Stack, options Options) (err error) {
