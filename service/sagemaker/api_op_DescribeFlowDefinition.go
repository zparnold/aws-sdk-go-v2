...
func (c *Client) DescribeFlowDefinition(ctx context.Context, params *DescribeFlowDefinitionInput, optFns ...func(*Options)) (*DescribeFlowDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFlowDefinition", params, optFns, addOperationDescribeFlowDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFlowDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
