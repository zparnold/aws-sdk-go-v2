...
func (c *Client) CreateTrainingJob(ctx context.Context, params *CreateTrainingJobInput, optFns ...func(*Options)) (*CreateTrainingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrainingJob", params, optFns, addOperationCreateTrainingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrainingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
