...
func (c *Client) ListTrainingJobs(ctx context.Context, params *ListTrainingJobsInput, optFns ...func(*Options)) (*ListTrainingJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrainingJobs", params, optFns, addOperationListTrainingJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrainingJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
