...
func (c *Client) CreateNotebookInstance(ctx context.Context, params *CreateNotebookInstanceInput, optFns ...func(*Options)) (*CreateNotebookInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNotebookInstance", params, optFns, addOperationCreateNotebookInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNotebookInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
