...
func (c *Client) ListSubscribedWorkteams(ctx context.Context, params *ListSubscribedWorkteamsInput, optFns ...func(*Options)) (*ListSubscribedWorkteamsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSubscribedWorkteams", params, optFns, addOperationListSubscribedWorkteamsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSubscribedWorkteamsMiddleware(stack *middleware.Stack, options Options) (err error) {
