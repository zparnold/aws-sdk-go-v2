...
func (c *Client) AssociateTrialComponent(ctx context.Context, params *AssociateTrialComponentInput, optFns ...func(*Options)) (*AssociateTrialComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateTrialComponent", params, optFns, addOperationAssociateTrialComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateTrialComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
