...
func (c *Client) UpdateEndpointWeightsAndCapacities(ctx context.Context, params *UpdateEndpointWeightsAndCapacitiesInput, optFns ...func(*Options)) (*UpdateEndpointWeightsAndCapacitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEndpointWeightsAndCapacities", params, optFns, addOperationUpdateEndpointWeightsAndCapacitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEndpointWeightsAndCapacitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
