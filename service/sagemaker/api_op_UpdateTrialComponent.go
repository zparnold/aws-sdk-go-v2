...
func (c *Client) UpdateTrialComponent(ctx context.Context, params *UpdateTrialComponentInput, optFns ...func(*Options)) (*UpdateTrialComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTrialComponent", params, optFns, addOperationUpdateTrialComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTrialComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
