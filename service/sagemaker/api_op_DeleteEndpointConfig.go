...
func (c *Client) DeleteEndpointConfig(ctx context.Context, params *DeleteEndpointConfigInput, optFns ...func(*Options)) (*DeleteEndpointConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEndpointConfig", params, optFns, addOperationDeleteEndpointConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEndpointConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
