...
func (c *Client) DeleteCodeRepository(ctx context.Context, params *DeleteCodeRepositoryInput, optFns ...func(*Options)) (*DeleteCodeRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCodeRepository", params, optFns, addOperationDeleteCodeRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCodeRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
