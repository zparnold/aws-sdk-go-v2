...
func (c *Client) DescribeHyperParameterTuningJob(ctx context.Context, params *DescribeHyperParameterTuningJobInput, optFns ...func(*Options)) (*DescribeHyperParameterTuningJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHyperParameterTuningJob", params, optFns, addOperationDescribeHyperParameterTuningJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHyperParameterTuningJobMiddleware(stack *middleware.Stack, options Options) (err error) {
