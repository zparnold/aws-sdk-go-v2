...
func (c *Client) DescribeTrainingJob(ctx context.Context, params *DescribeTrainingJobInput, optFns ...func(*Options)) (*DescribeTrainingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrainingJob", params, optFns, addOperationDescribeTrainingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrainingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
