...
func (c *Client) CreateAlgorithm(ctx context.Context, params *CreateAlgorithmInput, optFns ...func(*Options)) (*CreateAlgorithmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAlgorithm", params, optFns, addOperationCreateAlgorithmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAlgorithmMiddleware(stack *middleware.Stack, options Options) (err error) {
