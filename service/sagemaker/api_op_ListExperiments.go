...
func (c *Client) ListExperiments(ctx context.Context, params *ListExperimentsInput, optFns ...func(*Options)) (*ListExperimentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListExperiments", params, optFns, addOperationListExperimentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListExperimentsMiddleware(stack *middleware.Stack, options Options) (err error) {
