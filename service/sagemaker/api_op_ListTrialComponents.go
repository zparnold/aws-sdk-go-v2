...
func (c *Client) ListTrialComponents(ctx context.Context, params *ListTrialComponentsInput, optFns ...func(*Options)) (*ListTrialComponentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrialComponents", params, optFns, addOperationListTrialComponentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrialComponentsMiddleware(stack *middleware.Stack, options Options) (err error) {
