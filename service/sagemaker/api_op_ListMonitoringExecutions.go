...
func (c *Client) ListMonitoringExecutions(ctx context.Context, params *ListMonitoringExecutionsInput, optFns ...func(*Options)) (*ListMonitoringExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMonitoringExecutions", params, optFns, addOperationListMonitoringExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMonitoringExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
