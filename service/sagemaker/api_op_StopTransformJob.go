...
func (c *Client) StopTransformJob(ctx context.Context, params *StopTransformJobInput, optFns ...func(*Options)) (*StopTransformJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopTransformJob", params, optFns, addOperationStopTransformJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopTransformJobMiddleware(stack *middleware.Stack, options Options) (err error) {
