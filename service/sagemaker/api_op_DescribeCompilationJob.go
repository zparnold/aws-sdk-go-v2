...
func (c *Client) DescribeCompilationJob(ctx context.Context, params *DescribeCompilationJobInput, optFns ...func(*Options)) (*DescribeCompilationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCompilationJob", params, optFns, addOperationDescribeCompilationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCompilationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
