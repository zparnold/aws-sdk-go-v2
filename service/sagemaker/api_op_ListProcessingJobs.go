...
func (c *Client) ListProcessingJobs(ctx context.Context, params *ListProcessingJobsInput, optFns ...func(*Options)) (*ListProcessingJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProcessingJobs", params, optFns, addOperationListProcessingJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProcessingJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
