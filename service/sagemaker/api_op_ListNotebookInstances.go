...
func (c *Client) ListNotebookInstances(ctx context.Context, params *ListNotebookInstancesInput, optFns ...func(*Options)) (*ListNotebookInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNotebookInstances", params, optFns, addOperationListNotebookInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNotebookInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
