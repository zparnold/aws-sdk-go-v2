...
func (c *Client) CreatePresignedDomainUrl(ctx context.Context, params *CreatePresignedDomainUrlInput, optFns ...func(*Options)) (*CreatePresignedDomainUrlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePresignedDomainUrl", params, optFns, addOperationCreatePresignedDomainUrlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePresignedDomainUrlMiddleware(stack *middleware.Stack, options Options) (err error) {
