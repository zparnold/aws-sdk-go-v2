...
func (c *Client) DeleteMonitoringSchedule(ctx context.Context, params *DeleteMonitoringScheduleInput, optFns ...func(*Options)) (*DeleteMonitoringScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMonitoringSchedule", params, optFns, addOperationDeleteMonitoringScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMonitoringScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
