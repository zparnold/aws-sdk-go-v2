...
func (c *Client) CreateTransformJob(ctx context.Context, params *CreateTransformJobInput, optFns ...func(*Options)) (*CreateTransformJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTransformJob", params, optFns, addOperationCreateTransformJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTransformJobMiddleware(stack *middleware.Stack, options Options) (err error) {
