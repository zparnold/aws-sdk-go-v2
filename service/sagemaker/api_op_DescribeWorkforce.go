...
func (c *Client) DescribeWorkforce(ctx context.Context, params *DescribeWorkforceInput, optFns ...func(*Options)) (*DescribeWorkforceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkforce", params, optFns, addOperationDescribeWorkforceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkforceMiddleware(stack *middleware.Stack, options Options) (err error) {
