...
func (c *Client) DescribeApp(ctx context.Context, params *DescribeAppInput, optFns ...func(*Options)) (*DescribeAppOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeApp", params, optFns, addOperationDescribeAppMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAppMiddleware(stack *middleware.Stack, options Options) (err error) {
