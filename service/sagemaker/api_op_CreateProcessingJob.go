...
func (c *Client) CreateProcessingJob(ctx context.Context, params *CreateProcessingJobInput, optFns ...func(*Options)) (*CreateProcessingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProcessingJob", params, optFns, addOperationCreateProcessingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProcessingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
