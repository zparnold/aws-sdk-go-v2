...
func (c *Client) UpdateCodeRepository(ctx context.Context, params *UpdateCodeRepositoryInput, optFns ...func(*Options)) (*UpdateCodeRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCodeRepository", params, optFns, addOperationUpdateCodeRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCodeRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
