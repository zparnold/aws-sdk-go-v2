...
func (c *Client) DeleteModel(ctx context.Context, params *DeleteModelInput, optFns ...func(*Options)) (*DeleteModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteModel", params, optFns, addOperationDeleteModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteModelMiddleware(stack *middleware.Stack, options Options) (err error) {
