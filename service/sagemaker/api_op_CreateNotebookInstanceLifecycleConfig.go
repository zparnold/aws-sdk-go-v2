...
func (c *Client) CreateNotebookInstanceLifecycleConfig(ctx context.Context, params *CreateNotebookInstanceLifecycleConfigInput, optFns ...func(*Options)) (*CreateNotebookInstanceLifecycleConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNotebookInstanceLifecycleConfig", params, optFns, addOperationCreateNotebookInstanceLifecycleConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNotebookInstanceLifecycleConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
