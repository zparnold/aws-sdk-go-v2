...
func (c *Client) DeleteWorkteam(ctx context.Context, params *DeleteWorkteamInput, optFns ...func(*Options)) (*DeleteWorkteamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWorkteam", params, optFns, addOperationDeleteWorkteamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWorkteamMiddleware(stack *middleware.Stack, options Options) (err error) {
