...
func (c *Client) CreateHyperParameterTuningJob(ctx context.Context, params *CreateHyperParameterTuningJobInput, optFns ...func(*Options)) (*CreateHyperParameterTuningJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHyperParameterTuningJob", params, optFns, addOperationCreateHyperParameterTuningJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHyperParameterTuningJobMiddleware(stack *middleware.Stack, options Options) (err error) {
