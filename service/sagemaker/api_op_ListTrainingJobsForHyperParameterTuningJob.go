...
func (c *Client) ListTrainingJobsForHyperParameterTuningJob(ctx context.Context, params *ListTrainingJobsForHyperParameterTuningJobInput, optFns ...func(*Options)) (*ListTrainingJobsForHyperParameterTuningJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrainingJobsForHyperParameterTuningJob", params, optFns, addOperationListTrainingJobsForHyperParameterTuningJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrainingJobsForHyperParameterTuningJobMiddleware(stack *middleware.Stack, options Options) (err error) {
