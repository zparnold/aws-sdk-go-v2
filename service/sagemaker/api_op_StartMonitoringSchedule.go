...
func (c *Client) StartMonitoringSchedule(ctx context.Context, params *StartMonitoringScheduleInput, optFns ...func(*Options)) (*StartMonitoringScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMonitoringSchedule", params, optFns, addOperationStartMonitoringScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMonitoringScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
