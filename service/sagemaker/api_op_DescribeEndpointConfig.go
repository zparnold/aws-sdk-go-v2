...
func (c *Client) DescribeEndpointConfig(ctx context.Context, params *DescribeEndpointConfigInput, optFns ...func(*Options)) (*DescribeEndpointConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEndpointConfig", params, optFns, addOperationDescribeEndpointConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEndpointConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
