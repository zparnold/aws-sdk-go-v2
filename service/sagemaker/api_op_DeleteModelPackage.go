...
func (c *Client) DeleteModelPackage(ctx context.Context, params *DeleteModelPackageInput, optFns ...func(*Options)) (*DeleteModelPackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteModelPackage", params, optFns, addOperationDeleteModelPackageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteModelPackageMiddleware(stack *middleware.Stack, options Options) (err error) {
