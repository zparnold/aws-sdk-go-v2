...
func (c *Client) CreateAutoMLJob(ctx context.Context, params *CreateAutoMLJobInput, optFns ...func(*Options)) (*CreateAutoMLJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAutoMLJob", params, optFns, addOperationCreateAutoMLJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAutoMLJobMiddleware(stack *middleware.Stack, options Options) (err error) {
