...
func (c *Client) CreateWorkteam(ctx context.Context, params *CreateWorkteamInput, optFns ...func(*Options)) (*CreateWorkteamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateWorkteam", params, optFns, addOperationCreateWorkteamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateWorkteamMiddleware(stack *middleware.Stack, options Options) (err error) {
