...
func (c *Client) CreateLabelingJob(ctx context.Context, params *CreateLabelingJobInput, optFns ...func(*Options)) (*CreateLabelingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLabelingJob", params, optFns, addOperationCreateLabelingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLabelingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
