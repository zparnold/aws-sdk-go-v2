...
func (c *Client) DescribeAutoMLJob(ctx context.Context, params *DescribeAutoMLJobInput, optFns ...func(*Options)) (*DescribeAutoMLJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAutoMLJob", params, optFns, addOperationDescribeAutoMLJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAutoMLJobMiddleware(stack *middleware.Stack, options Options) (err error) {
