...
func (c *Client) DeleteFlowDefinition(ctx context.Context, params *DeleteFlowDefinitionInput, optFns ...func(*Options)) (*DeleteFlowDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFlowDefinition", params, optFns, addOperationDeleteFlowDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFlowDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
