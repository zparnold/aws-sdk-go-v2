...
func (c *Client) DescribeExperiment(ctx context.Context, params *DescribeExperimentInput, optFns ...func(*Options)) (*DescribeExperimentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeExperiment", params, optFns, addOperationDescribeExperimentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeExperimentMiddleware(stack *middleware.Stack, options Options) (err error) {
