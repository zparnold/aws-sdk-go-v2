...
func (c *Client) DeleteTrial(ctx context.Context, params *DeleteTrialInput, optFns ...func(*Options)) (*DeleteTrialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrial", params, optFns, addOperationDeleteTrialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrialMiddleware(stack *middleware.Stack, options Options) (err error) {
