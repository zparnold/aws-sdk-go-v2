...
func (c *Client) UpdateMonitoringSchedule(ctx context.Context, params *UpdateMonitoringScheduleInput, optFns ...func(*Options)) (*UpdateMonitoringScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMonitoringSchedule", params, optFns, addOperationUpdateMonitoringScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMonitoringScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
