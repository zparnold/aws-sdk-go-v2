...
func (c *Client) UpdateExperiment(ctx context.Context, params *UpdateExperimentInput, optFns ...func(*Options)) (*UpdateExperimentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateExperiment", params, optFns, addOperationUpdateExperimentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateExperimentMiddleware(stack *middleware.Stack, options Options) (err error) {
