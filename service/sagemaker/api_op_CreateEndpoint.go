...
func (c *Client) CreateEndpoint(ctx context.Context, params *CreateEndpointInput, optFns ...func(*Options)) (*CreateEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEndpoint", params, optFns, addOperationCreateEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
