...
func (c *Client) StopHyperParameterTuningJob(ctx context.Context, params *StopHyperParameterTuningJobInput, optFns ...func(*Options)) (*StopHyperParameterTuningJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopHyperParameterTuningJob", params, optFns, addOperationStopHyperParameterTuningJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopHyperParameterTuningJobMiddleware(stack *middleware.Stack, options Options) (err error) {
