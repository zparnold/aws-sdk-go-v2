...
func (c *Client) ListLabelingJobsForWorkteam(ctx context.Context, params *ListLabelingJobsForWorkteamInput, optFns ...func(*Options)) (*ListLabelingJobsForWorkteamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLabelingJobsForWorkteam", params, optFns, addOperationListLabelingJobsForWorkteamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLabelingJobsForWorkteamMiddleware(stack *middleware.Stack, options Options) (err error) {
