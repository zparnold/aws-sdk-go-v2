...
func (c *Client) CreateCodeRepository(ctx context.Context, params *CreateCodeRepositoryInput, optFns ...func(*Options)) (*CreateCodeRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCodeRepository", params, optFns, addOperationCreateCodeRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCodeRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
