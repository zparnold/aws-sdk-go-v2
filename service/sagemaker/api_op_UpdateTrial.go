...
func (c *Client) UpdateTrial(ctx context.Context, params *UpdateTrialInput, optFns ...func(*Options)) (*UpdateTrialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTrial", params, optFns, addOperationUpdateTrialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTrialMiddleware(stack *middleware.Stack, options Options) (err error) {
