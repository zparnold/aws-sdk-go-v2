...
func (c *Client) UpdateNotebookInstanceLifecycleConfig(ctx context.Context, params *UpdateNotebookInstanceLifecycleConfigInput, optFns ...func(*Options)) (*UpdateNotebookInstanceLifecycleConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNotebookInstanceLifecycleConfig", params, optFns, addOperationUpdateNotebookInstanceLifecycleConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNotebookInstanceLifecycleConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
