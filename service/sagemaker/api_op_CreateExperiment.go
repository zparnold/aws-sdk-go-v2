...
func (c *Client) CreateExperiment(ctx context.Context, params *CreateExperimentInput, optFns ...func(*Options)) (*CreateExperimentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateExperiment", params, optFns, addOperationCreateExperimentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateExperimentMiddleware(stack *middleware.Stack, options Options) (err error) {
