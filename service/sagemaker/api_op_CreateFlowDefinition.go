...
func (c *Client) CreateFlowDefinition(ctx context.Context, params *CreateFlowDefinitionInput, optFns ...func(*Options)) (*CreateFlowDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFlowDefinition", params, optFns, addOperationCreateFlowDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFlowDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
