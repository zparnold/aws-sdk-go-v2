...
func (c *Client) DescribeSubscribedWorkteam(ctx context.Context, params *DescribeSubscribedWorkteamInput, optFns ...func(*Options)) (*DescribeSubscribedWorkteamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSubscribedWorkteam", params, optFns, addOperationDescribeSubscribedWorkteamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSubscribedWorkteamMiddleware(stack *middleware.Stack, options Options) (err error) {
