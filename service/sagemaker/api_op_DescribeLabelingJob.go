...
func (c *Client) DescribeLabelingJob(ctx context.Context, params *DescribeLabelingJobInput, optFns ...func(*Options)) (*DescribeLabelingJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLabelingJob", params, optFns, addOperationDescribeLabelingJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLabelingJobMiddleware(stack *middleware.Stack, options Options) (err error) {
