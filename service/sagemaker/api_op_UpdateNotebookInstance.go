...
func (c *Client) UpdateNotebookInstance(ctx context.Context, params *UpdateNotebookInstanceInput, optFns ...func(*Options)) (*UpdateNotebookInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNotebookInstance", params, optFns, addOperationUpdateNotebookInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNotebookInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
