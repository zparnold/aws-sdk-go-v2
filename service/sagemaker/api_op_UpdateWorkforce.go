...
func (c *Client) UpdateWorkforce(ctx context.Context, params *UpdateWorkforceInput, optFns ...func(*Options)) (*UpdateWorkforceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateWorkforce", params, optFns, addOperationUpdateWorkforceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateWorkforceMiddleware(stack *middleware.Stack, options Options) (err error) {
