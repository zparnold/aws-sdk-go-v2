...
func (c *Client) CreateMonitoringSchedule(ctx context.Context, params *CreateMonitoringScheduleInput, optFns ...func(*Options)) (*CreateMonitoringScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMonitoringSchedule", params, optFns, addOperationCreateMonitoringScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMonitoringScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
