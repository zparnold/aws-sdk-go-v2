...
func (c *Client) DeleteNotebookInstance(ctx context.Context, params *DeleteNotebookInstanceInput, optFns ...func(*Options)) (*DeleteNotebookInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNotebookInstance", params, optFns, addOperationDeleteNotebookInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNotebookInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
