...
func (c *Client) DeleteExperiment(ctx context.Context, params *DeleteExperimentInput, optFns ...func(*Options)) (*DeleteExperimentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteExperiment", params, optFns, addOperationDeleteExperimentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteExperimentMiddleware(stack *middleware.Stack, options Options) (err error) {
