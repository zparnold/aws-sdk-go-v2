...
func (c *Client) CreateApp(ctx context.Context, params *CreateAppInput, optFns ...func(*Options)) (*CreateAppOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApp", params, optFns, addOperationCreateAppMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAppMiddleware(stack *middleware.Stack, options Options) (err error) {
