...
func (c *Client) ListWorkforces(ctx context.Context, params *ListWorkforcesInput, optFns ...func(*Options)) (*ListWorkforcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWorkforces", params, optFns, addOperationListWorkforcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWorkforcesMiddleware(stack *middleware.Stack, options Options) (err error) {
