...
func (c *Client) Search(ctx context.Context, params *SearchInput, optFns ...func(*Options)) (*SearchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Search", params, optFns, addOperationSearchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchMiddleware(stack *middleware.Stack, options Options) (err error) {
