...
func (c *Client) ListCompilationJobs(ctx context.Context, params *ListCompilationJobsInput, optFns ...func(*Options)) (*ListCompilationJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCompilationJobs", params, optFns, addOperationListCompilationJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCompilationJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
