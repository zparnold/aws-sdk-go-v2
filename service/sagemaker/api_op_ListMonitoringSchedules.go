...
func (c *Client) ListMonitoringSchedules(ctx context.Context, params *ListMonitoringSchedulesInput, optFns ...func(*Options)) (*ListMonitoringSchedulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMonitoringSchedules", params, optFns, addOperationListMonitoringSchedulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMonitoringSchedulesMiddleware(stack *middleware.Stack, options Options) (err error) {
