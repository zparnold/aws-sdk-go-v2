...
func (c *Client) ListModels(ctx context.Context, params *ListModelsInput, optFns ...func(*Options)) (*ListModelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListModels", params, optFns, addOperationListModelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListModelsMiddleware(stack *middleware.Stack, options Options) (err error) {
