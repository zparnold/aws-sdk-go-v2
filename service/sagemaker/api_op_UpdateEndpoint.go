...
func (c *Client) UpdateEndpoint(ctx context.Context, params *UpdateEndpointInput, optFns ...func(*Options)) (*UpdateEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEndpoint", params, optFns, addOperationUpdateEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
