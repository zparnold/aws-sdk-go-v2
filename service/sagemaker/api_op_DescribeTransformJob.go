...
func (c *Client) DescribeTransformJob(ctx context.Context, params *DescribeTransformJobInput, optFns ...func(*Options)) (*DescribeTransformJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTransformJob", params, optFns, addOperationDescribeTransformJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTransformJobMiddleware(stack *middleware.Stack, options Options) (err error) {
