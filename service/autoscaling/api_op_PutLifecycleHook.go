...
func (c *Client) PutLifecycleHook(ctx context.Context, params *PutLifecycleHookInput, optFns ...func(*Options)) (*PutLifecycleHookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutLifecycleHook", params, optFns, addOperationPutLifecycleHookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutLifecycleHookMiddleware(stack *middleware.Stack, options Options) (err error) {
