...
func (c *Client) UpdateAutoScalingGroup(ctx context.Context, params *UpdateAutoScalingGroupInput, optFns ...func(*Options)) (*UpdateAutoScalingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAutoScalingGroup", params, optFns, addOperationUpdateAutoScalingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAutoScalingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
