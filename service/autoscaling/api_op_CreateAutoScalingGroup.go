...
func (c *Client) CreateAutoScalingGroup(ctx context.Context, params *CreateAutoScalingGroupInput, optFns ...func(*Options)) (*CreateAutoScalingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAutoScalingGroup", params, optFns, addOperationCreateAutoScalingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAutoScalingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
