...
func (c *Client) CancelInstanceRefresh(ctx context.Context, params *CancelInstanceRefreshInput, optFns ...func(*Options)) (*CancelInstanceRefreshOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelInstanceRefresh", params, optFns, addOperationCancelInstanceRefreshMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelInstanceRefreshMiddleware(stack *middleware.Stack, options Options) (err error) {
