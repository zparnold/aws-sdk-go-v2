...
func (c *Client) DescribeLifecycleHookTypes(ctx context.Context, params *DescribeLifecycleHookTypesInput, optFns ...func(*Options)) (*DescribeLifecycleHookTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLifecycleHookTypes", params, optFns, addOperationDescribeLifecycleHookTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLifecycleHookTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
