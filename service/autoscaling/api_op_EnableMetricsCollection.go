...
func (c *Client) EnableMetricsCollection(ctx context.Context, params *EnableMetricsCollectionInput, optFns ...func(*Options)) (*EnableMetricsCollectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableMetricsCollection", params, optFns, addOperationEnableMetricsCollectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableMetricsCollectionMiddleware(stack *middleware.Stack, options Options) (err error) {
