...
func (c *Client) DescribeAutoScalingGroups(ctx context.Context, params *DescribeAutoScalingGroupsInput, optFns ...func(*Options)) (*DescribeAutoScalingGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAutoScalingGroups", params, optFns, addOperationDescribeAutoScalingGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAutoScalingGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
