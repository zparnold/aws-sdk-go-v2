...
func (c *Client) RecordLifecycleActionHeartbeat(ctx context.Context, params *RecordLifecycleActionHeartbeatInput, optFns ...func(*Options)) (*RecordLifecycleActionHeartbeatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RecordLifecycleActionHeartbeat", params, optFns, addOperationRecordLifecycleActionHeartbeatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRecordLifecycleActionHeartbeatMiddleware(stack *middleware.Stack, options Options) (err error) {
