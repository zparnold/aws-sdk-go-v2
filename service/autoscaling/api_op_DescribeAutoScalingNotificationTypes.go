...
func (c *Client) DescribeAutoScalingNotificationTypes(ctx context.Context, params *DescribeAutoScalingNotificationTypesInput, optFns ...func(*Options)) (*DescribeAutoScalingNotificationTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAutoScalingNotificationTypes", params, optFns, addOperationDescribeAutoScalingNotificationTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAutoScalingNotificationTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
