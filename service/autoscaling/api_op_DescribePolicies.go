...
func (c *Client) DescribePolicies(ctx context.Context, params *DescribePoliciesInput, optFns ...func(*Options)) (*DescribePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePolicies", params, optFns, addOperationDescribePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
