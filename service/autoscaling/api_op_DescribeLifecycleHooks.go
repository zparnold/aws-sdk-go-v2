...
func (c *Client) DescribeLifecycleHooks(ctx context.Context, params *DescribeLifecycleHooksInput, optFns ...func(*Options)) (*DescribeLifecycleHooksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLifecycleHooks", params, optFns, addOperationDescribeLifecycleHooksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLifecycleHooksMiddleware(stack *middleware.Stack, options Options) (err error) {
