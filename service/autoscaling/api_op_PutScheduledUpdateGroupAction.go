...
func (c *Client) PutScheduledUpdateGroupAction(ctx context.Context, params *PutScheduledUpdateGroupActionInput, optFns ...func(*Options)) (*PutScheduledUpdateGroupActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutScheduledUpdateGroupAction", params, optFns, addOperationPutScheduledUpdateGroupActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutScheduledUpdateGroupActionMiddleware(stack *middleware.Stack, options Options) (err error) {
