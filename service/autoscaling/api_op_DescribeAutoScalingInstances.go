...
func (c *Client) DescribeAutoScalingInstances(ctx context.Context, params *DescribeAutoScalingInstancesInput, optFns ...func(*Options)) (*DescribeAutoScalingInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAutoScalingInstances", params, optFns, addOperationDescribeAutoScalingInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAutoScalingInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
