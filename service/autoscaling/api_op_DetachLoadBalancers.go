...
func (c *Client) DetachLoadBalancers(ctx context.Context, params *DetachLoadBalancersInput, optFns ...func(*Options)) (*DetachLoadBalancersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachLoadBalancers", params, optFns, addOperationDetachLoadBalancersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachLoadBalancersMiddleware(stack *middleware.Stack, options Options) (err error) {
