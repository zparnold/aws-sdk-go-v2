...
func (c *Client) CreateLaunchConfiguration(ctx context.Context, params *CreateLaunchConfigurationInput, optFns ...func(*Options)) (*CreateLaunchConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLaunchConfiguration", params, optFns, addOperationCreateLaunchConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLaunchConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
