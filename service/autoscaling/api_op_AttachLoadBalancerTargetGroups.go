...
func (c *Client) AttachLoadBalancerTargetGroups(ctx context.Context, params *AttachLoadBalancerTargetGroupsInput, optFns ...func(*Options)) (*AttachLoadBalancerTargetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachLoadBalancerTargetGroups", params, optFns, addOperationAttachLoadBalancerTargetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachLoadBalancerTargetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
