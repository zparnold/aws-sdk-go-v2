...
func (c *Client) DeleteLaunchConfiguration(ctx context.Context, params *DeleteLaunchConfigurationInput, optFns ...func(*Options)) (*DeleteLaunchConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLaunchConfiguration", params, optFns, addOperationDeleteLaunchConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLaunchConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
