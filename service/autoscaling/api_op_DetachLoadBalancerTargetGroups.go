...
func (c *Client) DetachLoadBalancerTargetGroups(ctx context.Context, params *DetachLoadBalancerTargetGroupsInput, optFns ...func(*Options)) (*DetachLoadBalancerTargetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachLoadBalancerTargetGroups", params, optFns, addOperationDetachLoadBalancerTargetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachLoadBalancerTargetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
