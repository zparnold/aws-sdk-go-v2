...
func (c *Client) ExecutePolicy(ctx context.Context, params *ExecutePolicyInput, optFns ...func(*Options)) (*ExecutePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExecutePolicy", params, optFns, addOperationExecutePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExecutePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
