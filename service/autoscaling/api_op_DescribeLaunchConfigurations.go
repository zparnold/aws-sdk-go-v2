...
func (c *Client) DescribeLaunchConfigurations(ctx context.Context, params *DescribeLaunchConfigurationsInput, optFns ...func(*Options)) (*DescribeLaunchConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLaunchConfigurations", params, optFns, addOperationDescribeLaunchConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLaunchConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
