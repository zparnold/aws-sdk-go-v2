...
func (c *Client) ResumeProcesses(ctx context.Context, params *ResumeProcessesInput, optFns ...func(*Options)) (*ResumeProcessesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResumeProcesses", params, optFns, addOperationResumeProcessesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResumeProcessesMiddleware(stack *middleware.Stack, options Options) (err error) {
