...
func (c *Client) DescribeAdjustmentTypes(ctx context.Context, params *DescribeAdjustmentTypesInput, optFns ...func(*Options)) (*DescribeAdjustmentTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAdjustmentTypes", params, optFns, addOperationDescribeAdjustmentTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAdjustmentTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
