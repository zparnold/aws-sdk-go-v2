...
func (c *Client) SetInstanceHealth(ctx context.Context, params *SetInstanceHealthInput, optFns ...func(*Options)) (*SetInstanceHealthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetInstanceHealth", params, optFns, addOperationSetInstanceHealthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetInstanceHealthMiddleware(stack *middleware.Stack, options Options) (err error) {
