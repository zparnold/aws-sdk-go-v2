...
func (c *Client) StartInstanceRefresh(ctx context.Context, params *StartInstanceRefreshInput, optFns ...func(*Options)) (*StartInstanceRefreshOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartInstanceRefresh", params, optFns, addOperationStartInstanceRefreshMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartInstanceRefreshMiddleware(stack *middleware.Stack, options Options) (err error) {
