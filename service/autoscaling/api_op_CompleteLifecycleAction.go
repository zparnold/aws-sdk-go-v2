...
func (c *Client) CompleteLifecycleAction(ctx context.Context, params *CompleteLifecycleActionInput, optFns ...func(*Options)) (*CompleteLifecycleActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CompleteLifecycleAction", params, optFns, addOperationCompleteLifecycleActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCompleteLifecycleActionMiddleware(stack *middleware.Stack, options Options) (err error) {
