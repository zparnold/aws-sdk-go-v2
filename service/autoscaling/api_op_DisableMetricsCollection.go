...
func (c *Client) DisableMetricsCollection(ctx context.Context, params *DisableMetricsCollectionInput, optFns ...func(*Options)) (*DisableMetricsCollectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableMetricsCollection", params, optFns, addOperationDisableMetricsCollectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableMetricsCollectionMiddleware(stack *middleware.Stack, options Options) (err error) {
