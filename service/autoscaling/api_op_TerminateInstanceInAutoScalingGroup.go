...
func (c *Client) TerminateInstanceInAutoScalingGroup(ctx context.Context, params *TerminateInstanceInAutoScalingGroupInput, optFns ...func(*Options)) (*TerminateInstanceInAutoScalingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateInstanceInAutoScalingGroup", params, optFns, addOperationTerminateInstanceInAutoScalingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateInstanceInAutoScalingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
