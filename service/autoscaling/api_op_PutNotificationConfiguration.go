...
func (c *Client) PutNotificationConfiguration(ctx context.Context, params *PutNotificationConfigurationInput, optFns ...func(*Options)) (*PutNotificationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutNotificationConfiguration", params, optFns, addOperationPutNotificationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutNotificationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
