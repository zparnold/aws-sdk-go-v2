...
func (c *Client) DeleteNotificationConfiguration(ctx context.Context, params *DeleteNotificationConfigurationInput, optFns ...func(*Options)) (*DeleteNotificationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNotificationConfiguration", params, optFns, addOperationDeleteNotificationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNotificationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
