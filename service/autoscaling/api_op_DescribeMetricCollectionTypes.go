...
func (c *Client) DescribeMetricCollectionTypes(ctx context.Context, params *DescribeMetricCollectionTypesInput, optFns ...func(*Options)) (*DescribeMetricCollectionTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMetricCollectionTypes", params, optFns, addOperationDescribeMetricCollectionTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMetricCollectionTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
