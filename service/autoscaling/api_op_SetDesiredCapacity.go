...
func (c *Client) SetDesiredCapacity(ctx context.Context, params *SetDesiredCapacityInput, optFns ...func(*Options)) (*SetDesiredCapacityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetDesiredCapacity", params, optFns, addOperationSetDesiredCapacityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetDesiredCapacityMiddleware(stack *middleware.Stack, options Options) (err error) {
