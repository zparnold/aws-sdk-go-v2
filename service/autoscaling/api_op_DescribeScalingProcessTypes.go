...
func (c *Client) DescribeScalingProcessTypes(ctx context.Context, params *DescribeScalingProcessTypesInput, optFns ...func(*Options)) (*DescribeScalingProcessTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScalingProcessTypes", params, optFns, addOperationDescribeScalingProcessTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScalingProcessTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
