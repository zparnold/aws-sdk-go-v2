...
func (c *Client) DescribeInstanceRefreshes(ctx context.Context, params *DescribeInstanceRefreshesInput, optFns ...func(*Options)) (*DescribeInstanceRefreshesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceRefreshes", params, optFns, addOperationDescribeInstanceRefreshesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceRefreshesMiddleware(stack *middleware.Stack, options Options) (err error) {
