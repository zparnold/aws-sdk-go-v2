...
func (c *Client) AttachInstances(ctx context.Context, params *AttachInstancesInput, optFns ...func(*Options)) (*AttachInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachInstances", params, optFns, addOperationAttachInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
