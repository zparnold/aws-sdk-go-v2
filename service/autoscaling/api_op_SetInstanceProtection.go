...
func (c *Client) SetInstanceProtection(ctx context.Context, params *SetInstanceProtectionInput, optFns ...func(*Options)) (*SetInstanceProtectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetInstanceProtection", params, optFns, addOperationSetInstanceProtectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetInstanceProtectionMiddleware(stack *middleware.Stack, options Options) (err error) {
