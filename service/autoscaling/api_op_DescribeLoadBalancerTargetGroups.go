...
func (c *Client) DescribeLoadBalancerTargetGroups(ctx context.Context, params *DescribeLoadBalancerTargetGroupsInput, optFns ...func(*Options)) (*DescribeLoadBalancerTargetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoadBalancerTargetGroups", params, optFns, addOperationDescribeLoadBalancerTargetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoadBalancerTargetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
