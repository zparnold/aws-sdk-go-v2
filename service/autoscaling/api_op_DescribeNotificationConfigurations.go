...
func (c *Client) DescribeNotificationConfigurations(ctx context.Context, params *DescribeNotificationConfigurationsInput, optFns ...func(*Options)) (*DescribeNotificationConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNotificationConfigurations", params, optFns, addOperationDescribeNotificationConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNotificationConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
