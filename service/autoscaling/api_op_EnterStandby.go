...
func (c *Client) EnterStandby(ctx context.Context, params *EnterStandbyInput, optFns ...func(*Options)) (*EnterStandbyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnterStandby", params, optFns, addOperationEnterStandbyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnterStandbyMiddleware(stack *middleware.Stack, options Options) (err error) {
