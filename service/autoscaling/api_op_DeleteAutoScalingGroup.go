...
func (c *Client) DeleteAutoScalingGroup(ctx context.Context, params *DeleteAutoScalingGroupInput, optFns ...func(*Options)) (*DeleteAutoScalingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAutoScalingGroup", params, optFns, addOperationDeleteAutoScalingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAutoScalingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
