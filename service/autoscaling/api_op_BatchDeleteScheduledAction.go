...
func (c *Client) BatchDeleteScheduledAction(ctx context.Context, params *BatchDeleteScheduledActionInput, optFns ...func(*Options)) (*BatchDeleteScheduledActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeleteScheduledAction", params, optFns, addOperationBatchDeleteScheduledActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeleteScheduledActionMiddleware(stack *middleware.Stack, options Options) (err error) {
