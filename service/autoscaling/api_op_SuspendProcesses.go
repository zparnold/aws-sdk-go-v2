...
func (c *Client) SuspendProcesses(ctx context.Context, params *SuspendProcessesInput, optFns ...func(*Options)) (*SuspendProcessesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SuspendProcesses", params, optFns, addOperationSuspendProcessesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSuspendProcessesMiddleware(stack *middleware.Stack, options Options) (err error) {
