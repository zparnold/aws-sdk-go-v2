...
func (c *Client) CreateOrUpdateTags(ctx context.Context, params *CreateOrUpdateTagsInput, optFns ...func(*Options)) (*CreateOrUpdateTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOrUpdateTags", params, optFns, addOperationCreateOrUpdateTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOrUpdateTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
