...
func (c *Client) AttachLoadBalancers(ctx context.Context, params *AttachLoadBalancersInput, optFns ...func(*Options)) (*AttachLoadBalancersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachLoadBalancers", params, optFns, addOperationAttachLoadBalancersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachLoadBalancersMiddleware(stack *middleware.Stack, options Options) (err error) {
