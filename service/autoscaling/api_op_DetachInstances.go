...
func (c *Client) DetachInstances(ctx context.Context, params *DetachInstancesInput, optFns ...func(*Options)) (*DetachInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachInstances", params, optFns, addOperationDetachInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
