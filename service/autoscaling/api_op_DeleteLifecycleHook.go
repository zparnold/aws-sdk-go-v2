...
func (c *Client) DeleteLifecycleHook(ctx context.Context, params *DeleteLifecycleHookInput, optFns ...func(*Options)) (*DeleteLifecycleHookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLifecycleHook", params, optFns, addOperationDeleteLifecycleHookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLifecycleHookMiddleware(stack *middleware.Stack, options Options) (err error) {
