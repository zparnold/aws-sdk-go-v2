...
func (c *Client) BatchPutScheduledUpdateGroupAction(ctx context.Context, params *BatchPutScheduledUpdateGroupActionInput, optFns ...func(*Options)) (*BatchPutScheduledUpdateGroupActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchPutScheduledUpdateGroupAction", params, optFns, addOperationBatchPutScheduledUpdateGroupActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchPutScheduledUpdateGroupActionMiddleware(stack *middleware.Stack, options Options) (err error) {
