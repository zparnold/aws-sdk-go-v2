...
func (c *Client) ExitStandby(ctx context.Context, params *ExitStandbyInput, optFns ...func(*Options)) (*ExitStandbyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExitStandby", params, optFns, addOperationExitStandbyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExitStandbyMiddleware(stack *middleware.Stack, options Options) (err error) {
