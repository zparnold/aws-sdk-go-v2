...
func (c *Client) DescribeConnections(ctx context.Context, params *DescribeConnectionsInput, optFns ...func(*Options)) (*DescribeConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConnections", params, optFns, addOperationDescribeConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
