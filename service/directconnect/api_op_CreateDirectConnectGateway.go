...
func (c *Client) CreateDirectConnectGateway(ctx context.Context, params *CreateDirectConnectGatewayInput, optFns ...func(*Options)) (*CreateDirectConnectGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDirectConnectGateway", params, optFns, addOperationCreateDirectConnectGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDirectConnectGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
