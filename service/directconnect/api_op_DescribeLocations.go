...
func (c *Client) DescribeLocations(ctx context.Context, params *DescribeLocationsInput, optFns ...func(*Options)) (*DescribeLocationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocations", params, optFns, addOperationDescribeLocationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocationsMiddleware(stack *middleware.Stack, options Options) (err error) {
