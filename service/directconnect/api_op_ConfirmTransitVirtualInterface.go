...
func (c *Client) ConfirmTransitVirtualInterface(ctx context.Context, params *ConfirmTransitVirtualInterfaceInput, optFns ...func(*Options)) (*ConfirmTransitVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmTransitVirtualInterface", params, optFns, addOperationConfirmTransitVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmTransitVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
