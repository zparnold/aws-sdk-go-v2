...
func (c *Client) DescribeDirectConnectGatewayAssociationProposals(ctx context.Context, params *DescribeDirectConnectGatewayAssociationProposalsInput, optFns ...func(*Options)) (*DescribeDirectConnectGatewayAssociationProposalsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDirectConnectGatewayAssociationProposals", params, optFns, addOperationDescribeDirectConnectGatewayAssociationProposalsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDirectConnectGatewayAssociationProposalsMiddleware(stack *middleware.Stack, options Options) (err error) {
