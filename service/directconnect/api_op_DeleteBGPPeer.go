...
func (c *Client) DeleteBGPPeer(ctx context.Context, params *DeleteBGPPeerInput, optFns ...func(*Options)) (*DeleteBGPPeerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBGPPeer", params, optFns, addOperationDeleteBGPPeerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBGPPeerMiddleware(stack *middleware.Stack, options Options) (err error) {
