...
func (c *Client) CreateLag(ctx context.Context, params *CreateLagInput, optFns ...func(*Options)) (*CreateLagOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLag", params, optFns, addOperationCreateLagMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLagMiddleware(stack *middleware.Stack, options Options) (err error) {
