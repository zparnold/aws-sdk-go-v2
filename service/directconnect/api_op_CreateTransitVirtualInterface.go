...
func (c *Client) CreateTransitVirtualInterface(ctx context.Context, params *CreateTransitVirtualInterfaceInput, optFns ...func(*Options)) (*CreateTransitVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTransitVirtualInterface", params, optFns, addOperationCreateTransitVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTransitVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
