...
func (c *Client) StartBgpFailoverTest(ctx context.Context, params *StartBgpFailoverTestInput, optFns ...func(*Options)) (*StartBgpFailoverTestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartBgpFailoverTest", params, optFns, addOperationStartBgpFailoverTestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartBgpFailoverTestMiddleware(stack *middleware.Stack, options Options) (err error) {
