...
func (c *Client) DeleteDirectConnectGateway(ctx context.Context, params *DeleteDirectConnectGatewayInput, optFns ...func(*Options)) (*DeleteDirectConnectGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDirectConnectGateway", params, optFns, addOperationDeleteDirectConnectGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDirectConnectGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
