...
func (c *Client) AssociateHostedConnection(ctx context.Context, params *AssociateHostedConnectionInput, optFns ...func(*Options)) (*AssociateHostedConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateHostedConnection", params, optFns, addOperationAssociateHostedConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateHostedConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
