...
func (c *Client) StopBgpFailoverTest(ctx context.Context, params *StopBgpFailoverTestInput, optFns ...func(*Options)) (*StopBgpFailoverTestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopBgpFailoverTest", params, optFns, addOperationStopBgpFailoverTestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopBgpFailoverTestMiddleware(stack *middleware.Stack, options Options) (err error) {
