...
func (c *Client) AllocateConnectionOnInterconnect(ctx context.Context, params *AllocateConnectionOnInterconnectInput, optFns ...func(*Options)) (*AllocateConnectionOnInterconnectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocateConnectionOnInterconnect", params, optFns, addOperationAllocateConnectionOnInterconnectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocateConnectionOnInterconnectMiddleware(stack *middleware.Stack, options Options) (err error) {
