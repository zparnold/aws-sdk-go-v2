...
func (c *Client) DescribeInterconnectLoa(ctx context.Context, params *DescribeInterconnectLoaInput, optFns ...func(*Options)) (*DescribeInterconnectLoaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInterconnectLoa", params, optFns, addOperationDescribeInterconnectLoaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInterconnectLoaMiddleware(stack *middleware.Stack, options Options) (err error) {
