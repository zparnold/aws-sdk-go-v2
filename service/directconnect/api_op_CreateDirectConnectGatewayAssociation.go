...
func (c *Client) CreateDirectConnectGatewayAssociation(ctx context.Context, params *CreateDirectConnectGatewayAssociationInput, optFns ...func(*Options)) (*CreateDirectConnectGatewayAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDirectConnectGatewayAssociation", params, optFns, addOperationCreateDirectConnectGatewayAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDirectConnectGatewayAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
