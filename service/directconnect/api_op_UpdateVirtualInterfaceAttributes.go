...
func (c *Client) UpdateVirtualInterfaceAttributes(ctx context.Context, params *UpdateVirtualInterfaceAttributesInput, optFns ...func(*Options)) (*UpdateVirtualInterfaceAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVirtualInterfaceAttributes", params, optFns, addOperationUpdateVirtualInterfaceAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVirtualInterfaceAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
