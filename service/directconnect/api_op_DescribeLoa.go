...
func (c *Client) DescribeLoa(ctx context.Context, params *DescribeLoaInput, optFns ...func(*Options)) (*DescribeLoaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoa", params, optFns, addOperationDescribeLoaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoaMiddleware(stack *middleware.Stack, options Options) (err error) {
