...
func (c *Client) AllocatePrivateVirtualInterface(ctx context.Context, params *AllocatePrivateVirtualInterfaceInput, optFns ...func(*Options)) (*AllocatePrivateVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocatePrivateVirtualInterface", params, optFns, addOperationAllocatePrivateVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocatePrivateVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
