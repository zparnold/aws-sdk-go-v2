...
func (c *Client) DeleteInterconnect(ctx context.Context, params *DeleteInterconnectInput, optFns ...func(*Options)) (*DeleteInterconnectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInterconnect", params, optFns, addOperationDeleteInterconnectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInterconnectMiddleware(stack *middleware.Stack, options Options) (err error) {
