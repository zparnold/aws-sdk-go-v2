...
func (c *Client) DescribeInterconnects(ctx context.Context, params *DescribeInterconnectsInput, optFns ...func(*Options)) (*DescribeInterconnectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInterconnects", params, optFns, addOperationDescribeInterconnectsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInterconnectsMiddleware(stack *middleware.Stack, options Options) (err error) {
