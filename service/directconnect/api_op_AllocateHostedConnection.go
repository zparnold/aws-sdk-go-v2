...
func (c *Client) AllocateHostedConnection(ctx context.Context, params *AllocateHostedConnectionInput, optFns ...func(*Options)) (*AllocateHostedConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocateHostedConnection", params, optFns, addOperationAllocateHostedConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocateHostedConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
