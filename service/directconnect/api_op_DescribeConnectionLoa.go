...
func (c *Client) DescribeConnectionLoa(ctx context.Context, params *DescribeConnectionLoaInput, optFns ...func(*Options)) (*DescribeConnectionLoaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConnectionLoa", params, optFns, addOperationDescribeConnectionLoaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConnectionLoaMiddleware(stack *middleware.Stack, options Options) (err error) {
