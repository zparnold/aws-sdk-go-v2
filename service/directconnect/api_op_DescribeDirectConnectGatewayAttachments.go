...
func (c *Client) DescribeDirectConnectGatewayAttachments(ctx context.Context, params *DescribeDirectConnectGatewayAttachmentsInput, optFns ...func(*Options)) (*DescribeDirectConnectGatewayAttachmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDirectConnectGatewayAttachments", params, optFns, addOperationDescribeDirectConnectGatewayAttachmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDirectConnectGatewayAttachmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
