...
func (c *Client) DescribeVirtualInterfaces(ctx context.Context, params *DescribeVirtualInterfacesInput, optFns ...func(*Options)) (*DescribeVirtualInterfacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVirtualInterfaces", params, optFns, addOperationDescribeVirtualInterfacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVirtualInterfacesMiddleware(stack *middleware.Stack, options Options) (err error) {
