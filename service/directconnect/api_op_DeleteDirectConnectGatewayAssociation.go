...
func (c *Client) DeleteDirectConnectGatewayAssociation(ctx context.Context, params *DeleteDirectConnectGatewayAssociationInput, optFns ...func(*Options)) (*DeleteDirectConnectGatewayAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDirectConnectGatewayAssociation", params, optFns, addOperationDeleteDirectConnectGatewayAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDirectConnectGatewayAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
