...
func (c *Client) DescribeHostedConnections(ctx context.Context, params *DescribeHostedConnectionsInput, optFns ...func(*Options)) (*DescribeHostedConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHostedConnections", params, optFns, addOperationDescribeHostedConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHostedConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
