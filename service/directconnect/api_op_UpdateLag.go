...
func (c *Client) UpdateLag(ctx context.Context, params *UpdateLagInput, optFns ...func(*Options)) (*UpdateLagOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLag", params, optFns, addOperationUpdateLagMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLagMiddleware(stack *middleware.Stack, options Options) (err error) {
