...
func (c *Client) CreateBGPPeer(ctx context.Context, params *CreateBGPPeerInput, optFns ...func(*Options)) (*CreateBGPPeerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBGPPeer", params, optFns, addOperationCreateBGPPeerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBGPPeerMiddleware(stack *middleware.Stack, options Options) (err error) {
