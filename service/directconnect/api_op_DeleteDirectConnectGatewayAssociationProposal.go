...
func (c *Client) DeleteDirectConnectGatewayAssociationProposal(ctx context.Context, params *DeleteDirectConnectGatewayAssociationProposalInput, optFns ...func(*Options)) (*DeleteDirectConnectGatewayAssociationProposalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDirectConnectGatewayAssociationProposal", params, optFns, addOperationDeleteDirectConnectGatewayAssociationProposalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDirectConnectGatewayAssociationProposalMiddleware(stack *middleware.Stack, options Options) (err error) {
