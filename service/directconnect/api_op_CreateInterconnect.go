...
func (c *Client) CreateInterconnect(ctx context.Context, params *CreateInterconnectInput, optFns ...func(*Options)) (*CreateInterconnectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInterconnect", params, optFns, addOperationCreateInterconnectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInterconnectMiddleware(stack *middleware.Stack, options Options) (err error) {
