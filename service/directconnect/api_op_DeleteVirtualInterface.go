...
func (c *Client) DeleteVirtualInterface(ctx context.Context, params *DeleteVirtualInterfaceInput, optFns ...func(*Options)) (*DeleteVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVirtualInterface", params, optFns, addOperationDeleteVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
