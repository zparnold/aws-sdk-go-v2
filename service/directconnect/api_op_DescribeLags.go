...
func (c *Client) DescribeLags(ctx context.Context, params *DescribeLagsInput, optFns ...func(*Options)) (*DescribeLagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLags", params, optFns, addOperationDescribeLagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLagsMiddleware(stack *middleware.Stack, options Options) (err error) {
