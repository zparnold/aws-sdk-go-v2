...
func (c *Client) DisassociateConnectionFromLag(ctx context.Context, params *DisassociateConnectionFromLagInput, optFns ...func(*Options)) (*DisassociateConnectionFromLagOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateConnectionFromLag", params, optFns, addOperationDisassociateConnectionFromLagMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateConnectionFromLagMiddleware(stack *middleware.Stack, options Options) (err error) {
