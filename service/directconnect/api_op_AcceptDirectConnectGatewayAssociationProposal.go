...
func (c *Client) AcceptDirectConnectGatewayAssociationProposal(ctx context.Context, params *AcceptDirectConnectGatewayAssociationProposalInput, optFns ...func(*Options)) (*AcceptDirectConnectGatewayAssociationProposalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptDirectConnectGatewayAssociationProposal", params, optFns, addOperationAcceptDirectConnectGatewayAssociationProposalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptDirectConnectGatewayAssociationProposalMiddleware(stack *middleware.Stack, options Options) (err error) {
