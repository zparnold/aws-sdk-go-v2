...
func (c *Client) ConfirmPrivateVirtualInterface(ctx context.Context, params *ConfirmPrivateVirtualInterfaceInput, optFns ...func(*Options)) (*ConfirmPrivateVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmPrivateVirtualInterface", params, optFns, addOperationConfirmPrivateVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmPrivateVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
