...
func (c *Client) DescribeVirtualGateways(ctx context.Context, params *DescribeVirtualGatewaysInput, optFns ...func(*Options)) (*DescribeVirtualGatewaysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVirtualGateways", params, optFns, addOperationDescribeVirtualGatewaysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVirtualGatewaysMiddleware(stack *middleware.Stack, options Options) (err error) {
