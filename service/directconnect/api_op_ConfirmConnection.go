...
func (c *Client) ConfirmConnection(ctx context.Context, params *ConfirmConnectionInput, optFns ...func(*Options)) (*ConfirmConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmConnection", params, optFns, addOperationConfirmConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
