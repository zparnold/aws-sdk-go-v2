...
func (c *Client) CreatePrivateVirtualInterface(ctx context.Context, params *CreatePrivateVirtualInterfaceInput, optFns ...func(*Options)) (*CreatePrivateVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePrivateVirtualInterface", params, optFns, addOperationCreatePrivateVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePrivateVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
