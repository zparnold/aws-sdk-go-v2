...
func (c *Client) AssociateConnectionWithLag(ctx context.Context, params *AssociateConnectionWithLagInput, optFns ...func(*Options)) (*AssociateConnectionWithLagOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateConnectionWithLag", params, optFns, addOperationAssociateConnectionWithLagMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateConnectionWithLagMiddleware(stack *middleware.Stack, options Options) (err error) {
