...
func (c *Client) ListVirtualInterfaceTestHistory(ctx context.Context, params *ListVirtualInterfaceTestHistoryInput, optFns ...func(*Options)) (*ListVirtualInterfaceTestHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVirtualInterfaceTestHistory", params, optFns, addOperationListVirtualInterfaceTestHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVirtualInterfaceTestHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
