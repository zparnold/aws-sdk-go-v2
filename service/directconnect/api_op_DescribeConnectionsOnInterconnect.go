...
func (c *Client) DescribeConnectionsOnInterconnect(ctx context.Context, params *DescribeConnectionsOnInterconnectInput, optFns ...func(*Options)) (*DescribeConnectionsOnInterconnectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConnectionsOnInterconnect", params, optFns, addOperationDescribeConnectionsOnInterconnectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConnectionsOnInterconnectMiddleware(stack *middleware.Stack, options Options) (err error) {
