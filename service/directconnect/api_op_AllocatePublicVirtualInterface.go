...
func (c *Client) AllocatePublicVirtualInterface(ctx context.Context, params *AllocatePublicVirtualInterfaceInput, optFns ...func(*Options)) (*AllocatePublicVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocatePublicVirtualInterface", params, optFns, addOperationAllocatePublicVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocatePublicVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
