...
func (c *Client) AssociateVirtualInterface(ctx context.Context, params *AssociateVirtualInterfaceInput, optFns ...func(*Options)) (*AssociateVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateVirtualInterface", params, optFns, addOperationAssociateVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
