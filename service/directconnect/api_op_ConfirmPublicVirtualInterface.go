...
func (c *Client) ConfirmPublicVirtualInterface(ctx context.Context, params *ConfirmPublicVirtualInterfaceInput, optFns ...func(*Options)) (*ConfirmPublicVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmPublicVirtualInterface", params, optFns, addOperationConfirmPublicVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmPublicVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
