...
func (c *Client) UpdateDirectConnectGatewayAssociation(ctx context.Context, params *UpdateDirectConnectGatewayAssociationInput, optFns ...func(*Options)) (*UpdateDirectConnectGatewayAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDirectConnectGatewayAssociation", params, optFns, addOperationUpdateDirectConnectGatewayAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDirectConnectGatewayAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
