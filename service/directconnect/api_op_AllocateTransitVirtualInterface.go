...
func (c *Client) AllocateTransitVirtualInterface(ctx context.Context, params *AllocateTransitVirtualInterfaceInput, optFns ...func(*Options)) (*AllocateTransitVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocateTransitVirtualInterface", params, optFns, addOperationAllocateTransitVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocateTransitVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
