...
func (c *Client) DeleteLag(ctx context.Context, params *DeleteLagInput, optFns ...func(*Options)) (*DeleteLagOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLag", params, optFns, addOperationDeleteLagMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLagMiddleware(stack *middleware.Stack, options Options) (err error) {
