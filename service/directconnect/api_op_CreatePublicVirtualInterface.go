...
func (c *Client) CreatePublicVirtualInterface(ctx context.Context, params *CreatePublicVirtualInterfaceInput, optFns ...func(*Options)) (*CreatePublicVirtualInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePublicVirtualInterface", params, optFns, addOperationCreatePublicVirtualInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePublicVirtualInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
