...
func (c *Client) DeleteMembers(ctx context.Context, params *DeleteMembersInput, optFns ...func(*Options)) (*DeleteMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMembers", params, optFns, addOperationDeleteMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
