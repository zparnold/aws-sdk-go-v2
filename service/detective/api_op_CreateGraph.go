...
func (c *Client) CreateGraph(ctx context.Context, params *CreateGraphInput, optFns ...func(*Options)) (*CreateGraphOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGraph", params, optFns, addOperationCreateGraphMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGraphMiddleware(stack *middleware.Stack, options Options) (err error) {
