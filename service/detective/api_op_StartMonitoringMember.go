...
func (c *Client) StartMonitoringMember(ctx context.Context, params *StartMonitoringMemberInput, optFns ...func(*Options)) (*StartMonitoringMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMonitoringMember", params, optFns, addOperationStartMonitoringMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMonitoringMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
