...
func (c *Client) ListGraphs(ctx context.Context, params *ListGraphsInput, optFns ...func(*Options)) (*ListGraphsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGraphs", params, optFns, addOperationListGraphsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGraphsMiddleware(stack *middleware.Stack, options Options) (err error) {
