...
func (c *Client) CreateDataRepositoryTask(ctx context.Context, params *CreateDataRepositoryTaskInput, optFns ...func(*Options)) (*CreateDataRepositoryTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDataRepositoryTask", params, optFns, addOperationCreateDataRepositoryTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDataRepositoryTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
