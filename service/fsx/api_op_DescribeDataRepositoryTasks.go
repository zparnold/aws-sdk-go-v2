...
func (c *Client) DescribeDataRepositoryTasks(ctx context.Context, params *DescribeDataRepositoryTasksInput, optFns ...func(*Options)) (*DescribeDataRepositoryTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDataRepositoryTasks", params, optFns, addOperationDescribeDataRepositoryTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDataRepositoryTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
