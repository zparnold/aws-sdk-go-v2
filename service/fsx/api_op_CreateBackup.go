...
func (c *Client) CreateBackup(ctx context.Context, params *CreateBackupInput, optFns ...func(*Options)) (*CreateBackupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBackup", params, optFns, addOperationCreateBackupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBackupMiddleware(stack *middleware.Stack, options Options) (err error) {
