...
func (c *Client) CreateFileSystemFromBackup(ctx context.Context, params *CreateFileSystemFromBackupInput, optFns ...func(*Options)) (*CreateFileSystemFromBackupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFileSystemFromBackup", params, optFns, addOperationCreateFileSystemFromBackupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFileSystemFromBackupMiddleware(stack *middleware.Stack, options Options) (err error) {
