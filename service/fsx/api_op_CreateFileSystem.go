...
func (c *Client) CreateFileSystem(ctx context.Context, params *CreateFileSystemInput, optFns ...func(*Options)) (*CreateFileSystemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFileSystem", params, optFns, addOperationCreateFileSystemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFileSystemMiddleware(stack *middleware.Stack, options Options) (err error) {
