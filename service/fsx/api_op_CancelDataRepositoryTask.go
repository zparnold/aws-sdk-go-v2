...
func (c *Client) CancelDataRepositoryTask(ctx context.Context, params *CancelDataRepositoryTaskInput, optFns ...func(*Options)) (*CancelDataRepositoryTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelDataRepositoryTask", params, optFns, addOperationCancelDataRepositoryTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelDataRepositoryTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
