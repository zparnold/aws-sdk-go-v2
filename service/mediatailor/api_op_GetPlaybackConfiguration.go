...
func (c *Client) GetPlaybackConfiguration(ctx context.Context, params *GetPlaybackConfigurationInput, optFns ...func(*Options)) (*GetPlaybackConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPlaybackConfiguration", params, optFns, addOperationGetPlaybackConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPlaybackConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
