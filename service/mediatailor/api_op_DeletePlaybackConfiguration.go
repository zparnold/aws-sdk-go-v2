...
func (c *Client) DeletePlaybackConfiguration(ctx context.Context, params *DeletePlaybackConfigurationInput, optFns ...func(*Options)) (*DeletePlaybackConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePlaybackConfiguration", params, optFns, addOperationDeletePlaybackConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePlaybackConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
