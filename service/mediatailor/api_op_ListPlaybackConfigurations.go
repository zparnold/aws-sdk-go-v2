...
func (c *Client) ListPlaybackConfigurations(ctx context.Context, params *ListPlaybackConfigurationsInput, optFns ...func(*Options)) (*ListPlaybackConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPlaybackConfigurations", params, optFns, addOperationListPlaybackConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPlaybackConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
