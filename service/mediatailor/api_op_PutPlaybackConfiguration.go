...
func (c *Client) PutPlaybackConfiguration(ctx context.Context, params *PutPlaybackConfigurationInput, optFns ...func(*Options)) (*PutPlaybackConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutPlaybackConfiguration", params, optFns, addOperationPutPlaybackConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutPlaybackConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
