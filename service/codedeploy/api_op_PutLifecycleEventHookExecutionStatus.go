...
func (c *Client) PutLifecycleEventHookExecutionStatus(ctx context.Context, params *PutLifecycleEventHookExecutionStatusInput, optFns ...func(*Options)) (*PutLifecycleEventHookExecutionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutLifecycleEventHookExecutionStatus", params, optFns, addOperationPutLifecycleEventHookExecutionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutLifecycleEventHookExecutionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
