...
func (c *Client) BatchGetOnPremisesInstances(ctx context.Context, params *BatchGetOnPremisesInstancesInput, optFns ...func(*Options)) (*BatchGetOnPremisesInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetOnPremisesInstances", params, optFns, addOperationBatchGetOnPremisesInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetOnPremisesInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
