...
func (c *Client) ContinueDeployment(ctx context.Context, params *ContinueDeploymentInput, optFns ...func(*Options)) (*ContinueDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ContinueDeployment", params, optFns, addOperationContinueDeploymentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationContinueDeploymentMiddleware(stack *middleware.Stack, options Options) (err error) {
