...
func (c *Client) DeleteDeploymentConfig(ctx context.Context, params *DeleteDeploymentConfigInput, optFns ...func(*Options)) (*DeleteDeploymentConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeploymentConfig", params, optFns, addOperationDeleteDeploymentConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeploymentConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
