...
func (c *Client) ListOnPremisesInstances(ctx context.Context, params *ListOnPremisesInstancesInput, optFns ...func(*Options)) (*ListOnPremisesInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOnPremisesInstances", params, optFns, addOperationListOnPremisesInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOnPremisesInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
