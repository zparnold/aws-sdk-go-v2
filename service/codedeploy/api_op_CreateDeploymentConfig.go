...
func (c *Client) CreateDeploymentConfig(ctx context.Context, params *CreateDeploymentConfigInput, optFns ...func(*Options)) (*CreateDeploymentConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDeploymentConfig", params, optFns, addOperationCreateDeploymentConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDeploymentConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
