...
func (c *Client) RegisterOnPremisesInstance(ctx context.Context, params *RegisterOnPremisesInstanceInput, optFns ...func(*Options)) (*RegisterOnPremisesInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterOnPremisesInstance", params, optFns, addOperationRegisterOnPremisesInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterOnPremisesInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
