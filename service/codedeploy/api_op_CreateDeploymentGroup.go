...
func (c *Client) CreateDeploymentGroup(ctx context.Context, params *CreateDeploymentGroupInput, optFns ...func(*Options)) (*CreateDeploymentGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDeploymentGroup", params, optFns, addOperationCreateDeploymentGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDeploymentGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
