...
func (c *Client) AddTagsToOnPremisesInstances(ctx context.Context, params *AddTagsToOnPremisesInstancesInput, optFns ...func(*Options)) (*AddTagsToOnPremisesInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddTagsToOnPremisesInstances", params, optFns, addOperationAddTagsToOnPremisesInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddTagsToOnPremisesInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
