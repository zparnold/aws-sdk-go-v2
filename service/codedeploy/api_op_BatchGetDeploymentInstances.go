...
func (c *Client) BatchGetDeploymentInstances(ctx context.Context, params *BatchGetDeploymentInstancesInput, optFns ...func(*Options)) (*BatchGetDeploymentInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetDeploymentInstances", params, optFns, addOperationBatchGetDeploymentInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetDeploymentInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
