...
func (c *Client) GetDeploymentGroup(ctx context.Context, params *GetDeploymentGroupInput, optFns ...func(*Options)) (*GetDeploymentGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeploymentGroup", params, optFns, addOperationGetDeploymentGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeploymentGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
