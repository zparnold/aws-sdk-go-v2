...
func (c *Client) DeleteDeploymentGroup(ctx context.Context, params *DeleteDeploymentGroupInput, optFns ...func(*Options)) (*DeleteDeploymentGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeploymentGroup", params, optFns, addOperationDeleteDeploymentGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeploymentGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
