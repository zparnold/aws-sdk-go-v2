...
func (c *Client) RegisterApplicationRevision(ctx context.Context, params *RegisterApplicationRevisionInput, optFns ...func(*Options)) (*RegisterApplicationRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterApplicationRevision", params, optFns, addOperationRegisterApplicationRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterApplicationRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
