...
func (c *Client) BatchGetDeployments(ctx context.Context, params *BatchGetDeploymentsInput, optFns ...func(*Options)) (*BatchGetDeploymentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetDeployments", params, optFns, addOperationBatchGetDeploymentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetDeploymentsMiddleware(stack *middleware.Stack, options Options) (err error) {
