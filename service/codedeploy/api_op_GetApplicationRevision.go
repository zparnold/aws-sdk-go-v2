...
func (c *Client) GetApplicationRevision(ctx context.Context, params *GetApplicationRevisionInput, optFns ...func(*Options)) (*GetApplicationRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApplicationRevision", params, optFns, addOperationGetApplicationRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApplicationRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
