...
func (c *Client) GetDeploymentConfig(ctx context.Context, params *GetDeploymentConfigInput, optFns ...func(*Options)) (*GetDeploymentConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeploymentConfig", params, optFns, addOperationGetDeploymentConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeploymentConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
