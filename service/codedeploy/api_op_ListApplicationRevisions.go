...
func (c *Client) ListApplicationRevisions(ctx context.Context, params *ListApplicationRevisionsInput, optFns ...func(*Options)) (*ListApplicationRevisionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListApplicationRevisions", params, optFns, addOperationListApplicationRevisionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListApplicationRevisionsMiddleware(stack *middleware.Stack, options Options) (err error) {
