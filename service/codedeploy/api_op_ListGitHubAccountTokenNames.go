...
func (c *Client) ListGitHubAccountTokenNames(ctx context.Context, params *ListGitHubAccountTokenNamesInput, optFns ...func(*Options)) (*ListGitHubAccountTokenNamesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGitHubAccountTokenNames", params, optFns, addOperationListGitHubAccountTokenNamesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGitHubAccountTokenNamesMiddleware(stack *middleware.Stack, options Options) (err error) {
