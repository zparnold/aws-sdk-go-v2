...
func (c *Client) DeregisterOnPremisesInstance(ctx context.Context, params *DeregisterOnPremisesInstanceInput, optFns ...func(*Options)) (*DeregisterOnPremisesInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterOnPremisesInstance", params, optFns, addOperationDeregisterOnPremisesInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterOnPremisesInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
