...
func (c *Client) GetDeploymentInstance(ctx context.Context, params *GetDeploymentInstanceInput, optFns ...func(*Options)) (*GetDeploymentInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeploymentInstance", params, optFns, addOperationGetDeploymentInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeploymentInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
