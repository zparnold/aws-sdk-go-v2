...
func (c *Client) GetOnPremisesInstance(ctx context.Context, params *GetOnPremisesInstanceInput, optFns ...func(*Options)) (*GetOnPremisesInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOnPremisesInstance", params, optFns, addOperationGetOnPremisesInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOnPremisesInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
