...
func (c *Client) DeleteResourcesByExternalId(ctx context.Context, params *DeleteResourcesByExternalIdInput, optFns ...func(*Options)) (*DeleteResourcesByExternalIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResourcesByExternalId", params, optFns, addOperationDeleteResourcesByExternalIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResourcesByExternalIdMiddleware(stack *middleware.Stack, options Options) (err error) {
