...
func (c *Client) RemoveTagsFromOnPremisesInstances(ctx context.Context, params *RemoveTagsFromOnPremisesInstancesInput, optFns ...func(*Options)) (*RemoveTagsFromOnPremisesInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveTagsFromOnPremisesInstances", params, optFns, addOperationRemoveTagsFromOnPremisesInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveTagsFromOnPremisesInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
