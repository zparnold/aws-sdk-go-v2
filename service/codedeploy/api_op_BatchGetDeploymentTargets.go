...
func (c *Client) BatchGetDeploymentTargets(ctx context.Context, params *BatchGetDeploymentTargetsInput, optFns ...func(*Options)) (*BatchGetDeploymentTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetDeploymentTargets", params, optFns, addOperationBatchGetDeploymentTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetDeploymentTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
