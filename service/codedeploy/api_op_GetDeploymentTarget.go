...
func (c *Client) GetDeploymentTarget(ctx context.Context, params *GetDeploymentTargetInput, optFns ...func(*Options)) (*GetDeploymentTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeploymentTarget", params, optFns, addOperationGetDeploymentTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeploymentTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
