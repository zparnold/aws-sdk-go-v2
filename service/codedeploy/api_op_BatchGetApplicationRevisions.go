...
func (c *Client) BatchGetApplicationRevisions(ctx context.Context, params *BatchGetApplicationRevisionsInput, optFns ...func(*Options)) (*BatchGetApplicationRevisionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetApplicationRevisions", params, optFns, addOperationBatchGetApplicationRevisionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetApplicationRevisionsMiddleware(stack *middleware.Stack, options Options) (err error) {
