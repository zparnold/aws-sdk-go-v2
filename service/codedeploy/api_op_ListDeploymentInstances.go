...
func (c *Client) ListDeploymentInstances(ctx context.Context, params *ListDeploymentInstancesInput, optFns ...func(*Options)) (*ListDeploymentInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeploymentInstances", params, optFns, addOperationListDeploymentInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeploymentInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
