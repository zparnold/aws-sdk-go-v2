...
func (c *Client) ListDeploymentConfigs(ctx context.Context, params *ListDeploymentConfigsInput, optFns ...func(*Options)) (*ListDeploymentConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeploymentConfigs", params, optFns, addOperationListDeploymentConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeploymentConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
