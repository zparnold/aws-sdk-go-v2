...
func (c *Client) BatchGetDeploymentGroups(ctx context.Context, params *BatchGetDeploymentGroupsInput, optFns ...func(*Options)) (*BatchGetDeploymentGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetDeploymentGroups", params, optFns, addOperationBatchGetDeploymentGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetDeploymentGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
