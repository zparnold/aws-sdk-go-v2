...
func (c *Client) SkipWaitTimeForInstanceTermination(ctx context.Context, params *SkipWaitTimeForInstanceTerminationInput, optFns ...func(*Options)) (*SkipWaitTimeForInstanceTerminationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SkipWaitTimeForInstanceTermination", params, optFns, addOperationSkipWaitTimeForInstanceTerminationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSkipWaitTimeForInstanceTerminationMiddleware(stack *middleware.Stack, options Options) (err error) {
