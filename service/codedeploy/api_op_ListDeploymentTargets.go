...
func (c *Client) ListDeploymentTargets(ctx context.Context, params *ListDeploymentTargetsInput, optFns ...func(*Options)) (*ListDeploymentTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeploymentTargets", params, optFns, addOperationListDeploymentTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeploymentTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
