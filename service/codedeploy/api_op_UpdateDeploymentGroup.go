...
func (c *Client) UpdateDeploymentGroup(ctx context.Context, params *UpdateDeploymentGroupInput, optFns ...func(*Options)) (*UpdateDeploymentGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDeploymentGroup", params, optFns, addOperationUpdateDeploymentGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDeploymentGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
