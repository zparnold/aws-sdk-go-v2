...
func (c *Client) DeleteWorkspaceImage(ctx context.Context, params *DeleteWorkspaceImageInput, optFns ...func(*Options)) (*DeleteWorkspaceImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWorkspaceImage", params, optFns, addOperationDeleteWorkspaceImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWorkspaceImageMiddleware(stack *middleware.Stack, options Options) (err error) {
