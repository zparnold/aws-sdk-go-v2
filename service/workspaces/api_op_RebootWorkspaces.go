...
func (c *Client) RebootWorkspaces(ctx context.Context, params *RebootWorkspacesInput, optFns ...func(*Options)) (*RebootWorkspacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootWorkspaces", params, optFns, addOperationRebootWorkspacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootWorkspacesMiddleware(stack *middleware.Stack, options Options) (err error) {
