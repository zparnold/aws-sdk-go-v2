...
func (c *Client) ModifyWorkspaceAccessProperties(ctx context.Context, params *ModifyWorkspaceAccessPropertiesInput, optFns ...func(*Options)) (*ModifyWorkspaceAccessPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyWorkspaceAccessProperties", params, optFns, addOperationModifyWorkspaceAccessPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyWorkspaceAccessPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
