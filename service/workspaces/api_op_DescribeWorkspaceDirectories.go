...
func (c *Client) DescribeWorkspaceDirectories(ctx context.Context, params *DescribeWorkspaceDirectoriesInput, optFns ...func(*Options)) (*DescribeWorkspaceDirectoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkspaceDirectories", params, optFns, addOperationDescribeWorkspaceDirectoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkspaceDirectoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
