...
func (c *Client) ImportWorkspaceImage(ctx context.Context, params *ImportWorkspaceImageInput, optFns ...func(*Options)) (*ImportWorkspaceImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportWorkspaceImage", params, optFns, addOperationImportWorkspaceImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportWorkspaceImageMiddleware(stack *middleware.Stack, options Options) (err error) {
