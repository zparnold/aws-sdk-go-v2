...
func (c *Client) DeleteIpGroup(ctx context.Context, params *DeleteIpGroupInput, optFns ...func(*Options)) (*DeleteIpGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIpGroup", params, optFns, addOperationDeleteIpGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIpGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
