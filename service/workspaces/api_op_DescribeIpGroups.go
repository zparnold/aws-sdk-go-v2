...
func (c *Client) DescribeIpGroups(ctx context.Context, params *DescribeIpGroupsInput, optFns ...func(*Options)) (*DescribeIpGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIpGroups", params, optFns, addOperationDescribeIpGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIpGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
