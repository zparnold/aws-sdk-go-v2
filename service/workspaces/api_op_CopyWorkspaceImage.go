...
func (c *Client) CopyWorkspaceImage(ctx context.Context, params *CopyWorkspaceImageInput, optFns ...func(*Options)) (*CopyWorkspaceImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyWorkspaceImage", params, optFns, addOperationCopyWorkspaceImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyWorkspaceImageMiddleware(stack *middleware.Stack, options Options) (err error) {
