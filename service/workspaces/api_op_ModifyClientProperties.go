...
func (c *Client) ModifyClientProperties(ctx context.Context, params *ModifyClientPropertiesInput, optFns ...func(*Options)) (*ModifyClientPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClientProperties", params, optFns, addOperationModifyClientPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClientPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
