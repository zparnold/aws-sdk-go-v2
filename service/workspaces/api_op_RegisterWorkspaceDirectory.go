...
func (c *Client) RegisterWorkspaceDirectory(ctx context.Context, params *RegisterWorkspaceDirectoryInput, optFns ...func(*Options)) (*RegisterWorkspaceDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterWorkspaceDirectory", params, optFns, addOperationRegisterWorkspaceDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterWorkspaceDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
