...
func (c *Client) CreateIpGroup(ctx context.Context, params *CreateIpGroupInput, optFns ...func(*Options)) (*CreateIpGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIpGroup", params, optFns, addOperationCreateIpGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIpGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
