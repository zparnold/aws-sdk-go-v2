...
func (c *Client) UpdateRulesOfIpGroup(ctx context.Context, params *UpdateRulesOfIpGroupInput, optFns ...func(*Options)) (*UpdateRulesOfIpGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRulesOfIpGroup", params, optFns, addOperationUpdateRulesOfIpGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRulesOfIpGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
