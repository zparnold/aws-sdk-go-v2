...
func (c *Client) DescribeAccount(ctx context.Context, params *DescribeAccountInput, optFns ...func(*Options)) (*DescribeAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccount", params, optFns, addOperationDescribeAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
