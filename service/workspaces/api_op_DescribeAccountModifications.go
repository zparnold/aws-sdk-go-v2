...
func (c *Client) DescribeAccountModifications(ctx context.Context, params *DescribeAccountModificationsInput, optFns ...func(*Options)) (*DescribeAccountModificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccountModifications", params, optFns, addOperationDescribeAccountModificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccountModificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
