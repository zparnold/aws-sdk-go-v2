...
func (c *Client) StartWorkspaces(ctx context.Context, params *StartWorkspacesInput, optFns ...func(*Options)) (*StartWorkspacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartWorkspaces", params, optFns, addOperationStartWorkspacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartWorkspacesMiddleware(stack *middleware.Stack, options Options) (err error) {
