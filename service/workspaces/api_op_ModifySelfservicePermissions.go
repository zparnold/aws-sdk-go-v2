...
func (c *Client) ModifySelfservicePermissions(ctx context.Context, params *ModifySelfservicePermissionsInput, optFns ...func(*Options)) (*ModifySelfservicePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifySelfservicePermissions", params, optFns, addOperationModifySelfservicePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifySelfservicePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
