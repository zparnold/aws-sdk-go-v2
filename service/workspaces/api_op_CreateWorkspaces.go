...
func (c *Client) CreateWorkspaces(ctx context.Context, params *CreateWorkspacesInput, optFns ...func(*Options)) (*CreateWorkspacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateWorkspaces", params, optFns, addOperationCreateWorkspacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateWorkspacesMiddleware(stack *middleware.Stack, options Options) (err error) {
