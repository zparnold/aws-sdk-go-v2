...
func (c *Client) UpdateWorkspaceImagePermission(ctx context.Context, params *UpdateWorkspaceImagePermissionInput, optFns ...func(*Options)) (*UpdateWorkspaceImagePermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateWorkspaceImagePermission", params, optFns, addOperationUpdateWorkspaceImagePermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateWorkspaceImagePermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
