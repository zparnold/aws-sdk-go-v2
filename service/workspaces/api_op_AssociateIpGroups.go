...
func (c *Client) AssociateIpGroups(ctx context.Context, params *AssociateIpGroupsInput, optFns ...func(*Options)) (*AssociateIpGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateIpGroups", params, optFns, addOperationAssociateIpGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateIpGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
