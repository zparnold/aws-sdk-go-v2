...
func (c *Client) ModifyAccount(ctx context.Context, params *ModifyAccountInput, optFns ...func(*Options)) (*ModifyAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyAccount", params, optFns, addOperationModifyAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
