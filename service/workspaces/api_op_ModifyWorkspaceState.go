...
func (c *Client) ModifyWorkspaceState(ctx context.Context, params *ModifyWorkspaceStateInput, optFns ...func(*Options)) (*ModifyWorkspaceStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyWorkspaceState", params, optFns, addOperationModifyWorkspaceStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyWorkspaceStateMiddleware(stack *middleware.Stack, options Options) (err error) {
