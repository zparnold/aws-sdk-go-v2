...
func (c *Client) DeleteTags(ctx context.Context, params *DeleteTagsInput, optFns ...func(*Options)) (*DeleteTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTags", params, optFns, addOperationDeleteTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
