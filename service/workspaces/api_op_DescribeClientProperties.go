...
func (c *Client) DescribeClientProperties(ctx context.Context, params *DescribeClientPropertiesInput, optFns ...func(*Options)) (*DescribeClientPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClientProperties", params, optFns, addOperationDescribeClientPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClientPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
