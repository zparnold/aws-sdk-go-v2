...
func (c *Client) DeregisterWorkspaceDirectory(ctx context.Context, params *DeregisterWorkspaceDirectoryInput, optFns ...func(*Options)) (*DeregisterWorkspaceDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterWorkspaceDirectory", params, optFns, addOperationDeregisterWorkspaceDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterWorkspaceDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
