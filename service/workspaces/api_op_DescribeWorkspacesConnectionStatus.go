...
func (c *Client) DescribeWorkspacesConnectionStatus(ctx context.Context, params *DescribeWorkspacesConnectionStatusInput, optFns ...func(*Options)) (*DescribeWorkspacesConnectionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkspacesConnectionStatus", params, optFns, addOperationDescribeWorkspacesConnectionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkspacesConnectionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
