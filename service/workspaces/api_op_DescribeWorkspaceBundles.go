...
func (c *Client) DescribeWorkspaceBundles(ctx context.Context, params *DescribeWorkspaceBundlesInput, optFns ...func(*Options)) (*DescribeWorkspaceBundlesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkspaceBundles", params, optFns, addOperationDescribeWorkspaceBundlesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkspaceBundlesMiddleware(stack *middleware.Stack, options Options) (err error) {
