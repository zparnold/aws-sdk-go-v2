...
func (c *Client) RebuildWorkspaces(ctx context.Context, params *RebuildWorkspacesInput, optFns ...func(*Options)) (*RebuildWorkspacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebuildWorkspaces", params, optFns, addOperationRebuildWorkspacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebuildWorkspacesMiddleware(stack *middleware.Stack, options Options) (err error) {
