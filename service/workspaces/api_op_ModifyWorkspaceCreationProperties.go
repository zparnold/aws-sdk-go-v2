...
func (c *Client) ModifyWorkspaceCreationProperties(ctx context.Context, params *ModifyWorkspaceCreationPropertiesInput, optFns ...func(*Options)) (*ModifyWorkspaceCreationPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyWorkspaceCreationProperties", params, optFns, addOperationModifyWorkspaceCreationPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyWorkspaceCreationPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
