...
func (c *Client) RevokeIpRules(ctx context.Context, params *RevokeIpRulesInput, optFns ...func(*Options)) (*RevokeIpRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeIpRules", params, optFns, addOperationRevokeIpRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeIpRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
