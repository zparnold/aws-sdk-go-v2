...
func (c *Client) AuthorizeIpRules(ctx context.Context, params *AuthorizeIpRulesInput, optFns ...func(*Options)) (*AuthorizeIpRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeIpRules", params, optFns, addOperationAuthorizeIpRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeIpRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
