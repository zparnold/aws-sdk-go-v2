...
func (c *Client) RestoreWorkspace(ctx context.Context, params *RestoreWorkspaceInput, optFns ...func(*Options)) (*RestoreWorkspaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreWorkspace", params, optFns, addOperationRestoreWorkspaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreWorkspaceMiddleware(stack *middleware.Stack, options Options) (err error) {
