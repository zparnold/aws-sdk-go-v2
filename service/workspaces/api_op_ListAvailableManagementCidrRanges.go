...
func (c *Client) ListAvailableManagementCidrRanges(ctx context.Context, params *ListAvailableManagementCidrRangesInput, optFns ...func(*Options)) (*ListAvailableManagementCidrRangesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAvailableManagementCidrRanges", params, optFns, addOperationListAvailableManagementCidrRangesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAvailableManagementCidrRangesMiddleware(stack *middleware.Stack, options Options) (err error) {
