...
func (c *Client) ModifyWorkspaceProperties(ctx context.Context, params *ModifyWorkspacePropertiesInput, optFns ...func(*Options)) (*ModifyWorkspacePropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyWorkspaceProperties", params, optFns, addOperationModifyWorkspacePropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyWorkspacePropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
