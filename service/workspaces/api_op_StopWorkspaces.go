...
func (c *Client) StopWorkspaces(ctx context.Context, params *StopWorkspacesInput, optFns ...func(*Options)) (*StopWorkspacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopWorkspaces", params, optFns, addOperationStopWorkspacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopWorkspacesMiddleware(stack *middleware.Stack, options Options) (err error) {
