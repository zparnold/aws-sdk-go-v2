...
func (c *Client) DescribeWorkspaceImages(ctx context.Context, params *DescribeWorkspaceImagesInput, optFns ...func(*Options)) (*DescribeWorkspaceImagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkspaceImages", params, optFns, addOperationDescribeWorkspaceImagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkspaceImagesMiddleware(stack *middleware.Stack, options Options) (err error) {
