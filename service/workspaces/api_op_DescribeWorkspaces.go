...
func (c *Client) DescribeWorkspaces(ctx context.Context, params *DescribeWorkspacesInput, optFns ...func(*Options)) (*DescribeWorkspacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkspaces", params, optFns, addOperationDescribeWorkspacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkspacesMiddleware(stack *middleware.Stack, options Options) (err error) {
