...
func (c *Client) TerminateWorkspaces(ctx context.Context, params *TerminateWorkspacesInput, optFns ...func(*Options)) (*TerminateWorkspacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateWorkspaces", params, optFns, addOperationTerminateWorkspacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateWorkspacesMiddleware(stack *middleware.Stack, options Options) (err error) {
