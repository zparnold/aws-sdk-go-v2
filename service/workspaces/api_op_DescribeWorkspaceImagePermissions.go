...
func (c *Client) DescribeWorkspaceImagePermissions(ctx context.Context, params *DescribeWorkspaceImagePermissionsInput, optFns ...func(*Options)) (*DescribeWorkspaceImagePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkspaceImagePermissions", params, optFns, addOperationDescribeWorkspaceImagePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkspaceImagePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
