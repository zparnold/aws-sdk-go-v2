...
func (c *Client) DescribeUsageLimits(ctx context.Context, params *DescribeUsageLimitsInput, optFns ...func(*Options)) (*DescribeUsageLimitsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUsageLimits", params, optFns, addOperationDescribeUsageLimitsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUsageLimitsMiddleware(stack *middleware.Stack, options Options) (err error) {
