...
func (c *Client) DescribeStorage(ctx context.Context, params *DescribeStorageInput, optFns ...func(*Options)) (*DescribeStorageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStorage", params, optFns, addOperationDescribeStorageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStorageMiddleware(stack *middleware.Stack, options Options) (err error) {
