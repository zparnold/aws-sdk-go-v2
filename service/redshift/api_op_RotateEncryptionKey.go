...
func (c *Client) RotateEncryptionKey(ctx context.Context, params *RotateEncryptionKeyInput, optFns ...func(*Options)) (*RotateEncryptionKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RotateEncryptionKey", params, optFns, addOperationRotateEncryptionKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRotateEncryptionKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
