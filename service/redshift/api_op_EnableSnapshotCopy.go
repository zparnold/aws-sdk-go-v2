...
func (c *Client) EnableSnapshotCopy(ctx context.Context, params *EnableSnapshotCopyInput, optFns ...func(*Options)) (*EnableSnapshotCopyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableSnapshotCopy", params, optFns, addOperationEnableSnapshotCopyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableSnapshotCopyMiddleware(stack *middleware.Stack, options Options) (err error) {
