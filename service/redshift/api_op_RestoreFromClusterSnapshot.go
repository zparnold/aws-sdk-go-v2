...
func (c *Client) RestoreFromClusterSnapshot(ctx context.Context, params *RestoreFromClusterSnapshotInput, optFns ...func(*Options)) (*RestoreFromClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreFromClusterSnapshot", params, optFns, addOperationRestoreFromClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreFromClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
