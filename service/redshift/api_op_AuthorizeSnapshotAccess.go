...
func (c *Client) AuthorizeSnapshotAccess(ctx context.Context, params *AuthorizeSnapshotAccessInput, optFns ...func(*Options)) (*AuthorizeSnapshotAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeSnapshotAccess", params, optFns, addOperationAuthorizeSnapshotAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeSnapshotAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
