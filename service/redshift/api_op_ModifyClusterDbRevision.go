...
func (c *Client) ModifyClusterDbRevision(ctx context.Context, params *ModifyClusterDbRevisionInput, optFns ...func(*Options)) (*ModifyClusterDbRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClusterDbRevision", params, optFns, addOperationModifyClusterDbRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClusterDbRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
