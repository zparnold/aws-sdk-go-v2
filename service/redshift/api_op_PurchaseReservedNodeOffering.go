...
func (c *Client) PurchaseReservedNodeOffering(ctx context.Context, params *PurchaseReservedNodeOfferingInput, optFns ...func(*Options)) (*PurchaseReservedNodeOfferingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurchaseReservedNodeOffering", params, optFns, addOperationPurchaseReservedNodeOfferingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurchaseReservedNodeOfferingMiddleware(stack *middleware.Stack, options Options) (err error) {
