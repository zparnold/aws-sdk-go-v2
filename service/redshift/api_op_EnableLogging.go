...
func (c *Client) EnableLogging(ctx context.Context, params *EnableLoggingInput, optFns ...func(*Options)) (*EnableLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableLogging", params, optFns, addOperationEnableLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
