...
func (c *Client) DescribeScheduledActions(ctx context.Context, params *DescribeScheduledActionsInput, optFns ...func(*Options)) (*DescribeScheduledActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScheduledActions", params, optFns, addOperationDescribeScheduledActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScheduledActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
