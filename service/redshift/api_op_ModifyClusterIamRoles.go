...
func (c *Client) ModifyClusterIamRoles(ctx context.Context, params *ModifyClusterIamRolesInput, optFns ...func(*Options)) (*ModifyClusterIamRolesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClusterIamRoles", params, optFns, addOperationModifyClusterIamRolesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClusterIamRolesMiddleware(stack *middleware.Stack, options Options) (err error) {
