...
func (c *Client) CreateClusterSubnetGroup(ctx context.Context, params *CreateClusterSubnetGroupInput, optFns ...func(*Options)) (*CreateClusterSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateClusterSubnetGroup", params, optFns, addOperationCreateClusterSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateClusterSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
