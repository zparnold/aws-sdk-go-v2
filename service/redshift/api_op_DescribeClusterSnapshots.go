...
func (c *Client) DescribeClusterSnapshots(ctx context.Context, params *DescribeClusterSnapshotsInput, optFns ...func(*Options)) (*DescribeClusterSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterSnapshots", params, optFns, addOperationDescribeClusterSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
