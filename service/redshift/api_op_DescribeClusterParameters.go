...
func (c *Client) DescribeClusterParameters(ctx context.Context, params *DescribeClusterParametersInput, optFns ...func(*Options)) (*DescribeClusterParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterParameters", params, optFns, addOperationDescribeClusterParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
