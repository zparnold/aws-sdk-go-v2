...
func (c *Client) DeleteClusterSnapshot(ctx context.Context, params *DeleteClusterSnapshotInput, optFns ...func(*Options)) (*DeleteClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClusterSnapshot", params, optFns, addOperationDeleteClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
