...
func (c *Client) DescribeClusterSecurityGroups(ctx context.Context, params *DescribeClusterSecurityGroupsInput, optFns ...func(*Options)) (*DescribeClusterSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterSecurityGroups", params, optFns, addOperationDescribeClusterSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
