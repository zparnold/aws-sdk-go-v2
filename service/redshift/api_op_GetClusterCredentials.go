...
func (c *Client) GetClusterCredentials(ctx context.Context, params *GetClusterCredentialsInput, optFns ...func(*Options)) (*GetClusterCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetClusterCredentials", params, optFns, addOperationGetClusterCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetClusterCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
