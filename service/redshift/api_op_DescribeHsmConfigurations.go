...
func (c *Client) DescribeHsmConfigurations(ctx context.Context, params *DescribeHsmConfigurationsInput, optFns ...func(*Options)) (*DescribeHsmConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHsmConfigurations", params, optFns, addOperationDescribeHsmConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHsmConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
