...
func (c *Client) ModifySnapshotCopyRetentionPeriod(ctx context.Context, params *ModifySnapshotCopyRetentionPeriodInput, optFns ...func(*Options)) (*ModifySnapshotCopyRetentionPeriodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifySnapshotCopyRetentionPeriod", params, optFns, addOperationModifySnapshotCopyRetentionPeriodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifySnapshotCopyRetentionPeriodMiddleware(stack *middleware.Stack, options Options) (err error) {
