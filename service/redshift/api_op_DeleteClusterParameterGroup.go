...
func (c *Client) DeleteClusterParameterGroup(ctx context.Context, params *DeleteClusterParameterGroupInput, optFns ...func(*Options)) (*DeleteClusterParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClusterParameterGroup", params, optFns, addOperationDeleteClusterParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClusterParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
