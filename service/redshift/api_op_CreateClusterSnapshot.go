...
func (c *Client) CreateClusterSnapshot(ctx context.Context, params *CreateClusterSnapshotInput, optFns ...func(*Options)) (*CreateClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateClusterSnapshot", params, optFns, addOperationCreateClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
