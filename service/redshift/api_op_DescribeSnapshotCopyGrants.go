...
func (c *Client) DescribeSnapshotCopyGrants(ctx context.Context, params *DescribeSnapshotCopyGrantsInput, optFns ...func(*Options)) (*DescribeSnapshotCopyGrantsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSnapshotCopyGrants", params, optFns, addOperationDescribeSnapshotCopyGrantsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSnapshotCopyGrantsMiddleware(stack *middleware.Stack, options Options) (err error) {
