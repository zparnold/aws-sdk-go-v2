...
func (c *Client) CreateClusterSecurityGroup(ctx context.Context, params *CreateClusterSecurityGroupInput, optFns ...func(*Options)) (*CreateClusterSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateClusterSecurityGroup", params, optFns, addOperationCreateClusterSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateClusterSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
