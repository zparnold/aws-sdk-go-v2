...
func (c *Client) ModifySnapshotSchedule(ctx context.Context, params *ModifySnapshotScheduleInput, optFns ...func(*Options)) (*ModifySnapshotScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifySnapshotSchedule", params, optFns, addOperationModifySnapshotScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifySnapshotScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
