...
func (c *Client) BatchModifyClusterSnapshots(ctx context.Context, params *BatchModifyClusterSnapshotsInput, optFns ...func(*Options)) (*BatchModifyClusterSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchModifyClusterSnapshots", params, optFns, addOperationBatchModifyClusterSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchModifyClusterSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
