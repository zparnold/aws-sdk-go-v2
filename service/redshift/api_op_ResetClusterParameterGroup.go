...
func (c *Client) ResetClusterParameterGroup(ctx context.Context, params *ResetClusterParameterGroupInput, optFns ...func(*Options)) (*ResetClusterParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetClusterParameterGroup", params, optFns, addOperationResetClusterParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetClusterParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
