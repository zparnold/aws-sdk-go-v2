...
func (c *Client) RevokeClusterSecurityGroupIngress(ctx context.Context, params *RevokeClusterSecurityGroupIngressInput, optFns ...func(*Options)) (*RevokeClusterSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeClusterSecurityGroupIngress", params, optFns, addOperationRevokeClusterSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeClusterSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
