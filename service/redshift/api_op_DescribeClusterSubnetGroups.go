...
func (c *Client) DescribeClusterSubnetGroups(ctx context.Context, params *DescribeClusterSubnetGroupsInput, optFns ...func(*Options)) (*DescribeClusterSubnetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterSubnetGroups", params, optFns, addOperationDescribeClusterSubnetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterSubnetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
