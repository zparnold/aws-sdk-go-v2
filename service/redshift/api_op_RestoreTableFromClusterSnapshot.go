...
func (c *Client) RestoreTableFromClusterSnapshot(ctx context.Context, params *RestoreTableFromClusterSnapshotInput, optFns ...func(*Options)) (*RestoreTableFromClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreTableFromClusterSnapshot", params, optFns, addOperationRestoreTableFromClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreTableFromClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
