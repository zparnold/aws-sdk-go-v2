...
func (c *Client) ResizeCluster(ctx context.Context, params *ResizeClusterInput, optFns ...func(*Options)) (*ResizeClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResizeCluster", params, optFns, addOperationResizeClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResizeClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
