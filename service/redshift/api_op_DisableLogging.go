...
func (c *Client) DisableLogging(ctx context.Context, params *DisableLoggingInput, optFns ...func(*Options)) (*DisableLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableLogging", params, optFns, addOperationDisableLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
