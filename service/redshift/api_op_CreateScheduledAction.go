...
func (c *Client) CreateScheduledAction(ctx context.Context, params *CreateScheduledActionInput, optFns ...func(*Options)) (*CreateScheduledActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateScheduledAction", params, optFns, addOperationCreateScheduledActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateScheduledActionMiddleware(stack *middleware.Stack, options Options) (err error) {
