...
func (c *Client) ModifyClusterMaintenance(ctx context.Context, params *ModifyClusterMaintenanceInput, optFns ...func(*Options)) (*ModifyClusterMaintenanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClusterMaintenance", params, optFns, addOperationModifyClusterMaintenanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClusterMaintenanceMiddleware(stack *middleware.Stack, options Options) (err error) {
