...
func (c *Client) RevokeSnapshotAccess(ctx context.Context, params *RevokeSnapshotAccessInput, optFns ...func(*Options)) (*RevokeSnapshotAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeSnapshotAccess", params, optFns, addOperationRevokeSnapshotAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeSnapshotAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
