...
func (c *Client) DescribeNodeConfigurationOptions(ctx context.Context, params *DescribeNodeConfigurationOptionsInput, optFns ...func(*Options)) (*DescribeNodeConfigurationOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNodeConfigurationOptions", params, optFns, addOperationDescribeNodeConfigurationOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNodeConfigurationOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
