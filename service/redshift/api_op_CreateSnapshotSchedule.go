...
func (c *Client) CreateSnapshotSchedule(ctx context.Context, params *CreateSnapshotScheduleInput, optFns ...func(*Options)) (*CreateSnapshotScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSnapshotSchedule", params, optFns, addOperationCreateSnapshotScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSnapshotScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
