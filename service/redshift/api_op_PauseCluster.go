...
func (c *Client) PauseCluster(ctx context.Context, params *PauseClusterInput, optFns ...func(*Options)) (*PauseClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PauseCluster", params, optFns, addOperationPauseClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPauseClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
