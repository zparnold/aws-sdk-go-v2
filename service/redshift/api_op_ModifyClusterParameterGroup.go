...
func (c *Client) ModifyClusterParameterGroup(ctx context.Context, params *ModifyClusterParameterGroupInput, optFns ...func(*Options)) (*ModifyClusterParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClusterParameterGroup", params, optFns, addOperationModifyClusterParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClusterParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
