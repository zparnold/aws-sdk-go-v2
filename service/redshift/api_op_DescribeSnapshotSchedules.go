...
func (c *Client) DescribeSnapshotSchedules(ctx context.Context, params *DescribeSnapshotSchedulesInput, optFns ...func(*Options)) (*DescribeSnapshotSchedulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSnapshotSchedules", params, optFns, addOperationDescribeSnapshotSchedulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSnapshotSchedulesMiddleware(stack *middleware.Stack, options Options) (err error) {
