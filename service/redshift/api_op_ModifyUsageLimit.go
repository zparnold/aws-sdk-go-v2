...
func (c *Client) ModifyUsageLimit(ctx context.Context, params *ModifyUsageLimitInput, optFns ...func(*Options)) (*ModifyUsageLimitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyUsageLimit", params, optFns, addOperationModifyUsageLimitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyUsageLimitMiddleware(stack *middleware.Stack, options Options) (err error) {
