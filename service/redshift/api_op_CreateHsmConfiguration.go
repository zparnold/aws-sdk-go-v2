...
func (c *Client) CreateHsmConfiguration(ctx context.Context, params *CreateHsmConfigurationInput, optFns ...func(*Options)) (*CreateHsmConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHsmConfiguration", params, optFns, addOperationCreateHsmConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHsmConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
