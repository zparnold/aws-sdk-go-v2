...
func (c *Client) ModifyScheduledAction(ctx context.Context, params *ModifyScheduledActionInput, optFns ...func(*Options)) (*ModifyScheduledActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyScheduledAction", params, optFns, addOperationModifyScheduledActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyScheduledActionMiddleware(stack *middleware.Stack, options Options) (err error) {
