...
func (c *Client) DescribeResize(ctx context.Context, params *DescribeResizeInput, optFns ...func(*Options)) (*DescribeResizeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeResize", params, optFns, addOperationDescribeResizeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeResizeMiddleware(stack *middleware.Stack, options Options) (err error) {
