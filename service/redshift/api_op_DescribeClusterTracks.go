...
func (c *Client) DescribeClusterTracks(ctx context.Context, params *DescribeClusterTracksInput, optFns ...func(*Options)) (*DescribeClusterTracksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterTracks", params, optFns, addOperationDescribeClusterTracksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterTracksMiddleware(stack *middleware.Stack, options Options) (err error) {
