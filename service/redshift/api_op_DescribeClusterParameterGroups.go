...
func (c *Client) DescribeClusterParameterGroups(ctx context.Context, params *DescribeClusterParameterGroupsInput, optFns ...func(*Options)) (*DescribeClusterParameterGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterParameterGroups", params, optFns, addOperationDescribeClusterParameterGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterParameterGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
