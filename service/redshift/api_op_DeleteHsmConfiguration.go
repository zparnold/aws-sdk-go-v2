...
func (c *Client) DeleteHsmConfiguration(ctx context.Context, params *DeleteHsmConfigurationInput, optFns ...func(*Options)) (*DeleteHsmConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHsmConfiguration", params, optFns, addOperationDeleteHsmConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHsmConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
