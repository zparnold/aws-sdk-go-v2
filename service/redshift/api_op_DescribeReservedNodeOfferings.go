...
func (c *Client) DescribeReservedNodeOfferings(ctx context.Context, params *DescribeReservedNodeOfferingsInput, optFns ...func(*Options)) (*DescribeReservedNodeOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedNodeOfferings", params, optFns, addOperationDescribeReservedNodeOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedNodeOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
