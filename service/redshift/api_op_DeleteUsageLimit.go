...
func (c *Client) DeleteUsageLimit(ctx context.Context, params *DeleteUsageLimitInput, optFns ...func(*Options)) (*DeleteUsageLimitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUsageLimit", params, optFns, addOperationDeleteUsageLimitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUsageLimitMiddleware(stack *middleware.Stack, options Options) (err error) {
