...
func (c *Client) CreateUsageLimit(ctx context.Context, params *CreateUsageLimitInput, optFns ...func(*Options)) (*CreateUsageLimitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUsageLimit", params, optFns, addOperationCreateUsageLimitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUsageLimitMiddleware(stack *middleware.Stack, options Options) (err error) {
