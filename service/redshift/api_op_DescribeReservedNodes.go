...
func (c *Client) DescribeReservedNodes(ctx context.Context, params *DescribeReservedNodesInput, optFns ...func(*Options)) (*DescribeReservedNodesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedNodes", params, optFns, addOperationDescribeReservedNodesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedNodesMiddleware(stack *middleware.Stack, options Options) (err error) {
