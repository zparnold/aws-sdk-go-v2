...
func (c *Client) DescribeHsmClientCertificates(ctx context.Context, params *DescribeHsmClientCertificatesInput, optFns ...func(*Options)) (*DescribeHsmClientCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHsmClientCertificates", params, optFns, addOperationDescribeHsmClientCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHsmClientCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
