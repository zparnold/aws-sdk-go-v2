...
func (c *Client) DeleteSnapshotCopyGrant(ctx context.Context, params *DeleteSnapshotCopyGrantInput, optFns ...func(*Options)) (*DeleteSnapshotCopyGrantOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSnapshotCopyGrant", params, optFns, addOperationDeleteSnapshotCopyGrantMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSnapshotCopyGrantMiddleware(stack *middleware.Stack, options Options) (err error) {
