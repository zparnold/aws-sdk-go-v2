...
func (c *Client) CopyClusterSnapshot(ctx context.Context, params *CopyClusterSnapshotInput, optFns ...func(*Options)) (*CopyClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyClusterSnapshot", params, optFns, addOperationCopyClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
