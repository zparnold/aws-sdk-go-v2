...
func (c *Client) DeleteSnapshotSchedule(ctx context.Context, params *DeleteSnapshotScheduleInput, optFns ...func(*Options)) (*DeleteSnapshotScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSnapshotSchedule", params, optFns, addOperationDeleteSnapshotScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSnapshotScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
