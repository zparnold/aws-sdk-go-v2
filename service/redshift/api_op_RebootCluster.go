...
func (c *Client) RebootCluster(ctx context.Context, params *RebootClusterInput, optFns ...func(*Options)) (*RebootClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootCluster", params, optFns, addOperationRebootClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
