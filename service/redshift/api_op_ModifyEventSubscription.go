...
func (c *Client) ModifyEventSubscription(ctx context.Context, params *ModifyEventSubscriptionInput, optFns ...func(*Options)) (*ModifyEventSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyEventSubscription", params, optFns, addOperationModifyEventSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyEventSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
