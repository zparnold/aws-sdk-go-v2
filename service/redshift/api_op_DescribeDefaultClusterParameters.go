...
func (c *Client) DescribeDefaultClusterParameters(ctx context.Context, params *DescribeDefaultClusterParametersInput, optFns ...func(*Options)) (*DescribeDefaultClusterParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDefaultClusterParameters", params, optFns, addOperationDescribeDefaultClusterParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDefaultClusterParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
