...
func (c *Client) DeleteClusterSecurityGroup(ctx context.Context, params *DeleteClusterSecurityGroupInput, optFns ...func(*Options)) (*DeleteClusterSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClusterSecurityGroup", params, optFns, addOperationDeleteClusterSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClusterSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
