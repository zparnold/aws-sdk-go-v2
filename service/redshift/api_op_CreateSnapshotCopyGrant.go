...
func (c *Client) CreateSnapshotCopyGrant(ctx context.Context, params *CreateSnapshotCopyGrantInput, optFns ...func(*Options)) (*CreateSnapshotCopyGrantOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSnapshotCopyGrant", params, optFns, addOperationCreateSnapshotCopyGrantMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSnapshotCopyGrantMiddleware(stack *middleware.Stack, options Options) (err error) {
