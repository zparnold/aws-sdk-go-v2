...
func (c *Client) DescribeLoggingStatus(ctx context.Context, params *DescribeLoggingStatusInput, optFns ...func(*Options)) (*DescribeLoggingStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoggingStatus", params, optFns, addOperationDescribeLoggingStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoggingStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
