...
func (c *Client) ModifyClusterSnapshotSchedule(ctx context.Context, params *ModifyClusterSnapshotScheduleInput, optFns ...func(*Options)) (*ModifyClusterSnapshotScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClusterSnapshotSchedule", params, optFns, addOperationModifyClusterSnapshotScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClusterSnapshotScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
