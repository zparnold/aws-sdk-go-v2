...
func (c *Client) DescribeClusterDbRevisions(ctx context.Context, params *DescribeClusterDbRevisionsInput, optFns ...func(*Options)) (*DescribeClusterDbRevisionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterDbRevisions", params, optFns, addOperationDescribeClusterDbRevisionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterDbRevisionsMiddleware(stack *middleware.Stack, options Options) (err error) {
