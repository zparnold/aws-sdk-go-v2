...
func (c *Client) ModifyClusterSnapshot(ctx context.Context, params *ModifyClusterSnapshotInput, optFns ...func(*Options)) (*ModifyClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClusterSnapshot", params, optFns, addOperationModifyClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
