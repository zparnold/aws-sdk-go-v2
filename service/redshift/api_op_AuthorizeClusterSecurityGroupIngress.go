...
func (c *Client) AuthorizeClusterSecurityGroupIngress(ctx context.Context, params *AuthorizeClusterSecurityGroupIngressInput, optFns ...func(*Options)) (*AuthorizeClusterSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeClusterSecurityGroupIngress", params, optFns, addOperationAuthorizeClusterSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeClusterSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
