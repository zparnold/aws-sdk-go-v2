...
func (c *Client) DescribeOrderableClusterOptions(ctx context.Context, params *DescribeOrderableClusterOptionsInput, optFns ...func(*Options)) (*DescribeOrderableClusterOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrderableClusterOptions", params, optFns, addOperationDescribeOrderableClusterOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrderableClusterOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
