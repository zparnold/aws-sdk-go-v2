...
func (c *Client) DeleteClusterSubnetGroup(ctx context.Context, params *DeleteClusterSubnetGroupInput, optFns ...func(*Options)) (*DeleteClusterSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClusterSubnetGroup", params, optFns, addOperationDeleteClusterSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClusterSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
