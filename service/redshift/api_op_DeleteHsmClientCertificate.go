...
func (c *Client) DeleteHsmClientCertificate(ctx context.Context, params *DeleteHsmClientCertificateInput, optFns ...func(*Options)) (*DeleteHsmClientCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHsmClientCertificate", params, optFns, addOperationDeleteHsmClientCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHsmClientCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
