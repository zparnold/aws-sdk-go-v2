...
func (c *Client) CancelResize(ctx context.Context, params *CancelResizeInput, optFns ...func(*Options)) (*CancelResizeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelResize", params, optFns, addOperationCancelResizeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelResizeMiddleware(stack *middleware.Stack, options Options) (err error) {
