...
func (c *Client) DescribeClusterVersions(ctx context.Context, params *DescribeClusterVersionsInput, optFns ...func(*Options)) (*DescribeClusterVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusterVersions", params, optFns, addOperationDescribeClusterVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
