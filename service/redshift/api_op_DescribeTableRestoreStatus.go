...
func (c *Client) DescribeTableRestoreStatus(ctx context.Context, params *DescribeTableRestoreStatusInput, optFns ...func(*Options)) (*DescribeTableRestoreStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTableRestoreStatus", params, optFns, addOperationDescribeTableRestoreStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTableRestoreStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
