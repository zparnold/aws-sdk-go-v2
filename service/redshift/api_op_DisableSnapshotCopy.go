...
func (c *Client) DisableSnapshotCopy(ctx context.Context, params *DisableSnapshotCopyInput, optFns ...func(*Options)) (*DisableSnapshotCopyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableSnapshotCopy", params, optFns, addOperationDisableSnapshotCopyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableSnapshotCopyMiddleware(stack *middleware.Stack, options Options) (err error) {
