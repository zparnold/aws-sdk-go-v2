...
func (c *Client) DeleteGateway(ctx context.Context, params *DeleteGatewayInput, optFns ...func(*Options)) (*DeleteGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGateway", params, optFns, addOperationDeleteGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
