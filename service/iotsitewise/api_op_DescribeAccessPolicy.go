...
func (c *Client) DescribeAccessPolicy(ctx context.Context, params *DescribeAccessPolicyInput, optFns ...func(*Options)) (*DescribeAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccessPolicy", params, optFns, addOperationDescribeAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
