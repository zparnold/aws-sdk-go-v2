...
func (c *Client) AssociateAssets(ctx context.Context, params *AssociateAssetsInput, optFns ...func(*Options)) (*AssociateAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateAssets", params, optFns, addOperationAssociateAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
