...
func (c *Client) DescribeAsset(ctx context.Context, params *DescribeAssetInput, optFns ...func(*Options)) (*DescribeAssetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAsset", params, optFns, addOperationDescribeAssetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssetMiddleware(stack *middleware.Stack, options Options) (err error) {
