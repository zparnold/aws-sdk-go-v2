...
func (c *Client) DeleteAssetModel(ctx context.Context, params *DeleteAssetModelInput, optFns ...func(*Options)) (*DeleteAssetModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAssetModel", params, optFns, addOperationDeleteAssetModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAssetModelMiddleware(stack *middleware.Stack, options Options) (err error) {
