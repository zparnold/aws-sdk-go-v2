...
func (c *Client) CreatePortal(ctx context.Context, params *CreatePortalInput, optFns ...func(*Options)) (*CreatePortalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePortal", params, optFns, addOperationCreatePortalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePortalMiddleware(stack *middleware.Stack, options Options) (err error) {
