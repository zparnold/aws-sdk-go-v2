...
func (c *Client) CreateAsset(ctx context.Context, params *CreateAssetInput, optFns ...func(*Options)) (*CreateAssetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAsset", params, optFns, addOperationCreateAssetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAssetMiddleware(stack *middleware.Stack, options Options) (err error) {
