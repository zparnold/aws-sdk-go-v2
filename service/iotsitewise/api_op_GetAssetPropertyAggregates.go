...
func (c *Client) GetAssetPropertyAggregates(ctx context.Context, params *GetAssetPropertyAggregatesInput, optFns ...func(*Options)) (*GetAssetPropertyAggregatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssetPropertyAggregates", params, optFns, addOperationGetAssetPropertyAggregatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssetPropertyAggregatesMiddleware(stack *middleware.Stack, options Options) (err error) {
