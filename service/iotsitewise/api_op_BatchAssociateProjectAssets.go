...
func (c *Client) BatchAssociateProjectAssets(ctx context.Context, params *BatchAssociateProjectAssetsInput, optFns ...func(*Options)) (*BatchAssociateProjectAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchAssociateProjectAssets", params, optFns, addOperationBatchAssociateProjectAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchAssociateProjectAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
