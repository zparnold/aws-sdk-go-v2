...
func (c *Client) UpdateAssetModel(ctx context.Context, params *UpdateAssetModelInput, optFns ...func(*Options)) (*UpdateAssetModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAssetModel", params, optFns, addOperationUpdateAssetModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAssetModelMiddleware(stack *middleware.Stack, options Options) (err error) {
