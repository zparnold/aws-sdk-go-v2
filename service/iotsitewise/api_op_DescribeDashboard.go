...
func (c *Client) DescribeDashboard(ctx context.Context, params *DescribeDashboardInput, optFns ...func(*Options)) (*DescribeDashboardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDashboard", params, optFns, addOperationDescribeDashboardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDashboardMiddleware(stack *middleware.Stack, options Options) (err error) {
