...
func (c *Client) UpdateAssetProperty(ctx context.Context, params *UpdateAssetPropertyInput, optFns ...func(*Options)) (*UpdateAssetPropertyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAssetProperty", params, optFns, addOperationUpdateAssetPropertyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAssetPropertyMiddleware(stack *middleware.Stack, options Options) (err error) {
