...
func (c *Client) PutLoggingOptions(ctx context.Context, params *PutLoggingOptionsInput, optFns ...func(*Options)) (*PutLoggingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutLoggingOptions", params, optFns, addOperationPutLoggingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutLoggingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
