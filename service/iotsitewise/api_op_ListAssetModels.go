...
func (c *Client) ListAssetModels(ctx context.Context, params *ListAssetModelsInput, optFns ...func(*Options)) (*ListAssetModelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssetModels", params, optFns, addOperationListAssetModelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssetModelsMiddleware(stack *middleware.Stack, options Options) (err error) {
