...
func (c *Client) BatchDisassociateProjectAssets(ctx context.Context, params *BatchDisassociateProjectAssetsInput, optFns ...func(*Options)) (*BatchDisassociateProjectAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDisassociateProjectAssets", params, optFns, addOperationBatchDisassociateProjectAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDisassociateProjectAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
