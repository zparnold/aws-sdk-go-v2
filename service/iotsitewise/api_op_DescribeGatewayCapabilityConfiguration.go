...
func (c *Client) DescribeGatewayCapabilityConfiguration(ctx context.Context, params *DescribeGatewayCapabilityConfigurationInput, optFns ...func(*Options)) (*DescribeGatewayCapabilityConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGatewayCapabilityConfiguration", params, optFns, addOperationDescribeGatewayCapabilityConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGatewayCapabilityConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
