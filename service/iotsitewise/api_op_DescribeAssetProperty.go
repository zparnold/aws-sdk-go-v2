...
func (c *Client) DescribeAssetProperty(ctx context.Context, params *DescribeAssetPropertyInput, optFns ...func(*Options)) (*DescribeAssetPropertyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssetProperty", params, optFns, addOperationDescribeAssetPropertyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssetPropertyMiddleware(stack *middleware.Stack, options Options) (err error) {
