...
func (c *Client) GetAssetPropertyValueHistory(ctx context.Context, params *GetAssetPropertyValueHistoryInput, optFns ...func(*Options)) (*GetAssetPropertyValueHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssetPropertyValueHistory", params, optFns, addOperationGetAssetPropertyValueHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssetPropertyValueHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
