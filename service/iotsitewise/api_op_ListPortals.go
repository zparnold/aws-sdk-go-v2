...
func (c *Client) ListPortals(ctx context.Context, params *ListPortalsInput, optFns ...func(*Options)) (*ListPortalsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPortals", params, optFns, addOperationListPortalsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPortalsMiddleware(stack *middleware.Stack, options Options) (err error) {
