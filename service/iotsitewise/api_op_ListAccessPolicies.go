...
func (c *Client) ListAccessPolicies(ctx context.Context, params *ListAccessPoliciesInput, optFns ...func(*Options)) (*ListAccessPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccessPolicies", params, optFns, addOperationListAccessPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccessPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
