...
func (c *Client) DeleteAccessPolicy(ctx context.Context, params *DeleteAccessPolicyInput, optFns ...func(*Options)) (*DeleteAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccessPolicy", params, optFns, addOperationDeleteAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
