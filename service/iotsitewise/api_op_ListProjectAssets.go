...
func (c *Client) ListProjectAssets(ctx context.Context, params *ListProjectAssetsInput, optFns ...func(*Options)) (*ListProjectAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProjectAssets", params, optFns, addOperationListProjectAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProjectAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
