...
func (c *Client) ListAssociatedAssets(ctx context.Context, params *ListAssociatedAssetsInput, optFns ...func(*Options)) (*ListAssociatedAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssociatedAssets", params, optFns, addOperationListAssociatedAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssociatedAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
