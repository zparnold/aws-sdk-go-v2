...
func (c *Client) DescribePortal(ctx context.Context, params *DescribePortalInput, optFns ...func(*Options)) (*DescribePortalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePortal", params, optFns, addOperationDescribePortalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePortalMiddleware(stack *middleware.Stack, options Options) (err error) {
