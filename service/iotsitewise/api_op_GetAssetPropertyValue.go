...
func (c *Client) GetAssetPropertyValue(ctx context.Context, params *GetAssetPropertyValueInput, optFns ...func(*Options)) (*GetAssetPropertyValueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssetPropertyValue", params, optFns, addOperationGetAssetPropertyValueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssetPropertyValueMiddleware(stack *middleware.Stack, options Options) (err error) {
