...
func (c *Client) DescribeGateway(ctx context.Context, params *DescribeGatewayInput, optFns ...func(*Options)) (*DescribeGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGateway", params, optFns, addOperationDescribeGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
