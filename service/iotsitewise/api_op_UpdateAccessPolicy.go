...
func (c *Client) UpdateAccessPolicy(ctx context.Context, params *UpdateAccessPolicyInput, optFns ...func(*Options)) (*UpdateAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAccessPolicy", params, optFns, addOperationUpdateAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
