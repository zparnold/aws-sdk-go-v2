...
func (c *Client) UpdatePortal(ctx context.Context, params *UpdatePortalInput, optFns ...func(*Options)) (*UpdatePortalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePortal", params, optFns, addOperationUpdatePortalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePortalMiddleware(stack *middleware.Stack, options Options) (err error) {
