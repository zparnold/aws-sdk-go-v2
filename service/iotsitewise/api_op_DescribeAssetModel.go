...
func (c *Client) DescribeAssetModel(ctx context.Context, params *DescribeAssetModelInput, optFns ...func(*Options)) (*DescribeAssetModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssetModel", params, optFns, addOperationDescribeAssetModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssetModelMiddleware(stack *middleware.Stack, options Options) (err error) {
