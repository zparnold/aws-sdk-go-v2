...
func (c *Client) ListAssets(ctx context.Context, params *ListAssetsInput, optFns ...func(*Options)) (*ListAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssets", params, optFns, addOperationListAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
