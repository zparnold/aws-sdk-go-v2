...
func (c *Client) CreateGateway(ctx context.Context, params *CreateGatewayInput, optFns ...func(*Options)) (*CreateGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGateway", params, optFns, addOperationCreateGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
