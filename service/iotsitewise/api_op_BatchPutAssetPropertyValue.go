...
func (c *Client) BatchPutAssetPropertyValue(ctx context.Context, params *BatchPutAssetPropertyValueInput, optFns ...func(*Options)) (*BatchPutAssetPropertyValueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchPutAssetPropertyValue", params, optFns, addOperationBatchPutAssetPropertyValueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchPutAssetPropertyValueMiddleware(stack *middleware.Stack, options Options) (err error) {
