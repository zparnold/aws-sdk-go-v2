...
func (c *Client) CreateAssetModel(ctx context.Context, params *CreateAssetModelInput, optFns ...func(*Options)) (*CreateAssetModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAssetModel", params, optFns, addOperationCreateAssetModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAssetModelMiddleware(stack *middleware.Stack, options Options) (err error) {
