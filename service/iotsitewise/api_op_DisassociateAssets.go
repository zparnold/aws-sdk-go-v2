...
func (c *Client) DisassociateAssets(ctx context.Context, params *DisassociateAssetsInput, optFns ...func(*Options)) (*DisassociateAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateAssets", params, optFns, addOperationDisassociateAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
