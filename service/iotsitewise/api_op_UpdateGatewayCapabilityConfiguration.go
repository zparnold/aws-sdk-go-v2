...
func (c *Client) UpdateGatewayCapabilityConfiguration(ctx context.Context, params *UpdateGatewayCapabilityConfigurationInput, optFns ...func(*Options)) (*UpdateGatewayCapabilityConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGatewayCapabilityConfiguration", params, optFns, addOperationUpdateGatewayCapabilityConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewayCapabilityConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
