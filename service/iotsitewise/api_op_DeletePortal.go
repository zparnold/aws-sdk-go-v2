...
func (c *Client) DeletePortal(ctx context.Context, params *DeletePortalInput, optFns ...func(*Options)) (*DeletePortalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePortal", params, optFns, addOperationDeletePortalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePortalMiddleware(stack *middleware.Stack, options Options) (err error) {
