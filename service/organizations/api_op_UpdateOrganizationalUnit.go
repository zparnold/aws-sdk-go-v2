...
func (c *Client) UpdateOrganizationalUnit(ctx context.Context, params *UpdateOrganizationalUnitInput, optFns ...func(*Options)) (*UpdateOrganizationalUnitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateOrganizationalUnit", params, optFns, addOperationUpdateOrganizationalUnitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateOrganizationalUnitMiddleware(stack *middleware.Stack, options Options) (err error) {
