...
func (c *Client) ListHandshakesForAccount(ctx context.Context, params *ListHandshakesForAccountInput, optFns ...func(*Options)) (*ListHandshakesForAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHandshakesForAccount", params, optFns, addOperationListHandshakesForAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHandshakesForAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
