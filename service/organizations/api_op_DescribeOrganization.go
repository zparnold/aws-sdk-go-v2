...
func (c *Client) DescribeOrganization(ctx context.Context, params *DescribeOrganizationInput, optFns ...func(*Options)) (*DescribeOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrganization", params, optFns, addOperationDescribeOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
