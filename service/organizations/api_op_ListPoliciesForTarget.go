...
func (c *Client) ListPoliciesForTarget(ctx context.Context, params *ListPoliciesForTargetInput, optFns ...func(*Options)) (*ListPoliciesForTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPoliciesForTarget", params, optFns, addOperationListPoliciesForTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPoliciesForTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
