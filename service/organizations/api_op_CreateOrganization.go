...
func (c *Client) CreateOrganization(ctx context.Context, params *CreateOrganizationInput, optFns ...func(*Options)) (*CreateOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOrganization", params, optFns, addOperationCreateOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
