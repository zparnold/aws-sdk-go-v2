...
func (c *Client) ListChildren(ctx context.Context, params *ListChildrenInput, optFns ...func(*Options)) (*ListChildrenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListChildren", params, optFns, addOperationListChildrenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListChildrenMiddleware(stack *middleware.Stack, options Options) (err error) {
