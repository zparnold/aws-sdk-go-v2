...
func (c *Client) MoveAccount(ctx context.Context, params *MoveAccountInput, optFns ...func(*Options)) (*MoveAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MoveAccount", params, optFns, addOperationMoveAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMoveAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
