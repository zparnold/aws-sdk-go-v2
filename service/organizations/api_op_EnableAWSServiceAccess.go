...
func (c *Client) EnableAWSServiceAccess(ctx context.Context, params *EnableAWSServiceAccessInput, optFns ...func(*Options)) (*EnableAWSServiceAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableAWSServiceAccess", params, optFns, addOperationEnableAWSServiceAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableAWSServiceAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
