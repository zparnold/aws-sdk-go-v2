...
func (c *Client) CreateAccount(ctx context.Context, params *CreateAccountInput, optFns ...func(*Options)) (*CreateAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAccount", params, optFns, addOperationCreateAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
