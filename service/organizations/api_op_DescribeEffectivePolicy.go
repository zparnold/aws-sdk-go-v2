...
func (c *Client) DescribeEffectivePolicy(ctx context.Context, params *DescribeEffectivePolicyInput, optFns ...func(*Options)) (*DescribeEffectivePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEffectivePolicy", params, optFns, addOperationDescribeEffectivePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEffectivePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
