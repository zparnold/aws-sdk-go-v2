...
func (c *Client) EnablePolicyType(ctx context.Context, params *EnablePolicyTypeInput, optFns ...func(*Options)) (*EnablePolicyTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnablePolicyType", params, optFns, addOperationEnablePolicyTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnablePolicyTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
