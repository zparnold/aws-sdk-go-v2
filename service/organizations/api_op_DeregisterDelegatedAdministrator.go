...
func (c *Client) DeregisterDelegatedAdministrator(ctx context.Context, params *DeregisterDelegatedAdministratorInput, optFns ...func(*Options)) (*DeregisterDelegatedAdministratorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterDelegatedAdministrator", params, optFns, addOperationDeregisterDelegatedAdministratorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterDelegatedAdministratorMiddleware(stack *middleware.Stack, options Options) (err error) {
