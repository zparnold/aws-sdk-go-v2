...
func (c *Client) ListOrganizationalUnitsForParent(ctx context.Context, params *ListOrganizationalUnitsForParentInput, optFns ...func(*Options)) (*ListOrganizationalUnitsForParentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOrganizationalUnitsForParent", params, optFns, addOperationListOrganizationalUnitsForParentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOrganizationalUnitsForParentMiddleware(stack *middleware.Stack, options Options) (err error) {
