...
func (c *Client) RegisterDelegatedAdministrator(ctx context.Context, params *RegisterDelegatedAdministratorInput, optFns ...func(*Options)) (*RegisterDelegatedAdministratorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterDelegatedAdministrator", params, optFns, addOperationRegisterDelegatedAdministratorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterDelegatedAdministratorMiddleware(stack *middleware.Stack, options Options) (err error) {
