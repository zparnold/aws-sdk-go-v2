...
func (c *Client) ListHandshakesForOrganization(ctx context.Context, params *ListHandshakesForOrganizationInput, optFns ...func(*Options)) (*ListHandshakesForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHandshakesForOrganization", params, optFns, addOperationListHandshakesForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHandshakesForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
