...
func (c *Client) AcceptHandshake(ctx context.Context, params *AcceptHandshakeInput, optFns ...func(*Options)) (*AcceptHandshakeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptHandshake", params, optFns, addOperationAcceptHandshakeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptHandshakeMiddleware(stack *middleware.Stack, options Options) (err error) {
