...
func (c *Client) DetachPolicy(ctx context.Context, params *DetachPolicyInput, optFns ...func(*Options)) (*DetachPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachPolicy", params, optFns, addOperationDetachPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
