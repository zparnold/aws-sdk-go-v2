...
func (c *Client) DeleteOrganization(ctx context.Context, params *DeleteOrganizationInput, optFns ...func(*Options)) (*DeleteOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOrganization", params, optFns, addOperationDeleteOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
