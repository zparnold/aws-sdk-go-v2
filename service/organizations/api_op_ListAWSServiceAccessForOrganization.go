...
func (c *Client) ListAWSServiceAccessForOrganization(ctx context.Context, params *ListAWSServiceAccessForOrganizationInput, optFns ...func(*Options)) (*ListAWSServiceAccessForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAWSServiceAccessForOrganization", params, optFns, addOperationListAWSServiceAccessForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAWSServiceAccessForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
