...
func (c *Client) ListTargetsForPolicy(ctx context.Context, params *ListTargetsForPolicyInput, optFns ...func(*Options)) (*ListTargetsForPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTargetsForPolicy", params, optFns, addOperationListTargetsForPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTargetsForPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
