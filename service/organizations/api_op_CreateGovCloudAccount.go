...
func (c *Client) CreateGovCloudAccount(ctx context.Context, params *CreateGovCloudAccountInput, optFns ...func(*Options)) (*CreateGovCloudAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGovCloudAccount", params, optFns, addOperationCreateGovCloudAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGovCloudAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
