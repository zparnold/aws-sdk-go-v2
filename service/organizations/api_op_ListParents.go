...
func (c *Client) ListParents(ctx context.Context, params *ListParentsInput, optFns ...func(*Options)) (*ListParentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListParents", params, optFns, addOperationListParentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListParentsMiddleware(stack *middleware.Stack, options Options) (err error) {
