...
func (c *Client) DescribeHandshake(ctx context.Context, params *DescribeHandshakeInput, optFns ...func(*Options)) (*DescribeHandshakeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHandshake", params, optFns, addOperationDescribeHandshakeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHandshakeMiddleware(stack *middleware.Stack, options Options) (err error) {
