...
func (c *Client) DeclineHandshake(ctx context.Context, params *DeclineHandshakeInput, optFns ...func(*Options)) (*DeclineHandshakeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeclineHandshake", params, optFns, addOperationDeclineHandshakeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeclineHandshakeMiddleware(stack *middleware.Stack, options Options) (err error) {
