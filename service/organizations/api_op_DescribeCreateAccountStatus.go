...
func (c *Client) DescribeCreateAccountStatus(ctx context.Context, params *DescribeCreateAccountStatusInput, optFns ...func(*Options)) (*DescribeCreateAccountStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCreateAccountStatus", params, optFns, addOperationDescribeCreateAccountStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCreateAccountStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
