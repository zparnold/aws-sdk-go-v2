...
func (c *Client) ListAccounts(ctx context.Context, params *ListAccountsInput, optFns ...func(*Options)) (*ListAccountsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccounts", params, optFns, addOperationListAccountsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccountsMiddleware(stack *middleware.Stack, options Options) (err error) {
