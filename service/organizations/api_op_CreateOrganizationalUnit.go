...
func (c *Client) CreateOrganizationalUnit(ctx context.Context, params *CreateOrganizationalUnitInput, optFns ...func(*Options)) (*CreateOrganizationalUnitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOrganizationalUnit", params, optFns, addOperationCreateOrganizationalUnitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOrganizationalUnitMiddleware(stack *middleware.Stack, options Options) (err error) {
