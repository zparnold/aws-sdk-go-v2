...
func (c *Client) DisablePolicyType(ctx context.Context, params *DisablePolicyTypeInput, optFns ...func(*Options)) (*DisablePolicyTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisablePolicyType", params, optFns, addOperationDisablePolicyTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisablePolicyTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
