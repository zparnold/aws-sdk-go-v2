...
func (c *Client) UpdatePolicy(ctx context.Context, params *UpdatePolicyInput, optFns ...func(*Options)) (*UpdatePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePolicy", params, optFns, addOperationUpdatePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
