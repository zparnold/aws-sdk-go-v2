...
func (c *Client) RemoveAccountFromOrganization(ctx context.Context, params *RemoveAccountFromOrganizationInput, optFns ...func(*Options)) (*RemoveAccountFromOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveAccountFromOrganization", params, optFns, addOperationRemoveAccountFromOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveAccountFromOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
