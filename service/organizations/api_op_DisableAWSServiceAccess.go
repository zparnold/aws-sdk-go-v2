...
func (c *Client) DisableAWSServiceAccess(ctx context.Context, params *DisableAWSServiceAccessInput, optFns ...func(*Options)) (*DisableAWSServiceAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableAWSServiceAccess", params, optFns, addOperationDisableAWSServiceAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableAWSServiceAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
