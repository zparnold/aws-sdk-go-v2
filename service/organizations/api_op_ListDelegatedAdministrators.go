...
func (c *Client) ListDelegatedAdministrators(ctx context.Context, params *ListDelegatedAdministratorsInput, optFns ...func(*Options)) (*ListDelegatedAdministratorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDelegatedAdministrators", params, optFns, addOperationListDelegatedAdministratorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDelegatedAdministratorsMiddleware(stack *middleware.Stack, options Options) (err error) {
