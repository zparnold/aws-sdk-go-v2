...
func (c *Client) ListDelegatedServicesForAccount(ctx context.Context, params *ListDelegatedServicesForAccountInput, optFns ...func(*Options)) (*ListDelegatedServicesForAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDelegatedServicesForAccount", params, optFns, addOperationListDelegatedServicesForAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDelegatedServicesForAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
