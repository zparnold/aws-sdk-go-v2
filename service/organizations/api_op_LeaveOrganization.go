...
func (c *Client) LeaveOrganization(ctx context.Context, params *LeaveOrganizationInput, optFns ...func(*Options)) (*LeaveOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "LeaveOrganization", params, optFns, addOperationLeaveOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLeaveOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
