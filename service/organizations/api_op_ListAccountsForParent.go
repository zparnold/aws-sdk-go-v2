...
func (c *Client) ListAccountsForParent(ctx context.Context, params *ListAccountsForParentInput, optFns ...func(*Options)) (*ListAccountsForParentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccountsForParent", params, optFns, addOperationListAccountsForParentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccountsForParentMiddleware(stack *middleware.Stack, options Options) (err error) {
