...
func (c *Client) DescribePolicy(ctx context.Context, params *DescribePolicyInput, optFns ...func(*Options)) (*DescribePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePolicy", params, optFns, addOperationDescribePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
