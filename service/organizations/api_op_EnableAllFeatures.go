...
func (c *Client) EnableAllFeatures(ctx context.Context, params *EnableAllFeaturesInput, optFns ...func(*Options)) (*EnableAllFeaturesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableAllFeatures", params, optFns, addOperationEnableAllFeaturesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableAllFeaturesMiddleware(stack *middleware.Stack, options Options) (err error) {
