...
func (c *Client) ListRoots(ctx context.Context, params *ListRootsInput, optFns ...func(*Options)) (*ListRootsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRoots", params, optFns, addOperationListRootsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRootsMiddleware(stack *middleware.Stack, options Options) (err error) {
