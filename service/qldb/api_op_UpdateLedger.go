...
func (c *Client) UpdateLedger(ctx context.Context, params *UpdateLedgerInput, optFns ...func(*Options)) (*UpdateLedgerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLedger", params, optFns, addOperationUpdateLedgerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLedgerMiddleware(stack *middleware.Stack, options Options) (err error) {
