...
func (c *Client) ListJournalS3Exports(ctx context.Context, params *ListJournalS3ExportsInput, optFns ...func(*Options)) (*ListJournalS3ExportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJournalS3Exports", params, optFns, addOperationListJournalS3ExportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJournalS3ExportsMiddleware(stack *middleware.Stack, options Options) (err error) {
