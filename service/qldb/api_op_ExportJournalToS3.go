...
func (c *Client) ExportJournalToS3(ctx context.Context, params *ExportJournalToS3Input, optFns ...func(*Options)) (*ExportJournalToS3Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportJournalToS3", params, optFns, addOperationExportJournalToS3Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportJournalToS3Middleware(stack *middleware.Stack, options Options) (err error) {
