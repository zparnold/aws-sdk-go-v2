...
func (c *Client) DescribeLedger(ctx context.Context, params *DescribeLedgerInput, optFns ...func(*Options)) (*DescribeLedgerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLedger", params, optFns, addOperationDescribeLedgerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLedgerMiddleware(stack *middleware.Stack, options Options) (err error) {
