...
func (c *Client) CreateLedger(ctx context.Context, params *CreateLedgerInput, optFns ...func(*Options)) (*CreateLedgerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLedger", params, optFns, addOperationCreateLedgerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLedgerMiddleware(stack *middleware.Stack, options Options) (err error) {
