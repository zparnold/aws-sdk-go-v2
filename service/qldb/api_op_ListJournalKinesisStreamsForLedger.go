...
func (c *Client) ListJournalKinesisStreamsForLedger(ctx context.Context, params *ListJournalKinesisStreamsForLedgerInput, optFns ...func(*Options)) (*ListJournalKinesisStreamsForLedgerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJournalKinesisStreamsForLedger", params, optFns, addOperationListJournalKinesisStreamsForLedgerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJournalKinesisStreamsForLedgerMiddleware(stack *middleware.Stack, options Options) (err error) {
