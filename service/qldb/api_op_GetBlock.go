...
func (c *Client) GetBlock(ctx context.Context, params *GetBlockInput, optFns ...func(*Options)) (*GetBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBlock", params, optFns, addOperationGetBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
