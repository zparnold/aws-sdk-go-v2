...
func (c *Client) DeleteLedger(ctx context.Context, params *DeleteLedgerInput, optFns ...func(*Options)) (*DeleteLedgerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLedger", params, optFns, addOperationDeleteLedgerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLedgerMiddleware(stack *middleware.Stack, options Options) (err error) {
