...
func (c *Client) DescribeJournalKinesisStream(ctx context.Context, params *DescribeJournalKinesisStreamInput, optFns ...func(*Options)) (*DescribeJournalKinesisStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeJournalKinesisStream", params, optFns, addOperationDescribeJournalKinesisStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeJournalKinesisStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
