...
func (c *Client) CancelJournalKinesisStream(ctx context.Context, params *CancelJournalKinesisStreamInput, optFns ...func(*Options)) (*CancelJournalKinesisStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelJournalKinesisStream", params, optFns, addOperationCancelJournalKinesisStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelJournalKinesisStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
