...
func (c *Client) GetRevision(ctx context.Context, params *GetRevisionInput, optFns ...func(*Options)) (*GetRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRevision", params, optFns, addOperationGetRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
