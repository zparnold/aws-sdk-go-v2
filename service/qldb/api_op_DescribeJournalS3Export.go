...
func (c *Client) DescribeJournalS3Export(ctx context.Context, params *DescribeJournalS3ExportInput, optFns ...func(*Options)) (*DescribeJournalS3ExportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeJournalS3Export", params, optFns, addOperationDescribeJournalS3ExportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeJournalS3ExportMiddleware(stack *middleware.Stack, options Options) (err error) {
