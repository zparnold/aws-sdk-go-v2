...
func (c *Client) ListLedgers(ctx context.Context, params *ListLedgersInput, optFns ...func(*Options)) (*ListLedgersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLedgers", params, optFns, addOperationListLedgersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLedgersMiddleware(stack *middleware.Stack, options Options) (err error) {
