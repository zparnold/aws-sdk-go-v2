...
func (c *Client) StreamJournalToKinesis(ctx context.Context, params *StreamJournalToKinesisInput, optFns ...func(*Options)) (*StreamJournalToKinesisOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StreamJournalToKinesis", params, optFns, addOperationStreamJournalToKinesisMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStreamJournalToKinesisMiddleware(stack *middleware.Stack, options Options) (err error) {
