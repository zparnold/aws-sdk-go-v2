...
func (c *Client) ListJournalS3ExportsForLedger(ctx context.Context, params *ListJournalS3ExportsForLedgerInput, optFns ...func(*Options)) (*ListJournalS3ExportsForLedgerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJournalS3ExportsForLedger", params, optFns, addOperationListJournalS3ExportsForLedgerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJournalS3ExportsForLedgerMiddleware(stack *middleware.Stack, options Options) (err error) {
