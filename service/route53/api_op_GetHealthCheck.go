...
func (c *Client) GetHealthCheck(ctx context.Context, params *GetHealthCheckInput, optFns ...func(*Options)) (*GetHealthCheckOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHealthCheck", params, optFns, addOperationGetHealthCheckMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHealthCheckMiddleware(stack *middleware.Stack, options Options) (err error) {
