...
func (c *Client) CreateQueryLoggingConfig(ctx context.Context, params *CreateQueryLoggingConfigInput, optFns ...func(*Options)) (*CreateQueryLoggingConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateQueryLoggingConfig", params, optFns, addOperationCreateQueryLoggingConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateQueryLoggingConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
