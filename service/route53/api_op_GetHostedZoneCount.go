...
func (c *Client) GetHostedZoneCount(ctx context.Context, params *GetHostedZoneCountInput, optFns ...func(*Options)) (*GetHostedZoneCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHostedZoneCount", params, optFns, addOperationGetHostedZoneCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHostedZoneCountMiddleware(stack *middleware.Stack, options Options) (err error) {
