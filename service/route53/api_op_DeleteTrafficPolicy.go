...
func (c *Client) DeleteTrafficPolicy(ctx context.Context, params *DeleteTrafficPolicyInput, optFns ...func(*Options)) (*DeleteTrafficPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrafficPolicy", params, optFns, addOperationDeleteTrafficPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrafficPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
