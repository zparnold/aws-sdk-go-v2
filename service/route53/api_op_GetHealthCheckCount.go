...
func (c *Client) GetHealthCheckCount(ctx context.Context, params *GetHealthCheckCountInput, optFns ...func(*Options)) (*GetHealthCheckCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHealthCheckCount", params, optFns, addOperationGetHealthCheckCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHealthCheckCountMiddleware(stack *middleware.Stack, options Options) (err error) {
