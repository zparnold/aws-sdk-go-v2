...
func (c *Client) CreateHostedZone(ctx context.Context, params *CreateHostedZoneInput, optFns ...func(*Options)) (*CreateHostedZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHostedZone", params, optFns, addOperationCreateHostedZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHostedZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
