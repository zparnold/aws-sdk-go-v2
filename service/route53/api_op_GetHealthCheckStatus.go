...
func (c *Client) GetHealthCheckStatus(ctx context.Context, params *GetHealthCheckStatusInput, optFns ...func(*Options)) (*GetHealthCheckStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHealthCheckStatus", params, optFns, addOperationGetHealthCheckStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHealthCheckStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
