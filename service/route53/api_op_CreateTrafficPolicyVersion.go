...
func (c *Client) CreateTrafficPolicyVersion(ctx context.Context, params *CreateTrafficPolicyVersionInput, optFns ...func(*Options)) (*CreateTrafficPolicyVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrafficPolicyVersion", params, optFns, addOperationCreateTrafficPolicyVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrafficPolicyVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
