...
func (c *Client) ListHostedZonesByVPC(ctx context.Context, params *ListHostedZonesByVPCInput, optFns ...func(*Options)) (*ListHostedZonesByVPCOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHostedZonesByVPC", params, optFns, addOperationListHostedZonesByVPCMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHostedZonesByVPCMiddleware(stack *middleware.Stack, options Options) (err error) {
