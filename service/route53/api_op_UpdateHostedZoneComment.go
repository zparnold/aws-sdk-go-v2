...
func (c *Client) UpdateHostedZoneComment(ctx context.Context, params *UpdateHostedZoneCommentInput, optFns ...func(*Options)) (*UpdateHostedZoneCommentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateHostedZoneComment", params, optFns, addOperationUpdateHostedZoneCommentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateHostedZoneCommentMiddleware(stack *middleware.Stack, options Options) (err error) {
