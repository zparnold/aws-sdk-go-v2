...
func (c *Client) DisassociateVPCFromHostedZone(ctx context.Context, params *DisassociateVPCFromHostedZoneInput, optFns ...func(*Options)) (*DisassociateVPCFromHostedZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateVPCFromHostedZone", params, optFns, addOperationDisassociateVPCFromHostedZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateVPCFromHostedZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
