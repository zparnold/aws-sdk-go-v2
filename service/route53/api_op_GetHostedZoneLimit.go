...
func (c *Client) GetHostedZoneLimit(ctx context.Context, params *GetHostedZoneLimitInput, optFns ...func(*Options)) (*GetHostedZoneLimitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHostedZoneLimit", params, optFns, addOperationGetHostedZoneLimitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHostedZoneLimitMiddleware(stack *middleware.Stack, options Options) (err error) {
