...
func (c *Client) ListResourceRecordSets(ctx context.Context, params *ListResourceRecordSetsInput, optFns ...func(*Options)) (*ListResourceRecordSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceRecordSets", params, optFns, addOperationListResourceRecordSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceRecordSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
