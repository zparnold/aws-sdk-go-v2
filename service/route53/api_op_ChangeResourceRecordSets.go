...
func (c *Client) ChangeResourceRecordSets(ctx context.Context, params *ChangeResourceRecordSetsInput, optFns ...func(*Options)) (*ChangeResourceRecordSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ChangeResourceRecordSets", params, optFns, addOperationChangeResourceRecordSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationChangeResourceRecordSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
