...
func (c *Client) GetQueryLoggingConfig(ctx context.Context, params *GetQueryLoggingConfigInput, optFns ...func(*Options)) (*GetQueryLoggingConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQueryLoggingConfig", params, optFns, addOperationGetQueryLoggingConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQueryLoggingConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
