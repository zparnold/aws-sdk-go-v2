...
func (c *Client) ListTagsForResources(ctx context.Context, params *ListTagsForResourcesInput, optFns ...func(*Options)) (*ListTagsForResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForResources", params, optFns, addOperationListTagsForResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
