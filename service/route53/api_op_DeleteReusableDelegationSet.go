...
func (c *Client) DeleteReusableDelegationSet(ctx context.Context, params *DeleteReusableDelegationSetInput, optFns ...func(*Options)) (*DeleteReusableDelegationSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReusableDelegationSet", params, optFns, addOperationDeleteReusableDelegationSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReusableDelegationSetMiddleware(stack *middleware.Stack, options Options) (err error) {
