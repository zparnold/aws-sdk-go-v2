...
func (c *Client) ListGeoLocations(ctx context.Context, params *ListGeoLocationsInput, optFns ...func(*Options)) (*ListGeoLocationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGeoLocations", params, optFns, addOperationListGeoLocationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGeoLocationsMiddleware(stack *middleware.Stack, options Options) (err error) {
