...
func (c *Client) DeleteQueryLoggingConfig(ctx context.Context, params *DeleteQueryLoggingConfigInput, optFns ...func(*Options)) (*DeleteQueryLoggingConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteQueryLoggingConfig", params, optFns, addOperationDeleteQueryLoggingConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteQueryLoggingConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
