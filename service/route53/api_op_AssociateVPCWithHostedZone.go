...
func (c *Client) AssociateVPCWithHostedZone(ctx context.Context, params *AssociateVPCWithHostedZoneInput, optFns ...func(*Options)) (*AssociateVPCWithHostedZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateVPCWithHostedZone", params, optFns, addOperationAssociateVPCWithHostedZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateVPCWithHostedZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
