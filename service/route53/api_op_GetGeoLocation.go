...
func (c *Client) GetGeoLocation(ctx context.Context, params *GetGeoLocationInput, optFns ...func(*Options)) (*GetGeoLocationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGeoLocation", params, optFns, addOperationGetGeoLocationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGeoLocationMiddleware(stack *middleware.Stack, options Options) (err error) {
