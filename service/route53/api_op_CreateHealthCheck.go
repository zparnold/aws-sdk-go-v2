...
func (c *Client) CreateHealthCheck(ctx context.Context, params *CreateHealthCheckInput, optFns ...func(*Options)) (*CreateHealthCheckOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHealthCheck", params, optFns, addOperationCreateHealthCheckMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHealthCheckMiddleware(stack *middleware.Stack, options Options) (err error) {
