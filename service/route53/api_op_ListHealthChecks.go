...
func (c *Client) ListHealthChecks(ctx context.Context, params *ListHealthChecksInput, optFns ...func(*Options)) (*ListHealthChecksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHealthChecks", params, optFns, addOperationListHealthChecksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHealthChecksMiddleware(stack *middleware.Stack, options Options) (err error) {
