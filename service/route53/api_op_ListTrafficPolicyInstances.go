...
func (c *Client) ListTrafficPolicyInstances(ctx context.Context, params *ListTrafficPolicyInstancesInput, optFns ...func(*Options)) (*ListTrafficPolicyInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrafficPolicyInstances", params, optFns, addOperationListTrafficPolicyInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrafficPolicyInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
