...
func (c *Client) GetHostedZone(ctx context.Context, params *GetHostedZoneInput, optFns ...func(*Options)) (*GetHostedZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHostedZone", params, optFns, addOperationGetHostedZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHostedZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
