...
func (c *Client) ListVPCAssociationAuthorizations(ctx context.Context, params *ListVPCAssociationAuthorizationsInput, optFns ...func(*Options)) (*ListVPCAssociationAuthorizationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVPCAssociationAuthorizations", params, optFns, addOperationListVPCAssociationAuthorizationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVPCAssociationAuthorizationsMiddleware(stack *middleware.Stack, options Options) (err error) {
