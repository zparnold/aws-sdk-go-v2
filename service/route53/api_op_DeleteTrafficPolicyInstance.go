...
func (c *Client) DeleteTrafficPolicyInstance(ctx context.Context, params *DeleteTrafficPolicyInstanceInput, optFns ...func(*Options)) (*DeleteTrafficPolicyInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrafficPolicyInstance", params, optFns, addOperationDeleteTrafficPolicyInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrafficPolicyInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
