...
func (c *Client) ListHostedZones(ctx context.Context, params *ListHostedZonesInput, optFns ...func(*Options)) (*ListHostedZonesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHostedZones", params, optFns, addOperationListHostedZonesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHostedZonesMiddleware(stack *middleware.Stack, options Options) (err error) {
