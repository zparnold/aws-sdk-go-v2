...
func (c *Client) CreateReusableDelegationSet(ctx context.Context, params *CreateReusableDelegationSetInput, optFns ...func(*Options)) (*CreateReusableDelegationSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReusableDelegationSet", params, optFns, addOperationCreateReusableDelegationSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReusableDelegationSetMiddleware(stack *middleware.Stack, options Options) (err error) {
