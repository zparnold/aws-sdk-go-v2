...
func (c *Client) GetChange(ctx context.Context, params *GetChangeInput, optFns ...func(*Options)) (*GetChangeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetChange", params, optFns, addOperationGetChangeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetChangeMiddleware(stack *middleware.Stack, options Options) (err error) {
