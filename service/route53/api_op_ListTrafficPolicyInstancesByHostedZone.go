...
func (c *Client) ListTrafficPolicyInstancesByHostedZone(ctx context.Context, params *ListTrafficPolicyInstancesByHostedZoneInput, optFns ...func(*Options)) (*ListTrafficPolicyInstancesByHostedZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrafficPolicyInstancesByHostedZone", params, optFns, addOperationListTrafficPolicyInstancesByHostedZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrafficPolicyInstancesByHostedZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
