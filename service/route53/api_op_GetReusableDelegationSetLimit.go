...
func (c *Client) GetReusableDelegationSetLimit(ctx context.Context, params *GetReusableDelegationSetLimitInput, optFns ...func(*Options)) (*GetReusableDelegationSetLimitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetReusableDelegationSetLimit", params, optFns, addOperationGetReusableDelegationSetLimitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetReusableDelegationSetLimitMiddleware(stack *middleware.Stack, options Options) (err error) {
