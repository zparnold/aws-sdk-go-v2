...
func (c *Client) DeleteHostedZone(ctx context.Context, params *DeleteHostedZoneInput, optFns ...func(*Options)) (*DeleteHostedZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHostedZone", params, optFns, addOperationDeleteHostedZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHostedZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
