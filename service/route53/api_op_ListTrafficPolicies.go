...
func (c *Client) ListTrafficPolicies(ctx context.Context, params *ListTrafficPoliciesInput, optFns ...func(*Options)) (*ListTrafficPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrafficPolicies", params, optFns, addOperationListTrafficPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrafficPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
