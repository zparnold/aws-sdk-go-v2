...
func (c *Client) DeleteVPCAssociationAuthorization(ctx context.Context, params *DeleteVPCAssociationAuthorizationInput, optFns ...func(*Options)) (*DeleteVPCAssociationAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVPCAssociationAuthorization", params, optFns, addOperationDeleteVPCAssociationAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVPCAssociationAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
