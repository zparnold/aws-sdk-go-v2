...
func (c *Client) ListTrafficPolicyInstancesByPolicy(ctx context.Context, params *ListTrafficPolicyInstancesByPolicyInput, optFns ...func(*Options)) (*ListTrafficPolicyInstancesByPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrafficPolicyInstancesByPolicy", params, optFns, addOperationListTrafficPolicyInstancesByPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrafficPolicyInstancesByPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
