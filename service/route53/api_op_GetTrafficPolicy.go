...
func (c *Client) GetTrafficPolicy(ctx context.Context, params *GetTrafficPolicyInput, optFns ...func(*Options)) (*GetTrafficPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTrafficPolicy", params, optFns, addOperationGetTrafficPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTrafficPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
