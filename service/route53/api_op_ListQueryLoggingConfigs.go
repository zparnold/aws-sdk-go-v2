...
func (c *Client) ListQueryLoggingConfigs(ctx context.Context, params *ListQueryLoggingConfigsInput, optFns ...func(*Options)) (*ListQueryLoggingConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListQueryLoggingConfigs", params, optFns, addOperationListQueryLoggingConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListQueryLoggingConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
