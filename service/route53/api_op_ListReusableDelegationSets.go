...
func (c *Client) ListReusableDelegationSets(ctx context.Context, params *ListReusableDelegationSetsInput, optFns ...func(*Options)) (*ListReusableDelegationSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReusableDelegationSets", params, optFns, addOperationListReusableDelegationSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReusableDelegationSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
