...
func (c *Client) UpdateTrafficPolicyComment(ctx context.Context, params *UpdateTrafficPolicyCommentInput, optFns ...func(*Options)) (*UpdateTrafficPolicyCommentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTrafficPolicyComment", params, optFns, addOperationUpdateTrafficPolicyCommentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTrafficPolicyCommentMiddleware(stack *middleware.Stack, options Options) (err error) {
