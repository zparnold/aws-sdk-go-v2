...
func (c *Client) CreateTrafficPolicy(ctx context.Context, params *CreateTrafficPolicyInput, optFns ...func(*Options)) (*CreateTrafficPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrafficPolicy", params, optFns, addOperationCreateTrafficPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrafficPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
