...
func (c *Client) GetHealthCheckLastFailureReason(ctx context.Context, params *GetHealthCheckLastFailureReasonInput, optFns ...func(*Options)) (*GetHealthCheckLastFailureReasonOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHealthCheckLastFailureReason", params, optFns, addOperationGetHealthCheckLastFailureReasonMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHealthCheckLastFailureReasonMiddleware(stack *middleware.Stack, options Options) (err error) {
