...
func (c *Client) CreateTrafficPolicyInstance(ctx context.Context, params *CreateTrafficPolicyInstanceInput, optFns ...func(*Options)) (*CreateTrafficPolicyInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrafficPolicyInstance", params, optFns, addOperationCreateTrafficPolicyInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrafficPolicyInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
