...
func (c *Client) ListTrafficPolicyVersions(ctx context.Context, params *ListTrafficPolicyVersionsInput, optFns ...func(*Options)) (*ListTrafficPolicyVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrafficPolicyVersions", params, optFns, addOperationListTrafficPolicyVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrafficPolicyVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
