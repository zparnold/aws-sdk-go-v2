...
func (c *Client) GetReusableDelegationSet(ctx context.Context, params *GetReusableDelegationSetInput, optFns ...func(*Options)) (*GetReusableDelegationSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetReusableDelegationSet", params, optFns, addOperationGetReusableDelegationSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetReusableDelegationSetMiddleware(stack *middleware.Stack, options Options) (err error) {
