...
func (c *Client) TestDNSAnswer(ctx context.Context, params *TestDNSAnswerInput, optFns ...func(*Options)) (*TestDNSAnswerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestDNSAnswer", params, optFns, addOperationTestDNSAnswerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestDNSAnswerMiddleware(stack *middleware.Stack, options Options) (err error) {
