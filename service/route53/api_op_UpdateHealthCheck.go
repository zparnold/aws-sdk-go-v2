...
func (c *Client) UpdateHealthCheck(ctx context.Context, params *UpdateHealthCheckInput, optFns ...func(*Options)) (*UpdateHealthCheckOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateHealthCheck", params, optFns, addOperationUpdateHealthCheckMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateHealthCheckMiddleware(stack *middleware.Stack, options Options) (err error) {
