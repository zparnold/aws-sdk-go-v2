...
func (c *Client) GetTrafficPolicyInstanceCount(ctx context.Context, params *GetTrafficPolicyInstanceCountInput, optFns ...func(*Options)) (*GetTrafficPolicyInstanceCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTrafficPolicyInstanceCount", params, optFns, addOperationGetTrafficPolicyInstanceCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTrafficPolicyInstanceCountMiddleware(stack *middleware.Stack, options Options) (err error) {
