...
func (c *Client) GetCheckerIpRanges(ctx context.Context, params *GetCheckerIpRangesInput, optFns ...func(*Options)) (*GetCheckerIpRangesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCheckerIpRanges", params, optFns, addOperationGetCheckerIpRangesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCheckerIpRangesMiddleware(stack *middleware.Stack, options Options) (err error) {
