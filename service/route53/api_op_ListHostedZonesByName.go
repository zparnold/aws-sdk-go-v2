...
func (c *Client) ListHostedZonesByName(ctx context.Context, params *ListHostedZonesByNameInput, optFns ...func(*Options)) (*ListHostedZonesByNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHostedZonesByName", params, optFns, addOperationListHostedZonesByNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHostedZonesByNameMiddleware(stack *middleware.Stack, options Options) (err error) {
