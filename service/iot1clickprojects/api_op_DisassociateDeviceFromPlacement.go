...
func (c *Client) DisassociateDeviceFromPlacement(ctx context.Context, params *DisassociateDeviceFromPlacementInput, optFns ...func(*Options)) (*DisassociateDeviceFromPlacementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateDeviceFromPlacement", params, optFns, addOperationDisassociateDeviceFromPlacementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateDeviceFromPlacementMiddleware(stack *middleware.Stack, options Options) (err error) {
