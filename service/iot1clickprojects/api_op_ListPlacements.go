...
func (c *Client) ListPlacements(ctx context.Context, params *ListPlacementsInput, optFns ...func(*Options)) (*ListPlacementsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPlacements", params, optFns, addOperationListPlacementsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPlacementsMiddleware(stack *middleware.Stack, options Options) (err error) {
