...
func (c *Client) DeletePlacement(ctx context.Context, params *DeletePlacementInput, optFns ...func(*Options)) (*DeletePlacementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePlacement", params, optFns, addOperationDeletePlacementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePlacementMiddleware(stack *middleware.Stack, options Options) (err error) {
