...
func (c *Client) DescribePlacement(ctx context.Context, params *DescribePlacementInput, optFns ...func(*Options)) (*DescribePlacementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePlacement", params, optFns, addOperationDescribePlacementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePlacementMiddleware(stack *middleware.Stack, options Options) (err error) {
