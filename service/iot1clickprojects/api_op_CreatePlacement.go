...
func (c *Client) CreatePlacement(ctx context.Context, params *CreatePlacementInput, optFns ...func(*Options)) (*CreatePlacementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePlacement", params, optFns, addOperationCreatePlacementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePlacementMiddleware(stack *middleware.Stack, options Options) (err error) {
