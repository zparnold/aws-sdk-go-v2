...
func (c *Client) DeleteUtterances(ctx context.Context, params *DeleteUtterancesInput, optFns ...func(*Options)) (*DeleteUtterancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUtterances", params, optFns, addOperationDeleteUtterancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUtterancesMiddleware(stack *middleware.Stack, options Options) (err error) {
