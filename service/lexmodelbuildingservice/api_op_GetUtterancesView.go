...
func (c *Client) GetUtterancesView(ctx context.Context, params *GetUtterancesViewInput, optFns ...func(*Options)) (*GetUtterancesViewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUtterancesView", params, optFns, addOperationGetUtterancesViewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUtterancesViewMiddleware(stack *middleware.Stack, options Options) (err error) {
