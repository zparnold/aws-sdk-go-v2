...
func (c *Client) GetBotVersions(ctx context.Context, params *GetBotVersionsInput, optFns ...func(*Options)) (*GetBotVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBotVersions", params, optFns, addOperationGetBotVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBotVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
