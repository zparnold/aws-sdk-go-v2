...
func (c *Client) PutBot(ctx context.Context, params *PutBotInput, optFns ...func(*Options)) (*PutBotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBot", params, optFns, addOperationPutBotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBotMiddleware(stack *middleware.Stack, options Options) (err error) {
