...
func (c *Client) PutIntent(ctx context.Context, params *PutIntentInput, optFns ...func(*Options)) (*PutIntentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutIntent", params, optFns, addOperationPutIntentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutIntentMiddleware(stack *middleware.Stack, options Options) (err error) {
