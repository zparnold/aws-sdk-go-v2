...
func (c *Client) DeleteBotVersion(ctx context.Context, params *DeleteBotVersionInput, optFns ...func(*Options)) (*DeleteBotVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBotVersion", params, optFns, addOperationDeleteBotVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBotVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
