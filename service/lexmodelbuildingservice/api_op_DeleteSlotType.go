...
func (c *Client) DeleteSlotType(ctx context.Context, params *DeleteSlotTypeInput, optFns ...func(*Options)) (*DeleteSlotTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSlotType", params, optFns, addOperationDeleteSlotTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSlotTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
