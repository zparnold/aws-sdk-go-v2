...
func (c *Client) PutSlotType(ctx context.Context, params *PutSlotTypeInput, optFns ...func(*Options)) (*PutSlotTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSlotType", params, optFns, addOperationPutSlotTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSlotTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
