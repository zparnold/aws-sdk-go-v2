...
func (c *Client) DeleteBotChannelAssociation(ctx context.Context, params *DeleteBotChannelAssociationInput, optFns ...func(*Options)) (*DeleteBotChannelAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBotChannelAssociation", params, optFns, addOperationDeleteBotChannelAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBotChannelAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
