...
func (c *Client) GetBotAlias(ctx context.Context, params *GetBotAliasInput, optFns ...func(*Options)) (*GetBotAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBotAlias", params, optFns, addOperationGetBotAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBotAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
