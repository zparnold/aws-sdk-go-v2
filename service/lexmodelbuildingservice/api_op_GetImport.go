...
func (c *Client) GetImport(ctx context.Context, params *GetImportInput, optFns ...func(*Options)) (*GetImportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetImport", params, optFns, addOperationGetImportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetImportMiddleware(stack *middleware.Stack, options Options) (err error) {
