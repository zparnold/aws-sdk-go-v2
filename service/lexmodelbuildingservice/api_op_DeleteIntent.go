...
func (c *Client) DeleteIntent(ctx context.Context, params *DeleteIntentInput, optFns ...func(*Options)) (*DeleteIntentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIntent", params, optFns, addOperationDeleteIntentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIntentMiddleware(stack *middleware.Stack, options Options) (err error) {
