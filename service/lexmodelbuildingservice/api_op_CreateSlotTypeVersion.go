...
func (c *Client) CreateSlotTypeVersion(ctx context.Context, params *CreateSlotTypeVersionInput, optFns ...func(*Options)) (*CreateSlotTypeVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSlotTypeVersion", params, optFns, addOperationCreateSlotTypeVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSlotTypeVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
