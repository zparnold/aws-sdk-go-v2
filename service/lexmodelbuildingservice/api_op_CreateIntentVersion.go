...
func (c *Client) CreateIntentVersion(ctx context.Context, params *CreateIntentVersionInput, optFns ...func(*Options)) (*CreateIntentVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIntentVersion", params, optFns, addOperationCreateIntentVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIntentVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
