...
func (c *Client) GetBotAliases(ctx context.Context, params *GetBotAliasesInput, optFns ...func(*Options)) (*GetBotAliasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBotAliases", params, optFns, addOperationGetBotAliasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBotAliasesMiddleware(stack *middleware.Stack, options Options) (err error) {
