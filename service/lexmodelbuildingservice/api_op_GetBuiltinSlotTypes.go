...
func (c *Client) GetBuiltinSlotTypes(ctx context.Context, params *GetBuiltinSlotTypesInput, optFns ...func(*Options)) (*GetBuiltinSlotTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBuiltinSlotTypes", params, optFns, addOperationGetBuiltinSlotTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBuiltinSlotTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
