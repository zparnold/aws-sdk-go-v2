...
func (c *Client) GetBotChannelAssociations(ctx context.Context, params *GetBotChannelAssociationsInput, optFns ...func(*Options)) (*GetBotChannelAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBotChannelAssociations", params, optFns, addOperationGetBotChannelAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBotChannelAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
