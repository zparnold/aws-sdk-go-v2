...
func (c *Client) DeleteSlotTypeVersion(ctx context.Context, params *DeleteSlotTypeVersionInput, optFns ...func(*Options)) (*DeleteSlotTypeVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSlotTypeVersion", params, optFns, addOperationDeleteSlotTypeVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSlotTypeVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
