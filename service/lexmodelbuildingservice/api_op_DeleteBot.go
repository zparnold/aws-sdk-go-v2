...
func (c *Client) DeleteBot(ctx context.Context, params *DeleteBotInput, optFns ...func(*Options)) (*DeleteBotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBot", params, optFns, addOperationDeleteBotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBotMiddleware(stack *middleware.Stack, options Options) (err error) {
