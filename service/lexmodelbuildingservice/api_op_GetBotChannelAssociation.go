...
func (c *Client) GetBotChannelAssociation(ctx context.Context, params *GetBotChannelAssociationInput, optFns ...func(*Options)) (*GetBotChannelAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBotChannelAssociation", params, optFns, addOperationGetBotChannelAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBotChannelAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
