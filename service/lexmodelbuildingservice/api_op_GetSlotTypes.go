...
func (c *Client) GetSlotTypes(ctx context.Context, params *GetSlotTypesInput, optFns ...func(*Options)) (*GetSlotTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSlotTypes", params, optFns, addOperationGetSlotTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSlotTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
