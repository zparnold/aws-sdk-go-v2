...
func (c *Client) GetIntentVersions(ctx context.Context, params *GetIntentVersionsInput, optFns ...func(*Options)) (*GetIntentVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntentVersions", params, optFns, addOperationGetIntentVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntentVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
