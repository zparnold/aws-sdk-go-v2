...
func (c *Client) GetBot(ctx context.Context, params *GetBotInput, optFns ...func(*Options)) (*GetBotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBot", params, optFns, addOperationGetBotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBotMiddleware(stack *middleware.Stack, options Options) (err error) {
