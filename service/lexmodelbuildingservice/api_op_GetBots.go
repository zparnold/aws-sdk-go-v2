...
func (c *Client) GetBots(ctx context.Context, params *GetBotsInput, optFns ...func(*Options)) (*GetBotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBots", params, optFns, addOperationGetBotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBotsMiddleware(stack *middleware.Stack, options Options) (err error) {
