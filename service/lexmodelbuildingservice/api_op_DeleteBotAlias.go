...
func (c *Client) DeleteBotAlias(ctx context.Context, params *DeleteBotAliasInput, optFns ...func(*Options)) (*DeleteBotAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBotAlias", params, optFns, addOperationDeleteBotAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBotAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
