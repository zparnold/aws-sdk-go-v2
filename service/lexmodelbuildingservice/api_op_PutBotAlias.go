...
func (c *Client) PutBotAlias(ctx context.Context, params *PutBotAliasInput, optFns ...func(*Options)) (*PutBotAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBotAlias", params, optFns, addOperationPutBotAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBotAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
