...
func (c *Client) CreateBotVersion(ctx context.Context, params *CreateBotVersionInput, optFns ...func(*Options)) (*CreateBotVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBotVersion", params, optFns, addOperationCreateBotVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBotVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
