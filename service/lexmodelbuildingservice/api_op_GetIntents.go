...
func (c *Client) GetIntents(ctx context.Context, params *GetIntentsInput, optFns ...func(*Options)) (*GetIntentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntents", params, optFns, addOperationGetIntentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntentsMiddleware(stack *middleware.Stack, options Options) (err error) {
