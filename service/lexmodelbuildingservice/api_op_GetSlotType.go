...
func (c *Client) GetSlotType(ctx context.Context, params *GetSlotTypeInput, optFns ...func(*Options)) (*GetSlotTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSlotType", params, optFns, addOperationGetSlotTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSlotTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
