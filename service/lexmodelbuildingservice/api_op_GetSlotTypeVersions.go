...
func (c *Client) GetSlotTypeVersions(ctx context.Context, params *GetSlotTypeVersionsInput, optFns ...func(*Options)) (*GetSlotTypeVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSlotTypeVersions", params, optFns, addOperationGetSlotTypeVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSlotTypeVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
