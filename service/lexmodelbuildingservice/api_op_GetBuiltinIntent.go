...
func (c *Client) GetBuiltinIntent(ctx context.Context, params *GetBuiltinIntentInput, optFns ...func(*Options)) (*GetBuiltinIntentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBuiltinIntent", params, optFns, addOperationGetBuiltinIntentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBuiltinIntentMiddleware(stack *middleware.Stack, options Options) (err error) {
