...
func (c *Client) GetIntent(ctx context.Context, params *GetIntentInput, optFns ...func(*Options)) (*GetIntentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntent", params, optFns, addOperationGetIntentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntentMiddleware(stack *middleware.Stack, options Options) (err error) {
