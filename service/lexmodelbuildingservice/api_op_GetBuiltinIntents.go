...
func (c *Client) GetBuiltinIntents(ctx context.Context, params *GetBuiltinIntentsInput, optFns ...func(*Options)) (*GetBuiltinIntentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBuiltinIntents", params, optFns, addOperationGetBuiltinIntentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBuiltinIntentsMiddleware(stack *middleware.Stack, options Options) (err error) {
