...
func (c *Client) CreateHIT(ctx context.Context, params *CreateHITInput, optFns ...func(*Options)) (*CreateHITOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHIT", params, optFns, addOperationCreateHITMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHITMiddleware(stack *middleware.Stack, options Options) (err error) {
