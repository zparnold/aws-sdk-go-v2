...
func (c *Client) NotifyWorkers(ctx context.Context, params *NotifyWorkersInput, optFns ...func(*Options)) (*NotifyWorkersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NotifyWorkers", params, optFns, addOperationNotifyWorkersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNotifyWorkersMiddleware(stack *middleware.Stack, options Options) (err error) {
