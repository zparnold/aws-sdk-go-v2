...
func (c *Client) ListHITs(ctx context.Context, params *ListHITsInput, optFns ...func(*Options)) (*ListHITsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHITs", params, optFns, addOperationListHITsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHITsMiddleware(stack *middleware.Stack, options Options) (err error) {
