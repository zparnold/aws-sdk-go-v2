...
func (c *Client) UpdateHITTypeOfHIT(ctx context.Context, params *UpdateHITTypeOfHITInput, optFns ...func(*Options)) (*UpdateHITTypeOfHITOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateHITTypeOfHIT", params, optFns, addOperationUpdateHITTypeOfHITMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateHITTypeOfHITMiddleware(stack *middleware.Stack, options Options) (err error) {
