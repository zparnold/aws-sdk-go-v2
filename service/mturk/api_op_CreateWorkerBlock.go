...
func (c *Client) CreateWorkerBlock(ctx context.Context, params *CreateWorkerBlockInput, optFns ...func(*Options)) (*CreateWorkerBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateWorkerBlock", params, optFns, addOperationCreateWorkerBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateWorkerBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
