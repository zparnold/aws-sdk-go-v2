...
func (c *Client) ListQualificationRequests(ctx context.Context, params *ListQualificationRequestsInput, optFns ...func(*Options)) (*ListQualificationRequestsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListQualificationRequests", params, optFns, addOperationListQualificationRequestsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListQualificationRequestsMiddleware(stack *middleware.Stack, options Options) (err error) {
