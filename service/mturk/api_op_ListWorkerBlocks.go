...
func (c *Client) ListWorkerBlocks(ctx context.Context, params *ListWorkerBlocksInput, optFns ...func(*Options)) (*ListWorkerBlocksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWorkerBlocks", params, optFns, addOperationListWorkerBlocksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWorkerBlocksMiddleware(stack *middleware.Stack, options Options) (err error) {
