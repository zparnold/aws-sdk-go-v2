...
func (c *Client) GetQualificationScore(ctx context.Context, params *GetQualificationScoreInput, optFns ...func(*Options)) (*GetQualificationScoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQualificationScore", params, optFns, addOperationGetQualificationScoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQualificationScoreMiddleware(stack *middleware.Stack, options Options) (err error) {
