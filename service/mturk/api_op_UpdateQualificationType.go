...
func (c *Client) UpdateQualificationType(ctx context.Context, params *UpdateQualificationTypeInput, optFns ...func(*Options)) (*UpdateQualificationTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateQualificationType", params, optFns, addOperationUpdateQualificationTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateQualificationTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
