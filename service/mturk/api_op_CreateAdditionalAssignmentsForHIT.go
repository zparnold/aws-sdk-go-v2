...
func (c *Client) CreateAdditionalAssignmentsForHIT(ctx context.Context, params *CreateAdditionalAssignmentsForHITInput, optFns ...func(*Options)) (*CreateAdditionalAssignmentsForHITOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAdditionalAssignmentsForHIT", params, optFns, addOperationCreateAdditionalAssignmentsForHITMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAdditionalAssignmentsForHITMiddleware(stack *middleware.Stack, options Options) (err error) {
