...
func (c *Client) CreateHITType(ctx context.Context, params *CreateHITTypeInput, optFns ...func(*Options)) (*CreateHITTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHITType", params, optFns, addOperationCreateHITTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHITTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
