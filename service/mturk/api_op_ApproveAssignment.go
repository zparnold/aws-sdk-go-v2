...
func (c *Client) ApproveAssignment(ctx context.Context, params *ApproveAssignmentInput, optFns ...func(*Options)) (*ApproveAssignmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ApproveAssignment", params, optFns, addOperationApproveAssignmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationApproveAssignmentMiddleware(stack *middleware.Stack, options Options) (err error) {
