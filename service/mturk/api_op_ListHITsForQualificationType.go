...
func (c *Client) ListHITsForQualificationType(ctx context.Context, params *ListHITsForQualificationTypeInput, optFns ...func(*Options)) (*ListHITsForQualificationTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHITsForQualificationType", params, optFns, addOperationListHITsForQualificationTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHITsForQualificationTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
