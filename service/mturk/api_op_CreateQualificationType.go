...
func (c *Client) CreateQualificationType(ctx context.Context, params *CreateQualificationTypeInput, optFns ...func(*Options)) (*CreateQualificationTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateQualificationType", params, optFns, addOperationCreateQualificationTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateQualificationTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
