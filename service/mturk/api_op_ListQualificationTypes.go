...
func (c *Client) ListQualificationTypes(ctx context.Context, params *ListQualificationTypesInput, optFns ...func(*Options)) (*ListQualificationTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListQualificationTypes", params, optFns, addOperationListQualificationTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListQualificationTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
