...
func (c *Client) UpdateExpirationForHIT(ctx context.Context, params *UpdateExpirationForHITInput, optFns ...func(*Options)) (*UpdateExpirationForHITOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateExpirationForHIT", params, optFns, addOperationUpdateExpirationForHITMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateExpirationForHITMiddleware(stack *middleware.Stack, options Options) (err error) {
