...
func (c *Client) SendBonus(ctx context.Context, params *SendBonusInput, optFns ...func(*Options)) (*SendBonusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendBonus", params, optFns, addOperationSendBonusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendBonusMiddleware(stack *middleware.Stack, options Options) (err error) {
