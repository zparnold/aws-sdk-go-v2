...
func (c *Client) GetFileUploadURL(ctx context.Context, params *GetFileUploadURLInput, optFns ...func(*Options)) (*GetFileUploadURLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFileUploadURL", params, optFns, addOperationGetFileUploadURLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFileUploadURLMiddleware(stack *middleware.Stack, options Options) (err error) {
