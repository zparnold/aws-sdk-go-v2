...
func (c *Client) ListWorkersWithQualificationType(ctx context.Context, params *ListWorkersWithQualificationTypeInput, optFns ...func(*Options)) (*ListWorkersWithQualificationTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWorkersWithQualificationType", params, optFns, addOperationListWorkersWithQualificationTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWorkersWithQualificationTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
