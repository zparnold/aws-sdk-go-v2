...
func (c *Client) GetHIT(ctx context.Context, params *GetHITInput, optFns ...func(*Options)) (*GetHITOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHIT", params, optFns, addOperationGetHITMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHITMiddleware(stack *middleware.Stack, options Options) (err error) {
