...
func (c *Client) UpdateNotificationSettings(ctx context.Context, params *UpdateNotificationSettingsInput, optFns ...func(*Options)) (*UpdateNotificationSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNotificationSettings", params, optFns, addOperationUpdateNotificationSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNotificationSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
