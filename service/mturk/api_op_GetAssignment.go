...
func (c *Client) GetAssignment(ctx context.Context, params *GetAssignmentInput, optFns ...func(*Options)) (*GetAssignmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssignment", params, optFns, addOperationGetAssignmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssignmentMiddleware(stack *middleware.Stack, options Options) (err error) {
