...
func (c *Client) DeleteQualificationType(ctx context.Context, params *DeleteQualificationTypeInput, optFns ...func(*Options)) (*DeleteQualificationTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteQualificationType", params, optFns, addOperationDeleteQualificationTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteQualificationTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
