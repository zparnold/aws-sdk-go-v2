...
func (c *Client) RejectAssignment(ctx context.Context, params *RejectAssignmentInput, optFns ...func(*Options)) (*RejectAssignmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectAssignment", params, optFns, addOperationRejectAssignmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectAssignmentMiddleware(stack *middleware.Stack, options Options) (err error) {
