...
func (c *Client) ListAssignmentsForHIT(ctx context.Context, params *ListAssignmentsForHITInput, optFns ...func(*Options)) (*ListAssignmentsForHITOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssignmentsForHIT", params, optFns, addOperationListAssignmentsForHITMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssignmentsForHITMiddleware(stack *middleware.Stack, options Options) (err error) {
