...
func (c *Client) GetAccountBalance(ctx context.Context, params *GetAccountBalanceInput, optFns ...func(*Options)) (*GetAccountBalanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccountBalance", params, optFns, addOperationGetAccountBalanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccountBalanceMiddleware(stack *middleware.Stack, options Options) (err error) {
