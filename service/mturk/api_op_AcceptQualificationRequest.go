...
func (c *Client) AcceptQualificationRequest(ctx context.Context, params *AcceptQualificationRequestInput, optFns ...func(*Options)) (*AcceptQualificationRequestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptQualificationRequest", params, optFns, addOperationAcceptQualificationRequestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptQualificationRequestMiddleware(stack *middleware.Stack, options Options) (err error) {
