...
func (c *Client) AssociateQualificationWithWorker(ctx context.Context, params *AssociateQualificationWithWorkerInput, optFns ...func(*Options)) (*AssociateQualificationWithWorkerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateQualificationWithWorker", params, optFns, addOperationAssociateQualificationWithWorkerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateQualificationWithWorkerMiddleware(stack *middleware.Stack, options Options) (err error) {
