...
func (c *Client) RejectQualificationRequest(ctx context.Context, params *RejectQualificationRequestInput, optFns ...func(*Options)) (*RejectQualificationRequestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectQualificationRequest", params, optFns, addOperationRejectQualificationRequestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectQualificationRequestMiddleware(stack *middleware.Stack, options Options) (err error) {
