...
func (c *Client) CreateHITWithHITType(ctx context.Context, params *CreateHITWithHITTypeInput, optFns ...func(*Options)) (*CreateHITWithHITTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHITWithHITType", params, optFns, addOperationCreateHITWithHITTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHITWithHITTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
