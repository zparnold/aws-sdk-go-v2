...
func (c *Client) ListReviewableHITs(ctx context.Context, params *ListReviewableHITsInput, optFns ...func(*Options)) (*ListReviewableHITsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReviewableHITs", params, optFns, addOperationListReviewableHITsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReviewableHITsMiddleware(stack *middleware.Stack, options Options) (err error) {
