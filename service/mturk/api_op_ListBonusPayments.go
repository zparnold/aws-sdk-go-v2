...
func (c *Client) ListBonusPayments(ctx context.Context, params *ListBonusPaymentsInput, optFns ...func(*Options)) (*ListBonusPaymentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBonusPayments", params, optFns, addOperationListBonusPaymentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBonusPaymentsMiddleware(stack *middleware.Stack, options Options) (err error) {
