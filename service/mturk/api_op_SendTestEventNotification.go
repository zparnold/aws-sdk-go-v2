...
func (c *Client) SendTestEventNotification(ctx context.Context, params *SendTestEventNotificationInput, optFns ...func(*Options)) (*SendTestEventNotificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendTestEventNotification", params, optFns, addOperationSendTestEventNotificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendTestEventNotificationMiddleware(stack *middleware.Stack, options Options) (err error) {
