...
func (c *Client) DeleteWorkerBlock(ctx context.Context, params *DeleteWorkerBlockInput, optFns ...func(*Options)) (*DeleteWorkerBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWorkerBlock", params, optFns, addOperationDeleteWorkerBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWorkerBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
