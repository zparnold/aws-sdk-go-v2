...
func (c *Client) ListReviewPolicyResultsForHIT(ctx context.Context, params *ListReviewPolicyResultsForHITInput, optFns ...func(*Options)) (*ListReviewPolicyResultsForHITOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReviewPolicyResultsForHIT", params, optFns, addOperationListReviewPolicyResultsForHITMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReviewPolicyResultsForHITMiddleware(stack *middleware.Stack, options Options) (err error) {
