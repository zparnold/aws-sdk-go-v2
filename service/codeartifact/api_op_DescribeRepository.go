...
func (c *Client) DescribeRepository(ctx context.Context, params *DescribeRepositoryInput, optFns ...func(*Options)) (*DescribeRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRepository", params, optFns, addOperationDescribeRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
