...
func (c *Client) PutRepositoryPermissionsPolicy(ctx context.Context, params *PutRepositoryPermissionsPolicyInput, optFns ...func(*Options)) (*PutRepositoryPermissionsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRepositoryPermissionsPolicy", params, optFns, addOperationPutRepositoryPermissionsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRepositoryPermissionsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
