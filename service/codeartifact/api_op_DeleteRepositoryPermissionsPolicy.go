...
func (c *Client) DeleteRepositoryPermissionsPolicy(ctx context.Context, params *DeleteRepositoryPermissionsPolicyInput, optFns ...func(*Options)) (*DeleteRepositoryPermissionsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRepositoryPermissionsPolicy", params, optFns, addOperationDeleteRepositoryPermissionsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRepositoryPermissionsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
