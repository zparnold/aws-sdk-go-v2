...
func (c *Client) AssociateExternalConnection(ctx context.Context, params *AssociateExternalConnectionInput, optFns ...func(*Options)) (*AssociateExternalConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateExternalConnection", params, optFns, addOperationAssociateExternalConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateExternalConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
