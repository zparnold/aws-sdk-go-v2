...
func (c *Client) ListRepositoriesInDomain(ctx context.Context, params *ListRepositoriesInDomainInput, optFns ...func(*Options)) (*ListRepositoriesInDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRepositoriesInDomain", params, optFns, addOperationListRepositoriesInDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRepositoriesInDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
