...
func (c *Client) UpdateRepository(ctx context.Context, params *UpdateRepositoryInput, optFns ...func(*Options)) (*UpdateRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRepository", params, optFns, addOperationUpdateRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
