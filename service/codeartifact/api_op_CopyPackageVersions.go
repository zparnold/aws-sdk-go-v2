...
func (c *Client) CopyPackageVersions(ctx context.Context, params *CopyPackageVersionsInput, optFns ...func(*Options)) (*CopyPackageVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyPackageVersions", params, optFns, addOperationCopyPackageVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyPackageVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
