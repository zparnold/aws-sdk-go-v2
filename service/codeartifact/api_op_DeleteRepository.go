...
func (c *Client) DeleteRepository(ctx context.Context, params *DeleteRepositoryInput, optFns ...func(*Options)) (*DeleteRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRepository", params, optFns, addOperationDeleteRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
