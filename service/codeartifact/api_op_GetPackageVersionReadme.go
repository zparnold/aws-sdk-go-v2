...
func (c *Client) GetPackageVersionReadme(ctx context.Context, params *GetPackageVersionReadmeInput, optFns ...func(*Options)) (*GetPackageVersionReadmeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPackageVersionReadme", params, optFns, addOperationGetPackageVersionReadmeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPackageVersionReadmeMiddleware(stack *middleware.Stack, options Options) (err error) {
