...
func (c *Client) ListPackageVersionDependencies(ctx context.Context, params *ListPackageVersionDependenciesInput, optFns ...func(*Options)) (*ListPackageVersionDependenciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPackageVersionDependencies", params, optFns, addOperationListPackageVersionDependenciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPackageVersionDependenciesMiddleware(stack *middleware.Stack, options Options) (err error) {
