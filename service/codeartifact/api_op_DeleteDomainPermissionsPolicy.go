...
func (c *Client) DeleteDomainPermissionsPolicy(ctx context.Context, params *DeleteDomainPermissionsPolicyInput, optFns ...func(*Options)) (*DeleteDomainPermissionsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDomainPermissionsPolicy", params, optFns, addOperationDeleteDomainPermissionsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDomainPermissionsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
