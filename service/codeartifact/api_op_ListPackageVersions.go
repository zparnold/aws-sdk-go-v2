...
func (c *Client) ListPackageVersions(ctx context.Context, params *ListPackageVersionsInput, optFns ...func(*Options)) (*ListPackageVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPackageVersions", params, optFns, addOperationListPackageVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPackageVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
