...
func (c *Client) DescribePackageVersion(ctx context.Context, params *DescribePackageVersionInput, optFns ...func(*Options)) (*DescribePackageVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePackageVersion", params, optFns, addOperationDescribePackageVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePackageVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
