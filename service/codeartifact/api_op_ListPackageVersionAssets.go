...
func (c *Client) ListPackageVersionAssets(ctx context.Context, params *ListPackageVersionAssetsInput, optFns ...func(*Options)) (*ListPackageVersionAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPackageVersionAssets", params, optFns, addOperationListPackageVersionAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPackageVersionAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
