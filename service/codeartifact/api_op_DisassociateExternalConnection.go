...
func (c *Client) DisassociateExternalConnection(ctx context.Context, params *DisassociateExternalConnectionInput, optFns ...func(*Options)) (*DisassociateExternalConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateExternalConnection", params, optFns, addOperationDisassociateExternalConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateExternalConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
