...
func (c *Client) GetPackageVersionAsset(ctx context.Context, params *GetPackageVersionAssetInput, optFns ...func(*Options)) (*GetPackageVersionAssetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPackageVersionAsset", params, optFns, addOperationGetPackageVersionAssetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPackageVersionAssetMiddleware(stack *middleware.Stack, options Options) (err error) {
