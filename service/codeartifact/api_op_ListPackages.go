...
func (c *Client) ListPackages(ctx context.Context, params *ListPackagesInput, optFns ...func(*Options)) (*ListPackagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPackages", params, optFns, addOperationListPackagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPackagesMiddleware(stack *middleware.Stack, options Options) (err error) {
