...
func (c *Client) DeleteDomain(ctx context.Context, params *DeleteDomainInput, optFns ...func(*Options)) (*DeleteDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDomain", params, optFns, addOperationDeleteDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
