...
func (c *Client) DeletePackageVersions(ctx context.Context, params *DeletePackageVersionsInput, optFns ...func(*Options)) (*DeletePackageVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePackageVersions", params, optFns, addOperationDeletePackageVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePackageVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
