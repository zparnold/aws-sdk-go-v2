...
func (c *Client) PutDomainPermissionsPolicy(ctx context.Context, params *PutDomainPermissionsPolicyInput, optFns ...func(*Options)) (*PutDomainPermissionsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDomainPermissionsPolicy", params, optFns, addOperationPutDomainPermissionsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDomainPermissionsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
