...
func (c *Client) UpdatePackageVersionsStatus(ctx context.Context, params *UpdatePackageVersionsStatusInput, optFns ...func(*Options)) (*UpdatePackageVersionsStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePackageVersionsStatus", params, optFns, addOperationUpdatePackageVersionsStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePackageVersionsStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
