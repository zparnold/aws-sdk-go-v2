...
func (c *Client) GetDomainPermissionsPolicy(ctx context.Context, params *GetDomainPermissionsPolicyInput, optFns ...func(*Options)) (*GetDomainPermissionsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainPermissionsPolicy", params, optFns, addOperationGetDomainPermissionsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainPermissionsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
