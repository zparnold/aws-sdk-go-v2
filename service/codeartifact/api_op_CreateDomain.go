...
func (c *Client) CreateDomain(ctx context.Context, params *CreateDomainInput, optFns ...func(*Options)) (*CreateDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDomain", params, optFns, addOperationCreateDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
