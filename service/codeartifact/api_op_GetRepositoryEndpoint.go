...
func (c *Client) GetRepositoryEndpoint(ctx context.Context, params *GetRepositoryEndpointInput, optFns ...func(*Options)) (*GetRepositoryEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRepositoryEndpoint", params, optFns, addOperationGetRepositoryEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRepositoryEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
