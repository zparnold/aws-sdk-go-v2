...
func (c *Client) DisposePackageVersions(ctx context.Context, params *DisposePackageVersionsInput, optFns ...func(*Options)) (*DisposePackageVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisposePackageVersions", params, optFns, addOperationDisposePackageVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisposePackageVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
