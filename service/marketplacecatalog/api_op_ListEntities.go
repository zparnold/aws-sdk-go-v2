...
func (c *Client) ListEntities(ctx context.Context, params *ListEntitiesInput, optFns ...func(*Options)) (*ListEntitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEntities", params, optFns, addOperationListEntitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEntitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
