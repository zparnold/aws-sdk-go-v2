...
func (c *Client) StartChangeSet(ctx context.Context, params *StartChangeSetInput, optFns ...func(*Options)) (*StartChangeSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartChangeSet", params, optFns, addOperationStartChangeSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartChangeSetMiddleware(stack *middleware.Stack, options Options) (err error) {
