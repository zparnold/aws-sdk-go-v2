...
func (c *Client) DescribeEntity(ctx context.Context, params *DescribeEntityInput, optFns ...func(*Options)) (*DescribeEntityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEntity", params, optFns, addOperationDescribeEntityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEntityMiddleware(stack *middleware.Stack, options Options) (err error) {
