...
func (c *Client) CancelChangeSet(ctx context.Context, params *CancelChangeSetInput, optFns ...func(*Options)) (*CancelChangeSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelChangeSet", params, optFns, addOperationCancelChangeSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelChangeSetMiddleware(stack *middleware.Stack, options Options) (err error) {
