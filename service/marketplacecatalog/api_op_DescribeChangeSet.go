...
func (c *Client) DescribeChangeSet(ctx context.Context, params *DescribeChangeSetInput, optFns ...func(*Options)) (*DescribeChangeSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeChangeSet", params, optFns, addOperationDescribeChangeSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeChangeSetMiddleware(stack *middleware.Stack, options Options) (err error) {
