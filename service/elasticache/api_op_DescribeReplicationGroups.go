...
func (c *Client) DescribeReplicationGroups(ctx context.Context, params *DescribeReplicationGroupsInput, optFns ...func(*Options)) (*DescribeReplicationGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReplicationGroups", params, optFns, addOperationDescribeReplicationGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReplicationGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
