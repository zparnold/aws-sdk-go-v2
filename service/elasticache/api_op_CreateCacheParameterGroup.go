...
func (c *Client) CreateCacheParameterGroup(ctx context.Context, params *CreateCacheParameterGroupInput, optFns ...func(*Options)) (*CreateCacheParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCacheParameterGroup", params, optFns, addOperationCreateCacheParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCacheParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
