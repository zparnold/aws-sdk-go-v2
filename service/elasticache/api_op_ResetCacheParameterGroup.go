...
func (c *Client) ResetCacheParameterGroup(ctx context.Context, params *ResetCacheParameterGroupInput, optFns ...func(*Options)) (*ResetCacheParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetCacheParameterGroup", params, optFns, addOperationResetCacheParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetCacheParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
