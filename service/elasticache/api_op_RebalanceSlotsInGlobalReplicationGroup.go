...
func (c *Client) RebalanceSlotsInGlobalReplicationGroup(ctx context.Context, params *RebalanceSlotsInGlobalReplicationGroupInput, optFns ...func(*Options)) (*RebalanceSlotsInGlobalReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebalanceSlotsInGlobalReplicationGroup", params, optFns, addOperationRebalanceSlotsInGlobalReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebalanceSlotsInGlobalReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
