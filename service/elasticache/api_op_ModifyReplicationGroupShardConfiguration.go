...
func (c *Client) ModifyReplicationGroupShardConfiguration(ctx context.Context, params *ModifyReplicationGroupShardConfigurationInput, optFns ...func(*Options)) (*ModifyReplicationGroupShardConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyReplicationGroupShardConfiguration", params, optFns, addOperationModifyReplicationGroupShardConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyReplicationGroupShardConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
