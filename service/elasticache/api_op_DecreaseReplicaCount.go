...
func (c *Client) DecreaseReplicaCount(ctx context.Context, params *DecreaseReplicaCountInput, optFns ...func(*Options)) (*DecreaseReplicaCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DecreaseReplicaCount", params, optFns, addOperationDecreaseReplicaCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDecreaseReplicaCountMiddleware(stack *middleware.Stack, options Options) (err error) {
