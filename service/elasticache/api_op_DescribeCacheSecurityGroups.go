...
func (c *Client) DescribeCacheSecurityGroups(ctx context.Context, params *DescribeCacheSecurityGroupsInput, optFns ...func(*Options)) (*DescribeCacheSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCacheSecurityGroups", params, optFns, addOperationDescribeCacheSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
