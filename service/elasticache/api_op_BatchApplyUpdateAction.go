...
func (c *Client) BatchApplyUpdateAction(ctx context.Context, params *BatchApplyUpdateActionInput, optFns ...func(*Options)) (*BatchApplyUpdateActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchApplyUpdateAction", params, optFns, addOperationBatchApplyUpdateActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchApplyUpdateActionMiddleware(stack *middleware.Stack, options Options) (err error) {
