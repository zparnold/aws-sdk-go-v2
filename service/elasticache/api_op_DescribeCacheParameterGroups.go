...
func (c *Client) DescribeCacheParameterGroups(ctx context.Context, params *DescribeCacheParameterGroupsInput, optFns ...func(*Options)) (*DescribeCacheParameterGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCacheParameterGroups", params, optFns, addOperationDescribeCacheParameterGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheParameterGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
