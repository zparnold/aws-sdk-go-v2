...
func (c *Client) DescribeSnapshots(ctx context.Context, params *DescribeSnapshotsInput, optFns ...func(*Options)) (*DescribeSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSnapshots", params, optFns, addOperationDescribeSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
