...
func (c *Client) DescribeCacheSubnetGroups(ctx context.Context, params *DescribeCacheSubnetGroupsInput, optFns ...func(*Options)) (*DescribeCacheSubnetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCacheSubnetGroups", params, optFns, addOperationDescribeCacheSubnetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheSubnetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
