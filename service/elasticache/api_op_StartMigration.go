...
func (c *Client) StartMigration(ctx context.Context, params *StartMigrationInput, optFns ...func(*Options)) (*StartMigrationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMigration", params, optFns, addOperationStartMigrationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMigrationMiddleware(stack *middleware.Stack, options Options) (err error) {
