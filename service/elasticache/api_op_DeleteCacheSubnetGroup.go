...
func (c *Client) DeleteCacheSubnetGroup(ctx context.Context, params *DeleteCacheSubnetGroupInput, optFns ...func(*Options)) (*DeleteCacheSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCacheSubnetGroup", params, optFns, addOperationDeleteCacheSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCacheSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
