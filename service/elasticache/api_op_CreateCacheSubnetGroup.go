...
func (c *Client) CreateCacheSubnetGroup(ctx context.Context, params *CreateCacheSubnetGroupInput, optFns ...func(*Options)) (*CreateCacheSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCacheSubnetGroup", params, optFns, addOperationCreateCacheSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCacheSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
