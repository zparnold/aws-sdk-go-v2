...
func (c *Client) CreateReplicationGroup(ctx context.Context, params *CreateReplicationGroupInput, optFns ...func(*Options)) (*CreateReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReplicationGroup", params, optFns, addOperationCreateReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
