...
func (c *Client) DescribeUpdateActions(ctx context.Context, params *DescribeUpdateActionsInput, optFns ...func(*Options)) (*DescribeUpdateActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUpdateActions", params, optFns, addOperationDescribeUpdateActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUpdateActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
