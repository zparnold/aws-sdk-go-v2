...
func (c *Client) DecreaseNodeGroupsInGlobalReplicationGroup(ctx context.Context, params *DecreaseNodeGroupsInGlobalReplicationGroupInput, optFns ...func(*Options)) (*DecreaseNodeGroupsInGlobalReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DecreaseNodeGroupsInGlobalReplicationGroup", params, optFns, addOperationDecreaseNodeGroupsInGlobalReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDecreaseNodeGroupsInGlobalReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
