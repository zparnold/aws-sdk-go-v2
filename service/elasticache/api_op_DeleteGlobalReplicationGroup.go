...
func (c *Client) DeleteGlobalReplicationGroup(ctx context.Context, params *DeleteGlobalReplicationGroupInput, optFns ...func(*Options)) (*DeleteGlobalReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGlobalReplicationGroup", params, optFns, addOperationDeleteGlobalReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGlobalReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
