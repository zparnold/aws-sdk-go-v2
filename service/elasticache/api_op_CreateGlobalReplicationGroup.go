...
func (c *Client) CreateGlobalReplicationGroup(ctx context.Context, params *CreateGlobalReplicationGroupInput, optFns ...func(*Options)) (*CreateGlobalReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGlobalReplicationGroup", params, optFns, addOperationCreateGlobalReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGlobalReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
