...
func (c *Client) ModifyCacheCluster(ctx context.Context, params *ModifyCacheClusterInput, optFns ...func(*Options)) (*ModifyCacheClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyCacheCluster", params, optFns, addOperationModifyCacheClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyCacheClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
