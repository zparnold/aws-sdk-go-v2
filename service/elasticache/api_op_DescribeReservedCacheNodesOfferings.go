...
func (c *Client) DescribeReservedCacheNodesOfferings(ctx context.Context, params *DescribeReservedCacheNodesOfferingsInput, optFns ...func(*Options)) (*DescribeReservedCacheNodesOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedCacheNodesOfferings", params, optFns, addOperationDescribeReservedCacheNodesOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedCacheNodesOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
