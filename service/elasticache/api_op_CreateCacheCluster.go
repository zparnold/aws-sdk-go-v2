...
func (c *Client) CreateCacheCluster(ctx context.Context, params *CreateCacheClusterInput, optFns ...func(*Options)) (*CreateCacheClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCacheCluster", params, optFns, addOperationCreateCacheClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCacheClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
