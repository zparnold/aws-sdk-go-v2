...
func (c *Client) DisassociateGlobalReplicationGroup(ctx context.Context, params *DisassociateGlobalReplicationGroupInput, optFns ...func(*Options)) (*DisassociateGlobalReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateGlobalReplicationGroup", params, optFns, addOperationDisassociateGlobalReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateGlobalReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
