...
func (c *Client) CopySnapshot(ctx context.Context, params *CopySnapshotInput, optFns ...func(*Options)) (*CopySnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopySnapshot", params, optFns, addOperationCopySnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopySnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
