...
func (c *Client) CompleteMigration(ctx context.Context, params *CompleteMigrationInput, optFns ...func(*Options)) (*CompleteMigrationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CompleteMigration", params, optFns, addOperationCompleteMigrationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCompleteMigrationMiddleware(stack *middleware.Stack, options Options) (err error) {
