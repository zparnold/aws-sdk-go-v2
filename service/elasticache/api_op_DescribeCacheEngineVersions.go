...
func (c *Client) DescribeCacheEngineVersions(ctx context.Context, params *DescribeCacheEngineVersionsInput, optFns ...func(*Options)) (*DescribeCacheEngineVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCacheEngineVersions", params, optFns, addOperationDescribeCacheEngineVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheEngineVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
