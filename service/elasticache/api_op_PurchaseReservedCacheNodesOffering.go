...
func (c *Client) PurchaseReservedCacheNodesOffering(ctx context.Context, params *PurchaseReservedCacheNodesOfferingInput, optFns ...func(*Options)) (*PurchaseReservedCacheNodesOfferingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurchaseReservedCacheNodesOffering", params, optFns, addOperationPurchaseReservedCacheNodesOfferingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurchaseReservedCacheNodesOfferingMiddleware(stack *middleware.Stack, options Options) (err error) {
