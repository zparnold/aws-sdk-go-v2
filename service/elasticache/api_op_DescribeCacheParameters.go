...
func (c *Client) DescribeCacheParameters(ctx context.Context, params *DescribeCacheParametersInput, optFns ...func(*Options)) (*DescribeCacheParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCacheParameters", params, optFns, addOperationDescribeCacheParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
