...
func (c *Client) AuthorizeCacheSecurityGroupIngress(ctx context.Context, params *AuthorizeCacheSecurityGroupIngressInput, optFns ...func(*Options)) (*AuthorizeCacheSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeCacheSecurityGroupIngress", params, optFns, addOperationAuthorizeCacheSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeCacheSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
