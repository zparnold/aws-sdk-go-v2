...
func (c *Client) DescribeCacheClusters(ctx context.Context, params *DescribeCacheClustersInput, optFns ...func(*Options)) (*DescribeCacheClustersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCacheClusters", params, optFns, addOperationDescribeCacheClustersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheClustersMiddleware(stack *middleware.Stack, options Options) (err error) {
