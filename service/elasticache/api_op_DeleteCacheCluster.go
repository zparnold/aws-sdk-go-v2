...
func (c *Client) DeleteCacheCluster(ctx context.Context, params *DeleteCacheClusterInput, optFns ...func(*Options)) (*DeleteCacheClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCacheCluster", params, optFns, addOperationDeleteCacheClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCacheClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
