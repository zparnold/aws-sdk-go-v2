...
func (c *Client) ModifyReplicationGroup(ctx context.Context, params *ModifyReplicationGroupInput, optFns ...func(*Options)) (*ModifyReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyReplicationGroup", params, optFns, addOperationModifyReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
