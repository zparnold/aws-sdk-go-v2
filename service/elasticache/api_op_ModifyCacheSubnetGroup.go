...
func (c *Client) ModifyCacheSubnetGroup(ctx context.Context, params *ModifyCacheSubnetGroupInput, optFns ...func(*Options)) (*ModifyCacheSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyCacheSubnetGroup", params, optFns, addOperationModifyCacheSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyCacheSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
