...
func (c *Client) CreateSnapshot(ctx context.Context, params *CreateSnapshotInput, optFns ...func(*Options)) (*CreateSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSnapshot", params, optFns, addOperationCreateSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
