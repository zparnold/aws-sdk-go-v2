...
func (c *Client) DescribeReservedCacheNodes(ctx context.Context, params *DescribeReservedCacheNodesInput, optFns ...func(*Options)) (*DescribeReservedCacheNodesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedCacheNodes", params, optFns, addOperationDescribeReservedCacheNodesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedCacheNodesMiddleware(stack *middleware.Stack, options Options) (err error) {
