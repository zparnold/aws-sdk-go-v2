...
func (c *Client) RevokeCacheSecurityGroupIngress(ctx context.Context, params *RevokeCacheSecurityGroupIngressInput, optFns ...func(*Options)) (*RevokeCacheSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeCacheSecurityGroupIngress", params, optFns, addOperationRevokeCacheSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeCacheSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
