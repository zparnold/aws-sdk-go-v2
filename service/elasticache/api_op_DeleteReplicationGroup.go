...
func (c *Client) DeleteReplicationGroup(ctx context.Context, params *DeleteReplicationGroupInput, optFns ...func(*Options)) (*DeleteReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReplicationGroup", params, optFns, addOperationDeleteReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
