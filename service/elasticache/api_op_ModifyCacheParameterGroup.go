...
func (c *Client) ModifyCacheParameterGroup(ctx context.Context, params *ModifyCacheParameterGroupInput, optFns ...func(*Options)) (*ModifyCacheParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyCacheParameterGroup", params, optFns, addOperationModifyCacheParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyCacheParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
