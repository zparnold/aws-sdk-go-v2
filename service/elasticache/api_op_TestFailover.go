...
func (c *Client) TestFailover(ctx context.Context, params *TestFailoverInput, optFns ...func(*Options)) (*TestFailoverOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestFailover", params, optFns, addOperationTestFailoverMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestFailoverMiddleware(stack *middleware.Stack, options Options) (err error) {
