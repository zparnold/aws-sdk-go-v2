...
func (c *Client) IncreaseReplicaCount(ctx context.Context, params *IncreaseReplicaCountInput, optFns ...func(*Options)) (*IncreaseReplicaCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IncreaseReplicaCount", params, optFns, addOperationIncreaseReplicaCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIncreaseReplicaCountMiddleware(stack *middleware.Stack, options Options) (err error) {
