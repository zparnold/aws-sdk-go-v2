...
func (c *Client) RebootCacheCluster(ctx context.Context, params *RebootCacheClusterInput, optFns ...func(*Options)) (*RebootCacheClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootCacheCluster", params, optFns, addOperationRebootCacheClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootCacheClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
