...
func (c *Client) DescribeGlobalReplicationGroups(ctx context.Context, params *DescribeGlobalReplicationGroupsInput, optFns ...func(*Options)) (*DescribeGlobalReplicationGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGlobalReplicationGroups", params, optFns, addOperationDescribeGlobalReplicationGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGlobalReplicationGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
