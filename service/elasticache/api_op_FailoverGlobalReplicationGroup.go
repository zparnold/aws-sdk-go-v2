...
func (c *Client) FailoverGlobalReplicationGroup(ctx context.Context, params *FailoverGlobalReplicationGroupInput, optFns ...func(*Options)) (*FailoverGlobalReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FailoverGlobalReplicationGroup", params, optFns, addOperationFailoverGlobalReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFailoverGlobalReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
