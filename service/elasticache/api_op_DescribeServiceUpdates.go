...
func (c *Client) DescribeServiceUpdates(ctx context.Context, params *DescribeServiceUpdatesInput, optFns ...func(*Options)) (*DescribeServiceUpdatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeServiceUpdates", params, optFns, addOperationDescribeServiceUpdatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeServiceUpdatesMiddleware(stack *middleware.Stack, options Options) (err error) {
