...
func (c *Client) IncreaseNodeGroupsInGlobalReplicationGroup(ctx context.Context, params *IncreaseNodeGroupsInGlobalReplicationGroupInput, optFns ...func(*Options)) (*IncreaseNodeGroupsInGlobalReplicationGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IncreaseNodeGroupsInGlobalReplicationGroup", params, optFns, addOperationIncreaseNodeGroupsInGlobalReplicationGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIncreaseNodeGroupsInGlobalReplicationGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
