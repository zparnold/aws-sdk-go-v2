...
func (c *Client) CreateToken(ctx context.Context, params *CreateTokenInput, optFns ...func(*Options)) (*CreateTokenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateToken", params, optFns, addOperationCreateTokenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTokenMiddleware(stack *middleware.Stack, options Options) (err error) {
