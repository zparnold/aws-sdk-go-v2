...
func (c *Client) RegisterClient(ctx context.Context, params *RegisterClientInput, optFns ...func(*Options)) (*RegisterClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterClient", params, optFns, addOperationRegisterClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterClientMiddleware(stack *middleware.Stack, options Options) (err error) {
