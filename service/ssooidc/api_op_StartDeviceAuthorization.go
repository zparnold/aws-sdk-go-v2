...
func (c *Client) StartDeviceAuthorization(ctx context.Context, params *StartDeviceAuthorizationInput, optFns ...func(*Options)) (*StartDeviceAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDeviceAuthorization", params, optFns, addOperationStartDeviceAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDeviceAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
