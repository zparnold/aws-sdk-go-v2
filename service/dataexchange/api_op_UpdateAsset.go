...
func (c *Client) UpdateAsset(ctx context.Context, params *UpdateAssetInput, optFns ...func(*Options)) (*UpdateAssetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAsset", params, optFns, addOperationUpdateAssetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAssetMiddleware(stack *middleware.Stack, options Options) (err error) {
