...
func (c *Client) ListRevisionAssets(ctx context.Context, params *ListRevisionAssetsInput, optFns ...func(*Options)) (*ListRevisionAssetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRevisionAssets", params, optFns, addOperationListRevisionAssetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRevisionAssetsMiddleware(stack *middleware.Stack, options Options) (err error) {
