...
func (c *Client) GetDataSet(ctx context.Context, params *GetDataSetInput, optFns ...func(*Options)) (*GetDataSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataSet", params, optFns, addOperationGetDataSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataSetMiddleware(stack *middleware.Stack, options Options) (err error) {
