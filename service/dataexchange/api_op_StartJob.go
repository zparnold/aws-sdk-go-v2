...
func (c *Client) StartJob(ctx context.Context, params *StartJobInput, optFns ...func(*Options)) (*StartJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartJob", params, optFns, addOperationStartJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartJobMiddleware(stack *middleware.Stack, options Options) (err error) {
