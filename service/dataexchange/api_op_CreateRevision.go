...
func (c *Client) CreateRevision(ctx context.Context, params *CreateRevisionInput, optFns ...func(*Options)) (*CreateRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRevision", params, optFns, addOperationCreateRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
