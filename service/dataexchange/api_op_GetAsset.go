...
func (c *Client) GetAsset(ctx context.Context, params *GetAssetInput, optFns ...func(*Options)) (*GetAssetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAsset", params, optFns, addOperationGetAssetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssetMiddleware(stack *middleware.Stack, options Options) (err error) {
