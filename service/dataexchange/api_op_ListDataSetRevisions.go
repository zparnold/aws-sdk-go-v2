...
func (c *Client) ListDataSetRevisions(ctx context.Context, params *ListDataSetRevisionsInput, optFns ...func(*Options)) (*ListDataSetRevisionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDataSetRevisions", params, optFns, addOperationListDataSetRevisionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDataSetRevisionsMiddleware(stack *middleware.Stack, options Options) (err error) {
