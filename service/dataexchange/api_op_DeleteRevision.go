...
func (c *Client) DeleteRevision(ctx context.Context, params *DeleteRevisionInput, optFns ...func(*Options)) (*DeleteRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRevision", params, optFns, addOperationDeleteRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
