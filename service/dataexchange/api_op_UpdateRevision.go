...
func (c *Client) UpdateRevision(ctx context.Context, params *UpdateRevisionInput, optFns ...func(*Options)) (*UpdateRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRevision", params, optFns, addOperationUpdateRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
