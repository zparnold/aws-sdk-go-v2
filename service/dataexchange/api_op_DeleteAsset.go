...
func (c *Client) DeleteAsset(ctx context.Context, params *DeleteAssetInput, optFns ...func(*Options)) (*DeleteAssetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAsset", params, optFns, addOperationDeleteAssetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAssetMiddleware(stack *middleware.Stack, options Options) (err error) {
