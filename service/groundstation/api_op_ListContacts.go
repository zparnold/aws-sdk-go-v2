...
func (c *Client) ListContacts(ctx context.Context, params *ListContactsInput, optFns ...func(*Options)) (*ListContactsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListContacts", params, optFns, addOperationListContactsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListContactsMiddleware(stack *middleware.Stack, options Options) (err error) {
