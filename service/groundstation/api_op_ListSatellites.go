...
func (c *Client) ListSatellites(ctx context.Context, params *ListSatellitesInput, optFns ...func(*Options)) (*ListSatellitesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSatellites", params, optFns, addOperationListSatellitesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSatellitesMiddleware(stack *middleware.Stack, options Options) (err error) {
