...
func (c *Client) GetSatellite(ctx context.Context, params *GetSatelliteInput, optFns ...func(*Options)) (*GetSatelliteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSatellite", params, optFns, addOperationGetSatelliteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSatelliteMiddleware(stack *middleware.Stack, options Options) (err error) {
