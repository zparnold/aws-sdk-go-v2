...
func (c *Client) ListGroundStations(ctx context.Context, params *ListGroundStationsInput, optFns ...func(*Options)) (*ListGroundStationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGroundStations", params, optFns, addOperationListGroundStationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGroundStationsMiddleware(stack *middleware.Stack, options Options) (err error) {
