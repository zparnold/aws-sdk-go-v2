...
func (c *Client) ListConfigs(ctx context.Context, params *ListConfigsInput, optFns ...func(*Options)) (*ListConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConfigs", params, optFns, addOperationListConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
