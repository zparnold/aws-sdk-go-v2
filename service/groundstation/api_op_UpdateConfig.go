...
func (c *Client) UpdateConfig(ctx context.Context, params *UpdateConfigInput, optFns ...func(*Options)) (*UpdateConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConfig", params, optFns, addOperationUpdateConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
