...
func (c *Client) CreateDataflowEndpointGroup(ctx context.Context, params *CreateDataflowEndpointGroupInput, optFns ...func(*Options)) (*CreateDataflowEndpointGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDataflowEndpointGroup", params, optFns, addOperationCreateDataflowEndpointGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDataflowEndpointGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
