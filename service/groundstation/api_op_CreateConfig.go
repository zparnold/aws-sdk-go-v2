...
func (c *Client) CreateConfig(ctx context.Context, params *CreateConfigInput, optFns ...func(*Options)) (*CreateConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConfig", params, optFns, addOperationCreateConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
