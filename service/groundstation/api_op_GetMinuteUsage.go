...
func (c *Client) GetMinuteUsage(ctx context.Context, params *GetMinuteUsageInput, optFns ...func(*Options)) (*GetMinuteUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMinuteUsage", params, optFns, addOperationGetMinuteUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMinuteUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
