...
func (c *Client) CancelContact(ctx context.Context, params *CancelContactInput, optFns ...func(*Options)) (*CancelContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelContact", params, optFns, addOperationCancelContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelContactMiddleware(stack *middleware.Stack, options Options) (err error) {
