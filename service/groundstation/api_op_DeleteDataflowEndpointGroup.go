...
func (c *Client) DeleteDataflowEndpointGroup(ctx context.Context, params *DeleteDataflowEndpointGroupInput, optFns ...func(*Options)) (*DeleteDataflowEndpointGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDataflowEndpointGroup", params, optFns, addOperationDeleteDataflowEndpointGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDataflowEndpointGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
