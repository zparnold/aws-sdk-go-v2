...
func (c *Client) CreateMissionProfile(ctx context.Context, params *CreateMissionProfileInput, optFns ...func(*Options)) (*CreateMissionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMissionProfile", params, optFns, addOperationCreateMissionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMissionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
