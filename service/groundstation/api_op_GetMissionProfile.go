...
func (c *Client) GetMissionProfile(ctx context.Context, params *GetMissionProfileInput, optFns ...func(*Options)) (*GetMissionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMissionProfile", params, optFns, addOperationGetMissionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMissionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
