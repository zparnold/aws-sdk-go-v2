...
func (c *Client) DeleteMissionProfile(ctx context.Context, params *DeleteMissionProfileInput, optFns ...func(*Options)) (*DeleteMissionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMissionProfile", params, optFns, addOperationDeleteMissionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMissionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
