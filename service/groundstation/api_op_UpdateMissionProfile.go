...
func (c *Client) UpdateMissionProfile(ctx context.Context, params *UpdateMissionProfileInput, optFns ...func(*Options)) (*UpdateMissionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMissionProfile", params, optFns, addOperationUpdateMissionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMissionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
