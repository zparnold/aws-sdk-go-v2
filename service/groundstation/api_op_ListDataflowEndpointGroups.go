...
func (c *Client) ListDataflowEndpointGroups(ctx context.Context, params *ListDataflowEndpointGroupsInput, optFns ...func(*Options)) (*ListDataflowEndpointGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDataflowEndpointGroups", params, optFns, addOperationListDataflowEndpointGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDataflowEndpointGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
