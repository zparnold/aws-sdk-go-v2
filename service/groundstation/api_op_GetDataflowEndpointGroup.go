...
func (c *Client) GetDataflowEndpointGroup(ctx context.Context, params *GetDataflowEndpointGroupInput, optFns ...func(*Options)) (*GetDataflowEndpointGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataflowEndpointGroup", params, optFns, addOperationGetDataflowEndpointGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataflowEndpointGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
