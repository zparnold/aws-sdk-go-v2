...
func (c *Client) ReserveContact(ctx context.Context, params *ReserveContactInput, optFns ...func(*Options)) (*ReserveContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReserveContact", params, optFns, addOperationReserveContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReserveContactMiddleware(stack *middleware.Stack, options Options) (err error) {
