...
func (c *Client) DescribeContact(ctx context.Context, params *DescribeContactInput, optFns ...func(*Options)) (*DescribeContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeContact", params, optFns, addOperationDescribeContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeContactMiddleware(stack *middleware.Stack, options Options) (err error) {
