...
func (c *Client) SendVoiceMessage(ctx context.Context, params *SendVoiceMessageInput, optFns ...func(*Options)) (*SendVoiceMessageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendVoiceMessage", params, optFns, addOperationSendVoiceMessageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendVoiceMessageMiddleware(stack *middleware.Stack, options Options) (err error) {
