...
func (c *Client) DescribePHIDetectionJob(ctx context.Context, params *DescribePHIDetectionJobInput, optFns ...func(*Options)) (*DescribePHIDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePHIDetectionJob", params, optFns, addOperationDescribePHIDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePHIDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
