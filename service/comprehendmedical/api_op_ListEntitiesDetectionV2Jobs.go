...
func (c *Client) ListEntitiesDetectionV2Jobs(ctx context.Context, params *ListEntitiesDetectionV2JobsInput, optFns ...func(*Options)) (*ListEntitiesDetectionV2JobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEntitiesDetectionV2Jobs", params, optFns, addOperationListEntitiesDetectionV2JobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEntitiesDetectionV2JobsMiddleware(stack *middleware.Stack, options Options) (err error) {
