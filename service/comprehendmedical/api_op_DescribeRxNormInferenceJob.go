...
func (c *Client) DescribeRxNormInferenceJob(ctx context.Context, params *DescribeRxNormInferenceJobInput, optFns ...func(*Options)) (*DescribeRxNormInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRxNormInferenceJob", params, optFns, addOperationDescribeRxNormInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRxNormInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
