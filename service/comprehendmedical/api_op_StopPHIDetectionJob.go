...
func (c *Client) StopPHIDetectionJob(ctx context.Context, params *StopPHIDetectionJobInput, optFns ...func(*Options)) (*StopPHIDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopPHIDetectionJob", params, optFns, addOperationStopPHIDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopPHIDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
