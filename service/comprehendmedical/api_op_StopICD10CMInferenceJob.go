...
func (c *Client) StopICD10CMInferenceJob(ctx context.Context, params *StopICD10CMInferenceJobInput, optFns ...func(*Options)) (*StopICD10CMInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopICD10CMInferenceJob", params, optFns, addOperationStopICD10CMInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopICD10CMInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
