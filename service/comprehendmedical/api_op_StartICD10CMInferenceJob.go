...
func (c *Client) StartICD10CMInferenceJob(ctx context.Context, params *StartICD10CMInferenceJobInput, optFns ...func(*Options)) (*StartICD10CMInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartICD10CMInferenceJob", params, optFns, addOperationStartICD10CMInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartICD10CMInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
