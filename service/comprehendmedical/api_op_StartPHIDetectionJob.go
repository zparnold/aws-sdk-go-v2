...
func (c *Client) StartPHIDetectionJob(ctx context.Context, params *StartPHIDetectionJobInput, optFns ...func(*Options)) (*StartPHIDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartPHIDetectionJob", params, optFns, addOperationStartPHIDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartPHIDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
