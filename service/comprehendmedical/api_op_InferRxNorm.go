...
func (c *Client) InferRxNorm(ctx context.Context, params *InferRxNormInput, optFns ...func(*Options)) (*InferRxNormOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InferRxNorm", params, optFns, addOperationInferRxNormMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInferRxNormMiddleware(stack *middleware.Stack, options Options) (err error) {
