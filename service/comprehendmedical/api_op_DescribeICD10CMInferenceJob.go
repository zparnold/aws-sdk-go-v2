...
func (c *Client) DescribeICD10CMInferenceJob(ctx context.Context, params *DescribeICD10CMInferenceJobInput, optFns ...func(*Options)) (*DescribeICD10CMInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeICD10CMInferenceJob", params, optFns, addOperationDescribeICD10CMInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeICD10CMInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
