...
func (c *Client) ListPHIDetectionJobs(ctx context.Context, params *ListPHIDetectionJobsInput, optFns ...func(*Options)) (*ListPHIDetectionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPHIDetectionJobs", params, optFns, addOperationListPHIDetectionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPHIDetectionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
