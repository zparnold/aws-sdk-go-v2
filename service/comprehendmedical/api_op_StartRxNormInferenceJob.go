...
func (c *Client) StartRxNormInferenceJob(ctx context.Context, params *StartRxNormInferenceJobInput, optFns ...func(*Options)) (*StartRxNormInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartRxNormInferenceJob", params, optFns, addOperationStartRxNormInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartRxNormInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
