...
func (c *Client) ListRxNormInferenceJobs(ctx context.Context, params *ListRxNormInferenceJobsInput, optFns ...func(*Options)) (*ListRxNormInferenceJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRxNormInferenceJobs", params, optFns, addOperationListRxNormInferenceJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRxNormInferenceJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
