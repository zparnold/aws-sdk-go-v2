...
func (c *Client) StopEntitiesDetectionV2Job(ctx context.Context, params *StopEntitiesDetectionV2JobInput, optFns ...func(*Options)) (*StopEntitiesDetectionV2JobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopEntitiesDetectionV2Job", params, optFns, addOperationStopEntitiesDetectionV2JobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopEntitiesDetectionV2JobMiddleware(stack *middleware.Stack, options Options) (err error) {
