...
func (c *Client) DetectEntitiesV2(ctx context.Context, params *DetectEntitiesV2Input, optFns ...func(*Options)) (*DetectEntitiesV2Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectEntitiesV2", params, optFns, addOperationDetectEntitiesV2Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectEntitiesV2Middleware(stack *middleware.Stack, options Options) (err error) {
