...
func (c *Client) StartEntitiesDetectionV2Job(ctx context.Context, params *StartEntitiesDetectionV2JobInput, optFns ...func(*Options)) (*StartEntitiesDetectionV2JobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartEntitiesDetectionV2Job", params, optFns, addOperationStartEntitiesDetectionV2JobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartEntitiesDetectionV2JobMiddleware(stack *middleware.Stack, options Options) (err error) {
