...
func (c *Client) InferICD10CM(ctx context.Context, params *InferICD10CMInput, optFns ...func(*Options)) (*InferICD10CMOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InferICD10CM", params, optFns, addOperationInferICD10CMMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInferICD10CMMiddleware(stack *middleware.Stack, options Options) (err error) {
