...
func (c *Client) ListICD10CMInferenceJobs(ctx context.Context, params *ListICD10CMInferenceJobsInput, optFns ...func(*Options)) (*ListICD10CMInferenceJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListICD10CMInferenceJobs", params, optFns, addOperationListICD10CMInferenceJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListICD10CMInferenceJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
