...
func (c *Client) DetectPHI(ctx context.Context, params *DetectPHIInput, optFns ...func(*Options)) (*DetectPHIOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectPHI", params, optFns, addOperationDetectPHIMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectPHIMiddleware(stack *middleware.Stack, options Options) (err error) {
