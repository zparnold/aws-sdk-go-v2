...
func (c *Client) StopRxNormInferenceJob(ctx context.Context, params *StopRxNormInferenceJobInput, optFns ...func(*Options)) (*StopRxNormInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopRxNormInferenceJob", params, optFns, addOperationStopRxNormInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopRxNormInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
