...
func (c *Client) GetMacieSession(ctx context.Context, params *GetMacieSessionInput, optFns ...func(*Options)) (*GetMacieSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMacieSession", params, optFns, addOperationGetMacieSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMacieSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
