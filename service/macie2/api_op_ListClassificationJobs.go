...
func (c *Client) ListClassificationJobs(ctx context.Context, params *ListClassificationJobsInput, optFns ...func(*Options)) (*ListClassificationJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListClassificationJobs", params, optFns, addOperationListClassificationJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListClassificationJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
