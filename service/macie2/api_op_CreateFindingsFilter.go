...
func (c *Client) CreateFindingsFilter(ctx context.Context, params *CreateFindingsFilterInput, optFns ...func(*Options)) (*CreateFindingsFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFindingsFilter", params, optFns, addOperationCreateFindingsFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFindingsFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
