...
func (c *Client) UpdateOrganizationConfiguration(ctx context.Context, params *UpdateOrganizationConfigurationInput, optFns ...func(*Options)) (*UpdateOrganizationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateOrganizationConfiguration", params, optFns, addOperationUpdateOrganizationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateOrganizationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
