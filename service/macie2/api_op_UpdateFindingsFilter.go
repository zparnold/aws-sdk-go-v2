...
func (c *Client) UpdateFindingsFilter(ctx context.Context, params *UpdateFindingsFilterInput, optFns ...func(*Options)) (*UpdateFindingsFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFindingsFilter", params, optFns, addOperationUpdateFindingsFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFindingsFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
