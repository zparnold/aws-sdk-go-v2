...
func (c *Client) CreateInvitations(ctx context.Context, params *CreateInvitationsInput, optFns ...func(*Options)) (*CreateInvitationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInvitations", params, optFns, addOperationCreateInvitationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInvitationsMiddleware(stack *middleware.Stack, options Options) (err error) {
