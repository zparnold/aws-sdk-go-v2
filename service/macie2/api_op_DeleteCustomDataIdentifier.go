...
func (c *Client) DeleteCustomDataIdentifier(ctx context.Context, params *DeleteCustomDataIdentifierInput, optFns ...func(*Options)) (*DeleteCustomDataIdentifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCustomDataIdentifier", params, optFns, addOperationDeleteCustomDataIdentifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCustomDataIdentifierMiddleware(stack *middleware.Stack, options Options) (err error) {
