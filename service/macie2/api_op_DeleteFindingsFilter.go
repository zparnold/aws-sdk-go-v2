...
func (c *Client) DeleteFindingsFilter(ctx context.Context, params *DeleteFindingsFilterInput, optFns ...func(*Options)) (*DeleteFindingsFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFindingsFilter", params, optFns, addOperationDeleteFindingsFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFindingsFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
