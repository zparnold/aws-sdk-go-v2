...
func (c *Client) ListFindingsFilters(ctx context.Context, params *ListFindingsFiltersInput, optFns ...func(*Options)) (*ListFindingsFiltersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFindingsFilters", params, optFns, addOperationListFindingsFiltersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFindingsFiltersMiddleware(stack *middleware.Stack, options Options) (err error) {
