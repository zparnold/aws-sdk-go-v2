...
func (c *Client) DisableOrganizationAdminAccount(ctx context.Context, params *DisableOrganizationAdminAccountInput, optFns ...func(*Options)) (*DisableOrganizationAdminAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableOrganizationAdminAccount", params, optFns, addOperationDisableOrganizationAdminAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableOrganizationAdminAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
