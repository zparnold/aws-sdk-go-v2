...
func (c *Client) UpdateMemberSession(ctx context.Context, params *UpdateMemberSessionInput, optFns ...func(*Options)) (*UpdateMemberSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMemberSession", params, optFns, addOperationUpdateMemberSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMemberSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
