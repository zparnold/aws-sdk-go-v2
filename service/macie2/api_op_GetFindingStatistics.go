...
func (c *Client) GetFindingStatistics(ctx context.Context, params *GetFindingStatisticsInput, optFns ...func(*Options)) (*GetFindingStatisticsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFindingStatistics", params, optFns, addOperationGetFindingStatisticsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFindingStatisticsMiddleware(stack *middleware.Stack, options Options) (err error) {
