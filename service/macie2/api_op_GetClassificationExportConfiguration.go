...
func (c *Client) GetClassificationExportConfiguration(ctx context.Context, params *GetClassificationExportConfigurationInput, optFns ...func(*Options)) (*GetClassificationExportConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetClassificationExportConfiguration", params, optFns, addOperationGetClassificationExportConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetClassificationExportConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
