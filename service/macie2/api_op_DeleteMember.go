...
func (c *Client) DeleteMember(ctx context.Context, params *DeleteMemberInput, optFns ...func(*Options)) (*DeleteMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMember", params, optFns, addOperationDeleteMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
