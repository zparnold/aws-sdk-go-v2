...
func (c *Client) ListFindings(ctx context.Context, params *ListFindingsInput, optFns ...func(*Options)) (*ListFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFindings", params, optFns, addOperationListFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
