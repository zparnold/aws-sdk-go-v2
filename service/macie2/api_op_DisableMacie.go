...
func (c *Client) DisableMacie(ctx context.Context, params *DisableMacieInput, optFns ...func(*Options)) (*DisableMacieOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableMacie", params, optFns, addOperationDisableMacieMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableMacieMiddleware(stack *middleware.Stack, options Options) (err error) {
