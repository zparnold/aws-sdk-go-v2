...
func (c *Client) PutClassificationExportConfiguration(ctx context.Context, params *PutClassificationExportConfigurationInput, optFns ...func(*Options)) (*PutClassificationExportConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutClassificationExportConfiguration", params, optFns, addOperationPutClassificationExportConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutClassificationExportConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
