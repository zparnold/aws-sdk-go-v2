...
func (c *Client) ListCustomDataIdentifiers(ctx context.Context, params *ListCustomDataIdentifiersInput, optFns ...func(*Options)) (*ListCustomDataIdentifiersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCustomDataIdentifiers", params, optFns, addOperationListCustomDataIdentifiersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCustomDataIdentifiersMiddleware(stack *middleware.Stack, options Options) (err error) {
