...
func (c *Client) GetFindingsFilter(ctx context.Context, params *GetFindingsFilterInput, optFns ...func(*Options)) (*GetFindingsFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFindingsFilter", params, optFns, addOperationGetFindingsFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFindingsFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
