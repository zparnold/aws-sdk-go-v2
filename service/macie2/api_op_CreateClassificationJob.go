...
func (c *Client) CreateClassificationJob(ctx context.Context, params *CreateClassificationJobInput, optFns ...func(*Options)) (*CreateClassificationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateClassificationJob", params, optFns, addOperationCreateClassificationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateClassificationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
