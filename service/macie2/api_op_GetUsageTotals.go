...
func (c *Client) GetUsageTotals(ctx context.Context, params *GetUsageTotalsInput, optFns ...func(*Options)) (*GetUsageTotalsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUsageTotals", params, optFns, addOperationGetUsageTotalsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUsageTotalsMiddleware(stack *middleware.Stack, options Options) (err error) {
