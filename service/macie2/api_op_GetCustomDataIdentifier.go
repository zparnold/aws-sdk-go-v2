...
func (c *Client) GetCustomDataIdentifier(ctx context.Context, params *GetCustomDataIdentifierInput, optFns ...func(*Options)) (*GetCustomDataIdentifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCustomDataIdentifier", params, optFns, addOperationGetCustomDataIdentifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCustomDataIdentifierMiddleware(stack *middleware.Stack, options Options) (err error) {
