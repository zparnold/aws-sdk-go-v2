...
func (c *Client) TestCustomDataIdentifier(ctx context.Context, params *TestCustomDataIdentifierInput, optFns ...func(*Options)) (*TestCustomDataIdentifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestCustomDataIdentifier", params, optFns, addOperationTestCustomDataIdentifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestCustomDataIdentifierMiddleware(stack *middleware.Stack, options Options) (err error) {
