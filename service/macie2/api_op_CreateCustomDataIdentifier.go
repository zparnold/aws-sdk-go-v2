...
func (c *Client) CreateCustomDataIdentifier(ctx context.Context, params *CreateCustomDataIdentifierInput, optFns ...func(*Options)) (*CreateCustomDataIdentifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomDataIdentifier", params, optFns, addOperationCreateCustomDataIdentifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomDataIdentifierMiddleware(stack *middleware.Stack, options Options) (err error) {
