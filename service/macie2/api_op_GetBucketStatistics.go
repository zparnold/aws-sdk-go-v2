...
func (c *Client) GetBucketStatistics(ctx context.Context, params *GetBucketStatisticsInput, optFns ...func(*Options)) (*GetBucketStatisticsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketStatistics", params, optFns, addOperationGetBucketStatisticsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketStatisticsMiddleware(stack *middleware.Stack, options Options) (err error) {
