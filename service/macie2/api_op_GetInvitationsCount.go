...
func (c *Client) GetInvitationsCount(ctx context.Context, params *GetInvitationsCountInput, optFns ...func(*Options)) (*GetInvitationsCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInvitationsCount", params, optFns, addOperationGetInvitationsCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInvitationsCountMiddleware(stack *middleware.Stack, options Options) (err error) {
