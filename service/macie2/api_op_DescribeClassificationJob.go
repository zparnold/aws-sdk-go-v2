...
func (c *Client) DescribeClassificationJob(ctx context.Context, params *DescribeClassificationJobInput, optFns ...func(*Options)) (*DescribeClassificationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClassificationJob", params, optFns, addOperationDescribeClassificationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClassificationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
