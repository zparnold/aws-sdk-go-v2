...
func (c *Client) DisassociateMember(ctx context.Context, params *DisassociateMemberInput, optFns ...func(*Options)) (*DisassociateMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateMember", params, optFns, addOperationDisassociateMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
