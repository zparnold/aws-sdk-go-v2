...
func (c *Client) UpdateMacieSession(ctx context.Context, params *UpdateMacieSessionInput, optFns ...func(*Options)) (*UpdateMacieSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMacieSession", params, optFns, addOperationUpdateMacieSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMacieSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
