...
func (c *Client) UpdateClassificationJob(ctx context.Context, params *UpdateClassificationJobInput, optFns ...func(*Options)) (*UpdateClassificationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClassificationJob", params, optFns, addOperationUpdateClassificationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClassificationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
