...
func (c *Client) EnableMacie(ctx context.Context, params *EnableMacieInput, optFns ...func(*Options)) (*EnableMacieOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableMacie", params, optFns, addOperationEnableMacieMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableMacieMiddleware(stack *middleware.Stack, options Options) (err error) {
