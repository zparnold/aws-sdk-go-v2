...
func (c *Client) ListSecrets(ctx context.Context, params *ListSecretsInput, optFns ...func(*Options)) (*ListSecretsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSecrets", params, optFns, addOperationListSecretsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSecretsMiddleware(stack *middleware.Stack, options Options) (err error) {
