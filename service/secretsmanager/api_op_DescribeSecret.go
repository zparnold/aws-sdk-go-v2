...
func (c *Client) DescribeSecret(ctx context.Context, params *DescribeSecretInput, optFns ...func(*Options)) (*DescribeSecretOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSecret", params, optFns, addOperationDescribeSecretMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSecretMiddleware(stack *middleware.Stack, options Options) (err error) {
