...
func (c *Client) UpdateSecret(ctx context.Context, params *UpdateSecretInput, optFns ...func(*Options)) (*UpdateSecretOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSecret", params, optFns, addOperationUpdateSecretMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSecretMiddleware(stack *middleware.Stack, options Options) (err error) {
