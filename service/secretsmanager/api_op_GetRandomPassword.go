...
func (c *Client) GetRandomPassword(ctx context.Context, params *GetRandomPasswordInput, optFns ...func(*Options)) (*GetRandomPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRandomPassword", params, optFns, addOperationGetRandomPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRandomPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
