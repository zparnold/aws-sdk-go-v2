...
func (c *Client) GetSecretValue(ctx context.Context, params *GetSecretValueInput, optFns ...func(*Options)) (*GetSecretValueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSecretValue", params, optFns, addOperationGetSecretValueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSecretValueMiddleware(stack *middleware.Stack, options Options) (err error) {
