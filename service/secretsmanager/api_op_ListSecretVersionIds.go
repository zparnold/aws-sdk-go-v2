...
func (c *Client) ListSecretVersionIds(ctx context.Context, params *ListSecretVersionIdsInput, optFns ...func(*Options)) (*ListSecretVersionIdsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSecretVersionIds", params, optFns, addOperationListSecretVersionIdsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSecretVersionIdsMiddleware(stack *middleware.Stack, options Options) (err error) {
