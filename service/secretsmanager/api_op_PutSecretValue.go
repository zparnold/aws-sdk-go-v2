...
func (c *Client) PutSecretValue(ctx context.Context, params *PutSecretValueInput, optFns ...func(*Options)) (*PutSecretValueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSecretValue", params, optFns, addOperationPutSecretValueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSecretValueMiddleware(stack *middleware.Stack, options Options) (err error) {
