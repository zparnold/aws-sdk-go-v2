...
func (c *Client) CancelRotateSecret(ctx context.Context, params *CancelRotateSecretInput, optFns ...func(*Options)) (*CancelRotateSecretOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelRotateSecret", params, optFns, addOperationCancelRotateSecretMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelRotateSecretMiddleware(stack *middleware.Stack, options Options) (err error) {
