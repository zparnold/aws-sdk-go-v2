...
func (c *Client) UpdateSecretVersionStage(ctx context.Context, params *UpdateSecretVersionStageInput, optFns ...func(*Options)) (*UpdateSecretVersionStageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSecretVersionStage", params, optFns, addOperationUpdateSecretVersionStageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSecretVersionStageMiddleware(stack *middleware.Stack, options Options) (err error) {
