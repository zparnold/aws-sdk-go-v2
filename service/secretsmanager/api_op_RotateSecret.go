...
func (c *Client) RotateSecret(ctx context.Context, params *RotateSecretInput, optFns ...func(*Options)) (*RotateSecretOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RotateSecret", params, optFns, addOperationRotateSecretMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRotateSecretMiddleware(stack *middleware.Stack, options Options) (err error) {
