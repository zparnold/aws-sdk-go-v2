...
func (c *Client) RestoreSecret(ctx context.Context, params *RestoreSecretInput, optFns ...func(*Options)) (*RestoreSecretOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreSecret", params, optFns, addOperationRestoreSecretMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreSecretMiddleware(stack *middleware.Stack, options Options) (err error) {
