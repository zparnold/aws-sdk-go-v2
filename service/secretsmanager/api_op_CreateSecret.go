...
func (c *Client) CreateSecret(ctx context.Context, params *CreateSecretInput, optFns ...func(*Options)) (*CreateSecretOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSecret", params, optFns, addOperationCreateSecretMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSecretMiddleware(stack *middleware.Stack, options Options) (err error) {
