...
func (c *Client) ReportTaskRunnerHeartbeat(ctx context.Context, params *ReportTaskRunnerHeartbeatInput, optFns ...func(*Options)) (*ReportTaskRunnerHeartbeatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReportTaskRunnerHeartbeat", params, optFns, addOperationReportTaskRunnerHeartbeatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReportTaskRunnerHeartbeatMiddleware(stack *middleware.Stack, options Options) (err error) {
