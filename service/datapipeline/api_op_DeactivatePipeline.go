...
func (c *Client) DeactivatePipeline(ctx context.Context, params *DeactivatePipelineInput, optFns ...func(*Options)) (*DeactivatePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeactivatePipeline", params, optFns, addOperationDeactivatePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeactivatePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
