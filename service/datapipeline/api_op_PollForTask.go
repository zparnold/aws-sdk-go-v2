...
func (c *Client) PollForTask(ctx context.Context, params *PollForTaskInput, optFns ...func(*Options)) (*PollForTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PollForTask", params, optFns, addOperationPollForTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPollForTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
