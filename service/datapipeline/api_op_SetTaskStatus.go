...
func (c *Client) SetTaskStatus(ctx context.Context, params *SetTaskStatusInput, optFns ...func(*Options)) (*SetTaskStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetTaskStatus", params, optFns, addOperationSetTaskStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetTaskStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
