...
func (c *Client) ValidatePipelineDefinition(ctx context.Context, params *ValidatePipelineDefinitionInput, optFns ...func(*Options)) (*ValidatePipelineDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ValidatePipelineDefinition", params, optFns, addOperationValidatePipelineDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationValidatePipelineDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
