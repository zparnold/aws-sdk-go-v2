...
func (c *Client) ActivatePipeline(ctx context.Context, params *ActivatePipelineInput, optFns ...func(*Options)) (*ActivatePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ActivatePipeline", params, optFns, addOperationActivatePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationActivatePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
