...
func (c *Client) PutPipelineDefinition(ctx context.Context, params *PutPipelineDefinitionInput, optFns ...func(*Options)) (*PutPipelineDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutPipelineDefinition", params, optFns, addOperationPutPipelineDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutPipelineDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
