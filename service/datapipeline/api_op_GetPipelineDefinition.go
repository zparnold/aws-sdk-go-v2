...
func (c *Client) GetPipelineDefinition(ctx context.Context, params *GetPipelineDefinitionInput, optFns ...func(*Options)) (*GetPipelineDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPipelineDefinition", params, optFns, addOperationGetPipelineDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPipelineDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
