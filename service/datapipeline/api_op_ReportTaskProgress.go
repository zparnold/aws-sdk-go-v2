...
func (c *Client) ReportTaskProgress(ctx context.Context, params *ReportTaskProgressInput, optFns ...func(*Options)) (*ReportTaskProgressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReportTaskProgress", params, optFns, addOperationReportTaskProgressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReportTaskProgressMiddleware(stack *middleware.Stack, options Options) (err error) {
