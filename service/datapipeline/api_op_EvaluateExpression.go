...
func (c *Client) EvaluateExpression(ctx context.Context, params *EvaluateExpressionInput, optFns ...func(*Options)) (*EvaluateExpressionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EvaluateExpression", params, optFns, addOperationEvaluateExpressionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEvaluateExpressionMiddleware(stack *middleware.Stack, options Options) (err error) {
