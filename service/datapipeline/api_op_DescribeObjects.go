...
func (c *Client) DescribeObjects(ctx context.Context, params *DescribeObjectsInput, optFns ...func(*Options)) (*DescribeObjectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeObjects", params, optFns, addOperationDescribeObjectsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeObjectsMiddleware(stack *middleware.Stack, options Options) (err error) {
