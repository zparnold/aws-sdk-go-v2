...
func (c *Client) DescribePipelines(ctx context.Context, params *DescribePipelinesInput, optFns ...func(*Options)) (*DescribePipelinesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePipelines", params, optFns, addOperationDescribePipelinesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePipelinesMiddleware(stack *middleware.Stack, options Options) (err error) {
