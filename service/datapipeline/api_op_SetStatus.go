...
func (c *Client) SetStatus(ctx context.Context, params *SetStatusInput, optFns ...func(*Options)) (*SetStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetStatus", params, optFns, addOperationSetStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
