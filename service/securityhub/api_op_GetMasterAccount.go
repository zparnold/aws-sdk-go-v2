...
func (c *Client) GetMasterAccount(ctx context.Context, params *GetMasterAccountInput, optFns ...func(*Options)) (*GetMasterAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMasterAccount", params, optFns, addOperationGetMasterAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMasterAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
