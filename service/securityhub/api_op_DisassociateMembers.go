...
func (c *Client) DisassociateMembers(ctx context.Context, params *DisassociateMembersInput, optFns ...func(*Options)) (*DisassociateMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateMembers", params, optFns, addOperationDisassociateMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
