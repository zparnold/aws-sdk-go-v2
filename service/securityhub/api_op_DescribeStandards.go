...
func (c *Client) DescribeStandards(ctx context.Context, params *DescribeStandardsInput, optFns ...func(*Options)) (*DescribeStandardsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStandards", params, optFns, addOperationDescribeStandardsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStandardsMiddleware(stack *middleware.Stack, options Options) (err error) {
