...
func (c *Client) EnableImportFindingsForProduct(ctx context.Context, params *EnableImportFindingsForProductInput, optFns ...func(*Options)) (*EnableImportFindingsForProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableImportFindingsForProduct", params, optFns, addOperationEnableImportFindingsForProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableImportFindingsForProductMiddleware(stack *middleware.Stack, options Options) (err error) {
