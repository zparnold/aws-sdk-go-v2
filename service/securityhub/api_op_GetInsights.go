...
func (c *Client) GetInsights(ctx context.Context, params *GetInsightsInput, optFns ...func(*Options)) (*GetInsightsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInsights", params, optFns, addOperationGetInsightsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInsightsMiddleware(stack *middleware.Stack, options Options) (err error) {
