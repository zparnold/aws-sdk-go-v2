...
func (c *Client) DescribeActionTargets(ctx context.Context, params *DescribeActionTargetsInput, optFns ...func(*Options)) (*DescribeActionTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeActionTargets", params, optFns, addOperationDescribeActionTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeActionTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
