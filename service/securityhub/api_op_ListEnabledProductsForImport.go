...
func (c *Client) ListEnabledProductsForImport(ctx context.Context, params *ListEnabledProductsForImportInput, optFns ...func(*Options)) (*ListEnabledProductsForImportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEnabledProductsForImport", params, optFns, addOperationListEnabledProductsForImportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEnabledProductsForImportMiddleware(stack *middleware.Stack, options Options) (err error) {
