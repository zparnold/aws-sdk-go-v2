...
func (c *Client) DescribeHub(ctx context.Context, params *DescribeHubInput, optFns ...func(*Options)) (*DescribeHubOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHub", params, optFns, addOperationDescribeHubMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHubMiddleware(stack *middleware.Stack, options Options) (err error) {
