...
func (c *Client) UpdateInsight(ctx context.Context, params *UpdateInsightInput, optFns ...func(*Options)) (*UpdateInsightOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateInsight", params, optFns, addOperationUpdateInsightMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateInsightMiddleware(stack *middleware.Stack, options Options) (err error) {
