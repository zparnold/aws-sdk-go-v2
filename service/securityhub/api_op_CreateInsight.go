...
func (c *Client) CreateInsight(ctx context.Context, params *CreateInsightInput, optFns ...func(*Options)) (*CreateInsightOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInsight", params, optFns, addOperationCreateInsightMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInsightMiddleware(stack *middleware.Stack, options Options) (err error) {
