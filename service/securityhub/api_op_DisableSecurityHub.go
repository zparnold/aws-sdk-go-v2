...
func (c *Client) DisableSecurityHub(ctx context.Context, params *DisableSecurityHubInput, optFns ...func(*Options)) (*DisableSecurityHubOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableSecurityHub", params, optFns, addOperationDisableSecurityHubMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableSecurityHubMiddleware(stack *middleware.Stack, options Options) (err error) {
