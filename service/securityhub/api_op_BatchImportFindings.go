...
func (c *Client) BatchImportFindings(ctx context.Context, params *BatchImportFindingsInput, optFns ...func(*Options)) (*BatchImportFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchImportFindings", params, optFns, addOperationBatchImportFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchImportFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
