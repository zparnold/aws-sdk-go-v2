...
func (c *Client) UpdateActionTarget(ctx context.Context, params *UpdateActionTargetInput, optFns ...func(*Options)) (*UpdateActionTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateActionTarget", params, optFns, addOperationUpdateActionTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateActionTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
