...
func (c *Client) BatchUpdateFindings(ctx context.Context, params *BatchUpdateFindingsInput, optFns ...func(*Options)) (*BatchUpdateFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchUpdateFindings", params, optFns, addOperationBatchUpdateFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchUpdateFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
