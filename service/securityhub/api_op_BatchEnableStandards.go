...
func (c *Client) BatchEnableStandards(ctx context.Context, params *BatchEnableStandardsInput, optFns ...func(*Options)) (*BatchEnableStandardsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchEnableStandards", params, optFns, addOperationBatchEnableStandardsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchEnableStandardsMiddleware(stack *middleware.Stack, options Options) (err error) {
