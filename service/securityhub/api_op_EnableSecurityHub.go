...
func (c *Client) EnableSecurityHub(ctx context.Context, params *EnableSecurityHubInput, optFns ...func(*Options)) (*EnableSecurityHubOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableSecurityHub", params, optFns, addOperationEnableSecurityHubMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableSecurityHubMiddleware(stack *middleware.Stack, options Options) (err error) {
