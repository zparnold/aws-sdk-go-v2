...
func (c *Client) DescribeStandardsControls(ctx context.Context, params *DescribeStandardsControlsInput, optFns ...func(*Options)) (*DescribeStandardsControlsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStandardsControls", params, optFns, addOperationDescribeStandardsControlsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStandardsControlsMiddleware(stack *middleware.Stack, options Options) (err error) {
