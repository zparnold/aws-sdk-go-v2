...
func (c *Client) DescribeProducts(ctx context.Context, params *DescribeProductsInput, optFns ...func(*Options)) (*DescribeProductsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProducts", params, optFns, addOperationDescribeProductsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProductsMiddleware(stack *middleware.Stack, options Options) (err error) {
