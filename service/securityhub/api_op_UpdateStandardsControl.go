...
func (c *Client) UpdateStandardsControl(ctx context.Context, params *UpdateStandardsControlInput, optFns ...func(*Options)) (*UpdateStandardsControlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStandardsControl", params, optFns, addOperationUpdateStandardsControlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStandardsControlMiddleware(stack *middleware.Stack, options Options) (err error) {
