...
func (c *Client) GetEnabledStandards(ctx context.Context, params *GetEnabledStandardsInput, optFns ...func(*Options)) (*GetEnabledStandardsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEnabledStandards", params, optFns, addOperationGetEnabledStandardsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEnabledStandardsMiddleware(stack *middleware.Stack, options Options) (err error) {
