...
func (c *Client) GetFindings(ctx context.Context, params *GetFindingsInput, optFns ...func(*Options)) (*GetFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFindings", params, optFns, addOperationGetFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
