...
func (c *Client) DisableImportFindingsForProduct(ctx context.Context, params *DisableImportFindingsForProductInput, optFns ...func(*Options)) (*DisableImportFindingsForProductOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableImportFindingsForProduct", params, optFns, addOperationDisableImportFindingsForProductMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableImportFindingsForProductMiddleware(stack *middleware.Stack, options Options) (err error) {
