...
func (c *Client) CreateActionTarget(ctx context.Context, params *CreateActionTargetInput, optFns ...func(*Options)) (*CreateActionTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateActionTarget", params, optFns, addOperationCreateActionTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateActionTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
