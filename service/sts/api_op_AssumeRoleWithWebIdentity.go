...
func (c *Client) AssumeRoleWithWebIdentity(ctx context.Context, params *AssumeRoleWithWebIdentityInput, optFns ...func(*Options)) (*AssumeRoleWithWebIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssumeRoleWithWebIdentity", params, optFns, addOperationAssumeRoleWithWebIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssumeRoleWithWebIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
