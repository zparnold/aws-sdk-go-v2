...
func (c *Client) AssumeRoleWithSAML(ctx context.Context, params *AssumeRoleWithSAMLInput, optFns ...func(*Options)) (*AssumeRoleWithSAMLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssumeRoleWithSAML", params, optFns, addOperationAssumeRoleWithSAMLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssumeRoleWithSAMLMiddleware(stack *middleware.Stack, options Options) (err error) {
