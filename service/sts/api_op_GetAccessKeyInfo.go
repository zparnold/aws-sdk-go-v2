...
func (c *Client) GetAccessKeyInfo(ctx context.Context, params *GetAccessKeyInfoInput, optFns ...func(*Options)) (*GetAccessKeyInfoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccessKeyInfo", params, optFns, addOperationGetAccessKeyInfoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccessKeyInfoMiddleware(stack *middleware.Stack, options Options) (err error) {
