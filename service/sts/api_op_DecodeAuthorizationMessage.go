...
func (c *Client) DecodeAuthorizationMessage(ctx context.Context, params *DecodeAuthorizationMessageInput, optFns ...func(*Options)) (*DecodeAuthorizationMessageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DecodeAuthorizationMessage", params, optFns, addOperationDecodeAuthorizationMessageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDecodeAuthorizationMessageMiddleware(stack *middleware.Stack, options Options) (err error) {
