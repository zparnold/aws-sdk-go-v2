...
func (c *Client) GetFederationToken(ctx context.Context, params *GetFederationTokenInput, optFns ...func(*Options)) (*GetFederationTokenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFederationToken", params, optFns, addOperationGetFederationTokenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFederationTokenMiddleware(stack *middleware.Stack, options Options) (err error) {
