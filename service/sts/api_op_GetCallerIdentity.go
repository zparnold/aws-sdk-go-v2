...
func (c *Client) GetCallerIdentity(ctx context.Context, params *GetCallerIdentityInput, optFns ...func(*Options)) (*GetCallerIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCallerIdentity", params, optFns, addOperationGetCallerIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCallerIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
