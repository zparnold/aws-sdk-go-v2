...
func (c *Client) AssumeRole(ctx context.Context, params *AssumeRoleInput, optFns ...func(*Options)) (*AssumeRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssumeRole", params, optFns, addOperationAssumeRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssumeRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
