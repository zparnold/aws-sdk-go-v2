...
func (c *Client) DescribeEventsForOrganization(ctx context.Context, params *DescribeEventsForOrganizationInput, optFns ...func(*Options)) (*DescribeEventsForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventsForOrganization", params, optFns, addOperationDescribeEventsForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventsForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
