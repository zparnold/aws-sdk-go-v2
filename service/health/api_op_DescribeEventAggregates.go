...
func (c *Client) DescribeEventAggregates(ctx context.Context, params *DescribeEventAggregatesInput, optFns ...func(*Options)) (*DescribeEventAggregatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventAggregates", params, optFns, addOperationDescribeEventAggregatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventAggregatesMiddleware(stack *middleware.Stack, options Options) (err error) {
