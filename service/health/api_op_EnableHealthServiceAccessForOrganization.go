...
func (c *Client) EnableHealthServiceAccessForOrganization(ctx context.Context, params *EnableHealthServiceAccessForOrganizationInput, optFns ...func(*Options)) (*EnableHealthServiceAccessForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableHealthServiceAccessForOrganization", params, optFns, addOperationEnableHealthServiceAccessForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableHealthServiceAccessForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
