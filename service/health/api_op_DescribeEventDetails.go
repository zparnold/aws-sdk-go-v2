...
func (c *Client) DescribeEventDetails(ctx context.Context, params *DescribeEventDetailsInput, optFns ...func(*Options)) (*DescribeEventDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventDetails", params, optFns, addOperationDescribeEventDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
