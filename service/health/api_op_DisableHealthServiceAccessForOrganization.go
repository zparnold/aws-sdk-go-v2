...
func (c *Client) DisableHealthServiceAccessForOrganization(ctx context.Context, params *DisableHealthServiceAccessForOrganizationInput, optFns ...func(*Options)) (*DisableHealthServiceAccessForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableHealthServiceAccessForOrganization", params, optFns, addOperationDisableHealthServiceAccessForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableHealthServiceAccessForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
