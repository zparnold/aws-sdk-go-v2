...
func (c *Client) DescribeHealthServiceStatusForOrganization(ctx context.Context, params *DescribeHealthServiceStatusForOrganizationInput, optFns ...func(*Options)) (*DescribeHealthServiceStatusForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHealthServiceStatusForOrganization", params, optFns, addOperationDescribeHealthServiceStatusForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHealthServiceStatusForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
