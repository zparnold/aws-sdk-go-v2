...
func (c *Client) DescribeAffectedAccountsForOrganization(ctx context.Context, params *DescribeAffectedAccountsForOrganizationInput, optFns ...func(*Options)) (*DescribeAffectedAccountsForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAffectedAccountsForOrganization", params, optFns, addOperationDescribeAffectedAccountsForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAffectedAccountsForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
