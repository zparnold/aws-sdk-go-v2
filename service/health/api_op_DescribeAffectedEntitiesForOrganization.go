...
func (c *Client) DescribeAffectedEntitiesForOrganization(ctx context.Context, params *DescribeAffectedEntitiesForOrganizationInput, optFns ...func(*Options)) (*DescribeAffectedEntitiesForOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAffectedEntitiesForOrganization", params, optFns, addOperationDescribeAffectedEntitiesForOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAffectedEntitiesForOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
