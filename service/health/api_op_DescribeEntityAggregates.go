...
func (c *Client) DescribeEntityAggregates(ctx context.Context, params *DescribeEntityAggregatesInput, optFns ...func(*Options)) (*DescribeEntityAggregatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEntityAggregates", params, optFns, addOperationDescribeEntityAggregatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEntityAggregatesMiddleware(stack *middleware.Stack, options Options) (err error) {
