...
func (c *Client) DescribeEventTypes(ctx context.Context, params *DescribeEventTypesInput, optFns ...func(*Options)) (*DescribeEventTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventTypes", params, optFns, addOperationDescribeEventTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
