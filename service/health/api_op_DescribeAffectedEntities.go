...
func (c *Client) DescribeAffectedEntities(ctx context.Context, params *DescribeAffectedEntitiesInput, optFns ...func(*Options)) (*DescribeAffectedEntitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAffectedEntities", params, optFns, addOperationDescribeAffectedEntitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAffectedEntitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
