...
func (c *Client) PutConfigurationSetTrackingOptions(ctx context.Context, params *PutConfigurationSetTrackingOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetTrackingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConfigurationSetTrackingOptions", params, optFns, addOperationPutConfigurationSetTrackingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConfigurationSetTrackingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
