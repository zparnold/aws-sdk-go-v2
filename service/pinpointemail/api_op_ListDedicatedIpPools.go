...
func (c *Client) ListDedicatedIpPools(ctx context.Context, params *ListDedicatedIpPoolsInput, optFns ...func(*Options)) (*ListDedicatedIpPoolsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDedicatedIpPools", params, optFns, addOperationListDedicatedIpPoolsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDedicatedIpPoolsMiddleware(stack *middleware.Stack, options Options) (err error) {
