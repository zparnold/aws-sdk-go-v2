...
func (c *Client) PutEmailIdentityMailFromAttributes(ctx context.Context, params *PutEmailIdentityMailFromAttributesInput, optFns ...func(*Options)) (*PutEmailIdentityMailFromAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEmailIdentityMailFromAttributes", params, optFns, addOperationPutEmailIdentityMailFromAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEmailIdentityMailFromAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
