...
func (c *Client) PutEmailIdentityFeedbackAttributes(ctx context.Context, params *PutEmailIdentityFeedbackAttributesInput, optFns ...func(*Options)) (*PutEmailIdentityFeedbackAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEmailIdentityFeedbackAttributes", params, optFns, addOperationPutEmailIdentityFeedbackAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEmailIdentityFeedbackAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
