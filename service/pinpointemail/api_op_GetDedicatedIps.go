...
func (c *Client) GetDedicatedIps(ctx context.Context, params *GetDedicatedIpsInput, optFns ...func(*Options)) (*GetDedicatedIpsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDedicatedIps", params, optFns, addOperationGetDedicatedIpsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDedicatedIpsMiddleware(stack *middleware.Stack, options Options) (err error) {
