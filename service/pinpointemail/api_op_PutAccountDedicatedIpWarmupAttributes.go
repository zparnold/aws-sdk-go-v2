...
func (c *Client) PutAccountDedicatedIpWarmupAttributes(ctx context.Context, params *PutAccountDedicatedIpWarmupAttributesInput, optFns ...func(*Options)) (*PutAccountDedicatedIpWarmupAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccountDedicatedIpWarmupAttributes", params, optFns, addOperationPutAccountDedicatedIpWarmupAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccountDedicatedIpWarmupAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
