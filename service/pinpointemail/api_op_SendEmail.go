...
func (c *Client) SendEmail(ctx context.Context, params *SendEmailInput, optFns ...func(*Options)) (*SendEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendEmail", params, optFns, addOperationSendEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
