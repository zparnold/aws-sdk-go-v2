...
func (c *Client) GetConfigurationSet(ctx context.Context, params *GetConfigurationSetInput, optFns ...func(*Options)) (*GetConfigurationSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConfigurationSet", params, optFns, addOperationGetConfigurationSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConfigurationSetMiddleware(stack *middleware.Stack, options Options) (err error) {
