...
func (c *Client) PutDeliverabilityDashboardOption(ctx context.Context, params *PutDeliverabilityDashboardOptionInput, optFns ...func(*Options)) (*PutDeliverabilityDashboardOptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDeliverabilityDashboardOption", params, optFns, addOperationPutDeliverabilityDashboardOptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDeliverabilityDashboardOptionMiddleware(stack *middleware.Stack, options Options) (err error) {
