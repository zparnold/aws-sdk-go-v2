...
func (c *Client) GetDomainStatisticsReport(ctx context.Context, params *GetDomainStatisticsReportInput, optFns ...func(*Options)) (*GetDomainStatisticsReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainStatisticsReport", params, optFns, addOperationGetDomainStatisticsReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainStatisticsReportMiddleware(stack *middleware.Stack, options Options) (err error) {
