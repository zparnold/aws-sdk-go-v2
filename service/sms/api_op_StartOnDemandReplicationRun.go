...
func (c *Client) StartOnDemandReplicationRun(ctx context.Context, params *StartOnDemandReplicationRunInput, optFns ...func(*Options)) (*StartOnDemandReplicationRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartOnDemandReplicationRun", params, optFns, addOperationStartOnDemandReplicationRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartOnDemandReplicationRunMiddleware(stack *middleware.Stack, options Options) (err error) {
