...
func (c *Client) StartAppReplication(ctx context.Context, params *StartAppReplicationInput, optFns ...func(*Options)) (*StartAppReplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartAppReplication", params, optFns, addOperationStartAppReplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartAppReplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
