...
func (c *Client) GetServers(ctx context.Context, params *GetServersInput, optFns ...func(*Options)) (*GetServersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServers", params, optFns, addOperationGetServersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServersMiddleware(stack *middleware.Stack, options Options) (err error) {
