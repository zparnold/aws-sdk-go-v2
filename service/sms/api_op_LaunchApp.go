...
func (c *Client) LaunchApp(ctx context.Context, params *LaunchAppInput, optFns ...func(*Options)) (*LaunchAppOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "LaunchApp", params, optFns, addOperationLaunchAppMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLaunchAppMiddleware(stack *middleware.Stack, options Options) (err error) {
