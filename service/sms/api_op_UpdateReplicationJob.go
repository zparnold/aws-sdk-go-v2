...
func (c *Client) UpdateReplicationJob(ctx context.Context, params *UpdateReplicationJobInput, optFns ...func(*Options)) (*UpdateReplicationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateReplicationJob", params, optFns, addOperationUpdateReplicationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateReplicationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
