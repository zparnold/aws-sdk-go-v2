...
func (c *Client) DeleteAppLaunchConfiguration(ctx context.Context, params *DeleteAppLaunchConfigurationInput, optFns ...func(*Options)) (*DeleteAppLaunchConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAppLaunchConfiguration", params, optFns, addOperationDeleteAppLaunchConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAppLaunchConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
