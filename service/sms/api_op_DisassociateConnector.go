...
func (c *Client) DisassociateConnector(ctx context.Context, params *DisassociateConnectorInput, optFns ...func(*Options)) (*DisassociateConnectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateConnector", params, optFns, addOperationDisassociateConnectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateConnectorMiddleware(stack *middleware.Stack, options Options) (err error) {
