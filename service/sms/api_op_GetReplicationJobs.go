...
func (c *Client) GetReplicationJobs(ctx context.Context, params *GetReplicationJobsInput, optFns ...func(*Options)) (*GetReplicationJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetReplicationJobs", params, optFns, addOperationGetReplicationJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetReplicationJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
