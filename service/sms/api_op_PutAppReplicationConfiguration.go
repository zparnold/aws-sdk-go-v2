...
func (c *Client) PutAppReplicationConfiguration(ctx context.Context, params *PutAppReplicationConfigurationInput, optFns ...func(*Options)) (*PutAppReplicationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAppReplicationConfiguration", params, optFns, addOperationPutAppReplicationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAppReplicationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
