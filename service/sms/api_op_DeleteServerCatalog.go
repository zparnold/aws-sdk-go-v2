...
func (c *Client) DeleteServerCatalog(ctx context.Context, params *DeleteServerCatalogInput, optFns ...func(*Options)) (*DeleteServerCatalogOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteServerCatalog", params, optFns, addOperationDeleteServerCatalogMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteServerCatalogMiddleware(stack *middleware.Stack, options Options) (err error) {
