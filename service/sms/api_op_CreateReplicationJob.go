...
func (c *Client) CreateReplicationJob(ctx context.Context, params *CreateReplicationJobInput, optFns ...func(*Options)) (*CreateReplicationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReplicationJob", params, optFns, addOperationCreateReplicationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReplicationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
