...
func (c *Client) GenerateTemplate(ctx context.Context, params *GenerateTemplateInput, optFns ...func(*Options)) (*GenerateTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateTemplate", params, optFns, addOperationGenerateTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
