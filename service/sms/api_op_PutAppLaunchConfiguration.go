...
func (c *Client) PutAppLaunchConfiguration(ctx context.Context, params *PutAppLaunchConfigurationInput, optFns ...func(*Options)) (*PutAppLaunchConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAppLaunchConfiguration", params, optFns, addOperationPutAppLaunchConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAppLaunchConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
