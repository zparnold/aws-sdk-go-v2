...
func (c *Client) TerminateApp(ctx context.Context, params *TerminateAppInput, optFns ...func(*Options)) (*TerminateAppOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateApp", params, optFns, addOperationTerminateAppMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateAppMiddleware(stack *middleware.Stack, options Options) (err error) {
