...
func (c *Client) GetAppLaunchConfiguration(ctx context.Context, params *GetAppLaunchConfigurationInput, optFns ...func(*Options)) (*GetAppLaunchConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAppLaunchConfiguration", params, optFns, addOperationGetAppLaunchConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAppLaunchConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
