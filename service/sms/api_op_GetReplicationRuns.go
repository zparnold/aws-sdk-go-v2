...
func (c *Client) GetReplicationRuns(ctx context.Context, params *GetReplicationRunsInput, optFns ...func(*Options)) (*GetReplicationRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetReplicationRuns", params, optFns, addOperationGetReplicationRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetReplicationRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
