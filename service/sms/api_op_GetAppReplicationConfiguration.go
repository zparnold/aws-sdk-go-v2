...
func (c *Client) GetAppReplicationConfiguration(ctx context.Context, params *GetAppReplicationConfigurationInput, optFns ...func(*Options)) (*GetAppReplicationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAppReplicationConfiguration", params, optFns, addOperationGetAppReplicationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAppReplicationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
