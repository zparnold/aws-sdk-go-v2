...
func (c *Client) GenerateChangeSet(ctx context.Context, params *GenerateChangeSetInput, optFns ...func(*Options)) (*GenerateChangeSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateChangeSet", params, optFns, addOperationGenerateChangeSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateChangeSetMiddleware(stack *middleware.Stack, options Options) (err error) {
