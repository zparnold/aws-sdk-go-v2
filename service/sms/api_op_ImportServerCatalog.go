...
func (c *Client) ImportServerCatalog(ctx context.Context, params *ImportServerCatalogInput, optFns ...func(*Options)) (*ImportServerCatalogOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportServerCatalog", params, optFns, addOperationImportServerCatalogMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportServerCatalogMiddleware(stack *middleware.Stack, options Options) (err error) {
