...
func (c *Client) CreateParameterGroup(ctx context.Context, params *CreateParameterGroupInput, optFns ...func(*Options)) (*CreateParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateParameterGroup", params, optFns, addOperationCreateParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
