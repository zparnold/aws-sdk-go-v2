...
func (c *Client) UpdateSubnetGroup(ctx context.Context, params *UpdateSubnetGroupInput, optFns ...func(*Options)) (*UpdateSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSubnetGroup", params, optFns, addOperationUpdateSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
