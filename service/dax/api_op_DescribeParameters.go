...
func (c *Client) DescribeParameters(ctx context.Context, params *DescribeParametersInput, optFns ...func(*Options)) (*DescribeParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeParameters", params, optFns, addOperationDescribeParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
