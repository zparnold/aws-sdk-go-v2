...
func (c *Client) DescribeParameterGroups(ctx context.Context, params *DescribeParameterGroupsInput, optFns ...func(*Options)) (*DescribeParameterGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeParameterGroups", params, optFns, addOperationDescribeParameterGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeParameterGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
