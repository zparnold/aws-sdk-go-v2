...
func (c *Client) UpdateParameterGroup(ctx context.Context, params *UpdateParameterGroupInput, optFns ...func(*Options)) (*UpdateParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateParameterGroup", params, optFns, addOperationUpdateParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
