...
func (c *Client) DeleteParameterGroup(ctx context.Context, params *DeleteParameterGroupInput, optFns ...func(*Options)) (*DeleteParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteParameterGroup", params, optFns, addOperationDeleteParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
