...
func (c *Client) CreateSubnetGroup(ctx context.Context, params *CreateSubnetGroupInput, optFns ...func(*Options)) (*CreateSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSubnetGroup", params, optFns, addOperationCreateSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
