...
func (c *Client) RebootNode(ctx context.Context, params *RebootNodeInput, optFns ...func(*Options)) (*RebootNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootNode", params, optFns, addOperationRebootNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
