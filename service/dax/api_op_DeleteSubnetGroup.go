...
func (c *Client) DeleteSubnetGroup(ctx context.Context, params *DeleteSubnetGroupInput, optFns ...func(*Options)) (*DeleteSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSubnetGroup", params, optFns, addOperationDeleteSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
