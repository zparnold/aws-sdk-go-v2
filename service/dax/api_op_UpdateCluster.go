...
func (c *Client) UpdateCluster(ctx context.Context, params *UpdateClusterInput, optFns ...func(*Options)) (*UpdateClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCluster", params, optFns, addOperationUpdateClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
