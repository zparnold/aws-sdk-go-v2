...
func (c *Client) DecreaseReplicationFactor(ctx context.Context, params *DecreaseReplicationFactorInput, optFns ...func(*Options)) (*DecreaseReplicationFactorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DecreaseReplicationFactor", params, optFns, addOperationDecreaseReplicationFactorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDecreaseReplicationFactorMiddleware(stack *middleware.Stack, options Options) (err error) {
