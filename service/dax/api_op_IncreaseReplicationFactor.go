...
func (c *Client) IncreaseReplicationFactor(ctx context.Context, params *IncreaseReplicationFactorInput, optFns ...func(*Options)) (*IncreaseReplicationFactorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IncreaseReplicationFactor", params, optFns, addOperationIncreaseReplicationFactorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIncreaseReplicationFactorMiddleware(stack *middleware.Stack, options Options) (err error) {
