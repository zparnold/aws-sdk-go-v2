...
func (c *Client) DescribeDefaultParameters(ctx context.Context, params *DescribeDefaultParametersInput, optFns ...func(*Options)) (*DescribeDefaultParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDefaultParameters", params, optFns, addOperationDescribeDefaultParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDefaultParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
