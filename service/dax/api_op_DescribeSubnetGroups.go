...
func (c *Client) DescribeSubnetGroups(ctx context.Context, params *DescribeSubnetGroupsInput, optFns ...func(*Options)) (*DescribeSubnetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSubnetGroups", params, optFns, addOperationDescribeSubnetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSubnetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
