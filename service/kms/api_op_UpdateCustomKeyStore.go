...
func (c *Client) UpdateCustomKeyStore(ctx context.Context, params *UpdateCustomKeyStoreInput, optFns ...func(*Options)) (*UpdateCustomKeyStoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCustomKeyStore", params, optFns, addOperationUpdateCustomKeyStoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCustomKeyStoreMiddleware(stack *middleware.Stack, options Options) (err error) {
