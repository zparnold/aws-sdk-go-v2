...
func (c *Client) CreateGrant(ctx context.Context, params *CreateGrantInput, optFns ...func(*Options)) (*CreateGrantOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGrant", params, optFns, addOperationCreateGrantMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGrantMiddleware(stack *middleware.Stack, options Options) (err error) {
