...
func (c *Client) EnableKeyRotation(ctx context.Context, params *EnableKeyRotationInput, optFns ...func(*Options)) (*EnableKeyRotationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableKeyRotation", params, optFns, addOperationEnableKeyRotationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableKeyRotationMiddleware(stack *middleware.Stack, options Options) (err error) {
