...
func (c *Client) DisconnectCustomKeyStore(ctx context.Context, params *DisconnectCustomKeyStoreInput, optFns ...func(*Options)) (*DisconnectCustomKeyStoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisconnectCustomKeyStore", params, optFns, addOperationDisconnectCustomKeyStoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisconnectCustomKeyStoreMiddleware(stack *middleware.Stack, options Options) (err error) {
