...
func (c *Client) DisableKeyRotation(ctx context.Context, params *DisableKeyRotationInput, optFns ...func(*Options)) (*DisableKeyRotationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableKeyRotation", params, optFns, addOperationDisableKeyRotationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableKeyRotationMiddleware(stack *middleware.Stack, options Options) (err error) {
