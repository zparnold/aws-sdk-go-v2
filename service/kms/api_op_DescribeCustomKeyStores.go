...
func (c *Client) DescribeCustomKeyStores(ctx context.Context, params *DescribeCustomKeyStoresInput, optFns ...func(*Options)) (*DescribeCustomKeyStoresOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCustomKeyStores", params, optFns, addOperationDescribeCustomKeyStoresMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCustomKeyStoresMiddleware(stack *middleware.Stack, options Options) (err error) {
