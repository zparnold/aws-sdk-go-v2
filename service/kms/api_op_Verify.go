...
func (c *Client) Verify(ctx context.Context, params *VerifyInput, optFns ...func(*Options)) (*VerifyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Verify", params, optFns, addOperationVerifyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationVerifyMiddleware(stack *middleware.Stack, options Options) (err error) {
