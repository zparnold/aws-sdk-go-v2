...
func (c *Client) CancelKeyDeletion(ctx context.Context, params *CancelKeyDeletionInput, optFns ...func(*Options)) (*CancelKeyDeletionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelKeyDeletion", params, optFns, addOperationCancelKeyDeletionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelKeyDeletionMiddleware(stack *middleware.Stack, options Options) (err error) {
