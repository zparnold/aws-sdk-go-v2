...
func (c *Client) GenerateDataKeyWithoutPlaintext(ctx context.Context, params *GenerateDataKeyWithoutPlaintextInput, optFns ...func(*Options)) (*GenerateDataKeyWithoutPlaintextOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateDataKeyWithoutPlaintext", params, optFns, addOperationGenerateDataKeyWithoutPlaintextMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateDataKeyWithoutPlaintextMiddleware(stack *middleware.Stack, options Options) (err error) {
