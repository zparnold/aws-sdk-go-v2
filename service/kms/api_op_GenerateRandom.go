...
func (c *Client) GenerateRandom(ctx context.Context, params *GenerateRandomInput, optFns ...func(*Options)) (*GenerateRandomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateRandom", params, optFns, addOperationGenerateRandomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateRandomMiddleware(stack *middleware.Stack, options Options) (err error) {
