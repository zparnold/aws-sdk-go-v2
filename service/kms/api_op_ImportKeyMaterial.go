...
func (c *Client) ImportKeyMaterial(ctx context.Context, params *ImportKeyMaterialInput, optFns ...func(*Options)) (*ImportKeyMaterialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportKeyMaterial", params, optFns, addOperationImportKeyMaterialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportKeyMaterialMiddleware(stack *middleware.Stack, options Options) (err error) {
