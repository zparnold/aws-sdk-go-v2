...
func (c *Client) GetKeyPolicy(ctx context.Context, params *GetKeyPolicyInput, optFns ...func(*Options)) (*GetKeyPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetKeyPolicy", params, optFns, addOperationGetKeyPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetKeyPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
