...
func (c *Client) EnableKey(ctx context.Context, params *EnableKeyInput, optFns ...func(*Options)) (*EnableKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableKey", params, optFns, addOperationEnableKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
