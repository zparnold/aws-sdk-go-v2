...
func (c *Client) Sign(ctx context.Context, params *SignInput, optFns ...func(*Options)) (*SignOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Sign", params, optFns, addOperationSignMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSignMiddleware(stack *middleware.Stack, options Options) (err error) {
