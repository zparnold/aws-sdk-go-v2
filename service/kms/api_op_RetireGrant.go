...
func (c *Client) RetireGrant(ctx context.Context, params *RetireGrantInput, optFns ...func(*Options)) (*RetireGrantOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetireGrant", params, optFns, addOperationRetireGrantMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetireGrantMiddleware(stack *middleware.Stack, options Options) (err error) {
