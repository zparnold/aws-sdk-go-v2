...
func (c *Client) ConnectCustomKeyStore(ctx context.Context, params *ConnectCustomKeyStoreInput, optFns ...func(*Options)) (*ConnectCustomKeyStoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConnectCustomKeyStore", params, optFns, addOperationConnectCustomKeyStoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConnectCustomKeyStoreMiddleware(stack *middleware.Stack, options Options) (err error) {
