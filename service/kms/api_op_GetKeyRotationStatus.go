...
func (c *Client) GetKeyRotationStatus(ctx context.Context, params *GetKeyRotationStatusInput, optFns ...func(*Options)) (*GetKeyRotationStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetKeyRotationStatus", params, optFns, addOperationGetKeyRotationStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetKeyRotationStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
