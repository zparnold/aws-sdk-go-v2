...
func (c *Client) ListKeys(ctx context.Context, params *ListKeysInput, optFns ...func(*Options)) (*ListKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListKeys", params, optFns, addOperationListKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
