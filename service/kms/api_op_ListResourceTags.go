...
func (c *Client) ListResourceTags(ctx context.Context, params *ListResourceTagsInput, optFns ...func(*Options)) (*ListResourceTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceTags", params, optFns, addOperationListResourceTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
