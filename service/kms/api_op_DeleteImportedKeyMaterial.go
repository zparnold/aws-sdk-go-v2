...
func (c *Client) DeleteImportedKeyMaterial(ctx context.Context, params *DeleteImportedKeyMaterialInput, optFns ...func(*Options)) (*DeleteImportedKeyMaterialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteImportedKeyMaterial", params, optFns, addOperationDeleteImportedKeyMaterialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteImportedKeyMaterialMiddleware(stack *middleware.Stack, options Options) (err error) {
