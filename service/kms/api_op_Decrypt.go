...
func (c *Client) Decrypt(ctx context.Context, params *DecryptInput, optFns ...func(*Options)) (*DecryptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Decrypt", params, optFns, addOperationDecryptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDecryptMiddleware(stack *middleware.Stack, options Options) (err error) {
