...
func (c *Client) UpdateKeyDescription(ctx context.Context, params *UpdateKeyDescriptionInput, optFns ...func(*Options)) (*UpdateKeyDescriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateKeyDescription", params, optFns, addOperationUpdateKeyDescriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateKeyDescriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
