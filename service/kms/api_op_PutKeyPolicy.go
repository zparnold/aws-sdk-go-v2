...
func (c *Client) PutKeyPolicy(ctx context.Context, params *PutKeyPolicyInput, optFns ...func(*Options)) (*PutKeyPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutKeyPolicy", params, optFns, addOperationPutKeyPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutKeyPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
