...
func (c *Client) CreateCustomKeyStore(ctx context.Context, params *CreateCustomKeyStoreInput, optFns ...func(*Options)) (*CreateCustomKeyStoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomKeyStore", params, optFns, addOperationCreateCustomKeyStoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomKeyStoreMiddleware(stack *middleware.Stack, options Options) (err error) {
