...
func (c *Client) GenerateDataKey(ctx context.Context, params *GenerateDataKeyInput, optFns ...func(*Options)) (*GenerateDataKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateDataKey", params, optFns, addOperationGenerateDataKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateDataKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
