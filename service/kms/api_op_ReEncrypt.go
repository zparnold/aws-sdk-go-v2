...
func (c *Client) ReEncrypt(ctx context.Context, params *ReEncryptInput, optFns ...func(*Options)) (*ReEncryptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReEncrypt", params, optFns, addOperationReEncryptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReEncryptMiddleware(stack *middleware.Stack, options Options) (err error) {
