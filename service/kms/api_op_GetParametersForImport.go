...
func (c *Client) GetParametersForImport(ctx context.Context, params *GetParametersForImportInput, optFns ...func(*Options)) (*GetParametersForImportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetParametersForImport", params, optFns, addOperationGetParametersForImportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetParametersForImportMiddleware(stack *middleware.Stack, options Options) (err error) {
