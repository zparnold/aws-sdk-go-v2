...
func (c *Client) GenerateDataKeyPairWithoutPlaintext(ctx context.Context, params *GenerateDataKeyPairWithoutPlaintextInput, optFns ...func(*Options)) (*GenerateDataKeyPairWithoutPlaintextOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateDataKeyPairWithoutPlaintext", params, optFns, addOperationGenerateDataKeyPairWithoutPlaintextMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateDataKeyPairWithoutPlaintextMiddleware(stack *middleware.Stack, options Options) (err error) {
