...
func (c *Client) RevokeGrant(ctx context.Context, params *RevokeGrantInput, optFns ...func(*Options)) (*RevokeGrantOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeGrant", params, optFns, addOperationRevokeGrantMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeGrantMiddleware(stack *middleware.Stack, options Options) (err error) {
