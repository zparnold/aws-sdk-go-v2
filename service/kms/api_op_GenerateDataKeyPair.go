...
func (c *Client) GenerateDataKeyPair(ctx context.Context, params *GenerateDataKeyPairInput, optFns ...func(*Options)) (*GenerateDataKeyPairOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateDataKeyPair", params, optFns, addOperationGenerateDataKeyPairMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateDataKeyPairMiddleware(stack *middleware.Stack, options Options) (err error) {
