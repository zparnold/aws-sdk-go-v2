...
func (c *Client) DeleteCustomKeyStore(ctx context.Context, params *DeleteCustomKeyStoreInput, optFns ...func(*Options)) (*DeleteCustomKeyStoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCustomKeyStore", params, optFns, addOperationDeleteCustomKeyStoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCustomKeyStoreMiddleware(stack *middleware.Stack, options Options) (err error) {
