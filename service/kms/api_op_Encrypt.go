...
func (c *Client) Encrypt(ctx context.Context, params *EncryptInput, optFns ...func(*Options)) (*EncryptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Encrypt", params, optFns, addOperationEncryptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEncryptMiddleware(stack *middleware.Stack, options Options) (err error) {
