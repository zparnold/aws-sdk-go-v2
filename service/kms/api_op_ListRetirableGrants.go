...
func (c *Client) ListRetirableGrants(ctx context.Context, params *ListRetirableGrantsInput, optFns ...func(*Options)) (*ListRetirableGrantsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRetirableGrants", params, optFns, addOperationListRetirableGrantsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRetirableGrantsMiddleware(stack *middleware.Stack, options Options) (err error) {
