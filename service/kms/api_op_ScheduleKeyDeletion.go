...
func (c *Client) ScheduleKeyDeletion(ctx context.Context, params *ScheduleKeyDeletionInput, optFns ...func(*Options)) (*ScheduleKeyDeletionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ScheduleKeyDeletion", params, optFns, addOperationScheduleKeyDeletionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationScheduleKeyDeletionMiddleware(stack *middleware.Stack, options Options) (err error) {
