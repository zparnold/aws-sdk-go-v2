...
func (c *Client) ListKeyPolicies(ctx context.Context, params *ListKeyPoliciesInput, optFns ...func(*Options)) (*ListKeyPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListKeyPolicies", params, optFns, addOperationListKeyPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListKeyPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
