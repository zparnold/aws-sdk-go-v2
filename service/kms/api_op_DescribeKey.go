...
func (c *Client) DescribeKey(ctx context.Context, params *DescribeKeyInput, optFns ...func(*Options)) (*DescribeKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeKey", params, optFns, addOperationDescribeKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
