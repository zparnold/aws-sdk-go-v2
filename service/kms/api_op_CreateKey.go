...
func (c *Client) CreateKey(ctx context.Context, params *CreateKeyInput, optFns ...func(*Options)) (*CreateKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateKey", params, optFns, addOperationCreateKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
