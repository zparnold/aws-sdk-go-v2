...
func (c *Client) DisableKey(ctx context.Context, params *DisableKeyInput, optFns ...func(*Options)) (*DisableKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableKey", params, optFns, addOperationDisableKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
