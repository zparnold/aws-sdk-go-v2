...
func (c *Client) ListGrants(ctx context.Context, params *ListGrantsInput, optFns ...func(*Options)) (*ListGrantsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGrants", params, optFns, addOperationListGrantsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGrantsMiddleware(stack *middleware.Stack, options Options) (err error) {
