...
func (c *Client) UpdateFleet(ctx context.Context, params *UpdateFleetInput, optFns ...func(*Options)) (*UpdateFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFleet", params, optFns, addOperationUpdateFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
