...
func (c *Client) CreateUsageReportSubscription(ctx context.Context, params *CreateUsageReportSubscriptionInput, optFns ...func(*Options)) (*CreateUsageReportSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUsageReportSubscription", params, optFns, addOperationCreateUsageReportSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUsageReportSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
