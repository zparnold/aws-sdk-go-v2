...
func (c *Client) AssociateFleet(ctx context.Context, params *AssociateFleetInput, optFns ...func(*Options)) (*AssociateFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateFleet", params, optFns, addOperationAssociateFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
