...
func (c *Client) BatchDisassociateUserStack(ctx context.Context, params *BatchDisassociateUserStackInput, optFns ...func(*Options)) (*BatchDisassociateUserStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDisassociateUserStack", params, optFns, addOperationBatchDisassociateUserStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDisassociateUserStackMiddleware(stack *middleware.Stack, options Options) (err error) {
