...
func (c *Client) CreateStreamingURL(ctx context.Context, params *CreateStreamingURLInput, optFns ...func(*Options)) (*CreateStreamingURLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStreamingURL", params, optFns, addOperationCreateStreamingURLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStreamingURLMiddleware(stack *middleware.Stack, options Options) (err error) {
