...
func (c *Client) DisassociateFleet(ctx context.Context, params *DisassociateFleetInput, optFns ...func(*Options)) (*DisassociateFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateFleet", params, optFns, addOperationDisassociateFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
