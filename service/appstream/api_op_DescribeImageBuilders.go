...
func (c *Client) DescribeImageBuilders(ctx context.Context, params *DescribeImageBuildersInput, optFns ...func(*Options)) (*DescribeImageBuildersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeImageBuilders", params, optFns, addOperationDescribeImageBuildersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeImageBuildersMiddleware(stack *middleware.Stack, options Options) (err error) {
