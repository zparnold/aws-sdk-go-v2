...
func (c *Client) DescribeUserStackAssociations(ctx context.Context, params *DescribeUserStackAssociationsInput, optFns ...func(*Options)) (*DescribeUserStackAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUserStackAssociations", params, optFns, addOperationDescribeUserStackAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUserStackAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
