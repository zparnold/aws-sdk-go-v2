...
func (c *Client) CreateStack(ctx context.Context, params *CreateStackInput, optFns ...func(*Options)) (*CreateStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStack", params, optFns, addOperationCreateStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStackMiddleware(stack *middleware.Stack, options Options) (err error) {
