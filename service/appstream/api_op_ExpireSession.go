...
func (c *Client) ExpireSession(ctx context.Context, params *ExpireSessionInput, optFns ...func(*Options)) (*ExpireSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExpireSession", params, optFns, addOperationExpireSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExpireSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
