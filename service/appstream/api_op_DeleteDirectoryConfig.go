...
func (c *Client) DeleteDirectoryConfig(ctx context.Context, params *DeleteDirectoryConfigInput, optFns ...func(*Options)) (*DeleteDirectoryConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDirectoryConfig", params, optFns, addOperationDeleteDirectoryConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDirectoryConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
