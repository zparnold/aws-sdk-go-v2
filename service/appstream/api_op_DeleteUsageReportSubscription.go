...
func (c *Client) DeleteUsageReportSubscription(ctx context.Context, params *DeleteUsageReportSubscriptionInput, optFns ...func(*Options)) (*DeleteUsageReportSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUsageReportSubscription", params, optFns, addOperationDeleteUsageReportSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUsageReportSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
