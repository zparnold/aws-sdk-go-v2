...
func (c *Client) DescribeImagePermissions(ctx context.Context, params *DescribeImagePermissionsInput, optFns ...func(*Options)) (*DescribeImagePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeImagePermissions", params, optFns, addOperationDescribeImagePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeImagePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
