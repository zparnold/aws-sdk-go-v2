...
func (c *Client) DescribeDirectoryConfigs(ctx context.Context, params *DescribeDirectoryConfigsInput, optFns ...func(*Options)) (*DescribeDirectoryConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDirectoryConfigs", params, optFns, addOperationDescribeDirectoryConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDirectoryConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
