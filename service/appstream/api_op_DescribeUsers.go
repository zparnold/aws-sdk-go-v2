...
func (c *Client) DescribeUsers(ctx context.Context, params *DescribeUsersInput, optFns ...func(*Options)) (*DescribeUsersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUsers", params, optFns, addOperationDescribeUsersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUsersMiddleware(stack *middleware.Stack, options Options) (err error) {
