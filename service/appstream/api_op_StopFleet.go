...
func (c *Client) StopFleet(ctx context.Context, params *StopFleetInput, optFns ...func(*Options)) (*StopFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopFleet", params, optFns, addOperationStopFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
