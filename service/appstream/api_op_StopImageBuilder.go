...
func (c *Client) StopImageBuilder(ctx context.Context, params *StopImageBuilderInput, optFns ...func(*Options)) (*StopImageBuilderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopImageBuilder", params, optFns, addOperationStopImageBuilderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopImageBuilderMiddleware(stack *middleware.Stack, options Options) (err error) {
