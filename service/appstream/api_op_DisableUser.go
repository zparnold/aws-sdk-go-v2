...
func (c *Client) DisableUser(ctx context.Context, params *DisableUserInput, optFns ...func(*Options)) (*DisableUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableUser", params, optFns, addOperationDisableUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableUserMiddleware(stack *middleware.Stack, options Options) (err error) {
