...
func (c *Client) CreateImageBuilderStreamingURL(ctx context.Context, params *CreateImageBuilderStreamingURLInput, optFns ...func(*Options)) (*CreateImageBuilderStreamingURLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateImageBuilderStreamingURL", params, optFns, addOperationCreateImageBuilderStreamingURLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateImageBuilderStreamingURLMiddleware(stack *middleware.Stack, options Options) (err error) {
