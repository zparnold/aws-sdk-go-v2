...
func (c *Client) UpdateDirectoryConfig(ctx context.Context, params *UpdateDirectoryConfigInput, optFns ...func(*Options)) (*UpdateDirectoryConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDirectoryConfig", params, optFns, addOperationUpdateDirectoryConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDirectoryConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
