...
func (c *Client) DescribeUsageReportSubscriptions(ctx context.Context, params *DescribeUsageReportSubscriptionsInput, optFns ...func(*Options)) (*DescribeUsageReportSubscriptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUsageReportSubscriptions", params, optFns, addOperationDescribeUsageReportSubscriptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUsageReportSubscriptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
