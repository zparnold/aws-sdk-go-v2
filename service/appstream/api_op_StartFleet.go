...
func (c *Client) StartFleet(ctx context.Context, params *StartFleetInput, optFns ...func(*Options)) (*StartFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartFleet", params, optFns, addOperationStartFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
