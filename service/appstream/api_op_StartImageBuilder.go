...
func (c *Client) StartImageBuilder(ctx context.Context, params *StartImageBuilderInput, optFns ...func(*Options)) (*StartImageBuilderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartImageBuilder", params, optFns, addOperationStartImageBuilderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartImageBuilderMiddleware(stack *middleware.Stack, options Options) (err error) {
