...
func (c *Client) DescribeFleets(ctx context.Context, params *DescribeFleetsInput, optFns ...func(*Options)) (*DescribeFleetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleets", params, optFns, addOperationDescribeFleetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetsMiddleware(stack *middleware.Stack, options Options) (err error) {
