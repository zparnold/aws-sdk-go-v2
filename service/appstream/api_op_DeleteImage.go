...
func (c *Client) DeleteImage(ctx context.Context, params *DeleteImageInput, optFns ...func(*Options)) (*DeleteImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteImage", params, optFns, addOperationDeleteImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteImageMiddleware(stack *middleware.Stack, options Options) (err error) {
