...
func (c *Client) CreateImageBuilder(ctx context.Context, params *CreateImageBuilderInput, optFns ...func(*Options)) (*CreateImageBuilderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateImageBuilder", params, optFns, addOperationCreateImageBuilderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateImageBuilderMiddleware(stack *middleware.Stack, options Options) (err error) {
