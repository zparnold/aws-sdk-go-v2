...
func (c *Client) EnableUser(ctx context.Context, params *EnableUserInput, optFns ...func(*Options)) (*EnableUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableUser", params, optFns, addOperationEnableUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableUserMiddleware(stack *middleware.Stack, options Options) (err error) {
