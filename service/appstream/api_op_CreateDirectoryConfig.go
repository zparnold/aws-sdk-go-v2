...
func (c *Client) CreateDirectoryConfig(ctx context.Context, params *CreateDirectoryConfigInput, optFns ...func(*Options)) (*CreateDirectoryConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDirectoryConfig", params, optFns, addOperationCreateDirectoryConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDirectoryConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
