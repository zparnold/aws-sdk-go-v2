...
func (c *Client) ListAssociatedStacks(ctx context.Context, params *ListAssociatedStacksInput, optFns ...func(*Options)) (*ListAssociatedStacksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssociatedStacks", params, optFns, addOperationListAssociatedStacksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssociatedStacksMiddleware(stack *middleware.Stack, options Options) (err error) {
