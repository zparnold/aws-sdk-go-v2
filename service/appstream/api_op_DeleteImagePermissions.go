...
func (c *Client) DeleteImagePermissions(ctx context.Context, params *DeleteImagePermissionsInput, optFns ...func(*Options)) (*DeleteImagePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteImagePermissions", params, optFns, addOperationDeleteImagePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteImagePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
