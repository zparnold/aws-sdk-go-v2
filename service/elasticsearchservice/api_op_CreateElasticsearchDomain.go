...
func (c *Client) CreateElasticsearchDomain(ctx context.Context, params *CreateElasticsearchDomainInput, optFns ...func(*Options)) (*CreateElasticsearchDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateElasticsearchDomain", params, optFns, addOperationCreateElasticsearchDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateElasticsearchDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
