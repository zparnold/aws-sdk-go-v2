...
func (c *Client) DissociatePackage(ctx context.Context, params *DissociatePackageInput, optFns ...func(*Options)) (*DissociatePackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DissociatePackage", params, optFns, addOperationDissociatePackageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDissociatePackageMiddleware(stack *middleware.Stack, options Options) (err error) {
