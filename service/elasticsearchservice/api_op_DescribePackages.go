...
func (c *Client) DescribePackages(ctx context.Context, params *DescribePackagesInput, optFns ...func(*Options)) (*DescribePackagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePackages", params, optFns, addOperationDescribePackagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePackagesMiddleware(stack *middleware.Stack, options Options) (err error) {
