...
func (c *Client) ListPackagesForDomain(ctx context.Context, params *ListPackagesForDomainInput, optFns ...func(*Options)) (*ListPackagesForDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPackagesForDomain", params, optFns, addOperationListPackagesForDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPackagesForDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
