...
func (c *Client) CancelElasticsearchServiceSoftwareUpdate(ctx context.Context, params *CancelElasticsearchServiceSoftwareUpdateInput, optFns ...func(*Options)) (*CancelElasticsearchServiceSoftwareUpdateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelElasticsearchServiceSoftwareUpdate", params, optFns, addOperationCancelElasticsearchServiceSoftwareUpdateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelElasticsearchServiceSoftwareUpdateMiddleware(stack *middleware.Stack, options Options) (err error) {
