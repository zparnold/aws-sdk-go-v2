...
func (c *Client) DescribeElasticsearchDomains(ctx context.Context, params *DescribeElasticsearchDomainsInput, optFns ...func(*Options)) (*DescribeElasticsearchDomainsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeElasticsearchDomains", params, optFns, addOperationDescribeElasticsearchDomainsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeElasticsearchDomainsMiddleware(stack *middleware.Stack, options Options) (err error) {
