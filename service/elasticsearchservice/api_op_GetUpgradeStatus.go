...
func (c *Client) GetUpgradeStatus(ctx context.Context, params *GetUpgradeStatusInput, optFns ...func(*Options)) (*GetUpgradeStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUpgradeStatus", params, optFns, addOperationGetUpgradeStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUpgradeStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
