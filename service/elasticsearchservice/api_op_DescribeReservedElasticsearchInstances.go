...
func (c *Client) DescribeReservedElasticsearchInstances(ctx context.Context, params *DescribeReservedElasticsearchInstancesInput, optFns ...func(*Options)) (*DescribeReservedElasticsearchInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedElasticsearchInstances", params, optFns, addOperationDescribeReservedElasticsearchInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedElasticsearchInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
