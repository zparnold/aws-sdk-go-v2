...
func (c *Client) DescribeInboundCrossClusterSearchConnections(ctx context.Context, params *DescribeInboundCrossClusterSearchConnectionsInput, optFns ...func(*Options)) (*DescribeInboundCrossClusterSearchConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInboundCrossClusterSearchConnections", params, optFns, addOperationDescribeInboundCrossClusterSearchConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInboundCrossClusterSearchConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
