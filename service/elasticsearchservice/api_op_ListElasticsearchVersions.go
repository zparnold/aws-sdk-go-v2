...
func (c *Client) ListElasticsearchVersions(ctx context.Context, params *ListElasticsearchVersionsInput, optFns ...func(*Options)) (*ListElasticsearchVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListElasticsearchVersions", params, optFns, addOperationListElasticsearchVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListElasticsearchVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
