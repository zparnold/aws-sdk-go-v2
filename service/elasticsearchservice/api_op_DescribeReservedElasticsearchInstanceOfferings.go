...
func (c *Client) DescribeReservedElasticsearchInstanceOfferings(ctx context.Context, params *DescribeReservedElasticsearchInstanceOfferingsInput, optFns ...func(*Options)) (*DescribeReservedElasticsearchInstanceOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedElasticsearchInstanceOfferings", params, optFns, addOperationDescribeReservedElasticsearchInstanceOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedElasticsearchInstanceOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
