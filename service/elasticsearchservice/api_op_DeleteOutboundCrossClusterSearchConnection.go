...
func (c *Client) DeleteOutboundCrossClusterSearchConnection(ctx context.Context, params *DeleteOutboundCrossClusterSearchConnectionInput, optFns ...func(*Options)) (*DeleteOutboundCrossClusterSearchConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOutboundCrossClusterSearchConnection", params, optFns, addOperationDeleteOutboundCrossClusterSearchConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOutboundCrossClusterSearchConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
