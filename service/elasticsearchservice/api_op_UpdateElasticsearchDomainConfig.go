...
func (c *Client) UpdateElasticsearchDomainConfig(ctx context.Context, params *UpdateElasticsearchDomainConfigInput, optFns ...func(*Options)) (*UpdateElasticsearchDomainConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateElasticsearchDomainConfig", params, optFns, addOperationUpdateElasticsearchDomainConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateElasticsearchDomainConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
