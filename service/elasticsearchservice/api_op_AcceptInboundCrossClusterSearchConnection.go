...
func (c *Client) AcceptInboundCrossClusterSearchConnection(ctx context.Context, params *AcceptInboundCrossClusterSearchConnectionInput, optFns ...func(*Options)) (*AcceptInboundCrossClusterSearchConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptInboundCrossClusterSearchConnection", params, optFns, addOperationAcceptInboundCrossClusterSearchConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptInboundCrossClusterSearchConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
