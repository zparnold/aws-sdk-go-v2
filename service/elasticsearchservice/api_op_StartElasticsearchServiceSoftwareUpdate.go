...
func (c *Client) StartElasticsearchServiceSoftwareUpdate(ctx context.Context, params *StartElasticsearchServiceSoftwareUpdateInput, optFns ...func(*Options)) (*StartElasticsearchServiceSoftwareUpdateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartElasticsearchServiceSoftwareUpdate", params, optFns, addOperationStartElasticsearchServiceSoftwareUpdateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartElasticsearchServiceSoftwareUpdateMiddleware(stack *middleware.Stack, options Options) (err error) {
