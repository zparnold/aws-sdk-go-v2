...
func (c *Client) CreatePackage(ctx context.Context, params *CreatePackageInput, optFns ...func(*Options)) (*CreatePackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePackage", params, optFns, addOperationCreatePackageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePackageMiddleware(stack *middleware.Stack, options Options) (err error) {
