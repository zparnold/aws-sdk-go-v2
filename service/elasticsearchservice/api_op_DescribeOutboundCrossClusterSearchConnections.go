...
func (c *Client) DescribeOutboundCrossClusterSearchConnections(ctx context.Context, params *DescribeOutboundCrossClusterSearchConnectionsInput, optFns ...func(*Options)) (*DescribeOutboundCrossClusterSearchConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOutboundCrossClusterSearchConnections", params, optFns, addOperationDescribeOutboundCrossClusterSearchConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOutboundCrossClusterSearchConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
