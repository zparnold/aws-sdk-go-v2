...
func (c *Client) PurchaseReservedElasticsearchInstanceOffering(ctx context.Context, params *PurchaseReservedElasticsearchInstanceOfferingInput, optFns ...func(*Options)) (*PurchaseReservedElasticsearchInstanceOfferingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurchaseReservedElasticsearchInstanceOffering", params, optFns, addOperationPurchaseReservedElasticsearchInstanceOfferingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurchaseReservedElasticsearchInstanceOfferingMiddleware(stack *middleware.Stack, options Options) (err error) {
