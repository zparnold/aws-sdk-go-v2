...
func (c *Client) ListElasticsearchInstanceTypes(ctx context.Context, params *ListElasticsearchInstanceTypesInput, optFns ...func(*Options)) (*ListElasticsearchInstanceTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListElasticsearchInstanceTypes", params, optFns, addOperationListElasticsearchInstanceTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListElasticsearchInstanceTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
