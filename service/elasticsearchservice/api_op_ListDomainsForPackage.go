...
func (c *Client) ListDomainsForPackage(ctx context.Context, params *ListDomainsForPackageInput, optFns ...func(*Options)) (*ListDomainsForPackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDomainsForPackage", params, optFns, addOperationListDomainsForPackageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDomainsForPackageMiddleware(stack *middleware.Stack, options Options) (err error) {
