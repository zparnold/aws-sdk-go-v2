...
func (c *Client) DeleteInboundCrossClusterSearchConnection(ctx context.Context, params *DeleteInboundCrossClusterSearchConnectionInput, optFns ...func(*Options)) (*DeleteInboundCrossClusterSearchConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInboundCrossClusterSearchConnection", params, optFns, addOperationDeleteInboundCrossClusterSearchConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInboundCrossClusterSearchConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
