...
func (c *Client) DeletePackage(ctx context.Context, params *DeletePackageInput, optFns ...func(*Options)) (*DeletePackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePackage", params, optFns, addOperationDeletePackageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePackageMiddleware(stack *middleware.Stack, options Options) (err error) {
