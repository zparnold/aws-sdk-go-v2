...
func (c *Client) CreateOutboundCrossClusterSearchConnection(ctx context.Context, params *CreateOutboundCrossClusterSearchConnectionInput, optFns ...func(*Options)) (*CreateOutboundCrossClusterSearchConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOutboundCrossClusterSearchConnection", params, optFns, addOperationCreateOutboundCrossClusterSearchConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOutboundCrossClusterSearchConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
