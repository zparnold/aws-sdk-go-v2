...
func (c *Client) GetUpgradeHistory(ctx context.Context, params *GetUpgradeHistoryInput, optFns ...func(*Options)) (*GetUpgradeHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUpgradeHistory", params, optFns, addOperationGetUpgradeHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUpgradeHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
