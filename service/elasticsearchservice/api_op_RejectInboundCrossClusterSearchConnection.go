...
func (c *Client) RejectInboundCrossClusterSearchConnection(ctx context.Context, params *RejectInboundCrossClusterSearchConnectionInput, optFns ...func(*Options)) (*RejectInboundCrossClusterSearchConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectInboundCrossClusterSearchConnection", params, optFns, addOperationRejectInboundCrossClusterSearchConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectInboundCrossClusterSearchConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
