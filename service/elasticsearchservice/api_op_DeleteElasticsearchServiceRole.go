...
func (c *Client) DeleteElasticsearchServiceRole(ctx context.Context, params *DeleteElasticsearchServiceRoleInput, optFns ...func(*Options)) (*DeleteElasticsearchServiceRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteElasticsearchServiceRole", params, optFns, addOperationDeleteElasticsearchServiceRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteElasticsearchServiceRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
