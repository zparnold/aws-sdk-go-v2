...
func (c *Client) AssociatePackage(ctx context.Context, params *AssociatePackageInput, optFns ...func(*Options)) (*AssociatePackageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociatePackage", params, optFns, addOperationAssociatePackageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociatePackageMiddleware(stack *middleware.Stack, options Options) (err error) {
