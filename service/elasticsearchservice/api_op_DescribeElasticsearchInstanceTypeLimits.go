...
func (c *Client) DescribeElasticsearchInstanceTypeLimits(ctx context.Context, params *DescribeElasticsearchInstanceTypeLimitsInput, optFns ...func(*Options)) (*DescribeElasticsearchInstanceTypeLimitsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeElasticsearchInstanceTypeLimits", params, optFns, addOperationDescribeElasticsearchInstanceTypeLimitsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeElasticsearchInstanceTypeLimitsMiddleware(stack *middleware.Stack, options Options) (err error) {
