...
func (c *Client) DescribeElasticsearchDomain(ctx context.Context, params *DescribeElasticsearchDomainInput, optFns ...func(*Options)) (*DescribeElasticsearchDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeElasticsearchDomain", params, optFns, addOperationDescribeElasticsearchDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeElasticsearchDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
