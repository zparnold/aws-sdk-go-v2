...
func (c *Client) GetCompatibleElasticsearchVersions(ctx context.Context, params *GetCompatibleElasticsearchVersionsInput, optFns ...func(*Options)) (*GetCompatibleElasticsearchVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCompatibleElasticsearchVersions", params, optFns, addOperationGetCompatibleElasticsearchVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCompatibleElasticsearchVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
