...
func (c *Client) PutLogEvents(ctx context.Context, params *PutLogEventsInput, optFns ...func(*Options)) (*PutLogEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutLogEvents", params, optFns, addOperationPutLogEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutLogEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
