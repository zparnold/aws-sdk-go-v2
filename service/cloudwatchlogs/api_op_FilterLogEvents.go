...
func (c *Client) FilterLogEvents(ctx context.Context, params *FilterLogEventsInput, optFns ...func(*Options)) (*FilterLogEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FilterLogEvents", params, optFns, addOperationFilterLogEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFilterLogEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
