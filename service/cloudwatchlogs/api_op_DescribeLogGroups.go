...
func (c *Client) DescribeLogGroups(ctx context.Context, params *DescribeLogGroupsInput, optFns ...func(*Options)) (*DescribeLogGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLogGroups", params, optFns, addOperationDescribeLogGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLogGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
