...
func (c *Client) GetQueryResults(ctx context.Context, params *GetQueryResultsInput, optFns ...func(*Options)) (*GetQueryResultsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQueryResults", params, optFns, addOperationGetQueryResultsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQueryResultsMiddleware(stack *middleware.Stack, options Options) (err error) {
