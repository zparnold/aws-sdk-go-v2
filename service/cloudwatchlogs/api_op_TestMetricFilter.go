...
func (c *Client) TestMetricFilter(ctx context.Context, params *TestMetricFilterInput, optFns ...func(*Options)) (*TestMetricFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestMetricFilter", params, optFns, addOperationTestMetricFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestMetricFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
