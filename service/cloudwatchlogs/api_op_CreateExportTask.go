...
func (c *Client) CreateExportTask(ctx context.Context, params *CreateExportTaskInput, optFns ...func(*Options)) (*CreateExportTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateExportTask", params, optFns, addOperationCreateExportTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateExportTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
