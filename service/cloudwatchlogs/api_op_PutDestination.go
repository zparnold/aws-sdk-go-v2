...
func (c *Client) PutDestination(ctx context.Context, params *PutDestinationInput, optFns ...func(*Options)) (*PutDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDestination", params, optFns, addOperationPutDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
