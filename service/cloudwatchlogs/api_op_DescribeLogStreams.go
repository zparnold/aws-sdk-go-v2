...
func (c *Client) DescribeLogStreams(ctx context.Context, params *DescribeLogStreamsInput, optFns ...func(*Options)) (*DescribeLogStreamsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLogStreams", params, optFns, addOperationDescribeLogStreamsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLogStreamsMiddleware(stack *middleware.Stack, options Options) (err error) {
