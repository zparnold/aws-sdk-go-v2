...
func (c *Client) PutSubscriptionFilter(ctx context.Context, params *PutSubscriptionFilterInput, optFns ...func(*Options)) (*PutSubscriptionFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSubscriptionFilter", params, optFns, addOperationPutSubscriptionFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSubscriptionFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
