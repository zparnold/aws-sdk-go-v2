...
func (c *Client) StartQuery(ctx context.Context, params *StartQueryInput, optFns ...func(*Options)) (*StartQueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartQuery", params, optFns, addOperationStartQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
