...
func (c *Client) AssociateKmsKey(ctx context.Context, params *AssociateKmsKeyInput, optFns ...func(*Options)) (*AssociateKmsKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateKmsKey", params, optFns, addOperationAssociateKmsKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateKmsKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
