...
func (c *Client) PutDestinationPolicy(ctx context.Context, params *PutDestinationPolicyInput, optFns ...func(*Options)) (*PutDestinationPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDestinationPolicy", params, optFns, addOperationPutDestinationPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDestinationPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
