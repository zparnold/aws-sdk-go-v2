...
func (c *Client) DescribeResourcePolicies(ctx context.Context, params *DescribeResourcePoliciesInput, optFns ...func(*Options)) (*DescribeResourcePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeResourcePolicies", params, optFns, addOperationDescribeResourcePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeResourcePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
