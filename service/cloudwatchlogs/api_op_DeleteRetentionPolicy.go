...
func (c *Client) DeleteRetentionPolicy(ctx context.Context, params *DeleteRetentionPolicyInput, optFns ...func(*Options)) (*DeleteRetentionPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRetentionPolicy", params, optFns, addOperationDeleteRetentionPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRetentionPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
