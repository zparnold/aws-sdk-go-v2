...
func (c *Client) DescribeQueryDefinitions(ctx context.Context, params *DescribeQueryDefinitionsInput, optFns ...func(*Options)) (*DescribeQueryDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeQueryDefinitions", params, optFns, addOperationDescribeQueryDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeQueryDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
