...
func (c *Client) DisassociateKmsKey(ctx context.Context, params *DisassociateKmsKeyInput, optFns ...func(*Options)) (*DisassociateKmsKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateKmsKey", params, optFns, addOperationDisassociateKmsKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateKmsKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
