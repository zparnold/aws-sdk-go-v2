...
func (c *Client) PutQueryDefinition(ctx context.Context, params *PutQueryDefinitionInput, optFns ...func(*Options)) (*PutQueryDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutQueryDefinition", params, optFns, addOperationPutQueryDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutQueryDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
