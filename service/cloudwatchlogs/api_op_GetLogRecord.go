...
func (c *Client) GetLogRecord(ctx context.Context, params *GetLogRecordInput, optFns ...func(*Options)) (*GetLogRecordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLogRecord", params, optFns, addOperationGetLogRecordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLogRecordMiddleware(stack *middleware.Stack, options Options) (err error) {
