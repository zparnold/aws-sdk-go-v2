...
func (c *Client) GetLogGroupFields(ctx context.Context, params *GetLogGroupFieldsInput, optFns ...func(*Options)) (*GetLogGroupFieldsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLogGroupFields", params, optFns, addOperationGetLogGroupFieldsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLogGroupFieldsMiddleware(stack *middleware.Stack, options Options) (err error) {
