...
func (c *Client) UntagLogGroup(ctx context.Context, params *UntagLogGroupInput, optFns ...func(*Options)) (*UntagLogGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagLogGroup", params, optFns, addOperationUntagLogGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagLogGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
