...
func (c *Client) CreateLogGroup(ctx context.Context, params *CreateLogGroupInput, optFns ...func(*Options)) (*CreateLogGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLogGroup", params, optFns, addOperationCreateLogGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLogGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
