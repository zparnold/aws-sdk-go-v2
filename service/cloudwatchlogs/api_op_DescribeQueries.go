...
func (c *Client) DescribeQueries(ctx context.Context, params *DescribeQueriesInput, optFns ...func(*Options)) (*DescribeQueriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeQueries", params, optFns, addOperationDescribeQueriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeQueriesMiddleware(stack *middleware.Stack, options Options) (err error) {
