...
func (c *Client) PutMetricFilter(ctx context.Context, params *PutMetricFilterInput, optFns ...func(*Options)) (*PutMetricFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMetricFilter", params, optFns, addOperationPutMetricFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMetricFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
