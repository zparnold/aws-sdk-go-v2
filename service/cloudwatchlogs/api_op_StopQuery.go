...
func (c *Client) StopQuery(ctx context.Context, params *StopQueryInput, optFns ...func(*Options)) (*StopQueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopQuery", params, optFns, addOperationStopQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
