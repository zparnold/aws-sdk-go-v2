...
func (c *Client) DeleteMetricFilter(ctx context.Context, params *DeleteMetricFilterInput, optFns ...func(*Options)) (*DeleteMetricFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMetricFilter", params, optFns, addOperationDeleteMetricFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMetricFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
