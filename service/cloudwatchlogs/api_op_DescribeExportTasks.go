...
func (c *Client) DescribeExportTasks(ctx context.Context, params *DescribeExportTasksInput, optFns ...func(*Options)) (*DescribeExportTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeExportTasks", params, optFns, addOperationDescribeExportTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeExportTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
