...
func (c *Client) DeleteLogGroup(ctx context.Context, params *DeleteLogGroupInput, optFns ...func(*Options)) (*DeleteLogGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLogGroup", params, optFns, addOperationDeleteLogGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLogGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
