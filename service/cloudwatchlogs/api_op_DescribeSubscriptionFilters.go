...
func (c *Client) DescribeSubscriptionFilters(ctx context.Context, params *DescribeSubscriptionFiltersInput, optFns ...func(*Options)) (*DescribeSubscriptionFiltersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSubscriptionFilters", params, optFns, addOperationDescribeSubscriptionFiltersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSubscriptionFiltersMiddleware(stack *middleware.Stack, options Options) (err error) {
