...
func (c *Client) PutRetentionPolicy(ctx context.Context, params *PutRetentionPolicyInput, optFns ...func(*Options)) (*PutRetentionPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRetentionPolicy", params, optFns, addOperationPutRetentionPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRetentionPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
