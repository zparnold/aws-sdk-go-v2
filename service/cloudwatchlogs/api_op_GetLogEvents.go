...
func (c *Client) GetLogEvents(ctx context.Context, params *GetLogEventsInput, optFns ...func(*Options)) (*GetLogEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLogEvents", params, optFns, addOperationGetLogEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLogEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
