...
func (c *Client) DeleteQueryDefinition(ctx context.Context, params *DeleteQueryDefinitionInput, optFns ...func(*Options)) (*DeleteQueryDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteQueryDefinition", params, optFns, addOperationDeleteQueryDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteQueryDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
