...
func (c *Client) DescribeMetricFilters(ctx context.Context, params *DescribeMetricFiltersInput, optFns ...func(*Options)) (*DescribeMetricFiltersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMetricFilters", params, optFns, addOperationDescribeMetricFiltersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMetricFiltersMiddleware(stack *middleware.Stack, options Options) (err error) {
