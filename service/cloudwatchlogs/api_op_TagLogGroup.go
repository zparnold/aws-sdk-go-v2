...
func (c *Client) TagLogGroup(ctx context.Context, params *TagLogGroupInput, optFns ...func(*Options)) (*TagLogGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagLogGroup", params, optFns, addOperationTagLogGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagLogGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
