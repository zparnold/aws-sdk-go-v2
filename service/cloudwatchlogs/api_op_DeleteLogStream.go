...
func (c *Client) DeleteLogStream(ctx context.Context, params *DeleteLogStreamInput, optFns ...func(*Options)) (*DeleteLogStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLogStream", params, optFns, addOperationDeleteLogStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLogStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
