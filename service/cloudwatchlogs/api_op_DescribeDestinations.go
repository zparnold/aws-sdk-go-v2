...
func (c *Client) DescribeDestinations(ctx context.Context, params *DescribeDestinationsInput, optFns ...func(*Options)) (*DescribeDestinationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDestinations", params, optFns, addOperationDescribeDestinationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDestinationsMiddleware(stack *middleware.Stack, options Options) (err error) {
