...
func (c *Client) DeleteSubscriptionFilter(ctx context.Context, params *DeleteSubscriptionFilterInput, optFns ...func(*Options)) (*DeleteSubscriptionFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSubscriptionFilter", params, optFns, addOperationDeleteSubscriptionFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSubscriptionFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
