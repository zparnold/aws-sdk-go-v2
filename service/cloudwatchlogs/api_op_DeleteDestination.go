...
func (c *Client) DeleteDestination(ctx context.Context, params *DeleteDestinationInput, optFns ...func(*Options)) (*DeleteDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDestination", params, optFns, addOperationDeleteDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
