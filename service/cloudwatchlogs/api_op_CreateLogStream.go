...
func (c *Client) CreateLogStream(ctx context.Context, params *CreateLogStreamInput, optFns ...func(*Options)) (*CreateLogStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLogStream", params, optFns, addOperationCreateLogStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLogStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
