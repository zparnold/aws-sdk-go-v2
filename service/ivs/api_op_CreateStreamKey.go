...
func (c *Client) CreateStreamKey(ctx context.Context, params *CreateStreamKeyInput, optFns ...func(*Options)) (*CreateStreamKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStreamKey", params, optFns, addOperationCreateStreamKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStreamKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
