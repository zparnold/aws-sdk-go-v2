...
func (c *Client) ListStreamKeys(ctx context.Context, params *ListStreamKeysInput, optFns ...func(*Options)) (*ListStreamKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStreamKeys", params, optFns, addOperationListStreamKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStreamKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
