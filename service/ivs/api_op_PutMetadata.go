...
func (c *Client) PutMetadata(ctx context.Context, params *PutMetadataInput, optFns ...func(*Options)) (*PutMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMetadata", params, optFns, addOperationPutMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
