...
func (c *Client) GetChannel(ctx context.Context, params *GetChannelInput, optFns ...func(*Options)) (*GetChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetChannel", params, optFns, addOperationGetChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
