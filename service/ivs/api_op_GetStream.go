...
func (c *Client) GetStream(ctx context.Context, params *GetStreamInput, optFns ...func(*Options)) (*GetStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStream", params, optFns, addOperationGetStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
