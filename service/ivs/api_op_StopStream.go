...
func (c *Client) StopStream(ctx context.Context, params *StopStreamInput, optFns ...func(*Options)) (*StopStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopStream", params, optFns, addOperationStopStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
