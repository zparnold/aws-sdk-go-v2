...
func (c *Client) BatchGetStreamKey(ctx context.Context, params *BatchGetStreamKeyInput, optFns ...func(*Options)) (*BatchGetStreamKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetStreamKey", params, optFns, addOperationBatchGetStreamKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetStreamKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
