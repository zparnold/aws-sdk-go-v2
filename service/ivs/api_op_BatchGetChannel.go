...
func (c *Client) BatchGetChannel(ctx context.Context, params *BatchGetChannelInput, optFns ...func(*Options)) (*BatchGetChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetChannel", params, optFns, addOperationBatchGetChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
