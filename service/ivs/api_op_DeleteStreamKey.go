...
func (c *Client) DeleteStreamKey(ctx context.Context, params *DeleteStreamKeyInput, optFns ...func(*Options)) (*DeleteStreamKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStreamKey", params, optFns, addOperationDeleteStreamKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStreamKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
