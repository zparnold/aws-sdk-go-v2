...
func (c *Client) UpdateComputeEnvironment(ctx context.Context, params *UpdateComputeEnvironmentInput, optFns ...func(*Options)) (*UpdateComputeEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateComputeEnvironment", params, optFns, addOperationUpdateComputeEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateComputeEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
