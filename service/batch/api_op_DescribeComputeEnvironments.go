...
func (c *Client) DescribeComputeEnvironments(ctx context.Context, params *DescribeComputeEnvironmentsInput, optFns ...func(*Options)) (*DescribeComputeEnvironmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeComputeEnvironments", params, optFns, addOperationDescribeComputeEnvironmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeComputeEnvironmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
