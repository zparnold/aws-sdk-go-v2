...
func (c *Client) DescribeJobs(ctx context.Context, params *DescribeJobsInput, optFns ...func(*Options)) (*DescribeJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeJobs", params, optFns, addOperationDescribeJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
