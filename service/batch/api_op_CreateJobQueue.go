...
func (c *Client) CreateJobQueue(ctx context.Context, params *CreateJobQueueInput, optFns ...func(*Options)) (*CreateJobQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateJobQueue", params, optFns, addOperationCreateJobQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateJobQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
