...
func (c *Client) DeregisterJobDefinition(ctx context.Context, params *DeregisterJobDefinitionInput, optFns ...func(*Options)) (*DeregisterJobDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterJobDefinition", params, optFns, addOperationDeregisterJobDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterJobDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
