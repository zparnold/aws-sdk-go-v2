...
func (c *Client) SubmitJob(ctx context.Context, params *SubmitJobInput, optFns ...func(*Options)) (*SubmitJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubmitJob", params, optFns, addOperationSubmitJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubmitJobMiddleware(stack *middleware.Stack, options Options) (err error) {
