...
func (c *Client) UpdateJobQueue(ctx context.Context, params *UpdateJobQueueInput, optFns ...func(*Options)) (*UpdateJobQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateJobQueue", params, optFns, addOperationUpdateJobQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateJobQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
