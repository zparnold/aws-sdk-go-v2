...
func (c *Client) RegisterJobDefinition(ctx context.Context, params *RegisterJobDefinitionInput, optFns ...func(*Options)) (*RegisterJobDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterJobDefinition", params, optFns, addOperationRegisterJobDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterJobDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
