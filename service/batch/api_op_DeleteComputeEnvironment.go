...
func (c *Client) DeleteComputeEnvironment(ctx context.Context, params *DeleteComputeEnvironmentInput, optFns ...func(*Options)) (*DeleteComputeEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteComputeEnvironment", params, optFns, addOperationDeleteComputeEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteComputeEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
