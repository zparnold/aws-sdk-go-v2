...
func (c *Client) DescribeJobDefinitions(ctx context.Context, params *DescribeJobDefinitionsInput, optFns ...func(*Options)) (*DescribeJobDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeJobDefinitions", params, optFns, addOperationDescribeJobDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeJobDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
