...
func (c *Client) CreateComputeEnvironment(ctx context.Context, params *CreateComputeEnvironmentInput, optFns ...func(*Options)) (*CreateComputeEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateComputeEnvironment", params, optFns, addOperationCreateComputeEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateComputeEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
