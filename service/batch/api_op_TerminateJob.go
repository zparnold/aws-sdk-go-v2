...
func (c *Client) TerminateJob(ctx context.Context, params *TerminateJobInput, optFns ...func(*Options)) (*TerminateJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateJob", params, optFns, addOperationTerminateJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateJobMiddleware(stack *middleware.Stack, options Options) (err error) {
