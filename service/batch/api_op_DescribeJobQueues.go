...
func (c *Client) DescribeJobQueues(ctx context.Context, params *DescribeJobQueuesInput, optFns ...func(*Options)) (*DescribeJobQueuesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeJobQueues", params, optFns, addOperationDescribeJobQueuesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeJobQueuesMiddleware(stack *middleware.Stack, options Options) (err error) {
