...
func (c *Client) GetAutoScalingGroupRecommendations(ctx context.Context, params *GetAutoScalingGroupRecommendationsInput, optFns ...func(*Options)) (*GetAutoScalingGroupRecommendationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAutoScalingGroupRecommendations", params, optFns, addOperationGetAutoScalingGroupRecommendationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAutoScalingGroupRecommendationsMiddleware(stack *middleware.Stack, options Options) (err error) {
