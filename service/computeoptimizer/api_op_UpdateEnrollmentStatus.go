...
func (c *Client) UpdateEnrollmentStatus(ctx context.Context, params *UpdateEnrollmentStatusInput, optFns ...func(*Options)) (*UpdateEnrollmentStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEnrollmentStatus", params, optFns, addOperationUpdateEnrollmentStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEnrollmentStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
