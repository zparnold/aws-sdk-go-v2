...
func (c *Client) GetEnrollmentStatus(ctx context.Context, params *GetEnrollmentStatusInput, optFns ...func(*Options)) (*GetEnrollmentStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEnrollmentStatus", params, optFns, addOperationGetEnrollmentStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEnrollmentStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
