...
func (c *Client) ExportEC2InstanceRecommendations(ctx context.Context, params *ExportEC2InstanceRecommendationsInput, optFns ...func(*Options)) (*ExportEC2InstanceRecommendationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportEC2InstanceRecommendations", params, optFns, addOperationExportEC2InstanceRecommendationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportEC2InstanceRecommendationsMiddleware(stack *middleware.Stack, options Options) (err error) {
