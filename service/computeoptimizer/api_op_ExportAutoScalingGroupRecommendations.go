...
func (c *Client) ExportAutoScalingGroupRecommendations(ctx context.Context, params *ExportAutoScalingGroupRecommendationsInput, optFns ...func(*Options)) (*ExportAutoScalingGroupRecommendationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportAutoScalingGroupRecommendations", params, optFns, addOperationExportAutoScalingGroupRecommendationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportAutoScalingGroupRecommendationsMiddleware(stack *middleware.Stack, options Options) (err error) {
