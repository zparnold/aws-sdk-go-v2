...
func (c *Client) GetEC2InstanceRecommendations(ctx context.Context, params *GetEC2InstanceRecommendationsInput, optFns ...func(*Options)) (*GetEC2InstanceRecommendationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEC2InstanceRecommendations", params, optFns, addOperationGetEC2InstanceRecommendationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEC2InstanceRecommendationsMiddleware(stack *middleware.Stack, options Options) (err error) {
