...
func (c *Client) DescribeRecommendationExportJobs(ctx context.Context, params *DescribeRecommendationExportJobsInput, optFns ...func(*Options)) (*DescribeRecommendationExportJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRecommendationExportJobs", params, optFns, addOperationDescribeRecommendationExportJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRecommendationExportJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
