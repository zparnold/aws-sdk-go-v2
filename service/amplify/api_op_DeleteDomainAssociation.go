...
func (c *Client) DeleteDomainAssociation(ctx context.Context, params *DeleteDomainAssociationInput, optFns ...func(*Options)) (*DeleteDomainAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDomainAssociation", params, optFns, addOperationDeleteDomainAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDomainAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
