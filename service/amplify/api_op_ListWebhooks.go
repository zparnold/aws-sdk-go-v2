...
func (c *Client) ListWebhooks(ctx context.Context, params *ListWebhooksInput, optFns ...func(*Options)) (*ListWebhooksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWebhooks", params, optFns, addOperationListWebhooksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWebhooksMiddleware(stack *middleware.Stack, options Options) (err error) {
