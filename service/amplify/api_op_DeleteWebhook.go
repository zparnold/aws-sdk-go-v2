...
func (c *Client) DeleteWebhook(ctx context.Context, params *DeleteWebhookInput, optFns ...func(*Options)) (*DeleteWebhookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWebhook", params, optFns, addOperationDeleteWebhookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWebhookMiddleware(stack *middleware.Stack, options Options) (err error) {
