...
func (c *Client) StartDeployment(ctx context.Context, params *StartDeploymentInput, optFns ...func(*Options)) (*StartDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDeployment", params, optFns, addOperationStartDeploymentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDeploymentMiddleware(stack *middleware.Stack, options Options) (err error) {
