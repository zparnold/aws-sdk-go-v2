...
func (c *Client) GetDomainAssociation(ctx context.Context, params *GetDomainAssociationInput, optFns ...func(*Options)) (*GetDomainAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainAssociation", params, optFns, addOperationGetDomainAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
