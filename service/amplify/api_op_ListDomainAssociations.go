...
func (c *Client) ListDomainAssociations(ctx context.Context, params *ListDomainAssociationsInput, optFns ...func(*Options)) (*ListDomainAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDomainAssociations", params, optFns, addOperationListDomainAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDomainAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
