...
func (c *Client) ListArtifacts(ctx context.Context, params *ListArtifactsInput, optFns ...func(*Options)) (*ListArtifactsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListArtifacts", params, optFns, addOperationListArtifactsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListArtifactsMiddleware(stack *middleware.Stack, options Options) (err error) {
