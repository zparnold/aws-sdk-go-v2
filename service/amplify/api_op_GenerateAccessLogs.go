...
func (c *Client) GenerateAccessLogs(ctx context.Context, params *GenerateAccessLogsInput, optFns ...func(*Options)) (*GenerateAccessLogsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateAccessLogs", params, optFns, addOperationGenerateAccessLogsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateAccessLogsMiddleware(stack *middleware.Stack, options Options) (err error) {
