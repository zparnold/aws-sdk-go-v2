...
func (c *Client) UpdateDomainAssociation(ctx context.Context, params *UpdateDomainAssociationInput, optFns ...func(*Options)) (*UpdateDomainAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomainAssociation", params, optFns, addOperationUpdateDomainAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
