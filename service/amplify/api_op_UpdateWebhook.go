...
func (c *Client) UpdateWebhook(ctx context.Context, params *UpdateWebhookInput, optFns ...func(*Options)) (*UpdateWebhookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateWebhook", params, optFns, addOperationUpdateWebhookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateWebhookMiddleware(stack *middleware.Stack, options Options) (err error) {
