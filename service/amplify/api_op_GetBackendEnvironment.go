...
func (c *Client) GetBackendEnvironment(ctx context.Context, params *GetBackendEnvironmentInput, optFns ...func(*Options)) (*GetBackendEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBackendEnvironment", params, optFns, addOperationGetBackendEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBackendEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
