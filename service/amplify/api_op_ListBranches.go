...
func (c *Client) ListBranches(ctx context.Context, params *ListBranchesInput, optFns ...func(*Options)) (*ListBranchesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBranches", params, optFns, addOperationListBranchesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBranchesMiddleware(stack *middleware.Stack, options Options) (err error) {
