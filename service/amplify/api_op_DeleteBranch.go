...
func (c *Client) DeleteBranch(ctx context.Context, params *DeleteBranchInput, optFns ...func(*Options)) (*DeleteBranchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBranch", params, optFns, addOperationDeleteBranchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBranchMiddleware(stack *middleware.Stack, options Options) (err error) {
