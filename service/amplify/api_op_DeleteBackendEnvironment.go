...
func (c *Client) DeleteBackendEnvironment(ctx context.Context, params *DeleteBackendEnvironmentInput, optFns ...func(*Options)) (*DeleteBackendEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBackendEnvironment", params, optFns, addOperationDeleteBackendEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBackendEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
