...
func (c *Client) GetApp(ctx context.Context, params *GetAppInput, optFns ...func(*Options)) (*GetAppOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApp", params, optFns, addOperationGetAppMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAppMiddleware(stack *middleware.Stack, options Options) (err error) {
