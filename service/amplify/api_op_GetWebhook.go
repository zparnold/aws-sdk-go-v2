...
func (c *Client) GetWebhook(ctx context.Context, params *GetWebhookInput, optFns ...func(*Options)) (*GetWebhookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWebhook", params, optFns, addOperationGetWebhookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWebhookMiddleware(stack *middleware.Stack, options Options) (err error) {
