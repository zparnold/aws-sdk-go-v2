...
func (c *Client) DeleteJob(ctx context.Context, params *DeleteJobInput, optFns ...func(*Options)) (*DeleteJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteJob", params, optFns, addOperationDeleteJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteJobMiddleware(stack *middleware.Stack, options Options) (err error) {
