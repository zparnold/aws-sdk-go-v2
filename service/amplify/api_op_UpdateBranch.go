...
func (c *Client) UpdateBranch(ctx context.Context, params *UpdateBranchInput, optFns ...func(*Options)) (*UpdateBranchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBranch", params, optFns, addOperationUpdateBranchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBranchMiddleware(stack *middleware.Stack, options Options) (err error) {
