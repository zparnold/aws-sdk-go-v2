...
func (c *Client) ListBackendEnvironments(ctx context.Context, params *ListBackendEnvironmentsInput, optFns ...func(*Options)) (*ListBackendEnvironmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBackendEnvironments", params, optFns, addOperationListBackendEnvironmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBackendEnvironmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
