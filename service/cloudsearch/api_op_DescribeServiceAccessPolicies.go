...
func (c *Client) DescribeServiceAccessPolicies(ctx context.Context, params *DescribeServiceAccessPoliciesInput, optFns ...func(*Options)) (*DescribeServiceAccessPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeServiceAccessPolicies", params, optFns, addOperationDescribeServiceAccessPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeServiceAccessPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
