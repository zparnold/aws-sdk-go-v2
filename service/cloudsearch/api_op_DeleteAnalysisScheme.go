...
func (c *Client) DeleteAnalysisScheme(ctx context.Context, params *DeleteAnalysisSchemeInput, optFns ...func(*Options)) (*DeleteAnalysisSchemeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAnalysisScheme", params, optFns, addOperationDeleteAnalysisSchemeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAnalysisSchemeMiddleware(stack *middleware.Stack, options Options) (err error) {
