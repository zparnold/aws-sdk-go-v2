...
func (c *Client) DeleteExpression(ctx context.Context, params *DeleteExpressionInput, optFns ...func(*Options)) (*DeleteExpressionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteExpression", params, optFns, addOperationDeleteExpressionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteExpressionMiddleware(stack *middleware.Stack, options Options) (err error) {
