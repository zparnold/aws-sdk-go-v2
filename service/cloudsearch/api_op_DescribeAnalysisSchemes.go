...
func (c *Client) DescribeAnalysisSchemes(ctx context.Context, params *DescribeAnalysisSchemesInput, optFns ...func(*Options)) (*DescribeAnalysisSchemesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAnalysisSchemes", params, optFns, addOperationDescribeAnalysisSchemesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAnalysisSchemesMiddleware(stack *middleware.Stack, options Options) (err error) {
