...
func (c *Client) DefineExpression(ctx context.Context, params *DefineExpressionInput, optFns ...func(*Options)) (*DefineExpressionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DefineExpression", params, optFns, addOperationDefineExpressionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDefineExpressionMiddleware(stack *middleware.Stack, options Options) (err error) {
