...
func (c *Client) UpdateAvailabilityOptions(ctx context.Context, params *UpdateAvailabilityOptionsInput, optFns ...func(*Options)) (*UpdateAvailabilityOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAvailabilityOptions", params, optFns, addOperationUpdateAvailabilityOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAvailabilityOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
