...
func (c *Client) DeleteSuggester(ctx context.Context, params *DeleteSuggesterInput, optFns ...func(*Options)) (*DeleteSuggesterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSuggester", params, optFns, addOperationDeleteSuggesterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSuggesterMiddleware(stack *middleware.Stack, options Options) (err error) {
