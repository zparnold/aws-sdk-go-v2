...
func (c *Client) IndexDocuments(ctx context.Context, params *IndexDocumentsInput, optFns ...func(*Options)) (*IndexDocumentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IndexDocuments", params, optFns, addOperationIndexDocumentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIndexDocumentsMiddleware(stack *middleware.Stack, options Options) (err error) {
