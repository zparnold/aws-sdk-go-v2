...
func (c *Client) DefineSuggester(ctx context.Context, params *DefineSuggesterInput, optFns ...func(*Options)) (*DefineSuggesterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DefineSuggester", params, optFns, addOperationDefineSuggesterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDefineSuggesterMiddleware(stack *middleware.Stack, options Options) (err error) {
