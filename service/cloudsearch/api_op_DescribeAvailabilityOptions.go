...
func (c *Client) DescribeAvailabilityOptions(ctx context.Context, params *DescribeAvailabilityOptionsInput, optFns ...func(*Options)) (*DescribeAvailabilityOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAvailabilityOptions", params, optFns, addOperationDescribeAvailabilityOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAvailabilityOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
