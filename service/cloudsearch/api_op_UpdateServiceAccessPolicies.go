...
func (c *Client) UpdateServiceAccessPolicies(ctx context.Context, params *UpdateServiceAccessPoliciesInput, optFns ...func(*Options)) (*UpdateServiceAccessPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServiceAccessPolicies", params, optFns, addOperationUpdateServiceAccessPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServiceAccessPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
