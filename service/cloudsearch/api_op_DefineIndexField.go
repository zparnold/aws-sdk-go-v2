...
func (c *Client) DefineIndexField(ctx context.Context, params *DefineIndexFieldInput, optFns ...func(*Options)) (*DefineIndexFieldOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DefineIndexField", params, optFns, addOperationDefineIndexFieldMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDefineIndexFieldMiddleware(stack *middleware.Stack, options Options) (err error) {
