...
func (c *Client) UpdateDomainEndpointOptions(ctx context.Context, params *UpdateDomainEndpointOptionsInput, optFns ...func(*Options)) (*UpdateDomainEndpointOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomainEndpointOptions", params, optFns, addOperationUpdateDomainEndpointOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainEndpointOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
