...
func (c *Client) BuildSuggesters(ctx context.Context, params *BuildSuggestersInput, optFns ...func(*Options)) (*BuildSuggestersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BuildSuggesters", params, optFns, addOperationBuildSuggestersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBuildSuggestersMiddleware(stack *middleware.Stack, options Options) (err error) {
