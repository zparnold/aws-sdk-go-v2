...
func (c *Client) DescribeSuggesters(ctx context.Context, params *DescribeSuggestersInput, optFns ...func(*Options)) (*DescribeSuggestersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSuggesters", params, optFns, addOperationDescribeSuggestersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSuggestersMiddleware(stack *middleware.Stack, options Options) (err error) {
