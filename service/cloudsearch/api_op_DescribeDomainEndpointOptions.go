...
func (c *Client) DescribeDomainEndpointOptions(ctx context.Context, params *DescribeDomainEndpointOptionsInput, optFns ...func(*Options)) (*DescribeDomainEndpointOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDomainEndpointOptions", params, optFns, addOperationDescribeDomainEndpointOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDomainEndpointOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
