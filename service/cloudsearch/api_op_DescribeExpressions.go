...
func (c *Client) DescribeExpressions(ctx context.Context, params *DescribeExpressionsInput, optFns ...func(*Options)) (*DescribeExpressionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeExpressions", params, optFns, addOperationDescribeExpressionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeExpressionsMiddleware(stack *middleware.Stack, options Options) (err error) {
