...
func (c *Client) DeleteIndexField(ctx context.Context, params *DeleteIndexFieldInput, optFns ...func(*Options)) (*DeleteIndexFieldOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIndexField", params, optFns, addOperationDeleteIndexFieldMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIndexFieldMiddleware(stack *middleware.Stack, options Options) (err error) {
