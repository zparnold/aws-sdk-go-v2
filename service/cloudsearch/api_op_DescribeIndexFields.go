...
func (c *Client) DescribeIndexFields(ctx context.Context, params *DescribeIndexFieldsInput, optFns ...func(*Options)) (*DescribeIndexFieldsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIndexFields", params, optFns, addOperationDescribeIndexFieldsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIndexFieldsMiddleware(stack *middleware.Stack, options Options) (err error) {
