...
func (c *Client) DefineAnalysisScheme(ctx context.Context, params *DefineAnalysisSchemeInput, optFns ...func(*Options)) (*DefineAnalysisSchemeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DefineAnalysisScheme", params, optFns, addOperationDefineAnalysisSchemeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDefineAnalysisSchemeMiddleware(stack *middleware.Stack, options Options) (err error) {
