...
func (c *Client) DescribeDomains(ctx context.Context, params *DescribeDomainsInput, optFns ...func(*Options)) (*DescribeDomainsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDomains", params, optFns, addOperationDescribeDomainsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDomainsMiddleware(stack *middleware.Stack, options Options) (err error) {
