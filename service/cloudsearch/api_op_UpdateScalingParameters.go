...
func (c *Client) UpdateScalingParameters(ctx context.Context, params *UpdateScalingParametersInput, optFns ...func(*Options)) (*UpdateScalingParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateScalingParameters", params, optFns, addOperationUpdateScalingParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateScalingParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
