...
func (c *Client) DetectFaces(ctx context.Context, params *DetectFacesInput, optFns ...func(*Options)) (*DetectFacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectFaces", params, optFns, addOperationDetectFacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectFacesMiddleware(stack *middleware.Stack, options Options) (err error) {
