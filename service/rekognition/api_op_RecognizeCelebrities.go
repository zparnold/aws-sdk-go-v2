...
func (c *Client) RecognizeCelebrities(ctx context.Context, params *RecognizeCelebritiesInput, optFns ...func(*Options)) (*RecognizeCelebritiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RecognizeCelebrities", params, optFns, addOperationRecognizeCelebritiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRecognizeCelebritiesMiddleware(stack *middleware.Stack, options Options) (err error) {
