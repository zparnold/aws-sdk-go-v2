...
func (c *Client) StartContentModeration(ctx context.Context, params *StartContentModerationInput, optFns ...func(*Options)) (*StartContentModerationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartContentModeration", params, optFns, addOperationStartContentModerationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartContentModerationMiddleware(stack *middleware.Stack, options Options) (err error) {
