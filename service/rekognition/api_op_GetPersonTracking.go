...
func (c *Client) GetPersonTracking(ctx context.Context, params *GetPersonTrackingInput, optFns ...func(*Options)) (*GetPersonTrackingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPersonTracking", params, optFns, addOperationGetPersonTrackingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPersonTrackingMiddleware(stack *middleware.Stack, options Options) (err error) {
