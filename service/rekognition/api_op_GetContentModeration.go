...
func (c *Client) GetContentModeration(ctx context.Context, params *GetContentModerationInput, optFns ...func(*Options)) (*GetContentModerationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetContentModeration", params, optFns, addOperationGetContentModerationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetContentModerationMiddleware(stack *middleware.Stack, options Options) (err error) {
