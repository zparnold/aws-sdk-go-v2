...
func (c *Client) StartTextDetection(ctx context.Context, params *StartTextDetectionInput, optFns ...func(*Options)) (*StartTextDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartTextDetection", params, optFns, addOperationStartTextDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartTextDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
