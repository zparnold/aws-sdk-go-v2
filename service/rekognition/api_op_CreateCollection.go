...
func (c *Client) CreateCollection(ctx context.Context, params *CreateCollectionInput, optFns ...func(*Options)) (*CreateCollectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCollection", params, optFns, addOperationCreateCollectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCollectionMiddleware(stack *middleware.Stack, options Options) (err error) {
