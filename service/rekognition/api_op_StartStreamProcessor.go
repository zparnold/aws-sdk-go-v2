...
func (c *Client) StartStreamProcessor(ctx context.Context, params *StartStreamProcessorInput, optFns ...func(*Options)) (*StartStreamProcessorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartStreamProcessor", params, optFns, addOperationStartStreamProcessorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartStreamProcessorMiddleware(stack *middleware.Stack, options Options) (err error) {
