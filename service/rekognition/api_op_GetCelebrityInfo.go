...
func (c *Client) GetCelebrityInfo(ctx context.Context, params *GetCelebrityInfoInput, optFns ...func(*Options)) (*GetCelebrityInfoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCelebrityInfo", params, optFns, addOperationGetCelebrityInfoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCelebrityInfoMiddleware(stack *middleware.Stack, options Options) (err error) {
