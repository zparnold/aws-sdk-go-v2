...
func (c *Client) CreateStreamProcessor(ctx context.Context, params *CreateStreamProcessorInput, optFns ...func(*Options)) (*CreateStreamProcessorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStreamProcessor", params, optFns, addOperationCreateStreamProcessorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStreamProcessorMiddleware(stack *middleware.Stack, options Options) (err error) {
