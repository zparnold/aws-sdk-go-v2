...
func (c *Client) SearchFacesByImage(ctx context.Context, params *SearchFacesByImageInput, optFns ...func(*Options)) (*SearchFacesByImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchFacesByImage", params, optFns, addOperationSearchFacesByImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchFacesByImageMiddleware(stack *middleware.Stack, options Options) (err error) {
