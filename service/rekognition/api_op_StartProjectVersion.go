...
func (c *Client) StartProjectVersion(ctx context.Context, params *StartProjectVersionInput, optFns ...func(*Options)) (*StartProjectVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartProjectVersion", params, optFns, addOperationStartProjectVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartProjectVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
