...
func (c *Client) CreateProject(ctx context.Context, params *CreateProjectInput, optFns ...func(*Options)) (*CreateProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProject", params, optFns, addOperationCreateProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
