...
func (c *Client) ListStreamProcessors(ctx context.Context, params *ListStreamProcessorsInput, optFns ...func(*Options)) (*ListStreamProcessorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStreamProcessors", params, optFns, addOperationListStreamProcessorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStreamProcessorsMiddleware(stack *middleware.Stack, options Options) (err error) {
