...
func (c *Client) ListFaces(ctx context.Context, params *ListFacesInput, optFns ...func(*Options)) (*ListFacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFaces", params, optFns, addOperationListFacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFacesMiddleware(stack *middleware.Stack, options Options) (err error) {
