...
func (c *Client) StartLabelDetection(ctx context.Context, params *StartLabelDetectionInput, optFns ...func(*Options)) (*StartLabelDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartLabelDetection", params, optFns, addOperationStartLabelDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartLabelDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
