...
func (c *Client) StartFaceSearch(ctx context.Context, params *StartFaceSearchInput, optFns ...func(*Options)) (*StartFaceSearchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartFaceSearch", params, optFns, addOperationStartFaceSearchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartFaceSearchMiddleware(stack *middleware.Stack, options Options) (err error) {
