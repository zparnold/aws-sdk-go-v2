...
func (c *Client) GetTextDetection(ctx context.Context, params *GetTextDetectionInput, optFns ...func(*Options)) (*GetTextDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTextDetection", params, optFns, addOperationGetTextDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTextDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
