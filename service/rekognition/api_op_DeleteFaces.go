...
func (c *Client) DeleteFaces(ctx context.Context, params *DeleteFacesInput, optFns ...func(*Options)) (*DeleteFacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFaces", params, optFns, addOperationDeleteFacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFacesMiddleware(stack *middleware.Stack, options Options) (err error) {
