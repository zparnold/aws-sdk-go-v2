...
func (c *Client) CompareFaces(ctx context.Context, params *CompareFacesInput, optFns ...func(*Options)) (*CompareFacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CompareFaces", params, optFns, addOperationCompareFacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCompareFacesMiddleware(stack *middleware.Stack, options Options) (err error) {
