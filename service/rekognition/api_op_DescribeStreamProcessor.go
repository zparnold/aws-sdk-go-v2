...
func (c *Client) DescribeStreamProcessor(ctx context.Context, params *DescribeStreamProcessorInput, optFns ...func(*Options)) (*DescribeStreamProcessorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStreamProcessor", params, optFns, addOperationDescribeStreamProcessorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStreamProcessorMiddleware(stack *middleware.Stack, options Options) (err error) {
