...
func (c *Client) IndexFaces(ctx context.Context, params *IndexFacesInput, optFns ...func(*Options)) (*IndexFacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IndexFaces", params, optFns, addOperationIndexFacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIndexFacesMiddleware(stack *middleware.Stack, options Options) (err error) {
