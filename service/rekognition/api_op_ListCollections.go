...
func (c *Client) ListCollections(ctx context.Context, params *ListCollectionsInput, optFns ...func(*Options)) (*ListCollectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCollections", params, optFns, addOperationListCollectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCollectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
