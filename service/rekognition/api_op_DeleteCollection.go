...
func (c *Client) DeleteCollection(ctx context.Context, params *DeleteCollectionInput, optFns ...func(*Options)) (*DeleteCollectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCollection", params, optFns, addOperationDeleteCollectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCollectionMiddleware(stack *middleware.Stack, options Options) (err error) {
