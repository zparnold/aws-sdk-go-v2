...
func (c *Client) StopStreamProcessor(ctx context.Context, params *StopStreamProcessorInput, optFns ...func(*Options)) (*StopStreamProcessorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopStreamProcessor", params, optFns, addOperationStopStreamProcessorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopStreamProcessorMiddleware(stack *middleware.Stack, options Options) (err error) {
