...
func (c *Client) DescribeProjects(ctx context.Context, params *DescribeProjectsInput, optFns ...func(*Options)) (*DescribeProjectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProjects", params, optFns, addOperationDescribeProjectsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProjectsMiddleware(stack *middleware.Stack, options Options) (err error) {
