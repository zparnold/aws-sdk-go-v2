...
func (c *Client) GetCelebrityRecognition(ctx context.Context, params *GetCelebrityRecognitionInput, optFns ...func(*Options)) (*GetCelebrityRecognitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCelebrityRecognition", params, optFns, addOperationGetCelebrityRecognitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCelebrityRecognitionMiddleware(stack *middleware.Stack, options Options) (err error) {
