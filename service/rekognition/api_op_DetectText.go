...
func (c *Client) DetectText(ctx context.Context, params *DetectTextInput, optFns ...func(*Options)) (*DetectTextOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectText", params, optFns, addOperationDetectTextMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectTextMiddleware(stack *middleware.Stack, options Options) (err error) {
