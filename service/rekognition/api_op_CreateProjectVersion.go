...
func (c *Client) CreateProjectVersion(ctx context.Context, params *CreateProjectVersionInput, optFns ...func(*Options)) (*CreateProjectVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProjectVersion", params, optFns, addOperationCreateProjectVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProjectVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
