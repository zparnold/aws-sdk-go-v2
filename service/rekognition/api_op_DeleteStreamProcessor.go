...
func (c *Client) DeleteStreamProcessor(ctx context.Context, params *DeleteStreamProcessorInput, optFns ...func(*Options)) (*DeleteStreamProcessorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStreamProcessor", params, optFns, addOperationDeleteStreamProcessorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStreamProcessorMiddleware(stack *middleware.Stack, options Options) (err error) {
