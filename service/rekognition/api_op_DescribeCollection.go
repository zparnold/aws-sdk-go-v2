...
func (c *Client) DescribeCollection(ctx context.Context, params *DescribeCollectionInput, optFns ...func(*Options)) (*DescribeCollectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCollection", params, optFns, addOperationDescribeCollectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCollectionMiddleware(stack *middleware.Stack, options Options) (err error) {
