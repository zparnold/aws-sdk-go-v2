...
func (c *Client) DetectLabels(ctx context.Context, params *DetectLabelsInput, optFns ...func(*Options)) (*DetectLabelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectLabels", params, optFns, addOperationDetectLabelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectLabelsMiddleware(stack *middleware.Stack, options Options) (err error) {
