...
func (c *Client) StartSegmentDetection(ctx context.Context, params *StartSegmentDetectionInput, optFns ...func(*Options)) (*StartSegmentDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSegmentDetection", params, optFns, addOperationStartSegmentDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSegmentDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
