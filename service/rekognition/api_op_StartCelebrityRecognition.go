...
func (c *Client) StartCelebrityRecognition(ctx context.Context, params *StartCelebrityRecognitionInput, optFns ...func(*Options)) (*StartCelebrityRecognitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartCelebrityRecognition", params, optFns, addOperationStartCelebrityRecognitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartCelebrityRecognitionMiddleware(stack *middleware.Stack, options Options) (err error) {
