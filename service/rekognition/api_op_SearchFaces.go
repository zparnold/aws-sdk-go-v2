...
func (c *Client) SearchFaces(ctx context.Context, params *SearchFacesInput, optFns ...func(*Options)) (*SearchFacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchFaces", params, optFns, addOperationSearchFacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchFacesMiddleware(stack *middleware.Stack, options Options) (err error) {
