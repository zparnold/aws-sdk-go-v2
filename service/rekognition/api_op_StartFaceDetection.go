...
func (c *Client) StartFaceDetection(ctx context.Context, params *StartFaceDetectionInput, optFns ...func(*Options)) (*StartFaceDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartFaceDetection", params, optFns, addOperationStartFaceDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartFaceDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
