...
func (c *Client) StartPersonTracking(ctx context.Context, params *StartPersonTrackingInput, optFns ...func(*Options)) (*StartPersonTrackingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartPersonTracking", params, optFns, addOperationStartPersonTrackingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartPersonTrackingMiddleware(stack *middleware.Stack, options Options) (err error) {
