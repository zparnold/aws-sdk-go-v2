...
func (c *Client) DeleteProjectVersion(ctx context.Context, params *DeleteProjectVersionInput, optFns ...func(*Options)) (*DeleteProjectVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProjectVersion", params, optFns, addOperationDeleteProjectVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProjectVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
