...
func (c *Client) GetLabelDetection(ctx context.Context, params *GetLabelDetectionInput, optFns ...func(*Options)) (*GetLabelDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLabelDetection", params, optFns, addOperationGetLabelDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLabelDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
