...
func (c *Client) GetSegmentDetection(ctx context.Context, params *GetSegmentDetectionInput, optFns ...func(*Options)) (*GetSegmentDetectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSegmentDetection", params, optFns, addOperationGetSegmentDetectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSegmentDetectionMiddleware(stack *middleware.Stack, options Options) (err error) {
