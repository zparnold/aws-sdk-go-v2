...
func (c *Client) GetMediaForFragmentList(ctx context.Context, params *GetMediaForFragmentListInput, optFns ...func(*Options)) (*GetMediaForFragmentListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMediaForFragmentList", params, optFns, addOperationGetMediaForFragmentListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMediaForFragmentListMiddleware(stack *middleware.Stack, options Options) (err error) {
