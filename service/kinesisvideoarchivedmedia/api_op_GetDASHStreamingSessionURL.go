...
func (c *Client) GetDASHStreamingSessionURL(ctx context.Context, params *GetDASHStreamingSessionURLInput, optFns ...func(*Options)) (*GetDASHStreamingSessionURLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDASHStreamingSessionURL", params, optFns, addOperationGetDASHStreamingSessionURLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDASHStreamingSessionURLMiddleware(stack *middleware.Stack, options Options) (err error) {
