...
func (c *Client) GetClip(ctx context.Context, params *GetClipInput, optFns ...func(*Options)) (*GetClipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetClip", params, optFns, addOperationGetClipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetClipMiddleware(stack *middleware.Stack, options Options) (err error) {
