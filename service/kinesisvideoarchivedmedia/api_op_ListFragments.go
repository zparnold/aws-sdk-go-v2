...
func (c *Client) ListFragments(ctx context.Context, params *ListFragmentsInput, optFns ...func(*Options)) (*ListFragmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFragments", params, optFns, addOperationListFragmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFragmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
