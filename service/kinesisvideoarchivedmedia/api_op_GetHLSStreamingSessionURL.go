...
func (c *Client) GetHLSStreamingSessionURL(ctx context.Context, params *GetHLSStreamingSessionURLInput, optFns ...func(*Options)) (*GetHLSStreamingSessionURLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHLSStreamingSessionURL", params, optFns, addOperationGetHLSStreamingSessionURLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHLSStreamingSessionURLMiddleware(stack *middleware.Stack, options Options) (err error) {
