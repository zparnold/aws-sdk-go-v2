...
func (c *Client) RestoreBackup(ctx context.Context, params *RestoreBackupInput, optFns ...func(*Options)) (*RestoreBackupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreBackup", params, optFns, addOperationRestoreBackupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreBackupMiddleware(stack *middleware.Stack, options Options) (err error) {
