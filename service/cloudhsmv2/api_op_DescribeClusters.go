...
func (c *Client) DescribeClusters(ctx context.Context, params *DescribeClustersInput, optFns ...func(*Options)) (*DescribeClustersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClusters", params, optFns, addOperationDescribeClustersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClustersMiddleware(stack *middleware.Stack, options Options) (err error) {
