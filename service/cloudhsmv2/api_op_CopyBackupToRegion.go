...
func (c *Client) CopyBackupToRegion(ctx context.Context, params *CopyBackupToRegionInput, optFns ...func(*Options)) (*CopyBackupToRegionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyBackupToRegion", params, optFns, addOperationCopyBackupToRegionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyBackupToRegionMiddleware(stack *middleware.Stack, options Options) (err error) {
