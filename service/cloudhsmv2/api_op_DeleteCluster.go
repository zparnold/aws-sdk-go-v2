...
func (c *Client) DeleteCluster(ctx context.Context, params *DeleteClusterInput, optFns ...func(*Options)) (*DeleteClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCluster", params, optFns, addOperationDeleteClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
