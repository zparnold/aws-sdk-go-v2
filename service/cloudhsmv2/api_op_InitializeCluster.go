...
func (c *Client) InitializeCluster(ctx context.Context, params *InitializeClusterInput, optFns ...func(*Options)) (*InitializeClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InitializeCluster", params, optFns, addOperationInitializeClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInitializeClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
