...
func (c *Client) AcceptResourceShareInvitation(ctx context.Context, params *AcceptResourceShareInvitationInput, optFns ...func(*Options)) (*AcceptResourceShareInvitationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptResourceShareInvitation", params, optFns, addOperationAcceptResourceShareInvitationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptResourceShareInvitationMiddleware(stack *middleware.Stack, options Options) (err error) {
