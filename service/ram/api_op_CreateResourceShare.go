...
func (c *Client) CreateResourceShare(ctx context.Context, params *CreateResourceShareInput, optFns ...func(*Options)) (*CreateResourceShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResourceShare", params, optFns, addOperationCreateResourceShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResourceShareMiddleware(stack *middleware.Stack, options Options) (err error) {
