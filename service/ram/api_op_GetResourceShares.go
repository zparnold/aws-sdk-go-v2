...
func (c *Client) GetResourceShares(ctx context.Context, params *GetResourceSharesInput, optFns ...func(*Options)) (*GetResourceSharesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResourceShares", params, optFns, addOperationGetResourceSharesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourceSharesMiddleware(stack *middleware.Stack, options Options) (err error) {
