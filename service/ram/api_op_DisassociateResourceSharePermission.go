...
func (c *Client) DisassociateResourceSharePermission(ctx context.Context, params *DisassociateResourceSharePermissionInput, optFns ...func(*Options)) (*DisassociateResourceSharePermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateResourceSharePermission", params, optFns, addOperationDisassociateResourceSharePermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateResourceSharePermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
