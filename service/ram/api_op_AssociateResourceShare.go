...
func (c *Client) AssociateResourceShare(ctx context.Context, params *AssociateResourceShareInput, optFns ...func(*Options)) (*AssociateResourceShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateResourceShare", params, optFns, addOperationAssociateResourceShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateResourceShareMiddleware(stack *middleware.Stack, options Options) (err error) {
