...
func (c *Client) EnableSharingWithAwsOrganization(ctx context.Context, params *EnableSharingWithAwsOrganizationInput, optFns ...func(*Options)) (*EnableSharingWithAwsOrganizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableSharingWithAwsOrganization", params, optFns, addOperationEnableSharingWithAwsOrganizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableSharingWithAwsOrganizationMiddleware(stack *middleware.Stack, options Options) (err error) {
