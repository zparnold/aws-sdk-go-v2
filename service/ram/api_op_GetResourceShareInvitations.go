...
func (c *Client) GetResourceShareInvitations(ctx context.Context, params *GetResourceShareInvitationsInput, optFns ...func(*Options)) (*GetResourceShareInvitationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResourceShareInvitations", params, optFns, addOperationGetResourceShareInvitationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourceShareInvitationsMiddleware(stack *middleware.Stack, options Options) (err error) {
