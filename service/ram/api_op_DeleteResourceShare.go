...
func (c *Client) DeleteResourceShare(ctx context.Context, params *DeleteResourceShareInput, optFns ...func(*Options)) (*DeleteResourceShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResourceShare", params, optFns, addOperationDeleteResourceShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResourceShareMiddleware(stack *middleware.Stack, options Options) (err error) {
