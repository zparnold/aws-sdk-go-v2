...
func (c *Client) UpdateResourceShare(ctx context.Context, params *UpdateResourceShareInput, optFns ...func(*Options)) (*UpdateResourceShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResourceShare", params, optFns, addOperationUpdateResourceShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResourceShareMiddleware(stack *middleware.Stack, options Options) (err error) {
