...
func (c *Client) ListPendingInvitationResources(ctx context.Context, params *ListPendingInvitationResourcesInput, optFns ...func(*Options)) (*ListPendingInvitationResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPendingInvitationResources", params, optFns, addOperationListPendingInvitationResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPendingInvitationResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
