...
func (c *Client) GetPermission(ctx context.Context, params *GetPermissionInput, optFns ...func(*Options)) (*GetPermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPermission", params, optFns, addOperationGetPermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
