...
func (c *Client) ListResourceTypes(ctx context.Context, params *ListResourceTypesInput, optFns ...func(*Options)) (*ListResourceTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceTypes", params, optFns, addOperationListResourceTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
