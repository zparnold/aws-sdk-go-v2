...
func (c *Client) PromoteResourceShareCreatedFromPolicy(ctx context.Context, params *PromoteResourceShareCreatedFromPolicyInput, optFns ...func(*Options)) (*PromoteResourceShareCreatedFromPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PromoteResourceShareCreatedFromPolicy", params, optFns, addOperationPromoteResourceShareCreatedFromPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPromoteResourceShareCreatedFromPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
