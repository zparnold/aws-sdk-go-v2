...
func (c *Client) ListPrincipals(ctx context.Context, params *ListPrincipalsInput, optFns ...func(*Options)) (*ListPrincipalsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPrincipals", params, optFns, addOperationListPrincipalsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPrincipalsMiddleware(stack *middleware.Stack, options Options) (err error) {
