...
func (c *Client) GetResourceShareAssociations(ctx context.Context, params *GetResourceShareAssociationsInput, optFns ...func(*Options)) (*GetResourceShareAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResourceShareAssociations", params, optFns, addOperationGetResourceShareAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourceShareAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
