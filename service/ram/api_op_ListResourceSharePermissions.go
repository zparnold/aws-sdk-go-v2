...
func (c *Client) ListResourceSharePermissions(ctx context.Context, params *ListResourceSharePermissionsInput, optFns ...func(*Options)) (*ListResourceSharePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceSharePermissions", params, optFns, addOperationListResourceSharePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceSharePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
