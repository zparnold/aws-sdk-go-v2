...
func (c *Client) RejectResourceShareInvitation(ctx context.Context, params *RejectResourceShareInvitationInput, optFns ...func(*Options)) (*RejectResourceShareInvitationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectResourceShareInvitation", params, optFns, addOperationRejectResourceShareInvitationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectResourceShareInvitationMiddleware(stack *middleware.Stack, options Options) (err error) {
