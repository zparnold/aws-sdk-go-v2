...
func (c *Client) DisassociateResourceShare(ctx context.Context, params *DisassociateResourceShareInput, optFns ...func(*Options)) (*DisassociateResourceShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateResourceShare", params, optFns, addOperationDisassociateResourceShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateResourceShareMiddleware(stack *middleware.Stack, options Options) (err error) {
