...
func (c *Client) AttachRolePolicy(ctx context.Context, params *AttachRolePolicyInput, optFns ...func(*Options)) (*AttachRolePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachRolePolicy", params, optFns, addOperationAttachRolePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachRolePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
