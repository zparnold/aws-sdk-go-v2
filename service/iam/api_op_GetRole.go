...
func (c *Client) GetRole(ctx context.Context, params *GetRoleInput, optFns ...func(*Options)) (*GetRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRole", params, optFns, addOperationGetRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
