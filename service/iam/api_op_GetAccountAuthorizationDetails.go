...
func (c *Client) GetAccountAuthorizationDetails(ctx context.Context, params *GetAccountAuthorizationDetailsInput, optFns ...func(*Options)) (*GetAccountAuthorizationDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccountAuthorizationDetails", params, optFns, addOperationGetAccountAuthorizationDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccountAuthorizationDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
