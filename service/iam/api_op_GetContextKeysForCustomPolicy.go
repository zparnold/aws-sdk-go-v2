...
func (c *Client) GetContextKeysForCustomPolicy(ctx context.Context, params *GetContextKeysForCustomPolicyInput, optFns ...func(*Options)) (*GetContextKeysForCustomPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetContextKeysForCustomPolicy", params, optFns, addOperationGetContextKeysForCustomPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetContextKeysForCustomPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
