...
func (c *Client) ListMFADevices(ctx context.Context, params *ListMFADevicesInput, optFns ...func(*Options)) (*ListMFADevicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMFADevices", params, optFns, addOperationListMFADevicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMFADevicesMiddleware(stack *middleware.Stack, options Options) (err error) {
