...
func (c *Client) GenerateCredentialReport(ctx context.Context, params *GenerateCredentialReportInput, optFns ...func(*Options)) (*GenerateCredentialReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateCredentialReport", params, optFns, addOperationGenerateCredentialReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateCredentialReportMiddleware(stack *middleware.Stack, options Options) (err error) {
