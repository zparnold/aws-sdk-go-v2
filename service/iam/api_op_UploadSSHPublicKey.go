...
func (c *Client) UploadSSHPublicKey(ctx context.Context, params *UploadSSHPublicKeyInput, optFns ...func(*Options)) (*UploadSSHPublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadSSHPublicKey", params, optFns, addOperationUploadSSHPublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadSSHPublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
