...
func (c *Client) ListGroupsForUser(ctx context.Context, params *ListGroupsForUserInput, optFns ...func(*Options)) (*ListGroupsForUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGroupsForUser", params, optFns, addOperationListGroupsForUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGroupsForUserMiddleware(stack *middleware.Stack, options Options) (err error) {
