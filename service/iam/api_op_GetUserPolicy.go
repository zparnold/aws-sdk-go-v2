...
func (c *Client) GetUserPolicy(ctx context.Context, params *GetUserPolicyInput, optFns ...func(*Options)) (*GetUserPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUserPolicy", params, optFns, addOperationGetUserPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
