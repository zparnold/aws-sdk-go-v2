...
func (c *Client) DeleteAccountPasswordPolicy(ctx context.Context, params *DeleteAccountPasswordPolicyInput, optFns ...func(*Options)) (*DeleteAccountPasswordPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccountPasswordPolicy", params, optFns, addOperationDeleteAccountPasswordPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccountPasswordPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
