...
func (c *Client) ListEntitiesForPolicy(ctx context.Context, params *ListEntitiesForPolicyInput, optFns ...func(*Options)) (*ListEntitiesForPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEntitiesForPolicy", params, optFns, addOperationListEntitiesForPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEntitiesForPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
