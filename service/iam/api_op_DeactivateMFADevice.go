...
func (c *Client) DeactivateMFADevice(ctx context.Context, params *DeactivateMFADeviceInput, optFns ...func(*Options)) (*DeactivateMFADeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeactivateMFADevice", params, optFns, addOperationDeactivateMFADeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeactivateMFADeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
