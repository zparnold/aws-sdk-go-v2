...
func (c *Client) DeleteServiceLinkedRole(ctx context.Context, params *DeleteServiceLinkedRoleInput, optFns ...func(*Options)) (*DeleteServiceLinkedRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteServiceLinkedRole", params, optFns, addOperationDeleteServiceLinkedRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteServiceLinkedRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
