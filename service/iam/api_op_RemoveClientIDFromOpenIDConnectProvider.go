...
func (c *Client) RemoveClientIDFromOpenIDConnectProvider(ctx context.Context, params *RemoveClientIDFromOpenIDConnectProviderInput, optFns ...func(*Options)) (*RemoveClientIDFromOpenIDConnectProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveClientIDFromOpenIDConnectProvider", params, optFns, addOperationRemoveClientIDFromOpenIDConnectProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveClientIDFromOpenIDConnectProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
