...
func (c *Client) UntagRole(ctx context.Context, params *UntagRoleInput, optFns ...func(*Options)) (*UntagRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagRole", params, optFns, addOperationUntagRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
