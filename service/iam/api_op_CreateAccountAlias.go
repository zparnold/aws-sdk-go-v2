...
func (c *Client) CreateAccountAlias(ctx context.Context, params *CreateAccountAliasInput, optFns ...func(*Options)) (*CreateAccountAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAccountAlias", params, optFns, addOperationCreateAccountAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAccountAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
