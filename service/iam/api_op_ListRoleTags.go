...
func (c *Client) ListRoleTags(ctx context.Context, params *ListRoleTagsInput, optFns ...func(*Options)) (*ListRoleTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRoleTags", params, optFns, addOperationListRoleTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRoleTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
