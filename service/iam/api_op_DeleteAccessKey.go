...
func (c *Client) DeleteAccessKey(ctx context.Context, params *DeleteAccessKeyInput, optFns ...func(*Options)) (*DeleteAccessKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccessKey", params, optFns, addOperationDeleteAccessKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccessKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
