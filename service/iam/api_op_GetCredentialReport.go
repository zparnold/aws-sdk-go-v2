...
func (c *Client) GetCredentialReport(ctx context.Context, params *GetCredentialReportInput, optFns ...func(*Options)) (*GetCredentialReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCredentialReport", params, optFns, addOperationGetCredentialReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCredentialReportMiddleware(stack *middleware.Stack, options Options) (err error) {
