...
func (c *Client) CreateVirtualMFADevice(ctx context.Context, params *CreateVirtualMFADeviceInput, optFns ...func(*Options)) (*CreateVirtualMFADeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVirtualMFADevice", params, optFns, addOperationCreateVirtualMFADeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVirtualMFADeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
