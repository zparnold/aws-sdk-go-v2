...
func (c *Client) SetDefaultPolicyVersion(ctx context.Context, params *SetDefaultPolicyVersionInput, optFns ...func(*Options)) (*SetDefaultPolicyVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetDefaultPolicyVersion", params, optFns, addOperationSetDefaultPolicyVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetDefaultPolicyVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
