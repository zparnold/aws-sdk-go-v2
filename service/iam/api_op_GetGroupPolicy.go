...
func (c *Client) GetGroupPolicy(ctx context.Context, params *GetGroupPolicyInput, optFns ...func(*Options)) (*GetGroupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroupPolicy", params, optFns, addOperationGetGroupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
