...
func (c *Client) ListRolePolicies(ctx context.Context, params *ListRolePoliciesInput, optFns ...func(*Options)) (*ListRolePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRolePolicies", params, optFns, addOperationListRolePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRolePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
