...
func (c *Client) DeleteSigningCertificate(ctx context.Context, params *DeleteSigningCertificateInput, optFns ...func(*Options)) (*DeleteSigningCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSigningCertificate", params, optFns, addOperationDeleteSigningCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSigningCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
