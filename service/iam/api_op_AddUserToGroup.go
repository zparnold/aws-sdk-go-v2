...
func (c *Client) AddUserToGroup(ctx context.Context, params *AddUserToGroupInput, optFns ...func(*Options)) (*AddUserToGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddUserToGroup", params, optFns, addOperationAddUserToGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddUserToGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
