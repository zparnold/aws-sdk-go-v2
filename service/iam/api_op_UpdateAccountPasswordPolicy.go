...
func (c *Client) UpdateAccountPasswordPolicy(ctx context.Context, params *UpdateAccountPasswordPolicyInput, optFns ...func(*Options)) (*UpdateAccountPasswordPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAccountPasswordPolicy", params, optFns, addOperationUpdateAccountPasswordPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAccountPasswordPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
