...
func (c *Client) PutUserPermissionsBoundary(ctx context.Context, params *PutUserPermissionsBoundaryInput, optFns ...func(*Options)) (*PutUserPermissionsBoundaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutUserPermissionsBoundary", params, optFns, addOperationPutUserPermissionsBoundaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutUserPermissionsBoundaryMiddleware(stack *middleware.Stack, options Options) (err error) {
