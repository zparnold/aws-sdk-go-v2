...
func (c *Client) ListSigningCertificates(ctx context.Context, params *ListSigningCertificatesInput, optFns ...func(*Options)) (*ListSigningCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSigningCertificates", params, optFns, addOperationListSigningCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSigningCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
