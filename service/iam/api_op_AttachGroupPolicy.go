...
func (c *Client) AttachGroupPolicy(ctx context.Context, params *AttachGroupPolicyInput, optFns ...func(*Options)) (*AttachGroupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachGroupPolicy", params, optFns, addOperationAttachGroupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachGroupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
