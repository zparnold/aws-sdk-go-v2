...
func (c *Client) UpdateOpenIDConnectProviderThumbprint(ctx context.Context, params *UpdateOpenIDConnectProviderThumbprintInput, optFns ...func(*Options)) (*UpdateOpenIDConnectProviderThumbprintOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateOpenIDConnectProviderThumbprint", params, optFns, addOperationUpdateOpenIDConnectProviderThumbprintMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateOpenIDConnectProviderThumbprintMiddleware(stack *middleware.Stack, options Options) (err error) {
