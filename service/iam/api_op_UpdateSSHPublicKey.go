...
func (c *Client) UpdateSSHPublicKey(ctx context.Context, params *UpdateSSHPublicKeyInput, optFns ...func(*Options)) (*UpdateSSHPublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSSHPublicKey", params, optFns, addOperationUpdateSSHPublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSSHPublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
