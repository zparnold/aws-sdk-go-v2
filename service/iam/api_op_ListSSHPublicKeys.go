...
func (c *Client) ListSSHPublicKeys(ctx context.Context, params *ListSSHPublicKeysInput, optFns ...func(*Options)) (*ListSSHPublicKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSSHPublicKeys", params, optFns, addOperationListSSHPublicKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSSHPublicKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
