...
func (c *Client) ListUserPolicies(ctx context.Context, params *ListUserPoliciesInput, optFns ...func(*Options)) (*ListUserPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserPolicies", params, optFns, addOperationListUserPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
