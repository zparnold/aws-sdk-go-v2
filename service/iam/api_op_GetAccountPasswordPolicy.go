...
func (c *Client) GetAccountPasswordPolicy(ctx context.Context, params *GetAccountPasswordPolicyInput, optFns ...func(*Options)) (*GetAccountPasswordPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccountPasswordPolicy", params, optFns, addOperationGetAccountPasswordPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccountPasswordPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
