...
func (c *Client) UpdateServerCertificate(ctx context.Context, params *UpdateServerCertificateInput, optFns ...func(*Options)) (*UpdateServerCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServerCertificate", params, optFns, addOperationUpdateServerCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServerCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
