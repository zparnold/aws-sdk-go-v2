...
func (c *Client) DeleteSSHPublicKey(ctx context.Context, params *DeleteSSHPublicKeyInput, optFns ...func(*Options)) (*DeleteSSHPublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSSHPublicKey", params, optFns, addOperationDeleteSSHPublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSSHPublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
