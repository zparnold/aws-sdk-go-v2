...
func (c *Client) PutRolePolicy(ctx context.Context, params *PutRolePolicyInput, optFns ...func(*Options)) (*PutRolePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRolePolicy", params, optFns, addOperationPutRolePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRolePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
