...
func (c *Client) DeleteVirtualMFADevice(ctx context.Context, params *DeleteVirtualMFADeviceInput, optFns ...func(*Options)) (*DeleteVirtualMFADeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVirtualMFADevice", params, optFns, addOperationDeleteVirtualMFADeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVirtualMFADeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
