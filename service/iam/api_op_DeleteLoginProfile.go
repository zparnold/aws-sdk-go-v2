...
func (c *Client) DeleteLoginProfile(ctx context.Context, params *DeleteLoginProfileInput, optFns ...func(*Options)) (*DeleteLoginProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLoginProfile", params, optFns, addOperationDeleteLoginProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLoginProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
