...
func (c *Client) TagRole(ctx context.Context, params *TagRoleInput, optFns ...func(*Options)) (*TagRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagRole", params, optFns, addOperationTagRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
