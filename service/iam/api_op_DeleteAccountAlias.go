...
func (c *Client) DeleteAccountAlias(ctx context.Context, params *DeleteAccountAliasInput, optFns ...func(*Options)) (*DeleteAccountAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccountAlias", params, optFns, addOperationDeleteAccountAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccountAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
