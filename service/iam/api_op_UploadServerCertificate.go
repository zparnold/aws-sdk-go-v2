...
func (c *Client) UploadServerCertificate(ctx context.Context, params *UploadServerCertificateInput, optFns ...func(*Options)) (*UploadServerCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadServerCertificate", params, optFns, addOperationUploadServerCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadServerCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
