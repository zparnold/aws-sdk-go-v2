...
func (c *Client) TagUser(ctx context.Context, params *TagUserInput, optFns ...func(*Options)) (*TagUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagUser", params, optFns, addOperationTagUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagUserMiddleware(stack *middleware.Stack, options Options) (err error) {
