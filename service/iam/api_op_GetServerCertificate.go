...
func (c *Client) GetServerCertificate(ctx context.Context, params *GetServerCertificateInput, optFns ...func(*Options)) (*GetServerCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServerCertificate", params, optFns, addOperationGetServerCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServerCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
