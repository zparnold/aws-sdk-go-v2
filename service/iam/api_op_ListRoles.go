...
func (c *Client) ListRoles(ctx context.Context, params *ListRolesInput, optFns ...func(*Options)) (*ListRolesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRoles", params, optFns, addOperationListRolesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRolesMiddleware(stack *middleware.Stack, options Options) (err error) {
