...
func (c *Client) CreateOpenIDConnectProvider(ctx context.Context, params *CreateOpenIDConnectProviderInput, optFns ...func(*Options)) (*CreateOpenIDConnectProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOpenIDConnectProvider", params, optFns, addOperationCreateOpenIDConnectProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOpenIDConnectProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
