...
func (c *Client) ResetServiceSpecificCredential(ctx context.Context, params *ResetServiceSpecificCredentialInput, optFns ...func(*Options)) (*ResetServiceSpecificCredentialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetServiceSpecificCredential", params, optFns, addOperationResetServiceSpecificCredentialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetServiceSpecificCredentialMiddleware(stack *middleware.Stack, options Options) (err error) {
