...
func (c *Client) ListInstanceProfilesForRole(ctx context.Context, params *ListInstanceProfilesForRoleInput, optFns ...func(*Options)) (*ListInstanceProfilesForRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInstanceProfilesForRole", params, optFns, addOperationListInstanceProfilesForRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInstanceProfilesForRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
