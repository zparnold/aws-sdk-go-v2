...
func (c *Client) UpdateSAMLProvider(ctx context.Context, params *UpdateSAMLProviderInput, optFns ...func(*Options)) (*UpdateSAMLProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSAMLProvider", params, optFns, addOperationUpdateSAMLProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSAMLProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
