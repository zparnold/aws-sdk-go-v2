...
func (c *Client) CreateSAMLProvider(ctx context.Context, params *CreateSAMLProviderInput, optFns ...func(*Options)) (*CreateSAMLProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSAMLProvider", params, optFns, addOperationCreateSAMLProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSAMLProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
