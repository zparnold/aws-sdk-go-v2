...
func (c *Client) ListAttachedGroupPolicies(ctx context.Context, params *ListAttachedGroupPoliciesInput, optFns ...func(*Options)) (*ListAttachedGroupPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAttachedGroupPolicies", params, optFns, addOperationListAttachedGroupPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAttachedGroupPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
