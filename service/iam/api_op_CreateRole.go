...
func (c *Client) CreateRole(ctx context.Context, params *CreateRoleInput, optFns ...func(*Options)) (*CreateRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRole", params, optFns, addOperationCreateRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
