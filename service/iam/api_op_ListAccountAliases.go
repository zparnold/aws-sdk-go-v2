...
func (c *Client) ListAccountAliases(ctx context.Context, params *ListAccountAliasesInput, optFns ...func(*Options)) (*ListAccountAliasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccountAliases", params, optFns, addOperationListAccountAliasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccountAliasesMiddleware(stack *middleware.Stack, options Options) (err error) {
