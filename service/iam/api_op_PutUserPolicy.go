...
func (c *Client) PutUserPolicy(ctx context.Context, params *PutUserPolicyInput, optFns ...func(*Options)) (*PutUserPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutUserPolicy", params, optFns, addOperationPutUserPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutUserPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
