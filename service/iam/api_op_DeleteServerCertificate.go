...
func (c *Client) DeleteServerCertificate(ctx context.Context, params *DeleteServerCertificateInput, optFns ...func(*Options)) (*DeleteServerCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteServerCertificate", params, optFns, addOperationDeleteServerCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteServerCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
