...
func (c *Client) GetSSHPublicKey(ctx context.Context, params *GetSSHPublicKeyInput, optFns ...func(*Options)) (*GetSSHPublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSSHPublicKey", params, optFns, addOperationGetSSHPublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSSHPublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
