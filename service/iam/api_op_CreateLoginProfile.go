...
func (c *Client) CreateLoginProfile(ctx context.Context, params *CreateLoginProfileInput, optFns ...func(*Options)) (*CreateLoginProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLoginProfile", params, optFns, addOperationCreateLoginProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLoginProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
