...
func (c *Client) DeleteRolePermissionsBoundary(ctx context.Context, params *DeleteRolePermissionsBoundaryInput, optFns ...func(*Options)) (*DeleteRolePermissionsBoundaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRolePermissionsBoundary", params, optFns, addOperationDeleteRolePermissionsBoundaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRolePermissionsBoundaryMiddleware(stack *middleware.Stack, options Options) (err error) {
