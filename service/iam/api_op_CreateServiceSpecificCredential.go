...
func (c *Client) CreateServiceSpecificCredential(ctx context.Context, params *CreateServiceSpecificCredentialInput, optFns ...func(*Options)) (*CreateServiceSpecificCredentialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateServiceSpecificCredential", params, optFns, addOperationCreateServiceSpecificCredentialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateServiceSpecificCredentialMiddleware(stack *middleware.Stack, options Options) (err error) {
