...
func (c *Client) ListUserTags(ctx context.Context, params *ListUserTagsInput, optFns ...func(*Options)) (*ListUserTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserTags", params, optFns, addOperationListUserTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
