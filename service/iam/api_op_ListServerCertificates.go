...
func (c *Client) ListServerCertificates(ctx context.Context, params *ListServerCertificatesInput, optFns ...func(*Options)) (*ListServerCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServerCertificates", params, optFns, addOperationListServerCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServerCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
