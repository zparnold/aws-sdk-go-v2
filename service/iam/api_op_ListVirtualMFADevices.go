...
func (c *Client) ListVirtualMFADevices(ctx context.Context, params *ListVirtualMFADevicesInput, optFns ...func(*Options)) (*ListVirtualMFADevicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVirtualMFADevices", params, optFns, addOperationListVirtualMFADevicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVirtualMFADevicesMiddleware(stack *middleware.Stack, options Options) (err error) {
