...
func (c *Client) ListOpenIDConnectProviders(ctx context.Context, params *ListOpenIDConnectProvidersInput, optFns ...func(*Options)) (*ListOpenIDConnectProvidersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOpenIDConnectProviders", params, optFns, addOperationListOpenIDConnectProvidersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOpenIDConnectProvidersMiddleware(stack *middleware.Stack, options Options) (err error) {
