...
func (c *Client) CreateInstanceProfile(ctx context.Context, params *CreateInstanceProfileInput, optFns ...func(*Options)) (*CreateInstanceProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInstanceProfile", params, optFns, addOperationCreateInstanceProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInstanceProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
