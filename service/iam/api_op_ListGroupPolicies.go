...
func (c *Client) ListGroupPolicies(ctx context.Context, params *ListGroupPoliciesInput, optFns ...func(*Options)) (*ListGroupPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGroupPolicies", params, optFns, addOperationListGroupPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGroupPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
