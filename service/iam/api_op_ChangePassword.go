...
func (c *Client) ChangePassword(ctx context.Context, params *ChangePasswordInput, optFns ...func(*Options)) (*ChangePasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ChangePassword", params, optFns, addOperationChangePasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationChangePasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
