...
func (c *Client) GetSAMLProvider(ctx context.Context, params *GetSAMLProviderInput, optFns ...func(*Options)) (*GetSAMLProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSAMLProvider", params, optFns, addOperationGetSAMLProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSAMLProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
