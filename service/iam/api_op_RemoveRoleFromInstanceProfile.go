...
func (c *Client) RemoveRoleFromInstanceProfile(ctx context.Context, params *RemoveRoleFromInstanceProfileInput, optFns ...func(*Options)) (*RemoveRoleFromInstanceProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveRoleFromInstanceProfile", params, optFns, addOperationRemoveRoleFromInstanceProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveRoleFromInstanceProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
