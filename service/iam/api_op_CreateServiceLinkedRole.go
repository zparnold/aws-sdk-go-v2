...
func (c *Client) CreateServiceLinkedRole(ctx context.Context, params *CreateServiceLinkedRoleInput, optFns ...func(*Options)) (*CreateServiceLinkedRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateServiceLinkedRole", params, optFns, addOperationCreateServiceLinkedRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateServiceLinkedRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
