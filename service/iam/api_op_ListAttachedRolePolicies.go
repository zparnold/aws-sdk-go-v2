...
func (c *Client) ListAttachedRolePolicies(ctx context.Context, params *ListAttachedRolePoliciesInput, optFns ...func(*Options)) (*ListAttachedRolePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAttachedRolePolicies", params, optFns, addOperationListAttachedRolePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAttachedRolePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
