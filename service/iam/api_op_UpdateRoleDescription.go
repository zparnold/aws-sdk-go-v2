...
func (c *Client) UpdateRoleDescription(ctx context.Context, params *UpdateRoleDescriptionInput, optFns ...func(*Options)) (*UpdateRoleDescriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRoleDescription", params, optFns, addOperationUpdateRoleDescriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRoleDescriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
