...
func (c *Client) GetOrganizationsAccessReport(ctx context.Context, params *GetOrganizationsAccessReportInput, optFns ...func(*Options)) (*GetOrganizationsAccessReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOrganizationsAccessReport", params, optFns, addOperationGetOrganizationsAccessReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOrganizationsAccessReportMiddleware(stack *middleware.Stack, options Options) (err error) {
