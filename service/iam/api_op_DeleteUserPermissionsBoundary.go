...
func (c *Client) DeleteUserPermissionsBoundary(ctx context.Context, params *DeleteUserPermissionsBoundaryInput, optFns ...func(*Options)) (*DeleteUserPermissionsBoundaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserPermissionsBoundary", params, optFns, addOperationDeleteUserPermissionsBoundaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserPermissionsBoundaryMiddleware(stack *middleware.Stack, options Options) (err error) {
