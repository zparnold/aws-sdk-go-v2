...
func (c *Client) GetContextKeysForPrincipalPolicy(ctx context.Context, params *GetContextKeysForPrincipalPolicyInput, optFns ...func(*Options)) (*GetContextKeysForPrincipalPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetContextKeysForPrincipalPolicy", params, optFns, addOperationGetContextKeysForPrincipalPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetContextKeysForPrincipalPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
