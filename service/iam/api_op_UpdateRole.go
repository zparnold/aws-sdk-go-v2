...
func (c *Client) UpdateRole(ctx context.Context, params *UpdateRoleInput, optFns ...func(*Options)) (*UpdateRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRole", params, optFns, addOperationUpdateRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
