...
func (c *Client) DeleteSAMLProvider(ctx context.Context, params *DeleteSAMLProviderInput, optFns ...func(*Options)) (*DeleteSAMLProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSAMLProvider", params, optFns, addOperationDeleteSAMLProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSAMLProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
