...
func (c *Client) UpdateAccessKey(ctx context.Context, params *UpdateAccessKeyInput, optFns ...func(*Options)) (*UpdateAccessKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAccessKey", params, optFns, addOperationUpdateAccessKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAccessKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
