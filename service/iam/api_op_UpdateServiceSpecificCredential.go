...
func (c *Client) UpdateServiceSpecificCredential(ctx context.Context, params *UpdateServiceSpecificCredentialInput, optFns ...func(*Options)) (*UpdateServiceSpecificCredentialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServiceSpecificCredential", params, optFns, addOperationUpdateServiceSpecificCredentialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServiceSpecificCredentialMiddleware(stack *middleware.Stack, options Options) (err error) {
