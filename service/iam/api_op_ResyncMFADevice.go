...
func (c *Client) ResyncMFADevice(ctx context.Context, params *ResyncMFADeviceInput, optFns ...func(*Options)) (*ResyncMFADeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResyncMFADevice", params, optFns, addOperationResyncMFADeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResyncMFADeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
