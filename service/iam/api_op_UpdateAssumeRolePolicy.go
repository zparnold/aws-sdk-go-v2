...
func (c *Client) UpdateAssumeRolePolicy(ctx context.Context, params *UpdateAssumeRolePolicyInput, optFns ...func(*Options)) (*UpdateAssumeRolePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAssumeRolePolicy", params, optFns, addOperationUpdateAssumeRolePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAssumeRolePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
