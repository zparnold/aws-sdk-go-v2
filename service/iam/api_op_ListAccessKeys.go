...
func (c *Client) ListAccessKeys(ctx context.Context, params *ListAccessKeysInput, optFns ...func(*Options)) (*ListAccessKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccessKeys", params, optFns, addOperationListAccessKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccessKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
