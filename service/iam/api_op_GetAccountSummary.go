...
func (c *Client) GetAccountSummary(ctx context.Context, params *GetAccountSummaryInput, optFns ...func(*Options)) (*GetAccountSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccountSummary", params, optFns, addOperationGetAccountSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccountSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
