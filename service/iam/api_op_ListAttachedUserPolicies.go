...
func (c *Client) ListAttachedUserPolicies(ctx context.Context, params *ListAttachedUserPoliciesInput, optFns ...func(*Options)) (*ListAttachedUserPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAttachedUserPolicies", params, optFns, addOperationListAttachedUserPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAttachedUserPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
