...
func (c *Client) GenerateServiceLastAccessedDetails(ctx context.Context, params *GenerateServiceLastAccessedDetailsInput, optFns ...func(*Options)) (*GenerateServiceLastAccessedDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateServiceLastAccessedDetails", params, optFns, addOperationGenerateServiceLastAccessedDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateServiceLastAccessedDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
