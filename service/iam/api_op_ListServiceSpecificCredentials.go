...
func (c *Client) ListServiceSpecificCredentials(ctx context.Context, params *ListServiceSpecificCredentialsInput, optFns ...func(*Options)) (*ListServiceSpecificCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServiceSpecificCredentials", params, optFns, addOperationListServiceSpecificCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServiceSpecificCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
