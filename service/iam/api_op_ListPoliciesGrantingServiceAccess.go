...
func (c *Client) ListPoliciesGrantingServiceAccess(ctx context.Context, params *ListPoliciesGrantingServiceAccessInput, optFns ...func(*Options)) (*ListPoliciesGrantingServiceAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPoliciesGrantingServiceAccess", params, optFns, addOperationListPoliciesGrantingServiceAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPoliciesGrantingServiceAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
