...
func (c *Client) DeleteServiceSpecificCredential(ctx context.Context, params *DeleteServiceSpecificCredentialInput, optFns ...func(*Options)) (*DeleteServiceSpecificCredentialOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteServiceSpecificCredential", params, optFns, addOperationDeleteServiceSpecificCredentialMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteServiceSpecificCredentialMiddleware(stack *middleware.Stack, options Options) (err error) {
