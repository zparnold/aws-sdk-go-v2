...
func (c *Client) DeleteUserPolicy(ctx context.Context, params *DeleteUserPolicyInput, optFns ...func(*Options)) (*DeleteUserPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserPolicy", params, optFns, addOperationDeleteUserPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
