...
func (c *Client) PutRolePermissionsBoundary(ctx context.Context, params *PutRolePermissionsBoundaryInput, optFns ...func(*Options)) (*PutRolePermissionsBoundaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRolePermissionsBoundary", params, optFns, addOperationPutRolePermissionsBoundaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRolePermissionsBoundaryMiddleware(stack *middleware.Stack, options Options) (err error) {
