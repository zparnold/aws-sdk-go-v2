...
func (c *Client) DeleteRolePolicy(ctx context.Context, params *DeleteRolePolicyInput, optFns ...func(*Options)) (*DeleteRolePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRolePolicy", params, optFns, addOperationDeleteRolePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRolePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
