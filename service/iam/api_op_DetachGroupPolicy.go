...
func (c *Client) DetachGroupPolicy(ctx context.Context, params *DetachGroupPolicyInput, optFns ...func(*Options)) (*DetachGroupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachGroupPolicy", params, optFns, addOperationDetachGroupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachGroupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
