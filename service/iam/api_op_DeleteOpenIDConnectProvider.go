...
func (c *Client) DeleteOpenIDConnectProvider(ctx context.Context, params *DeleteOpenIDConnectProviderInput, optFns ...func(*Options)) (*DeleteOpenIDConnectProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOpenIDConnectProvider", params, optFns, addOperationDeleteOpenIDConnectProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOpenIDConnectProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
