...
func (c *Client) AddRoleToInstanceProfile(ctx context.Context, params *AddRoleToInstanceProfileInput, optFns ...func(*Options)) (*AddRoleToInstanceProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddRoleToInstanceProfile", params, optFns, addOperationAddRoleToInstanceProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddRoleToInstanceProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
