...
func (c *Client) GetAccessKeyLastUsed(ctx context.Context, params *GetAccessKeyLastUsedInput, optFns ...func(*Options)) (*GetAccessKeyLastUsedOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccessKeyLastUsed", params, optFns, addOperationGetAccessKeyLastUsedMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccessKeyLastUsedMiddleware(stack *middleware.Stack, options Options) (err error) {
