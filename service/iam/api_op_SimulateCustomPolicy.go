...
func (c *Client) SimulateCustomPolicy(ctx context.Context, params *SimulateCustomPolicyInput, optFns ...func(*Options)) (*SimulateCustomPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SimulateCustomPolicy", params, optFns, addOperationSimulateCustomPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSimulateCustomPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
