...
func (c *Client) DeleteRole(ctx context.Context, params *DeleteRoleInput, optFns ...func(*Options)) (*DeleteRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRole", params, optFns, addOperationDeleteRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
