...
func (c *Client) ListPolicies(ctx context.Context, params *ListPoliciesInput, optFns ...func(*Options)) (*ListPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPolicies", params, optFns, addOperationListPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
