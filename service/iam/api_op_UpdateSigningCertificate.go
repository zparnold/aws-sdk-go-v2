...
func (c *Client) UpdateSigningCertificate(ctx context.Context, params *UpdateSigningCertificateInput, optFns ...func(*Options)) (*UpdateSigningCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSigningCertificate", params, optFns, addOperationUpdateSigningCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSigningCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
