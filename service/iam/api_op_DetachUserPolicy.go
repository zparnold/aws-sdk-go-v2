...
func (c *Client) DetachUserPolicy(ctx context.Context, params *DetachUserPolicyInput, optFns ...func(*Options)) (*DetachUserPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachUserPolicy", params, optFns, addOperationDetachUserPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachUserPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
