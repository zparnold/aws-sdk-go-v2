...
func (c *Client) EnableMFADevice(ctx context.Context, params *EnableMFADeviceInput, optFns ...func(*Options)) (*EnableMFADeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableMFADevice", params, optFns, addOperationEnableMFADeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableMFADeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
