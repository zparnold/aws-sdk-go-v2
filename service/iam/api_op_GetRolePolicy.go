...
func (c *Client) GetRolePolicy(ctx context.Context, params *GetRolePolicyInput, optFns ...func(*Options)) (*GetRolePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRolePolicy", params, optFns, addOperationGetRolePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRolePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
