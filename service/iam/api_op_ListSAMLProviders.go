...
func (c *Client) ListSAMLProviders(ctx context.Context, params *ListSAMLProvidersInput, optFns ...func(*Options)) (*ListSAMLProvidersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSAMLProviders", params, optFns, addOperationListSAMLProvidersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSAMLProvidersMiddleware(stack *middleware.Stack, options Options) (err error) {
