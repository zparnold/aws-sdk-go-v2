...
func (c *Client) AttachUserPolicy(ctx context.Context, params *AttachUserPolicyInput, optFns ...func(*Options)) (*AttachUserPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachUserPolicy", params, optFns, addOperationAttachUserPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachUserPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
