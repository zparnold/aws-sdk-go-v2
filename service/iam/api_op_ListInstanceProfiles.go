...
func (c *Client) ListInstanceProfiles(ctx context.Context, params *ListInstanceProfilesInput, optFns ...func(*Options)) (*ListInstanceProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInstanceProfiles", params, optFns, addOperationListInstanceProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInstanceProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
