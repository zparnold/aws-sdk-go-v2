...
func (c *Client) GenerateOrganizationsAccessReport(ctx context.Context, params *GenerateOrganizationsAccessReportInput, optFns ...func(*Options)) (*GenerateOrganizationsAccessReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateOrganizationsAccessReport", params, optFns, addOperationGenerateOrganizationsAccessReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateOrganizationsAccessReportMiddleware(stack *middleware.Stack, options Options) (err error) {
