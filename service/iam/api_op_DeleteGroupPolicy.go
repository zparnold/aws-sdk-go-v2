...
func (c *Client) DeleteGroupPolicy(ctx context.Context, params *DeleteGroupPolicyInput, optFns ...func(*Options)) (*DeleteGroupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGroupPolicy", params, optFns, addOperationDeleteGroupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGroupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
