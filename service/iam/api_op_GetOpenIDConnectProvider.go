...
func (c *Client) GetOpenIDConnectProvider(ctx context.Context, params *GetOpenIDConnectProviderInput, optFns ...func(*Options)) (*GetOpenIDConnectProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOpenIDConnectProvider", params, optFns, addOperationGetOpenIDConnectProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOpenIDConnectProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
