...
func (c *Client) PutGroupPolicy(ctx context.Context, params *PutGroupPolicyInput, optFns ...func(*Options)) (*PutGroupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutGroupPolicy", params, optFns, addOperationPutGroupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutGroupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
