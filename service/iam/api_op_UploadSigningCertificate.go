...
func (c *Client) UploadSigningCertificate(ctx context.Context, params *UploadSigningCertificateInput, optFns ...func(*Options)) (*UploadSigningCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadSigningCertificate", params, optFns, addOperationUploadSigningCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadSigningCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
