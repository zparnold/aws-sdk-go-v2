...
func (c *Client) GetServiceLastAccessedDetailsWithEntities(ctx context.Context, params *GetServiceLastAccessedDetailsWithEntitiesInput, optFns ...func(*Options)) (*GetServiceLastAccessedDetailsWithEntitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServiceLastAccessedDetailsWithEntities", params, optFns, addOperationGetServiceLastAccessedDetailsWithEntitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServiceLastAccessedDetailsWithEntitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
