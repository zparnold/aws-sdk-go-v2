...
func (c *Client) CreateAccessKey(ctx context.Context, params *CreateAccessKeyInput, optFns ...func(*Options)) (*CreateAccessKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAccessKey", params, optFns, addOperationCreateAccessKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAccessKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
