...
func (c *Client) GetServiceLastAccessedDetails(ctx context.Context, params *GetServiceLastAccessedDetailsInput, optFns ...func(*Options)) (*GetServiceLastAccessedDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServiceLastAccessedDetails", params, optFns, addOperationGetServiceLastAccessedDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServiceLastAccessedDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
