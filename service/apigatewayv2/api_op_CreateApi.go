...
func (c *Client) CreateApi(ctx context.Context, params *CreateApiInput, optFns ...func(*Options)) (*CreateApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApi", params, optFns, addOperationCreateApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateApiMiddleware(stack *middleware.Stack, options Options) (err error) {
