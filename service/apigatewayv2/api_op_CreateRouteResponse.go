...
func (c *Client) CreateRouteResponse(ctx context.Context, params *CreateRouteResponseInput, optFns ...func(*Options)) (*CreateRouteResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRouteResponse", params, optFns, addOperationCreateRouteResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRouteResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
