...
func (c *Client) GetApiMappings(ctx context.Context, params *GetApiMappingsInput, optFns ...func(*Options)) (*GetApiMappingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApiMappings", params, optFns, addOperationGetApiMappingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApiMappingsMiddleware(stack *middleware.Stack, options Options) (err error) {
