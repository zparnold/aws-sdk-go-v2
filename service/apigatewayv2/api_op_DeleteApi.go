...
func (c *Client) DeleteApi(ctx context.Context, params *DeleteApiInput, optFns ...func(*Options)) (*DeleteApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApi", params, optFns, addOperationDeleteApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApiMiddleware(stack *middleware.Stack, options Options) (err error) {
