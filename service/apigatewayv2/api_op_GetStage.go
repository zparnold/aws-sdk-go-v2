...
func (c *Client) GetStage(ctx context.Context, params *GetStageInput, optFns ...func(*Options)) (*GetStageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStage", params, optFns, addOperationGetStageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStageMiddleware(stack *middleware.Stack, options Options) (err error) {
