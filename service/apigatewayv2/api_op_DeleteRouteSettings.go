...
func (c *Client) DeleteRouteSettings(ctx context.Context, params *DeleteRouteSettingsInput, optFns ...func(*Options)) (*DeleteRouteSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRouteSettings", params, optFns, addOperationDeleteRouteSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRouteSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
