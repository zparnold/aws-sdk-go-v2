...
func (c *Client) DeleteAccessLogSettings(ctx context.Context, params *DeleteAccessLogSettingsInput, optFns ...func(*Options)) (*DeleteAccessLogSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccessLogSettings", params, optFns, addOperationDeleteAccessLogSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccessLogSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
