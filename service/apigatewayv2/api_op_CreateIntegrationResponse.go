...
func (c *Client) CreateIntegrationResponse(ctx context.Context, params *CreateIntegrationResponseInput, optFns ...func(*Options)) (*CreateIntegrationResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIntegrationResponse", params, optFns, addOperationCreateIntegrationResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIntegrationResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
