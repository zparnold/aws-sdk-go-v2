...
func (c *Client) ExportApi(ctx context.Context, params *ExportApiInput, optFns ...func(*Options)) (*ExportApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportApi", params, optFns, addOperationExportApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportApiMiddleware(stack *middleware.Stack, options Options) (err error) {
