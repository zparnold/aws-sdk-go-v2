...
func (c *Client) GetApi(ctx context.Context, params *GetApiInput, optFns ...func(*Options)) (*GetApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApi", params, optFns, addOperationGetApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApiMiddleware(stack *middleware.Stack, options Options) (err error) {
