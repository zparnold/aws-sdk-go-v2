...
func (c *Client) ImportApi(ctx context.Context, params *ImportApiInput, optFns ...func(*Options)) (*ImportApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportApi", params, optFns, addOperationImportApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportApiMiddleware(stack *middleware.Stack, options Options) (err error) {
