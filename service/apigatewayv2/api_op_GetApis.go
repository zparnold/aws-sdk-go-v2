...
func (c *Client) GetApis(ctx context.Context, params *GetApisInput, optFns ...func(*Options)) (*GetApisOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApis", params, optFns, addOperationGetApisMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApisMiddleware(stack *middleware.Stack, options Options) (err error) {
