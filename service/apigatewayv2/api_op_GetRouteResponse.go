...
func (c *Client) GetRouteResponse(ctx context.Context, params *GetRouteResponseInput, optFns ...func(*Options)) (*GetRouteResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRouteResponse", params, optFns, addOperationGetRouteResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRouteResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
