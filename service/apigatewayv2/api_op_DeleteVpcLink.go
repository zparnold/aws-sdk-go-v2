...
func (c *Client) DeleteVpcLink(ctx context.Context, params *DeleteVpcLinkInput, optFns ...func(*Options)) (*DeleteVpcLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpcLink", params, optFns, addOperationDeleteVpcLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpcLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
