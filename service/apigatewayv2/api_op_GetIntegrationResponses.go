...
func (c *Client) GetIntegrationResponses(ctx context.Context, params *GetIntegrationResponsesInput, optFns ...func(*Options)) (*GetIntegrationResponsesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntegrationResponses", params, optFns, addOperationGetIntegrationResponsesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntegrationResponsesMiddleware(stack *middleware.Stack, options Options) (err error) {
