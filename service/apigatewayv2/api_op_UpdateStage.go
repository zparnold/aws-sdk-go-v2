...
func (c *Client) UpdateStage(ctx context.Context, params *UpdateStageInput, optFns ...func(*Options)) (*UpdateStageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStage", params, optFns, addOperationUpdateStageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStageMiddleware(stack *middleware.Stack, options Options) (err error) {
