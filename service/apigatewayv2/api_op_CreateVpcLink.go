...
func (c *Client) CreateVpcLink(ctx context.Context, params *CreateVpcLinkInput, optFns ...func(*Options)) (*CreateVpcLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpcLink", params, optFns, addOperationCreateVpcLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpcLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
