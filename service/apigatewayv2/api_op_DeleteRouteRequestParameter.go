...
func (c *Client) DeleteRouteRequestParameter(ctx context.Context, params *DeleteRouteRequestParameterInput, optFns ...func(*Options)) (*DeleteRouteRequestParameterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRouteRequestParameter", params, optFns, addOperationDeleteRouteRequestParameterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRouteRequestParameterMiddleware(stack *middleware.Stack, options Options) (err error) {
