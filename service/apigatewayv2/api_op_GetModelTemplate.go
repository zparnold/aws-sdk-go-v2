...
func (c *Client) GetModelTemplate(ctx context.Context, params *GetModelTemplateInput, optFns ...func(*Options)) (*GetModelTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetModelTemplate", params, optFns, addOperationGetModelTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetModelTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
