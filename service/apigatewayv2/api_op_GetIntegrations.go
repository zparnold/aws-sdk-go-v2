...
func (c *Client) GetIntegrations(ctx context.Context, params *GetIntegrationsInput, optFns ...func(*Options)) (*GetIntegrationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntegrations", params, optFns, addOperationGetIntegrationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntegrationsMiddleware(stack *middleware.Stack, options Options) (err error) {
