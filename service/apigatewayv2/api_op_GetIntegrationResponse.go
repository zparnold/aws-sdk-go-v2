...
func (c *Client) GetIntegrationResponse(ctx context.Context, params *GetIntegrationResponseInput, optFns ...func(*Options)) (*GetIntegrationResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntegrationResponse", params, optFns, addOperationGetIntegrationResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntegrationResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
