...
func (c *Client) CreateIntegration(ctx context.Context, params *CreateIntegrationInput, optFns ...func(*Options)) (*CreateIntegrationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIntegration", params, optFns, addOperationCreateIntegrationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIntegrationMiddleware(stack *middleware.Stack, options Options) (err error) {
