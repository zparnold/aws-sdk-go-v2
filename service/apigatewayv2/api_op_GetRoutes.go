...
func (c *Client) GetRoutes(ctx context.Context, params *GetRoutesInput, optFns ...func(*Options)) (*GetRoutesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRoutes", params, optFns, addOperationGetRoutesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRoutesMiddleware(stack *middleware.Stack, options Options) (err error) {
