...
func (c *Client) GetAuthorizers(ctx context.Context, params *GetAuthorizersInput, optFns ...func(*Options)) (*GetAuthorizersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAuthorizers", params, optFns, addOperationGetAuthorizersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAuthorizersMiddleware(stack *middleware.Stack, options Options) (err error) {
