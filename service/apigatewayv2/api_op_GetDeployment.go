...
func (c *Client) GetDeployment(ctx context.Context, params *GetDeploymentInput, optFns ...func(*Options)) (*GetDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeployment", params, optFns, addOperationGetDeploymentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeploymentMiddleware(stack *middleware.Stack, options Options) (err error) {
