...
func (c *Client) GetModel(ctx context.Context, params *GetModelInput, optFns ...func(*Options)) (*GetModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetModel", params, optFns, addOperationGetModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetModelMiddleware(stack *middleware.Stack, options Options) (err error) {
