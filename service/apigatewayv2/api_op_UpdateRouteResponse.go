...
func (c *Client) UpdateRouteResponse(ctx context.Context, params *UpdateRouteResponseInput, optFns ...func(*Options)) (*UpdateRouteResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRouteResponse", params, optFns, addOperationUpdateRouteResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRouteResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
