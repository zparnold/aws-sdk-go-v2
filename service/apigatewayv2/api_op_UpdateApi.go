...
func (c *Client) UpdateApi(ctx context.Context, params *UpdateApiInput, optFns ...func(*Options)) (*UpdateApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApi", params, optFns, addOperationUpdateApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApiMiddleware(stack *middleware.Stack, options Options) (err error) {
