...
func (c *Client) CreateAuthorizer(ctx context.Context, params *CreateAuthorizerInput, optFns ...func(*Options)) (*CreateAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAuthorizer", params, optFns, addOperationCreateAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
