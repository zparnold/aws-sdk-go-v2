...
func (c *Client) GetRouteResponses(ctx context.Context, params *GetRouteResponsesInput, optFns ...func(*Options)) (*GetRouteResponsesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRouteResponses", params, optFns, addOperationGetRouteResponsesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRouteResponsesMiddleware(stack *middleware.Stack, options Options) (err error) {
