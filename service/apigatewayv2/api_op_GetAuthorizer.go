...
func (c *Client) GetAuthorizer(ctx context.Context, params *GetAuthorizerInput, optFns ...func(*Options)) (*GetAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAuthorizer", params, optFns, addOperationGetAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
