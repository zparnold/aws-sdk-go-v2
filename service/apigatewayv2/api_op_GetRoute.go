...
func (c *Client) GetRoute(ctx context.Context, params *GetRouteInput, optFns ...func(*Options)) (*GetRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRoute", params, optFns, addOperationGetRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
