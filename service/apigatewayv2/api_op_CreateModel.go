...
func (c *Client) CreateModel(ctx context.Context, params *CreateModelInput, optFns ...func(*Options)) (*CreateModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateModel", params, optFns, addOperationCreateModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateModelMiddleware(stack *middleware.Stack, options Options) (err error) {
