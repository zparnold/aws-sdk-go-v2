...
func (c *Client) DeleteRouteResponse(ctx context.Context, params *DeleteRouteResponseInput, optFns ...func(*Options)) (*DeleteRouteResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRouteResponse", params, optFns, addOperationDeleteRouteResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRouteResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
