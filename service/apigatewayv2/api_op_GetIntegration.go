...
func (c *Client) GetIntegration(ctx context.Context, params *GetIntegrationInput, optFns ...func(*Options)) (*GetIntegrationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntegration", params, optFns, addOperationGetIntegrationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntegrationMiddleware(stack *middleware.Stack, options Options) (err error) {
