...
func (c *Client) UpdateIntegrationResponse(ctx context.Context, params *UpdateIntegrationResponseInput, optFns ...func(*Options)) (*UpdateIntegrationResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIntegrationResponse", params, optFns, addOperationUpdateIntegrationResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIntegrationResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
