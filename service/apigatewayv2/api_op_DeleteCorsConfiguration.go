...
func (c *Client) DeleteCorsConfiguration(ctx context.Context, params *DeleteCorsConfigurationInput, optFns ...func(*Options)) (*DeleteCorsConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCorsConfiguration", params, optFns, addOperationDeleteCorsConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCorsConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
