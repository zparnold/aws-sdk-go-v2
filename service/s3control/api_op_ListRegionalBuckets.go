...
func (c *Client) ListRegionalBuckets(ctx context.Context, params *ListRegionalBucketsInput, optFns ...func(*Options)) (*ListRegionalBucketsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRegionalBuckets", params, optFns, addOperationListRegionalBucketsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRegionalBucketsMiddleware(stack *middleware.Stack, options Options) (err error) {
