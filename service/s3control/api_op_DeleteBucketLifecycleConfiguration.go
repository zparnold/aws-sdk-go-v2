...
func (c *Client) DeleteBucketLifecycleConfiguration(ctx context.Context, params *DeleteBucketLifecycleConfigurationInput, optFns ...func(*Options)) (*DeleteBucketLifecycleConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketLifecycleConfiguration", params, optFns, addOperationDeleteBucketLifecycleConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketLifecycleConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
