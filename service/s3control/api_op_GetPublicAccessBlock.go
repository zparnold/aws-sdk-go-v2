...
func (c *Client) GetPublicAccessBlock(ctx context.Context, params *GetPublicAccessBlockInput, optFns ...func(*Options)) (*GetPublicAccessBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPublicAccessBlock", params, optFns, addOperationGetPublicAccessBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPublicAccessBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
