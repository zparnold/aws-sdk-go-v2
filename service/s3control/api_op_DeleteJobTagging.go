...
func (c *Client) DeleteJobTagging(ctx context.Context, params *DeleteJobTaggingInput, optFns ...func(*Options)) (*DeleteJobTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteJobTagging", params, optFns, addOperationDeleteJobTaggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteJobTaggingMiddleware(stack *middleware.Stack, options Options) (err error) {
