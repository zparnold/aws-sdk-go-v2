...
func (c *Client) DeleteAccessPointPolicy(ctx context.Context, params *DeleteAccessPointPolicyInput, optFns ...func(*Options)) (*DeleteAccessPointPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccessPointPolicy", params, optFns, addOperationDeleteAccessPointPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccessPointPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
