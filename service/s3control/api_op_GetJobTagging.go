...
func (c *Client) GetJobTagging(ctx context.Context, params *GetJobTaggingInput, optFns ...func(*Options)) (*GetJobTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobTagging", params, optFns, addOperationGetJobTaggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobTaggingMiddleware(stack *middleware.Stack, options Options) (err error) {
