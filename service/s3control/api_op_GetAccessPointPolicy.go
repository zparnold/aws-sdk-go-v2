...
func (c *Client) GetAccessPointPolicy(ctx context.Context, params *GetAccessPointPolicyInput, optFns ...func(*Options)) (*GetAccessPointPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccessPointPolicy", params, optFns, addOperationGetAccessPointPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccessPointPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
