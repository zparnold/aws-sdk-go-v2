...
func (c *Client) GetBucket(ctx context.Context, params *GetBucketInput, optFns ...func(*Options)) (*GetBucketOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucket", params, optFns, addOperationGetBucketMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketMiddleware(stack *middleware.Stack, options Options) (err error) {
