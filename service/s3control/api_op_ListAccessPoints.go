...
func (c *Client) ListAccessPoints(ctx context.Context, params *ListAccessPointsInput, optFns ...func(*Options)) (*ListAccessPointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccessPoints", params, optFns, addOperationListAccessPointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccessPointsMiddleware(stack *middleware.Stack, options Options) (err error) {
