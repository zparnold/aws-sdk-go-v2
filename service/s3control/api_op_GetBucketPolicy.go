...
func (c *Client) GetBucketPolicy(ctx context.Context, params *GetBucketPolicyInput, optFns ...func(*Options)) (*GetBucketPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketPolicy", params, optFns, addOperationGetBucketPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
