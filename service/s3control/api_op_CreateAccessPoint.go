...
func (c *Client) CreateAccessPoint(ctx context.Context, params *CreateAccessPointInput, optFns ...func(*Options)) (*CreateAccessPointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAccessPoint", params, optFns, addOperationCreateAccessPointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAccessPointMiddleware(stack *middleware.Stack, options Options) (err error) {
