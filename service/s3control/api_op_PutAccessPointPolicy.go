...
func (c *Client) PutAccessPointPolicy(ctx context.Context, params *PutAccessPointPolicyInput, optFns ...func(*Options)) (*PutAccessPointPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccessPointPolicy", params, optFns, addOperationPutAccessPointPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccessPointPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
