...
func (c *Client) DeleteBucketPolicy(ctx context.Context, params *DeleteBucketPolicyInput, optFns ...func(*Options)) (*DeleteBucketPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketPolicy", params, optFns, addOperationDeleteBucketPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
