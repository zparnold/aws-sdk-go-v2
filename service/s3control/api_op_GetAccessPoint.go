...
func (c *Client) GetAccessPoint(ctx context.Context, params *GetAccessPointInput, optFns ...func(*Options)) (*GetAccessPointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccessPoint", params, optFns, addOperationGetAccessPointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccessPointMiddleware(stack *middleware.Stack, options Options) (err error) {
