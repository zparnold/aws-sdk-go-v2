...
func (c *Client) GetAccessPointPolicyStatus(ctx context.Context, params *GetAccessPointPolicyStatusInput, optFns ...func(*Options)) (*GetAccessPointPolicyStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccessPointPolicyStatus", params, optFns, addOperationGetAccessPointPolicyStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccessPointPolicyStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
