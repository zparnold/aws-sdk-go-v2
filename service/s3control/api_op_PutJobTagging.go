...
func (c *Client) PutJobTagging(ctx context.Context, params *PutJobTaggingInput, optFns ...func(*Options)) (*PutJobTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutJobTagging", params, optFns, addOperationPutJobTaggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutJobTaggingMiddleware(stack *middleware.Stack, options Options) (err error) {
