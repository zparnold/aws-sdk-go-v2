...
func (c *Client) GetBucketTagging(ctx context.Context, params *GetBucketTaggingInput, optFns ...func(*Options)) (*GetBucketTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketTagging", params, optFns, addOperationGetBucketTaggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketTaggingMiddleware(stack *middleware.Stack, options Options) (err error) {
