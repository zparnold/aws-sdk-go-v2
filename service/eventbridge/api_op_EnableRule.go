...
func (c *Client) EnableRule(ctx context.Context, params *EnableRuleInput, optFns ...func(*Options)) (*EnableRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableRule", params, optFns, addOperationEnableRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
