...
func (c *Client) DeactivateEventSource(ctx context.Context, params *DeactivateEventSourceInput, optFns ...func(*Options)) (*DeactivateEventSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeactivateEventSource", params, optFns, addOperationDeactivateEventSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeactivateEventSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
