...
func (c *Client) PutEvents(ctx context.Context, params *PutEventsInput, optFns ...func(*Options)) (*PutEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEvents", params, optFns, addOperationPutEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
