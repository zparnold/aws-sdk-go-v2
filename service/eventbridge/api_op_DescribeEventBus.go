...
func (c *Client) DescribeEventBus(ctx context.Context, params *DescribeEventBusInput, optFns ...func(*Options)) (*DescribeEventBusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventBus", params, optFns, addOperationDescribeEventBusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventBusMiddleware(stack *middleware.Stack, options Options) (err error) {
