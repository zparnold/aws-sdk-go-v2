...
func (c *Client) CreatePartnerEventSource(ctx context.Context, params *CreatePartnerEventSourceInput, optFns ...func(*Options)) (*CreatePartnerEventSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePartnerEventSource", params, optFns, addOperationCreatePartnerEventSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePartnerEventSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
