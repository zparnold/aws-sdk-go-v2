...
func (c *Client) ListEventBuses(ctx context.Context, params *ListEventBusesInput, optFns ...func(*Options)) (*ListEventBusesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEventBuses", params, optFns, addOperationListEventBusesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEventBusesMiddleware(stack *middleware.Stack, options Options) (err error) {
