...
func (c *Client) DeleteRule(ctx context.Context, params *DeleteRuleInput, optFns ...func(*Options)) (*DeleteRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRule", params, optFns, addOperationDeleteRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
