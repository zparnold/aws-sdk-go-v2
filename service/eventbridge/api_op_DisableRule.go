...
func (c *Client) DisableRule(ctx context.Context, params *DisableRuleInput, optFns ...func(*Options)) (*DisableRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableRule", params, optFns, addOperationDisableRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
