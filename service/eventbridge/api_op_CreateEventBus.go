...
func (c *Client) CreateEventBus(ctx context.Context, params *CreateEventBusInput, optFns ...func(*Options)) (*CreateEventBusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEventBus", params, optFns, addOperationCreateEventBusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEventBusMiddleware(stack *middleware.Stack, options Options) (err error) {
