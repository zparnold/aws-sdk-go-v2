...
func (c *Client) DescribeRdsDbInstances(ctx context.Context, params *DescribeRdsDbInstancesInput, optFns ...func(*Options)) (*DescribeRdsDbInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRdsDbInstances", params, optFns, addOperationDescribeRdsDbInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRdsDbInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
