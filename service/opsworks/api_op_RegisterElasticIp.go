...
func (c *Client) RegisterElasticIp(ctx context.Context, params *RegisterElasticIpInput, optFns ...func(*Options)) (*RegisterElasticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterElasticIp", params, optFns, addOperationRegisterElasticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterElasticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
