...
func (c *Client) RegisterVolume(ctx context.Context, params *RegisterVolumeInput, optFns ...func(*Options)) (*RegisterVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterVolume", params, optFns, addOperationRegisterVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
