...
func (c *Client) DeregisterVolume(ctx context.Context, params *DeregisterVolumeInput, optFns ...func(*Options)) (*DeregisterVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterVolume", params, optFns, addOperationDeregisterVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
