...
func (c *Client) UnassignVolume(ctx context.Context, params *UnassignVolumeInput, optFns ...func(*Options)) (*UnassignVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnassignVolume", params, optFns, addOperationUnassignVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnassignVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
