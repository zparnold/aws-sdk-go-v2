...
func (c *Client) AttachElasticLoadBalancer(ctx context.Context, params *AttachElasticLoadBalancerInput, optFns ...func(*Options)) (*AttachElasticLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachElasticLoadBalancer", params, optFns, addOperationAttachElasticLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachElasticLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
