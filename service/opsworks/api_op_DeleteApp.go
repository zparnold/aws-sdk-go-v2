...
func (c *Client) DeleteApp(ctx context.Context, params *DeleteAppInput, optFns ...func(*Options)) (*DeleteAppOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApp", params, optFns, addOperationDeleteAppMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAppMiddleware(stack *middleware.Stack, options Options) (err error) {
