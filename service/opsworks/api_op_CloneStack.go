...
func (c *Client) CloneStack(ctx context.Context, params *CloneStackInput, optFns ...func(*Options)) (*CloneStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CloneStack", params, optFns, addOperationCloneStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCloneStackMiddleware(stack *middleware.Stack, options Options) (err error) {
