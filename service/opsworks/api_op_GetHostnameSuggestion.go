...
func (c *Client) GetHostnameSuggestion(ctx context.Context, params *GetHostnameSuggestionInput, optFns ...func(*Options)) (*GetHostnameSuggestionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHostnameSuggestion", params, optFns, addOperationGetHostnameSuggestionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHostnameSuggestionMiddleware(stack *middleware.Stack, options Options) (err error) {
