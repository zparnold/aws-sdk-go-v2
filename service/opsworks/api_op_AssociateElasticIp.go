...
func (c *Client) AssociateElasticIp(ctx context.Context, params *AssociateElasticIpInput, optFns ...func(*Options)) (*AssociateElasticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateElasticIp", params, optFns, addOperationAssociateElasticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateElasticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
