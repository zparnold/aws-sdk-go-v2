...
func (c *Client) UpdateVolume(ctx context.Context, params *UpdateVolumeInput, optFns ...func(*Options)) (*UpdateVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVolume", params, optFns, addOperationUpdateVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
