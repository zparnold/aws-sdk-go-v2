...
func (c *Client) StartStack(ctx context.Context, params *StartStackInput, optFns ...func(*Options)) (*StartStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartStack", params, optFns, addOperationStartStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartStackMiddleware(stack *middleware.Stack, options Options) (err error) {
