...
func (c *Client) UpdateLayer(ctx context.Context, params *UpdateLayerInput, optFns ...func(*Options)) (*UpdateLayerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLayer", params, optFns, addOperationUpdateLayerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLayerMiddleware(stack *middleware.Stack, options Options) (err error) {
