...
func (c *Client) DeleteLayer(ctx context.Context, params *DeleteLayerInput, optFns ...func(*Options)) (*DeleteLayerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLayer", params, optFns, addOperationDeleteLayerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLayerMiddleware(stack *middleware.Stack, options Options) (err error) {
