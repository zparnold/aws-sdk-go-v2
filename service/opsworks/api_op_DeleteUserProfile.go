...
func (c *Client) DeleteUserProfile(ctx context.Context, params *DeleteUserProfileInput, optFns ...func(*Options)) (*DeleteUserProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserProfile", params, optFns, addOperationDeleteUserProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
