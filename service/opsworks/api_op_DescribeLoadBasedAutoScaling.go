...
func (c *Client) DescribeLoadBasedAutoScaling(ctx context.Context, params *DescribeLoadBasedAutoScalingInput, optFns ...func(*Options)) (*DescribeLoadBasedAutoScalingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoadBasedAutoScaling", params, optFns, addOperationDescribeLoadBasedAutoScalingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoadBasedAutoScalingMiddleware(stack *middleware.Stack, options Options) (err error) {
