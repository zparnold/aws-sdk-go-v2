...
func (c *Client) UpdateElasticIp(ctx context.Context, params *UpdateElasticIpInput, optFns ...func(*Options)) (*UpdateElasticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateElasticIp", params, optFns, addOperationUpdateElasticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateElasticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
