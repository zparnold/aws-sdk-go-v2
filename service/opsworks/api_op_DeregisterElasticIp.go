...
func (c *Client) DeregisterElasticIp(ctx context.Context, params *DeregisterElasticIpInput, optFns ...func(*Options)) (*DeregisterElasticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterElasticIp", params, optFns, addOperationDeregisterElasticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterElasticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
