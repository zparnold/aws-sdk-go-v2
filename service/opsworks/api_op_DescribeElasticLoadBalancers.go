...
func (c *Client) DescribeElasticLoadBalancers(ctx context.Context, params *DescribeElasticLoadBalancersInput, optFns ...func(*Options)) (*DescribeElasticLoadBalancersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeElasticLoadBalancers", params, optFns, addOperationDescribeElasticLoadBalancersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeElasticLoadBalancersMiddleware(stack *middleware.Stack, options Options) (err error) {
