...
func (c *Client) DescribeMyUserProfile(ctx context.Context, params *DescribeMyUserProfileInput, optFns ...func(*Options)) (*DescribeMyUserProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMyUserProfile", params, optFns, addOperationDescribeMyUserProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMyUserProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
