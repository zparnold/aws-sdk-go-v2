...
func (c *Client) SetLoadBasedAutoScaling(ctx context.Context, params *SetLoadBasedAutoScalingInput, optFns ...func(*Options)) (*SetLoadBasedAutoScalingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetLoadBasedAutoScaling", params, optFns, addOperationSetLoadBasedAutoScalingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetLoadBasedAutoScalingMiddleware(stack *middleware.Stack, options Options) (err error) {
