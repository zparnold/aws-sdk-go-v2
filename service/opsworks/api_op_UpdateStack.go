...
func (c *Client) UpdateStack(ctx context.Context, params *UpdateStackInput, optFns ...func(*Options)) (*UpdateStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStack", params, optFns, addOperationUpdateStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStackMiddleware(stack *middleware.Stack, options Options) (err error) {
