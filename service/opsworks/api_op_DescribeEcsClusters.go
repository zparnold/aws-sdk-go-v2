...
func (c *Client) DescribeEcsClusters(ctx context.Context, params *DescribeEcsClustersInput, optFns ...func(*Options)) (*DescribeEcsClustersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEcsClusters", params, optFns, addOperationDescribeEcsClustersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEcsClustersMiddleware(stack *middleware.Stack, options Options) (err error) {
