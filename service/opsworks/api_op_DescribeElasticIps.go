...
func (c *Client) DescribeElasticIps(ctx context.Context, params *DescribeElasticIpsInput, optFns ...func(*Options)) (*DescribeElasticIpsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeElasticIps", params, optFns, addOperationDescribeElasticIpsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeElasticIpsMiddleware(stack *middleware.Stack, options Options) (err error) {
