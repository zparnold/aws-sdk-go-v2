...
func (c *Client) UpdateMyUserProfile(ctx context.Context, params *UpdateMyUserProfileInput, optFns ...func(*Options)) (*UpdateMyUserProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMyUserProfile", params, optFns, addOperationUpdateMyUserProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMyUserProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
