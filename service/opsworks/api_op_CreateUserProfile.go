...
func (c *Client) CreateUserProfile(ctx context.Context, params *CreateUserProfileInput, optFns ...func(*Options)) (*CreateUserProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUserProfile", params, optFns, addOperationCreateUserProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUserProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
