...
func (c *Client) DeleteStack(ctx context.Context, params *DeleteStackInput, optFns ...func(*Options)) (*DeleteStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStack", params, optFns, addOperationDeleteStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStackMiddleware(stack *middleware.Stack, options Options) (err error) {
