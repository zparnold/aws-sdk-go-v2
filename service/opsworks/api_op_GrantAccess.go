...
func (c *Client) GrantAccess(ctx context.Context, params *GrantAccessInput, optFns ...func(*Options)) (*GrantAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GrantAccess", params, optFns, addOperationGrantAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGrantAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
