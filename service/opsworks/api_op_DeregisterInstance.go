...
func (c *Client) DeregisterInstance(ctx context.Context, params *DeregisterInstanceInput, optFns ...func(*Options)) (*DeregisterInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterInstance", params, optFns, addOperationDeregisterInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
