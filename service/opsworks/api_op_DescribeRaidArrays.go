...
func (c *Client) DescribeRaidArrays(ctx context.Context, params *DescribeRaidArraysInput, optFns ...func(*Options)) (*DescribeRaidArraysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRaidArrays", params, optFns, addOperationDescribeRaidArraysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRaidArraysMiddleware(stack *middleware.Stack, options Options) (err error) {
