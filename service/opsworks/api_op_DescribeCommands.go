...
func (c *Client) DescribeCommands(ctx context.Context, params *DescribeCommandsInput, optFns ...func(*Options)) (*DescribeCommandsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCommands", params, optFns, addOperationDescribeCommandsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCommandsMiddleware(stack *middleware.Stack, options Options) (err error) {
