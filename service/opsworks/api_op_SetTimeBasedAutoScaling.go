...
func (c *Client) SetTimeBasedAutoScaling(ctx context.Context, params *SetTimeBasedAutoScalingInput, optFns ...func(*Options)) (*SetTimeBasedAutoScalingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetTimeBasedAutoScaling", params, optFns, addOperationSetTimeBasedAutoScalingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetTimeBasedAutoScalingMiddleware(stack *middleware.Stack, options Options) (err error) {
