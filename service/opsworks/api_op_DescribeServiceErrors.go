...
func (c *Client) DescribeServiceErrors(ctx context.Context, params *DescribeServiceErrorsInput, optFns ...func(*Options)) (*DescribeServiceErrorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeServiceErrors", params, optFns, addOperationDescribeServiceErrorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeServiceErrorsMiddleware(stack *middleware.Stack, options Options) (err error) {
