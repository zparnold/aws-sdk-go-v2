...
func (c *Client) RegisterRdsDbInstance(ctx context.Context, params *RegisterRdsDbInstanceInput, optFns ...func(*Options)) (*RegisterRdsDbInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterRdsDbInstance", params, optFns, addOperationRegisterRdsDbInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterRdsDbInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
