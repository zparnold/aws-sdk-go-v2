...
func (c *Client) DescribeUserProfiles(ctx context.Context, params *DescribeUserProfilesInput, optFns ...func(*Options)) (*DescribeUserProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUserProfiles", params, optFns, addOperationDescribeUserProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUserProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
