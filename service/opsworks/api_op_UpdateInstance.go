...
func (c *Client) UpdateInstance(ctx context.Context, params *UpdateInstanceInput, optFns ...func(*Options)) (*UpdateInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateInstance", params, optFns, addOperationUpdateInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
