...
func (c *Client) AssignVolume(ctx context.Context, params *AssignVolumeInput, optFns ...func(*Options)) (*AssignVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssignVolume", params, optFns, addOperationAssignVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssignVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
