...
func (c *Client) DisassociateElasticIp(ctx context.Context, params *DisassociateElasticIpInput, optFns ...func(*Options)) (*DisassociateElasticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateElasticIp", params, optFns, addOperationDisassociateElasticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateElasticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
