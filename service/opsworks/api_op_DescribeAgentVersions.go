...
func (c *Client) DescribeAgentVersions(ctx context.Context, params *DescribeAgentVersionsInput, optFns ...func(*Options)) (*DescribeAgentVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAgentVersions", params, optFns, addOperationDescribeAgentVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAgentVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
