...
func (c *Client) DescribeOperatingSystems(ctx context.Context, params *DescribeOperatingSystemsInput, optFns ...func(*Options)) (*DescribeOperatingSystemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOperatingSystems", params, optFns, addOperationDescribeOperatingSystemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOperatingSystemsMiddleware(stack *middleware.Stack, options Options) (err error) {
