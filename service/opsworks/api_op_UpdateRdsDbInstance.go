...
func (c *Client) UpdateRdsDbInstance(ctx context.Context, params *UpdateRdsDbInstanceInput, optFns ...func(*Options)) (*UpdateRdsDbInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRdsDbInstance", params, optFns, addOperationUpdateRdsDbInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRdsDbInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
