...
func (c *Client) DescribeDeployments(ctx context.Context, params *DescribeDeploymentsInput, optFns ...func(*Options)) (*DescribeDeploymentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDeployments", params, optFns, addOperationDescribeDeploymentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDeploymentsMiddleware(stack *middleware.Stack, options Options) (err error) {
