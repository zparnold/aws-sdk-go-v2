...
func (c *Client) AssignInstance(ctx context.Context, params *AssignInstanceInput, optFns ...func(*Options)) (*AssignInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssignInstance", params, optFns, addOperationAssignInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssignInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
