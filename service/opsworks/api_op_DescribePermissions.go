...
func (c *Client) DescribePermissions(ctx context.Context, params *DescribePermissionsInput, optFns ...func(*Options)) (*DescribePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePermissions", params, optFns, addOperationDescribePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
