...
func (c *Client) DescribeLayers(ctx context.Context, params *DescribeLayersInput, optFns ...func(*Options)) (*DescribeLayersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLayers", params, optFns, addOperationDescribeLayersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLayersMiddleware(stack *middleware.Stack, options Options) (err error) {
