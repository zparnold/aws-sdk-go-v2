...
func (c *Client) DescribeStackProvisioningParameters(ctx context.Context, params *DescribeStackProvisioningParametersInput, optFns ...func(*Options)) (*DescribeStackProvisioningParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackProvisioningParameters", params, optFns, addOperationDescribeStackProvisioningParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackProvisioningParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
