...
func (c *Client) DescribeTimeBasedAutoScaling(ctx context.Context, params *DescribeTimeBasedAutoScalingInput, optFns ...func(*Options)) (*DescribeTimeBasedAutoScalingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTimeBasedAutoScaling", params, optFns, addOperationDescribeTimeBasedAutoScalingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTimeBasedAutoScalingMiddleware(stack *middleware.Stack, options Options) (err error) {
