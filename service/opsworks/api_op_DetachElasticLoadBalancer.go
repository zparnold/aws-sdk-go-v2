...
func (c *Client) DetachElasticLoadBalancer(ctx context.Context, params *DetachElasticLoadBalancerInput, optFns ...func(*Options)) (*DetachElasticLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachElasticLoadBalancer", params, optFns, addOperationDetachElasticLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachElasticLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
