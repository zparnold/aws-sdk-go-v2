...
func (c *Client) UpdateUserProfile(ctx context.Context, params *UpdateUserProfileInput, optFns ...func(*Options)) (*UpdateUserProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserProfile", params, optFns, addOperationUpdateUserProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
