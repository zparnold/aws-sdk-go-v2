...
func (c *Client) DeregisterEcsCluster(ctx context.Context, params *DeregisterEcsClusterInput, optFns ...func(*Options)) (*DeregisterEcsClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterEcsCluster", params, optFns, addOperationDeregisterEcsClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterEcsClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
