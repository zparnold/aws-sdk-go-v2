...
func (c *Client) DescribeStackSummary(ctx context.Context, params *DescribeStackSummaryInput, optFns ...func(*Options)) (*DescribeStackSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackSummary", params, optFns, addOperationDescribeStackSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
