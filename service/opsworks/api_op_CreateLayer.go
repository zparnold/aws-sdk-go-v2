...
func (c *Client) CreateLayer(ctx context.Context, params *CreateLayerInput, optFns ...func(*Options)) (*CreateLayerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLayer", params, optFns, addOperationCreateLayerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLayerMiddleware(stack *middleware.Stack, options Options) (err error) {
