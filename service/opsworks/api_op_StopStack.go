...
func (c *Client) StopStack(ctx context.Context, params *StopStackInput, optFns ...func(*Options)) (*StopStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopStack", params, optFns, addOperationStopStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopStackMiddleware(stack *middleware.Stack, options Options) (err error) {
