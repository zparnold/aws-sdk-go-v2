...
func (c *Client) CreateInstance(ctx context.Context, params *CreateInstanceInput, optFns ...func(*Options)) (*CreateInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInstance", params, optFns, addOperationCreateInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
