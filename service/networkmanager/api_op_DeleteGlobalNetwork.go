...
func (c *Client) DeleteGlobalNetwork(ctx context.Context, params *DeleteGlobalNetworkInput, optFns ...func(*Options)) (*DeleteGlobalNetworkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGlobalNetwork", params, optFns, addOperationDeleteGlobalNetworkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGlobalNetworkMiddleware(stack *middleware.Stack, options Options) (err error) {
