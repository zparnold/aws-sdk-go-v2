...
func (c *Client) AssociateCustomerGateway(ctx context.Context, params *AssociateCustomerGatewayInput, optFns ...func(*Options)) (*AssociateCustomerGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateCustomerGateway", params, optFns, addOperationAssociateCustomerGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateCustomerGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
