...
func (c *Client) GetLinkAssociations(ctx context.Context, params *GetLinkAssociationsInput, optFns ...func(*Options)) (*GetLinkAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLinkAssociations", params, optFns, addOperationGetLinkAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLinkAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
