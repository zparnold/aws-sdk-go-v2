...
func (c *Client) DisassociateLink(ctx context.Context, params *DisassociateLinkInput, optFns ...func(*Options)) (*DisassociateLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateLink", params, optFns, addOperationDisassociateLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
