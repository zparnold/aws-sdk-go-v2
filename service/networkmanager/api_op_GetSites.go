...
func (c *Client) GetSites(ctx context.Context, params *GetSitesInput, optFns ...func(*Options)) (*GetSitesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSites", params, optFns, addOperationGetSitesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSitesMiddleware(stack *middleware.Stack, options Options) (err error) {
