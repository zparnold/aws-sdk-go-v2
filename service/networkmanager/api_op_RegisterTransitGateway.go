...
func (c *Client) RegisterTransitGateway(ctx context.Context, params *RegisterTransitGatewayInput, optFns ...func(*Options)) (*RegisterTransitGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterTransitGateway", params, optFns, addOperationRegisterTransitGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterTransitGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
