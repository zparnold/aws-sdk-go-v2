...
func (c *Client) CreateLink(ctx context.Context, params *CreateLinkInput, optFns ...func(*Options)) (*CreateLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLink", params, optFns, addOperationCreateLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
