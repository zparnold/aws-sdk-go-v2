...
func (c *Client) DeleteDevice(ctx context.Context, params *DeleteDeviceInput, optFns ...func(*Options)) (*DeleteDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDevice", params, optFns, addOperationDeleteDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
