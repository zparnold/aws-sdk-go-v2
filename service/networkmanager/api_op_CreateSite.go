...
func (c *Client) CreateSite(ctx context.Context, params *CreateSiteInput, optFns ...func(*Options)) (*CreateSiteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSite", params, optFns, addOperationCreateSiteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSiteMiddleware(stack *middleware.Stack, options Options) (err error) {
