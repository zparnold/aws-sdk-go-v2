...
func (c *Client) CreateDevice(ctx context.Context, params *CreateDeviceInput, optFns ...func(*Options)) (*CreateDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDevice", params, optFns, addOperationCreateDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
