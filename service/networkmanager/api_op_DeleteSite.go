...
func (c *Client) DeleteSite(ctx context.Context, params *DeleteSiteInput, optFns ...func(*Options)) (*DeleteSiteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSite", params, optFns, addOperationDeleteSiteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSiteMiddleware(stack *middleware.Stack, options Options) (err error) {
