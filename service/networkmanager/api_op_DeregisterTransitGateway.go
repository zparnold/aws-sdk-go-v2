...
func (c *Client) DeregisterTransitGateway(ctx context.Context, params *DeregisterTransitGatewayInput, optFns ...func(*Options)) (*DeregisterTransitGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterTransitGateway", params, optFns, addOperationDeregisterTransitGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterTransitGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
