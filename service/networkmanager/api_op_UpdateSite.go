...
func (c *Client) UpdateSite(ctx context.Context, params *UpdateSiteInput, optFns ...func(*Options)) (*UpdateSiteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSite", params, optFns, addOperationUpdateSiteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSiteMiddleware(stack *middleware.Stack, options Options) (err error) {
