...
func (c *Client) GetDevices(ctx context.Context, params *GetDevicesInput, optFns ...func(*Options)) (*GetDevicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDevices", params, optFns, addOperationGetDevicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDevicesMiddleware(stack *middleware.Stack, options Options) (err error) {
