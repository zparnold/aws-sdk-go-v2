...
func (c *Client) GetTransitGatewayRegistrations(ctx context.Context, params *GetTransitGatewayRegistrationsInput, optFns ...func(*Options)) (*GetTransitGatewayRegistrationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTransitGatewayRegistrations", params, optFns, addOperationGetTransitGatewayRegistrationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTransitGatewayRegistrationsMiddleware(stack *middleware.Stack, options Options) (err error) {
