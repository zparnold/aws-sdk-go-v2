...
func (c *Client) UpdateDevice(ctx context.Context, params *UpdateDeviceInput, optFns ...func(*Options)) (*UpdateDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDevice", params, optFns, addOperationUpdateDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
