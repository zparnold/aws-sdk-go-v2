...
func (c *Client) DisassociateCustomerGateway(ctx context.Context, params *DisassociateCustomerGatewayInput, optFns ...func(*Options)) (*DisassociateCustomerGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateCustomerGateway", params, optFns, addOperationDisassociateCustomerGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateCustomerGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
