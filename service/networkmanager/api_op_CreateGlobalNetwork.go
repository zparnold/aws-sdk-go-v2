...
func (c *Client) CreateGlobalNetwork(ctx context.Context, params *CreateGlobalNetworkInput, optFns ...func(*Options)) (*CreateGlobalNetworkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGlobalNetwork", params, optFns, addOperationCreateGlobalNetworkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGlobalNetworkMiddleware(stack *middleware.Stack, options Options) (err error) {
