...
func (c *Client) DeleteLink(ctx context.Context, params *DeleteLinkInput, optFns ...func(*Options)) (*DeleteLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLink", params, optFns, addOperationDeleteLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
