...
func (c *Client) DescribeGlobalNetworks(ctx context.Context, params *DescribeGlobalNetworksInput, optFns ...func(*Options)) (*DescribeGlobalNetworksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGlobalNetworks", params, optFns, addOperationDescribeGlobalNetworksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGlobalNetworksMiddleware(stack *middleware.Stack, options Options) (err error) {
