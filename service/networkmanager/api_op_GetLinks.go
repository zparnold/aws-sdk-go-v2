...
func (c *Client) GetLinks(ctx context.Context, params *GetLinksInput, optFns ...func(*Options)) (*GetLinksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLinks", params, optFns, addOperationGetLinksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLinksMiddleware(stack *middleware.Stack, options Options) (err error) {
