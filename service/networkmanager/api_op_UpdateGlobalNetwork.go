...
func (c *Client) UpdateGlobalNetwork(ctx context.Context, params *UpdateGlobalNetworkInput, optFns ...func(*Options)) (*UpdateGlobalNetworkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGlobalNetwork", params, optFns, addOperationUpdateGlobalNetworkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGlobalNetworkMiddleware(stack *middleware.Stack, options Options) (err error) {
