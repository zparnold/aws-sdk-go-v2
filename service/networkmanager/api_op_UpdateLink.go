...
func (c *Client) UpdateLink(ctx context.Context, params *UpdateLinkInput, optFns ...func(*Options)) (*UpdateLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLink", params, optFns, addOperationUpdateLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
