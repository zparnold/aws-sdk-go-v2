...
func (c *Client) AssociateLink(ctx context.Context, params *AssociateLinkInput, optFns ...func(*Options)) (*AssociateLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateLink", params, optFns, addOperationAssociateLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
