...
func (c *Client) GetFinding(ctx context.Context, params *GetFindingInput, optFns ...func(*Options)) (*GetFindingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFinding", params, optFns, addOperationGetFindingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFindingMiddleware(stack *middleware.Stack, options Options) (err error) {
