...
func (c *Client) DeleteAnalyzer(ctx context.Context, params *DeleteAnalyzerInput, optFns ...func(*Options)) (*DeleteAnalyzerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAnalyzer", params, optFns, addOperationDeleteAnalyzerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAnalyzerMiddleware(stack *middleware.Stack, options Options) (err error) {
