...
func (c *Client) UpdateFindings(ctx context.Context, params *UpdateFindingsInput, optFns ...func(*Options)) (*UpdateFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFindings", params, optFns, addOperationUpdateFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
