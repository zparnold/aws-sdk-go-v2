...
func (c *Client) CreateAnalyzer(ctx context.Context, params *CreateAnalyzerInput, optFns ...func(*Options)) (*CreateAnalyzerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAnalyzer", params, optFns, addOperationCreateAnalyzerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAnalyzerMiddleware(stack *middleware.Stack, options Options) (err error) {
