...
func (c *Client) StartResourceScan(ctx context.Context, params *StartResourceScanInput, optFns ...func(*Options)) (*StartResourceScanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartResourceScan", params, optFns, addOperationStartResourceScanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartResourceScanMiddleware(stack *middleware.Stack, options Options) (err error) {
