...
func (c *Client) GetAnalyzedResource(ctx context.Context, params *GetAnalyzedResourceInput, optFns ...func(*Options)) (*GetAnalyzedResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAnalyzedResource", params, optFns, addOperationGetAnalyzedResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAnalyzedResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
