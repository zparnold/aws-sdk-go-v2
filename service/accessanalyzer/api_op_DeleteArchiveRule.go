...
func (c *Client) DeleteArchiveRule(ctx context.Context, params *DeleteArchiveRuleInput, optFns ...func(*Options)) (*DeleteArchiveRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteArchiveRule", params, optFns, addOperationDeleteArchiveRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteArchiveRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
