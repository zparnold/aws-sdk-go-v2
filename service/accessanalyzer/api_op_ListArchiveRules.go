...
func (c *Client) ListArchiveRules(ctx context.Context, params *ListArchiveRulesInput, optFns ...func(*Options)) (*ListArchiveRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListArchiveRules", params, optFns, addOperationListArchiveRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListArchiveRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
