...
func (c *Client) ListAnalyzers(ctx context.Context, params *ListAnalyzersInput, optFns ...func(*Options)) (*ListAnalyzersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAnalyzers", params, optFns, addOperationListAnalyzersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAnalyzersMiddleware(stack *middleware.Stack, options Options) (err error) {
