...
func (c *Client) CreateArchiveRule(ctx context.Context, params *CreateArchiveRuleInput, optFns ...func(*Options)) (*CreateArchiveRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateArchiveRule", params, optFns, addOperationCreateArchiveRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateArchiveRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
