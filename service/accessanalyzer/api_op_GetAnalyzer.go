...
func (c *Client) GetAnalyzer(ctx context.Context, params *GetAnalyzerInput, optFns ...func(*Options)) (*GetAnalyzerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAnalyzer", params, optFns, addOperationGetAnalyzerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAnalyzerMiddleware(stack *middleware.Stack, options Options) (err error) {
