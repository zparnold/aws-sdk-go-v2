...
func (c *Client) ListStateMachines(ctx context.Context, params *ListStateMachinesInput, optFns ...func(*Options)) (*ListStateMachinesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStateMachines", params, optFns, addOperationListStateMachinesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStateMachinesMiddleware(stack *middleware.Stack, options Options) (err error) {
