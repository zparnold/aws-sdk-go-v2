...
func (c *Client) ListExecutions(ctx context.Context, params *ListExecutionsInput, optFns ...func(*Options)) (*ListExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListExecutions", params, optFns, addOperationListExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
