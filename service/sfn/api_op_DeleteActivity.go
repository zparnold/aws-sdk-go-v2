...
func (c *Client) DeleteActivity(ctx context.Context, params *DeleteActivityInput, optFns ...func(*Options)) (*DeleteActivityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteActivity", params, optFns, addOperationDeleteActivityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteActivityMiddleware(stack *middleware.Stack, options Options) (err error) {
