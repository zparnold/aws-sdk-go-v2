...
func (c *Client) SendTaskHeartbeat(ctx context.Context, params *SendTaskHeartbeatInput, optFns ...func(*Options)) (*SendTaskHeartbeatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendTaskHeartbeat", params, optFns, addOperationSendTaskHeartbeatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendTaskHeartbeatMiddleware(stack *middleware.Stack, options Options) (err error) {
