...
func (c *Client) GetActivityTask(ctx context.Context, params *GetActivityTaskInput, optFns ...func(*Options)) (*GetActivityTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetActivityTask", params, optFns, addOperationGetActivityTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetActivityTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
