...
func (c *Client) SendTaskSuccess(ctx context.Context, params *SendTaskSuccessInput, optFns ...func(*Options)) (*SendTaskSuccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendTaskSuccess", params, optFns, addOperationSendTaskSuccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendTaskSuccessMiddleware(stack *middleware.Stack, options Options) (err error) {
