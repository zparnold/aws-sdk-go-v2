...
func (c *Client) DescribeStateMachine(ctx context.Context, params *DescribeStateMachineInput, optFns ...func(*Options)) (*DescribeStateMachineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStateMachine", params, optFns, addOperationDescribeStateMachineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStateMachineMiddleware(stack *middleware.Stack, options Options) (err error) {
