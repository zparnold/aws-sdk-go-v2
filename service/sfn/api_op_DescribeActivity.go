...
func (c *Client) DescribeActivity(ctx context.Context, params *DescribeActivityInput, optFns ...func(*Options)) (*DescribeActivityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeActivity", params, optFns, addOperationDescribeActivityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeActivityMiddleware(stack *middleware.Stack, options Options) (err error) {
