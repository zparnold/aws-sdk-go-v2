...
func (c *Client) ListActivities(ctx context.Context, params *ListActivitiesInput, optFns ...func(*Options)) (*ListActivitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListActivities", params, optFns, addOperationListActivitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListActivitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
