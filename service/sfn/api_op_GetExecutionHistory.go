...
func (c *Client) GetExecutionHistory(ctx context.Context, params *GetExecutionHistoryInput, optFns ...func(*Options)) (*GetExecutionHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetExecutionHistory", params, optFns, addOperationGetExecutionHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetExecutionHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
