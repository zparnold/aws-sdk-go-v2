...
func (c *Client) CreateStateMachine(ctx context.Context, params *CreateStateMachineInput, optFns ...func(*Options)) (*CreateStateMachineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStateMachine", params, optFns, addOperationCreateStateMachineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStateMachineMiddleware(stack *middleware.Stack, options Options) (err error) {
