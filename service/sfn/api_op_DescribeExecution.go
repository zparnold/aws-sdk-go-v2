...
func (c *Client) DescribeExecution(ctx context.Context, params *DescribeExecutionInput, optFns ...func(*Options)) (*DescribeExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeExecution", params, optFns, addOperationDescribeExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
