...
func (c *Client) SendTaskFailure(ctx context.Context, params *SendTaskFailureInput, optFns ...func(*Options)) (*SendTaskFailureOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendTaskFailure", params, optFns, addOperationSendTaskFailureMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendTaskFailureMiddleware(stack *middleware.Stack, options Options) (err error) {
