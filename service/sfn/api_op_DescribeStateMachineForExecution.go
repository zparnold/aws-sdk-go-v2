...
func (c *Client) DescribeStateMachineForExecution(ctx context.Context, params *DescribeStateMachineForExecutionInput, optFns ...func(*Options)) (*DescribeStateMachineForExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStateMachineForExecution", params, optFns, addOperationDescribeStateMachineForExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStateMachineForExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
