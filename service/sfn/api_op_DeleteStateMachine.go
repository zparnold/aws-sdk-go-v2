...
func (c *Client) DeleteStateMachine(ctx context.Context, params *DeleteStateMachineInput, optFns ...func(*Options)) (*DeleteStateMachineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStateMachine", params, optFns, addOperationDeleteStateMachineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStateMachineMiddleware(stack *middleware.Stack, options Options) (err error) {
