...
func (c *Client) GetSystemTemplate(ctx context.Context, params *GetSystemTemplateInput, optFns ...func(*Options)) (*GetSystemTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSystemTemplate", params, optFns, addOperationGetSystemTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSystemTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
