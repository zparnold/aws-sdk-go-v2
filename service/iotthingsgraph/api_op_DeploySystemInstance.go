...
func (c *Client) DeploySystemInstance(ctx context.Context, params *DeploySystemInstanceInput, optFns ...func(*Options)) (*DeploySystemInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeploySystemInstance", params, optFns, addOperationDeploySystemInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeploySystemInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
