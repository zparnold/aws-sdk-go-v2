...
func (c *Client) GetFlowTemplateRevisions(ctx context.Context, params *GetFlowTemplateRevisionsInput, optFns ...func(*Options)) (*GetFlowTemplateRevisionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFlowTemplateRevisions", params, optFns, addOperationGetFlowTemplateRevisionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFlowTemplateRevisionsMiddleware(stack *middleware.Stack, options Options) (err error) {
