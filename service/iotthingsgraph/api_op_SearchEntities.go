...
func (c *Client) SearchEntities(ctx context.Context, params *SearchEntitiesInput, optFns ...func(*Options)) (*SearchEntitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchEntities", params, optFns, addOperationSearchEntitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchEntitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
