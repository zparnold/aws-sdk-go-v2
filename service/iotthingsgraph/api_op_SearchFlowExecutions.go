...
func (c *Client) SearchFlowExecutions(ctx context.Context, params *SearchFlowExecutionsInput, optFns ...func(*Options)) (*SearchFlowExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchFlowExecutions", params, optFns, addOperationSearchFlowExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchFlowExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
