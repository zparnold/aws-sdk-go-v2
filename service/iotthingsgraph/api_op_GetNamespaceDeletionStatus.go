...
func (c *Client) GetNamespaceDeletionStatus(ctx context.Context, params *GetNamespaceDeletionStatusInput, optFns ...func(*Options)) (*GetNamespaceDeletionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetNamespaceDeletionStatus", params, optFns, addOperationGetNamespaceDeletionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetNamespaceDeletionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
