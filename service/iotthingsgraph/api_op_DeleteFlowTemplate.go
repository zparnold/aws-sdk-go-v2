...
func (c *Client) DeleteFlowTemplate(ctx context.Context, params *DeleteFlowTemplateInput, optFns ...func(*Options)) (*DeleteFlowTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFlowTemplate", params, optFns, addOperationDeleteFlowTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFlowTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
