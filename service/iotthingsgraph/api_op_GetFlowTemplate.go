...
func (c *Client) GetFlowTemplate(ctx context.Context, params *GetFlowTemplateInput, optFns ...func(*Options)) (*GetFlowTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFlowTemplate", params, optFns, addOperationGetFlowTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFlowTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
