...
func (c *Client) UploadEntityDefinitions(ctx context.Context, params *UploadEntityDefinitionsInput, optFns ...func(*Options)) (*UploadEntityDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadEntityDefinitions", params, optFns, addOperationUploadEntityDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadEntityDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
