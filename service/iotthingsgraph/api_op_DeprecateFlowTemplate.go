...
func (c *Client) DeprecateFlowTemplate(ctx context.Context, params *DeprecateFlowTemplateInput, optFns ...func(*Options)) (*DeprecateFlowTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeprecateFlowTemplate", params, optFns, addOperationDeprecateFlowTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeprecateFlowTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
