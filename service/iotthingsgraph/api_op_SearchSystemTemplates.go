...
func (c *Client) SearchSystemTemplates(ctx context.Context, params *SearchSystemTemplatesInput, optFns ...func(*Options)) (*SearchSystemTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchSystemTemplates", params, optFns, addOperationSearchSystemTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchSystemTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
