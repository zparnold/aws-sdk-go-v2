...
func (c *Client) SearchSystemInstances(ctx context.Context, params *SearchSystemInstancesInput, optFns ...func(*Options)) (*SearchSystemInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchSystemInstances", params, optFns, addOperationSearchSystemInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchSystemInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
