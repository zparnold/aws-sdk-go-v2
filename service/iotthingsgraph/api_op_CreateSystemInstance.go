...
func (c *Client) CreateSystemInstance(ctx context.Context, params *CreateSystemInstanceInput, optFns ...func(*Options)) (*CreateSystemInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSystemInstance", params, optFns, addOperationCreateSystemInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSystemInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
