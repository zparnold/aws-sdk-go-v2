...
func (c *Client) UpdateFlowTemplate(ctx context.Context, params *UpdateFlowTemplateInput, optFns ...func(*Options)) (*UpdateFlowTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFlowTemplate", params, optFns, addOperationUpdateFlowTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFlowTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
