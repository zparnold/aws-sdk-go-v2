...
func (c *Client) GetSystemInstance(ctx context.Context, params *GetSystemInstanceInput, optFns ...func(*Options)) (*GetSystemInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSystemInstance", params, optFns, addOperationGetSystemInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSystemInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
