...
func (c *Client) SearchThings(ctx context.Context, params *SearchThingsInput, optFns ...func(*Options)) (*SearchThingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchThings", params, optFns, addOperationSearchThingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchThingsMiddleware(stack *middleware.Stack, options Options) (err error) {
