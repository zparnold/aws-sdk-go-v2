...
func (c *Client) CreateSystemTemplate(ctx context.Context, params *CreateSystemTemplateInput, optFns ...func(*Options)) (*CreateSystemTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSystemTemplate", params, optFns, addOperationCreateSystemTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSystemTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
