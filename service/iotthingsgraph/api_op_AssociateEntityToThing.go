...
func (c *Client) AssociateEntityToThing(ctx context.Context, params *AssociateEntityToThingInput, optFns ...func(*Options)) (*AssociateEntityToThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateEntityToThing", params, optFns, addOperationAssociateEntityToThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateEntityToThingMiddleware(stack *middleware.Stack, options Options) (err error) {
