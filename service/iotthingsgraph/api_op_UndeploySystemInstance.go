...
func (c *Client) UndeploySystemInstance(ctx context.Context, params *UndeploySystemInstanceInput, optFns ...func(*Options)) (*UndeploySystemInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UndeploySystemInstance", params, optFns, addOperationUndeploySystemInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUndeploySystemInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
