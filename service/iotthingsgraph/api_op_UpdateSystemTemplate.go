...
func (c *Client) UpdateSystemTemplate(ctx context.Context, params *UpdateSystemTemplateInput, optFns ...func(*Options)) (*UpdateSystemTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSystemTemplate", params, optFns, addOperationUpdateSystemTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSystemTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
