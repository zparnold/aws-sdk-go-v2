...
func (c *Client) CreateFlowTemplate(ctx context.Context, params *CreateFlowTemplateInput, optFns ...func(*Options)) (*CreateFlowTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFlowTemplate", params, optFns, addOperationCreateFlowTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFlowTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
