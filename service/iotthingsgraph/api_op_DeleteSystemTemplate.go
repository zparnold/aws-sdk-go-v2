...
func (c *Client) DeleteSystemTemplate(ctx context.Context, params *DeleteSystemTemplateInput, optFns ...func(*Options)) (*DeleteSystemTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSystemTemplate", params, optFns, addOperationDeleteSystemTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSystemTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
