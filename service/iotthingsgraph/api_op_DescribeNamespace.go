...
func (c *Client) DescribeNamespace(ctx context.Context, params *DescribeNamespaceInput, optFns ...func(*Options)) (*DescribeNamespaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNamespace", params, optFns, addOperationDescribeNamespaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNamespaceMiddleware(stack *middleware.Stack, options Options) (err error) {
