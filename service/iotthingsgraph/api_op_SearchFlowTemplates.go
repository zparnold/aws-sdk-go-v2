...
func (c *Client) SearchFlowTemplates(ctx context.Context, params *SearchFlowTemplatesInput, optFns ...func(*Options)) (*SearchFlowTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchFlowTemplates", params, optFns, addOperationSearchFlowTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchFlowTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
