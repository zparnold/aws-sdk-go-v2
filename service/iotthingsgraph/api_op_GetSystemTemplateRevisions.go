...
func (c *Client) GetSystemTemplateRevisions(ctx context.Context, params *GetSystemTemplateRevisionsInput, optFns ...func(*Options)) (*GetSystemTemplateRevisionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSystemTemplateRevisions", params, optFns, addOperationGetSystemTemplateRevisionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSystemTemplateRevisionsMiddleware(stack *middleware.Stack, options Options) (err error) {
