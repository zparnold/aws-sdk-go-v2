...
func (c *Client) DeprecateSystemTemplate(ctx context.Context, params *DeprecateSystemTemplateInput, optFns ...func(*Options)) (*DeprecateSystemTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeprecateSystemTemplate", params, optFns, addOperationDeprecateSystemTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeprecateSystemTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
