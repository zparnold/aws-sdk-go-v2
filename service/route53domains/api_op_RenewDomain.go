...
func (c *Client) RenewDomain(ctx context.Context, params *RenewDomainInput, optFns ...func(*Options)) (*RenewDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RenewDomain", params, optFns, addOperationRenewDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRenewDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
