...
func (c *Client) RejectDomainTransferFromAnotherAwsAccount(ctx context.Context, params *RejectDomainTransferFromAnotherAwsAccountInput, optFns ...func(*Options)) (*RejectDomainTransferFromAnotherAwsAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectDomainTransferFromAnotherAwsAccount", params, optFns, addOperationRejectDomainTransferFromAnotherAwsAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectDomainTransferFromAnotherAwsAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
