...
func (c *Client) EnableDomainAutoRenew(ctx context.Context, params *EnableDomainAutoRenewInput, optFns ...func(*Options)) (*EnableDomainAutoRenewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableDomainAutoRenew", params, optFns, addOperationEnableDomainAutoRenewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableDomainAutoRenewMiddleware(stack *middleware.Stack, options Options) (err error) {
