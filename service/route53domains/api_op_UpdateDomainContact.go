...
func (c *Client) UpdateDomainContact(ctx context.Context, params *UpdateDomainContactInput, optFns ...func(*Options)) (*UpdateDomainContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomainContact", params, optFns, addOperationUpdateDomainContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainContactMiddleware(stack *middleware.Stack, options Options) (err error) {
