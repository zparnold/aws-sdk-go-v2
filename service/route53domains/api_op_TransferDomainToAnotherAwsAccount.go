...
func (c *Client) TransferDomainToAnotherAwsAccount(ctx context.Context, params *TransferDomainToAnotherAwsAccountInput, optFns ...func(*Options)) (*TransferDomainToAnotherAwsAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TransferDomainToAnotherAwsAccount", params, optFns, addOperationTransferDomainToAnotherAwsAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTransferDomainToAnotherAwsAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
