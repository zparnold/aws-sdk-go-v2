...
func (c *Client) ResendContactReachabilityEmail(ctx context.Context, params *ResendContactReachabilityEmailInput, optFns ...func(*Options)) (*ResendContactReachabilityEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResendContactReachabilityEmail", params, optFns, addOperationResendContactReachabilityEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResendContactReachabilityEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
