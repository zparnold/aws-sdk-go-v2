...
func (c *Client) UpdateDomainNameservers(ctx context.Context, params *UpdateDomainNameserversInput, optFns ...func(*Options)) (*UpdateDomainNameserversOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomainNameservers", params, optFns, addOperationUpdateDomainNameserversMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainNameserversMiddleware(stack *middleware.Stack, options Options) (err error) {
