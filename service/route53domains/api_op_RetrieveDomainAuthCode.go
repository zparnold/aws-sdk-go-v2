...
func (c *Client) RetrieveDomainAuthCode(ctx context.Context, params *RetrieveDomainAuthCodeInput, optFns ...func(*Options)) (*RetrieveDomainAuthCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetrieveDomainAuthCode", params, optFns, addOperationRetrieveDomainAuthCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetrieveDomainAuthCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
