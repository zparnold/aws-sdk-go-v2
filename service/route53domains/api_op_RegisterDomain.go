...
func (c *Client) RegisterDomain(ctx context.Context, params *RegisterDomainInput, optFns ...func(*Options)) (*RegisterDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterDomain", params, optFns, addOperationRegisterDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
