...
func (c *Client) GetDomainSuggestions(ctx context.Context, params *GetDomainSuggestionsInput, optFns ...func(*Options)) (*GetDomainSuggestionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainSuggestions", params, optFns, addOperationGetDomainSuggestionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainSuggestionsMiddleware(stack *middleware.Stack, options Options) (err error) {
