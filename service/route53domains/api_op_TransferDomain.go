...
func (c *Client) TransferDomain(ctx context.Context, params *TransferDomainInput, optFns ...func(*Options)) (*TransferDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TransferDomain", params, optFns, addOperationTransferDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTransferDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
