...
func (c *Client) DisableDomainTransferLock(ctx context.Context, params *DisableDomainTransferLockInput, optFns ...func(*Options)) (*DisableDomainTransferLockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableDomainTransferLock", params, optFns, addOperationDisableDomainTransferLockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableDomainTransferLockMiddleware(stack *middleware.Stack, options Options) (err error) {
