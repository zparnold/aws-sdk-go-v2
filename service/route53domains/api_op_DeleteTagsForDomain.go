...
func (c *Client) DeleteTagsForDomain(ctx context.Context, params *DeleteTagsForDomainInput, optFns ...func(*Options)) (*DeleteTagsForDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTagsForDomain", params, optFns, addOperationDeleteTagsForDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTagsForDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
