...
func (c *Client) DisableDomainAutoRenew(ctx context.Context, params *DisableDomainAutoRenewInput, optFns ...func(*Options)) (*DisableDomainAutoRenewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableDomainAutoRenew", params, optFns, addOperationDisableDomainAutoRenewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableDomainAutoRenewMiddleware(stack *middleware.Stack, options Options) (err error) {
