...
func (c *Client) GetDomainDetail(ctx context.Context, params *GetDomainDetailInput, optFns ...func(*Options)) (*GetDomainDetailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainDetail", params, optFns, addOperationGetDomainDetailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainDetailMiddleware(stack *middleware.Stack, options Options) (err error) {
