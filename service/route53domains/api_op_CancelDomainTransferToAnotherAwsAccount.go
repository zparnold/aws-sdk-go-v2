...
func (c *Client) CancelDomainTransferToAnotherAwsAccount(ctx context.Context, params *CancelDomainTransferToAnotherAwsAccountInput, optFns ...func(*Options)) (*CancelDomainTransferToAnotherAwsAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelDomainTransferToAnotherAwsAccount", params, optFns, addOperationCancelDomainTransferToAnotherAwsAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelDomainTransferToAnotherAwsAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
