...
func (c *Client) GetOperationDetail(ctx context.Context, params *GetOperationDetailInput, optFns ...func(*Options)) (*GetOperationDetailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOperationDetail", params, optFns, addOperationGetOperationDetailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOperationDetailMiddleware(stack *middleware.Stack, options Options) (err error) {
