...
func (c *Client) UpdateDomainContactPrivacy(ctx context.Context, params *UpdateDomainContactPrivacyInput, optFns ...func(*Options)) (*UpdateDomainContactPrivacyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomainContactPrivacy", params, optFns, addOperationUpdateDomainContactPrivacyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainContactPrivacyMiddleware(stack *middleware.Stack, options Options) (err error) {
