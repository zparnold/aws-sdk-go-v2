...
func (c *Client) ListTagsForDomain(ctx context.Context, params *ListTagsForDomainInput, optFns ...func(*Options)) (*ListTagsForDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForDomain", params, optFns, addOperationListTagsForDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
