...
func (c *Client) CheckDomainAvailability(ctx context.Context, params *CheckDomainAvailabilityInput, optFns ...func(*Options)) (*CheckDomainAvailabilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CheckDomainAvailability", params, optFns, addOperationCheckDomainAvailabilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCheckDomainAvailabilityMiddleware(stack *middleware.Stack, options Options) (err error) {
