...
func (c *Client) UpdateTagsForDomain(ctx context.Context, params *UpdateTagsForDomainInput, optFns ...func(*Options)) (*UpdateTagsForDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTagsForDomain", params, optFns, addOperationUpdateTagsForDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTagsForDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
