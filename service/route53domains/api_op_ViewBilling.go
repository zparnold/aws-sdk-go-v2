...
func (c *Client) ViewBilling(ctx context.Context, params *ViewBillingInput, optFns ...func(*Options)) (*ViewBillingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ViewBilling", params, optFns, addOperationViewBillingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationViewBillingMiddleware(stack *middleware.Stack, options Options) (err error) {
