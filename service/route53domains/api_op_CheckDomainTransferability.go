...
func (c *Client) CheckDomainTransferability(ctx context.Context, params *CheckDomainTransferabilityInput, optFns ...func(*Options)) (*CheckDomainTransferabilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CheckDomainTransferability", params, optFns, addOperationCheckDomainTransferabilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCheckDomainTransferabilityMiddleware(stack *middleware.Stack, options Options) (err error) {
