...
func (c *Client) GetContactReachabilityStatus(ctx context.Context, params *GetContactReachabilityStatusInput, optFns ...func(*Options)) (*GetContactReachabilityStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetContactReachabilityStatus", params, optFns, addOperationGetContactReachabilityStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetContactReachabilityStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
