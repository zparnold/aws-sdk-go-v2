...
func (c *Client) AcceptDomainTransferFromAnotherAwsAccount(ctx context.Context, params *AcceptDomainTransferFromAnotherAwsAccountInput, optFns ...func(*Options)) (*AcceptDomainTransferFromAnotherAwsAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptDomainTransferFromAnotherAwsAccount", params, optFns, addOperationAcceptDomainTransferFromAnotherAwsAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptDomainTransferFromAnotherAwsAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
