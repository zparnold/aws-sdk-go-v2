...
func (c *Client) EnableDomainTransferLock(ctx context.Context, params *EnableDomainTransferLockInput, optFns ...func(*Options)) (*EnableDomainTransferLockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableDomainTransferLock", params, optFns, addOperationEnableDomainTransferLockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableDomainTransferLockMiddleware(stack *middleware.Stack, options Options) (err error) {
