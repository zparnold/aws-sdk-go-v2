...
func (c *Client) DeleteMailboxPermissions(ctx context.Context, params *DeleteMailboxPermissionsInput, optFns ...func(*Options)) (*DeleteMailboxPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMailboxPermissions", params, optFns, addOperationDeleteMailboxPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMailboxPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
