...
func (c *Client) PutMailboxPermissions(ctx context.Context, params *PutMailboxPermissionsInput, optFns ...func(*Options)) (*PutMailboxPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMailboxPermissions", params, optFns, addOperationPutMailboxPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMailboxPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
