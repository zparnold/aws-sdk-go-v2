...
func (c *Client) DisassociateMemberFromGroup(ctx context.Context, params *DisassociateMemberFromGroupInput, optFns ...func(*Options)) (*DisassociateMemberFromGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateMemberFromGroup", params, optFns, addOperationDisassociateMemberFromGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateMemberFromGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
