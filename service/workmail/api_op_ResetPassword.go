...
func (c *Client) ResetPassword(ctx context.Context, params *ResetPasswordInput, optFns ...func(*Options)) (*ResetPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetPassword", params, optFns, addOperationResetPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
