...
func (c *Client) RegisterToWorkMail(ctx context.Context, params *RegisterToWorkMailInput, optFns ...func(*Options)) (*RegisterToWorkMailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterToWorkMail", params, optFns, addOperationRegisterToWorkMailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterToWorkMailMiddleware(stack *middleware.Stack, options Options) (err error) {
