...
func (c *Client) DeregisterFromWorkMail(ctx context.Context, params *DeregisterFromWorkMailInput, optFns ...func(*Options)) (*DeregisterFromWorkMailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterFromWorkMail", params, optFns, addOperationDeregisterFromWorkMailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterFromWorkMailMiddleware(stack *middleware.Stack, options Options) (err error) {
