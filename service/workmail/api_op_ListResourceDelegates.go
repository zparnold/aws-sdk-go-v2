...
func (c *Client) ListResourceDelegates(ctx context.Context, params *ListResourceDelegatesInput, optFns ...func(*Options)) (*ListResourceDelegatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceDelegates", params, optFns, addOperationListResourceDelegatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceDelegatesMiddleware(stack *middleware.Stack, options Options) (err error) {
