...
func (c *Client) AssociateMemberToGroup(ctx context.Context, params *AssociateMemberToGroupInput, optFns ...func(*Options)) (*AssociateMemberToGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateMemberToGroup", params, optFns, addOperationAssociateMemberToGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateMemberToGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
