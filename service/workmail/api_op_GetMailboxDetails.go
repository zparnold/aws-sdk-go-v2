...
func (c *Client) GetMailboxDetails(ctx context.Context, params *GetMailboxDetailsInput, optFns ...func(*Options)) (*GetMailboxDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMailboxDetails", params, optFns, addOperationGetMailboxDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMailboxDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
