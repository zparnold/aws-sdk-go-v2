...
func (c *Client) UpdateMailboxQuota(ctx context.Context, params *UpdateMailboxQuotaInput, optFns ...func(*Options)) (*UpdateMailboxQuotaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMailboxQuota", params, optFns, addOperationUpdateMailboxQuotaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMailboxQuotaMiddleware(stack *middleware.Stack, options Options) (err error) {
