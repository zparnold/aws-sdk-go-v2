...
func (c *Client) ListMailboxPermissions(ctx context.Context, params *ListMailboxPermissionsInput, optFns ...func(*Options)) (*ListMailboxPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMailboxPermissions", params, optFns, addOperationListMailboxPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMailboxPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
