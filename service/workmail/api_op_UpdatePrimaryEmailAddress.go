...
func (c *Client) UpdatePrimaryEmailAddress(ctx context.Context, params *UpdatePrimaryEmailAddressInput, optFns ...func(*Options)) (*UpdatePrimaryEmailAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePrimaryEmailAddress", params, optFns, addOperationUpdatePrimaryEmailAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePrimaryEmailAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
