...
func (c *Client) DescribeGroup(ctx context.Context, params *DescribeGroupInput, optFns ...func(*Options)) (*DescribeGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGroup", params, optFns, addOperationDescribeGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
