...
func (c *Client) AssociateDelegateToResource(ctx context.Context, params *AssociateDelegateToResourceInput, optFns ...func(*Options)) (*AssociateDelegateToResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateDelegateToResource", params, optFns, addOperationAssociateDelegateToResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateDelegateToResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
