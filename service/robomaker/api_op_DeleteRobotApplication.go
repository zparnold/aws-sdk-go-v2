...
func (c *Client) DeleteRobotApplication(ctx context.Context, params *DeleteRobotApplicationInput, optFns ...func(*Options)) (*DeleteRobotApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRobotApplication", params, optFns, addOperationDeleteRobotApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRobotApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
