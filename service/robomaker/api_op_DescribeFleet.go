...
func (c *Client) DescribeFleet(ctx context.Context, params *DescribeFleetInput, optFns ...func(*Options)) (*DescribeFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleet", params, optFns, addOperationDescribeFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
