...
func (c *Client) RegisterRobot(ctx context.Context, params *RegisterRobotInput, optFns ...func(*Options)) (*RegisterRobotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterRobot", params, optFns, addOperationRegisterRobotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterRobotMiddleware(stack *middleware.Stack, options Options) (err error) {
