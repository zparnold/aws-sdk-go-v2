...
func (c *Client) CreateRobot(ctx context.Context, params *CreateRobotInput, optFns ...func(*Options)) (*CreateRobotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRobot", params, optFns, addOperationCreateRobotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRobotMiddleware(stack *middleware.Stack, options Options) (err error) {
