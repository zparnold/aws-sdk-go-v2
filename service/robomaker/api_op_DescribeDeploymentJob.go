...
func (c *Client) DescribeDeploymentJob(ctx context.Context, params *DescribeDeploymentJobInput, optFns ...func(*Options)) (*DescribeDeploymentJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDeploymentJob", params, optFns, addOperationDescribeDeploymentJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDeploymentJobMiddleware(stack *middleware.Stack, options Options) (err error) {
