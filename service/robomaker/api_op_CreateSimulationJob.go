...
func (c *Client) CreateSimulationJob(ctx context.Context, params *CreateSimulationJobInput, optFns ...func(*Options)) (*CreateSimulationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSimulationJob", params, optFns, addOperationCreateSimulationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSimulationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
