...
func (c *Client) DescribeSimulationApplication(ctx context.Context, params *DescribeSimulationApplicationInput, optFns ...func(*Options)) (*DescribeSimulationApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSimulationApplication", params, optFns, addOperationDescribeSimulationApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSimulationApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
