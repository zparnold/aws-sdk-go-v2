...
func (c *Client) CreateRobotApplicationVersion(ctx context.Context, params *CreateRobotApplicationVersionInput, optFns ...func(*Options)) (*CreateRobotApplicationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRobotApplicationVersion", params, optFns, addOperationCreateRobotApplicationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRobotApplicationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
