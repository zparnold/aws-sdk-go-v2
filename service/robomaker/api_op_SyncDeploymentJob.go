...
func (c *Client) SyncDeploymentJob(ctx context.Context, params *SyncDeploymentJobInput, optFns ...func(*Options)) (*SyncDeploymentJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SyncDeploymentJob", params, optFns, addOperationSyncDeploymentJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSyncDeploymentJobMiddleware(stack *middleware.Stack, options Options) (err error) {
