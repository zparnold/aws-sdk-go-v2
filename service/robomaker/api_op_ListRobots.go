...
func (c *Client) ListRobots(ctx context.Context, params *ListRobotsInput, optFns ...func(*Options)) (*ListRobotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRobots", params, optFns, addOperationListRobotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRobotsMiddleware(stack *middleware.Stack, options Options) (err error) {
