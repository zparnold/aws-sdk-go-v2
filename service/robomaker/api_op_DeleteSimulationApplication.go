...
func (c *Client) DeleteSimulationApplication(ctx context.Context, params *DeleteSimulationApplicationInput, optFns ...func(*Options)) (*DeleteSimulationApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSimulationApplication", params, optFns, addOperationDeleteSimulationApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSimulationApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
