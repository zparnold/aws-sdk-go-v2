...
func (c *Client) CancelSimulationJob(ctx context.Context, params *CancelSimulationJobInput, optFns ...func(*Options)) (*CancelSimulationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelSimulationJob", params, optFns, addOperationCancelSimulationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelSimulationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
