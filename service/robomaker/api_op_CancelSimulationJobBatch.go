...
func (c *Client) CancelSimulationJobBatch(ctx context.Context, params *CancelSimulationJobBatchInput, optFns ...func(*Options)) (*CancelSimulationJobBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelSimulationJobBatch", params, optFns, addOperationCancelSimulationJobBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelSimulationJobBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
