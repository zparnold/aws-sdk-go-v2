...
func (c *Client) StartSimulationJobBatch(ctx context.Context, params *StartSimulationJobBatchInput, optFns ...func(*Options)) (*StartSimulationJobBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSimulationJobBatch", params, optFns, addOperationStartSimulationJobBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSimulationJobBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
