...
func (c *Client) CreateSimulationApplicationVersion(ctx context.Context, params *CreateSimulationApplicationVersionInput, optFns ...func(*Options)) (*CreateSimulationApplicationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSimulationApplicationVersion", params, optFns, addOperationCreateSimulationApplicationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSimulationApplicationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
