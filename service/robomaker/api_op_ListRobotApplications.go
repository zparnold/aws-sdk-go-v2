...
func (c *Client) ListRobotApplications(ctx context.Context, params *ListRobotApplicationsInput, optFns ...func(*Options)) (*ListRobotApplicationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRobotApplications", params, optFns, addOperationListRobotApplicationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRobotApplicationsMiddleware(stack *middleware.Stack, options Options) (err error) {
