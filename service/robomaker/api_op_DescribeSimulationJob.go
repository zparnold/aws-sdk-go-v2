...
func (c *Client) DescribeSimulationJob(ctx context.Context, params *DescribeSimulationJobInput, optFns ...func(*Options)) (*DescribeSimulationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSimulationJob", params, optFns, addOperationDescribeSimulationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSimulationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
