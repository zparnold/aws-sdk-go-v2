...
func (c *Client) UpdateSimulationApplication(ctx context.Context, params *UpdateSimulationApplicationInput, optFns ...func(*Options)) (*UpdateSimulationApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSimulationApplication", params, optFns, addOperationUpdateSimulationApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSimulationApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
