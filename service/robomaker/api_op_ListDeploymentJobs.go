...
func (c *Client) ListDeploymentJobs(ctx context.Context, params *ListDeploymentJobsInput, optFns ...func(*Options)) (*ListDeploymentJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeploymentJobs", params, optFns, addOperationListDeploymentJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeploymentJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
