...
func (c *Client) RestartSimulationJob(ctx context.Context, params *RestartSimulationJobInput, optFns ...func(*Options)) (*RestartSimulationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestartSimulationJob", params, optFns, addOperationRestartSimulationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestartSimulationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
