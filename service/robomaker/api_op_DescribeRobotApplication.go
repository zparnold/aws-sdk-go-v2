...
func (c *Client) DescribeRobotApplication(ctx context.Context, params *DescribeRobotApplicationInput, optFns ...func(*Options)) (*DescribeRobotApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRobotApplication", params, optFns, addOperationDescribeRobotApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRobotApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
