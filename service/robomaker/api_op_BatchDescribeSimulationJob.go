...
func (c *Client) BatchDescribeSimulationJob(ctx context.Context, params *BatchDescribeSimulationJobInput, optFns ...func(*Options)) (*BatchDescribeSimulationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDescribeSimulationJob", params, optFns, addOperationBatchDescribeSimulationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDescribeSimulationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
