...
func (c *Client) ListSimulationJobBatches(ctx context.Context, params *ListSimulationJobBatchesInput, optFns ...func(*Options)) (*ListSimulationJobBatchesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSimulationJobBatches", params, optFns, addOperationListSimulationJobBatchesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSimulationJobBatchesMiddleware(stack *middleware.Stack, options Options) (err error) {
