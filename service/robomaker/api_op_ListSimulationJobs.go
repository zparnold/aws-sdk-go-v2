...
func (c *Client) ListSimulationJobs(ctx context.Context, params *ListSimulationJobsInput, optFns ...func(*Options)) (*ListSimulationJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSimulationJobs", params, optFns, addOperationListSimulationJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSimulationJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
