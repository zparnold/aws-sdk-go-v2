...
func (c *Client) ListSimulationApplications(ctx context.Context, params *ListSimulationApplicationsInput, optFns ...func(*Options)) (*ListSimulationApplicationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSimulationApplications", params, optFns, addOperationListSimulationApplicationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSimulationApplicationsMiddleware(stack *middleware.Stack, options Options) (err error) {
