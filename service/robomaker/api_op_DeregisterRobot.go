...
func (c *Client) DeregisterRobot(ctx context.Context, params *DeregisterRobotInput, optFns ...func(*Options)) (*DeregisterRobotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterRobot", params, optFns, addOperationDeregisterRobotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterRobotMiddleware(stack *middleware.Stack, options Options) (err error) {
