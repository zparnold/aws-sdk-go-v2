...
func (c *Client) DescribeSimulationJobBatch(ctx context.Context, params *DescribeSimulationJobBatchInput, optFns ...func(*Options)) (*DescribeSimulationJobBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSimulationJobBatch", params, optFns, addOperationDescribeSimulationJobBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSimulationJobBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
