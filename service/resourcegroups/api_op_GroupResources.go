...
func (c *Client) GroupResources(ctx context.Context, params *GroupResourcesInput, optFns ...func(*Options)) (*GroupResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GroupResources", params, optFns, addOperationGroupResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGroupResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
