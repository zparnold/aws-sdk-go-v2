...
func (c *Client) GetGroupQuery(ctx context.Context, params *GetGroupQueryInput, optFns ...func(*Options)) (*GetGroupQueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroupQuery", params, optFns, addOperationGetGroupQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
