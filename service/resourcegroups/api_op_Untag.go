...
func (c *Client) Untag(ctx context.Context, params *UntagInput, optFns ...func(*Options)) (*UntagOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Untag", params, optFns, addOperationUntagMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagMiddleware(stack *middleware.Stack, options Options) (err error) {
