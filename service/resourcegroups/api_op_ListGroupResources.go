...
func (c *Client) ListGroupResources(ctx context.Context, params *ListGroupResourcesInput, optFns ...func(*Options)) (*ListGroupResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGroupResources", params, optFns, addOperationListGroupResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGroupResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
