...
func (c *Client) UngroupResources(ctx context.Context, params *UngroupResourcesInput, optFns ...func(*Options)) (*UngroupResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UngroupResources", params, optFns, addOperationUngroupResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUngroupResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
