...
func (c *Client) Tag(ctx context.Context, params *TagInput, optFns ...func(*Options)) (*TagOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Tag", params, optFns, addOperationTagMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagMiddleware(stack *middleware.Stack, options Options) (err error) {
