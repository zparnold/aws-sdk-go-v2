...
func (c *Client) GetGroupConfiguration(ctx context.Context, params *GetGroupConfigurationInput, optFns ...func(*Options)) (*GetGroupConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroupConfiguration", params, optFns, addOperationGetGroupConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
