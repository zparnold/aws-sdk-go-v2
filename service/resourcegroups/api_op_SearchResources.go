...
func (c *Client) SearchResources(ctx context.Context, params *SearchResourcesInput, optFns ...func(*Options)) (*SearchResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchResources", params, optFns, addOperationSearchResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
