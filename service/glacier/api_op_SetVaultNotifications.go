...
func (c *Client) SetVaultNotifications(ctx context.Context, params *SetVaultNotificationsInput, optFns ...func(*Options)) (*SetVaultNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetVaultNotifications", params, optFns, addOperationSetVaultNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetVaultNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
