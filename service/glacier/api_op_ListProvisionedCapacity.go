...
func (c *Client) ListProvisionedCapacity(ctx context.Context, params *ListProvisionedCapacityInput, optFns ...func(*Options)) (*ListProvisionedCapacityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProvisionedCapacity", params, optFns, addOperationListProvisionedCapacityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProvisionedCapacityMiddleware(stack *middleware.Stack, options Options) (err error) {
