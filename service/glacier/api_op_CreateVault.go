...
func (c *Client) CreateVault(ctx context.Context, params *CreateVaultInput, optFns ...func(*Options)) (*CreateVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVault", params, optFns, addOperationCreateVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
