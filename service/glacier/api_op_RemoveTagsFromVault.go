...
func (c *Client) RemoveTagsFromVault(ctx context.Context, params *RemoveTagsFromVaultInput, optFns ...func(*Options)) (*RemoveTagsFromVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveTagsFromVault", params, optFns, addOperationRemoveTagsFromVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveTagsFromVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
