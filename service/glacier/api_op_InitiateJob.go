...
func (c *Client) InitiateJob(ctx context.Context, params *InitiateJobInput, optFns ...func(*Options)) (*InitiateJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InitiateJob", params, optFns, addOperationInitiateJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInitiateJobMiddleware(stack *middleware.Stack, options Options) (err error) {
