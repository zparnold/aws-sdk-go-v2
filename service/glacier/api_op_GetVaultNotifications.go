...
func (c *Client) GetVaultNotifications(ctx context.Context, params *GetVaultNotificationsInput, optFns ...func(*Options)) (*GetVaultNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVaultNotifications", params, optFns, addOperationGetVaultNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVaultNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
