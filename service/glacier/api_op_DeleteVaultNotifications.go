...
func (c *Client) DeleteVaultNotifications(ctx context.Context, params *DeleteVaultNotificationsInput, optFns ...func(*Options)) (*DeleteVaultNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVaultNotifications", params, optFns, addOperationDeleteVaultNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVaultNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
