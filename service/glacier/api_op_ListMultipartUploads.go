...
func (c *Client) ListMultipartUploads(ctx context.Context, params *ListMultipartUploadsInput, optFns ...func(*Options)) (*ListMultipartUploadsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMultipartUploads", params, optFns, addOperationListMultipartUploadsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMultipartUploadsMiddleware(stack *middleware.Stack, options Options) (err error) {
