...
func (c *Client) ListTagsForVault(ctx context.Context, params *ListTagsForVaultInput, optFns ...func(*Options)) (*ListTagsForVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForVault", params, optFns, addOperationListTagsForVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
