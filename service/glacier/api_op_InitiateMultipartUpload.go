...
func (c *Client) InitiateMultipartUpload(ctx context.Context, params *InitiateMultipartUploadInput, optFns ...func(*Options)) (*InitiateMultipartUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InitiateMultipartUpload", params, optFns, addOperationInitiateMultipartUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInitiateMultipartUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
