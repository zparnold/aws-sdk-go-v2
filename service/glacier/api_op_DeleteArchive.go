...
func (c *Client) DeleteArchive(ctx context.Context, params *DeleteArchiveInput, optFns ...func(*Options)) (*DeleteArchiveOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteArchive", params, optFns, addOperationDeleteArchiveMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteArchiveMiddleware(stack *middleware.Stack, options Options) (err error) {
