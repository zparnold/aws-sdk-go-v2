...
func (c *Client) GetVaultLock(ctx context.Context, params *GetVaultLockInput, optFns ...func(*Options)) (*GetVaultLockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVaultLock", params, optFns, addOperationGetVaultLockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVaultLockMiddleware(stack *middleware.Stack, options Options) (err error) {
