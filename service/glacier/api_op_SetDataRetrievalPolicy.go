...
func (c *Client) SetDataRetrievalPolicy(ctx context.Context, params *SetDataRetrievalPolicyInput, optFns ...func(*Options)) (*SetDataRetrievalPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetDataRetrievalPolicy", params, optFns, addOperationSetDataRetrievalPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetDataRetrievalPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
