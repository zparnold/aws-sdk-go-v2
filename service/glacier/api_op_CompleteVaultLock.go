...
func (c *Client) CompleteVaultLock(ctx context.Context, params *CompleteVaultLockInput, optFns ...func(*Options)) (*CompleteVaultLockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CompleteVaultLock", params, optFns, addOperationCompleteVaultLockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCompleteVaultLockMiddleware(stack *middleware.Stack, options Options) (err error) {
