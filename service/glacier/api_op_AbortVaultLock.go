...
func (c *Client) AbortVaultLock(ctx context.Context, params *AbortVaultLockInput, optFns ...func(*Options)) (*AbortVaultLockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AbortVaultLock", params, optFns, addOperationAbortVaultLockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAbortVaultLockMiddleware(stack *middleware.Stack, options Options) (err error) {
