...
func (c *Client) AbortMultipartUpload(ctx context.Context, params *AbortMultipartUploadInput, optFns ...func(*Options)) (*AbortMultipartUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AbortMultipartUpload", params, optFns, addOperationAbortMultipartUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAbortMultipartUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
