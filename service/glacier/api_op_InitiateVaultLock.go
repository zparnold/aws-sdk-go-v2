...
func (c *Client) InitiateVaultLock(ctx context.Context, params *InitiateVaultLockInput, optFns ...func(*Options)) (*InitiateVaultLockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InitiateVaultLock", params, optFns, addOperationInitiateVaultLockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInitiateVaultLockMiddleware(stack *middleware.Stack, options Options) (err error) {
