...
func (c *Client) GetVaultAccessPolicy(ctx context.Context, params *GetVaultAccessPolicyInput, optFns ...func(*Options)) (*GetVaultAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVaultAccessPolicy", params, optFns, addOperationGetVaultAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVaultAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
