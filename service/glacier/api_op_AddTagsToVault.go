...
func (c *Client) AddTagsToVault(ctx context.Context, params *AddTagsToVaultInput, optFns ...func(*Options)) (*AddTagsToVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddTagsToVault", params, optFns, addOperationAddTagsToVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddTagsToVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
