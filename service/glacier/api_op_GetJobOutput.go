...
func (c *Client) GetJobOutput(ctx context.Context, params *GetJobOutputInput, optFns ...func(*Options)) (*GetJobOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobOutput", params, optFns, addOperationGetJobOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
