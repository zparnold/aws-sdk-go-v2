...
func (c *Client) SetVaultAccessPolicy(ctx context.Context, params *SetVaultAccessPolicyInput, optFns ...func(*Options)) (*SetVaultAccessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetVaultAccessPolicy", params, optFns, addOperationSetVaultAccessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetVaultAccessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
