...
func (c *Client) UploadArchive(ctx context.Context, params *UploadArchiveInput, optFns ...func(*Options)) (*UploadArchiveOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadArchive", params, optFns, addOperationUploadArchiveMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadArchiveMiddleware(stack *middleware.Stack, options Options) (err error) {
