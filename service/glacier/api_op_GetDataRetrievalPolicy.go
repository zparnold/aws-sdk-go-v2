...
func (c *Client) GetDataRetrievalPolicy(ctx context.Context, params *GetDataRetrievalPolicyInput, optFns ...func(*Options)) (*GetDataRetrievalPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataRetrievalPolicy", params, optFns, addOperationGetDataRetrievalPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataRetrievalPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
