...
func (c *Client) PurchaseProvisionedCapacity(ctx context.Context, params *PurchaseProvisionedCapacityInput, optFns ...func(*Options)) (*PurchaseProvisionedCapacityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurchaseProvisionedCapacity", params, optFns, addOperationPurchaseProvisionedCapacityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurchaseProvisionedCapacityMiddleware(stack *middleware.Stack, options Options) (err error) {
