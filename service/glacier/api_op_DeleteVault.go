...
func (c *Client) DeleteVault(ctx context.Context, params *DeleteVaultInput, optFns ...func(*Options)) (*DeleteVaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVault", params, optFns, addOperationDeleteVaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVaultMiddleware(stack *middleware.Stack, options Options) (err error) {
