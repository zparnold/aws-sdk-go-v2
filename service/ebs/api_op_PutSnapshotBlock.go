...
func (c *Client) PutSnapshotBlock(ctx context.Context, params *PutSnapshotBlockInput, optFns ...func(*Options)) (*PutSnapshotBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSnapshotBlock", params, optFns, addOperationPutSnapshotBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSnapshotBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
