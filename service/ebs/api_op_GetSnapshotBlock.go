...
func (c *Client) GetSnapshotBlock(ctx context.Context, params *GetSnapshotBlockInput, optFns ...func(*Options)) (*GetSnapshotBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSnapshotBlock", params, optFns, addOperationGetSnapshotBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSnapshotBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
