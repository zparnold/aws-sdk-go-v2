...
func (c *Client) ListChangedBlocks(ctx context.Context, params *ListChangedBlocksInput, optFns ...func(*Options)) (*ListChangedBlocksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListChangedBlocks", params, optFns, addOperationListChangedBlocksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListChangedBlocksMiddleware(stack *middleware.Stack, options Options) (err error) {
