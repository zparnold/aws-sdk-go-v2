...
func (c *Client) StartSnapshot(ctx context.Context, params *StartSnapshotInput, optFns ...func(*Options)) (*StartSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSnapshot", params, optFns, addOperationStartSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
