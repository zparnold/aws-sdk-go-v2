...
func (c *Client) CompleteSnapshot(ctx context.Context, params *CompleteSnapshotInput, optFns ...func(*Options)) (*CompleteSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CompleteSnapshot", params, optFns, addOperationCompleteSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCompleteSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
