...
func (c *Client) DescribeGatewayRoute(ctx context.Context, params *DescribeGatewayRouteInput, optFns ...func(*Options)) (*DescribeGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGatewayRoute", params, optFns, addOperationDescribeGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
