...
func (c *Client) ListVirtualServices(ctx context.Context, params *ListVirtualServicesInput, optFns ...func(*Options)) (*ListVirtualServicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVirtualServices", params, optFns, addOperationListVirtualServicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVirtualServicesMiddleware(stack *middleware.Stack, options Options) (err error) {
