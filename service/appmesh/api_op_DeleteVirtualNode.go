...
func (c *Client) DeleteVirtualNode(ctx context.Context, params *DeleteVirtualNodeInput, optFns ...func(*Options)) (*DeleteVirtualNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVirtualNode", params, optFns, addOperationDeleteVirtualNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVirtualNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
