...
func (c *Client) UpdateGatewayRoute(ctx context.Context, params *UpdateGatewayRouteInput, optFns ...func(*Options)) (*UpdateGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGatewayRoute", params, optFns, addOperationUpdateGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
