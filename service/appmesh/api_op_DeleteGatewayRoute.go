...
func (c *Client) DeleteGatewayRoute(ctx context.Context, params *DeleteGatewayRouteInput, optFns ...func(*Options)) (*DeleteGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGatewayRoute", params, optFns, addOperationDeleteGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
