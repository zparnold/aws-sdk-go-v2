...
func (c *Client) DeleteVirtualService(ctx context.Context, params *DeleteVirtualServiceInput, optFns ...func(*Options)) (*DeleteVirtualServiceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVirtualService", params, optFns, addOperationDeleteVirtualServiceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVirtualServiceMiddleware(stack *middleware.Stack, options Options) (err error) {
