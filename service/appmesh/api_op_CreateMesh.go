...
func (c *Client) CreateMesh(ctx context.Context, params *CreateMeshInput, optFns ...func(*Options)) (*CreateMeshOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMesh", params, optFns, addOperationCreateMeshMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMeshMiddleware(stack *middleware.Stack, options Options) (err error) {
