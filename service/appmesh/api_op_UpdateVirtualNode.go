...
func (c *Client) UpdateVirtualNode(ctx context.Context, params *UpdateVirtualNodeInput, optFns ...func(*Options)) (*UpdateVirtualNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVirtualNode", params, optFns, addOperationUpdateVirtualNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVirtualNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
