...
func (c *Client) UpdateMesh(ctx context.Context, params *UpdateMeshInput, optFns ...func(*Options)) (*UpdateMeshOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMesh", params, optFns, addOperationUpdateMeshMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMeshMiddleware(stack *middleware.Stack, options Options) (err error) {
