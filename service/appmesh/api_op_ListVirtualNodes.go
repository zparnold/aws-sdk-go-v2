...
func (c *Client) ListVirtualNodes(ctx context.Context, params *ListVirtualNodesInput, optFns ...func(*Options)) (*ListVirtualNodesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVirtualNodes", params, optFns, addOperationListVirtualNodesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVirtualNodesMiddleware(stack *middleware.Stack, options Options) (err error) {
