...
func (c *Client) DescribeVirtualService(ctx context.Context, params *DescribeVirtualServiceInput, optFns ...func(*Options)) (*DescribeVirtualServiceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVirtualService", params, optFns, addOperationDescribeVirtualServiceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVirtualServiceMiddleware(stack *middleware.Stack, options Options) (err error) {
