...
func (c *Client) ListGatewayRoutes(ctx context.Context, params *ListGatewayRoutesInput, optFns ...func(*Options)) (*ListGatewayRoutesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGatewayRoutes", params, optFns, addOperationListGatewayRoutesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGatewayRoutesMiddleware(stack *middleware.Stack, options Options) (err error) {
