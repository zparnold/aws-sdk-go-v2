...
func (c *Client) DescribeRoute(ctx context.Context, params *DescribeRouteInput, optFns ...func(*Options)) (*DescribeRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRoute", params, optFns, addOperationDescribeRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
