...
func (c *Client) CreateVirtualGateway(ctx context.Context, params *CreateVirtualGatewayInput, optFns ...func(*Options)) (*CreateVirtualGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVirtualGateway", params, optFns, addOperationCreateVirtualGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVirtualGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
