...
func (c *Client) CreateGatewayRoute(ctx context.Context, params *CreateGatewayRouteInput, optFns ...func(*Options)) (*CreateGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGatewayRoute", params, optFns, addOperationCreateGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
