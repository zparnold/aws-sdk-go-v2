...
func (c *Client) CreateVirtualService(ctx context.Context, params *CreateVirtualServiceInput, optFns ...func(*Options)) (*CreateVirtualServiceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVirtualService", params, optFns, addOperationCreateVirtualServiceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVirtualServiceMiddleware(stack *middleware.Stack, options Options) (err error) {
