...
func (c *Client) DescribeVirtualNode(ctx context.Context, params *DescribeVirtualNodeInput, optFns ...func(*Options)) (*DescribeVirtualNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVirtualNode", params, optFns, addOperationDescribeVirtualNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVirtualNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
