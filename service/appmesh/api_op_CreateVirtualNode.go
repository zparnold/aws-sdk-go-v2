...
func (c *Client) CreateVirtualNode(ctx context.Context, params *CreateVirtualNodeInput, optFns ...func(*Options)) (*CreateVirtualNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVirtualNode", params, optFns, addOperationCreateVirtualNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVirtualNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
