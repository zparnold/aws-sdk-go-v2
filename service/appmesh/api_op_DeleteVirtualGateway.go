...
func (c *Client) DeleteVirtualGateway(ctx context.Context, params *DeleteVirtualGatewayInput, optFns ...func(*Options)) (*DeleteVirtualGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVirtualGateway", params, optFns, addOperationDeleteVirtualGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVirtualGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
