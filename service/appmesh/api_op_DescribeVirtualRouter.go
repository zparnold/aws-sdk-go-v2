...
func (c *Client) DescribeVirtualRouter(ctx context.Context, params *DescribeVirtualRouterInput, optFns ...func(*Options)) (*DescribeVirtualRouterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVirtualRouter", params, optFns, addOperationDescribeVirtualRouterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVirtualRouterMiddleware(stack *middleware.Stack, options Options) (err error) {
