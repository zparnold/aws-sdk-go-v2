...
func (c *Client) DescribeMesh(ctx context.Context, params *DescribeMeshInput, optFns ...func(*Options)) (*DescribeMeshOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMesh", params, optFns, addOperationDescribeMeshMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMeshMiddleware(stack *middleware.Stack, options Options) (err error) {
