...
func (c *Client) UpdateVirtualRouter(ctx context.Context, params *UpdateVirtualRouterInput, optFns ...func(*Options)) (*UpdateVirtualRouterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVirtualRouter", params, optFns, addOperationUpdateVirtualRouterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVirtualRouterMiddleware(stack *middleware.Stack, options Options) (err error) {
