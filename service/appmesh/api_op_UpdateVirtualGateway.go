...
func (c *Client) UpdateVirtualGateway(ctx context.Context, params *UpdateVirtualGatewayInput, optFns ...func(*Options)) (*UpdateVirtualGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVirtualGateway", params, optFns, addOperationUpdateVirtualGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVirtualGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
