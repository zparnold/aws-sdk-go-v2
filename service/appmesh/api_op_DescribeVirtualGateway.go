...
func (c *Client) DescribeVirtualGateway(ctx context.Context, params *DescribeVirtualGatewayInput, optFns ...func(*Options)) (*DescribeVirtualGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVirtualGateway", params, optFns, addOperationDescribeVirtualGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVirtualGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
