...
func (c *Client) ListRoutes(ctx context.Context, params *ListRoutesInput, optFns ...func(*Options)) (*ListRoutesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRoutes", params, optFns, addOperationListRoutesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRoutesMiddleware(stack *middleware.Stack, options Options) (err error) {
