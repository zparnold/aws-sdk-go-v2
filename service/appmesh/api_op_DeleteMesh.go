...
func (c *Client) DeleteMesh(ctx context.Context, params *DeleteMeshInput, optFns ...func(*Options)) (*DeleteMeshOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMesh", params, optFns, addOperationDeleteMeshMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMeshMiddleware(stack *middleware.Stack, options Options) (err error) {
