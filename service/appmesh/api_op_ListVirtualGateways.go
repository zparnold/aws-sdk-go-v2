...
func (c *Client) ListVirtualGateways(ctx context.Context, params *ListVirtualGatewaysInput, optFns ...func(*Options)) (*ListVirtualGatewaysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVirtualGateways", params, optFns, addOperationListVirtualGatewaysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVirtualGatewaysMiddleware(stack *middleware.Stack, options Options) (err error) {
