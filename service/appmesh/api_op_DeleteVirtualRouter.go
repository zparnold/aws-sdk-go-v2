...
func (c *Client) DeleteVirtualRouter(ctx context.Context, params *DeleteVirtualRouterInput, optFns ...func(*Options)) (*DeleteVirtualRouterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVirtualRouter", params, optFns, addOperationDeleteVirtualRouterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVirtualRouterMiddleware(stack *middleware.Stack, options Options) (err error) {
