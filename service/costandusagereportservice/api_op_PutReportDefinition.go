...
func (c *Client) PutReportDefinition(ctx context.Context, params *PutReportDefinitionInput, optFns ...func(*Options)) (*PutReportDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutReportDefinition", params, optFns, addOperationPutReportDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutReportDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
