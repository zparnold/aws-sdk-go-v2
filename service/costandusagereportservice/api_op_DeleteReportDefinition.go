...
func (c *Client) DeleteReportDefinition(ctx context.Context, params *DeleteReportDefinitionInput, optFns ...func(*Options)) (*DeleteReportDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReportDefinition", params, optFns, addOperationDeleteReportDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReportDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
