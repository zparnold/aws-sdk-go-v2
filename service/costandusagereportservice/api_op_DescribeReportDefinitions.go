...
func (c *Client) DescribeReportDefinitions(ctx context.Context, params *DescribeReportDefinitionsInput, optFns ...func(*Options)) (*DescribeReportDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReportDefinitions", params, optFns, addOperationDescribeReportDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReportDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
