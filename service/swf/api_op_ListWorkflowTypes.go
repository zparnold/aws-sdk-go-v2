...
func (c *Client) ListWorkflowTypes(ctx context.Context, params *ListWorkflowTypesInput, optFns ...func(*Options)) (*ListWorkflowTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWorkflowTypes", params, optFns, addOperationListWorkflowTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWorkflowTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
