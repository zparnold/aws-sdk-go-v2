...
func (c *Client) UndeprecateDomain(ctx context.Context, params *UndeprecateDomainInput, optFns ...func(*Options)) (*UndeprecateDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UndeprecateDomain", params, optFns, addOperationUndeprecateDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUndeprecateDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
