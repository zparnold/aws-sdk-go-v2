...
func (c *Client) DescribeWorkflowExecution(ctx context.Context, params *DescribeWorkflowExecutionInput, optFns ...func(*Options)) (*DescribeWorkflowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkflowExecution", params, optFns, addOperationDescribeWorkflowExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkflowExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
