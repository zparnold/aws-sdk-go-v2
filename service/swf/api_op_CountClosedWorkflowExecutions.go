...
func (c *Client) CountClosedWorkflowExecutions(ctx context.Context, params *CountClosedWorkflowExecutionsInput, optFns ...func(*Options)) (*CountClosedWorkflowExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CountClosedWorkflowExecutions", params, optFns, addOperationCountClosedWorkflowExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCountClosedWorkflowExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
