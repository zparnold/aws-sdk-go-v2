...
func (c *Client) UndeprecateWorkflowType(ctx context.Context, params *UndeprecateWorkflowTypeInput, optFns ...func(*Options)) (*UndeprecateWorkflowTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UndeprecateWorkflowType", params, optFns, addOperationUndeprecateWorkflowTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUndeprecateWorkflowTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
