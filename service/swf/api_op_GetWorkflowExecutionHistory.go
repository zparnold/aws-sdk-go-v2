...
func (c *Client) GetWorkflowExecutionHistory(ctx context.Context, params *GetWorkflowExecutionHistoryInput, optFns ...func(*Options)) (*GetWorkflowExecutionHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWorkflowExecutionHistory", params, optFns, addOperationGetWorkflowExecutionHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWorkflowExecutionHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
