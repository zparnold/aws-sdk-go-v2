...
func (c *Client) RespondActivityTaskCompleted(ctx context.Context, params *RespondActivityTaskCompletedInput, optFns ...func(*Options)) (*RespondActivityTaskCompletedOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RespondActivityTaskCompleted", params, optFns, addOperationRespondActivityTaskCompletedMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRespondActivityTaskCompletedMiddleware(stack *middleware.Stack, options Options) (err error) {
