...
func (c *Client) RecordActivityTaskHeartbeat(ctx context.Context, params *RecordActivityTaskHeartbeatInput, optFns ...func(*Options)) (*RecordActivityTaskHeartbeatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RecordActivityTaskHeartbeat", params, optFns, addOperationRecordActivityTaskHeartbeatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRecordActivityTaskHeartbeatMiddleware(stack *middleware.Stack, options Options) (err error) {
