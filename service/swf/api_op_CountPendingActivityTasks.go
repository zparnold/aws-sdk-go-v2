...
func (c *Client) CountPendingActivityTasks(ctx context.Context, params *CountPendingActivityTasksInput, optFns ...func(*Options)) (*CountPendingActivityTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CountPendingActivityTasks", params, optFns, addOperationCountPendingActivityTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCountPendingActivityTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
