...
func (c *Client) PollForDecisionTask(ctx context.Context, params *PollForDecisionTaskInput, optFns ...func(*Options)) (*PollForDecisionTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PollForDecisionTask", params, optFns, addOperationPollForDecisionTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPollForDecisionTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
