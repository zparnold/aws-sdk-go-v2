...
func (c *Client) DeprecateActivityType(ctx context.Context, params *DeprecateActivityTypeInput, optFns ...func(*Options)) (*DeprecateActivityTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeprecateActivityType", params, optFns, addOperationDeprecateActivityTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeprecateActivityTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
