...
func (c *Client) DescribeWorkflowType(ctx context.Context, params *DescribeWorkflowTypeInput, optFns ...func(*Options)) (*DescribeWorkflowTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkflowType", params, optFns, addOperationDescribeWorkflowTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkflowTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
