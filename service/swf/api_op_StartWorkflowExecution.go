...
func (c *Client) StartWorkflowExecution(ctx context.Context, params *StartWorkflowExecutionInput, optFns ...func(*Options)) (*StartWorkflowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartWorkflowExecution", params, optFns, addOperationStartWorkflowExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartWorkflowExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
