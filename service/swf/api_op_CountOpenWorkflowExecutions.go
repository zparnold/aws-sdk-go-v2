...
func (c *Client) CountOpenWorkflowExecutions(ctx context.Context, params *CountOpenWorkflowExecutionsInput, optFns ...func(*Options)) (*CountOpenWorkflowExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CountOpenWorkflowExecutions", params, optFns, addOperationCountOpenWorkflowExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCountOpenWorkflowExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
