...
func (c *Client) ListActivityTypes(ctx context.Context, params *ListActivityTypesInput, optFns ...func(*Options)) (*ListActivityTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListActivityTypes", params, optFns, addOperationListActivityTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListActivityTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
