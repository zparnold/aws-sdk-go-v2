...
func (c *Client) TerminateWorkflowExecution(ctx context.Context, params *TerminateWorkflowExecutionInput, optFns ...func(*Options)) (*TerminateWorkflowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateWorkflowExecution", params, optFns, addOperationTerminateWorkflowExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateWorkflowExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
