...
func (c *Client) RegisterActivityType(ctx context.Context, params *RegisterActivityTypeInput, optFns ...func(*Options)) (*RegisterActivityTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterActivityType", params, optFns, addOperationRegisterActivityTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterActivityTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
