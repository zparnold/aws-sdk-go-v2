...
func (c *Client) RespondDecisionTaskCompleted(ctx context.Context, params *RespondDecisionTaskCompletedInput, optFns ...func(*Options)) (*RespondDecisionTaskCompletedOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RespondDecisionTaskCompleted", params, optFns, addOperationRespondDecisionTaskCompletedMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRespondDecisionTaskCompletedMiddleware(stack *middleware.Stack, options Options) (err error) {
