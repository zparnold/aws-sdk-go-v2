...
func (c *Client) DeprecateDomain(ctx context.Context, params *DeprecateDomainInput, optFns ...func(*Options)) (*DeprecateDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeprecateDomain", params, optFns, addOperationDeprecateDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeprecateDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
