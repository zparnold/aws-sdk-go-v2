...
func (c *Client) CountPendingDecisionTasks(ctx context.Context, params *CountPendingDecisionTasksInput, optFns ...func(*Options)) (*CountPendingDecisionTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CountPendingDecisionTasks", params, optFns, addOperationCountPendingDecisionTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCountPendingDecisionTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
