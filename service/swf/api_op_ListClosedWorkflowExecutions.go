...
func (c *Client) ListClosedWorkflowExecutions(ctx context.Context, params *ListClosedWorkflowExecutionsInput, optFns ...func(*Options)) (*ListClosedWorkflowExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListClosedWorkflowExecutions", params, optFns, addOperationListClosedWorkflowExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListClosedWorkflowExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
