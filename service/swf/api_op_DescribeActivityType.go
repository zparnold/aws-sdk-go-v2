...
func (c *Client) DescribeActivityType(ctx context.Context, params *DescribeActivityTypeInput, optFns ...func(*Options)) (*DescribeActivityTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeActivityType", params, optFns, addOperationDescribeActivityTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeActivityTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
