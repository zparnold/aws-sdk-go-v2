...
func (c *Client) UndeprecateActivityType(ctx context.Context, params *UndeprecateActivityTypeInput, optFns ...func(*Options)) (*UndeprecateActivityTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UndeprecateActivityType", params, optFns, addOperationUndeprecateActivityTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUndeprecateActivityTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
