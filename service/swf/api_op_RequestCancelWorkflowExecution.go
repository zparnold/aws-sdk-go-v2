...
func (c *Client) RequestCancelWorkflowExecution(ctx context.Context, params *RequestCancelWorkflowExecutionInput, optFns ...func(*Options)) (*RequestCancelWorkflowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RequestCancelWorkflowExecution", params, optFns, addOperationRequestCancelWorkflowExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRequestCancelWorkflowExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
