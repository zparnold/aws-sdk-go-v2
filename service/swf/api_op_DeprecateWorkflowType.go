...
func (c *Client) DeprecateWorkflowType(ctx context.Context, params *DeprecateWorkflowTypeInput, optFns ...func(*Options)) (*DeprecateWorkflowTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeprecateWorkflowType", params, optFns, addOperationDeprecateWorkflowTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeprecateWorkflowTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
