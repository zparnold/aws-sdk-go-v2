...
func (c *Client) RespondActivityTaskCanceled(ctx context.Context, params *RespondActivityTaskCanceledInput, optFns ...func(*Options)) (*RespondActivityTaskCanceledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RespondActivityTaskCanceled", params, optFns, addOperationRespondActivityTaskCanceledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRespondActivityTaskCanceledMiddleware(stack *middleware.Stack, options Options) (err error) {
