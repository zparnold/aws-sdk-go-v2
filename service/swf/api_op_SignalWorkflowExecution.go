...
func (c *Client) SignalWorkflowExecution(ctx context.Context, params *SignalWorkflowExecutionInput, optFns ...func(*Options)) (*SignalWorkflowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SignalWorkflowExecution", params, optFns, addOperationSignalWorkflowExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSignalWorkflowExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
