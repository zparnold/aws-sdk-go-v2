...
func (c *Client) DescribeDomain(ctx context.Context, params *DescribeDomainInput, optFns ...func(*Options)) (*DescribeDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDomain", params, optFns, addOperationDescribeDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
