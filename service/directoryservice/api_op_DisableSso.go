...
func (c *Client) DisableSso(ctx context.Context, params *DisableSsoInput, optFns ...func(*Options)) (*DisableSsoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableSso", params, optFns, addOperationDisableSsoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableSsoMiddleware(stack *middleware.Stack, options Options) (err error) {
