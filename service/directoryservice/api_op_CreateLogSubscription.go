...
func (c *Client) CreateLogSubscription(ctx context.Context, params *CreateLogSubscriptionInput, optFns ...func(*Options)) (*CreateLogSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLogSubscription", params, optFns, addOperationCreateLogSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLogSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
