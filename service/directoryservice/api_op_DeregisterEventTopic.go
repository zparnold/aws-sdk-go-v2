...
func (c *Client) DeregisterEventTopic(ctx context.Context, params *DeregisterEventTopicInput, optFns ...func(*Options)) (*DeregisterEventTopicOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterEventTopic", params, optFns, addOperationDeregisterEventTopicMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterEventTopicMiddleware(stack *middleware.Stack, options Options) (err error) {
