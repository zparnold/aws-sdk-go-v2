...
func (c *Client) AddIpRoutes(ctx context.Context, params *AddIpRoutesInput, optFns ...func(*Options)) (*AddIpRoutesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddIpRoutes", params, optFns, addOperationAddIpRoutesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddIpRoutesMiddleware(stack *middleware.Stack, options Options) (err error) {
