...
func (c *Client) DisableLDAPS(ctx context.Context, params *DisableLDAPSInput, optFns ...func(*Options)) (*DisableLDAPSOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableLDAPS", params, optFns, addOperationDisableLDAPSMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableLDAPSMiddleware(stack *middleware.Stack, options Options) (err error) {
