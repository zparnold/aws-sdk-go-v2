...
func (c *Client) DescribeConditionalForwarders(ctx context.Context, params *DescribeConditionalForwardersInput, optFns ...func(*Options)) (*DescribeConditionalForwardersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConditionalForwarders", params, optFns, addOperationDescribeConditionalForwardersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConditionalForwardersMiddleware(stack *middleware.Stack, options Options) (err error) {
