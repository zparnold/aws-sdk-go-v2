...
func (c *Client) ConnectDirectory(ctx context.Context, params *ConnectDirectoryInput, optFns ...func(*Options)) (*ConnectDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConnectDirectory", params, optFns, addOperationConnectDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConnectDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
