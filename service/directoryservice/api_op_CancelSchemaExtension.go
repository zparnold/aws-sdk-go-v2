...
func (c *Client) CancelSchemaExtension(ctx context.Context, params *CancelSchemaExtensionInput, optFns ...func(*Options)) (*CancelSchemaExtensionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelSchemaExtension", params, optFns, addOperationCancelSchemaExtensionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelSchemaExtensionMiddleware(stack *middleware.Stack, options Options) (err error) {
