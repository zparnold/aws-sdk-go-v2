...
func (c *Client) ListLogSubscriptions(ctx context.Context, params *ListLogSubscriptionsInput, optFns ...func(*Options)) (*ListLogSubscriptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLogSubscriptions", params, optFns, addOperationListLogSubscriptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLogSubscriptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
