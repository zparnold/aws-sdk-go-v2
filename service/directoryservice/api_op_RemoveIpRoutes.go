...
func (c *Client) RemoveIpRoutes(ctx context.Context, params *RemoveIpRoutesInput, optFns ...func(*Options)) (*RemoveIpRoutesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveIpRoutes", params, optFns, addOperationRemoveIpRoutesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveIpRoutesMiddleware(stack *middleware.Stack, options Options) (err error) {
