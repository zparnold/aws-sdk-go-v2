...
func (c *Client) CreateConditionalForwarder(ctx context.Context, params *CreateConditionalForwarderInput, optFns ...func(*Options)) (*CreateConditionalForwarderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConditionalForwarder", params, optFns, addOperationCreateConditionalForwarderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConditionalForwarderMiddleware(stack *middleware.Stack, options Options) (err error) {
