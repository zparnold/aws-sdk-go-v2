...
func (c *Client) StartSchemaExtension(ctx context.Context, params *StartSchemaExtensionInput, optFns ...func(*Options)) (*StartSchemaExtensionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSchemaExtension", params, optFns, addOperationStartSchemaExtensionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSchemaExtensionMiddleware(stack *middleware.Stack, options Options) (err error) {
