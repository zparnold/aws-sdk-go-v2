...
func (c *Client) EnableRadius(ctx context.Context, params *EnableRadiusInput, optFns ...func(*Options)) (*EnableRadiusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableRadius", params, optFns, addOperationEnableRadiusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableRadiusMiddleware(stack *middleware.Stack, options Options) (err error) {
