...
func (c *Client) DescribeDirectories(ctx context.Context, params *DescribeDirectoriesInput, optFns ...func(*Options)) (*DescribeDirectoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDirectories", params, optFns, addOperationDescribeDirectoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDirectoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
