...
func (c *Client) CreateMicrosoftAD(ctx context.Context, params *CreateMicrosoftADInput, optFns ...func(*Options)) (*CreateMicrosoftADOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMicrosoftAD", params, optFns, addOperationCreateMicrosoftADMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMicrosoftADMiddleware(stack *middleware.Stack, options Options) (err error) {
