...
func (c *Client) UnshareDirectory(ctx context.Context, params *UnshareDirectoryInput, optFns ...func(*Options)) (*UnshareDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnshareDirectory", params, optFns, addOperationUnshareDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnshareDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
