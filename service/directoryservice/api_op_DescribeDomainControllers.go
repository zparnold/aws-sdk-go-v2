...
func (c *Client) DescribeDomainControllers(ctx context.Context, params *DescribeDomainControllersInput, optFns ...func(*Options)) (*DescribeDomainControllersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDomainControllers", params, optFns, addOperationDescribeDomainControllersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDomainControllersMiddleware(stack *middleware.Stack, options Options) (err error) {
