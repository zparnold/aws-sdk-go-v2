...
func (c *Client) DescribeTrusts(ctx context.Context, params *DescribeTrustsInput, optFns ...func(*Options)) (*DescribeTrustsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrusts", params, optFns, addOperationDescribeTrustsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrustsMiddleware(stack *middleware.Stack, options Options) (err error) {
