...
func (c *Client) CreateComputer(ctx context.Context, params *CreateComputerInput, optFns ...func(*Options)) (*CreateComputerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateComputer", params, optFns, addOperationCreateComputerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateComputerMiddleware(stack *middleware.Stack, options Options) (err error) {
