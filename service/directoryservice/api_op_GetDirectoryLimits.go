...
func (c *Client) GetDirectoryLimits(ctx context.Context, params *GetDirectoryLimitsInput, optFns ...func(*Options)) (*GetDirectoryLimitsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDirectoryLimits", params, optFns, addOperationGetDirectoryLimitsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDirectoryLimitsMiddleware(stack *middleware.Stack, options Options) (err error) {
