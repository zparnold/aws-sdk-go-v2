...
func (c *Client) AcceptSharedDirectory(ctx context.Context, params *AcceptSharedDirectoryInput, optFns ...func(*Options)) (*AcceptSharedDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptSharedDirectory", params, optFns, addOperationAcceptSharedDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptSharedDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
