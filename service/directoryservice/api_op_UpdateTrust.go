...
func (c *Client) UpdateTrust(ctx context.Context, params *UpdateTrustInput, optFns ...func(*Options)) (*UpdateTrustOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTrust", params, optFns, addOperationUpdateTrustMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTrustMiddleware(stack *middleware.Stack, options Options) (err error) {
