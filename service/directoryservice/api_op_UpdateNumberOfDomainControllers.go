...
func (c *Client) UpdateNumberOfDomainControllers(ctx context.Context, params *UpdateNumberOfDomainControllersInput, optFns ...func(*Options)) (*UpdateNumberOfDomainControllersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNumberOfDomainControllers", params, optFns, addOperationUpdateNumberOfDomainControllersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNumberOfDomainControllersMiddleware(stack *middleware.Stack, options Options) (err error) {
