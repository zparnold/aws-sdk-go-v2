...
func (c *Client) UpdateConditionalForwarder(ctx context.Context, params *UpdateConditionalForwarderInput, optFns ...func(*Options)) (*UpdateConditionalForwarderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConditionalForwarder", params, optFns, addOperationUpdateConditionalForwarderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConditionalForwarderMiddleware(stack *middleware.Stack, options Options) (err error) {
