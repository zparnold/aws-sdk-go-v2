...
func (c *Client) DescribeEventTopics(ctx context.Context, params *DescribeEventTopicsInput, optFns ...func(*Options)) (*DescribeEventTopicsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventTopics", params, optFns, addOperationDescribeEventTopicsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventTopicsMiddleware(stack *middleware.Stack, options Options) (err error) {
