...
func (c *Client) DeleteTrust(ctx context.Context, params *DeleteTrustInput, optFns ...func(*Options)) (*DeleteTrustOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrust", params, optFns, addOperationDeleteTrustMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrustMiddleware(stack *middleware.Stack, options Options) (err error) {
