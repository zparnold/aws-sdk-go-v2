...
func (c *Client) DeleteLogSubscription(ctx context.Context, params *DeleteLogSubscriptionInput, optFns ...func(*Options)) (*DeleteLogSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLogSubscription", params, optFns, addOperationDeleteLogSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLogSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
