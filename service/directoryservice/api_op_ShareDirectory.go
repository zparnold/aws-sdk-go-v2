...
func (c *Client) ShareDirectory(ctx context.Context, params *ShareDirectoryInput, optFns ...func(*Options)) (*ShareDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ShareDirectory", params, optFns, addOperationShareDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationShareDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
