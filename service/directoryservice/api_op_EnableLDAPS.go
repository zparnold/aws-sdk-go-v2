...
func (c *Client) EnableLDAPS(ctx context.Context, params *EnableLDAPSInput, optFns ...func(*Options)) (*EnableLDAPSOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableLDAPS", params, optFns, addOperationEnableLDAPSMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableLDAPSMiddleware(stack *middleware.Stack, options Options) (err error) {
