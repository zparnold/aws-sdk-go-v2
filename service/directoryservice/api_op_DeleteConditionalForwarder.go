...
func (c *Client) DeleteConditionalForwarder(ctx context.Context, params *DeleteConditionalForwarderInput, optFns ...func(*Options)) (*DeleteConditionalForwarderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConditionalForwarder", params, optFns, addOperationDeleteConditionalForwarderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConditionalForwarderMiddleware(stack *middleware.Stack, options Options) (err error) {
