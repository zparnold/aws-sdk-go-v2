...
func (c *Client) ListSchemaExtensions(ctx context.Context, params *ListSchemaExtensionsInput, optFns ...func(*Options)) (*ListSchemaExtensionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSchemaExtensions", params, optFns, addOperationListSchemaExtensionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSchemaExtensionsMiddleware(stack *middleware.Stack, options Options) (err error) {
