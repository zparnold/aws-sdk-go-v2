...
func (c *Client) DeregisterCertificate(ctx context.Context, params *DeregisterCertificateInput, optFns ...func(*Options)) (*DeregisterCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterCertificate", params, optFns, addOperationDeregisterCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
