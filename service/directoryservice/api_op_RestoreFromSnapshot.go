...
func (c *Client) RestoreFromSnapshot(ctx context.Context, params *RestoreFromSnapshotInput, optFns ...func(*Options)) (*RestoreFromSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreFromSnapshot", params, optFns, addOperationRestoreFromSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreFromSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
