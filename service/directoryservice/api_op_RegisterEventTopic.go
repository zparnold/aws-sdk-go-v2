...
func (c *Client) RegisterEventTopic(ctx context.Context, params *RegisterEventTopicInput, optFns ...func(*Options)) (*RegisterEventTopicOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterEventTopic", params, optFns, addOperationRegisterEventTopicMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterEventTopicMiddleware(stack *middleware.Stack, options Options) (err error) {
