...
func (c *Client) CreateDirectory(ctx context.Context, params *CreateDirectoryInput, optFns ...func(*Options)) (*CreateDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDirectory", params, optFns, addOperationCreateDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
