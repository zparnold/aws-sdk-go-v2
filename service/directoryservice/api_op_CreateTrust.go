...
func (c *Client) CreateTrust(ctx context.Context, params *CreateTrustInput, optFns ...func(*Options)) (*CreateTrustOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrust", params, optFns, addOperationCreateTrustMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrustMiddleware(stack *middleware.Stack, options Options) (err error) {
