...
func (c *Client) EnableSso(ctx context.Context, params *EnableSsoInput, optFns ...func(*Options)) (*EnableSsoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableSso", params, optFns, addOperationEnableSsoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableSsoMiddleware(stack *middleware.Stack, options Options) (err error) {
