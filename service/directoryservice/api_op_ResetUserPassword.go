...
func (c *Client) ResetUserPassword(ctx context.Context, params *ResetUserPasswordInput, optFns ...func(*Options)) (*ResetUserPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetUserPassword", params, optFns, addOperationResetUserPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetUserPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
