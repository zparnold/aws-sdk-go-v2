...
func (c *Client) ListMemberAccounts(ctx context.Context, params *ListMemberAccountsInput, optFns ...func(*Options)) (*ListMemberAccountsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMemberAccounts", params, optFns, addOperationListMemberAccountsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMemberAccountsMiddleware(stack *middleware.Stack, options Options) (err error) {
