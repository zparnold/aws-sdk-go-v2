...
func (c *Client) AssociateMemberAccount(ctx context.Context, params *AssociateMemberAccountInput, optFns ...func(*Options)) (*AssociateMemberAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateMemberAccount", params, optFns, addOperationAssociateMemberAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateMemberAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
