...
func (c *Client) DisassociateS3Resources(ctx context.Context, params *DisassociateS3ResourcesInput, optFns ...func(*Options)) (*DisassociateS3ResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateS3Resources", params, optFns, addOperationDisassociateS3ResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateS3ResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
