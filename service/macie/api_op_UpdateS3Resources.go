...
func (c *Client) UpdateS3Resources(ctx context.Context, params *UpdateS3ResourcesInput, optFns ...func(*Options)) (*UpdateS3ResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateS3Resources", params, optFns, addOperationUpdateS3ResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateS3ResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
