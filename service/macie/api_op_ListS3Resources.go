...
func (c *Client) ListS3Resources(ctx context.Context, params *ListS3ResourcesInput, optFns ...func(*Options)) (*ListS3ResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListS3Resources", params, optFns, addOperationListS3ResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListS3ResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
