...
func (c *Client) AssociateS3Resources(ctx context.Context, params *AssociateS3ResourcesInput, optFns ...func(*Options)) (*AssociateS3ResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateS3Resources", params, optFns, addOperationAssociateS3ResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateS3ResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
