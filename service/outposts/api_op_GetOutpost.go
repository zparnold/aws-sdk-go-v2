...
func (c *Client) GetOutpost(ctx context.Context, params *GetOutpostInput, optFns ...func(*Options)) (*GetOutpostOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOutpost", params, optFns, addOperationGetOutpostMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOutpostMiddleware(stack *middleware.Stack, options Options) (err error) {
