...
func (c *Client) GetOutpostInstanceTypes(ctx context.Context, params *GetOutpostInstanceTypesInput, optFns ...func(*Options)) (*GetOutpostInstanceTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOutpostInstanceTypes", params, optFns, addOperationGetOutpostInstanceTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOutpostInstanceTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
