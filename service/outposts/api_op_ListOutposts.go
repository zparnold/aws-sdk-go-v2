...
func (c *Client) ListOutposts(ctx context.Context, params *ListOutpostsInput, optFns ...func(*Options)) (*ListOutpostsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOutposts", params, optFns, addOperationListOutpostsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOutpostsMiddleware(stack *middleware.Stack, options Options) (err error) {
