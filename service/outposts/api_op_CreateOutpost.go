...
func (c *Client) CreateOutpost(ctx context.Context, params *CreateOutpostInput, optFns ...func(*Options)) (*CreateOutpostOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOutpost", params, optFns, addOperationCreateOutpostMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOutpostMiddleware(stack *middleware.Stack, options Options) (err error) {
