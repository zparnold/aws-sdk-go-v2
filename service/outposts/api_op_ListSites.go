...
func (c *Client) ListSites(ctx context.Context, params *ListSitesInput, optFns ...func(*Options)) (*ListSitesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSites", params, optFns, addOperationListSitesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSitesMiddleware(stack *middleware.Stack, options Options) (err error) {
