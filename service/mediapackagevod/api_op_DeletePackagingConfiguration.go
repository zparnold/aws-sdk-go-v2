...
func (c *Client) DeletePackagingConfiguration(ctx context.Context, params *DeletePackagingConfigurationInput, optFns ...func(*Options)) (*DeletePackagingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePackagingConfiguration", params, optFns, addOperationDeletePackagingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePackagingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
