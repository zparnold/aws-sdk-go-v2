...
func (c *Client) UpdatePackagingGroup(ctx context.Context, params *UpdatePackagingGroupInput, optFns ...func(*Options)) (*UpdatePackagingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePackagingGroup", params, optFns, addOperationUpdatePackagingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePackagingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
