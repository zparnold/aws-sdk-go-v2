...
func (c *Client) CreatePackagingConfiguration(ctx context.Context, params *CreatePackagingConfigurationInput, optFns ...func(*Options)) (*CreatePackagingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePackagingConfiguration", params, optFns, addOperationCreatePackagingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePackagingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
