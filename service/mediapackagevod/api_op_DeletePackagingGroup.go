...
func (c *Client) DeletePackagingGroup(ctx context.Context, params *DeletePackagingGroupInput, optFns ...func(*Options)) (*DeletePackagingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePackagingGroup", params, optFns, addOperationDeletePackagingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePackagingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
