...
func (c *Client) ListPackagingGroups(ctx context.Context, params *ListPackagingGroupsInput, optFns ...func(*Options)) (*ListPackagingGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPackagingGroups", params, optFns, addOperationListPackagingGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPackagingGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
