...
func (c *Client) DescribePackagingConfiguration(ctx context.Context, params *DescribePackagingConfigurationInput, optFns ...func(*Options)) (*DescribePackagingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePackagingConfiguration", params, optFns, addOperationDescribePackagingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePackagingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
