...
func (c *Client) ListPackagingConfigurations(ctx context.Context, params *ListPackagingConfigurationsInput, optFns ...func(*Options)) (*ListPackagingConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPackagingConfigurations", params, optFns, addOperationListPackagingConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPackagingConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
