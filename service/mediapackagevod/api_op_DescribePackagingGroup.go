...
func (c *Client) DescribePackagingGroup(ctx context.Context, params *DescribePackagingGroupInput, optFns ...func(*Options)) (*DescribePackagingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePackagingGroup", params, optFns, addOperationDescribePackagingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePackagingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
