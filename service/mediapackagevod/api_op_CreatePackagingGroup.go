...
func (c *Client) CreatePackagingGroup(ctx context.Context, params *CreatePackagingGroupInput, optFns ...func(*Options)) (*CreatePackagingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePackagingGroup", params, optFns, addOperationCreatePackagingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePackagingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
