...
func (c *Client) ListDistributionConfigurations(ctx context.Context, params *ListDistributionConfigurationsInput, optFns ...func(*Options)) (*ListDistributionConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDistributionConfigurations", params, optFns, addOperationListDistributionConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDistributionConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
