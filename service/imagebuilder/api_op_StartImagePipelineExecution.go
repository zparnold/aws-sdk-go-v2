...
func (c *Client) StartImagePipelineExecution(ctx context.Context, params *StartImagePipelineExecutionInput, optFns ...func(*Options)) (*StartImagePipelineExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartImagePipelineExecution", params, optFns, addOperationStartImagePipelineExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartImagePipelineExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
