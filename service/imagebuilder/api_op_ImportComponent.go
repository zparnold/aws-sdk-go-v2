...
func (c *Client) ImportComponent(ctx context.Context, params *ImportComponentInput, optFns ...func(*Options)) (*ImportComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportComponent", params, optFns, addOperationImportComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
