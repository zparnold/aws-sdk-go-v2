...
func (c *Client) ListImageRecipes(ctx context.Context, params *ListImageRecipesInput, optFns ...func(*Options)) (*ListImageRecipesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListImageRecipes", params, optFns, addOperationListImageRecipesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListImageRecipesMiddleware(stack *middleware.Stack, options Options) (err error) {
