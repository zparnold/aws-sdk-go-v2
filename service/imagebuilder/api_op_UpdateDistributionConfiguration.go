...
func (c *Client) UpdateDistributionConfiguration(ctx context.Context, params *UpdateDistributionConfigurationInput, optFns ...func(*Options)) (*UpdateDistributionConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDistributionConfiguration", params, optFns, addOperationUpdateDistributionConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDistributionConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
