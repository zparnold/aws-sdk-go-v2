...
func (c *Client) GetInfrastructureConfiguration(ctx context.Context, params *GetInfrastructureConfigurationInput, optFns ...func(*Options)) (*GetInfrastructureConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInfrastructureConfiguration", params, optFns, addOperationGetInfrastructureConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInfrastructureConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
