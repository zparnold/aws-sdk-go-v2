...
func (c *Client) ListComponentBuildVersions(ctx context.Context, params *ListComponentBuildVersionsInput, optFns ...func(*Options)) (*ListComponentBuildVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListComponentBuildVersions", params, optFns, addOperationListComponentBuildVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListComponentBuildVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
