...
func (c *Client) CancelImageCreation(ctx context.Context, params *CancelImageCreationInput, optFns ...func(*Options)) (*CancelImageCreationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelImageCreation", params, optFns, addOperationCancelImageCreationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelImageCreationMiddleware(stack *middleware.Stack, options Options) (err error) {
