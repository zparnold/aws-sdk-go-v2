...
func (c *Client) CreateImageRecipe(ctx context.Context, params *CreateImageRecipeInput, optFns ...func(*Options)) (*CreateImageRecipeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateImageRecipe", params, optFns, addOperationCreateImageRecipeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateImageRecipeMiddleware(stack *middleware.Stack, options Options) (err error) {
