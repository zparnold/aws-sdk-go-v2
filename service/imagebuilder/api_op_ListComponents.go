...
func (c *Client) ListComponents(ctx context.Context, params *ListComponentsInput, optFns ...func(*Options)) (*ListComponentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListComponents", params, optFns, addOperationListComponentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListComponentsMiddleware(stack *middleware.Stack, options Options) (err error) {
