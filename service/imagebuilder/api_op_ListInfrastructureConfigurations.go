...
func (c *Client) ListInfrastructureConfigurations(ctx context.Context, params *ListInfrastructureConfigurationsInput, optFns ...func(*Options)) (*ListInfrastructureConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInfrastructureConfigurations", params, optFns, addOperationListInfrastructureConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInfrastructureConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
