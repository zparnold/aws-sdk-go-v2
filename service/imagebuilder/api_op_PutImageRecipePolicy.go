...
func (c *Client) PutImageRecipePolicy(ctx context.Context, params *PutImageRecipePolicyInput, optFns ...func(*Options)) (*PutImageRecipePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutImageRecipePolicy", params, optFns, addOperationPutImageRecipePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutImageRecipePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
