...
func (c *Client) DeleteImagePipeline(ctx context.Context, params *DeleteImagePipelineInput, optFns ...func(*Options)) (*DeleteImagePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteImagePipeline", params, optFns, addOperationDeleteImagePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteImagePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
