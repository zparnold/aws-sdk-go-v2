...
func (c *Client) PutImagePolicy(ctx context.Context, params *PutImagePolicyInput, optFns ...func(*Options)) (*PutImagePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutImagePolicy", params, optFns, addOperationPutImagePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutImagePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
