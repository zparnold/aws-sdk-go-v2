...
func (c *Client) CreateDistributionConfiguration(ctx context.Context, params *CreateDistributionConfigurationInput, optFns ...func(*Options)) (*CreateDistributionConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDistributionConfiguration", params, optFns, addOperationCreateDistributionConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDistributionConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
