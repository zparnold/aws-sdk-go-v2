...
func (c *Client) GetDistributionConfiguration(ctx context.Context, params *GetDistributionConfigurationInput, optFns ...func(*Options)) (*GetDistributionConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDistributionConfiguration", params, optFns, addOperationGetDistributionConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDistributionConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
