...
func (c *Client) CreateInfrastructureConfiguration(ctx context.Context, params *CreateInfrastructureConfigurationInput, optFns ...func(*Options)) (*CreateInfrastructureConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInfrastructureConfiguration", params, optFns, addOperationCreateInfrastructureConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInfrastructureConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
