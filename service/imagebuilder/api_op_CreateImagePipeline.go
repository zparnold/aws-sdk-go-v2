...
func (c *Client) CreateImagePipeline(ctx context.Context, params *CreateImagePipelineInput, optFns ...func(*Options)) (*CreateImagePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateImagePipeline", params, optFns, addOperationCreateImagePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateImagePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
