...
func (c *Client) DeleteImageRecipe(ctx context.Context, params *DeleteImageRecipeInput, optFns ...func(*Options)) (*DeleteImageRecipeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteImageRecipe", params, optFns, addOperationDeleteImageRecipeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteImageRecipeMiddleware(stack *middleware.Stack, options Options) (err error) {
