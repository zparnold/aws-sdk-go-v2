...
func (c *Client) DeleteInfrastructureConfiguration(ctx context.Context, params *DeleteInfrastructureConfigurationInput, optFns ...func(*Options)) (*DeleteInfrastructureConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInfrastructureConfiguration", params, optFns, addOperationDeleteInfrastructureConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInfrastructureConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
