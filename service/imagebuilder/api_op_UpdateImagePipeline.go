...
func (c *Client) UpdateImagePipeline(ctx context.Context, params *UpdateImagePipelineInput, optFns ...func(*Options)) (*UpdateImagePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateImagePipeline", params, optFns, addOperationUpdateImagePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateImagePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
