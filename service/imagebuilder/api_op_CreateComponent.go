...
func (c *Client) CreateComponent(ctx context.Context, params *CreateComponentInput, optFns ...func(*Options)) (*CreateComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateComponent", params, optFns, addOperationCreateComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
