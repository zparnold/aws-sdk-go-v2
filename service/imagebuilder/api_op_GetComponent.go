...
func (c *Client) GetComponent(ctx context.Context, params *GetComponentInput, optFns ...func(*Options)) (*GetComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComponent", params, optFns, addOperationGetComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
