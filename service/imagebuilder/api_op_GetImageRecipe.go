...
func (c *Client) GetImageRecipe(ctx context.Context, params *GetImageRecipeInput, optFns ...func(*Options)) (*GetImageRecipeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetImageRecipe", params, optFns, addOperationGetImageRecipeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetImageRecipeMiddleware(stack *middleware.Stack, options Options) (err error) {
