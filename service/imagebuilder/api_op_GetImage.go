...
func (c *Client) GetImage(ctx context.Context, params *GetImageInput, optFns ...func(*Options)) (*GetImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetImage", params, optFns, addOperationGetImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetImageMiddleware(stack *middleware.Stack, options Options) (err error) {
