...
func (c *Client) GetComponentPolicy(ctx context.Context, params *GetComponentPolicyInput, optFns ...func(*Options)) (*GetComponentPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComponentPolicy", params, optFns, addOperationGetComponentPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComponentPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
