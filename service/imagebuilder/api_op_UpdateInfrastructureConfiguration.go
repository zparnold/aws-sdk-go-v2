...
func (c *Client) UpdateInfrastructureConfiguration(ctx context.Context, params *UpdateInfrastructureConfigurationInput, optFns ...func(*Options)) (*UpdateInfrastructureConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateInfrastructureConfiguration", params, optFns, addOperationUpdateInfrastructureConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateInfrastructureConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
