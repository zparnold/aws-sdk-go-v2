...
func (c *Client) GetImageRecipePolicy(ctx context.Context, params *GetImageRecipePolicyInput, optFns ...func(*Options)) (*GetImageRecipePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetImageRecipePolicy", params, optFns, addOperationGetImageRecipePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetImageRecipePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
