...
func (c *Client) GetRawMessageContent(ctx context.Context, params *GetRawMessageContentInput, optFns ...func(*Options)) (*GetRawMessageContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRawMessageContent", params, optFns, addOperationGetRawMessageContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRawMessageContentMiddleware(stack *middleware.Stack, options Options) (err error) {
