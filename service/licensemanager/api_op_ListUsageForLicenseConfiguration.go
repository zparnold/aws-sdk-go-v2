...
func (c *Client) ListUsageForLicenseConfiguration(ctx context.Context, params *ListUsageForLicenseConfigurationInput, optFns ...func(*Options)) (*ListUsageForLicenseConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUsageForLicenseConfiguration", params, optFns, addOperationListUsageForLicenseConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUsageForLicenseConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
