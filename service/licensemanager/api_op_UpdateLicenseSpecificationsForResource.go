...
func (c *Client) UpdateLicenseSpecificationsForResource(ctx context.Context, params *UpdateLicenseSpecificationsForResourceInput, optFns ...func(*Options)) (*UpdateLicenseSpecificationsForResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLicenseSpecificationsForResource", params, optFns, addOperationUpdateLicenseSpecificationsForResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLicenseSpecificationsForResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
