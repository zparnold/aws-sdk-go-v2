...
func (c *Client) ListResourceInventory(ctx context.Context, params *ListResourceInventoryInput, optFns ...func(*Options)) (*ListResourceInventoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceInventory", params, optFns, addOperationListResourceInventoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceInventoryMiddleware(stack *middleware.Stack, options Options) (err error) {
