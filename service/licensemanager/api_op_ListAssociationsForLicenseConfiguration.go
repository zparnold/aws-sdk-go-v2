...
func (c *Client) ListAssociationsForLicenseConfiguration(ctx context.Context, params *ListAssociationsForLicenseConfigurationInput, optFns ...func(*Options)) (*ListAssociationsForLicenseConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssociationsForLicenseConfiguration", params, optFns, addOperationListAssociationsForLicenseConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssociationsForLicenseConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
