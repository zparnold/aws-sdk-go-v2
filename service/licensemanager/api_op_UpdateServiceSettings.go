...
func (c *Client) UpdateServiceSettings(ctx context.Context, params *UpdateServiceSettingsInput, optFns ...func(*Options)) (*UpdateServiceSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServiceSettings", params, optFns, addOperationUpdateServiceSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServiceSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
