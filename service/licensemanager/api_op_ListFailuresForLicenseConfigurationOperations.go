...
func (c *Client) ListFailuresForLicenseConfigurationOperations(ctx context.Context, params *ListFailuresForLicenseConfigurationOperationsInput, optFns ...func(*Options)) (*ListFailuresForLicenseConfigurationOperationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFailuresForLicenseConfigurationOperations", params, optFns, addOperationListFailuresForLicenseConfigurationOperationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFailuresForLicenseConfigurationOperationsMiddleware(stack *middleware.Stack, options Options) (err error) {
