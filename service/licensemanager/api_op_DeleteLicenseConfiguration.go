...
func (c *Client) DeleteLicenseConfiguration(ctx context.Context, params *DeleteLicenseConfigurationInput, optFns ...func(*Options)) (*DeleteLicenseConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLicenseConfiguration", params, optFns, addOperationDeleteLicenseConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLicenseConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
