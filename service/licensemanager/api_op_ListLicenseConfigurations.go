...
func (c *Client) ListLicenseConfigurations(ctx context.Context, params *ListLicenseConfigurationsInput, optFns ...func(*Options)) (*ListLicenseConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLicenseConfigurations", params, optFns, addOperationListLicenseConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLicenseConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
