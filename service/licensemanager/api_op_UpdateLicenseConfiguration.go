...
func (c *Client) UpdateLicenseConfiguration(ctx context.Context, params *UpdateLicenseConfigurationInput, optFns ...func(*Options)) (*UpdateLicenseConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLicenseConfiguration", params, optFns, addOperationUpdateLicenseConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLicenseConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
