...
func (c *Client) UpdateThingShadow(ctx context.Context, params *UpdateThingShadowInput, optFns ...func(*Options)) (*UpdateThingShadowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateThingShadow", params, optFns, addOperationUpdateThingShadowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThingShadowMiddleware(stack *middleware.Stack, options Options) (err error) {
