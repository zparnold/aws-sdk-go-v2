...
func (c *Client) DeleteThingShadow(ctx context.Context, params *DeleteThingShadowInput, optFns ...func(*Options)) (*DeleteThingShadowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteThingShadow", params, optFns, addOperationDeleteThingShadowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteThingShadowMiddleware(stack *middleware.Stack, options Options) (err error) {
