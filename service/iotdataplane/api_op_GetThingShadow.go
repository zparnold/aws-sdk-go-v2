...
func (c *Client) GetThingShadow(ctx context.Context, params *GetThingShadowInput, optFns ...func(*Options)) (*GetThingShadowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetThingShadow", params, optFns, addOperationGetThingShadowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetThingShadowMiddleware(stack *middleware.Stack, options Options) (err error) {
