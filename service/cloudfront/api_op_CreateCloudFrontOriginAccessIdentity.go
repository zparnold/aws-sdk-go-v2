...
func (c *Client) CreateCloudFrontOriginAccessIdentity(ctx context.Context, params *CreateCloudFrontOriginAccessIdentityInput, optFns ...func(*Options)) (*CreateCloudFrontOriginAccessIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCloudFrontOriginAccessIdentity", params, optFns, addOperationCreateCloudFrontOriginAccessIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCloudFrontOriginAccessIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
