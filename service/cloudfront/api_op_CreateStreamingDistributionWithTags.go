...
func (c *Client) CreateStreamingDistributionWithTags(ctx context.Context, params *CreateStreamingDistributionWithTagsInput, optFns ...func(*Options)) (*CreateStreamingDistributionWithTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStreamingDistributionWithTags", params, optFns, addOperationCreateStreamingDistributionWithTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStreamingDistributionWithTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
