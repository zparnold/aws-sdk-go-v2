...
func (c *Client) ListDistributionsByCachePolicyId(ctx context.Context, params *ListDistributionsByCachePolicyIdInput, optFns ...func(*Options)) (*ListDistributionsByCachePolicyIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDistributionsByCachePolicyId", params, optFns, addOperationListDistributionsByCachePolicyIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDistributionsByCachePolicyIdMiddleware(stack *middleware.Stack, options Options) (err error) {
