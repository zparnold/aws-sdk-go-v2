...
func (c *Client) ListCachePolicies(ctx context.Context, params *ListCachePoliciesInput, optFns ...func(*Options)) (*ListCachePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCachePolicies", params, optFns, addOperationListCachePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCachePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
