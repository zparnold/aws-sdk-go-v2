...
func (c *Client) DeleteOriginRequestPolicy(ctx context.Context, params *DeleteOriginRequestPolicyInput, optFns ...func(*Options)) (*DeleteOriginRequestPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOriginRequestPolicy", params, optFns, addOperationDeleteOriginRequestPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOriginRequestPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
