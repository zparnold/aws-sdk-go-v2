...
func (c *Client) UpdateStreamingDistribution(ctx context.Context, params *UpdateStreamingDistributionInput, optFns ...func(*Options)) (*UpdateStreamingDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStreamingDistribution", params, optFns, addOperationUpdateStreamingDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStreamingDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
