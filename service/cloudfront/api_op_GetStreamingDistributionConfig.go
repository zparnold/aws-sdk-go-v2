...
func (c *Client) GetStreamingDistributionConfig(ctx context.Context, params *GetStreamingDistributionConfigInput, optFns ...func(*Options)) (*GetStreamingDistributionConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStreamingDistributionConfig", params, optFns, addOperationGetStreamingDistributionConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStreamingDistributionConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
