...
func (c *Client) CreateCachePolicy(ctx context.Context, params *CreateCachePolicyInput, optFns ...func(*Options)) (*CreateCachePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCachePolicy", params, optFns, addOperationCreateCachePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCachePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
