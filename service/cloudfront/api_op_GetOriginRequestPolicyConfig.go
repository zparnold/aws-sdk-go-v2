...
func (c *Client) GetOriginRequestPolicyConfig(ctx context.Context, params *GetOriginRequestPolicyConfigInput, optFns ...func(*Options)) (*GetOriginRequestPolicyConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOriginRequestPolicyConfig", params, optFns, addOperationGetOriginRequestPolicyConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOriginRequestPolicyConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
