...
func (c *Client) DeleteFieldLevelEncryptionConfig(ctx context.Context, params *DeleteFieldLevelEncryptionConfigInput, optFns ...func(*Options)) (*DeleteFieldLevelEncryptionConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFieldLevelEncryptionConfig", params, optFns, addOperationDeleteFieldLevelEncryptionConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFieldLevelEncryptionConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
