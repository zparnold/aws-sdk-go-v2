...
func (c *Client) ListFieldLevelEncryptionProfiles(ctx context.Context, params *ListFieldLevelEncryptionProfilesInput, optFns ...func(*Options)) (*ListFieldLevelEncryptionProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFieldLevelEncryptionProfiles", params, optFns, addOperationListFieldLevelEncryptionProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFieldLevelEncryptionProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
