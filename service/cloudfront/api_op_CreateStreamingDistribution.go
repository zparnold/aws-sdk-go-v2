...
func (c *Client) CreateStreamingDistribution(ctx context.Context, params *CreateStreamingDistributionInput, optFns ...func(*Options)) (*CreateStreamingDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStreamingDistribution", params, optFns, addOperationCreateStreamingDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStreamingDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
