...
func (c *Client) CreateFieldLevelEncryptionConfig(ctx context.Context, params *CreateFieldLevelEncryptionConfigInput, optFns ...func(*Options)) (*CreateFieldLevelEncryptionConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFieldLevelEncryptionConfig", params, optFns, addOperationCreateFieldLevelEncryptionConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFieldLevelEncryptionConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
