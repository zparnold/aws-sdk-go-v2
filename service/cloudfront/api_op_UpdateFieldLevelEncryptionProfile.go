...
func (c *Client) UpdateFieldLevelEncryptionProfile(ctx context.Context, params *UpdateFieldLevelEncryptionProfileInput, optFns ...func(*Options)) (*UpdateFieldLevelEncryptionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFieldLevelEncryptionProfile", params, optFns, addOperationUpdateFieldLevelEncryptionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFieldLevelEncryptionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
