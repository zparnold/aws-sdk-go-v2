...
func (c *Client) UpdateDistribution(ctx context.Context, params *UpdateDistributionInput, optFns ...func(*Options)) (*UpdateDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDistribution", params, optFns, addOperationUpdateDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
