...
func (c *Client) ListDistributions(ctx context.Context, params *ListDistributionsInput, optFns ...func(*Options)) (*ListDistributionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDistributions", params, optFns, addOperationListDistributionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDistributionsMiddleware(stack *middleware.Stack, options Options) (err error) {
