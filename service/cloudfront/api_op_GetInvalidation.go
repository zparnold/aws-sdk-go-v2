...
func (c *Client) GetInvalidation(ctx context.Context, params *GetInvalidationInput, optFns ...func(*Options)) (*GetInvalidationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInvalidation", params, optFns, addOperationGetInvalidationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInvalidationMiddleware(stack *middleware.Stack, options Options) (err error) {
