...
func (c *Client) CreatePublicKey(ctx context.Context, params *CreatePublicKeyInput, optFns ...func(*Options)) (*CreatePublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePublicKey", params, optFns, addOperationCreatePublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
