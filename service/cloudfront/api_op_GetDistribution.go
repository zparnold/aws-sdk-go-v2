...
func (c *Client) GetDistribution(ctx context.Context, params *GetDistributionInput, optFns ...func(*Options)) (*GetDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDistribution", params, optFns, addOperationGetDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
