...
func (c *Client) UpdatePublicKey(ctx context.Context, params *UpdatePublicKeyInput, optFns ...func(*Options)) (*UpdatePublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePublicKey", params, optFns, addOperationUpdatePublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
