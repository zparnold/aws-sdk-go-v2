...
func (c *Client) DeleteDistribution(ctx context.Context, params *DeleteDistributionInput, optFns ...func(*Options)) (*DeleteDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDistribution", params, optFns, addOperationDeleteDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
