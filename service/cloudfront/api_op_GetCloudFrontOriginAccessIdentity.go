...
func (c *Client) GetCloudFrontOriginAccessIdentity(ctx context.Context, params *GetCloudFrontOriginAccessIdentityInput, optFns ...func(*Options)) (*GetCloudFrontOriginAccessIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCloudFrontOriginAccessIdentity", params, optFns, addOperationGetCloudFrontOriginAccessIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCloudFrontOriginAccessIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
