...
func (c *Client) DeletePublicKey(ctx context.Context, params *DeletePublicKeyInput, optFns ...func(*Options)) (*DeletePublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePublicKey", params, optFns, addOperationDeletePublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
