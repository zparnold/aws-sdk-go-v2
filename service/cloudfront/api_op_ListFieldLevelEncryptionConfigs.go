...
func (c *Client) ListFieldLevelEncryptionConfigs(ctx context.Context, params *ListFieldLevelEncryptionConfigsInput, optFns ...func(*Options)) (*ListFieldLevelEncryptionConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFieldLevelEncryptionConfigs", params, optFns, addOperationListFieldLevelEncryptionConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFieldLevelEncryptionConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
