...
func (c *Client) UpdateCachePolicy(ctx context.Context, params *UpdateCachePolicyInput, optFns ...func(*Options)) (*UpdateCachePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCachePolicy", params, optFns, addOperationUpdateCachePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCachePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
