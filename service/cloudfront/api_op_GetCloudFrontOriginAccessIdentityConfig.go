...
func (c *Client) GetCloudFrontOriginAccessIdentityConfig(ctx context.Context, params *GetCloudFrontOriginAccessIdentityConfigInput, optFns ...func(*Options)) (*GetCloudFrontOriginAccessIdentityConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCloudFrontOriginAccessIdentityConfig", params, optFns, addOperationGetCloudFrontOriginAccessIdentityConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCloudFrontOriginAccessIdentityConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
