...
func (c *Client) ListStreamingDistributions(ctx context.Context, params *ListStreamingDistributionsInput, optFns ...func(*Options)) (*ListStreamingDistributionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStreamingDistributions", params, optFns, addOperationListStreamingDistributionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStreamingDistributionsMiddleware(stack *middleware.Stack, options Options) (err error) {
