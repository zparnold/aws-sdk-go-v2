...
func (c *Client) ListInvalidations(ctx context.Context, params *ListInvalidationsInput, optFns ...func(*Options)) (*ListInvalidationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInvalidations", params, optFns, addOperationListInvalidationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInvalidationsMiddleware(stack *middleware.Stack, options Options) (err error) {
