...
func (c *Client) GetCachePolicy(ctx context.Context, params *GetCachePolicyInput, optFns ...func(*Options)) (*GetCachePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCachePolicy", params, optFns, addOperationGetCachePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCachePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
