...
func (c *Client) DeleteCachePolicy(ctx context.Context, params *DeleteCachePolicyInput, optFns ...func(*Options)) (*DeleteCachePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCachePolicy", params, optFns, addOperationDeleteCachePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCachePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
