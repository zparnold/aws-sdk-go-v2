...
func (c *Client) ListDistributionsByOriginRequestPolicyId(ctx context.Context, params *ListDistributionsByOriginRequestPolicyIdInput, optFns ...func(*Options)) (*ListDistributionsByOriginRequestPolicyIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDistributionsByOriginRequestPolicyId", params, optFns, addOperationListDistributionsByOriginRequestPolicyIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDistributionsByOriginRequestPolicyIdMiddleware(stack *middleware.Stack, options Options) (err error) {
