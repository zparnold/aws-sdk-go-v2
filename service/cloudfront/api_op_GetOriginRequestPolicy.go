...
func (c *Client) GetOriginRequestPolicy(ctx context.Context, params *GetOriginRequestPolicyInput, optFns ...func(*Options)) (*GetOriginRequestPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOriginRequestPolicy", params, optFns, addOperationGetOriginRequestPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOriginRequestPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
