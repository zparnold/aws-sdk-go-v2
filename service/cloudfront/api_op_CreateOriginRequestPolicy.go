...
func (c *Client) CreateOriginRequestPolicy(ctx context.Context, params *CreateOriginRequestPolicyInput, optFns ...func(*Options)) (*CreateOriginRequestPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOriginRequestPolicy", params, optFns, addOperationCreateOriginRequestPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOriginRequestPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
