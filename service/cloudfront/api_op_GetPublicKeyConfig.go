...
func (c *Client) GetPublicKeyConfig(ctx context.Context, params *GetPublicKeyConfigInput, optFns ...func(*Options)) (*GetPublicKeyConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPublicKeyConfig", params, optFns, addOperationGetPublicKeyConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPublicKeyConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
