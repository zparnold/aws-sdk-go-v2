...
func (c *Client) GetCachePolicyConfig(ctx context.Context, params *GetCachePolicyConfigInput, optFns ...func(*Options)) (*GetCachePolicyConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCachePolicyConfig", params, optFns, addOperationGetCachePolicyConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCachePolicyConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
