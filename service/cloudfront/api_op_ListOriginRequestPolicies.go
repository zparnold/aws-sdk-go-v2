...
func (c *Client) ListOriginRequestPolicies(ctx context.Context, params *ListOriginRequestPoliciesInput, optFns ...func(*Options)) (*ListOriginRequestPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOriginRequestPolicies", params, optFns, addOperationListOriginRequestPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOriginRequestPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
