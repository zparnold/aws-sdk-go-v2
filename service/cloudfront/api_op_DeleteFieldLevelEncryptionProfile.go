...
func (c *Client) DeleteFieldLevelEncryptionProfile(ctx context.Context, params *DeleteFieldLevelEncryptionProfileInput, optFns ...func(*Options)) (*DeleteFieldLevelEncryptionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFieldLevelEncryptionProfile", params, optFns, addOperationDeleteFieldLevelEncryptionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFieldLevelEncryptionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
