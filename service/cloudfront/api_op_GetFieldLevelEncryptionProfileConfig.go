...
func (c *Client) GetFieldLevelEncryptionProfileConfig(ctx context.Context, params *GetFieldLevelEncryptionProfileConfigInput, optFns ...func(*Options)) (*GetFieldLevelEncryptionProfileConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFieldLevelEncryptionProfileConfig", params, optFns, addOperationGetFieldLevelEncryptionProfileConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFieldLevelEncryptionProfileConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
