...
func (c *Client) UpdateFieldLevelEncryptionConfig(ctx context.Context, params *UpdateFieldLevelEncryptionConfigInput, optFns ...func(*Options)) (*UpdateFieldLevelEncryptionConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFieldLevelEncryptionConfig", params, optFns, addOperationUpdateFieldLevelEncryptionConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFieldLevelEncryptionConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
