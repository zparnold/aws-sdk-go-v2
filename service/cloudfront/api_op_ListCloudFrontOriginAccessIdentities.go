...
func (c *Client) ListCloudFrontOriginAccessIdentities(ctx context.Context, params *ListCloudFrontOriginAccessIdentitiesInput, optFns ...func(*Options)) (*ListCloudFrontOriginAccessIdentitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCloudFrontOriginAccessIdentities", params, optFns, addOperationListCloudFrontOriginAccessIdentitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCloudFrontOriginAccessIdentitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
