...
func (c *Client) CreateDistributionWithTags(ctx context.Context, params *CreateDistributionWithTagsInput, optFns ...func(*Options)) (*CreateDistributionWithTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDistributionWithTags", params, optFns, addOperationCreateDistributionWithTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDistributionWithTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
