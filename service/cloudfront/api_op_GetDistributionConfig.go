...
func (c *Client) GetDistributionConfig(ctx context.Context, params *GetDistributionConfigInput, optFns ...func(*Options)) (*GetDistributionConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDistributionConfig", params, optFns, addOperationGetDistributionConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDistributionConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
