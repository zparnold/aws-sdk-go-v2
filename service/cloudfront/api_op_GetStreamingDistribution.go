...
func (c *Client) GetStreamingDistribution(ctx context.Context, params *GetStreamingDistributionInput, optFns ...func(*Options)) (*GetStreamingDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStreamingDistribution", params, optFns, addOperationGetStreamingDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStreamingDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
