...
func (c *Client) GetFieldLevelEncryptionProfile(ctx context.Context, params *GetFieldLevelEncryptionProfileInput, optFns ...func(*Options)) (*GetFieldLevelEncryptionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFieldLevelEncryptionProfile", params, optFns, addOperationGetFieldLevelEncryptionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFieldLevelEncryptionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
