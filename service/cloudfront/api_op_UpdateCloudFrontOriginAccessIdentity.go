...
func (c *Client) UpdateCloudFrontOriginAccessIdentity(ctx context.Context, params *UpdateCloudFrontOriginAccessIdentityInput, optFns ...func(*Options)) (*UpdateCloudFrontOriginAccessIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCloudFrontOriginAccessIdentity", params, optFns, addOperationUpdateCloudFrontOriginAccessIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCloudFrontOriginAccessIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
