...
func (c *Client) GetFieldLevelEncryption(ctx context.Context, params *GetFieldLevelEncryptionInput, optFns ...func(*Options)) (*GetFieldLevelEncryptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFieldLevelEncryption", params, optFns, addOperationGetFieldLevelEncryptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFieldLevelEncryptionMiddleware(stack *middleware.Stack, options Options) (err error) {
