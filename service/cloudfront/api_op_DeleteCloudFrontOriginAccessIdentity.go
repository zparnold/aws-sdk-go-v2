...
func (c *Client) DeleteCloudFrontOriginAccessIdentity(ctx context.Context, params *DeleteCloudFrontOriginAccessIdentityInput, optFns ...func(*Options)) (*DeleteCloudFrontOriginAccessIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCloudFrontOriginAccessIdentity", params, optFns, addOperationDeleteCloudFrontOriginAccessIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCloudFrontOriginAccessIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
