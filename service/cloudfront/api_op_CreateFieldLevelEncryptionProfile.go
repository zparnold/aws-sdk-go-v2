...
func (c *Client) CreateFieldLevelEncryptionProfile(ctx context.Context, params *CreateFieldLevelEncryptionProfileInput, optFns ...func(*Options)) (*CreateFieldLevelEncryptionProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFieldLevelEncryptionProfile", params, optFns, addOperationCreateFieldLevelEncryptionProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFieldLevelEncryptionProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
