...
func (c *Client) RegisterUsage(ctx context.Context, params *RegisterUsageInput, optFns ...func(*Options)) (*RegisterUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterUsage", params, optFns, addOperationRegisterUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
