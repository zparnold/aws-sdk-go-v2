...
func (c *Client) ResolveCustomer(ctx context.Context, params *ResolveCustomerInput, optFns ...func(*Options)) (*ResolveCustomerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResolveCustomer", params, optFns, addOperationResolveCustomerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResolveCustomerMiddleware(stack *middleware.Stack, options Options) (err error) {
