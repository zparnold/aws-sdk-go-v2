...
func (c *Client) MeterUsage(ctx context.Context, params *MeterUsageInput, optFns ...func(*Options)) (*MeterUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MeterUsage", params, optFns, addOperationMeterUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMeterUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
