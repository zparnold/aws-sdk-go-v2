...
func (c *Client) BatchMeterUsage(ctx context.Context, params *BatchMeterUsageInput, optFns ...func(*Options)) (*BatchMeterUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchMeterUsage", params, optFns, addOperationBatchMeterUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchMeterUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
