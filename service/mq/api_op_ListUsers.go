...
func (c *Client) ListUsers(ctx context.Context, params *ListUsersInput, optFns ...func(*Options)) (*ListUsersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUsers", params, optFns, addOperationListUsersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUsersMiddleware(stack *middleware.Stack, options Options) (err error) {
