...
func (c *Client) UpdateConfiguration(ctx context.Context, params *UpdateConfigurationInput, optFns ...func(*Options)) (*UpdateConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConfiguration", params, optFns, addOperationUpdateConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
