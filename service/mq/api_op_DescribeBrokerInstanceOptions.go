...
func (c *Client) DescribeBrokerInstanceOptions(ctx context.Context, params *DescribeBrokerInstanceOptionsInput, optFns ...func(*Options)) (*DescribeBrokerInstanceOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBrokerInstanceOptions", params, optFns, addOperationDescribeBrokerInstanceOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBrokerInstanceOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
