...
func (c *Client) CreateBroker(ctx context.Context, params *CreateBrokerInput, optFns ...func(*Options)) (*CreateBrokerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBroker", params, optFns, addOperationCreateBrokerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBrokerMiddleware(stack *middleware.Stack, options Options) (err error) {
