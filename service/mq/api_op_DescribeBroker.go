...
func (c *Client) DescribeBroker(ctx context.Context, params *DescribeBrokerInput, optFns ...func(*Options)) (*DescribeBrokerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBroker", params, optFns, addOperationDescribeBrokerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBrokerMiddleware(stack *middleware.Stack, options Options) (err error) {
