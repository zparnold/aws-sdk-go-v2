...
func (c *Client) ListBrokers(ctx context.Context, params *ListBrokersInput, optFns ...func(*Options)) (*ListBrokersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBrokers", params, optFns, addOperationListBrokersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBrokersMiddleware(stack *middleware.Stack, options Options) (err error) {
