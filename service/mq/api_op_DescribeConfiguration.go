...
func (c *Client) DescribeConfiguration(ctx context.Context, params *DescribeConfigurationInput, optFns ...func(*Options)) (*DescribeConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfiguration", params, optFns, addOperationDescribeConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
