...
func (c *Client) DeleteBroker(ctx context.Context, params *DeleteBrokerInput, optFns ...func(*Options)) (*DeleteBrokerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBroker", params, optFns, addOperationDeleteBrokerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBrokerMiddleware(stack *middleware.Stack, options Options) (err error) {
