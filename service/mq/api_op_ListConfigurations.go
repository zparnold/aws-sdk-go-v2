...
func (c *Client) ListConfigurations(ctx context.Context, params *ListConfigurationsInput, optFns ...func(*Options)) (*ListConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConfigurations", params, optFns, addOperationListConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
