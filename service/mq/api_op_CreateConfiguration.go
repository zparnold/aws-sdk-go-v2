...
func (c *Client) CreateConfiguration(ctx context.Context, params *CreateConfigurationInput, optFns ...func(*Options)) (*CreateConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConfiguration", params, optFns, addOperationCreateConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
