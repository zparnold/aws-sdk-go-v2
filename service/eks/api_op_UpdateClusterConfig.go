...
func (c *Client) UpdateClusterConfig(ctx context.Context, params *UpdateClusterConfigInput, optFns ...func(*Options)) (*UpdateClusterConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClusterConfig", params, optFns, addOperationUpdateClusterConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClusterConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
