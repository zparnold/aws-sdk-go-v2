...
func (c *Client) ListUpdates(ctx context.Context, params *ListUpdatesInput, optFns ...func(*Options)) (*ListUpdatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUpdates", params, optFns, addOperationListUpdatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUpdatesMiddleware(stack *middleware.Stack, options Options) (err error) {
