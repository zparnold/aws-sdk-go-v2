...
func (c *Client) DeleteFargateProfile(ctx context.Context, params *DeleteFargateProfileInput, optFns ...func(*Options)) (*DeleteFargateProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFargateProfile", params, optFns, addOperationDeleteFargateProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFargateProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
