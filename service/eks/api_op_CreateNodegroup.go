...
func (c *Client) CreateNodegroup(ctx context.Context, params *CreateNodegroupInput, optFns ...func(*Options)) (*CreateNodegroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNodegroup", params, optFns, addOperationCreateNodegroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNodegroupMiddleware(stack *middleware.Stack, options Options) (err error) {
