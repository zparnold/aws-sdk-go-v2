...
func (c *Client) DescribeNodegroup(ctx context.Context, params *DescribeNodegroupInput, optFns ...func(*Options)) (*DescribeNodegroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNodegroup", params, optFns, addOperationDescribeNodegroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNodegroupMiddleware(stack *middleware.Stack, options Options) (err error) {
