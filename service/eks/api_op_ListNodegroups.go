...
func (c *Client) ListNodegroups(ctx context.Context, params *ListNodegroupsInput, optFns ...func(*Options)) (*ListNodegroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNodegroups", params, optFns, addOperationListNodegroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNodegroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
