...
func (c *Client) ListFargateProfiles(ctx context.Context, params *ListFargateProfilesInput, optFns ...func(*Options)) (*ListFargateProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFargateProfiles", params, optFns, addOperationListFargateProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFargateProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
