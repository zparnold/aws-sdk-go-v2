...
func (c *Client) DescribeUpdate(ctx context.Context, params *DescribeUpdateInput, optFns ...func(*Options)) (*DescribeUpdateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUpdate", params, optFns, addOperationDescribeUpdateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUpdateMiddleware(stack *middleware.Stack, options Options) (err error) {
