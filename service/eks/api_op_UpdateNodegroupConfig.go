...
func (c *Client) UpdateNodegroupConfig(ctx context.Context, params *UpdateNodegroupConfigInput, optFns ...func(*Options)) (*UpdateNodegroupConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNodegroupConfig", params, optFns, addOperationUpdateNodegroupConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNodegroupConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
