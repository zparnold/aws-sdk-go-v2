...
func (c *Client) DeleteNodegroup(ctx context.Context, params *DeleteNodegroupInput, optFns ...func(*Options)) (*DeleteNodegroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNodegroup", params, optFns, addOperationDeleteNodegroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNodegroupMiddleware(stack *middleware.Stack, options Options) (err error) {
