...
func (c *Client) UpdateClusterVersion(ctx context.Context, params *UpdateClusterVersionInput, optFns ...func(*Options)) (*UpdateClusterVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClusterVersion", params, optFns, addOperationUpdateClusterVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClusterVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
