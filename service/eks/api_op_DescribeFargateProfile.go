...
func (c *Client) DescribeFargateProfile(ctx context.Context, params *DescribeFargateProfileInput, optFns ...func(*Options)) (*DescribeFargateProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFargateProfile", params, optFns, addOperationDescribeFargateProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFargateProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
