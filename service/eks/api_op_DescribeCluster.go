...
func (c *Client) DescribeCluster(ctx context.Context, params *DescribeClusterInput, optFns ...func(*Options)) (*DescribeClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCluster", params, optFns, addOperationDescribeClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
