...
func (c *Client) UpdateNodegroupVersion(ctx context.Context, params *UpdateNodegroupVersionInput, optFns ...func(*Options)) (*UpdateNodegroupVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNodegroupVersion", params, optFns, addOperationUpdateNodegroupVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNodegroupVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
