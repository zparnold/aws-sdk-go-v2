...
func (c *Client) CreateFargateProfile(ctx context.Context, params *CreateFargateProfileInput, optFns ...func(*Options)) (*CreateFargateProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFargateProfile", params, optFns, addOperationCreateFargateProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFargateProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
