...
func (c *Client) DescribeReplicationTaskAssessmentRuns(ctx context.Context, params *DescribeReplicationTaskAssessmentRunsInput, optFns ...func(*Options)) (*DescribeReplicationTaskAssessmentRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReplicationTaskAssessmentRuns", params, optFns, addOperationDescribeReplicationTaskAssessmentRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReplicationTaskAssessmentRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
