...
func (c *Client) CancelReplicationTaskAssessmentRun(ctx context.Context, params *CancelReplicationTaskAssessmentRunInput, optFns ...func(*Options)) (*CancelReplicationTaskAssessmentRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelReplicationTaskAssessmentRun", params, optFns, addOperationCancelReplicationTaskAssessmentRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelReplicationTaskAssessmentRunMiddleware(stack *middleware.Stack, options Options) (err error) {
