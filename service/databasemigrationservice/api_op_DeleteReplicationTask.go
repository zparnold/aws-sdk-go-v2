...
func (c *Client) DeleteReplicationTask(ctx context.Context, params *DeleteReplicationTaskInput, optFns ...func(*Options)) (*DeleteReplicationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReplicationTask", params, optFns, addOperationDeleteReplicationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReplicationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
