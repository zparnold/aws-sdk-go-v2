...
func (c *Client) ReloadTables(ctx context.Context, params *ReloadTablesInput, optFns ...func(*Options)) (*ReloadTablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReloadTables", params, optFns, addOperationReloadTablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReloadTablesMiddleware(stack *middleware.Stack, options Options) (err error) {
