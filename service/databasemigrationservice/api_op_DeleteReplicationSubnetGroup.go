...
func (c *Client) DeleteReplicationSubnetGroup(ctx context.Context, params *DeleteReplicationSubnetGroupInput, optFns ...func(*Options)) (*DeleteReplicationSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReplicationSubnetGroup", params, optFns, addOperationDeleteReplicationSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReplicationSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
