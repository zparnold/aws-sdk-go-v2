...
func (c *Client) ModifyReplicationTask(ctx context.Context, params *ModifyReplicationTaskInput, optFns ...func(*Options)) (*ModifyReplicationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyReplicationTask", params, optFns, addOperationModifyReplicationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyReplicationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
