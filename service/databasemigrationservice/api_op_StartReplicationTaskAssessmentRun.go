...
func (c *Client) StartReplicationTaskAssessmentRun(ctx context.Context, params *StartReplicationTaskAssessmentRunInput, optFns ...func(*Options)) (*StartReplicationTaskAssessmentRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartReplicationTaskAssessmentRun", params, optFns, addOperationStartReplicationTaskAssessmentRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartReplicationTaskAssessmentRunMiddleware(stack *middleware.Stack, options Options) (err error) {
