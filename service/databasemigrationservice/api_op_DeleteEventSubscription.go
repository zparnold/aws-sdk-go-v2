...
func (c *Client) DeleteEventSubscription(ctx context.Context, params *DeleteEventSubscriptionInput, optFns ...func(*Options)) (*DeleteEventSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEventSubscription", params, optFns, addOperationDeleteEventSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEventSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
