...
func (c *Client) RefreshSchemas(ctx context.Context, params *RefreshSchemasInput, optFns ...func(*Options)) (*RefreshSchemasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RefreshSchemas", params, optFns, addOperationRefreshSchemasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRefreshSchemasMiddleware(stack *middleware.Stack, options Options) (err error) {
