...
func (c *Client) DescribeSchemas(ctx context.Context, params *DescribeSchemasInput, optFns ...func(*Options)) (*DescribeSchemasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSchemas", params, optFns, addOperationDescribeSchemasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSchemasMiddleware(stack *middleware.Stack, options Options) (err error) {
