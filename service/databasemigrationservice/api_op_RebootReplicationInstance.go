...
func (c *Client) RebootReplicationInstance(ctx context.Context, params *RebootReplicationInstanceInput, optFns ...func(*Options)) (*RebootReplicationInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootReplicationInstance", params, optFns, addOperationRebootReplicationInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootReplicationInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
