...
func (c *Client) DescribeEndpointTypes(ctx context.Context, params *DescribeEndpointTypesInput, optFns ...func(*Options)) (*DescribeEndpointTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEndpointTypes", params, optFns, addOperationDescribeEndpointTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEndpointTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
