...
func (c *Client) CreateReplicationSubnetGroup(ctx context.Context, params *CreateReplicationSubnetGroupInput, optFns ...func(*Options)) (*CreateReplicationSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReplicationSubnetGroup", params, optFns, addOperationCreateReplicationSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReplicationSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
