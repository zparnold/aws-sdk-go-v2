...
func (c *Client) ImportCertificate(ctx context.Context, params *ImportCertificateInput, optFns ...func(*Options)) (*ImportCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportCertificate", params, optFns, addOperationImportCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
