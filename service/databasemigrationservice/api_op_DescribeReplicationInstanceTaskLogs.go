...
func (c *Client) DescribeReplicationInstanceTaskLogs(ctx context.Context, params *DescribeReplicationInstanceTaskLogsInput, optFns ...func(*Options)) (*DescribeReplicationInstanceTaskLogsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReplicationInstanceTaskLogs", params, optFns, addOperationDescribeReplicationInstanceTaskLogsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReplicationInstanceTaskLogsMiddleware(stack *middleware.Stack, options Options) (err error) {
