...
func (c *Client) StartReplicationTaskAssessment(ctx context.Context, params *StartReplicationTaskAssessmentInput, optFns ...func(*Options)) (*StartReplicationTaskAssessmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartReplicationTaskAssessment", params, optFns, addOperationStartReplicationTaskAssessmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartReplicationTaskAssessmentMiddleware(stack *middleware.Stack, options Options) (err error) {
