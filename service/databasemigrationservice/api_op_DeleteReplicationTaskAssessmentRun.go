...
func (c *Client) DeleteReplicationTaskAssessmentRun(ctx context.Context, params *DeleteReplicationTaskAssessmentRunInput, optFns ...func(*Options)) (*DeleteReplicationTaskAssessmentRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReplicationTaskAssessmentRun", params, optFns, addOperationDeleteReplicationTaskAssessmentRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReplicationTaskAssessmentRunMiddleware(stack *middleware.Stack, options Options) (err error) {
