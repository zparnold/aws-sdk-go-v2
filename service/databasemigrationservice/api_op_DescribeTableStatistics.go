...
func (c *Client) DescribeTableStatistics(ctx context.Context, params *DescribeTableStatisticsInput, optFns ...func(*Options)) (*DescribeTableStatisticsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTableStatistics", params, optFns, addOperationDescribeTableStatisticsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTableStatisticsMiddleware(stack *middleware.Stack, options Options) (err error) {
