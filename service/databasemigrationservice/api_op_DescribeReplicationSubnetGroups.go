...
func (c *Client) DescribeReplicationSubnetGroups(ctx context.Context, params *DescribeReplicationSubnetGroupsInput, optFns ...func(*Options)) (*DescribeReplicationSubnetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReplicationSubnetGroups", params, optFns, addOperationDescribeReplicationSubnetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReplicationSubnetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
