...
func (c *Client) DescribeReplicationTasks(ctx context.Context, params *DescribeReplicationTasksInput, optFns ...func(*Options)) (*DescribeReplicationTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReplicationTasks", params, optFns, addOperationDescribeReplicationTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReplicationTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
