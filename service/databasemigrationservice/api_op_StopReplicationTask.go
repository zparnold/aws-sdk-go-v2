...
func (c *Client) StopReplicationTask(ctx context.Context, params *StopReplicationTaskInput, optFns ...func(*Options)) (*StopReplicationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopReplicationTask", params, optFns, addOperationStopReplicationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopReplicationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
