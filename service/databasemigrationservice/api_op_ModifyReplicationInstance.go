...
func (c *Client) ModifyReplicationInstance(ctx context.Context, params *ModifyReplicationInstanceInput, optFns ...func(*Options)) (*ModifyReplicationInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyReplicationInstance", params, optFns, addOperationModifyReplicationInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyReplicationInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
