...
func (c *Client) CreateReplicationInstance(ctx context.Context, params *CreateReplicationInstanceInput, optFns ...func(*Options)) (*CreateReplicationInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReplicationInstance", params, optFns, addOperationCreateReplicationInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReplicationInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
