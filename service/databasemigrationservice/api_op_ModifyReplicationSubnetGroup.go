...
func (c *Client) ModifyReplicationSubnetGroup(ctx context.Context, params *ModifyReplicationSubnetGroupInput, optFns ...func(*Options)) (*ModifyReplicationSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyReplicationSubnetGroup", params, optFns, addOperationModifyReplicationSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyReplicationSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
