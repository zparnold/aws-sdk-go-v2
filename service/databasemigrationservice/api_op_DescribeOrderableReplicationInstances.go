...
func (c *Client) DescribeOrderableReplicationInstances(ctx context.Context, params *DescribeOrderableReplicationInstancesInput, optFns ...func(*Options)) (*DescribeOrderableReplicationInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrderableReplicationInstances", params, optFns, addOperationDescribeOrderableReplicationInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrderableReplicationInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
