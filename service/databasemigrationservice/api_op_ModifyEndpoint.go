...
func (c *Client) ModifyEndpoint(ctx context.Context, params *ModifyEndpointInput, optFns ...func(*Options)) (*ModifyEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyEndpoint", params, optFns, addOperationModifyEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
