...
func (c *Client) CreateReplicationTask(ctx context.Context, params *CreateReplicationTaskInput, optFns ...func(*Options)) (*CreateReplicationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReplicationTask", params, optFns, addOperationCreateReplicationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReplicationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
