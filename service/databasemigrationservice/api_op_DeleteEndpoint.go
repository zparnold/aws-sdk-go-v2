...
func (c *Client) DeleteEndpoint(ctx context.Context, params *DeleteEndpointInput, optFns ...func(*Options)) (*DeleteEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEndpoint", params, optFns, addOperationDeleteEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
