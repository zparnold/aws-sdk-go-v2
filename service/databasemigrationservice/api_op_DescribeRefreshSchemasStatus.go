...
func (c *Client) DescribeRefreshSchemasStatus(ctx context.Context, params *DescribeRefreshSchemasStatusInput, optFns ...func(*Options)) (*DescribeRefreshSchemasStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRefreshSchemasStatus", params, optFns, addOperationDescribeRefreshSchemasStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRefreshSchemasStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
