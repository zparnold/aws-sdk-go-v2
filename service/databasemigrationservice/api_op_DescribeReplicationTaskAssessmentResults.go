...
func (c *Client) DescribeReplicationTaskAssessmentResults(ctx context.Context, params *DescribeReplicationTaskAssessmentResultsInput, optFns ...func(*Options)) (*DescribeReplicationTaskAssessmentResultsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReplicationTaskAssessmentResults", params, optFns, addOperationDescribeReplicationTaskAssessmentResultsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReplicationTaskAssessmentResultsMiddleware(stack *middleware.Stack, options Options) (err error) {
