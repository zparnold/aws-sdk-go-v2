...
func (c *Client) DeleteReplicationInstance(ctx context.Context, params *DeleteReplicationInstanceInput, optFns ...func(*Options)) (*DeleteReplicationInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReplicationInstance", params, optFns, addOperationDeleteReplicationInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReplicationInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
