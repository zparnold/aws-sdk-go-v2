...
func (c *Client) StartReplicationTask(ctx context.Context, params *StartReplicationTaskInput, optFns ...func(*Options)) (*StartReplicationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartReplicationTask", params, optFns, addOperationStartReplicationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartReplicationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
