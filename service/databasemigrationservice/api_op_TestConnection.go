...
func (c *Client) TestConnection(ctx context.Context, params *TestConnectionInput, optFns ...func(*Options)) (*TestConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestConnection", params, optFns, addOperationTestConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
