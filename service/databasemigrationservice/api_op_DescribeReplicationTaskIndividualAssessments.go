...
func (c *Client) DescribeReplicationTaskIndividualAssessments(ctx context.Context, params *DescribeReplicationTaskIndividualAssessmentsInput, optFns ...func(*Options)) (*DescribeReplicationTaskIndividualAssessmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReplicationTaskIndividualAssessments", params, optFns, addOperationDescribeReplicationTaskIndividualAssessmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReplicationTaskIndividualAssessmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
