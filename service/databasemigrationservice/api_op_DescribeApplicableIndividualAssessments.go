...
func (c *Client) DescribeApplicableIndividualAssessments(ctx context.Context, params *DescribeApplicableIndividualAssessmentsInput, optFns ...func(*Options)) (*DescribeApplicableIndividualAssessmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeApplicableIndividualAssessments", params, optFns, addOperationDescribeApplicableIndividualAssessmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeApplicableIndividualAssessmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
