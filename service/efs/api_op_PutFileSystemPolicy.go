...
func (c *Client) PutFileSystemPolicy(ctx context.Context, params *PutFileSystemPolicyInput, optFns ...func(*Options)) (*PutFileSystemPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutFileSystemPolicy", params, optFns, addOperationPutFileSystemPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutFileSystemPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
