...
func (c *Client) ModifyMountTargetSecurityGroups(ctx context.Context, params *ModifyMountTargetSecurityGroupsInput, optFns ...func(*Options)) (*ModifyMountTargetSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyMountTargetSecurityGroups", params, optFns, addOperationModifyMountTargetSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyMountTargetSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
