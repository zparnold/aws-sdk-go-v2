...
func (c *Client) DescribeAccessPoints(ctx context.Context, params *DescribeAccessPointsInput, optFns ...func(*Options)) (*DescribeAccessPointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccessPoints", params, optFns, addOperationDescribeAccessPointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccessPointsMiddleware(stack *middleware.Stack, options Options) (err error) {
