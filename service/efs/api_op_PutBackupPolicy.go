...
func (c *Client) PutBackupPolicy(ctx context.Context, params *PutBackupPolicyInput, optFns ...func(*Options)) (*PutBackupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBackupPolicy", params, optFns, addOperationPutBackupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBackupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
