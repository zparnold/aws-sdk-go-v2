...
func (c *Client) DescribeFileSystems(ctx context.Context, params *DescribeFileSystemsInput, optFns ...func(*Options)) (*DescribeFileSystemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFileSystems", params, optFns, addOperationDescribeFileSystemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFileSystemsMiddleware(stack *middleware.Stack, options Options) (err error) {
