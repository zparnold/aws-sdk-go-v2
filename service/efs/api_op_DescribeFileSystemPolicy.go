...
func (c *Client) DescribeFileSystemPolicy(ctx context.Context, params *DescribeFileSystemPolicyInput, optFns ...func(*Options)) (*DescribeFileSystemPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFileSystemPolicy", params, optFns, addOperationDescribeFileSystemPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFileSystemPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
