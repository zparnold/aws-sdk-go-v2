...
func (c *Client) DescribeTags(ctx context.Context, params *DescribeTagsInput, optFns ...func(*Options)) (*DescribeTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTags", params, optFns, addOperationDescribeTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
