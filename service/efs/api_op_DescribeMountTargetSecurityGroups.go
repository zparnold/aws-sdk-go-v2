...
func (c *Client) DescribeMountTargetSecurityGroups(ctx context.Context, params *DescribeMountTargetSecurityGroupsInput, optFns ...func(*Options)) (*DescribeMountTargetSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMountTargetSecurityGroups", params, optFns, addOperationDescribeMountTargetSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMountTargetSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
