...
func (c *Client) DeleteAccessPoint(ctx context.Context, params *DeleteAccessPointInput, optFns ...func(*Options)) (*DeleteAccessPointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccessPoint", params, optFns, addOperationDeleteAccessPointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccessPointMiddleware(stack *middleware.Stack, options Options) (err error) {
