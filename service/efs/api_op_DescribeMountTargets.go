...
func (c *Client) DescribeMountTargets(ctx context.Context, params *DescribeMountTargetsInput, optFns ...func(*Options)) (*DescribeMountTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMountTargets", params, optFns, addOperationDescribeMountTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMountTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
