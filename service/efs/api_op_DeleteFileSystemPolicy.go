...
func (c *Client) DeleteFileSystemPolicy(ctx context.Context, params *DeleteFileSystemPolicyInput, optFns ...func(*Options)) (*DeleteFileSystemPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFileSystemPolicy", params, optFns, addOperationDeleteFileSystemPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFileSystemPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
