...
func (c *Client) DeleteFileSystem(ctx context.Context, params *DeleteFileSystemInput, optFns ...func(*Options)) (*DeleteFileSystemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFileSystem", params, optFns, addOperationDeleteFileSystemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFileSystemMiddleware(stack *middleware.Stack, options Options) (err error) {
