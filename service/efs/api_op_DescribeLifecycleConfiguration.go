...
func (c *Client) DescribeLifecycleConfiguration(ctx context.Context, params *DescribeLifecycleConfigurationInput, optFns ...func(*Options)) (*DescribeLifecycleConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLifecycleConfiguration", params, optFns, addOperationDescribeLifecycleConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLifecycleConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
