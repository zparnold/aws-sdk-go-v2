...
func (c *Client) DescribeBackupPolicy(ctx context.Context, params *DescribeBackupPolicyInput, optFns ...func(*Options)) (*DescribeBackupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBackupPolicy", params, optFns, addOperationDescribeBackupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBackupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
