...
func (c *Client) DeleteMountTarget(ctx context.Context, params *DeleteMountTargetInput, optFns ...func(*Options)) (*DeleteMountTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMountTarget", params, optFns, addOperationDeleteMountTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMountTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
