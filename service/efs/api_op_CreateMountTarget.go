...
func (c *Client) CreateMountTarget(ctx context.Context, params *CreateMountTargetInput, optFns ...func(*Options)) (*CreateMountTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMountTarget", params, optFns, addOperationCreateMountTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMountTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
