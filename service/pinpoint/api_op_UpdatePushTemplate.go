...
func (c *Client) UpdatePushTemplate(ctx context.Context, params *UpdatePushTemplateInput, optFns ...func(*Options)) (*UpdatePushTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePushTemplate", params, optFns, addOperationUpdatePushTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePushTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
