...
func (c *Client) DeleteGcmChannel(ctx context.Context, params *DeleteGcmChannelInput, optFns ...func(*Options)) (*DeleteGcmChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGcmChannel", params, optFns, addOperationDeleteGcmChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGcmChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
