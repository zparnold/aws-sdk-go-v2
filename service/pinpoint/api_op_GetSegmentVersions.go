...
func (c *Client) GetSegmentVersions(ctx context.Context, params *GetSegmentVersionsInput, optFns ...func(*Options)) (*GetSegmentVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSegmentVersions", params, optFns, addOperationGetSegmentVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSegmentVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
