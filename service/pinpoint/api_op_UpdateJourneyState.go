...
func (c *Client) UpdateJourneyState(ctx context.Context, params *UpdateJourneyStateInput, optFns ...func(*Options)) (*UpdateJourneyStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateJourneyState", params, optFns, addOperationUpdateJourneyStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateJourneyStateMiddleware(stack *middleware.Stack, options Options) (err error) {
