...
func (c *Client) GetBaiduChannel(ctx context.Context, params *GetBaiduChannelInput, optFns ...func(*Options)) (*GetBaiduChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBaiduChannel", params, optFns, addOperationGetBaiduChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBaiduChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
