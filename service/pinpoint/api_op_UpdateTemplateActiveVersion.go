...
func (c *Client) UpdateTemplateActiveVersion(ctx context.Context, params *UpdateTemplateActiveVersionInput, optFns ...func(*Options)) (*UpdateTemplateActiveVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTemplateActiveVersion", params, optFns, addOperationUpdateTemplateActiveVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTemplateActiveVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
