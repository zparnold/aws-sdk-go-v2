...
func (c *Client) PutEventStream(ctx context.Context, params *PutEventStreamInput, optFns ...func(*Options)) (*PutEventStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEventStream", params, optFns, addOperationPutEventStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEventStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
