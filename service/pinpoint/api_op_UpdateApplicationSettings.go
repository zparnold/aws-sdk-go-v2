...
func (c *Client) UpdateApplicationSettings(ctx context.Context, params *UpdateApplicationSettingsInput, optFns ...func(*Options)) (*UpdateApplicationSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApplicationSettings", params, optFns, addOperationUpdateApplicationSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApplicationSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
