...
func (c *Client) GetSegments(ctx context.Context, params *GetSegmentsInput, optFns ...func(*Options)) (*GetSegmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSegments", params, optFns, addOperationGetSegmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSegmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
