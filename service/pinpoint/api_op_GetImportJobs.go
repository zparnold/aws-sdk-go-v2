...
func (c *Client) GetImportJobs(ctx context.Context, params *GetImportJobsInput, optFns ...func(*Options)) (*GetImportJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetImportJobs", params, optFns, addOperationGetImportJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetImportJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
