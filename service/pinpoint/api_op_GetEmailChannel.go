...
func (c *Client) GetEmailChannel(ctx context.Context, params *GetEmailChannelInput, optFns ...func(*Options)) (*GetEmailChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEmailChannel", params, optFns, addOperationGetEmailChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEmailChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
