...
func (c *Client) ListTemplates(ctx context.Context, params *ListTemplatesInput, optFns ...func(*Options)) (*ListTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTemplates", params, optFns, addOperationListTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
