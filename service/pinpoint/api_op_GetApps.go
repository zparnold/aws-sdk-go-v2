...
func (c *Client) GetApps(ctx context.Context, params *GetAppsInput, optFns ...func(*Options)) (*GetAppsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApps", params, optFns, addOperationGetAppsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAppsMiddleware(stack *middleware.Stack, options Options) (err error) {
