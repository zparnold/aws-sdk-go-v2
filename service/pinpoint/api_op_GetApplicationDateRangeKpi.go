...
func (c *Client) GetApplicationDateRangeKpi(ctx context.Context, params *GetApplicationDateRangeKpiInput, optFns ...func(*Options)) (*GetApplicationDateRangeKpiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApplicationDateRangeKpi", params, optFns, addOperationGetApplicationDateRangeKpiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApplicationDateRangeKpiMiddleware(stack *middleware.Stack, options Options) (err error) {
