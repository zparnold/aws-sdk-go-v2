...
func (c *Client) DeletePushTemplate(ctx context.Context, params *DeletePushTemplateInput, optFns ...func(*Options)) (*DeletePushTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePushTemplate", params, optFns, addOperationDeletePushTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePushTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
