...
func (c *Client) GetCampaignVersions(ctx context.Context, params *GetCampaignVersionsInput, optFns ...func(*Options)) (*GetCampaignVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCampaignVersions", params, optFns, addOperationGetCampaignVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCampaignVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
