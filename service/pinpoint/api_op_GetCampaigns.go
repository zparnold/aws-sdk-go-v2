...
func (c *Client) GetCampaigns(ctx context.Context, params *GetCampaignsInput, optFns ...func(*Options)) (*GetCampaignsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCampaigns", params, optFns, addOperationGetCampaignsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCampaignsMiddleware(stack *middleware.Stack, options Options) (err error) {
