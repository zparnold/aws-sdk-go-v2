...
func (c *Client) CreatePushTemplate(ctx context.Context, params *CreatePushTemplateInput, optFns ...func(*Options)) (*CreatePushTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePushTemplate", params, optFns, addOperationCreatePushTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePushTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
