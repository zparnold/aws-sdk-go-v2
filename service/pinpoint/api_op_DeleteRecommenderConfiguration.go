...
func (c *Client) DeleteRecommenderConfiguration(ctx context.Context, params *DeleteRecommenderConfigurationInput, optFns ...func(*Options)) (*DeleteRecommenderConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRecommenderConfiguration", params, optFns, addOperationDeleteRecommenderConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRecommenderConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
