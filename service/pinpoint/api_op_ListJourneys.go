...
func (c *Client) ListJourneys(ctx context.Context, params *ListJourneysInput, optFns ...func(*Options)) (*ListJourneysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJourneys", params, optFns, addOperationListJourneysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJourneysMiddleware(stack *middleware.Stack, options Options) (err error) {
