...
func (c *Client) DeleteEmailChannel(ctx context.Context, params *DeleteEmailChannelInput, optFns ...func(*Options)) (*DeleteEmailChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEmailChannel", params, optFns, addOperationDeleteEmailChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEmailChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
