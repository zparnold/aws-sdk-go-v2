...
func (c *Client) GetSegment(ctx context.Context, params *GetSegmentInput, optFns ...func(*Options)) (*GetSegmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSegment", params, optFns, addOperationGetSegmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSegmentMiddleware(stack *middleware.Stack, options Options) (err error) {
