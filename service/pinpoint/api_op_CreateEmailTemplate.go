...
func (c *Client) CreateEmailTemplate(ctx context.Context, params *CreateEmailTemplateInput, optFns ...func(*Options)) (*CreateEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEmailTemplate", params, optFns, addOperationCreateEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
