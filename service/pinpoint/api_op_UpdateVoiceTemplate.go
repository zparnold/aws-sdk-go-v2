...
func (c *Client) UpdateVoiceTemplate(ctx context.Context, params *UpdateVoiceTemplateInput, optFns ...func(*Options)) (*UpdateVoiceTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVoiceTemplate", params, optFns, addOperationUpdateVoiceTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVoiceTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
