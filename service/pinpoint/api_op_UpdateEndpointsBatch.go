...
func (c *Client) UpdateEndpointsBatch(ctx context.Context, params *UpdateEndpointsBatchInput, optFns ...func(*Options)) (*UpdateEndpointsBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEndpointsBatch", params, optFns, addOperationUpdateEndpointsBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEndpointsBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
