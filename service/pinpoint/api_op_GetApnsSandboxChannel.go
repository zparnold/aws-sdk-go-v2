...
func (c *Client) GetApnsSandboxChannel(ctx context.Context, params *GetApnsSandboxChannelInput, optFns ...func(*Options)) (*GetApnsSandboxChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApnsSandboxChannel", params, optFns, addOperationGetApnsSandboxChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApnsSandboxChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
