...
func (c *Client) SendMessages(ctx context.Context, params *SendMessagesInput, optFns ...func(*Options)) (*SendMessagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendMessages", params, optFns, addOperationSendMessagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendMessagesMiddleware(stack *middleware.Stack, options Options) (err error) {
