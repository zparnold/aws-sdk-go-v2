...
func (c *Client) GetRecommenderConfigurations(ctx context.Context, params *GetRecommenderConfigurationsInput, optFns ...func(*Options)) (*GetRecommenderConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRecommenderConfigurations", params, optFns, addOperationGetRecommenderConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRecommenderConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
