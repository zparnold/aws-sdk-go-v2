...
func (c *Client) GetChannels(ctx context.Context, params *GetChannelsInput, optFns ...func(*Options)) (*GetChannelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetChannels", params, optFns, addOperationGetChannelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetChannelsMiddleware(stack *middleware.Stack, options Options) (err error) {
