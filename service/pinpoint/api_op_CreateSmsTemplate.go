...
func (c *Client) CreateSmsTemplate(ctx context.Context, params *CreateSmsTemplateInput, optFns ...func(*Options)) (*CreateSmsTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSmsTemplate", params, optFns, addOperationCreateSmsTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSmsTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
