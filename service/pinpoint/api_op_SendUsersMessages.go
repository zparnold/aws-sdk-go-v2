...
func (c *Client) SendUsersMessages(ctx context.Context, params *SendUsersMessagesInput, optFns ...func(*Options)) (*SendUsersMessagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendUsersMessages", params, optFns, addOperationSendUsersMessagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendUsersMessagesMiddleware(stack *middleware.Stack, options Options) (err error) {
