...
func (c *Client) UpdateRecommenderConfiguration(ctx context.Context, params *UpdateRecommenderConfigurationInput, optFns ...func(*Options)) (*UpdateRecommenderConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRecommenderConfiguration", params, optFns, addOperationUpdateRecommenderConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRecommenderConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
