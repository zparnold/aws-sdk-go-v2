...
func (c *Client) GetApnsChannel(ctx context.Context, params *GetApnsChannelInput, optFns ...func(*Options)) (*GetApnsChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApnsChannel", params, optFns, addOperationGetApnsChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApnsChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
