...
func (c *Client) CreateSegment(ctx context.Context, params *CreateSegmentInput, optFns ...func(*Options)) (*CreateSegmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSegment", params, optFns, addOperationCreateSegmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSegmentMiddleware(stack *middleware.Stack, options Options) (err error) {
