...
func (c *Client) DeleteUserEndpoints(ctx context.Context, params *DeleteUserEndpointsInput, optFns ...func(*Options)) (*DeleteUserEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserEndpoints", params, optFns, addOperationDeleteUserEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
