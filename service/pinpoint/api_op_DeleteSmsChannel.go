...
func (c *Client) DeleteSmsChannel(ctx context.Context, params *DeleteSmsChannelInput, optFns ...func(*Options)) (*DeleteSmsChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSmsChannel", params, optFns, addOperationDeleteSmsChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSmsChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
