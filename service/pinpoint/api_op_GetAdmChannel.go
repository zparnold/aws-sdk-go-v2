...
func (c *Client) GetAdmChannel(ctx context.Context, params *GetAdmChannelInput, optFns ...func(*Options)) (*GetAdmChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAdmChannel", params, optFns, addOperationGetAdmChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAdmChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
