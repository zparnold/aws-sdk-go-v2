...
func (c *Client) UpdateSegment(ctx context.Context, params *UpdateSegmentInput, optFns ...func(*Options)) (*UpdateSegmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSegment", params, optFns, addOperationUpdateSegmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSegmentMiddleware(stack *middleware.Stack, options Options) (err error) {
