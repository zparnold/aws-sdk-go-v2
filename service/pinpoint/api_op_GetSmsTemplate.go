...
func (c *Client) GetSmsTemplate(ctx context.Context, params *GetSmsTemplateInput, optFns ...func(*Options)) (*GetSmsTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSmsTemplate", params, optFns, addOperationGetSmsTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSmsTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
