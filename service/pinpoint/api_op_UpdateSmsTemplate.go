...
func (c *Client) UpdateSmsTemplate(ctx context.Context, params *UpdateSmsTemplateInput, optFns ...func(*Options)) (*UpdateSmsTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSmsTemplate", params, optFns, addOperationUpdateSmsTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSmsTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
