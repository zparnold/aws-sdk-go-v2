...
func (c *Client) GetJourneyDateRangeKpi(ctx context.Context, params *GetJourneyDateRangeKpiInput, optFns ...func(*Options)) (*GetJourneyDateRangeKpiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJourneyDateRangeKpi", params, optFns, addOperationGetJourneyDateRangeKpiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJourneyDateRangeKpiMiddleware(stack *middleware.Stack, options Options) (err error) {
