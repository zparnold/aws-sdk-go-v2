...
func (c *Client) GetCampaign(ctx context.Context, params *GetCampaignInput, optFns ...func(*Options)) (*GetCampaignOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCampaign", params, optFns, addOperationGetCampaignMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCampaignMiddleware(stack *middleware.Stack, options Options) (err error) {
