...
func (c *Client) DeleteVoiceTemplate(ctx context.Context, params *DeleteVoiceTemplateInput, optFns ...func(*Options)) (*DeleteVoiceTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceTemplate", params, optFns, addOperationDeleteVoiceTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
