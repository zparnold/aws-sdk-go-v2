...
func (c *Client) CreateVoiceTemplate(ctx context.Context, params *CreateVoiceTemplateInput, optFns ...func(*Options)) (*CreateVoiceTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVoiceTemplate", params, optFns, addOperationCreateVoiceTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVoiceTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
