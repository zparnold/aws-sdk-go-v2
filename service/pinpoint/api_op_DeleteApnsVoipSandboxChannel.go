...
func (c *Client) DeleteApnsVoipSandboxChannel(ctx context.Context, params *DeleteApnsVoipSandboxChannelInput, optFns ...func(*Options)) (*DeleteApnsVoipSandboxChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApnsVoipSandboxChannel", params, optFns, addOperationDeleteApnsVoipSandboxChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApnsVoipSandboxChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
