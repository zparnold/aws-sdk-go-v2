...
func (c *Client) GetCampaignActivities(ctx context.Context, params *GetCampaignActivitiesInput, optFns ...func(*Options)) (*GetCampaignActivitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCampaignActivities", params, optFns, addOperationGetCampaignActivitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCampaignActivitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
