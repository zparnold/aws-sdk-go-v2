...
func (c *Client) DeleteSegment(ctx context.Context, params *DeleteSegmentInput, optFns ...func(*Options)) (*DeleteSegmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSegment", params, optFns, addOperationDeleteSegmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSegmentMiddleware(stack *middleware.Stack, options Options) (err error) {
