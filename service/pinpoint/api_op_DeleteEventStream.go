...
func (c *Client) DeleteEventStream(ctx context.Context, params *DeleteEventStreamInput, optFns ...func(*Options)) (*DeleteEventStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEventStream", params, optFns, addOperationDeleteEventStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEventStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
