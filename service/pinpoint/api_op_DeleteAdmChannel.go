...
func (c *Client) DeleteAdmChannel(ctx context.Context, params *DeleteAdmChannelInput, optFns ...func(*Options)) (*DeleteAdmChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAdmChannel", params, optFns, addOperationDeleteAdmChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAdmChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
