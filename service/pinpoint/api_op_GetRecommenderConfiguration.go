...
func (c *Client) GetRecommenderConfiguration(ctx context.Context, params *GetRecommenderConfigurationInput, optFns ...func(*Options)) (*GetRecommenderConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRecommenderConfiguration", params, optFns, addOperationGetRecommenderConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRecommenderConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
