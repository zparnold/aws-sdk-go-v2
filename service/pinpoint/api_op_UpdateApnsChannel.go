...
func (c *Client) UpdateApnsChannel(ctx context.Context, params *UpdateApnsChannelInput, optFns ...func(*Options)) (*UpdateApnsChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApnsChannel", params, optFns, addOperationUpdateApnsChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApnsChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
