...
func (c *Client) GetCampaignDateRangeKpi(ctx context.Context, params *GetCampaignDateRangeKpiInput, optFns ...func(*Options)) (*GetCampaignDateRangeKpiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCampaignDateRangeKpi", params, optFns, addOperationGetCampaignDateRangeKpiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCampaignDateRangeKpiMiddleware(stack *middleware.Stack, options Options) (err error) {
