...
func (c *Client) PhoneNumberValidate(ctx context.Context, params *PhoneNumberValidateInput, optFns ...func(*Options)) (*PhoneNumberValidateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PhoneNumberValidate", params, optFns, addOperationPhoneNumberValidateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPhoneNumberValidateMiddleware(stack *middleware.Stack, options Options) (err error) {
