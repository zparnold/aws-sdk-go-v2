...
func (c *Client) CreateExportJob(ctx context.Context, params *CreateExportJobInput, optFns ...func(*Options)) (*CreateExportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateExportJob", params, optFns, addOperationCreateExportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateExportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
