...
func (c *Client) DeleteApnsSandboxChannel(ctx context.Context, params *DeleteApnsSandboxChannelInput, optFns ...func(*Options)) (*DeleteApnsSandboxChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApnsSandboxChannel", params, optFns, addOperationDeleteApnsSandboxChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApnsSandboxChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
