...
func (c *Client) GetApnsVoipChannel(ctx context.Context, params *GetApnsVoipChannelInput, optFns ...func(*Options)) (*GetApnsVoipChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApnsVoipChannel", params, optFns, addOperationGetApnsVoipChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApnsVoipChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
