...
func (c *Client) GetSegmentImportJobs(ctx context.Context, params *GetSegmentImportJobsInput, optFns ...func(*Options)) (*GetSegmentImportJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSegmentImportJobs", params, optFns, addOperationGetSegmentImportJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSegmentImportJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
