...
func (c *Client) GetExportJobs(ctx context.Context, params *GetExportJobsInput, optFns ...func(*Options)) (*GetExportJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetExportJobs", params, optFns, addOperationGetExportJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetExportJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
