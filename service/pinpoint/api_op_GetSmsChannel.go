...
func (c *Client) GetSmsChannel(ctx context.Context, params *GetSmsChannelInput, optFns ...func(*Options)) (*GetSmsChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSmsChannel", params, optFns, addOperationGetSmsChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSmsChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
