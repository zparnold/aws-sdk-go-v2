...
func (c *Client) UpdateBaiduChannel(ctx context.Context, params *UpdateBaiduChannelInput, optFns ...func(*Options)) (*UpdateBaiduChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBaiduChannel", params, optFns, addOperationUpdateBaiduChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBaiduChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
