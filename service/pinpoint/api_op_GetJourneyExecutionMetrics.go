...
func (c *Client) GetJourneyExecutionMetrics(ctx context.Context, params *GetJourneyExecutionMetricsInput, optFns ...func(*Options)) (*GetJourneyExecutionMetricsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJourneyExecutionMetrics", params, optFns, addOperationGetJourneyExecutionMetricsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJourneyExecutionMetricsMiddleware(stack *middleware.Stack, options Options) (err error) {
