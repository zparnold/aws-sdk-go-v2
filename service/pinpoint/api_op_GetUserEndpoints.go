...
func (c *Client) GetUserEndpoints(ctx context.Context, params *GetUserEndpointsInput, optFns ...func(*Options)) (*GetUserEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUserEndpoints", params, optFns, addOperationGetUserEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
