...
func (c *Client) UpdateGcmChannel(ctx context.Context, params *UpdateGcmChannelInput, optFns ...func(*Options)) (*UpdateGcmChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGcmChannel", params, optFns, addOperationUpdateGcmChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGcmChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
