...
func (c *Client) CreateJourney(ctx context.Context, params *CreateJourneyInput, optFns ...func(*Options)) (*CreateJourneyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateJourney", params, optFns, addOperationCreateJourneyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateJourneyMiddleware(stack *middleware.Stack, options Options) (err error) {
