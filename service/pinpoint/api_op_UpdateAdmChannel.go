...
func (c *Client) UpdateAdmChannel(ctx context.Context, params *UpdateAdmChannelInput, optFns ...func(*Options)) (*UpdateAdmChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAdmChannel", params, optFns, addOperationUpdateAdmChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAdmChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
