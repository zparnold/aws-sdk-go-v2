...
func (c *Client) DeleteVoiceChannel(ctx context.Context, params *DeleteVoiceChannelInput, optFns ...func(*Options)) (*DeleteVoiceChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVoiceChannel", params, optFns, addOperationDeleteVoiceChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVoiceChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
