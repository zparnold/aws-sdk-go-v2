...
func (c *Client) GetEndpoint(ctx context.Context, params *GetEndpointInput, optFns ...func(*Options)) (*GetEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEndpoint", params, optFns, addOperationGetEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
