...
func (c *Client) GetPushTemplate(ctx context.Context, params *GetPushTemplateInput, optFns ...func(*Options)) (*GetPushTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPushTemplate", params, optFns, addOperationGetPushTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPushTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
