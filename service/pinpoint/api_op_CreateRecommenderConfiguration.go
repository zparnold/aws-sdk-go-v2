...
func (c *Client) CreateRecommenderConfiguration(ctx context.Context, params *CreateRecommenderConfigurationInput, optFns ...func(*Options)) (*CreateRecommenderConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRecommenderConfiguration", params, optFns, addOperationCreateRecommenderConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRecommenderConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
