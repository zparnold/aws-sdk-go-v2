...
func (c *Client) GetVoiceChannel(ctx context.Context, params *GetVoiceChannelInput, optFns ...func(*Options)) (*GetVoiceChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceChannel", params, optFns, addOperationGetVoiceChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
