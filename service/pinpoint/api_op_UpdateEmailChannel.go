...
func (c *Client) UpdateEmailChannel(ctx context.Context, params *UpdateEmailChannelInput, optFns ...func(*Options)) (*UpdateEmailChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEmailChannel", params, optFns, addOperationUpdateEmailChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEmailChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
