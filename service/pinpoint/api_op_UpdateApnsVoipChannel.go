...
func (c *Client) UpdateApnsVoipChannel(ctx context.Context, params *UpdateApnsVoipChannelInput, optFns ...func(*Options)) (*UpdateApnsVoipChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApnsVoipChannel", params, optFns, addOperationUpdateApnsVoipChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApnsVoipChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
