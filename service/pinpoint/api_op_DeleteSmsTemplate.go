...
func (c *Client) DeleteSmsTemplate(ctx context.Context, params *DeleteSmsTemplateInput, optFns ...func(*Options)) (*DeleteSmsTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSmsTemplate", params, optFns, addOperationDeleteSmsTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSmsTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
