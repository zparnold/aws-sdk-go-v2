...
func (c *Client) UpdateVoiceChannel(ctx context.Context, params *UpdateVoiceChannelInput, optFns ...func(*Options)) (*UpdateVoiceChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVoiceChannel", params, optFns, addOperationUpdateVoiceChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVoiceChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
