...
func (c *Client) GetGcmChannel(ctx context.Context, params *GetGcmChannelInput, optFns ...func(*Options)) (*GetGcmChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGcmChannel", params, optFns, addOperationGetGcmChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGcmChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
