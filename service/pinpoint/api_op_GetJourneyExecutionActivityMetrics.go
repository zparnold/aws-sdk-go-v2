...
func (c *Client) GetJourneyExecutionActivityMetrics(ctx context.Context, params *GetJourneyExecutionActivityMetricsInput, optFns ...func(*Options)) (*GetJourneyExecutionActivityMetricsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJourneyExecutionActivityMetrics", params, optFns, addOperationGetJourneyExecutionActivityMetricsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJourneyExecutionActivityMetricsMiddleware(stack *middleware.Stack, options Options) (err error) {
