...
func (c *Client) GetVoiceTemplate(ctx context.Context, params *GetVoiceTemplateInput, optFns ...func(*Options)) (*GetVoiceTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVoiceTemplate", params, optFns, addOperationGetVoiceTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVoiceTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
