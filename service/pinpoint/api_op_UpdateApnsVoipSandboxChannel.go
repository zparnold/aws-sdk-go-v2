...
func (c *Client) UpdateApnsVoipSandboxChannel(ctx context.Context, params *UpdateApnsVoipSandboxChannelInput, optFns ...func(*Options)) (*UpdateApnsVoipSandboxChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApnsVoipSandboxChannel", params, optFns, addOperationUpdateApnsVoipSandboxChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApnsVoipSandboxChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
