...
func (c *Client) BatchPutDocument(ctx context.Context, params *BatchPutDocumentInput, optFns ...func(*Options)) (*BatchPutDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchPutDocument", params, optFns, addOperationBatchPutDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchPutDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
