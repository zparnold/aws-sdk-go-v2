...
func (c *Client) ListIndices(ctx context.Context, params *ListIndicesInput, optFns ...func(*Options)) (*ListIndicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIndices", params, optFns, addOperationListIndicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIndicesMiddleware(stack *middleware.Stack, options Options) (err error) {
