...
func (c *Client) DeleteFaq(ctx context.Context, params *DeleteFaqInput, optFns ...func(*Options)) (*DeleteFaqOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFaq", params, optFns, addOperationDeleteFaqMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFaqMiddleware(stack *middleware.Stack, options Options) (err error) {
