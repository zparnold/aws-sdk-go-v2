...
func (c *Client) DeleteIndex(ctx context.Context, params *DeleteIndexInput, optFns ...func(*Options)) (*DeleteIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIndex", params, optFns, addOperationDeleteIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
