...
func (c *Client) ListDataSources(ctx context.Context, params *ListDataSourcesInput, optFns ...func(*Options)) (*ListDataSourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDataSources", params, optFns, addOperationListDataSourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDataSourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
