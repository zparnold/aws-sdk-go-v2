...
func (c *Client) StartDataSourceSyncJob(ctx context.Context, params *StartDataSourceSyncJobInput, optFns ...func(*Options)) (*StartDataSourceSyncJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDataSourceSyncJob", params, optFns, addOperationStartDataSourceSyncJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDataSourceSyncJobMiddleware(stack *middleware.Stack, options Options) (err error) {
