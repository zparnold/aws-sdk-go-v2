...
func (c *Client) ListFaqs(ctx context.Context, params *ListFaqsInput, optFns ...func(*Options)) (*ListFaqsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFaqs", params, optFns, addOperationListFaqsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFaqsMiddleware(stack *middleware.Stack, options Options) (err error) {
