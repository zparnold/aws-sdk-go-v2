...
func (c *Client) DescribeDataSource(ctx context.Context, params *DescribeDataSourceInput, optFns ...func(*Options)) (*DescribeDataSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDataSource", params, optFns, addOperationDescribeDataSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDataSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
