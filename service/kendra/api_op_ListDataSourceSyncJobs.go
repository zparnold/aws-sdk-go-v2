...
func (c *Client) ListDataSourceSyncJobs(ctx context.Context, params *ListDataSourceSyncJobsInput, optFns ...func(*Options)) (*ListDataSourceSyncJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDataSourceSyncJobs", params, optFns, addOperationListDataSourceSyncJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDataSourceSyncJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
