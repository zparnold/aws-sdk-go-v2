...
func (c *Client) BatchDeleteDocument(ctx context.Context, params *BatchDeleteDocumentInput, optFns ...func(*Options)) (*BatchDeleteDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeleteDocument", params, optFns, addOperationBatchDeleteDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeleteDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
