...
func (c *Client) SubmitFeedback(ctx context.Context, params *SubmitFeedbackInput, optFns ...func(*Options)) (*SubmitFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubmitFeedback", params, optFns, addOperationSubmitFeedbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubmitFeedbackMiddleware(stack *middleware.Stack, options Options) (err error) {
