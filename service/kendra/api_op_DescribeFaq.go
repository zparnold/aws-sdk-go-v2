...
func (c *Client) DescribeFaq(ctx context.Context, params *DescribeFaqInput, optFns ...func(*Options)) (*DescribeFaqOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFaq", params, optFns, addOperationDescribeFaqMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFaqMiddleware(stack *middleware.Stack, options Options) (err error) {
