...
func (c *Client) CreateFaq(ctx context.Context, params *CreateFaqInput, optFns ...func(*Options)) (*CreateFaqOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFaq", params, optFns, addOperationCreateFaqMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFaqMiddleware(stack *middleware.Stack, options Options) (err error) {
