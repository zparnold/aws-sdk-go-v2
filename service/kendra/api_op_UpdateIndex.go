...
func (c *Client) UpdateIndex(ctx context.Context, params *UpdateIndexInput, optFns ...func(*Options)) (*UpdateIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIndex", params, optFns, addOperationUpdateIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
