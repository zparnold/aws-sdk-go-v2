...
func (c *Client) CreateVocabularyFilter(ctx context.Context, params *CreateVocabularyFilterInput, optFns ...func(*Options)) (*CreateVocabularyFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVocabularyFilter", params, optFns, addOperationCreateVocabularyFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVocabularyFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
