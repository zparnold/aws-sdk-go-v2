...
func (c *Client) StartMedicalTranscriptionJob(ctx context.Context, params *StartMedicalTranscriptionJobInput, optFns ...func(*Options)) (*StartMedicalTranscriptionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMedicalTranscriptionJob", params, optFns, addOperationStartMedicalTranscriptionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMedicalTranscriptionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
