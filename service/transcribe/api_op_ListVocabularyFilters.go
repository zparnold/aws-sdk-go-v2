...
func (c *Client) ListVocabularyFilters(ctx context.Context, params *ListVocabularyFiltersInput, optFns ...func(*Options)) (*ListVocabularyFiltersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVocabularyFilters", params, optFns, addOperationListVocabularyFiltersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVocabularyFiltersMiddleware(stack *middleware.Stack, options Options) (err error) {
