...
func (c *Client) CreateVocabulary(ctx context.Context, params *CreateVocabularyInput, optFns ...func(*Options)) (*CreateVocabularyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVocabulary", params, optFns, addOperationCreateVocabularyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVocabularyMiddleware(stack *middleware.Stack, options Options) (err error) {
