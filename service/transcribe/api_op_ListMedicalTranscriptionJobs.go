...
func (c *Client) ListMedicalTranscriptionJobs(ctx context.Context, params *ListMedicalTranscriptionJobsInput, optFns ...func(*Options)) (*ListMedicalTranscriptionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMedicalTranscriptionJobs", params, optFns, addOperationListMedicalTranscriptionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMedicalTranscriptionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
