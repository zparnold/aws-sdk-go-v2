...
func (c *Client) ListMedicalVocabularies(ctx context.Context, params *ListMedicalVocabulariesInput, optFns ...func(*Options)) (*ListMedicalVocabulariesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMedicalVocabularies", params, optFns, addOperationListMedicalVocabulariesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMedicalVocabulariesMiddleware(stack *middleware.Stack, options Options) (err error) {
