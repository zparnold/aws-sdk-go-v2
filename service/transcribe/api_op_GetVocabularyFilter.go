...
func (c *Client) GetVocabularyFilter(ctx context.Context, params *GetVocabularyFilterInput, optFns ...func(*Options)) (*GetVocabularyFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVocabularyFilter", params, optFns, addOperationGetVocabularyFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVocabularyFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
