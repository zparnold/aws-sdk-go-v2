...
func (c *Client) ListTranscriptionJobs(ctx context.Context, params *ListTranscriptionJobsInput, optFns ...func(*Options)) (*ListTranscriptionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTranscriptionJobs", params, optFns, addOperationListTranscriptionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTranscriptionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
