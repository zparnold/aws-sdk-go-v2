...
func (c *Client) DeleteMedicalVocabulary(ctx context.Context, params *DeleteMedicalVocabularyInput, optFns ...func(*Options)) (*DeleteMedicalVocabularyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMedicalVocabulary", params, optFns, addOperationDeleteMedicalVocabularyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMedicalVocabularyMiddleware(stack *middleware.Stack, options Options) (err error) {
