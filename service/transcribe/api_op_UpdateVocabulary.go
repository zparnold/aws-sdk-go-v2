...
func (c *Client) UpdateVocabulary(ctx context.Context, params *UpdateVocabularyInput, optFns ...func(*Options)) (*UpdateVocabularyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVocabulary", params, optFns, addOperationUpdateVocabularyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVocabularyMiddleware(stack *middleware.Stack, options Options) (err error) {
