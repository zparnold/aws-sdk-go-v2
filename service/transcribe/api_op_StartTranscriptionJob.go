...
func (c *Client) StartTranscriptionJob(ctx context.Context, params *StartTranscriptionJobInput, optFns ...func(*Options)) (*StartTranscriptionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartTranscriptionJob", params, optFns, addOperationStartTranscriptionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartTranscriptionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
