...
func (c *Client) GetVocabulary(ctx context.Context, params *GetVocabularyInput, optFns ...func(*Options)) (*GetVocabularyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVocabulary", params, optFns, addOperationGetVocabularyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVocabularyMiddleware(stack *middleware.Stack, options Options) (err error) {
