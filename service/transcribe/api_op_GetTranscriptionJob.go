...
func (c *Client) GetTranscriptionJob(ctx context.Context, params *GetTranscriptionJobInput, optFns ...func(*Options)) (*GetTranscriptionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTranscriptionJob", params, optFns, addOperationGetTranscriptionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTranscriptionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
