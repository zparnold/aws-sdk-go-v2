...
func (c *Client) DeleteTranscriptionJob(ctx context.Context, params *DeleteTranscriptionJobInput, optFns ...func(*Options)) (*DeleteTranscriptionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTranscriptionJob", params, optFns, addOperationDeleteTranscriptionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTranscriptionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
