...
func (c *Client) GetMedicalTranscriptionJob(ctx context.Context, params *GetMedicalTranscriptionJobInput, optFns ...func(*Options)) (*GetMedicalTranscriptionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMedicalTranscriptionJob", params, optFns, addOperationGetMedicalTranscriptionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMedicalTranscriptionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
