...
func (c *Client) CreateMedicalVocabulary(ctx context.Context, params *CreateMedicalVocabularyInput, optFns ...func(*Options)) (*CreateMedicalVocabularyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMedicalVocabulary", params, optFns, addOperationCreateMedicalVocabularyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMedicalVocabularyMiddleware(stack *middleware.Stack, options Options) (err error) {
