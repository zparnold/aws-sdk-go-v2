...
func (c *Client) UpdateVocabularyFilter(ctx context.Context, params *UpdateVocabularyFilterInput, optFns ...func(*Options)) (*UpdateVocabularyFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVocabularyFilter", params, optFns, addOperationUpdateVocabularyFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVocabularyFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
