...
func (c *Client) GetMedicalVocabulary(ctx context.Context, params *GetMedicalVocabularyInput, optFns ...func(*Options)) (*GetMedicalVocabularyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMedicalVocabulary", params, optFns, addOperationGetMedicalVocabularyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMedicalVocabularyMiddleware(stack *middleware.Stack, options Options) (err error) {
