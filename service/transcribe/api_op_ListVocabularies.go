...
func (c *Client) ListVocabularies(ctx context.Context, params *ListVocabulariesInput, optFns ...func(*Options)) (*ListVocabulariesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVocabularies", params, optFns, addOperationListVocabulariesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVocabulariesMiddleware(stack *middleware.Stack, options Options) (err error) {
