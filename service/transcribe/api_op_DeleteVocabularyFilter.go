...
func (c *Client) DeleteVocabularyFilter(ctx context.Context, params *DeleteVocabularyFilterInput, optFns ...func(*Options)) (*DeleteVocabularyFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVocabularyFilter", params, optFns, addOperationDeleteVocabularyFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVocabularyFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
