...
func (c *Client) UpdateScalingPlan(ctx context.Context, params *UpdateScalingPlanInput, optFns ...func(*Options)) (*UpdateScalingPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateScalingPlan", params, optFns, addOperationUpdateScalingPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateScalingPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
