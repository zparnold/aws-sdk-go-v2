...
func (c *Client) CreateScalingPlan(ctx context.Context, params *CreateScalingPlanInput, optFns ...func(*Options)) (*CreateScalingPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateScalingPlan", params, optFns, addOperationCreateScalingPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateScalingPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
