...
func (c *Client) DeleteScalingPlan(ctx context.Context, params *DeleteScalingPlanInput, optFns ...func(*Options)) (*DeleteScalingPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteScalingPlan", params, optFns, addOperationDeleteScalingPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteScalingPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
