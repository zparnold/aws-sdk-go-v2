...
func (c *Client) DescribeScalingPlans(ctx context.Context, params *DescribeScalingPlansInput, optFns ...func(*Options)) (*DescribeScalingPlansOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScalingPlans", params, optFns, addOperationDescribeScalingPlansMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScalingPlansMiddleware(stack *middleware.Stack, options Options) (err error) {
