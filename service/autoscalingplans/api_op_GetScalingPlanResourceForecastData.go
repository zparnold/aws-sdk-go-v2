...
func (c *Client) GetScalingPlanResourceForecastData(ctx context.Context, params *GetScalingPlanResourceForecastDataInput, optFns ...func(*Options)) (*GetScalingPlanResourceForecastDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetScalingPlanResourceForecastData", params, optFns, addOperationGetScalingPlanResourceForecastDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetScalingPlanResourceForecastDataMiddleware(stack *middleware.Stack, options Options) (err error) {
