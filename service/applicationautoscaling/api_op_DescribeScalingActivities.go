...
func (c *Client) DescribeScalingActivities(ctx context.Context, params *DescribeScalingActivitiesInput, optFns ...func(*Options)) (*DescribeScalingActivitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScalingActivities", params, optFns, addOperationDescribeScalingActivitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScalingActivitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
