...
func (c *Client) RegisterScalableTarget(ctx context.Context, params *RegisterScalableTargetInput, optFns ...func(*Options)) (*RegisterScalableTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterScalableTarget", params, optFns, addOperationRegisterScalableTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterScalableTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
