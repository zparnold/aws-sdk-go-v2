...
func (c *Client) DeleteScheduledAction(ctx context.Context, params *DeleteScheduledActionInput, optFns ...func(*Options)) (*DeleteScheduledActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteScheduledAction", params, optFns, addOperationDeleteScheduledActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteScheduledActionMiddleware(stack *middleware.Stack, options Options) (err error) {
