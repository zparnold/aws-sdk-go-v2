...
func (c *Client) DeleteScalingPolicy(ctx context.Context, params *DeleteScalingPolicyInput, optFns ...func(*Options)) (*DeleteScalingPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteScalingPolicy", params, optFns, addOperationDeleteScalingPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteScalingPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
