...
func (c *Client) DescribeScalableTargets(ctx context.Context, params *DescribeScalableTargetsInput, optFns ...func(*Options)) (*DescribeScalableTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScalableTargets", params, optFns, addOperationDescribeScalableTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScalableTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
