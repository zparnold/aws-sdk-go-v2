...
func (c *Client) PutScheduledAction(ctx context.Context, params *PutScheduledActionInput, optFns ...func(*Options)) (*PutScheduledActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutScheduledAction", params, optFns, addOperationPutScheduledActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutScheduledActionMiddleware(stack *middleware.Stack, options Options) (err error) {
