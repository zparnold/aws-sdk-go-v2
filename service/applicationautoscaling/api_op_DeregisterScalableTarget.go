...
func (c *Client) DeregisterScalableTarget(ctx context.Context, params *DeregisterScalableTargetInput, optFns ...func(*Options)) (*DeregisterScalableTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterScalableTarget", params, optFns, addOperationDeregisterScalableTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterScalableTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
