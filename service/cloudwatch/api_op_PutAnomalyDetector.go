...
func (c *Client) PutAnomalyDetector(ctx context.Context, params *PutAnomalyDetectorInput, optFns ...func(*Options)) (*PutAnomalyDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAnomalyDetector", params, optFns, addOperationPutAnomalyDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAnomalyDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
