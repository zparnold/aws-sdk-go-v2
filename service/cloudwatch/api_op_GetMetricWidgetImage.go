...
func (c *Client) GetMetricWidgetImage(ctx context.Context, params *GetMetricWidgetImageInput, optFns ...func(*Options)) (*GetMetricWidgetImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMetricWidgetImage", params, optFns, addOperationGetMetricWidgetImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMetricWidgetImageMiddleware(stack *middleware.Stack, options Options) (err error) {
