...
func (c *Client) DescribeInsightRules(ctx context.Context, params *DescribeInsightRulesInput, optFns ...func(*Options)) (*DescribeInsightRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInsightRules", params, optFns, addOperationDescribeInsightRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInsightRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
