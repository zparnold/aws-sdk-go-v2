...
func (c *Client) DeleteAnomalyDetector(ctx context.Context, params *DeleteAnomalyDetectorInput, optFns ...func(*Options)) (*DeleteAnomalyDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAnomalyDetector", params, optFns, addOperationDeleteAnomalyDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAnomalyDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
