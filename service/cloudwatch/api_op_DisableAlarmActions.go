...
func (c *Client) DisableAlarmActions(ctx context.Context, params *DisableAlarmActionsInput, optFns ...func(*Options)) (*DisableAlarmActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableAlarmActions", params, optFns, addOperationDisableAlarmActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableAlarmActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
