...
func (c *Client) SetAlarmState(ctx context.Context, params *SetAlarmStateInput, optFns ...func(*Options)) (*SetAlarmStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetAlarmState", params, optFns, addOperationSetAlarmStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetAlarmStateMiddleware(stack *middleware.Stack, options Options) (err error) {
