...
func (c *Client) DescribeAlarmsForMetric(ctx context.Context, params *DescribeAlarmsForMetricInput, optFns ...func(*Options)) (*DescribeAlarmsForMetricOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAlarmsForMetric", params, optFns, addOperationDescribeAlarmsForMetricMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAlarmsForMetricMiddleware(stack *middleware.Stack, options Options) (err error) {
