...
func (c *Client) PutMetricData(ctx context.Context, params *PutMetricDataInput, optFns ...func(*Options)) (*PutMetricDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMetricData", params, optFns, addOperationPutMetricDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMetricDataMiddleware(stack *middleware.Stack, options Options) (err error) {
