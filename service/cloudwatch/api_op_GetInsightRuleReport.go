...
func (c *Client) GetInsightRuleReport(ctx context.Context, params *GetInsightRuleReportInput, optFns ...func(*Options)) (*GetInsightRuleReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInsightRuleReport", params, optFns, addOperationGetInsightRuleReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInsightRuleReportMiddleware(stack *middleware.Stack, options Options) (err error) {
