...
func (c *Client) PutMetricAlarm(ctx context.Context, params *PutMetricAlarmInput, optFns ...func(*Options)) (*PutMetricAlarmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMetricAlarm", params, optFns, addOperationPutMetricAlarmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMetricAlarmMiddleware(stack *middleware.Stack, options Options) (err error) {
