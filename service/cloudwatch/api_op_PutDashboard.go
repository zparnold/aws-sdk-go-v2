...
func (c *Client) PutDashboard(ctx context.Context, params *PutDashboardInput, optFns ...func(*Options)) (*PutDashboardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDashboard", params, optFns, addOperationPutDashboardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDashboardMiddleware(stack *middleware.Stack, options Options) (err error) {
