...
func (c *Client) PutCompositeAlarm(ctx context.Context, params *PutCompositeAlarmInput, optFns ...func(*Options)) (*PutCompositeAlarmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutCompositeAlarm", params, optFns, addOperationPutCompositeAlarmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutCompositeAlarmMiddleware(stack *middleware.Stack, options Options) (err error) {
