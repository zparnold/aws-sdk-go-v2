...
func (c *Client) DeleteInsightRules(ctx context.Context, params *DeleteInsightRulesInput, optFns ...func(*Options)) (*DeleteInsightRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInsightRules", params, optFns, addOperationDeleteInsightRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInsightRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
