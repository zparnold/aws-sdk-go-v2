...
func (c *Client) ListMetrics(ctx context.Context, params *ListMetricsInput, optFns ...func(*Options)) (*ListMetricsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMetrics", params, optFns, addOperationListMetricsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMetricsMiddleware(stack *middleware.Stack, options Options) (err error) {
