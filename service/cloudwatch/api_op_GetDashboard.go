...
func (c *Client) GetDashboard(ctx context.Context, params *GetDashboardInput, optFns ...func(*Options)) (*GetDashboardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDashboard", params, optFns, addOperationGetDashboardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDashboardMiddleware(stack *middleware.Stack, options Options) (err error) {
