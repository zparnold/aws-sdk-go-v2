...
func (c *Client) DeleteDashboards(ctx context.Context, params *DeleteDashboardsInput, optFns ...func(*Options)) (*DeleteDashboardsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDashboards", params, optFns, addOperationDeleteDashboardsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDashboardsMiddleware(stack *middleware.Stack, options Options) (err error) {
