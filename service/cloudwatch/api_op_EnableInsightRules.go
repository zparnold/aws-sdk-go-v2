...
func (c *Client) EnableInsightRules(ctx context.Context, params *EnableInsightRulesInput, optFns ...func(*Options)) (*EnableInsightRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableInsightRules", params, optFns, addOperationEnableInsightRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableInsightRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
