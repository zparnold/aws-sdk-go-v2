...
func (c *Client) DescribeAlarms(ctx context.Context, params *DescribeAlarmsInput, optFns ...func(*Options)) (*DescribeAlarmsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAlarms", params, optFns, addOperationDescribeAlarmsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAlarmsMiddleware(stack *middleware.Stack, options Options) (err error) {
