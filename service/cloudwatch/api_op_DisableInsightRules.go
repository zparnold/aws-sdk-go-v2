...
func (c *Client) DisableInsightRules(ctx context.Context, params *DisableInsightRulesInput, optFns ...func(*Options)) (*DisableInsightRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableInsightRules", params, optFns, addOperationDisableInsightRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableInsightRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
