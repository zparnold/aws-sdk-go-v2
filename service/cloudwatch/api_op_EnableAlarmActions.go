...
func (c *Client) EnableAlarmActions(ctx context.Context, params *EnableAlarmActionsInput, optFns ...func(*Options)) (*EnableAlarmActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableAlarmActions", params, optFns, addOperationEnableAlarmActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableAlarmActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
