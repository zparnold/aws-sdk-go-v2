...
func (c *Client) DescribeAnomalyDetectors(ctx context.Context, params *DescribeAnomalyDetectorsInput, optFns ...func(*Options)) (*DescribeAnomalyDetectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAnomalyDetectors", params, optFns, addOperationDescribeAnomalyDetectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAnomalyDetectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
