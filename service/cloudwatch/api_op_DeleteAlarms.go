...
func (c *Client) DeleteAlarms(ctx context.Context, params *DeleteAlarmsInput, optFns ...func(*Options)) (*DeleteAlarmsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAlarms", params, optFns, addOperationDeleteAlarmsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAlarmsMiddleware(stack *middleware.Stack, options Options) (err error) {
