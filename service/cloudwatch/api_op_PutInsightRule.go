...
func (c *Client) PutInsightRule(ctx context.Context, params *PutInsightRuleInput, optFns ...func(*Options)) (*PutInsightRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutInsightRule", params, optFns, addOperationPutInsightRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutInsightRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
