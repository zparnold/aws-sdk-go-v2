...
func (c *Client) DescribeAlarmHistory(ctx context.Context, params *DescribeAlarmHistoryInput, optFns ...func(*Options)) (*DescribeAlarmHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAlarmHistory", params, optFns, addOperationDescribeAlarmHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAlarmHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
