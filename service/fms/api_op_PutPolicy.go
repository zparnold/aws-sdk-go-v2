...
func (c *Client) PutPolicy(ctx context.Context, params *PutPolicyInput, optFns ...func(*Options)) (*PutPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutPolicy", params, optFns, addOperationPutPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
