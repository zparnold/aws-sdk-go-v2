...
func (c *Client) GetAdminAccount(ctx context.Context, params *GetAdminAccountInput, optFns ...func(*Options)) (*GetAdminAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAdminAccount", params, optFns, addOperationGetAdminAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAdminAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
