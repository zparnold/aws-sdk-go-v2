...
func (c *Client) ListComplianceStatus(ctx context.Context, params *ListComplianceStatusInput, optFns ...func(*Options)) (*ListComplianceStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListComplianceStatus", params, optFns, addOperationListComplianceStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListComplianceStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
