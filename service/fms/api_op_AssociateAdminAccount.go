...
func (c *Client) AssociateAdminAccount(ctx context.Context, params *AssociateAdminAccountInput, optFns ...func(*Options)) (*AssociateAdminAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateAdminAccount", params, optFns, addOperationAssociateAdminAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateAdminAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
