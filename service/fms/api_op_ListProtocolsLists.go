...
func (c *Client) ListProtocolsLists(ctx context.Context, params *ListProtocolsListsInput, optFns ...func(*Options)) (*ListProtocolsListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProtocolsLists", params, optFns, addOperationListProtocolsListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProtocolsListsMiddleware(stack *middleware.Stack, options Options) (err error) {
