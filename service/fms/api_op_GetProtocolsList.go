...
func (c *Client) GetProtocolsList(ctx context.Context, params *GetProtocolsListInput, optFns ...func(*Options)) (*GetProtocolsListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetProtocolsList", params, optFns, addOperationGetProtocolsListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetProtocolsListMiddleware(stack *middleware.Stack, options Options) (err error) {
