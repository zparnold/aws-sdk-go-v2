...
func (c *Client) GetComplianceDetail(ctx context.Context, params *GetComplianceDetailInput, optFns ...func(*Options)) (*GetComplianceDetailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComplianceDetail", params, optFns, addOperationGetComplianceDetailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComplianceDetailMiddleware(stack *middleware.Stack, options Options) (err error) {
