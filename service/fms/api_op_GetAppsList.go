...
func (c *Client) GetAppsList(ctx context.Context, params *GetAppsListInput, optFns ...func(*Options)) (*GetAppsListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAppsList", params, optFns, addOperationGetAppsListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAppsListMiddleware(stack *middleware.Stack, options Options) (err error) {
