...
func (c *Client) GetProtectionStatus(ctx context.Context, params *GetProtectionStatusInput, optFns ...func(*Options)) (*GetProtectionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetProtectionStatus", params, optFns, addOperationGetProtectionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetProtectionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
