...
func (c *Client) PutNotificationChannel(ctx context.Context, params *PutNotificationChannelInput, optFns ...func(*Options)) (*PutNotificationChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutNotificationChannel", params, optFns, addOperationPutNotificationChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutNotificationChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
