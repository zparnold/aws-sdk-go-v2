...
func (c *Client) PutProtocolsList(ctx context.Context, params *PutProtocolsListInput, optFns ...func(*Options)) (*PutProtocolsListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutProtocolsList", params, optFns, addOperationPutProtocolsListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutProtocolsListMiddleware(stack *middleware.Stack, options Options) (err error) {
