...
func (c *Client) ListAppsLists(ctx context.Context, params *ListAppsListsInput, optFns ...func(*Options)) (*ListAppsListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAppsLists", params, optFns, addOperationListAppsListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAppsListsMiddleware(stack *middleware.Stack, options Options) (err error) {
