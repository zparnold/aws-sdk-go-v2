...
func (c *Client) PutAppsList(ctx context.Context, params *PutAppsListInput, optFns ...func(*Options)) (*PutAppsListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAppsList", params, optFns, addOperationPutAppsListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAppsListMiddleware(stack *middleware.Stack, options Options) (err error) {
