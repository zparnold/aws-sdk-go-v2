...
func (c *Client) DeleteNotificationChannel(ctx context.Context, params *DeleteNotificationChannelInput, optFns ...func(*Options)) (*DeleteNotificationChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNotificationChannel", params, optFns, addOperationDeleteNotificationChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNotificationChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
