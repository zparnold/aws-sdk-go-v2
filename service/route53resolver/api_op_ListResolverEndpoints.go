...
func (c *Client) ListResolverEndpoints(ctx context.Context, params *ListResolverEndpointsInput, optFns ...func(*Options)) (*ListResolverEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResolverEndpoints", params, optFns, addOperationListResolverEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResolverEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
