...
func (c *Client) PutResolverRulePolicy(ctx context.Context, params *PutResolverRulePolicyInput, optFns ...func(*Options)) (*PutResolverRulePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutResolverRulePolicy", params, optFns, addOperationPutResolverRulePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutResolverRulePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
