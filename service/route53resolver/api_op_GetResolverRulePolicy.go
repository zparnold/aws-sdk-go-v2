...
func (c *Client) GetResolverRulePolicy(ctx context.Context, params *GetResolverRulePolicyInput, optFns ...func(*Options)) (*GetResolverRulePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResolverRulePolicy", params, optFns, addOperationGetResolverRulePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResolverRulePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
