...
func (c *Client) ListResolverRules(ctx context.Context, params *ListResolverRulesInput, optFns ...func(*Options)) (*ListResolverRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResolverRules", params, optFns, addOperationListResolverRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResolverRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
