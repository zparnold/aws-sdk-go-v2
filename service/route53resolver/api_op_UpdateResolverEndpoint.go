...
func (c *Client) UpdateResolverEndpoint(ctx context.Context, params *UpdateResolverEndpointInput, optFns ...func(*Options)) (*UpdateResolverEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResolverEndpoint", params, optFns, addOperationUpdateResolverEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResolverEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
