...
func (c *Client) DeleteResolverRule(ctx context.Context, params *DeleteResolverRuleInput, optFns ...func(*Options)) (*DeleteResolverRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResolverRule", params, optFns, addOperationDeleteResolverRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResolverRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
