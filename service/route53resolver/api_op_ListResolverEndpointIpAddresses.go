...
func (c *Client) ListResolverEndpointIpAddresses(ctx context.Context, params *ListResolverEndpointIpAddressesInput, optFns ...func(*Options)) (*ListResolverEndpointIpAddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResolverEndpointIpAddresses", params, optFns, addOperationListResolverEndpointIpAddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResolverEndpointIpAddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
