...
func (c *Client) UpdateResolverRule(ctx context.Context, params *UpdateResolverRuleInput, optFns ...func(*Options)) (*UpdateResolverRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResolverRule", params, optFns, addOperationUpdateResolverRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResolverRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
