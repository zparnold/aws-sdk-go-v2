...
func (c *Client) CreateResolverRule(ctx context.Context, params *CreateResolverRuleInput, optFns ...func(*Options)) (*CreateResolverRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResolverRule", params, optFns, addOperationCreateResolverRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResolverRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
