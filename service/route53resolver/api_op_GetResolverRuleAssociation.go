...
func (c *Client) GetResolverRuleAssociation(ctx context.Context, params *GetResolverRuleAssociationInput, optFns ...func(*Options)) (*GetResolverRuleAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResolverRuleAssociation", params, optFns, addOperationGetResolverRuleAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResolverRuleAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
