...
func (c *Client) CreateResolverEndpoint(ctx context.Context, params *CreateResolverEndpointInput, optFns ...func(*Options)) (*CreateResolverEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResolverEndpoint", params, optFns, addOperationCreateResolverEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResolverEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
