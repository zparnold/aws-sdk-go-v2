...
func (c *Client) AssociateResolverRule(ctx context.Context, params *AssociateResolverRuleInput, optFns ...func(*Options)) (*AssociateResolverRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateResolverRule", params, optFns, addOperationAssociateResolverRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateResolverRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
