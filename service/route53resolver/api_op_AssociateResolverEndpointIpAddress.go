...
func (c *Client) AssociateResolverEndpointIpAddress(ctx context.Context, params *AssociateResolverEndpointIpAddressInput, optFns ...func(*Options)) (*AssociateResolverEndpointIpAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateResolverEndpointIpAddress", params, optFns, addOperationAssociateResolverEndpointIpAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateResolverEndpointIpAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
