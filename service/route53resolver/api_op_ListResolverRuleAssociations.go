...
func (c *Client) ListResolverRuleAssociations(ctx context.Context, params *ListResolverRuleAssociationsInput, optFns ...func(*Options)) (*ListResolverRuleAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResolverRuleAssociations", params, optFns, addOperationListResolverRuleAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResolverRuleAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
