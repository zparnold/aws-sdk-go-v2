...
func (c *Client) DisassociateResolverRule(ctx context.Context, params *DisassociateResolverRuleInput, optFns ...func(*Options)) (*DisassociateResolverRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateResolverRule", params, optFns, addOperationDisassociateResolverRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateResolverRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
