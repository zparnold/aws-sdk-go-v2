...
func (c *Client) DeleteResolverEndpoint(ctx context.Context, params *DeleteResolverEndpointInput, optFns ...func(*Options)) (*DeleteResolverEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResolverEndpoint", params, optFns, addOperationDeleteResolverEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResolverEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
