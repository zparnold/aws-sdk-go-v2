...
func (c *Client) GetResolverEndpoint(ctx context.Context, params *GetResolverEndpointInput, optFns ...func(*Options)) (*GetResolverEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResolverEndpoint", params, optFns, addOperationGetResolverEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResolverEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
