...
func (c *Client) CreateUpload(ctx context.Context, params *CreateUploadInput, optFns ...func(*Options)) (*CreateUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUpload", params, optFns, addOperationCreateUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
