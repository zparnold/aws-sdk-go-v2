...
func (c *Client) DeleteRun(ctx context.Context, params *DeleteRunInput, optFns ...func(*Options)) (*DeleteRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRun", params, optFns, addOperationDeleteRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRunMiddleware(stack *middleware.Stack, options Options) (err error) {
