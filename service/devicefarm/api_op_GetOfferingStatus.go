...
func (c *Client) GetOfferingStatus(ctx context.Context, params *GetOfferingStatusInput, optFns ...func(*Options)) (*GetOfferingStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOfferingStatus", params, optFns, addOperationGetOfferingStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOfferingStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
