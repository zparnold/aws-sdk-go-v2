...
func (c *Client) ListTestGridSessionArtifacts(ctx context.Context, params *ListTestGridSessionArtifactsInput, optFns ...func(*Options)) (*ListTestGridSessionArtifactsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTestGridSessionArtifacts", params, optFns, addOperationListTestGridSessionArtifactsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTestGridSessionArtifactsMiddleware(stack *middleware.Stack, options Options) (err error) {
