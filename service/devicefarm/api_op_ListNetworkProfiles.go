...
func (c *Client) ListNetworkProfiles(ctx context.Context, params *ListNetworkProfilesInput, optFns ...func(*Options)) (*ListNetworkProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNetworkProfiles", params, optFns, addOperationListNetworkProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNetworkProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
