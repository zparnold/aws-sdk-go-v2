...
func (c *Client) ListSuites(ctx context.Context, params *ListSuitesInput, optFns ...func(*Options)) (*ListSuitesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSuites", params, optFns, addOperationListSuitesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSuitesMiddleware(stack *middleware.Stack, options Options) (err error) {
