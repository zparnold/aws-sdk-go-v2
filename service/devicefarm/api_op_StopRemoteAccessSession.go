...
func (c *Client) StopRemoteAccessSession(ctx context.Context, params *StopRemoteAccessSessionInput, optFns ...func(*Options)) (*StopRemoteAccessSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopRemoteAccessSession", params, optFns, addOperationStopRemoteAccessSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopRemoteAccessSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
