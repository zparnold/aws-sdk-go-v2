...
func (c *Client) ListTests(ctx context.Context, params *ListTestsInput, optFns ...func(*Options)) (*ListTestsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTests", params, optFns, addOperationListTestsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTestsMiddleware(stack *middleware.Stack, options Options) (err error) {
