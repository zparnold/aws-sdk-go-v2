...
func (c *Client) InstallToRemoteAccessSession(ctx context.Context, params *InstallToRemoteAccessSessionInput, optFns ...func(*Options)) (*InstallToRemoteAccessSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InstallToRemoteAccessSession", params, optFns, addOperationInstallToRemoteAccessSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInstallToRemoteAccessSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
