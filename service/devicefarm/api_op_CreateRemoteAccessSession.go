...
func (c *Client) CreateRemoteAccessSession(ctx context.Context, params *CreateRemoteAccessSessionInput, optFns ...func(*Options)) (*CreateRemoteAccessSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRemoteAccessSession", params, optFns, addOperationCreateRemoteAccessSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRemoteAccessSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
