...
func (c *Client) RenewOffering(ctx context.Context, params *RenewOfferingInput, optFns ...func(*Options)) (*RenewOfferingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RenewOffering", params, optFns, addOperationRenewOfferingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRenewOfferingMiddleware(stack *middleware.Stack, options Options) (err error) {
