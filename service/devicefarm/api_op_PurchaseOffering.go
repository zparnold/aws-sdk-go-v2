...
func (c *Client) PurchaseOffering(ctx context.Context, params *PurchaseOfferingInput, optFns ...func(*Options)) (*PurchaseOfferingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurchaseOffering", params, optFns, addOperationPurchaseOfferingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurchaseOfferingMiddleware(stack *middleware.Stack, options Options) (err error) {
