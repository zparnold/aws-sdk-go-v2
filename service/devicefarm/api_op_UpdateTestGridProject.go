...
func (c *Client) UpdateTestGridProject(ctx context.Context, params *UpdateTestGridProjectInput, optFns ...func(*Options)) (*UpdateTestGridProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTestGridProject", params, optFns, addOperationUpdateTestGridProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTestGridProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
