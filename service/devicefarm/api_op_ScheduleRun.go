...
func (c *Client) ScheduleRun(ctx context.Context, params *ScheduleRunInput, optFns ...func(*Options)) (*ScheduleRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ScheduleRun", params, optFns, addOperationScheduleRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationScheduleRunMiddleware(stack *middleware.Stack, options Options) (err error) {
