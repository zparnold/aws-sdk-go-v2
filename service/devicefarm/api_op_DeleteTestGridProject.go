...
func (c *Client) DeleteTestGridProject(ctx context.Context, params *DeleteTestGridProjectInput, optFns ...func(*Options)) (*DeleteTestGridProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTestGridProject", params, optFns, addOperationDeleteTestGridProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTestGridProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
