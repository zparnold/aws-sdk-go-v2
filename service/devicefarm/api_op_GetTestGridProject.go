...
func (c *Client) GetTestGridProject(ctx context.Context, params *GetTestGridProjectInput, optFns ...func(*Options)) (*GetTestGridProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTestGridProject", params, optFns, addOperationGetTestGridProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTestGridProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
