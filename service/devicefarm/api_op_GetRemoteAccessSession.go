...
func (c *Client) GetRemoteAccessSession(ctx context.Context, params *GetRemoteAccessSessionInput, optFns ...func(*Options)) (*GetRemoteAccessSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRemoteAccessSession", params, optFns, addOperationGetRemoteAccessSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRemoteAccessSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
