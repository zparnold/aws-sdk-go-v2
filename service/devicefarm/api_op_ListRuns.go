...
func (c *Client) ListRuns(ctx context.Context, params *ListRunsInput, optFns ...func(*Options)) (*ListRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRuns", params, optFns, addOperationListRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
