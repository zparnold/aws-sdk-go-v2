...
func (c *Client) ListRemoteAccessSessions(ctx context.Context, params *ListRemoteAccessSessionsInput, optFns ...func(*Options)) (*ListRemoteAccessSessionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRemoteAccessSessions", params, optFns, addOperationListRemoteAccessSessionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRemoteAccessSessionsMiddleware(stack *middleware.Stack, options Options) (err error) {
