...
func (c *Client) DeleteUpload(ctx context.Context, params *DeleteUploadInput, optFns ...func(*Options)) (*DeleteUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUpload", params, optFns, addOperationDeleteUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
