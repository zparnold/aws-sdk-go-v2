...
func (c *Client) StopJob(ctx context.Context, params *StopJobInput, optFns ...func(*Options)) (*StopJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopJob", params, optFns, addOperationStopJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopJobMiddleware(stack *middleware.Stack, options Options) (err error) {
