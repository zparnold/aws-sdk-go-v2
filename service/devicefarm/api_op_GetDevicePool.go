...
func (c *Client) GetDevicePool(ctx context.Context, params *GetDevicePoolInput, optFns ...func(*Options)) (*GetDevicePoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDevicePool", params, optFns, addOperationGetDevicePoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDevicePoolMiddleware(stack *middleware.Stack, options Options) (err error) {
