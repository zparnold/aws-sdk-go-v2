...
func (c *Client) UpdateVPCEConfiguration(ctx context.Context, params *UpdateVPCEConfigurationInput, optFns ...func(*Options)) (*UpdateVPCEConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVPCEConfiguration", params, optFns, addOperationUpdateVPCEConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVPCEConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
