...
func (c *Client) GetAccountSettings(ctx context.Context, params *GetAccountSettingsInput, optFns ...func(*Options)) (*GetAccountSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccountSettings", params, optFns, addOperationGetAccountSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccountSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
