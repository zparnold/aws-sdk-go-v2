...
func (c *Client) GetDevicePoolCompatibility(ctx context.Context, params *GetDevicePoolCompatibilityInput, optFns ...func(*Options)) (*GetDevicePoolCompatibilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDevicePoolCompatibility", params, optFns, addOperationGetDevicePoolCompatibilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDevicePoolCompatibilityMiddleware(stack *middleware.Stack, options Options) (err error) {
