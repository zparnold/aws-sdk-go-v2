...
func (c *Client) UpdateProject(ctx context.Context, params *UpdateProjectInput, optFns ...func(*Options)) (*UpdateProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProject", params, optFns, addOperationUpdateProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
