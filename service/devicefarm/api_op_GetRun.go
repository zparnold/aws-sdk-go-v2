...
func (c *Client) GetRun(ctx context.Context, params *GetRunInput, optFns ...func(*Options)) (*GetRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRun", params, optFns, addOperationGetRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRunMiddleware(stack *middleware.Stack, options Options) (err error) {
