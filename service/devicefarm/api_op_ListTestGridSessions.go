...
func (c *Client) ListTestGridSessions(ctx context.Context, params *ListTestGridSessionsInput, optFns ...func(*Options)) (*ListTestGridSessionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTestGridSessions", params, optFns, addOperationListTestGridSessionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTestGridSessionsMiddleware(stack *middleware.Stack, options Options) (err error) {
