...
func (c *Client) ListUploads(ctx context.Context, params *ListUploadsInput, optFns ...func(*Options)) (*ListUploadsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUploads", params, optFns, addOperationListUploadsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUploadsMiddleware(stack *middleware.Stack, options Options) (err error) {
