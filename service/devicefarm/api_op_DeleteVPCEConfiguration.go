...
func (c *Client) DeleteVPCEConfiguration(ctx context.Context, params *DeleteVPCEConfigurationInput, optFns ...func(*Options)) (*DeleteVPCEConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVPCEConfiguration", params, optFns, addOperationDeleteVPCEConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVPCEConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
