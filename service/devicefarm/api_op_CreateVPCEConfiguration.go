...
func (c *Client) CreateVPCEConfiguration(ctx context.Context, params *CreateVPCEConfigurationInput, optFns ...func(*Options)) (*CreateVPCEConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVPCEConfiguration", params, optFns, addOperationCreateVPCEConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVPCEConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
