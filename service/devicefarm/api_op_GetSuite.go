...
func (c *Client) GetSuite(ctx context.Context, params *GetSuiteInput, optFns ...func(*Options)) (*GetSuiteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSuite", params, optFns, addOperationGetSuiteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSuiteMiddleware(stack *middleware.Stack, options Options) (err error) {
