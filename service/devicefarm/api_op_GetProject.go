...
func (c *Client) GetProject(ctx context.Context, params *GetProjectInput, optFns ...func(*Options)) (*GetProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetProject", params, optFns, addOperationGetProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
