...
func (c *Client) CreateTestGridProject(ctx context.Context, params *CreateTestGridProjectInput, optFns ...func(*Options)) (*CreateTestGridProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTestGridProject", params, optFns, addOperationCreateTestGridProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTestGridProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
