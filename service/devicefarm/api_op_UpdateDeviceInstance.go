...
func (c *Client) UpdateDeviceInstance(ctx context.Context, params *UpdateDeviceInstanceInput, optFns ...func(*Options)) (*UpdateDeviceInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDeviceInstance", params, optFns, addOperationUpdateDeviceInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDeviceInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
