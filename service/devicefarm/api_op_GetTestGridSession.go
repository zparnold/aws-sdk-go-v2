...
func (c *Client) GetTestGridSession(ctx context.Context, params *GetTestGridSessionInput, optFns ...func(*Options)) (*GetTestGridSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTestGridSession", params, optFns, addOperationGetTestGridSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTestGridSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
