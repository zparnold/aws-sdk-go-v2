...
func (c *Client) ListOfferingTransactions(ctx context.Context, params *ListOfferingTransactionsInput, optFns ...func(*Options)) (*ListOfferingTransactionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOfferingTransactions", params, optFns, addOperationListOfferingTransactionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOfferingTransactionsMiddleware(stack *middleware.Stack, options Options) (err error) {
