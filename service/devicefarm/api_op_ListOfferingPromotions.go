...
func (c *Client) ListOfferingPromotions(ctx context.Context, params *ListOfferingPromotionsInput, optFns ...func(*Options)) (*ListOfferingPromotionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOfferingPromotions", params, optFns, addOperationListOfferingPromotionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOfferingPromotionsMiddleware(stack *middleware.Stack, options Options) (err error) {
