...
func (c *Client) ListTestGridProjects(ctx context.Context, params *ListTestGridProjectsInput, optFns ...func(*Options)) (*ListTestGridProjectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTestGridProjects", params, optFns, addOperationListTestGridProjectsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTestGridProjectsMiddleware(stack *middleware.Stack, options Options) (err error) {
