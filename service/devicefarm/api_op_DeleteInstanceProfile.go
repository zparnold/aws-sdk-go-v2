...
func (c *Client) DeleteInstanceProfile(ctx context.Context, params *DeleteInstanceProfileInput, optFns ...func(*Options)) (*DeleteInstanceProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInstanceProfile", params, optFns, addOperationDeleteInstanceProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInstanceProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
