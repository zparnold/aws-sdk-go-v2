...
func (c *Client) CreateTestGridUrl(ctx context.Context, params *CreateTestGridUrlInput, optFns ...func(*Options)) (*CreateTestGridUrlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTestGridUrl", params, optFns, addOperationCreateTestGridUrlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTestGridUrlMiddleware(stack *middleware.Stack, options Options) (err error) {
