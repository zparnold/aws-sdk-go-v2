...
func (c *Client) ListDevicePools(ctx context.Context, params *ListDevicePoolsInput, optFns ...func(*Options)) (*ListDevicePoolsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDevicePools", params, optFns, addOperationListDevicePoolsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDevicePoolsMiddleware(stack *middleware.Stack, options Options) (err error) {
