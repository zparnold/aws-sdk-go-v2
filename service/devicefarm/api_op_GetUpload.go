...
func (c *Client) GetUpload(ctx context.Context, params *GetUploadInput, optFns ...func(*Options)) (*GetUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUpload", params, optFns, addOperationGetUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
