...
func (c *Client) DeleteDevicePool(ctx context.Context, params *DeleteDevicePoolInput, optFns ...func(*Options)) (*DeleteDevicePoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDevicePool", params, optFns, addOperationDeleteDevicePoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDevicePoolMiddleware(stack *middleware.Stack, options Options) (err error) {
