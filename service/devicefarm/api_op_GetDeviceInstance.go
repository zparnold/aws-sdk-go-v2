...
func (c *Client) GetDeviceInstance(ctx context.Context, params *GetDeviceInstanceInput, optFns ...func(*Options)) (*GetDeviceInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeviceInstance", params, optFns, addOperationGetDeviceInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeviceInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
