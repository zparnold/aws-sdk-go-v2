...
func (c *Client) ListSamples(ctx context.Context, params *ListSamplesInput, optFns ...func(*Options)) (*ListSamplesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSamples", params, optFns, addOperationListSamplesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSamplesMiddleware(stack *middleware.Stack, options Options) (err error) {
