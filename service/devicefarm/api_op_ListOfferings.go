...
func (c *Client) ListOfferings(ctx context.Context, params *ListOfferingsInput, optFns ...func(*Options)) (*ListOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOfferings", params, optFns, addOperationListOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
