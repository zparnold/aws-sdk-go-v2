...
func (c *Client) GetVPCEConfiguration(ctx context.Context, params *GetVPCEConfigurationInput, optFns ...func(*Options)) (*GetVPCEConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVPCEConfiguration", params, optFns, addOperationGetVPCEConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVPCEConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
