...
func (c *Client) GetInstanceProfile(ctx context.Context, params *GetInstanceProfileInput, optFns ...func(*Options)) (*GetInstanceProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInstanceProfile", params, optFns, addOperationGetInstanceProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInstanceProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
