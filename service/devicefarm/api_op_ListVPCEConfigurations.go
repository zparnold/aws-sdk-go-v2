...
func (c *Client) ListVPCEConfigurations(ctx context.Context, params *ListVPCEConfigurationsInput, optFns ...func(*Options)) (*ListVPCEConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVPCEConfigurations", params, optFns, addOperationListVPCEConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVPCEConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
