...
func (c *Client) DeleteRemoteAccessSession(ctx context.Context, params *DeleteRemoteAccessSessionInput, optFns ...func(*Options)) (*DeleteRemoteAccessSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRemoteAccessSession", params, optFns, addOperationDeleteRemoteAccessSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRemoteAccessSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
