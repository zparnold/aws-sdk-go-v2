...
func (c *Client) ListTestGridSessionActions(ctx context.Context, params *ListTestGridSessionActionsInput, optFns ...func(*Options)) (*ListTestGridSessionActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTestGridSessionActions", params, optFns, addOperationListTestGridSessionActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTestGridSessionActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
