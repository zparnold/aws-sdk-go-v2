...
func (c *Client) ListUniqueProblems(ctx context.Context, params *ListUniqueProblemsInput, optFns ...func(*Options)) (*ListUniqueProblemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUniqueProblems", params, optFns, addOperationListUniqueProblemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUniqueProblemsMiddleware(stack *middleware.Stack, options Options) (err error) {
