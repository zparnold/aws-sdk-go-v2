...
func (c *Client) ListItems(ctx context.Context, params *ListItemsInput, optFns ...func(*Options)) (*ListItemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListItems", params, optFns, addOperationListItemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListItemsMiddleware(stack *middleware.Stack, options Options) (err error) {
