...
func (c *Client) DescribeObject(ctx context.Context, params *DescribeObjectInput, optFns ...func(*Options)) (*DescribeObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeObject", params, optFns, addOperationDescribeObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
