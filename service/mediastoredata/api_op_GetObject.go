...
func (c *Client) GetObject(ctx context.Context, params *GetObjectInput, optFns ...func(*Options)) (*GetObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObject", params, optFns, addOperationGetObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
