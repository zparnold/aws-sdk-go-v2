...
func (c *Client) PutObject(ctx context.Context, params *PutObjectInput, optFns ...func(*Options)) (*PutObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutObject", params, optFns, addOperationPutObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
