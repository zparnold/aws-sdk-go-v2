...
func (c *Client) ListConnections(ctx context.Context, params *ListConnectionsInput, optFns ...func(*Options)) (*ListConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConnections", params, optFns, addOperationListConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
