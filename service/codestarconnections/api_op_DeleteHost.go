...
func (c *Client) DeleteHost(ctx context.Context, params *DeleteHostInput, optFns ...func(*Options)) (*DeleteHostOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteHost", params, optFns, addOperationDeleteHostMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteHostMiddleware(stack *middleware.Stack, options Options) (err error) {
