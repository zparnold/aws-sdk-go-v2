...
func (c *Client) GetHost(ctx context.Context, params *GetHostInput, optFns ...func(*Options)) (*GetHostOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHost", params, optFns, addOperationGetHostMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHostMiddleware(stack *middleware.Stack, options Options) (err error) {
