...
func (c *Client) ListHosts(ctx context.Context, params *ListHostsInput, optFns ...func(*Options)) (*ListHostsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHosts", params, optFns, addOperationListHostsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHostsMiddleware(stack *middleware.Stack, options Options) (err error) {
