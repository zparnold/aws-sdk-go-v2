...
func (c *Client) DescribeStackSetOperation(ctx context.Context, params *DescribeStackSetOperationInput, optFns ...func(*Options)) (*DescribeStackSetOperationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackSetOperation", params, optFns, addOperationDescribeStackSetOperationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackSetOperationMiddleware(stack *middleware.Stack, options Options) (err error) {
