...
func (c *Client) ListStackInstances(ctx context.Context, params *ListStackInstancesInput, optFns ...func(*Options)) (*ListStackInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStackInstances", params, optFns, addOperationListStackInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStackInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
