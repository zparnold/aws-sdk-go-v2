...
func (c *Client) ListStacks(ctx context.Context, params *ListStacksInput, optFns ...func(*Options)) (*ListStacksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStacks", params, optFns, addOperationListStacksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStacksMiddleware(stack *middleware.Stack, options Options) (err error) {
