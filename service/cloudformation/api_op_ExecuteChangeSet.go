...
func (c *Client) ExecuteChangeSet(ctx context.Context, params *ExecuteChangeSetInput, optFns ...func(*Options)) (*ExecuteChangeSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExecuteChangeSet", params, optFns, addOperationExecuteChangeSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExecuteChangeSetMiddleware(stack *middleware.Stack, options Options) (err error) {
