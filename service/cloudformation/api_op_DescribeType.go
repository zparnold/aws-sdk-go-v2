...
func (c *Client) DescribeType(ctx context.Context, params *DescribeTypeInput, optFns ...func(*Options)) (*DescribeTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeType", params, optFns, addOperationDescribeTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
