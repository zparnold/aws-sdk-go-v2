...
func (c *Client) DescribeStackResourceDrifts(ctx context.Context, params *DescribeStackResourceDriftsInput, optFns ...func(*Options)) (*DescribeStackResourceDriftsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackResourceDrifts", params, optFns, addOperationDescribeStackResourceDriftsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackResourceDriftsMiddleware(stack *middleware.Stack, options Options) (err error) {
