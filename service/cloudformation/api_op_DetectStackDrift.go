...
func (c *Client) DetectStackDrift(ctx context.Context, params *DetectStackDriftInput, optFns ...func(*Options)) (*DetectStackDriftOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectStackDrift", params, optFns, addOperationDetectStackDriftMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectStackDriftMiddleware(stack *middleware.Stack, options Options) (err error) {
