...
func (c *Client) StopStackSetOperation(ctx context.Context, params *StopStackSetOperationInput, optFns ...func(*Options)) (*StopStackSetOperationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopStackSetOperation", params, optFns, addOperationStopStackSetOperationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopStackSetOperationMiddleware(stack *middleware.Stack, options Options) (err error) {
