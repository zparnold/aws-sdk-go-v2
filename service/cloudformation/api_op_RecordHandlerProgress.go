...
func (c *Client) RecordHandlerProgress(ctx context.Context, params *RecordHandlerProgressInput, optFns ...func(*Options)) (*RecordHandlerProgressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RecordHandlerProgress", params, optFns, addOperationRecordHandlerProgressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRecordHandlerProgressMiddleware(stack *middleware.Stack, options Options) (err error) {
