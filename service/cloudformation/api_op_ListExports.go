...
func (c *Client) ListExports(ctx context.Context, params *ListExportsInput, optFns ...func(*Options)) (*ListExportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListExports", params, optFns, addOperationListExportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListExportsMiddleware(stack *middleware.Stack, options Options) (err error) {
