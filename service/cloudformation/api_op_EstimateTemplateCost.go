...
func (c *Client) EstimateTemplateCost(ctx context.Context, params *EstimateTemplateCostInput, optFns ...func(*Options)) (*EstimateTemplateCostOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EstimateTemplateCost", params, optFns, addOperationEstimateTemplateCostMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEstimateTemplateCostMiddleware(stack *middleware.Stack, options Options) (err error) {
