...
func (c *Client) CreateStackSet(ctx context.Context, params *CreateStackSetInput, optFns ...func(*Options)) (*CreateStackSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStackSet", params, optFns, addOperationCreateStackSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStackSetMiddleware(stack *middleware.Stack, options Options) (err error) {
