...
func (c *Client) ListImports(ctx context.Context, params *ListImportsInput, optFns ...func(*Options)) (*ListImportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListImports", params, optFns, addOperationListImportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListImportsMiddleware(stack *middleware.Stack, options Options) (err error) {
