...
func (c *Client) UpdateTerminationProtection(ctx context.Context, params *UpdateTerminationProtectionInput, optFns ...func(*Options)) (*UpdateTerminationProtectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTerminationProtection", params, optFns, addOperationUpdateTerminationProtectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTerminationProtectionMiddleware(stack *middleware.Stack, options Options) (err error) {
