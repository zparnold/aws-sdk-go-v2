...
func (c *Client) CancelUpdateStack(ctx context.Context, params *CancelUpdateStackInput, optFns ...func(*Options)) (*CancelUpdateStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelUpdateStack", params, optFns, addOperationCancelUpdateStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelUpdateStackMiddleware(stack *middleware.Stack, options Options) (err error) {
