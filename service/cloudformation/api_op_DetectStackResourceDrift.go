...
func (c *Client) DetectStackResourceDrift(ctx context.Context, params *DetectStackResourceDriftInput, optFns ...func(*Options)) (*DetectStackResourceDriftOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectStackResourceDrift", params, optFns, addOperationDetectStackResourceDriftMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectStackResourceDriftMiddleware(stack *middleware.Stack, options Options) (err error) {
