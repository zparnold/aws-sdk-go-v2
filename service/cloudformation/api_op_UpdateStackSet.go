...
func (c *Client) UpdateStackSet(ctx context.Context, params *UpdateStackSetInput, optFns ...func(*Options)) (*UpdateStackSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStackSet", params, optFns, addOperationUpdateStackSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStackSetMiddleware(stack *middleware.Stack, options Options) (err error) {
