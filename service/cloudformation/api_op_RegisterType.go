...
func (c *Client) RegisterType(ctx context.Context, params *RegisterTypeInput, optFns ...func(*Options)) (*RegisterTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterType", params, optFns, addOperationRegisterTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
