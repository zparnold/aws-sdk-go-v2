...
func (c *Client) DescribeStackEvents(ctx context.Context, params *DescribeStackEventsInput, optFns ...func(*Options)) (*DescribeStackEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackEvents", params, optFns, addOperationDescribeStackEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
