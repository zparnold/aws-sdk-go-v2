...
func (c *Client) DetectStackSetDrift(ctx context.Context, params *DetectStackSetDriftInput, optFns ...func(*Options)) (*DetectStackSetDriftOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectStackSetDrift", params, optFns, addOperationDetectStackSetDriftMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectStackSetDriftMiddleware(stack *middleware.Stack, options Options) (err error) {
