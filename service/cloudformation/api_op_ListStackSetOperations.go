...
func (c *Client) ListStackSetOperations(ctx context.Context, params *ListStackSetOperationsInput, optFns ...func(*Options)) (*ListStackSetOperationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStackSetOperations", params, optFns, addOperationListStackSetOperationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStackSetOperationsMiddleware(stack *middleware.Stack, options Options) (err error) {
