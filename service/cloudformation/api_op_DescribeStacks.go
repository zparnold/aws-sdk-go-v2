...
func (c *Client) DescribeStacks(ctx context.Context, params *DescribeStacksInput, optFns ...func(*Options)) (*DescribeStacksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStacks", params, optFns, addOperationDescribeStacksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStacksMiddleware(stack *middleware.Stack, options Options) (err error) {
