...
func (c *Client) SignalResource(ctx context.Context, params *SignalResourceInput, optFns ...func(*Options)) (*SignalResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SignalResource", params, optFns, addOperationSignalResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSignalResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
