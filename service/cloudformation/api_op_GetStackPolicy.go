...
func (c *Client) GetStackPolicy(ctx context.Context, params *GetStackPolicyInput, optFns ...func(*Options)) (*GetStackPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStackPolicy", params, optFns, addOperationGetStackPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStackPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
