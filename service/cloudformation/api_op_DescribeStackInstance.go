...
func (c *Client) DescribeStackInstance(ctx context.Context, params *DescribeStackInstanceInput, optFns ...func(*Options)) (*DescribeStackInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackInstance", params, optFns, addOperationDescribeStackInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
