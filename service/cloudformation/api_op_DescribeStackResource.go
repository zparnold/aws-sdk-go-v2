...
func (c *Client) DescribeStackResource(ctx context.Context, params *DescribeStackResourceInput, optFns ...func(*Options)) (*DescribeStackResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackResource", params, optFns, addOperationDescribeStackResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
