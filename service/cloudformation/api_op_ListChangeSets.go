...
func (c *Client) ListChangeSets(ctx context.Context, params *ListChangeSetsInput, optFns ...func(*Options)) (*ListChangeSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListChangeSets", params, optFns, addOperationListChangeSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListChangeSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
