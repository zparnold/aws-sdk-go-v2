...
func (c *Client) ContinueUpdateRollback(ctx context.Context, params *ContinueUpdateRollbackInput, optFns ...func(*Options)) (*ContinueUpdateRollbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ContinueUpdateRollback", params, optFns, addOperationContinueUpdateRollbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationContinueUpdateRollbackMiddleware(stack *middleware.Stack, options Options) (err error) {
