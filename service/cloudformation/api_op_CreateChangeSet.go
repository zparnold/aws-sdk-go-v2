...
func (c *Client) CreateChangeSet(ctx context.Context, params *CreateChangeSetInput, optFns ...func(*Options)) (*CreateChangeSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateChangeSet", params, optFns, addOperationCreateChangeSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateChangeSetMiddleware(stack *middleware.Stack, options Options) (err error) {
