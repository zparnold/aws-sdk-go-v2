...
func (c *Client) SetStackPolicy(ctx context.Context, params *SetStackPolicyInput, optFns ...func(*Options)) (*SetStackPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetStackPolicy", params, optFns, addOperationSetStackPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetStackPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
