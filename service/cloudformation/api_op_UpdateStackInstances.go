...
func (c *Client) UpdateStackInstances(ctx context.Context, params *UpdateStackInstancesInput, optFns ...func(*Options)) (*UpdateStackInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStackInstances", params, optFns, addOperationUpdateStackInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStackInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
