...
func (c *Client) ListTypeRegistrations(ctx context.Context, params *ListTypeRegistrationsInput, optFns ...func(*Options)) (*ListTypeRegistrationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTypeRegistrations", params, optFns, addOperationListTypeRegistrationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTypeRegistrationsMiddleware(stack *middleware.Stack, options Options) (err error) {
