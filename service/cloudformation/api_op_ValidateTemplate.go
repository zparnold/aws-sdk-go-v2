...
func (c *Client) ValidateTemplate(ctx context.Context, params *ValidateTemplateInput, optFns ...func(*Options)) (*ValidateTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ValidateTemplate", params, optFns, addOperationValidateTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationValidateTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
