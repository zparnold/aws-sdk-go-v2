...
func (c *Client) GetTemplate(ctx context.Context, params *GetTemplateInput, optFns ...func(*Options)) (*GetTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTemplate", params, optFns, addOperationGetTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
