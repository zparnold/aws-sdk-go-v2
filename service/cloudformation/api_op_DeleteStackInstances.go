...
func (c *Client) DeleteStackInstances(ctx context.Context, params *DeleteStackInstancesInput, optFns ...func(*Options)) (*DeleteStackInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStackInstances", params, optFns, addOperationDeleteStackInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStackInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
