...
func (c *Client) GetTemplateSummary(ctx context.Context, params *GetTemplateSummaryInput, optFns ...func(*Options)) (*GetTemplateSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTemplateSummary", params, optFns, addOperationGetTemplateSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTemplateSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
