...
func (c *Client) DeleteStackSet(ctx context.Context, params *DeleteStackSetInput, optFns ...func(*Options)) (*DeleteStackSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStackSet", params, optFns, addOperationDeleteStackSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStackSetMiddleware(stack *middleware.Stack, options Options) (err error) {
