...
func (c *Client) DeregisterType(ctx context.Context, params *DeregisterTypeInput, optFns ...func(*Options)) (*DeregisterTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterType", params, optFns, addOperationDeregisterTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
