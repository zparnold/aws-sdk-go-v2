...
func (c *Client) DescribeStackDriftDetectionStatus(ctx context.Context, params *DescribeStackDriftDetectionStatusInput, optFns ...func(*Options)) (*DescribeStackDriftDetectionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackDriftDetectionStatus", params, optFns, addOperationDescribeStackDriftDetectionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackDriftDetectionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
