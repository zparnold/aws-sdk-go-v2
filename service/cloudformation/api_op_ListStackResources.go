...
func (c *Client) ListStackResources(ctx context.Context, params *ListStackResourcesInput, optFns ...func(*Options)) (*ListStackResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStackResources", params, optFns, addOperationListStackResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStackResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
