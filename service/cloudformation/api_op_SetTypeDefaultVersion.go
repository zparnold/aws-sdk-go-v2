...
func (c *Client) SetTypeDefaultVersion(ctx context.Context, params *SetTypeDefaultVersionInput, optFns ...func(*Options)) (*SetTypeDefaultVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetTypeDefaultVersion", params, optFns, addOperationSetTypeDefaultVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetTypeDefaultVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
