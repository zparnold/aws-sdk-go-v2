...
func (c *Client) DescribeTypeRegistration(ctx context.Context, params *DescribeTypeRegistrationInput, optFns ...func(*Options)) (*DescribeTypeRegistrationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTypeRegistration", params, optFns, addOperationDescribeTypeRegistrationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTypeRegistrationMiddleware(stack *middleware.Stack, options Options) (err error) {
