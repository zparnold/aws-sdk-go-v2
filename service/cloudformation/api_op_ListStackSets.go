...
func (c *Client) ListStackSets(ctx context.Context, params *ListStackSetsInput, optFns ...func(*Options)) (*ListStackSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStackSets", params, optFns, addOperationListStackSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStackSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
