...
func (c *Client) DescribeStackResources(ctx context.Context, params *DescribeStackResourcesInput, optFns ...func(*Options)) (*DescribeStackResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStackResources", params, optFns, addOperationDescribeStackResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStackResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
