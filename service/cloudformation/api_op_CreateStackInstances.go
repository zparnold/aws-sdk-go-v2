...
func (c *Client) CreateStackInstances(ctx context.Context, params *CreateStackInstancesInput, optFns ...func(*Options)) (*CreateStackInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStackInstances", params, optFns, addOperationCreateStackInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStackInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
