...
func (c *Client) DescribeDataSources(ctx context.Context, params *DescribeDataSourcesInput, optFns ...func(*Options)) (*DescribeDataSourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDataSources", params, optFns, addOperationDescribeDataSourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDataSourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
