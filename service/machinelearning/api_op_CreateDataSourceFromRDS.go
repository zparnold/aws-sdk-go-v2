...
func (c *Client) CreateDataSourceFromRDS(ctx context.Context, params *CreateDataSourceFromRDSInput, optFns ...func(*Options)) (*CreateDataSourceFromRDSOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDataSourceFromRDS", params, optFns, addOperationCreateDataSourceFromRDSMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDataSourceFromRDSMiddleware(stack *middleware.Stack, options Options) (err error) {
