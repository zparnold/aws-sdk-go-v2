...
func (c *Client) UpdateMLModel(ctx context.Context, params *UpdateMLModelInput, optFns ...func(*Options)) (*UpdateMLModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMLModel", params, optFns, addOperationUpdateMLModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMLModelMiddleware(stack *middleware.Stack, options Options) (err error) {
