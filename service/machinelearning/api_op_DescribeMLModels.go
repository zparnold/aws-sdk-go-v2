...
func (c *Client) DescribeMLModels(ctx context.Context, params *DescribeMLModelsInput, optFns ...func(*Options)) (*DescribeMLModelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMLModels", params, optFns, addOperationDescribeMLModelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMLModelsMiddleware(stack *middleware.Stack, options Options) (err error) {
