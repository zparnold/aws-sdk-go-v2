...
func (c *Client) DeleteDataSource(ctx context.Context, params *DeleteDataSourceInput, optFns ...func(*Options)) (*DeleteDataSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDataSource", params, optFns, addOperationDeleteDataSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDataSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
