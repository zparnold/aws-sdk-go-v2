...
func (c *Client) UpdateEvaluation(ctx context.Context, params *UpdateEvaluationInput, optFns ...func(*Options)) (*UpdateEvaluationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEvaluation", params, optFns, addOperationUpdateEvaluationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEvaluationMiddleware(stack *middleware.Stack, options Options) (err error) {
