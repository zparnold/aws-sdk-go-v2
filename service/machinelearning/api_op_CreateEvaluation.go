...
func (c *Client) CreateEvaluation(ctx context.Context, params *CreateEvaluationInput, optFns ...func(*Options)) (*CreateEvaluationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEvaluation", params, optFns, addOperationCreateEvaluationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEvaluationMiddleware(stack *middleware.Stack, options Options) (err error) {
