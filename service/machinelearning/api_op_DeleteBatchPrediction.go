...
func (c *Client) DeleteBatchPrediction(ctx context.Context, params *DeleteBatchPredictionInput, optFns ...func(*Options)) (*DeleteBatchPredictionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBatchPrediction", params, optFns, addOperationDeleteBatchPredictionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBatchPredictionMiddleware(stack *middleware.Stack, options Options) (err error) {
