...
func (c *Client) DeleteRealtimeEndpoint(ctx context.Context, params *DeleteRealtimeEndpointInput, optFns ...func(*Options)) (*DeleteRealtimeEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRealtimeEndpoint", params, optFns, addOperationDeleteRealtimeEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRealtimeEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
