...
func (c *Client) CreateBatchPrediction(ctx context.Context, params *CreateBatchPredictionInput, optFns ...func(*Options)) (*CreateBatchPredictionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBatchPrediction", params, optFns, addOperationCreateBatchPredictionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBatchPredictionMiddleware(stack *middleware.Stack, options Options) (err error) {
