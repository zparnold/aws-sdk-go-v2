...
func (c *Client) Predict(ctx context.Context, params *PredictInput, optFns ...func(*Options)) (*PredictOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Predict", params, optFns, addOperationPredictMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPredictMiddleware(stack *middleware.Stack, options Options) (err error) {
