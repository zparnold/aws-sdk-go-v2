...
func (c *Client) GetEvaluation(ctx context.Context, params *GetEvaluationInput, optFns ...func(*Options)) (*GetEvaluationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEvaluation", params, optFns, addOperationGetEvaluationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEvaluationMiddleware(stack *middleware.Stack, options Options) (err error) {
