...
func (c *Client) GetBatchPrediction(ctx context.Context, params *GetBatchPredictionInput, optFns ...func(*Options)) (*GetBatchPredictionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBatchPrediction", params, optFns, addOperationGetBatchPredictionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBatchPredictionMiddleware(stack *middleware.Stack, options Options) (err error) {
