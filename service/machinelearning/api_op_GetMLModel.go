...
func (c *Client) GetMLModel(ctx context.Context, params *GetMLModelInput, optFns ...func(*Options)) (*GetMLModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMLModel", params, optFns, addOperationGetMLModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMLModelMiddleware(stack *middleware.Stack, options Options) (err error) {
