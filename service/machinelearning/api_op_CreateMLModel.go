...
func (c *Client) CreateMLModel(ctx context.Context, params *CreateMLModelInput, optFns ...func(*Options)) (*CreateMLModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMLModel", params, optFns, addOperationCreateMLModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMLModelMiddleware(stack *middleware.Stack, options Options) (err error) {
