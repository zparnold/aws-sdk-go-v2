...
func (c *Client) UpdateBatchPrediction(ctx context.Context, params *UpdateBatchPredictionInput, optFns ...func(*Options)) (*UpdateBatchPredictionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBatchPrediction", params, optFns, addOperationUpdateBatchPredictionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBatchPredictionMiddleware(stack *middleware.Stack, options Options) (err error) {
