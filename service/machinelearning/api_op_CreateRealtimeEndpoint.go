...
func (c *Client) CreateRealtimeEndpoint(ctx context.Context, params *CreateRealtimeEndpointInput, optFns ...func(*Options)) (*CreateRealtimeEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRealtimeEndpoint", params, optFns, addOperationCreateRealtimeEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRealtimeEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
