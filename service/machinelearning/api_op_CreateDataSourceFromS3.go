...
func (c *Client) CreateDataSourceFromS3(ctx context.Context, params *CreateDataSourceFromS3Input, optFns ...func(*Options)) (*CreateDataSourceFromS3Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDataSourceFromS3", params, optFns, addOperationCreateDataSourceFromS3Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDataSourceFromS3Middleware(stack *middleware.Stack, options Options) (err error) {
