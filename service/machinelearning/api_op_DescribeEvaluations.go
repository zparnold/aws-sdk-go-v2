...
func (c *Client) DescribeEvaluations(ctx context.Context, params *DescribeEvaluationsInput, optFns ...func(*Options)) (*DescribeEvaluationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEvaluations", params, optFns, addOperationDescribeEvaluationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEvaluationsMiddleware(stack *middleware.Stack, options Options) (err error) {
