...
func (c *Client) DescribeBatchPredictions(ctx context.Context, params *DescribeBatchPredictionsInput, optFns ...func(*Options)) (*DescribeBatchPredictionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBatchPredictions", params, optFns, addOperationDescribeBatchPredictionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBatchPredictionsMiddleware(stack *middleware.Stack, options Options) (err error) {
