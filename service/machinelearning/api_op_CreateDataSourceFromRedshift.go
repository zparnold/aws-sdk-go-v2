...
func (c *Client) CreateDataSourceFromRedshift(ctx context.Context, params *CreateDataSourceFromRedshiftInput, optFns ...func(*Options)) (*CreateDataSourceFromRedshiftOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDataSourceFromRedshift", params, optFns, addOperationCreateDataSourceFromRedshiftMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDataSourceFromRedshiftMiddleware(stack *middleware.Stack, options Options) (err error) {
