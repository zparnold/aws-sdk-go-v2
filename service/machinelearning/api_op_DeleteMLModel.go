...
func (c *Client) DeleteMLModel(ctx context.Context, params *DeleteMLModelInput, optFns ...func(*Options)) (*DeleteMLModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMLModel", params, optFns, addOperationDeleteMLModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMLModelMiddleware(stack *middleware.Stack, options Options) (err error) {
