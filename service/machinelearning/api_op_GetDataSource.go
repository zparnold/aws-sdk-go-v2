...
func (c *Client) GetDataSource(ctx context.Context, params *GetDataSourceInput, optFns ...func(*Options)) (*GetDataSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataSource", params, optFns, addOperationGetDataSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
