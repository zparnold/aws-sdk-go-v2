...
func (c *Client) DeleteEvaluation(ctx context.Context, params *DeleteEvaluationInput, optFns ...func(*Options)) (*DeleteEvaluationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEvaluation", params, optFns, addOperationDeleteEvaluationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEvaluationMiddleware(stack *middleware.Stack, options Options) (err error) {
