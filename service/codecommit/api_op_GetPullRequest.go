...
func (c *Client) GetPullRequest(ctx context.Context, params *GetPullRequestInput, optFns ...func(*Options)) (*GetPullRequestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPullRequest", params, optFns, addOperationGetPullRequestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPullRequestMiddleware(stack *middleware.Stack, options Options) (err error) {
