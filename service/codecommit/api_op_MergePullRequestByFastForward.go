...
func (c *Client) MergePullRequestByFastForward(ctx context.Context, params *MergePullRequestByFastForwardInput, optFns ...func(*Options)) (*MergePullRequestByFastForwardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MergePullRequestByFastForward", params, optFns, addOperationMergePullRequestByFastForwardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMergePullRequestByFastForwardMiddleware(stack *middleware.Stack, options Options) (err error) {
