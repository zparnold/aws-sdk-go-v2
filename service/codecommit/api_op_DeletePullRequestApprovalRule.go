...
func (c *Client) DeletePullRequestApprovalRule(ctx context.Context, params *DeletePullRequestApprovalRuleInput, optFns ...func(*Options)) (*DeletePullRequestApprovalRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePullRequestApprovalRule", params, optFns, addOperationDeletePullRequestApprovalRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePullRequestApprovalRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
