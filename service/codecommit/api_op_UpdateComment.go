...
func (c *Client) UpdateComment(ctx context.Context, params *UpdateCommentInput, optFns ...func(*Options)) (*UpdateCommentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateComment", params, optFns, addOperationUpdateCommentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCommentMiddleware(stack *middleware.Stack, options Options) (err error) {
