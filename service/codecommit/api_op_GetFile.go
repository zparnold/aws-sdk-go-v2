...
func (c *Client) GetFile(ctx context.Context, params *GetFileInput, optFns ...func(*Options)) (*GetFileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFile", params, optFns, addOperationGetFileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFileMiddleware(stack *middleware.Stack, options Options) (err error) {
