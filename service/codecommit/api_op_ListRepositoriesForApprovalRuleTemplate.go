...
func (c *Client) ListRepositoriesForApprovalRuleTemplate(ctx context.Context, params *ListRepositoriesForApprovalRuleTemplateInput, optFns ...func(*Options)) (*ListRepositoriesForApprovalRuleTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRepositoriesForApprovalRuleTemplate", params, optFns, addOperationListRepositoriesForApprovalRuleTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRepositoriesForApprovalRuleTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
