...
func (c *Client) GetCommentsForComparedCommit(ctx context.Context, params *GetCommentsForComparedCommitInput, optFns ...func(*Options)) (*GetCommentsForComparedCommitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCommentsForComparedCommit", params, optFns, addOperationGetCommentsForComparedCommitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCommentsForComparedCommitMiddleware(stack *middleware.Stack, options Options) (err error) {
