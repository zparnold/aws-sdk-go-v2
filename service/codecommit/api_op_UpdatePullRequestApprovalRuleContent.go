...
func (c *Client) UpdatePullRequestApprovalRuleContent(ctx context.Context, params *UpdatePullRequestApprovalRuleContentInput, optFns ...func(*Options)) (*UpdatePullRequestApprovalRuleContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePullRequestApprovalRuleContent", params, optFns, addOperationUpdatePullRequestApprovalRuleContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePullRequestApprovalRuleContentMiddleware(stack *middleware.Stack, options Options) (err error) {
