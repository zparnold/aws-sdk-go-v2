...
func (c *Client) DeleteApprovalRuleTemplate(ctx context.Context, params *DeleteApprovalRuleTemplateInput, optFns ...func(*Options)) (*DeleteApprovalRuleTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApprovalRuleTemplate", params, optFns, addOperationDeleteApprovalRuleTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApprovalRuleTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
