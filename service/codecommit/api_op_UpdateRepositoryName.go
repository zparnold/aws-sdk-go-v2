...
func (c *Client) UpdateRepositoryName(ctx context.Context, params *UpdateRepositoryNameInput, optFns ...func(*Options)) (*UpdateRepositoryNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRepositoryName", params, optFns, addOperationUpdateRepositoryNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRepositoryNameMiddleware(stack *middleware.Stack, options Options) (err error) {
