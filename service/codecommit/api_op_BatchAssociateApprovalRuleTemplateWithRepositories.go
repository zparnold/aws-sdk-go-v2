...
func (c *Client) BatchAssociateApprovalRuleTemplateWithRepositories(ctx context.Context, params *BatchAssociateApprovalRuleTemplateWithRepositoriesInput, optFns ...func(*Options)) (*BatchAssociateApprovalRuleTemplateWithRepositoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchAssociateApprovalRuleTemplateWithRepositories", params, optFns, addOperationBatchAssociateApprovalRuleTemplateWithRepositoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchAssociateApprovalRuleTemplateWithRepositoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
