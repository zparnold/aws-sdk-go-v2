...
func (c *Client) PostCommentForComparedCommit(ctx context.Context, params *PostCommentForComparedCommitInput, optFns ...func(*Options)) (*PostCommentForComparedCommitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PostCommentForComparedCommit", params, optFns, addOperationPostCommentForComparedCommitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPostCommentForComparedCommitMiddleware(stack *middleware.Stack, options Options) (err error) {
