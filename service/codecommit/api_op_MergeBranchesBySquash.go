...
func (c *Client) MergeBranchesBySquash(ctx context.Context, params *MergeBranchesBySquashInput, optFns ...func(*Options)) (*MergeBranchesBySquashOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MergeBranchesBySquash", params, optFns, addOperationMergeBranchesBySquashMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMergeBranchesBySquashMiddleware(stack *middleware.Stack, options Options) (err error) {
