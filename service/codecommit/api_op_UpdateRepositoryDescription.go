...
func (c *Client) UpdateRepositoryDescription(ctx context.Context, params *UpdateRepositoryDescriptionInput, optFns ...func(*Options)) (*UpdateRepositoryDescriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRepositoryDescription", params, optFns, addOperationUpdateRepositoryDescriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRepositoryDescriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
