...
func (c *Client) GetApprovalRuleTemplate(ctx context.Context, params *GetApprovalRuleTemplateInput, optFns ...func(*Options)) (*GetApprovalRuleTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApprovalRuleTemplate", params, optFns, addOperationGetApprovalRuleTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApprovalRuleTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
