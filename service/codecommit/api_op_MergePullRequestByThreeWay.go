...
func (c *Client) MergePullRequestByThreeWay(ctx context.Context, params *MergePullRequestByThreeWayInput, optFns ...func(*Options)) (*MergePullRequestByThreeWayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MergePullRequestByThreeWay", params, optFns, addOperationMergePullRequestByThreeWayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMergePullRequestByThreeWayMiddleware(stack *middleware.Stack, options Options) (err error) {
