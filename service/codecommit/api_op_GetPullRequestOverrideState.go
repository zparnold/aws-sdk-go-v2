...
func (c *Client) GetPullRequestOverrideState(ctx context.Context, params *GetPullRequestOverrideStateInput, optFns ...func(*Options)) (*GetPullRequestOverrideStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPullRequestOverrideState", params, optFns, addOperationGetPullRequestOverrideStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPullRequestOverrideStateMiddleware(stack *middleware.Stack, options Options) (err error) {
