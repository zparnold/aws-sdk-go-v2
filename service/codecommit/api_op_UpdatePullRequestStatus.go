...
func (c *Client) UpdatePullRequestStatus(ctx context.Context, params *UpdatePullRequestStatusInput, optFns ...func(*Options)) (*UpdatePullRequestStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePullRequestStatus", params, optFns, addOperationUpdatePullRequestStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePullRequestStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
