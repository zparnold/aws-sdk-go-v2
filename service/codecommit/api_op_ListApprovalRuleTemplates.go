...
func (c *Client) ListApprovalRuleTemplates(ctx context.Context, params *ListApprovalRuleTemplatesInput, optFns ...func(*Options)) (*ListApprovalRuleTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListApprovalRuleTemplates", params, optFns, addOperationListApprovalRuleTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListApprovalRuleTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
