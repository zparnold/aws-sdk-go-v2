...
func (c *Client) PutCommentReaction(ctx context.Context, params *PutCommentReactionInput, optFns ...func(*Options)) (*PutCommentReactionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutCommentReaction", params, optFns, addOperationPutCommentReactionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutCommentReactionMiddleware(stack *middleware.Stack, options Options) (err error) {
