...
func (c *Client) DisassociateApprovalRuleTemplateFromRepository(ctx context.Context, params *DisassociateApprovalRuleTemplateFromRepositoryInput, optFns ...func(*Options)) (*DisassociateApprovalRuleTemplateFromRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateApprovalRuleTemplateFromRepository", params, optFns, addOperationDisassociateApprovalRuleTemplateFromRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateApprovalRuleTemplateFromRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
