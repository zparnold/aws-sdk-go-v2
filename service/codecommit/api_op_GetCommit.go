...
func (c *Client) GetCommit(ctx context.Context, params *GetCommitInput, optFns ...func(*Options)) (*GetCommitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCommit", params, optFns, addOperationGetCommitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCommitMiddleware(stack *middleware.Stack, options Options) (err error) {
