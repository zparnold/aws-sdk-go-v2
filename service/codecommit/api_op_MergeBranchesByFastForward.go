...
func (c *Client) MergeBranchesByFastForward(ctx context.Context, params *MergeBranchesByFastForwardInput, optFns ...func(*Options)) (*MergeBranchesByFastForwardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MergeBranchesByFastForward", params, optFns, addOperationMergeBranchesByFastForwardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMergeBranchesByFastForwardMiddleware(stack *middleware.Stack, options Options) (err error) {
