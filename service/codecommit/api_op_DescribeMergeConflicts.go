...
func (c *Client) DescribeMergeConflicts(ctx context.Context, params *DescribeMergeConflictsInput, optFns ...func(*Options)) (*DescribeMergeConflictsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMergeConflicts", params, optFns, addOperationDescribeMergeConflictsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMergeConflictsMiddleware(stack *middleware.Stack, options Options) (err error) {
