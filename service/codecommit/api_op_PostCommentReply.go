...
func (c *Client) PostCommentReply(ctx context.Context, params *PostCommentReplyInput, optFns ...func(*Options)) (*PostCommentReplyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PostCommentReply", params, optFns, addOperationPostCommentReplyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPostCommentReplyMiddleware(stack *middleware.Stack, options Options) (err error) {
