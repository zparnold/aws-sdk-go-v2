...
func (c *Client) UpdateApprovalRuleTemplateContent(ctx context.Context, params *UpdateApprovalRuleTemplateContentInput, optFns ...func(*Options)) (*UpdateApprovalRuleTemplateContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApprovalRuleTemplateContent", params, optFns, addOperationUpdateApprovalRuleTemplateContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApprovalRuleTemplateContentMiddleware(stack *middleware.Stack, options Options) (err error) {
