...
func (c *Client) EvaluatePullRequestApprovalRules(ctx context.Context, params *EvaluatePullRequestApprovalRulesInput, optFns ...func(*Options)) (*EvaluatePullRequestApprovalRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EvaluatePullRequestApprovalRules", params, optFns, addOperationEvaluatePullRequestApprovalRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEvaluatePullRequestApprovalRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
