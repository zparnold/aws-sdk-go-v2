...
func (c *Client) BatchGetRepositories(ctx context.Context, params *BatchGetRepositoriesInput, optFns ...func(*Options)) (*BatchGetRepositoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetRepositories", params, optFns, addOperationBatchGetRepositoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetRepositoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
