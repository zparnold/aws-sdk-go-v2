...
func (c *Client) ListAssociatedApprovalRuleTemplatesForRepository(ctx context.Context, params *ListAssociatedApprovalRuleTemplatesForRepositoryInput, optFns ...func(*Options)) (*ListAssociatedApprovalRuleTemplatesForRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssociatedApprovalRuleTemplatesForRepository", params, optFns, addOperationListAssociatedApprovalRuleTemplatesForRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssociatedApprovalRuleTemplatesForRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
