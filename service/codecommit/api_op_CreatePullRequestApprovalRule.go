...
func (c *Client) CreatePullRequestApprovalRule(ctx context.Context, params *CreatePullRequestApprovalRuleInput, optFns ...func(*Options)) (*CreatePullRequestApprovalRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePullRequestApprovalRule", params, optFns, addOperationCreatePullRequestApprovalRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePullRequestApprovalRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
