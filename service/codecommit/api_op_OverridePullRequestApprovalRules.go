...
func (c *Client) OverridePullRequestApprovalRules(ctx context.Context, params *OverridePullRequestApprovalRulesInput, optFns ...func(*Options)) (*OverridePullRequestApprovalRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "OverridePullRequestApprovalRules", params, optFns, addOperationOverridePullRequestApprovalRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationOverridePullRequestApprovalRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
