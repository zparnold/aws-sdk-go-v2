...
func (c *Client) BatchDescribeMergeConflicts(ctx context.Context, params *BatchDescribeMergeConflictsInput, optFns ...func(*Options)) (*BatchDescribeMergeConflictsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDescribeMergeConflicts", params, optFns, addOperationBatchDescribeMergeConflictsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDescribeMergeConflictsMiddleware(stack *middleware.Stack, options Options) (err error) {
