...
func (c *Client) GetCommentReactions(ctx context.Context, params *GetCommentReactionsInput, optFns ...func(*Options)) (*GetCommentReactionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCommentReactions", params, optFns, addOperationGetCommentReactionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCommentReactionsMiddleware(stack *middleware.Stack, options Options) (err error) {
