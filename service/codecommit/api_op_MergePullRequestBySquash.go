...
func (c *Client) MergePullRequestBySquash(ctx context.Context, params *MergePullRequestBySquashInput, optFns ...func(*Options)) (*MergePullRequestBySquashOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MergePullRequestBySquash", params, optFns, addOperationMergePullRequestBySquashMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMergePullRequestBySquashMiddleware(stack *middleware.Stack, options Options) (err error) {
