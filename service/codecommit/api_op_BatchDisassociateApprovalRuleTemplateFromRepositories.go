...
func (c *Client) BatchDisassociateApprovalRuleTemplateFromRepositories(ctx context.Context, params *BatchDisassociateApprovalRuleTemplateFromRepositoriesInput, optFns ...func(*Options)) (*BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDisassociateApprovalRuleTemplateFromRepositories", params, optFns, addOperationBatchDisassociateApprovalRuleTemplateFromRepositoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDisassociateApprovalRuleTemplateFromRepositoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
