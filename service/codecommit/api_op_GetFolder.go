...
func (c *Client) GetFolder(ctx context.Context, params *GetFolderInput, optFns ...func(*Options)) (*GetFolderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFolder", params, optFns, addOperationGetFolderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFolderMiddleware(stack *middleware.Stack, options Options) (err error) {
