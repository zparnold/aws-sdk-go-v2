...
func (c *Client) UpdatePullRequestApprovalState(ctx context.Context, params *UpdatePullRequestApprovalStateInput, optFns ...func(*Options)) (*UpdatePullRequestApprovalStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePullRequestApprovalState", params, optFns, addOperationUpdatePullRequestApprovalStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePullRequestApprovalStateMiddleware(stack *middleware.Stack, options Options) (err error) {
