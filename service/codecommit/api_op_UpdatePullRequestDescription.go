...
func (c *Client) UpdatePullRequestDescription(ctx context.Context, params *UpdatePullRequestDescriptionInput, optFns ...func(*Options)) (*UpdatePullRequestDescriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePullRequestDescription", params, optFns, addOperationUpdatePullRequestDescriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePullRequestDescriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
