...
func (c *Client) PostCommentForPullRequest(ctx context.Context, params *PostCommentForPullRequestInput, optFns ...func(*Options)) (*PostCommentForPullRequestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PostCommentForPullRequest", params, optFns, addOperationPostCommentForPullRequestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPostCommentForPullRequestMiddleware(stack *middleware.Stack, options Options) (err error) {
