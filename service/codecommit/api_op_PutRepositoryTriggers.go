...
func (c *Client) PutRepositoryTriggers(ctx context.Context, params *PutRepositoryTriggersInput, optFns ...func(*Options)) (*PutRepositoryTriggersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRepositoryTriggers", params, optFns, addOperationPutRepositoryTriggersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRepositoryTriggersMiddleware(stack *middleware.Stack, options Options) (err error) {
