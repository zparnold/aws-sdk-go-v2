...
func (c *Client) CreateUnreferencedMergeCommit(ctx context.Context, params *CreateUnreferencedMergeCommitInput, optFns ...func(*Options)) (*CreateUnreferencedMergeCommitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUnreferencedMergeCommit", params, optFns, addOperationCreateUnreferencedMergeCommitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUnreferencedMergeCommitMiddleware(stack *middleware.Stack, options Options) (err error) {
