...
func (c *Client) GetBlob(ctx context.Context, params *GetBlobInput, optFns ...func(*Options)) (*GetBlobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBlob", params, optFns, addOperationGetBlobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBlobMiddleware(stack *middleware.Stack, options Options) (err error) {
