...
func (c *Client) GetMergeOptions(ctx context.Context, params *GetMergeOptionsInput, optFns ...func(*Options)) (*GetMergeOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMergeOptions", params, optFns, addOperationGetMergeOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMergeOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
