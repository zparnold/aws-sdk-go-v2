...
func (c *Client) AssociateApprovalRuleTemplateWithRepository(ctx context.Context, params *AssociateApprovalRuleTemplateWithRepositoryInput, optFns ...func(*Options)) (*AssociateApprovalRuleTemplateWithRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateApprovalRuleTemplateWithRepository", params, optFns, addOperationAssociateApprovalRuleTemplateWithRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateApprovalRuleTemplateWithRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
