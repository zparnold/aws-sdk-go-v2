...
func (c *Client) ListPullRequests(ctx context.Context, params *ListPullRequestsInput, optFns ...func(*Options)) (*ListPullRequestsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPullRequests", params, optFns, addOperationListPullRequestsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPullRequestsMiddleware(stack *middleware.Stack, options Options) (err error) {
