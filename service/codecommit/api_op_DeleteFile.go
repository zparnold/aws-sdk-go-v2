...
func (c *Client) DeleteFile(ctx context.Context, params *DeleteFileInput, optFns ...func(*Options)) (*DeleteFileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFile", params, optFns, addOperationDeleteFileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFileMiddleware(stack *middleware.Stack, options Options) (err error) {
