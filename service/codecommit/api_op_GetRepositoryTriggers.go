...
func (c *Client) GetRepositoryTriggers(ctx context.Context, params *GetRepositoryTriggersInput, optFns ...func(*Options)) (*GetRepositoryTriggersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRepositoryTriggers", params, optFns, addOperationGetRepositoryTriggersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRepositoryTriggersMiddleware(stack *middleware.Stack, options Options) (err error) {
