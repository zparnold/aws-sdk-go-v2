...
func (c *Client) PutFile(ctx context.Context, params *PutFileInput, optFns ...func(*Options)) (*PutFileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutFile", params, optFns, addOperationPutFileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutFileMiddleware(stack *middleware.Stack, options Options) (err error) {
