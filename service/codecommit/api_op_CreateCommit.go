...
func (c *Client) CreateCommit(ctx context.Context, params *CreateCommitInput, optFns ...func(*Options)) (*CreateCommitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCommit", params, optFns, addOperationCreateCommitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCommitMiddleware(stack *middleware.Stack, options Options) (err error) {
