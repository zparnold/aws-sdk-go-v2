...
func (c *Client) ListRepositories(ctx context.Context, params *ListRepositoriesInput, optFns ...func(*Options)) (*ListRepositoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRepositories", params, optFns, addOperationListRepositoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRepositoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
