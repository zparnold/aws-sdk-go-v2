...
func (c *Client) GetMergeCommit(ctx context.Context, params *GetMergeCommitInput, optFns ...func(*Options)) (*GetMergeCommitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMergeCommit", params, optFns, addOperationGetMergeCommitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMergeCommitMiddleware(stack *middleware.Stack, options Options) (err error) {
