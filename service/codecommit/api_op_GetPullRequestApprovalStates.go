...
func (c *Client) GetPullRequestApprovalStates(ctx context.Context, params *GetPullRequestApprovalStatesInput, optFns ...func(*Options)) (*GetPullRequestApprovalStatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPullRequestApprovalStates", params, optFns, addOperationGetPullRequestApprovalStatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPullRequestApprovalStatesMiddleware(stack *middleware.Stack, options Options) (err error) {
