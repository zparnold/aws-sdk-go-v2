...
func (c *Client) DescribePullRequestEvents(ctx context.Context, params *DescribePullRequestEventsInput, optFns ...func(*Options)) (*DescribePullRequestEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePullRequestEvents", params, optFns, addOperationDescribePullRequestEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePullRequestEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
