...
func (c *Client) UpdateApprovalRuleTemplateDescription(ctx context.Context, params *UpdateApprovalRuleTemplateDescriptionInput, optFns ...func(*Options)) (*UpdateApprovalRuleTemplateDescriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApprovalRuleTemplateDescription", params, optFns, addOperationUpdateApprovalRuleTemplateDescriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApprovalRuleTemplateDescriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
