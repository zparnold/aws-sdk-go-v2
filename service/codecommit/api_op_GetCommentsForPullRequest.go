...
func (c *Client) GetCommentsForPullRequest(ctx context.Context, params *GetCommentsForPullRequestInput, optFns ...func(*Options)) (*GetCommentsForPullRequestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCommentsForPullRequest", params, optFns, addOperationGetCommentsForPullRequestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCommentsForPullRequestMiddleware(stack *middleware.Stack, options Options) (err error) {
