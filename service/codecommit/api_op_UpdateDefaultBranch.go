...
func (c *Client) UpdateDefaultBranch(ctx context.Context, params *UpdateDefaultBranchInput, optFns ...func(*Options)) (*UpdateDefaultBranchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDefaultBranch", params, optFns, addOperationUpdateDefaultBranchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDefaultBranchMiddleware(stack *middleware.Stack, options Options) (err error) {
