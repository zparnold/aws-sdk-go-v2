...
func (c *Client) CreateApprovalRuleTemplate(ctx context.Context, params *CreateApprovalRuleTemplateInput, optFns ...func(*Options)) (*CreateApprovalRuleTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApprovalRuleTemplate", params, optFns, addOperationCreateApprovalRuleTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateApprovalRuleTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
