...
func (c *Client) UpdatePullRequestTitle(ctx context.Context, params *UpdatePullRequestTitleInput, optFns ...func(*Options)) (*UpdatePullRequestTitleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePullRequestTitle", params, optFns, addOperationUpdatePullRequestTitleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePullRequestTitleMiddleware(stack *middleware.Stack, options Options) (err error) {
