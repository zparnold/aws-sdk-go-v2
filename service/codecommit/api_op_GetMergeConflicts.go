...
func (c *Client) GetMergeConflicts(ctx context.Context, params *GetMergeConflictsInput, optFns ...func(*Options)) (*GetMergeConflictsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMergeConflicts", params, optFns, addOperationGetMergeConflictsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMergeConflictsMiddleware(stack *middleware.Stack, options Options) (err error) {
