...
func (c *Client) TestRepositoryTriggers(ctx context.Context, params *TestRepositoryTriggersInput, optFns ...func(*Options)) (*TestRepositoryTriggersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestRepositoryTriggers", params, optFns, addOperationTestRepositoryTriggersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestRepositoryTriggersMiddleware(stack *middleware.Stack, options Options) (err error) {
