...
func (c *Client) GetDifferences(ctx context.Context, params *GetDifferencesInput, optFns ...func(*Options)) (*GetDifferencesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDifferences", params, optFns, addOperationGetDifferencesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDifferencesMiddleware(stack *middleware.Stack, options Options) (err error) {
