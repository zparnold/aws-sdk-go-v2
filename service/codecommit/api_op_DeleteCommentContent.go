...
func (c *Client) DeleteCommentContent(ctx context.Context, params *DeleteCommentContentInput, optFns ...func(*Options)) (*DeleteCommentContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCommentContent", params, optFns, addOperationDeleteCommentContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCommentContentMiddleware(stack *middleware.Stack, options Options) (err error) {
