...
func (c *Client) UpdateApprovalRuleTemplateName(ctx context.Context, params *UpdateApprovalRuleTemplateNameInput, optFns ...func(*Options)) (*UpdateApprovalRuleTemplateNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApprovalRuleTemplateName", params, optFns, addOperationUpdateApprovalRuleTemplateNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApprovalRuleTemplateNameMiddleware(stack *middleware.Stack, options Options) (err error) {
