...
func (c *Client) GetRepository(ctx context.Context, params *GetRepositoryInput, optFns ...func(*Options)) (*GetRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRepository", params, optFns, addOperationGetRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
