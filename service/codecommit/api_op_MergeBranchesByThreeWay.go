...
func (c *Client) MergeBranchesByThreeWay(ctx context.Context, params *MergeBranchesByThreeWayInput, optFns ...func(*Options)) (*MergeBranchesByThreeWayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MergeBranchesByThreeWay", params, optFns, addOperationMergeBranchesByThreeWayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMergeBranchesByThreeWayMiddleware(stack *middleware.Stack, options Options) (err error) {
