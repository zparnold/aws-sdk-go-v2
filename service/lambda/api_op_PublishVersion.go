...
func (c *Client) PublishVersion(ctx context.Context, params *PublishVersionInput, optFns ...func(*Options)) (*PublishVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PublishVersion", params, optFns, addOperationPublishVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPublishVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
