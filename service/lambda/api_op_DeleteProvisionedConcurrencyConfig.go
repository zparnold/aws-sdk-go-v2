...
func (c *Client) DeleteProvisionedConcurrencyConfig(ctx context.Context, params *DeleteProvisionedConcurrencyConfigInput, optFns ...func(*Options)) (*DeleteProvisionedConcurrencyConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProvisionedConcurrencyConfig", params, optFns, addOperationDeleteProvisionedConcurrencyConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProvisionedConcurrencyConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
