...
func (c *Client) ListLayerVersions(ctx context.Context, params *ListLayerVersionsInput, optFns ...func(*Options)) (*ListLayerVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLayerVersions", params, optFns, addOperationListLayerVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLayerVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
