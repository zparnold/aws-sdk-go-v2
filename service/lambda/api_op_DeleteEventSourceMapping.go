...
func (c *Client) DeleteEventSourceMapping(ctx context.Context, params *DeleteEventSourceMappingInput, optFns ...func(*Options)) (*DeleteEventSourceMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEventSourceMapping", params, optFns, addOperationDeleteEventSourceMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEventSourceMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
