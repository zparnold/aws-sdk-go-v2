...
func (c *Client) ListFunctions(ctx context.Context, params *ListFunctionsInput, optFns ...func(*Options)) (*ListFunctionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFunctions", params, optFns, addOperationListFunctionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFunctionsMiddleware(stack *middleware.Stack, options Options) (err error) {
