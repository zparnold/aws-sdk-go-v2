...
func (c *Client) ListProvisionedConcurrencyConfigs(ctx context.Context, params *ListProvisionedConcurrencyConfigsInput, optFns ...func(*Options)) (*ListProvisionedConcurrencyConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProvisionedConcurrencyConfigs", params, optFns, addOperationListProvisionedConcurrencyConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProvisionedConcurrencyConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
