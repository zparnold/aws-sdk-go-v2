...
func (c *Client) GetLayerVersionPolicy(ctx context.Context, params *GetLayerVersionPolicyInput, optFns ...func(*Options)) (*GetLayerVersionPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLayerVersionPolicy", params, optFns, addOperationGetLayerVersionPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLayerVersionPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
