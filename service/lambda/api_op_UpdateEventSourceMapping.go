...
func (c *Client) UpdateEventSourceMapping(ctx context.Context, params *UpdateEventSourceMappingInput, optFns ...func(*Options)) (*UpdateEventSourceMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEventSourceMapping", params, optFns, addOperationUpdateEventSourceMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEventSourceMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
