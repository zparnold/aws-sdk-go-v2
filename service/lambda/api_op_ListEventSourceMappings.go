...
func (c *Client) ListEventSourceMappings(ctx context.Context, params *ListEventSourceMappingsInput, optFns ...func(*Options)) (*ListEventSourceMappingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEventSourceMappings", params, optFns, addOperationListEventSourceMappingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEventSourceMappingsMiddleware(stack *middleware.Stack, options Options) (err error) {
