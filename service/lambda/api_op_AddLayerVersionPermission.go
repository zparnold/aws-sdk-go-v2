...
func (c *Client) AddLayerVersionPermission(ctx context.Context, params *AddLayerVersionPermissionInput, optFns ...func(*Options)) (*AddLayerVersionPermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddLayerVersionPermission", params, optFns, addOperationAddLayerVersionPermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddLayerVersionPermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
