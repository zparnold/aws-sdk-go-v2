...
func (c *Client) GetLayerVersionByArn(ctx context.Context, params *GetLayerVersionByArnInput, optFns ...func(*Options)) (*GetLayerVersionByArnOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLayerVersionByArn", params, optFns, addOperationGetLayerVersionByArnMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLayerVersionByArnMiddleware(stack *middleware.Stack, options Options) (err error) {
