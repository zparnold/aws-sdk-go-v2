...
func (c *Client) GetFunctionConcurrency(ctx context.Context, params *GetFunctionConcurrencyInput, optFns ...func(*Options)) (*GetFunctionConcurrencyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFunctionConcurrency", params, optFns, addOperationGetFunctionConcurrencyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFunctionConcurrencyMiddleware(stack *middleware.Stack, options Options) (err error) {
