...
func (c *Client) CreateEventSourceMapping(ctx context.Context, params *CreateEventSourceMappingInput, optFns ...func(*Options)) (*CreateEventSourceMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEventSourceMapping", params, optFns, addOperationCreateEventSourceMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEventSourceMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
