...
func (c *Client) CreateFunction(ctx context.Context, params *CreateFunctionInput, optFns ...func(*Options)) (*CreateFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFunction", params, optFns, addOperationCreateFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
