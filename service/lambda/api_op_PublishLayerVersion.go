...
func (c *Client) PublishLayerVersion(ctx context.Context, params *PublishLayerVersionInput, optFns ...func(*Options)) (*PublishLayerVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PublishLayerVersion", params, optFns, addOperationPublishLayerVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPublishLayerVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
