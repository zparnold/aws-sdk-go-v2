...
func (c *Client) GetEventSourceMapping(ctx context.Context, params *GetEventSourceMappingInput, optFns ...func(*Options)) (*GetEventSourceMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEventSourceMapping", params, optFns, addOperationGetEventSourceMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEventSourceMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
