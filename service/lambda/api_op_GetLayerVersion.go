...
func (c *Client) GetLayerVersion(ctx context.Context, params *GetLayerVersionInput, optFns ...func(*Options)) (*GetLayerVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLayerVersion", params, optFns, addOperationGetLayerVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLayerVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
