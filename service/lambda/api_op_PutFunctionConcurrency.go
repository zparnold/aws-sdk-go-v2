...
func (c *Client) PutFunctionConcurrency(ctx context.Context, params *PutFunctionConcurrencyInput, optFns ...func(*Options)) (*PutFunctionConcurrencyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutFunctionConcurrency", params, optFns, addOperationPutFunctionConcurrencyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutFunctionConcurrencyMiddleware(stack *middleware.Stack, options Options) (err error) {
