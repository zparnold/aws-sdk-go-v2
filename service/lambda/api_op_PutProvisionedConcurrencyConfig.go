...
func (c *Client) PutProvisionedConcurrencyConfig(ctx context.Context, params *PutProvisionedConcurrencyConfigInput, optFns ...func(*Options)) (*PutProvisionedConcurrencyConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutProvisionedConcurrencyConfig", params, optFns, addOperationPutProvisionedConcurrencyConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutProvisionedConcurrencyConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
