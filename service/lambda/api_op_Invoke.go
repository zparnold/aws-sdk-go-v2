...
func (c *Client) Invoke(ctx context.Context, params *InvokeInput, optFns ...func(*Options)) (*InvokeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Invoke", params, optFns, addOperationInvokeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInvokeMiddleware(stack *middleware.Stack, options Options) (err error) {
