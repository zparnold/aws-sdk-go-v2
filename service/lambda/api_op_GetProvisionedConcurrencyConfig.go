...
func (c *Client) GetProvisionedConcurrencyConfig(ctx context.Context, params *GetProvisionedConcurrencyConfigInput, optFns ...func(*Options)) (*GetProvisionedConcurrencyConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetProvisionedConcurrencyConfig", params, optFns, addOperationGetProvisionedConcurrencyConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetProvisionedConcurrencyConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
