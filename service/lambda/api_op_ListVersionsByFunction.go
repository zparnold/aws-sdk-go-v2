...
func (c *Client) ListVersionsByFunction(ctx context.Context, params *ListVersionsByFunctionInput, optFns ...func(*Options)) (*ListVersionsByFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVersionsByFunction", params, optFns, addOperationListVersionsByFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVersionsByFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
