...
func (c *Client) GetFunctionConfiguration(ctx context.Context, params *GetFunctionConfigurationInput, optFns ...func(*Options)) (*GetFunctionConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFunctionConfiguration", params, optFns, addOperationGetFunctionConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFunctionConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
