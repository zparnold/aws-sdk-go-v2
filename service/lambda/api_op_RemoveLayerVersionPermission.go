...
func (c *Client) RemoveLayerVersionPermission(ctx context.Context, params *RemoveLayerVersionPermissionInput, optFns ...func(*Options)) (*RemoveLayerVersionPermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveLayerVersionPermission", params, optFns, addOperationRemoveLayerVersionPermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveLayerVersionPermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
