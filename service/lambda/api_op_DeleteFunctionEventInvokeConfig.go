...
func (c *Client) DeleteFunctionEventInvokeConfig(ctx context.Context, params *DeleteFunctionEventInvokeConfigInput, optFns ...func(*Options)) (*DeleteFunctionEventInvokeConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFunctionEventInvokeConfig", params, optFns, addOperationDeleteFunctionEventInvokeConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFunctionEventInvokeConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
