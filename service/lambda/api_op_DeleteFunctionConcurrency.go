...
func (c *Client) DeleteFunctionConcurrency(ctx context.Context, params *DeleteFunctionConcurrencyInput, optFns ...func(*Options)) (*DeleteFunctionConcurrencyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFunctionConcurrency", params, optFns, addOperationDeleteFunctionConcurrencyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFunctionConcurrencyMiddleware(stack *middleware.Stack, options Options) (err error) {
