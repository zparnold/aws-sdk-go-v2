...
func (c *Client) ListFunctionEventInvokeConfigs(ctx context.Context, params *ListFunctionEventInvokeConfigsInput, optFns ...func(*Options)) (*ListFunctionEventInvokeConfigsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFunctionEventInvokeConfigs", params, optFns, addOperationListFunctionEventInvokeConfigsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFunctionEventInvokeConfigsMiddleware(stack *middleware.Stack, options Options) (err error) {
