...
func (c *Client) UpdateFunctionCode(ctx context.Context, params *UpdateFunctionCodeInput, optFns ...func(*Options)) (*UpdateFunctionCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFunctionCode", params, optFns, addOperationUpdateFunctionCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFunctionCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
