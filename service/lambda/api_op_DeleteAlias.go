...
func (c *Client) DeleteAlias(ctx context.Context, params *DeleteAliasInput, optFns ...func(*Options)) (*DeleteAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAlias", params, optFns, addOperationDeleteAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
