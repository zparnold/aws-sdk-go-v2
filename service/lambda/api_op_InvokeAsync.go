...
func (c *Client) InvokeAsync(ctx context.Context, params *InvokeAsyncInput, optFns ...func(*Options)) (*InvokeAsyncOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InvokeAsync", params, optFns, addOperationInvokeAsyncMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInvokeAsyncMiddleware(stack *middleware.Stack, options Options) (err error) {
