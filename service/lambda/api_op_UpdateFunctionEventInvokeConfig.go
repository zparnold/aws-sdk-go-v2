...
func (c *Client) UpdateFunctionEventInvokeConfig(ctx context.Context, params *UpdateFunctionEventInvokeConfigInput, optFns ...func(*Options)) (*UpdateFunctionEventInvokeConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFunctionEventInvokeConfig", params, optFns, addOperationUpdateFunctionEventInvokeConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFunctionEventInvokeConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
