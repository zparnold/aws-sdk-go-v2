...
func (c *Client) GetFunctionEventInvokeConfig(ctx context.Context, params *GetFunctionEventInvokeConfigInput, optFns ...func(*Options)) (*GetFunctionEventInvokeConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFunctionEventInvokeConfig", params, optFns, addOperationGetFunctionEventInvokeConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFunctionEventInvokeConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
