...
func (c *Client) ListLayers(ctx context.Context, params *ListLayersInput, optFns ...func(*Options)) (*ListLayersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLayers", params, optFns, addOperationListLayersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLayersMiddleware(stack *middleware.Stack, options Options) (err error) {
