...
func (c *Client) PutFunctionEventInvokeConfig(ctx context.Context, params *PutFunctionEventInvokeConfigInput, optFns ...func(*Options)) (*PutFunctionEventInvokeConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutFunctionEventInvokeConfig", params, optFns, addOperationPutFunctionEventInvokeConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutFunctionEventInvokeConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
