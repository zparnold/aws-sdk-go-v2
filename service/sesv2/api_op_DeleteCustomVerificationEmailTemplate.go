...
func (c *Client) DeleteCustomVerificationEmailTemplate(ctx context.Context, params *DeleteCustomVerificationEmailTemplateInput, optFns ...func(*Options)) (*DeleteCustomVerificationEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCustomVerificationEmailTemplate", params, optFns, addOperationDeleteCustomVerificationEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCustomVerificationEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
