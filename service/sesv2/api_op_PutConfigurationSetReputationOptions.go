...
func (c *Client) PutConfigurationSetReputationOptions(ctx context.Context, params *PutConfigurationSetReputationOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetReputationOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConfigurationSetReputationOptions", params, optFns, addOperationPutConfigurationSetReputationOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConfigurationSetReputationOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
