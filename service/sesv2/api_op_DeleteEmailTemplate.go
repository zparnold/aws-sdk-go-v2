...
func (c *Client) DeleteEmailTemplate(ctx context.Context, params *DeleteEmailTemplateInput, optFns ...func(*Options)) (*DeleteEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEmailTemplate", params, optFns, addOperationDeleteEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
