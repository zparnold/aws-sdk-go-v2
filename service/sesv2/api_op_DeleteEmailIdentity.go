...
func (c *Client) DeleteEmailIdentity(ctx context.Context, params *DeleteEmailIdentityInput, optFns ...func(*Options)) (*DeleteEmailIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEmailIdentity", params, optFns, addOperationDeleteEmailIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEmailIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
