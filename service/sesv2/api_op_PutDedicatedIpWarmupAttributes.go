...
func (c *Client) PutDedicatedIpWarmupAttributes(ctx context.Context, params *PutDedicatedIpWarmupAttributesInput, optFns ...func(*Options)) (*PutDedicatedIpWarmupAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDedicatedIpWarmupAttributes", params, optFns, addOperationPutDedicatedIpWarmupAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDedicatedIpWarmupAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
