...
func (c *Client) GetSuppressedDestination(ctx context.Context, params *GetSuppressedDestinationInput, optFns ...func(*Options)) (*GetSuppressedDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSuppressedDestination", params, optFns, addOperationGetSuppressedDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSuppressedDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
