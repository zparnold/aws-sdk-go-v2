...
func (c *Client) DeleteEmailIdentityPolicy(ctx context.Context, params *DeleteEmailIdentityPolicyInput, optFns ...func(*Options)) (*DeleteEmailIdentityPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEmailIdentityPolicy", params, optFns, addOperationDeleteEmailIdentityPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEmailIdentityPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
