...
func (c *Client) CreateEmailIdentity(ctx context.Context, params *CreateEmailIdentityInput, optFns ...func(*Options)) (*CreateEmailIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEmailIdentity", params, optFns, addOperationCreateEmailIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEmailIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
