...
func (c *Client) PutDedicatedIpInPool(ctx context.Context, params *PutDedicatedIpInPoolInput, optFns ...func(*Options)) (*PutDedicatedIpInPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDedicatedIpInPool", params, optFns, addOperationPutDedicatedIpInPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDedicatedIpInPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
