...
func (c *Client) PutAccountSuppressionAttributes(ctx context.Context, params *PutAccountSuppressionAttributesInput, optFns ...func(*Options)) (*PutAccountSuppressionAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccountSuppressionAttributes", params, optFns, addOperationPutAccountSuppressionAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccountSuppressionAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
