...
func (c *Client) PutAccountSendingAttributes(ctx context.Context, params *PutAccountSendingAttributesInput, optFns ...func(*Options)) (*PutAccountSendingAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccountSendingAttributes", params, optFns, addOperationPutAccountSendingAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccountSendingAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
