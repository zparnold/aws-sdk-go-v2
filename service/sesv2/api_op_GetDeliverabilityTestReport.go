...
func (c *Client) GetDeliverabilityTestReport(ctx context.Context, params *GetDeliverabilityTestReportInput, optFns ...func(*Options)) (*GetDeliverabilityTestReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeliverabilityTestReport", params, optFns, addOperationGetDeliverabilityTestReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeliverabilityTestReportMiddleware(stack *middleware.Stack, options Options) (err error) {
