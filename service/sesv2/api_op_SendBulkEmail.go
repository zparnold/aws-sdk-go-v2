...
func (c *Client) SendBulkEmail(ctx context.Context, params *SendBulkEmailInput, optFns ...func(*Options)) (*SendBulkEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendBulkEmail", params, optFns, addOperationSendBulkEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendBulkEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
