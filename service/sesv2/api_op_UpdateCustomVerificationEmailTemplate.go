...
func (c *Client) UpdateCustomVerificationEmailTemplate(ctx context.Context, params *UpdateCustomVerificationEmailTemplateInput, optFns ...func(*Options)) (*UpdateCustomVerificationEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCustomVerificationEmailTemplate", params, optFns, addOperationUpdateCustomVerificationEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCustomVerificationEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
