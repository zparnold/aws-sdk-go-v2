...
func (c *Client) UpdateEmailTemplate(ctx context.Context, params *UpdateEmailTemplateInput, optFns ...func(*Options)) (*UpdateEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEmailTemplate", params, optFns, addOperationUpdateEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
