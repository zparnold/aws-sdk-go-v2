...
func (c *Client) PutSuppressedDestination(ctx context.Context, params *PutSuppressedDestinationInput, optFns ...func(*Options)) (*PutSuppressedDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSuppressedDestination", params, optFns, addOperationPutSuppressedDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSuppressedDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
