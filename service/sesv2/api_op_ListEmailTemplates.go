...
func (c *Client) ListEmailTemplates(ctx context.Context, params *ListEmailTemplatesInput, optFns ...func(*Options)) (*ListEmailTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEmailTemplates", params, optFns, addOperationListEmailTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEmailTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
