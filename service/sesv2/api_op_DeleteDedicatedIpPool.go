...
func (c *Client) DeleteDedicatedIpPool(ctx context.Context, params *DeleteDedicatedIpPoolInput, optFns ...func(*Options)) (*DeleteDedicatedIpPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDedicatedIpPool", params, optFns, addOperationDeleteDedicatedIpPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDedicatedIpPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
