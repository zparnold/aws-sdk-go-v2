...
func (c *Client) GetEmailIdentityPolicies(ctx context.Context, params *GetEmailIdentityPoliciesInput, optFns ...func(*Options)) (*GetEmailIdentityPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEmailIdentityPolicies", params, optFns, addOperationGetEmailIdentityPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEmailIdentityPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
