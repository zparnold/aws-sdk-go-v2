...
func (c *Client) GetDomainDeliverabilityCampaign(ctx context.Context, params *GetDomainDeliverabilityCampaignInput, optFns ...func(*Options)) (*GetDomainDeliverabilityCampaignOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainDeliverabilityCampaign", params, optFns, addOperationGetDomainDeliverabilityCampaignMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainDeliverabilityCampaignMiddleware(stack *middleware.Stack, options Options) (err error) {
