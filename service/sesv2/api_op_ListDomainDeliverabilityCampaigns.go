...
func (c *Client) ListDomainDeliverabilityCampaigns(ctx context.Context, params *ListDomainDeliverabilityCampaignsInput, optFns ...func(*Options)) (*ListDomainDeliverabilityCampaignsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDomainDeliverabilityCampaigns", params, optFns, addOperationListDomainDeliverabilityCampaignsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDomainDeliverabilityCampaignsMiddleware(stack *middleware.Stack, options Options) (err error) {
