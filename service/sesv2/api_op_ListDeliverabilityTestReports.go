...
func (c *Client) ListDeliverabilityTestReports(ctx context.Context, params *ListDeliverabilityTestReportsInput, optFns ...func(*Options)) (*ListDeliverabilityTestReportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeliverabilityTestReports", params, optFns, addOperationListDeliverabilityTestReportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeliverabilityTestReportsMiddleware(stack *middleware.Stack, options Options) (err error) {
