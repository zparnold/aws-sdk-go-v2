...
func (c *Client) GetBlacklistReports(ctx context.Context, params *GetBlacklistReportsInput, optFns ...func(*Options)) (*GetBlacklistReportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBlacklistReports", params, optFns, addOperationGetBlacklistReportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBlacklistReportsMiddleware(stack *middleware.Stack, options Options) (err error) {
