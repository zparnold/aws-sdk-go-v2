...
func (c *Client) PutConfigurationSetSendingOptions(ctx context.Context, params *PutConfigurationSetSendingOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetSendingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConfigurationSetSendingOptions", params, optFns, addOperationPutConfigurationSetSendingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConfigurationSetSendingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
