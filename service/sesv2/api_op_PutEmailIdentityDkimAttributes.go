...
func (c *Client) PutEmailIdentityDkimAttributes(ctx context.Context, params *PutEmailIdentityDkimAttributesInput, optFns ...func(*Options)) (*PutEmailIdentityDkimAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEmailIdentityDkimAttributes", params, optFns, addOperationPutEmailIdentityDkimAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEmailIdentityDkimAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
