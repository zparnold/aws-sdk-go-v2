...
func (c *Client) PutConfigurationSetSuppressionOptions(ctx context.Context, params *PutConfigurationSetSuppressionOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetSuppressionOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConfigurationSetSuppressionOptions", params, optFns, addOperationPutConfigurationSetSuppressionOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConfigurationSetSuppressionOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
