...
func (c *Client) DeleteSuppressedDestination(ctx context.Context, params *DeleteSuppressedDestinationInput, optFns ...func(*Options)) (*DeleteSuppressedDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSuppressedDestination", params, optFns, addOperationDeleteSuppressedDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSuppressedDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
