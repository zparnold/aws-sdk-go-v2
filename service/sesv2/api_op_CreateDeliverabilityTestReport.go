...
func (c *Client) CreateDeliverabilityTestReport(ctx context.Context, params *CreateDeliverabilityTestReportInput, optFns ...func(*Options)) (*CreateDeliverabilityTestReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDeliverabilityTestReport", params, optFns, addOperationCreateDeliverabilityTestReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDeliverabilityTestReportMiddleware(stack *middleware.Stack, options Options) (err error) {
