...
func (c *Client) PutAccountDetails(ctx context.Context, params *PutAccountDetailsInput, optFns ...func(*Options)) (*PutAccountDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAccountDetails", params, optFns, addOperationPutAccountDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAccountDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
