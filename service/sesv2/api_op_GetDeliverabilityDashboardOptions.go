...
func (c *Client) GetDeliverabilityDashboardOptions(ctx context.Context, params *GetDeliverabilityDashboardOptionsInput, optFns ...func(*Options)) (*GetDeliverabilityDashboardOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeliverabilityDashboardOptions", params, optFns, addOperationGetDeliverabilityDashboardOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeliverabilityDashboardOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
