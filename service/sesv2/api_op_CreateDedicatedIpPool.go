...
func (c *Client) CreateDedicatedIpPool(ctx context.Context, params *CreateDedicatedIpPoolInput, optFns ...func(*Options)) (*CreateDedicatedIpPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDedicatedIpPool", params, optFns, addOperationCreateDedicatedIpPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDedicatedIpPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
