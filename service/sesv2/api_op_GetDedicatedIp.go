...
func (c *Client) GetDedicatedIp(ctx context.Context, params *GetDedicatedIpInput, optFns ...func(*Options)) (*GetDedicatedIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDedicatedIp", params, optFns, addOperationGetDedicatedIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDedicatedIpMiddleware(stack *middleware.Stack, options Options) (err error) {
