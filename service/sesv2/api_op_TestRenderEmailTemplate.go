...
func (c *Client) TestRenderEmailTemplate(ctx context.Context, params *TestRenderEmailTemplateInput, optFns ...func(*Options)) (*TestRenderEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestRenderEmailTemplate", params, optFns, addOperationTestRenderEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestRenderEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
