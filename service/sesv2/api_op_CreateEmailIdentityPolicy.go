...
func (c *Client) CreateEmailIdentityPolicy(ctx context.Context, params *CreateEmailIdentityPolicyInput, optFns ...func(*Options)) (*CreateEmailIdentityPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEmailIdentityPolicy", params, optFns, addOperationCreateEmailIdentityPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEmailIdentityPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
