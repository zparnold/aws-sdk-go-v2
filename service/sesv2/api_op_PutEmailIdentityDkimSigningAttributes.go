...
func (c *Client) PutEmailIdentityDkimSigningAttributes(ctx context.Context, params *PutEmailIdentityDkimSigningAttributesInput, optFns ...func(*Options)) (*PutEmailIdentityDkimSigningAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEmailIdentityDkimSigningAttributes", params, optFns, addOperationPutEmailIdentityDkimSigningAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEmailIdentityDkimSigningAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
