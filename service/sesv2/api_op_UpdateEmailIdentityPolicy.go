...
func (c *Client) UpdateEmailIdentityPolicy(ctx context.Context, params *UpdateEmailIdentityPolicyInput, optFns ...func(*Options)) (*UpdateEmailIdentityPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEmailIdentityPolicy", params, optFns, addOperationUpdateEmailIdentityPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEmailIdentityPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
