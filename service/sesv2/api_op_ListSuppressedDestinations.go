...
func (c *Client) ListSuppressedDestinations(ctx context.Context, params *ListSuppressedDestinationsInput, optFns ...func(*Options)) (*ListSuppressedDestinationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSuppressedDestinations", params, optFns, addOperationListSuppressedDestinationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSuppressedDestinationsMiddleware(stack *middleware.Stack, options Options) (err error) {
