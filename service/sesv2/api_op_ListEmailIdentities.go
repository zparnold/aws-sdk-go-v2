...
func (c *Client) ListEmailIdentities(ctx context.Context, params *ListEmailIdentitiesInput, optFns ...func(*Options)) (*ListEmailIdentitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEmailIdentities", params, optFns, addOperationListEmailIdentitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEmailIdentitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
