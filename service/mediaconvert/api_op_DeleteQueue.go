...
func (c *Client) DeleteQueue(ctx context.Context, params *DeleteQueueInput, optFns ...func(*Options)) (*DeleteQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteQueue", params, optFns, addOperationDeleteQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
