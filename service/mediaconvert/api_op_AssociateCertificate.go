...
func (c *Client) AssociateCertificate(ctx context.Context, params *AssociateCertificateInput, optFns ...func(*Options)) (*AssociateCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateCertificate", params, optFns, addOperationAssociateCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
