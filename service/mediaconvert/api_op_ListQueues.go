...
func (c *Client) ListQueues(ctx context.Context, params *ListQueuesInput, optFns ...func(*Options)) (*ListQueuesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListQueues", params, optFns, addOperationListQueuesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListQueuesMiddleware(stack *middleware.Stack, options Options) (err error) {
