...
func (c *Client) ListJobTemplates(ctx context.Context, params *ListJobTemplatesInput, optFns ...func(*Options)) (*ListJobTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJobTemplates", params, optFns, addOperationListJobTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJobTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
