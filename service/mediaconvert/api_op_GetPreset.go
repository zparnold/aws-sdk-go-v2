...
func (c *Client) GetPreset(ctx context.Context, params *GetPresetInput, optFns ...func(*Options)) (*GetPresetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPreset", params, optFns, addOperationGetPresetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPresetMiddleware(stack *middleware.Stack, options Options) (err error) {
