...
func (c *Client) GetJobTemplate(ctx context.Context, params *GetJobTemplateInput, optFns ...func(*Options)) (*GetJobTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobTemplate", params, optFns, addOperationGetJobTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
