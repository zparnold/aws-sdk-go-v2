...
func (c *Client) DisassociateCertificate(ctx context.Context, params *DisassociateCertificateInput, optFns ...func(*Options)) (*DisassociateCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateCertificate", params, optFns, addOperationDisassociateCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
