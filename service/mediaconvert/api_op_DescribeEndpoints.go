...
func (c *Client) DescribeEndpoints(ctx context.Context, params *DescribeEndpointsInput, optFns ...func(*Options)) (*DescribeEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEndpoints", params, optFns, addOperationDescribeEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
