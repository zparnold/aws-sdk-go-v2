...
func (c *Client) UpdatePreset(ctx context.Context, params *UpdatePresetInput, optFns ...func(*Options)) (*UpdatePresetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePreset", params, optFns, addOperationUpdatePresetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePresetMiddleware(stack *middleware.Stack, options Options) (err error) {
