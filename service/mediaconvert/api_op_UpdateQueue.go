...
func (c *Client) UpdateQueue(ctx context.Context, params *UpdateQueueInput, optFns ...func(*Options)) (*UpdateQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateQueue", params, optFns, addOperationUpdateQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
