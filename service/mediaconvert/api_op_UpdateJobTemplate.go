...
func (c *Client) UpdateJobTemplate(ctx context.Context, params *UpdateJobTemplateInput, optFns ...func(*Options)) (*UpdateJobTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateJobTemplate", params, optFns, addOperationUpdateJobTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateJobTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
