...
func (c *Client) ListPresets(ctx context.Context, params *ListPresetsInput, optFns ...func(*Options)) (*ListPresetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPresets", params, optFns, addOperationListPresetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPresetsMiddleware(stack *middleware.Stack, options Options) (err error) {
