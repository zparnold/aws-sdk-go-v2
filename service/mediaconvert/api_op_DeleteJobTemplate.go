...
func (c *Client) DeleteJobTemplate(ctx context.Context, params *DeleteJobTemplateInput, optFns ...func(*Options)) (*DeleteJobTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteJobTemplate", params, optFns, addOperationDeleteJobTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteJobTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
