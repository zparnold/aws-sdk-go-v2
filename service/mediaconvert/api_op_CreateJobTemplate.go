...
func (c *Client) CreateJobTemplate(ctx context.Context, params *CreateJobTemplateInput, optFns ...func(*Options)) (*CreateJobTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateJobTemplate", params, optFns, addOperationCreateJobTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateJobTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
