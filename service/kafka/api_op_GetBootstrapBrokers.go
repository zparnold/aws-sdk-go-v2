...
func (c *Client) GetBootstrapBrokers(ctx context.Context, params *GetBootstrapBrokersInput, optFns ...func(*Options)) (*GetBootstrapBrokersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBootstrapBrokers", params, optFns, addOperationGetBootstrapBrokersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBootstrapBrokersMiddleware(stack *middleware.Stack, options Options) (err error) {
