...
func (c *Client) ListKafkaVersions(ctx context.Context, params *ListKafkaVersionsInput, optFns ...func(*Options)) (*ListKafkaVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListKafkaVersions", params, optFns, addOperationListKafkaVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListKafkaVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
