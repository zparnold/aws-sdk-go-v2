...
func (c *Client) UpdateBrokerStorage(ctx context.Context, params *UpdateBrokerStorageInput, optFns ...func(*Options)) (*UpdateBrokerStorageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBrokerStorage", params, optFns, addOperationUpdateBrokerStorageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBrokerStorageMiddleware(stack *middleware.Stack, options Options) (err error) {
