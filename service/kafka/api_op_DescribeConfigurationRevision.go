...
func (c *Client) DescribeConfigurationRevision(ctx context.Context, params *DescribeConfigurationRevisionInput, optFns ...func(*Options)) (*DescribeConfigurationRevisionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationRevision", params, optFns, addOperationDescribeConfigurationRevisionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationRevisionMiddleware(stack *middleware.Stack, options Options) (err error) {
