...
func (c *Client) GetCompatibleKafkaVersions(ctx context.Context, params *GetCompatibleKafkaVersionsInput, optFns ...func(*Options)) (*GetCompatibleKafkaVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCompatibleKafkaVersions", params, optFns, addOperationGetCompatibleKafkaVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCompatibleKafkaVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
