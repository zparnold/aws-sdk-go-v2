...
func (c *Client) UpdateBrokerCount(ctx context.Context, params *UpdateBrokerCountInput, optFns ...func(*Options)) (*UpdateBrokerCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBrokerCount", params, optFns, addOperationUpdateBrokerCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBrokerCountMiddleware(stack *middleware.Stack, options Options) (err error) {
