...
func (c *Client) ListConfigurationRevisions(ctx context.Context, params *ListConfigurationRevisionsInput, optFns ...func(*Options)) (*ListConfigurationRevisionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConfigurationRevisions", params, optFns, addOperationListConfigurationRevisionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConfigurationRevisionsMiddleware(stack *middleware.Stack, options Options) (err error) {
