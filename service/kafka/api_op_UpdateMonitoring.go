...
func (c *Client) UpdateMonitoring(ctx context.Context, params *UpdateMonitoringInput, optFns ...func(*Options)) (*UpdateMonitoringOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMonitoring", params, optFns, addOperationUpdateMonitoringMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMonitoringMiddleware(stack *middleware.Stack, options Options) (err error) {
