...
func (c *Client) UpdateClusterKafkaVersion(ctx context.Context, params *UpdateClusterKafkaVersionInput, optFns ...func(*Options)) (*UpdateClusterKafkaVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClusterKafkaVersion", params, optFns, addOperationUpdateClusterKafkaVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClusterKafkaVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
