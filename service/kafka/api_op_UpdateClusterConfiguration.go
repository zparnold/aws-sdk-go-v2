...
func (c *Client) UpdateClusterConfiguration(ctx context.Context, params *UpdateClusterConfigurationInput, optFns ...func(*Options)) (*UpdateClusterConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClusterConfiguration", params, optFns, addOperationUpdateClusterConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClusterConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
