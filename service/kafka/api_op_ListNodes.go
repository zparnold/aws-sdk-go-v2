...
func (c *Client) ListNodes(ctx context.Context, params *ListNodesInput, optFns ...func(*Options)) (*ListNodesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNodes", params, optFns, addOperationListNodesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNodesMiddleware(stack *middleware.Stack, options Options) (err error) {
