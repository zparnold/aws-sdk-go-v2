...
func (c *Client) RebootBroker(ctx context.Context, params *RebootBrokerInput, optFns ...func(*Options)) (*RebootBrokerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootBroker", params, optFns, addOperationRebootBrokerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootBrokerMiddleware(stack *middleware.Stack, options Options) (err error) {
