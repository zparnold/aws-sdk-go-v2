...
func (c *Client) ListClusterOperations(ctx context.Context, params *ListClusterOperationsInput, optFns ...func(*Options)) (*ListClusterOperationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListClusterOperations", params, optFns, addOperationListClusterOperationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListClusterOperationsMiddleware(stack *middleware.Stack, options Options) (err error) {
