...
func (c *Client) DescribeHomeRegionControls(ctx context.Context, params *DescribeHomeRegionControlsInput, optFns ...func(*Options)) (*DescribeHomeRegionControlsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHomeRegionControls", params, optFns, addOperationDescribeHomeRegionControlsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHomeRegionControlsMiddleware(stack *middleware.Stack, options Options) (err error) {
