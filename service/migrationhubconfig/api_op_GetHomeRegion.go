...
func (c *Client) GetHomeRegion(ctx context.Context, params *GetHomeRegionInput, optFns ...func(*Options)) (*GetHomeRegionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHomeRegion", params, optFns, addOperationGetHomeRegionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHomeRegionMiddleware(stack *middleware.Stack, options Options) (err error) {
