...
func (c *Client) CreateHomeRegionControl(ctx context.Context, params *CreateHomeRegionControlInput, optFns ...func(*Options)) (*CreateHomeRegionControlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHomeRegionControl", params, optFns, addOperationCreateHomeRegionControlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHomeRegionControlMiddleware(stack *middleware.Stack, options Options) (err error) {
