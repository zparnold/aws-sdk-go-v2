...
func (c *Client) UpdateRelationalDatabaseParameters(ctx context.Context, params *UpdateRelationalDatabaseParametersInput, optFns ...func(*Options)) (*UpdateRelationalDatabaseParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRelationalDatabaseParameters", params, optFns, addOperationUpdateRelationalDatabaseParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRelationalDatabaseParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
