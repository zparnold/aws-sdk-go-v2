...
func (c *Client) CreateInstancesFromSnapshot(ctx context.Context, params *CreateInstancesFromSnapshotInput, optFns ...func(*Options)) (*CreateInstancesFromSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInstancesFromSnapshot", params, optFns, addOperationCreateInstancesFromSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInstancesFromSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
