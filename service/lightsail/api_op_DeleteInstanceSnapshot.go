...
func (c *Client) DeleteInstanceSnapshot(ctx context.Context, params *DeleteInstanceSnapshotInput, optFns ...func(*Options)) (*DeleteInstanceSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInstanceSnapshot", params, optFns, addOperationDeleteInstanceSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInstanceSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
