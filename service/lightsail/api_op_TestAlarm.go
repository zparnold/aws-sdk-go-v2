...
func (c *Client) TestAlarm(ctx context.Context, params *TestAlarmInput, optFns ...func(*Options)) (*TestAlarmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestAlarm", params, optFns, addOperationTestAlarmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestAlarmMiddleware(stack *middleware.Stack, options Options) (err error) {
