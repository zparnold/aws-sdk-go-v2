...
func (c *Client) GetLoadBalancer(ctx context.Context, params *GetLoadBalancerInput, optFns ...func(*Options)) (*GetLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoadBalancer", params, optFns, addOperationGetLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
