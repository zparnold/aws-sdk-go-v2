...
func (c *Client) CreateDiskFromSnapshot(ctx context.Context, params *CreateDiskFromSnapshotInput, optFns ...func(*Options)) (*CreateDiskFromSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDiskFromSnapshot", params, optFns, addOperationCreateDiskFromSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDiskFromSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
