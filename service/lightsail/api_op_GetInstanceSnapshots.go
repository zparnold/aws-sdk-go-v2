...
func (c *Client) GetInstanceSnapshots(ctx context.Context, params *GetInstanceSnapshotsInput, optFns ...func(*Options)) (*GetInstanceSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInstanceSnapshots", params, optFns, addOperationGetInstanceSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInstanceSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
