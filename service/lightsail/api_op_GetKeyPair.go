...
func (c *Client) GetKeyPair(ctx context.Context, params *GetKeyPairInput, optFns ...func(*Options)) (*GetKeyPairOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetKeyPair", params, optFns, addOperationGetKeyPairMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetKeyPairMiddleware(stack *middleware.Stack, options Options) (err error) {
