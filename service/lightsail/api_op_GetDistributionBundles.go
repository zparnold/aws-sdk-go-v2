...
func (c *Client) GetDistributionBundles(ctx context.Context, params *GetDistributionBundlesInput, optFns ...func(*Options)) (*GetDistributionBundlesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDistributionBundles", params, optFns, addOperationGetDistributionBundlesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDistributionBundlesMiddleware(stack *middleware.Stack, options Options) (err error) {
