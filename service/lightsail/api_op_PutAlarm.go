...
func (c *Client) PutAlarm(ctx context.Context, params *PutAlarmInput, optFns ...func(*Options)) (*PutAlarmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAlarm", params, optFns, addOperationPutAlarmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAlarmMiddleware(stack *middleware.Stack, options Options) (err error) {
