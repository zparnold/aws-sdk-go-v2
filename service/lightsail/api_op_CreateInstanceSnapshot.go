...
func (c *Client) CreateInstanceSnapshot(ctx context.Context, params *CreateInstanceSnapshotInput, optFns ...func(*Options)) (*CreateInstanceSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateInstanceSnapshot", params, optFns, addOperationCreateInstanceSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateInstanceSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
