...
func (c *Client) RebootInstance(ctx context.Context, params *RebootInstanceInput, optFns ...func(*Options)) (*RebootInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootInstance", params, optFns, addOperationRebootInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
