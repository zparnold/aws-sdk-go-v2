...
func (c *Client) GetRelationalDatabaseLogStreams(ctx context.Context, params *GetRelationalDatabaseLogStreamsInput, optFns ...func(*Options)) (*GetRelationalDatabaseLogStreamsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRelationalDatabaseLogStreams", params, optFns, addOperationGetRelationalDatabaseLogStreamsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRelationalDatabaseLogStreamsMiddleware(stack *middleware.Stack, options Options) (err error) {
