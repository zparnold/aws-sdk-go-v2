...
func (c *Client) GetAutoSnapshots(ctx context.Context, params *GetAutoSnapshotsInput, optFns ...func(*Options)) (*GetAutoSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAutoSnapshots", params, optFns, addOperationGetAutoSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAutoSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
