...
func (c *Client) GetDistributionLatestCacheReset(ctx context.Context, params *GetDistributionLatestCacheResetInput, optFns ...func(*Options)) (*GetDistributionLatestCacheResetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDistributionLatestCacheReset", params, optFns, addOperationGetDistributionLatestCacheResetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDistributionLatestCacheResetMiddleware(stack *middleware.Stack, options Options) (err error) {
