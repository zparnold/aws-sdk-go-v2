...
func (c *Client) AttachDisk(ctx context.Context, params *AttachDiskInput, optFns ...func(*Options)) (*AttachDiskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachDisk", params, optFns, addOperationAttachDiskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachDiskMiddleware(stack *middleware.Stack, options Options) (err error) {
