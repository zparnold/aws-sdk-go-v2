...
func (c *Client) ExportSnapshot(ctx context.Context, params *ExportSnapshotInput, optFns ...func(*Options)) (*ExportSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportSnapshot", params, optFns, addOperationExportSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
