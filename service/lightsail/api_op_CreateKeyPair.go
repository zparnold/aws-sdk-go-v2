...
func (c *Client) CreateKeyPair(ctx context.Context, params *CreateKeyPairInput, optFns ...func(*Options)) (*CreateKeyPairOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateKeyPair", params, optFns, addOperationCreateKeyPairMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateKeyPairMiddleware(stack *middleware.Stack, options Options) (err error) {
