...
func (c *Client) GetRegions(ctx context.Context, params *GetRegionsInput, optFns ...func(*Options)) (*GetRegionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRegions", params, optFns, addOperationGetRegionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRegionsMiddleware(stack *middleware.Stack, options Options) (err error) {
