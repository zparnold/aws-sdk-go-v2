...
func (c *Client) CreateRelationalDatabaseSnapshot(ctx context.Context, params *CreateRelationalDatabaseSnapshotInput, optFns ...func(*Options)) (*CreateRelationalDatabaseSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRelationalDatabaseSnapshot", params, optFns, addOperationCreateRelationalDatabaseSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRelationalDatabaseSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
