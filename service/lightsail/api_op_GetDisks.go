...
func (c *Client) GetDisks(ctx context.Context, params *GetDisksInput, optFns ...func(*Options)) (*GetDisksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDisks", params, optFns, addOperationGetDisksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDisksMiddleware(stack *middleware.Stack, options Options) (err error) {
