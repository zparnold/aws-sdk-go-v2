...
func (c *Client) CreateCloudFormationStack(ctx context.Context, params *CreateCloudFormationStackInput, optFns ...func(*Options)) (*CreateCloudFormationStackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCloudFormationStack", params, optFns, addOperationCreateCloudFormationStackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCloudFormationStackMiddleware(stack *middleware.Stack, options Options) (err error) {
