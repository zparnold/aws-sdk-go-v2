...
func (c *Client) GetRelationalDatabaseSnapshot(ctx context.Context, params *GetRelationalDatabaseSnapshotInput, optFns ...func(*Options)) (*GetRelationalDatabaseSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRelationalDatabaseSnapshot", params, optFns, addOperationGetRelationalDatabaseSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRelationalDatabaseSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
