...
func (c *Client) EnableAddOn(ctx context.Context, params *EnableAddOnInput, optFns ...func(*Options)) (*EnableAddOnOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableAddOn", params, optFns, addOperationEnableAddOnMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableAddOnMiddleware(stack *middleware.Stack, options Options) (err error) {
