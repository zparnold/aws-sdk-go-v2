...
func (c *Client) DeleteKnownHostKeys(ctx context.Context, params *DeleteKnownHostKeysInput, optFns ...func(*Options)) (*DeleteKnownHostKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteKnownHostKeys", params, optFns, addOperationDeleteKnownHostKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteKnownHostKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
