...
func (c *Client) UnpeerVpc(ctx context.Context, params *UnpeerVpcInput, optFns ...func(*Options)) (*UnpeerVpcOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnpeerVpc", params, optFns, addOperationUnpeerVpcMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnpeerVpcMiddleware(stack *middleware.Stack, options Options) (err error) {
