...
func (c *Client) AllocateStaticIp(ctx context.Context, params *AllocateStaticIpInput, optFns ...func(*Options)) (*AllocateStaticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocateStaticIp", params, optFns, addOperationAllocateStaticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocateStaticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
