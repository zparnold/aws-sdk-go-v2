...
func (c *Client) GetRelationalDatabase(ctx context.Context, params *GetRelationalDatabaseInput, optFns ...func(*Options)) (*GetRelationalDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRelationalDatabase", params, optFns, addOperationGetRelationalDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRelationalDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
