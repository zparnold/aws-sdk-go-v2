...
func (c *Client) GetLoadBalancerMetricData(ctx context.Context, params *GetLoadBalancerMetricDataInput, optFns ...func(*Options)) (*GetLoadBalancerMetricDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoadBalancerMetricData", params, optFns, addOperationGetLoadBalancerMetricDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoadBalancerMetricDataMiddleware(stack *middleware.Stack, options Options) (err error) {
