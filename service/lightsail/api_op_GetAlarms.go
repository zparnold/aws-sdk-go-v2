...
func (c *Client) GetAlarms(ctx context.Context, params *GetAlarmsInput, optFns ...func(*Options)) (*GetAlarmsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAlarms", params, optFns, addOperationGetAlarmsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAlarmsMiddleware(stack *middleware.Stack, options Options) (err error) {
