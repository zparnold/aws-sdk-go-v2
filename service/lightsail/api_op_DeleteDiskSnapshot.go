...
func (c *Client) DeleteDiskSnapshot(ctx context.Context, params *DeleteDiskSnapshotInput, optFns ...func(*Options)) (*DeleteDiskSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDiskSnapshot", params, optFns, addOperationDeleteDiskSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDiskSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
