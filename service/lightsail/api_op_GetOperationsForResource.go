...
func (c *Client) GetOperationsForResource(ctx context.Context, params *GetOperationsForResourceInput, optFns ...func(*Options)) (*GetOperationsForResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOperationsForResource", params, optFns, addOperationGetOperationsForResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOperationsForResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
