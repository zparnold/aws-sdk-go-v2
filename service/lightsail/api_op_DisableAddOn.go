...
func (c *Client) DisableAddOn(ctx context.Context, params *DisableAddOnInput, optFns ...func(*Options)) (*DisableAddOnOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableAddOn", params, optFns, addOperationDisableAddOnMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableAddOnMiddleware(stack *middleware.Stack, options Options) (err error) {
