...
func (c *Client) RebootRelationalDatabase(ctx context.Context, params *RebootRelationalDatabaseInput, optFns ...func(*Options)) (*RebootRelationalDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootRelationalDatabase", params, optFns, addOperationRebootRelationalDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootRelationalDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
