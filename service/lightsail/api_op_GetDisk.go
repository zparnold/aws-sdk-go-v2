...
func (c *Client) GetDisk(ctx context.Context, params *GetDiskInput, optFns ...func(*Options)) (*GetDiskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDisk", params, optFns, addOperationGetDiskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDiskMiddleware(stack *middleware.Stack, options Options) (err error) {
