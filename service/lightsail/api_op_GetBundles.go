...
func (c *Client) GetBundles(ctx context.Context, params *GetBundlesInput, optFns ...func(*Options)) (*GetBundlesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBundles", params, optFns, addOperationGetBundlesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBundlesMiddleware(stack *middleware.Stack, options Options) (err error) {
