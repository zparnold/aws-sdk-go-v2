...
func (c *Client) GetRelationalDatabaseLogEvents(ctx context.Context, params *GetRelationalDatabaseLogEventsInput, optFns ...func(*Options)) (*GetRelationalDatabaseLogEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRelationalDatabaseLogEvents", params, optFns, addOperationGetRelationalDatabaseLogEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRelationalDatabaseLogEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
