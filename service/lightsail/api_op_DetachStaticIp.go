...
func (c *Client) DetachStaticIp(ctx context.Context, params *DetachStaticIpInput, optFns ...func(*Options)) (*DetachStaticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachStaticIp", params, optFns, addOperationDetachStaticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachStaticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
