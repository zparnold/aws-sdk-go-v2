...
func (c *Client) GetDomain(ctx context.Context, params *GetDomainInput, optFns ...func(*Options)) (*GetDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomain", params, optFns, addOperationGetDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
