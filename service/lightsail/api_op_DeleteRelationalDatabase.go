...
func (c *Client) DeleteRelationalDatabase(ctx context.Context, params *DeleteRelationalDatabaseInput, optFns ...func(*Options)) (*DeleteRelationalDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRelationalDatabase", params, optFns, addOperationDeleteRelationalDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRelationalDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
