...
func (c *Client) CreateRelationalDatabaseFromSnapshot(ctx context.Context, params *CreateRelationalDatabaseFromSnapshotInput, optFns ...func(*Options)) (*CreateRelationalDatabaseFromSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRelationalDatabaseFromSnapshot", params, optFns, addOperationCreateRelationalDatabaseFromSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRelationalDatabaseFromSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
