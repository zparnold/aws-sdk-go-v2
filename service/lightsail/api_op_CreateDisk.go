...
func (c *Client) CreateDisk(ctx context.Context, params *CreateDiskInput, optFns ...func(*Options)) (*CreateDiskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDisk", params, optFns, addOperationCreateDiskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDiskMiddleware(stack *middleware.Stack, options Options) (err error) {
