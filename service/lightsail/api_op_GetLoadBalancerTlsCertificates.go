...
func (c *Client) GetLoadBalancerTlsCertificates(ctx context.Context, params *GetLoadBalancerTlsCertificatesInput, optFns ...func(*Options)) (*GetLoadBalancerTlsCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoadBalancerTlsCertificates", params, optFns, addOperationGetLoadBalancerTlsCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoadBalancerTlsCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
