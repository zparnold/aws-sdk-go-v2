...
func (c *Client) GetDistributionMetricData(ctx context.Context, params *GetDistributionMetricDataInput, optFns ...func(*Options)) (*GetDistributionMetricDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDistributionMetricData", params, optFns, addOperationGetDistributionMetricDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDistributionMetricDataMiddleware(stack *middleware.Stack, options Options) (err error) {
