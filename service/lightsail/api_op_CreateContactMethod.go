...
func (c *Client) CreateContactMethod(ctx context.Context, params *CreateContactMethodInput, optFns ...func(*Options)) (*CreateContactMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateContactMethod", params, optFns, addOperationCreateContactMethodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateContactMethodMiddleware(stack *middleware.Stack, options Options) (err error) {
