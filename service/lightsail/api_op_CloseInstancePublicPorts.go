...
func (c *Client) CloseInstancePublicPorts(ctx context.Context, params *CloseInstancePublicPortsInput, optFns ...func(*Options)) (*CloseInstancePublicPortsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CloseInstancePublicPorts", params, optFns, addOperationCloseInstancePublicPortsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCloseInstancePublicPortsMiddleware(stack *middleware.Stack, options Options) (err error) {
