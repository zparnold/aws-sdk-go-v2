...
func (c *Client) GetDiskSnapshots(ctx context.Context, params *GetDiskSnapshotsInput, optFns ...func(*Options)) (*GetDiskSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDiskSnapshots", params, optFns, addOperationGetDiskSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDiskSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
