...
func (c *Client) DetachDisk(ctx context.Context, params *DetachDiskInput, optFns ...func(*Options)) (*DetachDiskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachDisk", params, optFns, addOperationDetachDiskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachDiskMiddleware(stack *middleware.Stack, options Options) (err error) {
