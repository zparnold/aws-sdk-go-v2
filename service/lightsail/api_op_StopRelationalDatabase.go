...
func (c *Client) StopRelationalDatabase(ctx context.Context, params *StopRelationalDatabaseInput, optFns ...func(*Options)) (*StopRelationalDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopRelationalDatabase", params, optFns, addOperationStopRelationalDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopRelationalDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
