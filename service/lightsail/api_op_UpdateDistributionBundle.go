...
func (c *Client) UpdateDistributionBundle(ctx context.Context, params *UpdateDistributionBundleInput, optFns ...func(*Options)) (*UpdateDistributionBundleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDistributionBundle", params, optFns, addOperationUpdateDistributionBundleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDistributionBundleMiddleware(stack *middleware.Stack, options Options) (err error) {
