...
func (c *Client) AttachStaticIp(ctx context.Context, params *AttachStaticIpInput, optFns ...func(*Options)) (*AttachStaticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachStaticIp", params, optFns, addOperationAttachStaticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachStaticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
