...
func (c *Client) StartRelationalDatabase(ctx context.Context, params *StartRelationalDatabaseInput, optFns ...func(*Options)) (*StartRelationalDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartRelationalDatabase", params, optFns, addOperationStartRelationalDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartRelationalDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
