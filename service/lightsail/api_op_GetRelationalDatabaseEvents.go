...
func (c *Client) GetRelationalDatabaseEvents(ctx context.Context, params *GetRelationalDatabaseEventsInput, optFns ...func(*Options)) (*GetRelationalDatabaseEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRelationalDatabaseEvents", params, optFns, addOperationGetRelationalDatabaseEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRelationalDatabaseEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
