...
func (c *Client) GetDiskSnapshot(ctx context.Context, params *GetDiskSnapshotInput, optFns ...func(*Options)) (*GetDiskSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDiskSnapshot", params, optFns, addOperationGetDiskSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDiskSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
