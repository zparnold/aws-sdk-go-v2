...
func (c *Client) GetLoadBalancers(ctx context.Context, params *GetLoadBalancersInput, optFns ...func(*Options)) (*GetLoadBalancersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoadBalancers", params, optFns, addOperationGetLoadBalancersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoadBalancersMiddleware(stack *middleware.Stack, options Options) (err error) {
