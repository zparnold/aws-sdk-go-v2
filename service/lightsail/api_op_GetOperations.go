...
func (c *Client) GetOperations(ctx context.Context, params *GetOperationsInput, optFns ...func(*Options)) (*GetOperationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOperations", params, optFns, addOperationGetOperationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOperationsMiddleware(stack *middleware.Stack, options Options) (err error) {
