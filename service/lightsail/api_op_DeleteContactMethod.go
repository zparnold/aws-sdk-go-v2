...
func (c *Client) DeleteContactMethod(ctx context.Context, params *DeleteContactMethodInput, optFns ...func(*Options)) (*DeleteContactMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteContactMethod", params, optFns, addOperationDeleteContactMethodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteContactMethodMiddleware(stack *middleware.Stack, options Options) (err error) {
