...
func (c *Client) SendContactMethodVerification(ctx context.Context, params *SendContactMethodVerificationInput, optFns ...func(*Options)) (*SendContactMethodVerificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendContactMethodVerification", params, optFns, addOperationSendContactMethodVerificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendContactMethodVerificationMiddleware(stack *middleware.Stack, options Options) (err error) {
