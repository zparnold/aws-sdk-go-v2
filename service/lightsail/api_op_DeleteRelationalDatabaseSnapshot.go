...
func (c *Client) DeleteRelationalDatabaseSnapshot(ctx context.Context, params *DeleteRelationalDatabaseSnapshotInput, optFns ...func(*Options)) (*DeleteRelationalDatabaseSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRelationalDatabaseSnapshot", params, optFns, addOperationDeleteRelationalDatabaseSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRelationalDatabaseSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
