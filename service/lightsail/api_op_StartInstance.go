...
func (c *Client) StartInstance(ctx context.Context, params *StartInstanceInput, optFns ...func(*Options)) (*StartInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartInstance", params, optFns, addOperationStartInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
