...
func (c *Client) GetCertificates(ctx context.Context, params *GetCertificatesInput, optFns ...func(*Options)) (*GetCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCertificates", params, optFns, addOperationGetCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
