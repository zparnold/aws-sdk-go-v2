...
func (c *Client) PeerVpc(ctx context.Context, params *PeerVpcInput, optFns ...func(*Options)) (*PeerVpcOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PeerVpc", params, optFns, addOperationPeerVpcMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPeerVpcMiddleware(stack *middleware.Stack, options Options) (err error) {
