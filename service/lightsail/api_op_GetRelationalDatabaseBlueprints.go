...
func (c *Client) GetRelationalDatabaseBlueprints(ctx context.Context, params *GetRelationalDatabaseBlueprintsInput, optFns ...func(*Options)) (*GetRelationalDatabaseBlueprintsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRelationalDatabaseBlueprints", params, optFns, addOperationGetRelationalDatabaseBlueprintsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRelationalDatabaseBlueprintsMiddleware(stack *middleware.Stack, options Options) (err error) {
