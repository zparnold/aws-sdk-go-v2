...
func (c *Client) ResetDistributionCache(ctx context.Context, params *ResetDistributionCacheInput, optFns ...func(*Options)) (*ResetDistributionCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetDistributionCache", params, optFns, addOperationResetDistributionCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetDistributionCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
