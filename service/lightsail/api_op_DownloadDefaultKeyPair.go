...
func (c *Client) DownloadDefaultKeyPair(ctx context.Context, params *DownloadDefaultKeyPairInput, optFns ...func(*Options)) (*DownloadDefaultKeyPairOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DownloadDefaultKeyPair", params, optFns, addOperationDownloadDefaultKeyPairMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDownloadDefaultKeyPairMiddleware(stack *middleware.Stack, options Options) (err error) {
