...
func (c *Client) GetInstanceSnapshot(ctx context.Context, params *GetInstanceSnapshotInput, optFns ...func(*Options)) (*GetInstanceSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInstanceSnapshot", params, optFns, addOperationGetInstanceSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInstanceSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
