...
func (c *Client) GetRelationalDatabaseMetricData(ctx context.Context, params *GetRelationalDatabaseMetricDataInput, optFns ...func(*Options)) (*GetRelationalDatabaseMetricDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRelationalDatabaseMetricData", params, optFns, addOperationGetRelationalDatabaseMetricDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRelationalDatabaseMetricDataMiddleware(stack *middleware.Stack, options Options) (err error) {
