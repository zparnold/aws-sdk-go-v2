...
func (c *Client) GetActiveNames(ctx context.Context, params *GetActiveNamesInput, optFns ...func(*Options)) (*GetActiveNamesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetActiveNames", params, optFns, addOperationGetActiveNamesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetActiveNamesMiddleware(stack *middleware.Stack, options Options) (err error) {
