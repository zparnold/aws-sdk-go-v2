...
func (c *Client) GetKeyPairs(ctx context.Context, params *GetKeyPairsInput, optFns ...func(*Options)) (*GetKeyPairsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetKeyPairs", params, optFns, addOperationGetKeyPairsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetKeyPairsMiddleware(stack *middleware.Stack, options Options) (err error) {
