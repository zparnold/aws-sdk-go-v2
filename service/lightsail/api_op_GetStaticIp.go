...
func (c *Client) GetStaticIp(ctx context.Context, params *GetStaticIpInput, optFns ...func(*Options)) (*GetStaticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStaticIp", params, optFns, addOperationGetStaticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStaticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
