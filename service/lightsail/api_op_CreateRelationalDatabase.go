...
func (c *Client) CreateRelationalDatabase(ctx context.Context, params *CreateRelationalDatabaseInput, optFns ...func(*Options)) (*CreateRelationalDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRelationalDatabase", params, optFns, addOperationCreateRelationalDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRelationalDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
