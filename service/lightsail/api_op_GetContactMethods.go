...
func (c *Client) GetContactMethods(ctx context.Context, params *GetContactMethodsInput, optFns ...func(*Options)) (*GetContactMethodsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetContactMethods", params, optFns, addOperationGetContactMethodsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetContactMethodsMiddleware(stack *middleware.Stack, options Options) (err error) {
