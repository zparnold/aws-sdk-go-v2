...
func (c *Client) DetachCertificateFromDistribution(ctx context.Context, params *DetachCertificateFromDistributionInput, optFns ...func(*Options)) (*DetachCertificateFromDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachCertificateFromDistribution", params, optFns, addOperationDetachCertificateFromDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachCertificateFromDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
