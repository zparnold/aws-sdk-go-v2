...
func (c *Client) AttachInstancesToLoadBalancer(ctx context.Context, params *AttachInstancesToLoadBalancerInput, optFns ...func(*Options)) (*AttachInstancesToLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachInstancesToLoadBalancer", params, optFns, addOperationAttachInstancesToLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachInstancesToLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
