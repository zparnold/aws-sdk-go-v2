...
func (c *Client) GetStaticIps(ctx context.Context, params *GetStaticIpsInput, optFns ...func(*Options)) (*GetStaticIpsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStaticIps", params, optFns, addOperationGetStaticIpsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStaticIpsMiddleware(stack *middleware.Stack, options Options) (err error) {
