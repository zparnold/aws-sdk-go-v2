...
func (c *Client) IsVpcPeered(ctx context.Context, params *IsVpcPeeredInput, optFns ...func(*Options)) (*IsVpcPeeredOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IsVpcPeered", params, optFns, addOperationIsVpcPeeredMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIsVpcPeeredMiddleware(stack *middleware.Stack, options Options) (err error) {
