...
func (c *Client) GetCloudFormationStackRecords(ctx context.Context, params *GetCloudFormationStackRecordsInput, optFns ...func(*Options)) (*GetCloudFormationStackRecordsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCloudFormationStackRecords", params, optFns, addOperationGetCloudFormationStackRecordsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCloudFormationStackRecordsMiddleware(stack *middleware.Stack, options Options) (err error) {
