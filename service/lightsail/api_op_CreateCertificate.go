...
func (c *Client) CreateCertificate(ctx context.Context, params *CreateCertificateInput, optFns ...func(*Options)) (*CreateCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCertificate", params, optFns, addOperationCreateCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
