...
func (c *Client) GetBlueprints(ctx context.Context, params *GetBlueprintsInput, optFns ...func(*Options)) (*GetBlueprintsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBlueprints", params, optFns, addOperationGetBlueprintsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBlueprintsMiddleware(stack *middleware.Stack, options Options) (err error) {
