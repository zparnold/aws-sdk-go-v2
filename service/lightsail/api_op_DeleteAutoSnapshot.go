...
func (c *Client) DeleteAutoSnapshot(ctx context.Context, params *DeleteAutoSnapshotInput, optFns ...func(*Options)) (*DeleteAutoSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAutoSnapshot", params, optFns, addOperationDeleteAutoSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAutoSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
