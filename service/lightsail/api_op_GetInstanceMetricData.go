...
func (c *Client) GetInstanceMetricData(ctx context.Context, params *GetInstanceMetricDataInput, optFns ...func(*Options)) (*GetInstanceMetricDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInstanceMetricData", params, optFns, addOperationGetInstanceMetricDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInstanceMetricDataMiddleware(stack *middleware.Stack, options Options) (err error) {
