...
func (c *Client) GetDomains(ctx context.Context, params *GetDomainsInput, optFns ...func(*Options)) (*GetDomainsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomains", params, optFns, addOperationGetDomainsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainsMiddleware(stack *middleware.Stack, options Options) (err error) {
