...
func (c *Client) CreateDiskSnapshot(ctx context.Context, params *CreateDiskSnapshotInput, optFns ...func(*Options)) (*CreateDiskSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDiskSnapshot", params, optFns, addOperationCreateDiskSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDiskSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
