...
func (c *Client) DetachInstancesFromLoadBalancer(ctx context.Context, params *DetachInstancesFromLoadBalancerInput, optFns ...func(*Options)) (*DetachInstancesFromLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachInstancesFromLoadBalancer", params, optFns, addOperationDetachInstancesFromLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachInstancesFromLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
