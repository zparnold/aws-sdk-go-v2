...
func (c *Client) UpdateRelationalDatabase(ctx context.Context, params *UpdateRelationalDatabaseInput, optFns ...func(*Options)) (*UpdateRelationalDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRelationalDatabase", params, optFns, addOperationUpdateRelationalDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRelationalDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
