...
func (c *Client) CreateLoadBalancerTlsCertificate(ctx context.Context, params *CreateLoadBalancerTlsCertificateInput, optFns ...func(*Options)) (*CreateLoadBalancerTlsCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLoadBalancerTlsCertificate", params, optFns, addOperationCreateLoadBalancerTlsCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLoadBalancerTlsCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
