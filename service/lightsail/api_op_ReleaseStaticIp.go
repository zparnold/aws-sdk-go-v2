...
func (c *Client) ReleaseStaticIp(ctx context.Context, params *ReleaseStaticIpInput, optFns ...func(*Options)) (*ReleaseStaticIpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReleaseStaticIp", params, optFns, addOperationReleaseStaticIpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReleaseStaticIpMiddleware(stack *middleware.Stack, options Options) (err error) {
