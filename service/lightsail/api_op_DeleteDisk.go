...
func (c *Client) DeleteDisk(ctx context.Context, params *DeleteDiskInput, optFns ...func(*Options)) (*DeleteDiskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDisk", params, optFns, addOperationDeleteDiskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDiskMiddleware(stack *middleware.Stack, options Options) (err error) {
