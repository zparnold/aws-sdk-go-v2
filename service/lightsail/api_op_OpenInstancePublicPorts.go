...
func (c *Client) OpenInstancePublicPorts(ctx context.Context, params *OpenInstancePublicPortsInput, optFns ...func(*Options)) (*OpenInstancePublicPortsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "OpenInstancePublicPorts", params, optFns, addOperationOpenInstancePublicPortsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationOpenInstancePublicPortsMiddleware(stack *middleware.Stack, options Options) (err error) {
