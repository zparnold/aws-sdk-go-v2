...
func (c *Client) DeleteDomainEntry(ctx context.Context, params *DeleteDomainEntryInput, optFns ...func(*Options)) (*DeleteDomainEntryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDomainEntry", params, optFns, addOperationDeleteDomainEntryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDomainEntryMiddleware(stack *middleware.Stack, options Options) (err error) {
