...
func (c *Client) UpdateLoadBalancerAttribute(ctx context.Context, params *UpdateLoadBalancerAttributeInput, optFns ...func(*Options)) (*UpdateLoadBalancerAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLoadBalancerAttribute", params, optFns, addOperationUpdateLoadBalancerAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLoadBalancerAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
