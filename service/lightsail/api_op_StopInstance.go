...
func (c *Client) StopInstance(ctx context.Context, params *StopInstanceInput, optFns ...func(*Options)) (*StopInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopInstance", params, optFns, addOperationStopInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
