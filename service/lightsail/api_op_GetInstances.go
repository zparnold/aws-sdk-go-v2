...
func (c *Client) GetInstances(ctx context.Context, params *GetInstancesInput, optFns ...func(*Options)) (*GetInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInstances", params, optFns, addOperationGetInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
