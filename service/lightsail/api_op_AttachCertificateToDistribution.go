...
func (c *Client) AttachCertificateToDistribution(ctx context.Context, params *AttachCertificateToDistributionInput, optFns ...func(*Options)) (*AttachCertificateToDistributionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachCertificateToDistribution", params, optFns, addOperationAttachCertificateToDistributionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachCertificateToDistributionMiddleware(stack *middleware.Stack, options Options) (err error) {
