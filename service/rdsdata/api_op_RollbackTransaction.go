...
func (c *Client) RollbackTransaction(ctx context.Context, params *RollbackTransactionInput, optFns ...func(*Options)) (*RollbackTransactionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RollbackTransaction", params, optFns, addOperationRollbackTransactionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRollbackTransactionMiddleware(stack *middleware.Stack, options Options) (err error) {
