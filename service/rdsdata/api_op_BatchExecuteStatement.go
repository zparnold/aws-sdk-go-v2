...
func (c *Client) BatchExecuteStatement(ctx context.Context, params *BatchExecuteStatementInput, optFns ...func(*Options)) (*BatchExecuteStatementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchExecuteStatement", params, optFns, addOperationBatchExecuteStatementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchExecuteStatementMiddleware(stack *middleware.Stack, options Options) (err error) {
