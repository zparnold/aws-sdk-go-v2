...
func (c *Client) CommitTransaction(ctx context.Context, params *CommitTransactionInput, optFns ...func(*Options)) (*CommitTransactionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CommitTransaction", params, optFns, addOperationCommitTransactionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCommitTransactionMiddleware(stack *middleware.Stack, options Options) (err error) {
