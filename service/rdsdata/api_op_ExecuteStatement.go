...
func (c *Client) ExecuteStatement(ctx context.Context, params *ExecuteStatementInput, optFns ...func(*Options)) (*ExecuteStatementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExecuteStatement", params, optFns, addOperationExecuteStatementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExecuteStatementMiddleware(stack *middleware.Stack, options Options) (err error) {
