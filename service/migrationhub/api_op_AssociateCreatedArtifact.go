...
func (c *Client) AssociateCreatedArtifact(ctx context.Context, params *AssociateCreatedArtifactInput, optFns ...func(*Options)) (*AssociateCreatedArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateCreatedArtifact", params, optFns, addOperationAssociateCreatedArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateCreatedArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
