...
func (c *Client) CreateProgressUpdateStream(ctx context.Context, params *CreateProgressUpdateStreamInput, optFns ...func(*Options)) (*CreateProgressUpdateStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProgressUpdateStream", params, optFns, addOperationCreateProgressUpdateStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProgressUpdateStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
