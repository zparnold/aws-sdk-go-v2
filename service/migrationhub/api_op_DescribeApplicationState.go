...
func (c *Client) DescribeApplicationState(ctx context.Context, params *DescribeApplicationStateInput, optFns ...func(*Options)) (*DescribeApplicationStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeApplicationState", params, optFns, addOperationDescribeApplicationStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeApplicationStateMiddleware(stack *middleware.Stack, options Options) (err error) {
