...
func (c *Client) ImportMigrationTask(ctx context.Context, params *ImportMigrationTaskInput, optFns ...func(*Options)) (*ImportMigrationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportMigrationTask", params, optFns, addOperationImportMigrationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportMigrationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
