...
func (c *Client) DescribeMigrationTask(ctx context.Context, params *DescribeMigrationTaskInput, optFns ...func(*Options)) (*DescribeMigrationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMigrationTask", params, optFns, addOperationDescribeMigrationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMigrationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
