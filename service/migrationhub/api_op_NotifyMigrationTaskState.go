...
func (c *Client) NotifyMigrationTaskState(ctx context.Context, params *NotifyMigrationTaskStateInput, optFns ...func(*Options)) (*NotifyMigrationTaskStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NotifyMigrationTaskState", params, optFns, addOperationNotifyMigrationTaskStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNotifyMigrationTaskStateMiddleware(stack *middleware.Stack, options Options) (err error) {
