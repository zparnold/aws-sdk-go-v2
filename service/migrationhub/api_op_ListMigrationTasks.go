...
func (c *Client) ListMigrationTasks(ctx context.Context, params *ListMigrationTasksInput, optFns ...func(*Options)) (*ListMigrationTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMigrationTasks", params, optFns, addOperationListMigrationTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMigrationTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
