...
func (c *Client) DeleteProgressUpdateStream(ctx context.Context, params *DeleteProgressUpdateStreamInput, optFns ...func(*Options)) (*DeleteProgressUpdateStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProgressUpdateStream", params, optFns, addOperationDeleteProgressUpdateStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProgressUpdateStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
