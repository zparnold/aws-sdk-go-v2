...
func (c *Client) ListDiscoveredResources(ctx context.Context, params *ListDiscoveredResourcesInput, optFns ...func(*Options)) (*ListDiscoveredResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDiscoveredResources", params, optFns, addOperationListDiscoveredResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDiscoveredResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
