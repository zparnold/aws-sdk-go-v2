...
func (c *Client) ListApplicationStates(ctx context.Context, params *ListApplicationStatesInput, optFns ...func(*Options)) (*ListApplicationStatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListApplicationStates", params, optFns, addOperationListApplicationStatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListApplicationStatesMiddleware(stack *middleware.Stack, options Options) (err error) {
