...
func (c *Client) AssociateDiscoveredResource(ctx context.Context, params *AssociateDiscoveredResourceInput, optFns ...func(*Options)) (*AssociateDiscoveredResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateDiscoveredResource", params, optFns, addOperationAssociateDiscoveredResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateDiscoveredResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
