...
func (c *Client) PutResourceAttributes(ctx context.Context, params *PutResourceAttributesInput, optFns ...func(*Options)) (*PutResourceAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutResourceAttributes", params, optFns, addOperationPutResourceAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutResourceAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
