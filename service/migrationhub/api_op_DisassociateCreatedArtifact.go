...
func (c *Client) DisassociateCreatedArtifact(ctx context.Context, params *DisassociateCreatedArtifactInput, optFns ...func(*Options)) (*DisassociateCreatedArtifactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateCreatedArtifact", params, optFns, addOperationDisassociateCreatedArtifactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateCreatedArtifactMiddleware(stack *middleware.Stack, options Options) (err error) {
