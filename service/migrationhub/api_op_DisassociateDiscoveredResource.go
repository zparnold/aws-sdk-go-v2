...
func (c *Client) DisassociateDiscoveredResource(ctx context.Context, params *DisassociateDiscoveredResourceInput, optFns ...func(*Options)) (*DisassociateDiscoveredResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateDiscoveredResource", params, optFns, addOperationDisassociateDiscoveredResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateDiscoveredResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
