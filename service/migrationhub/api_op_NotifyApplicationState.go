...
func (c *Client) NotifyApplicationState(ctx context.Context, params *NotifyApplicationStateInput, optFns ...func(*Options)) (*NotifyApplicationStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NotifyApplicationState", params, optFns, addOperationNotifyApplicationStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNotifyApplicationStateMiddleware(stack *middleware.Stack, options Options) (err error) {
