...
func (c *Client) ListCreatedArtifacts(ctx context.Context, params *ListCreatedArtifactsInput, optFns ...func(*Options)) (*ListCreatedArtifactsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCreatedArtifacts", params, optFns, addOperationListCreatedArtifactsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCreatedArtifactsMiddleware(stack *middleware.Stack, options Options) (err error) {
