...
func (c *Client) ListProgressUpdateStreams(ctx context.Context, params *ListProgressUpdateStreamsInput, optFns ...func(*Options)) (*ListProgressUpdateStreamsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProgressUpdateStreams", params, optFns, addOperationListProgressUpdateStreamsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProgressUpdateStreamsMiddleware(stack *middleware.Stack, options Options) (err error) {
