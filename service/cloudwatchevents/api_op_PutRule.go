...
func (c *Client) PutRule(ctx context.Context, params *PutRuleInput, optFns ...func(*Options)) (*PutRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRule", params, optFns, addOperationPutRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
