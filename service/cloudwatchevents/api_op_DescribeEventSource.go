...
func (c *Client) DescribeEventSource(ctx context.Context, params *DescribeEventSourceInput, optFns ...func(*Options)) (*DescribeEventSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventSource", params, optFns, addOperationDescribeEventSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
