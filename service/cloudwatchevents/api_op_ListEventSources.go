...
func (c *Client) ListEventSources(ctx context.Context, params *ListEventSourcesInput, optFns ...func(*Options)) (*ListEventSourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEventSources", params, optFns, addOperationListEventSourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEventSourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
