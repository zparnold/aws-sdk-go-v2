...
func (c *Client) ListTargetsByRule(ctx context.Context, params *ListTargetsByRuleInput, optFns ...func(*Options)) (*ListTargetsByRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTargetsByRule", params, optFns, addOperationListTargetsByRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTargetsByRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
