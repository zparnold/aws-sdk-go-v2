...
func (c *Client) ListPartnerEventSources(ctx context.Context, params *ListPartnerEventSourcesInput, optFns ...func(*Options)) (*ListPartnerEventSourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPartnerEventSources", params, optFns, addOperationListPartnerEventSourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPartnerEventSourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
