...
func (c *Client) RemoveTargets(ctx context.Context, params *RemoveTargetsInput, optFns ...func(*Options)) (*RemoveTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveTargets", params, optFns, addOperationRemoveTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
