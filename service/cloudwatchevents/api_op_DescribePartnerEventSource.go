...
func (c *Client) DescribePartnerEventSource(ctx context.Context, params *DescribePartnerEventSourceInput, optFns ...func(*Options)) (*DescribePartnerEventSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePartnerEventSource", params, optFns, addOperationDescribePartnerEventSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePartnerEventSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
