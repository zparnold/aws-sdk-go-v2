...
func (c *Client) PutTargets(ctx context.Context, params *PutTargetsInput, optFns ...func(*Options)) (*PutTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutTargets", params, optFns, addOperationPutTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
