...
func (c *Client) DescribeRule(ctx context.Context, params *DescribeRuleInput, optFns ...func(*Options)) (*DescribeRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRule", params, optFns, addOperationDescribeRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
