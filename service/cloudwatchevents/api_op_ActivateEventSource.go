...
func (c *Client) ActivateEventSource(ctx context.Context, params *ActivateEventSourceInput, optFns ...func(*Options)) (*ActivateEventSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ActivateEventSource", params, optFns, addOperationActivateEventSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationActivateEventSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
