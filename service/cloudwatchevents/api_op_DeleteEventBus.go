...
func (c *Client) DeleteEventBus(ctx context.Context, params *DeleteEventBusInput, optFns ...func(*Options)) (*DeleteEventBusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEventBus", params, optFns, addOperationDeleteEventBusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEventBusMiddleware(stack *middleware.Stack, options Options) (err error) {
