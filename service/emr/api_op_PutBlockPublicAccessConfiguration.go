...
func (c *Client) PutBlockPublicAccessConfiguration(ctx context.Context, params *PutBlockPublicAccessConfigurationInput, optFns ...func(*Options)) (*PutBlockPublicAccessConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBlockPublicAccessConfiguration", params, optFns, addOperationPutBlockPublicAccessConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBlockPublicAccessConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
