...
func (c *Client) ListInstanceFleets(ctx context.Context, params *ListInstanceFleetsInput, optFns ...func(*Options)) (*ListInstanceFleetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInstanceFleets", params, optFns, addOperationListInstanceFleetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInstanceFleetsMiddleware(stack *middleware.Stack, options Options) (err error) {
