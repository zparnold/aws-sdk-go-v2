...
func (c *Client) ListBootstrapActions(ctx context.Context, params *ListBootstrapActionsInput, optFns ...func(*Options)) (*ListBootstrapActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBootstrapActions", params, optFns, addOperationListBootstrapActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBootstrapActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
