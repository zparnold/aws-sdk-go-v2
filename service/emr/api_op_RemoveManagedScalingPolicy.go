...
func (c *Client) RemoveManagedScalingPolicy(ctx context.Context, params *RemoveManagedScalingPolicyInput, optFns ...func(*Options)) (*RemoveManagedScalingPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveManagedScalingPolicy", params, optFns, addOperationRemoveManagedScalingPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveManagedScalingPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
