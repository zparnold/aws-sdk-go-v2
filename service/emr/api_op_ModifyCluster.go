...
func (c *Client) ModifyCluster(ctx context.Context, params *ModifyClusterInput, optFns ...func(*Options)) (*ModifyClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyCluster", params, optFns, addOperationModifyClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
