...
func (c *Client) ListInstanceGroups(ctx context.Context, params *ListInstanceGroupsInput, optFns ...func(*Options)) (*ListInstanceGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInstanceGroups", params, optFns, addOperationListInstanceGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInstanceGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
