...
func (c *Client) AddInstanceGroups(ctx context.Context, params *AddInstanceGroupsInput, optFns ...func(*Options)) (*AddInstanceGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddInstanceGroups", params, optFns, addOperationAddInstanceGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddInstanceGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
