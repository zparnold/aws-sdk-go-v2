...
func (c *Client) SetVisibleToAllUsers(ctx context.Context, params *SetVisibleToAllUsersInput, optFns ...func(*Options)) (*SetVisibleToAllUsersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetVisibleToAllUsers", params, optFns, addOperationSetVisibleToAllUsersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetVisibleToAllUsersMiddleware(stack *middleware.Stack, options Options) (err error) {
