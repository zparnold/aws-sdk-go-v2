...
func (c *Client) ListSecurityConfigurations(ctx context.Context, params *ListSecurityConfigurationsInput, optFns ...func(*Options)) (*ListSecurityConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSecurityConfigurations", params, optFns, addOperationListSecurityConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSecurityConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
