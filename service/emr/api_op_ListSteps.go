...
func (c *Client) ListSteps(ctx context.Context, params *ListStepsInput, optFns ...func(*Options)) (*ListStepsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSteps", params, optFns, addOperationListStepsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStepsMiddleware(stack *middleware.Stack, options Options) (err error) {
