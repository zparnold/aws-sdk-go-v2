...
func (c *Client) SetTerminationProtection(ctx context.Context, params *SetTerminationProtectionInput, optFns ...func(*Options)) (*SetTerminationProtectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetTerminationProtection", params, optFns, addOperationSetTerminationProtectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetTerminationProtectionMiddleware(stack *middleware.Stack, options Options) (err error) {
