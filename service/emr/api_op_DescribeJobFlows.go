...
func (c *Client) DescribeJobFlows(ctx context.Context, params *DescribeJobFlowsInput, optFns ...func(*Options)) (*DescribeJobFlowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeJobFlows", params, optFns, addOperationDescribeJobFlowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeJobFlowsMiddleware(stack *middleware.Stack, options Options) (err error) {
