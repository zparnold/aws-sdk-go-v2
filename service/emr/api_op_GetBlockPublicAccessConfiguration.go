...
func (c *Client) GetBlockPublicAccessConfiguration(ctx context.Context, params *GetBlockPublicAccessConfigurationInput, optFns ...func(*Options)) (*GetBlockPublicAccessConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBlockPublicAccessConfiguration", params, optFns, addOperationGetBlockPublicAccessConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBlockPublicAccessConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
