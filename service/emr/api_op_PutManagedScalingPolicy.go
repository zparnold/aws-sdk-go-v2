...
func (c *Client) PutManagedScalingPolicy(ctx context.Context, params *PutManagedScalingPolicyInput, optFns ...func(*Options)) (*PutManagedScalingPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutManagedScalingPolicy", params, optFns, addOperationPutManagedScalingPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutManagedScalingPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
