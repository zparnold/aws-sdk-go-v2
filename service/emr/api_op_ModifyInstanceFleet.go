...
func (c *Client) ModifyInstanceFleet(ctx context.Context, params *ModifyInstanceFleetInput, optFns ...func(*Options)) (*ModifyInstanceFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyInstanceFleet", params, optFns, addOperationModifyInstanceFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyInstanceFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
