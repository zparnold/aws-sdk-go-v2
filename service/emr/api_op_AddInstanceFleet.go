...
func (c *Client) AddInstanceFleet(ctx context.Context, params *AddInstanceFleetInput, optFns ...func(*Options)) (*AddInstanceFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddInstanceFleet", params, optFns, addOperationAddInstanceFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddInstanceFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
