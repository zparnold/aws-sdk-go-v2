...
func (c *Client) DescribeSecurityConfiguration(ctx context.Context, params *DescribeSecurityConfigurationInput, optFns ...func(*Options)) (*DescribeSecurityConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSecurityConfiguration", params, optFns, addOperationDescribeSecurityConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSecurityConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
