...
func (c *Client) RemoveAutoScalingPolicy(ctx context.Context, params *RemoveAutoScalingPolicyInput, optFns ...func(*Options)) (*RemoveAutoScalingPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveAutoScalingPolicy", params, optFns, addOperationRemoveAutoScalingPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveAutoScalingPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
