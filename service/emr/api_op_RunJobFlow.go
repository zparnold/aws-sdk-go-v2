...
func (c *Client) RunJobFlow(ctx context.Context, params *RunJobFlowInput, optFns ...func(*Options)) (*RunJobFlowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RunJobFlow", params, optFns, addOperationRunJobFlowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRunJobFlowMiddleware(stack *middleware.Stack, options Options) (err error) {
