...
func (c *Client) AddJobFlowSteps(ctx context.Context, params *AddJobFlowStepsInput, optFns ...func(*Options)) (*AddJobFlowStepsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddJobFlowSteps", params, optFns, addOperationAddJobFlowStepsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddJobFlowStepsMiddleware(stack *middleware.Stack, options Options) (err error) {
