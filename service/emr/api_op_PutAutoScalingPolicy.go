...
func (c *Client) PutAutoScalingPolicy(ctx context.Context, params *PutAutoScalingPolicyInput, optFns ...func(*Options)) (*PutAutoScalingPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAutoScalingPolicy", params, optFns, addOperationPutAutoScalingPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAutoScalingPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
