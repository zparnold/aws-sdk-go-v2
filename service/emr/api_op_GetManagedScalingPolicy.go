...
func (c *Client) GetManagedScalingPolicy(ctx context.Context, params *GetManagedScalingPolicyInput, optFns ...func(*Options)) (*GetManagedScalingPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetManagedScalingPolicy", params, optFns, addOperationGetManagedScalingPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetManagedScalingPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
