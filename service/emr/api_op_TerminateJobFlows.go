...
func (c *Client) TerminateJobFlows(ctx context.Context, params *TerminateJobFlowsInput, optFns ...func(*Options)) (*TerminateJobFlowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateJobFlows", params, optFns, addOperationTerminateJobFlowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateJobFlowsMiddleware(stack *middleware.Stack, options Options) (err error) {
