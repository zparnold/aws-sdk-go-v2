...
func (c *Client) AssociateRepository(ctx context.Context, params *AssociateRepositoryInput, optFns ...func(*Options)) (*AssociateRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateRepository", params, optFns, addOperationAssociateRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
