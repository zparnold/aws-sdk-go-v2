...
func (c *Client) DescribeRecommendationFeedback(ctx context.Context, params *DescribeRecommendationFeedbackInput, optFns ...func(*Options)) (*DescribeRecommendationFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRecommendationFeedback", params, optFns, addOperationDescribeRecommendationFeedbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRecommendationFeedbackMiddleware(stack *middleware.Stack, options Options) (err error) {
