...
func (c *Client) DescribeCodeReview(ctx context.Context, params *DescribeCodeReviewInput, optFns ...func(*Options)) (*DescribeCodeReviewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCodeReview", params, optFns, addOperationDescribeCodeReviewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCodeReviewMiddleware(stack *middleware.Stack, options Options) (err error) {
