...
func (c *Client) ListRecommendationFeedback(ctx context.Context, params *ListRecommendationFeedbackInput, optFns ...func(*Options)) (*ListRecommendationFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRecommendationFeedback", params, optFns, addOperationListRecommendationFeedbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRecommendationFeedbackMiddleware(stack *middleware.Stack, options Options) (err error) {
