...
func (c *Client) PutRecommendationFeedback(ctx context.Context, params *PutRecommendationFeedbackInput, optFns ...func(*Options)) (*PutRecommendationFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRecommendationFeedback", params, optFns, addOperationPutRecommendationFeedbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRecommendationFeedbackMiddleware(stack *middleware.Stack, options Options) (err error) {
