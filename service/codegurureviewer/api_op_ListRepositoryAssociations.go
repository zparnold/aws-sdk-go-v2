...
func (c *Client) ListRepositoryAssociations(ctx context.Context, params *ListRepositoryAssociationsInput, optFns ...func(*Options)) (*ListRepositoryAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRepositoryAssociations", params, optFns, addOperationListRepositoryAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRepositoryAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
