...
func (c *Client) ListRecommendations(ctx context.Context, params *ListRecommendationsInput, optFns ...func(*Options)) (*ListRecommendationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRecommendations", params, optFns, addOperationListRecommendationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRecommendationsMiddleware(stack *middleware.Stack, options Options) (err error) {
