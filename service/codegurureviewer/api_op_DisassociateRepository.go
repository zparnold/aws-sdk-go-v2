...
func (c *Client) DisassociateRepository(ctx context.Context, params *DisassociateRepositoryInput, optFns ...func(*Options)) (*DisassociateRepositoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateRepository", params, optFns, addOperationDisassociateRepositoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateRepositoryMiddleware(stack *middleware.Stack, options Options) (err error) {
