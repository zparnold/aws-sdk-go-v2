...
func (c *Client) DescribeRepositoryAssociation(ctx context.Context, params *DescribeRepositoryAssociationInput, optFns ...func(*Options)) (*DescribeRepositoryAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRepositoryAssociation", params, optFns, addOperationDescribeRepositoryAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRepositoryAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
