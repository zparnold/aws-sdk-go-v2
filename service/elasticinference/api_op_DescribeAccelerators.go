...
func (c *Client) DescribeAccelerators(ctx context.Context, params *DescribeAcceleratorsInput, optFns ...func(*Options)) (*DescribeAcceleratorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccelerators", params, optFns, addOperationDescribeAcceleratorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAcceleratorsMiddleware(stack *middleware.Stack, options Options) (err error) {
