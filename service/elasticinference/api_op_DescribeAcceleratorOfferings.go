...
func (c *Client) DescribeAcceleratorOfferings(ctx context.Context, params *DescribeAcceleratorOfferingsInput, optFns ...func(*Options)) (*DescribeAcceleratorOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAcceleratorOfferings", params, optFns, addOperationDescribeAcceleratorOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAcceleratorOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
