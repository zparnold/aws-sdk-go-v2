...
func (c *Client) DescribeAcceleratorTypes(ctx context.Context, params *DescribeAcceleratorTypesInput, optFns ...func(*Options)) (*DescribeAcceleratorTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAcceleratorTypes", params, optFns, addOperationDescribeAcceleratorTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAcceleratorTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
