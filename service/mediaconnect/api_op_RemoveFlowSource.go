...
func (c *Client) RemoveFlowSource(ctx context.Context, params *RemoveFlowSourceInput, optFns ...func(*Options)) (*RemoveFlowSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveFlowSource", params, optFns, addOperationRemoveFlowSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveFlowSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
