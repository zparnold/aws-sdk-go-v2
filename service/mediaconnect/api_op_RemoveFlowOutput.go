...
func (c *Client) RemoveFlowOutput(ctx context.Context, params *RemoveFlowOutputInput, optFns ...func(*Options)) (*RemoveFlowOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveFlowOutput", params, optFns, addOperationRemoveFlowOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveFlowOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
