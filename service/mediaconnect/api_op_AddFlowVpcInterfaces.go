...
func (c *Client) AddFlowVpcInterfaces(ctx context.Context, params *AddFlowVpcInterfacesInput, optFns ...func(*Options)) (*AddFlowVpcInterfacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddFlowVpcInterfaces", params, optFns, addOperationAddFlowVpcInterfacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddFlowVpcInterfacesMiddleware(stack *middleware.Stack, options Options) (err error) {
