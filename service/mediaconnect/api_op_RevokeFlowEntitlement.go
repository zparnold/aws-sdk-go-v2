...
func (c *Client) RevokeFlowEntitlement(ctx context.Context, params *RevokeFlowEntitlementInput, optFns ...func(*Options)) (*RevokeFlowEntitlementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeFlowEntitlement", params, optFns, addOperationRevokeFlowEntitlementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeFlowEntitlementMiddleware(stack *middleware.Stack, options Options) (err error) {
