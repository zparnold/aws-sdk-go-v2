...
func (c *Client) AddFlowSources(ctx context.Context, params *AddFlowSourcesInput, optFns ...func(*Options)) (*AddFlowSourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddFlowSources", params, optFns, addOperationAddFlowSourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddFlowSourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
