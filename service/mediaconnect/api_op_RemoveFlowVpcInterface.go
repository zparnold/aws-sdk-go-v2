...
func (c *Client) RemoveFlowVpcInterface(ctx context.Context, params *RemoveFlowVpcInterfaceInput, optFns ...func(*Options)) (*RemoveFlowVpcInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveFlowVpcInterface", params, optFns, addOperationRemoveFlowVpcInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveFlowVpcInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
