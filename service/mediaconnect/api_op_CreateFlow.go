...
func (c *Client) CreateFlow(ctx context.Context, params *CreateFlowInput, optFns ...func(*Options)) (*CreateFlowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFlow", params, optFns, addOperationCreateFlowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFlowMiddleware(stack *middleware.Stack, options Options) (err error) {
