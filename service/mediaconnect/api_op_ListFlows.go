...
func (c *Client) ListFlows(ctx context.Context, params *ListFlowsInput, optFns ...func(*Options)) (*ListFlowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFlows", params, optFns, addOperationListFlowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFlowsMiddleware(stack *middleware.Stack, options Options) (err error) {
