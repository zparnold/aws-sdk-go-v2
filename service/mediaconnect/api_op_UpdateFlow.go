...
func (c *Client) UpdateFlow(ctx context.Context, params *UpdateFlowInput, optFns ...func(*Options)) (*UpdateFlowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFlow", params, optFns, addOperationUpdateFlowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFlowMiddleware(stack *middleware.Stack, options Options) (err error) {
