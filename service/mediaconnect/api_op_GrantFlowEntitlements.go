...
func (c *Client) GrantFlowEntitlements(ctx context.Context, params *GrantFlowEntitlementsInput, optFns ...func(*Options)) (*GrantFlowEntitlementsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GrantFlowEntitlements", params, optFns, addOperationGrantFlowEntitlementsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGrantFlowEntitlementsMiddleware(stack *middleware.Stack, options Options) (err error) {
