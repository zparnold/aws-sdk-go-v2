...
func (c *Client) AddFlowOutputs(ctx context.Context, params *AddFlowOutputsInput, optFns ...func(*Options)) (*AddFlowOutputsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddFlowOutputs", params, optFns, addOperationAddFlowOutputsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddFlowOutputsMiddleware(stack *middleware.Stack, options Options) (err error) {
