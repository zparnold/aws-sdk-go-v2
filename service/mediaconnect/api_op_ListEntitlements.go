...
func (c *Client) ListEntitlements(ctx context.Context, params *ListEntitlementsInput, optFns ...func(*Options)) (*ListEntitlementsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEntitlements", params, optFns, addOperationListEntitlementsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEntitlementsMiddleware(stack *middleware.Stack, options Options) (err error) {
