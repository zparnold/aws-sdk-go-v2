...
func (c *Client) DescribeFlow(ctx context.Context, params *DescribeFlowInput, optFns ...func(*Options)) (*DescribeFlowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFlow", params, optFns, addOperationDescribeFlowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFlowMiddleware(stack *middleware.Stack, options Options) (err error) {
