...
func (c *Client) UpdateFlowSource(ctx context.Context, params *UpdateFlowSourceInput, optFns ...func(*Options)) (*UpdateFlowSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFlowSource", params, optFns, addOperationUpdateFlowSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFlowSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
