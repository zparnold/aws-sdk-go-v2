...
func (c *Client) UpdateFlowEntitlement(ctx context.Context, params *UpdateFlowEntitlementInput, optFns ...func(*Options)) (*UpdateFlowEntitlementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFlowEntitlement", params, optFns, addOperationUpdateFlowEntitlementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFlowEntitlementMiddleware(stack *middleware.Stack, options Options) (err error) {
