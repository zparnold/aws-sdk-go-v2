...
func (c *Client) StartFlow(ctx context.Context, params *StartFlowInput, optFns ...func(*Options)) (*StartFlowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartFlow", params, optFns, addOperationStartFlowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartFlowMiddleware(stack *middleware.Stack, options Options) (err error) {
