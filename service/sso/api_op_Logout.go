...
func (c *Client) Logout(ctx context.Context, params *LogoutInput, optFns ...func(*Options)) (*LogoutOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Logout", params, optFns, addOperationLogoutMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLogoutMiddleware(stack *middleware.Stack, options Options) (err error) {
