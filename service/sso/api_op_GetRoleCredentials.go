...
func (c *Client) GetRoleCredentials(ctx context.Context, params *GetRoleCredentialsInput, optFns ...func(*Options)) (*GetRoleCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRoleCredentials", params, optFns, addOperationGetRoleCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRoleCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
