...
func (c *Client) ListAccountRoles(ctx context.Context, params *ListAccountRolesInput, optFns ...func(*Options)) (*ListAccountRolesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccountRoles", params, optFns, addOperationListAccountRolesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAccountRolesMiddleware(stack *middleware.Stack, options Options) (err error) {
