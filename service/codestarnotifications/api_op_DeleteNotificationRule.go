...
func (c *Client) DeleteNotificationRule(ctx context.Context, params *DeleteNotificationRuleInput, optFns ...func(*Options)) (*DeleteNotificationRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNotificationRule", params, optFns, addOperationDeleteNotificationRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNotificationRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
