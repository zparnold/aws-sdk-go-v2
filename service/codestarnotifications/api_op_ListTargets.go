...
func (c *Client) ListTargets(ctx context.Context, params *ListTargetsInput, optFns ...func(*Options)) (*ListTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTargets", params, optFns, addOperationListTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
