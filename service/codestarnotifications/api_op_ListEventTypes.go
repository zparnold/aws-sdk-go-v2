...
func (c *Client) ListEventTypes(ctx context.Context, params *ListEventTypesInput, optFns ...func(*Options)) (*ListEventTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEventTypes", params, optFns, addOperationListEventTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEventTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
