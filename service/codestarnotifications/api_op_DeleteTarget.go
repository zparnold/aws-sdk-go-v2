...
func (c *Client) DeleteTarget(ctx context.Context, params *DeleteTargetInput, optFns ...func(*Options)) (*DeleteTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTarget", params, optFns, addOperationDeleteTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
