...
func (c *Client) ListNotificationRules(ctx context.Context, params *ListNotificationRulesInput, optFns ...func(*Options)) (*ListNotificationRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNotificationRules", params, optFns, addOperationListNotificationRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNotificationRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
