...
func (c *Client) DescribeNotificationRule(ctx context.Context, params *DescribeNotificationRuleInput, optFns ...func(*Options)) (*DescribeNotificationRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNotificationRule", params, optFns, addOperationDescribeNotificationRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNotificationRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
