...
func (c *Client) UpdateNotificationRule(ctx context.Context, params *UpdateNotificationRuleInput, optFns ...func(*Options)) (*UpdateNotificationRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNotificationRule", params, optFns, addOperationUpdateNotificationRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNotificationRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
