...
func (c *Client) CreateNotificationRule(ctx context.Context, params *CreateNotificationRuleInput, optFns ...func(*Options)) (*CreateNotificationRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNotificationRule", params, optFns, addOperationCreateNotificationRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNotificationRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
