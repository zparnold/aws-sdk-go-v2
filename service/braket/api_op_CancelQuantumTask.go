...
func (c *Client) CancelQuantumTask(ctx context.Context, params *CancelQuantumTaskInput, optFns ...func(*Options)) (*CancelQuantumTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelQuantumTask", params, optFns, addOperationCancelQuantumTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelQuantumTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
