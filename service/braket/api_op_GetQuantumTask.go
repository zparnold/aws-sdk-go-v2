...
func (c *Client) GetQuantumTask(ctx context.Context, params *GetQuantumTaskInput, optFns ...func(*Options)) (*GetQuantumTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQuantumTask", params, optFns, addOperationGetQuantumTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQuantumTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
