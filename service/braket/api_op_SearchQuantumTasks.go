...
func (c *Client) SearchQuantumTasks(ctx context.Context, params *SearchQuantumTasksInput, optFns ...func(*Options)) (*SearchQuantumTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchQuantumTasks", params, optFns, addOperationSearchQuantumTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchQuantumTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
