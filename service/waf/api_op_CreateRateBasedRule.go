...
func (c *Client) CreateRateBasedRule(ctx context.Context, params *CreateRateBasedRuleInput, optFns ...func(*Options)) (*CreateRateBasedRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRateBasedRule", params, optFns, addOperationCreateRateBasedRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRateBasedRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
