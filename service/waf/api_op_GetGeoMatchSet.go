...
func (c *Client) GetGeoMatchSet(ctx context.Context, params *GetGeoMatchSetInput, optFns ...func(*Options)) (*GetGeoMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGeoMatchSet", params, optFns, addOperationGetGeoMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGeoMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
