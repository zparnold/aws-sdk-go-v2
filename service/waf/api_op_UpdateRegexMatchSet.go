...
func (c *Client) UpdateRegexMatchSet(ctx context.Context, params *UpdateRegexMatchSetInput, optFns ...func(*Options)) (*UpdateRegexMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRegexMatchSet", params, optFns, addOperationUpdateRegexMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRegexMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
