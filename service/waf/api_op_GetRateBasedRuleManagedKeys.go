...
func (c *Client) GetRateBasedRuleManagedKeys(ctx context.Context, params *GetRateBasedRuleManagedKeysInput, optFns ...func(*Options)) (*GetRateBasedRuleManagedKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRateBasedRuleManagedKeys", params, optFns, addOperationGetRateBasedRuleManagedKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRateBasedRuleManagedKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
