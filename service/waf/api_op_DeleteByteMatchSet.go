...
func (c *Client) DeleteByteMatchSet(ctx context.Context, params *DeleteByteMatchSetInput, optFns ...func(*Options)) (*DeleteByteMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteByteMatchSet", params, optFns, addOperationDeleteByteMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteByteMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
