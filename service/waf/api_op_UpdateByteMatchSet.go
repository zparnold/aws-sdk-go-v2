...
func (c *Client) UpdateByteMatchSet(ctx context.Context, params *UpdateByteMatchSetInput, optFns ...func(*Options)) (*UpdateByteMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateByteMatchSet", params, optFns, addOperationUpdateByteMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateByteMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
