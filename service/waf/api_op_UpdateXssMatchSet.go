...
func (c *Client) UpdateXssMatchSet(ctx context.Context, params *UpdateXssMatchSetInput, optFns ...func(*Options)) (*UpdateXssMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateXssMatchSet", params, optFns, addOperationUpdateXssMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateXssMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
