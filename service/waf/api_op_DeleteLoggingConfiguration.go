...
func (c *Client) DeleteLoggingConfiguration(ctx context.Context, params *DeleteLoggingConfigurationInput, optFns ...func(*Options)) (*DeleteLoggingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLoggingConfiguration", params, optFns, addOperationDeleteLoggingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLoggingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
