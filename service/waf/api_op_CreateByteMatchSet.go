...
func (c *Client) CreateByteMatchSet(ctx context.Context, params *CreateByteMatchSetInput, optFns ...func(*Options)) (*CreateByteMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateByteMatchSet", params, optFns, addOperationCreateByteMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateByteMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
