...
func (c *Client) DeleteGeoMatchSet(ctx context.Context, params *DeleteGeoMatchSetInput, optFns ...func(*Options)) (*DeleteGeoMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGeoMatchSet", params, optFns, addOperationDeleteGeoMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGeoMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
