...
func (c *Client) ListSizeConstraintSets(ctx context.Context, params *ListSizeConstraintSetsInput, optFns ...func(*Options)) (*ListSizeConstraintSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSizeConstraintSets", params, optFns, addOperationListSizeConstraintSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSizeConstraintSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
