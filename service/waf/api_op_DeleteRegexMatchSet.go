...
func (c *Client) DeleteRegexMatchSet(ctx context.Context, params *DeleteRegexMatchSetInput, optFns ...func(*Options)) (*DeleteRegexMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRegexMatchSet", params, optFns, addOperationDeleteRegexMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRegexMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
