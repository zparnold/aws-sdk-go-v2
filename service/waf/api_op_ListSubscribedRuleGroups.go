...
func (c *Client) ListSubscribedRuleGroups(ctx context.Context, params *ListSubscribedRuleGroupsInput, optFns ...func(*Options)) (*ListSubscribedRuleGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSubscribedRuleGroups", params, optFns, addOperationListSubscribedRuleGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSubscribedRuleGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
