...
func (c *Client) CreateWebACL(ctx context.Context, params *CreateWebACLInput, optFns ...func(*Options)) (*CreateWebACLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateWebACL", params, optFns, addOperationCreateWebACLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateWebACLMiddleware(stack *middleware.Stack, options Options) (err error) {
