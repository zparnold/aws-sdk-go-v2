...
func (c *Client) ListRuleGroups(ctx context.Context, params *ListRuleGroupsInput, optFns ...func(*Options)) (*ListRuleGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRuleGroups", params, optFns, addOperationListRuleGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRuleGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
