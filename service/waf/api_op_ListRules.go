...
func (c *Client) ListRules(ctx context.Context, params *ListRulesInput, optFns ...func(*Options)) (*ListRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRules", params, optFns, addOperationListRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
