...
func (c *Client) PutPermissionPolicy(ctx context.Context, params *PutPermissionPolicyInput, optFns ...func(*Options)) (*PutPermissionPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutPermissionPolicy", params, optFns, addOperationPutPermissionPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutPermissionPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
