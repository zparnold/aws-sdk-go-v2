...
func (c *Client) GetChangeTokenStatus(ctx context.Context, params *GetChangeTokenStatusInput, optFns ...func(*Options)) (*GetChangeTokenStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetChangeTokenStatus", params, optFns, addOperationGetChangeTokenStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetChangeTokenStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
