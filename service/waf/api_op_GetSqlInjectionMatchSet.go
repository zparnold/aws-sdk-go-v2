...
func (c *Client) GetSqlInjectionMatchSet(ctx context.Context, params *GetSqlInjectionMatchSetInput, optFns ...func(*Options)) (*GetSqlInjectionMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSqlInjectionMatchSet", params, optFns, addOperationGetSqlInjectionMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSqlInjectionMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
