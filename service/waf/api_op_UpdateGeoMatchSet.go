...
func (c *Client) UpdateGeoMatchSet(ctx context.Context, params *UpdateGeoMatchSetInput, optFns ...func(*Options)) (*UpdateGeoMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGeoMatchSet", params, optFns, addOperationUpdateGeoMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGeoMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
