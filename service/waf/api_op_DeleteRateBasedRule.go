...
func (c *Client) DeleteRateBasedRule(ctx context.Context, params *DeleteRateBasedRuleInput, optFns ...func(*Options)) (*DeleteRateBasedRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRateBasedRule", params, optFns, addOperationDeleteRateBasedRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRateBasedRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
