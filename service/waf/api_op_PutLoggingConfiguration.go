...
func (c *Client) PutLoggingConfiguration(ctx context.Context, params *PutLoggingConfigurationInput, optFns ...func(*Options)) (*PutLoggingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutLoggingConfiguration", params, optFns, addOperationPutLoggingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutLoggingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
