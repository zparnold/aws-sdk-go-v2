...
func (c *Client) DeletePermissionPolicy(ctx context.Context, params *DeletePermissionPolicyInput, optFns ...func(*Options)) (*DeletePermissionPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePermissionPolicy", params, optFns, addOperationDeletePermissionPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePermissionPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
