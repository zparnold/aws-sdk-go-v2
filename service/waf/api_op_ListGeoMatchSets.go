...
func (c *Client) ListGeoMatchSets(ctx context.Context, params *ListGeoMatchSetsInput, optFns ...func(*Options)) (*ListGeoMatchSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGeoMatchSets", params, optFns, addOperationListGeoMatchSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGeoMatchSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
