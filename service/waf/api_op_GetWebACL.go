...
func (c *Client) GetWebACL(ctx context.Context, params *GetWebACLInput, optFns ...func(*Options)) (*GetWebACLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWebACL", params, optFns, addOperationGetWebACLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWebACLMiddleware(stack *middleware.Stack, options Options) (err error) {
