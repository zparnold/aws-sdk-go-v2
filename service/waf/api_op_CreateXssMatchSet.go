...
func (c *Client) CreateXssMatchSet(ctx context.Context, params *CreateXssMatchSetInput, optFns ...func(*Options)) (*CreateXssMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateXssMatchSet", params, optFns, addOperationCreateXssMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateXssMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
