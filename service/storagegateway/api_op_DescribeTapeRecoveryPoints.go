...
func (c *Client) DescribeTapeRecoveryPoints(ctx context.Context, params *DescribeTapeRecoveryPointsInput, optFns ...func(*Options)) (*DescribeTapeRecoveryPointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTapeRecoveryPoints", params, optFns, addOperationDescribeTapeRecoveryPointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTapeRecoveryPointsMiddleware(stack *middleware.Stack, options Options) (err error) {
