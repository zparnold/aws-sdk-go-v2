...
func (c *Client) DescribeSnapshotSchedule(ctx context.Context, params *DescribeSnapshotScheduleInput, optFns ...func(*Options)) (*DescribeSnapshotScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSnapshotSchedule", params, optFns, addOperationDescribeSnapshotScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSnapshotScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
