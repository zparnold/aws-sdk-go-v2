...
func (c *Client) UpdateAutomaticTapeCreationPolicy(ctx context.Context, params *UpdateAutomaticTapeCreationPolicyInput, optFns ...func(*Options)) (*UpdateAutomaticTapeCreationPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAutomaticTapeCreationPolicy", params, optFns, addOperationUpdateAutomaticTapeCreationPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAutomaticTapeCreationPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
