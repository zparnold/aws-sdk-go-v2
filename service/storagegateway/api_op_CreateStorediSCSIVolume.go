...
func (c *Client) CreateStorediSCSIVolume(ctx context.Context, params *CreateStorediSCSIVolumeInput, optFns ...func(*Options)) (*CreateStorediSCSIVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStorediSCSIVolume", params, optFns, addOperationCreateStorediSCSIVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStorediSCSIVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
