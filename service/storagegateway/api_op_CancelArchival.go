...
func (c *Client) CancelArchival(ctx context.Context, params *CancelArchivalInput, optFns ...func(*Options)) (*CancelArchivalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelArchival", params, optFns, addOperationCancelArchivalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelArchivalMiddleware(stack *middleware.Stack, options Options) (err error) {
