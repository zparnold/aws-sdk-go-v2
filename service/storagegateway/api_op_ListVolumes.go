...
func (c *Client) ListVolumes(ctx context.Context, params *ListVolumesInput, optFns ...func(*Options)) (*ListVolumesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVolumes", params, optFns, addOperationListVolumesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVolumesMiddleware(stack *middleware.Stack, options Options) (err error) {
