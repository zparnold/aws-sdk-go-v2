...
func (c *Client) AssignTapePool(ctx context.Context, params *AssignTapePoolInput, optFns ...func(*Options)) (*AssignTapePoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssignTapePool", params, optFns, addOperationAssignTapePoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssignTapePoolMiddleware(stack *middleware.Stack, options Options) (err error) {
