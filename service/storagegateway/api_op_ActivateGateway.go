...
func (c *Client) ActivateGateway(ctx context.Context, params *ActivateGatewayInput, optFns ...func(*Options)) (*ActivateGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ActivateGateway", params, optFns, addOperationActivateGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationActivateGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
