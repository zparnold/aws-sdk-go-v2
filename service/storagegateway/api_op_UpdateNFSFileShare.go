...
func (c *Client) UpdateNFSFileShare(ctx context.Context, params *UpdateNFSFileShareInput, optFns ...func(*Options)) (*UpdateNFSFileShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNFSFileShare", params, optFns, addOperationUpdateNFSFileShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNFSFileShareMiddleware(stack *middleware.Stack, options Options) (err error) {
