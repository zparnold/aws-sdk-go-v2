...
func (c *Client) RefreshCache(ctx context.Context, params *RefreshCacheInput, optFns ...func(*Options)) (*RefreshCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RefreshCache", params, optFns, addOperationRefreshCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRefreshCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
