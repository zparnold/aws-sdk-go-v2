...
func (c *Client) CreateNFSFileShare(ctx context.Context, params *CreateNFSFileShareInput, optFns ...func(*Options)) (*CreateNFSFileShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNFSFileShare", params, optFns, addOperationCreateNFSFileShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNFSFileShareMiddleware(stack *middleware.Stack, options Options) (err error) {
