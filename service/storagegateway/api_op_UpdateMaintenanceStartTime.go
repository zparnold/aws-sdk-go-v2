...
func (c *Client) UpdateMaintenanceStartTime(ctx context.Context, params *UpdateMaintenanceStartTimeInput, optFns ...func(*Options)) (*UpdateMaintenanceStartTimeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMaintenanceStartTime", params, optFns, addOperationUpdateMaintenanceStartTimeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMaintenanceStartTimeMiddleware(stack *middleware.Stack, options Options) (err error) {
