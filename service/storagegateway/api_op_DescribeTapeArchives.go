...
func (c *Client) DescribeTapeArchives(ctx context.Context, params *DescribeTapeArchivesInput, optFns ...func(*Options)) (*DescribeTapeArchivesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTapeArchives", params, optFns, addOperationDescribeTapeArchivesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTapeArchivesMiddleware(stack *middleware.Stack, options Options) (err error) {
