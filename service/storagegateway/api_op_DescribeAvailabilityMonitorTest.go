...
func (c *Client) DescribeAvailabilityMonitorTest(ctx context.Context, params *DescribeAvailabilityMonitorTestInput, optFns ...func(*Options)) (*DescribeAvailabilityMonitorTestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAvailabilityMonitorTest", params, optFns, addOperationDescribeAvailabilityMonitorTestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAvailabilityMonitorTestMiddleware(stack *middleware.Stack, options Options) (err error) {
