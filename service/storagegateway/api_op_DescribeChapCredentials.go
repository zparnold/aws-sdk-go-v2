...
func (c *Client) DescribeChapCredentials(ctx context.Context, params *DescribeChapCredentialsInput, optFns ...func(*Options)) (*DescribeChapCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeChapCredentials", params, optFns, addOperationDescribeChapCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeChapCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
