...
func (c *Client) DescribeUploadBuffer(ctx context.Context, params *DescribeUploadBufferInput, optFns ...func(*Options)) (*DescribeUploadBufferOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUploadBuffer", params, optFns, addOperationDescribeUploadBufferMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUploadBufferMiddleware(stack *middleware.Stack, options Options) (err error) {
