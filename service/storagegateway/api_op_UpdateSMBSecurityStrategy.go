...
func (c *Client) UpdateSMBSecurityStrategy(ctx context.Context, params *UpdateSMBSecurityStrategyInput, optFns ...func(*Options)) (*UpdateSMBSecurityStrategyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSMBSecurityStrategy", params, optFns, addOperationUpdateSMBSecurityStrategyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSMBSecurityStrategyMiddleware(stack *middleware.Stack, options Options) (err error) {
