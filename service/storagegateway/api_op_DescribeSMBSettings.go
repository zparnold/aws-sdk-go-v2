...
func (c *Client) DescribeSMBSettings(ctx context.Context, params *DescribeSMBSettingsInput, optFns ...func(*Options)) (*DescribeSMBSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSMBSettings", params, optFns, addOperationDescribeSMBSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSMBSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
