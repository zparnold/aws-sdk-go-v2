...
func (c *Client) CreateSnapshotFromVolumeRecoveryPoint(ctx context.Context, params *CreateSnapshotFromVolumeRecoveryPointInput, optFns ...func(*Options)) (*CreateSnapshotFromVolumeRecoveryPointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSnapshotFromVolumeRecoveryPoint", params, optFns, addOperationCreateSnapshotFromVolumeRecoveryPointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSnapshotFromVolumeRecoveryPointMiddleware(stack *middleware.Stack, options Options) (err error) {
