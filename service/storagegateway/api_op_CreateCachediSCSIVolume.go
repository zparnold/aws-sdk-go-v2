...
func (c *Client) CreateCachediSCSIVolume(ctx context.Context, params *CreateCachediSCSIVolumeInput, optFns ...func(*Options)) (*CreateCachediSCSIVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCachediSCSIVolume", params, optFns, addOperationCreateCachediSCSIVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCachediSCSIVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
