...
func (c *Client) RetrieveTapeArchive(ctx context.Context, params *RetrieveTapeArchiveInput, optFns ...func(*Options)) (*RetrieveTapeArchiveOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetrieveTapeArchive", params, optFns, addOperationRetrieveTapeArchiveMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetrieveTapeArchiveMiddleware(stack *middleware.Stack, options Options) (err error) {
