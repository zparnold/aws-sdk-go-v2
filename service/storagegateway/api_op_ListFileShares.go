...
func (c *Client) ListFileShares(ctx context.Context, params *ListFileSharesInput, optFns ...func(*Options)) (*ListFileSharesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFileShares", params, optFns, addOperationListFileSharesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFileSharesMiddleware(stack *middleware.Stack, options Options) (err error) {
