...
func (c *Client) DescribeSMBFileShares(ctx context.Context, params *DescribeSMBFileSharesInput, optFns ...func(*Options)) (*DescribeSMBFileSharesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSMBFileShares", params, optFns, addOperationDescribeSMBFileSharesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSMBFileSharesMiddleware(stack *middleware.Stack, options Options) (err error) {
