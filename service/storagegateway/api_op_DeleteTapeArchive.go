...
func (c *Client) DeleteTapeArchive(ctx context.Context, params *DeleteTapeArchiveInput, optFns ...func(*Options)) (*DeleteTapeArchiveOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTapeArchive", params, optFns, addOperationDeleteTapeArchiveMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTapeArchiveMiddleware(stack *middleware.Stack, options Options) (err error) {
