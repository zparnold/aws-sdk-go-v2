...
func (c *Client) AddUploadBuffer(ctx context.Context, params *AddUploadBufferInput, optFns ...func(*Options)) (*AddUploadBufferOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddUploadBuffer", params, optFns, addOperationAddUploadBufferMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddUploadBufferMiddleware(stack *middleware.Stack, options Options) (err error) {
