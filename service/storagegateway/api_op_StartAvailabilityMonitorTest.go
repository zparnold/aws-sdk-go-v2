...
func (c *Client) StartAvailabilityMonitorTest(ctx context.Context, params *StartAvailabilityMonitorTestInput, optFns ...func(*Options)) (*StartAvailabilityMonitorTestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartAvailabilityMonitorTest", params, optFns, addOperationStartAvailabilityMonitorTestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartAvailabilityMonitorTestMiddleware(stack *middleware.Stack, options Options) (err error) {
