...
func (c *Client) DetachVolume(ctx context.Context, params *DetachVolumeInput, optFns ...func(*Options)) (*DetachVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachVolume", params, optFns, addOperationDetachVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
