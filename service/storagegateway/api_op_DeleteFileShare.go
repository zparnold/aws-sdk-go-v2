...
func (c *Client) DeleteFileShare(ctx context.Context, params *DeleteFileShareInput, optFns ...func(*Options)) (*DeleteFileShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFileShare", params, optFns, addOperationDeleteFileShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFileShareMiddleware(stack *middleware.Stack, options Options) (err error) {
