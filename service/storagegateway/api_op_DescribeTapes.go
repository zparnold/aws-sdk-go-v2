...
func (c *Client) DescribeTapes(ctx context.Context, params *DescribeTapesInput, optFns ...func(*Options)) (*DescribeTapesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTapes", params, optFns, addOperationDescribeTapesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTapesMiddleware(stack *middleware.Stack, options Options) (err error) {
