...
func (c *Client) DeleteChapCredentials(ctx context.Context, params *DeleteChapCredentialsInput, optFns ...func(*Options)) (*DeleteChapCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteChapCredentials", params, optFns, addOperationDeleteChapCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteChapCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
