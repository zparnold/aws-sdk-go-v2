...
func (c *Client) DescribeNFSFileShares(ctx context.Context, params *DescribeNFSFileSharesInput, optFns ...func(*Options)) (*DescribeNFSFileSharesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNFSFileShares", params, optFns, addOperationDescribeNFSFileSharesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNFSFileSharesMiddleware(stack *middleware.Stack, options Options) (err error) {
