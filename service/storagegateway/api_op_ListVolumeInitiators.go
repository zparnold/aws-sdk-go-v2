...
func (c *Client) ListVolumeInitiators(ctx context.Context, params *ListVolumeInitiatorsInput, optFns ...func(*Options)) (*ListVolumeInitiatorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVolumeInitiators", params, optFns, addOperationListVolumeInitiatorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVolumeInitiatorsMiddleware(stack *middleware.Stack, options Options) (err error) {
