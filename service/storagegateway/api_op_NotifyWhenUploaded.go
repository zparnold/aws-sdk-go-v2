...
func (c *Client) NotifyWhenUploaded(ctx context.Context, params *NotifyWhenUploadedInput, optFns ...func(*Options)) (*NotifyWhenUploadedOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "NotifyWhenUploaded", params, optFns, addOperationNotifyWhenUploadedMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationNotifyWhenUploadedMiddleware(stack *middleware.Stack, options Options) (err error) {
