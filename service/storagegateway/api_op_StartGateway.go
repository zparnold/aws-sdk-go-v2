...
func (c *Client) StartGateway(ctx context.Context, params *StartGatewayInput, optFns ...func(*Options)) (*StartGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartGateway", params, optFns, addOperationStartGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
