...
func (c *Client) CancelRetrieval(ctx context.Context, params *CancelRetrievalInput, optFns ...func(*Options)) (*CancelRetrievalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelRetrieval", params, optFns, addOperationCancelRetrievalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelRetrievalMiddleware(stack *middleware.Stack, options Options) (err error) {
