...
func (c *Client) DescribeWorkingStorage(ctx context.Context, params *DescribeWorkingStorageInput, optFns ...func(*Options)) (*DescribeWorkingStorageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeWorkingStorage", params, optFns, addOperationDescribeWorkingStorageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeWorkingStorageMiddleware(stack *middleware.Stack, options Options) (err error) {
