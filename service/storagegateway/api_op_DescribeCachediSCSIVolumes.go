...
func (c *Client) DescribeCachediSCSIVolumes(ctx context.Context, params *DescribeCachediSCSIVolumesInput, optFns ...func(*Options)) (*DescribeCachediSCSIVolumesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCachediSCSIVolumes", params, optFns, addOperationDescribeCachediSCSIVolumesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCachediSCSIVolumesMiddleware(stack *middleware.Stack, options Options) (err error) {
