...
func (c *Client) DisableGateway(ctx context.Context, params *DisableGatewayInput, optFns ...func(*Options)) (*DisableGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableGateway", params, optFns, addOperationDisableGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
