...
func (c *Client) DescribeGatewayInformation(ctx context.Context, params *DescribeGatewayInformationInput, optFns ...func(*Options)) (*DescribeGatewayInformationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGatewayInformation", params, optFns, addOperationDescribeGatewayInformationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGatewayInformationMiddleware(stack *middleware.Stack, options Options) (err error) {
