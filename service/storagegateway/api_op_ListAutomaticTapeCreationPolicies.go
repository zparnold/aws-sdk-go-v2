...
func (c *Client) ListAutomaticTapeCreationPolicies(ctx context.Context, params *ListAutomaticTapeCreationPoliciesInput, optFns ...func(*Options)) (*ListAutomaticTapeCreationPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAutomaticTapeCreationPolicies", params, optFns, addOperationListAutomaticTapeCreationPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAutomaticTapeCreationPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
