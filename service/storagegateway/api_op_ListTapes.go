...
func (c *Client) ListTapes(ctx context.Context, params *ListTapesInput, optFns ...func(*Options)) (*ListTapesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTapes", params, optFns, addOperationListTapesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTapesMiddleware(stack *middleware.Stack, options Options) (err error) {
