...
func (c *Client) UpdateBandwidthRateLimit(ctx context.Context, params *UpdateBandwidthRateLimitInput, optFns ...func(*Options)) (*UpdateBandwidthRateLimitOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBandwidthRateLimit", params, optFns, addOperationUpdateBandwidthRateLimitMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBandwidthRateLimitMiddleware(stack *middleware.Stack, options Options) (err error) {
