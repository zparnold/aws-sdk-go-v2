...
func (c *Client) ListLocalDisks(ctx context.Context, params *ListLocalDisksInput, optFns ...func(*Options)) (*ListLocalDisksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLocalDisks", params, optFns, addOperationListLocalDisksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLocalDisksMiddleware(stack *middleware.Stack, options Options) (err error) {
