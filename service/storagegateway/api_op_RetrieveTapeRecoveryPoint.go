...
func (c *Client) RetrieveTapeRecoveryPoint(ctx context.Context, params *RetrieveTapeRecoveryPointInput, optFns ...func(*Options)) (*RetrieveTapeRecoveryPointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetrieveTapeRecoveryPoint", params, optFns, addOperationRetrieveTapeRecoveryPointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetrieveTapeRecoveryPointMiddleware(stack *middleware.Stack, options Options) (err error) {
