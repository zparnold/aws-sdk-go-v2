...
func (c *Client) AddWorkingStorage(ctx context.Context, params *AddWorkingStorageInput, optFns ...func(*Options)) (*AddWorkingStorageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddWorkingStorage", params, optFns, addOperationAddWorkingStorageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddWorkingStorageMiddleware(stack *middleware.Stack, options Options) (err error) {
