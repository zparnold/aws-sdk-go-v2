...
func (c *Client) SetLocalConsolePassword(ctx context.Context, params *SetLocalConsolePasswordInput, optFns ...func(*Options)) (*SetLocalConsolePasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetLocalConsolePassword", params, optFns, addOperationSetLocalConsolePasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetLocalConsolePasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
