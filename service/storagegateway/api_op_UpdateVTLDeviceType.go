...
func (c *Client) UpdateVTLDeviceType(ctx context.Context, params *UpdateVTLDeviceTypeInput, optFns ...func(*Options)) (*UpdateVTLDeviceTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVTLDeviceType", params, optFns, addOperationUpdateVTLDeviceTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVTLDeviceTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
