...
func (c *Client) JoinDomain(ctx context.Context, params *JoinDomainInput, optFns ...func(*Options)) (*JoinDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "JoinDomain", params, optFns, addOperationJoinDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationJoinDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
