...
func (c *Client) CreateTapeWithBarcode(ctx context.Context, params *CreateTapeWithBarcodeInput, optFns ...func(*Options)) (*CreateTapeWithBarcodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTapeWithBarcode", params, optFns, addOperationCreateTapeWithBarcodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTapeWithBarcodeMiddleware(stack *middleware.Stack, options Options) (err error) {
