...
func (c *Client) UpdateGatewaySoftwareNow(ctx context.Context, params *UpdateGatewaySoftwareNowInput, optFns ...func(*Options)) (*UpdateGatewaySoftwareNowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGatewaySoftwareNow", params, optFns, addOperationUpdateGatewaySoftwareNowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewaySoftwareNowMiddleware(stack *middleware.Stack, options Options) (err error) {
