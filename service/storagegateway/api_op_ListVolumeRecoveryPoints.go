...
func (c *Client) ListVolumeRecoveryPoints(ctx context.Context, params *ListVolumeRecoveryPointsInput, optFns ...func(*Options)) (*ListVolumeRecoveryPointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVolumeRecoveryPoints", params, optFns, addOperationListVolumeRecoveryPointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVolumeRecoveryPointsMiddleware(stack *middleware.Stack, options Options) (err error) {
