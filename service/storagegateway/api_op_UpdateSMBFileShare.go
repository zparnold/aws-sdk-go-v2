...
func (c *Client) UpdateSMBFileShare(ctx context.Context, params *UpdateSMBFileShareInput, optFns ...func(*Options)) (*UpdateSMBFileShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSMBFileShare", params, optFns, addOperationUpdateSMBFileShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSMBFileShareMiddleware(stack *middleware.Stack, options Options) (err error) {
