...
func (c *Client) AddCache(ctx context.Context, params *AddCacheInput, optFns ...func(*Options)) (*AddCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddCache", params, optFns, addOperationAddCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
