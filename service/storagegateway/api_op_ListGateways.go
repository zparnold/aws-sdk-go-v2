...
func (c *Client) ListGateways(ctx context.Context, params *ListGatewaysInput, optFns ...func(*Options)) (*ListGatewaysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGateways", params, optFns, addOperationListGatewaysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGatewaysMiddleware(stack *middleware.Stack, options Options) (err error) {
