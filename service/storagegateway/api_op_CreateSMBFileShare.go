...
func (c *Client) CreateSMBFileShare(ctx context.Context, params *CreateSMBFileShareInput, optFns ...func(*Options)) (*CreateSMBFileShareOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSMBFileShare", params, optFns, addOperationCreateSMBFileShareMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSMBFileShareMiddleware(stack *middleware.Stack, options Options) (err error) {
