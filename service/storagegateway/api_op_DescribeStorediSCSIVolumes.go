...
func (c *Client) DescribeStorediSCSIVolumes(ctx context.Context, params *DescribeStorediSCSIVolumesInput, optFns ...func(*Options)) (*DescribeStorediSCSIVolumesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStorediSCSIVolumes", params, optFns, addOperationDescribeStorediSCSIVolumesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStorediSCSIVolumesMiddleware(stack *middleware.Stack, options Options) (err error) {
