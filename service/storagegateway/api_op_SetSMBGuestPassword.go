...
func (c *Client) SetSMBGuestPassword(ctx context.Context, params *SetSMBGuestPasswordInput, optFns ...func(*Options)) (*SetSMBGuestPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetSMBGuestPassword", params, optFns, addOperationSetSMBGuestPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetSMBGuestPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
