...
func (c *Client) DescribeCache(ctx context.Context, params *DescribeCacheInput, optFns ...func(*Options)) (*DescribeCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCache", params, optFns, addOperationDescribeCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
