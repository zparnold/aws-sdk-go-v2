...
func (c *Client) UpdateSnapshotSchedule(ctx context.Context, params *UpdateSnapshotScheduleInput, optFns ...func(*Options)) (*UpdateSnapshotScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSnapshotSchedule", params, optFns, addOperationUpdateSnapshotScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSnapshotScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
