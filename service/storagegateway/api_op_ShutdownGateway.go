...
func (c *Client) ShutdownGateway(ctx context.Context, params *ShutdownGatewayInput, optFns ...func(*Options)) (*ShutdownGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ShutdownGateway", params, optFns, addOperationShutdownGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationShutdownGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
