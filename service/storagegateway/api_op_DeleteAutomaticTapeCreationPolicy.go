...
func (c *Client) DeleteAutomaticTapeCreationPolicy(ctx context.Context, params *DeleteAutomaticTapeCreationPolicyInput, optFns ...func(*Options)) (*DeleteAutomaticTapeCreationPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAutomaticTapeCreationPolicy", params, optFns, addOperationDeleteAutomaticTapeCreationPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAutomaticTapeCreationPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
