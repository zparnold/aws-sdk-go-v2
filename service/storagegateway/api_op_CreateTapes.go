...
func (c *Client) CreateTapes(ctx context.Context, params *CreateTapesInput, optFns ...func(*Options)) (*CreateTapesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTapes", params, optFns, addOperationCreateTapesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTapesMiddleware(stack *middleware.Stack, options Options) (err error) {
