...
func (c *Client) DeleteTape(ctx context.Context, params *DeleteTapeInput, optFns ...func(*Options)) (*DeleteTapeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTape", params, optFns, addOperationDeleteTapeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTapeMiddleware(stack *middleware.Stack, options Options) (err error) {
