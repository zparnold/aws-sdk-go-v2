...
func (c *Client) DescribeMaintenanceStartTime(ctx context.Context, params *DescribeMaintenanceStartTimeInput, optFns ...func(*Options)) (*DescribeMaintenanceStartTimeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMaintenanceStartTime", params, optFns, addOperationDescribeMaintenanceStartTimeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMaintenanceStartTimeMiddleware(stack *middleware.Stack, options Options) (err error) {
