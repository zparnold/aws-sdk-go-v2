...
func (c *Client) UpdateGatewayInformation(ctx context.Context, params *UpdateGatewayInformationInput, optFns ...func(*Options)) (*UpdateGatewayInformationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGatewayInformation", params, optFns, addOperationUpdateGatewayInformationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewayInformationMiddleware(stack *middleware.Stack, options Options) (err error) {
