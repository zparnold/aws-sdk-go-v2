...
func (c *Client) DescribeVTLDevices(ctx context.Context, params *DescribeVTLDevicesInput, optFns ...func(*Options)) (*DescribeVTLDevicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVTLDevices", params, optFns, addOperationDescribeVTLDevicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVTLDevicesMiddleware(stack *middleware.Stack, options Options) (err error) {
