...
func (c *Client) DescribeTrustedAdvisorCheckRefreshStatuses(ctx context.Context, params *DescribeTrustedAdvisorCheckRefreshStatusesInput, optFns ...func(*Options)) (*DescribeTrustedAdvisorCheckRefreshStatusesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrustedAdvisorCheckRefreshStatuses", params, optFns, addOperationDescribeTrustedAdvisorCheckRefreshStatusesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrustedAdvisorCheckRefreshStatusesMiddleware(stack *middleware.Stack, options Options) (err error) {
