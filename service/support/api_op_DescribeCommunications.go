...
func (c *Client) DescribeCommunications(ctx context.Context, params *DescribeCommunicationsInput, optFns ...func(*Options)) (*DescribeCommunicationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCommunications", params, optFns, addOperationDescribeCommunicationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCommunicationsMiddleware(stack *middleware.Stack, options Options) (err error) {
