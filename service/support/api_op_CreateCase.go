...
func (c *Client) CreateCase(ctx context.Context, params *CreateCaseInput, optFns ...func(*Options)) (*CreateCaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCase", params, optFns, addOperationCreateCaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCaseMiddleware(stack *middleware.Stack, options Options) (err error) {
