...
func (c *Client) DescribeCases(ctx context.Context, params *DescribeCasesInput, optFns ...func(*Options)) (*DescribeCasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCases", params, optFns, addOperationDescribeCasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCasesMiddleware(stack *middleware.Stack, options Options) (err error) {
