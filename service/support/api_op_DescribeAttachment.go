...
func (c *Client) DescribeAttachment(ctx context.Context, params *DescribeAttachmentInput, optFns ...func(*Options)) (*DescribeAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAttachment", params, optFns, addOperationDescribeAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
