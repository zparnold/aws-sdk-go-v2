...
func (c *Client) ResolveCase(ctx context.Context, params *ResolveCaseInput, optFns ...func(*Options)) (*ResolveCaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResolveCase", params, optFns, addOperationResolveCaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResolveCaseMiddleware(stack *middleware.Stack, options Options) (err error) {
