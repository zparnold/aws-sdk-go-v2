...
func (c *Client) DescribeSeverityLevels(ctx context.Context, params *DescribeSeverityLevelsInput, optFns ...func(*Options)) (*DescribeSeverityLevelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSeverityLevels", params, optFns, addOperationDescribeSeverityLevelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSeverityLevelsMiddleware(stack *middleware.Stack, options Options) (err error) {
