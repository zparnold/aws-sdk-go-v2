...
func (c *Client) DescribeTrustedAdvisorCheckSummaries(ctx context.Context, params *DescribeTrustedAdvisorCheckSummariesInput, optFns ...func(*Options)) (*DescribeTrustedAdvisorCheckSummariesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrustedAdvisorCheckSummaries", params, optFns, addOperationDescribeTrustedAdvisorCheckSummariesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrustedAdvisorCheckSummariesMiddleware(stack *middleware.Stack, options Options) (err error) {
