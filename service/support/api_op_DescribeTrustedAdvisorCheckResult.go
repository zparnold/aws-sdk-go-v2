...
func (c *Client) DescribeTrustedAdvisorCheckResult(ctx context.Context, params *DescribeTrustedAdvisorCheckResultInput, optFns ...func(*Options)) (*DescribeTrustedAdvisorCheckResultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrustedAdvisorCheckResult", params, optFns, addOperationDescribeTrustedAdvisorCheckResultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrustedAdvisorCheckResultMiddleware(stack *middleware.Stack, options Options) (err error) {
