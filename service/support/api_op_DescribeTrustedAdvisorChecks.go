...
func (c *Client) DescribeTrustedAdvisorChecks(ctx context.Context, params *DescribeTrustedAdvisorChecksInput, optFns ...func(*Options)) (*DescribeTrustedAdvisorChecksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrustedAdvisorChecks", params, optFns, addOperationDescribeTrustedAdvisorChecksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrustedAdvisorChecksMiddleware(stack *middleware.Stack, options Options) (err error) {
