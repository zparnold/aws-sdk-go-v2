...
func (c *Client) RefreshTrustedAdvisorCheck(ctx context.Context, params *RefreshTrustedAdvisorCheckInput, optFns ...func(*Options)) (*RefreshTrustedAdvisorCheckOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RefreshTrustedAdvisorCheck", params, optFns, addOperationRefreshTrustedAdvisorCheckMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRefreshTrustedAdvisorCheckMiddleware(stack *middleware.Stack, options Options) (err error) {
