...
func (c *Client) AddAttachmentsToSet(ctx context.Context, params *AddAttachmentsToSetInput, optFns ...func(*Options)) (*AddAttachmentsToSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddAttachmentsToSet", params, optFns, addOperationAddAttachmentsToSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddAttachmentsToSetMiddleware(stack *middleware.Stack, options Options) (err error) {
