...
func (c *Client) GetRuleGroup(ctx context.Context, params *GetRuleGroupInput, optFns ...func(*Options)) (*GetRuleGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRuleGroup", params, optFns, addOperationGetRuleGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRuleGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
