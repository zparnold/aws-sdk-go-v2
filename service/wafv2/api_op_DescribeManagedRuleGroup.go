...
func (c *Client) DescribeManagedRuleGroup(ctx context.Context, params *DescribeManagedRuleGroupInput, optFns ...func(*Options)) (*DescribeManagedRuleGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeManagedRuleGroup", params, optFns, addOperationDescribeManagedRuleGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeManagedRuleGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
