...
func (c *Client) GetRateBasedStatementManagedKeys(ctx context.Context, params *GetRateBasedStatementManagedKeysInput, optFns ...func(*Options)) (*GetRateBasedStatementManagedKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRateBasedStatementManagedKeys", params, optFns, addOperationGetRateBasedStatementManagedKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRateBasedStatementManagedKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
