...
func (c *Client) CreateRegexPatternSet(ctx context.Context, params *CreateRegexPatternSetInput, optFns ...func(*Options)) (*CreateRegexPatternSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRegexPatternSet", params, optFns, addOperationCreateRegexPatternSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRegexPatternSetMiddleware(stack *middleware.Stack, options Options) (err error) {
