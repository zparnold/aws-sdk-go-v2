...
func (c *Client) CheckCapacity(ctx context.Context, params *CheckCapacityInput, optFns ...func(*Options)) (*CheckCapacityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CheckCapacity", params, optFns, addOperationCheckCapacityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCheckCapacityMiddleware(stack *middleware.Stack, options Options) (err error) {
