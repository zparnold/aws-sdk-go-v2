...
func (c *Client) DeleteFirewallManagerRuleGroups(ctx context.Context, params *DeleteFirewallManagerRuleGroupsInput, optFns ...func(*Options)) (*DeleteFirewallManagerRuleGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFirewallManagerRuleGroups", params, optFns, addOperationDeleteFirewallManagerRuleGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFirewallManagerRuleGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
