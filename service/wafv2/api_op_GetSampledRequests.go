...
func (c *Client) GetSampledRequests(ctx context.Context, params *GetSampledRequestsInput, optFns ...func(*Options)) (*GetSampledRequestsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSampledRequests", params, optFns, addOperationGetSampledRequestsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSampledRequestsMiddleware(stack *middleware.Stack, options Options) (err error) {
