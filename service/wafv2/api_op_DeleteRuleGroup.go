...
func (c *Client) DeleteRuleGroup(ctx context.Context, params *DeleteRuleGroupInput, optFns ...func(*Options)) (*DeleteRuleGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRuleGroup", params, optFns, addOperationDeleteRuleGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRuleGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
