...
func (c *Client) GetWebACLForResource(ctx context.Context, params *GetWebACLForResourceInput, optFns ...func(*Options)) (*GetWebACLForResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWebACLForResource", params, optFns, addOperationGetWebACLForResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWebACLForResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
