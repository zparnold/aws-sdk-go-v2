...
func (c *Client) GetRegexPatternSet(ctx context.Context, params *GetRegexPatternSetInput, optFns ...func(*Options)) (*GetRegexPatternSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRegexPatternSet", params, optFns, addOperationGetRegexPatternSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRegexPatternSetMiddleware(stack *middleware.Stack, options Options) (err error) {
