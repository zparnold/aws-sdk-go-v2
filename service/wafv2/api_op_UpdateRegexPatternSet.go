...
func (c *Client) UpdateRegexPatternSet(ctx context.Context, params *UpdateRegexPatternSetInput, optFns ...func(*Options)) (*UpdateRegexPatternSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRegexPatternSet", params, optFns, addOperationUpdateRegexPatternSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRegexPatternSetMiddleware(stack *middleware.Stack, options Options) (err error) {
