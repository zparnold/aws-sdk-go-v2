...
func (c *Client) GetLoggingConfiguration(ctx context.Context, params *GetLoggingConfigurationInput, optFns ...func(*Options)) (*GetLoggingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoggingConfiguration", params, optFns, addOperationGetLoggingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoggingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
