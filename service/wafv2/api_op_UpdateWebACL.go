...
func (c *Client) UpdateWebACL(ctx context.Context, params *UpdateWebACLInput, optFns ...func(*Options)) (*UpdateWebACLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateWebACL", params, optFns, addOperationUpdateWebACLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateWebACLMiddleware(stack *middleware.Stack, options Options) (err error) {
