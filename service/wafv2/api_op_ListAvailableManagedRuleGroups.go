...
func (c *Client) ListAvailableManagedRuleGroups(ctx context.Context, params *ListAvailableManagedRuleGroupsInput, optFns ...func(*Options)) (*ListAvailableManagedRuleGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAvailableManagedRuleGroups", params, optFns, addOperationListAvailableManagedRuleGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAvailableManagedRuleGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
