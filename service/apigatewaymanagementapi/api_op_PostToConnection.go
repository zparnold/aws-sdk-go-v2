...
func (c *Client) PostToConnection(ctx context.Context, params *PostToConnectionInput, optFns ...func(*Options)) (*PostToConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PostToConnection", params, optFns, addOperationPostToConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPostToConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
