...
func (c *Client) GetConnection(ctx context.Context, params *GetConnectionInput, optFns ...func(*Options)) (*GetConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConnection", params, optFns, addOperationGetConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
