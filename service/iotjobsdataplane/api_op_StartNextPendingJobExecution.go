...
func (c *Client) StartNextPendingJobExecution(ctx context.Context, params *StartNextPendingJobExecutionInput, optFns ...func(*Options)) (*StartNextPendingJobExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartNextPendingJobExecution", params, optFns, addOperationStartNextPendingJobExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartNextPendingJobExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
