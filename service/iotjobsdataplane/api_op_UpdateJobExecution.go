...
func (c *Client) UpdateJobExecution(ctx context.Context, params *UpdateJobExecutionInput, optFns ...func(*Options)) (*UpdateJobExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateJobExecution", params, optFns, addOperationUpdateJobExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateJobExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
