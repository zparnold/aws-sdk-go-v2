...
func (c *Client) DescribeJobExecution(ctx context.Context, params *DescribeJobExecutionInput, optFns ...func(*Options)) (*DescribeJobExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeJobExecution", params, optFns, addOperationDescribeJobExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeJobExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
