...
func (c *Client) GetLexicon(ctx context.Context, params *GetLexiconInput, optFns ...func(*Options)) (*GetLexiconOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLexicon", params, optFns, addOperationGetLexiconMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLexiconMiddleware(stack *middleware.Stack, options Options) (err error) {
