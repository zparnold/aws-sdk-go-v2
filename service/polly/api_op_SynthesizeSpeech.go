...
func (c *Client) SynthesizeSpeech(ctx context.Context, params *SynthesizeSpeechInput, optFns ...func(*Options)) (*SynthesizeSpeechOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SynthesizeSpeech", params, optFns, addOperationSynthesizeSpeechMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSynthesizeSpeechMiddleware(stack *middleware.Stack, options Options) (err error) {
