...
func (c *Client) StartSpeechSynthesisTask(ctx context.Context, params *StartSpeechSynthesisTaskInput, optFns ...func(*Options)) (*StartSpeechSynthesisTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSpeechSynthesisTask", params, optFns, addOperationStartSpeechSynthesisTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSpeechSynthesisTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
