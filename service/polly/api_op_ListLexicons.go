...
func (c *Client) ListLexicons(ctx context.Context, params *ListLexiconsInput, optFns ...func(*Options)) (*ListLexiconsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLexicons", params, optFns, addOperationListLexiconsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLexiconsMiddleware(stack *middleware.Stack, options Options) (err error) {
