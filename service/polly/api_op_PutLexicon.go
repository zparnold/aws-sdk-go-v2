...
func (c *Client) PutLexicon(ctx context.Context, params *PutLexiconInput, optFns ...func(*Options)) (*PutLexiconOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutLexicon", params, optFns, addOperationPutLexiconMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutLexiconMiddleware(stack *middleware.Stack, options Options) (err error) {
