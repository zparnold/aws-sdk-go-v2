...
func (c *Client) ListSpeechSynthesisTasks(ctx context.Context, params *ListSpeechSynthesisTasksInput, optFns ...func(*Options)) (*ListSpeechSynthesisTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSpeechSynthesisTasks", params, optFns, addOperationListSpeechSynthesisTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSpeechSynthesisTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
