...
func (c *Client) DeleteLexicon(ctx context.Context, params *DeleteLexiconInput, optFns ...func(*Options)) (*DeleteLexiconOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLexicon", params, optFns, addOperationDeleteLexiconMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLexiconMiddleware(stack *middleware.Stack, options Options) (err error) {
