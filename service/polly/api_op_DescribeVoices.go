...
func (c *Client) DescribeVoices(ctx context.Context, params *DescribeVoicesInput, optFns ...func(*Options)) (*DescribeVoicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVoices", params, optFns, addOperationDescribeVoicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVoicesMiddleware(stack *middleware.Stack, options Options) (err error) {
