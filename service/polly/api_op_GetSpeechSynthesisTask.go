...
func (c *Client) GetSpeechSynthesisTask(ctx context.Context, params *GetSpeechSynthesisTaskInput, optFns ...func(*Options)) (*GetSpeechSynthesisTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSpeechSynthesisTask", params, optFns, addOperationGetSpeechSynthesisTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSpeechSynthesisTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
