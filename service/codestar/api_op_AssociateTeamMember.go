...
func (c *Client) AssociateTeamMember(ctx context.Context, params *AssociateTeamMemberInput, optFns ...func(*Options)) (*AssociateTeamMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateTeamMember", params, optFns, addOperationAssociateTeamMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateTeamMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
