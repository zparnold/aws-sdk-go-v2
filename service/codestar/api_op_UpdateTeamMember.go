...
func (c *Client) UpdateTeamMember(ctx context.Context, params *UpdateTeamMemberInput, optFns ...func(*Options)) (*UpdateTeamMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTeamMember", params, optFns, addOperationUpdateTeamMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTeamMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
