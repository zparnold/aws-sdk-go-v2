...
func (c *Client) ListTagsForProject(ctx context.Context, params *ListTagsForProjectInput, optFns ...func(*Options)) (*ListTagsForProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForProject", params, optFns, addOperationListTagsForProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
