...
func (c *Client) UntagProject(ctx context.Context, params *UntagProjectInput, optFns ...func(*Options)) (*UntagProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagProject", params, optFns, addOperationUntagProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
