...
func (c *Client) TagProject(ctx context.Context, params *TagProjectInput, optFns ...func(*Options)) (*TagProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagProject", params, optFns, addOperationTagProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
