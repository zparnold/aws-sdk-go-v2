...
func (c *Client) DisassociateTeamMember(ctx context.Context, params *DisassociateTeamMemberInput, optFns ...func(*Options)) (*DisassociateTeamMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateTeamMember", params, optFns, addOperationDisassociateTeamMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateTeamMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
