...
func (c *Client) ListEndpointGroups(ctx context.Context, params *ListEndpointGroupsInput, optFns ...func(*Options)) (*ListEndpointGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEndpointGroups", params, optFns, addOperationListEndpointGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEndpointGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
