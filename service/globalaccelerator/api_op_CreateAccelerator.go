...
func (c *Client) CreateAccelerator(ctx context.Context, params *CreateAcceleratorInput, optFns ...func(*Options)) (*CreateAcceleratorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAccelerator", params, optFns, addOperationCreateAcceleratorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAcceleratorMiddleware(stack *middleware.Stack, options Options) (err error) {
