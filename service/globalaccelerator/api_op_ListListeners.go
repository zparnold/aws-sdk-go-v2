...
func (c *Client) ListListeners(ctx context.Context, params *ListListenersInput, optFns ...func(*Options)) (*ListListenersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListListeners", params, optFns, addOperationListListenersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListListenersMiddleware(stack *middleware.Stack, options Options) (err error) {
