...
func (c *Client) ListByoipCidrs(ctx context.Context, params *ListByoipCidrsInput, optFns ...func(*Options)) (*ListByoipCidrsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListByoipCidrs", params, optFns, addOperationListByoipCidrsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListByoipCidrsMiddleware(stack *middleware.Stack, options Options) (err error) {
