...
func (c *Client) DescribeAcceleratorAttributes(ctx context.Context, params *DescribeAcceleratorAttributesInput, optFns ...func(*Options)) (*DescribeAcceleratorAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAcceleratorAttributes", params, optFns, addOperationDescribeAcceleratorAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAcceleratorAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
