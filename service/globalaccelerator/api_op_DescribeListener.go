...
func (c *Client) DescribeListener(ctx context.Context, params *DescribeListenerInput, optFns ...func(*Options)) (*DescribeListenerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeListener", params, optFns, addOperationDescribeListenerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeListenerMiddleware(stack *middleware.Stack, options Options) (err error) {
