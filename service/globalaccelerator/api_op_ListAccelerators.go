...
func (c *Client) ListAccelerators(ctx context.Context, params *ListAcceleratorsInput, optFns ...func(*Options)) (*ListAcceleratorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAccelerators", params, optFns, addOperationListAcceleratorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAcceleratorsMiddleware(stack *middleware.Stack, options Options) (err error) {
