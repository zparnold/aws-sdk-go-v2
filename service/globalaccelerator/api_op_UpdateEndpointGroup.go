...
func (c *Client) UpdateEndpointGroup(ctx context.Context, params *UpdateEndpointGroupInput, optFns ...func(*Options)) (*UpdateEndpointGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEndpointGroup", params, optFns, addOperationUpdateEndpointGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEndpointGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
