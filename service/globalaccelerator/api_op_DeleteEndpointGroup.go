...
func (c *Client) DeleteEndpointGroup(ctx context.Context, params *DeleteEndpointGroupInput, optFns ...func(*Options)) (*DeleteEndpointGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEndpointGroup", params, optFns, addOperationDeleteEndpointGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEndpointGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
