...
func (c *Client) UpdateAcceleratorAttributes(ctx context.Context, params *UpdateAcceleratorAttributesInput, optFns ...func(*Options)) (*UpdateAcceleratorAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAcceleratorAttributes", params, optFns, addOperationUpdateAcceleratorAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAcceleratorAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
