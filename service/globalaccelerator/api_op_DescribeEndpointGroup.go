...
func (c *Client) DescribeEndpointGroup(ctx context.Context, params *DescribeEndpointGroupInput, optFns ...func(*Options)) (*DescribeEndpointGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEndpointGroup", params, optFns, addOperationDescribeEndpointGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEndpointGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
