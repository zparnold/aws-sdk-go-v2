...
func (c *Client) UpdateAccelerator(ctx context.Context, params *UpdateAcceleratorInput, optFns ...func(*Options)) (*UpdateAcceleratorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAccelerator", params, optFns, addOperationUpdateAcceleratorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAcceleratorMiddleware(stack *middleware.Stack, options Options) (err error) {
