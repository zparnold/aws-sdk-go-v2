...
func (c *Client) UpdateListener(ctx context.Context, params *UpdateListenerInput, optFns ...func(*Options)) (*UpdateListenerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateListener", params, optFns, addOperationUpdateListenerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateListenerMiddleware(stack *middleware.Stack, options Options) (err error) {
