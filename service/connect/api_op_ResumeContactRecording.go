...
func (c *Client) ResumeContactRecording(ctx context.Context, params *ResumeContactRecordingInput, optFns ...func(*Options)) (*ResumeContactRecordingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResumeContactRecording", params, optFns, addOperationResumeContactRecordingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResumeContactRecordingMiddleware(stack *middleware.Stack, options Options) (err error) {
