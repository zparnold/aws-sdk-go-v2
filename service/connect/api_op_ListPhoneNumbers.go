...
func (c *Client) ListPhoneNumbers(ctx context.Context, params *ListPhoneNumbersInput, optFns ...func(*Options)) (*ListPhoneNumbersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPhoneNumbers", params, optFns, addOperationListPhoneNumbersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPhoneNumbersMiddleware(stack *middleware.Stack, options Options) (err error) {
