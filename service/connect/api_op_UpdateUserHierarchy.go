...
func (c *Client) UpdateUserHierarchy(ctx context.Context, params *UpdateUserHierarchyInput, optFns ...func(*Options)) (*UpdateUserHierarchyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserHierarchy", params, optFns, addOperationUpdateUserHierarchyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserHierarchyMiddleware(stack *middleware.Stack, options Options) (err error) {
