...
func (c *Client) ListSecurityProfiles(ctx context.Context, params *ListSecurityProfilesInput, optFns ...func(*Options)) (*ListSecurityProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSecurityProfiles", params, optFns, addOperationListSecurityProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSecurityProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
