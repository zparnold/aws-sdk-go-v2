...
func (c *Client) UpdateUserIdentityInfo(ctx context.Context, params *UpdateUserIdentityInfoInput, optFns ...func(*Options)) (*UpdateUserIdentityInfoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserIdentityInfo", params, optFns, addOperationUpdateUserIdentityInfoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserIdentityInfoMiddleware(stack *middleware.Stack, options Options) (err error) {
