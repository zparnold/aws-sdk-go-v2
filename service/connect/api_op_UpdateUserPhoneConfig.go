...
func (c *Client) UpdateUserPhoneConfig(ctx context.Context, params *UpdateUserPhoneConfigInput, optFns ...func(*Options)) (*UpdateUserPhoneConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserPhoneConfig", params, optFns, addOperationUpdateUserPhoneConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserPhoneConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
