...
func (c *Client) StartContactRecording(ctx context.Context, params *StartContactRecordingInput, optFns ...func(*Options)) (*StartContactRecordingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartContactRecording", params, optFns, addOperationStartContactRecordingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartContactRecordingMiddleware(stack *middleware.Stack, options Options) (err error) {
