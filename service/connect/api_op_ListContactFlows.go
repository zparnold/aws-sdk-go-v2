...
func (c *Client) ListContactFlows(ctx context.Context, params *ListContactFlowsInput, optFns ...func(*Options)) (*ListContactFlowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListContactFlows", params, optFns, addOperationListContactFlowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListContactFlowsMiddleware(stack *middleware.Stack, options Options) (err error) {
