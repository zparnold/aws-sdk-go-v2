...
func (c *Client) ListUserHierarchyGroups(ctx context.Context, params *ListUserHierarchyGroupsInput, optFns ...func(*Options)) (*ListUserHierarchyGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserHierarchyGroups", params, optFns, addOperationListUserHierarchyGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserHierarchyGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
