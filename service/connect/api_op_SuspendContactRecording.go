...
func (c *Client) SuspendContactRecording(ctx context.Context, params *SuspendContactRecordingInput, optFns ...func(*Options)) (*SuspendContactRecordingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SuspendContactRecording", params, optFns, addOperationSuspendContactRecordingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSuspendContactRecordingMiddleware(stack *middleware.Stack, options Options) (err error) {
