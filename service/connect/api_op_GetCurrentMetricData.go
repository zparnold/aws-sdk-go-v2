...
func (c *Client) GetCurrentMetricData(ctx context.Context, params *GetCurrentMetricDataInput, optFns ...func(*Options)) (*GetCurrentMetricDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCurrentMetricData", params, optFns, addOperationGetCurrentMetricDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCurrentMetricDataMiddleware(stack *middleware.Stack, options Options) (err error) {
