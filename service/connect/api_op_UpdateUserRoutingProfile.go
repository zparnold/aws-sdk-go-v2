...
func (c *Client) UpdateUserRoutingProfile(ctx context.Context, params *UpdateUserRoutingProfileInput, optFns ...func(*Options)) (*UpdateUserRoutingProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserRoutingProfile", params, optFns, addOperationUpdateUserRoutingProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserRoutingProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
