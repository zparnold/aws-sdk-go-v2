...
func (c *Client) StartChatContact(ctx context.Context, params *StartChatContactInput, optFns ...func(*Options)) (*StartChatContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartChatContact", params, optFns, addOperationStartChatContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartChatContactMiddleware(stack *middleware.Stack, options Options) (err error) {
