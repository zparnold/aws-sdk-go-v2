...
func (c *Client) UpdateContactAttributes(ctx context.Context, params *UpdateContactAttributesInput, optFns ...func(*Options)) (*UpdateContactAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateContactAttributes", params, optFns, addOperationUpdateContactAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateContactAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
