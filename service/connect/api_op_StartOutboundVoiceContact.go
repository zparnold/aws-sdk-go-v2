...
func (c *Client) StartOutboundVoiceContact(ctx context.Context, params *StartOutboundVoiceContactInput, optFns ...func(*Options)) (*StartOutboundVoiceContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartOutboundVoiceContact", params, optFns, addOperationStartOutboundVoiceContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartOutboundVoiceContactMiddleware(stack *middleware.Stack, options Options) (err error) {
