...
func (c *Client) ListRoutingProfiles(ctx context.Context, params *ListRoutingProfilesInput, optFns ...func(*Options)) (*ListRoutingProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRoutingProfiles", params, optFns, addOperationListRoutingProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRoutingProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
