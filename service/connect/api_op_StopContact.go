...
func (c *Client) StopContact(ctx context.Context, params *StopContactInput, optFns ...func(*Options)) (*StopContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopContact", params, optFns, addOperationStopContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopContactMiddleware(stack *middleware.Stack, options Options) (err error) {
