...
func (c *Client) ListHoursOfOperations(ctx context.Context, params *ListHoursOfOperationsInput, optFns ...func(*Options)) (*ListHoursOfOperationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHoursOfOperations", params, optFns, addOperationListHoursOfOperationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHoursOfOperationsMiddleware(stack *middleware.Stack, options Options) (err error) {
