...
func (c *Client) GetTagKeys(ctx context.Context, params *GetTagKeysInput, optFns ...func(*Options)) (*GetTagKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTagKeys", params, optFns, addOperationGetTagKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTagKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
