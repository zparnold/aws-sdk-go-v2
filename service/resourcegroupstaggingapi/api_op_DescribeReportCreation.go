...
func (c *Client) DescribeReportCreation(ctx context.Context, params *DescribeReportCreationInput, optFns ...func(*Options)) (*DescribeReportCreationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReportCreation", params, optFns, addOperationDescribeReportCreationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReportCreationMiddleware(stack *middleware.Stack, options Options) (err error) {
