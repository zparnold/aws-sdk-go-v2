...
func (c *Client) TagResources(ctx context.Context, params *TagResourcesInput, optFns ...func(*Options)) (*TagResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagResources", params, optFns, addOperationTagResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
