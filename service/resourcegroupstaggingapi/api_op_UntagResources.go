...
func (c *Client) UntagResources(ctx context.Context, params *UntagResourcesInput, optFns ...func(*Options)) (*UntagResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagResources", params, optFns, addOperationUntagResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
