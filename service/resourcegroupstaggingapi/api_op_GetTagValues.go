...
func (c *Client) GetTagValues(ctx context.Context, params *GetTagValuesInput, optFns ...func(*Options)) (*GetTagValuesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTagValues", params, optFns, addOperationGetTagValuesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTagValuesMiddleware(stack *middleware.Stack, options Options) (err error) {
