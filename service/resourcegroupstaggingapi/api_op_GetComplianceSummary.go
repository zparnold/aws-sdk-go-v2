...
func (c *Client) GetComplianceSummary(ctx context.Context, params *GetComplianceSummaryInput, optFns ...func(*Options)) (*GetComplianceSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComplianceSummary", params, optFns, addOperationGetComplianceSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComplianceSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
