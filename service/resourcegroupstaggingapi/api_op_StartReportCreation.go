...
func (c *Client) StartReportCreation(ctx context.Context, params *StartReportCreationInput, optFns ...func(*Options)) (*StartReportCreationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartReportCreation", params, optFns, addOperationStartReportCreationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartReportCreationMiddleware(stack *middleware.Stack, options Options) (err error) {
