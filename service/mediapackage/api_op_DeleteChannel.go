...
func (c *Client) DeleteChannel(ctx context.Context, params *DeleteChannelInput, optFns ...func(*Options)) (*DeleteChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteChannel", params, optFns, addOperationDeleteChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
