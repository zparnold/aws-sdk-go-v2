...
func (c *Client) CreateHarvestJob(ctx context.Context, params *CreateHarvestJobInput, optFns ...func(*Options)) (*CreateHarvestJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateHarvestJob", params, optFns, addOperationCreateHarvestJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateHarvestJobMiddleware(stack *middleware.Stack, options Options) (err error) {
