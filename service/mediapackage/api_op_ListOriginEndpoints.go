...
func (c *Client) ListOriginEndpoints(ctx context.Context, params *ListOriginEndpointsInput, optFns ...func(*Options)) (*ListOriginEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOriginEndpoints", params, optFns, addOperationListOriginEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOriginEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
