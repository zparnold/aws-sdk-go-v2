...
func (c *Client) CreateOriginEndpoint(ctx context.Context, params *CreateOriginEndpointInput, optFns ...func(*Options)) (*CreateOriginEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOriginEndpoint", params, optFns, addOperationCreateOriginEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOriginEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
