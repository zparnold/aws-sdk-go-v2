...
func (c *Client) DescribeOriginEndpoint(ctx context.Context, params *DescribeOriginEndpointInput, optFns ...func(*Options)) (*DescribeOriginEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOriginEndpoint", params, optFns, addOperationDescribeOriginEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOriginEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
