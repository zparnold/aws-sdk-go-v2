...
func (c *Client) DescribeHarvestJob(ctx context.Context, params *DescribeHarvestJobInput, optFns ...func(*Options)) (*DescribeHarvestJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHarvestJob", params, optFns, addOperationDescribeHarvestJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHarvestJobMiddleware(stack *middleware.Stack, options Options) (err error) {
