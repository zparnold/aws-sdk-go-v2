...
func (c *Client) ListChannels(ctx context.Context, params *ListChannelsInput, optFns ...func(*Options)) (*ListChannelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListChannels", params, optFns, addOperationListChannelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListChannelsMiddleware(stack *middleware.Stack, options Options) (err error) {
