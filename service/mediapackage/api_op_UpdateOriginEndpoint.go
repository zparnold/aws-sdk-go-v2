...
func (c *Client) UpdateOriginEndpoint(ctx context.Context, params *UpdateOriginEndpointInput, optFns ...func(*Options)) (*UpdateOriginEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateOriginEndpoint", params, optFns, addOperationUpdateOriginEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateOriginEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
