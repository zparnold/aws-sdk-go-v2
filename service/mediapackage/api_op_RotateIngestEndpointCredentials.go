...
func (c *Client) RotateIngestEndpointCredentials(ctx context.Context, params *RotateIngestEndpointCredentialsInput, optFns ...func(*Options)) (*RotateIngestEndpointCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RotateIngestEndpointCredentials", params, optFns, addOperationRotateIngestEndpointCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRotateIngestEndpointCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
