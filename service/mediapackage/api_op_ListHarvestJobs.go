...
func (c *Client) ListHarvestJobs(ctx context.Context, params *ListHarvestJobsInput, optFns ...func(*Options)) (*ListHarvestJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHarvestJobs", params, optFns, addOperationListHarvestJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHarvestJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
