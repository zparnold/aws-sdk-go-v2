...
func (c *Client) DeleteOriginEndpoint(ctx context.Context, params *DeleteOriginEndpointInput, optFns ...func(*Options)) (*DeleteOriginEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOriginEndpoint", params, optFns, addOperationDeleteOriginEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOriginEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
