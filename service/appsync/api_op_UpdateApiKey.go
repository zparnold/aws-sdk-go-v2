...
func (c *Client) UpdateApiKey(ctx context.Context, params *UpdateApiKeyInput, optFns ...func(*Options)) (*UpdateApiKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApiKey", params, optFns, addOperationUpdateApiKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApiKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
