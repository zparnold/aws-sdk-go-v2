...
func (c *Client) ListApiKeys(ctx context.Context, params *ListApiKeysInput, optFns ...func(*Options)) (*ListApiKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListApiKeys", params, optFns, addOperationListApiKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListApiKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
