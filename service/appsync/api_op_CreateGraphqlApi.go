...
func (c *Client) CreateGraphqlApi(ctx context.Context, params *CreateGraphqlApiInput, optFns ...func(*Options)) (*CreateGraphqlApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGraphqlApi", params, optFns, addOperationCreateGraphqlApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGraphqlApiMiddleware(stack *middleware.Stack, options Options) (err error) {
