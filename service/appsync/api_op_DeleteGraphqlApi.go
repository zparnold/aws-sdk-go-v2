...
func (c *Client) DeleteGraphqlApi(ctx context.Context, params *DeleteGraphqlApiInput, optFns ...func(*Options)) (*DeleteGraphqlApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGraphqlApi", params, optFns, addOperationDeleteGraphqlApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGraphqlApiMiddleware(stack *middleware.Stack, options Options) (err error) {
