...
func (c *Client) UpdateApiCache(ctx context.Context, params *UpdateApiCacheInput, optFns ...func(*Options)) (*UpdateApiCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApiCache", params, optFns, addOperationUpdateApiCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApiCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
