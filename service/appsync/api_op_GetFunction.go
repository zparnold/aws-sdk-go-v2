...
func (c *Client) GetFunction(ctx context.Context, params *GetFunctionInput, optFns ...func(*Options)) (*GetFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFunction", params, optFns, addOperationGetFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
