...
func (c *Client) CreateResolver(ctx context.Context, params *CreateResolverInput, optFns ...func(*Options)) (*CreateResolverOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResolver", params, optFns, addOperationCreateResolverMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResolverMiddleware(stack *middleware.Stack, options Options) (err error) {
