...
func (c *Client) UpdateFunction(ctx context.Context, params *UpdateFunctionInput, optFns ...func(*Options)) (*UpdateFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFunction", params, optFns, addOperationUpdateFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
