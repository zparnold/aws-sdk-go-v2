...
func (c *Client) UpdateType(ctx context.Context, params *UpdateTypeInput, optFns ...func(*Options)) (*UpdateTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateType", params, optFns, addOperationUpdateTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
