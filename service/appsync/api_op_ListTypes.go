...
func (c *Client) ListTypes(ctx context.Context, params *ListTypesInput, optFns ...func(*Options)) (*ListTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTypes", params, optFns, addOperationListTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
