...
func (c *Client) CreateApiCache(ctx context.Context, params *CreateApiCacheInput, optFns ...func(*Options)) (*CreateApiCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApiCache", params, optFns, addOperationCreateApiCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateApiCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
