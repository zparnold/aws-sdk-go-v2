...
func (c *Client) ListResolvers(ctx context.Context, params *ListResolversInput, optFns ...func(*Options)) (*ListResolversOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResolvers", params, optFns, addOperationListResolversMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResolversMiddleware(stack *middleware.Stack, options Options) (err error) {
