...
func (c *Client) CreateApiKey(ctx context.Context, params *CreateApiKeyInput, optFns ...func(*Options)) (*CreateApiKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApiKey", params, optFns, addOperationCreateApiKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateApiKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
