...
func (c *Client) ListGraphqlApis(ctx context.Context, params *ListGraphqlApisInput, optFns ...func(*Options)) (*ListGraphqlApisOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGraphqlApis", params, optFns, addOperationListGraphqlApisMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGraphqlApisMiddleware(stack *middleware.Stack, options Options) (err error) {
