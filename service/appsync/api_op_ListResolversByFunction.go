...
func (c *Client) ListResolversByFunction(ctx context.Context, params *ListResolversByFunctionInput, optFns ...func(*Options)) (*ListResolversByFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResolversByFunction", params, optFns, addOperationListResolversByFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResolversByFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
