...
func (c *Client) GetApiCache(ctx context.Context, params *GetApiCacheInput, optFns ...func(*Options)) (*GetApiCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApiCache", params, optFns, addOperationGetApiCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApiCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
