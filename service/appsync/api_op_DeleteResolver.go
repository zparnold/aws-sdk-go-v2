...
func (c *Client) DeleteResolver(ctx context.Context, params *DeleteResolverInput, optFns ...func(*Options)) (*DeleteResolverOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResolver", params, optFns, addOperationDeleteResolverMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResolverMiddleware(stack *middleware.Stack, options Options) (err error) {
