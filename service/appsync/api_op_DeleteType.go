...
func (c *Client) DeleteType(ctx context.Context, params *DeleteTypeInput, optFns ...func(*Options)) (*DeleteTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteType", params, optFns, addOperationDeleteTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
