...
func (c *Client) GetType(ctx context.Context, params *GetTypeInput, optFns ...func(*Options)) (*GetTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetType", params, optFns, addOperationGetTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
