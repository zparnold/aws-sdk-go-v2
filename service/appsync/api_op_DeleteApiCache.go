...
func (c *Client) DeleteApiCache(ctx context.Context, params *DeleteApiCacheInput, optFns ...func(*Options)) (*DeleteApiCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApiCache", params, optFns, addOperationDeleteApiCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApiCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
