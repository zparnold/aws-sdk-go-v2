...
func (c *Client) StartSchemaCreation(ctx context.Context, params *StartSchemaCreationInput, optFns ...func(*Options)) (*StartSchemaCreationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSchemaCreation", params, optFns, addOperationStartSchemaCreationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSchemaCreationMiddleware(stack *middleware.Stack, options Options) (err error) {
