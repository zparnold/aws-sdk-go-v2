...
func (c *Client) CreateType(ctx context.Context, params *CreateTypeInput, optFns ...func(*Options)) (*CreateTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateType", params, optFns, addOperationCreateTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
