...
func (c *Client) DeleteFunction(ctx context.Context, params *DeleteFunctionInput, optFns ...func(*Options)) (*DeleteFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFunction", params, optFns, addOperationDeleteFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
