...
func (c *Client) GetIntrospectionSchema(ctx context.Context, params *GetIntrospectionSchemaInput, optFns ...func(*Options)) (*GetIntrospectionSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIntrospectionSchema", params, optFns, addOperationGetIntrospectionSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIntrospectionSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
