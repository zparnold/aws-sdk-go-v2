...
func (c *Client) GetSchemaCreationStatus(ctx context.Context, params *GetSchemaCreationStatusInput, optFns ...func(*Options)) (*GetSchemaCreationStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSchemaCreationStatus", params, optFns, addOperationGetSchemaCreationStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSchemaCreationStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
