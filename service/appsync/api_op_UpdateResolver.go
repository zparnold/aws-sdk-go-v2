...
func (c *Client) UpdateResolver(ctx context.Context, params *UpdateResolverInput, optFns ...func(*Options)) (*UpdateResolverOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResolver", params, optFns, addOperationUpdateResolverMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResolverMiddleware(stack *middleware.Stack, options Options) (err error) {
