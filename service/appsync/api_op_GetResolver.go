...
func (c *Client) GetResolver(ctx context.Context, params *GetResolverInput, optFns ...func(*Options)) (*GetResolverOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResolver", params, optFns, addOperationGetResolverMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResolverMiddleware(stack *middleware.Stack, options Options) (err error) {
