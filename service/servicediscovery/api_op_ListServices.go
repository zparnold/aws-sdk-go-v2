...
func (c *Client) ListServices(ctx context.Context, params *ListServicesInput, optFns ...func(*Options)) (*ListServicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServices", params, optFns, addOperationListServicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServicesMiddleware(stack *middleware.Stack, options Options) (err error) {
