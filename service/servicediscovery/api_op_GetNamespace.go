...
func (c *Client) GetNamespace(ctx context.Context, params *GetNamespaceInput, optFns ...func(*Options)) (*GetNamespaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetNamespace", params, optFns, addOperationGetNamespaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetNamespaceMiddleware(stack *middleware.Stack, options Options) (err error) {
