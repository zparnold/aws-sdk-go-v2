...
func (c *Client) DeleteService(ctx context.Context, params *DeleteServiceInput, optFns ...func(*Options)) (*DeleteServiceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteService", params, optFns, addOperationDeleteServiceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteServiceMiddleware(stack *middleware.Stack, options Options) (err error) {
