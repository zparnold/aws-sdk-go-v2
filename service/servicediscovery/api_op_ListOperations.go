...
func (c *Client) ListOperations(ctx context.Context, params *ListOperationsInput, optFns ...func(*Options)) (*ListOperationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOperations", params, optFns, addOperationListOperationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOperationsMiddleware(stack *middleware.Stack, options Options) (err error) {
