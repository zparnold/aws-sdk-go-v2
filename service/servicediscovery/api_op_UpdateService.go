...
func (c *Client) UpdateService(ctx context.Context, params *UpdateServiceInput, optFns ...func(*Options)) (*UpdateServiceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateService", params, optFns, addOperationUpdateServiceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServiceMiddleware(stack *middleware.Stack, options Options) (err error) {
