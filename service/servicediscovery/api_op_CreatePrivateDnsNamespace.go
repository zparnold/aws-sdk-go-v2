...
func (c *Client) CreatePrivateDnsNamespace(ctx context.Context, params *CreatePrivateDnsNamespaceInput, optFns ...func(*Options)) (*CreatePrivateDnsNamespaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePrivateDnsNamespace", params, optFns, addOperationCreatePrivateDnsNamespaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePrivateDnsNamespaceMiddleware(stack *middleware.Stack, options Options) (err error) {
