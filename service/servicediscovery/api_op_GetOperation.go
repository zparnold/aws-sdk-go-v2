...
func (c *Client) GetOperation(ctx context.Context, params *GetOperationInput, optFns ...func(*Options)) (*GetOperationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOperation", params, optFns, addOperationGetOperationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOperationMiddleware(stack *middleware.Stack, options Options) (err error) {
