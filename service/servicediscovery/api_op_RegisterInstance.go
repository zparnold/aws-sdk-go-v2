...
func (c *Client) RegisterInstance(ctx context.Context, params *RegisterInstanceInput, optFns ...func(*Options)) (*RegisterInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterInstance", params, optFns, addOperationRegisterInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
