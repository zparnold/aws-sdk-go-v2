...
func (c *Client) CreatePublicDnsNamespace(ctx context.Context, params *CreatePublicDnsNamespaceInput, optFns ...func(*Options)) (*CreatePublicDnsNamespaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePublicDnsNamespace", params, optFns, addOperationCreatePublicDnsNamespaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePublicDnsNamespaceMiddleware(stack *middleware.Stack, options Options) (err error) {
