...
func (c *Client) GetInstancesHealthStatus(ctx context.Context, params *GetInstancesHealthStatusInput, optFns ...func(*Options)) (*GetInstancesHealthStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInstancesHealthStatus", params, optFns, addOperationGetInstancesHealthStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInstancesHealthStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
