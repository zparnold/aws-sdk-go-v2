...
func (c *Client) DiscoverInstances(ctx context.Context, params *DiscoverInstancesInput, optFns ...func(*Options)) (*DiscoverInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DiscoverInstances", params, optFns, addOperationDiscoverInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDiscoverInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
