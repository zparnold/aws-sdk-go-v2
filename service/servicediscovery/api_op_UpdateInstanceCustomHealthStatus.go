...
func (c *Client) UpdateInstanceCustomHealthStatus(ctx context.Context, params *UpdateInstanceCustomHealthStatusInput, optFns ...func(*Options)) (*UpdateInstanceCustomHealthStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateInstanceCustomHealthStatus", params, optFns, addOperationUpdateInstanceCustomHealthStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateInstanceCustomHealthStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
