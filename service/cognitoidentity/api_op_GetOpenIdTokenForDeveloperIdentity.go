...
func (c *Client) GetOpenIdTokenForDeveloperIdentity(ctx context.Context, params *GetOpenIdTokenForDeveloperIdentityInput, optFns ...func(*Options)) (*GetOpenIdTokenForDeveloperIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOpenIdTokenForDeveloperIdentity", params, optFns, addOperationGetOpenIdTokenForDeveloperIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOpenIdTokenForDeveloperIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
