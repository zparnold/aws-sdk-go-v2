...
func (c *Client) ListIdentityPools(ctx context.Context, params *ListIdentityPoolsInput, optFns ...func(*Options)) (*ListIdentityPoolsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIdentityPools", params, optFns, addOperationListIdentityPoolsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIdentityPoolsMiddleware(stack *middleware.Stack, options Options) (err error) {
