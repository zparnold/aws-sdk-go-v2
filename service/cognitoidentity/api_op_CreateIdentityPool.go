...
func (c *Client) CreateIdentityPool(ctx context.Context, params *CreateIdentityPoolInput, optFns ...func(*Options)) (*CreateIdentityPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIdentityPool", params, optFns, addOperationCreateIdentityPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIdentityPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
