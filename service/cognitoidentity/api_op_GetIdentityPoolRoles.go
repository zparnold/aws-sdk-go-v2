...
func (c *Client) GetIdentityPoolRoles(ctx context.Context, params *GetIdentityPoolRolesInput, optFns ...func(*Options)) (*GetIdentityPoolRolesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityPoolRoles", params, optFns, addOperationGetIdentityPoolRolesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityPoolRolesMiddleware(stack *middleware.Stack, options Options) (err error) {
