...
func (c *Client) UnlinkIdentity(ctx context.Context, params *UnlinkIdentityInput, optFns ...func(*Options)) (*UnlinkIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnlinkIdentity", params, optFns, addOperationUnlinkIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnlinkIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
