...
func (c *Client) GetOpenIdToken(ctx context.Context, params *GetOpenIdTokenInput, optFns ...func(*Options)) (*GetOpenIdTokenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOpenIdToken", params, optFns, addOperationGetOpenIdTokenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOpenIdTokenMiddleware(stack *middleware.Stack, options Options) (err error) {
