...
func (c *Client) DescribeIdentityPool(ctx context.Context, params *DescribeIdentityPoolInput, optFns ...func(*Options)) (*DescribeIdentityPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIdentityPool", params, optFns, addOperationDescribeIdentityPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIdentityPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
