...
func (c *Client) DescribeIdentity(ctx context.Context, params *DescribeIdentityInput, optFns ...func(*Options)) (*DescribeIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIdentity", params, optFns, addOperationDescribeIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
