...
func (c *Client) UpdateIdentityPool(ctx context.Context, params *UpdateIdentityPoolInput, optFns ...func(*Options)) (*UpdateIdentityPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIdentityPool", params, optFns, addOperationUpdateIdentityPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIdentityPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
