...
func (c *Client) UnlinkDeveloperIdentity(ctx context.Context, params *UnlinkDeveloperIdentityInput, optFns ...func(*Options)) (*UnlinkDeveloperIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnlinkDeveloperIdentity", params, optFns, addOperationUnlinkDeveloperIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnlinkDeveloperIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
