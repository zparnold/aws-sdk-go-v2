...
func (c *Client) DeleteIdentityPool(ctx context.Context, params *DeleteIdentityPoolInput, optFns ...func(*Options)) (*DeleteIdentityPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIdentityPool", params, optFns, addOperationDeleteIdentityPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIdentityPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
