...
func (c *Client) LookupDeveloperIdentity(ctx context.Context, params *LookupDeveloperIdentityInput, optFns ...func(*Options)) (*LookupDeveloperIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "LookupDeveloperIdentity", params, optFns, addOperationLookupDeveloperIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLookupDeveloperIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
