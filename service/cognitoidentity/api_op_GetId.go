...
func (c *Client) GetId(ctx context.Context, params *GetIdInput, optFns ...func(*Options)) (*GetIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetId", params, optFns, addOperationGetIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdMiddleware(stack *middleware.Stack, options Options) (err error) {
