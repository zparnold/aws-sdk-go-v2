...
func (c *Client) GetCredentialsForIdentity(ctx context.Context, params *GetCredentialsForIdentityInput, optFns ...func(*Options)) (*GetCredentialsForIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCredentialsForIdentity", params, optFns, addOperationGetCredentialsForIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCredentialsForIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
