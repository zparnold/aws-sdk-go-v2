...
func (c *Client) SetIdentityPoolRoles(ctx context.Context, params *SetIdentityPoolRolesInput, optFns ...func(*Options)) (*SetIdentityPoolRolesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIdentityPoolRoles", params, optFns, addOperationSetIdentityPoolRolesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIdentityPoolRolesMiddleware(stack *middleware.Stack, options Options) (err error) {
