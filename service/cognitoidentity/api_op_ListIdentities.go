...
func (c *Client) ListIdentities(ctx context.Context, params *ListIdentitiesInput, optFns ...func(*Options)) (*ListIdentitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIdentities", params, optFns, addOperationListIdentitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIdentitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
