...
func (c *Client) ListDeliveryStreams(ctx context.Context, params *ListDeliveryStreamsInput, optFns ...func(*Options)) (*ListDeliveryStreamsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeliveryStreams", params, optFns, addOperationListDeliveryStreamsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeliveryStreamsMiddleware(stack *middleware.Stack, options Options) (err error) {
