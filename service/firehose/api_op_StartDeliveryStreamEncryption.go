...
func (c *Client) StartDeliveryStreamEncryption(ctx context.Context, params *StartDeliveryStreamEncryptionInput, optFns ...func(*Options)) (*StartDeliveryStreamEncryptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDeliveryStreamEncryption", params, optFns, addOperationStartDeliveryStreamEncryptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDeliveryStreamEncryptionMiddleware(stack *middleware.Stack, options Options) (err error) {
