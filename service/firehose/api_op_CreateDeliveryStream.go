...
func (c *Client) CreateDeliveryStream(ctx context.Context, params *CreateDeliveryStreamInput, optFns ...func(*Options)) (*CreateDeliveryStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDeliveryStream", params, optFns, addOperationCreateDeliveryStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDeliveryStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
