...
func (c *Client) PutRecordBatch(ctx context.Context, params *PutRecordBatchInput, optFns ...func(*Options)) (*PutRecordBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRecordBatch", params, optFns, addOperationPutRecordBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRecordBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
