...
func (c *Client) DescribeDeliveryStream(ctx context.Context, params *DescribeDeliveryStreamInput, optFns ...func(*Options)) (*DescribeDeliveryStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDeliveryStream", params, optFns, addOperationDescribeDeliveryStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDeliveryStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
