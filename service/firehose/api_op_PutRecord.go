...
func (c *Client) PutRecord(ctx context.Context, params *PutRecordInput, optFns ...func(*Options)) (*PutRecordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRecord", params, optFns, addOperationPutRecordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRecordMiddleware(stack *middleware.Stack, options Options) (err error) {
