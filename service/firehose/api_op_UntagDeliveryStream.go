...
func (c *Client) UntagDeliveryStream(ctx context.Context, params *UntagDeliveryStreamInput, optFns ...func(*Options)) (*UntagDeliveryStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagDeliveryStream", params, optFns, addOperationUntagDeliveryStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagDeliveryStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
