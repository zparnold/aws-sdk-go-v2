...
func (c *Client) DeleteDeliveryStream(ctx context.Context, params *DeleteDeliveryStreamInput, optFns ...func(*Options)) (*DeleteDeliveryStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeliveryStream", params, optFns, addOperationDeleteDeliveryStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeliveryStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
