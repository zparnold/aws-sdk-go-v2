...
func (c *Client) UpdateDestination(ctx context.Context, params *UpdateDestinationInput, optFns ...func(*Options)) (*UpdateDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDestination", params, optFns, addOperationUpdateDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
