...
func (c *Client) TagDeliveryStream(ctx context.Context, params *TagDeliveryStreamInput, optFns ...func(*Options)) (*TagDeliveryStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagDeliveryStream", params, optFns, addOperationTagDeliveryStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagDeliveryStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
