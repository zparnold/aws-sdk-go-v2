...
func (c *Client) DescribeTargetGroups(ctx context.Context, params *DescribeTargetGroupsInput, optFns ...func(*Options)) (*DescribeTargetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTargetGroups", params, optFns, addOperationDescribeTargetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTargetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
