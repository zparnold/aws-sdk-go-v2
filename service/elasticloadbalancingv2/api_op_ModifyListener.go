...
func (c *Client) ModifyListener(ctx context.Context, params *ModifyListenerInput, optFns ...func(*Options)) (*ModifyListenerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyListener", params, optFns, addOperationModifyListenerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyListenerMiddleware(stack *middleware.Stack, options Options) (err error) {
