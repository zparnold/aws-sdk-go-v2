...
func (c *Client) DescribeRules(ctx context.Context, params *DescribeRulesInput, optFns ...func(*Options)) (*DescribeRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRules", params, optFns, addOperationDescribeRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
