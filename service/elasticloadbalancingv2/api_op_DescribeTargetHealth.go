...
func (c *Client) DescribeTargetHealth(ctx context.Context, params *DescribeTargetHealthInput, optFns ...func(*Options)) (*DescribeTargetHealthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTargetHealth", params, optFns, addOperationDescribeTargetHealthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTargetHealthMiddleware(stack *middleware.Stack, options Options) (err error) {
