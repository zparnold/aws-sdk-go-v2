...
func (c *Client) DeleteTargetGroup(ctx context.Context, params *DeleteTargetGroupInput, optFns ...func(*Options)) (*DeleteTargetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTargetGroup", params, optFns, addOperationDeleteTargetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTargetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
