...
func (c *Client) DescribeLoadBalancerAttributes(ctx context.Context, params *DescribeLoadBalancerAttributesInput, optFns ...func(*Options)) (*DescribeLoadBalancerAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoadBalancerAttributes", params, optFns, addOperationDescribeLoadBalancerAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoadBalancerAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
