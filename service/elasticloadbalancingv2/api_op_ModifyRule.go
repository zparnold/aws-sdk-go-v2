...
func (c *Client) ModifyRule(ctx context.Context, params *ModifyRuleInput, optFns ...func(*Options)) (*ModifyRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyRule", params, optFns, addOperationModifyRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
