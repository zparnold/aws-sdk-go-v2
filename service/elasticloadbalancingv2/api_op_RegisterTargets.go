...
func (c *Client) RegisterTargets(ctx context.Context, params *RegisterTargetsInput, optFns ...func(*Options)) (*RegisterTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterTargets", params, optFns, addOperationRegisterTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
