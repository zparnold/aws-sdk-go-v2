...
func (c *Client) DeleteListener(ctx context.Context, params *DeleteListenerInput, optFns ...func(*Options)) (*DeleteListenerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteListener", params, optFns, addOperationDeleteListenerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteListenerMiddleware(stack *middleware.Stack, options Options) (err error) {
