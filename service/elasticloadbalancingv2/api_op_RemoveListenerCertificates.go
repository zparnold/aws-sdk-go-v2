...
func (c *Client) RemoveListenerCertificates(ctx context.Context, params *RemoveListenerCertificatesInput, optFns ...func(*Options)) (*RemoveListenerCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveListenerCertificates", params, optFns, addOperationRemoveListenerCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveListenerCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
