...
func (c *Client) CreateLoadBalancer(ctx context.Context, params *CreateLoadBalancerInput, optFns ...func(*Options)) (*CreateLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLoadBalancer", params, optFns, addOperationCreateLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
