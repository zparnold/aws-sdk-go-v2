...
func (c *Client) CreateListener(ctx context.Context, params *CreateListenerInput, optFns ...func(*Options)) (*CreateListenerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateListener", params, optFns, addOperationCreateListenerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateListenerMiddleware(stack *middleware.Stack, options Options) (err error) {
