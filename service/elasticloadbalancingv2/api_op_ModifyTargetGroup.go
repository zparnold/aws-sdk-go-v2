...
func (c *Client) ModifyTargetGroup(ctx context.Context, params *ModifyTargetGroupInput, optFns ...func(*Options)) (*ModifyTargetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyTargetGroup", params, optFns, addOperationModifyTargetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyTargetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
