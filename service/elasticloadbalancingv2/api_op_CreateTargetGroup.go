...
func (c *Client) CreateTargetGroup(ctx context.Context, params *CreateTargetGroupInput, optFns ...func(*Options)) (*CreateTargetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTargetGroup", params, optFns, addOperationCreateTargetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTargetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
