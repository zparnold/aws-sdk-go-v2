...
func (c *Client) DescribeListenerCertificates(ctx context.Context, params *DescribeListenerCertificatesInput, optFns ...func(*Options)) (*DescribeListenerCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeListenerCertificates", params, optFns, addOperationDescribeListenerCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeListenerCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
