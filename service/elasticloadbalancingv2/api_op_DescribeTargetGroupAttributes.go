...
func (c *Client) DescribeTargetGroupAttributes(ctx context.Context, params *DescribeTargetGroupAttributesInput, optFns ...func(*Options)) (*DescribeTargetGroupAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTargetGroupAttributes", params, optFns, addOperationDescribeTargetGroupAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTargetGroupAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
