...
func (c *Client) SetSecurityGroups(ctx context.Context, params *SetSecurityGroupsInput, optFns ...func(*Options)) (*SetSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetSecurityGroups", params, optFns, addOperationSetSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
