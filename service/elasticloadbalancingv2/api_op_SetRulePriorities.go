...
func (c *Client) SetRulePriorities(ctx context.Context, params *SetRulePrioritiesInput, optFns ...func(*Options)) (*SetRulePrioritiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetRulePriorities", params, optFns, addOperationSetRulePrioritiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetRulePrioritiesMiddleware(stack *middleware.Stack, options Options) (err error) {
