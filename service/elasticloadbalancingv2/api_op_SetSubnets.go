...
func (c *Client) SetSubnets(ctx context.Context, params *SetSubnetsInput, optFns ...func(*Options)) (*SetSubnetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetSubnets", params, optFns, addOperationSetSubnetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetSubnetsMiddleware(stack *middleware.Stack, options Options) (err error) {
