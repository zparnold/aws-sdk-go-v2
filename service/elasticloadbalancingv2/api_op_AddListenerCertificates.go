...
func (c *Client) AddListenerCertificates(ctx context.Context, params *AddListenerCertificatesInput, optFns ...func(*Options)) (*AddListenerCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddListenerCertificates", params, optFns, addOperationAddListenerCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddListenerCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
