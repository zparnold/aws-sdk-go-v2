...
func (c *Client) DescribeListeners(ctx context.Context, params *DescribeListenersInput, optFns ...func(*Options)) (*DescribeListenersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeListeners", params, optFns, addOperationDescribeListenersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeListenersMiddleware(stack *middleware.Stack, options Options) (err error) {
