...
func (c *Client) SetIpAddressType(ctx context.Context, params *SetIpAddressTypeInput, optFns ...func(*Options)) (*SetIpAddressTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIpAddressType", params, optFns, addOperationSetIpAddressTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIpAddressTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
