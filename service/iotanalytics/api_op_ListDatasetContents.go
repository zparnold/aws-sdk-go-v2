...
func (c *Client) ListDatasetContents(ctx context.Context, params *ListDatasetContentsInput, optFns ...func(*Options)) (*ListDatasetContentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDatasetContents", params, optFns, addOperationListDatasetContentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDatasetContentsMiddleware(stack *middleware.Stack, options Options) (err error) {
