...
func (c *Client) SampleChannelData(ctx context.Context, params *SampleChannelDataInput, optFns ...func(*Options)) (*SampleChannelDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SampleChannelData", params, optFns, addOperationSampleChannelDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSampleChannelDataMiddleware(stack *middleware.Stack, options Options) (err error) {
