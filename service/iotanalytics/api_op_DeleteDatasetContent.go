...
func (c *Client) DeleteDatasetContent(ctx context.Context, params *DeleteDatasetContentInput, optFns ...func(*Options)) (*DeleteDatasetContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDatasetContent", params, optFns, addOperationDeleteDatasetContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDatasetContentMiddleware(stack *middleware.Stack, options Options) (err error) {
