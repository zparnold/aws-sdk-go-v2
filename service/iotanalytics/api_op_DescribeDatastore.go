...
func (c *Client) DescribeDatastore(ctx context.Context, params *DescribeDatastoreInput, optFns ...func(*Options)) (*DescribeDatastoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDatastore", params, optFns, addOperationDescribeDatastoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDatastoreMiddleware(stack *middleware.Stack, options Options) (err error) {
