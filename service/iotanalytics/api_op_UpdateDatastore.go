...
func (c *Client) UpdateDatastore(ctx context.Context, params *UpdateDatastoreInput, optFns ...func(*Options)) (*UpdateDatastoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDatastore", params, optFns, addOperationUpdateDatastoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDatastoreMiddleware(stack *middleware.Stack, options Options) (err error) {
