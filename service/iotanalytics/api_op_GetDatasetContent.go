...
func (c *Client) GetDatasetContent(ctx context.Context, params *GetDatasetContentInput, optFns ...func(*Options)) (*GetDatasetContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDatasetContent", params, optFns, addOperationGetDatasetContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDatasetContentMiddleware(stack *middleware.Stack, options Options) (err error) {
