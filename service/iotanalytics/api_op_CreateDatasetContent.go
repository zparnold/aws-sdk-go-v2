...
func (c *Client) CreateDatasetContent(ctx context.Context, params *CreateDatasetContentInput, optFns ...func(*Options)) (*CreateDatasetContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDatasetContent", params, optFns, addOperationCreateDatasetContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDatasetContentMiddleware(stack *middleware.Stack, options Options) (err error) {
