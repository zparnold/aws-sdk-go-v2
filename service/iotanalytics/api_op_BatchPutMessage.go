...
func (c *Client) BatchPutMessage(ctx context.Context, params *BatchPutMessageInput, optFns ...func(*Options)) (*BatchPutMessageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchPutMessage", params, optFns, addOperationBatchPutMessageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchPutMessageMiddleware(stack *middleware.Stack, options Options) (err error) {
