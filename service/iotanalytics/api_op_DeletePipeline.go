...
func (c *Client) DeletePipeline(ctx context.Context, params *DeletePipelineInput, optFns ...func(*Options)) (*DeletePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePipeline", params, optFns, addOperationDeletePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
