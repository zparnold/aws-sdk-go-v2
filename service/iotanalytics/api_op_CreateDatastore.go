...
func (c *Client) CreateDatastore(ctx context.Context, params *CreateDatastoreInput, optFns ...func(*Options)) (*CreateDatastoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDatastore", params, optFns, addOperationCreateDatastoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDatastoreMiddleware(stack *middleware.Stack, options Options) (err error) {
