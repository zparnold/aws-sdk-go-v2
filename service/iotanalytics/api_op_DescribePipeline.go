...
func (c *Client) DescribePipeline(ctx context.Context, params *DescribePipelineInput, optFns ...func(*Options)) (*DescribePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePipeline", params, optFns, addOperationDescribePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
