...
func (c *Client) DeleteDatastore(ctx context.Context, params *DeleteDatastoreInput, optFns ...func(*Options)) (*DeleteDatastoreOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDatastore", params, optFns, addOperationDeleteDatastoreMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDatastoreMiddleware(stack *middleware.Stack, options Options) (err error) {
