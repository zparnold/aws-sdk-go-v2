...
func (c *Client) StartPipelineReprocessing(ctx context.Context, params *StartPipelineReprocessingInput, optFns ...func(*Options)) (*StartPipelineReprocessingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartPipelineReprocessing", params, optFns, addOperationStartPipelineReprocessingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartPipelineReprocessingMiddleware(stack *middleware.Stack, options Options) (err error) {
