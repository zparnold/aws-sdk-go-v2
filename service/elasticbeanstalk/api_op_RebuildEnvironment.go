...
func (c *Client) RebuildEnvironment(ctx context.Context, params *RebuildEnvironmentInput, optFns ...func(*Options)) (*RebuildEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebuildEnvironment", params, optFns, addOperationRebuildEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebuildEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
