...
func (c *Client) AbortEnvironmentUpdate(ctx context.Context, params *AbortEnvironmentUpdateInput, optFns ...func(*Options)) (*AbortEnvironmentUpdateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AbortEnvironmentUpdate", params, optFns, addOperationAbortEnvironmentUpdateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAbortEnvironmentUpdateMiddleware(stack *middleware.Stack, options Options) (err error) {
