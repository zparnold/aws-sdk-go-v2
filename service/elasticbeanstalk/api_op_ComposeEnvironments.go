...
func (c *Client) ComposeEnvironments(ctx context.Context, params *ComposeEnvironmentsInput, optFns ...func(*Options)) (*ComposeEnvironmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ComposeEnvironments", params, optFns, addOperationComposeEnvironmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationComposeEnvironmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
