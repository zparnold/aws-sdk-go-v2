...
func (c *Client) UpdateConfigurationTemplate(ctx context.Context, params *UpdateConfigurationTemplateInput, optFns ...func(*Options)) (*UpdateConfigurationTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConfigurationTemplate", params, optFns, addOperationUpdateConfigurationTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConfigurationTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
