...
func (c *Client) DescribeEnvironmentManagedActions(ctx context.Context, params *DescribeEnvironmentManagedActionsInput, optFns ...func(*Options)) (*DescribeEnvironmentManagedActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEnvironmentManagedActions", params, optFns, addOperationDescribeEnvironmentManagedActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEnvironmentManagedActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
