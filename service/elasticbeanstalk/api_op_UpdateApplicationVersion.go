...
func (c *Client) UpdateApplicationVersion(ctx context.Context, params *UpdateApplicationVersionInput, optFns ...func(*Options)) (*UpdateApplicationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateApplicationVersion", params, optFns, addOperationUpdateApplicationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateApplicationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
