...
func (c *Client) DeleteConfigurationTemplate(ctx context.Context, params *DeleteConfigurationTemplateInput, optFns ...func(*Options)) (*DeleteConfigurationTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConfigurationTemplate", params, optFns, addOperationDeleteConfigurationTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConfigurationTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
