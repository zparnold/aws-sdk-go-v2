...
func (c *Client) DescribeInstancesHealth(ctx context.Context, params *DescribeInstancesHealthInput, optFns ...func(*Options)) (*DescribeInstancesHealthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstancesHealth", params, optFns, addOperationDescribeInstancesHealthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstancesHealthMiddleware(stack *middleware.Stack, options Options) (err error) {
