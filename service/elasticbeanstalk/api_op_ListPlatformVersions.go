...
func (c *Client) ListPlatformVersions(ctx context.Context, params *ListPlatformVersionsInput, optFns ...func(*Options)) (*ListPlatformVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPlatformVersions", params, optFns, addOperationListPlatformVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPlatformVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
