...
func (c *Client) ApplyEnvironmentManagedAction(ctx context.Context, params *ApplyEnvironmentManagedActionInput, optFns ...func(*Options)) (*ApplyEnvironmentManagedActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ApplyEnvironmentManagedAction", params, optFns, addOperationApplyEnvironmentManagedActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationApplyEnvironmentManagedActionMiddleware(stack *middleware.Stack, options Options) (err error) {
