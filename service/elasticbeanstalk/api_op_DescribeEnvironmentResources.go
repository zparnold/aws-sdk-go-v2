...
func (c *Client) DescribeEnvironmentResources(ctx context.Context, params *DescribeEnvironmentResourcesInput, optFns ...func(*Options)) (*DescribeEnvironmentResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEnvironmentResources", params, optFns, addOperationDescribeEnvironmentResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEnvironmentResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
