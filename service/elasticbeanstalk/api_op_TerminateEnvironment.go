...
func (c *Client) TerminateEnvironment(ctx context.Context, params *TerminateEnvironmentInput, optFns ...func(*Options)) (*TerminateEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateEnvironment", params, optFns, addOperationTerminateEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
