...
func (c *Client) DescribeEnvironmentHealth(ctx context.Context, params *DescribeEnvironmentHealthInput, optFns ...func(*Options)) (*DescribeEnvironmentHealthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEnvironmentHealth", params, optFns, addOperationDescribeEnvironmentHealthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEnvironmentHealthMiddleware(stack *middleware.Stack, options Options) (err error) {
