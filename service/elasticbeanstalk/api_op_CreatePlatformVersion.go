...
func (c *Client) CreatePlatformVersion(ctx context.Context, params *CreatePlatformVersionInput, optFns ...func(*Options)) (*CreatePlatformVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePlatformVersion", params, optFns, addOperationCreatePlatformVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePlatformVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
