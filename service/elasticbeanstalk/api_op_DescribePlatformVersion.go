...
func (c *Client) DescribePlatformVersion(ctx context.Context, params *DescribePlatformVersionInput, optFns ...func(*Options)) (*DescribePlatformVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePlatformVersion", params, optFns, addOperationDescribePlatformVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePlatformVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
