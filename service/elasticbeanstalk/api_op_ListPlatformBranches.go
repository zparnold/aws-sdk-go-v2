...
func (c *Client) ListPlatformBranches(ctx context.Context, params *ListPlatformBranchesInput, optFns ...func(*Options)) (*ListPlatformBranchesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPlatformBranches", params, optFns, addOperationListPlatformBranchesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPlatformBranchesMiddleware(stack *middleware.Stack, options Options) (err error) {
