...
func (c *Client) DeleteEnvironmentConfiguration(ctx context.Context, params *DeleteEnvironmentConfigurationInput, optFns ...func(*Options)) (*DeleteEnvironmentConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEnvironmentConfiguration", params, optFns, addOperationDeleteEnvironmentConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEnvironmentConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
