...
func (c *Client) DescribeApplications(ctx context.Context, params *DescribeApplicationsInput, optFns ...func(*Options)) (*DescribeApplicationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeApplications", params, optFns, addOperationDescribeApplicationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeApplicationsMiddleware(stack *middleware.Stack, options Options) (err error) {
