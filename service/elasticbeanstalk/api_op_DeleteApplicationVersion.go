...
func (c *Client) DeleteApplicationVersion(ctx context.Context, params *DeleteApplicationVersionInput, optFns ...func(*Options)) (*DeleteApplicationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApplicationVersion", params, optFns, addOperationDeleteApplicationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApplicationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
