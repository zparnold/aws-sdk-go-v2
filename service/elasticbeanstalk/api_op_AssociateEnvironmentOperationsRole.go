...
func (c *Client) AssociateEnvironmentOperationsRole(ctx context.Context, params *AssociateEnvironmentOperationsRoleInput, optFns ...func(*Options)) (*AssociateEnvironmentOperationsRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateEnvironmentOperationsRole", params, optFns, addOperationAssociateEnvironmentOperationsRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateEnvironmentOperationsRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
