...
func (c *Client) SwapEnvironmentCNAMEs(ctx context.Context, params *SwapEnvironmentCNAMEsInput, optFns ...func(*Options)) (*SwapEnvironmentCNAMEsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SwapEnvironmentCNAMEs", params, optFns, addOperationSwapEnvironmentCNAMEsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSwapEnvironmentCNAMEsMiddleware(stack *middleware.Stack, options Options) (err error) {
