...
func (c *Client) DeletePlatformVersion(ctx context.Context, params *DeletePlatformVersionInput, optFns ...func(*Options)) (*DeletePlatformVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePlatformVersion", params, optFns, addOperationDeletePlatformVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePlatformVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
