...
func (c *Client) DescribeConfigurationSettings(ctx context.Context, params *DescribeConfigurationSettingsInput, optFns ...func(*Options)) (*DescribeConfigurationSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationSettings", params, optFns, addOperationDescribeConfigurationSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
