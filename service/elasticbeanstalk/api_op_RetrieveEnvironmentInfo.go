...
func (c *Client) RetrieveEnvironmentInfo(ctx context.Context, params *RetrieveEnvironmentInfoInput, optFns ...func(*Options)) (*RetrieveEnvironmentInfoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetrieveEnvironmentInfo", params, optFns, addOperationRetrieveEnvironmentInfoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetrieveEnvironmentInfoMiddleware(stack *middleware.Stack, options Options) (err error) {
