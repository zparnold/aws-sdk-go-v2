...
func (c *Client) RestartAppServer(ctx context.Context, params *RestartAppServerInput, optFns ...func(*Options)) (*RestartAppServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestartAppServer", params, optFns, addOperationRestartAppServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestartAppServerMiddleware(stack *middleware.Stack, options Options) (err error) {
