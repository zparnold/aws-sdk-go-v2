...
func (c *Client) CreateConfigurationTemplate(ctx context.Context, params *CreateConfigurationTemplateInput, optFns ...func(*Options)) (*CreateConfigurationTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConfigurationTemplate", params, optFns, addOperationCreateConfigurationTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConfigurationTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
