...
func (c *Client) ListAvailableSolutionStacks(ctx context.Context, params *ListAvailableSolutionStacksInput, optFns ...func(*Options)) (*ListAvailableSolutionStacksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAvailableSolutionStacks", params, optFns, addOperationListAvailableSolutionStacksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAvailableSolutionStacksMiddleware(stack *middleware.Stack, options Options) (err error) {
