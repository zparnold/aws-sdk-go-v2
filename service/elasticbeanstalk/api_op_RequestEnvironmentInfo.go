...
func (c *Client) RequestEnvironmentInfo(ctx context.Context, params *RequestEnvironmentInfoInput, optFns ...func(*Options)) (*RequestEnvironmentInfoOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RequestEnvironmentInfo", params, optFns, addOperationRequestEnvironmentInfoMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRequestEnvironmentInfoMiddleware(stack *middleware.Stack, options Options) (err error) {
