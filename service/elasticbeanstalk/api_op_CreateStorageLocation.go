...
func (c *Client) CreateStorageLocation(ctx context.Context, params *CreateStorageLocationInput, optFns ...func(*Options)) (*CreateStorageLocationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStorageLocation", params, optFns, addOperationCreateStorageLocationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStorageLocationMiddleware(stack *middleware.Stack, options Options) (err error) {
