...
func (c *Client) CheckDNSAvailability(ctx context.Context, params *CheckDNSAvailabilityInput, optFns ...func(*Options)) (*CheckDNSAvailabilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CheckDNSAvailability", params, optFns, addOperationCheckDNSAvailabilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCheckDNSAvailabilityMiddleware(stack *middleware.Stack, options Options) (err error) {
