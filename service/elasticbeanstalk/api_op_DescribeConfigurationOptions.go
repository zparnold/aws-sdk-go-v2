...
func (c *Client) DescribeConfigurationOptions(ctx context.Context, params *DescribeConfigurationOptionsInput, optFns ...func(*Options)) (*DescribeConfigurationOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationOptions", params, optFns, addOperationDescribeConfigurationOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
