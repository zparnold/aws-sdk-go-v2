...
func (c *Client) ValidateConfigurationSettings(ctx context.Context, params *ValidateConfigurationSettingsInput, optFns ...func(*Options)) (*ValidateConfigurationSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ValidateConfigurationSettings", params, optFns, addOperationValidateConfigurationSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationValidateConfigurationSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
