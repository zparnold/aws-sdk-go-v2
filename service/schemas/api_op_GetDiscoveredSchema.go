...
func (c *Client) GetDiscoveredSchema(ctx context.Context, params *GetDiscoveredSchemaInput, optFns ...func(*Options)) (*GetDiscoveredSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDiscoveredSchema", params, optFns, addOperationGetDiscoveredSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDiscoveredSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
