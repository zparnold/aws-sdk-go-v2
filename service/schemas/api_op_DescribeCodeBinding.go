...
func (c *Client) DescribeCodeBinding(ctx context.Context, params *DescribeCodeBindingInput, optFns ...func(*Options)) (*DescribeCodeBindingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCodeBinding", params, optFns, addOperationDescribeCodeBindingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCodeBindingMiddleware(stack *middleware.Stack, options Options) (err error) {
