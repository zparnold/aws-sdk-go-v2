...
func (c *Client) DeleteDiscoverer(ctx context.Context, params *DeleteDiscovererInput, optFns ...func(*Options)) (*DeleteDiscovererOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDiscoverer", params, optFns, addOperationDeleteDiscovererMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDiscovererMiddleware(stack *middleware.Stack, options Options) (err error) {
