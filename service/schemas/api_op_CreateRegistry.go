...
func (c *Client) CreateRegistry(ctx context.Context, params *CreateRegistryInput, optFns ...func(*Options)) (*CreateRegistryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRegistry", params, optFns, addOperationCreateRegistryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRegistryMiddleware(stack *middleware.Stack, options Options) (err error) {
