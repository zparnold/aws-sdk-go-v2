...
func (c *Client) UpdateRegistry(ctx context.Context, params *UpdateRegistryInput, optFns ...func(*Options)) (*UpdateRegistryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRegistry", params, optFns, addOperationUpdateRegistryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRegistryMiddleware(stack *middleware.Stack, options Options) (err error) {
