...
func (c *Client) GetCodeBindingSource(ctx context.Context, params *GetCodeBindingSourceInput, optFns ...func(*Options)) (*GetCodeBindingSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCodeBindingSource", params, optFns, addOperationGetCodeBindingSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCodeBindingSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
