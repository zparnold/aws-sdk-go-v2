...
func (c *Client) StopDiscoverer(ctx context.Context, params *StopDiscovererInput, optFns ...func(*Options)) (*StopDiscovererOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopDiscoverer", params, optFns, addOperationStopDiscovererMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopDiscovererMiddleware(stack *middleware.Stack, options Options) (err error) {
