...
func (c *Client) PutCodeBinding(ctx context.Context, params *PutCodeBindingInput, optFns ...func(*Options)) (*PutCodeBindingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutCodeBinding", params, optFns, addOperationPutCodeBindingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutCodeBindingMiddleware(stack *middleware.Stack, options Options) (err error) {
