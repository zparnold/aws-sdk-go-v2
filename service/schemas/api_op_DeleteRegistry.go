...
func (c *Client) DeleteRegistry(ctx context.Context, params *DeleteRegistryInput, optFns ...func(*Options)) (*DeleteRegistryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRegistry", params, optFns, addOperationDeleteRegistryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRegistryMiddleware(stack *middleware.Stack, options Options) (err error) {
