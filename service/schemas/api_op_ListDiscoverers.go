...
func (c *Client) ListDiscoverers(ctx context.Context, params *ListDiscoverersInput, optFns ...func(*Options)) (*ListDiscoverersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDiscoverers", params, optFns, addOperationListDiscoverersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDiscoverersMiddleware(stack *middleware.Stack, options Options) (err error) {
