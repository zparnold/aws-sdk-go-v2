...
func (c *Client) SearchSchemas(ctx context.Context, params *SearchSchemasInput, optFns ...func(*Options)) (*SearchSchemasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchSchemas", params, optFns, addOperationSearchSchemasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchSchemasMiddleware(stack *middleware.Stack, options Options) (err error) {
