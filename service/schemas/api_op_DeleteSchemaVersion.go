...
func (c *Client) DeleteSchemaVersion(ctx context.Context, params *DeleteSchemaVersionInput, optFns ...func(*Options)) (*DeleteSchemaVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSchemaVersion", params, optFns, addOperationDeleteSchemaVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSchemaVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
