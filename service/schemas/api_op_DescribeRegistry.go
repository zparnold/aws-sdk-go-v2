...
func (c *Client) DescribeRegistry(ctx context.Context, params *DescribeRegistryInput, optFns ...func(*Options)) (*DescribeRegistryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRegistry", params, optFns, addOperationDescribeRegistryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRegistryMiddleware(stack *middleware.Stack, options Options) (err error) {
