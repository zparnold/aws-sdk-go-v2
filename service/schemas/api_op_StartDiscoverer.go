...
func (c *Client) StartDiscoverer(ctx context.Context, params *StartDiscovererInput, optFns ...func(*Options)) (*StartDiscovererOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDiscoverer", params, optFns, addOperationStartDiscovererMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDiscovererMiddleware(stack *middleware.Stack, options Options) (err error) {
