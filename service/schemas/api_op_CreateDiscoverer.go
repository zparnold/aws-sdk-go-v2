...
func (c *Client) CreateDiscoverer(ctx context.Context, params *CreateDiscovererInput, optFns ...func(*Options)) (*CreateDiscovererOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDiscoverer", params, optFns, addOperationCreateDiscovererMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDiscovererMiddleware(stack *middleware.Stack, options Options) (err error) {
