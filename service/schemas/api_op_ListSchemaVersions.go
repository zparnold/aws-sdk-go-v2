...
func (c *Client) ListSchemaVersions(ctx context.Context, params *ListSchemaVersionsInput, optFns ...func(*Options)) (*ListSchemaVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSchemaVersions", params, optFns, addOperationListSchemaVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSchemaVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
