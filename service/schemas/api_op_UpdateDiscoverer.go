...
func (c *Client) UpdateDiscoverer(ctx context.Context, params *UpdateDiscovererInput, optFns ...func(*Options)) (*UpdateDiscovererOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDiscoverer", params, optFns, addOperationUpdateDiscovererMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDiscovererMiddleware(stack *middleware.Stack, options Options) (err error) {
