...
func (c *Client) ListSchemas(ctx context.Context, params *ListSchemasInput, optFns ...func(*Options)) (*ListSchemasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSchemas", params, optFns, addOperationListSchemasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSchemasMiddleware(stack *middleware.Stack, options Options) (err error) {
