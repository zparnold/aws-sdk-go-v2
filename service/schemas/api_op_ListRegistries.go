...
func (c *Client) ListRegistries(ctx context.Context, params *ListRegistriesInput, optFns ...func(*Options)) (*ListRegistriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRegistries", params, optFns, addOperationListRegistriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRegistriesMiddleware(stack *middleware.Stack, options Options) (err error) {
