...
func (c *Client) UpdateSchema(ctx context.Context, params *UpdateSchemaInput, optFns ...func(*Options)) (*UpdateSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSchema", params, optFns, addOperationUpdateSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
