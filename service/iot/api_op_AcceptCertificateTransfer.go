...
func (c *Client) AcceptCertificateTransfer(ctx context.Context, params *AcceptCertificateTransferInput, optFns ...func(*Options)) (*AcceptCertificateTransferOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptCertificateTransfer", params, optFns, addOperationAcceptCertificateTransferMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptCertificateTransferMiddleware(stack *middleware.Stack, options Options) (err error) {
