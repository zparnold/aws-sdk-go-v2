...
func (c *Client) UpdateRoleAlias(ctx context.Context, params *UpdateRoleAliasInput, optFns ...func(*Options)) (*UpdateRoleAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRoleAlias", params, optFns, addOperationUpdateRoleAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRoleAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
