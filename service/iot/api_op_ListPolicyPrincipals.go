...
func (c *Client) ListPolicyPrincipals(ctx context.Context, params *ListPolicyPrincipalsInput, optFns ...func(*Options)) (*ListPolicyPrincipalsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPolicyPrincipals", params, optFns, addOperationListPolicyPrincipalsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPolicyPrincipalsMiddleware(stack *middleware.Stack, options Options) (err error) {
