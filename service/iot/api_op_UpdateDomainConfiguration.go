...
func (c *Client) UpdateDomainConfiguration(ctx context.Context, params *UpdateDomainConfigurationInput, optFns ...func(*Options)) (*UpdateDomainConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDomainConfiguration", params, optFns, addOperationUpdateDomainConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDomainConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
