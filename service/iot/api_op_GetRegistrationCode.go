...
func (c *Client) GetRegistrationCode(ctx context.Context, params *GetRegistrationCodeInput, optFns ...func(*Options)) (*GetRegistrationCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRegistrationCode", params, optFns, addOperationGetRegistrationCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRegistrationCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
