...
func (c *Client) CancelAuditMitigationActionsTask(ctx context.Context, params *CancelAuditMitigationActionsTaskInput, optFns ...func(*Options)) (*CancelAuditMitigationActionsTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelAuditMitigationActionsTask", params, optFns, addOperationCancelAuditMitigationActionsTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelAuditMitigationActionsTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
