...
func (c *Client) RegisterCertificateWithoutCA(ctx context.Context, params *RegisterCertificateWithoutCAInput, optFns ...func(*Options)) (*RegisterCertificateWithoutCAOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterCertificateWithoutCA", params, optFns, addOperationRegisterCertificateWithoutCAMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterCertificateWithoutCAMiddleware(stack *middleware.Stack, options Options) (err error) {
