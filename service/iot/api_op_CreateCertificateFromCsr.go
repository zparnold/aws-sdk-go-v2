...
func (c *Client) CreateCertificateFromCsr(ctx context.Context, params *CreateCertificateFromCsrInput, optFns ...func(*Options)) (*CreateCertificateFromCsrOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCertificateFromCsr", params, optFns, addOperationCreateCertificateFromCsrMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCertificateFromCsrMiddleware(stack *middleware.Stack, options Options) (err error) {
