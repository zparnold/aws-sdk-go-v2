...
func (c *Client) RejectCertificateTransfer(ctx context.Context, params *RejectCertificateTransferInput, optFns ...func(*Options)) (*RejectCertificateTransferOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectCertificateTransfer", params, optFns, addOperationRejectCertificateTransferMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectCertificateTransferMiddleware(stack *middleware.Stack, options Options) (err error) {
