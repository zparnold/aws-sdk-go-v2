...
func (c *Client) GetIndexingConfiguration(ctx context.Context, params *GetIndexingConfigurationInput, optFns ...func(*Options)) (*GetIndexingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIndexingConfiguration", params, optFns, addOperationGetIndexingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIndexingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
