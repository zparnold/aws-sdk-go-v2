...
func (c *Client) RegisterThing(ctx context.Context, params *RegisterThingInput, optFns ...func(*Options)) (*RegisterThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterThing", params, optFns, addOperationRegisterThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterThingMiddleware(stack *middleware.Stack, options Options) (err error) {
