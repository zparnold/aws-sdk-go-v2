...
func (c *Client) ListThings(ctx context.Context, params *ListThingsInput, optFns ...func(*Options)) (*ListThingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThings", params, optFns, addOperationListThingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThingsMiddleware(stack *middleware.Stack, options Options) (err error) {
