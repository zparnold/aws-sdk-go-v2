...
func (c *Client) GetPolicy(ctx context.Context, params *GetPolicyInput, optFns ...func(*Options)) (*GetPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPolicy", params, optFns, addOperationGetPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
