...
func (c *Client) CreateThingType(ctx context.Context, params *CreateThingTypeInput, optFns ...func(*Options)) (*CreateThingTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateThingType", params, optFns, addOperationCreateThingTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateThingTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
