...
func (c *Client) ListPrincipalPolicies(ctx context.Context, params *ListPrincipalPoliciesInput, optFns ...func(*Options)) (*ListPrincipalPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPrincipalPolicies", params, optFns, addOperationListPrincipalPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPrincipalPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
