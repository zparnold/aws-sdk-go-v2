...
func (c *Client) CreateDomainConfiguration(ctx context.Context, params *CreateDomainConfigurationInput, optFns ...func(*Options)) (*CreateDomainConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDomainConfiguration", params, optFns, addOperationCreateDomainConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDomainConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
