...
func (c *Client) CreateTopicRuleDestination(ctx context.Context, params *CreateTopicRuleDestinationInput, optFns ...func(*Options)) (*CreateTopicRuleDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTopicRuleDestination", params, optFns, addOperationCreateTopicRuleDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTopicRuleDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
