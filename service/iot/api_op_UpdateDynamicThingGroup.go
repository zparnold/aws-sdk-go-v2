...
func (c *Client) UpdateDynamicThingGroup(ctx context.Context, params *UpdateDynamicThingGroupInput, optFns ...func(*Options)) (*UpdateDynamicThingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDynamicThingGroup", params, optFns, addOperationUpdateDynamicThingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDynamicThingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
