...
func (c *Client) ListRoleAliases(ctx context.Context, params *ListRoleAliasesInput, optFns ...func(*Options)) (*ListRoleAliasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRoleAliases", params, optFns, addOperationListRoleAliasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRoleAliasesMiddleware(stack *middleware.Stack, options Options) (err error) {
