...
func (c *Client) DeleteSecurityProfile(ctx context.Context, params *DeleteSecurityProfileInput, optFns ...func(*Options)) (*DeleteSecurityProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSecurityProfile", params, optFns, addOperationDeleteSecurityProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSecurityProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
