...
func (c *Client) DeleteAccountAuditConfiguration(ctx context.Context, params *DeleteAccountAuditConfigurationInput, optFns ...func(*Options)) (*DeleteAccountAuditConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccountAuditConfiguration", params, optFns, addOperationDeleteAccountAuditConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccountAuditConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
