...
func (c *Client) GetTopicRuleDestination(ctx context.Context, params *GetTopicRuleDestinationInput, optFns ...func(*Options)) (*GetTopicRuleDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTopicRuleDestination", params, optFns, addOperationGetTopicRuleDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTopicRuleDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
