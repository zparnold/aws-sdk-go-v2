...
func (c *Client) ClearDefaultAuthorizer(ctx context.Context, params *ClearDefaultAuthorizerInput, optFns ...func(*Options)) (*ClearDefaultAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ClearDefaultAuthorizer", params, optFns, addOperationClearDefaultAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationClearDefaultAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
