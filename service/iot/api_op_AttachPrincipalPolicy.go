...
func (c *Client) AttachPrincipalPolicy(ctx context.Context, params *AttachPrincipalPolicyInput, optFns ...func(*Options)) (*AttachPrincipalPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachPrincipalPolicy", params, optFns, addOperationAttachPrincipalPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachPrincipalPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
