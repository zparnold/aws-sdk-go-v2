...
func (c *Client) ListThingRegistrationTasks(ctx context.Context, params *ListThingRegistrationTasksInput, optFns ...func(*Options)) (*ListThingRegistrationTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThingRegistrationTasks", params, optFns, addOperationListThingRegistrationTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThingRegistrationTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
