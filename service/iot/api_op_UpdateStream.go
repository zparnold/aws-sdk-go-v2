...
func (c *Client) UpdateStream(ctx context.Context, params *UpdateStreamInput, optFns ...func(*Options)) (*UpdateStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateStream", params, optFns, addOperationUpdateStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
