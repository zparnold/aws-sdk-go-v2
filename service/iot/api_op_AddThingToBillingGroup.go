...
func (c *Client) AddThingToBillingGroup(ctx context.Context, params *AddThingToBillingGroupInput, optFns ...func(*Options)) (*AddThingToBillingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddThingToBillingGroup", params, optFns, addOperationAddThingToBillingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddThingToBillingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
