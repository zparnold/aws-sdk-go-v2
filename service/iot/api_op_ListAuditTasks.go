...
func (c *Client) ListAuditTasks(ctx context.Context, params *ListAuditTasksInput, optFns ...func(*Options)) (*ListAuditTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAuditTasks", params, optFns, addOperationListAuditTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAuditTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
