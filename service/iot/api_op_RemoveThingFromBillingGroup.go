...
func (c *Client) RemoveThingFromBillingGroup(ctx context.Context, params *RemoveThingFromBillingGroupInput, optFns ...func(*Options)) (*RemoveThingFromBillingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveThingFromBillingGroup", params, optFns, addOperationRemoveThingFromBillingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveThingFromBillingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
