...
func (c *Client) CreateTopicRule(ctx context.Context, params *CreateTopicRuleInput, optFns ...func(*Options)) (*CreateTopicRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTopicRule", params, optFns, addOperationCreateTopicRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTopicRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
