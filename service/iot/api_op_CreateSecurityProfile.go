...
func (c *Client) CreateSecurityProfile(ctx context.Context, params *CreateSecurityProfileInput, optFns ...func(*Options)) (*CreateSecurityProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSecurityProfile", params, optFns, addOperationCreateSecurityProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSecurityProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
