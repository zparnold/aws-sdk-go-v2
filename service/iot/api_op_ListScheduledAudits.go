...
func (c *Client) ListScheduledAudits(ctx context.Context, params *ListScheduledAuditsInput, optFns ...func(*Options)) (*ListScheduledAuditsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListScheduledAudits", params, optFns, addOperationListScheduledAuditsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListScheduledAuditsMiddleware(stack *middleware.Stack, options Options) (err error) {
