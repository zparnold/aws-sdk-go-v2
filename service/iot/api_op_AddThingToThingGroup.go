...
func (c *Client) AddThingToThingGroup(ctx context.Context, params *AddThingToThingGroupInput, optFns ...func(*Options)) (*AddThingToThingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddThingToThingGroup", params, optFns, addOperationAddThingToThingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddThingToThingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
