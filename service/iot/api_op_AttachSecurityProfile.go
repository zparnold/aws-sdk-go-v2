...
func (c *Client) AttachSecurityProfile(ctx context.Context, params *AttachSecurityProfileInput, optFns ...func(*Options)) (*AttachSecurityProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachSecurityProfile", params, optFns, addOperationAttachSecurityProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachSecurityProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
