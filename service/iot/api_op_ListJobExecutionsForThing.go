...
func (c *Client) ListJobExecutionsForThing(ctx context.Context, params *ListJobExecutionsForThingInput, optFns ...func(*Options)) (*ListJobExecutionsForThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJobExecutionsForThing", params, optFns, addOperationListJobExecutionsForThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJobExecutionsForThingMiddleware(stack *middleware.Stack, options Options) (err error) {
