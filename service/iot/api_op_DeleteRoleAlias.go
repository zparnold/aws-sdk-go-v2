...
func (c *Client) DeleteRoleAlias(ctx context.Context, params *DeleteRoleAliasInput, optFns ...func(*Options)) (*DeleteRoleAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRoleAlias", params, optFns, addOperationDeleteRoleAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRoleAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
