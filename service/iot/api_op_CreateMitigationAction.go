...
func (c *Client) CreateMitigationAction(ctx context.Context, params *CreateMitigationActionInput, optFns ...func(*Options)) (*CreateMitigationActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMitigationAction", params, optFns, addOperationCreateMitigationActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMitigationActionMiddleware(stack *middleware.Stack, options Options) (err error) {
