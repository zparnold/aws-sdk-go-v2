...
func (c *Client) ListCertificatesByCA(ctx context.Context, params *ListCertificatesByCAInput, optFns ...func(*Options)) (*ListCertificatesByCAOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCertificatesByCA", params, optFns, addOperationListCertificatesByCAMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCertificatesByCAMiddleware(stack *middleware.Stack, options Options) (err error) {
