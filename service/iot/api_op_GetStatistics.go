...
func (c *Client) GetStatistics(ctx context.Context, params *GetStatisticsInput, optFns ...func(*Options)) (*GetStatisticsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetStatistics", params, optFns, addOperationGetStatisticsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetStatisticsMiddleware(stack *middleware.Stack, options Options) (err error) {
