...
func (c *Client) ListTopicRuleDestinations(ctx context.Context, params *ListTopicRuleDestinationsInput, optFns ...func(*Options)) (*ListTopicRuleDestinationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTopicRuleDestinations", params, optFns, addOperationListTopicRuleDestinationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTopicRuleDestinationsMiddleware(stack *middleware.Stack, options Options) (err error) {
