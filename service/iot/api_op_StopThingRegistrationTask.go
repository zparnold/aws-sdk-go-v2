...
func (c *Client) StopThingRegistrationTask(ctx context.Context, params *StopThingRegistrationTaskInput, optFns ...func(*Options)) (*StopThingRegistrationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopThingRegistrationTask", params, optFns, addOperationStopThingRegistrationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopThingRegistrationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
