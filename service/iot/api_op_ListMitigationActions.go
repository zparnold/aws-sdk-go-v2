...
func (c *Client) ListMitigationActions(ctx context.Context, params *ListMitigationActionsInput, optFns ...func(*Options)) (*ListMitigationActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListMitigationActions", params, optFns, addOperationListMitigationActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListMitigationActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
