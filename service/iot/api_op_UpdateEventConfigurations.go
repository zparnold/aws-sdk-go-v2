...
func (c *Client) UpdateEventConfigurations(ctx context.Context, params *UpdateEventConfigurationsInput, optFns ...func(*Options)) (*UpdateEventConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEventConfigurations", params, optFns, addOperationUpdateEventConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEventConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
