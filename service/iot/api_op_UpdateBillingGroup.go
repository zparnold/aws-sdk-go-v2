...
func (c *Client) UpdateBillingGroup(ctx context.Context, params *UpdateBillingGroupInput, optFns ...func(*Options)) (*UpdateBillingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBillingGroup", params, optFns, addOperationUpdateBillingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBillingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
