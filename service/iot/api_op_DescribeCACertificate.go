...
func (c *Client) DescribeCACertificate(ctx context.Context, params *DescribeCACertificateInput, optFns ...func(*Options)) (*DescribeCACertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCACertificate", params, optFns, addOperationDescribeCACertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCACertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
