...
func (c *Client) DeleteJobExecution(ctx context.Context, params *DeleteJobExecutionInput, optFns ...func(*Options)) (*DeleteJobExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteJobExecution", params, optFns, addOperationDeleteJobExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteJobExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
