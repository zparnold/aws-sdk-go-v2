...
func (c *Client) CreateProvisioningClaim(ctx context.Context, params *CreateProvisioningClaimInput, optFns ...func(*Options)) (*CreateProvisioningClaimOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProvisioningClaim", params, optFns, addOperationCreateProvisioningClaimMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProvisioningClaimMiddleware(stack *middleware.Stack, options Options) (err error) {
