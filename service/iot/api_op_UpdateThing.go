...
func (c *Client) UpdateThing(ctx context.Context, params *UpdateThingInput, optFns ...func(*Options)) (*UpdateThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateThing", params, optFns, addOperationUpdateThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThingMiddleware(stack *middleware.Stack, options Options) (err error) {
