...
func (c *Client) RegisterCertificate(ctx context.Context, params *RegisterCertificateInput, optFns ...func(*Options)) (*RegisterCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterCertificate", params, optFns, addOperationRegisterCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
