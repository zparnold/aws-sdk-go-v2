...
func (c *Client) ListOTAUpdates(ctx context.Context, params *ListOTAUpdatesInput, optFns ...func(*Options)) (*ListOTAUpdatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOTAUpdates", params, optFns, addOperationListOTAUpdatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOTAUpdatesMiddleware(stack *middleware.Stack, options Options) (err error) {
