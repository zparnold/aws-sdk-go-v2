...
func (c *Client) ListAuditMitigationActionsExecutions(ctx context.Context, params *ListAuditMitigationActionsExecutionsInput, optFns ...func(*Options)) (*ListAuditMitigationActionsExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAuditMitigationActionsExecutions", params, optFns, addOperationListAuditMitigationActionsExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAuditMitigationActionsExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
