...
func (c *Client) UpdateSecurityProfile(ctx context.Context, params *UpdateSecurityProfileInput, optFns ...func(*Options)) (*UpdateSecurityProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSecurityProfile", params, optFns, addOperationUpdateSecurityProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSecurityProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
