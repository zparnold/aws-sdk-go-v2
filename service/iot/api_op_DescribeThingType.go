...
func (c *Client) DescribeThingType(ctx context.Context, params *DescribeThingTypeInput, optFns ...func(*Options)) (*DescribeThingTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeThingType", params, optFns, addOperationDescribeThingTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeThingTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
