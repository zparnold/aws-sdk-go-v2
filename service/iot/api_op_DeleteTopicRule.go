...
func (c *Client) DeleteTopicRule(ctx context.Context, params *DeleteTopicRuleInput, optFns ...func(*Options)) (*DeleteTopicRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTopicRule", params, optFns, addOperationDeleteTopicRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTopicRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
