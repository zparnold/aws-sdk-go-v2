...
func (c *Client) CreateThing(ctx context.Context, params *CreateThingInput, optFns ...func(*Options)) (*CreateThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateThing", params, optFns, addOperationCreateThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateThingMiddleware(stack *middleware.Stack, options Options) (err error) {
