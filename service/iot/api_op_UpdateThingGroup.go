...
func (c *Client) UpdateThingGroup(ctx context.Context, params *UpdateThingGroupInput, optFns ...func(*Options)) (*UpdateThingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateThingGroup", params, optFns, addOperationUpdateThingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
