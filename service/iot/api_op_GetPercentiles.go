...
func (c *Client) GetPercentiles(ctx context.Context, params *GetPercentilesInput, optFns ...func(*Options)) (*GetPercentilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPercentiles", params, optFns, addOperationGetPercentilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPercentilesMiddleware(stack *middleware.Stack, options Options) (err error) {
