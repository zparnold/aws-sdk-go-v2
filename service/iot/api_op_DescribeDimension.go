...
func (c *Client) DescribeDimension(ctx context.Context, params *DescribeDimensionInput, optFns ...func(*Options)) (*DescribeDimensionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDimension", params, optFns, addOperationDescribeDimensionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDimensionMiddleware(stack *middleware.Stack, options Options) (err error) {
