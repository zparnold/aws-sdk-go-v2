...
func (c *Client) DescribeThingGroup(ctx context.Context, params *DescribeThingGroupInput, optFns ...func(*Options)) (*DescribeThingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeThingGroup", params, optFns, addOperationDescribeThingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeThingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
