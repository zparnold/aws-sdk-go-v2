...
func (c *Client) ListThingRegistrationTaskReports(ctx context.Context, params *ListThingRegistrationTaskReportsInput, optFns ...func(*Options)) (*ListThingRegistrationTaskReportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThingRegistrationTaskReports", params, optFns, addOperationListThingRegistrationTaskReportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThingRegistrationTaskReportsMiddleware(stack *middleware.Stack, options Options) (err error) {
