...
func (c *Client) DeleteAuthorizer(ctx context.Context, params *DeleteAuthorizerInput, optFns ...func(*Options)) (*DeleteAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAuthorizer", params, optFns, addOperationDeleteAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
