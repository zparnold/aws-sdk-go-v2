...
func (c *Client) SearchIndex(ctx context.Context, params *SearchIndexInput, optFns ...func(*Options)) (*SearchIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchIndex", params, optFns, addOperationSearchIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
