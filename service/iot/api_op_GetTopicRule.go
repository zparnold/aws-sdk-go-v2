...
func (c *Client) GetTopicRule(ctx context.Context, params *GetTopicRuleInput, optFns ...func(*Options)) (*GetTopicRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTopicRule", params, optFns, addOperationGetTopicRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTopicRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
