...
func (c *Client) DeleteDomainConfiguration(ctx context.Context, params *DeleteDomainConfigurationInput, optFns ...func(*Options)) (*DeleteDomainConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDomainConfiguration", params, optFns, addOperationDeleteDomainConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDomainConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
