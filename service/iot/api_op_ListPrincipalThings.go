...
func (c *Client) ListPrincipalThings(ctx context.Context, params *ListPrincipalThingsInput, optFns ...func(*Options)) (*ListPrincipalThingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPrincipalThings", params, optFns, addOperationListPrincipalThingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPrincipalThingsMiddleware(stack *middleware.Stack, options Options) (err error) {
