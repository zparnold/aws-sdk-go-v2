...
func (c *Client) UpdateCertificate(ctx context.Context, params *UpdateCertificateInput, optFns ...func(*Options)) (*UpdateCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCertificate", params, optFns, addOperationUpdateCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
