...
func (c *Client) DescribeAuditFinding(ctx context.Context, params *DescribeAuditFindingInput, optFns ...func(*Options)) (*DescribeAuditFindingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAuditFinding", params, optFns, addOperationDescribeAuditFindingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAuditFindingMiddleware(stack *middleware.Stack, options Options) (err error) {
