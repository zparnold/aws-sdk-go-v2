...
func (c *Client) DescribeDomainConfiguration(ctx context.Context, params *DescribeDomainConfigurationInput, optFns ...func(*Options)) (*DescribeDomainConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDomainConfiguration", params, optFns, addOperationDescribeDomainConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDomainConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
