...
func (c *Client) ListBillingGroups(ctx context.Context, params *ListBillingGroupsInput, optFns ...func(*Options)) (*ListBillingGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBillingGroups", params, optFns, addOperationListBillingGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBillingGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
