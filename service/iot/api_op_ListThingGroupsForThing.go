...
func (c *Client) ListThingGroupsForThing(ctx context.Context, params *ListThingGroupsForThingInput, optFns ...func(*Options)) (*ListThingGroupsForThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThingGroupsForThing", params, optFns, addOperationListThingGroupsForThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThingGroupsForThingMiddleware(stack *middleware.Stack, options Options) (err error) {
