...
func (c *Client) SetV2LoggingOptions(ctx context.Context, params *SetV2LoggingOptionsInput, optFns ...func(*Options)) (*SetV2LoggingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetV2LoggingOptions", params, optFns, addOperationSetV2LoggingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetV2LoggingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
