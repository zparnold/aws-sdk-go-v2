...
func (c *Client) ListThingsInBillingGroup(ctx context.Context, params *ListThingsInBillingGroupInput, optFns ...func(*Options)) (*ListThingsInBillingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThingsInBillingGroup", params, optFns, addOperationListThingsInBillingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThingsInBillingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
