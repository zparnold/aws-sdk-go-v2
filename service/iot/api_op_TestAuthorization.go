...
func (c *Client) TestAuthorization(ctx context.Context, params *TestAuthorizationInput, optFns ...func(*Options)) (*TestAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestAuthorization", params, optFns, addOperationTestAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
