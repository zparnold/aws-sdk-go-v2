...
func (c *Client) DeleteScheduledAudit(ctx context.Context, params *DeleteScheduledAuditInput, optFns ...func(*Options)) (*DeleteScheduledAuditOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteScheduledAudit", params, optFns, addOperationDeleteScheduledAuditMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteScheduledAuditMiddleware(stack *middleware.Stack, options Options) (err error) {
