...
func (c *Client) DetachSecurityProfile(ctx context.Context, params *DetachSecurityProfileInput, optFns ...func(*Options)) (*DetachSecurityProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachSecurityProfile", params, optFns, addOperationDetachSecurityProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachSecurityProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
