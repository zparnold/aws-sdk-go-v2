...
func (c *Client) ListAuthorizers(ctx context.Context, params *ListAuthorizersInput, optFns ...func(*Options)) (*ListAuthorizersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAuthorizers", params, optFns, addOperationListAuthorizersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAuthorizersMiddleware(stack *middleware.Stack, options Options) (err error) {
