...
func (c *Client) AttachPolicy(ctx context.Context, params *AttachPolicyInput, optFns ...func(*Options)) (*AttachPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachPolicy", params, optFns, addOperationAttachPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
