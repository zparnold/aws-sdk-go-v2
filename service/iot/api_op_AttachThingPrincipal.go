...
func (c *Client) AttachThingPrincipal(ctx context.Context, params *AttachThingPrincipalInput, optFns ...func(*Options)) (*AttachThingPrincipalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachThingPrincipal", params, optFns, addOperationAttachThingPrincipalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachThingPrincipalMiddleware(stack *middleware.Stack, options Options) (err error) {
