...
func (c *Client) DescribeAccountAuditConfiguration(ctx context.Context, params *DescribeAccountAuditConfigurationInput, optFns ...func(*Options)) (*DescribeAccountAuditConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccountAuditConfiguration", params, optFns, addOperationDescribeAccountAuditConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccountAuditConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
