...
func (c *Client) CreateJob(ctx context.Context, params *CreateJobInput, optFns ...func(*Options)) (*CreateJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateJob", params, optFns, addOperationCreateJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateJobMiddleware(stack *middleware.Stack, options Options) (err error) {
