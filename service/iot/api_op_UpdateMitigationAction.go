...
func (c *Client) UpdateMitigationAction(ctx context.Context, params *UpdateMitigationActionInput, optFns ...func(*Options)) (*UpdateMitigationActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMitigationAction", params, optFns, addOperationUpdateMitigationActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMitigationActionMiddleware(stack *middleware.Stack, options Options) (err error) {
