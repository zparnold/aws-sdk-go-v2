...
func (c *Client) RegisterCACertificate(ctx context.Context, params *RegisterCACertificateInput, optFns ...func(*Options)) (*RegisterCACertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterCACertificate", params, optFns, addOperationRegisterCACertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterCACertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
