...
func (c *Client) DeleteBillingGroup(ctx context.Context, params *DeleteBillingGroupInput, optFns ...func(*Options)) (*DeleteBillingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBillingGroup", params, optFns, addOperationDeleteBillingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBillingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
