...
func (c *Client) StartAuditMitigationActionsTask(ctx context.Context, params *StartAuditMitigationActionsTaskInput, optFns ...func(*Options)) (*StartAuditMitigationActionsTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartAuditMitigationActionsTask", params, optFns, addOperationStartAuditMitigationActionsTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartAuditMitigationActionsTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
