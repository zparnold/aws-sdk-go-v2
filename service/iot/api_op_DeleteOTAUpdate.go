...
func (c *Client) DeleteOTAUpdate(ctx context.Context, params *DeleteOTAUpdateInput, optFns ...func(*Options)) (*DeleteOTAUpdateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOTAUpdate", params, optFns, addOperationDeleteOTAUpdateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOTAUpdateMiddleware(stack *middleware.Stack, options Options) (err error) {
