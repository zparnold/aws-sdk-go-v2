...
func (c *Client) ListThingGroups(ctx context.Context, params *ListThingGroupsInput, optFns ...func(*Options)) (*ListThingGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThingGroups", params, optFns, addOperationListThingGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThingGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
