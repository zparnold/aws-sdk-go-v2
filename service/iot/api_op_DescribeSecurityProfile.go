...
func (c *Client) DescribeSecurityProfile(ctx context.Context, params *DescribeSecurityProfileInput, optFns ...func(*Options)) (*DescribeSecurityProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSecurityProfile", params, optFns, addOperationDescribeSecurityProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSecurityProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
