...
func (c *Client) DeleteV2LoggingLevel(ctx context.Context, params *DeleteV2LoggingLevelInput, optFns ...func(*Options)) (*DeleteV2LoggingLevelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteV2LoggingLevel", params, optFns, addOperationDeleteV2LoggingLevelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteV2LoggingLevelMiddleware(stack *middleware.Stack, options Options) (err error) {
