...
func (c *Client) ReplaceTopicRule(ctx context.Context, params *ReplaceTopicRuleInput, optFns ...func(*Options)) (*ReplaceTopicRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReplaceTopicRule", params, optFns, addOperationReplaceTopicRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReplaceTopicRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
