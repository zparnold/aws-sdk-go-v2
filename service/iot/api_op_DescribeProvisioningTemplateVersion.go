...
func (c *Client) DescribeProvisioningTemplateVersion(ctx context.Context, params *DescribeProvisioningTemplateVersionInput, optFns ...func(*Options)) (*DescribeProvisioningTemplateVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProvisioningTemplateVersion", params, optFns, addOperationDescribeProvisioningTemplateVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProvisioningTemplateVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
