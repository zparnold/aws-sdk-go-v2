...
func (c *Client) DescribeMitigationAction(ctx context.Context, params *DescribeMitigationActionInput, optFns ...func(*Options)) (*DescribeMitigationActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMitigationAction", params, optFns, addOperationDescribeMitigationActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMitigationActionMiddleware(stack *middleware.Stack, options Options) (err error) {
