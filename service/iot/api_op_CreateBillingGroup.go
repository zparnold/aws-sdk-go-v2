...
func (c *Client) CreateBillingGroup(ctx context.Context, params *CreateBillingGroupInput, optFns ...func(*Options)) (*CreateBillingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBillingGroup", params, optFns, addOperationCreateBillingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBillingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
