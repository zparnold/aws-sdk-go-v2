...
func (c *Client) ListActiveViolations(ctx context.Context, params *ListActiveViolationsInput, optFns ...func(*Options)) (*ListActiveViolationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListActiveViolations", params, optFns, addOperationListActiveViolationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListActiveViolationsMiddleware(stack *middleware.Stack, options Options) (err error) {
