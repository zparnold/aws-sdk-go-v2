...
func (c *Client) DeleteThingGroup(ctx context.Context, params *DeleteThingGroupInput, optFns ...func(*Options)) (*DeleteThingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteThingGroup", params, optFns, addOperationDeleteThingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteThingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
