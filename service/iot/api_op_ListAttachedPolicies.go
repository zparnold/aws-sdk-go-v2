...
func (c *Client) ListAttachedPolicies(ctx context.Context, params *ListAttachedPoliciesInput, optFns ...func(*Options)) (*ListAttachedPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAttachedPolicies", params, optFns, addOperationListAttachedPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAttachedPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
