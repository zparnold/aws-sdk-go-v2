...
func (c *Client) AssociateTargetsWithJob(ctx context.Context, params *AssociateTargetsWithJobInput, optFns ...func(*Options)) (*AssociateTargetsWithJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateTargetsWithJob", params, optFns, addOperationAssociateTargetsWithJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateTargetsWithJobMiddleware(stack *middleware.Stack, options Options) (err error) {
