...
func (c *Client) ListProvisioningTemplates(ctx context.Context, params *ListProvisioningTemplatesInput, optFns ...func(*Options)) (*ListProvisioningTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProvisioningTemplates", params, optFns, addOperationListProvisioningTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProvisioningTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
