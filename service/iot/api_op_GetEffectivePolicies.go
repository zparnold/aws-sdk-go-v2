...
func (c *Client) GetEffectivePolicies(ctx context.Context, params *GetEffectivePoliciesInput, optFns ...func(*Options)) (*GetEffectivePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEffectivePolicies", params, optFns, addOperationGetEffectivePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEffectivePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
