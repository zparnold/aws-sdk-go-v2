...
func (c *Client) DeleteProvisioningTemplate(ctx context.Context, params *DeleteProvisioningTemplateInput, optFns ...func(*Options)) (*DeleteProvisioningTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProvisioningTemplate", params, optFns, addOperationDeleteProvisioningTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProvisioningTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
