...
func (c *Client) DeleteDimension(ctx context.Context, params *DeleteDimensionInput, optFns ...func(*Options)) (*DeleteDimensionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDimension", params, optFns, addOperationDeleteDimensionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDimensionMiddleware(stack *middleware.Stack, options Options) (err error) {
