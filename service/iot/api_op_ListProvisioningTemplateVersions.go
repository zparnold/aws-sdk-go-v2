...
func (c *Client) ListProvisioningTemplateVersions(ctx context.Context, params *ListProvisioningTemplateVersionsInput, optFns ...func(*Options)) (*ListProvisioningTemplateVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProvisioningTemplateVersions", params, optFns, addOperationListProvisioningTemplateVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProvisioningTemplateVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
