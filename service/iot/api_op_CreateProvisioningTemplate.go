...
func (c *Client) CreateProvisioningTemplate(ctx context.Context, params *CreateProvisioningTemplateInput, optFns ...func(*Options)) (*CreateProvisioningTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProvisioningTemplate", params, optFns, addOperationCreateProvisioningTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProvisioningTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
