...
func (c *Client) DescribeBillingGroup(ctx context.Context, params *DescribeBillingGroupInput, optFns ...func(*Options)) (*DescribeBillingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBillingGroup", params, optFns, addOperationDescribeBillingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBillingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
