...
func (c *Client) GetV2LoggingOptions(ctx context.Context, params *GetV2LoggingOptionsInput, optFns ...func(*Options)) (*GetV2LoggingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetV2LoggingOptions", params, optFns, addOperationGetV2LoggingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetV2LoggingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
