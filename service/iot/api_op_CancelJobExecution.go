...
func (c *Client) CancelJobExecution(ctx context.Context, params *CancelJobExecutionInput, optFns ...func(*Options)) (*CancelJobExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelJobExecution", params, optFns, addOperationCancelJobExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelJobExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
