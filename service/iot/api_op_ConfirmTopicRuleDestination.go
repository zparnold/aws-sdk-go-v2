...
func (c *Client) ConfirmTopicRuleDestination(ctx context.Context, params *ConfirmTopicRuleDestinationInput, optFns ...func(*Options)) (*ConfirmTopicRuleDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmTopicRuleDestination", params, optFns, addOperationConfirmTopicRuleDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmTopicRuleDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
