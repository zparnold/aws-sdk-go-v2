...
func (c *Client) DetachPrincipalPolicy(ctx context.Context, params *DetachPrincipalPolicyInput, optFns ...func(*Options)) (*DetachPrincipalPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachPrincipalPolicy", params, optFns, addOperationDetachPrincipalPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachPrincipalPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
