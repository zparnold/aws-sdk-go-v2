...
func (c *Client) DescribeThingRegistrationTask(ctx context.Context, params *DescribeThingRegistrationTaskInput, optFns ...func(*Options)) (*DescribeThingRegistrationTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeThingRegistrationTask", params, optFns, addOperationDescribeThingRegistrationTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeThingRegistrationTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
