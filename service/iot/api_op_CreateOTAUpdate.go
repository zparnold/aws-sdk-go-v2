...
func (c *Client) CreateOTAUpdate(ctx context.Context, params *CreateOTAUpdateInput, optFns ...func(*Options)) (*CreateOTAUpdateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOTAUpdate", params, optFns, addOperationCreateOTAUpdateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOTAUpdateMiddleware(stack *middleware.Stack, options Options) (err error) {
