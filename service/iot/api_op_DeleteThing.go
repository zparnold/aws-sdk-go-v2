...
func (c *Client) DeleteThing(ctx context.Context, params *DeleteThingInput, optFns ...func(*Options)) (*DeleteThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteThing", params, optFns, addOperationDeleteThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteThingMiddleware(stack *middleware.Stack, options Options) (err error) {
