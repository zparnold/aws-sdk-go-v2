...
func (c *Client) UpdateDimension(ctx context.Context, params *UpdateDimensionInput, optFns ...func(*Options)) (*UpdateDimensionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDimension", params, optFns, addOperationUpdateDimensionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDimensionMiddleware(stack *middleware.Stack, options Options) (err error) {
