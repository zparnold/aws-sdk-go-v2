...
func (c *Client) ListViolationEvents(ctx context.Context, params *ListViolationEventsInput, optFns ...func(*Options)) (*ListViolationEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListViolationEvents", params, optFns, addOperationListViolationEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListViolationEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
