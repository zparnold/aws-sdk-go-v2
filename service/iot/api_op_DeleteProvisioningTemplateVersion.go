...
func (c *Client) DeleteProvisioningTemplateVersion(ctx context.Context, params *DeleteProvisioningTemplateVersionInput, optFns ...func(*Options)) (*DeleteProvisioningTemplateVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProvisioningTemplateVersion", params, optFns, addOperationDeleteProvisioningTemplateVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProvisioningTemplateVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
