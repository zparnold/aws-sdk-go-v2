...
func (c *Client) EnableTopicRule(ctx context.Context, params *EnableTopicRuleInput, optFns ...func(*Options)) (*EnableTopicRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableTopicRule", params, optFns, addOperationEnableTopicRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableTopicRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
