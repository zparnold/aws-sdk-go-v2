...
func (c *Client) DescribeStream(ctx context.Context, params *DescribeStreamInput, optFns ...func(*Options)) (*DescribeStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStream", params, optFns, addOperationDescribeStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
