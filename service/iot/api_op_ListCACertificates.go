...
func (c *Client) ListCACertificates(ctx context.Context, params *ListCACertificatesInput, optFns ...func(*Options)) (*ListCACertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCACertificates", params, optFns, addOperationListCACertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCACertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
