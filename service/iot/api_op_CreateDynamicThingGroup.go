...
func (c *Client) CreateDynamicThingGroup(ctx context.Context, params *CreateDynamicThingGroupInput, optFns ...func(*Options)) (*CreateDynamicThingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDynamicThingGroup", params, optFns, addOperationCreateDynamicThingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDynamicThingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
