...
func (c *Client) GetOTAUpdate(ctx context.Context, params *GetOTAUpdateInput, optFns ...func(*Options)) (*GetOTAUpdateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOTAUpdate", params, optFns, addOperationGetOTAUpdateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOTAUpdateMiddleware(stack *middleware.Stack, options Options) (err error) {
