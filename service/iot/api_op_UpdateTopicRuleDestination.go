...
func (c *Client) UpdateTopicRuleDestination(ctx context.Context, params *UpdateTopicRuleDestinationInput, optFns ...func(*Options)) (*UpdateTopicRuleDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTopicRuleDestination", params, optFns, addOperationUpdateTopicRuleDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTopicRuleDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
