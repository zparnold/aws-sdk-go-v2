...
func (c *Client) DeleteCACertificate(ctx context.Context, params *DeleteCACertificateInput, optFns ...func(*Options)) (*DeleteCACertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCACertificate", params, optFns, addOperationDeleteCACertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCACertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
