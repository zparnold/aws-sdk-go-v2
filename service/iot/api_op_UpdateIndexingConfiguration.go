...
func (c *Client) UpdateIndexingConfiguration(ctx context.Context, params *UpdateIndexingConfigurationInput, optFns ...func(*Options)) (*UpdateIndexingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIndexingConfiguration", params, optFns, addOperationUpdateIndexingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIndexingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
