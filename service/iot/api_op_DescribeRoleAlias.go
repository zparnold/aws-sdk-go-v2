...
func (c *Client) DescribeRoleAlias(ctx context.Context, params *DescribeRoleAliasInput, optFns ...func(*Options)) (*DescribeRoleAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRoleAlias", params, optFns, addOperationDescribeRoleAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRoleAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
