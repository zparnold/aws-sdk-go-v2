...
func (c *Client) ListOutgoingCertificates(ctx context.Context, params *ListOutgoingCertificatesInput, optFns ...func(*Options)) (*ListOutgoingCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOutgoingCertificates", params, optFns, addOperationListOutgoingCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOutgoingCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
