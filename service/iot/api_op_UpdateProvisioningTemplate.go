...
func (c *Client) UpdateProvisioningTemplate(ctx context.Context, params *UpdateProvisioningTemplateInput, optFns ...func(*Options)) (*UpdateProvisioningTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProvisioningTemplate", params, optFns, addOperationUpdateProvisioningTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProvisioningTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
