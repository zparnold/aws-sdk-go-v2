...
func (c *Client) DescribeIndex(ctx context.Context, params *DescribeIndexInput, optFns ...func(*Options)) (*DescribeIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIndex", params, optFns, addOperationDescribeIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
