...
func (c *Client) ListDomainConfigurations(ctx context.Context, params *ListDomainConfigurationsInput, optFns ...func(*Options)) (*ListDomainConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDomainConfigurations", params, optFns, addOperationListDomainConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDomainConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
