...
func (c *Client) ListTargetsForSecurityProfile(ctx context.Context, params *ListTargetsForSecurityProfileInput, optFns ...func(*Options)) (*ListTargetsForSecurityProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTargetsForSecurityProfile", params, optFns, addOperationListTargetsForSecurityProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTargetsForSecurityProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
