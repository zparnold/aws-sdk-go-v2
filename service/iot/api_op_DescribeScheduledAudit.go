...
func (c *Client) DescribeScheduledAudit(ctx context.Context, params *DescribeScheduledAuditInput, optFns ...func(*Options)) (*DescribeScheduledAuditOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScheduledAudit", params, optFns, addOperationDescribeScheduledAuditMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScheduledAuditMiddleware(stack *middleware.Stack, options Options) (err error) {
