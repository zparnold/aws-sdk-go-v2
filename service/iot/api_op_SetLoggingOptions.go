...
func (c *Client) SetLoggingOptions(ctx context.Context, params *SetLoggingOptionsInput, optFns ...func(*Options)) (*SetLoggingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetLoggingOptions", params, optFns, addOperationSetLoggingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetLoggingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
