...
func (c *Client) DescribeAuditMitigationActionsTask(ctx context.Context, params *DescribeAuditMitigationActionsTaskInput, optFns ...func(*Options)) (*DescribeAuditMitigationActionsTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAuditMitigationActionsTask", params, optFns, addOperationDescribeAuditMitigationActionsTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAuditMitigationActionsTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
