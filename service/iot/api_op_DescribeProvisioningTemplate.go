...
func (c *Client) DescribeProvisioningTemplate(ctx context.Context, params *DescribeProvisioningTemplateInput, optFns ...func(*Options)) (*DescribeProvisioningTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProvisioningTemplate", params, optFns, addOperationDescribeProvisioningTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProvisioningTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
