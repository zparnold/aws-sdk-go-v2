...
func (c *Client) GetCardinality(ctx context.Context, params *GetCardinalityInput, optFns ...func(*Options)) (*GetCardinalityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCardinality", params, optFns, addOperationGetCardinalityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCardinalityMiddleware(stack *middleware.Stack, options Options) (err error) {
