...
func (c *Client) CreateProvisioningTemplateVersion(ctx context.Context, params *CreateProvisioningTemplateVersionInput, optFns ...func(*Options)) (*CreateProvisioningTemplateVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProvisioningTemplateVersion", params, optFns, addOperationCreateProvisioningTemplateVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProvisioningTemplateVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
