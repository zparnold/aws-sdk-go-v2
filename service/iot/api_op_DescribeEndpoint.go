...
func (c *Client) DescribeEndpoint(ctx context.Context, params *DescribeEndpointInput, optFns ...func(*Options)) (*DescribeEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEndpoint", params, optFns, addOperationDescribeEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
