...
func (c *Client) DeleteMitigationAction(ctx context.Context, params *DeleteMitigationActionInput, optFns ...func(*Options)) (*DeleteMitigationActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMitigationAction", params, optFns, addOperationDeleteMitigationActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMitigationActionMiddleware(stack *middleware.Stack, options Options) (err error) {
