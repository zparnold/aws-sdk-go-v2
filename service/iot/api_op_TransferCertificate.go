...
func (c *Client) TransferCertificate(ctx context.Context, params *TransferCertificateInput, optFns ...func(*Options)) (*TransferCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TransferCertificate", params, optFns, addOperationTransferCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTransferCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
