...
func (c *Client) ListPolicyVersions(ctx context.Context, params *ListPolicyVersionsInput, optFns ...func(*Options)) (*ListPolicyVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPolicyVersions", params, optFns, addOperationListPolicyVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPolicyVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
