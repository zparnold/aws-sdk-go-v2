...
func (c *Client) DeleteRegistrationCode(ctx context.Context, params *DeleteRegistrationCodeInput, optFns ...func(*Options)) (*DeleteRegistrationCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRegistrationCode", params, optFns, addOperationDeleteRegistrationCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRegistrationCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
