...
func (c *Client) SetDefaultAuthorizer(ctx context.Context, params *SetDefaultAuthorizerInput, optFns ...func(*Options)) (*SetDefaultAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetDefaultAuthorizer", params, optFns, addOperationSetDefaultAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetDefaultAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
