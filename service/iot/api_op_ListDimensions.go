...
func (c *Client) ListDimensions(ctx context.Context, params *ListDimensionsInput, optFns ...func(*Options)) (*ListDimensionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDimensions", params, optFns, addOperationListDimensionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDimensionsMiddleware(stack *middleware.Stack, options Options) (err error) {
