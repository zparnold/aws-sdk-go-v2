...
func (c *Client) ListAuditMitigationActionsTasks(ctx context.Context, params *ListAuditMitigationActionsTasksInput, optFns ...func(*Options)) (*ListAuditMitigationActionsTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAuditMitigationActionsTasks", params, optFns, addOperationListAuditMitigationActionsTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAuditMitigationActionsTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
