...
func (c *Client) ListAuditFindings(ctx context.Context, params *ListAuditFindingsInput, optFns ...func(*Options)) (*ListAuditFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAuditFindings", params, optFns, addOperationListAuditFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAuditFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
