...
func (c *Client) CancelAuditTask(ctx context.Context, params *CancelAuditTaskInput, optFns ...func(*Options)) (*CancelAuditTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelAuditTask", params, optFns, addOperationCancelAuditTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelAuditTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
