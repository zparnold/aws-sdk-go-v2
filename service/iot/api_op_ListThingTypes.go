...
func (c *Client) ListThingTypes(ctx context.Context, params *ListThingTypesInput, optFns ...func(*Options)) (*ListThingTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThingTypes", params, optFns, addOperationListThingTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThingTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
