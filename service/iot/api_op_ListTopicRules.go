...
func (c *Client) ListTopicRules(ctx context.Context, params *ListTopicRulesInput, optFns ...func(*Options)) (*ListTopicRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTopicRules", params, optFns, addOperationListTopicRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTopicRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
