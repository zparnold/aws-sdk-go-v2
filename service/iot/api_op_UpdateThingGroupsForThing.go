...
func (c *Client) UpdateThingGroupsForThing(ctx context.Context, params *UpdateThingGroupsForThingInput, optFns ...func(*Options)) (*UpdateThingGroupsForThingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateThingGroupsForThing", params, optFns, addOperationUpdateThingGroupsForThingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThingGroupsForThingMiddleware(stack *middleware.Stack, options Options) (err error) {
