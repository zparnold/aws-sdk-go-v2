...
func (c *Client) DeprecateThingType(ctx context.Context, params *DeprecateThingTypeInput, optFns ...func(*Options)) (*DeprecateThingTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeprecateThingType", params, optFns, addOperationDeprecateThingTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeprecateThingTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
