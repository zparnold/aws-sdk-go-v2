...
func (c *Client) ListSecurityProfilesForTarget(ctx context.Context, params *ListSecurityProfilesForTargetInput, optFns ...func(*Options)) (*ListSecurityProfilesForTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSecurityProfilesForTarget", params, optFns, addOperationListSecurityProfilesForTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSecurityProfilesForTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
