...
func (c *Client) DescribeDefaultAuthorizer(ctx context.Context, params *DescribeDefaultAuthorizerInput, optFns ...func(*Options)) (*DescribeDefaultAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDefaultAuthorizer", params, optFns, addOperationDescribeDefaultAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDefaultAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
