...
func (c *Client) RemoveThingFromThingGroup(ctx context.Context, params *RemoveThingFromThingGroupInput, optFns ...func(*Options)) (*RemoveThingFromThingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveThingFromThingGroup", params, optFns, addOperationRemoveThingFromThingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveThingFromThingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
