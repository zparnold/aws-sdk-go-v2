...
func (c *Client) CreateKeysAndCertificate(ctx context.Context, params *CreateKeysAndCertificateInput, optFns ...func(*Options)) (*CreateKeysAndCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateKeysAndCertificate", params, optFns, addOperationCreateKeysAndCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateKeysAndCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
