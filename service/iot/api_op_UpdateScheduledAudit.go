...
func (c *Client) UpdateScheduledAudit(ctx context.Context, params *UpdateScheduledAuditInput, optFns ...func(*Options)) (*UpdateScheduledAuditOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateScheduledAudit", params, optFns, addOperationUpdateScheduledAuditMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateScheduledAuditMiddleware(stack *middleware.Stack, options Options) (err error) {
