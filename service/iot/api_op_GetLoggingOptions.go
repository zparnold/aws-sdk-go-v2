...
func (c *Client) GetLoggingOptions(ctx context.Context, params *GetLoggingOptionsInput, optFns ...func(*Options)) (*GetLoggingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLoggingOptions", params, optFns, addOperationGetLoggingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLoggingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
