...
func (c *Client) CreateRoleAlias(ctx context.Context, params *CreateRoleAliasInput, optFns ...func(*Options)) (*CreateRoleAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRoleAlias", params, optFns, addOperationCreateRoleAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRoleAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
