...
func (c *Client) GetPolicyVersion(ctx context.Context, params *GetPolicyVersionInput, optFns ...func(*Options)) (*GetPolicyVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPolicyVersion", params, optFns, addOperationGetPolicyVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPolicyVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
