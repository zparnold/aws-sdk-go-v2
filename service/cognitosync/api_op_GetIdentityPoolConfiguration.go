...
func (c *Client) GetIdentityPoolConfiguration(ctx context.Context, params *GetIdentityPoolConfigurationInput, optFns ...func(*Options)) (*GetIdentityPoolConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityPoolConfiguration", params, optFns, addOperationGetIdentityPoolConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityPoolConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
