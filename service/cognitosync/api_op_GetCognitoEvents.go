...
func (c *Client) GetCognitoEvents(ctx context.Context, params *GetCognitoEventsInput, optFns ...func(*Options)) (*GetCognitoEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCognitoEvents", params, optFns, addOperationGetCognitoEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCognitoEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
