...
func (c *Client) GetBulkPublishDetails(ctx context.Context, params *GetBulkPublishDetailsInput, optFns ...func(*Options)) (*GetBulkPublishDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBulkPublishDetails", params, optFns, addOperationGetBulkPublishDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBulkPublishDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
