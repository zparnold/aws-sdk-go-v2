...
func (c *Client) ListRecords(ctx context.Context, params *ListRecordsInput, optFns ...func(*Options)) (*ListRecordsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRecords", params, optFns, addOperationListRecordsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRecordsMiddleware(stack *middleware.Stack, options Options) (err error) {
