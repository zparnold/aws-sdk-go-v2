...
func (c *Client) RegisterDevice(ctx context.Context, params *RegisterDeviceInput, optFns ...func(*Options)) (*RegisterDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterDevice", params, optFns, addOperationRegisterDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
