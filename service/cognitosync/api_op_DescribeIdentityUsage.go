...
func (c *Client) DescribeIdentityUsage(ctx context.Context, params *DescribeIdentityUsageInput, optFns ...func(*Options)) (*DescribeIdentityUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIdentityUsage", params, optFns, addOperationDescribeIdentityUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIdentityUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
