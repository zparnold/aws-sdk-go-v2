...
func (c *Client) UnsubscribeFromDataset(ctx context.Context, params *UnsubscribeFromDatasetInput, optFns ...func(*Options)) (*UnsubscribeFromDatasetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnsubscribeFromDataset", params, optFns, addOperationUnsubscribeFromDatasetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnsubscribeFromDatasetMiddleware(stack *middleware.Stack, options Options) (err error) {
