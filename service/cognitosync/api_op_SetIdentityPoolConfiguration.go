...
func (c *Client) SetIdentityPoolConfiguration(ctx context.Context, params *SetIdentityPoolConfigurationInput, optFns ...func(*Options)) (*SetIdentityPoolConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIdentityPoolConfiguration", params, optFns, addOperationSetIdentityPoolConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIdentityPoolConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
