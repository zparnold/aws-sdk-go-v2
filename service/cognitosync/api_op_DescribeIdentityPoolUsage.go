...
func (c *Client) DescribeIdentityPoolUsage(ctx context.Context, params *DescribeIdentityPoolUsageInput, optFns ...func(*Options)) (*DescribeIdentityPoolUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIdentityPoolUsage", params, optFns, addOperationDescribeIdentityPoolUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIdentityPoolUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
