...
func (c *Client) ListIdentityPoolUsage(ctx context.Context, params *ListIdentityPoolUsageInput, optFns ...func(*Options)) (*ListIdentityPoolUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIdentityPoolUsage", params, optFns, addOperationListIdentityPoolUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIdentityPoolUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
