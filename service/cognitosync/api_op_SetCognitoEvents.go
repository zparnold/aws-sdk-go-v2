...
func (c *Client) SetCognitoEvents(ctx context.Context, params *SetCognitoEventsInput, optFns ...func(*Options)) (*SetCognitoEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetCognitoEvents", params, optFns, addOperationSetCognitoEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetCognitoEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
