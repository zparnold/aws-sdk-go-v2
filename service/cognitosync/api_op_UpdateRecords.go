...
func (c *Client) UpdateRecords(ctx context.Context, params *UpdateRecordsInput, optFns ...func(*Options)) (*UpdateRecordsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRecords", params, optFns, addOperationUpdateRecordsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRecordsMiddleware(stack *middleware.Stack, options Options) (err error) {
