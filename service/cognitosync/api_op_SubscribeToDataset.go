...
func (c *Client) SubscribeToDataset(ctx context.Context, params *SubscribeToDatasetInput, optFns ...func(*Options)) (*SubscribeToDatasetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubscribeToDataset", params, optFns, addOperationSubscribeToDatasetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubscribeToDatasetMiddleware(stack *middleware.Stack, options Options) (err error) {
