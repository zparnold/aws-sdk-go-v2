...
func (c *Client) CreateProfilingGroup(ctx context.Context, params *CreateProfilingGroupInput, optFns ...func(*Options)) (*CreateProfilingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProfilingGroup", params, optFns, addOperationCreateProfilingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProfilingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
