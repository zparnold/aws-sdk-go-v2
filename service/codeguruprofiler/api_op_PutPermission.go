...
func (c *Client) PutPermission(ctx context.Context, params *PutPermissionInput, optFns ...func(*Options)) (*PutPermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutPermission", params, optFns, addOperationPutPermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutPermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
