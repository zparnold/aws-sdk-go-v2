...
func (c *Client) RetrieveTimeSeries(ctx context.Context, params *RetrieveTimeSeriesInput, optFns ...func(*Options)) (*RetrieveTimeSeriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetrieveTimeSeries", params, optFns, addOperationRetrieveTimeSeriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetrieveTimeSeriesMiddleware(stack *middleware.Stack, options Options) (err error) {
