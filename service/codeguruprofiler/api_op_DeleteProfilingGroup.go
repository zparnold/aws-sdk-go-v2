...
func (c *Client) DeleteProfilingGroup(ctx context.Context, params *DeleteProfilingGroupInput, optFns ...func(*Options)) (*DeleteProfilingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProfilingGroup", params, optFns, addOperationDeleteProfilingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProfilingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
