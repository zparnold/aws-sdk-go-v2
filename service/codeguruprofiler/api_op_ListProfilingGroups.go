...
func (c *Client) ListProfilingGroups(ctx context.Context, params *ListProfilingGroupsInput, optFns ...func(*Options)) (*ListProfilingGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProfilingGroups", params, optFns, addOperationListProfilingGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProfilingGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
