...
func (c *Client) PostAgentProfile(ctx context.Context, params *PostAgentProfileInput, optFns ...func(*Options)) (*PostAgentProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PostAgentProfile", params, optFns, addOperationPostAgentProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPostAgentProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
