...
func (c *Client) DescribeProfilingGroup(ctx context.Context, params *DescribeProfilingGroupInput, optFns ...func(*Options)) (*DescribeProfilingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProfilingGroup", params, optFns, addOperationDescribeProfilingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProfilingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
