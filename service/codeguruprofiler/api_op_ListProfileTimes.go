...
func (c *Client) ListProfileTimes(ctx context.Context, params *ListProfileTimesInput, optFns ...func(*Options)) (*ListProfileTimesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProfileTimes", params, optFns, addOperationListProfileTimesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProfileTimesMiddleware(stack *middleware.Stack, options Options) (err error) {
