...
func (c *Client) UpdateProfilingGroup(ctx context.Context, params *UpdateProfilingGroupInput, optFns ...func(*Options)) (*UpdateProfilingGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProfilingGroup", params, optFns, addOperationUpdateProfilingGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProfilingGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
