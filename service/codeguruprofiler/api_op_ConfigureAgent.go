...
func (c *Client) ConfigureAgent(ctx context.Context, params *ConfigureAgentInput, optFns ...func(*Options)) (*ConfigureAgentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfigureAgent", params, optFns, addOperationConfigureAgentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfigureAgentMiddleware(stack *middleware.Stack, options Options) (err error) {
