...
func (c *Client) StartSupportDataExport(ctx context.Context, params *StartSupportDataExportInput, optFns ...func(*Options)) (*StartSupportDataExportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSupportDataExport", params, optFns, addOperationStartSupportDataExportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSupportDataExportMiddleware(stack *middleware.Stack, options Options) (err error) {
