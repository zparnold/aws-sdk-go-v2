...
func (c *Client) GenerateDataSet(ctx context.Context, params *GenerateDataSetInput, optFns ...func(*Options)) (*GenerateDataSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateDataSet", params, optFns, addOperationGenerateDataSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateDataSetMiddleware(stack *middleware.Stack, options Options) (err error) {
