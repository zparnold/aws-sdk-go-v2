...
func (c *Client) SendCustomVerificationEmail(ctx context.Context, params *SendCustomVerificationEmailInput, optFns ...func(*Options)) (*SendCustomVerificationEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendCustomVerificationEmail", params, optFns, addOperationSendCustomVerificationEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendCustomVerificationEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
