...
func (c *Client) UpdateConfigurationSetTrackingOptions(ctx context.Context, params *UpdateConfigurationSetTrackingOptionsInput, optFns ...func(*Options)) (*UpdateConfigurationSetTrackingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConfigurationSetTrackingOptions", params, optFns, addOperationUpdateConfigurationSetTrackingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConfigurationSetTrackingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
