...
func (c *Client) GetCustomVerificationEmailTemplate(ctx context.Context, params *GetCustomVerificationEmailTemplateInput, optFns ...func(*Options)) (*GetCustomVerificationEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCustomVerificationEmailTemplate", params, optFns, addOperationGetCustomVerificationEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCustomVerificationEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
