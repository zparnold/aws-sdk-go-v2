...
func (c *Client) ListConfigurationSets(ctx context.Context, params *ListConfigurationSetsInput, optFns ...func(*Options)) (*ListConfigurationSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConfigurationSets", params, optFns, addOperationListConfigurationSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConfigurationSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
