...
func (c *Client) ListReceiptRuleSets(ctx context.Context, params *ListReceiptRuleSetsInput, optFns ...func(*Options)) (*ListReceiptRuleSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReceiptRuleSets", params, optFns, addOperationListReceiptRuleSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReceiptRuleSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
