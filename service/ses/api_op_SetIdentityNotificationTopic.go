...
func (c *Client) SetIdentityNotificationTopic(ctx context.Context, params *SetIdentityNotificationTopicInput, optFns ...func(*Options)) (*SetIdentityNotificationTopicOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIdentityNotificationTopic", params, optFns, addOperationSetIdentityNotificationTopicMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIdentityNotificationTopicMiddleware(stack *middleware.Stack, options Options) (err error) {
