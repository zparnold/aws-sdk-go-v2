...
func (c *Client) ReorderReceiptRuleSet(ctx context.Context, params *ReorderReceiptRuleSetInput, optFns ...func(*Options)) (*ReorderReceiptRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReorderReceiptRuleSet", params, optFns, addOperationReorderReceiptRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReorderReceiptRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
