...
func (c *Client) GetIdentityDkimAttributes(ctx context.Context, params *GetIdentityDkimAttributesInput, optFns ...func(*Options)) (*GetIdentityDkimAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityDkimAttributes", params, optFns, addOperationGetIdentityDkimAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityDkimAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
