...
func (c *Client) VerifyDomainDkim(ctx context.Context, params *VerifyDomainDkimInput, optFns ...func(*Options)) (*VerifyDomainDkimOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "VerifyDomainDkim", params, optFns, addOperationVerifyDomainDkimMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationVerifyDomainDkimMiddleware(stack *middleware.Stack, options Options) (err error) {
