...
func (c *Client) DeleteVerifiedEmailAddress(ctx context.Context, params *DeleteVerifiedEmailAddressInput, optFns ...func(*Options)) (*DeleteVerifiedEmailAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVerifiedEmailAddress", params, optFns, addOperationDeleteVerifiedEmailAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVerifiedEmailAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
