...
func (c *Client) VerifyEmailIdentity(ctx context.Context, params *VerifyEmailIdentityInput, optFns ...func(*Options)) (*VerifyEmailIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "VerifyEmailIdentity", params, optFns, addOperationVerifyEmailIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationVerifyEmailIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
