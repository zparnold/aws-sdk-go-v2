...
func (c *Client) DeleteIdentity(ctx context.Context, params *DeleteIdentityInput, optFns ...func(*Options)) (*DeleteIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIdentity", params, optFns, addOperationDeleteIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
