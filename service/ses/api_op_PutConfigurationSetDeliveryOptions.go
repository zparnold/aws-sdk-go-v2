...
func (c *Client) PutConfigurationSetDeliveryOptions(ctx context.Context, params *PutConfigurationSetDeliveryOptionsInput, optFns ...func(*Options)) (*PutConfigurationSetDeliveryOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConfigurationSetDeliveryOptions", params, optFns, addOperationPutConfigurationSetDeliveryOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConfigurationSetDeliveryOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
