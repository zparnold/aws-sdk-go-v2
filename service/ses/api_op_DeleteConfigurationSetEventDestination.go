...
func (c *Client) DeleteConfigurationSetEventDestination(ctx context.Context, params *DeleteConfigurationSetEventDestinationInput, optFns ...func(*Options)) (*DeleteConfigurationSetEventDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConfigurationSetEventDestination", params, optFns, addOperationDeleteConfigurationSetEventDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConfigurationSetEventDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
