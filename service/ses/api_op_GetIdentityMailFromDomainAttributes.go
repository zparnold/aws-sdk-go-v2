...
func (c *Client) GetIdentityMailFromDomainAttributes(ctx context.Context, params *GetIdentityMailFromDomainAttributesInput, optFns ...func(*Options)) (*GetIdentityMailFromDomainAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityMailFromDomainAttributes", params, optFns, addOperationGetIdentityMailFromDomainAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityMailFromDomainAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
