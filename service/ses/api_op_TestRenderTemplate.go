...
func (c *Client) TestRenderTemplate(ctx context.Context, params *TestRenderTemplateInput, optFns ...func(*Options)) (*TestRenderTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestRenderTemplate", params, optFns, addOperationTestRenderTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestRenderTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
