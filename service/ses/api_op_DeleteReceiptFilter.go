...
func (c *Client) DeleteReceiptFilter(ctx context.Context, params *DeleteReceiptFilterInput, optFns ...func(*Options)) (*DeleteReceiptFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReceiptFilter", params, optFns, addOperationDeleteReceiptFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReceiptFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
