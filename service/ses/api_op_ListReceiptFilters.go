...
func (c *Client) ListReceiptFilters(ctx context.Context, params *ListReceiptFiltersInput, optFns ...func(*Options)) (*ListReceiptFiltersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReceiptFilters", params, optFns, addOperationListReceiptFiltersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReceiptFiltersMiddleware(stack *middleware.Stack, options Options) (err error) {
