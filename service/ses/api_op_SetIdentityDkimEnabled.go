...
func (c *Client) SetIdentityDkimEnabled(ctx context.Context, params *SetIdentityDkimEnabledInput, optFns ...func(*Options)) (*SetIdentityDkimEnabledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIdentityDkimEnabled", params, optFns, addOperationSetIdentityDkimEnabledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIdentityDkimEnabledMiddleware(stack *middleware.Stack, options Options) (err error) {
