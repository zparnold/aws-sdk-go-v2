...
func (c *Client) GetAccountSendingEnabled(ctx context.Context, params *GetAccountSendingEnabledInput, optFns ...func(*Options)) (*GetAccountSendingEnabledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccountSendingEnabled", params, optFns, addOperationGetAccountSendingEnabledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccountSendingEnabledMiddleware(stack *middleware.Stack, options Options) (err error) {
