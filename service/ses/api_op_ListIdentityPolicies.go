...
func (c *Client) ListIdentityPolicies(ctx context.Context, params *ListIdentityPoliciesInput, optFns ...func(*Options)) (*ListIdentityPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIdentityPolicies", params, optFns, addOperationListIdentityPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIdentityPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
