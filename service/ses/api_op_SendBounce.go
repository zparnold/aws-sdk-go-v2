...
func (c *Client) SendBounce(ctx context.Context, params *SendBounceInput, optFns ...func(*Options)) (*SendBounceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendBounce", params, optFns, addOperationSendBounceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendBounceMiddleware(stack *middleware.Stack, options Options) (err error) {
