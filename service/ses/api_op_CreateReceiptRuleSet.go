...
func (c *Client) CreateReceiptRuleSet(ctx context.Context, params *CreateReceiptRuleSetInput, optFns ...func(*Options)) (*CreateReceiptRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReceiptRuleSet", params, optFns, addOperationCreateReceiptRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReceiptRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
