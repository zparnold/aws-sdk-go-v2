...
func (c *Client) ListVerifiedEmailAddresses(ctx context.Context, params *ListVerifiedEmailAddressesInput, optFns ...func(*Options)) (*ListVerifiedEmailAddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListVerifiedEmailAddresses", params, optFns, addOperationListVerifiedEmailAddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListVerifiedEmailAddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
