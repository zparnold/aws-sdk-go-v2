...
func (c *Client) CloneReceiptRuleSet(ctx context.Context, params *CloneReceiptRuleSetInput, optFns ...func(*Options)) (*CloneReceiptRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CloneReceiptRuleSet", params, optFns, addOperationCloneReceiptRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCloneReceiptRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
