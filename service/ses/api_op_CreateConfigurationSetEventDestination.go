...
func (c *Client) CreateConfigurationSetEventDestination(ctx context.Context, params *CreateConfigurationSetEventDestinationInput, optFns ...func(*Options)) (*CreateConfigurationSetEventDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConfigurationSetEventDestination", params, optFns, addOperationCreateConfigurationSetEventDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConfigurationSetEventDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
