...
func (c *Client) SetActiveReceiptRuleSet(ctx context.Context, params *SetActiveReceiptRuleSetInput, optFns ...func(*Options)) (*SetActiveReceiptRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetActiveReceiptRuleSet", params, optFns, addOperationSetActiveReceiptRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetActiveReceiptRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
