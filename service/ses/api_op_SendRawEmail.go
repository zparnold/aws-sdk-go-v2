...
func (c *Client) SendRawEmail(ctx context.Context, params *SendRawEmailInput, optFns ...func(*Options)) (*SendRawEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendRawEmail", params, optFns, addOperationSendRawEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendRawEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
