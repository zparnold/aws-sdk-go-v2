...
func (c *Client) SendBulkTemplatedEmail(ctx context.Context, params *SendBulkTemplatedEmailInput, optFns ...func(*Options)) (*SendBulkTemplatedEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendBulkTemplatedEmail", params, optFns, addOperationSendBulkTemplatedEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendBulkTemplatedEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
