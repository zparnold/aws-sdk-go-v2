...
func (c *Client) DeleteReceiptRule(ctx context.Context, params *DeleteReceiptRuleInput, optFns ...func(*Options)) (*DeleteReceiptRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReceiptRule", params, optFns, addOperationDeleteReceiptRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReceiptRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
