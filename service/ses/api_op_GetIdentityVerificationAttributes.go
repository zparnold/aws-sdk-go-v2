...
func (c *Client) GetIdentityVerificationAttributes(ctx context.Context, params *GetIdentityVerificationAttributesInput, optFns ...func(*Options)) (*GetIdentityVerificationAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityVerificationAttributes", params, optFns, addOperationGetIdentityVerificationAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityVerificationAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
