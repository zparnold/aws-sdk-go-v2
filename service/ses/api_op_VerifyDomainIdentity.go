...
func (c *Client) VerifyDomainIdentity(ctx context.Context, params *VerifyDomainIdentityInput, optFns ...func(*Options)) (*VerifyDomainIdentityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "VerifyDomainIdentity", params, optFns, addOperationVerifyDomainIdentityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationVerifyDomainIdentityMiddleware(stack *middleware.Stack, options Options) (err error) {
