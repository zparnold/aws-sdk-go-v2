...
func (c *Client) DescribeReceiptRuleSet(ctx context.Context, params *DescribeReceiptRuleSetInput, optFns ...func(*Options)) (*DescribeReceiptRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReceiptRuleSet", params, optFns, addOperationDescribeReceiptRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReceiptRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
