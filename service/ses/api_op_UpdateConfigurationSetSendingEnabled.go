...
func (c *Client) UpdateConfigurationSetSendingEnabled(ctx context.Context, params *UpdateConfigurationSetSendingEnabledInput, optFns ...func(*Options)) (*UpdateConfigurationSetSendingEnabledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConfigurationSetSendingEnabled", params, optFns, addOperationUpdateConfigurationSetSendingEnabledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConfigurationSetSendingEnabledMiddleware(stack *middleware.Stack, options Options) (err error) {
