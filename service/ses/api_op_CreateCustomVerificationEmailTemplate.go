...
func (c *Client) CreateCustomVerificationEmailTemplate(ctx context.Context, params *CreateCustomVerificationEmailTemplateInput, optFns ...func(*Options)) (*CreateCustomVerificationEmailTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomVerificationEmailTemplate", params, optFns, addOperationCreateCustomVerificationEmailTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomVerificationEmailTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
