...
func (c *Client) UpdateReceiptRule(ctx context.Context, params *UpdateReceiptRuleInput, optFns ...func(*Options)) (*UpdateReceiptRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateReceiptRule", params, optFns, addOperationUpdateReceiptRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateReceiptRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
