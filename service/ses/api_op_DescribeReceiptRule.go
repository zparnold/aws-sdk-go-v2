...
func (c *Client) DescribeReceiptRule(ctx context.Context, params *DescribeReceiptRuleInput, optFns ...func(*Options)) (*DescribeReceiptRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReceiptRule", params, optFns, addOperationDescribeReceiptRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReceiptRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
