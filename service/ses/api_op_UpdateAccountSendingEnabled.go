...
func (c *Client) UpdateAccountSendingEnabled(ctx context.Context, params *UpdateAccountSendingEnabledInput, optFns ...func(*Options)) (*UpdateAccountSendingEnabledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAccountSendingEnabled", params, optFns, addOperationUpdateAccountSendingEnabledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAccountSendingEnabledMiddleware(stack *middleware.Stack, options Options) (err error) {
