...
func (c *Client) PutIdentityPolicy(ctx context.Context, params *PutIdentityPolicyInput, optFns ...func(*Options)) (*PutIdentityPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutIdentityPolicy", params, optFns, addOperationPutIdentityPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutIdentityPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
