...
func (c *Client) UpdateConfigurationSetReputationMetricsEnabled(ctx context.Context, params *UpdateConfigurationSetReputationMetricsEnabledInput, optFns ...func(*Options)) (*UpdateConfigurationSetReputationMetricsEnabledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConfigurationSetReputationMetricsEnabled", params, optFns, addOperationUpdateConfigurationSetReputationMetricsEnabledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConfigurationSetReputationMetricsEnabledMiddleware(stack *middleware.Stack, options Options) (err error) {
