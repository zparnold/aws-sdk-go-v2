...
func (c *Client) GetIdentityPolicies(ctx context.Context, params *GetIdentityPoliciesInput, optFns ...func(*Options)) (*GetIdentityPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityPolicies", params, optFns, addOperationGetIdentityPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
