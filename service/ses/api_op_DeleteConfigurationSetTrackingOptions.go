...
func (c *Client) DeleteConfigurationSetTrackingOptions(ctx context.Context, params *DeleteConfigurationSetTrackingOptionsInput, optFns ...func(*Options)) (*DeleteConfigurationSetTrackingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConfigurationSetTrackingOptions", params, optFns, addOperationDeleteConfigurationSetTrackingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConfigurationSetTrackingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
