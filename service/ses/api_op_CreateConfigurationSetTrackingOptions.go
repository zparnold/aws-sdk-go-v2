...
func (c *Client) CreateConfigurationSetTrackingOptions(ctx context.Context, params *CreateConfigurationSetTrackingOptionsInput, optFns ...func(*Options)) (*CreateConfigurationSetTrackingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConfigurationSetTrackingOptions", params, optFns, addOperationCreateConfigurationSetTrackingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConfigurationSetTrackingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
