...
func (c *Client) GetSendQuota(ctx context.Context, params *GetSendQuotaInput, optFns ...func(*Options)) (*GetSendQuotaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSendQuota", params, optFns, addOperationGetSendQuotaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSendQuotaMiddleware(stack *middleware.Stack, options Options) (err error) {
