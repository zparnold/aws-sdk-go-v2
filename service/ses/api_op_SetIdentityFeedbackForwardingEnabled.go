...
func (c *Client) SetIdentityFeedbackForwardingEnabled(ctx context.Context, params *SetIdentityFeedbackForwardingEnabledInput, optFns ...func(*Options)) (*SetIdentityFeedbackForwardingEnabledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIdentityFeedbackForwardingEnabled", params, optFns, addOperationSetIdentityFeedbackForwardingEnabledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIdentityFeedbackForwardingEnabledMiddleware(stack *middleware.Stack, options Options) (err error) {
