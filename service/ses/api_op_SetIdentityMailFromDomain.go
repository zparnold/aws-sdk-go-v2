...
func (c *Client) SetIdentityMailFromDomain(ctx context.Context, params *SetIdentityMailFromDomainInput, optFns ...func(*Options)) (*SetIdentityMailFromDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIdentityMailFromDomain", params, optFns, addOperationSetIdentityMailFromDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIdentityMailFromDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
