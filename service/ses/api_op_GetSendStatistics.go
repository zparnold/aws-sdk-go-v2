...
func (c *Client) GetSendStatistics(ctx context.Context, params *GetSendStatisticsInput, optFns ...func(*Options)) (*GetSendStatisticsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSendStatistics", params, optFns, addOperationGetSendStatisticsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSendStatisticsMiddleware(stack *middleware.Stack, options Options) (err error) {
