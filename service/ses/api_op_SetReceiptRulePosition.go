...
func (c *Client) SetReceiptRulePosition(ctx context.Context, params *SetReceiptRulePositionInput, optFns ...func(*Options)) (*SetReceiptRulePositionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetReceiptRulePosition", params, optFns, addOperationSetReceiptRulePositionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetReceiptRulePositionMiddleware(stack *middleware.Stack, options Options) (err error) {
