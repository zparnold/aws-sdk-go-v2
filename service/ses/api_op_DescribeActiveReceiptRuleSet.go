...
func (c *Client) DescribeActiveReceiptRuleSet(ctx context.Context, params *DescribeActiveReceiptRuleSetInput, optFns ...func(*Options)) (*DescribeActiveReceiptRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeActiveReceiptRuleSet", params, optFns, addOperationDescribeActiveReceiptRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeActiveReceiptRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
