...
func (c *Client) SendTemplatedEmail(ctx context.Context, params *SendTemplatedEmailInput, optFns ...func(*Options)) (*SendTemplatedEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendTemplatedEmail", params, optFns, addOperationSendTemplatedEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendTemplatedEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
