...
func (c *Client) DeleteIdentityPolicy(ctx context.Context, params *DeleteIdentityPolicyInput, optFns ...func(*Options)) (*DeleteIdentityPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIdentityPolicy", params, optFns, addOperationDeleteIdentityPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIdentityPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
