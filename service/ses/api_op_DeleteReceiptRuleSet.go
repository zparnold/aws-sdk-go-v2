...
func (c *Client) DeleteReceiptRuleSet(ctx context.Context, params *DeleteReceiptRuleSetInput, optFns ...func(*Options)) (*DeleteReceiptRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReceiptRuleSet", params, optFns, addOperationDeleteReceiptRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReceiptRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
