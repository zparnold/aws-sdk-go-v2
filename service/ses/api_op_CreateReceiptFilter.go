...
func (c *Client) CreateReceiptFilter(ctx context.Context, params *CreateReceiptFilterInput, optFns ...func(*Options)) (*CreateReceiptFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReceiptFilter", params, optFns, addOperationCreateReceiptFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReceiptFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
