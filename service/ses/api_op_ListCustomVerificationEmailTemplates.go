...
func (c *Client) ListCustomVerificationEmailTemplates(ctx context.Context, params *ListCustomVerificationEmailTemplatesInput, optFns ...func(*Options)) (*ListCustomVerificationEmailTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCustomVerificationEmailTemplates", params, optFns, addOperationListCustomVerificationEmailTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCustomVerificationEmailTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
