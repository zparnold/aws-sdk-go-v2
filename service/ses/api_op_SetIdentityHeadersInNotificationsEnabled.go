...
func (c *Client) SetIdentityHeadersInNotificationsEnabled(ctx context.Context, params *SetIdentityHeadersInNotificationsEnabledInput, optFns ...func(*Options)) (*SetIdentityHeadersInNotificationsEnabledOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetIdentityHeadersInNotificationsEnabled", params, optFns, addOperationSetIdentityHeadersInNotificationsEnabledMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetIdentityHeadersInNotificationsEnabledMiddleware(stack *middleware.Stack, options Options) (err error) {
