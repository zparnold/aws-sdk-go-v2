...
func (c *Client) UpdateTemplate(ctx context.Context, params *UpdateTemplateInput, optFns ...func(*Options)) (*UpdateTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTemplate", params, optFns, addOperationUpdateTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
