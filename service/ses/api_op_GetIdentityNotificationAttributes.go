...
func (c *Client) GetIdentityNotificationAttributes(ctx context.Context, params *GetIdentityNotificationAttributesInput, optFns ...func(*Options)) (*GetIdentityNotificationAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityNotificationAttributes", params, optFns, addOperationGetIdentityNotificationAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityNotificationAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
