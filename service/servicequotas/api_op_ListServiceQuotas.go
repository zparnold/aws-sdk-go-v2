...
func (c *Client) ListServiceQuotas(ctx context.Context, params *ListServiceQuotasInput, optFns ...func(*Options)) (*ListServiceQuotasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServiceQuotas", params, optFns, addOperationListServiceQuotasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServiceQuotasMiddleware(stack *middleware.Stack, options Options) (err error) {
