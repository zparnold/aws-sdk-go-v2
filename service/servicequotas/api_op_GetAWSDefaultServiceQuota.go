...
func (c *Client) GetAWSDefaultServiceQuota(ctx context.Context, params *GetAWSDefaultServiceQuotaInput, optFns ...func(*Options)) (*GetAWSDefaultServiceQuotaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAWSDefaultServiceQuota", params, optFns, addOperationGetAWSDefaultServiceQuotaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAWSDefaultServiceQuotaMiddleware(stack *middleware.Stack, options Options) (err error) {
