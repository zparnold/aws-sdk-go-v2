...
func (c *Client) AssociateServiceQuotaTemplate(ctx context.Context, params *AssociateServiceQuotaTemplateInput, optFns ...func(*Options)) (*AssociateServiceQuotaTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateServiceQuotaTemplate", params, optFns, addOperationAssociateServiceQuotaTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateServiceQuotaTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
