...
func (c *Client) ListServiceQuotaIncreaseRequestsInTemplate(ctx context.Context, params *ListServiceQuotaIncreaseRequestsInTemplateInput, optFns ...func(*Options)) (*ListServiceQuotaIncreaseRequestsInTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServiceQuotaIncreaseRequestsInTemplate", params, optFns, addOperationListServiceQuotaIncreaseRequestsInTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServiceQuotaIncreaseRequestsInTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
