...
func (c *Client) GetServiceQuotaIncreaseRequestFromTemplate(ctx context.Context, params *GetServiceQuotaIncreaseRequestFromTemplateInput, optFns ...func(*Options)) (*GetServiceQuotaIncreaseRequestFromTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServiceQuotaIncreaseRequestFromTemplate", params, optFns, addOperationGetServiceQuotaIncreaseRequestFromTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServiceQuotaIncreaseRequestFromTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
