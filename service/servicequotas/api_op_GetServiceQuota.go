...
func (c *Client) GetServiceQuota(ctx context.Context, params *GetServiceQuotaInput, optFns ...func(*Options)) (*GetServiceQuotaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServiceQuota", params, optFns, addOperationGetServiceQuotaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServiceQuotaMiddleware(stack *middleware.Stack, options Options) (err error) {
