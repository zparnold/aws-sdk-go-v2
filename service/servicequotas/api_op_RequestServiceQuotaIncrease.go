...
func (c *Client) RequestServiceQuotaIncrease(ctx context.Context, params *RequestServiceQuotaIncreaseInput, optFns ...func(*Options)) (*RequestServiceQuotaIncreaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RequestServiceQuotaIncrease", params, optFns, addOperationRequestServiceQuotaIncreaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRequestServiceQuotaIncreaseMiddleware(stack *middleware.Stack, options Options) (err error) {
