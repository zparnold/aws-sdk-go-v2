...
func (c *Client) ListAWSDefaultServiceQuotas(ctx context.Context, params *ListAWSDefaultServiceQuotasInput, optFns ...func(*Options)) (*ListAWSDefaultServiceQuotasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAWSDefaultServiceQuotas", params, optFns, addOperationListAWSDefaultServiceQuotasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAWSDefaultServiceQuotasMiddleware(stack *middleware.Stack, options Options) (err error) {
