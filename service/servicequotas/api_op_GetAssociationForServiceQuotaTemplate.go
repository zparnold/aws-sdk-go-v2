...
func (c *Client) GetAssociationForServiceQuotaTemplate(ctx context.Context, params *GetAssociationForServiceQuotaTemplateInput, optFns ...func(*Options)) (*GetAssociationForServiceQuotaTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssociationForServiceQuotaTemplate", params, optFns, addOperationGetAssociationForServiceQuotaTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssociationForServiceQuotaTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
