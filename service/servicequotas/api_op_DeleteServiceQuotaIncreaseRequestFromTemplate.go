...
func (c *Client) DeleteServiceQuotaIncreaseRequestFromTemplate(ctx context.Context, params *DeleteServiceQuotaIncreaseRequestFromTemplateInput, optFns ...func(*Options)) (*DeleteServiceQuotaIncreaseRequestFromTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteServiceQuotaIncreaseRequestFromTemplate", params, optFns, addOperationDeleteServiceQuotaIncreaseRequestFromTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteServiceQuotaIncreaseRequestFromTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
