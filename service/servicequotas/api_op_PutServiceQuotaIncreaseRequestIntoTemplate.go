...
func (c *Client) PutServiceQuotaIncreaseRequestIntoTemplate(ctx context.Context, params *PutServiceQuotaIncreaseRequestIntoTemplateInput, optFns ...func(*Options)) (*PutServiceQuotaIncreaseRequestIntoTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutServiceQuotaIncreaseRequestIntoTemplate", params, optFns, addOperationPutServiceQuotaIncreaseRequestIntoTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutServiceQuotaIncreaseRequestIntoTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
