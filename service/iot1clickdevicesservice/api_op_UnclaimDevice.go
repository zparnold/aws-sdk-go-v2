...
func (c *Client) UnclaimDevice(ctx context.Context, params *UnclaimDeviceInput, optFns ...func(*Options)) (*UnclaimDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnclaimDevice", params, optFns, addOperationUnclaimDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnclaimDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
