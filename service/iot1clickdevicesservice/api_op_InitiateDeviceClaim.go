...
func (c *Client) InitiateDeviceClaim(ctx context.Context, params *InitiateDeviceClaimInput, optFns ...func(*Options)) (*InitiateDeviceClaimOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InitiateDeviceClaim", params, optFns, addOperationInitiateDeviceClaimMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInitiateDeviceClaimMiddleware(stack *middleware.Stack, options Options) (err error) {
