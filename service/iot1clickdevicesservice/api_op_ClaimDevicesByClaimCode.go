...
func (c *Client) ClaimDevicesByClaimCode(ctx context.Context, params *ClaimDevicesByClaimCodeInput, optFns ...func(*Options)) (*ClaimDevicesByClaimCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ClaimDevicesByClaimCode", params, optFns, addOperationClaimDevicesByClaimCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationClaimDevicesByClaimCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
