...
func (c *Client) FinalizeDeviceClaim(ctx context.Context, params *FinalizeDeviceClaimInput, optFns ...func(*Options)) (*FinalizeDeviceClaimOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FinalizeDeviceClaim", params, optFns, addOperationFinalizeDeviceClaimMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFinalizeDeviceClaimMiddleware(stack *middleware.Stack, options Options) (err error) {
