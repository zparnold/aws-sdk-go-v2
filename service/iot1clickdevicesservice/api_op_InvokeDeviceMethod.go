...
func (c *Client) InvokeDeviceMethod(ctx context.Context, params *InvokeDeviceMethodInput, optFns ...func(*Options)) (*InvokeDeviceMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InvokeDeviceMethod", params, optFns, addOperationInvokeDeviceMethodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInvokeDeviceMethodMiddleware(stack *middleware.Stack, options Options) (err error) {
