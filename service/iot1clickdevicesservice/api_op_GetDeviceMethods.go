...
func (c *Client) GetDeviceMethods(ctx context.Context, params *GetDeviceMethodsInput, optFns ...func(*Options)) (*GetDeviceMethodsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeviceMethods", params, optFns, addOperationGetDeviceMethodsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeviceMethodsMiddleware(stack *middleware.Stack, options Options) (err error) {
