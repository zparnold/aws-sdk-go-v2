...
func (c *Client) DescribeTunnel(ctx context.Context, params *DescribeTunnelInput, optFns ...func(*Options)) (*DescribeTunnelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTunnel", params, optFns, addOperationDescribeTunnelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTunnelMiddleware(stack *middleware.Stack, options Options) (err error) {
