...
func (c *Client) CloseTunnel(ctx context.Context, params *CloseTunnelInput, optFns ...func(*Options)) (*CloseTunnelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CloseTunnel", params, optFns, addOperationCloseTunnelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCloseTunnelMiddleware(stack *middleware.Stack, options Options) (err error) {
