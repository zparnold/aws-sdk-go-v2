...
func (c *Client) ListTunnels(ctx context.Context, params *ListTunnelsInput, optFns ...func(*Options)) (*ListTunnelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTunnels", params, optFns, addOperationListTunnelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTunnelsMiddleware(stack *middleware.Stack, options Options) (err error) {
