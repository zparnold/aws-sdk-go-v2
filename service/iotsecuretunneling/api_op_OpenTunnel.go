...
func (c *Client) OpenTunnel(ctx context.Context, params *OpenTunnelInput, optFns ...func(*Options)) (*OpenTunnelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "OpenTunnel", params, optFns, addOperationOpenTunnelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationOpenTunnelMiddleware(stack *middleware.Stack, options Options) (err error) {
