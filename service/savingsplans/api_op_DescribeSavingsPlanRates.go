...
func (c *Client) DescribeSavingsPlanRates(ctx context.Context, params *DescribeSavingsPlanRatesInput, optFns ...func(*Options)) (*DescribeSavingsPlanRatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSavingsPlanRates", params, optFns, addOperationDescribeSavingsPlanRatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSavingsPlanRatesMiddleware(stack *middleware.Stack, options Options) (err error) {
