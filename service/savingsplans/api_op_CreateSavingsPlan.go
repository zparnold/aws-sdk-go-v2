...
func (c *Client) CreateSavingsPlan(ctx context.Context, params *CreateSavingsPlanInput, optFns ...func(*Options)) (*CreateSavingsPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSavingsPlan", params, optFns, addOperationCreateSavingsPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSavingsPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
