...
func (c *Client) DescribeSavingsPlansOfferings(ctx context.Context, params *DescribeSavingsPlansOfferingsInput, optFns ...func(*Options)) (*DescribeSavingsPlansOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSavingsPlansOfferings", params, optFns, addOperationDescribeSavingsPlansOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSavingsPlansOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
