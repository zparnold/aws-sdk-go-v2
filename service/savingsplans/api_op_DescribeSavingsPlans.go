...
func (c *Client) DescribeSavingsPlans(ctx context.Context, params *DescribeSavingsPlansInput, optFns ...func(*Options)) (*DescribeSavingsPlansOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSavingsPlans", params, optFns, addOperationDescribeSavingsPlansMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSavingsPlansMiddleware(stack *middleware.Stack, options Options) (err error) {
