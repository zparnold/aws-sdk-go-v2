...
func (c *Client) DescribeSavingsPlansOfferingRates(ctx context.Context, params *DescribeSavingsPlansOfferingRatesInput, optFns ...func(*Options)) (*DescribeSavingsPlansOfferingRatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSavingsPlansOfferingRates", params, optFns, addOperationDescribeSavingsPlansOfferingRatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSavingsPlansOfferingRatesMiddleware(stack *middleware.Stack, options Options) (err error) {
