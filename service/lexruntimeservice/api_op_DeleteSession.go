...
func (c *Client) DeleteSession(ctx context.Context, params *DeleteSessionInput, optFns ...func(*Options)) (*DeleteSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSession", params, optFns, addOperationDeleteSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
