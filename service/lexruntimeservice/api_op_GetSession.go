...
func (c *Client) GetSession(ctx context.Context, params *GetSessionInput, optFns ...func(*Options)) (*GetSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSession", params, optFns, addOperationGetSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
