...
func (c *Client) PostContent(ctx context.Context, params *PostContentInput, optFns ...func(*Options)) (*PostContentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PostContent", params, optFns, addOperationPostContentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPostContentMiddleware(stack *middleware.Stack, options Options) (err error) {
