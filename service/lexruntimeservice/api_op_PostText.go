...
func (c *Client) PostText(ctx context.Context, params *PostTextInput, optFns ...func(*Options)) (*PostTextOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PostText", params, optFns, addOperationPostTextMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPostTextMiddleware(stack *middleware.Stack, options Options) (err error) {
