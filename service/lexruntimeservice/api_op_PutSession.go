...
func (c *Client) PutSession(ctx context.Context, params *PutSessionInput, optFns ...func(*Options)) (*PutSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSession", params, optFns, addOperationPutSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
