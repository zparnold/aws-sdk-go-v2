...
func (c *Client) DisassociateFromMasterAccount(ctx context.Context, params *DisassociateFromMasterAccountInput, optFns ...func(*Options)) (*DisassociateFromMasterAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateFromMasterAccount", params, optFns, addOperationDisassociateFromMasterAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateFromMasterAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
