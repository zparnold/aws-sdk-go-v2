...
func (c *Client) DescribeOrganizationConfiguration(ctx context.Context, params *DescribeOrganizationConfigurationInput, optFns ...func(*Options)) (*DescribeOrganizationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrganizationConfiguration", params, optFns, addOperationDescribeOrganizationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrganizationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
