...
func (c *Client) CreateThreatIntelSet(ctx context.Context, params *CreateThreatIntelSetInput, optFns ...func(*Options)) (*CreateThreatIntelSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateThreatIntelSet", params, optFns, addOperationCreateThreatIntelSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateThreatIntelSetMiddleware(stack *middleware.Stack, options Options) (err error) {
