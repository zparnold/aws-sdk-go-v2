...
func (c *Client) StartMonitoringMembers(ctx context.Context, params *StartMonitoringMembersInput, optFns ...func(*Options)) (*StartMonitoringMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMonitoringMembers", params, optFns, addOperationStartMonitoringMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMonitoringMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
