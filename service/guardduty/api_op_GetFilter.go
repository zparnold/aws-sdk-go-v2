...
func (c *Client) GetFilter(ctx context.Context, params *GetFilterInput, optFns ...func(*Options)) (*GetFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFilter", params, optFns, addOperationGetFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
