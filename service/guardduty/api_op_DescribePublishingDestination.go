...
func (c *Client) DescribePublishingDestination(ctx context.Context, params *DescribePublishingDestinationInput, optFns ...func(*Options)) (*DescribePublishingDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePublishingDestination", params, optFns, addOperationDescribePublishingDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePublishingDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
