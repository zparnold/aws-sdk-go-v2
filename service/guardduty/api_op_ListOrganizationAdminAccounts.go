...
func (c *Client) ListOrganizationAdminAccounts(ctx context.Context, params *ListOrganizationAdminAccountsInput, optFns ...func(*Options)) (*ListOrganizationAdminAccountsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOrganizationAdminAccounts", params, optFns, addOperationListOrganizationAdminAccountsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOrganizationAdminAccountsMiddleware(stack *middleware.Stack, options Options) (err error) {
