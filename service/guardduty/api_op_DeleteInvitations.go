...
func (c *Client) DeleteInvitations(ctx context.Context, params *DeleteInvitationsInput, optFns ...func(*Options)) (*DeleteInvitationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInvitations", params, optFns, addOperationDeleteInvitationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInvitationsMiddleware(stack *middleware.Stack, options Options) (err error) {
