...
func (c *Client) CreatePublishingDestination(ctx context.Context, params *CreatePublishingDestinationInput, optFns ...func(*Options)) (*CreatePublishingDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePublishingDestination", params, optFns, addOperationCreatePublishingDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePublishingDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
