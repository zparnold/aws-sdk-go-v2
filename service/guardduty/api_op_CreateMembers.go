...
func (c *Client) CreateMembers(ctx context.Context, params *CreateMembersInput, optFns ...func(*Options)) (*CreateMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMembers", params, optFns, addOperationCreateMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
