...
func (c *Client) StopMonitoringMembers(ctx context.Context, params *StopMonitoringMembersInput, optFns ...func(*Options)) (*StopMonitoringMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopMonitoringMembers", params, optFns, addOperationStopMonitoringMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopMonitoringMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
