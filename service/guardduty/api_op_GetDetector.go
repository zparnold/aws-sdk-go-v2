...
func (c *Client) GetDetector(ctx context.Context, params *GetDetectorInput, optFns ...func(*Options)) (*GetDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDetector", params, optFns, addOperationGetDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
