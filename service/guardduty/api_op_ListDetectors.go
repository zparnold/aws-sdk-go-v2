...
func (c *Client) ListDetectors(ctx context.Context, params *ListDetectorsInput, optFns ...func(*Options)) (*ListDetectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDetectors", params, optFns, addOperationListDetectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDetectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
