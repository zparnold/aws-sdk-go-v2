...
func (c *Client) UpdateThreatIntelSet(ctx context.Context, params *UpdateThreatIntelSetInput, optFns ...func(*Options)) (*UpdateThreatIntelSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateThreatIntelSet", params, optFns, addOperationUpdateThreatIntelSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThreatIntelSetMiddleware(stack *middleware.Stack, options Options) (err error) {
