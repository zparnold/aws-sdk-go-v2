...
func (c *Client) UpdateMemberDetectors(ctx context.Context, params *UpdateMemberDetectorsInput, optFns ...func(*Options)) (*UpdateMemberDetectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMemberDetectors", params, optFns, addOperationUpdateMemberDetectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMemberDetectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
