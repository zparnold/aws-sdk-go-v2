...
func (c *Client) ListThreatIntelSets(ctx context.Context, params *ListThreatIntelSetsInput, optFns ...func(*Options)) (*ListThreatIntelSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThreatIntelSets", params, optFns, addOperationListThreatIntelSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThreatIntelSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
