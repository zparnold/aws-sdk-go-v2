...
func (c *Client) UpdatePublishingDestination(ctx context.Context, params *UpdatePublishingDestinationInput, optFns ...func(*Options)) (*UpdatePublishingDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePublishingDestination", params, optFns, addOperationUpdatePublishingDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePublishingDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
