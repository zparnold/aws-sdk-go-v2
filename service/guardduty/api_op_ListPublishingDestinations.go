...
func (c *Client) ListPublishingDestinations(ctx context.Context, params *ListPublishingDestinationsInput, optFns ...func(*Options)) (*ListPublishingDestinationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPublishingDestinations", params, optFns, addOperationListPublishingDestinationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPublishingDestinationsMiddleware(stack *middleware.Stack, options Options) (err error) {
