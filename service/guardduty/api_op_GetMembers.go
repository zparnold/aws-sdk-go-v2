...
func (c *Client) GetMembers(ctx context.Context, params *GetMembersInput, optFns ...func(*Options)) (*GetMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMembers", params, optFns, addOperationGetMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
