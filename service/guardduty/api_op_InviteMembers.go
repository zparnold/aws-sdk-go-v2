...
func (c *Client) InviteMembers(ctx context.Context, params *InviteMembersInput, optFns ...func(*Options)) (*InviteMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InviteMembers", params, optFns, addOperationInviteMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInviteMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
