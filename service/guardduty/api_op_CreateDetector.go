...
func (c *Client) CreateDetector(ctx context.Context, params *CreateDetectorInput, optFns ...func(*Options)) (*CreateDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDetector", params, optFns, addOperationCreateDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
