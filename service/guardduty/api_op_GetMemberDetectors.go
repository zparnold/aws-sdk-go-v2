...
func (c *Client) GetMemberDetectors(ctx context.Context, params *GetMemberDetectorsInput, optFns ...func(*Options)) (*GetMemberDetectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMemberDetectors", params, optFns, addOperationGetMemberDetectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMemberDetectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
