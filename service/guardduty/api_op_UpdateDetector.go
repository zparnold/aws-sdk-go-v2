...
func (c *Client) UpdateDetector(ctx context.Context, params *UpdateDetectorInput, optFns ...func(*Options)) (*UpdateDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDetector", params, optFns, addOperationUpdateDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
