...
func (c *Client) GetFindingsStatistics(ctx context.Context, params *GetFindingsStatisticsInput, optFns ...func(*Options)) (*GetFindingsStatisticsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFindingsStatistics", params, optFns, addOperationGetFindingsStatisticsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFindingsStatisticsMiddleware(stack *middleware.Stack, options Options) (err error) {
