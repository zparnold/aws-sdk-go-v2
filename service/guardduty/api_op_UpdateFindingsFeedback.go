...
func (c *Client) UpdateFindingsFeedback(ctx context.Context, params *UpdateFindingsFeedbackInput, optFns ...func(*Options)) (*UpdateFindingsFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFindingsFeedback", params, optFns, addOperationUpdateFindingsFeedbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFindingsFeedbackMiddleware(stack *middleware.Stack, options Options) (err error) {
