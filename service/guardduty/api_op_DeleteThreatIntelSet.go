...
func (c *Client) DeleteThreatIntelSet(ctx context.Context, params *DeleteThreatIntelSetInput, optFns ...func(*Options)) (*DeleteThreatIntelSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteThreatIntelSet", params, optFns, addOperationDeleteThreatIntelSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteThreatIntelSetMiddleware(stack *middleware.Stack, options Options) (err error) {
