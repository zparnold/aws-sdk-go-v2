...
func (c *Client) DeclineInvitations(ctx context.Context, params *DeclineInvitationsInput, optFns ...func(*Options)) (*DeclineInvitationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeclineInvitations", params, optFns, addOperationDeclineInvitationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeclineInvitationsMiddleware(stack *middleware.Stack, options Options) (err error) {
