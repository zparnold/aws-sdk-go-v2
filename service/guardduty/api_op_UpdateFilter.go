...
func (c *Client) UpdateFilter(ctx context.Context, params *UpdateFilterInput, optFns ...func(*Options)) (*UpdateFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFilter", params, optFns, addOperationUpdateFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
