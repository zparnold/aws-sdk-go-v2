...
func (c *Client) EnableOrganizationAdminAccount(ctx context.Context, params *EnableOrganizationAdminAccountInput, optFns ...func(*Options)) (*EnableOrganizationAdminAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableOrganizationAdminAccount", params, optFns, addOperationEnableOrganizationAdminAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableOrganizationAdminAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
