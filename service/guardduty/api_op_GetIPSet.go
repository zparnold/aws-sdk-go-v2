...
func (c *Client) GetIPSet(ctx context.Context, params *GetIPSetInput, optFns ...func(*Options)) (*GetIPSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIPSet", params, optFns, addOperationGetIPSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIPSetMiddleware(stack *middleware.Stack, options Options) (err error) {
