...
func (c *Client) GetThreatIntelSet(ctx context.Context, params *GetThreatIntelSetInput, optFns ...func(*Options)) (*GetThreatIntelSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetThreatIntelSet", params, optFns, addOperationGetThreatIntelSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetThreatIntelSetMiddleware(stack *middleware.Stack, options Options) (err error) {
