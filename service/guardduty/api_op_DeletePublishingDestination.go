...
func (c *Client) DeletePublishingDestination(ctx context.Context, params *DeletePublishingDestinationInput, optFns ...func(*Options)) (*DeletePublishingDestinationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePublishingDestination", params, optFns, addOperationDeletePublishingDestinationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePublishingDestinationMiddleware(stack *middleware.Stack, options Options) (err error) {
