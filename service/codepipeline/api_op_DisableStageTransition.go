...
func (c *Client) DisableStageTransition(ctx context.Context, params *DisableStageTransitionInput, optFns ...func(*Options)) (*DisableStageTransitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableStageTransition", params, optFns, addOperationDisableStageTransitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableStageTransitionMiddleware(stack *middleware.Stack, options Options) (err error) {
