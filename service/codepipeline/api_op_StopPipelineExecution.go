...
func (c *Client) StopPipelineExecution(ctx context.Context, params *StopPipelineExecutionInput, optFns ...func(*Options)) (*StopPipelineExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopPipelineExecution", params, optFns, addOperationStopPipelineExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopPipelineExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
