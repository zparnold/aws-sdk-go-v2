...
func (c *Client) UpdatePipeline(ctx context.Context, params *UpdatePipelineInput, optFns ...func(*Options)) (*UpdatePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePipeline", params, optFns, addOperationUpdatePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
