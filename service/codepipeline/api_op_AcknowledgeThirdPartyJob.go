...
func (c *Client) AcknowledgeThirdPartyJob(ctx context.Context, params *AcknowledgeThirdPartyJobInput, optFns ...func(*Options)) (*AcknowledgeThirdPartyJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcknowledgeThirdPartyJob", params, optFns, addOperationAcknowledgeThirdPartyJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcknowledgeThirdPartyJobMiddleware(stack *middleware.Stack, options Options) (err error) {
