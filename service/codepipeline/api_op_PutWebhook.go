...
func (c *Client) PutWebhook(ctx context.Context, params *PutWebhookInput, optFns ...func(*Options)) (*PutWebhookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutWebhook", params, optFns, addOperationPutWebhookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutWebhookMiddleware(stack *middleware.Stack, options Options) (err error) {
