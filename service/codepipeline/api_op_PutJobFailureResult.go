...
func (c *Client) PutJobFailureResult(ctx context.Context, params *PutJobFailureResultInput, optFns ...func(*Options)) (*PutJobFailureResultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutJobFailureResult", params, optFns, addOperationPutJobFailureResultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutJobFailureResultMiddleware(stack *middleware.Stack, options Options) (err error) {
