...
func (c *Client) ListPipelineExecutions(ctx context.Context, params *ListPipelineExecutionsInput, optFns ...func(*Options)) (*ListPipelineExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPipelineExecutions", params, optFns, addOperationListPipelineExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPipelineExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
