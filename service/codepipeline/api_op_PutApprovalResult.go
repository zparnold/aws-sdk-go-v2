...
func (c *Client) PutApprovalResult(ctx context.Context, params *PutApprovalResultInput, optFns ...func(*Options)) (*PutApprovalResultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutApprovalResult", params, optFns, addOperationPutApprovalResultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutApprovalResultMiddleware(stack *middleware.Stack, options Options) (err error) {
