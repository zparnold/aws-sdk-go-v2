...
func (c *Client) DeleteCustomActionType(ctx context.Context, params *DeleteCustomActionTypeInput, optFns ...func(*Options)) (*DeleteCustomActionTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCustomActionType", params, optFns, addOperationDeleteCustomActionTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCustomActionTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
