...
func (c *Client) PollForJobs(ctx context.Context, params *PollForJobsInput, optFns ...func(*Options)) (*PollForJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PollForJobs", params, optFns, addOperationPollForJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPollForJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
