...
func (c *Client) ListActionTypes(ctx context.Context, params *ListActionTypesInput, optFns ...func(*Options)) (*ListActionTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListActionTypes", params, optFns, addOperationListActionTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListActionTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
