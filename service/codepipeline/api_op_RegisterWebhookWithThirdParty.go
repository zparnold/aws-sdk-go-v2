...
func (c *Client) RegisterWebhookWithThirdParty(ctx context.Context, params *RegisterWebhookWithThirdPartyInput, optFns ...func(*Options)) (*RegisterWebhookWithThirdPartyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterWebhookWithThirdParty", params, optFns, addOperationRegisterWebhookWithThirdPartyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterWebhookWithThirdPartyMiddleware(stack *middleware.Stack, options Options) (err error) {
