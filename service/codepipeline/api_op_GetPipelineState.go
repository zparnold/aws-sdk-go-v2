...
func (c *Client) GetPipelineState(ctx context.Context, params *GetPipelineStateInput, optFns ...func(*Options)) (*GetPipelineStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPipelineState", params, optFns, addOperationGetPipelineStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPipelineStateMiddleware(stack *middleware.Stack, options Options) (err error) {
