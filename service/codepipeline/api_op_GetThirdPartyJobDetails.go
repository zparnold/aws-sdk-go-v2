...
func (c *Client) GetThirdPartyJobDetails(ctx context.Context, params *GetThirdPartyJobDetailsInput, optFns ...func(*Options)) (*GetThirdPartyJobDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetThirdPartyJobDetails", params, optFns, addOperationGetThirdPartyJobDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetThirdPartyJobDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
