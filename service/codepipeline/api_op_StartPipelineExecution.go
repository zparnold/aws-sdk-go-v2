...
func (c *Client) StartPipelineExecution(ctx context.Context, params *StartPipelineExecutionInput, optFns ...func(*Options)) (*StartPipelineExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartPipelineExecution", params, optFns, addOperationStartPipelineExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartPipelineExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
