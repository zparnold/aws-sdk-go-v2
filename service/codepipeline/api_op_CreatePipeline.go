...
func (c *Client) CreatePipeline(ctx context.Context, params *CreatePipelineInput, optFns ...func(*Options)) (*CreatePipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePipeline", params, optFns, addOperationCreatePipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
