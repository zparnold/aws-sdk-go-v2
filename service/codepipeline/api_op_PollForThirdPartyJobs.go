...
func (c *Client) PollForThirdPartyJobs(ctx context.Context, params *PollForThirdPartyJobsInput, optFns ...func(*Options)) (*PollForThirdPartyJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PollForThirdPartyJobs", params, optFns, addOperationPollForThirdPartyJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPollForThirdPartyJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
