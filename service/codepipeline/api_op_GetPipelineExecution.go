...
func (c *Client) GetPipelineExecution(ctx context.Context, params *GetPipelineExecutionInput, optFns ...func(*Options)) (*GetPipelineExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPipelineExecution", params, optFns, addOperationGetPipelineExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPipelineExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
