...
func (c *Client) ListPipelines(ctx context.Context, params *ListPipelinesInput, optFns ...func(*Options)) (*ListPipelinesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPipelines", params, optFns, addOperationListPipelinesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPipelinesMiddleware(stack *middleware.Stack, options Options) (err error) {
