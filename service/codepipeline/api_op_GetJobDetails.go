...
func (c *Client) GetJobDetails(ctx context.Context, params *GetJobDetailsInput, optFns ...func(*Options)) (*GetJobDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobDetails", params, optFns, addOperationGetJobDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
