...
func (c *Client) CreateCustomActionType(ctx context.Context, params *CreateCustomActionTypeInput, optFns ...func(*Options)) (*CreateCustomActionTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomActionType", params, optFns, addOperationCreateCustomActionTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomActionTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
