...
func (c *Client) ListActionExecutions(ctx context.Context, params *ListActionExecutionsInput, optFns ...func(*Options)) (*ListActionExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListActionExecutions", params, optFns, addOperationListActionExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListActionExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
