...
func (c *Client) PutThirdPartyJobSuccessResult(ctx context.Context, params *PutThirdPartyJobSuccessResultInput, optFns ...func(*Options)) (*PutThirdPartyJobSuccessResultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutThirdPartyJobSuccessResult", params, optFns, addOperationPutThirdPartyJobSuccessResultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutThirdPartyJobSuccessResultMiddleware(stack *middleware.Stack, options Options) (err error) {
