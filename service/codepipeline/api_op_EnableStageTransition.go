...
func (c *Client) EnableStageTransition(ctx context.Context, params *EnableStageTransitionInput, optFns ...func(*Options)) (*EnableStageTransitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableStageTransition", params, optFns, addOperationEnableStageTransitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableStageTransitionMiddleware(stack *middleware.Stack, options Options) (err error) {
