...
func (c *Client) RetryStageExecution(ctx context.Context, params *RetryStageExecutionInput, optFns ...func(*Options)) (*RetryStageExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetryStageExecution", params, optFns, addOperationRetryStageExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetryStageExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
