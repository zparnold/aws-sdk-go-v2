...
func (c *Client) GetPipeline(ctx context.Context, params *GetPipelineInput, optFns ...func(*Options)) (*GetPipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPipeline", params, optFns, addOperationGetPipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
