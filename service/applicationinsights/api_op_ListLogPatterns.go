...
func (c *Client) ListLogPatterns(ctx context.Context, params *ListLogPatternsInput, optFns ...func(*Options)) (*ListLogPatternsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLogPatterns", params, optFns, addOperationListLogPatternsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLogPatternsMiddleware(stack *middleware.Stack, options Options) (err error) {
