...
func (c *Client) DescribeProblem(ctx context.Context, params *DescribeProblemInput, optFns ...func(*Options)) (*DescribeProblemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProblem", params, optFns, addOperationDescribeProblemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProblemMiddleware(stack *middleware.Stack, options Options) (err error) {
