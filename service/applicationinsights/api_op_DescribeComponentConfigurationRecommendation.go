...
func (c *Client) DescribeComponentConfigurationRecommendation(ctx context.Context, params *DescribeComponentConfigurationRecommendationInput, optFns ...func(*Options)) (*DescribeComponentConfigurationRecommendationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeComponentConfigurationRecommendation", params, optFns, addOperationDescribeComponentConfigurationRecommendationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeComponentConfigurationRecommendationMiddleware(stack *middleware.Stack, options Options) (err error) {
