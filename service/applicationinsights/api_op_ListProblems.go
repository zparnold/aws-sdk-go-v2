...
func (c *Client) ListProblems(ctx context.Context, params *ListProblemsInput, optFns ...func(*Options)) (*ListProblemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProblems", params, optFns, addOperationListProblemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProblemsMiddleware(stack *middleware.Stack, options Options) (err error) {
