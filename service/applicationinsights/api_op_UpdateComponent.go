...
func (c *Client) UpdateComponent(ctx context.Context, params *UpdateComponentInput, optFns ...func(*Options)) (*UpdateComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateComponent", params, optFns, addOperationUpdateComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
