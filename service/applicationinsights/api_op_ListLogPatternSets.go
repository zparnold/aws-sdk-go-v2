...
func (c *Client) ListLogPatternSets(ctx context.Context, params *ListLogPatternSetsInput, optFns ...func(*Options)) (*ListLogPatternSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLogPatternSets", params, optFns, addOperationListLogPatternSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLogPatternSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
