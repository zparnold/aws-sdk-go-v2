...
func (c *Client) CreateLogPattern(ctx context.Context, params *CreateLogPatternInput, optFns ...func(*Options)) (*CreateLogPatternOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLogPattern", params, optFns, addOperationCreateLogPatternMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLogPatternMiddleware(stack *middleware.Stack, options Options) (err error) {
