...
func (c *Client) DescribeComponentConfiguration(ctx context.Context, params *DescribeComponentConfigurationInput, optFns ...func(*Options)) (*DescribeComponentConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeComponentConfiguration", params, optFns, addOperationDescribeComponentConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeComponentConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
