...
func (c *Client) DeleteLogPattern(ctx context.Context, params *DeleteLogPatternInput, optFns ...func(*Options)) (*DeleteLogPatternOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLogPattern", params, optFns, addOperationDeleteLogPatternMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLogPatternMiddleware(stack *middleware.Stack, options Options) (err error) {
