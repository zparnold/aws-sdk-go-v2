...
func (c *Client) DescribeComponent(ctx context.Context, params *DescribeComponentInput, optFns ...func(*Options)) (*DescribeComponentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeComponent", params, optFns, addOperationDescribeComponentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeComponentMiddleware(stack *middleware.Stack, options Options) (err error) {
