...
func (c *Client) DescribeObservation(ctx context.Context, params *DescribeObservationInput, optFns ...func(*Options)) (*DescribeObservationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeObservation", params, optFns, addOperationDescribeObservationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeObservationMiddleware(stack *middleware.Stack, options Options) (err error) {
