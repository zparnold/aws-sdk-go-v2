...
func (c *Client) DescribeProblemObservations(ctx context.Context, params *DescribeProblemObservationsInput, optFns ...func(*Options)) (*DescribeProblemObservationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProblemObservations", params, optFns, addOperationDescribeProblemObservationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProblemObservationsMiddleware(stack *middleware.Stack, options Options) (err error) {
