...
func (c *Client) UpdateComponentConfiguration(ctx context.Context, params *UpdateComponentConfigurationInput, optFns ...func(*Options)) (*UpdateComponentConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateComponentConfiguration", params, optFns, addOperationUpdateComponentConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateComponentConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
