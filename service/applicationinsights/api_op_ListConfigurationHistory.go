...
func (c *Client) ListConfigurationHistory(ctx context.Context, params *ListConfigurationHistoryInput, optFns ...func(*Options)) (*ListConfigurationHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConfigurationHistory", params, optFns, addOperationListConfigurationHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConfigurationHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
