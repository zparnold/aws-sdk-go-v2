...
func (c *Client) ModifyTrafficMirrorFilterNetworkServices(ctx context.Context, params *ModifyTrafficMirrorFilterNetworkServicesInput, optFns ...func(*Options)) (*ModifyTrafficMirrorFilterNetworkServicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyTrafficMirrorFilterNetworkServices", params, optFns, addOperationModifyTrafficMirrorFilterNetworkServicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyTrafficMirrorFilterNetworkServicesMiddleware(stack *middleware.Stack, options Options) (err error) {
