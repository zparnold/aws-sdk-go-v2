...
func (c *Client) ModifyTransitGatewayVpcAttachment(ctx context.Context, params *ModifyTransitGatewayVpcAttachmentInput, optFns ...func(*Options)) (*ModifyTransitGatewayVpcAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyTransitGatewayVpcAttachment", params, optFns, addOperationModifyTransitGatewayVpcAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyTransitGatewayVpcAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
