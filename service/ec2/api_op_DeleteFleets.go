...
func (c *Client) DeleteFleets(ctx context.Context, params *DeleteFleetsInput, optFns ...func(*Options)) (*DeleteFleetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFleets", params, optFns, addOperationDeleteFleetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFleetsMiddleware(stack *middleware.Stack, options Options) (err error) {
