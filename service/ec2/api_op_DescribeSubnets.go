...
func (c *Client) DescribeSubnets(ctx context.Context, params *DescribeSubnetsInput, optFns ...func(*Options)) (*DescribeSubnetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSubnets", params, optFns, addOperationDescribeSubnetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSubnetsMiddleware(stack *middleware.Stack, options Options) (err error) {
