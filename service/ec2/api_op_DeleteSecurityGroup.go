...
func (c *Client) DeleteSecurityGroup(ctx context.Context, params *DeleteSecurityGroupInput, optFns ...func(*Options)) (*DeleteSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSecurityGroup", params, optFns, addOperationDeleteSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
