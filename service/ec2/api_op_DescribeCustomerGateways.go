...
func (c *Client) DescribeCustomerGateways(ctx context.Context, params *DescribeCustomerGatewaysInput, optFns ...func(*Options)) (*DescribeCustomerGatewaysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCustomerGateways", params, optFns, addOperationDescribeCustomerGatewaysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCustomerGatewaysMiddleware(stack *middleware.Stack, options Options) (err error) {
