...
func (c *Client) GetTransitGatewayRouteTableAssociations(ctx context.Context, params *GetTransitGatewayRouteTableAssociationsInput, optFns ...func(*Options)) (*GetTransitGatewayRouteTableAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTransitGatewayRouteTableAssociations", params, optFns, addOperationGetTransitGatewayRouteTableAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTransitGatewayRouteTableAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
