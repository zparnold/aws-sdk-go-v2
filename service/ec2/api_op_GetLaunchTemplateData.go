...
func (c *Client) GetLaunchTemplateData(ctx context.Context, params *GetLaunchTemplateDataInput, optFns ...func(*Options)) (*GetLaunchTemplateDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLaunchTemplateData", params, optFns, addOperationGetLaunchTemplateDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLaunchTemplateDataMiddleware(stack *middleware.Stack, options Options) (err error) {
