...
func (c *Client) DetachVpnGateway(ctx context.Context, params *DetachVpnGatewayInput, optFns ...func(*Options)) (*DetachVpnGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachVpnGateway", params, optFns, addOperationDetachVpnGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachVpnGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
