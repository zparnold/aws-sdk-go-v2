...
func (c *Client) AssociateVpcCidrBlock(ctx context.Context, params *AssociateVpcCidrBlockInput, optFns ...func(*Options)) (*AssociateVpcCidrBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateVpcCidrBlock", params, optFns, addOperationAssociateVpcCidrBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateVpcCidrBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
