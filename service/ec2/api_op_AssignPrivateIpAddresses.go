...
func (c *Client) AssignPrivateIpAddresses(ctx context.Context, params *AssignPrivateIpAddressesInput, optFns ...func(*Options)) (*AssignPrivateIpAddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssignPrivateIpAddresses", params, optFns, addOperationAssignPrivateIpAddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssignPrivateIpAddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
