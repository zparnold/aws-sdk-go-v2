...
func (c *Client) DeleteVpc(ctx context.Context, params *DeleteVpcInput, optFns ...func(*Options)) (*DeleteVpcOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpc", params, optFns, addOperationDeleteVpcMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpcMiddleware(stack *middleware.Stack, options Options) (err error) {
