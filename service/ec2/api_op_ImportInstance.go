...
func (c *Client) ImportInstance(ctx context.Context, params *ImportInstanceInput, optFns ...func(*Options)) (*ImportInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportInstance", params, optFns, addOperationImportInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
