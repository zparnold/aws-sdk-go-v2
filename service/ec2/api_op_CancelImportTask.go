...
func (c *Client) CancelImportTask(ctx context.Context, params *CancelImportTaskInput, optFns ...func(*Options)) (*CancelImportTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelImportTask", params, optFns, addOperationCancelImportTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelImportTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
