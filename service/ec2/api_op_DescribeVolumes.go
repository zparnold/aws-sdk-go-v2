...
func (c *Client) DescribeVolumes(ctx context.Context, params *DescribeVolumesInput, optFns ...func(*Options)) (*DescribeVolumesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVolumes", params, optFns, addOperationDescribeVolumesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVolumesMiddleware(stack *middleware.Stack, options Options) (err error) {
