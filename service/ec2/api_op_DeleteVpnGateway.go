...
func (c *Client) DeleteVpnGateway(ctx context.Context, params *DeleteVpnGatewayInput, optFns ...func(*Options)) (*DeleteVpnGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpnGateway", params, optFns, addOperationDeleteVpnGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpnGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
