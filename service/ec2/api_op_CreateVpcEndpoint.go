...
func (c *Client) CreateVpcEndpoint(ctx context.Context, params *CreateVpcEndpointInput, optFns ...func(*Options)) (*CreateVpcEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpcEndpoint", params, optFns, addOperationCreateVpcEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpcEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
