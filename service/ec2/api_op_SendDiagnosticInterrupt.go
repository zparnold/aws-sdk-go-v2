...
func (c *Client) SendDiagnosticInterrupt(ctx context.Context, params *SendDiagnosticInterruptInput, optFns ...func(*Options)) (*SendDiagnosticInterruptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendDiagnosticInterrupt", params, optFns, addOperationSendDiagnosticInterruptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendDiagnosticInterruptMiddleware(stack *middleware.Stack, options Options) (err error) {
