...
func (c *Client) DescribeInstanceTypes(ctx context.Context, params *DescribeInstanceTypesInput, optFns ...func(*Options)) (*DescribeInstanceTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceTypes", params, optFns, addOperationDescribeInstanceTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
