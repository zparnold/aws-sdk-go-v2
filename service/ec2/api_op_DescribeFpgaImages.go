...
func (c *Client) DescribeFpgaImages(ctx context.Context, params *DescribeFpgaImagesInput, optFns ...func(*Options)) (*DescribeFpgaImagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFpgaImages", params, optFns, addOperationDescribeFpgaImagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFpgaImagesMiddleware(stack *middleware.Stack, options Options) (err error) {
