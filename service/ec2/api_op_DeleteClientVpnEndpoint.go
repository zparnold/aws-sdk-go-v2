...
func (c *Client) DeleteClientVpnEndpoint(ctx context.Context, params *DeleteClientVpnEndpointInput, optFns ...func(*Options)) (*DeleteClientVpnEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClientVpnEndpoint", params, optFns, addOperationDeleteClientVpnEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClientVpnEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
