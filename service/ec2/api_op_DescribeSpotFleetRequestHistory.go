...
func (c *Client) DescribeSpotFleetRequestHistory(ctx context.Context, params *DescribeSpotFleetRequestHistoryInput, optFns ...func(*Options)) (*DescribeSpotFleetRequestHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSpotFleetRequestHistory", params, optFns, addOperationDescribeSpotFleetRequestHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSpotFleetRequestHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
