...
func (c *Client) DescribeByoipCidrs(ctx context.Context, params *DescribeByoipCidrsInput, optFns ...func(*Options)) (*DescribeByoipCidrsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeByoipCidrs", params, optFns, addOperationDescribeByoipCidrsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeByoipCidrsMiddleware(stack *middleware.Stack, options Options) (err error) {
