...
func (c *Client) DescribeHostReservationOfferings(ctx context.Context, params *DescribeHostReservationOfferingsInput, optFns ...func(*Options)) (*DescribeHostReservationOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHostReservationOfferings", params, optFns, addOperationDescribeHostReservationOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHostReservationOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
