...
func (c *Client) DescribeHostReservations(ctx context.Context, params *DescribeHostReservationsInput, optFns ...func(*Options)) (*DescribeHostReservationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHostReservations", params, optFns, addOperationDescribeHostReservationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHostReservationsMiddleware(stack *middleware.Stack, options Options) (err error) {
