...
func (c *Client) CreateSecurityGroup(ctx context.Context, params *CreateSecurityGroupInput, optFns ...func(*Options)) (*CreateSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSecurityGroup", params, optFns, addOperationCreateSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
