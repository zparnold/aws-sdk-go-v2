...
func (c *Client) DescribeKeyPairs(ctx context.Context, params *DescribeKeyPairsInput, optFns ...func(*Options)) (*DescribeKeyPairsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeKeyPairs", params, optFns, addOperationDescribeKeyPairsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeKeyPairsMiddleware(stack *middleware.Stack, options Options) (err error) {
