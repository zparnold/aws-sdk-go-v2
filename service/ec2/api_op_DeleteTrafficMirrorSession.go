...
func (c *Client) DeleteTrafficMirrorSession(ctx context.Context, params *DeleteTrafficMirrorSessionInput, optFns ...func(*Options)) (*DeleteTrafficMirrorSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrafficMirrorSession", params, optFns, addOperationDeleteTrafficMirrorSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrafficMirrorSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
