...
func (c *Client) RejectVpcPeeringConnection(ctx context.Context, params *RejectVpcPeeringConnectionInput, optFns ...func(*Options)) (*RejectVpcPeeringConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectVpcPeeringConnection", params, optFns, addOperationRejectVpcPeeringConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectVpcPeeringConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
