...
func (c *Client) CreateNetworkInterface(ctx context.Context, params *CreateNetworkInterfaceInput, optFns ...func(*Options)) (*CreateNetworkInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNetworkInterface", params, optFns, addOperationCreateNetworkInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNetworkInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
