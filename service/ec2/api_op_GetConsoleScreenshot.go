...
func (c *Client) GetConsoleScreenshot(ctx context.Context, params *GetConsoleScreenshotInput, optFns ...func(*Options)) (*GetConsoleScreenshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConsoleScreenshot", params, optFns, addOperationGetConsoleScreenshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConsoleScreenshotMiddleware(stack *middleware.Stack, options Options) (err error) {
