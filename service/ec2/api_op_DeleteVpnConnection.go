...
func (c *Client) DeleteVpnConnection(ctx context.Context, params *DeleteVpnConnectionInput, optFns ...func(*Options)) (*DeleteVpnConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpnConnection", params, optFns, addOperationDeleteVpnConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpnConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
