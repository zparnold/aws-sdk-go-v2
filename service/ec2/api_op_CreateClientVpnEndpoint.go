...
func (c *Client) CreateClientVpnEndpoint(ctx context.Context, params *CreateClientVpnEndpointInput, optFns ...func(*Options)) (*CreateClientVpnEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateClientVpnEndpoint", params, optFns, addOperationCreateClientVpnEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateClientVpnEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
