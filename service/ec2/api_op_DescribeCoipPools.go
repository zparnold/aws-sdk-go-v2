...
func (c *Client) DescribeCoipPools(ctx context.Context, params *DescribeCoipPoolsInput, optFns ...func(*Options)) (*DescribeCoipPoolsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCoipPools", params, optFns, addOperationDescribeCoipPoolsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCoipPoolsMiddleware(stack *middleware.Stack, options Options) (err error) {
