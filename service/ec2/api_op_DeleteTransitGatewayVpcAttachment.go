...
func (c *Client) DeleteTransitGatewayVpcAttachment(ctx context.Context, params *DeleteTransitGatewayVpcAttachmentInput, optFns ...func(*Options)) (*DeleteTransitGatewayVpcAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTransitGatewayVpcAttachment", params, optFns, addOperationDeleteTransitGatewayVpcAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTransitGatewayVpcAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
