...
func (c *Client) ModifyVolume(ctx context.Context, params *ModifyVolumeInput, optFns ...func(*Options)) (*ModifyVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVolume", params, optFns, addOperationModifyVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
