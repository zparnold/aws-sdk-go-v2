...
func (c *Client) DescribeTransitGatewayVpcAttachments(ctx context.Context, params *DescribeTransitGatewayVpcAttachmentsInput, optFns ...func(*Options)) (*DescribeTransitGatewayVpcAttachmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTransitGatewayVpcAttachments", params, optFns, addOperationDescribeTransitGatewayVpcAttachmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTransitGatewayVpcAttachmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
