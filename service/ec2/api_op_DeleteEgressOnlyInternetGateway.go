...
func (c *Client) DeleteEgressOnlyInternetGateway(ctx context.Context, params *DeleteEgressOnlyInternetGatewayInput, optFns ...func(*Options)) (*DeleteEgressOnlyInternetGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEgressOnlyInternetGateway", params, optFns, addOperationDeleteEgressOnlyInternetGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEgressOnlyInternetGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
