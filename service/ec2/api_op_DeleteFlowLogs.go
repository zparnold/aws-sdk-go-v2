...
func (c *Client) DeleteFlowLogs(ctx context.Context, params *DeleteFlowLogsInput, optFns ...func(*Options)) (*DeleteFlowLogsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFlowLogs", params, optFns, addOperationDeleteFlowLogsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFlowLogsMiddleware(stack *middleware.Stack, options Options) (err error) {
