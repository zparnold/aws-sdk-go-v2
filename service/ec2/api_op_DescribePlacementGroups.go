...
func (c *Client) DescribePlacementGroups(ctx context.Context, params *DescribePlacementGroupsInput, optFns ...func(*Options)) (*DescribePlacementGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePlacementGroups", params, optFns, addOperationDescribePlacementGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePlacementGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
