...
func (c *Client) DescribeSpotDatafeedSubscription(ctx context.Context, params *DescribeSpotDatafeedSubscriptionInput, optFns ...func(*Options)) (*DescribeSpotDatafeedSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSpotDatafeedSubscription", params, optFns, addOperationDescribeSpotDatafeedSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSpotDatafeedSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
