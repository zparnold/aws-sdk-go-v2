...
func (c *Client) ModifyVpcEndpointServiceConfiguration(ctx context.Context, params *ModifyVpcEndpointServiceConfigurationInput, optFns ...func(*Options)) (*ModifyVpcEndpointServiceConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVpcEndpointServiceConfiguration", params, optFns, addOperationModifyVpcEndpointServiceConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVpcEndpointServiceConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
