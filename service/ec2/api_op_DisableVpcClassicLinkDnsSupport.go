...
func (c *Client) DisableVpcClassicLinkDnsSupport(ctx context.Context, params *DisableVpcClassicLinkDnsSupportInput, optFns ...func(*Options)) (*DisableVpcClassicLinkDnsSupportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableVpcClassicLinkDnsSupport", params, optFns, addOperationDisableVpcClassicLinkDnsSupportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableVpcClassicLinkDnsSupportMiddleware(stack *middleware.Stack, options Options) (err error) {
