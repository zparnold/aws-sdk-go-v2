...
func (c *Client) CreateTransitGatewayPeeringAttachment(ctx context.Context, params *CreateTransitGatewayPeeringAttachmentInput, optFns ...func(*Options)) (*CreateTransitGatewayPeeringAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTransitGatewayPeeringAttachment", params, optFns, addOperationCreateTransitGatewayPeeringAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTransitGatewayPeeringAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
