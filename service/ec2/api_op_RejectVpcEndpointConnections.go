...
func (c *Client) RejectVpcEndpointConnections(ctx context.Context, params *RejectVpcEndpointConnectionsInput, optFns ...func(*Options)) (*RejectVpcEndpointConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectVpcEndpointConnections", params, optFns, addOperationRejectVpcEndpointConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectVpcEndpointConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
