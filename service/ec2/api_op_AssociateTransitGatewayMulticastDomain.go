...
func (c *Client) AssociateTransitGatewayMulticastDomain(ctx context.Context, params *AssociateTransitGatewayMulticastDomainInput, optFns ...func(*Options)) (*AssociateTransitGatewayMulticastDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateTransitGatewayMulticastDomain", params, optFns, addOperationAssociateTransitGatewayMulticastDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateTransitGatewayMulticastDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
