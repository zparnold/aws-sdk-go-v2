...
func (c *Client) CreatePlacementGroup(ctx context.Context, params *CreatePlacementGroupInput, optFns ...func(*Options)) (*CreatePlacementGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePlacementGroup", params, optFns, addOperationCreatePlacementGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePlacementGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
