...
func (c *Client) ModifySnapshotAttribute(ctx context.Context, params *ModifySnapshotAttributeInput, optFns ...func(*Options)) (*ModifySnapshotAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifySnapshotAttribute", params, optFns, addOperationModifySnapshotAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifySnapshotAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
