...
func (c *Client) AttachClassicLinkVpc(ctx context.Context, params *AttachClassicLinkVpcInput, optFns ...func(*Options)) (*AttachClassicLinkVpcOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachClassicLinkVpc", params, optFns, addOperationAttachClassicLinkVpcMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachClassicLinkVpcMiddleware(stack *middleware.Stack, options Options) (err error) {
