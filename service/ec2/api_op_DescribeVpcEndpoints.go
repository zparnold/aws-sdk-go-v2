...
func (c *Client) DescribeVpcEndpoints(ctx context.Context, params *DescribeVpcEndpointsInput, optFns ...func(*Options)) (*DescribeVpcEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcEndpoints", params, optFns, addOperationDescribeVpcEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
