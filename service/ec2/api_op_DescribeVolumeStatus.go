...
func (c *Client) DescribeVolumeStatus(ctx context.Context, params *DescribeVolumeStatusInput, optFns ...func(*Options)) (*DescribeVolumeStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVolumeStatus", params, optFns, addOperationDescribeVolumeStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVolumeStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
