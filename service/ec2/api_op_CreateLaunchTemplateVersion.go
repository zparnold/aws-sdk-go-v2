...
func (c *Client) CreateLaunchTemplateVersion(ctx context.Context, params *CreateLaunchTemplateVersionInput, optFns ...func(*Options)) (*CreateLaunchTemplateVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLaunchTemplateVersion", params, optFns, addOperationCreateLaunchTemplateVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLaunchTemplateVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
