...
func (c *Client) DescribeVolumeAttribute(ctx context.Context, params *DescribeVolumeAttributeInput, optFns ...func(*Options)) (*DescribeVolumeAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVolumeAttribute", params, optFns, addOperationDescribeVolumeAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVolumeAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
