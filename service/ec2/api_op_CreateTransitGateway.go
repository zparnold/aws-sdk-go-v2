...
func (c *Client) CreateTransitGateway(ctx context.Context, params *CreateTransitGatewayInput, optFns ...func(*Options)) (*CreateTransitGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTransitGateway", params, optFns, addOperationCreateTransitGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTransitGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
