...
func (c *Client) GetEbsEncryptionByDefault(ctx context.Context, params *GetEbsEncryptionByDefaultInput, optFns ...func(*Options)) (*GetEbsEncryptionByDefaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEbsEncryptionByDefault", params, optFns, addOperationGetEbsEncryptionByDefaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEbsEncryptionByDefaultMiddleware(stack *middleware.Stack, options Options) (err error) {
