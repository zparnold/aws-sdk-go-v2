...
func (c *Client) UnassignIpv6Addresses(ctx context.Context, params *UnassignIpv6AddressesInput, optFns ...func(*Options)) (*UnassignIpv6AddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnassignIpv6Addresses", params, optFns, addOperationUnassignIpv6AddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnassignIpv6AddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
