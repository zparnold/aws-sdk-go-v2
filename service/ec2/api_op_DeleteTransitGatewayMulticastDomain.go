...
func (c *Client) DeleteTransitGatewayMulticastDomain(ctx context.Context, params *DeleteTransitGatewayMulticastDomainInput, optFns ...func(*Options)) (*DeleteTransitGatewayMulticastDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTransitGatewayMulticastDomain", params, optFns, addOperationDeleteTransitGatewayMulticastDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTransitGatewayMulticastDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
