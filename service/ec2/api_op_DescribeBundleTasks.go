...
func (c *Client) DescribeBundleTasks(ctx context.Context, params *DescribeBundleTasksInput, optFns ...func(*Options)) (*DescribeBundleTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBundleTasks", params, optFns, addOperationDescribeBundleTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBundleTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
