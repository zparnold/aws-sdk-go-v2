...
func (c *Client) EnableVpcClassicLink(ctx context.Context, params *EnableVpcClassicLinkInput, optFns ...func(*Options)) (*EnableVpcClassicLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableVpcClassicLink", params, optFns, addOperationEnableVpcClassicLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableVpcClassicLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
