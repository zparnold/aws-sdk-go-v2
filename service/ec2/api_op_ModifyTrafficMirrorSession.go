...
func (c *Client) ModifyTrafficMirrorSession(ctx context.Context, params *ModifyTrafficMirrorSessionInput, optFns ...func(*Options)) (*ModifyTrafficMirrorSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyTrafficMirrorSession", params, optFns, addOperationModifyTrafficMirrorSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyTrafficMirrorSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
