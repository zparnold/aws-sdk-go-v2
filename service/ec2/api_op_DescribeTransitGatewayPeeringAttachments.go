...
func (c *Client) DescribeTransitGatewayPeeringAttachments(ctx context.Context, params *DescribeTransitGatewayPeeringAttachmentsInput, optFns ...func(*Options)) (*DescribeTransitGatewayPeeringAttachmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTransitGatewayPeeringAttachments", params, optFns, addOperationDescribeTransitGatewayPeeringAttachmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTransitGatewayPeeringAttachmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
