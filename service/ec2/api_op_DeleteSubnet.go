...
func (c *Client) DeleteSubnet(ctx context.Context, params *DeleteSubnetInput, optFns ...func(*Options)) (*DeleteSubnetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSubnet", params, optFns, addOperationDeleteSubnetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSubnetMiddleware(stack *middleware.Stack, options Options) (err error) {
