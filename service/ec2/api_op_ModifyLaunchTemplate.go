...
func (c *Client) ModifyLaunchTemplate(ctx context.Context, params *ModifyLaunchTemplateInput, optFns ...func(*Options)) (*ModifyLaunchTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyLaunchTemplate", params, optFns, addOperationModifyLaunchTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyLaunchTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
