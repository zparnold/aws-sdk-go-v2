...
func (c *Client) DescribeLaunchTemplateVersions(ctx context.Context, params *DescribeLaunchTemplateVersionsInput, optFns ...func(*Options)) (*DescribeLaunchTemplateVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLaunchTemplateVersions", params, optFns, addOperationDescribeLaunchTemplateVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLaunchTemplateVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
