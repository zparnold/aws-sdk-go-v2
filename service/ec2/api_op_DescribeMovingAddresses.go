...
func (c *Client) DescribeMovingAddresses(ctx context.Context, params *DescribeMovingAddressesInput, optFns ...func(*Options)) (*DescribeMovingAddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMovingAddresses", params, optFns, addOperationDescribeMovingAddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMovingAddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
