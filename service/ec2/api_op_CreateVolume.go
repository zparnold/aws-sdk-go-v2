...
func (c *Client) CreateVolume(ctx context.Context, params *CreateVolumeInput, optFns ...func(*Options)) (*CreateVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVolume", params, optFns, addOperationCreateVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
