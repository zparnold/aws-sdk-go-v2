...
func (c *Client) ModifyTrafficMirrorFilterRule(ctx context.Context, params *ModifyTrafficMirrorFilterRuleInput, optFns ...func(*Options)) (*ModifyTrafficMirrorFilterRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyTrafficMirrorFilterRule", params, optFns, addOperationModifyTrafficMirrorFilterRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyTrafficMirrorFilterRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
