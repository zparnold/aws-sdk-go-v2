...
func (c *Client) RevokeSecurityGroupIngress(ctx context.Context, params *RevokeSecurityGroupIngressInput, optFns ...func(*Options)) (*RevokeSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeSecurityGroupIngress", params, optFns, addOperationRevokeSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
