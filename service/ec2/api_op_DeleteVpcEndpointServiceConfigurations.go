...
func (c *Client) DeleteVpcEndpointServiceConfigurations(ctx context.Context, params *DeleteVpcEndpointServiceConfigurationsInput, optFns ...func(*Options)) (*DeleteVpcEndpointServiceConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpcEndpointServiceConfigurations", params, optFns, addOperationDeleteVpcEndpointServiceConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpcEndpointServiceConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
