...
func (c *Client) GetCapacityReservationUsage(ctx context.Context, params *GetCapacityReservationUsageInput, optFns ...func(*Options)) (*GetCapacityReservationUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCapacityReservationUsage", params, optFns, addOperationGetCapacityReservationUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCapacityReservationUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
