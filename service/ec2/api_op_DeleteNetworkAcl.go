...
func (c *Client) DeleteNetworkAcl(ctx context.Context, params *DeleteNetworkAclInput, optFns ...func(*Options)) (*DeleteNetworkAclOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNetworkAcl", params, optFns, addOperationDeleteNetworkAclMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNetworkAclMiddleware(stack *middleware.Stack, options Options) (err error) {
