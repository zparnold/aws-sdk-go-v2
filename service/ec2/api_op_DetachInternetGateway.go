...
func (c *Client) DetachInternetGateway(ctx context.Context, params *DetachInternetGatewayInput, optFns ...func(*Options)) (*DetachInternetGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachInternetGateway", params, optFns, addOperationDetachInternetGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachInternetGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
