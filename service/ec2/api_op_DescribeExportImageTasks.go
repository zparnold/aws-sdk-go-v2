...
func (c *Client) DescribeExportImageTasks(ctx context.Context, params *DescribeExportImageTasksInput, optFns ...func(*Options)) (*DescribeExportImageTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeExportImageTasks", params, optFns, addOperationDescribeExportImageTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeExportImageTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
