...
func (c *Client) ImportImage(ctx context.Context, params *ImportImageInput, optFns ...func(*Options)) (*ImportImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportImage", params, optFns, addOperationImportImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportImageMiddleware(stack *middleware.Stack, options Options) (err error) {
