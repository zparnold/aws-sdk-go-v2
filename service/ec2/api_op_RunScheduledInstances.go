...
func (c *Client) RunScheduledInstances(ctx context.Context, params *RunScheduledInstancesInput, optFns ...func(*Options)) (*RunScheduledInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RunScheduledInstances", params, optFns, addOperationRunScheduledInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRunScheduledInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
