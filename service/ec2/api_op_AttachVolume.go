...
func (c *Client) AttachVolume(ctx context.Context, params *AttachVolumeInput, optFns ...func(*Options)) (*AttachVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachVolume", params, optFns, addOperationAttachVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
