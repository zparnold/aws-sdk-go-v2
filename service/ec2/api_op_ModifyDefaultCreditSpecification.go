...
func (c *Client) ModifyDefaultCreditSpecification(ctx context.Context, params *ModifyDefaultCreditSpecificationInput, optFns ...func(*Options)) (*ModifyDefaultCreditSpecificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDefaultCreditSpecification", params, optFns, addOperationModifyDefaultCreditSpecificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDefaultCreditSpecificationMiddleware(stack *middleware.Stack, options Options) (err error) {
