...
func (c *Client) ReplaceIamInstanceProfileAssociation(ctx context.Context, params *ReplaceIamInstanceProfileAssociationInput, optFns ...func(*Options)) (*ReplaceIamInstanceProfileAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReplaceIamInstanceProfileAssociation", params, optFns, addOperationReplaceIamInstanceProfileAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReplaceIamInstanceProfileAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
