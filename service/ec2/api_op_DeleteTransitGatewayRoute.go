...
func (c *Client) DeleteTransitGatewayRoute(ctx context.Context, params *DeleteTransitGatewayRouteInput, optFns ...func(*Options)) (*DeleteTransitGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTransitGatewayRoute", params, optFns, addOperationDeleteTransitGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTransitGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
