...
func (c *Client) CopyImage(ctx context.Context, params *CopyImageInput, optFns ...func(*Options)) (*CopyImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyImage", params, optFns, addOperationCopyImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyImageMiddleware(stack *middleware.Stack, options Options) (err error) {
