...
func (c *Client) ReleaseHosts(ctx context.Context, params *ReleaseHostsInput, optFns ...func(*Options)) (*ReleaseHostsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReleaseHosts", params, optFns, addOperationReleaseHostsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReleaseHostsMiddleware(stack *middleware.Stack, options Options) (err error) {
