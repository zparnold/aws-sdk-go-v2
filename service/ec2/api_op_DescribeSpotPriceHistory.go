...
func (c *Client) DescribeSpotPriceHistory(ctx context.Context, params *DescribeSpotPriceHistoryInput, optFns ...func(*Options)) (*DescribeSpotPriceHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSpotPriceHistory", params, optFns, addOperationDescribeSpotPriceHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSpotPriceHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
