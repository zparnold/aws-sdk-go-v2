...
func (c *Client) GetHostReservationPurchasePreview(ctx context.Context, params *GetHostReservationPurchasePreviewInput, optFns ...func(*Options)) (*GetHostReservationPurchasePreviewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHostReservationPurchasePreview", params, optFns, addOperationGetHostReservationPurchasePreviewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHostReservationPurchasePreviewMiddleware(stack *middleware.Stack, options Options) (err error) {
