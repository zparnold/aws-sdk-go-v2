...
func (c *Client) ResetFpgaImageAttribute(ctx context.Context, params *ResetFpgaImageAttributeInput, optFns ...func(*Options)) (*ResetFpgaImageAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetFpgaImageAttribute", params, optFns, addOperationResetFpgaImageAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetFpgaImageAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
