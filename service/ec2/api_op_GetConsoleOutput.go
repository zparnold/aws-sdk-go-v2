...
func (c *Client) GetConsoleOutput(ctx context.Context, params *GetConsoleOutputInput, optFns ...func(*Options)) (*GetConsoleOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConsoleOutput", params, optFns, addOperationGetConsoleOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConsoleOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
