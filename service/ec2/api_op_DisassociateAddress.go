...
func (c *Client) DisassociateAddress(ctx context.Context, params *DisassociateAddressInput, optFns ...func(*Options)) (*DisassociateAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateAddress", params, optFns, addOperationDisassociateAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
