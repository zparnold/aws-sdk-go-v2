...
func (c *Client) CreateVpnGateway(ctx context.Context, params *CreateVpnGatewayInput, optFns ...func(*Options)) (*CreateVpnGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpnGateway", params, optFns, addOperationCreateVpnGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpnGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
