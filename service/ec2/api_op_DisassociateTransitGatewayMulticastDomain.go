...
func (c *Client) DisassociateTransitGatewayMulticastDomain(ctx context.Context, params *DisassociateTransitGatewayMulticastDomainInput, optFns ...func(*Options)) (*DisassociateTransitGatewayMulticastDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateTransitGatewayMulticastDomain", params, optFns, addOperationDisassociateTransitGatewayMulticastDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateTransitGatewayMulticastDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
