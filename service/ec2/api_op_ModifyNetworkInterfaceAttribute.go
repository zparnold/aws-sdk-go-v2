...
func (c *Client) ModifyNetworkInterfaceAttribute(ctx context.Context, params *ModifyNetworkInterfaceAttributeInput, optFns ...func(*Options)) (*ModifyNetworkInterfaceAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyNetworkInterfaceAttribute", params, optFns, addOperationModifyNetworkInterfaceAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyNetworkInterfaceAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
