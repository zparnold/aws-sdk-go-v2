...
func (c *Client) DisableTransitGatewayRouteTablePropagation(ctx context.Context, params *DisableTransitGatewayRouteTablePropagationInput, optFns ...func(*Options)) (*DisableTransitGatewayRouteTablePropagationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableTransitGatewayRouteTablePropagation", params, optFns, addOperationDisableTransitGatewayRouteTablePropagationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableTransitGatewayRouteTablePropagationMiddleware(stack *middleware.Stack, options Options) (err error) {
