...
func (c *Client) MonitorInstances(ctx context.Context, params *MonitorInstancesInput, optFns ...func(*Options)) (*MonitorInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MonitorInstances", params, optFns, addOperationMonitorInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMonitorInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
