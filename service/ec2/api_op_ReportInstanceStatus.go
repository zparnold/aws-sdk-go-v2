...
func (c *Client) ReportInstanceStatus(ctx context.Context, params *ReportInstanceStatusInput, optFns ...func(*Options)) (*ReportInstanceStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReportInstanceStatus", params, optFns, addOperationReportInstanceStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReportInstanceStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
