...
func (c *Client) AssignIpv6Addresses(ctx context.Context, params *AssignIpv6AddressesInput, optFns ...func(*Options)) (*AssignIpv6AddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssignIpv6Addresses", params, optFns, addOperationAssignIpv6AddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssignIpv6AddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
