...
func (c *Client) UpdateSecurityGroupRuleDescriptionsIngress(ctx context.Context, params *UpdateSecurityGroupRuleDescriptionsIngressInput, optFns ...func(*Options)) (*UpdateSecurityGroupRuleDescriptionsIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSecurityGroupRuleDescriptionsIngress", params, optFns, addOperationUpdateSecurityGroupRuleDescriptionsIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSecurityGroupRuleDescriptionsIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
