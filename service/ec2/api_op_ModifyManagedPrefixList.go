...
func (c *Client) ModifyManagedPrefixList(ctx context.Context, params *ModifyManagedPrefixListInput, optFns ...func(*Options)) (*ModifyManagedPrefixListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyManagedPrefixList", params, optFns, addOperationModifyManagedPrefixListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyManagedPrefixListMiddleware(stack *middleware.Stack, options Options) (err error) {
