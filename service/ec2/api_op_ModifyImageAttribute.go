...
func (c *Client) ModifyImageAttribute(ctx context.Context, params *ModifyImageAttributeInput, optFns ...func(*Options)) (*ModifyImageAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyImageAttribute", params, optFns, addOperationModifyImageAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyImageAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
