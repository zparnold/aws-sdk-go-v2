...
func (c *Client) TerminateClientVpnConnections(ctx context.Context, params *TerminateClientVpnConnectionsInput, optFns ...func(*Options)) (*TerminateClientVpnConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateClientVpnConnections", params, optFns, addOperationTerminateClientVpnConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateClientVpnConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
