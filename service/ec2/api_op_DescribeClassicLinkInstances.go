...
func (c *Client) DescribeClassicLinkInstances(ctx context.Context, params *DescribeClassicLinkInstancesInput, optFns ...func(*Options)) (*DescribeClassicLinkInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClassicLinkInstances", params, optFns, addOperationDescribeClassicLinkInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClassicLinkInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
