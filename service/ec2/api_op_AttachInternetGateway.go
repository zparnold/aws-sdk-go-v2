...
func (c *Client) AttachInternetGateway(ctx context.Context, params *AttachInternetGatewayInput, optFns ...func(*Options)) (*AttachInternetGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachInternetGateway", params, optFns, addOperationAttachInternetGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachInternetGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
