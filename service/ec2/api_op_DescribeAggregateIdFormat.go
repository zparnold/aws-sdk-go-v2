...
func (c *Client) DescribeAggregateIdFormat(ctx context.Context, params *DescribeAggregateIdFormatInput, optFns ...func(*Options)) (*DescribeAggregateIdFormatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAggregateIdFormat", params, optFns, addOperationDescribeAggregateIdFormatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAggregateIdFormatMiddleware(stack *middleware.Stack, options Options) (err error) {
