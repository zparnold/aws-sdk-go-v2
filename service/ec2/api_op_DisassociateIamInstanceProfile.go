...
func (c *Client) DisassociateIamInstanceProfile(ctx context.Context, params *DisassociateIamInstanceProfileInput, optFns ...func(*Options)) (*DisassociateIamInstanceProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateIamInstanceProfile", params, optFns, addOperationDisassociateIamInstanceProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateIamInstanceProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
