...
func (c *Client) ModifyInstanceMetadataOptions(ctx context.Context, params *ModifyInstanceMetadataOptionsInput, optFns ...func(*Options)) (*ModifyInstanceMetadataOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyInstanceMetadataOptions", params, optFns, addOperationModifyInstanceMetadataOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyInstanceMetadataOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
