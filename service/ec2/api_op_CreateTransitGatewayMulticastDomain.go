...
func (c *Client) CreateTransitGatewayMulticastDomain(ctx context.Context, params *CreateTransitGatewayMulticastDomainInput, optFns ...func(*Options)) (*CreateTransitGatewayMulticastDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTransitGatewayMulticastDomain", params, optFns, addOperationCreateTransitGatewayMulticastDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTransitGatewayMulticastDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
