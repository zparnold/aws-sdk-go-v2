...
func (c *Client) DescribeVpcAttribute(ctx context.Context, params *DescribeVpcAttributeInput, optFns ...func(*Options)) (*DescribeVpcAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcAttribute", params, optFns, addOperationDescribeVpcAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
