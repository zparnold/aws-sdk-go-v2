...
func (c *Client) DescribeSpotFleetInstances(ctx context.Context, params *DescribeSpotFleetInstancesInput, optFns ...func(*Options)) (*DescribeSpotFleetInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSpotFleetInstances", params, optFns, addOperationDescribeSpotFleetInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSpotFleetInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
