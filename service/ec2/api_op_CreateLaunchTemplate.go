...
func (c *Client) CreateLaunchTemplate(ctx context.Context, params *CreateLaunchTemplateInput, optFns ...func(*Options)) (*CreateLaunchTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLaunchTemplate", params, optFns, addOperationCreateLaunchTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLaunchTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
