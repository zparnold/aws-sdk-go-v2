...
func (c *Client) GetGroupsForCapacityReservation(ctx context.Context, params *GetGroupsForCapacityReservationInput, optFns ...func(*Options)) (*GetGroupsForCapacityReservationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroupsForCapacityReservation", params, optFns, addOperationGetGroupsForCapacityReservationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupsForCapacityReservationMiddleware(stack *middleware.Stack, options Options) (err error) {
