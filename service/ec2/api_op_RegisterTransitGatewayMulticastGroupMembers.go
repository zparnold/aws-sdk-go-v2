...
func (c *Client) RegisterTransitGatewayMulticastGroupMembers(ctx context.Context, params *RegisterTransitGatewayMulticastGroupMembersInput, optFns ...func(*Options)) (*RegisterTransitGatewayMulticastGroupMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterTransitGatewayMulticastGroupMembers", params, optFns, addOperationRegisterTransitGatewayMulticastGroupMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterTransitGatewayMulticastGroupMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
