...
func (c *Client) RestoreManagedPrefixListVersion(ctx context.Context, params *RestoreManagedPrefixListVersionInput, optFns ...func(*Options)) (*RestoreManagedPrefixListVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreManagedPrefixListVersion", params, optFns, addOperationRestoreManagedPrefixListVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreManagedPrefixListVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
