...
func (c *Client) CancelBundleTask(ctx context.Context, params *CancelBundleTaskInput, optFns ...func(*Options)) (*CancelBundleTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelBundleTask", params, optFns, addOperationCancelBundleTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelBundleTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
