...
func (c *Client) ModifyEbsDefaultKmsKeyId(ctx context.Context, params *ModifyEbsDefaultKmsKeyIdInput, optFns ...func(*Options)) (*ModifyEbsDefaultKmsKeyIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyEbsDefaultKmsKeyId", params, optFns, addOperationModifyEbsDefaultKmsKeyIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyEbsDefaultKmsKeyIdMiddleware(stack *middleware.Stack, options Options) (err error) {
