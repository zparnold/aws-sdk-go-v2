...
func (c *Client) DescribeLocalGateways(ctx context.Context, params *DescribeLocalGatewaysInput, optFns ...func(*Options)) (*DescribeLocalGatewaysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocalGateways", params, optFns, addOperationDescribeLocalGatewaysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocalGatewaysMiddleware(stack *middleware.Stack, options Options) (err error) {
