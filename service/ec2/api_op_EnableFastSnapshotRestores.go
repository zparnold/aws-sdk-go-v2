...
func (c *Client) EnableFastSnapshotRestores(ctx context.Context, params *EnableFastSnapshotRestoresInput, optFns ...func(*Options)) (*EnableFastSnapshotRestoresOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableFastSnapshotRestores", params, optFns, addOperationEnableFastSnapshotRestoresMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableFastSnapshotRestoresMiddleware(stack *middleware.Stack, options Options) (err error) {
