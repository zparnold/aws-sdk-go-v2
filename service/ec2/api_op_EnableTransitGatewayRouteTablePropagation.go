...
func (c *Client) EnableTransitGatewayRouteTablePropagation(ctx context.Context, params *EnableTransitGatewayRouteTablePropagationInput, optFns ...func(*Options)) (*EnableTransitGatewayRouteTablePropagationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableTransitGatewayRouteTablePropagation", params, optFns, addOperationEnableTransitGatewayRouteTablePropagationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableTransitGatewayRouteTablePropagationMiddleware(stack *middleware.Stack, options Options) (err error) {
