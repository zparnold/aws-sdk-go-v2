...
func (c *Client) CreateClientVpnRoute(ctx context.Context, params *CreateClientVpnRouteInput, optFns ...func(*Options)) (*CreateClientVpnRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateClientVpnRoute", params, optFns, addOperationCreateClientVpnRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateClientVpnRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
