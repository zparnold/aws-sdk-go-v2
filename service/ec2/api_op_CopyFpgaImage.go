...
func (c *Client) CopyFpgaImage(ctx context.Context, params *CopyFpgaImageInput, optFns ...func(*Options)) (*CopyFpgaImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyFpgaImage", params, optFns, addOperationCopyFpgaImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyFpgaImageMiddleware(stack *middleware.Stack, options Options) (err error) {
