...
func (c *Client) CreateLocalGatewayRouteTableVpcAssociation(ctx context.Context, params *CreateLocalGatewayRouteTableVpcAssociationInput, optFns ...func(*Options)) (*CreateLocalGatewayRouteTableVpcAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLocalGatewayRouteTableVpcAssociation", params, optFns, addOperationCreateLocalGatewayRouteTableVpcAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLocalGatewayRouteTableVpcAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
