...
func (c *Client) DescribeReservedInstancesListings(ctx context.Context, params *DescribeReservedInstancesListingsInput, optFns ...func(*Options)) (*DescribeReservedInstancesListingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedInstancesListings", params, optFns, addOperationDescribeReservedInstancesListingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedInstancesListingsMiddleware(stack *middleware.Stack, options Options) (err error) {
