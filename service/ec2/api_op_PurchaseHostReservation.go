...
func (c *Client) PurchaseHostReservation(ctx context.Context, params *PurchaseHostReservationInput, optFns ...func(*Options)) (*PurchaseHostReservationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurchaseHostReservation", params, optFns, addOperationPurchaseHostReservationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurchaseHostReservationMiddleware(stack *middleware.Stack, options Options) (err error) {
