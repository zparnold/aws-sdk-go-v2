...
func (c *Client) DescribeElasticGpus(ctx context.Context, params *DescribeElasticGpusInput, optFns ...func(*Options)) (*DescribeElasticGpusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeElasticGpus", params, optFns, addOperationDescribeElasticGpusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeElasticGpusMiddleware(stack *middleware.Stack, options Options) (err error) {
