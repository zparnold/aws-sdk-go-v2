...
func (c *Client) ReplaceNetworkAclEntry(ctx context.Context, params *ReplaceNetworkAclEntryInput, optFns ...func(*Options)) (*ReplaceNetworkAclEntryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReplaceNetworkAclEntry", params, optFns, addOperationReplaceNetworkAclEntryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReplaceNetworkAclEntryMiddleware(stack *middleware.Stack, options Options) (err error) {
