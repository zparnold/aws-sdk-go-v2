...
func (c *Client) DeleteTrafficMirrorFilter(ctx context.Context, params *DeleteTrafficMirrorFilterInput, optFns ...func(*Options)) (*DeleteTrafficMirrorFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrafficMirrorFilter", params, optFns, addOperationDeleteTrafficMirrorFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrafficMirrorFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
