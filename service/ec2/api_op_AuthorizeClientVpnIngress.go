...
func (c *Client) AuthorizeClientVpnIngress(ctx context.Context, params *AuthorizeClientVpnIngressInput, optFns ...func(*Options)) (*AuthorizeClientVpnIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeClientVpnIngress", params, optFns, addOperationAuthorizeClientVpnIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeClientVpnIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
