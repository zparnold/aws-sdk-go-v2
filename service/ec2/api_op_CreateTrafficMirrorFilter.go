...
func (c *Client) CreateTrafficMirrorFilter(ctx context.Context, params *CreateTrafficMirrorFilterInput, optFns ...func(*Options)) (*CreateTrafficMirrorFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrafficMirrorFilter", params, optFns, addOperationCreateTrafficMirrorFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrafficMirrorFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
