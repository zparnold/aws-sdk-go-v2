...
func (c *Client) DisableFastSnapshotRestores(ctx context.Context, params *DisableFastSnapshotRestoresInput, optFns ...func(*Options)) (*DisableFastSnapshotRestoresOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableFastSnapshotRestores", params, optFns, addOperationDisableFastSnapshotRestoresMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableFastSnapshotRestoresMiddleware(stack *middleware.Stack, options Options) (err error) {
