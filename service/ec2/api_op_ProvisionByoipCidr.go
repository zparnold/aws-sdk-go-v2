...
func (c *Client) ProvisionByoipCidr(ctx context.Context, params *ProvisionByoipCidrInput, optFns ...func(*Options)) (*ProvisionByoipCidrOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ProvisionByoipCidr", params, optFns, addOperationProvisionByoipCidrMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationProvisionByoipCidrMiddleware(stack *middleware.Stack, options Options) (err error) {
