...
func (c *Client) AllocateAddress(ctx context.Context, params *AllocateAddressInput, optFns ...func(*Options)) (*AllocateAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocateAddress", params, optFns, addOperationAllocateAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocateAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
