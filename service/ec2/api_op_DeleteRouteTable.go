...
func (c *Client) DeleteRouteTable(ctx context.Context, params *DeleteRouteTableInput, optFns ...func(*Options)) (*DeleteRouteTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRouteTable", params, optFns, addOperationDeleteRouteTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRouteTableMiddleware(stack *middleware.Stack, options Options) (err error) {
