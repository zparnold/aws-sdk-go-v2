...
func (c *Client) CreateDefaultSubnet(ctx context.Context, params *CreateDefaultSubnetInput, optFns ...func(*Options)) (*CreateDefaultSubnetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDefaultSubnet", params, optFns, addOperationCreateDefaultSubnetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDefaultSubnetMiddleware(stack *middleware.Stack, options Options) (err error) {
