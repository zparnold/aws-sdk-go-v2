...
func (c *Client) DescribeFleetInstances(ctx context.Context, params *DescribeFleetInstancesInput, optFns ...func(*Options)) (*DescribeFleetInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetInstances", params, optFns, addOperationDescribeFleetInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
