...
func (c *Client) AssociateClientVpnTargetNetwork(ctx context.Context, params *AssociateClientVpnTargetNetworkInput, optFns ...func(*Options)) (*AssociateClientVpnTargetNetworkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateClientVpnTargetNetwork", params, optFns, addOperationAssociateClientVpnTargetNetworkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateClientVpnTargetNetworkMiddleware(stack *middleware.Stack, options Options) (err error) {
