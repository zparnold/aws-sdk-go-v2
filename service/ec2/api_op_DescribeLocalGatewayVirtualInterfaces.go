...
func (c *Client) DescribeLocalGatewayVirtualInterfaces(ctx context.Context, params *DescribeLocalGatewayVirtualInterfacesInput, optFns ...func(*Options)) (*DescribeLocalGatewayVirtualInterfacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocalGatewayVirtualInterfaces", params, optFns, addOperationDescribeLocalGatewayVirtualInterfacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocalGatewayVirtualInterfacesMiddleware(stack *middleware.Stack, options Options) (err error) {
