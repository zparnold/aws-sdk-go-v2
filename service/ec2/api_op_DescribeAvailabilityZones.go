...
func (c *Client) DescribeAvailabilityZones(ctx context.Context, params *DescribeAvailabilityZonesInput, optFns ...func(*Options)) (*DescribeAvailabilityZonesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAvailabilityZones", params, optFns, addOperationDescribeAvailabilityZonesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAvailabilityZonesMiddleware(stack *middleware.Stack, options Options) (err error) {
