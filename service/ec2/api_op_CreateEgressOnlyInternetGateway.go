...
func (c *Client) CreateEgressOnlyInternetGateway(ctx context.Context, params *CreateEgressOnlyInternetGatewayInput, optFns ...func(*Options)) (*CreateEgressOnlyInternetGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEgressOnlyInternetGateway", params, optFns, addOperationCreateEgressOnlyInternetGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEgressOnlyInternetGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
