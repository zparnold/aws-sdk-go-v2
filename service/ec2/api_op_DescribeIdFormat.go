...
func (c *Client) DescribeIdFormat(ctx context.Context, params *DescribeIdFormatInput, optFns ...func(*Options)) (*DescribeIdFormatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIdFormat", params, optFns, addOperationDescribeIdFormatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIdFormatMiddleware(stack *middleware.Stack, options Options) (err error) {
