...
func (c *Client) CancelSpotInstanceRequests(ctx context.Context, params *CancelSpotInstanceRequestsInput, optFns ...func(*Options)) (*CancelSpotInstanceRequestsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelSpotInstanceRequests", params, optFns, addOperationCancelSpotInstanceRequestsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelSpotInstanceRequestsMiddleware(stack *middleware.Stack, options Options) (err error) {
