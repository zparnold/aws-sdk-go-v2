...
func (c *Client) RebootInstances(ctx context.Context, params *RebootInstancesInput, optFns ...func(*Options)) (*RebootInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RebootInstances", params, optFns, addOperationRebootInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRebootInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
