...
func (c *Client) DescribeSnapshotAttribute(ctx context.Context, params *DescribeSnapshotAttributeInput, optFns ...func(*Options)) (*DescribeSnapshotAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSnapshotAttribute", params, optFns, addOperationDescribeSnapshotAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSnapshotAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
