...
func (c *Client) CreateSnapshots(ctx context.Context, params *CreateSnapshotsInput, optFns ...func(*Options)) (*CreateSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSnapshots", params, optFns, addOperationCreateSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
