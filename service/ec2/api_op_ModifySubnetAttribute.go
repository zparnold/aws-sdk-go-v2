...
func (c *Client) ModifySubnetAttribute(ctx context.Context, params *ModifySubnetAttributeInput, optFns ...func(*Options)) (*ModifySubnetAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifySubnetAttribute", params, optFns, addOperationModifySubnetAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifySubnetAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
