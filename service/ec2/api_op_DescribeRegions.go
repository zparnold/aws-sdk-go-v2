...
func (c *Client) DescribeRegions(ctx context.Context, params *DescribeRegionsInput, optFns ...func(*Options)) (*DescribeRegionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRegions", params, optFns, addOperationDescribeRegionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRegionsMiddleware(stack *middleware.Stack, options Options) (err error) {
