...
func (c *Client) ModifyFpgaImageAttribute(ctx context.Context, params *ModifyFpgaImageAttributeInput, optFns ...func(*Options)) (*ModifyFpgaImageAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyFpgaImageAttribute", params, optFns, addOperationModifyFpgaImageAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyFpgaImageAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
