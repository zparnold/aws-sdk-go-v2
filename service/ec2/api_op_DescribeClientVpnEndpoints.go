...
func (c *Client) DescribeClientVpnEndpoints(ctx context.Context, params *DescribeClientVpnEndpointsInput, optFns ...func(*Options)) (*DescribeClientVpnEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClientVpnEndpoints", params, optFns, addOperationDescribeClientVpnEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClientVpnEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
