...
func (c *Client) ModifyInstanceCreditSpecification(ctx context.Context, params *ModifyInstanceCreditSpecificationInput, optFns ...func(*Options)) (*ModifyInstanceCreditSpecificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyInstanceCreditSpecification", params, optFns, addOperationModifyInstanceCreditSpecificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyInstanceCreditSpecificationMiddleware(stack *middleware.Stack, options Options) (err error) {
