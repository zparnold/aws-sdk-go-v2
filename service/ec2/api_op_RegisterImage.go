...
func (c *Client) RegisterImage(ctx context.Context, params *RegisterImageInput, optFns ...func(*Options)) (*RegisterImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterImage", params, optFns, addOperationRegisterImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterImageMiddleware(stack *middleware.Stack, options Options) (err error) {
