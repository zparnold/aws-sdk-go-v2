...
func (c *Client) ModifyInstancePlacement(ctx context.Context, params *ModifyInstancePlacementInput, optFns ...func(*Options)) (*ModifyInstancePlacementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyInstancePlacement", params, optFns, addOperationModifyInstancePlacementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyInstancePlacementMiddleware(stack *middleware.Stack, options Options) (err error) {
