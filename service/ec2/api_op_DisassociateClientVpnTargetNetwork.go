...
func (c *Client) DisassociateClientVpnTargetNetwork(ctx context.Context, params *DisassociateClientVpnTargetNetworkInput, optFns ...func(*Options)) (*DisassociateClientVpnTargetNetworkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateClientVpnTargetNetwork", params, optFns, addOperationDisassociateClientVpnTargetNetworkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateClientVpnTargetNetworkMiddleware(stack *middleware.Stack, options Options) (err error) {
