...
func (c *Client) DescribeInstanceEventNotificationAttributes(ctx context.Context, params *DescribeInstanceEventNotificationAttributesInput, optFns ...func(*Options)) (*DescribeInstanceEventNotificationAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceEventNotificationAttributes", params, optFns, addOperationDescribeInstanceEventNotificationAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceEventNotificationAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
