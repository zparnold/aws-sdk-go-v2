...
func (c *Client) CreateVpcEndpointServiceConfiguration(ctx context.Context, params *CreateVpcEndpointServiceConfigurationInput, optFns ...func(*Options)) (*CreateVpcEndpointServiceConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpcEndpointServiceConfiguration", params, optFns, addOperationCreateVpcEndpointServiceConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpcEndpointServiceConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
