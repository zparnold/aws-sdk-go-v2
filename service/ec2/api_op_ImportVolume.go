...
func (c *Client) ImportVolume(ctx context.Context, params *ImportVolumeInput, optFns ...func(*Options)) (*ImportVolumeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportVolume", params, optFns, addOperationImportVolumeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportVolumeMiddleware(stack *middleware.Stack, options Options) (err error) {
