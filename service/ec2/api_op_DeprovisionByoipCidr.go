...
func (c *Client) DeprovisionByoipCidr(ctx context.Context, params *DeprovisionByoipCidrInput, optFns ...func(*Options)) (*DeprovisionByoipCidrOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeprovisionByoipCidr", params, optFns, addOperationDeprovisionByoipCidrMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeprovisionByoipCidrMiddleware(stack *middleware.Stack, options Options) (err error) {
