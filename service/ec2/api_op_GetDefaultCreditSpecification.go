...
func (c *Client) GetDefaultCreditSpecification(ctx context.Context, params *GetDefaultCreditSpecificationInput, optFns ...func(*Options)) (*GetDefaultCreditSpecificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDefaultCreditSpecification", params, optFns, addOperationGetDefaultCreditSpecificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDefaultCreditSpecificationMiddleware(stack *middleware.Stack, options Options) (err error) {
