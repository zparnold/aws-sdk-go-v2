...
func (c *Client) RevokeClientVpnIngress(ctx context.Context, params *RevokeClientVpnIngressInput, optFns ...func(*Options)) (*RevokeClientVpnIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeClientVpnIngress", params, optFns, addOperationRevokeClientVpnIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeClientVpnIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
