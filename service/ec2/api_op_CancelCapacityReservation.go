...
func (c *Client) CancelCapacityReservation(ctx context.Context, params *CancelCapacityReservationInput, optFns ...func(*Options)) (*CancelCapacityReservationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelCapacityReservation", params, optFns, addOperationCancelCapacityReservationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelCapacityReservationMiddleware(stack *middleware.Stack, options Options) (err error) {
