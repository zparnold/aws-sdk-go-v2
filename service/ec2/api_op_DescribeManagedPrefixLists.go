...
func (c *Client) DescribeManagedPrefixLists(ctx context.Context, params *DescribeManagedPrefixListsInput, optFns ...func(*Options)) (*DescribeManagedPrefixListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeManagedPrefixLists", params, optFns, addOperationDescribeManagedPrefixListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeManagedPrefixListsMiddleware(stack *middleware.Stack, options Options) (err error) {
