...
func (c *Client) RunInstances(ctx context.Context, params *RunInstancesInput, optFns ...func(*Options)) (*RunInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RunInstances", params, optFns, addOperationRunInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRunInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
