...
func (c *Client) GetTransitGatewayRouteTablePropagations(ctx context.Context, params *GetTransitGatewayRouteTablePropagationsInput, optFns ...func(*Options)) (*GetTransitGatewayRouteTablePropagationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTransitGatewayRouteTablePropagations", params, optFns, addOperationGetTransitGatewayRouteTablePropagationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTransitGatewayRouteTablePropagationsMiddleware(stack *middleware.Stack, options Options) (err error) {
