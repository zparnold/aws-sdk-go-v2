...
func (c *Client) DeleteLocalGatewayRoute(ctx context.Context, params *DeleteLocalGatewayRouteInput, optFns ...func(*Options)) (*DeleteLocalGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLocalGatewayRoute", params, optFns, addOperationDeleteLocalGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLocalGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
