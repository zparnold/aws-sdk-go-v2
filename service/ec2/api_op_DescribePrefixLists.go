...
func (c *Client) DescribePrefixLists(ctx context.Context, params *DescribePrefixListsInput, optFns ...func(*Options)) (*DescribePrefixListsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePrefixLists", params, optFns, addOperationDescribePrefixListsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePrefixListsMiddleware(stack *middleware.Stack, options Options) (err error) {
