...
func (c *Client) DescribeVpcEndpointConnectionNotifications(ctx context.Context, params *DescribeVpcEndpointConnectionNotificationsInput, optFns ...func(*Options)) (*DescribeVpcEndpointConnectionNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcEndpointConnectionNotifications", params, optFns, addOperationDescribeVpcEndpointConnectionNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcEndpointConnectionNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
