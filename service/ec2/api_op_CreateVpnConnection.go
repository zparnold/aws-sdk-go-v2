...
func (c *Client) CreateVpnConnection(ctx context.Context, params *CreateVpnConnectionInput, optFns ...func(*Options)) (*CreateVpnConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpnConnection", params, optFns, addOperationCreateVpnConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpnConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
