...
func (c *Client) DescribeNetworkAcls(ctx context.Context, params *DescribeNetworkAclsInput, optFns ...func(*Options)) (*DescribeNetworkAclsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNetworkAcls", params, optFns, addOperationDescribeNetworkAclsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNetworkAclsMiddleware(stack *middleware.Stack, options Options) (err error) {
