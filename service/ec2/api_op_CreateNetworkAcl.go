...
func (c *Client) CreateNetworkAcl(ctx context.Context, params *CreateNetworkAclInput, optFns ...func(*Options)) (*CreateNetworkAclOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNetworkAcl", params, optFns, addOperationCreateNetworkAclMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNetworkAclMiddleware(stack *middleware.Stack, options Options) (err error) {
