...
func (c *Client) ReplaceTransitGatewayRoute(ctx context.Context, params *ReplaceTransitGatewayRouteInput, optFns ...func(*Options)) (*ReplaceTransitGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReplaceTransitGatewayRoute", params, optFns, addOperationReplaceTransitGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReplaceTransitGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
