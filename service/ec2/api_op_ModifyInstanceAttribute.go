...
func (c *Client) ModifyInstanceAttribute(ctx context.Context, params *ModifyInstanceAttributeInput, optFns ...func(*Options)) (*ModifyInstanceAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyInstanceAttribute", params, optFns, addOperationModifyInstanceAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyInstanceAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
