...
func (c *Client) AssociateDhcpOptions(ctx context.Context, params *AssociateDhcpOptionsInput, optFns ...func(*Options)) (*AssociateDhcpOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateDhcpOptions", params, optFns, addOperationAssociateDhcpOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateDhcpOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
