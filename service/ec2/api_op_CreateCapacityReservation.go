...
func (c *Client) CreateCapacityReservation(ctx context.Context, params *CreateCapacityReservationInput, optFns ...func(*Options)) (*CreateCapacityReservationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCapacityReservation", params, optFns, addOperationCreateCapacityReservationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCapacityReservationMiddleware(stack *middleware.Stack, options Options) (err error) {
