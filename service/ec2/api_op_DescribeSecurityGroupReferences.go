...
func (c *Client) DescribeSecurityGroupReferences(ctx context.Context, params *DescribeSecurityGroupReferencesInput, optFns ...func(*Options)) (*DescribeSecurityGroupReferencesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSecurityGroupReferences", params, optFns, addOperationDescribeSecurityGroupReferencesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSecurityGroupReferencesMiddleware(stack *middleware.Stack, options Options) (err error) {
