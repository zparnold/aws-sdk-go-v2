...
func (c *Client) DescribeReservedInstances(ctx context.Context, params *DescribeReservedInstancesInput, optFns ...func(*Options)) (*DescribeReservedInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedInstances", params, optFns, addOperationDescribeReservedInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
