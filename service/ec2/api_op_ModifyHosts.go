...
func (c *Client) ModifyHosts(ctx context.Context, params *ModifyHostsInput, optFns ...func(*Options)) (*ModifyHostsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyHosts", params, optFns, addOperationModifyHostsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyHostsMiddleware(stack *middleware.Stack, options Options) (err error) {
