...
func (c *Client) DescribeVpcEndpointConnections(ctx context.Context, params *DescribeVpcEndpointConnectionsInput, optFns ...func(*Options)) (*DescribeVpcEndpointConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcEndpointConnections", params, optFns, addOperationDescribeVpcEndpointConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcEndpointConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
