...
func (c *Client) DescribePublicIpv4Pools(ctx context.Context, params *DescribePublicIpv4PoolsInput, optFns ...func(*Options)) (*DescribePublicIpv4PoolsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePublicIpv4Pools", params, optFns, addOperationDescribePublicIpv4PoolsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePublicIpv4PoolsMiddleware(stack *middleware.Stack, options Options) (err error) {
