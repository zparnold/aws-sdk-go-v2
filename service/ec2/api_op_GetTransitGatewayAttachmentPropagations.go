...
func (c *Client) GetTransitGatewayAttachmentPropagations(ctx context.Context, params *GetTransitGatewayAttachmentPropagationsInput, optFns ...func(*Options)) (*GetTransitGatewayAttachmentPropagationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTransitGatewayAttachmentPropagations", params, optFns, addOperationGetTransitGatewayAttachmentPropagationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTransitGatewayAttachmentPropagationsMiddleware(stack *middleware.Stack, options Options) (err error) {
