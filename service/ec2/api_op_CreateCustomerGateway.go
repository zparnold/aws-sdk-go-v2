...
func (c *Client) CreateCustomerGateway(ctx context.Context, params *CreateCustomerGatewayInput, optFns ...func(*Options)) (*CreateCustomerGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomerGateway", params, optFns, addOperationCreateCustomerGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomerGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
