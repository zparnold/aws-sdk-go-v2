...
func (c *Client) DescribeAddresses(ctx context.Context, params *DescribeAddressesInput, optFns ...func(*Options)) (*DescribeAddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAddresses", params, optFns, addOperationDescribeAddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
