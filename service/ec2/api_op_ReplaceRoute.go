...
func (c *Client) ReplaceRoute(ctx context.Context, params *ReplaceRouteInput, optFns ...func(*Options)) (*ReplaceRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReplaceRoute", params, optFns, addOperationReplaceRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReplaceRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
