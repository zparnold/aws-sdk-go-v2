...
func (c *Client) DeleteFpgaImage(ctx context.Context, params *DeleteFpgaImageInput, optFns ...func(*Options)) (*DeleteFpgaImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFpgaImage", params, optFns, addOperationDeleteFpgaImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFpgaImageMiddleware(stack *middleware.Stack, options Options) (err error) {
