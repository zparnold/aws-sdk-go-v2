...
func (c *Client) CreateNatGateway(ctx context.Context, params *CreateNatGatewayInput, optFns ...func(*Options)) (*CreateNatGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNatGateway", params, optFns, addOperationCreateNatGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNatGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
