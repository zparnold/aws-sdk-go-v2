...
func (c *Client) ModifyIdFormat(ctx context.Context, params *ModifyIdFormatInput, optFns ...func(*Options)) (*ModifyIdFormatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyIdFormat", params, optFns, addOperationModifyIdFormatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyIdFormatMiddleware(stack *middleware.Stack, options Options) (err error) {
