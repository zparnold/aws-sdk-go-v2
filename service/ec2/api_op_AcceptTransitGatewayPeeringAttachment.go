...
func (c *Client) AcceptTransitGatewayPeeringAttachment(ctx context.Context, params *AcceptTransitGatewayPeeringAttachmentInput, optFns ...func(*Options)) (*AcceptTransitGatewayPeeringAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptTransitGatewayPeeringAttachment", params, optFns, addOperationAcceptTransitGatewayPeeringAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptTransitGatewayPeeringAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
