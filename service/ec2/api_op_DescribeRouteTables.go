...
func (c *Client) DescribeRouteTables(ctx context.Context, params *DescribeRouteTablesInput, optFns ...func(*Options)) (*DescribeRouteTablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRouteTables", params, optFns, addOperationDescribeRouteTablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRouteTablesMiddleware(stack *middleware.Stack, options Options) (err error) {
