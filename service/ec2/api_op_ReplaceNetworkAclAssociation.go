...
func (c *Client) ReplaceNetworkAclAssociation(ctx context.Context, params *ReplaceNetworkAclAssociationInput, optFns ...func(*Options)) (*ReplaceNetworkAclAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReplaceNetworkAclAssociation", params, optFns, addOperationReplaceNetworkAclAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReplaceNetworkAclAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
