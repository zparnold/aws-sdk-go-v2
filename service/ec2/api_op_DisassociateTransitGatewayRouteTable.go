...
func (c *Client) DisassociateTransitGatewayRouteTable(ctx context.Context, params *DisassociateTransitGatewayRouteTableInput, optFns ...func(*Options)) (*DisassociateTransitGatewayRouteTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateTransitGatewayRouteTable", params, optFns, addOperationDisassociateTransitGatewayRouteTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateTransitGatewayRouteTableMiddleware(stack *middleware.Stack, options Options) (err error) {
