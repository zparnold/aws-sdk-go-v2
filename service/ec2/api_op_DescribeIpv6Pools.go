...
func (c *Client) DescribeIpv6Pools(ctx context.Context, params *DescribeIpv6PoolsInput, optFns ...func(*Options)) (*DescribeIpv6PoolsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIpv6Pools", params, optFns, addOperationDescribeIpv6PoolsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIpv6PoolsMiddleware(stack *middleware.Stack, options Options) (err error) {
