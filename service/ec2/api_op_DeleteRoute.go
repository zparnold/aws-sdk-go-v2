...
func (c *Client) DeleteRoute(ctx context.Context, params *DeleteRouteInput, optFns ...func(*Options)) (*DeleteRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRoute", params, optFns, addOperationDeleteRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
