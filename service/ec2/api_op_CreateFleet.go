...
func (c *Client) CreateFleet(ctx context.Context, params *CreateFleetInput, optFns ...func(*Options)) (*CreateFleetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFleet", params, optFns, addOperationCreateFleetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFleetMiddleware(stack *middleware.Stack, options Options) (err error) {
