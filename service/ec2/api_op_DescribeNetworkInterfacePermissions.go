...
func (c *Client) DescribeNetworkInterfacePermissions(ctx context.Context, params *DescribeNetworkInterfacePermissionsInput, optFns ...func(*Options)) (*DescribeNetworkInterfacePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNetworkInterfacePermissions", params, optFns, addOperationDescribeNetworkInterfacePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNetworkInterfacePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
