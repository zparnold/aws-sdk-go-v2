...
func (c *Client) DetachClassicLinkVpc(ctx context.Context, params *DetachClassicLinkVpcInput, optFns ...func(*Options)) (*DetachClassicLinkVpcOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachClassicLinkVpc", params, optFns, addOperationDetachClassicLinkVpcMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachClassicLinkVpcMiddleware(stack *middleware.Stack, options Options) (err error) {
