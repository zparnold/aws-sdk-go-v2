...
func (c *Client) CreateNetworkInterfacePermission(ctx context.Context, params *CreateNetworkInterfacePermissionInput, optFns ...func(*Options)) (*CreateNetworkInterfacePermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNetworkInterfacePermission", params, optFns, addOperationCreateNetworkInterfacePermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNetworkInterfacePermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
