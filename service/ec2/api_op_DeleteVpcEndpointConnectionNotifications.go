...
func (c *Client) DeleteVpcEndpointConnectionNotifications(ctx context.Context, params *DeleteVpcEndpointConnectionNotificationsInput, optFns ...func(*Options)) (*DeleteVpcEndpointConnectionNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpcEndpointConnectionNotifications", params, optFns, addOperationDeleteVpcEndpointConnectionNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpcEndpointConnectionNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
