...
func (c *Client) DeleteLaunchTemplate(ctx context.Context, params *DeleteLaunchTemplateInput, optFns ...func(*Options)) (*DeleteLaunchTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLaunchTemplate", params, optFns, addOperationDeleteLaunchTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLaunchTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
