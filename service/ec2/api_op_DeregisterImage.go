...
func (c *Client) DeregisterImage(ctx context.Context, params *DeregisterImageInput, optFns ...func(*Options)) (*DeregisterImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterImage", params, optFns, addOperationDeregisterImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterImageMiddleware(stack *middleware.Stack, options Options) (err error) {
