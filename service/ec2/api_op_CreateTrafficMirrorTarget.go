...
func (c *Client) CreateTrafficMirrorTarget(ctx context.Context, params *CreateTrafficMirrorTargetInput, optFns ...func(*Options)) (*CreateTrafficMirrorTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrafficMirrorTarget", params, optFns, addOperationCreateTrafficMirrorTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrafficMirrorTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
