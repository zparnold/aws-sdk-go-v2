...
func (c *Client) CreateFpgaImage(ctx context.Context, params *CreateFpgaImageInput, optFns ...func(*Options)) (*CreateFpgaImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFpgaImage", params, optFns, addOperationCreateFpgaImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFpgaImageMiddleware(stack *middleware.Stack, options Options) (err error) {
