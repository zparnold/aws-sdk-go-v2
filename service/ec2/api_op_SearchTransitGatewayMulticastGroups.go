...
func (c *Client) SearchTransitGatewayMulticastGroups(ctx context.Context, params *SearchTransitGatewayMulticastGroupsInput, optFns ...func(*Options)) (*SearchTransitGatewayMulticastGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchTransitGatewayMulticastGroups", params, optFns, addOperationSearchTransitGatewayMulticastGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchTransitGatewayMulticastGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
