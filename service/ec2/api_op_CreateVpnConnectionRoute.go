...
func (c *Client) CreateVpnConnectionRoute(ctx context.Context, params *CreateVpnConnectionRouteInput, optFns ...func(*Options)) (*CreateVpnConnectionRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpnConnectionRoute", params, optFns, addOperationCreateVpnConnectionRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpnConnectionRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
