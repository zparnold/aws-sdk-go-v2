...
func (c *Client) ModifyVpnTunnelOptions(ctx context.Context, params *ModifyVpnTunnelOptionsInput, optFns ...func(*Options)) (*ModifyVpnTunnelOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVpnTunnelOptions", params, optFns, addOperationModifyVpnTunnelOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVpnTunnelOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
