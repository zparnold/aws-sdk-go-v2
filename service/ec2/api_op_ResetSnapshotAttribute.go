...
func (c *Client) ResetSnapshotAttribute(ctx context.Context, params *ResetSnapshotAttributeInput, optFns ...func(*Options)) (*ResetSnapshotAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetSnapshotAttribute", params, optFns, addOperationResetSnapshotAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetSnapshotAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
