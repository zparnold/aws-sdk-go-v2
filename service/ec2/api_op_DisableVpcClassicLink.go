...
func (c *Client) DisableVpcClassicLink(ctx context.Context, params *DisableVpcClassicLinkInput, optFns ...func(*Options)) (*DisableVpcClassicLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableVpcClassicLink", params, optFns, addOperationDisableVpcClassicLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableVpcClassicLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
