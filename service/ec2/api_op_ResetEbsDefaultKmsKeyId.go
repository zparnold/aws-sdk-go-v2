...
func (c *Client) ResetEbsDefaultKmsKeyId(ctx context.Context, params *ResetEbsDefaultKmsKeyIdInput, optFns ...func(*Options)) (*ResetEbsDefaultKmsKeyIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetEbsDefaultKmsKeyId", params, optFns, addOperationResetEbsDefaultKmsKeyIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetEbsDefaultKmsKeyIdMiddleware(stack *middleware.Stack, options Options) (err error) {
