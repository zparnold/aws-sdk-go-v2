...
func (c *Client) ExportImage(ctx context.Context, params *ExportImageInput, optFns ...func(*Options)) (*ExportImageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportImage", params, optFns, addOperationExportImageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportImageMiddleware(stack *middleware.Stack, options Options) (err error) {
