...
func (c *Client) EnableVgwRoutePropagation(ctx context.Context, params *EnableVgwRoutePropagationInput, optFns ...func(*Options)) (*EnableVgwRoutePropagationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableVgwRoutePropagation", params, optFns, addOperationEnableVgwRoutePropagationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableVgwRoutePropagationMiddleware(stack *middleware.Stack, options Options) (err error) {
