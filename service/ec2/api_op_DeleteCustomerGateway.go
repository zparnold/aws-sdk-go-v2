...
func (c *Client) DeleteCustomerGateway(ctx context.Context, params *DeleteCustomerGatewayInput, optFns ...func(*Options)) (*DeleteCustomerGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCustomerGateway", params, optFns, addOperationDeleteCustomerGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCustomerGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
