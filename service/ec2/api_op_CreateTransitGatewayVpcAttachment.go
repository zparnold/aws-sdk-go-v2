...
func (c *Client) CreateTransitGatewayVpcAttachment(ctx context.Context, params *CreateTransitGatewayVpcAttachmentInput, optFns ...func(*Options)) (*CreateTransitGatewayVpcAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTransitGatewayVpcAttachment", params, optFns, addOperationCreateTransitGatewayVpcAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTransitGatewayVpcAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
