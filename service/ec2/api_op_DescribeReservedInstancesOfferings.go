...
func (c *Client) DescribeReservedInstancesOfferings(ctx context.Context, params *DescribeReservedInstancesOfferingsInput, optFns ...func(*Options)) (*DescribeReservedInstancesOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedInstancesOfferings", params, optFns, addOperationDescribeReservedInstancesOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedInstancesOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
