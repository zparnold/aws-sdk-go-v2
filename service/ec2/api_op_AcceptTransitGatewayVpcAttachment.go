...
func (c *Client) AcceptTransitGatewayVpcAttachment(ctx context.Context, params *AcceptTransitGatewayVpcAttachmentInput, optFns ...func(*Options)) (*AcceptTransitGatewayVpcAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptTransitGatewayVpcAttachment", params, optFns, addOperationAcceptTransitGatewayVpcAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptTransitGatewayVpcAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
