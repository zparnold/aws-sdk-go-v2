...
func (c *Client) DescribeTransitGatewayAttachments(ctx context.Context, params *DescribeTransitGatewayAttachmentsInput, optFns ...func(*Options)) (*DescribeTransitGatewayAttachmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTransitGatewayAttachments", params, optFns, addOperationDescribeTransitGatewayAttachmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTransitGatewayAttachmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
