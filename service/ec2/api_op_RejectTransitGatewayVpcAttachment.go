...
func (c *Client) RejectTransitGatewayVpcAttachment(ctx context.Context, params *RejectTransitGatewayVpcAttachmentInput, optFns ...func(*Options)) (*RejectTransitGatewayVpcAttachmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectTransitGatewayVpcAttachment", params, optFns, addOperationRejectTransitGatewayVpcAttachmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectTransitGatewayVpcAttachmentMiddleware(stack *middleware.Stack, options Options) (err error) {
