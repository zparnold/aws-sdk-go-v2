...
func (c *Client) ReplaceRouteTableAssociation(ctx context.Context, params *ReplaceRouteTableAssociationInput, optFns ...func(*Options)) (*ReplaceRouteTableAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReplaceRouteTableAssociation", params, optFns, addOperationReplaceRouteTableAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReplaceRouteTableAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
