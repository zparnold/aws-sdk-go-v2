...
func (c *Client) DeleteSpotDatafeedSubscription(ctx context.Context, params *DeleteSpotDatafeedSubscriptionInput, optFns ...func(*Options)) (*DeleteSpotDatafeedSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSpotDatafeedSubscription", params, optFns, addOperationDeleteSpotDatafeedSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSpotDatafeedSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
