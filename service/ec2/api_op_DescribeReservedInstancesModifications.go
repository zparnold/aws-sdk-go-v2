...
func (c *Client) DescribeReservedInstancesModifications(ctx context.Context, params *DescribeReservedInstancesModificationsInput, optFns ...func(*Options)) (*DescribeReservedInstancesModificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedInstancesModifications", params, optFns, addOperationDescribeReservedInstancesModificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedInstancesModificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
