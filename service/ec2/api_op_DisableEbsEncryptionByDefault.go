...
func (c *Client) DisableEbsEncryptionByDefault(ctx context.Context, params *DisableEbsEncryptionByDefaultInput, optFns ...func(*Options)) (*DisableEbsEncryptionByDefaultOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableEbsEncryptionByDefault", params, optFns, addOperationDisableEbsEncryptionByDefaultMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableEbsEncryptionByDefaultMiddleware(stack *middleware.Stack, options Options) (err error) {
