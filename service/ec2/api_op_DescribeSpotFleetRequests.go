...
func (c *Client) DescribeSpotFleetRequests(ctx context.Context, params *DescribeSpotFleetRequestsInput, optFns ...func(*Options)) (*DescribeSpotFleetRequestsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSpotFleetRequests", params, optFns, addOperationDescribeSpotFleetRequestsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSpotFleetRequestsMiddleware(stack *middleware.Stack, options Options) (err error) {
