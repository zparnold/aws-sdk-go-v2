...
func (c *Client) DescribeImportSnapshotTasks(ctx context.Context, params *DescribeImportSnapshotTasksInput, optFns ...func(*Options)) (*DescribeImportSnapshotTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeImportSnapshotTasks", params, optFns, addOperationDescribeImportSnapshotTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeImportSnapshotTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
