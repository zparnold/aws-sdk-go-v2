...
func (c *Client) ExportClientVpnClientConfiguration(ctx context.Context, params *ExportClientVpnClientConfigurationInput, optFns ...func(*Options)) (*ExportClientVpnClientConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportClientVpnClientConfiguration", params, optFns, addOperationExportClientVpnClientConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportClientVpnClientConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
