...
func (c *Client) AssociateSubnetCidrBlock(ctx context.Context, params *AssociateSubnetCidrBlockInput, optFns ...func(*Options)) (*AssociateSubnetCidrBlockOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateSubnetCidrBlock", params, optFns, addOperationAssociateSubnetCidrBlockMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateSubnetCidrBlockMiddleware(stack *middleware.Stack, options Options) (err error) {
