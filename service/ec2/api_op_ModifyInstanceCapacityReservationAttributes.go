...
func (c *Client) ModifyInstanceCapacityReservationAttributes(ctx context.Context, params *ModifyInstanceCapacityReservationAttributesInput, optFns ...func(*Options)) (*ModifyInstanceCapacityReservationAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyInstanceCapacityReservationAttributes", params, optFns, addOperationModifyInstanceCapacityReservationAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyInstanceCapacityReservationAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
