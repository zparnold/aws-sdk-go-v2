...
func (c *Client) BundleInstance(ctx context.Context, params *BundleInstanceInput, optFns ...func(*Options)) (*BundleInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BundleInstance", params, optFns, addOperationBundleInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBundleInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
