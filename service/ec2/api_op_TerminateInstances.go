...
func (c *Client) TerminateInstances(ctx context.Context, params *TerminateInstancesInput, optFns ...func(*Options)) (*TerminateInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateInstances", params, optFns, addOperationTerminateInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
