...
func (c *Client) DeleteLaunchTemplateVersions(ctx context.Context, params *DeleteLaunchTemplateVersionsInput, optFns ...func(*Options)) (*DeleteLaunchTemplateVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLaunchTemplateVersions", params, optFns, addOperationDeleteLaunchTemplateVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLaunchTemplateVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
