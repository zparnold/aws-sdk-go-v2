...
func (c *Client) DescribeCapacityReservations(ctx context.Context, params *DescribeCapacityReservationsInput, optFns ...func(*Options)) (*DescribeCapacityReservationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCapacityReservations", params, optFns, addOperationDescribeCapacityReservationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCapacityReservationsMiddleware(stack *middleware.Stack, options Options) (err error) {
