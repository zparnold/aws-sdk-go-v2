...
func (c *Client) ConfirmProductInstance(ctx context.Context, params *ConfirmProductInstanceInput, optFns ...func(*Options)) (*ConfirmProductInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmProductInstance", params, optFns, addOperationConfirmProductInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmProductInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
