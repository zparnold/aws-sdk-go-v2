...
func (c *Client) CreateSpotDatafeedSubscription(ctx context.Context, params *CreateSpotDatafeedSubscriptionInput, optFns ...func(*Options)) (*CreateSpotDatafeedSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSpotDatafeedSubscription", params, optFns, addOperationCreateSpotDatafeedSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSpotDatafeedSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
