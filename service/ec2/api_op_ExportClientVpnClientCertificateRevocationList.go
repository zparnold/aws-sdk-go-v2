...
func (c *Client) ExportClientVpnClientCertificateRevocationList(ctx context.Context, params *ExportClientVpnClientCertificateRevocationListInput, optFns ...func(*Options)) (*ExportClientVpnClientCertificateRevocationListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportClientVpnClientCertificateRevocationList", params, optFns, addOperationExportClientVpnClientCertificateRevocationListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportClientVpnClientCertificateRevocationListMiddleware(stack *middleware.Stack, options Options) (err error) {
