...
func (c *Client) CreateDhcpOptions(ctx context.Context, params *CreateDhcpOptionsInput, optFns ...func(*Options)) (*CreateDhcpOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDhcpOptions", params, optFns, addOperationCreateDhcpOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDhcpOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
