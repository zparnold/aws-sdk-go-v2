...
func (c *Client) DescribeConversionTasks(ctx context.Context, params *DescribeConversionTasksInput, optFns ...func(*Options)) (*DescribeConversionTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConversionTasks", params, optFns, addOperationDescribeConversionTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConversionTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
