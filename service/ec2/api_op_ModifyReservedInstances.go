...
func (c *Client) ModifyReservedInstances(ctx context.Context, params *ModifyReservedInstancesInput, optFns ...func(*Options)) (*ModifyReservedInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyReservedInstances", params, optFns, addOperationModifyReservedInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyReservedInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
