...
func (c *Client) DescribeScheduledInstanceAvailability(ctx context.Context, params *DescribeScheduledInstanceAvailabilityInput, optFns ...func(*Options)) (*DescribeScheduledInstanceAvailabilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScheduledInstanceAvailability", params, optFns, addOperationDescribeScheduledInstanceAvailabilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScheduledInstanceAvailabilityMiddleware(stack *middleware.Stack, options Options) (err error) {
