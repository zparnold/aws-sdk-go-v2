...
func (c *Client) GetManagedPrefixListEntries(ctx context.Context, params *GetManagedPrefixListEntriesInput, optFns ...func(*Options)) (*GetManagedPrefixListEntriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetManagedPrefixListEntries", params, optFns, addOperationGetManagedPrefixListEntriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetManagedPrefixListEntriesMiddleware(stack *middleware.Stack, options Options) (err error) {
