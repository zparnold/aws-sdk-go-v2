...
func (c *Client) ModifyVpcEndpointServicePermissions(ctx context.Context, params *ModifyVpcEndpointServicePermissionsInput, optFns ...func(*Options)) (*ModifyVpcEndpointServicePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVpcEndpointServicePermissions", params, optFns, addOperationModifyVpcEndpointServicePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVpcEndpointServicePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
