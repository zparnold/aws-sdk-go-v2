...
func (c *Client) DisableVgwRoutePropagation(ctx context.Context, params *DisableVgwRoutePropagationInput, optFns ...func(*Options)) (*DisableVgwRoutePropagationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableVgwRoutePropagation", params, optFns, addOperationDisableVgwRoutePropagationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableVgwRoutePropagationMiddleware(stack *middleware.Stack, options Options) (err error) {
