...
func (c *Client) DescribeLocalGatewayVirtualInterfaceGroups(ctx context.Context, params *DescribeLocalGatewayVirtualInterfaceGroupsInput, optFns ...func(*Options)) (*DescribeLocalGatewayVirtualInterfaceGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocalGatewayVirtualInterfaceGroups", params, optFns, addOperationDescribeLocalGatewayVirtualInterfaceGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocalGatewayVirtualInterfaceGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
