...
func (c *Client) ModifySpotFleetRequest(ctx context.Context, params *ModifySpotFleetRequestInput, optFns ...func(*Options)) (*ModifySpotFleetRequestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifySpotFleetRequest", params, optFns, addOperationModifySpotFleetRequestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifySpotFleetRequestMiddleware(stack *middleware.Stack, options Options) (err error) {
