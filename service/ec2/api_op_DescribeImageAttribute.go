...
func (c *Client) DescribeImageAttribute(ctx context.Context, params *DescribeImageAttributeInput, optFns ...func(*Options)) (*DescribeImageAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeImageAttribute", params, optFns, addOperationDescribeImageAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeImageAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
