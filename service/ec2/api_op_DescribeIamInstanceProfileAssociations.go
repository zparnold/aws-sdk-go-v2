...
func (c *Client) DescribeIamInstanceProfileAssociations(ctx context.Context, params *DescribeIamInstanceProfileAssociationsInput, optFns ...func(*Options)) (*DescribeIamInstanceProfileAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIamInstanceProfileAssociations", params, optFns, addOperationDescribeIamInstanceProfileAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIamInstanceProfileAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
