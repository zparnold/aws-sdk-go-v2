...
func (c *Client) CreateLocalGatewayRoute(ctx context.Context, params *CreateLocalGatewayRouteInput, optFns ...func(*Options)) (*CreateLocalGatewayRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLocalGatewayRoute", params, optFns, addOperationCreateLocalGatewayRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLocalGatewayRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
