...
func (c *Client) SearchLocalGatewayRoutes(ctx context.Context, params *SearchLocalGatewayRoutesInput, optFns ...func(*Options)) (*SearchLocalGatewayRoutesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchLocalGatewayRoutes", params, optFns, addOperationSearchLocalGatewayRoutesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchLocalGatewayRoutesMiddleware(stack *middleware.Stack, options Options) (err error) {
