...
func (c *Client) AssociateIamInstanceProfile(ctx context.Context, params *AssociateIamInstanceProfileInput, optFns ...func(*Options)) (*AssociateIamInstanceProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateIamInstanceProfile", params, optFns, addOperationAssociateIamInstanceProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateIamInstanceProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
