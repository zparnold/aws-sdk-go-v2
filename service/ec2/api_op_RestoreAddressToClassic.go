...
func (c *Client) RestoreAddressToClassic(ctx context.Context, params *RestoreAddressToClassicInput, optFns ...func(*Options)) (*RestoreAddressToClassicOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreAddressToClassic", params, optFns, addOperationRestoreAddressToClassicMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreAddressToClassicMiddleware(stack *middleware.Stack, options Options) (err error) {
