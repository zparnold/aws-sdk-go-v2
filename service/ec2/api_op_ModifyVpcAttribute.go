...
func (c *Client) ModifyVpcAttribute(ctx context.Context, params *ModifyVpcAttributeInput, optFns ...func(*Options)) (*ModifyVpcAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVpcAttribute", params, optFns, addOperationModifyVpcAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVpcAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
