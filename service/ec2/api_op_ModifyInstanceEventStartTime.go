...
func (c *Client) ModifyInstanceEventStartTime(ctx context.Context, params *ModifyInstanceEventStartTimeInput, optFns ...func(*Options)) (*ModifyInstanceEventStartTimeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyInstanceEventStartTime", params, optFns, addOperationModifyInstanceEventStartTimeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyInstanceEventStartTimeMiddleware(stack *middleware.Stack, options Options) (err error) {
