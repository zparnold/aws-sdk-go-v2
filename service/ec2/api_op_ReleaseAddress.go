...
func (c *Client) ReleaseAddress(ctx context.Context, params *ReleaseAddressInput, optFns ...func(*Options)) (*ReleaseAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReleaseAddress", params, optFns, addOperationReleaseAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReleaseAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
