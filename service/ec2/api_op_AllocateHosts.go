...
func (c *Client) AllocateHosts(ctx context.Context, params *AllocateHostsInput, optFns ...func(*Options)) (*AllocateHostsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AllocateHosts", params, optFns, addOperationAllocateHostsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAllocateHostsMiddleware(stack *middleware.Stack, options Options) (err error) {
