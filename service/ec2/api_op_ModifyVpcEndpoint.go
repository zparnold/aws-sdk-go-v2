...
func (c *Client) ModifyVpcEndpoint(ctx context.Context, params *ModifyVpcEndpointInput, optFns ...func(*Options)) (*ModifyVpcEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVpcEndpoint", params, optFns, addOperationModifyVpcEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVpcEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
