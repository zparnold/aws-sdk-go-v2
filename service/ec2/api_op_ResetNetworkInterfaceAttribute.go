...
func (c *Client) ResetNetworkInterfaceAttribute(ctx context.Context, params *ResetNetworkInterfaceAttributeInput, optFns ...func(*Options)) (*ResetNetworkInterfaceAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetNetworkInterfaceAttribute", params, optFns, addOperationResetNetworkInterfaceAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetNetworkInterfaceAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
