...
func (c *Client) ModifyIdentityIdFormat(ctx context.Context, params *ModifyIdentityIdFormatInput, optFns ...func(*Options)) (*ModifyIdentityIdFormatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyIdentityIdFormat", params, optFns, addOperationModifyIdentityIdFormatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyIdentityIdFormatMiddleware(stack *middleware.Stack, options Options) (err error) {
