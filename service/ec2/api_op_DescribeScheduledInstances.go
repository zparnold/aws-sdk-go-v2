...
func (c *Client) DescribeScheduledInstances(ctx context.Context, params *DescribeScheduledInstancesInput, optFns ...func(*Options)) (*DescribeScheduledInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScheduledInstances", params, optFns, addOperationDescribeScheduledInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScheduledInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
