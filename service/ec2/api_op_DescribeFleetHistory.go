...
func (c *Client) DescribeFleetHistory(ctx context.Context, params *DescribeFleetHistoryInput, optFns ...func(*Options)) (*DescribeFleetHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetHistory", params, optFns, addOperationDescribeFleetHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
