...
func (c *Client) DescribeVpcs(ctx context.Context, params *DescribeVpcsInput, optFns ...func(*Options)) (*DescribeVpcsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcs", params, optFns, addOperationDescribeVpcsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcsMiddleware(stack *middleware.Stack, options Options) (err error) {
