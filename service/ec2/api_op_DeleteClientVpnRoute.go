...
func (c *Client) DeleteClientVpnRoute(ctx context.Context, params *DeleteClientVpnRouteInput, optFns ...func(*Options)) (*DeleteClientVpnRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClientVpnRoute", params, optFns, addOperationDeleteClientVpnRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClientVpnRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
