...
func (c *Client) StopInstances(ctx context.Context, params *StopInstancesInput, optFns ...func(*Options)) (*StopInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopInstances", params, optFns, addOperationStopInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
