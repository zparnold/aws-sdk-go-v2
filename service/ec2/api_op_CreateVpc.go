...
func (c *Client) CreateVpc(ctx context.Context, params *CreateVpcInput, optFns ...func(*Options)) (*CreateVpcOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpc", params, optFns, addOperationCreateVpcMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpcMiddleware(stack *middleware.Stack, options Options) (err error) {
