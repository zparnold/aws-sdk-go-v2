...
func (c *Client) DeleteDhcpOptions(ctx context.Context, params *DeleteDhcpOptionsInput, optFns ...func(*Options)) (*DeleteDhcpOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDhcpOptions", params, optFns, addOperationDeleteDhcpOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDhcpOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
