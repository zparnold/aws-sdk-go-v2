...
func (c *Client) DeleteManagedPrefixList(ctx context.Context, params *DeleteManagedPrefixListInput, optFns ...func(*Options)) (*DeleteManagedPrefixListOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteManagedPrefixList", params, optFns, addOperationDeleteManagedPrefixListMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteManagedPrefixListMiddleware(stack *middleware.Stack, options Options) (err error) {
