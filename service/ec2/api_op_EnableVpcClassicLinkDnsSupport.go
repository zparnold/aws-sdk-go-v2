...
func (c *Client) EnableVpcClassicLinkDnsSupport(ctx context.Context, params *EnableVpcClassicLinkDnsSupportInput, optFns ...func(*Options)) (*EnableVpcClassicLinkDnsSupportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableVpcClassicLinkDnsSupport", params, optFns, addOperationEnableVpcClassicLinkDnsSupportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableVpcClassicLinkDnsSupportMiddleware(stack *middleware.Stack, options Options) (err error) {
