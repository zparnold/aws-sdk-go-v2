...
func (c *Client) ImportSnapshot(ctx context.Context, params *ImportSnapshotInput, optFns ...func(*Options)) (*ImportSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportSnapshot", params, optFns, addOperationImportSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
