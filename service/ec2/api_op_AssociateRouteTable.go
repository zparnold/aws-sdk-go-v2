...
func (c *Client) AssociateRouteTable(ctx context.Context, params *AssociateRouteTableInput, optFns ...func(*Options)) (*AssociateRouteTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateRouteTable", params, optFns, addOperationAssociateRouteTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateRouteTableMiddleware(stack *middleware.Stack, options Options) (err error) {
