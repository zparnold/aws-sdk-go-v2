...
func (c *Client) DescribeStaleSecurityGroups(ctx context.Context, params *DescribeStaleSecurityGroupsInput, optFns ...func(*Options)) (*DescribeStaleSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStaleSecurityGroups", params, optFns, addOperationDescribeStaleSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStaleSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
