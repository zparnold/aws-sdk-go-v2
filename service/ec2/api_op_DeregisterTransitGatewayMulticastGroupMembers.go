...
func (c *Client) DeregisterTransitGatewayMulticastGroupMembers(ctx context.Context, params *DeregisterTransitGatewayMulticastGroupMembersInput, optFns ...func(*Options)) (*DeregisterTransitGatewayMulticastGroupMembersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterTransitGatewayMulticastGroupMembers", params, optFns, addOperationDeregisterTransitGatewayMulticastGroupMembersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterTransitGatewayMulticastGroupMembersMiddleware(stack *middleware.Stack, options Options) (err error) {
