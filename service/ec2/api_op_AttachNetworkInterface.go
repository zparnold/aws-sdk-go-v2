...
func (c *Client) AttachNetworkInterface(ctx context.Context, params *AttachNetworkInterfaceInput, optFns ...func(*Options)) (*AttachNetworkInterfaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachNetworkInterface", params, optFns, addOperationAttachNetworkInterfaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachNetworkInterfaceMiddleware(stack *middleware.Stack, options Options) (err error) {
