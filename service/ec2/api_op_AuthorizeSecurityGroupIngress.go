...
func (c *Client) AuthorizeSecurityGroupIngress(ctx context.Context, params *AuthorizeSecurityGroupIngressInput, optFns ...func(*Options)) (*AuthorizeSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeSecurityGroupIngress", params, optFns, addOperationAuthorizeSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
