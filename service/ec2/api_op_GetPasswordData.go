...
func (c *Client) GetPasswordData(ctx context.Context, params *GetPasswordDataInput, optFns ...func(*Options)) (*GetPasswordDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPasswordData", params, optFns, addOperationGetPasswordDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPasswordDataMiddleware(stack *middleware.Stack, options Options) (err error) {
