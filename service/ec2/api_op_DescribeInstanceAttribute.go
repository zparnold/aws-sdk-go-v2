...
func (c *Client) DescribeInstanceAttribute(ctx context.Context, params *DescribeInstanceAttributeInput, optFns ...func(*Options)) (*DescribeInstanceAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceAttribute", params, optFns, addOperationDescribeInstanceAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
