...
func (c *Client) ResetImageAttribute(ctx context.Context, params *ResetImageAttributeInput, optFns ...func(*Options)) (*ResetImageAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetImageAttribute", params, optFns, addOperationResetImageAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetImageAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
