...
func (c *Client) DisassociateRouteTable(ctx context.Context, params *DisassociateRouteTableInput, optFns ...func(*Options)) (*DisassociateRouteTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateRouteTable", params, optFns, addOperationDisassociateRouteTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateRouteTableMiddleware(stack *middleware.Stack, options Options) (err error) {
