...
func (c *Client) UnassignPrivateIpAddresses(ctx context.Context, params *UnassignPrivateIpAddressesInput, optFns ...func(*Options)) (*UnassignPrivateIpAddressesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnassignPrivateIpAddresses", params, optFns, addOperationUnassignPrivateIpAddressesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnassignPrivateIpAddressesMiddleware(stack *middleware.Stack, options Options) (err error) {
