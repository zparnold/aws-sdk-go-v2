...
func (c *Client) ModifyVpcEndpointConnectionNotification(ctx context.Context, params *ModifyVpcEndpointConnectionNotificationInput, optFns ...func(*Options)) (*ModifyVpcEndpointConnectionNotificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVpcEndpointConnectionNotification", params, optFns, addOperationModifyVpcEndpointConnectionNotificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVpcEndpointConnectionNotificationMiddleware(stack *middleware.Stack, options Options) (err error) {
