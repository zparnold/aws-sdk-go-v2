...
func (c *Client) DeleteVpcEndpoints(ctx context.Context, params *DeleteVpcEndpointsInput, optFns ...func(*Options)) (*DeleteVpcEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpcEndpoints", params, optFns, addOperationDeleteVpcEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpcEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
