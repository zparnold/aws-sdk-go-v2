...
func (c *Client) AcceptVpcEndpointConnections(ctx context.Context, params *AcceptVpcEndpointConnectionsInput, optFns ...func(*Options)) (*AcceptVpcEndpointConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptVpcEndpointConnections", params, optFns, addOperationAcceptVpcEndpointConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptVpcEndpointConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
