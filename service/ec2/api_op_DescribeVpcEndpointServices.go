...
func (c *Client) DescribeVpcEndpointServices(ctx context.Context, params *DescribeVpcEndpointServicesInput, optFns ...func(*Options)) (*DescribeVpcEndpointServicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcEndpointServices", params, optFns, addOperationDescribeVpcEndpointServicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcEndpointServicesMiddleware(stack *middleware.Stack, options Options) (err error) {
