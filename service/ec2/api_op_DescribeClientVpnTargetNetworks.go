...
func (c *Client) DescribeClientVpnTargetNetworks(ctx context.Context, params *DescribeClientVpnTargetNetworksInput, optFns ...func(*Options)) (*DescribeClientVpnTargetNetworksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeClientVpnTargetNetworks", params, optFns, addOperationDescribeClientVpnTargetNetworksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeClientVpnTargetNetworksMiddleware(stack *middleware.Stack, options Options) (err error) {
