...
func (c *Client) GetAssociatedIpv6PoolCidrs(ctx context.Context, params *GetAssociatedIpv6PoolCidrsInput, optFns ...func(*Options)) (*GetAssociatedIpv6PoolCidrsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssociatedIpv6PoolCidrs", params, optFns, addOperationGetAssociatedIpv6PoolCidrsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssociatedIpv6PoolCidrsMiddleware(stack *middleware.Stack, options Options) (err error) {
