...
func (c *Client) DescribeFlowLogs(ctx context.Context, params *DescribeFlowLogsInput, optFns ...func(*Options)) (*DescribeFlowLogsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFlowLogs", params, optFns, addOperationDescribeFlowLogsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFlowLogsMiddleware(stack *middleware.Stack, options Options) (err error) {
