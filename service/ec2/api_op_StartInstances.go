...
func (c *Client) StartInstances(ctx context.Context, params *StartInstancesInput, optFns ...func(*Options)) (*StartInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartInstances", params, optFns, addOperationStartInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
