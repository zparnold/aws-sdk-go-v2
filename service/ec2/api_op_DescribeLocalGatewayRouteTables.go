...
func (c *Client) DescribeLocalGatewayRouteTables(ctx context.Context, params *DescribeLocalGatewayRouteTablesInput, optFns ...func(*Options)) (*DescribeLocalGatewayRouteTablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocalGatewayRouteTables", params, optFns, addOperationDescribeLocalGatewayRouteTablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocalGatewayRouteTablesMiddleware(stack *middleware.Stack, options Options) (err error) {
