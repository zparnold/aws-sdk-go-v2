...
func (c *Client) RegisterInstanceEventNotificationAttributes(ctx context.Context, params *RegisterInstanceEventNotificationAttributesInput, optFns ...func(*Options)) (*RegisterInstanceEventNotificationAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterInstanceEventNotificationAttributes", params, optFns, addOperationRegisterInstanceEventNotificationAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterInstanceEventNotificationAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
