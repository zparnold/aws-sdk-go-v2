...
func (c *Client) GetEbsDefaultKmsKeyId(ctx context.Context, params *GetEbsDefaultKmsKeyIdInput, optFns ...func(*Options)) (*GetEbsDefaultKmsKeyIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEbsDefaultKmsKeyId", params, optFns, addOperationGetEbsDefaultKmsKeyIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEbsDefaultKmsKeyIdMiddleware(stack *middleware.Stack, options Options) (err error) {
