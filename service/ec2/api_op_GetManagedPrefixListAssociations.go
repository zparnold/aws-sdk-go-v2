...
func (c *Client) GetManagedPrefixListAssociations(ctx context.Context, params *GetManagedPrefixListAssociationsInput, optFns ...func(*Options)) (*GetManagedPrefixListAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetManagedPrefixListAssociations", params, optFns, addOperationGetManagedPrefixListAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetManagedPrefixListAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
