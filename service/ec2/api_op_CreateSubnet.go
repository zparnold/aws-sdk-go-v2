...
func (c *Client) CreateSubnet(ctx context.Context, params *CreateSubnetInput, optFns ...func(*Options)) (*CreateSubnetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSubnet", params, optFns, addOperationCreateSubnetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSubnetMiddleware(stack *middleware.Stack, options Options) (err error) {
