...
func (c *Client) UpdateSecurityGroupRuleDescriptionsEgress(ctx context.Context, params *UpdateSecurityGroupRuleDescriptionsEgressInput, optFns ...func(*Options)) (*UpdateSecurityGroupRuleDescriptionsEgressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSecurityGroupRuleDescriptionsEgress", params, optFns, addOperationUpdateSecurityGroupRuleDescriptionsEgressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSecurityGroupRuleDescriptionsEgressMiddleware(stack *middleware.Stack, options Options) (err error) {
