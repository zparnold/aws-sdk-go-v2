...
func (c *Client) DescribeLocalGatewayRouteTableVpcAssociations(ctx context.Context, params *DescribeLocalGatewayRouteTableVpcAssociationsInput, optFns ...func(*Options)) (*DescribeLocalGatewayRouteTableVpcAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocalGatewayRouteTableVpcAssociations", params, optFns, addOperationDescribeLocalGatewayRouteTableVpcAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocalGatewayRouteTableVpcAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
