...
func (c *Client) AuthorizeSecurityGroupEgress(ctx context.Context, params *AuthorizeSecurityGroupEgressInput, optFns ...func(*Options)) (*AuthorizeSecurityGroupEgressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeSecurityGroupEgress", params, optFns, addOperationAuthorizeSecurityGroupEgressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeSecurityGroupEgressMiddleware(stack *middleware.Stack, options Options) (err error) {
