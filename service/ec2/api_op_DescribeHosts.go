...
func (c *Client) DescribeHosts(ctx context.Context, params *DescribeHostsInput, optFns ...func(*Options)) (*DescribeHostsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeHosts", params, optFns, addOperationDescribeHostsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeHostsMiddleware(stack *middleware.Stack, options Options) (err error) {
