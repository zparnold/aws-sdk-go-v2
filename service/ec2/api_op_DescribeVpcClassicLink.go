...
func (c *Client) DescribeVpcClassicLink(ctx context.Context, params *DescribeVpcClassicLinkInput, optFns ...func(*Options)) (*DescribeVpcClassicLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcClassicLink", params, optFns, addOperationDescribeVpcClassicLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcClassicLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
