...
func (c *Client) DeleteNetworkInterfacePermission(ctx context.Context, params *DeleteNetworkInterfacePermissionInput, optFns ...func(*Options)) (*DeleteNetworkInterfacePermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNetworkInterfacePermission", params, optFns, addOperationDeleteNetworkInterfacePermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNetworkInterfacePermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
