...
func (c *Client) DescribeInstanceTypeOfferings(ctx context.Context, params *DescribeInstanceTypeOfferingsInput, optFns ...func(*Options)) (*DescribeInstanceTypeOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceTypeOfferings", params, optFns, addOperationDescribeInstanceTypeOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceTypeOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
