...
func (c *Client) DeleteTrafficMirrorFilterRule(ctx context.Context, params *DeleteTrafficMirrorFilterRuleInput, optFns ...func(*Options)) (*DeleteTrafficMirrorFilterRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrafficMirrorFilterRule", params, optFns, addOperationDeleteTrafficMirrorFilterRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrafficMirrorFilterRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
