...
func (c *Client) ImportKeyPair(ctx context.Context, params *ImportKeyPairInput, optFns ...func(*Options)) (*ImportKeyPairOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportKeyPair", params, optFns, addOperationImportKeyPairMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportKeyPairMiddleware(stack *middleware.Stack, options Options) (err error) {
