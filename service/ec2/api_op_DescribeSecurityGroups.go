...
func (c *Client) DescribeSecurityGroups(ctx context.Context, params *DescribeSecurityGroupsInput, optFns ...func(*Options)) (*DescribeSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSecurityGroups", params, optFns, addOperationDescribeSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
