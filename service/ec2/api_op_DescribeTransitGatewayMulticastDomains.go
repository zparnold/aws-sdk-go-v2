...
func (c *Client) DescribeTransitGatewayMulticastDomains(ctx context.Context, params *DescribeTransitGatewayMulticastDomainsInput, optFns ...func(*Options)) (*DescribeTransitGatewayMulticastDomainsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTransitGatewayMulticastDomains", params, optFns, addOperationDescribeTransitGatewayMulticastDomainsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTransitGatewayMulticastDomainsMiddleware(stack *middleware.Stack, options Options) (err error) {
