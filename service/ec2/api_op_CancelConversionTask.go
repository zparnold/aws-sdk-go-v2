...
func (c *Client) CancelConversionTask(ctx context.Context, params *CancelConversionTaskInput, optFns ...func(*Options)) (*CancelConversionTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelConversionTask", params, optFns, addOperationCancelConversionTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelConversionTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
