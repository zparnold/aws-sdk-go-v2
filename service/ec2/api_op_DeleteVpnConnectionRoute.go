...
func (c *Client) DeleteVpnConnectionRoute(ctx context.Context, params *DeleteVpnConnectionRouteInput, optFns ...func(*Options)) (*DeleteVpnConnectionRouteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpnConnectionRoute", params, optFns, addOperationDeleteVpnConnectionRouteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpnConnectionRouteMiddleware(stack *middleware.Stack, options Options) (err error) {
