...
func (c *Client) DescribeFastSnapshotRestores(ctx context.Context, params *DescribeFastSnapshotRestoresInput, optFns ...func(*Options)) (*DescribeFastSnapshotRestoresOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFastSnapshotRestores", params, optFns, addOperationDescribeFastSnapshotRestoresMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFastSnapshotRestoresMiddleware(stack *middleware.Stack, options Options) (err error) {
