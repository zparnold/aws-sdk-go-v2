...
func (c *Client) AttachVpnGateway(ctx context.Context, params *AttachVpnGatewayInput, optFns ...func(*Options)) (*AttachVpnGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachVpnGateway", params, optFns, addOperationAttachVpnGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachVpnGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
