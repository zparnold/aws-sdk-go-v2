...
func (c *Client) DescribeInstanceCreditSpecifications(ctx context.Context, params *DescribeInstanceCreditSpecificationsInput, optFns ...func(*Options)) (*DescribeInstanceCreditSpecificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceCreditSpecifications", params, optFns, addOperationDescribeInstanceCreditSpecificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceCreditSpecificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
