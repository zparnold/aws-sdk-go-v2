...
func (c *Client) DescribeInstanceStatus(ctx context.Context, params *DescribeInstanceStatusInput, optFns ...func(*Options)) (*DescribeInstanceStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceStatus", params, optFns, addOperationDescribeInstanceStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
