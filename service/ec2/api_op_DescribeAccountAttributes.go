...
func (c *Client) DescribeAccountAttributes(ctx context.Context, params *DescribeAccountAttributesInput, optFns ...func(*Options)) (*DescribeAccountAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccountAttributes", params, optFns, addOperationDescribeAccountAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccountAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
