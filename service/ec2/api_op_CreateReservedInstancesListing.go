...
func (c *Client) CreateReservedInstancesListing(ctx context.Context, params *CreateReservedInstancesListingInput, optFns ...func(*Options)) (*CreateReservedInstancesListingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateReservedInstancesListing", params, optFns, addOperationCreateReservedInstancesListingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateReservedInstancesListingMiddleware(stack *middleware.Stack, options Options) (err error) {
