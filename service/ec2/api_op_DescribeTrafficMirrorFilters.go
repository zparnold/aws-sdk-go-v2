...
func (c *Client) DescribeTrafficMirrorFilters(ctx context.Context, params *DescribeTrafficMirrorFiltersInput, optFns ...func(*Options)) (*DescribeTrafficMirrorFiltersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrafficMirrorFilters", params, optFns, addOperationDescribeTrafficMirrorFiltersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrafficMirrorFiltersMiddleware(stack *middleware.Stack, options Options) (err error) {
