...
func (c *Client) ModifyAvailabilityZoneGroup(ctx context.Context, params *ModifyAvailabilityZoneGroupInput, optFns ...func(*Options)) (*ModifyAvailabilityZoneGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyAvailabilityZoneGroup", params, optFns, addOperationModifyAvailabilityZoneGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyAvailabilityZoneGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
