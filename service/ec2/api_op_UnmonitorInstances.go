...
func (c *Client) UnmonitorInstances(ctx context.Context, params *UnmonitorInstancesInput, optFns ...func(*Options)) (*UnmonitorInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnmonitorInstances", params, optFns, addOperationUnmonitorInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnmonitorInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
