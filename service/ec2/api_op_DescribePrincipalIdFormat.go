...
func (c *Client) DescribePrincipalIdFormat(ctx context.Context, params *DescribePrincipalIdFormatInput, optFns ...func(*Options)) (*DescribePrincipalIdFormatOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePrincipalIdFormat", params, optFns, addOperationDescribePrincipalIdFormatMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePrincipalIdFormatMiddleware(stack *middleware.Stack, options Options) (err error) {
