...
func (c *Client) DeleteInternetGateway(ctx context.Context, params *DeleteInternetGatewayInput, optFns ...func(*Options)) (*DeleteInternetGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInternetGateway", params, optFns, addOperationDeleteInternetGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInternetGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
