...
func (c *Client) CreateDefaultVpc(ctx context.Context, params *CreateDefaultVpcInput, optFns ...func(*Options)) (*CreateDefaultVpcOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDefaultVpc", params, optFns, addOperationCreateDefaultVpcMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDefaultVpcMiddleware(stack *middleware.Stack, options Options) (err error) {
