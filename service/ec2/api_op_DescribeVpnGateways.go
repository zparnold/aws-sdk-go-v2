...
func (c *Client) DescribeVpnGateways(ctx context.Context, params *DescribeVpnGatewaysInput, optFns ...func(*Options)) (*DescribeVpnGatewaysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpnGateways", params, optFns, addOperationDescribeVpnGatewaysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpnGatewaysMiddleware(stack *middleware.Stack, options Options) (err error) {
