...
func (c *Client) ModifyVolumeAttribute(ctx context.Context, params *ModifyVolumeAttributeInput, optFns ...func(*Options)) (*ModifyVolumeAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyVolumeAttribute", params, optFns, addOperationModifyVolumeAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyVolumeAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
