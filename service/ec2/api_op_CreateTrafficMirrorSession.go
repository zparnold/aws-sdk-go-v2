...
func (c *Client) CreateTrafficMirrorSession(ctx context.Context, params *CreateTrafficMirrorSessionInput, optFns ...func(*Options)) (*CreateTrafficMirrorSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrafficMirrorSession", params, optFns, addOperationCreateTrafficMirrorSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrafficMirrorSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
