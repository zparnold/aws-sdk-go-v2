...
func (c *Client) ModifyClientVpnEndpoint(ctx context.Context, params *ModifyClientVpnEndpointInput, optFns ...func(*Options)) (*ModifyClientVpnEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyClientVpnEndpoint", params, optFns, addOperationModifyClientVpnEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyClientVpnEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
