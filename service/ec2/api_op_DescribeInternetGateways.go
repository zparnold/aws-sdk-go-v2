...
func (c *Client) DescribeInternetGateways(ctx context.Context, params *DescribeInternetGatewaysInput, optFns ...func(*Options)) (*DescribeInternetGatewaysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInternetGateways", params, optFns, addOperationDescribeInternetGatewaysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInternetGatewaysMiddleware(stack *middleware.Stack, options Options) (err error) {
