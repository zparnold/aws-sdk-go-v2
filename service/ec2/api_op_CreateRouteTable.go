...
func (c *Client) CreateRouteTable(ctx context.Context, params *CreateRouteTableInput, optFns ...func(*Options)) (*CreateRouteTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRouteTable", params, optFns, addOperationCreateRouteTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRouteTableMiddleware(stack *middleware.Stack, options Options) (err error) {
