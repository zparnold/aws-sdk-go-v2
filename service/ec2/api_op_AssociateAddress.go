...
func (c *Client) AssociateAddress(ctx context.Context, params *AssociateAddressInput, optFns ...func(*Options)) (*AssociateAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateAddress", params, optFns, addOperationAssociateAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
