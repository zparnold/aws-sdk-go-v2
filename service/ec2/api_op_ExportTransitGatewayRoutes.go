...
func (c *Client) ExportTransitGatewayRoutes(ctx context.Context, params *ExportTransitGatewayRoutesInput, optFns ...func(*Options)) (*ExportTransitGatewayRoutesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportTransitGatewayRoutes", params, optFns, addOperationExportTransitGatewayRoutesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportTransitGatewayRoutesMiddleware(stack *middleware.Stack, options Options) (err error) {
