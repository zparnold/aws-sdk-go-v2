...
func (c *Client) DescribeDhcpOptions(ctx context.Context, params *DescribeDhcpOptionsInput, optFns ...func(*Options)) (*DescribeDhcpOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDhcpOptions", params, optFns, addOperationDescribeDhcpOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDhcpOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
