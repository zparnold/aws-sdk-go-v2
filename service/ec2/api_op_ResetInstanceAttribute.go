...
func (c *Client) ResetInstanceAttribute(ctx context.Context, params *ResetInstanceAttributeInput, optFns ...func(*Options)) (*ResetInstanceAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetInstanceAttribute", params, optFns, addOperationResetInstanceAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetInstanceAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
