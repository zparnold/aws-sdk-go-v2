...
func (c *Client) DeletePlacementGroup(ctx context.Context, params *DeletePlacementGroupInput, optFns ...func(*Options)) (*DeletePlacementGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePlacementGroup", params, optFns, addOperationDeletePlacementGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePlacementGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
