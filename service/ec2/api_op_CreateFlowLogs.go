...
func (c *Client) CreateFlowLogs(ctx context.Context, params *CreateFlowLogsInput, optFns ...func(*Options)) (*CreateFlowLogsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFlowLogs", params, optFns, addOperationCreateFlowLogsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFlowLogsMiddleware(stack *middleware.Stack, options Options) (err error) {
