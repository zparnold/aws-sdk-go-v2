...
func (c *Client) RevokeSecurityGroupEgress(ctx context.Context, params *RevokeSecurityGroupEgressInput, optFns ...func(*Options)) (*RevokeSecurityGroupEgressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeSecurityGroupEgress", params, optFns, addOperationRevokeSecurityGroupEgressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeSecurityGroupEgressMiddleware(stack *middleware.Stack, options Options) (err error) {
