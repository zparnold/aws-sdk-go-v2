...
func (c *Client) StartVpcEndpointServicePrivateDnsVerification(ctx context.Context, params *StartVpcEndpointServicePrivateDnsVerificationInput, optFns ...func(*Options)) (*StartVpcEndpointServicePrivateDnsVerificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartVpcEndpointServicePrivateDnsVerification", params, optFns, addOperationStartVpcEndpointServicePrivateDnsVerificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartVpcEndpointServicePrivateDnsVerificationMiddleware(stack *middleware.Stack, options Options) (err error) {
