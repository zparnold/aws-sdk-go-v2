...
func (c *Client) CancelIngestion(ctx context.Context, params *CancelIngestionInput, optFns ...func(*Options)) (*CancelIngestionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelIngestion", params, optFns, addOperationCancelIngestionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelIngestionMiddleware(stack *middleware.Stack, options Options) (err error) {
