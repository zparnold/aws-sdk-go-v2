...
func (c *Client) ListUserGroups(ctx context.Context, params *ListUserGroupsInput, optFns ...func(*Options)) (*ListUserGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserGroups", params, optFns, addOperationListUserGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
