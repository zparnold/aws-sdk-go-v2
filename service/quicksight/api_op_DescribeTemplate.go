...
func (c *Client) DescribeTemplate(ctx context.Context, params *DescribeTemplateInput, optFns ...func(*Options)) (*DescribeTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTemplate", params, optFns, addOperationDescribeTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
