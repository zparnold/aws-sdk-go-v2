...
func (c *Client) DescribeIAMPolicyAssignment(ctx context.Context, params *DescribeIAMPolicyAssignmentInput, optFns ...func(*Options)) (*DescribeIAMPolicyAssignmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIAMPolicyAssignment", params, optFns, addOperationDescribeIAMPolicyAssignmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIAMPolicyAssignmentMiddleware(stack *middleware.Stack, options Options) (err error) {
