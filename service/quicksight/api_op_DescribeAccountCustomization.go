...
func (c *Client) DescribeAccountCustomization(ctx context.Context, params *DescribeAccountCustomizationInput, optFns ...func(*Options)) (*DescribeAccountCustomizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccountCustomization", params, optFns, addOperationDescribeAccountCustomizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccountCustomizationMiddleware(stack *middleware.Stack, options Options) (err error) {
