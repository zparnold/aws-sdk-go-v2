...
func (c *Client) RegisterUser(ctx context.Context, params *RegisterUserInput, optFns ...func(*Options)) (*RegisterUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterUser", params, optFns, addOperationRegisterUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterUserMiddleware(stack *middleware.Stack, options Options) (err error) {
