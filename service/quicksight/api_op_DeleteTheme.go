...
func (c *Client) DeleteTheme(ctx context.Context, params *DeleteThemeInput, optFns ...func(*Options)) (*DeleteThemeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTheme", params, optFns, addOperationDeleteThemeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteThemeMiddleware(stack *middleware.Stack, options Options) (err error) {
