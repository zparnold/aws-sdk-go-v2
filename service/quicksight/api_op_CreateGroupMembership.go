...
func (c *Client) CreateGroupMembership(ctx context.Context, params *CreateGroupMembershipInput, optFns ...func(*Options)) (*CreateGroupMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGroupMembership", params, optFns, addOperationCreateGroupMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGroupMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
