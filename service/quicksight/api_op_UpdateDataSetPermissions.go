...
func (c *Client) UpdateDataSetPermissions(ctx context.Context, params *UpdateDataSetPermissionsInput, optFns ...func(*Options)) (*UpdateDataSetPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDataSetPermissions", params, optFns, addOperationUpdateDataSetPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDataSetPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
