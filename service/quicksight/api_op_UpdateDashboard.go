...
func (c *Client) UpdateDashboard(ctx context.Context, params *UpdateDashboardInput, optFns ...func(*Options)) (*UpdateDashboardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDashboard", params, optFns, addOperationUpdateDashboardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDashboardMiddleware(stack *middleware.Stack, options Options) (err error) {
