...
func (c *Client) UpdateThemePermissions(ctx context.Context, params *UpdateThemePermissionsInput, optFns ...func(*Options)) (*UpdateThemePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateThemePermissions", params, optFns, addOperationUpdateThemePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThemePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
