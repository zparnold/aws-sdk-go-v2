...
func (c *Client) CreateAccountCustomization(ctx context.Context, params *CreateAccountCustomizationInput, optFns ...func(*Options)) (*CreateAccountCustomizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAccountCustomization", params, optFns, addOperationCreateAccountCustomizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAccountCustomizationMiddleware(stack *middleware.Stack, options Options) (err error) {
