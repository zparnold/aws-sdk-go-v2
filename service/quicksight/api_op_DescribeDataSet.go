...
func (c *Client) DescribeDataSet(ctx context.Context, params *DescribeDataSetInput, optFns ...func(*Options)) (*DescribeDataSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDataSet", params, optFns, addOperationDescribeDataSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDataSetMiddleware(stack *middleware.Stack, options Options) (err error) {
