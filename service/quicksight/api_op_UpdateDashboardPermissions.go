...
func (c *Client) UpdateDashboardPermissions(ctx context.Context, params *UpdateDashboardPermissionsInput, optFns ...func(*Options)) (*UpdateDashboardPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDashboardPermissions", params, optFns, addOperationUpdateDashboardPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDashboardPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
