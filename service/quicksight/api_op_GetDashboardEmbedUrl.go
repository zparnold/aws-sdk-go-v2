...
func (c *Client) GetDashboardEmbedUrl(ctx context.Context, params *GetDashboardEmbedUrlInput, optFns ...func(*Options)) (*GetDashboardEmbedUrlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDashboardEmbedUrl", params, optFns, addOperationGetDashboardEmbedUrlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDashboardEmbedUrlMiddleware(stack *middleware.Stack, options Options) (err error) {
