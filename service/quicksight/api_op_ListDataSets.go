...
func (c *Client) ListDataSets(ctx context.Context, params *ListDataSetsInput, optFns ...func(*Options)) (*ListDataSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDataSets", params, optFns, addOperationListDataSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDataSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
