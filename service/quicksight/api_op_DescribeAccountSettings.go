...
func (c *Client) DescribeAccountSettings(ctx context.Context, params *DescribeAccountSettingsInput, optFns ...func(*Options)) (*DescribeAccountSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccountSettings", params, optFns, addOperationDescribeAccountSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccountSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
