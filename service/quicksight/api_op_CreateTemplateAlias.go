...
func (c *Client) CreateTemplateAlias(ctx context.Context, params *CreateTemplateAliasInput, optFns ...func(*Options)) (*CreateTemplateAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTemplateAlias", params, optFns, addOperationCreateTemplateAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTemplateAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
