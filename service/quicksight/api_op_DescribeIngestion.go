...
func (c *Client) DescribeIngestion(ctx context.Context, params *DescribeIngestionInput, optFns ...func(*Options)) (*DescribeIngestionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIngestion", params, optFns, addOperationDescribeIngestionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIngestionMiddleware(stack *middleware.Stack, options Options) (err error) {
