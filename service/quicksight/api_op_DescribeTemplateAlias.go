...
func (c *Client) DescribeTemplateAlias(ctx context.Context, params *DescribeTemplateAliasInput, optFns ...func(*Options)) (*DescribeTemplateAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTemplateAlias", params, optFns, addOperationDescribeTemplateAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTemplateAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
