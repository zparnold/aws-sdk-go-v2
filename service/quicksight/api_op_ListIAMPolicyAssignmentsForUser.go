...
func (c *Client) ListIAMPolicyAssignmentsForUser(ctx context.Context, params *ListIAMPolicyAssignmentsForUserInput, optFns ...func(*Options)) (*ListIAMPolicyAssignmentsForUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIAMPolicyAssignmentsForUser", params, optFns, addOperationListIAMPolicyAssignmentsForUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIAMPolicyAssignmentsForUserMiddleware(stack *middleware.Stack, options Options) (err error) {
