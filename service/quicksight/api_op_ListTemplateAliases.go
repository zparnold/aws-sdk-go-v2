...
func (c *Client) ListTemplateAliases(ctx context.Context, params *ListTemplateAliasesInput, optFns ...func(*Options)) (*ListTemplateAliasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTemplateAliases", params, optFns, addOperationListTemplateAliasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTemplateAliasesMiddleware(stack *middleware.Stack, options Options) (err error) {
