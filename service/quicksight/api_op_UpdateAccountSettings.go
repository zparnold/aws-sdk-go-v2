...
func (c *Client) UpdateAccountSettings(ctx context.Context, params *UpdateAccountSettingsInput, optFns ...func(*Options)) (*UpdateAccountSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAccountSettings", params, optFns, addOperationUpdateAccountSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAccountSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
