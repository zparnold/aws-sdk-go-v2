...
func (c *Client) CreateThemeAlias(ctx context.Context, params *CreateThemeAliasInput, optFns ...func(*Options)) (*CreateThemeAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateThemeAlias", params, optFns, addOperationCreateThemeAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateThemeAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
