...
func (c *Client) UpdateDashboardPublishedVersion(ctx context.Context, params *UpdateDashboardPublishedVersionInput, optFns ...func(*Options)) (*UpdateDashboardPublishedVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDashboardPublishedVersion", params, optFns, addOperationUpdateDashboardPublishedVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDashboardPublishedVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
