...
func (c *Client) ListThemes(ctx context.Context, params *ListThemesInput, optFns ...func(*Options)) (*ListThemesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThemes", params, optFns, addOperationListThemesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThemesMiddleware(stack *middleware.Stack, options Options) (err error) {
