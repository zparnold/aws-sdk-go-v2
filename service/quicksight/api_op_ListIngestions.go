...
func (c *Client) ListIngestions(ctx context.Context, params *ListIngestionsInput, optFns ...func(*Options)) (*ListIngestionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIngestions", params, optFns, addOperationListIngestionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIngestionsMiddleware(stack *middleware.Stack, options Options) (err error) {
