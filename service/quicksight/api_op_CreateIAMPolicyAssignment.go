...
func (c *Client) CreateIAMPolicyAssignment(ctx context.Context, params *CreateIAMPolicyAssignmentInput, optFns ...func(*Options)) (*CreateIAMPolicyAssignmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIAMPolicyAssignment", params, optFns, addOperationCreateIAMPolicyAssignmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIAMPolicyAssignmentMiddleware(stack *middleware.Stack, options Options) (err error) {
