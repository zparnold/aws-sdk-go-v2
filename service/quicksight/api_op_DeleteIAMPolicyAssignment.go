...
func (c *Client) DeleteIAMPolicyAssignment(ctx context.Context, params *DeleteIAMPolicyAssignmentInput, optFns ...func(*Options)) (*DeleteIAMPolicyAssignmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIAMPolicyAssignment", params, optFns, addOperationDeleteIAMPolicyAssignmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIAMPolicyAssignmentMiddleware(stack *middleware.Stack, options Options) (err error) {
