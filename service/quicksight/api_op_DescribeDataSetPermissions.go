...
func (c *Client) DescribeDataSetPermissions(ctx context.Context, params *DescribeDataSetPermissionsInput, optFns ...func(*Options)) (*DescribeDataSetPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDataSetPermissions", params, optFns, addOperationDescribeDataSetPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDataSetPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
