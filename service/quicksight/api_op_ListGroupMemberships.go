...
func (c *Client) ListGroupMemberships(ctx context.Context, params *ListGroupMembershipsInput, optFns ...func(*Options)) (*ListGroupMembershipsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGroupMemberships", params, optFns, addOperationListGroupMembershipsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGroupMembershipsMiddleware(stack *middleware.Stack, options Options) (err error) {
