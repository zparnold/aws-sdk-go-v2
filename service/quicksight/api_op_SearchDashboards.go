...
func (c *Client) SearchDashboards(ctx context.Context, params *SearchDashboardsInput, optFns ...func(*Options)) (*SearchDashboardsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchDashboards", params, optFns, addOperationSearchDashboardsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchDashboardsMiddleware(stack *middleware.Stack, options Options) (err error) {
