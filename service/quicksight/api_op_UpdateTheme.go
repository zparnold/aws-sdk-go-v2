...
func (c *Client) UpdateTheme(ctx context.Context, params *UpdateThemeInput, optFns ...func(*Options)) (*UpdateThemeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTheme", params, optFns, addOperationUpdateThemeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThemeMiddleware(stack *middleware.Stack, options Options) (err error) {
