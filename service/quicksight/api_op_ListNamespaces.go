...
func (c *Client) ListNamespaces(ctx context.Context, params *ListNamespacesInput, optFns ...func(*Options)) (*ListNamespacesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNamespaces", params, optFns, addOperationListNamespacesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNamespacesMiddleware(stack *middleware.Stack, options Options) (err error) {
