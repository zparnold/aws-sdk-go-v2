...
func (c *Client) CreateIngestion(ctx context.Context, params *CreateIngestionInput, optFns ...func(*Options)) (*CreateIngestionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIngestion", params, optFns, addOperationCreateIngestionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIngestionMiddleware(stack *middleware.Stack, options Options) (err error) {
