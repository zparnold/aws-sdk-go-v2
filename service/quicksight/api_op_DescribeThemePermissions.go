...
func (c *Client) DescribeThemePermissions(ctx context.Context, params *DescribeThemePermissionsInput, optFns ...func(*Options)) (*DescribeThemePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeThemePermissions", params, optFns, addOperationDescribeThemePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeThemePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
