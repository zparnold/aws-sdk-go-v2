...
func (c *Client) UpdateIAMPolicyAssignment(ctx context.Context, params *UpdateIAMPolicyAssignmentInput, optFns ...func(*Options)) (*UpdateIAMPolicyAssignmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIAMPolicyAssignment", params, optFns, addOperationUpdateIAMPolicyAssignmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIAMPolicyAssignmentMiddleware(stack *middleware.Stack, options Options) (err error) {
