...
func (c *Client) ListIAMPolicyAssignments(ctx context.Context, params *ListIAMPolicyAssignmentsInput, optFns ...func(*Options)) (*ListIAMPolicyAssignmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIAMPolicyAssignments", params, optFns, addOperationListIAMPolicyAssignmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIAMPolicyAssignmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
