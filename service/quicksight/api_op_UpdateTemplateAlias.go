...
func (c *Client) UpdateTemplateAlias(ctx context.Context, params *UpdateTemplateAliasInput, optFns ...func(*Options)) (*UpdateTemplateAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTemplateAlias", params, optFns, addOperationUpdateTemplateAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTemplateAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
