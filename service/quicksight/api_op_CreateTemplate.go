...
func (c *Client) CreateTemplate(ctx context.Context, params *CreateTemplateInput, optFns ...func(*Options)) (*CreateTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTemplate", params, optFns, addOperationCreateTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
