...
func (c *Client) DeleteThemeAlias(ctx context.Context, params *DeleteThemeAliasInput, optFns ...func(*Options)) (*DeleteThemeAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteThemeAlias", params, optFns, addOperationDeleteThemeAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteThemeAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
