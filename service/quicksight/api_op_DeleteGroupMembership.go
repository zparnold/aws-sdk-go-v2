...
func (c *Client) DeleteGroupMembership(ctx context.Context, params *DeleteGroupMembershipInput, optFns ...func(*Options)) (*DeleteGroupMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGroupMembership", params, optFns, addOperationDeleteGroupMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGroupMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
