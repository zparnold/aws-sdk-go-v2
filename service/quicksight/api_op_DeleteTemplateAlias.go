...
func (c *Client) DeleteTemplateAlias(ctx context.Context, params *DeleteTemplateAliasInput, optFns ...func(*Options)) (*DeleteTemplateAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTemplateAlias", params, optFns, addOperationDeleteTemplateAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTemplateAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
