...
func (c *Client) ListDashboardVersions(ctx context.Context, params *ListDashboardVersionsInput, optFns ...func(*Options)) (*ListDashboardVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDashboardVersions", params, optFns, addOperationListDashboardVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDashboardVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
