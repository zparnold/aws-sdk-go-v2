...
func (c *Client) ListThemeAliases(ctx context.Context, params *ListThemeAliasesInput, optFns ...func(*Options)) (*ListThemeAliasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListThemeAliases", params, optFns, addOperationListThemeAliasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListThemeAliasesMiddleware(stack *middleware.Stack, options Options) (err error) {
