...
func (c *Client) DescribeTemplatePermissions(ctx context.Context, params *DescribeTemplatePermissionsInput, optFns ...func(*Options)) (*DescribeTemplatePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTemplatePermissions", params, optFns, addOperationDescribeTemplatePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTemplatePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
