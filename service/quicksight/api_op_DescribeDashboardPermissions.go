...
func (c *Client) DescribeDashboardPermissions(ctx context.Context, params *DescribeDashboardPermissionsInput, optFns ...func(*Options)) (*DescribeDashboardPermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDashboardPermissions", params, optFns, addOperationDescribeDashboardPermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDashboardPermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
