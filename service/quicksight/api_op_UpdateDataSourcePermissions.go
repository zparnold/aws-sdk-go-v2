...
func (c *Client) UpdateDataSourcePermissions(ctx context.Context, params *UpdateDataSourcePermissionsInput, optFns ...func(*Options)) (*UpdateDataSourcePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDataSourcePermissions", params, optFns, addOperationUpdateDataSourcePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDataSourcePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
