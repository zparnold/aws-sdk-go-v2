...
func (c *Client) UpdateTemplatePermissions(ctx context.Context, params *UpdateTemplatePermissionsInput, optFns ...func(*Options)) (*UpdateTemplatePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTemplatePermissions", params, optFns, addOperationUpdateTemplatePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTemplatePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
