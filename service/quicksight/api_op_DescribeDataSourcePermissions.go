...
func (c *Client) DescribeDataSourcePermissions(ctx context.Context, params *DescribeDataSourcePermissionsInput, optFns ...func(*Options)) (*DescribeDataSourcePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDataSourcePermissions", params, optFns, addOperationDescribeDataSourcePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDataSourcePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
