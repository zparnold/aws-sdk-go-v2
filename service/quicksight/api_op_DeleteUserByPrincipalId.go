...
func (c *Client) DeleteUserByPrincipalId(ctx context.Context, params *DeleteUserByPrincipalIdInput, optFns ...func(*Options)) (*DeleteUserByPrincipalIdOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserByPrincipalId", params, optFns, addOperationDeleteUserByPrincipalIdMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserByPrincipalIdMiddleware(stack *middleware.Stack, options Options) (err error) {
