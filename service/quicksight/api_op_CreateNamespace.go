...
func (c *Client) CreateNamespace(ctx context.Context, params *CreateNamespaceInput, optFns ...func(*Options)) (*CreateNamespaceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNamespace", params, optFns, addOperationCreateNamespaceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNamespaceMiddleware(stack *middleware.Stack, options Options) (err error) {
