...
func (c *Client) DescribeThemeAlias(ctx context.Context, params *DescribeThemeAliasInput, optFns ...func(*Options)) (*DescribeThemeAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeThemeAlias", params, optFns, addOperationDescribeThemeAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeThemeAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
