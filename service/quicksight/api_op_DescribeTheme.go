...
func (c *Client) DescribeTheme(ctx context.Context, params *DescribeThemeInput, optFns ...func(*Options)) (*DescribeThemeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTheme", params, optFns, addOperationDescribeThemeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeThemeMiddleware(stack *middleware.Stack, options Options) (err error) {
