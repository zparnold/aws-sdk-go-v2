...
func (c *Client) CreateDashboard(ctx context.Context, params *CreateDashboardInput, optFns ...func(*Options)) (*CreateDashboardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDashboard", params, optFns, addOperationCreateDashboardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDashboardMiddleware(stack *middleware.Stack, options Options) (err error) {
