...
func (c *Client) UpdateThemeAlias(ctx context.Context, params *UpdateThemeAliasInput, optFns ...func(*Options)) (*UpdateThemeAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateThemeAlias", params, optFns, addOperationUpdateThemeAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateThemeAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
