...
func (c *Client) DeleteAccountCustomization(ctx context.Context, params *DeleteAccountCustomizationInput, optFns ...func(*Options)) (*DeleteAccountCustomizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAccountCustomization", params, optFns, addOperationDeleteAccountCustomizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAccountCustomizationMiddleware(stack *middleware.Stack, options Options) (err error) {
