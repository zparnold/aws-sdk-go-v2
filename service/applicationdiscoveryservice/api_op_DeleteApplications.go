...
func (c *Client) DeleteApplications(ctx context.Context, params *DeleteApplicationsInput, optFns ...func(*Options)) (*DeleteApplicationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApplications", params, optFns, addOperationDeleteApplicationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApplicationsMiddleware(stack *middleware.Stack, options Options) (err error) {
