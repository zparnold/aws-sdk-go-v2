...
func (c *Client) ListServerNeighbors(ctx context.Context, params *ListServerNeighborsInput, optFns ...func(*Options)) (*ListServerNeighborsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServerNeighbors", params, optFns, addOperationListServerNeighborsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServerNeighborsMiddleware(stack *middleware.Stack, options Options) (err error) {
