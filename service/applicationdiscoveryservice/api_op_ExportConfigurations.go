...
func (c *Client) ExportConfigurations(ctx context.Context, params *ExportConfigurationsInput, optFns ...func(*Options)) (*ExportConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportConfigurations", params, optFns, addOperationExportConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
