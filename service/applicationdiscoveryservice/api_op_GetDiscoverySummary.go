...
func (c *Client) GetDiscoverySummary(ctx context.Context, params *GetDiscoverySummaryInput, optFns ...func(*Options)) (*GetDiscoverySummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDiscoverySummary", params, optFns, addOperationGetDiscoverySummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDiscoverySummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
