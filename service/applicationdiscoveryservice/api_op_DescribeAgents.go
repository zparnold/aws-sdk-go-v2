...
func (c *Client) DescribeAgents(ctx context.Context, params *DescribeAgentsInput, optFns ...func(*Options)) (*DescribeAgentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAgents", params, optFns, addOperationDescribeAgentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAgentsMiddleware(stack *middleware.Stack, options Options) (err error) {
