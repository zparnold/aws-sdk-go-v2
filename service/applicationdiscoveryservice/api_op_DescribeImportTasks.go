...
func (c *Client) DescribeImportTasks(ctx context.Context, params *DescribeImportTasksInput, optFns ...func(*Options)) (*DescribeImportTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeImportTasks", params, optFns, addOperationDescribeImportTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeImportTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
