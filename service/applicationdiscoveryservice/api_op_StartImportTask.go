...
func (c *Client) StartImportTask(ctx context.Context, params *StartImportTaskInput, optFns ...func(*Options)) (*StartImportTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartImportTask", params, optFns, addOperationStartImportTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartImportTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
