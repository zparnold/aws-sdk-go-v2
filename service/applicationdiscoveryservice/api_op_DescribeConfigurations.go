...
func (c *Client) DescribeConfigurations(ctx context.Context, params *DescribeConfigurationsInput, optFns ...func(*Options)) (*DescribeConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurations", params, optFns, addOperationDescribeConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
