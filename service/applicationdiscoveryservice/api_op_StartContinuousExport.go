...
func (c *Client) StartContinuousExport(ctx context.Context, params *StartContinuousExportInput, optFns ...func(*Options)) (*StartContinuousExportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartContinuousExport", params, optFns, addOperationStartContinuousExportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartContinuousExportMiddleware(stack *middleware.Stack, options Options) (err error) {
