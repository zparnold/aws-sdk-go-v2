...
func (c *Client) StartExportTask(ctx context.Context, params *StartExportTaskInput, optFns ...func(*Options)) (*StartExportTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartExportTask", params, optFns, addOperationStartExportTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartExportTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
