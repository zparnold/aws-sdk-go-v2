...
func (c *Client) StopDataCollectionByAgentIds(ctx context.Context, params *StopDataCollectionByAgentIdsInput, optFns ...func(*Options)) (*StopDataCollectionByAgentIdsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopDataCollectionByAgentIds", params, optFns, addOperationStopDataCollectionByAgentIdsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopDataCollectionByAgentIdsMiddleware(stack *middleware.Stack, options Options) (err error) {
