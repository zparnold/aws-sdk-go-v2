...
func (c *Client) BatchDeleteImportData(ctx context.Context, params *BatchDeleteImportDataInput, optFns ...func(*Options)) (*BatchDeleteImportDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeleteImportData", params, optFns, addOperationBatchDeleteImportDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeleteImportDataMiddleware(stack *middleware.Stack, options Options) (err error) {
