...
func (c *Client) DescribeContinuousExports(ctx context.Context, params *DescribeContinuousExportsInput, optFns ...func(*Options)) (*DescribeContinuousExportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeContinuousExports", params, optFns, addOperationDescribeContinuousExportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeContinuousExportsMiddleware(stack *middleware.Stack, options Options) (err error) {
