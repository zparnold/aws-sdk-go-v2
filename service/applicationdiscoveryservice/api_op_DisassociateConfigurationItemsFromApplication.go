...
func (c *Client) DisassociateConfigurationItemsFromApplication(ctx context.Context, params *DisassociateConfigurationItemsFromApplicationInput, optFns ...func(*Options)) (*DisassociateConfigurationItemsFromApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateConfigurationItemsFromApplication", params, optFns, addOperationDisassociateConfigurationItemsFromApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateConfigurationItemsFromApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
