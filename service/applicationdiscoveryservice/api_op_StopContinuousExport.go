...
func (c *Client) StopContinuousExport(ctx context.Context, params *StopContinuousExportInput, optFns ...func(*Options)) (*StopContinuousExportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopContinuousExport", params, optFns, addOperationStopContinuousExportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopContinuousExportMiddleware(stack *middleware.Stack, options Options) (err error) {
