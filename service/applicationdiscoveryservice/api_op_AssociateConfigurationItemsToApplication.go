...
func (c *Client) AssociateConfigurationItemsToApplication(ctx context.Context, params *AssociateConfigurationItemsToApplicationInput, optFns ...func(*Options)) (*AssociateConfigurationItemsToApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateConfigurationItemsToApplication", params, optFns, addOperationAssociateConfigurationItemsToApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateConfigurationItemsToApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
