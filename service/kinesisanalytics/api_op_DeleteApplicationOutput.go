...
func (c *Client) DeleteApplicationOutput(ctx context.Context, params *DeleteApplicationOutputInput, optFns ...func(*Options)) (*DeleteApplicationOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApplicationOutput", params, optFns, addOperationDeleteApplicationOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApplicationOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
