...
func (c *Client) DeleteApplicationReferenceDataSource(ctx context.Context, params *DeleteApplicationReferenceDataSourceInput, optFns ...func(*Options)) (*DeleteApplicationReferenceDataSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApplicationReferenceDataSource", params, optFns, addOperationDeleteApplicationReferenceDataSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApplicationReferenceDataSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
