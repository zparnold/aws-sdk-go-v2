...
func (c *Client) AddApplicationInput(ctx context.Context, params *AddApplicationInputInput, optFns ...func(*Options)) (*AddApplicationInputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddApplicationInput", params, optFns, addOperationAddApplicationInputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddApplicationInputMiddleware(stack *middleware.Stack, options Options) (err error) {
