...
func (c *Client) StopApplication(ctx context.Context, params *StopApplicationInput, optFns ...func(*Options)) (*StopApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopApplication", params, optFns, addOperationStopApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
