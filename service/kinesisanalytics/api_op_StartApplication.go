...
func (c *Client) StartApplication(ctx context.Context, params *StartApplicationInput, optFns ...func(*Options)) (*StartApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartApplication", params, optFns, addOperationStartApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
