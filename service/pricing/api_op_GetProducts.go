...
func (c *Client) GetProducts(ctx context.Context, params *GetProductsInput, optFns ...func(*Options)) (*GetProductsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetProducts", params, optFns, addOperationGetProductsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetProductsMiddleware(stack *middleware.Stack, options Options) (err error) {
