...
func (c *Client) StopStreamEncryption(ctx context.Context, params *StopStreamEncryptionInput, optFns ...func(*Options)) (*StopStreamEncryptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopStreamEncryption", params, optFns, addOperationStopStreamEncryptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopStreamEncryptionMiddleware(stack *middleware.Stack, options Options) (err error) {
