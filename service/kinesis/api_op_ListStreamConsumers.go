...
func (c *Client) ListStreamConsumers(ctx context.Context, params *ListStreamConsumersInput, optFns ...func(*Options)) (*ListStreamConsumersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListStreamConsumers", params, optFns, addOperationListStreamConsumersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListStreamConsumersMiddleware(stack *middleware.Stack, options Options) (err error) {
