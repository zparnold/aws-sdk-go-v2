...
func (c *Client) UpdateShardCount(ctx context.Context, params *UpdateShardCountInput, optFns ...func(*Options)) (*UpdateShardCountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateShardCount", params, optFns, addOperationUpdateShardCountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateShardCountMiddleware(stack *middleware.Stack, options Options) (err error) {
