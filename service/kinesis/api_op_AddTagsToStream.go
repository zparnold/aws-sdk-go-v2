...
func (c *Client) AddTagsToStream(ctx context.Context, params *AddTagsToStreamInput, optFns ...func(*Options)) (*AddTagsToStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddTagsToStream", params, optFns, addOperationAddTagsToStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddTagsToStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
