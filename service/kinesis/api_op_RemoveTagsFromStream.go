...
func (c *Client) RemoveTagsFromStream(ctx context.Context, params *RemoveTagsFromStreamInput, optFns ...func(*Options)) (*RemoveTagsFromStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveTagsFromStream", params, optFns, addOperationRemoveTagsFromStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveTagsFromStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
