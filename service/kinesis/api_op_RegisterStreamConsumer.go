...
func (c *Client) RegisterStreamConsumer(ctx context.Context, params *RegisterStreamConsumerInput, optFns ...func(*Options)) (*RegisterStreamConsumerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterStreamConsumer", params, optFns, addOperationRegisterStreamConsumerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterStreamConsumerMiddleware(stack *middleware.Stack, options Options) (err error) {
