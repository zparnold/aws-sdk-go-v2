...
func (c *Client) DeregisterStreamConsumer(ctx context.Context, params *DeregisterStreamConsumerInput, optFns ...func(*Options)) (*DeregisterStreamConsumerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterStreamConsumer", params, optFns, addOperationDeregisterStreamConsumerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterStreamConsumerMiddleware(stack *middleware.Stack, options Options) (err error) {
