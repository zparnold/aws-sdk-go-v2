...
func (c *Client) CreateStream(ctx context.Context, params *CreateStreamInput, optFns ...func(*Options)) (*CreateStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStream", params, optFns, addOperationCreateStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
