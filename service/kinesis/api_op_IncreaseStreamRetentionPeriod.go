...
func (c *Client) IncreaseStreamRetentionPeriod(ctx context.Context, params *IncreaseStreamRetentionPeriodInput, optFns ...func(*Options)) (*IncreaseStreamRetentionPeriodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "IncreaseStreamRetentionPeriod", params, optFns, addOperationIncreaseStreamRetentionPeriodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationIncreaseStreamRetentionPeriodMiddleware(stack *middleware.Stack, options Options) (err error) {
