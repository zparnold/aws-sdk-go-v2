...
func (c *Client) DisableEnhancedMonitoring(ctx context.Context, params *DisableEnhancedMonitoringInput, optFns ...func(*Options)) (*DisableEnhancedMonitoringOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableEnhancedMonitoring", params, optFns, addOperationDisableEnhancedMonitoringMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableEnhancedMonitoringMiddleware(stack *middleware.Stack, options Options) (err error) {
