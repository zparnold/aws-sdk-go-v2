...
func (c *Client) GetShardIterator(ctx context.Context, params *GetShardIteratorInput, optFns ...func(*Options)) (*GetShardIteratorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetShardIterator", params, optFns, addOperationGetShardIteratorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetShardIteratorMiddleware(stack *middleware.Stack, options Options) (err error) {
