...
func (c *Client) DeleteStream(ctx context.Context, params *DeleteStreamInput, optFns ...func(*Options)) (*DeleteStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStream", params, optFns, addOperationDeleteStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
