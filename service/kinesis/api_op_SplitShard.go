...
func (c *Client) SplitShard(ctx context.Context, params *SplitShardInput, optFns ...func(*Options)) (*SplitShardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SplitShard", params, optFns, addOperationSplitShardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSplitShardMiddleware(stack *middleware.Stack, options Options) (err error) {
