...
func (c *Client) SubscribeToShard(ctx context.Context, params *SubscribeToShardInput, optFns ...func(*Options)) (*SubscribeToShardOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubscribeToShard", params, optFns, addOperationSubscribeToShardMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubscribeToShardMiddleware(stack *middleware.Stack, options Options) (err error) {
