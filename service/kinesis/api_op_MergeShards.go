...
func (c *Client) MergeShards(ctx context.Context, params *MergeShardsInput, optFns ...func(*Options)) (*MergeShardsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "MergeShards", params, optFns, addOperationMergeShardsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationMergeShardsMiddleware(stack *middleware.Stack, options Options) (err error) {
