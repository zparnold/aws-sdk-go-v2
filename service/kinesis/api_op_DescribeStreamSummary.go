...
func (c *Client) DescribeStreamSummary(ctx context.Context, params *DescribeStreamSummaryInput, optFns ...func(*Options)) (*DescribeStreamSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStreamSummary", params, optFns, addOperationDescribeStreamSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStreamSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
