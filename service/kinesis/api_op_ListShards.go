...
func (c *Client) ListShards(ctx context.Context, params *ListShardsInput, optFns ...func(*Options)) (*ListShardsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListShards", params, optFns, addOperationListShardsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListShardsMiddleware(stack *middleware.Stack, options Options) (err error) {
