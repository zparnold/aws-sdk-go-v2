...
func (c *Client) DescribeStreamConsumer(ctx context.Context, params *DescribeStreamConsumerInput, optFns ...func(*Options)) (*DescribeStreamConsumerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeStreamConsumer", params, optFns, addOperationDescribeStreamConsumerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeStreamConsumerMiddleware(stack *middleware.Stack, options Options) (err error) {
