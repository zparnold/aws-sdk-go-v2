...
func (c *Client) EnableEnhancedMonitoring(ctx context.Context, params *EnableEnhancedMonitoringInput, optFns ...func(*Options)) (*EnableEnhancedMonitoringOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableEnhancedMonitoring", params, optFns, addOperationEnableEnhancedMonitoringMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableEnhancedMonitoringMiddleware(stack *middleware.Stack, options Options) (err error) {
