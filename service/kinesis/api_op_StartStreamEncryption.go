...
func (c *Client) StartStreamEncryption(ctx context.Context, params *StartStreamEncryptionInput, optFns ...func(*Options)) (*StartStreamEncryptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartStreamEncryption", params, optFns, addOperationStartStreamEncryptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartStreamEncryptionMiddleware(stack *middleware.Stack, options Options) (err error) {
