...
func (c *Client) DecreaseStreamRetentionPeriod(ctx context.Context, params *DecreaseStreamRetentionPeriodInput, optFns ...func(*Options)) (*DecreaseStreamRetentionPeriodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DecreaseStreamRetentionPeriod", params, optFns, addOperationDecreaseStreamRetentionPeriodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDecreaseStreamRetentionPeriodMiddleware(stack *middleware.Stack, options Options) (err error) {
