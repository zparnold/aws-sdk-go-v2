...
func (c *Client) PutRecords(ctx context.Context, params *PutRecordsInput, optFns ...func(*Options)) (*PutRecordsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRecords", params, optFns, addOperationPutRecordsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRecordsMiddleware(stack *middleware.Stack, options Options) (err error) {
