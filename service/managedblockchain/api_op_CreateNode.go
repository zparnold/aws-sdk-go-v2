...
func (c *Client) CreateNode(ctx context.Context, params *CreateNodeInput, optFns ...func(*Options)) (*CreateNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNode", params, optFns, addOperationCreateNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
