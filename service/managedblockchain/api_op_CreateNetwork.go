...
func (c *Client) CreateNetwork(ctx context.Context, params *CreateNetworkInput, optFns ...func(*Options)) (*CreateNetworkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNetwork", params, optFns, addOperationCreateNetworkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNetworkMiddleware(stack *middleware.Stack, options Options) (err error) {
