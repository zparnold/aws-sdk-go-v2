...
func (c *Client) RejectInvitation(ctx context.Context, params *RejectInvitationInput, optFns ...func(*Options)) (*RejectInvitationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectInvitation", params, optFns, addOperationRejectInvitationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectInvitationMiddleware(stack *middleware.Stack, options Options) (err error) {
