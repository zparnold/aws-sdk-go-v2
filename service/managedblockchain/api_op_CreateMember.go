...
func (c *Client) CreateMember(ctx context.Context, params *CreateMemberInput, optFns ...func(*Options)) (*CreateMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMember", params, optFns, addOperationCreateMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
