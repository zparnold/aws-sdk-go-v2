...
func (c *Client) DeleteNode(ctx context.Context, params *DeleteNodeInput, optFns ...func(*Options)) (*DeleteNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNode", params, optFns, addOperationDeleteNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
