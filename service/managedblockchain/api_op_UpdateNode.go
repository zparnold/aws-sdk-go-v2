...
func (c *Client) UpdateNode(ctx context.Context, params *UpdateNodeInput, optFns ...func(*Options)) (*UpdateNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNode", params, optFns, addOperationUpdateNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
