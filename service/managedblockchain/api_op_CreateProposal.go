...
func (c *Client) CreateProposal(ctx context.Context, params *CreateProposalInput, optFns ...func(*Options)) (*CreateProposalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProposal", params, optFns, addOperationCreateProposalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProposalMiddleware(stack *middleware.Stack, options Options) (err error) {
