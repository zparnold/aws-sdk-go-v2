...
func (c *Client) ListNetworks(ctx context.Context, params *ListNetworksInput, optFns ...func(*Options)) (*ListNetworksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListNetworks", params, optFns, addOperationListNetworksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListNetworksMiddleware(stack *middleware.Stack, options Options) (err error) {
