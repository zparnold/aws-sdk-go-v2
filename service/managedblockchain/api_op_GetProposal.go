...
func (c *Client) GetProposal(ctx context.Context, params *GetProposalInput, optFns ...func(*Options)) (*GetProposalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetProposal", params, optFns, addOperationGetProposalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetProposalMiddleware(stack *middleware.Stack, options Options) (err error) {
