...
func (c *Client) GetNode(ctx context.Context, params *GetNodeInput, optFns ...func(*Options)) (*GetNodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetNode", params, optFns, addOperationGetNodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetNodeMiddleware(stack *middleware.Stack, options Options) (err error) {
