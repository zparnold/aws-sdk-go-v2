...
func (c *Client) ListProposalVotes(ctx context.Context, params *ListProposalVotesInput, optFns ...func(*Options)) (*ListProposalVotesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProposalVotes", params, optFns, addOperationListProposalVotesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProposalVotesMiddleware(stack *middleware.Stack, options Options) (err error) {
