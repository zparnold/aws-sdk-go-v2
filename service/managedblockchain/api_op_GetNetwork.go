...
func (c *Client) GetNetwork(ctx context.Context, params *GetNetworkInput, optFns ...func(*Options)) (*GetNetworkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetNetwork", params, optFns, addOperationGetNetworkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetNetworkMiddleware(stack *middleware.Stack, options Options) (err error) {
