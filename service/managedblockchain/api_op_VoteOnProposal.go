...
func (c *Client) VoteOnProposal(ctx context.Context, params *VoteOnProposalInput, optFns ...func(*Options)) (*VoteOnProposalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "VoteOnProposal", params, optFns, addOperationVoteOnProposalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationVoteOnProposalMiddleware(stack *middleware.Stack, options Options) (err error) {
