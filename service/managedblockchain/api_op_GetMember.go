...
func (c *Client) GetMember(ctx context.Context, params *GetMemberInput, optFns ...func(*Options)) (*GetMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMember", params, optFns, addOperationGetMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
