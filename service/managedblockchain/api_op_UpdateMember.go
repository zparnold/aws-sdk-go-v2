...
func (c *Client) UpdateMember(ctx context.Context, params *UpdateMemberInput, optFns ...func(*Options)) (*UpdateMemberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMember", params, optFns, addOperationUpdateMemberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMemberMiddleware(stack *middleware.Stack, options Options) (err error) {
