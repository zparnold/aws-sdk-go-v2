...
func (c *Client) ListQueueTags(ctx context.Context, params *ListQueueTagsInput, optFns ...func(*Options)) (*ListQueueTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListQueueTags", params, optFns, addOperationListQueueTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListQueueTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
