...
func (c *Client) ChangeMessageVisibilityBatch(ctx context.Context, params *ChangeMessageVisibilityBatchInput, optFns ...func(*Options)) (*ChangeMessageVisibilityBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ChangeMessageVisibilityBatch", params, optFns, addOperationChangeMessageVisibilityBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationChangeMessageVisibilityBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
