...
func (c *Client) GetQueueAttributes(ctx context.Context, params *GetQueueAttributesInput, optFns ...func(*Options)) (*GetQueueAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQueueAttributes", params, optFns, addOperationGetQueueAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQueueAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
