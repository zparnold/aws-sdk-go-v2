...
func (c *Client) TagQueue(ctx context.Context, params *TagQueueInput, optFns ...func(*Options)) (*TagQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagQueue", params, optFns, addOperationTagQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
