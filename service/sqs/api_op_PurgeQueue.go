...
func (c *Client) PurgeQueue(ctx context.Context, params *PurgeQueueInput, optFns ...func(*Options)) (*PurgeQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurgeQueue", params, optFns, addOperationPurgeQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurgeQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
