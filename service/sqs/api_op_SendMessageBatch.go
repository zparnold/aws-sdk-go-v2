...
func (c *Client) SendMessageBatch(ctx context.Context, params *SendMessageBatchInput, optFns ...func(*Options)) (*SendMessageBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendMessageBatch", params, optFns, addOperationSendMessageBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendMessageBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
