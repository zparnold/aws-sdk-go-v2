...
func (c *Client) SetQueueAttributes(ctx context.Context, params *SetQueueAttributesInput, optFns ...func(*Options)) (*SetQueueAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetQueueAttributes", params, optFns, addOperationSetQueueAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetQueueAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
