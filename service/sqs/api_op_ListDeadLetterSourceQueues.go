...
func (c *Client) ListDeadLetterSourceQueues(ctx context.Context, params *ListDeadLetterSourceQueuesInput, optFns ...func(*Options)) (*ListDeadLetterSourceQueuesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeadLetterSourceQueues", params, optFns, addOperationListDeadLetterSourceQueuesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeadLetterSourceQueuesMiddleware(stack *middleware.Stack, options Options) (err error) {
