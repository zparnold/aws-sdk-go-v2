...
func (c *Client) SendMessage(ctx context.Context, params *SendMessageInput, optFns ...func(*Options)) (*SendMessageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendMessage", params, optFns, addOperationSendMessageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendMessageMiddleware(stack *middleware.Stack, options Options) (err error) {
