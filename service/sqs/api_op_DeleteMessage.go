...
func (c *Client) DeleteMessage(ctx context.Context, params *DeleteMessageInput, optFns ...func(*Options)) (*DeleteMessageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMessage", params, optFns, addOperationDeleteMessageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMessageMiddleware(stack *middleware.Stack, options Options) (err error) {
