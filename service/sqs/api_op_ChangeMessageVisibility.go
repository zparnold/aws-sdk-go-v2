...
func (c *Client) ChangeMessageVisibility(ctx context.Context, params *ChangeMessageVisibilityInput, optFns ...func(*Options)) (*ChangeMessageVisibilityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ChangeMessageVisibility", params, optFns, addOperationChangeMessageVisibilityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationChangeMessageVisibilityMiddleware(stack *middleware.Stack, options Options) (err error) {
