...
func (c *Client) UntagQueue(ctx context.Context, params *UntagQueueInput, optFns ...func(*Options)) (*UntagQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagQueue", params, optFns, addOperationUntagQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
