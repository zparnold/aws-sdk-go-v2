...
func (c *Client) ReceiveMessage(ctx context.Context, params *ReceiveMessageInput, optFns ...func(*Options)) (*ReceiveMessageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReceiveMessage", params, optFns, addOperationReceiveMessageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReceiveMessageMiddleware(stack *middleware.Stack, options Options) (err error) {
