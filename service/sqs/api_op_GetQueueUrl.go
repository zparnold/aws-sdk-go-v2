...
func (c *Client) GetQueueUrl(ctx context.Context, params *GetQueueUrlInput, optFns ...func(*Options)) (*GetQueueUrlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetQueueUrl", params, optFns, addOperationGetQueueUrlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetQueueUrlMiddleware(stack *middleware.Stack, options Options) (err error) {
