...
func (c *Client) CreateQueue(ctx context.Context, params *CreateQueueInput, optFns ...func(*Options)) (*CreateQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateQueue", params, optFns, addOperationCreateQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
