...
func (c *Client) DeleteMessageBatch(ctx context.Context, params *DeleteMessageBatchInput, optFns ...func(*Options)) (*DeleteMessageBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMessageBatch", params, optFns, addOperationDeleteMessageBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMessageBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
