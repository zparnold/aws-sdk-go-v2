...
func (c *Client) GetPersonalizedRanking(ctx context.Context, params *GetPersonalizedRankingInput, optFns ...func(*Options)) (*GetPersonalizedRankingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPersonalizedRanking", params, optFns, addOperationGetPersonalizedRankingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPersonalizedRankingMiddleware(stack *middleware.Stack, options Options) (err error) {
