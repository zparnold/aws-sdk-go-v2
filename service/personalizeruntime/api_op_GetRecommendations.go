...
func (c *Client) GetRecommendations(ctx context.Context, params *GetRecommendationsInput, optFns ...func(*Options)) (*GetRecommendationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRecommendations", params, optFns, addOperationGetRecommendationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRecommendationsMiddleware(stack *middleware.Stack, options Options) (err error) {
