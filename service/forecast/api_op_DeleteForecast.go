...
func (c *Client) DeleteForecast(ctx context.Context, params *DeleteForecastInput, optFns ...func(*Options)) (*DeleteForecastOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteForecast", params, optFns, addOperationDeleteForecastMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteForecastMiddleware(stack *middleware.Stack, options Options) (err error) {
