...
func (c *Client) ListForecasts(ctx context.Context, params *ListForecastsInput, optFns ...func(*Options)) (*ListForecastsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListForecasts", params, optFns, addOperationListForecastsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListForecastsMiddleware(stack *middleware.Stack, options Options) (err error) {
