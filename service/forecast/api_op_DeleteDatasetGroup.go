...
func (c *Client) DeleteDatasetGroup(ctx context.Context, params *DeleteDatasetGroupInput, optFns ...func(*Options)) (*DeleteDatasetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDatasetGroup", params, optFns, addOperationDeleteDatasetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDatasetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
