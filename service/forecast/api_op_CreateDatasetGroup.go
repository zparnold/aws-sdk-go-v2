...
func (c *Client) CreateDatasetGroup(ctx context.Context, params *CreateDatasetGroupInput, optFns ...func(*Options)) (*CreateDatasetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDatasetGroup", params, optFns, addOperationCreateDatasetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDatasetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
