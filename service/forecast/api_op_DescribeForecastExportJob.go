...
func (c *Client) DescribeForecastExportJob(ctx context.Context, params *DescribeForecastExportJobInput, optFns ...func(*Options)) (*DescribeForecastExportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeForecastExportJob", params, optFns, addOperationDescribeForecastExportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeForecastExportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
