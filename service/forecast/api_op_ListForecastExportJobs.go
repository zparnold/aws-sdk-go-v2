...
func (c *Client) ListForecastExportJobs(ctx context.Context, params *ListForecastExportJobsInput, optFns ...func(*Options)) (*ListForecastExportJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListForecastExportJobs", params, optFns, addOperationListForecastExportJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListForecastExportJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
