...
func (c *Client) DescribePredictor(ctx context.Context, params *DescribePredictorInput, optFns ...func(*Options)) (*DescribePredictorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePredictor", params, optFns, addOperationDescribePredictorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePredictorMiddleware(stack *middleware.Stack, options Options) (err error) {
