...
func (c *Client) ListDatasetImportJobs(ctx context.Context, params *ListDatasetImportJobsInput, optFns ...func(*Options)) (*ListDatasetImportJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDatasetImportJobs", params, optFns, addOperationListDatasetImportJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDatasetImportJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
