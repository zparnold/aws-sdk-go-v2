...
func (c *Client) ListPredictors(ctx context.Context, params *ListPredictorsInput, optFns ...func(*Options)) (*ListPredictorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPredictors", params, optFns, addOperationListPredictorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPredictorsMiddleware(stack *middleware.Stack, options Options) (err error) {
