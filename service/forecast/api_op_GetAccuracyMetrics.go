...
func (c *Client) GetAccuracyMetrics(ctx context.Context, params *GetAccuracyMetricsInput, optFns ...func(*Options)) (*GetAccuracyMetricsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccuracyMetrics", params, optFns, addOperationGetAccuracyMetricsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccuracyMetricsMiddleware(stack *middleware.Stack, options Options) (err error) {
