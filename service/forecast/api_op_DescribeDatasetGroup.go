...
func (c *Client) DescribeDatasetGroup(ctx context.Context, params *DescribeDatasetGroupInput, optFns ...func(*Options)) (*DescribeDatasetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDatasetGroup", params, optFns, addOperationDescribeDatasetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDatasetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
