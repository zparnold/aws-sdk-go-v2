...
func (c *Client) DescribeForecast(ctx context.Context, params *DescribeForecastInput, optFns ...func(*Options)) (*DescribeForecastOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeForecast", params, optFns, addOperationDescribeForecastMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeForecastMiddleware(stack *middleware.Stack, options Options) (err error) {
