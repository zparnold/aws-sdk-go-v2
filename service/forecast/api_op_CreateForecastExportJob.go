...
func (c *Client) CreateForecastExportJob(ctx context.Context, params *CreateForecastExportJobInput, optFns ...func(*Options)) (*CreateForecastExportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateForecastExportJob", params, optFns, addOperationCreateForecastExportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateForecastExportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
