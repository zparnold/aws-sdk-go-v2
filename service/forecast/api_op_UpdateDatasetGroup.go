...
func (c *Client) UpdateDatasetGroup(ctx context.Context, params *UpdateDatasetGroupInput, optFns ...func(*Options)) (*UpdateDatasetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDatasetGroup", params, optFns, addOperationUpdateDatasetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDatasetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
