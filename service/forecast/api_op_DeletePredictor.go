...
func (c *Client) DeletePredictor(ctx context.Context, params *DeletePredictorInput, optFns ...func(*Options)) (*DeletePredictorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePredictor", params, optFns, addOperationDeletePredictorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePredictorMiddleware(stack *middleware.Stack, options Options) (err error) {
