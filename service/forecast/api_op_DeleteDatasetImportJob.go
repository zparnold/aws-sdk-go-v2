...
func (c *Client) DeleteDatasetImportJob(ctx context.Context, params *DeleteDatasetImportJobInput, optFns ...func(*Options)) (*DeleteDatasetImportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDatasetImportJob", params, optFns, addOperationDeleteDatasetImportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDatasetImportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
