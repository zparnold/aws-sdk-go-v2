...
func (c *Client) CreatePredictor(ctx context.Context, params *CreatePredictorInput, optFns ...func(*Options)) (*CreatePredictorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePredictor", params, optFns, addOperationCreatePredictorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePredictorMiddleware(stack *middleware.Stack, options Options) (err error) {
