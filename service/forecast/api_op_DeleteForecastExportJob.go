...
func (c *Client) DeleteForecastExportJob(ctx context.Context, params *DeleteForecastExportJobInput, optFns ...func(*Options)) (*DeleteForecastExportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteForecastExportJob", params, optFns, addOperationDeleteForecastExportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteForecastExportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
