...
func (c *Client) CancelCluster(ctx context.Context, params *CancelClusterInput, optFns ...func(*Options)) (*CancelClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelCluster", params, optFns, addOperationCancelClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
