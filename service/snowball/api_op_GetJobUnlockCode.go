...
func (c *Client) GetJobUnlockCode(ctx context.Context, params *GetJobUnlockCodeInput, optFns ...func(*Options)) (*GetJobUnlockCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobUnlockCode", params, optFns, addOperationGetJobUnlockCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobUnlockCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
