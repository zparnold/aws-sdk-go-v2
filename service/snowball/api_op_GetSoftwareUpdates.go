...
func (c *Client) GetSoftwareUpdates(ctx context.Context, params *GetSoftwareUpdatesInput, optFns ...func(*Options)) (*GetSoftwareUpdatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSoftwareUpdates", params, optFns, addOperationGetSoftwareUpdatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSoftwareUpdatesMiddleware(stack *middleware.Stack, options Options) (err error) {
