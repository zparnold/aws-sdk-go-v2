...
func (c *Client) ListClusterJobs(ctx context.Context, params *ListClusterJobsInput, optFns ...func(*Options)) (*ListClusterJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListClusterJobs", params, optFns, addOperationListClusterJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListClusterJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
