...
func (c *Client) GetSnowballUsage(ctx context.Context, params *GetSnowballUsageInput, optFns ...func(*Options)) (*GetSnowballUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSnowballUsage", params, optFns, addOperationGetSnowballUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSnowballUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
