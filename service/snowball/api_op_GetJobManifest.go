...
func (c *Client) GetJobManifest(ctx context.Context, params *GetJobManifestInput, optFns ...func(*Options)) (*GetJobManifestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobManifest", params, optFns, addOperationGetJobManifestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobManifestMiddleware(stack *middleware.Stack, options Options) (err error) {
