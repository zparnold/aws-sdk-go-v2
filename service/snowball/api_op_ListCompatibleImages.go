...
func (c *Client) ListCompatibleImages(ctx context.Context, params *ListCompatibleImagesInput, optFns ...func(*Options)) (*ListCompatibleImagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCompatibleImages", params, optFns, addOperationListCompatibleImagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCompatibleImagesMiddleware(stack *middleware.Stack, options Options) (err error) {
