...
func (c *Client) CreateAddress(ctx context.Context, params *CreateAddressInput, optFns ...func(*Options)) (*CreateAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAddress", params, optFns, addOperationCreateAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
