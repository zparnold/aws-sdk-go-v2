...
func (c *Client) DescribeAddress(ctx context.Context, params *DescribeAddressInput, optFns ...func(*Options)) (*DescribeAddressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAddress", params, optFns, addOperationDescribeAddressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAddressMiddleware(stack *middleware.Stack, options Options) (err error) {
