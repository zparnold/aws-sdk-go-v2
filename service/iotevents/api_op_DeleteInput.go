...
func (c *Client) DeleteInput(ctx context.Context, params *DeleteInputInput, optFns ...func(*Options)) (*DeleteInputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInput", params, optFns, addOperationDeleteInputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInputMiddleware(stack *middleware.Stack, options Options) (err error) {
