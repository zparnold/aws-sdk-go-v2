...
func (c *Client) ListDetectorModelVersions(ctx context.Context, params *ListDetectorModelVersionsInput, optFns ...func(*Options)) (*ListDetectorModelVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDetectorModelVersions", params, optFns, addOperationListDetectorModelVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDetectorModelVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
