...
func (c *Client) DeleteDetectorModel(ctx context.Context, params *DeleteDetectorModelInput, optFns ...func(*Options)) (*DeleteDetectorModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDetectorModel", params, optFns, addOperationDeleteDetectorModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDetectorModelMiddleware(stack *middleware.Stack, options Options) (err error) {
