...
func (c *Client) DescribeInput(ctx context.Context, params *DescribeInputInput, optFns ...func(*Options)) (*DescribeInputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInput", params, optFns, addOperationDescribeInputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInputMiddleware(stack *middleware.Stack, options Options) (err error) {
