...
func (c *Client) UpdateInput(ctx context.Context, params *UpdateInputInput, optFns ...func(*Options)) (*UpdateInputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateInput", params, optFns, addOperationUpdateInputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateInputMiddleware(stack *middleware.Stack, options Options) (err error) {
