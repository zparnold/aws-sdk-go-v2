...
func (c *Client) UpdateDetectorModel(ctx context.Context, params *UpdateDetectorModelInput, optFns ...func(*Options)) (*UpdateDetectorModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDetectorModel", params, optFns, addOperationUpdateDetectorModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDetectorModelMiddleware(stack *middleware.Stack, options Options) (err error) {
