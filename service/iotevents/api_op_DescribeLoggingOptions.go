...
func (c *Client) DescribeLoggingOptions(ctx context.Context, params *DescribeLoggingOptionsInput, optFns ...func(*Options)) (*DescribeLoggingOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoggingOptions", params, optFns, addOperationDescribeLoggingOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoggingOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
