...
func (c *Client) ListInputs(ctx context.Context, params *ListInputsInput, optFns ...func(*Options)) (*ListInputsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListInputs", params, optFns, addOperationListInputsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListInputsMiddleware(stack *middleware.Stack, options Options) (err error) {
