...
func (c *Client) CreateDetectorModel(ctx context.Context, params *CreateDetectorModelInput, optFns ...func(*Options)) (*CreateDetectorModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDetectorModel", params, optFns, addOperationCreateDetectorModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDetectorModelMiddleware(stack *middleware.Stack, options Options) (err error) {
