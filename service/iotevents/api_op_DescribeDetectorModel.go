...
func (c *Client) DescribeDetectorModel(ctx context.Context, params *DescribeDetectorModelInput, optFns ...func(*Options)) (*DescribeDetectorModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDetectorModel", params, optFns, addOperationDescribeDetectorModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDetectorModelMiddleware(stack *middleware.Stack, options Options) (err error) {
