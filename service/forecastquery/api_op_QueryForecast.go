...
func (c *Client) QueryForecast(ctx context.Context, params *QueryForecastInput, optFns ...func(*Options)) (*QueryForecastOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "QueryForecast", params, optFns, addOperationQueryForecastMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationQueryForecastMiddleware(stack *middleware.Stack, options Options) (err error) {
