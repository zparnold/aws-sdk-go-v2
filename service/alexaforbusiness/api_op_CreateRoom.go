...
func (c *Client) CreateRoom(ctx context.Context, params *CreateRoomInput, optFns ...func(*Options)) (*CreateRoomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRoom", params, optFns, addOperationCreateRoomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRoomMiddleware(stack *middleware.Stack, options Options) (err error) {
