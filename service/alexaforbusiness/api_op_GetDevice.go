...
func (c *Client) GetDevice(ctx context.Context, params *GetDeviceInput, optFns ...func(*Options)) (*GetDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDevice", params, optFns, addOperationGetDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
