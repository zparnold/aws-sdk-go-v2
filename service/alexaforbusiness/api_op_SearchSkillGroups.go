...
func (c *Client) SearchSkillGroups(ctx context.Context, params *SearchSkillGroupsInput, optFns ...func(*Options)) (*SearchSkillGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchSkillGroups", params, optFns, addOperationSearchSkillGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchSkillGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
