...
func (c *Client) AssociateSkillWithUsers(ctx context.Context, params *AssociateSkillWithUsersInput, optFns ...func(*Options)) (*AssociateSkillWithUsersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateSkillWithUsers", params, optFns, addOperationAssociateSkillWithUsersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateSkillWithUsersMiddleware(stack *middleware.Stack, options Options) (err error) {
