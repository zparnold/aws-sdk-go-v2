...
func (c *Client) PutConferencePreference(ctx context.Context, params *PutConferencePreferenceInput, optFns ...func(*Options)) (*PutConferencePreferenceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConferencePreference", params, optFns, addOperationPutConferencePreferenceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConferencePreferenceMiddleware(stack *middleware.Stack, options Options) (err error) {
