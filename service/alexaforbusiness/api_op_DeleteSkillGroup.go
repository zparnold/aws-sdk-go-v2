...
func (c *Client) DeleteSkillGroup(ctx context.Context, params *DeleteSkillGroupInput, optFns ...func(*Options)) (*DeleteSkillGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSkillGroup", params, optFns, addOperationDeleteSkillGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSkillGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
