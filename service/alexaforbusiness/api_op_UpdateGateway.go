...
func (c *Client) UpdateGateway(ctx context.Context, params *UpdateGatewayInput, optFns ...func(*Options)) (*UpdateGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGateway", params, optFns, addOperationUpdateGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
