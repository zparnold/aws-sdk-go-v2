...
func (c *Client) ResolveRoom(ctx context.Context, params *ResolveRoomInput, optFns ...func(*Options)) (*ResolveRoomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResolveRoom", params, optFns, addOperationResolveRoomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResolveRoomMiddleware(stack *middleware.Stack, options Options) (err error) {
