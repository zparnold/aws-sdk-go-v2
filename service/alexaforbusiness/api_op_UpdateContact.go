...
func (c *Client) UpdateContact(ctx context.Context, params *UpdateContactInput, optFns ...func(*Options)) (*UpdateContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateContact", params, optFns, addOperationUpdateContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateContactMiddleware(stack *middleware.Stack, options Options) (err error) {
