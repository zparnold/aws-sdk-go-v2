...
func (c *Client) DeleteAddressBook(ctx context.Context, params *DeleteAddressBookInput, optFns ...func(*Options)) (*DeleteAddressBookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAddressBook", params, optFns, addOperationDeleteAddressBookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAddressBookMiddleware(stack *middleware.Stack, options Options) (err error) {
