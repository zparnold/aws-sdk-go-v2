...
func (c *Client) ListSmartHomeAppliances(ctx context.Context, params *ListSmartHomeAppliancesInput, optFns ...func(*Options)) (*ListSmartHomeAppliancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSmartHomeAppliances", params, optFns, addOperationListSmartHomeAppliancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSmartHomeAppliancesMiddleware(stack *middleware.Stack, options Options) (err error) {
