...
func (c *Client) ListDeviceEvents(ctx context.Context, params *ListDeviceEventsInput, optFns ...func(*Options)) (*ListDeviceEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeviceEvents", params, optFns, addOperationListDeviceEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeviceEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
