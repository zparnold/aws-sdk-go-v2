...
func (c *Client) DisassociateDeviceFromRoom(ctx context.Context, params *DisassociateDeviceFromRoomInput, optFns ...func(*Options)) (*DisassociateDeviceFromRoomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateDeviceFromRoom", params, optFns, addOperationDisassociateDeviceFromRoomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateDeviceFromRoomMiddleware(stack *middleware.Stack, options Options) (err error) {
