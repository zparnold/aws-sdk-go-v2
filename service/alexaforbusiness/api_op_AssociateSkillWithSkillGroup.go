...
func (c *Client) AssociateSkillWithSkillGroup(ctx context.Context, params *AssociateSkillWithSkillGroupInput, optFns ...func(*Options)) (*AssociateSkillWithSkillGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateSkillWithSkillGroup", params, optFns, addOperationAssociateSkillWithSkillGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateSkillWithSkillGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
