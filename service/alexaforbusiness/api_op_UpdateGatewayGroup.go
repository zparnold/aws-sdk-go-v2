...
func (c *Client) UpdateGatewayGroup(ctx context.Context, params *UpdateGatewayGroupInput, optFns ...func(*Options)) (*UpdateGatewayGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGatewayGroup", params, optFns, addOperationUpdateGatewayGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewayGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
