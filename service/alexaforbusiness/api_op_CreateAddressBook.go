...
func (c *Client) CreateAddressBook(ctx context.Context, params *CreateAddressBookInput, optFns ...func(*Options)) (*CreateAddressBookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAddressBook", params, optFns, addOperationCreateAddressBookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAddressBookMiddleware(stack *middleware.Stack, options Options) (err error) {
