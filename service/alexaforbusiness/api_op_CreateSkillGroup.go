...
func (c *Client) CreateSkillGroup(ctx context.Context, params *CreateSkillGroupInput, optFns ...func(*Options)) (*CreateSkillGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSkillGroup", params, optFns, addOperationCreateSkillGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSkillGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
