...
func (c *Client) DeleteSkillAuthorization(ctx context.Context, params *DeleteSkillAuthorizationInput, optFns ...func(*Options)) (*DeleteSkillAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSkillAuthorization", params, optFns, addOperationDeleteSkillAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSkillAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
