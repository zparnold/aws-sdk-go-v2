...
func (c *Client) DeleteNetworkProfile(ctx context.Context, params *DeleteNetworkProfileInput, optFns ...func(*Options)) (*DeleteNetworkProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteNetworkProfile", params, optFns, addOperationDeleteNetworkProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteNetworkProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
