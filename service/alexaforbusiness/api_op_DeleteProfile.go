...
func (c *Client) DeleteProfile(ctx context.Context, params *DeleteProfileInput, optFns ...func(*Options)) (*DeleteProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProfile", params, optFns, addOperationDeleteProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
