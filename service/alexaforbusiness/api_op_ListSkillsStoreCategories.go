...
func (c *Client) ListSkillsStoreCategories(ctx context.Context, params *ListSkillsStoreCategoriesInput, optFns ...func(*Options)) (*ListSkillsStoreCategoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSkillsStoreCategories", params, optFns, addOperationListSkillsStoreCategoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSkillsStoreCategoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
