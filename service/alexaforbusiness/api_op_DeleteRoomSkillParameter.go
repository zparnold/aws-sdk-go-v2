...
func (c *Client) DeleteRoomSkillParameter(ctx context.Context, params *DeleteRoomSkillParameterInput, optFns ...func(*Options)) (*DeleteRoomSkillParameterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRoomSkillParameter", params, optFns, addOperationDeleteRoomSkillParameterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRoomSkillParameterMiddleware(stack *middleware.Stack, options Options) (err error) {
