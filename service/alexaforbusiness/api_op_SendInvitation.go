...
func (c *Client) SendInvitation(ctx context.Context, params *SendInvitationInput, optFns ...func(*Options)) (*SendInvitationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendInvitation", params, optFns, addOperationSendInvitationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendInvitationMiddleware(stack *middleware.Stack, options Options) (err error) {
