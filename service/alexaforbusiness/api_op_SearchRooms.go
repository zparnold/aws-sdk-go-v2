...
func (c *Client) SearchRooms(ctx context.Context, params *SearchRoomsInput, optFns ...func(*Options)) (*SearchRoomsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchRooms", params, optFns, addOperationSearchRoomsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchRoomsMiddleware(stack *middleware.Stack, options Options) (err error) {
