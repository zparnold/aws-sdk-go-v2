...
func (c *Client) ListBusinessReportSchedules(ctx context.Context, params *ListBusinessReportSchedulesInput, optFns ...func(*Options)) (*ListBusinessReportSchedulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBusinessReportSchedules", params, optFns, addOperationListBusinessReportSchedulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBusinessReportSchedulesMiddleware(stack *middleware.Stack, options Options) (err error) {
