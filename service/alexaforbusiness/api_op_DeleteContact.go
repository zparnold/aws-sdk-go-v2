...
func (c *Client) DeleteContact(ctx context.Context, params *DeleteContactInput, optFns ...func(*Options)) (*DeleteContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteContact", params, optFns, addOperationDeleteContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteContactMiddleware(stack *middleware.Stack, options Options) (err error) {
