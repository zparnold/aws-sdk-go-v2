...
func (c *Client) CreateProfile(ctx context.Context, params *CreateProfileInput, optFns ...func(*Options)) (*CreateProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProfile", params, optFns, addOperationCreateProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
