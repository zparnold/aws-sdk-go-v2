...
func (c *Client) GetInvitationConfiguration(ctx context.Context, params *GetInvitationConfigurationInput, optFns ...func(*Options)) (*GetInvitationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInvitationConfiguration", params, optFns, addOperationGetInvitationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInvitationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
