...
func (c *Client) UpdateBusinessReportSchedule(ctx context.Context, params *UpdateBusinessReportScheduleInput, optFns ...func(*Options)) (*UpdateBusinessReportScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBusinessReportSchedule", params, optFns, addOperationUpdateBusinessReportScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBusinessReportScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
