...
func (c *Client) UpdateSkillGroup(ctx context.Context, params *UpdateSkillGroupInput, optFns ...func(*Options)) (*UpdateSkillGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSkillGroup", params, optFns, addOperationUpdateSkillGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSkillGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
