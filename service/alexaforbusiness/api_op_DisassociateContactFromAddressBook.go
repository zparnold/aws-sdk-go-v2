...
func (c *Client) DisassociateContactFromAddressBook(ctx context.Context, params *DisassociateContactFromAddressBookInput, optFns ...func(*Options)) (*DisassociateContactFromAddressBookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateContactFromAddressBook", params, optFns, addOperationDisassociateContactFromAddressBookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateContactFromAddressBookMiddleware(stack *middleware.Stack, options Options) (err error) {
