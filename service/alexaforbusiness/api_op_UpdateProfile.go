...
func (c *Client) UpdateProfile(ctx context.Context, params *UpdateProfileInput, optFns ...func(*Options)) (*UpdateProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateProfile", params, optFns, addOperationUpdateProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
