...
func (c *Client) PutInvitationConfiguration(ctx context.Context, params *PutInvitationConfigurationInput, optFns ...func(*Options)) (*PutInvitationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutInvitationConfiguration", params, optFns, addOperationPutInvitationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutInvitationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
