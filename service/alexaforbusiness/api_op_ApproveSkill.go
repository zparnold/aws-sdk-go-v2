...
func (c *Client) ApproveSkill(ctx context.Context, params *ApproveSkillInput, optFns ...func(*Options)) (*ApproveSkillOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ApproveSkill", params, optFns, addOperationApproveSkillMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationApproveSkillMiddleware(stack *middleware.Stack, options Options) (err error) {
