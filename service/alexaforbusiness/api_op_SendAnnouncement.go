...
func (c *Client) SendAnnouncement(ctx context.Context, params *SendAnnouncementInput, optFns ...func(*Options)) (*SendAnnouncementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendAnnouncement", params, optFns, addOperationSendAnnouncementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendAnnouncementMiddleware(stack *middleware.Stack, options Options) (err error) {
