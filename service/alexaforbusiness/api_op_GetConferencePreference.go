...
func (c *Client) GetConferencePreference(ctx context.Context, params *GetConferencePreferenceInput, optFns ...func(*Options)) (*GetConferencePreferenceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConferencePreference", params, optFns, addOperationGetConferencePreferenceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConferencePreferenceMiddleware(stack *middleware.Stack, options Options) (err error) {
