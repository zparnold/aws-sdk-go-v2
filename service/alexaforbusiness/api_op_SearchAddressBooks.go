...
func (c *Client) SearchAddressBooks(ctx context.Context, params *SearchAddressBooksInput, optFns ...func(*Options)) (*SearchAddressBooksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchAddressBooks", params, optFns, addOperationSearchAddressBooksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchAddressBooksMiddleware(stack *middleware.Stack, options Options) (err error) {
