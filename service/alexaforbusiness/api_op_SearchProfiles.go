...
func (c *Client) SearchProfiles(ctx context.Context, params *SearchProfilesInput, optFns ...func(*Options)) (*SearchProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchProfiles", params, optFns, addOperationSearchProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
