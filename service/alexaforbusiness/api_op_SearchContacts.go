...
func (c *Client) SearchContacts(ctx context.Context, params *SearchContactsInput, optFns ...func(*Options)) (*SearchContactsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchContacts", params, optFns, addOperationSearchContactsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchContactsMiddleware(stack *middleware.Stack, options Options) (err error) {
