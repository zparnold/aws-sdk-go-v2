...
func (c *Client) GetRoomSkillParameter(ctx context.Context, params *GetRoomSkillParameterInput, optFns ...func(*Options)) (*GetRoomSkillParameterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRoomSkillParameter", params, optFns, addOperationGetRoomSkillParameterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRoomSkillParameterMiddleware(stack *middleware.Stack, options Options) (err error) {
