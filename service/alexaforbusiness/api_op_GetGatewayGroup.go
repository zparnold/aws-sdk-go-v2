...
func (c *Client) GetGatewayGroup(ctx context.Context, params *GetGatewayGroupInput, optFns ...func(*Options)) (*GetGatewayGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGatewayGroup", params, optFns, addOperationGetGatewayGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGatewayGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
