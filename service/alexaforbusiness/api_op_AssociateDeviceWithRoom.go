...
func (c *Client) AssociateDeviceWithRoom(ctx context.Context, params *AssociateDeviceWithRoomInput, optFns ...func(*Options)) (*AssociateDeviceWithRoomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateDeviceWithRoom", params, optFns, addOperationAssociateDeviceWithRoomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateDeviceWithRoomMiddleware(stack *middleware.Stack, options Options) (err error) {
