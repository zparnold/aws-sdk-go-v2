...
func (c *Client) RegisterAVSDevice(ctx context.Context, params *RegisterAVSDeviceInput, optFns ...func(*Options)) (*RegisterAVSDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterAVSDevice", params, optFns, addOperationRegisterAVSDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterAVSDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
