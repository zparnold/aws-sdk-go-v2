...
func (c *Client) DeleteDeviceUsageData(ctx context.Context, params *DeleteDeviceUsageDataInput, optFns ...func(*Options)) (*DeleteDeviceUsageDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeviceUsageData", params, optFns, addOperationDeleteDeviceUsageDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeviceUsageDataMiddleware(stack *middleware.Stack, options Options) (err error) {
