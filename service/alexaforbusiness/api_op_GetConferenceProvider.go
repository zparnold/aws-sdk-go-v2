...
func (c *Client) GetConferenceProvider(ctx context.Context, params *GetConferenceProviderInput, optFns ...func(*Options)) (*GetConferenceProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConferenceProvider", params, optFns, addOperationGetConferenceProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConferenceProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
