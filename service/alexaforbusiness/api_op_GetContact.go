...
func (c *Client) GetContact(ctx context.Context, params *GetContactInput, optFns ...func(*Options)) (*GetContactOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetContact", params, optFns, addOperationGetContactMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetContactMiddleware(stack *middleware.Stack, options Options) (err error) {
