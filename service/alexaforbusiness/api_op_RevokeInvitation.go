...
func (c *Client) RevokeInvitation(ctx context.Context, params *RevokeInvitationInput, optFns ...func(*Options)) (*RevokeInvitationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeInvitation", params, optFns, addOperationRevokeInvitationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeInvitationMiddleware(stack *middleware.Stack, options Options) (err error) {
