...
func (c *Client) PutRoomSkillParameter(ctx context.Context, params *PutRoomSkillParameterInput, optFns ...func(*Options)) (*PutRoomSkillParameterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRoomSkillParameter", params, optFns, addOperationPutRoomSkillParameterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRoomSkillParameterMiddleware(stack *middleware.Stack, options Options) (err error) {
