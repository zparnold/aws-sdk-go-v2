...
func (c *Client) GetGateway(ctx context.Context, params *GetGatewayInput, optFns ...func(*Options)) (*GetGatewayOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGateway", params, optFns, addOperationGetGatewayMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGatewayMiddleware(stack *middleware.Stack, options Options) (err error) {
