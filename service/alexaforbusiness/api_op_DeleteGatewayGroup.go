...
func (c *Client) DeleteGatewayGroup(ctx context.Context, params *DeleteGatewayGroupInput, optFns ...func(*Options)) (*DeleteGatewayGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGatewayGroup", params, optFns, addOperationDeleteGatewayGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGatewayGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
