...
func (c *Client) SearchUsers(ctx context.Context, params *SearchUsersInput, optFns ...func(*Options)) (*SearchUsersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchUsers", params, optFns, addOperationSearchUsersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchUsersMiddleware(stack *middleware.Stack, options Options) (err error) {
