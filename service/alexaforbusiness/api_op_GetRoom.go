...
func (c *Client) GetRoom(ctx context.Context, params *GetRoomInput, optFns ...func(*Options)) (*GetRoomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRoom", params, optFns, addOperationGetRoomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRoomMiddleware(stack *middleware.Stack, options Options) (err error) {
