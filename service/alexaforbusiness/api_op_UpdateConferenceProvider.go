...
func (c *Client) UpdateConferenceProvider(ctx context.Context, params *UpdateConferenceProviderInput, optFns ...func(*Options)) (*UpdateConferenceProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConferenceProvider", params, optFns, addOperationUpdateConferenceProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConferenceProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
