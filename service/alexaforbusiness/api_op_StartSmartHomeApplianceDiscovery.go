...
func (c *Client) StartSmartHomeApplianceDiscovery(ctx context.Context, params *StartSmartHomeApplianceDiscoveryInput, optFns ...func(*Options)) (*StartSmartHomeApplianceDiscoveryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSmartHomeApplianceDiscovery", params, optFns, addOperationStartSmartHomeApplianceDiscoveryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSmartHomeApplianceDiscoveryMiddleware(stack *middleware.Stack, options Options) (err error) {
