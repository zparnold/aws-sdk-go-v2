...
func (c *Client) GetSkillGroup(ctx context.Context, params *GetSkillGroupInput, optFns ...func(*Options)) (*GetSkillGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSkillGroup", params, optFns, addOperationGetSkillGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSkillGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
