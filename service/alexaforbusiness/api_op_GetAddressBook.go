...
func (c *Client) GetAddressBook(ctx context.Context, params *GetAddressBookInput, optFns ...func(*Options)) (*GetAddressBookOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAddressBook", params, optFns, addOperationGetAddressBookMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAddressBookMiddleware(stack *middleware.Stack, options Options) (err error) {
