...
func (c *Client) CreateBusinessReportSchedule(ctx context.Context, params *CreateBusinessReportScheduleInput, optFns ...func(*Options)) (*CreateBusinessReportScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBusinessReportSchedule", params, optFns, addOperationCreateBusinessReportScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBusinessReportScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
