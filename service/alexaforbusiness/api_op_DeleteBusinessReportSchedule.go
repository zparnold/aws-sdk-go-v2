...
func (c *Client) DeleteBusinessReportSchedule(ctx context.Context, params *DeleteBusinessReportScheduleInput, optFns ...func(*Options)) (*DeleteBusinessReportScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBusinessReportSchedule", params, optFns, addOperationDeleteBusinessReportScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBusinessReportScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
