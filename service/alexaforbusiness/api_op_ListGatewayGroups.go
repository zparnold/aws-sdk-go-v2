...
func (c *Client) ListGatewayGroups(ctx context.Context, params *ListGatewayGroupsInput, optFns ...func(*Options)) (*ListGatewayGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGatewayGroups", params, optFns, addOperationListGatewayGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGatewayGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
