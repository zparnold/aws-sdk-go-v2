...
func (c *Client) ListConferenceProviders(ctx context.Context, params *ListConferenceProvidersInput, optFns ...func(*Options)) (*ListConferenceProvidersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConferenceProviders", params, optFns, addOperationListConferenceProvidersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConferenceProvidersMiddleware(stack *middleware.Stack, options Options) (err error) {
