...
func (c *Client) StartDeviceSync(ctx context.Context, params *StartDeviceSyncInput, optFns ...func(*Options)) (*StartDeviceSyncOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDeviceSync", params, optFns, addOperationStartDeviceSyncMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDeviceSyncMiddleware(stack *middleware.Stack, options Options) (err error) {
