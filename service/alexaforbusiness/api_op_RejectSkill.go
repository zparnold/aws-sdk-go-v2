...
func (c *Client) RejectSkill(ctx context.Context, params *RejectSkillInput, optFns ...func(*Options)) (*RejectSkillOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RejectSkill", params, optFns, addOperationRejectSkillMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRejectSkillMiddleware(stack *middleware.Stack, options Options) (err error) {
