...
func (c *Client) PutSkillAuthorization(ctx context.Context, params *PutSkillAuthorizationInput, optFns ...func(*Options)) (*PutSkillAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSkillAuthorization", params, optFns, addOperationPutSkillAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSkillAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
