...
func (c *Client) ForgetSmartHomeAppliances(ctx context.Context, params *ForgetSmartHomeAppliancesInput, optFns ...func(*Options)) (*ForgetSmartHomeAppliancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ForgetSmartHomeAppliances", params, optFns, addOperationForgetSmartHomeAppliancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationForgetSmartHomeAppliancesMiddleware(stack *middleware.Stack, options Options) (err error) {
