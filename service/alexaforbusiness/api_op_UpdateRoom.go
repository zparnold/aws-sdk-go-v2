...
func (c *Client) UpdateRoom(ctx context.Context, params *UpdateRoomInput, optFns ...func(*Options)) (*UpdateRoomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRoom", params, optFns, addOperationUpdateRoomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRoomMiddleware(stack *middleware.Stack, options Options) (err error) {
