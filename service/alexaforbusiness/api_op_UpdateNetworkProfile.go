...
func (c *Client) UpdateNetworkProfile(ctx context.Context, params *UpdateNetworkProfileInput, optFns ...func(*Options)) (*UpdateNetworkProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNetworkProfile", params, optFns, addOperationUpdateNetworkProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNetworkProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
