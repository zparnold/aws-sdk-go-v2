...
func (c *Client) DeleteConferenceProvider(ctx context.Context, params *DeleteConferenceProviderInput, optFns ...func(*Options)) (*DeleteConferenceProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConferenceProvider", params, optFns, addOperationDeleteConferenceProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConferenceProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
