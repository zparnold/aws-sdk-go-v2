...
func (c *Client) DisassociateSkillGroupFromRoom(ctx context.Context, params *DisassociateSkillGroupFromRoomInput, optFns ...func(*Options)) (*DisassociateSkillGroupFromRoomOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateSkillGroupFromRoom", params, optFns, addOperationDisassociateSkillGroupFromRoomMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateSkillGroupFromRoomMiddleware(stack *middleware.Stack, options Options) (err error) {
