...
func (c *Client) ListSkills(ctx context.Context, params *ListSkillsInput, optFns ...func(*Options)) (*ListSkillsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSkills", params, optFns, addOperationListSkillsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSkillsMiddleware(stack *middleware.Stack, options Options) (err error) {
