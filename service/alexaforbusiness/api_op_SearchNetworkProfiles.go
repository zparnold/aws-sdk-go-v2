...
func (c *Client) SearchNetworkProfiles(ctx context.Context, params *SearchNetworkProfilesInput, optFns ...func(*Options)) (*SearchNetworkProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchNetworkProfiles", params, optFns, addOperationSearchNetworkProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchNetworkProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
