...
func (c *Client) BatchGetBuildBatches(ctx context.Context, params *BatchGetBuildBatchesInput, optFns ...func(*Options)) (*BatchGetBuildBatchesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetBuildBatches", params, optFns, addOperationBatchGetBuildBatchesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetBuildBatchesMiddleware(stack *middleware.Stack, options Options) (err error) {
