...
func (c *Client) StopBuildBatch(ctx context.Context, params *StopBuildBatchInput, optFns ...func(*Options)) (*StopBuildBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopBuildBatch", params, optFns, addOperationStopBuildBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopBuildBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
