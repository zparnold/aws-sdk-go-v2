...
func (c *Client) StartBuild(ctx context.Context, params *StartBuildInput, optFns ...func(*Options)) (*StartBuildOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartBuild", params, optFns, addOperationStartBuildMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartBuildMiddleware(stack *middleware.Stack, options Options) (err error) {
