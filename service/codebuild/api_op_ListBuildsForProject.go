...
func (c *Client) ListBuildsForProject(ctx context.Context, params *ListBuildsForProjectInput, optFns ...func(*Options)) (*ListBuildsForProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBuildsForProject", params, optFns, addOperationListBuildsForProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBuildsForProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
