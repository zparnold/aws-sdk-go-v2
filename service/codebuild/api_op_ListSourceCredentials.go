...
func (c *Client) ListSourceCredentials(ctx context.Context, params *ListSourceCredentialsInput, optFns ...func(*Options)) (*ListSourceCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSourceCredentials", params, optFns, addOperationListSourceCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSourceCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
