...
func (c *Client) BatchGetReportGroups(ctx context.Context, params *BatchGetReportGroupsInput, optFns ...func(*Options)) (*BatchGetReportGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetReportGroups", params, optFns, addOperationBatchGetReportGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetReportGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
