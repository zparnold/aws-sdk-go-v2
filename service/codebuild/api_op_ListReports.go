...
func (c *Client) ListReports(ctx context.Context, params *ListReportsInput, optFns ...func(*Options)) (*ListReportsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReports", params, optFns, addOperationListReportsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReportsMiddleware(stack *middleware.Stack, options Options) (err error) {
