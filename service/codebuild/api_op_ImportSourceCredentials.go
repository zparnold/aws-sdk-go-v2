...
func (c *Client) ImportSourceCredentials(ctx context.Context, params *ImportSourceCredentialsInput, optFns ...func(*Options)) (*ImportSourceCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportSourceCredentials", params, optFns, addOperationImportSourceCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportSourceCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
