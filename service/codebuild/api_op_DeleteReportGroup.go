...
func (c *Client) DeleteReportGroup(ctx context.Context, params *DeleteReportGroupInput, optFns ...func(*Options)) (*DeleteReportGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteReportGroup", params, optFns, addOperationDeleteReportGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteReportGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
