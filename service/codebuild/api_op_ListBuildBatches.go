...
func (c *Client) ListBuildBatches(ctx context.Context, params *ListBuildBatchesInput, optFns ...func(*Options)) (*ListBuildBatchesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBuildBatches", params, optFns, addOperationListBuildBatchesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBuildBatchesMiddleware(stack *middleware.Stack, options Options) (err error) {
