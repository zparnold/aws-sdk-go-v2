...
func (c *Client) ListBuildBatchesForProject(ctx context.Context, params *ListBuildBatchesForProjectInput, optFns ...func(*Options)) (*ListBuildBatchesForProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBuildBatchesForProject", params, optFns, addOperationListBuildBatchesForProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBuildBatchesForProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
