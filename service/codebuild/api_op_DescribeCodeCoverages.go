...
func (c *Client) DescribeCodeCoverages(ctx context.Context, params *DescribeCodeCoveragesInput, optFns ...func(*Options)) (*DescribeCodeCoveragesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCodeCoverages", params, optFns, addOperationDescribeCodeCoveragesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCodeCoveragesMiddleware(stack *middleware.Stack, options Options) (err error) {
