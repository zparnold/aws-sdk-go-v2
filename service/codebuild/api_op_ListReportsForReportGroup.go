...
func (c *Client) ListReportsForReportGroup(ctx context.Context, params *ListReportsForReportGroupInput, optFns ...func(*Options)) (*ListReportsForReportGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReportsForReportGroup", params, optFns, addOperationListReportsForReportGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReportsForReportGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
