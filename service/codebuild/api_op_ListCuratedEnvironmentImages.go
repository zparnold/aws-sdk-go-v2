...
func (c *Client) ListCuratedEnvironmentImages(ctx context.Context, params *ListCuratedEnvironmentImagesInput, optFns ...func(*Options)) (*ListCuratedEnvironmentImagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCuratedEnvironmentImages", params, optFns, addOperationListCuratedEnvironmentImagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCuratedEnvironmentImagesMiddleware(stack *middleware.Stack, options Options) (err error) {
