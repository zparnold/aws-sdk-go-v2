...
func (c *Client) DeleteBuildBatch(ctx context.Context, params *DeleteBuildBatchInput, optFns ...func(*Options)) (*DeleteBuildBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBuildBatch", params, optFns, addOperationDeleteBuildBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBuildBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
