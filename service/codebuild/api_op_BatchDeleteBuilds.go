...
func (c *Client) BatchDeleteBuilds(ctx context.Context, params *BatchDeleteBuildsInput, optFns ...func(*Options)) (*BatchDeleteBuildsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeleteBuilds", params, optFns, addOperationBatchDeleteBuildsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeleteBuildsMiddleware(stack *middleware.Stack, options Options) (err error) {
