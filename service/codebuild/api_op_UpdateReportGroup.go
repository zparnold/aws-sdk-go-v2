...
func (c *Client) UpdateReportGroup(ctx context.Context, params *UpdateReportGroupInput, optFns ...func(*Options)) (*UpdateReportGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateReportGroup", params, optFns, addOperationUpdateReportGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateReportGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
