...
func (c *Client) StartBuildBatch(ctx context.Context, params *StartBuildBatchInput, optFns ...func(*Options)) (*StartBuildBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartBuildBatch", params, optFns, addOperationStartBuildBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartBuildBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
