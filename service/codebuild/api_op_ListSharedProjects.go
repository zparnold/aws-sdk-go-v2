...
func (c *Client) ListSharedProjects(ctx context.Context, params *ListSharedProjectsInput, optFns ...func(*Options)) (*ListSharedProjectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSharedProjects", params, optFns, addOperationListSharedProjectsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSharedProjectsMiddleware(stack *middleware.Stack, options Options) (err error) {
