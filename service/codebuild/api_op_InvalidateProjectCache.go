...
func (c *Client) InvalidateProjectCache(ctx context.Context, params *InvalidateProjectCacheInput, optFns ...func(*Options)) (*InvalidateProjectCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InvalidateProjectCache", params, optFns, addOperationInvalidateProjectCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInvalidateProjectCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
