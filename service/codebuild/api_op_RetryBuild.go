...
func (c *Client) RetryBuild(ctx context.Context, params *RetryBuildInput, optFns ...func(*Options)) (*RetryBuildOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetryBuild", params, optFns, addOperationRetryBuildMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetryBuildMiddleware(stack *middleware.Stack, options Options) (err error) {
