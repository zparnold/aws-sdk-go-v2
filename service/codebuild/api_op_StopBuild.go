...
func (c *Client) StopBuild(ctx context.Context, params *StopBuildInput, optFns ...func(*Options)) (*StopBuildOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopBuild", params, optFns, addOperationStopBuildMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopBuildMiddleware(stack *middleware.Stack, options Options) (err error) {
