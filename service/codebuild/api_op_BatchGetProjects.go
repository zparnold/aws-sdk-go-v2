...
func (c *Client) BatchGetProjects(ctx context.Context, params *BatchGetProjectsInput, optFns ...func(*Options)) (*BatchGetProjectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetProjects", params, optFns, addOperationBatchGetProjectsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetProjectsMiddleware(stack *middleware.Stack, options Options) (err error) {
