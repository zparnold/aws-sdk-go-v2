...
func (c *Client) ListSharedReportGroups(ctx context.Context, params *ListSharedReportGroupsInput, optFns ...func(*Options)) (*ListSharedReportGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSharedReportGroups", params, optFns, addOperationListSharedReportGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSharedReportGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
