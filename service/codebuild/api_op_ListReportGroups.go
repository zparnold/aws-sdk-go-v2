...
func (c *Client) ListReportGroups(ctx context.Context, params *ListReportGroupsInput, optFns ...func(*Options)) (*ListReportGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListReportGroups", params, optFns, addOperationListReportGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListReportGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
