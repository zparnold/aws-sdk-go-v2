...
func (c *Client) DescribeTestCases(ctx context.Context, params *DescribeTestCasesInput, optFns ...func(*Options)) (*DescribeTestCasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTestCases", params, optFns, addOperationDescribeTestCasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTestCasesMiddleware(stack *middleware.Stack, options Options) (err error) {
