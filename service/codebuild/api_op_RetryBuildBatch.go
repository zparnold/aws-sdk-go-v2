...
func (c *Client) RetryBuildBatch(ctx context.Context, params *RetryBuildBatchInput, optFns ...func(*Options)) (*RetryBuildBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RetryBuildBatch", params, optFns, addOperationRetryBuildBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRetryBuildBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
