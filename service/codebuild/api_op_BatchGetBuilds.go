...
func (c *Client) BatchGetBuilds(ctx context.Context, params *BatchGetBuildsInput, optFns ...func(*Options)) (*BatchGetBuildsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetBuilds", params, optFns, addOperationBatchGetBuildsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetBuildsMiddleware(stack *middleware.Stack, options Options) (err error) {
