...
func (c *Client) CopyDBClusterSnapshot(ctx context.Context, params *CopyDBClusterSnapshotInput, optFns ...func(*Options)) (*CopyDBClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyDBClusterSnapshot", params, optFns, addOperationCopyDBClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyDBClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
