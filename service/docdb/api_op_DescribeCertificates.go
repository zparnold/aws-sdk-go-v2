...
func (c *Client) DescribeCertificates(ctx context.Context, params *DescribeCertificatesInput, optFns ...func(*Options)) (*DescribeCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCertificates", params, optFns, addOperationDescribeCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
