...
func (c *Client) CreateDBSubnetGroup(ctx context.Context, params *CreateDBSubnetGroupInput, optFns ...func(*Options)) (*CreateDBSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBSubnetGroup", params, optFns, addOperationCreateDBSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
