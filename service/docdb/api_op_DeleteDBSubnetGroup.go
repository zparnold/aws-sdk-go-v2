...
func (c *Client) DeleteDBSubnetGroup(ctx context.Context, params *DeleteDBSubnetGroupInput, optFns ...func(*Options)) (*DeleteDBSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBSubnetGroup", params, optFns, addOperationDeleteDBSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
