...
func (c *Client) CreateDBCluster(ctx context.Context, params *CreateDBClusterInput, optFns ...func(*Options)) (*CreateDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBCluster", params, optFns, addOperationCreateDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
