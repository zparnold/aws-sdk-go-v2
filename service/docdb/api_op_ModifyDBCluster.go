...
func (c *Client) ModifyDBCluster(ctx context.Context, params *ModifyDBClusterInput, optFns ...func(*Options)) (*ModifyDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBCluster", params, optFns, addOperationModifyDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
