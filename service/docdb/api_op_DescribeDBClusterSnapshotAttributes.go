...
func (c *Client) DescribeDBClusterSnapshotAttributes(ctx context.Context, params *DescribeDBClusterSnapshotAttributesInput, optFns ...func(*Options)) (*DescribeDBClusterSnapshotAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBClusterSnapshotAttributes", params, optFns, addOperationDescribeDBClusterSnapshotAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBClusterSnapshotAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
