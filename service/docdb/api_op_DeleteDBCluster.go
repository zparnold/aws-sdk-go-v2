...
func (c *Client) DeleteDBCluster(ctx context.Context, params *DeleteDBClusterInput, optFns ...func(*Options)) (*DeleteDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBCluster", params, optFns, addOperationDeleteDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
