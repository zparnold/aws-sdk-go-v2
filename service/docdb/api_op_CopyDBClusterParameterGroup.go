...
func (c *Client) CopyDBClusterParameterGroup(ctx context.Context, params *CopyDBClusterParameterGroupInput, optFns ...func(*Options)) (*CopyDBClusterParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyDBClusterParameterGroup", params, optFns, addOperationCopyDBClusterParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyDBClusterParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
