...
func (c *Client) GetEntitlements(ctx context.Context, params *GetEntitlementsInput, optFns ...func(*Options)) (*GetEntitlementsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEntitlements", params, optFns, addOperationGetEntitlementsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEntitlementsMiddleware(stack *middleware.Stack, options Options) (err error) {
