...
func (c *Client) DescribeEnvironments(ctx context.Context, params *DescribeEnvironmentsInput, optFns ...func(*Options)) (*DescribeEnvironmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEnvironments", params, optFns, addOperationDescribeEnvironmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEnvironmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
