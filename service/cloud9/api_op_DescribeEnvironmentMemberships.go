...
func (c *Client) DescribeEnvironmentMemberships(ctx context.Context, params *DescribeEnvironmentMembershipsInput, optFns ...func(*Options)) (*DescribeEnvironmentMembershipsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEnvironmentMemberships", params, optFns, addOperationDescribeEnvironmentMembershipsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEnvironmentMembershipsMiddleware(stack *middleware.Stack, options Options) (err error) {
