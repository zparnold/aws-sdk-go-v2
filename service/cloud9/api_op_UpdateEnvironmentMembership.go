...
func (c *Client) UpdateEnvironmentMembership(ctx context.Context, params *UpdateEnvironmentMembershipInput, optFns ...func(*Options)) (*UpdateEnvironmentMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEnvironmentMembership", params, optFns, addOperationUpdateEnvironmentMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEnvironmentMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
