...
func (c *Client) CreateEnvironmentMembership(ctx context.Context, params *CreateEnvironmentMembershipInput, optFns ...func(*Options)) (*CreateEnvironmentMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEnvironmentMembership", params, optFns, addOperationCreateEnvironmentMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEnvironmentMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
