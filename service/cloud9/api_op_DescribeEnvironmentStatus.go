...
func (c *Client) DescribeEnvironmentStatus(ctx context.Context, params *DescribeEnvironmentStatusInput, optFns ...func(*Options)) (*DescribeEnvironmentStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEnvironmentStatus", params, optFns, addOperationDescribeEnvironmentStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEnvironmentStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
