...
func (c *Client) DeleteEnvironmentMembership(ctx context.Context, params *DeleteEnvironmentMembershipInput, optFns ...func(*Options)) (*DeleteEnvironmentMembershipOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEnvironmentMembership", params, optFns, addOperationDeleteEnvironmentMembershipMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEnvironmentMembershipMiddleware(stack *middleware.Stack, options Options) (err error) {
