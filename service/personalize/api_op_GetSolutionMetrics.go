...
func (c *Client) GetSolutionMetrics(ctx context.Context, params *GetSolutionMetricsInput, optFns ...func(*Options)) (*GetSolutionMetricsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSolutionMetrics", params, optFns, addOperationGetSolutionMetricsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSolutionMetricsMiddleware(stack *middleware.Stack, options Options) (err error) {
