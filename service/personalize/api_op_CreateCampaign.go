...
func (c *Client) CreateCampaign(ctx context.Context, params *CreateCampaignInput, optFns ...func(*Options)) (*CreateCampaignOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCampaign", params, optFns, addOperationCreateCampaignMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCampaignMiddleware(stack *middleware.Stack, options Options) (err error) {
