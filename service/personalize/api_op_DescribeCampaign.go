...
func (c *Client) DescribeCampaign(ctx context.Context, params *DescribeCampaignInput, optFns ...func(*Options)) (*DescribeCampaignOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCampaign", params, optFns, addOperationDescribeCampaignMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCampaignMiddleware(stack *middleware.Stack, options Options) (err error) {
