...
func (c *Client) UpdateCampaign(ctx context.Context, params *UpdateCampaignInput, optFns ...func(*Options)) (*UpdateCampaignOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCampaign", params, optFns, addOperationUpdateCampaignMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCampaignMiddleware(stack *middleware.Stack, options Options) (err error) {
