...
func (c *Client) ListSolutionVersions(ctx context.Context, params *ListSolutionVersionsInput, optFns ...func(*Options)) (*ListSolutionVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSolutionVersions", params, optFns, addOperationListSolutionVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSolutionVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
