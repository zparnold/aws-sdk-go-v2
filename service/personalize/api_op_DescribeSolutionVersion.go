...
func (c *Client) DescribeSolutionVersion(ctx context.Context, params *DescribeSolutionVersionInput, optFns ...func(*Options)) (*DescribeSolutionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSolutionVersion", params, optFns, addOperationDescribeSolutionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSolutionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
