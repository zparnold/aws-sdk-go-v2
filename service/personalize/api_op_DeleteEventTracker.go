...
func (c *Client) DeleteEventTracker(ctx context.Context, params *DeleteEventTrackerInput, optFns ...func(*Options)) (*DeleteEventTrackerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEventTracker", params, optFns, addOperationDeleteEventTrackerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEventTrackerMiddleware(stack *middleware.Stack, options Options) (err error) {
