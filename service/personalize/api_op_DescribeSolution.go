...
func (c *Client) DescribeSolution(ctx context.Context, params *DescribeSolutionInput, optFns ...func(*Options)) (*DescribeSolutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSolution", params, optFns, addOperationDescribeSolutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSolutionMiddleware(stack *middleware.Stack, options Options) (err error) {
