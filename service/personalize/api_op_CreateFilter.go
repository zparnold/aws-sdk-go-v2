...
func (c *Client) CreateFilter(ctx context.Context, params *CreateFilterInput, optFns ...func(*Options)) (*CreateFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFilter", params, optFns, addOperationCreateFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
