...
func (c *Client) ListEventTrackers(ctx context.Context, params *ListEventTrackersInput, optFns ...func(*Options)) (*ListEventTrackersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEventTrackers", params, optFns, addOperationListEventTrackersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEventTrackersMiddleware(stack *middleware.Stack, options Options) (err error) {
