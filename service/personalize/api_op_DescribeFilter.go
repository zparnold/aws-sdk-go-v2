...
func (c *Client) DescribeFilter(ctx context.Context, params *DescribeFilterInput, optFns ...func(*Options)) (*DescribeFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFilter", params, optFns, addOperationDescribeFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
