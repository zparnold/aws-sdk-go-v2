...
func (c *Client) ListBatchInferenceJobs(ctx context.Context, params *ListBatchInferenceJobsInput, optFns ...func(*Options)) (*ListBatchInferenceJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBatchInferenceJobs", params, optFns, addOperationListBatchInferenceJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBatchInferenceJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
