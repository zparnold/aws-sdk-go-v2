...
func (c *Client) DescribeBatchInferenceJob(ctx context.Context, params *DescribeBatchInferenceJobInput, optFns ...func(*Options)) (*DescribeBatchInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBatchInferenceJob", params, optFns, addOperationDescribeBatchInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBatchInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
