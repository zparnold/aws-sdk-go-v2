...
func (c *Client) CreateDatasetImportJob(ctx context.Context, params *CreateDatasetImportJobInput, optFns ...func(*Options)) (*CreateDatasetImportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDatasetImportJob", params, optFns, addOperationCreateDatasetImportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDatasetImportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
