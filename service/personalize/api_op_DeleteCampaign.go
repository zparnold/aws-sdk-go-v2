...
func (c *Client) DeleteCampaign(ctx context.Context, params *DeleteCampaignInput, optFns ...func(*Options)) (*DeleteCampaignOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCampaign", params, optFns, addOperationDeleteCampaignMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCampaignMiddleware(stack *middleware.Stack, options Options) (err error) {
