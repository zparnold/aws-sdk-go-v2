...
func (c *Client) DeleteFilter(ctx context.Context, params *DeleteFilterInput, optFns ...func(*Options)) (*DeleteFilterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFilter", params, optFns, addOperationDeleteFilterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFilterMiddleware(stack *middleware.Stack, options Options) (err error) {
