...
func (c *Client) DescribeRecipe(ctx context.Context, params *DescribeRecipeInput, optFns ...func(*Options)) (*DescribeRecipeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRecipe", params, optFns, addOperationDescribeRecipeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRecipeMiddleware(stack *middleware.Stack, options Options) (err error) {
