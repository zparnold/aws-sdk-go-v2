...
func (c *Client) DescribeEventTracker(ctx context.Context, params *DescribeEventTrackerInput, optFns ...func(*Options)) (*DescribeEventTrackerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventTracker", params, optFns, addOperationDescribeEventTrackerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventTrackerMiddleware(stack *middleware.Stack, options Options) (err error) {
