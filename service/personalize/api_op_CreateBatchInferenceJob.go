...
func (c *Client) CreateBatchInferenceJob(ctx context.Context, params *CreateBatchInferenceJobInput, optFns ...func(*Options)) (*CreateBatchInferenceJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBatchInferenceJob", params, optFns, addOperationCreateBatchInferenceJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBatchInferenceJobMiddleware(stack *middleware.Stack, options Options) (err error) {
