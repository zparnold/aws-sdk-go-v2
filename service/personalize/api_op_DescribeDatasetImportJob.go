...
func (c *Client) DescribeDatasetImportJob(ctx context.Context, params *DescribeDatasetImportJobInput, optFns ...func(*Options)) (*DescribeDatasetImportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDatasetImportJob", params, optFns, addOperationDescribeDatasetImportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDatasetImportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
