...
func (c *Client) DescribeSchema(ctx context.Context, params *DescribeSchemaInput, optFns ...func(*Options)) (*DescribeSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSchema", params, optFns, addOperationDescribeSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
