...
func (c *Client) ListCampaigns(ctx context.Context, params *ListCampaignsInput, optFns ...func(*Options)) (*ListCampaignsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCampaigns", params, optFns, addOperationListCampaignsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCampaignsMiddleware(stack *middleware.Stack, options Options) (err error) {
