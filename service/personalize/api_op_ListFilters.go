...
func (c *Client) ListFilters(ctx context.Context, params *ListFiltersInput, optFns ...func(*Options)) (*ListFiltersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListFilters", params, optFns, addOperationListFiltersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListFiltersMiddleware(stack *middleware.Stack, options Options) (err error) {
