...
func (c *Client) CreateSchema(ctx context.Context, params *CreateSchemaInput, optFns ...func(*Options)) (*CreateSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSchema", params, optFns, addOperationCreateSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
