...
func (c *Client) CreateEventTracker(ctx context.Context, params *CreateEventTrackerInput, optFns ...func(*Options)) (*CreateEventTrackerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEventTracker", params, optFns, addOperationCreateEventTrackerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEventTrackerMiddleware(stack *middleware.Stack, options Options) (err error) {
