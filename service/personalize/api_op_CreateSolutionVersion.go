...
func (c *Client) CreateSolutionVersion(ctx context.Context, params *CreateSolutionVersionInput, optFns ...func(*Options)) (*CreateSolutionVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSolutionVersion", params, optFns, addOperationCreateSolutionVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSolutionVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
