...
func (c *Client) ListDatasetGroups(ctx context.Context, params *ListDatasetGroupsInput, optFns ...func(*Options)) (*ListDatasetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDatasetGroups", params, optFns, addOperationListDatasetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDatasetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
