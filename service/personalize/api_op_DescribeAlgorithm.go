...
func (c *Client) DescribeAlgorithm(ctx context.Context, params *DescribeAlgorithmInput, optFns ...func(*Options)) (*DescribeAlgorithmOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAlgorithm", params, optFns, addOperationDescribeAlgorithmMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAlgorithmMiddleware(stack *middleware.Stack, options Options) (err error) {
