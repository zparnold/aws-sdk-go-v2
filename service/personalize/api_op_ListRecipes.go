...
func (c *Client) ListRecipes(ctx context.Context, params *ListRecipesInput, optFns ...func(*Options)) (*ListRecipesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRecipes", params, optFns, addOperationListRecipesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRecipesMiddleware(stack *middleware.Stack, options Options) (err error) {
