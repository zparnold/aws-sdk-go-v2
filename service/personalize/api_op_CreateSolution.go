...
func (c *Client) CreateSolution(ctx context.Context, params *CreateSolutionInput, optFns ...func(*Options)) (*CreateSolutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSolution", params, optFns, addOperationCreateSolutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSolutionMiddleware(stack *middleware.Stack, options Options) (err error) {
