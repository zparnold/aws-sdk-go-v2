...
func (c *Client) DescribeFeatureTransformation(ctx context.Context, params *DescribeFeatureTransformationInput, optFns ...func(*Options)) (*DescribeFeatureTransformationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFeatureTransformation", params, optFns, addOperationDescribeFeatureTransformationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFeatureTransformationMiddleware(stack *middleware.Stack, options Options) (err error) {
