...
func (c *Client) UpdatePipelineNotifications(ctx context.Context, params *UpdatePipelineNotificationsInput, optFns ...func(*Options)) (*UpdatePipelineNotificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePipelineNotifications", params, optFns, addOperationUpdatePipelineNotificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePipelineNotificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
