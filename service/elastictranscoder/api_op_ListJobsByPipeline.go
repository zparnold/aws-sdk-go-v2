...
func (c *Client) ListJobsByPipeline(ctx context.Context, params *ListJobsByPipelineInput, optFns ...func(*Options)) (*ListJobsByPipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJobsByPipeline", params, optFns, addOperationListJobsByPipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJobsByPipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
