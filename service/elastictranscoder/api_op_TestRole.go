...
func (c *Client) TestRole(ctx context.Context, params *TestRoleInput, optFns ...func(*Options)) (*TestRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestRole", params, optFns, addOperationTestRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
