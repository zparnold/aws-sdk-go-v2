...
func (c *Client) ReadPipeline(ctx context.Context, params *ReadPipelineInput, optFns ...func(*Options)) (*ReadPipelineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReadPipeline", params, optFns, addOperationReadPipelineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReadPipelineMiddleware(stack *middleware.Stack, options Options) (err error) {
