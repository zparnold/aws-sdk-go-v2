...
func (c *Client) UpdatePipelineStatus(ctx context.Context, params *UpdatePipelineStatusInput, optFns ...func(*Options)) (*UpdatePipelineStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePipelineStatus", params, optFns, addOperationUpdatePipelineStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePipelineStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
