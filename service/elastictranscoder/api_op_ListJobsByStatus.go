...
func (c *Client) ListJobsByStatus(ctx context.Context, params *ListJobsByStatusInput, optFns ...func(*Options)) (*ListJobsByStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListJobsByStatus", params, optFns, addOperationListJobsByStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListJobsByStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
