...
func (c *Client) ReadPreset(ctx context.Context, params *ReadPresetInput, optFns ...func(*Options)) (*ReadPresetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ReadPreset", params, optFns, addOperationReadPresetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationReadPresetMiddleware(stack *middleware.Stack, options Options) (err error) {
