...
func (c *Client) CreatePreset(ctx context.Context, params *CreatePresetInput, optFns ...func(*Options)) (*CreatePresetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePreset", params, optFns, addOperationCreatePresetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePresetMiddleware(stack *middleware.Stack, options Options) (err error) {
