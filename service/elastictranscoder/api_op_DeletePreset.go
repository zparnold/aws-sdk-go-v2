...
func (c *Client) DeletePreset(ctx context.Context, params *DeletePresetInput, optFns ...func(*Options)) (*DeletePresetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePreset", params, optFns, addOperationDeletePresetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePresetMiddleware(stack *middleware.Stack, options Options) (err error) {
