...
func (c *Client) UpdateDataRetention(ctx context.Context, params *UpdateDataRetentionInput, optFns ...func(*Options)) (*UpdateDataRetentionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDataRetention", params, optFns, addOperationUpdateDataRetentionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDataRetentionMiddleware(stack *middleware.Stack, options Options) (err error) {
