...
func (c *Client) UpdateSignalingChannel(ctx context.Context, params *UpdateSignalingChannelInput, optFns ...func(*Options)) (*UpdateSignalingChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSignalingChannel", params, optFns, addOperationUpdateSignalingChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSignalingChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
