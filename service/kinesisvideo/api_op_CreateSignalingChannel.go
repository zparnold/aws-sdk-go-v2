...
func (c *Client) CreateSignalingChannel(ctx context.Context, params *CreateSignalingChannelInput, optFns ...func(*Options)) (*CreateSignalingChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSignalingChannel", params, optFns, addOperationCreateSignalingChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSignalingChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
