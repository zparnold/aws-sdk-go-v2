...
func (c *Client) ListSignalingChannels(ctx context.Context, params *ListSignalingChannelsInput, optFns ...func(*Options)) (*ListSignalingChannelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSignalingChannels", params, optFns, addOperationListSignalingChannelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSignalingChannelsMiddleware(stack *middleware.Stack, options Options) (err error) {
