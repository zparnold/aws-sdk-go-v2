...
func (c *Client) DescribeSignalingChannel(ctx context.Context, params *DescribeSignalingChannelInput, optFns ...func(*Options)) (*DescribeSignalingChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSignalingChannel", params, optFns, addOperationDescribeSignalingChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSignalingChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
