...
func (c *Client) TagStream(ctx context.Context, params *TagStreamInput, optFns ...func(*Options)) (*TagStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TagStream", params, optFns, addOperationTagStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTagStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
