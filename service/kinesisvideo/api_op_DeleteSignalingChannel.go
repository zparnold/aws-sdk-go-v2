...
func (c *Client) DeleteSignalingChannel(ctx context.Context, params *DeleteSignalingChannelInput, optFns ...func(*Options)) (*DeleteSignalingChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSignalingChannel", params, optFns, addOperationDeleteSignalingChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSignalingChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
