...
func (c *Client) ListTagsForStream(ctx context.Context, params *ListTagsForStreamInput, optFns ...func(*Options)) (*ListTagsForStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForStream", params, optFns, addOperationListTagsForStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
