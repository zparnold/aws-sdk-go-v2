...
func (c *Client) UntagStream(ctx context.Context, params *UntagStreamInput, optFns ...func(*Options)) (*UntagStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UntagStream", params, optFns, addOperationUntagStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUntagStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
