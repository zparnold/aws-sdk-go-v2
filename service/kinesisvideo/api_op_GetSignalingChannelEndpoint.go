...
func (c *Client) GetSignalingChannelEndpoint(ctx context.Context, params *GetSignalingChannelEndpointInput, optFns ...func(*Options)) (*GetSignalingChannelEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSignalingChannelEndpoint", params, optFns, addOperationGetSignalingChannelEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSignalingChannelEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
