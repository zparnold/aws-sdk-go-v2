...
func (c *Client) GetDataEndpoint(ctx context.Context, params *GetDataEndpointInput, optFns ...func(*Options)) (*GetDataEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataEndpoint", params, optFns, addOperationGetDataEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
