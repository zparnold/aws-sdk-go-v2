...
func (c *Client) ListExclusions(ctx context.Context, params *ListExclusionsInput, optFns ...func(*Options)) (*ListExclusionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListExclusions", params, optFns, addOperationListExclusionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListExclusionsMiddleware(stack *middleware.Stack, options Options) (err error) {
