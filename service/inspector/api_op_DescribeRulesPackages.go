...
func (c *Client) DescribeRulesPackages(ctx context.Context, params *DescribeRulesPackagesInput, optFns ...func(*Options)) (*DescribeRulesPackagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRulesPackages", params, optFns, addOperationDescribeRulesPackagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRulesPackagesMiddleware(stack *middleware.Stack, options Options) (err error) {
