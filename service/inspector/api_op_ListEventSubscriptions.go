...
func (c *Client) ListEventSubscriptions(ctx context.Context, params *ListEventSubscriptionsInput, optFns ...func(*Options)) (*ListEventSubscriptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEventSubscriptions", params, optFns, addOperationListEventSubscriptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEventSubscriptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
