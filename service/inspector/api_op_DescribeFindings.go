...
func (c *Client) DescribeFindings(ctx context.Context, params *DescribeFindingsInput, optFns ...func(*Options)) (*DescribeFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFindings", params, optFns, addOperationDescribeFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
