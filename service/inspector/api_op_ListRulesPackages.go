...
func (c *Client) ListRulesPackages(ctx context.Context, params *ListRulesPackagesInput, optFns ...func(*Options)) (*ListRulesPackagesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRulesPackages", params, optFns, addOperationListRulesPackagesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRulesPackagesMiddleware(stack *middleware.Stack, options Options) (err error) {
