...
func (c *Client) GetTelemetryMetadata(ctx context.Context, params *GetTelemetryMetadataInput, optFns ...func(*Options)) (*GetTelemetryMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTelemetryMetadata", params, optFns, addOperationGetTelemetryMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTelemetryMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
