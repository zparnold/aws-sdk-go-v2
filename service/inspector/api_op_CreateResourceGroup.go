...
func (c *Client) CreateResourceGroup(ctx context.Context, params *CreateResourceGroupInput, optFns ...func(*Options)) (*CreateResourceGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResourceGroup", params, optFns, addOperationCreateResourceGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResourceGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
