...
func (c *Client) DescribeExclusions(ctx context.Context, params *DescribeExclusionsInput, optFns ...func(*Options)) (*DescribeExclusionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeExclusions", params, optFns, addOperationDescribeExclusionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeExclusionsMiddleware(stack *middleware.Stack, options Options) (err error) {
