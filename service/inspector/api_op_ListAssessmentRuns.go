...
func (c *Client) ListAssessmentRuns(ctx context.Context, params *ListAssessmentRunsInput, optFns ...func(*Options)) (*ListAssessmentRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssessmentRuns", params, optFns, addOperationListAssessmentRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssessmentRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
