...
func (c *Client) DescribeResourceGroups(ctx context.Context, params *DescribeResourceGroupsInput, optFns ...func(*Options)) (*DescribeResourceGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeResourceGroups", params, optFns, addOperationDescribeResourceGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeResourceGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
