...
func (c *Client) AddAttributesToFindings(ctx context.Context, params *AddAttributesToFindingsInput, optFns ...func(*Options)) (*AddAttributesToFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddAttributesToFindings", params, optFns, addOperationAddAttributesToFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddAttributesToFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
