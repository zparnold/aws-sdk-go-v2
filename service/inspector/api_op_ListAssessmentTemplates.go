...
func (c *Client) ListAssessmentTemplates(ctx context.Context, params *ListAssessmentTemplatesInput, optFns ...func(*Options)) (*ListAssessmentTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssessmentTemplates", params, optFns, addOperationListAssessmentTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssessmentTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
