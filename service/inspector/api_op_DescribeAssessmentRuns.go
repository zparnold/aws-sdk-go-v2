...
func (c *Client) DescribeAssessmentRuns(ctx context.Context, params *DescribeAssessmentRunsInput, optFns ...func(*Options)) (*DescribeAssessmentRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssessmentRuns", params, optFns, addOperationDescribeAssessmentRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssessmentRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
