...
func (c *Client) DescribeAssessmentTemplates(ctx context.Context, params *DescribeAssessmentTemplatesInput, optFns ...func(*Options)) (*DescribeAssessmentTemplatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssessmentTemplates", params, optFns, addOperationDescribeAssessmentTemplatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssessmentTemplatesMiddleware(stack *middleware.Stack, options Options) (err error) {
