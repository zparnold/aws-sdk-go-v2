...
func (c *Client) ListAssessmentTargets(ctx context.Context, params *ListAssessmentTargetsInput, optFns ...func(*Options)) (*ListAssessmentTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssessmentTargets", params, optFns, addOperationListAssessmentTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssessmentTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
