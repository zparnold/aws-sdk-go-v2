...
func (c *Client) CreateExclusionsPreview(ctx context.Context, params *CreateExclusionsPreviewInput, optFns ...func(*Options)) (*CreateExclusionsPreviewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateExclusionsPreview", params, optFns, addOperationCreateExclusionsPreviewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateExclusionsPreviewMiddleware(stack *middleware.Stack, options Options) (err error) {
