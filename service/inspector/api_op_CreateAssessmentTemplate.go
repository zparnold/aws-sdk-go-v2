...
func (c *Client) CreateAssessmentTemplate(ctx context.Context, params *CreateAssessmentTemplateInput, optFns ...func(*Options)) (*CreateAssessmentTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAssessmentTemplate", params, optFns, addOperationCreateAssessmentTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAssessmentTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
