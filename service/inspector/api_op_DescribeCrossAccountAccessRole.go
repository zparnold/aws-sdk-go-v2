...
func (c *Client) DescribeCrossAccountAccessRole(ctx context.Context, params *DescribeCrossAccountAccessRoleInput, optFns ...func(*Options)) (*DescribeCrossAccountAccessRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCrossAccountAccessRole", params, optFns, addOperationDescribeCrossAccountAccessRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCrossAccountAccessRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
