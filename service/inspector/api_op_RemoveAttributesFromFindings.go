...
func (c *Client) RemoveAttributesFromFindings(ctx context.Context, params *RemoveAttributesFromFindingsInput, optFns ...func(*Options)) (*RemoveAttributesFromFindingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveAttributesFromFindings", params, optFns, addOperationRemoveAttributesFromFindingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveAttributesFromFindingsMiddleware(stack *middleware.Stack, options Options) (err error) {
