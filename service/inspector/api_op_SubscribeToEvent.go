...
func (c *Client) SubscribeToEvent(ctx context.Context, params *SubscribeToEventInput, optFns ...func(*Options)) (*SubscribeToEventOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SubscribeToEvent", params, optFns, addOperationSubscribeToEventMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubscribeToEventMiddleware(stack *middleware.Stack, options Options) (err error) {
