...
func (c *Client) PreviewAgents(ctx context.Context, params *PreviewAgentsInput, optFns ...func(*Options)) (*PreviewAgentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PreviewAgents", params, optFns, addOperationPreviewAgentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPreviewAgentsMiddleware(stack *middleware.Stack, options Options) (err error) {
