...
func (c *Client) StartAssessmentRun(ctx context.Context, params *StartAssessmentRunInput, optFns ...func(*Options)) (*StartAssessmentRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartAssessmentRun", params, optFns, addOperationStartAssessmentRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartAssessmentRunMiddleware(stack *middleware.Stack, options Options) (err error) {
