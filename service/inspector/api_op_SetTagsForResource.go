...
func (c *Client) SetTagsForResource(ctx context.Context, params *SetTagsForResourceInput, optFns ...func(*Options)) (*SetTagsForResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetTagsForResource", params, optFns, addOperationSetTagsForResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetTagsForResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
