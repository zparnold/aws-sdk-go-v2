...
func (c *Client) RegisterCrossAccountAccessRole(ctx context.Context, params *RegisterCrossAccountAccessRoleInput, optFns ...func(*Options)) (*RegisterCrossAccountAccessRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterCrossAccountAccessRole", params, optFns, addOperationRegisterCrossAccountAccessRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterCrossAccountAccessRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
