...
func (c *Client) DeleteAssessmentRun(ctx context.Context, params *DeleteAssessmentRunInput, optFns ...func(*Options)) (*DeleteAssessmentRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAssessmentRun", params, optFns, addOperationDeleteAssessmentRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAssessmentRunMiddleware(stack *middleware.Stack, options Options) (err error) {
