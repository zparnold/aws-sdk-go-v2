...
func (c *Client) ListAssessmentRunAgents(ctx context.Context, params *ListAssessmentRunAgentsInput, optFns ...func(*Options)) (*ListAssessmentRunAgentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssessmentRunAgents", params, optFns, addOperationListAssessmentRunAgentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssessmentRunAgentsMiddleware(stack *middleware.Stack, options Options) (err error) {
