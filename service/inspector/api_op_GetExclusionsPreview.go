...
func (c *Client) GetExclusionsPreview(ctx context.Context, params *GetExclusionsPreviewInput, optFns ...func(*Options)) (*GetExclusionsPreviewOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetExclusionsPreview", params, optFns, addOperationGetExclusionsPreviewMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetExclusionsPreviewMiddleware(stack *middleware.Stack, options Options) (err error) {
