...
func (c *Client) GetAssessmentReport(ctx context.Context, params *GetAssessmentReportInput, optFns ...func(*Options)) (*GetAssessmentReportOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAssessmentReport", params, optFns, addOperationGetAssessmentReportMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAssessmentReportMiddleware(stack *middleware.Stack, options Options) (err error) {
