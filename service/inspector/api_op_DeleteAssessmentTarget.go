...
func (c *Client) DeleteAssessmentTarget(ctx context.Context, params *DeleteAssessmentTargetInput, optFns ...func(*Options)) (*DeleteAssessmentTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAssessmentTarget", params, optFns, addOperationDeleteAssessmentTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAssessmentTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
