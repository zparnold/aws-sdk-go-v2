...
func (c *Client) UnsubscribeFromEvent(ctx context.Context, params *UnsubscribeFromEventInput, optFns ...func(*Options)) (*UnsubscribeFromEventOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnsubscribeFromEvent", params, optFns, addOperationUnsubscribeFromEventMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnsubscribeFromEventMiddleware(stack *middleware.Stack, options Options) (err error) {
