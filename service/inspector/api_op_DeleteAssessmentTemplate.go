...
func (c *Client) DeleteAssessmentTemplate(ctx context.Context, params *DeleteAssessmentTemplateInput, optFns ...func(*Options)) (*DeleteAssessmentTemplateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAssessmentTemplate", params, optFns, addOperationDeleteAssessmentTemplateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAssessmentTemplateMiddleware(stack *middleware.Stack, options Options) (err error) {
