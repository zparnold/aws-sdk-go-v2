...
func (c *Client) CreateAssessmentTarget(ctx context.Context, params *CreateAssessmentTargetInput, optFns ...func(*Options)) (*CreateAssessmentTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAssessmentTarget", params, optFns, addOperationCreateAssessmentTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAssessmentTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
