...
func (c *Client) StopAssessmentRun(ctx context.Context, params *StopAssessmentRunInput, optFns ...func(*Options)) (*StopAssessmentRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopAssessmentRun", params, optFns, addOperationStopAssessmentRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopAssessmentRunMiddleware(stack *middleware.Stack, options Options) (err error) {
