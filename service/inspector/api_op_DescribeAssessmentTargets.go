...
func (c *Client) DescribeAssessmentTargets(ctx context.Context, params *DescribeAssessmentTargetsInput, optFns ...func(*Options)) (*DescribeAssessmentTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssessmentTargets", params, optFns, addOperationDescribeAssessmentTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssessmentTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
