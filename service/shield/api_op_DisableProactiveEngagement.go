...
func (c *Client) DisableProactiveEngagement(ctx context.Context, params *DisableProactiveEngagementInput, optFns ...func(*Options)) (*DisableProactiveEngagementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableProactiveEngagement", params, optFns, addOperationDisableProactiveEngagementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableProactiveEngagementMiddleware(stack *middleware.Stack, options Options) (err error) {
