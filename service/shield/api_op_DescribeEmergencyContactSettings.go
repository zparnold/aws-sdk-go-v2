...
func (c *Client) DescribeEmergencyContactSettings(ctx context.Context, params *DescribeEmergencyContactSettingsInput, optFns ...func(*Options)) (*DescribeEmergencyContactSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEmergencyContactSettings", params, optFns, addOperationDescribeEmergencyContactSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEmergencyContactSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
