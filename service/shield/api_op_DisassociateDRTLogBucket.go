...
func (c *Client) DisassociateDRTLogBucket(ctx context.Context, params *DisassociateDRTLogBucketInput, optFns ...func(*Options)) (*DisassociateDRTLogBucketOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateDRTLogBucket", params, optFns, addOperationDisassociateDRTLogBucketMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateDRTLogBucketMiddleware(stack *middleware.Stack, options Options) (err error) {
