...
func (c *Client) DescribeSubscription(ctx context.Context, params *DescribeSubscriptionInput, optFns ...func(*Options)) (*DescribeSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSubscription", params, optFns, addOperationDescribeSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
