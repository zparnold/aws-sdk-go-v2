...
func (c *Client) DisassociateHealthCheck(ctx context.Context, params *DisassociateHealthCheckInput, optFns ...func(*Options)) (*DisassociateHealthCheckOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateHealthCheck", params, optFns, addOperationDisassociateHealthCheckMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateHealthCheckMiddleware(stack *middleware.Stack, options Options) (err error) {
