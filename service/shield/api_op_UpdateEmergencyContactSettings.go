...
func (c *Client) UpdateEmergencyContactSettings(ctx context.Context, params *UpdateEmergencyContactSettingsInput, optFns ...func(*Options)) (*UpdateEmergencyContactSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateEmergencyContactSettings", params, optFns, addOperationUpdateEmergencyContactSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateEmergencyContactSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
