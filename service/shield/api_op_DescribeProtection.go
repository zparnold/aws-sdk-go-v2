...
func (c *Client) DescribeProtection(ctx context.Context, params *DescribeProtectionInput, optFns ...func(*Options)) (*DescribeProtectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeProtection", params, optFns, addOperationDescribeProtectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeProtectionMiddleware(stack *middleware.Stack, options Options) (err error) {
