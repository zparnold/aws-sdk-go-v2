...
func (c *Client) GetSubscriptionState(ctx context.Context, params *GetSubscriptionStateInput, optFns ...func(*Options)) (*GetSubscriptionStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSubscriptionState", params, optFns, addOperationGetSubscriptionStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSubscriptionStateMiddleware(stack *middleware.Stack, options Options) (err error) {
