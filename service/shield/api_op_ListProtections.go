...
func (c *Client) ListProtections(ctx context.Context, params *ListProtectionsInput, optFns ...func(*Options)) (*ListProtectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListProtections", params, optFns, addOperationListProtectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListProtectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
