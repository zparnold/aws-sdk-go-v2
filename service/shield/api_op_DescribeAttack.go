...
func (c *Client) DescribeAttack(ctx context.Context, params *DescribeAttackInput, optFns ...func(*Options)) (*DescribeAttackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAttack", params, optFns, addOperationDescribeAttackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAttackMiddleware(stack *middleware.Stack, options Options) (err error) {
