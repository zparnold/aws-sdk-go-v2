...
func (c *Client) CreateSubscription(ctx context.Context, params *CreateSubscriptionInput, optFns ...func(*Options)) (*CreateSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSubscription", params, optFns, addOperationCreateSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
