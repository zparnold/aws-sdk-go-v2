...
func (c *Client) DisassociateDRTRole(ctx context.Context, params *DisassociateDRTRoleInput, optFns ...func(*Options)) (*DisassociateDRTRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisassociateDRTRole", params, optFns, addOperationDisassociateDRTRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisassociateDRTRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
