...
func (c *Client) AssociateHealthCheck(ctx context.Context, params *AssociateHealthCheckInput, optFns ...func(*Options)) (*AssociateHealthCheckOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateHealthCheck", params, optFns, addOperationAssociateHealthCheckMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateHealthCheckMiddleware(stack *middleware.Stack, options Options) (err error) {
