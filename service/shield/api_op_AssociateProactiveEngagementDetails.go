...
func (c *Client) AssociateProactiveEngagementDetails(ctx context.Context, params *AssociateProactiveEngagementDetailsInput, optFns ...func(*Options)) (*AssociateProactiveEngagementDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateProactiveEngagementDetails", params, optFns, addOperationAssociateProactiveEngagementDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateProactiveEngagementDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
