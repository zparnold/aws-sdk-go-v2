...
func (c *Client) AssociateDRTRole(ctx context.Context, params *AssociateDRTRoleInput, optFns ...func(*Options)) (*AssociateDRTRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateDRTRole", params, optFns, addOperationAssociateDRTRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateDRTRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
