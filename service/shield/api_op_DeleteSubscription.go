...
func (c *Client) DeleteSubscription(ctx context.Context, params *DeleteSubscriptionInput, optFns ...func(*Options)) (*DeleteSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSubscription", params, optFns, addOperationDeleteSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
