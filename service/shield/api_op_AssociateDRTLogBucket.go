...
func (c *Client) AssociateDRTLogBucket(ctx context.Context, params *AssociateDRTLogBucketInput, optFns ...func(*Options)) (*AssociateDRTLogBucketOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateDRTLogBucket", params, optFns, addOperationAssociateDRTLogBucketMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateDRTLogBucketMiddleware(stack *middleware.Stack, options Options) (err error) {
