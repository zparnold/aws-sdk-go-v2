...
func (c *Client) CreateProtection(ctx context.Context, params *CreateProtectionInput, optFns ...func(*Options)) (*CreateProtectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateProtection", params, optFns, addOperationCreateProtectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateProtectionMiddleware(stack *middleware.Stack, options Options) (err error) {
