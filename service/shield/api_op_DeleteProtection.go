...
func (c *Client) DeleteProtection(ctx context.Context, params *DeleteProtectionInput, optFns ...func(*Options)) (*DeleteProtectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteProtection", params, optFns, addOperationDeleteProtectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteProtectionMiddleware(stack *middleware.Stack, options Options) (err error) {
