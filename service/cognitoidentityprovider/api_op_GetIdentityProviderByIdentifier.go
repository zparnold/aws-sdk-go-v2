...
func (c *Client) GetIdentityProviderByIdentifier(ctx context.Context, params *GetIdentityProviderByIdentifierInput, optFns ...func(*Options)) (*GetIdentityProviderByIdentifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIdentityProviderByIdentifier", params, optFns, addOperationGetIdentityProviderByIdentifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIdentityProviderByIdentifierMiddleware(stack *middleware.Stack, options Options) (err error) {
