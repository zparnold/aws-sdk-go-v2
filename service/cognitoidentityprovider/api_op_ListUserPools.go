...
func (c *Client) ListUserPools(ctx context.Context, params *ListUserPoolsInput, optFns ...func(*Options)) (*ListUserPoolsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserPools", params, optFns, addOperationListUserPoolsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserPoolsMiddleware(stack *middleware.Stack, options Options) (err error) {
