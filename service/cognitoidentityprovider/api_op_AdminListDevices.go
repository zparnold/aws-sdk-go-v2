...
func (c *Client) AdminListDevices(ctx context.Context, params *AdminListDevicesInput, optFns ...func(*Options)) (*AdminListDevicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminListDevices", params, optFns, addOperationAdminListDevicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminListDevicesMiddleware(stack *middleware.Stack, options Options) (err error) {
