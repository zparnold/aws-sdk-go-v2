...
func (c *Client) GetUICustomization(ctx context.Context, params *GetUICustomizationInput, optFns ...func(*Options)) (*GetUICustomizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUICustomization", params, optFns, addOperationGetUICustomizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUICustomizationMiddleware(stack *middleware.Stack, options Options) (err error) {
