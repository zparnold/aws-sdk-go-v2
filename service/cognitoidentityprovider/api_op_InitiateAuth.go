...
func (c *Client) InitiateAuth(ctx context.Context, params *InitiateAuthInput, optFns ...func(*Options)) (*InitiateAuthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InitiateAuth", params, optFns, addOperationInitiateAuthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInitiateAuthMiddleware(stack *middleware.Stack, options Options) (err error) {
