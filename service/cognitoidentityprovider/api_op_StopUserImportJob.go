...
func (c *Client) StopUserImportJob(ctx context.Context, params *StopUserImportJobInput, optFns ...func(*Options)) (*StopUserImportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopUserImportJob", params, optFns, addOperationStopUserImportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopUserImportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
