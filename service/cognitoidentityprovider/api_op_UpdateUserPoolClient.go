...
func (c *Client) UpdateUserPoolClient(ctx context.Context, params *UpdateUserPoolClientInput, optFns ...func(*Options)) (*UpdateUserPoolClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserPoolClient", params, optFns, addOperationUpdateUserPoolClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserPoolClientMiddleware(stack *middleware.Stack, options Options) (err error) {
