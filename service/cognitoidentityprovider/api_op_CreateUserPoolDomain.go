...
func (c *Client) CreateUserPoolDomain(ctx context.Context, params *CreateUserPoolDomainInput, optFns ...func(*Options)) (*CreateUserPoolDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUserPoolDomain", params, optFns, addOperationCreateUserPoolDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUserPoolDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
