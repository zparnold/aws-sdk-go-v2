...
func (c *Client) SetUserSettings(ctx context.Context, params *SetUserSettingsInput, optFns ...func(*Options)) (*SetUserSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetUserSettings", params, optFns, addOperationSetUserSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetUserSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
