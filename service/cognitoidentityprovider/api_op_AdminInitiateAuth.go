...
func (c *Client) AdminInitiateAuth(ctx context.Context, params *AdminInitiateAuthInput, optFns ...func(*Options)) (*AdminInitiateAuthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminInitiateAuth", params, optFns, addOperationAdminInitiateAuthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminInitiateAuthMiddleware(stack *middleware.Stack, options Options) (err error) {
