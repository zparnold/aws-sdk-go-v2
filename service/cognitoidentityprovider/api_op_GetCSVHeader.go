...
func (c *Client) GetCSVHeader(ctx context.Context, params *GetCSVHeaderInput, optFns ...func(*Options)) (*GetCSVHeaderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCSVHeader", params, optFns, addOperationGetCSVHeaderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCSVHeaderMiddleware(stack *middleware.Stack, options Options) (err error) {
