...
func (c *Client) ListUsersInGroup(ctx context.Context, params *ListUsersInGroupInput, optFns ...func(*Options)) (*ListUsersInGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUsersInGroup", params, optFns, addOperationListUsersInGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUsersInGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
