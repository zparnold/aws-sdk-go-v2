...
func (c *Client) AdminUpdateAuthEventFeedback(ctx context.Context, params *AdminUpdateAuthEventFeedbackInput, optFns ...func(*Options)) (*AdminUpdateAuthEventFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminUpdateAuthEventFeedback", params, optFns, addOperationAdminUpdateAuthEventFeedbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminUpdateAuthEventFeedbackMiddleware(stack *middleware.Stack, options Options) (err error) {
