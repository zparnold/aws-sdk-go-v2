...
func (c *Client) CreateUserPoolClient(ctx context.Context, params *CreateUserPoolClientInput, optFns ...func(*Options)) (*CreateUserPoolClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUserPoolClient", params, optFns, addOperationCreateUserPoolClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUserPoolClientMiddleware(stack *middleware.Stack, options Options) (err error) {
