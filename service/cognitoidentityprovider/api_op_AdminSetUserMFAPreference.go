...
func (c *Client) AdminSetUserMFAPreference(ctx context.Context, params *AdminSetUserMFAPreferenceInput, optFns ...func(*Options)) (*AdminSetUserMFAPreferenceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminSetUserMFAPreference", params, optFns, addOperationAdminSetUserMFAPreferenceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminSetUserMFAPreferenceMiddleware(stack *middleware.Stack, options Options) (err error) {
