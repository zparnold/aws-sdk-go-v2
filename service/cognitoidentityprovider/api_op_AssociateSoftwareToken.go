...
func (c *Client) AssociateSoftwareToken(ctx context.Context, params *AssociateSoftwareTokenInput, optFns ...func(*Options)) (*AssociateSoftwareTokenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AssociateSoftwareToken", params, optFns, addOperationAssociateSoftwareTokenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAssociateSoftwareTokenMiddleware(stack *middleware.Stack, options Options) (err error) {
