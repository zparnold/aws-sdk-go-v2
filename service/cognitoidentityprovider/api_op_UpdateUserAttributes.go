...
func (c *Client) UpdateUserAttributes(ctx context.Context, params *UpdateUserAttributesInput, optFns ...func(*Options)) (*UpdateUserAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserAttributes", params, optFns, addOperationUpdateUserAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
