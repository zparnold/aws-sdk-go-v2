...
func (c *Client) AdminGetDevice(ctx context.Context, params *AdminGetDeviceInput, optFns ...func(*Options)) (*AdminGetDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminGetDevice", params, optFns, addOperationAdminGetDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminGetDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
