...
func (c *Client) SetUICustomization(ctx context.Context, params *SetUICustomizationInput, optFns ...func(*Options)) (*SetUICustomizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetUICustomization", params, optFns, addOperationSetUICustomizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetUICustomizationMiddleware(stack *middleware.Stack, options Options) (err error) {
