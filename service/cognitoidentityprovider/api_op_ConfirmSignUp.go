...
func (c *Client) ConfirmSignUp(ctx context.Context, params *ConfirmSignUpInput, optFns ...func(*Options)) (*ConfirmSignUpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmSignUp", params, optFns, addOperationConfirmSignUpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmSignUpMiddleware(stack *middleware.Stack, options Options) (err error) {
