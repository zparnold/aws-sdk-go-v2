...
func (c *Client) VerifyUserAttribute(ctx context.Context, params *VerifyUserAttributeInput, optFns ...func(*Options)) (*VerifyUserAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "VerifyUserAttribute", params, optFns, addOperationVerifyUserAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationVerifyUserAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
