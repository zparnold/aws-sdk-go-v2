...
func (c *Client) DescribeResourceServer(ctx context.Context, params *DescribeResourceServerInput, optFns ...func(*Options)) (*DescribeResourceServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeResourceServer", params, optFns, addOperationDescribeResourceServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeResourceServerMiddleware(stack *middleware.Stack, options Options) (err error) {
