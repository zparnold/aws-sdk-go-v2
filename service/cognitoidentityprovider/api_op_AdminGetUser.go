...
func (c *Client) AdminGetUser(ctx context.Context, params *AdminGetUserInput, optFns ...func(*Options)) (*AdminGetUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminGetUser", params, optFns, addOperationAdminGetUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminGetUserMiddleware(stack *middleware.Stack, options Options) (err error) {
