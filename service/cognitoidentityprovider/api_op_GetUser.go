...
func (c *Client) GetUser(ctx context.Context, params *GetUserInput, optFns ...func(*Options)) (*GetUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUser", params, optFns, addOperationGetUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserMiddleware(stack *middleware.Stack, options Options) (err error) {
