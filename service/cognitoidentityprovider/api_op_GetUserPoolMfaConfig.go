...
func (c *Client) GetUserPoolMfaConfig(ctx context.Context, params *GetUserPoolMfaConfigInput, optFns ...func(*Options)) (*GetUserPoolMfaConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUserPoolMfaConfig", params, optFns, addOperationGetUserPoolMfaConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserPoolMfaConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
