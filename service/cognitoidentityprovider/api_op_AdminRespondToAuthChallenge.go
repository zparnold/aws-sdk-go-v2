...
func (c *Client) AdminRespondToAuthChallenge(ctx context.Context, params *AdminRespondToAuthChallengeInput, optFns ...func(*Options)) (*AdminRespondToAuthChallengeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminRespondToAuthChallenge", params, optFns, addOperationAdminRespondToAuthChallengeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminRespondToAuthChallengeMiddleware(stack *middleware.Stack, options Options) (err error) {
