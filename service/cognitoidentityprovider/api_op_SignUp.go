...
func (c *Client) SignUp(ctx context.Context, params *SignUpInput, optFns ...func(*Options)) (*SignUpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SignUp", params, optFns, addOperationSignUpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSignUpMiddleware(stack *middleware.Stack, options Options) (err error) {
