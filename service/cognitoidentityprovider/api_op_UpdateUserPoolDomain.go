...
func (c *Client) UpdateUserPoolDomain(ctx context.Context, params *UpdateUserPoolDomainInput, optFns ...func(*Options)) (*UpdateUserPoolDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserPoolDomain", params, optFns, addOperationUpdateUserPoolDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserPoolDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
