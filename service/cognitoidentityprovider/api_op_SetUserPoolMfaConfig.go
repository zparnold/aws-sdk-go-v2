...
func (c *Client) SetUserPoolMfaConfig(ctx context.Context, params *SetUserPoolMfaConfigInput, optFns ...func(*Options)) (*SetUserPoolMfaConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetUserPoolMfaConfig", params, optFns, addOperationSetUserPoolMfaConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetUserPoolMfaConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
