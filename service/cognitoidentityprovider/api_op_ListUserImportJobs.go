...
func (c *Client) ListUserImportJobs(ctx context.Context, params *ListUserImportJobsInput, optFns ...func(*Options)) (*ListUserImportJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserImportJobs", params, optFns, addOperationListUserImportJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserImportJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
