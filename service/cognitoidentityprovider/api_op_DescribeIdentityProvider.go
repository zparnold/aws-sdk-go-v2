...
func (c *Client) DescribeIdentityProvider(ctx context.Context, params *DescribeIdentityProviderInput, optFns ...func(*Options)) (*DescribeIdentityProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeIdentityProvider", params, optFns, addOperationDescribeIdentityProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeIdentityProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
