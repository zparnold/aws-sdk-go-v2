...
func (c *Client) AdminLinkProviderForUser(ctx context.Context, params *AdminLinkProviderForUserInput, optFns ...func(*Options)) (*AdminLinkProviderForUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminLinkProviderForUser", params, optFns, addOperationAdminLinkProviderForUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminLinkProviderForUserMiddleware(stack *middleware.Stack, options Options) (err error) {
