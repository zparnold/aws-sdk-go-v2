...
func (c *Client) SetUserMFAPreference(ctx context.Context, params *SetUserMFAPreferenceInput, optFns ...func(*Options)) (*SetUserMFAPreferenceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetUserMFAPreference", params, optFns, addOperationSetUserMFAPreferenceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetUserMFAPreferenceMiddleware(stack *middleware.Stack, options Options) (err error) {
