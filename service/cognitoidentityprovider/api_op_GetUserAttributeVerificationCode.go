...
func (c *Client) GetUserAttributeVerificationCode(ctx context.Context, params *GetUserAttributeVerificationCodeInput, optFns ...func(*Options)) (*GetUserAttributeVerificationCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUserAttributeVerificationCode", params, optFns, addOperationGetUserAttributeVerificationCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserAttributeVerificationCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
