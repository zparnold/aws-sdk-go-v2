...
func (c *Client) StartUserImportJob(ctx context.Context, params *StartUserImportJobInput, optFns ...func(*Options)) (*StartUserImportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartUserImportJob", params, optFns, addOperationStartUserImportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartUserImportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
