...
func (c *Client) AdminAddUserToGroup(ctx context.Context, params *AdminAddUserToGroupInput, optFns ...func(*Options)) (*AdminAddUserToGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminAddUserToGroup", params, optFns, addOperationAdminAddUserToGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminAddUserToGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
