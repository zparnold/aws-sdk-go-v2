...
func (c *Client) AdminSetUserSettings(ctx context.Context, params *AdminSetUserSettingsInput, optFns ...func(*Options)) (*AdminSetUserSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminSetUserSettings", params, optFns, addOperationAdminSetUserSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminSetUserSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
