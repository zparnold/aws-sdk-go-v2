...
func (c *Client) ConfirmForgotPassword(ctx context.Context, params *ConfirmForgotPasswordInput, optFns ...func(*Options)) (*ConfirmForgotPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmForgotPassword", params, optFns, addOperationConfirmForgotPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmForgotPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
