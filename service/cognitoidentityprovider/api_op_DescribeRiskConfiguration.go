...
func (c *Client) DescribeRiskConfiguration(ctx context.Context, params *DescribeRiskConfigurationInput, optFns ...func(*Options)) (*DescribeRiskConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRiskConfiguration", params, optFns, addOperationDescribeRiskConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRiskConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
