...
func (c *Client) AdminDeleteUser(ctx context.Context, params *AdminDeleteUserInput, optFns ...func(*Options)) (*AdminDeleteUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminDeleteUser", params, optFns, addOperationAdminDeleteUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminDeleteUserMiddleware(stack *middleware.Stack, options Options) (err error) {
