...
func (c *Client) VerifySoftwareToken(ctx context.Context, params *VerifySoftwareTokenInput, optFns ...func(*Options)) (*VerifySoftwareTokenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "VerifySoftwareToken", params, optFns, addOperationVerifySoftwareTokenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationVerifySoftwareTokenMiddleware(stack *middleware.Stack, options Options) (err error) {
