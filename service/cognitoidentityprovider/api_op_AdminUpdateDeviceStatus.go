...
func (c *Client) AdminUpdateDeviceStatus(ctx context.Context, params *AdminUpdateDeviceStatusInput, optFns ...func(*Options)) (*AdminUpdateDeviceStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminUpdateDeviceStatus", params, optFns, addOperationAdminUpdateDeviceStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminUpdateDeviceStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
