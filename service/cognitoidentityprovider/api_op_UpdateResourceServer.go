...
func (c *Client) UpdateResourceServer(ctx context.Context, params *UpdateResourceServerInput, optFns ...func(*Options)) (*UpdateResourceServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResourceServer", params, optFns, addOperationUpdateResourceServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResourceServerMiddleware(stack *middleware.Stack, options Options) (err error) {
