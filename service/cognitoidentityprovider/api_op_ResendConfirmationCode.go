...
func (c *Client) ResendConfirmationCode(ctx context.Context, params *ResendConfirmationCodeInput, optFns ...func(*Options)) (*ResendConfirmationCodeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResendConfirmationCode", params, optFns, addOperationResendConfirmationCodeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResendConfirmationCodeMiddleware(stack *middleware.Stack, options Options) (err error) {
