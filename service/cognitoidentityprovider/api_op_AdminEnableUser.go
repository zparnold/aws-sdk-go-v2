...
func (c *Client) AdminEnableUser(ctx context.Context, params *AdminEnableUserInput, optFns ...func(*Options)) (*AdminEnableUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminEnableUser", params, optFns, addOperationAdminEnableUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminEnableUserMiddleware(stack *middleware.Stack, options Options) (err error) {
