...
func (c *Client) DescribeUserImportJob(ctx context.Context, params *DescribeUserImportJobInput, optFns ...func(*Options)) (*DescribeUserImportJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUserImportJob", params, optFns, addOperationDescribeUserImportJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUserImportJobMiddleware(stack *middleware.Stack, options Options) (err error) {
