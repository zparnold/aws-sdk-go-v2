...
func (c *Client) ListResourceServers(ctx context.Context, params *ListResourceServersInput, optFns ...func(*Options)) (*ListResourceServersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceServers", params, optFns, addOperationListResourceServersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceServersMiddleware(stack *middleware.Stack, options Options) (err error) {
