...
func (c *Client) AdminDisableProviderForUser(ctx context.Context, params *AdminDisableProviderForUserInput, optFns ...func(*Options)) (*AdminDisableProviderForUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminDisableProviderForUser", params, optFns, addOperationAdminDisableProviderForUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminDisableProviderForUserMiddleware(stack *middleware.Stack, options Options) (err error) {
