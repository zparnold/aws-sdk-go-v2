...
func (c *Client) AdminForgetDevice(ctx context.Context, params *AdminForgetDeviceInput, optFns ...func(*Options)) (*AdminForgetDeviceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminForgetDevice", params, optFns, addOperationAdminForgetDeviceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminForgetDeviceMiddleware(stack *middleware.Stack, options Options) (err error) {
