...
func (c *Client) AdminDeleteUserAttributes(ctx context.Context, params *AdminDeleteUserAttributesInput, optFns ...func(*Options)) (*AdminDeleteUserAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminDeleteUserAttributes", params, optFns, addOperationAdminDeleteUserAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminDeleteUserAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
