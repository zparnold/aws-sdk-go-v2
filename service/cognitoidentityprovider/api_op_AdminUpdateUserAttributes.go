...
func (c *Client) AdminUpdateUserAttributes(ctx context.Context, params *AdminUpdateUserAttributesInput, optFns ...func(*Options)) (*AdminUpdateUserAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminUpdateUserAttributes", params, optFns, addOperationAdminUpdateUserAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminUpdateUserAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
