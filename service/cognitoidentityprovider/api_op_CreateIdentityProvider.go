...
func (c *Client) CreateIdentityProvider(ctx context.Context, params *CreateIdentityProviderInput, optFns ...func(*Options)) (*CreateIdentityProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIdentityProvider", params, optFns, addOperationCreateIdentityProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIdentityProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
