...
func (c *Client) DeleteIdentityProvider(ctx context.Context, params *DeleteIdentityProviderInput, optFns ...func(*Options)) (*DeleteIdentityProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteIdentityProvider", params, optFns, addOperationDeleteIdentityProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteIdentityProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
