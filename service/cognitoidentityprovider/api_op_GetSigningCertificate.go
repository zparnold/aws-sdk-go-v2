...
func (c *Client) GetSigningCertificate(ctx context.Context, params *GetSigningCertificateInput, optFns ...func(*Options)) (*GetSigningCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSigningCertificate", params, optFns, addOperationGetSigningCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSigningCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
