...
func (c *Client) AdminResetUserPassword(ctx context.Context, params *AdminResetUserPasswordInput, optFns ...func(*Options)) (*AdminResetUserPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminResetUserPassword", params, optFns, addOperationAdminResetUserPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminResetUserPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
