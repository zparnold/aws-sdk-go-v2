...
func (c *Client) UpdateUserPool(ctx context.Context, params *UpdateUserPoolInput, optFns ...func(*Options)) (*UpdateUserPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserPool", params, optFns, addOperationUpdateUserPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
