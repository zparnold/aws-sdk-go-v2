...
func (c *Client) AdminConfirmSignUp(ctx context.Context, params *AdminConfirmSignUpInput, optFns ...func(*Options)) (*AdminConfirmSignUpOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminConfirmSignUp", params, optFns, addOperationAdminConfirmSignUpMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminConfirmSignUpMiddleware(stack *middleware.Stack, options Options) (err error) {
