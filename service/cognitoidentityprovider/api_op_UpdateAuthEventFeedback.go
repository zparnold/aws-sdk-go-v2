...
func (c *Client) UpdateAuthEventFeedback(ctx context.Context, params *UpdateAuthEventFeedbackInput, optFns ...func(*Options)) (*UpdateAuthEventFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAuthEventFeedback", params, optFns, addOperationUpdateAuthEventFeedbackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAuthEventFeedbackMiddleware(stack *middleware.Stack, options Options) (err error) {
