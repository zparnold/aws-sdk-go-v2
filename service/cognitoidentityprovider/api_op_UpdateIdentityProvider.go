...
func (c *Client) UpdateIdentityProvider(ctx context.Context, params *UpdateIdentityProviderInput, optFns ...func(*Options)) (*UpdateIdentityProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIdentityProvider", params, optFns, addOperationUpdateIdentityProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIdentityProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
