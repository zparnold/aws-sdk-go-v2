...
func (c *Client) DeleteUserPoolClient(ctx context.Context, params *DeleteUserPoolClientInput, optFns ...func(*Options)) (*DeleteUserPoolClientOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserPoolClient", params, optFns, addOperationDeleteUserPoolClientMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserPoolClientMiddleware(stack *middleware.Stack, options Options) (err error) {
