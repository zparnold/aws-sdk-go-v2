...
func (c *Client) UpdateDeviceStatus(ctx context.Context, params *UpdateDeviceStatusInput, optFns ...func(*Options)) (*UpdateDeviceStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDeviceStatus", params, optFns, addOperationUpdateDeviceStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDeviceStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
