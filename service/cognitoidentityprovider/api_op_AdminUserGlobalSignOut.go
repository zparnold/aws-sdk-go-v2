...
func (c *Client) AdminUserGlobalSignOut(ctx context.Context, params *AdminUserGlobalSignOutInput, optFns ...func(*Options)) (*AdminUserGlobalSignOutOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminUserGlobalSignOut", params, optFns, addOperationAdminUserGlobalSignOutMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminUserGlobalSignOutMiddleware(stack *middleware.Stack, options Options) (err error) {
