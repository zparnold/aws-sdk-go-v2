...
func (c *Client) AdminRemoveUserFromGroup(ctx context.Context, params *AdminRemoveUserFromGroupInput, optFns ...func(*Options)) (*AdminRemoveUserFromGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminRemoveUserFromGroup", params, optFns, addOperationAdminRemoveUserFromGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminRemoveUserFromGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
