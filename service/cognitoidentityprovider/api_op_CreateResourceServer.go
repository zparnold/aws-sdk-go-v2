...
func (c *Client) CreateResourceServer(ctx context.Context, params *CreateResourceServerInput, optFns ...func(*Options)) (*CreateResourceServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResourceServer", params, optFns, addOperationCreateResourceServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResourceServerMiddleware(stack *middleware.Stack, options Options) (err error) {
