...
func (c *Client) AdminListUserAuthEvents(ctx context.Context, params *AdminListUserAuthEventsInput, optFns ...func(*Options)) (*AdminListUserAuthEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminListUserAuthEvents", params, optFns, addOperationAdminListUserAuthEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminListUserAuthEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
