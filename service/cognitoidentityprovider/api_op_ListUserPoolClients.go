...
func (c *Client) ListUserPoolClients(ctx context.Context, params *ListUserPoolClientsInput, optFns ...func(*Options)) (*ListUserPoolClientsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListUserPoolClients", params, optFns, addOperationListUserPoolClientsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListUserPoolClientsMiddleware(stack *middleware.Stack, options Options) (err error) {
