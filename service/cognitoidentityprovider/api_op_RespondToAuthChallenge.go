...
func (c *Client) RespondToAuthChallenge(ctx context.Context, params *RespondToAuthChallengeInput, optFns ...func(*Options)) (*RespondToAuthChallengeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RespondToAuthChallenge", params, optFns, addOperationRespondToAuthChallengeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRespondToAuthChallengeMiddleware(stack *middleware.Stack, options Options) (err error) {
