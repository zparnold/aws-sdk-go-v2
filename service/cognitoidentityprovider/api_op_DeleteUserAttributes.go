...
func (c *Client) DeleteUserAttributes(ctx context.Context, params *DeleteUserAttributesInput, optFns ...func(*Options)) (*DeleteUserAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserAttributes", params, optFns, addOperationDeleteUserAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
