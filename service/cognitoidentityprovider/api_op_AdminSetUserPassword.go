...
func (c *Client) AdminSetUserPassword(ctx context.Context, params *AdminSetUserPasswordInput, optFns ...func(*Options)) (*AdminSetUserPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminSetUserPassword", params, optFns, addOperationAdminSetUserPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminSetUserPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
