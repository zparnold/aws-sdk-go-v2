...
func (c *Client) ForgotPassword(ctx context.Context, params *ForgotPasswordInput, optFns ...func(*Options)) (*ForgotPasswordOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ForgotPassword", params, optFns, addOperationForgotPasswordMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationForgotPasswordMiddleware(stack *middleware.Stack, options Options) (err error) {
