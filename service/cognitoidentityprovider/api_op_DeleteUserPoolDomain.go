...
func (c *Client) DeleteUserPoolDomain(ctx context.Context, params *DeleteUserPoolDomainInput, optFns ...func(*Options)) (*DeleteUserPoolDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserPoolDomain", params, optFns, addOperationDeleteUserPoolDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserPoolDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
