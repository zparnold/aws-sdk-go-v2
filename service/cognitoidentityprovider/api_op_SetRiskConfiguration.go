...
func (c *Client) SetRiskConfiguration(ctx context.Context, params *SetRiskConfigurationInput, optFns ...func(*Options)) (*SetRiskConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetRiskConfiguration", params, optFns, addOperationSetRiskConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetRiskConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
