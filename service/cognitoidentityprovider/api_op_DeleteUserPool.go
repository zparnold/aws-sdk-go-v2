...
func (c *Client) DeleteUserPool(ctx context.Context, params *DeleteUserPoolInput, optFns ...func(*Options)) (*DeleteUserPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserPool", params, optFns, addOperationDeleteUserPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
