...
func (c *Client) DescribeUserPoolDomain(ctx context.Context, params *DescribeUserPoolDomainInput, optFns ...func(*Options)) (*DescribeUserPoolDomainOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeUserPoolDomain", params, optFns, addOperationDescribeUserPoolDomainMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeUserPoolDomainMiddleware(stack *middleware.Stack, options Options) (err error) {
