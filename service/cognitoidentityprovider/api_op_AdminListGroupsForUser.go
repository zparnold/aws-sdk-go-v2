...
func (c *Client) AdminListGroupsForUser(ctx context.Context, params *AdminListGroupsForUserInput, optFns ...func(*Options)) (*AdminListGroupsForUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AdminListGroupsForUser", params, optFns, addOperationAdminListGroupsForUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAdminListGroupsForUserMiddleware(stack *middleware.Stack, options Options) (err error) {
