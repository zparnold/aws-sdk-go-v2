...
func (c *Client) CreateUserPool(ctx context.Context, params *CreateUserPoolInput, optFns ...func(*Options)) (*CreateUserPoolOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUserPool", params, optFns, addOperationCreateUserPoolMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUserPoolMiddleware(stack *middleware.Stack, options Options) (err error) {
