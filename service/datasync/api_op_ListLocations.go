...
func (c *Client) ListLocations(ctx context.Context, params *ListLocationsInput, optFns ...func(*Options)) (*ListLocationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLocations", params, optFns, addOperationListLocationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLocationsMiddleware(stack *middleware.Stack, options Options) (err error) {
