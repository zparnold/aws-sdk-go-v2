...
func (c *Client) DescribeLocationSmb(ctx context.Context, params *DescribeLocationSmbInput, optFns ...func(*Options)) (*DescribeLocationSmbOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocationSmb", params, optFns, addOperationDescribeLocationSmbMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocationSmbMiddleware(stack *middleware.Stack, options Options) (err error) {
