...
func (c *Client) DeleteLocation(ctx context.Context, params *DeleteLocationInput, optFns ...func(*Options)) (*DeleteLocationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLocation", params, optFns, addOperationDeleteLocationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLocationMiddleware(stack *middleware.Stack, options Options) (err error) {
