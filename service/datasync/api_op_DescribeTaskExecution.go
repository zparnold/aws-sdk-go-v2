...
func (c *Client) DescribeTaskExecution(ctx context.Context, params *DescribeTaskExecutionInput, optFns ...func(*Options)) (*DescribeTaskExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTaskExecution", params, optFns, addOperationDescribeTaskExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTaskExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
