...
func (c *Client) StartTaskExecution(ctx context.Context, params *StartTaskExecutionInput, optFns ...func(*Options)) (*StartTaskExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartTaskExecution", params, optFns, addOperationStartTaskExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartTaskExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
