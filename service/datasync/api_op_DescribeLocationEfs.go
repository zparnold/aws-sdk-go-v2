...
func (c *Client) DescribeLocationEfs(ctx context.Context, params *DescribeLocationEfsInput, optFns ...func(*Options)) (*DescribeLocationEfsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocationEfs", params, optFns, addOperationDescribeLocationEfsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocationEfsMiddleware(stack *middleware.Stack, options Options) (err error) {
