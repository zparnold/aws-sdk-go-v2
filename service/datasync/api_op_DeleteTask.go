...
func (c *Client) DeleteTask(ctx context.Context, params *DeleteTaskInput, optFns ...func(*Options)) (*DeleteTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTask", params, optFns, addOperationDeleteTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
