...
func (c *Client) ListTagsForResource(ctx context.Context, params *ListTagsForResourceInput, optFns ...func(*Options)) (*ListTagsForResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForResource", params, optFns, addOperationListTagsForResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
