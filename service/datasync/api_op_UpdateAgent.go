...
func (c *Client) UpdateAgent(ctx context.Context, params *UpdateAgentInput, optFns ...func(*Options)) (*UpdateAgentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAgent", params, optFns, addOperationUpdateAgentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAgentMiddleware(stack *middleware.Stack, options Options) (err error) {
