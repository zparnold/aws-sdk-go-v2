...
func (c *Client) UpdateTask(ctx context.Context, params *UpdateTaskInput, optFns ...func(*Options)) (*UpdateTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTask", params, optFns, addOperationUpdateTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
