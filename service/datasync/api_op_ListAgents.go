...
func (c *Client) ListAgents(ctx context.Context, params *ListAgentsInput, optFns ...func(*Options)) (*ListAgentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAgents", params, optFns, addOperationListAgentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAgentsMiddleware(stack *middleware.Stack, options Options) (err error) {
