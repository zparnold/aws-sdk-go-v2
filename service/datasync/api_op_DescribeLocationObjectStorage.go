...
func (c *Client) DescribeLocationObjectStorage(ctx context.Context, params *DescribeLocationObjectStorageInput, optFns ...func(*Options)) (*DescribeLocationObjectStorageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocationObjectStorage", params, optFns, addOperationDescribeLocationObjectStorageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocationObjectStorageMiddleware(stack *middleware.Stack, options Options) (err error) {
