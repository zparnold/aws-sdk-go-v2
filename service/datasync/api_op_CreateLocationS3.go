...
func (c *Client) CreateLocationS3(ctx context.Context, params *CreateLocationS3Input, optFns ...func(*Options)) (*CreateLocationS3Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLocationS3", params, optFns, addOperationCreateLocationS3Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLocationS3Middleware(stack *middleware.Stack, options Options) (err error) {
