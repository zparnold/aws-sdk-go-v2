...
func (c *Client) CreateLocationFsxWindows(ctx context.Context, params *CreateLocationFsxWindowsInput, optFns ...func(*Options)) (*CreateLocationFsxWindowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLocationFsxWindows", params, optFns, addOperationCreateLocationFsxWindowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLocationFsxWindowsMiddleware(stack *middleware.Stack, options Options) (err error) {
