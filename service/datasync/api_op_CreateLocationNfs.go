...
func (c *Client) CreateLocationNfs(ctx context.Context, params *CreateLocationNfsInput, optFns ...func(*Options)) (*CreateLocationNfsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLocationNfs", params, optFns, addOperationCreateLocationNfsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLocationNfsMiddleware(stack *middleware.Stack, options Options) (err error) {
