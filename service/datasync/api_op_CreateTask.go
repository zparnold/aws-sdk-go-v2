...
func (c *Client) CreateTask(ctx context.Context, params *CreateTaskInput, optFns ...func(*Options)) (*CreateTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTask", params, optFns, addOperationCreateTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
