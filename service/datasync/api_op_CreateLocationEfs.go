...
func (c *Client) CreateLocationEfs(ctx context.Context, params *CreateLocationEfsInput, optFns ...func(*Options)) (*CreateLocationEfsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLocationEfs", params, optFns, addOperationCreateLocationEfsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLocationEfsMiddleware(stack *middleware.Stack, options Options) (err error) {
