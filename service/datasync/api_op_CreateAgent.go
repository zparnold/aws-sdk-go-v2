...
func (c *Client) CreateAgent(ctx context.Context, params *CreateAgentInput, optFns ...func(*Options)) (*CreateAgentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAgent", params, optFns, addOperationCreateAgentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAgentMiddleware(stack *middleware.Stack, options Options) (err error) {
