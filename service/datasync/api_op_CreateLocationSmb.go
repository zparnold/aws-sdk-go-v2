...
func (c *Client) CreateLocationSmb(ctx context.Context, params *CreateLocationSmbInput, optFns ...func(*Options)) (*CreateLocationSmbOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLocationSmb", params, optFns, addOperationCreateLocationSmbMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLocationSmbMiddleware(stack *middleware.Stack, options Options) (err error) {
