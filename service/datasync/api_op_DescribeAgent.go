...
func (c *Client) DescribeAgent(ctx context.Context, params *DescribeAgentInput, optFns ...func(*Options)) (*DescribeAgentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAgent", params, optFns, addOperationDescribeAgentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAgentMiddleware(stack *middleware.Stack, options Options) (err error) {
