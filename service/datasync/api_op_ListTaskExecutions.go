...
func (c *Client) ListTaskExecutions(ctx context.Context, params *ListTaskExecutionsInput, optFns ...func(*Options)) (*ListTaskExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTaskExecutions", params, optFns, addOperationListTaskExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTaskExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
