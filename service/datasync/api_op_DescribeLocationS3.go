...
func (c *Client) DescribeLocationS3(ctx context.Context, params *DescribeLocationS3Input, optFns ...func(*Options)) (*DescribeLocationS3Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocationS3", params, optFns, addOperationDescribeLocationS3Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocationS3Middleware(stack *middleware.Stack, options Options) (err error) {
