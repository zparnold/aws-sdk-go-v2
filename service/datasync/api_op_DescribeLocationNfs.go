...
func (c *Client) DescribeLocationNfs(ctx context.Context, params *DescribeLocationNfsInput, optFns ...func(*Options)) (*DescribeLocationNfsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocationNfs", params, optFns, addOperationDescribeLocationNfsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocationNfsMiddleware(stack *middleware.Stack, options Options) (err error) {
