...
func (c *Client) DescribeLocationFsxWindows(ctx context.Context, params *DescribeLocationFsxWindowsInput, optFns ...func(*Options)) (*DescribeLocationFsxWindowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLocationFsxWindows", params, optFns, addOperationDescribeLocationFsxWindowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLocationFsxWindowsMiddleware(stack *middleware.Stack, options Options) (err error) {
