...
func (c *Client) ListBuilds(ctx context.Context, params *ListBuildsInput, optFns ...func(*Options)) (*ListBuildsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBuilds", params, optFns, addOperationListBuildsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBuildsMiddleware(stack *middleware.Stack, options Options) (err error) {
