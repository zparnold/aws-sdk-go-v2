...
func (c *Client) DescribeAlias(ctx context.Context, params *DescribeAliasInput, optFns ...func(*Options)) (*DescribeAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAlias", params, optFns, addOperationDescribeAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
