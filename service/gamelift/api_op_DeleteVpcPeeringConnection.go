...
func (c *Client) DeleteVpcPeeringConnection(ctx context.Context, params *DeleteVpcPeeringConnectionInput, optFns ...func(*Options)) (*DeleteVpcPeeringConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpcPeeringConnection", params, optFns, addOperationDeleteVpcPeeringConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpcPeeringConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
