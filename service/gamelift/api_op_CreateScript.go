...
func (c *Client) CreateScript(ctx context.Context, params *CreateScriptInput, optFns ...func(*Options)) (*CreateScriptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateScript", params, optFns, addOperationCreateScriptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateScriptMiddleware(stack *middleware.Stack, options Options) (err error) {
