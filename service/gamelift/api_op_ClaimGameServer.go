...
func (c *Client) ClaimGameServer(ctx context.Context, params *ClaimGameServerInput, optFns ...func(*Options)) (*ClaimGameServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ClaimGameServer", params, optFns, addOperationClaimGameServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationClaimGameServerMiddleware(stack *middleware.Stack, options Options) (err error) {
