...
func (c *Client) DescribeBuild(ctx context.Context, params *DescribeBuildInput, optFns ...func(*Options)) (*DescribeBuildOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBuild", params, optFns, addOperationDescribeBuildMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBuildMiddleware(stack *middleware.Stack, options Options) (err error) {
