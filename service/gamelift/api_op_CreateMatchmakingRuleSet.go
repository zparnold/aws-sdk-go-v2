...
func (c *Client) CreateMatchmakingRuleSet(ctx context.Context, params *CreateMatchmakingRuleSetInput, optFns ...func(*Options)) (*CreateMatchmakingRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMatchmakingRuleSet", params, optFns, addOperationCreateMatchmakingRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMatchmakingRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
