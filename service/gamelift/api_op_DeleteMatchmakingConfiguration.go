...
func (c *Client) DeleteMatchmakingConfiguration(ctx context.Context, params *DeleteMatchmakingConfigurationInput, optFns ...func(*Options)) (*DeleteMatchmakingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMatchmakingConfiguration", params, optFns, addOperationDeleteMatchmakingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMatchmakingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
