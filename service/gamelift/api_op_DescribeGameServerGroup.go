...
func (c *Client) DescribeGameServerGroup(ctx context.Context, params *DescribeGameServerGroupInput, optFns ...func(*Options)) (*DescribeGameServerGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGameServerGroup", params, optFns, addOperationDescribeGameServerGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGameServerGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
