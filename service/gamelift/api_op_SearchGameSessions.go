...
func (c *Client) SearchGameSessions(ctx context.Context, params *SearchGameSessionsInput, optFns ...func(*Options)) (*SearchGameSessionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchGameSessions", params, optFns, addOperationSearchGameSessionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchGameSessionsMiddleware(stack *middleware.Stack, options Options) (err error) {
