...
func (c *Client) DescribeMatchmakingConfigurations(ctx context.Context, params *DescribeMatchmakingConfigurationsInput, optFns ...func(*Options)) (*DescribeMatchmakingConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMatchmakingConfigurations", params, optFns, addOperationDescribeMatchmakingConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMatchmakingConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
