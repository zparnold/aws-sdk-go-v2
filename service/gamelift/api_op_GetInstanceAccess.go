...
func (c *Client) GetInstanceAccess(ctx context.Context, params *GetInstanceAccessInput, optFns ...func(*Options)) (*GetInstanceAccessOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInstanceAccess", params, optFns, addOperationGetInstanceAccessMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInstanceAccessMiddleware(stack *middleware.Stack, options Options) (err error) {
