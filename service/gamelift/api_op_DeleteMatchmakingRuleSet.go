...
func (c *Client) DeleteMatchmakingRuleSet(ctx context.Context, params *DeleteMatchmakingRuleSetInput, optFns ...func(*Options)) (*DeleteMatchmakingRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMatchmakingRuleSet", params, optFns, addOperationDeleteMatchmakingRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMatchmakingRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
