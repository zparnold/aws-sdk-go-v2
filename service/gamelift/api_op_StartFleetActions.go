...
func (c *Client) StartFleetActions(ctx context.Context, params *StartFleetActionsInput, optFns ...func(*Options)) (*StartFleetActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartFleetActions", params, optFns, addOperationStartFleetActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartFleetActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
