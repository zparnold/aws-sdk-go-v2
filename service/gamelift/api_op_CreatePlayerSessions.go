...
func (c *Client) CreatePlayerSessions(ctx context.Context, params *CreatePlayerSessionsInput, optFns ...func(*Options)) (*CreatePlayerSessionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePlayerSessions", params, optFns, addOperationCreatePlayerSessionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePlayerSessionsMiddleware(stack *middleware.Stack, options Options) (err error) {
