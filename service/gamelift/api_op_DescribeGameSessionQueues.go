...
func (c *Client) DescribeGameSessionQueues(ctx context.Context, params *DescribeGameSessionQueuesInput, optFns ...func(*Options)) (*DescribeGameSessionQueuesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGameSessionQueues", params, optFns, addOperationDescribeGameSessionQueuesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGameSessionQueuesMiddleware(stack *middleware.Stack, options Options) (err error) {
