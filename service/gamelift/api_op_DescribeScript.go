...
func (c *Client) DescribeScript(ctx context.Context, params *DescribeScriptInput, optFns ...func(*Options)) (*DescribeScriptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeScript", params, optFns, addOperationDescribeScriptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeScriptMiddleware(stack *middleware.Stack, options Options) (err error) {
