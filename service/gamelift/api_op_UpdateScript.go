...
func (c *Client) UpdateScript(ctx context.Context, params *UpdateScriptInput, optFns ...func(*Options)) (*UpdateScriptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateScript", params, optFns, addOperationUpdateScriptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateScriptMiddleware(stack *middleware.Stack, options Options) (err error) {
