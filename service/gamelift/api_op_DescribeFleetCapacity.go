...
func (c *Client) DescribeFleetCapacity(ctx context.Context, params *DescribeFleetCapacityInput, optFns ...func(*Options)) (*DescribeFleetCapacityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetCapacity", params, optFns, addOperationDescribeFleetCapacityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetCapacityMiddleware(stack *middleware.Stack, options Options) (err error) {
