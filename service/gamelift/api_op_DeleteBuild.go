...
func (c *Client) DeleteBuild(ctx context.Context, params *DeleteBuildInput, optFns ...func(*Options)) (*DeleteBuildOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBuild", params, optFns, addOperationDeleteBuildMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBuildMiddleware(stack *middleware.Stack, options Options) (err error) {
