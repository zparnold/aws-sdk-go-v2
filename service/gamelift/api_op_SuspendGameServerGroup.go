...
func (c *Client) SuspendGameServerGroup(ctx context.Context, params *SuspendGameServerGroupInput, optFns ...func(*Options)) (*SuspendGameServerGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SuspendGameServerGroup", params, optFns, addOperationSuspendGameServerGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSuspendGameServerGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
