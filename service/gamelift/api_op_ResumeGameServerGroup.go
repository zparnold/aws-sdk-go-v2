...
func (c *Client) ResumeGameServerGroup(ctx context.Context, params *ResumeGameServerGroupInput, optFns ...func(*Options)) (*ResumeGameServerGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResumeGameServerGroup", params, optFns, addOperationResumeGameServerGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResumeGameServerGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
