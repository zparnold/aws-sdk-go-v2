...
func (c *Client) UpdateFleetCapacity(ctx context.Context, params *UpdateFleetCapacityInput, optFns ...func(*Options)) (*UpdateFleetCapacityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFleetCapacity", params, optFns, addOperationUpdateFleetCapacityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFleetCapacityMiddleware(stack *middleware.Stack, options Options) (err error) {
