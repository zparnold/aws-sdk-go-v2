...
func (c *Client) RequestUploadCredentials(ctx context.Context, params *RequestUploadCredentialsInput, optFns ...func(*Options)) (*RequestUploadCredentialsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RequestUploadCredentials", params, optFns, addOperationRequestUploadCredentialsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRequestUploadCredentialsMiddleware(stack *middleware.Stack, options Options) (err error) {
