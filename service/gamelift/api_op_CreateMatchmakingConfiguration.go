...
func (c *Client) CreateMatchmakingConfiguration(ctx context.Context, params *CreateMatchmakingConfigurationInput, optFns ...func(*Options)) (*CreateMatchmakingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMatchmakingConfiguration", params, optFns, addOperationCreateMatchmakingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMatchmakingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
