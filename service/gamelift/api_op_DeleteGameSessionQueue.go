...
func (c *Client) DeleteGameSessionQueue(ctx context.Context, params *DeleteGameSessionQueueInput, optFns ...func(*Options)) (*DeleteGameSessionQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGameSessionQueue", params, optFns, addOperationDeleteGameSessionQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGameSessionQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
