...
func (c *Client) DescribeMatchmakingRuleSets(ctx context.Context, params *DescribeMatchmakingRuleSetsInput, optFns ...func(*Options)) (*DescribeMatchmakingRuleSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMatchmakingRuleSets", params, optFns, addOperationDescribeMatchmakingRuleSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMatchmakingRuleSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
