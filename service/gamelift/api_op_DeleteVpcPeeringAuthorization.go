...
func (c *Client) DeleteVpcPeeringAuthorization(ctx context.Context, params *DeleteVpcPeeringAuthorizationInput, optFns ...func(*Options)) (*DeleteVpcPeeringAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteVpcPeeringAuthorization", params, optFns, addOperationDeleteVpcPeeringAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteVpcPeeringAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
