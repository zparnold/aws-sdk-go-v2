...
func (c *Client) DescribePlayerSessions(ctx context.Context, params *DescribePlayerSessionsInput, optFns ...func(*Options)) (*DescribePlayerSessionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePlayerSessions", params, optFns, addOperationDescribePlayerSessionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePlayerSessionsMiddleware(stack *middleware.Stack, options Options) (err error) {
