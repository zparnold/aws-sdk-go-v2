...
func (c *Client) DescribeFleetPortSettings(ctx context.Context, params *DescribeFleetPortSettingsInput, optFns ...func(*Options)) (*DescribeFleetPortSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetPortSettings", params, optFns, addOperationDescribeFleetPortSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetPortSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
