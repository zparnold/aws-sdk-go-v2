...
func (c *Client) ListGameServerGroups(ctx context.Context, params *ListGameServerGroupsInput, optFns ...func(*Options)) (*ListGameServerGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGameServerGroups", params, optFns, addOperationListGameServerGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGameServerGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
