...
func (c *Client) UpdateGameSessionQueue(ctx context.Context, params *UpdateGameSessionQueueInput, optFns ...func(*Options)) (*UpdateGameSessionQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGameSessionQueue", params, optFns, addOperationUpdateGameSessionQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGameSessionQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
