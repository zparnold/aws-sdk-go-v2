...
func (c *Client) CreateVpcPeeringConnection(ctx context.Context, params *CreateVpcPeeringConnectionInput, optFns ...func(*Options)) (*CreateVpcPeeringConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpcPeeringConnection", params, optFns, addOperationCreateVpcPeeringConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpcPeeringConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
