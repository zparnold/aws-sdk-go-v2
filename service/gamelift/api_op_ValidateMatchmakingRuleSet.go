...
func (c *Client) ValidateMatchmakingRuleSet(ctx context.Context, params *ValidateMatchmakingRuleSetInput, optFns ...func(*Options)) (*ValidateMatchmakingRuleSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ValidateMatchmakingRuleSet", params, optFns, addOperationValidateMatchmakingRuleSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationValidateMatchmakingRuleSetMiddleware(stack *middleware.Stack, options Options) (err error) {
