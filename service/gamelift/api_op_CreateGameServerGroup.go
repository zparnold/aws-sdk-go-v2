...
func (c *Client) CreateGameServerGroup(ctx context.Context, params *CreateGameServerGroupInput, optFns ...func(*Options)) (*CreateGameServerGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGameServerGroup", params, optFns, addOperationCreateGameServerGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGameServerGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
