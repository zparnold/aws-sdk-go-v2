...
func (c *Client) DescribeFleetEvents(ctx context.Context, params *DescribeFleetEventsInput, optFns ...func(*Options)) (*DescribeFleetEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetEvents", params, optFns, addOperationDescribeFleetEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
