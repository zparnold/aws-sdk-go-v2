...
func (c *Client) DescribeFleetAttributes(ctx context.Context, params *DescribeFleetAttributesInput, optFns ...func(*Options)) (*DescribeFleetAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetAttributes", params, optFns, addOperationDescribeFleetAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
