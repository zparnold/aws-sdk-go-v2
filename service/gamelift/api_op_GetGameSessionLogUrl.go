...
func (c *Client) GetGameSessionLogUrl(ctx context.Context, params *GetGameSessionLogUrlInput, optFns ...func(*Options)) (*GetGameSessionLogUrlOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGameSessionLogUrl", params, optFns, addOperationGetGameSessionLogUrlMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGameSessionLogUrlMiddleware(stack *middleware.Stack, options Options) (err error) {
