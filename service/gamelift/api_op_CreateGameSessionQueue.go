...
func (c *Client) CreateGameSessionQueue(ctx context.Context, params *CreateGameSessionQueueInput, optFns ...func(*Options)) (*CreateGameSessionQueueOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGameSessionQueue", params, optFns, addOperationCreateGameSessionQueueMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGameSessionQueueMiddleware(stack *middleware.Stack, options Options) (err error) {
