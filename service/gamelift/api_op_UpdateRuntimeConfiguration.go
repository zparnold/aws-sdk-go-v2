...
func (c *Client) UpdateRuntimeConfiguration(ctx context.Context, params *UpdateRuntimeConfigurationInput, optFns ...func(*Options)) (*UpdateRuntimeConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRuntimeConfiguration", params, optFns, addOperationUpdateRuntimeConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRuntimeConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
