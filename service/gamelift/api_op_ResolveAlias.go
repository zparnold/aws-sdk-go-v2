...
func (c *Client) ResolveAlias(ctx context.Context, params *ResolveAliasInput, optFns ...func(*Options)) (*ResolveAliasOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResolveAlias", params, optFns, addOperationResolveAliasMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResolveAliasMiddleware(stack *middleware.Stack, options Options) (err error) {
