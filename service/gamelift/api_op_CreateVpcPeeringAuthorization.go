...
func (c *Client) CreateVpcPeeringAuthorization(ctx context.Context, params *CreateVpcPeeringAuthorizationInput, optFns ...func(*Options)) (*CreateVpcPeeringAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVpcPeeringAuthorization", params, optFns, addOperationCreateVpcPeeringAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVpcPeeringAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
