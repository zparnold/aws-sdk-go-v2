...
func (c *Client) UpdateGameServer(ctx context.Context, params *UpdateGameServerInput, optFns ...func(*Options)) (*UpdateGameServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGameServer", params, optFns, addOperationUpdateGameServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGameServerMiddleware(stack *middleware.Stack, options Options) (err error) {
