...
func (c *Client) UpdateMatchmakingConfiguration(ctx context.Context, params *UpdateMatchmakingConfigurationInput, optFns ...func(*Options)) (*UpdateMatchmakingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMatchmakingConfiguration", params, optFns, addOperationUpdateMatchmakingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMatchmakingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
