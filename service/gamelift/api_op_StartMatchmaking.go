...
func (c *Client) StartMatchmaking(ctx context.Context, params *StartMatchmakingInput, optFns ...func(*Options)) (*StartMatchmakingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMatchmaking", params, optFns, addOperationStartMatchmakingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMatchmakingMiddleware(stack *middleware.Stack, options Options) (err error) {
