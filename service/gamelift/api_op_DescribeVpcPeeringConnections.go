...
func (c *Client) DescribeVpcPeeringConnections(ctx context.Context, params *DescribeVpcPeeringConnectionsInput, optFns ...func(*Options)) (*DescribeVpcPeeringConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeVpcPeeringConnections", params, optFns, addOperationDescribeVpcPeeringConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeVpcPeeringConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
