...
func (c *Client) UpdateFleetPortSettings(ctx context.Context, params *UpdateFleetPortSettingsInput, optFns ...func(*Options)) (*UpdateFleetPortSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFleetPortSettings", params, optFns, addOperationUpdateFleetPortSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFleetPortSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
