...
func (c *Client) DescribeMatchmaking(ctx context.Context, params *DescribeMatchmakingInput, optFns ...func(*Options)) (*DescribeMatchmakingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMatchmaking", params, optFns, addOperationDescribeMatchmakingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMatchmakingMiddleware(stack *middleware.Stack, options Options) (err error) {
