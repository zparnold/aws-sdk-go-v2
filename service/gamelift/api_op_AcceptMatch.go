...
func (c *Client) AcceptMatch(ctx context.Context, params *AcceptMatchInput, optFns ...func(*Options)) (*AcceptMatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AcceptMatch", params, optFns, addOperationAcceptMatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAcceptMatchMiddleware(stack *middleware.Stack, options Options) (err error) {
