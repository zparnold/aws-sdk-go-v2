...
func (c *Client) UpdateGameSession(ctx context.Context, params *UpdateGameSessionInput, optFns ...func(*Options)) (*UpdateGameSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGameSession", params, optFns, addOperationUpdateGameSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGameSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
