...
func (c *Client) DescribeRuntimeConfiguration(ctx context.Context, params *DescribeRuntimeConfigurationInput, optFns ...func(*Options)) (*DescribeRuntimeConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRuntimeConfiguration", params, optFns, addOperationDescribeRuntimeConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRuntimeConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
