...
func (c *Client) StopMatchmaking(ctx context.Context, params *StopMatchmakingInput, optFns ...func(*Options)) (*StopMatchmakingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopMatchmaking", params, optFns, addOperationStopMatchmakingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopMatchmakingMiddleware(stack *middleware.Stack, options Options) (err error) {
