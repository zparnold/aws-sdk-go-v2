...
func (c *Client) UpdateBuild(ctx context.Context, params *UpdateBuildInput, optFns ...func(*Options)) (*UpdateBuildOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBuild", params, optFns, addOperationUpdateBuildMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBuildMiddleware(stack *middleware.Stack, options Options) (err error) {
