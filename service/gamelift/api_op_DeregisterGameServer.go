...
func (c *Client) DeregisterGameServer(ctx context.Context, params *DeregisterGameServerInput, optFns ...func(*Options)) (*DeregisterGameServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterGameServer", params, optFns, addOperationDeregisterGameServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterGameServerMiddleware(stack *middleware.Stack, options Options) (err error) {
