...
func (c *Client) ListScripts(ctx context.Context, params *ListScriptsInput, optFns ...func(*Options)) (*ListScriptsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListScripts", params, optFns, addOperationListScriptsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListScriptsMiddleware(stack *middleware.Stack, options Options) (err error) {
