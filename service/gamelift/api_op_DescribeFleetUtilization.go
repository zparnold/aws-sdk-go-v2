...
func (c *Client) DescribeFleetUtilization(ctx context.Context, params *DescribeFleetUtilizationInput, optFns ...func(*Options)) (*DescribeFleetUtilizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFleetUtilization", params, optFns, addOperationDescribeFleetUtilizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFleetUtilizationMiddleware(stack *middleware.Stack, options Options) (err error) {
