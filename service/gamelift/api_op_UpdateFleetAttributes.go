...
func (c *Client) UpdateFleetAttributes(ctx context.Context, params *UpdateFleetAttributesInput, optFns ...func(*Options)) (*UpdateFleetAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFleetAttributes", params, optFns, addOperationUpdateFleetAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFleetAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
