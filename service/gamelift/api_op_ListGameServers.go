...
func (c *Client) ListGameServers(ctx context.Context, params *ListGameServersInput, optFns ...func(*Options)) (*ListGameServersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGameServers", params, optFns, addOperationListGameServersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGameServersMiddleware(stack *middleware.Stack, options Options) (err error) {
