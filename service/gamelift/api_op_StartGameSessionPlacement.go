...
func (c *Client) StartGameSessionPlacement(ctx context.Context, params *StartGameSessionPlacementInput, optFns ...func(*Options)) (*StartGameSessionPlacementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartGameSessionPlacement", params, optFns, addOperationStartGameSessionPlacementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartGameSessionPlacementMiddleware(stack *middleware.Stack, options Options) (err error) {
