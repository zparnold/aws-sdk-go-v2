...
func (c *Client) DescribeGameServer(ctx context.Context, params *DescribeGameServerInput, optFns ...func(*Options)) (*DescribeGameServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGameServer", params, optFns, addOperationDescribeGameServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGameServerMiddleware(stack *middleware.Stack, options Options) (err error) {
