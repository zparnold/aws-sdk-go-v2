...
func (c *Client) StopFleetActions(ctx context.Context, params *StopFleetActionsInput, optFns ...func(*Options)) (*StopFleetActionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopFleetActions", params, optFns, addOperationStopFleetActionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopFleetActionsMiddleware(stack *middleware.Stack, options Options) (err error) {
