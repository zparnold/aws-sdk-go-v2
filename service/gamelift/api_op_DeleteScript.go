...
func (c *Client) DeleteScript(ctx context.Context, params *DeleteScriptInput, optFns ...func(*Options)) (*DeleteScriptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteScript", params, optFns, addOperationDeleteScriptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteScriptMiddleware(stack *middleware.Stack, options Options) (err error) {
