...
func (c *Client) RegisterGameServer(ctx context.Context, params *RegisterGameServerInput, optFns ...func(*Options)) (*RegisterGameServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterGameServer", params, optFns, addOperationRegisterGameServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterGameServerMiddleware(stack *middleware.Stack, options Options) (err error) {
