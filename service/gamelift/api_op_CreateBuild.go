...
func (c *Client) CreateBuild(ctx context.Context, params *CreateBuildInput, optFns ...func(*Options)) (*CreateBuildOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBuild", params, optFns, addOperationCreateBuildMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBuildMiddleware(stack *middleware.Stack, options Options) (err error) {
