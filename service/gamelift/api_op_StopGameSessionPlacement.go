...
func (c *Client) StopGameSessionPlacement(ctx context.Context, params *StopGameSessionPlacementInput, optFns ...func(*Options)) (*StopGameSessionPlacementOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopGameSessionPlacement", params, optFns, addOperationStopGameSessionPlacementMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopGameSessionPlacementMiddleware(stack *middleware.Stack, options Options) (err error) {
