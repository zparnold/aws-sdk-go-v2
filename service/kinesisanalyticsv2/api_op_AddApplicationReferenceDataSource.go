...
func (c *Client) AddApplicationReferenceDataSource(ctx context.Context, params *AddApplicationReferenceDataSourceInput, optFns ...func(*Options)) (*AddApplicationReferenceDataSourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddApplicationReferenceDataSource", params, optFns, addOperationAddApplicationReferenceDataSourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddApplicationReferenceDataSourceMiddleware(stack *middleware.Stack, options Options) (err error) {
