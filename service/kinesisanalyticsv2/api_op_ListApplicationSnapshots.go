...
func (c *Client) ListApplicationSnapshots(ctx context.Context, params *ListApplicationSnapshotsInput, optFns ...func(*Options)) (*ListApplicationSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListApplicationSnapshots", params, optFns, addOperationListApplicationSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListApplicationSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
