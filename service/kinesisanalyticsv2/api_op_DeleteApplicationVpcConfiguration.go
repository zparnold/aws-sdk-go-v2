...
func (c *Client) DeleteApplicationVpcConfiguration(ctx context.Context, params *DeleteApplicationVpcConfigurationInput, optFns ...func(*Options)) (*DeleteApplicationVpcConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApplicationVpcConfiguration", params, optFns, addOperationDeleteApplicationVpcConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApplicationVpcConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
