...
func (c *Client) DeleteApplicationInputProcessingConfiguration(ctx context.Context, params *DeleteApplicationInputProcessingConfigurationInput, optFns ...func(*Options)) (*DeleteApplicationInputProcessingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApplicationInputProcessingConfiguration", params, optFns, addOperationDeleteApplicationInputProcessingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApplicationInputProcessingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
