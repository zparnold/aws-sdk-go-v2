...
func (c *Client) AddApplicationOutput(ctx context.Context, params *AddApplicationOutputInput, optFns ...func(*Options)) (*AddApplicationOutputOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddApplicationOutput", params, optFns, addOperationAddApplicationOutputMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddApplicationOutputMiddleware(stack *middleware.Stack, options Options) (err error) {
