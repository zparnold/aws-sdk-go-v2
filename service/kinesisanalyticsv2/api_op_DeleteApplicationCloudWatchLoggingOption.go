...
func (c *Client) DeleteApplicationCloudWatchLoggingOption(ctx context.Context, params *DeleteApplicationCloudWatchLoggingOptionInput, optFns ...func(*Options)) (*DeleteApplicationCloudWatchLoggingOptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApplicationCloudWatchLoggingOption", params, optFns, addOperationDeleteApplicationCloudWatchLoggingOptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApplicationCloudWatchLoggingOptionMiddleware(stack *middleware.Stack, options Options) (err error) {
