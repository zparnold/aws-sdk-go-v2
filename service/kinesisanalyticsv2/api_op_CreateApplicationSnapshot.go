...
func (c *Client) CreateApplicationSnapshot(ctx context.Context, params *CreateApplicationSnapshotInput, optFns ...func(*Options)) (*CreateApplicationSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApplicationSnapshot", params, optFns, addOperationCreateApplicationSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateApplicationSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
