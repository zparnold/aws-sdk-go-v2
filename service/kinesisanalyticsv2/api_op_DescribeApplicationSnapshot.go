...
func (c *Client) DescribeApplicationSnapshot(ctx context.Context, params *DescribeApplicationSnapshotInput, optFns ...func(*Options)) (*DescribeApplicationSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeApplicationSnapshot", params, optFns, addOperationDescribeApplicationSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeApplicationSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
