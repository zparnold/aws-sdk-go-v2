...
func (c *Client) AddApplicationVpcConfiguration(ctx context.Context, params *AddApplicationVpcConfigurationInput, optFns ...func(*Options)) (*AddApplicationVpcConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddApplicationVpcConfiguration", params, optFns, addOperationAddApplicationVpcConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddApplicationVpcConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
