...
func (c *Client) AddApplicationInputProcessingConfiguration(ctx context.Context, params *AddApplicationInputProcessingConfigurationInput, optFns ...func(*Options)) (*AddApplicationInputProcessingConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddApplicationInputProcessingConfiguration", params, optFns, addOperationAddApplicationInputProcessingConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddApplicationInputProcessingConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
