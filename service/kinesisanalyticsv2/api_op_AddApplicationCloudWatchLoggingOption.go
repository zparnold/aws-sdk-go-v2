...
func (c *Client) AddApplicationCloudWatchLoggingOption(ctx context.Context, params *AddApplicationCloudWatchLoggingOptionInput, optFns ...func(*Options)) (*AddApplicationCloudWatchLoggingOptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddApplicationCloudWatchLoggingOption", params, optFns, addOperationAddApplicationCloudWatchLoggingOptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddApplicationCloudWatchLoggingOptionMiddleware(stack *middleware.Stack, options Options) (err error) {
