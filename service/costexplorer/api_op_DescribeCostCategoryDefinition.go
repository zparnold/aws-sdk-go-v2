...
func (c *Client) DescribeCostCategoryDefinition(ctx context.Context, params *DescribeCostCategoryDefinitionInput, optFns ...func(*Options)) (*DescribeCostCategoryDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCostCategoryDefinition", params, optFns, addOperationDescribeCostCategoryDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCostCategoryDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
