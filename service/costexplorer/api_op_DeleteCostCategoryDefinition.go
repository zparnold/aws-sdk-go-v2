...
func (c *Client) DeleteCostCategoryDefinition(ctx context.Context, params *DeleteCostCategoryDefinitionInput, optFns ...func(*Options)) (*DeleteCostCategoryDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCostCategoryDefinition", params, optFns, addOperationDeleteCostCategoryDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCostCategoryDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
