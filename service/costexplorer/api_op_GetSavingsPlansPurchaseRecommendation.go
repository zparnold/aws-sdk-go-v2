...
func (c *Client) GetSavingsPlansPurchaseRecommendation(ctx context.Context, params *GetSavingsPlansPurchaseRecommendationInput, optFns ...func(*Options)) (*GetSavingsPlansPurchaseRecommendationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSavingsPlansPurchaseRecommendation", params, optFns, addOperationGetSavingsPlansPurchaseRecommendationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSavingsPlansPurchaseRecommendationMiddleware(stack *middleware.Stack, options Options) (err error) {
