...
func (c *Client) GetCostAndUsage(ctx context.Context, params *GetCostAndUsageInput, optFns ...func(*Options)) (*GetCostAndUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCostAndUsage", params, optFns, addOperationGetCostAndUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCostAndUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
