...
func (c *Client) GetCostAndUsageWithResources(ctx context.Context, params *GetCostAndUsageWithResourcesInput, optFns ...func(*Options)) (*GetCostAndUsageWithResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCostAndUsageWithResources", params, optFns, addOperationGetCostAndUsageWithResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCostAndUsageWithResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
