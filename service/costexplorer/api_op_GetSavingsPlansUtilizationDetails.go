...
func (c *Client) GetSavingsPlansUtilizationDetails(ctx context.Context, params *GetSavingsPlansUtilizationDetailsInput, optFns ...func(*Options)) (*GetSavingsPlansUtilizationDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSavingsPlansUtilizationDetails", params, optFns, addOperationGetSavingsPlansUtilizationDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSavingsPlansUtilizationDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
