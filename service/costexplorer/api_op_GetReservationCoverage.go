...
func (c *Client) GetReservationCoverage(ctx context.Context, params *GetReservationCoverageInput, optFns ...func(*Options)) (*GetReservationCoverageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetReservationCoverage", params, optFns, addOperationGetReservationCoverageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetReservationCoverageMiddleware(stack *middleware.Stack, options Options) (err error) {
