...
func (c *Client) GetTags(ctx context.Context, params *GetTagsInput, optFns ...func(*Options)) (*GetTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTags", params, optFns, addOperationGetTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
