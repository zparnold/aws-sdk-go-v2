...
func (c *Client) CreateCostCategoryDefinition(ctx context.Context, params *CreateCostCategoryDefinitionInput, optFns ...func(*Options)) (*CreateCostCategoryDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCostCategoryDefinition", params, optFns, addOperationCreateCostCategoryDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCostCategoryDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
