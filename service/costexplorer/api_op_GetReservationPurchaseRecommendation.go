...
func (c *Client) GetReservationPurchaseRecommendation(ctx context.Context, params *GetReservationPurchaseRecommendationInput, optFns ...func(*Options)) (*GetReservationPurchaseRecommendationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetReservationPurchaseRecommendation", params, optFns, addOperationGetReservationPurchaseRecommendationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetReservationPurchaseRecommendationMiddleware(stack *middleware.Stack, options Options) (err error) {
