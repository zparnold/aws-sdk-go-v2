...
func (c *Client) GetCostForecast(ctx context.Context, params *GetCostForecastInput, optFns ...func(*Options)) (*GetCostForecastOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCostForecast", params, optFns, addOperationGetCostForecastMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCostForecastMiddleware(stack *middleware.Stack, options Options) (err error) {
