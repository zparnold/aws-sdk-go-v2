...
func (c *Client) GetRightsizingRecommendation(ctx context.Context, params *GetRightsizingRecommendationInput, optFns ...func(*Options)) (*GetRightsizingRecommendationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRightsizingRecommendation", params, optFns, addOperationGetRightsizingRecommendationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRightsizingRecommendationMiddleware(stack *middleware.Stack, options Options) (err error) {
