...
func (c *Client) GetReservationUtilization(ctx context.Context, params *GetReservationUtilizationInput, optFns ...func(*Options)) (*GetReservationUtilizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetReservationUtilization", params, optFns, addOperationGetReservationUtilizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetReservationUtilizationMiddleware(stack *middleware.Stack, options Options) (err error) {
