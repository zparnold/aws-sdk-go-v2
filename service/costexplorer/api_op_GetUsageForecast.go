...
func (c *Client) GetUsageForecast(ctx context.Context, params *GetUsageForecastInput, optFns ...func(*Options)) (*GetUsageForecastOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUsageForecast", params, optFns, addOperationGetUsageForecastMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUsageForecastMiddleware(stack *middleware.Stack, options Options) (err error) {
