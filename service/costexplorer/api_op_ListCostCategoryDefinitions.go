...
func (c *Client) ListCostCategoryDefinitions(ctx context.Context, params *ListCostCategoryDefinitionsInput, optFns ...func(*Options)) (*ListCostCategoryDefinitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCostCategoryDefinitions", params, optFns, addOperationListCostCategoryDefinitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCostCategoryDefinitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
