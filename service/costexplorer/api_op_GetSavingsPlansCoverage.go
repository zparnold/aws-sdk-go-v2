...
func (c *Client) GetSavingsPlansCoverage(ctx context.Context, params *GetSavingsPlansCoverageInput, optFns ...func(*Options)) (*GetSavingsPlansCoverageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSavingsPlansCoverage", params, optFns, addOperationGetSavingsPlansCoverageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSavingsPlansCoverageMiddleware(stack *middleware.Stack, options Options) (err error) {
