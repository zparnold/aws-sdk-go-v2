...
func (c *Client) GetDimensionValues(ctx context.Context, params *GetDimensionValuesInput, optFns ...func(*Options)) (*GetDimensionValuesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDimensionValues", params, optFns, addOperationGetDimensionValuesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDimensionValuesMiddleware(stack *middleware.Stack, options Options) (err error) {
