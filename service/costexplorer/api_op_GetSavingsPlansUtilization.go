...
func (c *Client) GetSavingsPlansUtilization(ctx context.Context, params *GetSavingsPlansUtilizationInput, optFns ...func(*Options)) (*GetSavingsPlansUtilizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSavingsPlansUtilization", params, optFns, addOperationGetSavingsPlansUtilizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSavingsPlansUtilizationMiddleware(stack *middleware.Stack, options Options) (err error) {
