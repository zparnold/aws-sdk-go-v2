...
func (c *Client) UpdateCostCategoryDefinition(ctx context.Context, params *UpdateCostCategoryDefinitionInput, optFns ...func(*Options)) (*UpdateCostCategoryDefinitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCostCategoryDefinition", params, optFns, addOperationUpdateCostCategoryDefinitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCostCategoryDefinitionMiddleware(stack *middleware.Stack, options Options) (err error) {
