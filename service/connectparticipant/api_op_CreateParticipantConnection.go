...
func (c *Client) CreateParticipantConnection(ctx context.Context, params *CreateParticipantConnectionInput, optFns ...func(*Options)) (*CreateParticipantConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateParticipantConnection", params, optFns, addOperationCreateParticipantConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateParticipantConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
