...
func (c *Client) SendEvent(ctx context.Context, params *SendEventInput, optFns ...func(*Options)) (*SendEventOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendEvent", params, optFns, addOperationSendEventMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendEventMiddleware(stack *middleware.Stack, options Options) (err error) {
