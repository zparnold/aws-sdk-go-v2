...
func (c *Client) GetTranscript(ctx context.Context, params *GetTranscriptInput, optFns ...func(*Options)) (*GetTranscriptOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTranscript", params, optFns, addOperationGetTranscriptMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTranscriptMiddleware(stack *middleware.Stack, options Options) (err error) {
