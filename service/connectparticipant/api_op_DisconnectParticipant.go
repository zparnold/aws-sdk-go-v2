...
func (c *Client) DisconnectParticipant(ctx context.Context, params *DisconnectParticipantInput, optFns ...func(*Options)) (*DisconnectParticipantOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisconnectParticipant", params, optFns, addOperationDisconnectParticipantMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisconnectParticipantMiddleware(stack *middleware.Stack, options Options) (err error) {
