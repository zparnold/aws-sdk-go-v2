...
func (c *Client) AddTagsToCertificate(ctx context.Context, params *AddTagsToCertificateInput, optFns ...func(*Options)) (*AddTagsToCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddTagsToCertificate", params, optFns, addOperationAddTagsToCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddTagsToCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
