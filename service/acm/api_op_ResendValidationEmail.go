...
func (c *Client) ResendValidationEmail(ctx context.Context, params *ResendValidationEmailInput, optFns ...func(*Options)) (*ResendValidationEmailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResendValidationEmail", params, optFns, addOperationResendValidationEmailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResendValidationEmailMiddleware(stack *middleware.Stack, options Options) (err error) {
