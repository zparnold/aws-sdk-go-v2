...
func (c *Client) DeleteCertificate(ctx context.Context, params *DeleteCertificateInput, optFns ...func(*Options)) (*DeleteCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCertificate", params, optFns, addOperationDeleteCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
