...
func (c *Client) ListTagsForCertificate(ctx context.Context, params *ListTagsForCertificateInput, optFns ...func(*Options)) (*ListTagsForCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsForCertificate", params, optFns, addOperationListTagsForCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsForCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
