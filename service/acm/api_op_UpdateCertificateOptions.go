...
func (c *Client) UpdateCertificateOptions(ctx context.Context, params *UpdateCertificateOptionsInput, optFns ...func(*Options)) (*UpdateCertificateOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCertificateOptions", params, optFns, addOperationUpdateCertificateOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCertificateOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
