...
func (c *Client) RemoveTagsFromCertificate(ctx context.Context, params *RemoveTagsFromCertificateInput, optFns ...func(*Options)) (*RemoveTagsFromCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveTagsFromCertificate", params, optFns, addOperationRemoveTagsFromCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveTagsFromCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
