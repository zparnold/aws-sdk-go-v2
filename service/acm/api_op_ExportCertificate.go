...
func (c *Client) ExportCertificate(ctx context.Context, params *ExportCertificateInput, optFns ...func(*Options)) (*ExportCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportCertificate", params, optFns, addOperationExportCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
