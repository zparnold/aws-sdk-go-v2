...
func (c *Client) RequestCertificate(ctx context.Context, params *RequestCertificateInput, optFns ...func(*Options)) (*RequestCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RequestCertificate", params, optFns, addOperationRequestCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRequestCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
