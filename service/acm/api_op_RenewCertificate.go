...
func (c *Client) RenewCertificate(ctx context.Context, params *RenewCertificateInput, optFns ...func(*Options)) (*RenewCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RenewCertificate", params, optFns, addOperationRenewCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRenewCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
