...
func (c *Client) GetResources(ctx context.Context, params *GetResourcesInput, optFns ...func(*Options)) (*GetResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResources", params, optFns, addOperationGetResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
