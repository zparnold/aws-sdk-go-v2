...
func (c *Client) DeleteLabels(ctx context.Context, params *DeleteLabelsInput, optFns ...func(*Options)) (*DeleteLabelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLabels", params, optFns, addOperationDeleteLabelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLabelsMiddleware(stack *middleware.Stack, options Options) (err error) {
