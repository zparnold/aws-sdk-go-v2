...
func (c *Client) GetDocumentVersion(ctx context.Context, params *GetDocumentVersionInput, optFns ...func(*Options)) (*GetDocumentVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocumentVersion", params, optFns, addOperationGetDocumentVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
