...
func (c *Client) GetDocumentPath(ctx context.Context, params *GetDocumentPathInput, optFns ...func(*Options)) (*GetDocumentPathOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocumentPath", params, optFns, addOperationGetDocumentPathMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentPathMiddleware(stack *middleware.Stack, options Options) (err error) {
