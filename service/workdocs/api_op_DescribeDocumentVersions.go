...
func (c *Client) DescribeDocumentVersions(ctx context.Context, params *DescribeDocumentVersionsInput, optFns ...func(*Options)) (*DescribeDocumentVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDocumentVersions", params, optFns, addOperationDescribeDocumentVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDocumentVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
