...
func (c *Client) RemoveResourcePermission(ctx context.Context, params *RemoveResourcePermissionInput, optFns ...func(*Options)) (*RemoveResourcePermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveResourcePermission", params, optFns, addOperationRemoveResourcePermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveResourcePermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
