...
func (c *Client) DescribeResourcePermissions(ctx context.Context, params *DescribeResourcePermissionsInput, optFns ...func(*Options)) (*DescribeResourcePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeResourcePermissions", params, optFns, addOperationDescribeResourcePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeResourcePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
