...
func (c *Client) DescribeActivities(ctx context.Context, params *DescribeActivitiesInput, optFns ...func(*Options)) (*DescribeActivitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeActivities", params, optFns, addOperationDescribeActivitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeActivitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
