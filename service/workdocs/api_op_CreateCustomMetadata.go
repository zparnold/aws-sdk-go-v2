...
func (c *Client) CreateCustomMetadata(ctx context.Context, params *CreateCustomMetadataInput, optFns ...func(*Options)) (*CreateCustomMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomMetadata", params, optFns, addOperationCreateCustomMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
