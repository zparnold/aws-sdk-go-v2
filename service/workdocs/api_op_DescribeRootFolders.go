...
func (c *Client) DescribeRootFolders(ctx context.Context, params *DescribeRootFoldersInput, optFns ...func(*Options)) (*DescribeRootFoldersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRootFolders", params, optFns, addOperationDescribeRootFoldersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRootFoldersMiddleware(stack *middleware.Stack, options Options) (err error) {
