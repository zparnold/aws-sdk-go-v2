...
func (c *Client) AbortDocumentVersionUpload(ctx context.Context, params *AbortDocumentVersionUploadInput, optFns ...func(*Options)) (*AbortDocumentVersionUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AbortDocumentVersionUpload", params, optFns, addOperationAbortDocumentVersionUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAbortDocumentVersionUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
