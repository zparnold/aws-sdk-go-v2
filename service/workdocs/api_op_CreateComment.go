...
func (c *Client) CreateComment(ctx context.Context, params *CreateCommentInput, optFns ...func(*Options)) (*CreateCommentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateComment", params, optFns, addOperationCreateCommentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCommentMiddleware(stack *middleware.Stack, options Options) (err error) {
