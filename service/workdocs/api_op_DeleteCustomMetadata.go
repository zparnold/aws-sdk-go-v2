...
func (c *Client) DeleteCustomMetadata(ctx context.Context, params *DeleteCustomMetadataInput, optFns ...func(*Options)) (*DeleteCustomMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCustomMetadata", params, optFns, addOperationDeleteCustomMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCustomMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
