...
func (c *Client) GetCurrentUser(ctx context.Context, params *GetCurrentUserInput, optFns ...func(*Options)) (*GetCurrentUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCurrentUser", params, optFns, addOperationGetCurrentUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCurrentUserMiddleware(stack *middleware.Stack, options Options) (err error) {
