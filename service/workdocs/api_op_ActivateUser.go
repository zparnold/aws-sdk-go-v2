...
func (c *Client) ActivateUser(ctx context.Context, params *ActivateUserInput, optFns ...func(*Options)) (*ActivateUserOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ActivateUser", params, optFns, addOperationActivateUserMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationActivateUserMiddleware(stack *middleware.Stack, options Options) (err error) {
