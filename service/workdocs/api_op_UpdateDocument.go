...
func (c *Client) UpdateDocument(ctx context.Context, params *UpdateDocumentInput, optFns ...func(*Options)) (*UpdateDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDocument", params, optFns, addOperationUpdateDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
