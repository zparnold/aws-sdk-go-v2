...
func (c *Client) UpdateFolder(ctx context.Context, params *UpdateFolderInput, optFns ...func(*Options)) (*UpdateFolderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFolder", params, optFns, addOperationUpdateFolderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFolderMiddleware(stack *middleware.Stack, options Options) (err error) {
