...
func (c *Client) DescribeComments(ctx context.Context, params *DescribeCommentsInput, optFns ...func(*Options)) (*DescribeCommentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeComments", params, optFns, addOperationDescribeCommentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCommentsMiddleware(stack *middleware.Stack, options Options) (err error) {
