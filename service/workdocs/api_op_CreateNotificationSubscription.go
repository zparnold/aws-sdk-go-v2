...
func (c *Client) CreateNotificationSubscription(ctx context.Context, params *CreateNotificationSubscriptionInput, optFns ...func(*Options)) (*CreateNotificationSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNotificationSubscription", params, optFns, addOperationCreateNotificationSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNotificationSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
