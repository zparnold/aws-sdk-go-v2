...
func (c *Client) DeleteFolder(ctx context.Context, params *DeleteFolderInput, optFns ...func(*Options)) (*DeleteFolderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFolder", params, optFns, addOperationDeleteFolderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFolderMiddleware(stack *middleware.Stack, options Options) (err error) {
