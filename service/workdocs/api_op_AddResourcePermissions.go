...
func (c *Client) AddResourcePermissions(ctx context.Context, params *AddResourcePermissionsInput, optFns ...func(*Options)) (*AddResourcePermissionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddResourcePermissions", params, optFns, addOperationAddResourcePermissionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddResourcePermissionsMiddleware(stack *middleware.Stack, options Options) (err error) {
