...
func (c *Client) CreateLabels(ctx context.Context, params *CreateLabelsInput, optFns ...func(*Options)) (*CreateLabelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLabels", params, optFns, addOperationCreateLabelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLabelsMiddleware(stack *middleware.Stack, options Options) (err error) {
