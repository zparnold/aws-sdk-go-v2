...
func (c *Client) DescribeNotificationSubscriptions(ctx context.Context, params *DescribeNotificationSubscriptionsInput, optFns ...func(*Options)) (*DescribeNotificationSubscriptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNotificationSubscriptions", params, optFns, addOperationDescribeNotificationSubscriptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNotificationSubscriptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
