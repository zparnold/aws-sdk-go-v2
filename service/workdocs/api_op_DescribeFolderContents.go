...
func (c *Client) DescribeFolderContents(ctx context.Context, params *DescribeFolderContentsInput, optFns ...func(*Options)) (*DescribeFolderContentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFolderContents", params, optFns, addOperationDescribeFolderContentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeFolderContentsMiddleware(stack *middleware.Stack, options Options) (err error) {
