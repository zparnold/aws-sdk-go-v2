...
func (c *Client) GetFolderPath(ctx context.Context, params *GetFolderPathInput, optFns ...func(*Options)) (*GetFolderPathOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFolderPath", params, optFns, addOperationGetFolderPathMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFolderPathMiddleware(stack *middleware.Stack, options Options) (err error) {
