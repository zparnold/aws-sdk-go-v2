...
func (c *Client) CreateFolder(ctx context.Context, params *CreateFolderInput, optFns ...func(*Options)) (*CreateFolderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFolder", params, optFns, addOperationCreateFolderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFolderMiddleware(stack *middleware.Stack, options Options) (err error) {
