...
func (c *Client) DescribeAssociationExecutionTargets(ctx context.Context, params *DescribeAssociationExecutionTargetsInput, optFns ...func(*Options)) (*DescribeAssociationExecutionTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssociationExecutionTargets", params, optFns, addOperationDescribeAssociationExecutionTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssociationExecutionTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
