...
func (c *Client) DeregisterTargetFromMaintenanceWindow(ctx context.Context, params *DeregisterTargetFromMaintenanceWindowInput, optFns ...func(*Options)) (*DeregisterTargetFromMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterTargetFromMaintenanceWindow", params, optFns, addOperationDeregisterTargetFromMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterTargetFromMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
