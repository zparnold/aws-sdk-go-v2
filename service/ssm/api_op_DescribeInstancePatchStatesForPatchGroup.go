...
func (c *Client) DescribeInstancePatchStatesForPatchGroup(ctx context.Context, params *DescribeInstancePatchStatesForPatchGroupInput, optFns ...func(*Options)) (*DescribeInstancePatchStatesForPatchGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstancePatchStatesForPatchGroup", params, optFns, addOperationDescribeInstancePatchStatesForPatchGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstancePatchStatesForPatchGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
