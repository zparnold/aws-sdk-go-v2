...
func (c *Client) UpdateResourceDataSync(ctx context.Context, params *UpdateResourceDataSyncInput, optFns ...func(*Options)) (*UpdateResourceDataSyncOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateResourceDataSync", params, optFns, addOperationUpdateResourceDataSyncMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateResourceDataSyncMiddleware(stack *middleware.Stack, options Options) (err error) {
