...
func (c *Client) DescribeMaintenanceWindows(ctx context.Context, params *DescribeMaintenanceWindowsInput, optFns ...func(*Options)) (*DescribeMaintenanceWindowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMaintenanceWindows", params, optFns, addOperationDescribeMaintenanceWindowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMaintenanceWindowsMiddleware(stack *middleware.Stack, options Options) (err error) {
