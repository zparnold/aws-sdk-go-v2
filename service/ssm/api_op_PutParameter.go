...
func (c *Client) PutParameter(ctx context.Context, params *PutParameterInput, optFns ...func(*Options)) (*PutParameterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutParameter", params, optFns, addOperationPutParameterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutParameterMiddleware(stack *middleware.Stack, options Options) (err error) {
