...
func (c *Client) UpdateOpsItem(ctx context.Context, params *UpdateOpsItemInput, optFns ...func(*Options)) (*UpdateOpsItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateOpsItem", params, optFns, addOperationUpdateOpsItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateOpsItemMiddleware(stack *middleware.Stack, options Options) (err error) {
