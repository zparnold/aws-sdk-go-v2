...
func (c *Client) CreatePatchBaseline(ctx context.Context, params *CreatePatchBaselineInput, optFns ...func(*Options)) (*CreatePatchBaselineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePatchBaseline", params, optFns, addOperationCreatePatchBaselineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePatchBaselineMiddleware(stack *middleware.Stack, options Options) (err error) {
