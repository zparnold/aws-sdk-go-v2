...
func (c *Client) UpdatePatchBaseline(ctx context.Context, params *UpdatePatchBaselineInput, optFns ...func(*Options)) (*UpdatePatchBaselineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePatchBaseline", params, optFns, addOperationUpdatePatchBaselineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePatchBaselineMiddleware(stack *middleware.Stack, options Options) (err error) {
