...
func (c *Client) CancelMaintenanceWindowExecution(ctx context.Context, params *CancelMaintenanceWindowExecutionInput, optFns ...func(*Options)) (*CancelMaintenanceWindowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelMaintenanceWindowExecution", params, optFns, addOperationCancelMaintenanceWindowExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelMaintenanceWindowExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
