...
func (c *Client) GetServiceSetting(ctx context.Context, params *GetServiceSettingInput, optFns ...func(*Options)) (*GetServiceSettingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServiceSetting", params, optFns, addOperationGetServiceSettingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServiceSettingMiddleware(stack *middleware.Stack, options Options) (err error) {
