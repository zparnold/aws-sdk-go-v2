...
func (c *Client) UpdateAssociation(ctx context.Context, params *UpdateAssociationInput, optFns ...func(*Options)) (*UpdateAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAssociation", params, optFns, addOperationUpdateAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
