...
func (c *Client) DeleteAssociation(ctx context.Context, params *DeleteAssociationInput, optFns ...func(*Options)) (*DeleteAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAssociation", params, optFns, addOperationDeleteAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
