...
func (c *Client) DeleteInventory(ctx context.Context, params *DeleteInventoryInput, optFns ...func(*Options)) (*DeleteInventoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteInventory", params, optFns, addOperationDeleteInventoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteInventoryMiddleware(stack *middleware.Stack, options Options) (err error) {
