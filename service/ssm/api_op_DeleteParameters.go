...
func (c *Client) DeleteParameters(ctx context.Context, params *DeleteParametersInput, optFns ...func(*Options)) (*DeleteParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteParameters", params, optFns, addOperationDeleteParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
