...
func (c *Client) StopAutomationExecution(ctx context.Context, params *StopAutomationExecutionInput, optFns ...func(*Options)) (*StopAutomationExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopAutomationExecution", params, optFns, addOperationStopAutomationExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopAutomationExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
