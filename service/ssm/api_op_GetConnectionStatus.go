...
func (c *Client) GetConnectionStatus(ctx context.Context, params *GetConnectionStatusInput, optFns ...func(*Options)) (*GetConnectionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConnectionStatus", params, optFns, addOperationGetConnectionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConnectionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
