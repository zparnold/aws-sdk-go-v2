...
func (c *Client) GetDeployablePatchSnapshotForInstance(ctx context.Context, params *GetDeployablePatchSnapshotForInstanceInput, optFns ...func(*Options)) (*GetDeployablePatchSnapshotForInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeployablePatchSnapshotForInstance", params, optFns, addOperationGetDeployablePatchSnapshotForInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeployablePatchSnapshotForInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
