...
func (c *Client) GetParametersByPath(ctx context.Context, params *GetParametersByPathInput, optFns ...func(*Options)) (*GetParametersByPathOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetParametersByPath", params, optFns, addOperationGetParametersByPathMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetParametersByPathMiddleware(stack *middleware.Stack, options Options) (err error) {
