...
func (c *Client) DeleteResourceDataSync(ctx context.Context, params *DeleteResourceDataSyncInput, optFns ...func(*Options)) (*DeleteResourceDataSyncOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResourceDataSync", params, optFns, addOperationDeleteResourceDataSyncMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResourceDataSyncMiddleware(stack *middleware.Stack, options Options) (err error) {
