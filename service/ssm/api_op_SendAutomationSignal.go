...
func (c *Client) SendAutomationSignal(ctx context.Context, params *SendAutomationSignalInput, optFns ...func(*Options)) (*SendAutomationSignalOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendAutomationSignal", params, optFns, addOperationSendAutomationSignalMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendAutomationSignalMiddleware(stack *middleware.Stack, options Options) (err error) {
