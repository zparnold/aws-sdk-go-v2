...
func (c *Client) DeleteDocument(ctx context.Context, params *DeleteDocumentInput, optFns ...func(*Options)) (*DeleteDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDocument", params, optFns, addOperationDeleteDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
