...
func (c *Client) DescribeInventoryDeletions(ctx context.Context, params *DescribeInventoryDeletionsInput, optFns ...func(*Options)) (*DescribeInventoryDeletionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInventoryDeletions", params, optFns, addOperationDescribeInventoryDeletionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInventoryDeletionsMiddleware(stack *middleware.Stack, options Options) (err error) {
