...
func (c *Client) DescribeAutomationExecutions(ctx context.Context, params *DescribeAutomationExecutionsInput, optFns ...func(*Options)) (*DescribeAutomationExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAutomationExecutions", params, optFns, addOperationDescribeAutomationExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAutomationExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
