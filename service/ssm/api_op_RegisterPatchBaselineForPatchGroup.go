...
func (c *Client) RegisterPatchBaselineForPatchGroup(ctx context.Context, params *RegisterPatchBaselineForPatchGroupInput, optFns ...func(*Options)) (*RegisterPatchBaselineForPatchGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterPatchBaselineForPatchGroup", params, optFns, addOperationRegisterPatchBaselineForPatchGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterPatchBaselineForPatchGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
