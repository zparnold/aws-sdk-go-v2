...
func (c *Client) CreateAssociationBatch(ctx context.Context, params *CreateAssociationBatchInput, optFns ...func(*Options)) (*CreateAssociationBatchOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAssociationBatch", params, optFns, addOperationCreateAssociationBatchMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAssociationBatchMiddleware(stack *middleware.Stack, options Options) (err error) {
