...
func (c *Client) GetOpsItem(ctx context.Context, params *GetOpsItemInput, optFns ...func(*Options)) (*GetOpsItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOpsItem", params, optFns, addOperationGetOpsItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOpsItemMiddleware(stack *middleware.Stack, options Options) (err error) {
