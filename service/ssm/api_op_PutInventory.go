...
func (c *Client) PutInventory(ctx context.Context, params *PutInventoryInput, optFns ...func(*Options)) (*PutInventoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutInventory", params, optFns, addOperationPutInventoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutInventoryMiddleware(stack *middleware.Stack, options Options) (err error) {
