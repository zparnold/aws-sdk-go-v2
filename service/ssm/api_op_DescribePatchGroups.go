...
func (c *Client) DescribePatchGroups(ctx context.Context, params *DescribePatchGroupsInput, optFns ...func(*Options)) (*DescribePatchGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePatchGroups", params, optFns, addOperationDescribePatchGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePatchGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
