...
func (c *Client) ListCommands(ctx context.Context, params *ListCommandsInput, optFns ...func(*Options)) (*ListCommandsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCommands", params, optFns, addOperationListCommandsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCommandsMiddleware(stack *middleware.Stack, options Options) (err error) {
