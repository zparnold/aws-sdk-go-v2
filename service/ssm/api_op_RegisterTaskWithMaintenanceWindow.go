...
func (c *Client) RegisterTaskWithMaintenanceWindow(ctx context.Context, params *RegisterTaskWithMaintenanceWindowInput, optFns ...func(*Options)) (*RegisterTaskWithMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterTaskWithMaintenanceWindow", params, optFns, addOperationRegisterTaskWithMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterTaskWithMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
