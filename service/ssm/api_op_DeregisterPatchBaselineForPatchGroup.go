...
func (c *Client) DeregisterPatchBaselineForPatchGroup(ctx context.Context, params *DeregisterPatchBaselineForPatchGroupInput, optFns ...func(*Options)) (*DeregisterPatchBaselineForPatchGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterPatchBaselineForPatchGroup", params, optFns, addOperationDeregisterPatchBaselineForPatchGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterPatchBaselineForPatchGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
