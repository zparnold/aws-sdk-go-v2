...
func (c *Client) DescribeInstanceAssociationsStatus(ctx context.Context, params *DescribeInstanceAssociationsStatusInput, optFns ...func(*Options)) (*DescribeInstanceAssociationsStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceAssociationsStatus", params, optFns, addOperationDescribeInstanceAssociationsStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceAssociationsStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
