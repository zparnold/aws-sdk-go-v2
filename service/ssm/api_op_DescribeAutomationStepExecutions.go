...
func (c *Client) DescribeAutomationStepExecutions(ctx context.Context, params *DescribeAutomationStepExecutionsInput, optFns ...func(*Options)) (*DescribeAutomationStepExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAutomationStepExecutions", params, optFns, addOperationDescribeAutomationStepExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAutomationStepExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
