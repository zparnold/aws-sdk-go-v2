...
func (c *Client) DeregisterManagedInstance(ctx context.Context, params *DeregisterManagedInstanceInput, optFns ...func(*Options)) (*DeregisterManagedInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterManagedInstance", params, optFns, addOperationDeregisterManagedInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterManagedInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
