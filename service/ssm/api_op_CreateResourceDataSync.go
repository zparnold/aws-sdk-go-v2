...
func (c *Client) CreateResourceDataSync(ctx context.Context, params *CreateResourceDataSyncInput, optFns ...func(*Options)) (*CreateResourceDataSyncOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResourceDataSync", params, optFns, addOperationCreateResourceDataSyncMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResourceDataSyncMiddleware(stack *middleware.Stack, options Options) (err error) {
