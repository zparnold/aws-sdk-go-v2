...
func (c *Client) ResumeSession(ctx context.Context, params *ResumeSessionInput, optFns ...func(*Options)) (*ResumeSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResumeSession", params, optFns, addOperationResumeSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResumeSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
