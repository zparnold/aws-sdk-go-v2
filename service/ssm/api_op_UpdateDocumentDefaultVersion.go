...
func (c *Client) UpdateDocumentDefaultVersion(ctx context.Context, params *UpdateDocumentDefaultVersionInput, optFns ...func(*Options)) (*UpdateDocumentDefaultVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDocumentDefaultVersion", params, optFns, addOperationUpdateDocumentDefaultVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDocumentDefaultVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
