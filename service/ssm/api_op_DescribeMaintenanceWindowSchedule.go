...
func (c *Client) DescribeMaintenanceWindowSchedule(ctx context.Context, params *DescribeMaintenanceWindowScheduleInput, optFns ...func(*Options)) (*DescribeMaintenanceWindowScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMaintenanceWindowSchedule", params, optFns, addOperationDescribeMaintenanceWindowScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMaintenanceWindowScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
