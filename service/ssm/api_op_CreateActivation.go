...
func (c *Client) CreateActivation(ctx context.Context, params *CreateActivationInput, optFns ...func(*Options)) (*CreateActivationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateActivation", params, optFns, addOperationCreateActivationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateActivationMiddleware(stack *middleware.Stack, options Options) (err error) {
