...
func (c *Client) RegisterTargetWithMaintenanceWindow(ctx context.Context, params *RegisterTargetWithMaintenanceWindowInput, optFns ...func(*Options)) (*RegisterTargetWithMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterTargetWithMaintenanceWindow", params, optFns, addOperationRegisterTargetWithMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterTargetWithMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
