...
func (c *Client) DescribePatchProperties(ctx context.Context, params *DescribePatchPropertiesInput, optFns ...func(*Options)) (*DescribePatchPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePatchProperties", params, optFns, addOperationDescribePatchPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePatchPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
