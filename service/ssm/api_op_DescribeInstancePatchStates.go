...
func (c *Client) DescribeInstancePatchStates(ctx context.Context, params *DescribeInstancePatchStatesInput, optFns ...func(*Options)) (*DescribeInstancePatchStatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstancePatchStates", params, optFns, addOperationDescribeInstancePatchStatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstancePatchStatesMiddleware(stack *middleware.Stack, options Options) (err error) {
