...
func (c *Client) GetMaintenanceWindow(ctx context.Context, params *GetMaintenanceWindowInput, optFns ...func(*Options)) (*GetMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMaintenanceWindow", params, optFns, addOperationGetMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
