...
func (c *Client) DescribeAssociationExecutions(ctx context.Context, params *DescribeAssociationExecutionsInput, optFns ...func(*Options)) (*DescribeAssociationExecutionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssociationExecutions", params, optFns, addOperationDescribeAssociationExecutionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssociationExecutionsMiddleware(stack *middleware.Stack, options Options) (err error) {
