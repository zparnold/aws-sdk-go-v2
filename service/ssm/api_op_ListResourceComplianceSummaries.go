...
func (c *Client) ListResourceComplianceSummaries(ctx context.Context, params *ListResourceComplianceSummariesInput, optFns ...func(*Options)) (*ListResourceComplianceSummariesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceComplianceSummaries", params, optFns, addOperationListResourceComplianceSummariesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceComplianceSummariesMiddleware(stack *middleware.Stack, options Options) (err error) {
