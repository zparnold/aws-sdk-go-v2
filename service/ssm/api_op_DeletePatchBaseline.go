...
func (c *Client) DeletePatchBaseline(ctx context.Context, params *DeletePatchBaselineInput, optFns ...func(*Options)) (*DeletePatchBaselineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePatchBaseline", params, optFns, addOperationDeletePatchBaselineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePatchBaselineMiddleware(stack *middleware.Stack, options Options) (err error) {
