...
func (c *Client) DeleteParameter(ctx context.Context, params *DeleteParameterInput, optFns ...func(*Options)) (*DeleteParameterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteParameter", params, optFns, addOperationDeleteParameterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteParameterMiddleware(stack *middleware.Stack, options Options) (err error) {
