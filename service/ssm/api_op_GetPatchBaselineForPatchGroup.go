...
func (c *Client) GetPatchBaselineForPatchGroup(ctx context.Context, params *GetPatchBaselineForPatchGroupInput, optFns ...func(*Options)) (*GetPatchBaselineForPatchGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPatchBaselineForPatchGroup", params, optFns, addOperationGetPatchBaselineForPatchGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPatchBaselineForPatchGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
