...
func (c *Client) GetMaintenanceWindowExecution(ctx context.Context, params *GetMaintenanceWindowExecutionInput, optFns ...func(*Options)) (*GetMaintenanceWindowExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMaintenanceWindowExecution", params, optFns, addOperationGetMaintenanceWindowExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMaintenanceWindowExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
