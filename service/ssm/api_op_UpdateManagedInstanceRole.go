...
func (c *Client) UpdateManagedInstanceRole(ctx context.Context, params *UpdateManagedInstanceRoleInput, optFns ...func(*Options)) (*UpdateManagedInstanceRoleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateManagedInstanceRole", params, optFns, addOperationUpdateManagedInstanceRoleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateManagedInstanceRoleMiddleware(stack *middleware.Stack, options Options) (err error) {
