...
func (c *Client) StartSession(ctx context.Context, params *StartSessionInput, optFns ...func(*Options)) (*StartSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSession", params, optFns, addOperationStartSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
