...
func (c *Client) DescribeSessions(ctx context.Context, params *DescribeSessionsInput, optFns ...func(*Options)) (*DescribeSessionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSessions", params, optFns, addOperationDescribeSessionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSessionsMiddleware(stack *middleware.Stack, options Options) (err error) {
