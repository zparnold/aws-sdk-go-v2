...
func (c *Client) ListAssociations(ctx context.Context, params *ListAssociationsInput, optFns ...func(*Options)) (*ListAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssociations", params, optFns, addOperationListAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
