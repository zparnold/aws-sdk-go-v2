...
func (c *Client) DescribeEffectiveInstanceAssociations(ctx context.Context, params *DescribeEffectiveInstanceAssociationsInput, optFns ...func(*Options)) (*DescribeEffectiveInstanceAssociationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEffectiveInstanceAssociations", params, optFns, addOperationDescribeEffectiveInstanceAssociationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEffectiveInstanceAssociationsMiddleware(stack *middleware.Stack, options Options) (err error) {
