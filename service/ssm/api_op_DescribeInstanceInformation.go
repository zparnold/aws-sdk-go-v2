...
func (c *Client) DescribeInstanceInformation(ctx context.Context, params *DescribeInstanceInformationInput, optFns ...func(*Options)) (*DescribeInstanceInformationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceInformation", params, optFns, addOperationDescribeInstanceInformationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceInformationMiddleware(stack *middleware.Stack, options Options) (err error) {
