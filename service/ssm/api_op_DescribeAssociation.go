...
func (c *Client) DescribeAssociation(ctx context.Context, params *DescribeAssociationInput, optFns ...func(*Options)) (*DescribeAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAssociation", params, optFns, addOperationDescribeAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
