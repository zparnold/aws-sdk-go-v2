...
func (c *Client) CreateDocument(ctx context.Context, params *CreateDocumentInput, optFns ...func(*Options)) (*CreateDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDocument", params, optFns, addOperationCreateDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
