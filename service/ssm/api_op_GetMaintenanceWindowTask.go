...
func (c *Client) GetMaintenanceWindowTask(ctx context.Context, params *GetMaintenanceWindowTaskInput, optFns ...func(*Options)) (*GetMaintenanceWindowTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMaintenanceWindowTask", params, optFns, addOperationGetMaintenanceWindowTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMaintenanceWindowTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
