...
func (c *Client) GetCalendarState(ctx context.Context, params *GetCalendarStateInput, optFns ...func(*Options)) (*GetCalendarStateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCalendarState", params, optFns, addOperationGetCalendarStateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCalendarStateMiddleware(stack *middleware.Stack, options Options) (err error) {
