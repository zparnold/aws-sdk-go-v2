...
func (c *Client) DescribeMaintenanceWindowExecutionTasks(ctx context.Context, params *DescribeMaintenanceWindowExecutionTasksInput, optFns ...func(*Options)) (*DescribeMaintenanceWindowExecutionTasksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMaintenanceWindowExecutionTasks", params, optFns, addOperationDescribeMaintenanceWindowExecutionTasksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMaintenanceWindowExecutionTasksMiddleware(stack *middleware.Stack, options Options) (err error) {
