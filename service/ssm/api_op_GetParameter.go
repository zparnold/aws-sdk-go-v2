...
func (c *Client) GetParameter(ctx context.Context, params *GetParameterInput, optFns ...func(*Options)) (*GetParameterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetParameter", params, optFns, addOperationGetParameterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetParameterMiddleware(stack *middleware.Stack, options Options) (err error) {
