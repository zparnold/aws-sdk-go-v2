...
func (c *Client) UpdateMaintenanceWindowTask(ctx context.Context, params *UpdateMaintenanceWindowTaskInput, optFns ...func(*Options)) (*UpdateMaintenanceWindowTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMaintenanceWindowTask", params, optFns, addOperationUpdateMaintenanceWindowTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMaintenanceWindowTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
