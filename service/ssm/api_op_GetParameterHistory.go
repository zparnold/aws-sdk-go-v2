...
func (c *Client) GetParameterHistory(ctx context.Context, params *GetParameterHistoryInput, optFns ...func(*Options)) (*GetParameterHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetParameterHistory", params, optFns, addOperationGetParameterHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetParameterHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
