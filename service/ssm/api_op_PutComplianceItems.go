...
func (c *Client) PutComplianceItems(ctx context.Context, params *PutComplianceItemsInput, optFns ...func(*Options)) (*PutComplianceItemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutComplianceItems", params, optFns, addOperationPutComplianceItemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutComplianceItemsMiddleware(stack *middleware.Stack, options Options) (err error) {
