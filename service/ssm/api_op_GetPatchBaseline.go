...
func (c *Client) GetPatchBaseline(ctx context.Context, params *GetPatchBaselineInput, optFns ...func(*Options)) (*GetPatchBaselineOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPatchBaseline", params, optFns, addOperationGetPatchBaselineMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPatchBaselineMiddleware(stack *middleware.Stack, options Options) (err error) {
