...
func (c *Client) DescribeMaintenanceWindowsForTarget(ctx context.Context, params *DescribeMaintenanceWindowsForTargetInput, optFns ...func(*Options)) (*DescribeMaintenanceWindowsForTargetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMaintenanceWindowsForTarget", params, optFns, addOperationDescribeMaintenanceWindowsForTargetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMaintenanceWindowsForTargetMiddleware(stack *middleware.Stack, options Options) (err error) {
