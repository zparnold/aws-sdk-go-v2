...
func (c *Client) ListAssociationVersions(ctx context.Context, params *ListAssociationVersionsInput, optFns ...func(*Options)) (*ListAssociationVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAssociationVersions", params, optFns, addOperationListAssociationVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAssociationVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
