...
func (c *Client) GetParameters(ctx context.Context, params *GetParametersInput, optFns ...func(*Options)) (*GetParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetParameters", params, optFns, addOperationGetParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
