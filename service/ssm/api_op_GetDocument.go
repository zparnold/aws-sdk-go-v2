...
func (c *Client) GetDocument(ctx context.Context, params *GetDocumentInput, optFns ...func(*Options)) (*GetDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocument", params, optFns, addOperationGetDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
