...
func (c *Client) DescribeMaintenanceWindowExecutionTaskInvocations(ctx context.Context, params *DescribeMaintenanceWindowExecutionTaskInvocationsInput, optFns ...func(*Options)) (*DescribeMaintenanceWindowExecutionTaskInvocationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeMaintenanceWindowExecutionTaskInvocations", params, optFns, addOperationDescribeMaintenanceWindowExecutionTaskInvocationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeMaintenanceWindowExecutionTaskInvocationsMiddleware(stack *middleware.Stack, options Options) (err error) {
