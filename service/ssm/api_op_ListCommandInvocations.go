...
func (c *Client) ListCommandInvocations(ctx context.Context, params *ListCommandInvocationsInput, optFns ...func(*Options)) (*ListCommandInvocationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCommandInvocations", params, optFns, addOperationListCommandInvocationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCommandInvocationsMiddleware(stack *middleware.Stack, options Options) (err error) {
