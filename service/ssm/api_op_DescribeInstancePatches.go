...
func (c *Client) DescribeInstancePatches(ctx context.Context, params *DescribeInstancePatchesInput, optFns ...func(*Options)) (*DescribeInstancePatchesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstancePatches", params, optFns, addOperationDescribeInstancePatchesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstancePatchesMiddleware(stack *middleware.Stack, options Options) (err error) {
