...
func (c *Client) CreateMaintenanceWindow(ctx context.Context, params *CreateMaintenanceWindowInput, optFns ...func(*Options)) (*CreateMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMaintenanceWindow", params, optFns, addOperationCreateMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
