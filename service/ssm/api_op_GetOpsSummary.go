...
func (c *Client) GetOpsSummary(ctx context.Context, params *GetOpsSummaryInput, optFns ...func(*Options)) (*GetOpsSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOpsSummary", params, optFns, addOperationGetOpsSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOpsSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
