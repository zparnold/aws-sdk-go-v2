...
func (c *Client) ListResourceDataSync(ctx context.Context, params *ListResourceDataSyncInput, optFns ...func(*Options)) (*ListResourceDataSyncOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListResourceDataSync", params, optFns, addOperationListResourceDataSyncMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListResourceDataSyncMiddleware(stack *middleware.Stack, options Options) (err error) {
