...
func (c *Client) CreateAssociation(ctx context.Context, params *CreateAssociationInput, optFns ...func(*Options)) (*CreateAssociationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAssociation", params, optFns, addOperationCreateAssociationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAssociationMiddleware(stack *middleware.Stack, options Options) (err error) {
