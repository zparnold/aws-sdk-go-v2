...
func (c *Client) DescribeAvailablePatches(ctx context.Context, params *DescribeAvailablePatchesInput, optFns ...func(*Options)) (*DescribeAvailablePatchesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAvailablePatches", params, optFns, addOperationDescribeAvailablePatchesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAvailablePatchesMiddleware(stack *middleware.Stack, options Options) (err error) {
