...
func (c *Client) ListDocumentVersions(ctx context.Context, params *ListDocumentVersionsInput, optFns ...func(*Options)) (*ListDocumentVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDocumentVersions", params, optFns, addOperationListDocumentVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDocumentVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
