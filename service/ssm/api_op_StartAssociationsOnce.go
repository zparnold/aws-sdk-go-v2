...
func (c *Client) StartAssociationsOnce(ctx context.Context, params *StartAssociationsOnceInput, optFns ...func(*Options)) (*StartAssociationsOnceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartAssociationsOnce", params, optFns, addOperationStartAssociationsOnceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartAssociationsOnceMiddleware(stack *middleware.Stack, options Options) (err error) {
