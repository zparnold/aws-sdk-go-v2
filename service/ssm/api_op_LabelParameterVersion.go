...
func (c *Client) LabelParameterVersion(ctx context.Context, params *LabelParameterVersionInput, optFns ...func(*Options)) (*LabelParameterVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "LabelParameterVersion", params, optFns, addOperationLabelParameterVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLabelParameterVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
