...
func (c *Client) RemoveTagsFromResource(ctx context.Context, params *RemoveTagsFromResourceInput, optFns ...func(*Options)) (*RemoveTagsFromResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveTagsFromResource", params, optFns, addOperationRemoveTagsFromResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveTagsFromResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
