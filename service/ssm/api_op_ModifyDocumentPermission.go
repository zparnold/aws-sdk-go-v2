...
func (c *Client) ModifyDocumentPermission(ctx context.Context, params *ModifyDocumentPermissionInput, optFns ...func(*Options)) (*ModifyDocumentPermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDocumentPermission", params, optFns, addOperationModifyDocumentPermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDocumentPermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
