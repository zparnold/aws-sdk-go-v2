...
func (c *Client) DeregisterTaskFromMaintenanceWindow(ctx context.Context, params *DeregisterTaskFromMaintenanceWindowInput, optFns ...func(*Options)) (*DeregisterTaskFromMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterTaskFromMaintenanceWindow", params, optFns, addOperationDeregisterTaskFromMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterTaskFromMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
