...
func (c *Client) UpdateServiceSetting(ctx context.Context, params *UpdateServiceSettingInput, optFns ...func(*Options)) (*UpdateServiceSettingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateServiceSetting", params, optFns, addOperationUpdateServiceSettingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateServiceSettingMiddleware(stack *middleware.Stack, options Options) (err error) {
