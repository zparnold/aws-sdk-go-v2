...
func (c *Client) CreateOpsItem(ctx context.Context, params *CreateOpsItemInput, optFns ...func(*Options)) (*CreateOpsItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOpsItem", params, optFns, addOperationCreateOpsItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOpsItemMiddleware(stack *middleware.Stack, options Options) (err error) {
