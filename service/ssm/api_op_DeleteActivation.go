...
func (c *Client) DeleteActivation(ctx context.Context, params *DeleteActivationInput, optFns ...func(*Options)) (*DeleteActivationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteActivation", params, optFns, addOperationDeleteActivationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteActivationMiddleware(stack *middleware.Stack, options Options) (err error) {
