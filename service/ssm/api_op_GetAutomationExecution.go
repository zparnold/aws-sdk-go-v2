...
func (c *Client) GetAutomationExecution(ctx context.Context, params *GetAutomationExecutionInput, optFns ...func(*Options)) (*GetAutomationExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAutomationExecution", params, optFns, addOperationGetAutomationExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAutomationExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
