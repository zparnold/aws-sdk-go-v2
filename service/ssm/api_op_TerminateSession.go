...
func (c *Client) TerminateSession(ctx context.Context, params *TerminateSessionInput, optFns ...func(*Options)) (*TerminateSessionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TerminateSession", params, optFns, addOperationTerminateSessionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTerminateSessionMiddleware(stack *middleware.Stack, options Options) (err error) {
