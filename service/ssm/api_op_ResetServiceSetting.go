...
func (c *Client) ResetServiceSetting(ctx context.Context, params *ResetServiceSettingInput, optFns ...func(*Options)) (*ResetServiceSettingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetServiceSetting", params, optFns, addOperationResetServiceSettingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetServiceSettingMiddleware(stack *middleware.Stack, options Options) (err error) {
