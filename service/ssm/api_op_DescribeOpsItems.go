...
func (c *Client) DescribeOpsItems(ctx context.Context, params *DescribeOpsItemsInput, optFns ...func(*Options)) (*DescribeOpsItemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOpsItems", params, optFns, addOperationDescribeOpsItemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOpsItemsMiddleware(stack *middleware.Stack, options Options) (err error) {
