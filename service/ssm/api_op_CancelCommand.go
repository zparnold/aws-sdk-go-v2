...
func (c *Client) CancelCommand(ctx context.Context, params *CancelCommandInput, optFns ...func(*Options)) (*CancelCommandOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelCommand", params, optFns, addOperationCancelCommandMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelCommandMiddleware(stack *middleware.Stack, options Options) (err error) {
