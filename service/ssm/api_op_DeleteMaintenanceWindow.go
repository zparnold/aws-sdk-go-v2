...
func (c *Client) DeleteMaintenanceWindow(ctx context.Context, params *DeleteMaintenanceWindowInput, optFns ...func(*Options)) (*DeleteMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMaintenanceWindow", params, optFns, addOperationDeleteMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
