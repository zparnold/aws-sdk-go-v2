...
func (c *Client) ListDocuments(ctx context.Context, params *ListDocumentsInput, optFns ...func(*Options)) (*ListDocumentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDocuments", params, optFns, addOperationListDocumentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDocumentsMiddleware(stack *middleware.Stack, options Options) (err error) {
