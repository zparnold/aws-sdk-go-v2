...
func (c *Client) DescribeActivations(ctx context.Context, params *DescribeActivationsInput, optFns ...func(*Options)) (*DescribeActivationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeActivations", params, optFns, addOperationDescribeActivationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeActivationsMiddleware(stack *middleware.Stack, options Options) (err error) {
