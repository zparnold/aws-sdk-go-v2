...
func (c *Client) UpdateMaintenanceWindow(ctx context.Context, params *UpdateMaintenanceWindowInput, optFns ...func(*Options)) (*UpdateMaintenanceWindowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMaintenanceWindow", params, optFns, addOperationUpdateMaintenanceWindowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMaintenanceWindowMiddleware(stack *middleware.Stack, options Options) (err error) {
