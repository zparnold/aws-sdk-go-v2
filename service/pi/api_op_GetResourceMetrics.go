...
func (c *Client) GetResourceMetrics(ctx context.Context, params *GetResourceMetricsInput, optFns ...func(*Options)) (*GetResourceMetricsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResourceMetrics", params, optFns, addOperationGetResourceMetricsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourceMetricsMiddleware(stack *middleware.Stack, options Options) (err error) {
