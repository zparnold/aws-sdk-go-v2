...
func (c *Client) DescribeDimensionKeys(ctx context.Context, params *DescribeDimensionKeysInput, optFns ...func(*Options)) (*DescribeDimensionKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDimensionKeys", params, optFns, addOperationDescribeDimensionKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDimensionKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
