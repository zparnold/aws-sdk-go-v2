...
func (c *Client) UploadDocuments(ctx context.Context, params *UploadDocumentsInput, optFns ...func(*Options)) (*UploadDocumentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadDocuments", params, optFns, addOperationUploadDocumentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadDocumentsMiddleware(stack *middleware.Stack, options Options) (err error) {
