...
func (c *Client) Suggest(ctx context.Context, params *SuggestInput, optFns ...func(*Options)) (*SuggestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Suggest", params, optFns, addOperationSuggestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSuggestMiddleware(stack *middleware.Stack, options Options) (err error) {
