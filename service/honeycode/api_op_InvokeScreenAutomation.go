...
func (c *Client) InvokeScreenAutomation(ctx context.Context, params *InvokeScreenAutomationInput, optFns ...func(*Options)) (*InvokeScreenAutomationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "InvokeScreenAutomation", params, optFns, addOperationInvokeScreenAutomationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationInvokeScreenAutomationMiddleware(stack *middleware.Stack, options Options) (err error) {
