...
func (c *Client) GetScreenData(ctx context.Context, params *GetScreenDataInput, optFns ...func(*Options)) (*GetScreenDataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetScreenData", params, optFns, addOperationGetScreenDataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetScreenDataMiddleware(stack *middleware.Stack, options Options) (err error) {
