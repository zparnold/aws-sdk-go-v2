...
func (c *Client) StartServer(ctx context.Context, params *StartServerInput, optFns ...func(*Options)) (*StartServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartServer", params, optFns, addOperationStartServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartServerMiddleware(stack *middleware.Stack, options Options) (err error) {
