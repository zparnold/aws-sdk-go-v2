...
func (c *Client) TestIdentityProvider(ctx context.Context, params *TestIdentityProviderInput, optFns ...func(*Options)) (*TestIdentityProviderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestIdentityProvider", params, optFns, addOperationTestIdentityProviderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestIdentityProviderMiddleware(stack *middleware.Stack, options Options) (err error) {
