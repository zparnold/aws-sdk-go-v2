...
func (c *Client) ListServers(ctx context.Context, params *ListServersInput, optFns ...func(*Options)) (*ListServersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListServers", params, optFns, addOperationListServersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListServersMiddleware(stack *middleware.Stack, options Options) (err error) {
