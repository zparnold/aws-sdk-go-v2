...
func (c *Client) StopServer(ctx context.Context, params *StopServerInput, optFns ...func(*Options)) (*StopServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopServer", params, optFns, addOperationStopServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopServerMiddleware(stack *middleware.Stack, options Options) (err error) {
