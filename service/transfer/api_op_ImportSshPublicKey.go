...
func (c *Client) ImportSshPublicKey(ctx context.Context, params *ImportSshPublicKeyInput, optFns ...func(*Options)) (*ImportSshPublicKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportSshPublicKey", params, optFns, addOperationImportSshPublicKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportSshPublicKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
