...
func (c *Client) GetIceServerConfig(ctx context.Context, params *GetIceServerConfigInput, optFns ...func(*Options)) (*GetIceServerConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetIceServerConfig", params, optFns, addOperationGetIceServerConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetIceServerConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
