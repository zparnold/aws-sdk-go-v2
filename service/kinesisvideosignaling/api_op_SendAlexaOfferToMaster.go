...
func (c *Client) SendAlexaOfferToMaster(ctx context.Context, params *SendAlexaOfferToMasterInput, optFns ...func(*Options)) (*SendAlexaOfferToMasterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SendAlexaOfferToMaster", params, optFns, addOperationSendAlexaOfferToMasterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSendAlexaOfferToMasterMiddleware(stack *middleware.Stack, options Options) (err error) {
