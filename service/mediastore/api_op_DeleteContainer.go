...
func (c *Client) DeleteContainer(ctx context.Context, params *DeleteContainerInput, optFns ...func(*Options)) (*DeleteContainerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteContainer", params, optFns, addOperationDeleteContainerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteContainerMiddleware(stack *middleware.Stack, options Options) (err error) {
