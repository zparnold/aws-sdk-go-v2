...
func (c *Client) StopAccessLogging(ctx context.Context, params *StopAccessLoggingInput, optFns ...func(*Options)) (*StopAccessLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopAccessLogging", params, optFns, addOperationStopAccessLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopAccessLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
