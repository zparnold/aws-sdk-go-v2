...
func (c *Client) DeleteCorsPolicy(ctx context.Context, params *DeleteCorsPolicyInput, optFns ...func(*Options)) (*DeleteCorsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCorsPolicy", params, optFns, addOperationDeleteCorsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCorsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
