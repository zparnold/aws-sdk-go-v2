...
func (c *Client) CreateContainer(ctx context.Context, params *CreateContainerInput, optFns ...func(*Options)) (*CreateContainerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateContainer", params, optFns, addOperationCreateContainerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateContainerMiddleware(stack *middleware.Stack, options Options) (err error) {
