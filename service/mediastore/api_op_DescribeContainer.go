...
func (c *Client) DescribeContainer(ctx context.Context, params *DescribeContainerInput, optFns ...func(*Options)) (*DescribeContainerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeContainer", params, optFns, addOperationDescribeContainerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeContainerMiddleware(stack *middleware.Stack, options Options) (err error) {
