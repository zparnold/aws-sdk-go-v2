...
func (c *Client) GetCorsPolicy(ctx context.Context, params *GetCorsPolicyInput, optFns ...func(*Options)) (*GetCorsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCorsPolicy", params, optFns, addOperationGetCorsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCorsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
