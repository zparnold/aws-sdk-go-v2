...
func (c *Client) StartAccessLogging(ctx context.Context, params *StartAccessLoggingInput, optFns ...func(*Options)) (*StartAccessLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartAccessLogging", params, optFns, addOperationStartAccessLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartAccessLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
