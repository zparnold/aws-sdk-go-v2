...
func (c *Client) DeleteMetricPolicy(ctx context.Context, params *DeleteMetricPolicyInput, optFns ...func(*Options)) (*DeleteMetricPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMetricPolicy", params, optFns, addOperationDeleteMetricPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMetricPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
