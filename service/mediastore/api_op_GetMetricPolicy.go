...
func (c *Client) GetMetricPolicy(ctx context.Context, params *GetMetricPolicyInput, optFns ...func(*Options)) (*GetMetricPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMetricPolicy", params, optFns, addOperationGetMetricPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMetricPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
