...
func (c *Client) PutMetricPolicy(ctx context.Context, params *PutMetricPolicyInput, optFns ...func(*Options)) (*PutMetricPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMetricPolicy", params, optFns, addOperationPutMetricPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMetricPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
