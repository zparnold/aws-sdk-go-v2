...
func (c *Client) ListContainers(ctx context.Context, params *ListContainersInput, optFns ...func(*Options)) (*ListContainersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListContainers", params, optFns, addOperationListContainersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListContainersMiddleware(stack *middleware.Stack, options Options) (err error) {
