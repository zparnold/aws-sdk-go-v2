...
func (c *Client) DeleteContainerPolicy(ctx context.Context, params *DeleteContainerPolicyInput, optFns ...func(*Options)) (*DeleteContainerPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteContainerPolicy", params, optFns, addOperationDeleteContainerPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteContainerPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
