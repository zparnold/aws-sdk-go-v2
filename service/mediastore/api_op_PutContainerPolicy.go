...
func (c *Client) PutContainerPolicy(ctx context.Context, params *PutContainerPolicyInput, optFns ...func(*Options)) (*PutContainerPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutContainerPolicy", params, optFns, addOperationPutContainerPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutContainerPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
