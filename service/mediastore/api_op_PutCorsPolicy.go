...
func (c *Client) PutCorsPolicy(ctx context.Context, params *PutCorsPolicyInput, optFns ...func(*Options)) (*PutCorsPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutCorsPolicy", params, optFns, addOperationPutCorsPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutCorsPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
