...
func (c *Client) GetContainerPolicy(ctx context.Context, params *GetContainerPolicyInput, optFns ...func(*Options)) (*GetContainerPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetContainerPolicy", params, optFns, addOperationGetContainerPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetContainerPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
