...
func (c *Client) GetMedia(ctx context.Context, params *GetMediaInput, optFns ...func(*Options)) (*GetMediaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMedia", params, optFns, addOperationGetMediaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMediaMiddleware(stack *middleware.Stack, options Options) (err error) {
