...
func (c *Client) CreateTopic(ctx context.Context, params *CreateTopicInput, optFns ...func(*Options)) (*CreateTopicOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTopic", params, optFns, addOperationCreateTopicMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTopicMiddleware(stack *middleware.Stack, options Options) (err error) {
