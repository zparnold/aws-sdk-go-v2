...
func (c *Client) ConfirmSubscription(ctx context.Context, params *ConfirmSubscriptionInput, optFns ...func(*Options)) (*ConfirmSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfirmSubscription", params, optFns, addOperationConfirmSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfirmSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
