...
func (c *Client) OptInPhoneNumber(ctx context.Context, params *OptInPhoneNumberInput, optFns ...func(*Options)) (*OptInPhoneNumberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "OptInPhoneNumber", params, optFns, addOperationOptInPhoneNumberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationOptInPhoneNumberMiddleware(stack *middleware.Stack, options Options) (err error) {
