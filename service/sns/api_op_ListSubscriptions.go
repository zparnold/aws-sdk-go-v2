...
func (c *Client) ListSubscriptions(ctx context.Context, params *ListSubscriptionsInput, optFns ...func(*Options)) (*ListSubscriptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSubscriptions", params, optFns, addOperationListSubscriptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSubscriptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
