...
func (c *Client) SetSMSAttributes(ctx context.Context, params *SetSMSAttributesInput, optFns ...func(*Options)) (*SetSMSAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetSMSAttributes", params, optFns, addOperationSetSMSAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetSMSAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
