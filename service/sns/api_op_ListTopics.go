...
func (c *Client) ListTopics(ctx context.Context, params *ListTopicsInput, optFns ...func(*Options)) (*ListTopicsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTopics", params, optFns, addOperationListTopicsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTopicsMiddleware(stack *middleware.Stack, options Options) (err error) {
