...
func (c *Client) ListEndpointsByPlatformApplication(ctx context.Context, params *ListEndpointsByPlatformApplicationInput, optFns ...func(*Options)) (*ListEndpointsByPlatformApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEndpointsByPlatformApplication", params, optFns, addOperationListEndpointsByPlatformApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEndpointsByPlatformApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
