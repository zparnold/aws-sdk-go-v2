...
func (c *Client) DeletePlatformApplication(ctx context.Context, params *DeletePlatformApplicationInput, optFns ...func(*Options)) (*DeletePlatformApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePlatformApplication", params, optFns, addOperationDeletePlatformApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePlatformApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
