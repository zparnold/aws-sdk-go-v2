...
func (c *Client) CreatePlatformEndpoint(ctx context.Context, params *CreatePlatformEndpointInput, optFns ...func(*Options)) (*CreatePlatformEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePlatformEndpoint", params, optFns, addOperationCreatePlatformEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePlatformEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
