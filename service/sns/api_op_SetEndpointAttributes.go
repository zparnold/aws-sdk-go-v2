...
func (c *Client) SetEndpointAttributes(ctx context.Context, params *SetEndpointAttributesInput, optFns ...func(*Options)) (*SetEndpointAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetEndpointAttributes", params, optFns, addOperationSetEndpointAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetEndpointAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
