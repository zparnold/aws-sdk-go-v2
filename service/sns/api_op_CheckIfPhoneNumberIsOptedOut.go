...
func (c *Client) CheckIfPhoneNumberIsOptedOut(ctx context.Context, params *CheckIfPhoneNumberIsOptedOutInput, optFns ...func(*Options)) (*CheckIfPhoneNumberIsOptedOutOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CheckIfPhoneNumberIsOptedOut", params, optFns, addOperationCheckIfPhoneNumberIsOptedOutMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCheckIfPhoneNumberIsOptedOutMiddleware(stack *middleware.Stack, options Options) (err error) {
