...
func (c *Client) ListPhoneNumbersOptedOut(ctx context.Context, params *ListPhoneNumbersOptedOutInput, optFns ...func(*Options)) (*ListPhoneNumbersOptedOutOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPhoneNumbersOptedOut", params, optFns, addOperationListPhoneNumbersOptedOutMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPhoneNumbersOptedOutMiddleware(stack *middleware.Stack, options Options) (err error) {
