...
func (c *Client) GetSMSAttributes(ctx context.Context, params *GetSMSAttributesInput, optFns ...func(*Options)) (*GetSMSAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSMSAttributes", params, optFns, addOperationGetSMSAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSMSAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
