...
func (c *Client) SetTopicAttributes(ctx context.Context, params *SetTopicAttributesInput, optFns ...func(*Options)) (*SetTopicAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetTopicAttributes", params, optFns, addOperationSetTopicAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetTopicAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
