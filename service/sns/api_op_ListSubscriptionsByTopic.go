...
func (c *Client) ListSubscriptionsByTopic(ctx context.Context, params *ListSubscriptionsByTopicInput, optFns ...func(*Options)) (*ListSubscriptionsByTopicOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSubscriptionsByTopic", params, optFns, addOperationListSubscriptionsByTopicMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSubscriptionsByTopicMiddleware(stack *middleware.Stack, options Options) (err error) {
