...
func (c *Client) Publish(ctx context.Context, params *PublishInput, optFns ...func(*Options)) (*PublishOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Publish", params, optFns, addOperationPublishMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPublishMiddleware(stack *middleware.Stack, options Options) (err error) {
