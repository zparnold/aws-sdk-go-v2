...
func (c *Client) GetEndpointAttributes(ctx context.Context, params *GetEndpointAttributesInput, optFns ...func(*Options)) (*GetEndpointAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEndpointAttributes", params, optFns, addOperationGetEndpointAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEndpointAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
