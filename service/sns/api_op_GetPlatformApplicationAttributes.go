...
func (c *Client) GetPlatformApplicationAttributes(ctx context.Context, params *GetPlatformApplicationAttributesInput, optFns ...func(*Options)) (*GetPlatformApplicationAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPlatformApplicationAttributes", params, optFns, addOperationGetPlatformApplicationAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPlatformApplicationAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
