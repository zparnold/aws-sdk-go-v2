...
func (c *Client) CreatePlatformApplication(ctx context.Context, params *CreatePlatformApplicationInput, optFns ...func(*Options)) (*CreatePlatformApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePlatformApplication", params, optFns, addOperationCreatePlatformApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePlatformApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
