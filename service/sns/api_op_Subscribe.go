...
func (c *Client) Subscribe(ctx context.Context, params *SubscribeInput, optFns ...func(*Options)) (*SubscribeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Subscribe", params, optFns, addOperationSubscribeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSubscribeMiddleware(stack *middleware.Stack, options Options) (err error) {
