...
func (c *Client) Unsubscribe(ctx context.Context, params *UnsubscribeInput, optFns ...func(*Options)) (*UnsubscribeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Unsubscribe", params, optFns, addOperationUnsubscribeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnsubscribeMiddleware(stack *middleware.Stack, options Options) (err error) {
