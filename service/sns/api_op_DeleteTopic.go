...
func (c *Client) DeleteTopic(ctx context.Context, params *DeleteTopicInput, optFns ...func(*Options)) (*DeleteTopicOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTopic", params, optFns, addOperationDeleteTopicMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTopicMiddleware(stack *middleware.Stack, options Options) (err error) {
