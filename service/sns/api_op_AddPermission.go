...
func (c *Client) AddPermission(ctx context.Context, params *AddPermissionInput, optFns ...func(*Options)) (*AddPermissionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddPermission", params, optFns, addOperationAddPermissionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddPermissionMiddleware(stack *middleware.Stack, options Options) (err error) {
