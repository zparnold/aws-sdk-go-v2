...
func (c *Client) ListPlatformApplications(ctx context.Context, params *ListPlatformApplicationsInput, optFns ...func(*Options)) (*ListPlatformApplicationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPlatformApplications", params, optFns, addOperationListPlatformApplicationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPlatformApplicationsMiddleware(stack *middleware.Stack, options Options) (err error) {
