...
func (c *Client) GetSubscriptionAttributes(ctx context.Context, params *GetSubscriptionAttributesInput, optFns ...func(*Options)) (*GetSubscriptionAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSubscriptionAttributes", params, optFns, addOperationGetSubscriptionAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSubscriptionAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
