...
func (c *Client) GetConfiguration(ctx context.Context, params *GetConfigurationInput, optFns ...func(*Options)) (*GetConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConfiguration", params, optFns, addOperationGetConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
