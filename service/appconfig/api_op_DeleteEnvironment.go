...
func (c *Client) DeleteEnvironment(ctx context.Context, params *DeleteEnvironmentInput, optFns ...func(*Options)) (*DeleteEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEnvironment", params, optFns, addOperationDeleteEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
