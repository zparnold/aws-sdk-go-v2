...
func (c *Client) ValidateConfiguration(ctx context.Context, params *ValidateConfigurationInput, optFns ...func(*Options)) (*ValidateConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ValidateConfiguration", params, optFns, addOperationValidateConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationValidateConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
