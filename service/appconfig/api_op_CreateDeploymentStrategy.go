...
func (c *Client) CreateDeploymentStrategy(ctx context.Context, params *CreateDeploymentStrategyInput, optFns ...func(*Options)) (*CreateDeploymentStrategyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDeploymentStrategy", params, optFns, addOperationCreateDeploymentStrategyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDeploymentStrategyMiddleware(stack *middleware.Stack, options Options) (err error) {
