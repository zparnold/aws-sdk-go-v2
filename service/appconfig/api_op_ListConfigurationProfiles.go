...
func (c *Client) ListConfigurationProfiles(ctx context.Context, params *ListConfigurationProfilesInput, optFns ...func(*Options)) (*ListConfigurationProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListConfigurationProfiles", params, optFns, addOperationListConfigurationProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListConfigurationProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
