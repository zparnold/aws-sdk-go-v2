...
func (c *Client) CreateConfigurationProfile(ctx context.Context, params *CreateConfigurationProfileInput, optFns ...func(*Options)) (*CreateConfigurationProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateConfigurationProfile", params, optFns, addOperationCreateConfigurationProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateConfigurationProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
