...
func (c *Client) DeleteConfigurationProfile(ctx context.Context, params *DeleteConfigurationProfileInput, optFns ...func(*Options)) (*DeleteConfigurationProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConfigurationProfile", params, optFns, addOperationDeleteConfigurationProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConfigurationProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
