...
func (c *Client) ListDeploymentStrategies(ctx context.Context, params *ListDeploymentStrategiesInput, optFns ...func(*Options)) (*ListDeploymentStrategiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeploymentStrategies", params, optFns, addOperationListDeploymentStrategiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeploymentStrategiesMiddleware(stack *middleware.Stack, options Options) (err error) {
