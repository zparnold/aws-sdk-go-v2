...
func (c *Client) ListDeployments(ctx context.Context, params *ListDeploymentsInput, optFns ...func(*Options)) (*ListDeploymentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDeployments", params, optFns, addOperationListDeploymentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDeploymentsMiddleware(stack *middleware.Stack, options Options) (err error) {
