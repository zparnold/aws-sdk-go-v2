...
func (c *Client) GetEnvironment(ctx context.Context, params *GetEnvironmentInput, optFns ...func(*Options)) (*GetEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEnvironment", params, optFns, addOperationGetEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
