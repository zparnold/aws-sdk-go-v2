...
func (c *Client) GetApplication(ctx context.Context, params *GetApplicationInput, optFns ...func(*Options)) (*GetApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApplication", params, optFns, addOperationGetApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
