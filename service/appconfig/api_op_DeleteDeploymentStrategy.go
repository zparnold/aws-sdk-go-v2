...
func (c *Client) DeleteDeploymentStrategy(ctx context.Context, params *DeleteDeploymentStrategyInput, optFns ...func(*Options)) (*DeleteDeploymentStrategyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeploymentStrategy", params, optFns, addOperationDeleteDeploymentStrategyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeploymentStrategyMiddleware(stack *middleware.Stack, options Options) (err error) {
