...
func (c *Client) ListHostedConfigurationVersions(ctx context.Context, params *ListHostedConfigurationVersionsInput, optFns ...func(*Options)) (*ListHostedConfigurationVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListHostedConfigurationVersions", params, optFns, addOperationListHostedConfigurationVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListHostedConfigurationVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
