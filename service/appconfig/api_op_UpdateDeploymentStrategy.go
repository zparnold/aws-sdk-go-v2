...
func (c *Client) UpdateDeploymentStrategy(ctx context.Context, params *UpdateDeploymentStrategyInput, optFns ...func(*Options)) (*UpdateDeploymentStrategyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDeploymentStrategy", params, optFns, addOperationUpdateDeploymentStrategyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDeploymentStrategyMiddleware(stack *middleware.Stack, options Options) (err error) {
