...
func (c *Client) GetDeploymentStrategy(ctx context.Context, params *GetDeploymentStrategyInput, optFns ...func(*Options)) (*GetDeploymentStrategyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDeploymentStrategy", params, optFns, addOperationGetDeploymentStrategyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDeploymentStrategyMiddleware(stack *middleware.Stack, options Options) (err error) {
