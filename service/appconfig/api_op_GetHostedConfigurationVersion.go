...
func (c *Client) GetHostedConfigurationVersion(ctx context.Context, params *GetHostedConfigurationVersionInput, optFns ...func(*Options)) (*GetHostedConfigurationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetHostedConfigurationVersion", params, optFns, addOperationGetHostedConfigurationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetHostedConfigurationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
