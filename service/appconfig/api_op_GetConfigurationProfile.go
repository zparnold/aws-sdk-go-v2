...
func (c *Client) GetConfigurationProfile(ctx context.Context, params *GetConfigurationProfileInput, optFns ...func(*Options)) (*GetConfigurationProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConfigurationProfile", params, optFns, addOperationGetConfigurationProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConfigurationProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
