...
func (c *Client) CreateEnvironment(ctx context.Context, params *CreateEnvironmentInput, optFns ...func(*Options)) (*CreateEnvironmentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEnvironment", params, optFns, addOperationCreateEnvironmentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEnvironmentMiddleware(stack *middleware.Stack, options Options) (err error) {
