...
func (c *Client) UpdateConfigurationProfile(ctx context.Context, params *UpdateConfigurationProfileInput, optFns ...func(*Options)) (*UpdateConfigurationProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConfigurationProfile", params, optFns, addOperationUpdateConfigurationProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConfigurationProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
