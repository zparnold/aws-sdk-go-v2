...
func (c *Client) ListSigningJobs(ctx context.Context, params *ListSigningJobsInput, optFns ...func(*Options)) (*ListSigningJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSigningJobs", params, optFns, addOperationListSigningJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSigningJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
