...
func (c *Client) ListSigningProfiles(ctx context.Context, params *ListSigningProfilesInput, optFns ...func(*Options)) (*ListSigningProfilesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSigningProfiles", params, optFns, addOperationListSigningProfilesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSigningProfilesMiddleware(stack *middleware.Stack, options Options) (err error) {
