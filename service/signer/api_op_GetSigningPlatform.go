...
func (c *Client) GetSigningPlatform(ctx context.Context, params *GetSigningPlatformInput, optFns ...func(*Options)) (*GetSigningPlatformOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSigningPlatform", params, optFns, addOperationGetSigningPlatformMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSigningPlatformMiddleware(stack *middleware.Stack, options Options) (err error) {
