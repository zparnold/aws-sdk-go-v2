...
func (c *Client) PutSigningProfile(ctx context.Context, params *PutSigningProfileInput, optFns ...func(*Options)) (*PutSigningProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSigningProfile", params, optFns, addOperationPutSigningProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSigningProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
