...
func (c *Client) ListSigningPlatforms(ctx context.Context, params *ListSigningPlatformsInput, optFns ...func(*Options)) (*ListSigningPlatformsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSigningPlatforms", params, optFns, addOperationListSigningPlatformsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSigningPlatformsMiddleware(stack *middleware.Stack, options Options) (err error) {
