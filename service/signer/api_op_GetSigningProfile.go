...
func (c *Client) GetSigningProfile(ctx context.Context, params *GetSigningProfileInput, optFns ...func(*Options)) (*GetSigningProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSigningProfile", params, optFns, addOperationGetSigningProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSigningProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
