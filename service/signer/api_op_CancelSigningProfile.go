...
func (c *Client) CancelSigningProfile(ctx context.Context, params *CancelSigningProfileInput, optFns ...func(*Options)) (*CancelSigningProfileOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelSigningProfile", params, optFns, addOperationCancelSigningProfileMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelSigningProfileMiddleware(stack *middleware.Stack, options Options) (err error) {
