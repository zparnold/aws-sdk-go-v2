...
func (c *Client) StartSigningJob(ctx context.Context, params *StartSigningJobInput, optFns ...func(*Options)) (*StartSigningJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSigningJob", params, optFns, addOperationStartSigningJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSigningJobMiddleware(stack *middleware.Stack, options Options) (err error) {
