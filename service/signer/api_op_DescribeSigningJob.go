...
func (c *Client) DescribeSigningJob(ctx context.Context, params *DescribeSigningJobInput, optFns ...func(*Options)) (*DescribeSigningJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSigningJob", params, optFns, addOperationDescribeSigningJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSigningJobMiddleware(stack *middleware.Stack, options Options) (err error) {
