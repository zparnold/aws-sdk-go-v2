...
func (c *Client) DeleteBudget(ctx context.Context, params *DeleteBudgetInput, optFns ...func(*Options)) (*DeleteBudgetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBudget", params, optFns, addOperationDeleteBudgetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBudgetMiddleware(stack *middleware.Stack, options Options) (err error) {
