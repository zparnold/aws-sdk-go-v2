...
func (c *Client) CreateBudget(ctx context.Context, params *CreateBudgetInput, optFns ...func(*Options)) (*CreateBudgetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBudget", params, optFns, addOperationCreateBudgetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBudgetMiddleware(stack *middleware.Stack, options Options) (err error) {
