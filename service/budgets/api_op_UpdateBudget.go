...
func (c *Client) UpdateBudget(ctx context.Context, params *UpdateBudgetInput, optFns ...func(*Options)) (*UpdateBudgetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBudget", params, optFns, addOperationUpdateBudgetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBudgetMiddleware(stack *middleware.Stack, options Options) (err error) {
