...
func (c *Client) DescribeBudget(ctx context.Context, params *DescribeBudgetInput, optFns ...func(*Options)) (*DescribeBudgetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBudget", params, optFns, addOperationDescribeBudgetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBudgetMiddleware(stack *middleware.Stack, options Options) (err error) {
