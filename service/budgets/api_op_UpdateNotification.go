...
func (c *Client) UpdateNotification(ctx context.Context, params *UpdateNotificationInput, optFns ...func(*Options)) (*UpdateNotificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateNotification", params, optFns, addOperationUpdateNotificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateNotificationMiddleware(stack *middleware.Stack, options Options) (err error) {
