...
func (c *Client) DescribeNotificationsForBudget(ctx context.Context, params *DescribeNotificationsForBudgetInput, optFns ...func(*Options)) (*DescribeNotificationsForBudgetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeNotificationsForBudget", params, optFns, addOperationDescribeNotificationsForBudgetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeNotificationsForBudgetMiddleware(stack *middleware.Stack, options Options) (err error) {
