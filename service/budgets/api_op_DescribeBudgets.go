...
func (c *Client) DescribeBudgets(ctx context.Context, params *DescribeBudgetsInput, optFns ...func(*Options)) (*DescribeBudgetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBudgets", params, optFns, addOperationDescribeBudgetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBudgetsMiddleware(stack *middleware.Stack, options Options) (err error) {
