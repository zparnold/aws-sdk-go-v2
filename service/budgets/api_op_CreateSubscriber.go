...
func (c *Client) CreateSubscriber(ctx context.Context, params *CreateSubscriberInput, optFns ...func(*Options)) (*CreateSubscriberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSubscriber", params, optFns, addOperationCreateSubscriberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSubscriberMiddleware(stack *middleware.Stack, options Options) (err error) {
