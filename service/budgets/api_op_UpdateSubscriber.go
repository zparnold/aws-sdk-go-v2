...
func (c *Client) UpdateSubscriber(ctx context.Context, params *UpdateSubscriberInput, optFns ...func(*Options)) (*UpdateSubscriberOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSubscriber", params, optFns, addOperationUpdateSubscriberMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSubscriberMiddleware(stack *middleware.Stack, options Options) (err error) {
