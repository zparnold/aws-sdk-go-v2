...
func (c *Client) DescribeSubscribersForNotification(ctx context.Context, params *DescribeSubscribersForNotificationInput, optFns ...func(*Options)) (*DescribeSubscribersForNotificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSubscribersForNotification", params, optFns, addOperationDescribeSubscribersForNotificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSubscribersForNotificationMiddleware(stack *middleware.Stack, options Options) (err error) {
