...
func (c *Client) DescribeBudgetPerformanceHistory(ctx context.Context, params *DescribeBudgetPerformanceHistoryInput, optFns ...func(*Options)) (*DescribeBudgetPerformanceHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBudgetPerformanceHistory", params, optFns, addOperationDescribeBudgetPerformanceHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBudgetPerformanceHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
