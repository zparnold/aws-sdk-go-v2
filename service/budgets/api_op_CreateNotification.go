...
func (c *Client) CreateNotification(ctx context.Context, params *CreateNotificationInput, optFns ...func(*Options)) (*CreateNotificationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateNotification", params, optFns, addOperationCreateNotificationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateNotificationMiddleware(stack *middleware.Stack, options Options) (err error) {
