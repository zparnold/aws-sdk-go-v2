...
func (c *Client) CreateLBCookieStickinessPolicy(ctx context.Context, params *CreateLBCookieStickinessPolicyInput, optFns ...func(*Options)) (*CreateLBCookieStickinessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLBCookieStickinessPolicy", params, optFns, addOperationCreateLBCookieStickinessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLBCookieStickinessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
