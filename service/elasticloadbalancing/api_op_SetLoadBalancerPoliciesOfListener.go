...
func (c *Client) SetLoadBalancerPoliciesOfListener(ctx context.Context, params *SetLoadBalancerPoliciesOfListenerInput, optFns ...func(*Options)) (*SetLoadBalancerPoliciesOfListenerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetLoadBalancerPoliciesOfListener", params, optFns, addOperationSetLoadBalancerPoliciesOfListenerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetLoadBalancerPoliciesOfListenerMiddleware(stack *middleware.Stack, options Options) (err error) {
