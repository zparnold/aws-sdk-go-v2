...
func (c *Client) ModifyLoadBalancerAttributes(ctx context.Context, params *ModifyLoadBalancerAttributesInput, optFns ...func(*Options)) (*ModifyLoadBalancerAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyLoadBalancerAttributes", params, optFns, addOperationModifyLoadBalancerAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyLoadBalancerAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
