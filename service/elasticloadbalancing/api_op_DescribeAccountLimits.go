...
func (c *Client) DescribeAccountLimits(ctx context.Context, params *DescribeAccountLimitsInput, optFns ...func(*Options)) (*DescribeAccountLimitsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAccountLimits", params, optFns, addOperationDescribeAccountLimitsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAccountLimitsMiddleware(stack *middleware.Stack, options Options) (err error) {
