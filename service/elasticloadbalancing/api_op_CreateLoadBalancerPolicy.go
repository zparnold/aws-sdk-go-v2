...
func (c *Client) CreateLoadBalancerPolicy(ctx context.Context, params *CreateLoadBalancerPolicyInput, optFns ...func(*Options)) (*CreateLoadBalancerPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLoadBalancerPolicy", params, optFns, addOperationCreateLoadBalancerPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLoadBalancerPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
