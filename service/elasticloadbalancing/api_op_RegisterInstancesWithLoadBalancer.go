...
func (c *Client) RegisterInstancesWithLoadBalancer(ctx context.Context, params *RegisterInstancesWithLoadBalancerInput, optFns ...func(*Options)) (*RegisterInstancesWithLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterInstancesWithLoadBalancer", params, optFns, addOperationRegisterInstancesWithLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterInstancesWithLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
