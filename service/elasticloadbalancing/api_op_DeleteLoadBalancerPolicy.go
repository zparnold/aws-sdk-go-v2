...
func (c *Client) DeleteLoadBalancerPolicy(ctx context.Context, params *DeleteLoadBalancerPolicyInput, optFns ...func(*Options)) (*DeleteLoadBalancerPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteLoadBalancerPolicy", params, optFns, addOperationDeleteLoadBalancerPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteLoadBalancerPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
