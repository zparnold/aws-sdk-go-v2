...
func (c *Client) CreateLoadBalancerListeners(ctx context.Context, params *CreateLoadBalancerListenersInput, optFns ...func(*Options)) (*CreateLoadBalancerListenersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLoadBalancerListeners", params, optFns, addOperationCreateLoadBalancerListenersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLoadBalancerListenersMiddleware(stack *middleware.Stack, options Options) (err error) {
