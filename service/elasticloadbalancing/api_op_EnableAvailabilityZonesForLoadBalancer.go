...
func (c *Client) EnableAvailabilityZonesForLoadBalancer(ctx context.Context, params *EnableAvailabilityZonesForLoadBalancerInput, optFns ...func(*Options)) (*EnableAvailabilityZonesForLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableAvailabilityZonesForLoadBalancer", params, optFns, addOperationEnableAvailabilityZonesForLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableAvailabilityZonesForLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
