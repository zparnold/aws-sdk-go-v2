...
func (c *Client) DescribeLoadBalancerPolicies(ctx context.Context, params *DescribeLoadBalancerPoliciesInput, optFns ...func(*Options)) (*DescribeLoadBalancerPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoadBalancerPolicies", params, optFns, addOperationDescribeLoadBalancerPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoadBalancerPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
