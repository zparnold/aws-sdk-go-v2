...
func (c *Client) DeregisterInstancesFromLoadBalancer(ctx context.Context, params *DeregisterInstancesFromLoadBalancerInput, optFns ...func(*Options)) (*DeregisterInstancesFromLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterInstancesFromLoadBalancer", params, optFns, addOperationDeregisterInstancesFromLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterInstancesFromLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
