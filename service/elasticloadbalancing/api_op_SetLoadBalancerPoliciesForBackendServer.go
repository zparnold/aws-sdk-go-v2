...
func (c *Client) SetLoadBalancerPoliciesForBackendServer(ctx context.Context, params *SetLoadBalancerPoliciesForBackendServerInput, optFns ...func(*Options)) (*SetLoadBalancerPoliciesForBackendServerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetLoadBalancerPoliciesForBackendServer", params, optFns, addOperationSetLoadBalancerPoliciesForBackendServerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetLoadBalancerPoliciesForBackendServerMiddleware(stack *middleware.Stack, options Options) (err error) {
