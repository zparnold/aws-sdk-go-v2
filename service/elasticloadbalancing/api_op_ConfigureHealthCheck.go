...
func (c *Client) ConfigureHealthCheck(ctx context.Context, params *ConfigureHealthCheckInput, optFns ...func(*Options)) (*ConfigureHealthCheckOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ConfigureHealthCheck", params, optFns, addOperationConfigureHealthCheckMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationConfigureHealthCheckMiddleware(stack *middleware.Stack, options Options) (err error) {
