...
func (c *Client) DetachLoadBalancerFromSubnets(ctx context.Context, params *DetachLoadBalancerFromSubnetsInput, optFns ...func(*Options)) (*DetachLoadBalancerFromSubnetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachLoadBalancerFromSubnets", params, optFns, addOperationDetachLoadBalancerFromSubnetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachLoadBalancerFromSubnetsMiddleware(stack *middleware.Stack, options Options) (err error) {
