...
func (c *Client) ApplySecurityGroupsToLoadBalancer(ctx context.Context, params *ApplySecurityGroupsToLoadBalancerInput, optFns ...func(*Options)) (*ApplySecurityGroupsToLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ApplySecurityGroupsToLoadBalancer", params, optFns, addOperationApplySecurityGroupsToLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationApplySecurityGroupsToLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
