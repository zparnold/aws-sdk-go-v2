...
func (c *Client) DisableAvailabilityZonesForLoadBalancer(ctx context.Context, params *DisableAvailabilityZonesForLoadBalancerInput, optFns ...func(*Options)) (*DisableAvailabilityZonesForLoadBalancerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableAvailabilityZonesForLoadBalancer", params, optFns, addOperationDisableAvailabilityZonesForLoadBalancerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableAvailabilityZonesForLoadBalancerMiddleware(stack *middleware.Stack, options Options) (err error) {
