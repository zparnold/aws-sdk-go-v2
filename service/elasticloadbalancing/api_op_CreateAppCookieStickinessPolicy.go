...
func (c *Client) CreateAppCookieStickinessPolicy(ctx context.Context, params *CreateAppCookieStickinessPolicyInput, optFns ...func(*Options)) (*CreateAppCookieStickinessPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateAppCookieStickinessPolicy", params, optFns, addOperationCreateAppCookieStickinessPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateAppCookieStickinessPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
