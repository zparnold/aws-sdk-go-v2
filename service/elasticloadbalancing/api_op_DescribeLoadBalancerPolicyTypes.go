...
func (c *Client) DescribeLoadBalancerPolicyTypes(ctx context.Context, params *DescribeLoadBalancerPolicyTypesInput, optFns ...func(*Options)) (*DescribeLoadBalancerPolicyTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLoadBalancerPolicyTypes", params, optFns, addOperationDescribeLoadBalancerPolicyTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLoadBalancerPolicyTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
