...
func (c *Client) SetLoadBalancerListenerSSLCertificate(ctx context.Context, params *SetLoadBalancerListenerSSLCertificateInput, optFns ...func(*Options)) (*SetLoadBalancerListenerSSLCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SetLoadBalancerListenerSSLCertificate", params, optFns, addOperationSetLoadBalancerListenerSSLCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSetLoadBalancerListenerSSLCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
