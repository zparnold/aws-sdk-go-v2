...
func (c *Client) DescribeInstanceHealth(ctx context.Context, params *DescribeInstanceHealthInput, optFns ...func(*Options)) (*DescribeInstanceHealthOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstanceHealth", params, optFns, addOperationDescribeInstanceHealthMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstanceHealthMiddleware(stack *middleware.Stack, options Options) (err error) {
