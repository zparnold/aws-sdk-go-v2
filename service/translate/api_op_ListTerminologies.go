...
func (c *Client) ListTerminologies(ctx context.Context, params *ListTerminologiesInput, optFns ...func(*Options)) (*ListTerminologiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTerminologies", params, optFns, addOperationListTerminologiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTerminologiesMiddleware(stack *middleware.Stack, options Options) (err error) {
