...
func (c *Client) TranslateText(ctx context.Context, params *TranslateTextInput, optFns ...func(*Options)) (*TranslateTextOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TranslateText", params, optFns, addOperationTranslateTextMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTranslateTextMiddleware(stack *middleware.Stack, options Options) (err error) {
