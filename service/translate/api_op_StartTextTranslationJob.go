...
func (c *Client) StartTextTranslationJob(ctx context.Context, params *StartTextTranslationJobInput, optFns ...func(*Options)) (*StartTextTranslationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartTextTranslationJob", params, optFns, addOperationStartTextTranslationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartTextTranslationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
