...
func (c *Client) DescribeTextTranslationJob(ctx context.Context, params *DescribeTextTranslationJobInput, optFns ...func(*Options)) (*DescribeTextTranslationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTextTranslationJob", params, optFns, addOperationDescribeTextTranslationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTextTranslationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
