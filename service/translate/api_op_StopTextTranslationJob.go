...
func (c *Client) StopTextTranslationJob(ctx context.Context, params *StopTextTranslationJobInput, optFns ...func(*Options)) (*StopTextTranslationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopTextTranslationJob", params, optFns, addOperationStopTextTranslationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopTextTranslationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
