...
func (c *Client) ImportTerminology(ctx context.Context, params *ImportTerminologyInput, optFns ...func(*Options)) (*ImportTerminologyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportTerminology", params, optFns, addOperationImportTerminologyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportTerminologyMiddleware(stack *middleware.Stack, options Options) (err error) {
