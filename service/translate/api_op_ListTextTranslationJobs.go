...
func (c *Client) ListTextTranslationJobs(ctx context.Context, params *ListTextTranslationJobsInput, optFns ...func(*Options)) (*ListTextTranslationJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTextTranslationJobs", params, optFns, addOperationListTextTranslationJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTextTranslationJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
