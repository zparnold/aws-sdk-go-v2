...
func (c *Client) DeleteTerminology(ctx context.Context, params *DeleteTerminologyInput, optFns ...func(*Options)) (*DeleteTerminologyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTerminology", params, optFns, addOperationDeleteTerminologyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTerminologyMiddleware(stack *middleware.Stack, options Options) (err error) {
