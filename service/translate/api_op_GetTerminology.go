...
func (c *Client) GetTerminology(ctx context.Context, params *GetTerminologyInput, optFns ...func(*Options)) (*GetTerminologyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTerminology", params, optFns, addOperationGetTerminologyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTerminologyMiddleware(stack *middleware.Stack, options Options) (err error) {
