...
func (c *Client) UpdateConnection(ctx context.Context, params *UpdateConnectionInput, optFns ...func(*Options)) (*UpdateConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateConnection", params, optFns, addOperationUpdateConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
