...
func (c *Client) DeleteTrigger(ctx context.Context, params *DeleteTriggerInput, optFns ...func(*Options)) (*DeleteTriggerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrigger", params, optFns, addOperationDeleteTriggerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTriggerMiddleware(stack *middleware.Stack, options Options) (err error) {
