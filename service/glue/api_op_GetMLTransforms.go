...
func (c *Client) GetMLTransforms(ctx context.Context, params *GetMLTransformsInput, optFns ...func(*Options)) (*GetMLTransformsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMLTransforms", params, optFns, addOperationGetMLTransformsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMLTransformsMiddleware(stack *middleware.Stack, options Options) (err error) {
