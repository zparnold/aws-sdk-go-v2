...
func (c *Client) PutDataCatalogEncryptionSettings(ctx context.Context, params *PutDataCatalogEncryptionSettingsInput, optFns ...func(*Options)) (*PutDataCatalogEncryptionSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDataCatalogEncryptionSettings", params, optFns, addOperationPutDataCatalogEncryptionSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDataCatalogEncryptionSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
