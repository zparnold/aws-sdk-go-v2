...
func (c *Client) DeletePartition(ctx context.Context, params *DeletePartitionInput, optFns ...func(*Options)) (*DeletePartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePartition", params, optFns, addOperationDeletePartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
