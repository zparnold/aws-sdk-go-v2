...
func (c *Client) UpdateDevEndpoint(ctx context.Context, params *UpdateDevEndpointInput, optFns ...func(*Options)) (*UpdateDevEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDevEndpoint", params, optFns, addOperationUpdateDevEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDevEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
