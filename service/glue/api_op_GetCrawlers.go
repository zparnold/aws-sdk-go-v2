...
func (c *Client) GetCrawlers(ctx context.Context, params *GetCrawlersInput, optFns ...func(*Options)) (*GetCrawlersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCrawlers", params, optFns, addOperationGetCrawlersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCrawlersMiddleware(stack *middleware.Stack, options Options) (err error) {
