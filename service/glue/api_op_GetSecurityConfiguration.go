...
func (c *Client) GetSecurityConfiguration(ctx context.Context, params *GetSecurityConfigurationInput, optFns ...func(*Options)) (*GetSecurityConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSecurityConfiguration", params, optFns, addOperationGetSecurityConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSecurityConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
