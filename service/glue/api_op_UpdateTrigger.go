...
func (c *Client) UpdateTrigger(ctx context.Context, params *UpdateTriggerInput, optFns ...func(*Options)) (*UpdateTriggerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTrigger", params, optFns, addOperationUpdateTriggerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTriggerMiddleware(stack *middleware.Stack, options Options) (err error) {
