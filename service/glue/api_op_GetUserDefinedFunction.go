...
func (c *Client) GetUserDefinedFunction(ctx context.Context, params *GetUserDefinedFunctionInput, optFns ...func(*Options)) (*GetUserDefinedFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUserDefinedFunction", params, optFns, addOperationGetUserDefinedFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserDefinedFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
