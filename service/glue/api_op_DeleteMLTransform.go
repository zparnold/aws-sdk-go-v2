...
func (c *Client) DeleteMLTransform(ctx context.Context, params *DeleteMLTransformInput, optFns ...func(*Options)) (*DeleteMLTransformOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMLTransform", params, optFns, addOperationDeleteMLTransformMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMLTransformMiddleware(stack *middleware.Stack, options Options) (err error) {
