...
func (c *Client) BatchDeleteTableVersion(ctx context.Context, params *BatchDeleteTableVersionInput, optFns ...func(*Options)) (*BatchDeleteTableVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeleteTableVersion", params, optFns, addOperationBatchDeleteTableVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeleteTableVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
