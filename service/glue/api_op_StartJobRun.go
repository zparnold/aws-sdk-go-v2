...
func (c *Client) StartJobRun(ctx context.Context, params *StartJobRunInput, optFns ...func(*Options)) (*StartJobRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartJobRun", params, optFns, addOperationStartJobRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartJobRunMiddleware(stack *middleware.Stack, options Options) (err error) {
