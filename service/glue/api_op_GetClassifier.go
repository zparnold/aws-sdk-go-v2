...
func (c *Client) GetClassifier(ctx context.Context, params *GetClassifierInput, optFns ...func(*Options)) (*GetClassifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetClassifier", params, optFns, addOperationGetClassifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetClassifierMiddleware(stack *middleware.Stack, options Options) (err error) {
