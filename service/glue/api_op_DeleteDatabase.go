...
func (c *Client) DeleteDatabase(ctx context.Context, params *DeleteDatabaseInput, optFns ...func(*Options)) (*DeleteDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDatabase", params, optFns, addOperationDeleteDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
