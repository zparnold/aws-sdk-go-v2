...
func (c *Client) CancelMLTaskRun(ctx context.Context, params *CancelMLTaskRunInput, optFns ...func(*Options)) (*CancelMLTaskRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelMLTaskRun", params, optFns, addOperationCancelMLTaskRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelMLTaskRunMiddleware(stack *middleware.Stack, options Options) (err error) {
