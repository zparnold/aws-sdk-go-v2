...
func (c *Client) GetUserDefinedFunctions(ctx context.Context, params *GetUserDefinedFunctionsInput, optFns ...func(*Options)) (*GetUserDefinedFunctionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUserDefinedFunctions", params, optFns, addOperationGetUserDefinedFunctionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUserDefinedFunctionsMiddleware(stack *middleware.Stack, options Options) (err error) {
