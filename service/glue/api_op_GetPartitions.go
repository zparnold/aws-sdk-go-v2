...
func (c *Client) GetPartitions(ctx context.Context, params *GetPartitionsInput, optFns ...func(*Options)) (*GetPartitionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPartitions", params, optFns, addOperationGetPartitionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPartitionsMiddleware(stack *middleware.Stack, options Options) (err error) {
