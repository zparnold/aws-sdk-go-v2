...
func (c *Client) ListWorkflows(ctx context.Context, params *ListWorkflowsInput, optFns ...func(*Options)) (*ListWorkflowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWorkflows", params, optFns, addOperationListWorkflowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWorkflowsMiddleware(stack *middleware.Stack, options Options) (err error) {
