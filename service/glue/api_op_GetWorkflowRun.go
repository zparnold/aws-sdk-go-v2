...
func (c *Client) GetWorkflowRun(ctx context.Context, params *GetWorkflowRunInput, optFns ...func(*Options)) (*GetWorkflowRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWorkflowRun", params, optFns, addOperationGetWorkflowRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWorkflowRunMiddleware(stack *middleware.Stack, options Options) (err error) {
