...
func (c *Client) CreateWorkflow(ctx context.Context, params *CreateWorkflowInput, optFns ...func(*Options)) (*CreateWorkflowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateWorkflow", params, optFns, addOperationCreateWorkflowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateWorkflowMiddleware(stack *middleware.Stack, options Options) (err error) {
