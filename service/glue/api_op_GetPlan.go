...
func (c *Client) GetPlan(ctx context.Context, params *GetPlanInput, optFns ...func(*Options)) (*GetPlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetPlan", params, optFns, addOperationGetPlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetPlanMiddleware(stack *middleware.Stack, options Options) (err error) {
