...
func (c *Client) BatchDeleteConnection(ctx context.Context, params *BatchDeleteConnectionInput, optFns ...func(*Options)) (*BatchDeleteConnectionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeleteConnection", params, optFns, addOperationBatchDeleteConnectionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeleteConnectionMiddleware(stack *middleware.Stack, options Options) (err error) {
