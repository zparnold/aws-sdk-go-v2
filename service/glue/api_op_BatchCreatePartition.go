...
func (c *Client) BatchCreatePartition(ctx context.Context, params *BatchCreatePartitionInput, optFns ...func(*Options)) (*BatchCreatePartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchCreatePartition", params, optFns, addOperationBatchCreatePartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchCreatePartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
