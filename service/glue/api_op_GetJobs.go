...
func (c *Client) GetJobs(ctx context.Context, params *GetJobsInput, optFns ...func(*Options)) (*GetJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobs", params, optFns, addOperationGetJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
