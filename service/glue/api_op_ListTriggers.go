...
func (c *Client) ListTriggers(ctx context.Context, params *ListTriggersInput, optFns ...func(*Options)) (*ListTriggersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTriggers", params, optFns, addOperationListTriggersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTriggersMiddleware(stack *middleware.Stack, options Options) (err error) {
