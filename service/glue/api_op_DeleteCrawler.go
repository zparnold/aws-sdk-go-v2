...
func (c *Client) DeleteCrawler(ctx context.Context, params *DeleteCrawlerInput, optFns ...func(*Options)) (*DeleteCrawlerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCrawler", params, optFns, addOperationDeleteCrawlerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCrawlerMiddleware(stack *middleware.Stack, options Options) (err error) {
