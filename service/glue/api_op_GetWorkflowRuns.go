...
func (c *Client) GetWorkflowRuns(ctx context.Context, params *GetWorkflowRunsInput, optFns ...func(*Options)) (*GetWorkflowRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWorkflowRuns", params, optFns, addOperationGetWorkflowRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWorkflowRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
