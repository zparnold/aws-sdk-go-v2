...
func (c *Client) GetColumnStatisticsForPartition(ctx context.Context, params *GetColumnStatisticsForPartitionInput, optFns ...func(*Options)) (*GetColumnStatisticsForPartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetColumnStatisticsForPartition", params, optFns, addOperationGetColumnStatisticsForPartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetColumnStatisticsForPartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
