...
func (c *Client) GetTableVersions(ctx context.Context, params *GetTableVersionsInput, optFns ...func(*Options)) (*GetTableVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTableVersions", params, optFns, addOperationGetTableVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTableVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
