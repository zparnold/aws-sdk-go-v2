...
func (c *Client) ResetJobBookmark(ctx context.Context, params *ResetJobBookmarkInput, optFns ...func(*Options)) (*ResetJobBookmarkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetJobBookmark", params, optFns, addOperationResetJobBookmarkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetJobBookmarkMiddleware(stack *middleware.Stack, options Options) (err error) {
