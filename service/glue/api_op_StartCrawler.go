...
func (c *Client) StartCrawler(ctx context.Context, params *StartCrawlerInput, optFns ...func(*Options)) (*StartCrawlerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartCrawler", params, optFns, addOperationStartCrawlerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartCrawlerMiddleware(stack *middleware.Stack, options Options) (err error) {
