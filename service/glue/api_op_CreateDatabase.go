...
func (c *Client) CreateDatabase(ctx context.Context, params *CreateDatabaseInput, optFns ...func(*Options)) (*CreateDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDatabase", params, optFns, addOperationCreateDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
