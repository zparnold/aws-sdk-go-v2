...
func (c *Client) GetTable(ctx context.Context, params *GetTableInput, optFns ...func(*Options)) (*GetTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTable", params, optFns, addOperationGetTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTableMiddleware(stack *middleware.Stack, options Options) (err error) {
