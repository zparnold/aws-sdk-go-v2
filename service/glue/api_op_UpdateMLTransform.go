...
func (c *Client) UpdateMLTransform(ctx context.Context, params *UpdateMLTransformInput, optFns ...func(*Options)) (*UpdateMLTransformOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMLTransform", params, optFns, addOperationUpdateMLTransformMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMLTransformMiddleware(stack *middleware.Stack, options Options) (err error) {
