...
func (c *Client) UpdateWorkflow(ctx context.Context, params *UpdateWorkflowInput, optFns ...func(*Options)) (*UpdateWorkflowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateWorkflow", params, optFns, addOperationUpdateWorkflowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateWorkflowMiddleware(stack *middleware.Stack, options Options) (err error) {
