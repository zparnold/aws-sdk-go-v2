...
func (c *Client) GetJobBookmark(ctx context.Context, params *GetJobBookmarkInput, optFns ...func(*Options)) (*GetJobBookmarkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobBookmark", params, optFns, addOperationGetJobBookmarkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobBookmarkMiddleware(stack *middleware.Stack, options Options) (err error) {
