...
func (c *Client) CreateTable(ctx context.Context, params *CreateTableInput, optFns ...func(*Options)) (*CreateTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTable", params, optFns, addOperationCreateTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTableMiddleware(stack *middleware.Stack, options Options) (err error) {
