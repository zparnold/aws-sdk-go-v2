...
func (c *Client) DeleteUserDefinedFunction(ctx context.Context, params *DeleteUserDefinedFunctionInput, optFns ...func(*Options)) (*DeleteUserDefinedFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUserDefinedFunction", params, optFns, addOperationDeleteUserDefinedFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUserDefinedFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
