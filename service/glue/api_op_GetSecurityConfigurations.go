...
func (c *Client) GetSecurityConfigurations(ctx context.Context, params *GetSecurityConfigurationsInput, optFns ...func(*Options)) (*GetSecurityConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSecurityConfigurations", params, optFns, addOperationGetSecurityConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSecurityConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
