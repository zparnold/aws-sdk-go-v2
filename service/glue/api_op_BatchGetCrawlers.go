...
func (c *Client) BatchGetCrawlers(ctx context.Context, params *BatchGetCrawlersInput, optFns ...func(*Options)) (*BatchGetCrawlersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetCrawlers", params, optFns, addOperationBatchGetCrawlersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetCrawlersMiddleware(stack *middleware.Stack, options Options) (err error) {
