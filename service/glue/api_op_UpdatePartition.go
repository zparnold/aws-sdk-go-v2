...
func (c *Client) UpdatePartition(ctx context.Context, params *UpdatePartitionInput, optFns ...func(*Options)) (*UpdatePartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdatePartition", params, optFns, addOperationUpdatePartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdatePartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
