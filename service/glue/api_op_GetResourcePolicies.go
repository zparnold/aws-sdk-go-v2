...
func (c *Client) GetResourcePolicies(ctx context.Context, params *GetResourcePoliciesInput, optFns ...func(*Options)) (*GetResourcePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResourcePolicies", params, optFns, addOperationGetResourcePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourcePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
