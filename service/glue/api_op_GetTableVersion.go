...
func (c *Client) GetTableVersion(ctx context.Context, params *GetTableVersionInput, optFns ...func(*Options)) (*GetTableVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTableVersion", params, optFns, addOperationGetTableVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTableVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
