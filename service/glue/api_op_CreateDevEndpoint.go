...
func (c *Client) CreateDevEndpoint(ctx context.Context, params *CreateDevEndpointInput, optFns ...func(*Options)) (*CreateDevEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDevEndpoint", params, optFns, addOperationCreateDevEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDevEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
