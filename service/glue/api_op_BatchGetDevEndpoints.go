...
func (c *Client) BatchGetDevEndpoints(ctx context.Context, params *BatchGetDevEndpointsInput, optFns ...func(*Options)) (*BatchGetDevEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetDevEndpoints", params, optFns, addOperationBatchGetDevEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetDevEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
