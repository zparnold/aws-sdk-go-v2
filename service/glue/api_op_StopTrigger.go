...
func (c *Client) StopTrigger(ctx context.Context, params *StopTriggerInput, optFns ...func(*Options)) (*StopTriggerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopTrigger", params, optFns, addOperationStopTriggerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopTriggerMiddleware(stack *middleware.Stack, options Options) (err error) {
