...
func (c *Client) ListCrawlers(ctx context.Context, params *ListCrawlersInput, optFns ...func(*Options)) (*ListCrawlersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListCrawlers", params, optFns, addOperationListCrawlersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListCrawlersMiddleware(stack *middleware.Stack, options Options) (err error) {
