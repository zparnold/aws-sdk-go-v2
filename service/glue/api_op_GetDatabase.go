...
func (c *Client) GetDatabase(ctx context.Context, params *GetDatabaseInput, optFns ...func(*Options)) (*GetDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDatabase", params, optFns, addOperationGetDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
