...
func (c *Client) CreateMLTransform(ctx context.Context, params *CreateMLTransformInput, optFns ...func(*Options)) (*CreateMLTransformOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMLTransform", params, optFns, addOperationCreateMLTransformMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMLTransformMiddleware(stack *middleware.Stack, options Options) (err error) {
