...
func (c *Client) DeleteColumnStatisticsForTable(ctx context.Context, params *DeleteColumnStatisticsForTableInput, optFns ...func(*Options)) (*DeleteColumnStatisticsForTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteColumnStatisticsForTable", params, optFns, addOperationDeleteColumnStatisticsForTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteColumnStatisticsForTableMiddleware(stack *middleware.Stack, options Options) (err error) {
