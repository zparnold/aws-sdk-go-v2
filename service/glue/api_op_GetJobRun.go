...
func (c *Client) GetJobRun(ctx context.Context, params *GetJobRunInput, optFns ...func(*Options)) (*GetJobRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobRun", params, optFns, addOperationGetJobRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobRunMiddleware(stack *middleware.Stack, options Options) (err error) {
