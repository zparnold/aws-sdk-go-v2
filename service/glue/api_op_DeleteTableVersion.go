...
func (c *Client) DeleteTableVersion(ctx context.Context, params *DeleteTableVersionInput, optFns ...func(*Options)) (*DeleteTableVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTableVersion", params, optFns, addOperationDeleteTableVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTableVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
