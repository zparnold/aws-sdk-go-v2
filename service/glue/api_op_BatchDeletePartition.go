...
func (c *Client) BatchDeletePartition(ctx context.Context, params *BatchDeletePartitionInput, optFns ...func(*Options)) (*BatchDeletePartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDeletePartition", params, optFns, addOperationBatchDeletePartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDeletePartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
