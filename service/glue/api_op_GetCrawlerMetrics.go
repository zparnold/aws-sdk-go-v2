...
func (c *Client) GetCrawlerMetrics(ctx context.Context, params *GetCrawlerMetricsInput, optFns ...func(*Options)) (*GetCrawlerMetricsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCrawlerMetrics", params, optFns, addOperationGetCrawlerMetricsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCrawlerMetricsMiddleware(stack *middleware.Stack, options Options) (err error) {
