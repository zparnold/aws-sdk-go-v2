...
func (c *Client) GetDataflowGraph(ctx context.Context, params *GetDataflowGraphInput, optFns ...func(*Options)) (*GetDataflowGraphOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDataflowGraph", params, optFns, addOperationGetDataflowGraphMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDataflowGraphMiddleware(stack *middleware.Stack, options Options) (err error) {
