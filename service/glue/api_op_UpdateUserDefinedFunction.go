...
func (c *Client) UpdateUserDefinedFunction(ctx context.Context, params *UpdateUserDefinedFunctionInput, optFns ...func(*Options)) (*UpdateUserDefinedFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUserDefinedFunction", params, optFns, addOperationUpdateUserDefinedFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUserDefinedFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
