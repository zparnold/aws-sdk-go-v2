...
func (c *Client) UpdateColumnStatisticsForPartition(ctx context.Context, params *UpdateColumnStatisticsForPartitionInput, optFns ...func(*Options)) (*UpdateColumnStatisticsForPartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateColumnStatisticsForPartition", params, optFns, addOperationUpdateColumnStatisticsForPartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateColumnStatisticsForPartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
