...
func (c *Client) CreateCrawler(ctx context.Context, params *CreateCrawlerInput, optFns ...func(*Options)) (*CreateCrawlerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCrawler", params, optFns, addOperationCreateCrawlerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCrawlerMiddleware(stack *middleware.Stack, options Options) (err error) {
