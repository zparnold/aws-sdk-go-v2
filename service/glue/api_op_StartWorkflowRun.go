...
func (c *Client) StartWorkflowRun(ctx context.Context, params *StartWorkflowRunInput, optFns ...func(*Options)) (*StartWorkflowRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartWorkflowRun", params, optFns, addOperationStartWorkflowRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartWorkflowRunMiddleware(stack *middleware.Stack, options Options) (err error) {
