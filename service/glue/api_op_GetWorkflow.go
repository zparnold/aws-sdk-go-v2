...
func (c *Client) GetWorkflow(ctx context.Context, params *GetWorkflowInput, optFns ...func(*Options)) (*GetWorkflowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWorkflow", params, optFns, addOperationGetWorkflowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWorkflowMiddleware(stack *middleware.Stack, options Options) (err error) {
