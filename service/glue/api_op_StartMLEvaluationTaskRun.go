...
func (c *Client) StartMLEvaluationTaskRun(ctx context.Context, params *StartMLEvaluationTaskRunInput, optFns ...func(*Options)) (*StartMLEvaluationTaskRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartMLEvaluationTaskRun", params, optFns, addOperationStartMLEvaluationTaskRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartMLEvaluationTaskRunMiddleware(stack *middleware.Stack, options Options) (err error) {
