...
func (c *Client) PutWorkflowRunProperties(ctx context.Context, params *PutWorkflowRunPropertiesInput, optFns ...func(*Options)) (*PutWorkflowRunPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutWorkflowRunProperties", params, optFns, addOperationPutWorkflowRunPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutWorkflowRunPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
