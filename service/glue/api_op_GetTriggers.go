...
func (c *Client) GetTriggers(ctx context.Context, params *GetTriggersInput, optFns ...func(*Options)) (*GetTriggersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTriggers", params, optFns, addOperationGetTriggersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTriggersMiddleware(stack *middleware.Stack, options Options) (err error) {
