...
func (c *Client) BatchGetPartition(ctx context.Context, params *BatchGetPartitionInput, optFns ...func(*Options)) (*BatchGetPartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetPartition", params, optFns, addOperationBatchGetPartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetPartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
