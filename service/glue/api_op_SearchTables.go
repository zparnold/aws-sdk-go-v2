...
func (c *Client) SearchTables(ctx context.Context, params *SearchTablesInput, optFns ...func(*Options)) (*SearchTablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SearchTables", params, optFns, addOperationSearchTablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSearchTablesMiddleware(stack *middleware.Stack, options Options) (err error) {
