...
func (c *Client) DeleteWorkflow(ctx context.Context, params *DeleteWorkflowInput, optFns ...func(*Options)) (*DeleteWorkflowOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWorkflow", params, optFns, addOperationDeleteWorkflowMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWorkflowMiddleware(stack *middleware.Stack, options Options) (err error) {
