...
func (c *Client) GetCatalogImportStatus(ctx context.Context, params *GetCatalogImportStatusInput, optFns ...func(*Options)) (*GetCatalogImportStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCatalogImportStatus", params, optFns, addOperationGetCatalogImportStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCatalogImportStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
