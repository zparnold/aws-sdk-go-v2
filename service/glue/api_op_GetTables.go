...
func (c *Client) GetTables(ctx context.Context, params *GetTablesInput, optFns ...func(*Options)) (*GetTablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTables", params, optFns, addOperationGetTablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTablesMiddleware(stack *middleware.Stack, options Options) (err error) {
