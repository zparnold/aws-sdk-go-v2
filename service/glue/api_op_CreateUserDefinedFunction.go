...
func (c *Client) CreateUserDefinedFunction(ctx context.Context, params *CreateUserDefinedFunctionInput, optFns ...func(*Options)) (*CreateUserDefinedFunctionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUserDefinedFunction", params, optFns, addOperationCreateUserDefinedFunctionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUserDefinedFunctionMiddleware(stack *middleware.Stack, options Options) (err error) {
