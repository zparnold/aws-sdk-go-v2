...
func (c *Client) StopCrawlerSchedule(ctx context.Context, params *StopCrawlerScheduleInput, optFns ...func(*Options)) (*StopCrawlerScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopCrawlerSchedule", params, optFns, addOperationStopCrawlerScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopCrawlerScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
