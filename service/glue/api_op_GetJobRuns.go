...
func (c *Client) GetJobRuns(ctx context.Context, params *GetJobRunsInput, optFns ...func(*Options)) (*GetJobRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetJobRuns", params, optFns, addOperationGetJobRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetJobRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
