...
func (c *Client) StartTrigger(ctx context.Context, params *StartTriggerInput, optFns ...func(*Options)) (*StartTriggerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartTrigger", params, optFns, addOperationStartTriggerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartTriggerMiddleware(stack *middleware.Stack, options Options) (err error) {
