...
func (c *Client) GetMapping(ctx context.Context, params *GetMappingInput, optFns ...func(*Options)) (*GetMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMapping", params, optFns, addOperationGetMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
