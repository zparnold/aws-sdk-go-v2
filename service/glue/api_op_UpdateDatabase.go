...
func (c *Client) UpdateDatabase(ctx context.Context, params *UpdateDatabaseInput, optFns ...func(*Options)) (*UpdateDatabaseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDatabase", params, optFns, addOperationUpdateDatabaseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDatabaseMiddleware(stack *middleware.Stack, options Options) (err error) {
