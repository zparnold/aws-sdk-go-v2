...
func (c *Client) UpdateColumnStatisticsForTable(ctx context.Context, params *UpdateColumnStatisticsForTableInput, optFns ...func(*Options)) (*UpdateColumnStatisticsForTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateColumnStatisticsForTable", params, optFns, addOperationUpdateColumnStatisticsForTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateColumnStatisticsForTableMiddleware(stack *middleware.Stack, options Options) (err error) {
