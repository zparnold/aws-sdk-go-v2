...
func (c *Client) UpdateClassifier(ctx context.Context, params *UpdateClassifierInput, optFns ...func(*Options)) (*UpdateClassifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClassifier", params, optFns, addOperationUpdateClassifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClassifierMiddleware(stack *middleware.Stack, options Options) (err error) {
