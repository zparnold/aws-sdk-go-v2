...
func (c *Client) BatchGetTriggers(ctx context.Context, params *BatchGetTriggersInput, optFns ...func(*Options)) (*BatchGetTriggersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetTriggers", params, optFns, addOperationBatchGetTriggersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetTriggersMiddleware(stack *middleware.Stack, options Options) (err error) {
