...
func (c *Client) CreatePartition(ctx context.Context, params *CreatePartitionInput, optFns ...func(*Options)) (*CreatePartitionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreatePartition", params, optFns, addOperationCreatePartitionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreatePartitionMiddleware(stack *middleware.Stack, options Options) (err error) {
