...
func (c *Client) GetConnections(ctx context.Context, params *GetConnectionsInput, optFns ...func(*Options)) (*GetConnectionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConnections", params, optFns, addOperationGetConnectionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConnectionsMiddleware(stack *middleware.Stack, options Options) (err error) {
