...
func (c *Client) BatchGetWorkflows(ctx context.Context, params *BatchGetWorkflowsInput, optFns ...func(*Options)) (*BatchGetWorkflowsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetWorkflows", params, optFns, addOperationBatchGetWorkflowsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetWorkflowsMiddleware(stack *middleware.Stack, options Options) (err error) {
