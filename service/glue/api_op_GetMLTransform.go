...
func (c *Client) GetMLTransform(ctx context.Context, params *GetMLTransformInput, optFns ...func(*Options)) (*GetMLTransformOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMLTransform", params, optFns, addOperationGetMLTransformMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMLTransformMiddleware(stack *middleware.Stack, options Options) (err error) {
