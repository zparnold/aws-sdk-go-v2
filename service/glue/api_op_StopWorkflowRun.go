...
func (c *Client) StopWorkflowRun(ctx context.Context, params *StopWorkflowRunInput, optFns ...func(*Options)) (*StopWorkflowRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopWorkflowRun", params, optFns, addOperationStopWorkflowRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopWorkflowRunMiddleware(stack *middleware.Stack, options Options) (err error) {
