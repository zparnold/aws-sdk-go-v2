...
func (c *Client) GetMLTaskRun(ctx context.Context, params *GetMLTaskRunInput, optFns ...func(*Options)) (*GetMLTaskRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMLTaskRun", params, optFns, addOperationGetMLTaskRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMLTaskRunMiddleware(stack *middleware.Stack, options Options) (err error) {
