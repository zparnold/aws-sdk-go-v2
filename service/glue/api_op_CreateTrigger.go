...
func (c *Client) CreateTrigger(ctx context.Context, params *CreateTriggerInput, optFns ...func(*Options)) (*CreateTriggerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrigger", params, optFns, addOperationCreateTriggerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTriggerMiddleware(stack *middleware.Stack, options Options) (err error) {
