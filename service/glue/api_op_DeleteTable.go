...
func (c *Client) DeleteTable(ctx context.Context, params *DeleteTableInput, optFns ...func(*Options)) (*DeleteTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTable", params, optFns, addOperationDeleteTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTableMiddleware(stack *middleware.Stack, options Options) (err error) {
