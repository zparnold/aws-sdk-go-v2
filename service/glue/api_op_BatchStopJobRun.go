...
func (c *Client) BatchStopJobRun(ctx context.Context, params *BatchStopJobRunInput, optFns ...func(*Options)) (*BatchStopJobRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchStopJobRun", params, optFns, addOperationBatchStopJobRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchStopJobRunMiddleware(stack *middleware.Stack, options Options) (err error) {
