...
func (c *Client) GetWorkflowRunProperties(ctx context.Context, params *GetWorkflowRunPropertiesInput, optFns ...func(*Options)) (*GetWorkflowRunPropertiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetWorkflowRunProperties", params, optFns, addOperationGetWorkflowRunPropertiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetWorkflowRunPropertiesMiddleware(stack *middleware.Stack, options Options) (err error) {
