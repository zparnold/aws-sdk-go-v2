...
func (c *Client) GetColumnStatisticsForTable(ctx context.Context, params *GetColumnStatisticsForTableInput, optFns ...func(*Options)) (*GetColumnStatisticsForTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetColumnStatisticsForTable", params, optFns, addOperationGetColumnStatisticsForTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetColumnStatisticsForTableMiddleware(stack *middleware.Stack, options Options) (err error) {
