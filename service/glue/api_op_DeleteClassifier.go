...
func (c *Client) DeleteClassifier(ctx context.Context, params *DeleteClassifierInput, optFns ...func(*Options)) (*DeleteClassifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClassifier", params, optFns, addOperationDeleteClassifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClassifierMiddleware(stack *middleware.Stack, options Options) (err error) {
