...
func (c *Client) StartExportLabelsTaskRun(ctx context.Context, params *StartExportLabelsTaskRunInput, optFns ...func(*Options)) (*StartExportLabelsTaskRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartExportLabelsTaskRun", params, optFns, addOperationStartExportLabelsTaskRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartExportLabelsTaskRunMiddleware(stack *middleware.Stack, options Options) (err error) {
