...
func (c *Client) GetCrawler(ctx context.Context, params *GetCrawlerInput, optFns ...func(*Options)) (*GetCrawlerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCrawler", params, optFns, addOperationGetCrawlerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCrawlerMiddleware(stack *middleware.Stack, options Options) (err error) {
