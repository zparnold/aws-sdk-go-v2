...
func (c *Client) ResumeWorkflowRun(ctx context.Context, params *ResumeWorkflowRunInput, optFns ...func(*Options)) (*ResumeWorkflowRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResumeWorkflowRun", params, optFns, addOperationResumeWorkflowRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResumeWorkflowRunMiddleware(stack *middleware.Stack, options Options) (err error) {
