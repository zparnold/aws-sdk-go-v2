...
func (c *Client) GetMLTaskRuns(ctx context.Context, params *GetMLTaskRunsInput, optFns ...func(*Options)) (*GetMLTaskRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMLTaskRuns", params, optFns, addOperationGetMLTaskRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMLTaskRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
