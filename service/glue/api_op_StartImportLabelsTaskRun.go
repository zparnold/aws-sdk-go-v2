...
func (c *Client) StartImportLabelsTaskRun(ctx context.Context, params *StartImportLabelsTaskRunInput, optFns ...func(*Options)) (*StartImportLabelsTaskRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartImportLabelsTaskRun", params, optFns, addOperationStartImportLabelsTaskRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartImportLabelsTaskRunMiddleware(stack *middleware.Stack, options Options) (err error) {
