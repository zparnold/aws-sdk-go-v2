...
func (c *Client) UpdateCrawlerSchedule(ctx context.Context, params *UpdateCrawlerScheduleInput, optFns ...func(*Options)) (*UpdateCrawlerScheduleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCrawlerSchedule", params, optFns, addOperationUpdateCrawlerScheduleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCrawlerScheduleMiddleware(stack *middleware.Stack, options Options) (err error) {
