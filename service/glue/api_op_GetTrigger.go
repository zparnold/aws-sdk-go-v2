...
func (c *Client) GetTrigger(ctx context.Context, params *GetTriggerInput, optFns ...func(*Options)) (*GetTriggerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTrigger", params, optFns, addOperationGetTriggerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTriggerMiddleware(stack *middleware.Stack, options Options) (err error) {
