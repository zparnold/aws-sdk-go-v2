...
func (c *Client) GetDevEndpoint(ctx context.Context, params *GetDevEndpointInput, optFns ...func(*Options)) (*GetDevEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDevEndpoint", params, optFns, addOperationGetDevEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDevEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
