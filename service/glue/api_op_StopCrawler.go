...
func (c *Client) StopCrawler(ctx context.Context, params *StopCrawlerInput, optFns ...func(*Options)) (*StopCrawlerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopCrawler", params, optFns, addOperationStopCrawlerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopCrawlerMiddleware(stack *middleware.Stack, options Options) (err error) {
