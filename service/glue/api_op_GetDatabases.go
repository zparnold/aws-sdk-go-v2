...
func (c *Client) GetDatabases(ctx context.Context, params *GetDatabasesInput, optFns ...func(*Options)) (*GetDatabasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDatabases", params, optFns, addOperationGetDatabasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDatabasesMiddleware(stack *middleware.Stack, options Options) (err error) {
