...
func (c *Client) DeleteItem(ctx context.Context, params *DeleteItemInput, optFns ...func(*Options)) (*DeleteItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteItem", params, optFns, addOperationDeleteItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteItemMiddleware(stack *middleware.Stack, options Options) (err error) {
