...
func (c *Client) DescribeContributorInsights(ctx context.Context, params *DescribeContributorInsightsInput, optFns ...func(*Options)) (*DescribeContributorInsightsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeContributorInsights", params, optFns, addOperationDescribeContributorInsightsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeContributorInsightsMiddleware(stack *middleware.Stack, options Options) (err error) {
