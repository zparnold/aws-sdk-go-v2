...
func (c *Client) DescribeTable(ctx context.Context, params *DescribeTableInput, optFns ...func(*Options)) (*DescribeTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTable", params, optFns, addOperationDescribeTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTableMiddleware(stack *middleware.Stack, options Options) (err error) {
