...
func (c *Client) UpdateTable(ctx context.Context, params *UpdateTableInput, optFns ...func(*Options)) (*UpdateTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTable", params, optFns, addOperationUpdateTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTableMiddleware(stack *middleware.Stack, options Options) (err error) {
