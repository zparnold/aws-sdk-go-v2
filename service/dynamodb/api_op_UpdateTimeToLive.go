...
func (c *Client) UpdateTimeToLive(ctx context.Context, params *UpdateTimeToLiveInput, optFns ...func(*Options)) (*UpdateTimeToLiveOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTimeToLive", params, optFns, addOperationUpdateTimeToLiveMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTimeToLiveMiddleware(stack *middleware.Stack, options Options) (err error) {
