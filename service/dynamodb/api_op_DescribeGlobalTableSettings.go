...
func (c *Client) DescribeGlobalTableSettings(ctx context.Context, params *DescribeGlobalTableSettingsInput, optFns ...func(*Options)) (*DescribeGlobalTableSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGlobalTableSettings", params, optFns, addOperationDescribeGlobalTableSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGlobalTableSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
