...
func (c *Client) RestoreTableToPointInTime(ctx context.Context, params *RestoreTableToPointInTimeInput, optFns ...func(*Options)) (*RestoreTableToPointInTimeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreTableToPointInTime", params, optFns, addOperationRestoreTableToPointInTimeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreTableToPointInTimeMiddleware(stack *middleware.Stack, options Options) (err error) {
