...
func (c *Client) GetItem(ctx context.Context, params *GetItemInput, optFns ...func(*Options)) (*GetItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetItem", params, optFns, addOperationGetItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetItemMiddleware(stack *middleware.Stack, options Options) (err error) {
