...
func (c *Client) DescribeTimeToLive(ctx context.Context, params *DescribeTimeToLiveInput, optFns ...func(*Options)) (*DescribeTimeToLiveOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTimeToLive", params, optFns, addOperationDescribeTimeToLiveMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTimeToLiveMiddleware(stack *middleware.Stack, options Options) (err error) {
