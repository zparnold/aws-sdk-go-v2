...
func (c *Client) DescribeBackup(ctx context.Context, params *DescribeBackupInput, optFns ...func(*Options)) (*DescribeBackupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBackup", params, optFns, addOperationDescribeBackupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBackupMiddleware(stack *middleware.Stack, options Options) (err error) {
