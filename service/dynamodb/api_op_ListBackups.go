...
func (c *Client) ListBackups(ctx context.Context, params *ListBackupsInput, optFns ...func(*Options)) (*ListBackupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBackups", params, optFns, addOperationListBackupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBackupsMiddleware(stack *middleware.Stack, options Options) (err error) {
