...
func (c *Client) UpdateItem(ctx context.Context, params *UpdateItemInput, optFns ...func(*Options)) (*UpdateItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateItem", params, optFns, addOperationUpdateItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateItemMiddleware(stack *middleware.Stack, options Options) (err error) {
