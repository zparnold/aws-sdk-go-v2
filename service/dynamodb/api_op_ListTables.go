...
func (c *Client) ListTables(ctx context.Context, params *ListTablesInput, optFns ...func(*Options)) (*ListTablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTables", params, optFns, addOperationListTablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTablesMiddleware(stack *middleware.Stack, options Options) (err error) {
