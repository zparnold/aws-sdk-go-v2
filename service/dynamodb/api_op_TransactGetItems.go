...
func (c *Client) TransactGetItems(ctx context.Context, params *TransactGetItemsInput, optFns ...func(*Options)) (*TransactGetItemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TransactGetItems", params, optFns, addOperationTransactGetItemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTransactGetItemsMiddleware(stack *middleware.Stack, options Options) (err error) {
