...
func (c *Client) UpdateContributorInsights(ctx context.Context, params *UpdateContributorInsightsInput, optFns ...func(*Options)) (*UpdateContributorInsightsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateContributorInsights", params, optFns, addOperationUpdateContributorInsightsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateContributorInsightsMiddleware(stack *middleware.Stack, options Options) (err error) {
