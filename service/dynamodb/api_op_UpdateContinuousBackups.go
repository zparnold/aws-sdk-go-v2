...
func (c *Client) UpdateContinuousBackups(ctx context.Context, params *UpdateContinuousBackupsInput, optFns ...func(*Options)) (*UpdateContinuousBackupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateContinuousBackups", params, optFns, addOperationUpdateContinuousBackupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateContinuousBackupsMiddleware(stack *middleware.Stack, options Options) (err error) {
