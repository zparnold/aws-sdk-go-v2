...
func (c *Client) RestoreTableFromBackup(ctx context.Context, params *RestoreTableFromBackupInput, optFns ...func(*Options)) (*RestoreTableFromBackupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreTableFromBackup", params, optFns, addOperationRestoreTableFromBackupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreTableFromBackupMiddleware(stack *middleware.Stack, options Options) (err error) {
