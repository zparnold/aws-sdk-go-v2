...
func (c *Client) DescribeContinuousBackups(ctx context.Context, params *DescribeContinuousBackupsInput, optFns ...func(*Options)) (*DescribeContinuousBackupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeContinuousBackups", params, optFns, addOperationDescribeContinuousBackupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeContinuousBackupsMiddleware(stack *middleware.Stack, options Options) (err error) {
