...
func (c *Client) CreateGlobalTable(ctx context.Context, params *CreateGlobalTableInput, optFns ...func(*Options)) (*CreateGlobalTableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGlobalTable", params, optFns, addOperationCreateGlobalTableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGlobalTableMiddleware(stack *middleware.Stack, options Options) (err error) {
