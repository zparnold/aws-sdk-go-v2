...
func (c *Client) DescribeTableReplicaAutoScaling(ctx context.Context, params *DescribeTableReplicaAutoScalingInput, optFns ...func(*Options)) (*DescribeTableReplicaAutoScalingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTableReplicaAutoScaling", params, optFns, addOperationDescribeTableReplicaAutoScalingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTableReplicaAutoScalingMiddleware(stack *middleware.Stack, options Options) (err error) {
