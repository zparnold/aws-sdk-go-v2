...
func (c *Client) PutItem(ctx context.Context, params *PutItemInput, optFns ...func(*Options)) (*PutItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutItem", params, optFns, addOperationPutItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutItemMiddleware(stack *middleware.Stack, options Options) (err error) {
