...
func (c *Client) ListGlobalTables(ctx context.Context, params *ListGlobalTablesInput, optFns ...func(*Options)) (*ListGlobalTablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListGlobalTables", params, optFns, addOperationListGlobalTablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListGlobalTablesMiddleware(stack *middleware.Stack, options Options) (err error) {
