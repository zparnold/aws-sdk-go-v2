...
func (c *Client) DescribeLimits(ctx context.Context, params *DescribeLimitsInput, optFns ...func(*Options)) (*DescribeLimitsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeLimits", params, optFns, addOperationDescribeLimitsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeLimitsMiddleware(stack *middleware.Stack, options Options) (err error) {
