...
func (c *Client) UpdateGlobalTableSettings(ctx context.Context, params *UpdateGlobalTableSettingsInput, optFns ...func(*Options)) (*UpdateGlobalTableSettingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGlobalTableSettings", params, optFns, addOperationUpdateGlobalTableSettingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGlobalTableSettingsMiddleware(stack *middleware.Stack, options Options) (err error) {
