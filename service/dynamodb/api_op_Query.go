...
func (c *Client) Query(ctx context.Context, params *QueryInput, optFns ...func(*Options)) (*QueryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "Query", params, optFns, addOperationQueryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationQueryMiddleware(stack *middleware.Stack, options Options) (err error) {
