...
func (c *Client) BatchGetItem(ctx context.Context, params *BatchGetItemInput, optFns ...func(*Options)) (*BatchGetItemOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetItem", params, optFns, addOperationBatchGetItemMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetItemMiddleware(stack *middleware.Stack, options Options) (err error) {
