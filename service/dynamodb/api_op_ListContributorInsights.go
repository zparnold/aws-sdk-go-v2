...
func (c *Client) ListContributorInsights(ctx context.Context, params *ListContributorInsightsInput, optFns ...func(*Options)) (*ListContributorInsightsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListContributorInsights", params, optFns, addOperationListContributorInsightsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListContributorInsightsMiddleware(stack *middleware.Stack, options Options) (err error) {
