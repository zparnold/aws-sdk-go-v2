...
func (c *Client) ListTagsOfResource(ctx context.Context, params *ListTagsOfResourceInput, optFns ...func(*Options)) (*ListTagsOfResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTagsOfResource", params, optFns, addOperationListTagsOfResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsOfResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
