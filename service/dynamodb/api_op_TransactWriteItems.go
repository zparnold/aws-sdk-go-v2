...
func (c *Client) TransactWriteItems(ctx context.Context, params *TransactWriteItemsInput, optFns ...func(*Options)) (*TransactWriteItemsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TransactWriteItems", params, optFns, addOperationTransactWriteItemsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTransactWriteItemsMiddleware(stack *middleware.Stack, options Options) (err error) {
