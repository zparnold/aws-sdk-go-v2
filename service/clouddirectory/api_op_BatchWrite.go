...
func (c *Client) BatchWrite(ctx context.Context, params *BatchWriteInput, optFns ...func(*Options)) (*BatchWriteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchWrite", params, optFns, addOperationBatchWriteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchWriteMiddleware(stack *middleware.Stack, options Options) (err error) {
