...
func (c *Client) UpdateObjectAttributes(ctx context.Context, params *UpdateObjectAttributesInput, optFns ...func(*Options)) (*UpdateObjectAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateObjectAttributes", params, optFns, addOperationUpdateObjectAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateObjectAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
