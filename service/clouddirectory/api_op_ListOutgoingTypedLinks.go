...
func (c *Client) ListOutgoingTypedLinks(ctx context.Context, params *ListOutgoingTypedLinksInput, optFns ...func(*Options)) (*ListOutgoingTypedLinksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOutgoingTypedLinks", params, optFns, addOperationListOutgoingTypedLinksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListOutgoingTypedLinksMiddleware(stack *middleware.Stack, options Options) (err error) {
