...
func (c *Client) ListTypedLinkFacetNames(ctx context.Context, params *ListTypedLinkFacetNamesInput, optFns ...func(*Options)) (*ListTypedLinkFacetNamesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTypedLinkFacetNames", params, optFns, addOperationListTypedLinkFacetNamesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTypedLinkFacetNamesMiddleware(stack *middleware.Stack, options Options) (err error) {
