...
func (c *Client) ListObjectPolicies(ctx context.Context, params *ListObjectPoliciesInput, optFns ...func(*Options)) (*ListObjectPoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListObjectPolicies", params, optFns, addOperationListObjectPoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListObjectPoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
