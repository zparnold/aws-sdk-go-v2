...
func (c *Client) CreateFacet(ctx context.Context, params *CreateFacetInput, optFns ...func(*Options)) (*CreateFacetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateFacet", params, optFns, addOperationCreateFacetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateFacetMiddleware(stack *middleware.Stack, options Options) (err error) {
