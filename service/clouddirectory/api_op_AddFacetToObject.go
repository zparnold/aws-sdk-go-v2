...
func (c *Client) AddFacetToObject(ctx context.Context, params *AddFacetToObjectInput, optFns ...func(*Options)) (*AddFacetToObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddFacetToObject", params, optFns, addOperationAddFacetToObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddFacetToObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
