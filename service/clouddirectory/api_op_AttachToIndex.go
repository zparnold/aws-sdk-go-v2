...
func (c *Client) AttachToIndex(ctx context.Context, params *AttachToIndexInput, optFns ...func(*Options)) (*AttachToIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachToIndex", params, optFns, addOperationAttachToIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachToIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
