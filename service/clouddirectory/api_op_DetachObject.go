...
func (c *Client) DetachObject(ctx context.Context, params *DetachObjectInput, optFns ...func(*Options)) (*DetachObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachObject", params, optFns, addOperationDetachObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
