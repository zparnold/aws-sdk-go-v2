...
func (c *Client) ListObjectParents(ctx context.Context, params *ListObjectParentsInput, optFns ...func(*Options)) (*ListObjectParentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListObjectParents", params, optFns, addOperationListObjectParentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListObjectParentsMiddleware(stack *middleware.Stack, options Options) (err error) {
