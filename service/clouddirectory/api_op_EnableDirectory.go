...
func (c *Client) EnableDirectory(ctx context.Context, params *EnableDirectoryInput, optFns ...func(*Options)) (*EnableDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "EnableDirectory", params, optFns, addOperationEnableDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationEnableDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
