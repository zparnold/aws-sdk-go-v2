...
func (c *Client) ListPolicyAttachments(ctx context.Context, params *ListPolicyAttachmentsInput, optFns ...func(*Options)) (*ListPolicyAttachmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPolicyAttachments", params, optFns, addOperationListPolicyAttachmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPolicyAttachmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
