...
func (c *Client) DeleteSchema(ctx context.Context, params *DeleteSchemaInput, optFns ...func(*Options)) (*DeleteSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSchema", params, optFns, addOperationDeleteSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
