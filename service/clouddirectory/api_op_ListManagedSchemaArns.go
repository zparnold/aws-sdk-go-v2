...
func (c *Client) ListManagedSchemaArns(ctx context.Context, params *ListManagedSchemaArnsInput, optFns ...func(*Options)) (*ListManagedSchemaArnsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListManagedSchemaArns", params, optFns, addOperationListManagedSchemaArnsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListManagedSchemaArnsMiddleware(stack *middleware.Stack, options Options) (err error) {
