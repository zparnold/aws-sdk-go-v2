...
func (c *Client) GetDirectory(ctx context.Context, params *GetDirectoryInput, optFns ...func(*Options)) (*GetDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDirectory", params, optFns, addOperationGetDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
