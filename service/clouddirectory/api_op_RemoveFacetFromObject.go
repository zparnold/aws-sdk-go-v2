...
func (c *Client) RemoveFacetFromObject(ctx context.Context, params *RemoveFacetFromObjectInput, optFns ...func(*Options)) (*RemoveFacetFromObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveFacetFromObject", params, optFns, addOperationRemoveFacetFromObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveFacetFromObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
