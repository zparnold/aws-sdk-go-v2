...
func (c *Client) GetAppliedSchemaVersion(ctx context.Context, params *GetAppliedSchemaVersionInput, optFns ...func(*Options)) (*GetAppliedSchemaVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAppliedSchemaVersion", params, optFns, addOperationGetAppliedSchemaVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAppliedSchemaVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
