...
func (c *Client) ListObjectParentPaths(ctx context.Context, params *ListObjectParentPathsInput, optFns ...func(*Options)) (*ListObjectParentPathsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListObjectParentPaths", params, optFns, addOperationListObjectParentPathsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListObjectParentPathsMiddleware(stack *middleware.Stack, options Options) (err error) {
