...
func (c *Client) ListDirectories(ctx context.Context, params *ListDirectoriesInput, optFns ...func(*Options)) (*ListDirectoriesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDirectories", params, optFns, addOperationListDirectoriesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDirectoriesMiddleware(stack *middleware.Stack, options Options) (err error) {
