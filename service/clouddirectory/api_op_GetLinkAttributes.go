...
func (c *Client) GetLinkAttributes(ctx context.Context, params *GetLinkAttributesInput, optFns ...func(*Options)) (*GetLinkAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLinkAttributes", params, optFns, addOperationGetLinkAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLinkAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
