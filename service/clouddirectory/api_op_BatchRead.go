...
func (c *Client) BatchRead(ctx context.Context, params *BatchReadInput, optFns ...func(*Options)) (*BatchReadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchRead", params, optFns, addOperationBatchReadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchReadMiddleware(stack *middleware.Stack, options Options) (err error) {
