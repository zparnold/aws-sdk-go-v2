...
func (c *Client) CreateIndex(ctx context.Context, params *CreateIndexInput, optFns ...func(*Options)) (*CreateIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIndex", params, optFns, addOperationCreateIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
