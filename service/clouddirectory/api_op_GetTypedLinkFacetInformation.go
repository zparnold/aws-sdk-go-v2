...
func (c *Client) GetTypedLinkFacetInformation(ctx context.Context, params *GetTypedLinkFacetInformationInput, optFns ...func(*Options)) (*GetTypedLinkFacetInformationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTypedLinkFacetInformation", params, optFns, addOperationGetTypedLinkFacetInformationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTypedLinkFacetInformationMiddleware(stack *middleware.Stack, options Options) (err error) {
