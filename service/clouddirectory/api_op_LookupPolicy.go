...
func (c *Client) LookupPolicy(ctx context.Context, params *LookupPolicyInput, optFns ...func(*Options)) (*LookupPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "LookupPolicy", params, optFns, addOperationLookupPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLookupPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
