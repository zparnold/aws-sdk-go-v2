...
func (c *Client) DeleteFacet(ctx context.Context, params *DeleteFacetInput, optFns ...func(*Options)) (*DeleteFacetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteFacet", params, optFns, addOperationDeleteFacetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteFacetMiddleware(stack *middleware.Stack, options Options) (err error) {
