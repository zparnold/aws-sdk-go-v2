...
func (c *Client) ListPublishedSchemaArns(ctx context.Context, params *ListPublishedSchemaArnsInput, optFns ...func(*Options)) (*ListPublishedSchemaArnsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListPublishedSchemaArns", params, optFns, addOperationListPublishedSchemaArnsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPublishedSchemaArnsMiddleware(stack *middleware.Stack, options Options) (err error) {
