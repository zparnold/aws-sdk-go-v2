...
func (c *Client) GetSchemaAsJson(ctx context.Context, params *GetSchemaAsJsonInput, optFns ...func(*Options)) (*GetSchemaAsJsonOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSchemaAsJson", params, optFns, addOperationGetSchemaAsJsonMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSchemaAsJsonMiddleware(stack *middleware.Stack, options Options) (err error) {
