...
func (c *Client) ListIndex(ctx context.Context, params *ListIndexInput, optFns ...func(*Options)) (*ListIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIndex", params, optFns, addOperationListIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
