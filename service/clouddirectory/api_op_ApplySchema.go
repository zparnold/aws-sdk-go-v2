...
func (c *Client) ApplySchema(ctx context.Context, params *ApplySchemaInput, optFns ...func(*Options)) (*ApplySchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ApplySchema", params, optFns, addOperationApplySchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationApplySchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
