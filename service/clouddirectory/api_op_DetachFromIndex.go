...
func (c *Client) DetachFromIndex(ctx context.Context, params *DetachFromIndexInput, optFns ...func(*Options)) (*DetachFromIndexOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachFromIndex", params, optFns, addOperationDetachFromIndexMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachFromIndexMiddleware(stack *middleware.Stack, options Options) (err error) {
