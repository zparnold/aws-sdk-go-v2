...
func (c *Client) AttachObject(ctx context.Context, params *AttachObjectInput, optFns ...func(*Options)) (*AttachObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachObject", params, optFns, addOperationAttachObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
