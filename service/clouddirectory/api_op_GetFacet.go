...
func (c *Client) GetFacet(ctx context.Context, params *GetFacetInput, optFns ...func(*Options)) (*GetFacetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetFacet", params, optFns, addOperationGetFacetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetFacetMiddleware(stack *middleware.Stack, options Options) (err error) {
