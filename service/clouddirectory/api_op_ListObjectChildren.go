...
func (c *Client) ListObjectChildren(ctx context.Context, params *ListObjectChildrenInput, optFns ...func(*Options)) (*ListObjectChildrenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListObjectChildren", params, optFns, addOperationListObjectChildrenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListObjectChildrenMiddleware(stack *middleware.Stack, options Options) (err error) {
