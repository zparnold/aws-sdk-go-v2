...
func (c *Client) UpdateLinkAttributes(ctx context.Context, params *UpdateLinkAttributesInput, optFns ...func(*Options)) (*UpdateLinkAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLinkAttributes", params, optFns, addOperationUpdateLinkAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLinkAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
