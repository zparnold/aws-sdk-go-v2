...
func (c *Client) UpdateFacet(ctx context.Context, params *UpdateFacetInput, optFns ...func(*Options)) (*UpdateFacetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateFacet", params, optFns, addOperationUpdateFacetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateFacetMiddleware(stack *middleware.Stack, options Options) (err error) {
