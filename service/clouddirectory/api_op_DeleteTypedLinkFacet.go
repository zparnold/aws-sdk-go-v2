...
func (c *Client) DeleteTypedLinkFacet(ctx context.Context, params *DeleteTypedLinkFacetInput, optFns ...func(*Options)) (*DeleteTypedLinkFacetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTypedLinkFacet", params, optFns, addOperationDeleteTypedLinkFacetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTypedLinkFacetMiddleware(stack *middleware.Stack, options Options) (err error) {
