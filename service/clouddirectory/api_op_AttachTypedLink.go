...
func (c *Client) AttachTypedLink(ctx context.Context, params *AttachTypedLinkInput, optFns ...func(*Options)) (*AttachTypedLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AttachTypedLink", params, optFns, addOperationAttachTypedLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAttachTypedLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
