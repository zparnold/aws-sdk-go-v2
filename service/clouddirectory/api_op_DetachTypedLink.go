...
func (c *Client) DetachTypedLink(ctx context.Context, params *DetachTypedLinkInput, optFns ...func(*Options)) (*DetachTypedLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetachTypedLink", params, optFns, addOperationDetachTypedLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetachTypedLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
