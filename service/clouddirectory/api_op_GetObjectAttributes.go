...
func (c *Client) GetObjectAttributes(ctx context.Context, params *GetObjectAttributesInput, optFns ...func(*Options)) (*GetObjectAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectAttributes", params, optFns, addOperationGetObjectAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
