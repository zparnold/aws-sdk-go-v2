...
func (c *Client) PublishSchema(ctx context.Context, params *PublishSchemaInput, optFns ...func(*Options)) (*PublishSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PublishSchema", params, optFns, addOperationPublishSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPublishSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
