...
func (c *Client) ListIncomingTypedLinks(ctx context.Context, params *ListIncomingTypedLinksInput, optFns ...func(*Options)) (*ListIncomingTypedLinksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIncomingTypedLinks", params, optFns, addOperationListIncomingTypedLinksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIncomingTypedLinksMiddleware(stack *middleware.Stack, options Options) (err error) {
