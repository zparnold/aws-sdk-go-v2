...
func (c *Client) UpgradePublishedSchema(ctx context.Context, params *UpgradePublishedSchemaInput, optFns ...func(*Options)) (*UpgradePublishedSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpgradePublishedSchema", params, optFns, addOperationUpgradePublishedSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpgradePublishedSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
