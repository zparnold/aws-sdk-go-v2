...
func (c *Client) CreateObject(ctx context.Context, params *CreateObjectInput, optFns ...func(*Options)) (*CreateObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateObject", params, optFns, addOperationCreateObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
