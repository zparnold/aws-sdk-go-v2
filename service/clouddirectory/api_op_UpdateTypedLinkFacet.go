...
func (c *Client) UpdateTypedLinkFacet(ctx context.Context, params *UpdateTypedLinkFacetInput, optFns ...func(*Options)) (*UpdateTypedLinkFacetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTypedLinkFacet", params, optFns, addOperationUpdateTypedLinkFacetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTypedLinkFacetMiddleware(stack *middleware.Stack, options Options) (err error) {
