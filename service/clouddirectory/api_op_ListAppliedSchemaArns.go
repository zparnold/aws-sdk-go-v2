...
func (c *Client) ListAppliedSchemaArns(ctx context.Context, params *ListAppliedSchemaArnsInput, optFns ...func(*Options)) (*ListAppliedSchemaArnsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAppliedSchemaArns", params, optFns, addOperationListAppliedSchemaArnsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAppliedSchemaArnsMiddleware(stack *middleware.Stack, options Options) (err error) {
