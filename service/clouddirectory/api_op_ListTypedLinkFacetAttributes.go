...
func (c *Client) ListTypedLinkFacetAttributes(ctx context.Context, params *ListTypedLinkFacetAttributesInput, optFns ...func(*Options)) (*ListTypedLinkFacetAttributesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTypedLinkFacetAttributes", params, optFns, addOperationListTypedLinkFacetAttributesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTypedLinkFacetAttributesMiddleware(stack *middleware.Stack, options Options) (err error) {
