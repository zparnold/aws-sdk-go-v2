...
func (c *Client) GetObjectInformation(ctx context.Context, params *GetObjectInformationInput, optFns ...func(*Options)) (*GetObjectInformationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectInformation", params, optFns, addOperationGetObjectInformationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectInformationMiddleware(stack *middleware.Stack, options Options) (err error) {
