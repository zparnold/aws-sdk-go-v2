...
func (c *Client) CreateTypedLinkFacet(ctx context.Context, params *CreateTypedLinkFacetInput, optFns ...func(*Options)) (*CreateTypedLinkFacetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTypedLinkFacet", params, optFns, addOperationCreateTypedLinkFacetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTypedLinkFacetMiddleware(stack *middleware.Stack, options Options) (err error) {
