...
func (c *Client) PutSchemaFromJson(ctx context.Context, params *PutSchemaFromJsonInput, optFns ...func(*Options)) (*PutSchemaFromJsonOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutSchemaFromJson", params, optFns, addOperationPutSchemaFromJsonMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutSchemaFromJsonMiddleware(stack *middleware.Stack, options Options) (err error) {
