...
func (c *Client) DisableDirectory(ctx context.Context, params *DisableDirectoryInput, optFns ...func(*Options)) (*DisableDirectoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DisableDirectory", params, optFns, addOperationDisableDirectoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDisableDirectoryMiddleware(stack *middleware.Stack, options Options) (err error) {
