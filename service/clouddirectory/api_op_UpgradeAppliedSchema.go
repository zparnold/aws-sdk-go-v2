...
func (c *Client) UpgradeAppliedSchema(ctx context.Context, params *UpgradeAppliedSchemaInput, optFns ...func(*Options)) (*UpgradeAppliedSchemaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpgradeAppliedSchema", params, optFns, addOperationUpgradeAppliedSchemaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpgradeAppliedSchemaMiddleware(stack *middleware.Stack, options Options) (err error) {
