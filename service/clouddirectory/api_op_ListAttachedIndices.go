...
func (c *Client) ListAttachedIndices(ctx context.Context, params *ListAttachedIndicesInput, optFns ...func(*Options)) (*ListAttachedIndicesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAttachedIndices", params, optFns, addOperationListAttachedIndicesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAttachedIndicesMiddleware(stack *middleware.Stack, options Options) (err error) {
