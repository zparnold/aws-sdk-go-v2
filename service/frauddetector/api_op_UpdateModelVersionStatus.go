...
func (c *Client) UpdateModelVersionStatus(ctx context.Context, params *UpdateModelVersionStatusInput, optFns ...func(*Options)) (*UpdateModelVersionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateModelVersionStatus", params, optFns, addOperationUpdateModelVersionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateModelVersionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
