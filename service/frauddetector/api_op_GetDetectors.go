...
func (c *Client) GetDetectors(ctx context.Context, params *GetDetectorsInput, optFns ...func(*Options)) (*GetDetectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDetectors", params, optFns, addOperationGetDetectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDetectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
