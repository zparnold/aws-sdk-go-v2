...
func (c *Client) UpdateRuleVersion(ctx context.Context, params *UpdateRuleVersionInput, optFns ...func(*Options)) (*UpdateRuleVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRuleVersion", params, optFns, addOperationUpdateRuleVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRuleVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
