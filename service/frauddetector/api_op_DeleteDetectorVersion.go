...
func (c *Client) DeleteDetectorVersion(ctx context.Context, params *DeleteDetectorVersionInput, optFns ...func(*Options)) (*DeleteDetectorVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDetectorVersion", params, optFns, addOperationDeleteDetectorVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDetectorVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
