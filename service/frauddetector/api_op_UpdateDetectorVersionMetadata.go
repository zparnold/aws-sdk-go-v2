...
func (c *Client) UpdateDetectorVersionMetadata(ctx context.Context, params *UpdateDetectorVersionMetadataInput, optFns ...func(*Options)) (*UpdateDetectorVersionMetadataOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDetectorVersionMetadata", params, optFns, addOperationUpdateDetectorVersionMetadataMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDetectorVersionMetadataMiddleware(stack *middleware.Stack, options Options) (err error) {
