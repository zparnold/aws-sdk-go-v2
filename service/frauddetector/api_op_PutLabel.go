...
func (c *Client) PutLabel(ctx context.Context, params *PutLabelInput, optFns ...func(*Options)) (*PutLabelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutLabel", params, optFns, addOperationPutLabelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutLabelMiddleware(stack *middleware.Stack, options Options) (err error) {
