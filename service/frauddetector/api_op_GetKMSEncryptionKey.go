...
func (c *Client) GetKMSEncryptionKey(ctx context.Context, params *GetKMSEncryptionKeyInput, optFns ...func(*Options)) (*GetKMSEncryptionKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetKMSEncryptionKey", params, optFns, addOperationGetKMSEncryptionKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetKMSEncryptionKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
