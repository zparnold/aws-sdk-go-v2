...
func (c *Client) PutEntityType(ctx context.Context, params *PutEntityTypeInput, optFns ...func(*Options)) (*PutEntityTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEntityType", params, optFns, addOperationPutEntityTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEntityTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
