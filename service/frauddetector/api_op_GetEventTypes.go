...
func (c *Client) GetEventTypes(ctx context.Context, params *GetEventTypesInput, optFns ...func(*Options)) (*GetEventTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEventTypes", params, optFns, addOperationGetEventTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEventTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
