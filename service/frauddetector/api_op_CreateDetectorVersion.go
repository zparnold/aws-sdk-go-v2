...
func (c *Client) CreateDetectorVersion(ctx context.Context, params *CreateDetectorVersionInput, optFns ...func(*Options)) (*CreateDetectorVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDetectorVersion", params, optFns, addOperationCreateDetectorVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDetectorVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
