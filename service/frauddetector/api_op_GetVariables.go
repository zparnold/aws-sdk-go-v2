...
func (c *Client) GetVariables(ctx context.Context, params *GetVariablesInput, optFns ...func(*Options)) (*GetVariablesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVariables", params, optFns, addOperationGetVariablesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVariablesMiddleware(stack *middleware.Stack, options Options) (err error) {
