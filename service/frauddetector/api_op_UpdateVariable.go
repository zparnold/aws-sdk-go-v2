...
func (c *Client) UpdateVariable(ctx context.Context, params *UpdateVariableInput, optFns ...func(*Options)) (*UpdateVariableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVariable", params, optFns, addOperationUpdateVariableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVariableMiddleware(stack *middleware.Stack, options Options) (err error) {
