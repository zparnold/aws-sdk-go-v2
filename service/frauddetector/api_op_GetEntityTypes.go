...
func (c *Client) GetEntityTypes(ctx context.Context, params *GetEntityTypesInput, optFns ...func(*Options)) (*GetEntityTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEntityTypes", params, optFns, addOperationGetEntityTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEntityTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
