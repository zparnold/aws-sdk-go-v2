...
func (c *Client) CreateRule(ctx context.Context, params *CreateRuleInput, optFns ...func(*Options)) (*CreateRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRule", params, optFns, addOperationCreateRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
