...
func (c *Client) GetOutcomes(ctx context.Context, params *GetOutcomesInput, optFns ...func(*Options)) (*GetOutcomesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOutcomes", params, optFns, addOperationGetOutcomesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOutcomesMiddleware(stack *middleware.Stack, options Options) (err error) {
