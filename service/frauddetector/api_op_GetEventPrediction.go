...
func (c *Client) GetEventPrediction(ctx context.Context, params *GetEventPredictionInput, optFns ...func(*Options)) (*GetEventPredictionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEventPrediction", params, optFns, addOperationGetEventPredictionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEventPredictionMiddleware(stack *middleware.Stack, options Options) (err error) {
