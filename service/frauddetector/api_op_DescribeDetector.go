...
func (c *Client) DescribeDetector(ctx context.Context, params *DescribeDetectorInput, optFns ...func(*Options)) (*DescribeDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDetector", params, optFns, addOperationDescribeDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
