...
func (c *Client) DeleteDetector(ctx context.Context, params *DeleteDetectorInput, optFns ...func(*Options)) (*DeleteDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDetector", params, optFns, addOperationDeleteDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
