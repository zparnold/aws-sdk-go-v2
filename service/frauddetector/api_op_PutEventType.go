...
func (c *Client) PutEventType(ctx context.Context, params *PutEventTypeInput, optFns ...func(*Options)) (*PutEventTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEventType", params, optFns, addOperationPutEventTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEventTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
