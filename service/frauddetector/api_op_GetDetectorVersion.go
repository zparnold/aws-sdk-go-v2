...
func (c *Client) GetDetectorVersion(ctx context.Context, params *GetDetectorVersionInput, optFns ...func(*Options)) (*GetDetectorVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDetectorVersion", params, optFns, addOperationGetDetectorVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDetectorVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
