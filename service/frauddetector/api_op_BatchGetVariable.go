...
func (c *Client) BatchGetVariable(ctx context.Context, params *BatchGetVariableInput, optFns ...func(*Options)) (*BatchGetVariableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetVariable", params, optFns, addOperationBatchGetVariableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetVariableMiddleware(stack *middleware.Stack, options Options) (err error) {
