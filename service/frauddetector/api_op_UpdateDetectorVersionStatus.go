...
func (c *Client) UpdateDetectorVersionStatus(ctx context.Context, params *UpdateDetectorVersionStatusInput, optFns ...func(*Options)) (*UpdateDetectorVersionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDetectorVersionStatus", params, optFns, addOperationUpdateDetectorVersionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDetectorVersionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
