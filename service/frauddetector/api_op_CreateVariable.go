...
func (c *Client) CreateVariable(ctx context.Context, params *CreateVariableInput, optFns ...func(*Options)) (*CreateVariableOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateVariable", params, optFns, addOperationCreateVariableMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateVariableMiddleware(stack *middleware.Stack, options Options) (err error) {
