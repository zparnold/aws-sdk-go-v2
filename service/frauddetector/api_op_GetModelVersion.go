...
func (c *Client) GetModelVersion(ctx context.Context, params *GetModelVersionInput, optFns ...func(*Options)) (*GetModelVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetModelVersion", params, optFns, addOperationGetModelVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetModelVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
