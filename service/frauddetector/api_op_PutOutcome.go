...
func (c *Client) PutOutcome(ctx context.Context, params *PutOutcomeInput, optFns ...func(*Options)) (*PutOutcomeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutOutcome", params, optFns, addOperationPutOutcomeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutOutcomeMiddleware(stack *middleware.Stack, options Options) (err error) {
