...
func (c *Client) CreateModelVersion(ctx context.Context, params *CreateModelVersionInput, optFns ...func(*Options)) (*CreateModelVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateModelVersion", params, optFns, addOperationCreateModelVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateModelVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
