...
func (c *Client) PutExternalModel(ctx context.Context, params *PutExternalModelInput, optFns ...func(*Options)) (*PutExternalModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutExternalModel", params, optFns, addOperationPutExternalModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutExternalModelMiddleware(stack *middleware.Stack, options Options) (err error) {
