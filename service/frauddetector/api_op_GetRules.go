...
func (c *Client) GetRules(ctx context.Context, params *GetRulesInput, optFns ...func(*Options)) (*GetRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRules", params, optFns, addOperationGetRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
