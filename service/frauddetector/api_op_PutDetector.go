...
func (c *Client) PutDetector(ctx context.Context, params *PutDetectorInput, optFns ...func(*Options)) (*PutDetectorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDetector", params, optFns, addOperationPutDetectorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDetectorMiddleware(stack *middleware.Stack, options Options) (err error) {
