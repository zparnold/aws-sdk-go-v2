...
func (c *Client) GetServiceGraph(ctx context.Context, params *GetServiceGraphInput, optFns ...func(*Options)) (*GetServiceGraphOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetServiceGraph", params, optFns, addOperationGetServiceGraphMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetServiceGraphMiddleware(stack *middleware.Stack, options Options) (err error) {
