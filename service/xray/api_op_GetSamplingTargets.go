...
func (c *Client) GetSamplingTargets(ctx context.Context, params *GetSamplingTargetsInput, optFns ...func(*Options)) (*GetSamplingTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSamplingTargets", params, optFns, addOperationGetSamplingTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSamplingTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
