...
func (c *Client) GetGroups(ctx context.Context, params *GetGroupsInput, optFns ...func(*Options)) (*GetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGroups", params, optFns, addOperationGetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
