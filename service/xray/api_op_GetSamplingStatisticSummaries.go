...
func (c *Client) GetSamplingStatisticSummaries(ctx context.Context, params *GetSamplingStatisticSummariesInput, optFns ...func(*Options)) (*GetSamplingStatisticSummariesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSamplingStatisticSummaries", params, optFns, addOperationGetSamplingStatisticSummariesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSamplingStatisticSummariesMiddleware(stack *middleware.Stack, options Options) (err error) {
