...
func (c *Client) BatchGetTraces(ctx context.Context, params *BatchGetTracesInput, optFns ...func(*Options)) (*BatchGetTracesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchGetTraces", params, optFns, addOperationBatchGetTracesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchGetTracesMiddleware(stack *middleware.Stack, options Options) (err error) {
