...
func (c *Client) DeleteSamplingRule(ctx context.Context, params *DeleteSamplingRuleInput, optFns ...func(*Options)) (*DeleteSamplingRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSamplingRule", params, optFns, addOperationDeleteSamplingRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSamplingRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
