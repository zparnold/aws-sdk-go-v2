...
func (c *Client) PutTelemetryRecords(ctx context.Context, params *PutTelemetryRecordsInput, optFns ...func(*Options)) (*PutTelemetryRecordsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutTelemetryRecords", params, optFns, addOperationPutTelemetryRecordsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutTelemetryRecordsMiddleware(stack *middleware.Stack, options Options) (err error) {
