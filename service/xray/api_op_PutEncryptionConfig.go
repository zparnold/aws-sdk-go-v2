...
func (c *Client) PutEncryptionConfig(ctx context.Context, params *PutEncryptionConfigInput, optFns ...func(*Options)) (*PutEncryptionConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEncryptionConfig", params, optFns, addOperationPutEncryptionConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEncryptionConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
