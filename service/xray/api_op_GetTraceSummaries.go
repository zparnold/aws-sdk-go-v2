...
func (c *Client) GetTraceSummaries(ctx context.Context, params *GetTraceSummariesInput, optFns ...func(*Options)) (*GetTraceSummariesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTraceSummaries", params, optFns, addOperationGetTraceSummariesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTraceSummariesMiddleware(stack *middleware.Stack, options Options) (err error) {
