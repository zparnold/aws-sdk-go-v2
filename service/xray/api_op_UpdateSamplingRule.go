...
func (c *Client) UpdateSamplingRule(ctx context.Context, params *UpdateSamplingRuleInput, optFns ...func(*Options)) (*UpdateSamplingRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSamplingRule", params, optFns, addOperationUpdateSamplingRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSamplingRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
