...
func (c *Client) GetTraceGraph(ctx context.Context, params *GetTraceGraphInput, optFns ...func(*Options)) (*GetTraceGraphOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTraceGraph", params, optFns, addOperationGetTraceGraphMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTraceGraphMiddleware(stack *middleware.Stack, options Options) (err error) {
