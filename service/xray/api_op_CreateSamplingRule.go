...
func (c *Client) CreateSamplingRule(ctx context.Context, params *CreateSamplingRuleInput, optFns ...func(*Options)) (*CreateSamplingRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSamplingRule", params, optFns, addOperationCreateSamplingRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSamplingRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
