...
func (c *Client) PutTraceSegments(ctx context.Context, params *PutTraceSegmentsInput, optFns ...func(*Options)) (*PutTraceSegmentsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutTraceSegments", params, optFns, addOperationPutTraceSegmentsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutTraceSegmentsMiddleware(stack *middleware.Stack, options Options) (err error) {
