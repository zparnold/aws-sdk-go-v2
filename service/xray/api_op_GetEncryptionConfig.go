...
func (c *Client) GetEncryptionConfig(ctx context.Context, params *GetEncryptionConfigInput, optFns ...func(*Options)) (*GetEncryptionConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEncryptionConfig", params, optFns, addOperationGetEncryptionConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEncryptionConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
