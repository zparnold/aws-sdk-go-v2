...
func (c *Client) GetSamplingRules(ctx context.Context, params *GetSamplingRulesInput, optFns ...func(*Options)) (*GetSamplingRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSamplingRules", params, optFns, addOperationGetSamplingRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSamplingRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
