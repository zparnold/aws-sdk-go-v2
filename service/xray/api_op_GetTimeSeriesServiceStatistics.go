...
func (c *Client) GetTimeSeriesServiceStatistics(ctx context.Context, params *GetTimeSeriesServiceStatisticsInput, optFns ...func(*Options)) (*GetTimeSeriesServiceStatisticsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTimeSeriesServiceStatistics", params, optFns, addOperationGetTimeSeriesServiceStatisticsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTimeSeriesServiceStatisticsMiddleware(stack *middleware.Stack, options Options) (err error) {
