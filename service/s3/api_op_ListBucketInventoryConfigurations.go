...
func (c *Client) ListBucketInventoryConfigurations(ctx context.Context, params *ListBucketInventoryConfigurationsInput, optFns ...func(*Options)) (*ListBucketInventoryConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBucketInventoryConfigurations", params, optFns, addOperationListBucketInventoryConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBucketInventoryConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
