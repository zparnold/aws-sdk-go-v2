...
func (c *Client) ListParts(ctx context.Context, params *ListPartsInput, optFns ...func(*Options)) (*ListPartsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListParts", params, optFns, addOperationListPartsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListPartsMiddleware(stack *middleware.Stack, options Options) (err error) {
