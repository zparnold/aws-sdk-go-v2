...
func (c *Client) DeleteBucketAnalyticsConfiguration(ctx context.Context, params *DeleteBucketAnalyticsConfigurationInput, optFns ...func(*Options)) (*DeleteBucketAnalyticsConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketAnalyticsConfiguration", params, optFns, addOperationDeleteBucketAnalyticsConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketAnalyticsConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
