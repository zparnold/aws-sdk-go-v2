...
func (c *Client) PutObjectLegalHold(ctx context.Context, params *PutObjectLegalHoldInput, optFns ...func(*Options)) (*PutObjectLegalHoldOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutObjectLegalHold", params, optFns, addOperationPutObjectLegalHoldMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutObjectLegalHoldMiddleware(stack *middleware.Stack, options Options) (err error) {
