...
func (c *Client) DeleteObjects(ctx context.Context, params *DeleteObjectsInput, optFns ...func(*Options)) (*DeleteObjectsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteObjects", params, optFns, addOperationDeleteObjectsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteObjectsMiddleware(stack *middleware.Stack, options Options) (err error) {
