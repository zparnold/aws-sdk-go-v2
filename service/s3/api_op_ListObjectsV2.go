...
func (c *Client) ListObjectsV2(ctx context.Context, params *ListObjectsV2Input, optFns ...func(*Options)) (*ListObjectsV2Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListObjectsV2", params, optFns, addOperationListObjectsV2Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListObjectsV2Middleware(stack *middleware.Stack, options Options) (err error) {
