...
func (c *Client) DeleteBucketMetricsConfiguration(ctx context.Context, params *DeleteBucketMetricsConfigurationInput, optFns ...func(*Options)) (*DeleteBucketMetricsConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketMetricsConfiguration", params, optFns, addOperationDeleteBucketMetricsConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketMetricsConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
