...
func (c *Client) HeadObject(ctx context.Context, params *HeadObjectInput, optFns ...func(*Options)) (*HeadObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "HeadObject", params, optFns, addOperationHeadObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationHeadObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
