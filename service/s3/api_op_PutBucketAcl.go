...
func (c *Client) PutBucketAcl(ctx context.Context, params *PutBucketAclInput, optFns ...func(*Options)) (*PutBucketAclOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketAcl", params, optFns, addOperationPutBucketAclMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketAclMiddleware(stack *middleware.Stack, options Options) (err error) {
