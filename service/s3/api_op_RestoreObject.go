...
func (c *Client) RestoreObject(ctx context.Context, params *RestoreObjectInput, optFns ...func(*Options)) (*RestoreObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreObject", params, optFns, addOperationRestoreObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
