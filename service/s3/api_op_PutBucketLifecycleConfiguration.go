...
func (c *Client) PutBucketLifecycleConfiguration(ctx context.Context, params *PutBucketLifecycleConfigurationInput, optFns ...func(*Options)) (*PutBucketLifecycleConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketLifecycleConfiguration", params, optFns, addOperationPutBucketLifecycleConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketLifecycleConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
