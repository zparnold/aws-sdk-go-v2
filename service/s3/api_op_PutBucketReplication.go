...
func (c *Client) PutBucketReplication(ctx context.Context, params *PutBucketReplicationInput, optFns ...func(*Options)) (*PutBucketReplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketReplication", params, optFns, addOperationPutBucketReplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketReplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
