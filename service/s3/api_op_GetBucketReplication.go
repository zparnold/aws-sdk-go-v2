...
func (c *Client) GetBucketReplication(ctx context.Context, params *GetBucketReplicationInput, optFns ...func(*Options)) (*GetBucketReplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketReplication", params, optFns, addOperationGetBucketReplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketReplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
