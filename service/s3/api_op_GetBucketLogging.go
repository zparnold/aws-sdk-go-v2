...
func (c *Client) GetBucketLogging(ctx context.Context, params *GetBucketLoggingInput, optFns ...func(*Options)) (*GetBucketLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketLogging", params, optFns, addOperationGetBucketLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
