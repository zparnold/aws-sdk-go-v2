...
func (c *Client) GetBucketLifecycleConfiguration(ctx context.Context, params *GetBucketLifecycleConfigurationInput, optFns ...func(*Options)) (*GetBucketLifecycleConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketLifecycleConfiguration", params, optFns, addOperationGetBucketLifecycleConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketLifecycleConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
