...
func (c *Client) ListBucketAnalyticsConfigurations(ctx context.Context, params *ListBucketAnalyticsConfigurationsInput, optFns ...func(*Options)) (*ListBucketAnalyticsConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBucketAnalyticsConfigurations", params, optFns, addOperationListBucketAnalyticsConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBucketAnalyticsConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
