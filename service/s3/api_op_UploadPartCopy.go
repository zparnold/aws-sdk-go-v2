...
func (c *Client) UploadPartCopy(ctx context.Context, params *UploadPartCopyInput, optFns ...func(*Options)) (*UploadPartCopyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadPartCopy", params, optFns, addOperationUploadPartCopyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadPartCopyMiddleware(stack *middleware.Stack, options Options) (err error) {
