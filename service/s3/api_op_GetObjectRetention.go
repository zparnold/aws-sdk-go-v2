...
func (c *Client) GetObjectRetention(ctx context.Context, params *GetObjectRetentionInput, optFns ...func(*Options)) (*GetObjectRetentionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectRetention", params, optFns, addOperationGetObjectRetentionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectRetentionMiddleware(stack *middleware.Stack, options Options) (err error) {
