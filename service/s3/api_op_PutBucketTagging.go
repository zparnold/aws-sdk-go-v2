...
func (c *Client) PutBucketTagging(ctx context.Context, params *PutBucketTaggingInput, optFns ...func(*Options)) (*PutBucketTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketTagging", params, optFns, addOperationPutBucketTaggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketTaggingMiddleware(stack *middleware.Stack, options Options) (err error) {
