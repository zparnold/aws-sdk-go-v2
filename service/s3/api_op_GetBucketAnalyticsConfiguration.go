...
func (c *Client) GetBucketAnalyticsConfiguration(ctx context.Context, params *GetBucketAnalyticsConfigurationInput, optFns ...func(*Options)) (*GetBucketAnalyticsConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketAnalyticsConfiguration", params, optFns, addOperationGetBucketAnalyticsConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketAnalyticsConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
