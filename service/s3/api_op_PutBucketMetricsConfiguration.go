...
func (c *Client) PutBucketMetricsConfiguration(ctx context.Context, params *PutBucketMetricsConfigurationInput, optFns ...func(*Options)) (*PutBucketMetricsConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketMetricsConfiguration", params, optFns, addOperationPutBucketMetricsConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketMetricsConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
