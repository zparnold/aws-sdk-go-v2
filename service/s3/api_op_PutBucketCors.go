...
func (c *Client) PutBucketCors(ctx context.Context, params *PutBucketCorsInput, optFns ...func(*Options)) (*PutBucketCorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketCors", params, optFns, addOperationPutBucketCorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketCorsMiddleware(stack *middleware.Stack, options Options) (err error) {
