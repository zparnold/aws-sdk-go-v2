...
func (c *Client) GetObjectLegalHold(ctx context.Context, params *GetObjectLegalHoldInput, optFns ...func(*Options)) (*GetObjectLegalHoldOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectLegalHold", params, optFns, addOperationGetObjectLegalHoldMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectLegalHoldMiddleware(stack *middleware.Stack, options Options) (err error) {
