...
func (c *Client) PutBucketLogging(ctx context.Context, params *PutBucketLoggingInput, optFns ...func(*Options)) (*PutBucketLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketLogging", params, optFns, addOperationPutBucketLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
