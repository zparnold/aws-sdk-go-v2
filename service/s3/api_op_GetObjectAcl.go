...
func (c *Client) GetObjectAcl(ctx context.Context, params *GetObjectAclInput, optFns ...func(*Options)) (*GetObjectAclOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectAcl", params, optFns, addOperationGetObjectAclMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectAclMiddleware(stack *middleware.Stack, options Options) (err error) {
