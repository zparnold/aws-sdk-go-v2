...
func (c *Client) PutObjectRetention(ctx context.Context, params *PutObjectRetentionInput, optFns ...func(*Options)) (*PutObjectRetentionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutObjectRetention", params, optFns, addOperationPutObjectRetentionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutObjectRetentionMiddleware(stack *middleware.Stack, options Options) (err error) {
