...
func (c *Client) ListBuckets(ctx context.Context, params *ListBucketsInput, optFns ...func(*Options)) (*ListBucketsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBuckets", params, optFns, addOperationListBucketsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBucketsMiddleware(stack *middleware.Stack, options Options) (err error) {
