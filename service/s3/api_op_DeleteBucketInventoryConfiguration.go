...
func (c *Client) DeleteBucketInventoryConfiguration(ctx context.Context, params *DeleteBucketInventoryConfigurationInput, optFns ...func(*Options)) (*DeleteBucketInventoryConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketInventoryConfiguration", params, optFns, addOperationDeleteBucketInventoryConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketInventoryConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
