...
func (c *Client) GetBucketLocation(ctx context.Context, params *GetBucketLocationInput, optFns ...func(*Options)) (*GetBucketLocationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketLocation", params, optFns, addOperationGetBucketLocationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketLocationMiddleware(stack *middleware.Stack, options Options) (err error) {
