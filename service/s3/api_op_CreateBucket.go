...
func (c *Client) CreateBucket(ctx context.Context, params *CreateBucketInput, optFns ...func(*Options)) (*CreateBucketOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBucket", params, optFns, addOperationCreateBucketMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBucketMiddleware(stack *middleware.Stack, options Options) (err error) {
