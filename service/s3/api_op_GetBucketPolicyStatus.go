...
func (c *Client) GetBucketPolicyStatus(ctx context.Context, params *GetBucketPolicyStatusInput, optFns ...func(*Options)) (*GetBucketPolicyStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketPolicyStatus", params, optFns, addOperationGetBucketPolicyStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketPolicyStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
