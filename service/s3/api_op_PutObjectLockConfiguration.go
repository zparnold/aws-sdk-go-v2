...
func (c *Client) PutObjectLockConfiguration(ctx context.Context, params *PutObjectLockConfigurationInput, optFns ...func(*Options)) (*PutObjectLockConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutObjectLockConfiguration", params, optFns, addOperationPutObjectLockConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutObjectLockConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
