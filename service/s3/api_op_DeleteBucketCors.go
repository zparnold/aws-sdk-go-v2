...
func (c *Client) DeleteBucketCors(ctx context.Context, params *DeleteBucketCorsInput, optFns ...func(*Options)) (*DeleteBucketCorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketCors", params, optFns, addOperationDeleteBucketCorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketCorsMiddleware(stack *middleware.Stack, options Options) (err error) {
