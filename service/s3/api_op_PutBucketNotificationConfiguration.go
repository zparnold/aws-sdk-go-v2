...
func (c *Client) PutBucketNotificationConfiguration(ctx context.Context, params *PutBucketNotificationConfigurationInput, optFns ...func(*Options)) (*PutBucketNotificationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketNotificationConfiguration", params, optFns, addOperationPutBucketNotificationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketNotificationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
