...
func (c *Client) GetBucketNotificationConfiguration(ctx context.Context, params *GetBucketNotificationConfigurationInput, optFns ...func(*Options)) (*GetBucketNotificationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketNotificationConfiguration", params, optFns, addOperationGetBucketNotificationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketNotificationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
