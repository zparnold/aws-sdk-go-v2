...
func (c *Client) DeleteBucketEncryption(ctx context.Context, params *DeleteBucketEncryptionInput, optFns ...func(*Options)) (*DeleteBucketEncryptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketEncryption", params, optFns, addOperationDeleteBucketEncryptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketEncryptionMiddleware(stack *middleware.Stack, options Options) (err error) {
