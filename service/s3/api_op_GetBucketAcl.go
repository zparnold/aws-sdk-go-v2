...
func (c *Client) GetBucketAcl(ctx context.Context, params *GetBucketAclInput, optFns ...func(*Options)) (*GetBucketAclOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketAcl", params, optFns, addOperationGetBucketAclMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketAclMiddleware(stack *middleware.Stack, options Options) (err error) {
