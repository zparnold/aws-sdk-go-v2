...
func (c *Client) CompleteMultipartUpload(ctx context.Context, params *CompleteMultipartUploadInput, optFns ...func(*Options)) (*CompleteMultipartUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CompleteMultipartUpload", params, optFns, addOperationCompleteMultipartUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCompleteMultipartUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
