...
func (c *Client) CreateMultipartUpload(ctx context.Context, params *CreateMultipartUploadInput, optFns ...func(*Options)) (*CreateMultipartUploadOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateMultipartUpload", params, optFns, addOperationCreateMultipartUploadMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateMultipartUploadMiddleware(stack *middleware.Stack, options Options) (err error) {
