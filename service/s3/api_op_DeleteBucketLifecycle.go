...
func (c *Client) DeleteBucketLifecycle(ctx context.Context, params *DeleteBucketLifecycleInput, optFns ...func(*Options)) (*DeleteBucketLifecycleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBucketLifecycle", params, optFns, addOperationDeleteBucketLifecycleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBucketLifecycleMiddleware(stack *middleware.Stack, options Options) (err error) {
