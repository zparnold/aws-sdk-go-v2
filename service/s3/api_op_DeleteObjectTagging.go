...
func (c *Client) DeleteObjectTagging(ctx context.Context, params *DeleteObjectTaggingInput, optFns ...func(*Options)) (*DeleteObjectTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteObjectTagging", params, optFns, addOperationDeleteObjectTaggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteObjectTaggingMiddleware(stack *middleware.Stack, options Options) (err error) {
