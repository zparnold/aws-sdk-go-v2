...
func (c *Client) PutBucketVersioning(ctx context.Context, params *PutBucketVersioningInput, optFns ...func(*Options)) (*PutBucketVersioningOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketVersioning", params, optFns, addOperationPutBucketVersioningMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketVersioningMiddleware(stack *middleware.Stack, options Options) (err error) {
