...
func (c *Client) PutObjectAcl(ctx context.Context, params *PutObjectAclInput, optFns ...func(*Options)) (*PutObjectAclOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutObjectAcl", params, optFns, addOperationPutObjectAclMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutObjectAclMiddleware(stack *middleware.Stack, options Options) (err error) {
