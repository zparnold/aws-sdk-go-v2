...
func (c *Client) CopyObject(ctx context.Context, params *CopyObjectInput, optFns ...func(*Options)) (*CopyObjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyObject", params, optFns, addOperationCopyObjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyObjectMiddleware(stack *middleware.Stack, options Options) (err error) {
