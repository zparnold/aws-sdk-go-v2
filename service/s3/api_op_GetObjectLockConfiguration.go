...
func (c *Client) GetObjectLockConfiguration(ctx context.Context, params *GetObjectLockConfigurationInput, optFns ...func(*Options)) (*GetObjectLockConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectLockConfiguration", params, optFns, addOperationGetObjectLockConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectLockConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
