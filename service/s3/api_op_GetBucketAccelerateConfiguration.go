...
func (c *Client) GetBucketAccelerateConfiguration(ctx context.Context, params *GetBucketAccelerateConfigurationInput, optFns ...func(*Options)) (*GetBucketAccelerateConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketAccelerateConfiguration", params, optFns, addOperationGetBucketAccelerateConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketAccelerateConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
