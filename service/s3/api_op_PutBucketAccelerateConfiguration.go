...
func (c *Client) PutBucketAccelerateConfiguration(ctx context.Context, params *PutBucketAccelerateConfigurationInput, optFns ...func(*Options)) (*PutBucketAccelerateConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketAccelerateConfiguration", params, optFns, addOperationPutBucketAccelerateConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketAccelerateConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
