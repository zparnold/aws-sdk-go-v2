...
func (c *Client) ListBucketMetricsConfigurations(ctx context.Context, params *ListBucketMetricsConfigurationsInput, optFns ...func(*Options)) (*ListBucketMetricsConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBucketMetricsConfigurations", params, optFns, addOperationListBucketMetricsConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBucketMetricsConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
