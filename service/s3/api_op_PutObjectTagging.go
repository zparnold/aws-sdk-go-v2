...
func (c *Client) PutObjectTagging(ctx context.Context, params *PutObjectTaggingInput, optFns ...func(*Options)) (*PutObjectTaggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutObjectTagging", params, optFns, addOperationPutObjectTaggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutObjectTaggingMiddleware(stack *middleware.Stack, options Options) (err error) {
