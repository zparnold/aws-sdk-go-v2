...
func (c *Client) ListObjectVersions(ctx context.Context, params *ListObjectVersionsInput, optFns ...func(*Options)) (*ListObjectVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListObjectVersions", params, optFns, addOperationListObjectVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListObjectVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
