...
func (c *Client) GetObjectTorrent(ctx context.Context, params *GetObjectTorrentInput, optFns ...func(*Options)) (*GetObjectTorrentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetObjectTorrent", params, optFns, addOperationGetObjectTorrentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetObjectTorrentMiddleware(stack *middleware.Stack, options Options) (err error) {
