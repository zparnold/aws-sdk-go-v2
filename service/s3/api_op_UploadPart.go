...
func (c *Client) UploadPart(ctx context.Context, params *UploadPartInput, optFns ...func(*Options)) (*UploadPartOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UploadPart", params, optFns, addOperationUploadPartMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUploadPartMiddleware(stack *middleware.Stack, options Options) (err error) {
