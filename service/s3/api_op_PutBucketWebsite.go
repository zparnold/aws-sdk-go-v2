...
func (c *Client) PutBucketWebsite(ctx context.Context, params *PutBucketWebsiteInput, optFns ...func(*Options)) (*PutBucketWebsiteOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutBucketWebsite", params, optFns, addOperationPutBucketWebsiteMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutBucketWebsiteMiddleware(stack *middleware.Stack, options Options) (err error) {
