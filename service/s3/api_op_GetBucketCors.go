...
func (c *Client) GetBucketCors(ctx context.Context, params *GetBucketCorsInput, optFns ...func(*Options)) (*GetBucketCorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBucketCors", params, optFns, addOperationGetBucketCorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBucketCorsMiddleware(stack *middleware.Stack, options Options) (err error) {
