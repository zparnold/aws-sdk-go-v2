...
func (c *Client) ModifyDBProxyTargetGroup(ctx context.Context, params *ModifyDBProxyTargetGroupInput, optFns ...func(*Options)) (*ModifyDBProxyTargetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBProxyTargetGroup", params, optFns, addOperationModifyDBProxyTargetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBProxyTargetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
