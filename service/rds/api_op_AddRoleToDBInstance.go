...
func (c *Client) AddRoleToDBInstance(ctx context.Context, params *AddRoleToDBInstanceInput, optFns ...func(*Options)) (*AddRoleToDBInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddRoleToDBInstance", params, optFns, addOperationAddRoleToDBInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddRoleToDBInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
