...
func (c *Client) DescribeDBSecurityGroups(ctx context.Context, params *DescribeDBSecurityGroupsInput, optFns ...func(*Options)) (*DescribeDBSecurityGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBSecurityGroups", params, optFns, addOperationDescribeDBSecurityGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBSecurityGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
