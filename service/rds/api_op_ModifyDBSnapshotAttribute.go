...
func (c *Client) ModifyDBSnapshotAttribute(ctx context.Context, params *ModifyDBSnapshotAttributeInput, optFns ...func(*Options)) (*ModifyDBSnapshotAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBSnapshotAttribute", params, optFns, addOperationModifyDBSnapshotAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBSnapshotAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
