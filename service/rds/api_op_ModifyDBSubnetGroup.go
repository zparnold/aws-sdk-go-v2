...
func (c *Client) ModifyDBSubnetGroup(ctx context.Context, params *ModifyDBSubnetGroupInput, optFns ...func(*Options)) (*ModifyDBSubnetGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBSubnetGroup", params, optFns, addOperationModifyDBSubnetGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBSubnetGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
