...
func (c *Client) PromoteReadReplicaDBCluster(ctx context.Context, params *PromoteReadReplicaDBClusterInput, optFns ...func(*Options)) (*PromoteReadReplicaDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PromoteReadReplicaDBCluster", params, optFns, addOperationPromoteReadReplicaDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPromoteReadReplicaDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
