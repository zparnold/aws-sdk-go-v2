...
func (c *Client) ApplyPendingMaintenanceAction(ctx context.Context, params *ApplyPendingMaintenanceActionInput, optFns ...func(*Options)) (*ApplyPendingMaintenanceActionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ApplyPendingMaintenanceAction", params, optFns, addOperationApplyPendingMaintenanceActionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationApplyPendingMaintenanceActionMiddleware(stack *middleware.Stack, options Options) (err error) {
