...
func (c *Client) ModifyGlobalCluster(ctx context.Context, params *ModifyGlobalClusterInput, optFns ...func(*Options)) (*ModifyGlobalClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyGlobalCluster", params, optFns, addOperationModifyGlobalClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyGlobalClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
