...
func (c *Client) CopyDBSnapshot(ctx context.Context, params *CopyDBSnapshotInput, optFns ...func(*Options)) (*CopyDBSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyDBSnapshot", params, optFns, addOperationCopyDBSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyDBSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
