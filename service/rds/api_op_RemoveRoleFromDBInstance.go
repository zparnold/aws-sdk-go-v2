...
func (c *Client) RemoveRoleFromDBInstance(ctx context.Context, params *RemoveRoleFromDBInstanceInput, optFns ...func(*Options)) (*RemoveRoleFromDBInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveRoleFromDBInstance", params, optFns, addOperationRemoveRoleFromDBInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveRoleFromDBInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
