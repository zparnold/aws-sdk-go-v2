...
func (c *Client) DescribeDBSnapshots(ctx context.Context, params *DescribeDBSnapshotsInput, optFns ...func(*Options)) (*DescribeDBSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBSnapshots", params, optFns, addOperationDescribeDBSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
