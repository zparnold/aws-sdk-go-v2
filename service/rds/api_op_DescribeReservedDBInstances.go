...
func (c *Client) DescribeReservedDBInstances(ctx context.Context, params *DescribeReservedDBInstancesInput, optFns ...func(*Options)) (*DescribeReservedDBInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedDBInstances", params, optFns, addOperationDescribeReservedDBInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedDBInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
