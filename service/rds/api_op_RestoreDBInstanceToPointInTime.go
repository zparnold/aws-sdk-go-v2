...
func (c *Client) RestoreDBInstanceToPointInTime(ctx context.Context, params *RestoreDBInstanceToPointInTimeInput, optFns ...func(*Options)) (*RestoreDBInstanceToPointInTimeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreDBInstanceToPointInTime", params, optFns, addOperationRestoreDBInstanceToPointInTimeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreDBInstanceToPointInTimeMiddleware(stack *middleware.Stack, options Options) (err error) {
