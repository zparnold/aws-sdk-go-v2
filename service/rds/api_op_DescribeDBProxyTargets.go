...
func (c *Client) DescribeDBProxyTargets(ctx context.Context, params *DescribeDBProxyTargetsInput, optFns ...func(*Options)) (*DescribeDBProxyTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBProxyTargets", params, optFns, addOperationDescribeDBProxyTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBProxyTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
