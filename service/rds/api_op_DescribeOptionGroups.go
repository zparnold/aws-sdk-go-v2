...
func (c *Client) DescribeOptionGroups(ctx context.Context, params *DescribeOptionGroupsInput, optFns ...func(*Options)) (*DescribeOptionGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOptionGroups", params, optFns, addOperationDescribeOptionGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOptionGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
