...
func (c *Client) DescribeDBProxyTargetGroups(ctx context.Context, params *DescribeDBProxyTargetGroupsInput, optFns ...func(*Options)) (*DescribeDBProxyTargetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBProxyTargetGroups", params, optFns, addOperationDescribeDBProxyTargetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBProxyTargetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
