...
func (c *Client) DeleteDBClusterEndpoint(ctx context.Context, params *DeleteDBClusterEndpointInput, optFns ...func(*Options)) (*DeleteDBClusterEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBClusterEndpoint", params, optFns, addOperationDeleteDBClusterEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBClusterEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
