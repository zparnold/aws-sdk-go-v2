...
func (c *Client) RevokeDBSecurityGroupIngress(ctx context.Context, params *RevokeDBSecurityGroupIngressInput, optFns ...func(*Options)) (*RevokeDBSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RevokeDBSecurityGroupIngress", params, optFns, addOperationRevokeDBSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRevokeDBSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
