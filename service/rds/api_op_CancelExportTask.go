...
func (c *Client) CancelExportTask(ctx context.Context, params *CancelExportTaskInput, optFns ...func(*Options)) (*CancelExportTaskOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CancelExportTask", params, optFns, addOperationCancelExportTaskMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCancelExportTaskMiddleware(stack *middleware.Stack, options Options) (err error) {
