...
func (c *Client) StartActivityStream(ctx context.Context, params *StartActivityStreamInput, optFns ...func(*Options)) (*StartActivityStreamOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartActivityStream", params, optFns, addOperationStartActivityStreamMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartActivityStreamMiddleware(stack *middleware.Stack, options Options) (err error) {
