...
func (c *Client) DeleteDBParameterGroup(ctx context.Context, params *DeleteDBParameterGroupInput, optFns ...func(*Options)) (*DeleteDBParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBParameterGroup", params, optFns, addOperationDeleteDBParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
