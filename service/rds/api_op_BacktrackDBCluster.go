...
func (c *Client) BacktrackDBCluster(ctx context.Context, params *BacktrackDBClusterInput, optFns ...func(*Options)) (*BacktrackDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BacktrackDBCluster", params, optFns, addOperationBacktrackDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBacktrackDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
