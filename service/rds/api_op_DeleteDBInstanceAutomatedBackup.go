...
func (c *Client) DeleteDBInstanceAutomatedBackup(ctx context.Context, params *DeleteDBInstanceAutomatedBackupInput, optFns ...func(*Options)) (*DeleteDBInstanceAutomatedBackupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBInstanceAutomatedBackup", params, optFns, addOperationDeleteDBInstanceAutomatedBackupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBInstanceAutomatedBackupMiddleware(stack *middleware.Stack, options Options) (err error) {
