...
func (c *Client) CreateDBClusterParameterGroup(ctx context.Context, params *CreateDBClusterParameterGroupInput, optFns ...func(*Options)) (*CreateDBClusterParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBClusterParameterGroup", params, optFns, addOperationCreateDBClusterParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBClusterParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
