...
func (c *Client) StopDBInstance(ctx context.Context, params *StopDBInstanceInput, optFns ...func(*Options)) (*StopDBInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopDBInstance", params, optFns, addOperationStopDBInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopDBInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
