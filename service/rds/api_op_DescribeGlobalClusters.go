...
func (c *Client) DescribeGlobalClusters(ctx context.Context, params *DescribeGlobalClustersInput, optFns ...func(*Options)) (*DescribeGlobalClustersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeGlobalClusters", params, optFns, addOperationDescribeGlobalClustersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeGlobalClustersMiddleware(stack *middleware.Stack, options Options) (err error) {
