...
func (c *Client) DescribeCustomAvailabilityZones(ctx context.Context, params *DescribeCustomAvailabilityZonesInput, optFns ...func(*Options)) (*DescribeCustomAvailabilityZonesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCustomAvailabilityZones", params, optFns, addOperationDescribeCustomAvailabilityZonesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCustomAvailabilityZonesMiddleware(stack *middleware.Stack, options Options) (err error) {
