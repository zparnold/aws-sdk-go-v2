...
func (c *Client) AuthorizeDBSecurityGroupIngress(ctx context.Context, params *AuthorizeDBSecurityGroupIngressInput, optFns ...func(*Options)) (*AuthorizeDBSecurityGroupIngressOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AuthorizeDBSecurityGroupIngress", params, optFns, addOperationAuthorizeDBSecurityGroupIngressMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAuthorizeDBSecurityGroupIngressMiddleware(stack *middleware.Stack, options Options) (err error) {
