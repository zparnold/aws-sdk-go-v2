...
func (c *Client) RegisterDBProxyTargets(ctx context.Context, params *RegisterDBProxyTargetsInput, optFns ...func(*Options)) (*RegisterDBProxyTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RegisterDBProxyTargets", params, optFns, addOperationRegisterDBProxyTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRegisterDBProxyTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
