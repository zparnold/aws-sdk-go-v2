...
func (c *Client) ModifyCertificates(ctx context.Context, params *ModifyCertificatesInput, optFns ...func(*Options)) (*ModifyCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyCertificates", params, optFns, addOperationModifyCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
