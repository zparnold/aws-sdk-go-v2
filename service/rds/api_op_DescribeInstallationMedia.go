...
func (c *Client) DescribeInstallationMedia(ctx context.Context, params *DescribeInstallationMediaInput, optFns ...func(*Options)) (*DescribeInstallationMediaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeInstallationMedia", params, optFns, addOperationDescribeInstallationMediaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeInstallationMediaMiddleware(stack *middleware.Stack, options Options) (err error) {
