...
func (c *Client) CreateDBSecurityGroup(ctx context.Context, params *CreateDBSecurityGroupInput, optFns ...func(*Options)) (*CreateDBSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBSecurityGroup", params, optFns, addOperationCreateDBSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
