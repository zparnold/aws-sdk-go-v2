...
func (c *Client) RestoreDBInstanceFromDBSnapshot(ctx context.Context, params *RestoreDBInstanceFromDBSnapshotInput, optFns ...func(*Options)) (*RestoreDBInstanceFromDBSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreDBInstanceFromDBSnapshot", params, optFns, addOperationRestoreDBInstanceFromDBSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreDBInstanceFromDBSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
