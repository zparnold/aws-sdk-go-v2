...
func (c *Client) DescribeOrderableDBInstanceOptions(ctx context.Context, params *DescribeOrderableDBInstanceOptionsInput, optFns ...func(*Options)) (*DescribeOrderableDBInstanceOptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrderableDBInstanceOptions", params, optFns, addOperationDescribeOrderableDBInstanceOptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrderableDBInstanceOptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
