...
func (c *Client) CreateGlobalCluster(ctx context.Context, params *CreateGlobalClusterInput, optFns ...func(*Options)) (*CreateGlobalClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGlobalCluster", params, optFns, addOperationCreateGlobalClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGlobalClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
