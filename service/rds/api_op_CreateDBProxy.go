...
func (c *Client) CreateDBProxy(ctx context.Context, params *CreateDBProxyInput, optFns ...func(*Options)) (*CreateDBProxyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBProxy", params, optFns, addOperationCreateDBProxyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBProxyMiddleware(stack *middleware.Stack, options Options) (err error) {
