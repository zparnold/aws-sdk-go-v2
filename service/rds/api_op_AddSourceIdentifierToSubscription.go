...
func (c *Client) AddSourceIdentifierToSubscription(ctx context.Context, params *AddSourceIdentifierToSubscriptionInput, optFns ...func(*Options)) (*AddSourceIdentifierToSubscriptionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddSourceIdentifierToSubscription", params, optFns, addOperationAddSourceIdentifierToSubscriptionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddSourceIdentifierToSubscriptionMiddleware(stack *middleware.Stack, options Options) (err error) {
