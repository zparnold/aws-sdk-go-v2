...
func (c *Client) DescribeDBClusterEndpoints(ctx context.Context, params *DescribeDBClusterEndpointsInput, optFns ...func(*Options)) (*DescribeDBClusterEndpointsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBClusterEndpoints", params, optFns, addOperationDescribeDBClusterEndpointsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBClusterEndpointsMiddleware(stack *middleware.Stack, options Options) (err error) {
