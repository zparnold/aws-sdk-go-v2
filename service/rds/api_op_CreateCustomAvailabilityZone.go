...
func (c *Client) CreateCustomAvailabilityZone(ctx context.Context, params *CreateCustomAvailabilityZoneInput, optFns ...func(*Options)) (*CreateCustomAvailabilityZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCustomAvailabilityZone", params, optFns, addOperationCreateCustomAvailabilityZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCustomAvailabilityZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
