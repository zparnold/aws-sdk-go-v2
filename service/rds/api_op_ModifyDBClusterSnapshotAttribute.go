...
func (c *Client) ModifyDBClusterSnapshotAttribute(ctx context.Context, params *ModifyDBClusterSnapshotAttributeInput, optFns ...func(*Options)) (*ModifyDBClusterSnapshotAttributeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBClusterSnapshotAttribute", params, optFns, addOperationModifyDBClusterSnapshotAttributeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBClusterSnapshotAttributeMiddleware(stack *middleware.Stack, options Options) (err error) {
