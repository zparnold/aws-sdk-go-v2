...
func (c *Client) CopyOptionGroup(ctx context.Context, params *CopyOptionGroupInput, optFns ...func(*Options)) (*CopyOptionGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyOptionGroup", params, optFns, addOperationCopyOptionGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyOptionGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
