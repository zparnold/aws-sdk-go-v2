...
func (c *Client) ModifyOptionGroup(ctx context.Context, params *ModifyOptionGroupInput, optFns ...func(*Options)) (*ModifyOptionGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyOptionGroup", params, optFns, addOperationModifyOptionGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyOptionGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
