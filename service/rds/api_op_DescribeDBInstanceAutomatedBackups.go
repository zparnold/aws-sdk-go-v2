...
func (c *Client) DescribeDBInstanceAutomatedBackups(ctx context.Context, params *DescribeDBInstanceAutomatedBackupsInput, optFns ...func(*Options)) (*DescribeDBInstanceAutomatedBackupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBInstanceAutomatedBackups", params, optFns, addOperationDescribeDBInstanceAutomatedBackupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBInstanceAutomatedBackupsMiddleware(stack *middleware.Stack, options Options) (err error) {
