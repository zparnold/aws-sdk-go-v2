...
func (c *Client) DescribeDBClusterBacktracks(ctx context.Context, params *DescribeDBClusterBacktracksInput, optFns ...func(*Options)) (*DescribeDBClusterBacktracksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBClusterBacktracks", params, optFns, addOperationDescribeDBClusterBacktracksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBClusterBacktracksMiddleware(stack *middleware.Stack, options Options) (err error) {
