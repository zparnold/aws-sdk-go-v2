...
func (c *Client) StartDBInstance(ctx context.Context, params *StartDBInstanceInput, optFns ...func(*Options)) (*StartDBInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDBInstance", params, optFns, addOperationStartDBInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDBInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
