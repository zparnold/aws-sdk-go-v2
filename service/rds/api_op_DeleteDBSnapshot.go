...
func (c *Client) DeleteDBSnapshot(ctx context.Context, params *DeleteDBSnapshotInput, optFns ...func(*Options)) (*DeleteDBSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBSnapshot", params, optFns, addOperationDeleteDBSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
