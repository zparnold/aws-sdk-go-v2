...
func (c *Client) ModifyDBClusterEndpoint(ctx context.Context, params *ModifyDBClusterEndpointInput, optFns ...func(*Options)) (*ModifyDBClusterEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBClusterEndpoint", params, optFns, addOperationModifyDBClusterEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBClusterEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
