...
func (c *Client) AddRoleToDBCluster(ctx context.Context, params *AddRoleToDBClusterInput, optFns ...func(*Options)) (*AddRoleToDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "AddRoleToDBCluster", params, optFns, addOperationAddRoleToDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationAddRoleToDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
