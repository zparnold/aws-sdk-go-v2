...
func (c *Client) PurchaseReservedDBInstancesOffering(ctx context.Context, params *PurchaseReservedDBInstancesOfferingInput, optFns ...func(*Options)) (*PurchaseReservedDBInstancesOfferingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PurchaseReservedDBInstancesOffering", params, optFns, addOperationPurchaseReservedDBInstancesOfferingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPurchaseReservedDBInstancesOfferingMiddleware(stack *middleware.Stack, options Options) (err error) {
