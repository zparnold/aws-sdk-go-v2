...
func (c *Client) DescribeReservedDBInstancesOfferings(ctx context.Context, params *DescribeReservedDBInstancesOfferingsInput, optFns ...func(*Options)) (*DescribeReservedDBInstancesOfferingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeReservedDBInstancesOfferings", params, optFns, addOperationDescribeReservedDBInstancesOfferingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeReservedDBInstancesOfferingsMiddleware(stack *middleware.Stack, options Options) (err error) {
