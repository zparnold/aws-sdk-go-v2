...
func (c *Client) DeleteDBClusterSnapshot(ctx context.Context, params *DeleteDBClusterSnapshotInput, optFns ...func(*Options)) (*DeleteDBClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBClusterSnapshot", params, optFns, addOperationDeleteDBClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
