...
func (c *Client) DeregisterDBProxyTargets(ctx context.Context, params *DeregisterDBProxyTargetsInput, optFns ...func(*Options)) (*DeregisterDBProxyTargetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeregisterDBProxyTargets", params, optFns, addOperationDeregisterDBProxyTargetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeregisterDBProxyTargetsMiddleware(stack *middleware.Stack, options Options) (err error) {
