...
func (c *Client) CreateOptionGroup(ctx context.Context, params *CreateOptionGroupInput, optFns ...func(*Options)) (*CreateOptionGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateOptionGroup", params, optFns, addOperationCreateOptionGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateOptionGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
