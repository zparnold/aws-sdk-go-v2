...
func (c *Client) RestoreDBClusterFromS3(ctx context.Context, params *RestoreDBClusterFromS3Input, optFns ...func(*Options)) (*RestoreDBClusterFromS3Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreDBClusterFromS3", params, optFns, addOperationRestoreDBClusterFromS3Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreDBClusterFromS3Middleware(stack *middleware.Stack, options Options) (err error) {
