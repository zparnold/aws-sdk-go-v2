...
func (c *Client) DeleteCustomAvailabilityZone(ctx context.Context, params *DeleteCustomAvailabilityZoneInput, optFns ...func(*Options)) (*DeleteCustomAvailabilityZoneOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCustomAvailabilityZone", params, optFns, addOperationDeleteCustomAvailabilityZoneMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCustomAvailabilityZoneMiddleware(stack *middleware.Stack, options Options) (err error) {
