...
func (c *Client) FailoverDBCluster(ctx context.Context, params *FailoverDBClusterInput, optFns ...func(*Options)) (*FailoverDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FailoverDBCluster", params, optFns, addOperationFailoverDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFailoverDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
