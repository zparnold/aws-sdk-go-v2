...
func (c *Client) ImportInstallationMedia(ctx context.Context, params *ImportInstallationMediaInput, optFns ...func(*Options)) (*ImportInstallationMediaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportInstallationMedia", params, optFns, addOperationImportInstallationMediaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportInstallationMediaMiddleware(stack *middleware.Stack, options Options) (err error) {
