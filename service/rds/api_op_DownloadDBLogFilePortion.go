...
func (c *Client) DownloadDBLogFilePortion(ctx context.Context, params *DownloadDBLogFilePortionInput, optFns ...func(*Options)) (*DownloadDBLogFilePortionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DownloadDBLogFilePortion", params, optFns, addOperationDownloadDBLogFilePortionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDownloadDBLogFilePortionMiddleware(stack *middleware.Stack, options Options) (err error) {
