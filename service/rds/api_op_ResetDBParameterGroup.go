...
func (c *Client) ResetDBParameterGroup(ctx context.Context, params *ResetDBParameterGroupInput, optFns ...func(*Options)) (*ResetDBParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ResetDBParameterGroup", params, optFns, addOperationResetDBParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationResetDBParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
