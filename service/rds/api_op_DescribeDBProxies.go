...
func (c *Client) DescribeDBProxies(ctx context.Context, params *DescribeDBProxiesInput, optFns ...func(*Options)) (*DescribeDBProxiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBProxies", params, optFns, addOperationDescribeDBProxiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBProxiesMiddleware(stack *middleware.Stack, options Options) (err error) {
