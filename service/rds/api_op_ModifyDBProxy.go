...
func (c *Client) ModifyDBProxy(ctx context.Context, params *ModifyDBProxyInput, optFns ...func(*Options)) (*ModifyDBProxyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBProxy", params, optFns, addOperationModifyDBProxyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBProxyMiddleware(stack *middleware.Stack, options Options) (err error) {
