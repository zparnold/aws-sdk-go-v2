...
func (c *Client) DeleteOptionGroup(ctx context.Context, params *DeleteOptionGroupInput, optFns ...func(*Options)) (*DeleteOptionGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOptionGroup", params, optFns, addOperationDeleteOptionGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOptionGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
