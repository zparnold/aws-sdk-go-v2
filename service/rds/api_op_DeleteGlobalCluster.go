...
func (c *Client) DeleteGlobalCluster(ctx context.Context, params *DeleteGlobalClusterInput, optFns ...func(*Options)) (*DeleteGlobalClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteGlobalCluster", params, optFns, addOperationDeleteGlobalClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteGlobalClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
