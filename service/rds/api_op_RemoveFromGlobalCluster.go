...
func (c *Client) RemoveFromGlobalCluster(ctx context.Context, params *RemoveFromGlobalClusterInput, optFns ...func(*Options)) (*RemoveFromGlobalClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveFromGlobalCluster", params, optFns, addOperationRemoveFromGlobalClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveFromGlobalClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
