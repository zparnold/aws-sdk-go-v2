...
func (c *Client) CreateDBInstanceReadReplica(ctx context.Context, params *CreateDBInstanceReadReplicaInput, optFns ...func(*Options)) (*CreateDBInstanceReadReplicaOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBInstanceReadReplica", params, optFns, addOperationCreateDBInstanceReadReplicaMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBInstanceReadReplicaMiddleware(stack *middleware.Stack, options Options) (err error) {
