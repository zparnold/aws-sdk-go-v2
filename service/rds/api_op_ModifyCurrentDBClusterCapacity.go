...
func (c *Client) ModifyCurrentDBClusterCapacity(ctx context.Context, params *ModifyCurrentDBClusterCapacityInput, optFns ...func(*Options)) (*ModifyCurrentDBClusterCapacityOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyCurrentDBClusterCapacity", params, optFns, addOperationModifyCurrentDBClusterCapacityMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyCurrentDBClusterCapacityMiddleware(stack *middleware.Stack, options Options) (err error) {
