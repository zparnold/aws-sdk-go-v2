...
func (c *Client) RestoreDBInstanceFromS3(ctx context.Context, params *RestoreDBInstanceFromS3Input, optFns ...func(*Options)) (*RestoreDBInstanceFromS3Output, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreDBInstanceFromS3", params, optFns, addOperationRestoreDBInstanceFromS3Middleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreDBInstanceFromS3Middleware(stack *middleware.Stack, options Options) (err error) {
