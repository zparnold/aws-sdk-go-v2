...
func (c *Client) ModifyDBSnapshot(ctx context.Context, params *ModifyDBSnapshotInput, optFns ...func(*Options)) (*ModifyDBSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBSnapshot", params, optFns, addOperationModifyDBSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
