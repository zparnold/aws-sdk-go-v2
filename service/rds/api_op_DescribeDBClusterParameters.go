...
func (c *Client) DescribeDBClusterParameters(ctx context.Context, params *DescribeDBClusterParametersInput, optFns ...func(*Options)) (*DescribeDBClusterParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBClusterParameters", params, optFns, addOperationDescribeDBClusterParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBClusterParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
