...
func (c *Client) DeleteDBSecurityGroup(ctx context.Context, params *DeleteDBSecurityGroupInput, optFns ...func(*Options)) (*DeleteDBSecurityGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBSecurityGroup", params, optFns, addOperationDeleteDBSecurityGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBSecurityGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
