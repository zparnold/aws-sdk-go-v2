...
func (c *Client) CreateDBInstance(ctx context.Context, params *CreateDBInstanceInput, optFns ...func(*Options)) (*CreateDBInstanceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBInstance", params, optFns, addOperationCreateDBInstanceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBInstanceMiddleware(stack *middleware.Stack, options Options) (err error) {
