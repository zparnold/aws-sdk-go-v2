...
func (c *Client) CreateDBClusterEndpoint(ctx context.Context, params *CreateDBClusterEndpointInput, optFns ...func(*Options)) (*CreateDBClusterEndpointOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBClusterEndpoint", params, optFns, addOperationCreateDBClusterEndpointMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBClusterEndpointMiddleware(stack *middleware.Stack, options Options) (err error) {
