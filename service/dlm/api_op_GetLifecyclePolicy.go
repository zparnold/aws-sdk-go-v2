...
func (c *Client) GetLifecyclePolicy(ctx context.Context, params *GetLifecyclePolicyInput, optFns ...func(*Options)) (*GetLifecyclePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLifecyclePolicy", params, optFns, addOperationGetLifecyclePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLifecyclePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
