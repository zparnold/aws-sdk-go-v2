...
func (c *Client) UpdateLifecyclePolicy(ctx context.Context, params *UpdateLifecyclePolicyInput, optFns ...func(*Options)) (*UpdateLifecyclePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateLifecyclePolicy", params, optFns, addOperationUpdateLifecyclePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateLifecyclePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
