...
func (c *Client) CreateLifecyclePolicy(ctx context.Context, params *CreateLifecyclePolicyInput, optFns ...func(*Options)) (*CreateLifecyclePolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateLifecyclePolicy", params, optFns, addOperationCreateLifecyclePolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateLifecyclePolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
