...
func (c *Client) GetLifecyclePolicies(ctx context.Context, params *GetLifecyclePoliciesInput, optFns ...func(*Options)) (*GetLifecyclePoliciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetLifecyclePolicies", params, optFns, addOperationGetLifecyclePoliciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetLifecyclePoliciesMiddleware(stack *middleware.Stack, options Options) (err error) {
