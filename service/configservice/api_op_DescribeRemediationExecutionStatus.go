...
func (c *Client) DescribeRemediationExecutionStatus(ctx context.Context, params *DescribeRemediationExecutionStatusInput, optFns ...func(*Options)) (*DescribeRemediationExecutionStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRemediationExecutionStatus", params, optFns, addOperationDescribeRemediationExecutionStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRemediationExecutionStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
