...
func (c *Client) DescribeConfigRuleEvaluationStatus(ctx context.Context, params *DescribeConfigRuleEvaluationStatusInput, optFns ...func(*Options)) (*DescribeConfigRuleEvaluationStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigRuleEvaluationStatus", params, optFns, addOperationDescribeConfigRuleEvaluationStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigRuleEvaluationStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
