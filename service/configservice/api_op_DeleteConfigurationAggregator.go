...
func (c *Client) DeleteConfigurationAggregator(ctx context.Context, params *DeleteConfigurationAggregatorInput, optFns ...func(*Options)) (*DeleteConfigurationAggregatorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConfigurationAggregator", params, optFns, addOperationDeleteConfigurationAggregatorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConfigurationAggregatorMiddleware(stack *middleware.Stack, options Options) (err error) {
