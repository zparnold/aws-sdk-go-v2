...
func (c *Client) DeleteDeliveryChannel(ctx context.Context, params *DeleteDeliveryChannelInput, optFns ...func(*Options)) (*DeleteDeliveryChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeliveryChannel", params, optFns, addOperationDeleteDeliveryChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeliveryChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
