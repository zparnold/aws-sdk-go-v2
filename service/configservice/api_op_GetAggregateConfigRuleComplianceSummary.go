...
func (c *Client) GetAggregateConfigRuleComplianceSummary(ctx context.Context, params *GetAggregateConfigRuleComplianceSummaryInput, optFns ...func(*Options)) (*GetAggregateConfigRuleComplianceSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAggregateConfigRuleComplianceSummary", params, optFns, addOperationGetAggregateConfigRuleComplianceSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAggregateConfigRuleComplianceSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
