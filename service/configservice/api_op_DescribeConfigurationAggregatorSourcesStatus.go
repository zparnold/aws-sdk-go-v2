...
func (c *Client) DescribeConfigurationAggregatorSourcesStatus(ctx context.Context, params *DescribeConfigurationAggregatorSourcesStatusInput, optFns ...func(*Options)) (*DescribeConfigurationAggregatorSourcesStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationAggregatorSourcesStatus", params, optFns, addOperationDescribeConfigurationAggregatorSourcesStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationAggregatorSourcesStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
