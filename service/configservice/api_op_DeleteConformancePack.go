...
func (c *Client) DeleteConformancePack(ctx context.Context, params *DeleteConformancePackInput, optFns ...func(*Options)) (*DeleteConformancePackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConformancePack", params, optFns, addOperationDeleteConformancePackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConformancePackMiddleware(stack *middleware.Stack, options Options) (err error) {
