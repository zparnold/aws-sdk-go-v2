...
func (c *Client) DescribeComplianceByConfigRule(ctx context.Context, params *DescribeComplianceByConfigRuleInput, optFns ...func(*Options)) (*DescribeComplianceByConfigRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeComplianceByConfigRule", params, optFns, addOperationDescribeComplianceByConfigRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeComplianceByConfigRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
