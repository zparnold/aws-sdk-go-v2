...
func (c *Client) GetOrganizationConformancePackDetailedStatus(ctx context.Context, params *GetOrganizationConformancePackDetailedStatusInput, optFns ...func(*Options)) (*GetOrganizationConformancePackDetailedStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOrganizationConformancePackDetailedStatus", params, optFns, addOperationGetOrganizationConformancePackDetailedStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOrganizationConformancePackDetailedStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
