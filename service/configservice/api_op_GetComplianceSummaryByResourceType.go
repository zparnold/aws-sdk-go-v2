...
func (c *Client) GetComplianceSummaryByResourceType(ctx context.Context, params *GetComplianceSummaryByResourceTypeInput, optFns ...func(*Options)) (*GetComplianceSummaryByResourceTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComplianceSummaryByResourceType", params, optFns, addOperationGetComplianceSummaryByResourceTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComplianceSummaryByResourceTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
