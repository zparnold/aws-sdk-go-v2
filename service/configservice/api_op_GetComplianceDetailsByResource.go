...
func (c *Client) GetComplianceDetailsByResource(ctx context.Context, params *GetComplianceDetailsByResourceInput, optFns ...func(*Options)) (*GetComplianceDetailsByResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComplianceDetailsByResource", params, optFns, addOperationGetComplianceDetailsByResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComplianceDetailsByResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
