...
func (c *Client) DeleteAggregationAuthorization(ctx context.Context, params *DeleteAggregationAuthorizationInput, optFns ...func(*Options)) (*DeleteAggregationAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteAggregationAuthorization", params, optFns, addOperationDeleteAggregationAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteAggregationAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
