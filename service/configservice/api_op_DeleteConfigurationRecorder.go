...
func (c *Client) DeleteConfigurationRecorder(ctx context.Context, params *DeleteConfigurationRecorderInput, optFns ...func(*Options)) (*DeleteConfigurationRecorderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteConfigurationRecorder", params, optFns, addOperationDeleteConfigurationRecorderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteConfigurationRecorderMiddleware(stack *middleware.Stack, options Options) (err error) {
