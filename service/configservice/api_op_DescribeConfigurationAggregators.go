...
func (c *Client) DescribeConfigurationAggregators(ctx context.Context, params *DescribeConfigurationAggregatorsInput, optFns ...func(*Options)) (*DescribeConfigurationAggregatorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationAggregators", params, optFns, addOperationDescribeConfigurationAggregatorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationAggregatorsMiddleware(stack *middleware.Stack, options Options) (err error) {
