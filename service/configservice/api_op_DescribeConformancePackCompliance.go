...
func (c *Client) DescribeConformancePackCompliance(ctx context.Context, params *DescribeConformancePackComplianceInput, optFns ...func(*Options)) (*DescribeConformancePackComplianceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConformancePackCompliance", params, optFns, addOperationDescribeConformancePackComplianceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConformancePackComplianceMiddleware(stack *middleware.Stack, options Options) (err error) {
