...
func (c *Client) DescribeOrganizationConfigRules(ctx context.Context, params *DescribeOrganizationConfigRulesInput, optFns ...func(*Options)) (*DescribeOrganizationConfigRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrganizationConfigRules", params, optFns, addOperationDescribeOrganizationConfigRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrganizationConfigRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
