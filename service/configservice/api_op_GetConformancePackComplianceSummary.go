...
func (c *Client) GetConformancePackComplianceSummary(ctx context.Context, params *GetConformancePackComplianceSummaryInput, optFns ...func(*Options)) (*GetConformancePackComplianceSummaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConformancePackComplianceSummary", params, optFns, addOperationGetConformancePackComplianceSummaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConformancePackComplianceSummaryMiddleware(stack *middleware.Stack, options Options) (err error) {
