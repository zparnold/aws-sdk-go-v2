...
func (c *Client) StartConfigurationRecorder(ctx context.Context, params *StartConfigurationRecorderInput, optFns ...func(*Options)) (*StartConfigurationRecorderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartConfigurationRecorder", params, optFns, addOperationStartConfigurationRecorderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartConfigurationRecorderMiddleware(stack *middleware.Stack, options Options) (err error) {
