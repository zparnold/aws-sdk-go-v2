...
func (c *Client) DescribeRemediationConfigurations(ctx context.Context, params *DescribeRemediationConfigurationsInput, optFns ...func(*Options)) (*DescribeRemediationConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRemediationConfigurations", params, optFns, addOperationDescribeRemediationConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRemediationConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
