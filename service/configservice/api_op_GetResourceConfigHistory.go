...
func (c *Client) GetResourceConfigHistory(ctx context.Context, params *GetResourceConfigHistoryInput, optFns ...func(*Options)) (*GetResourceConfigHistoryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResourceConfigHistory", params, optFns, addOperationGetResourceConfigHistoryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourceConfigHistoryMiddleware(stack *middleware.Stack, options Options) (err error) {
