...
func (c *Client) DescribeOrganizationConformancePacks(ctx context.Context, params *DescribeOrganizationConformancePacksInput, optFns ...func(*Options)) (*DescribeOrganizationConformancePacksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrganizationConformancePacks", params, optFns, addOperationDescribeOrganizationConformancePacksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrganizationConformancePacksMiddleware(stack *middleware.Stack, options Options) (err error) {
