...
func (c *Client) GetConformancePackComplianceDetails(ctx context.Context, params *GetConformancePackComplianceDetailsInput, optFns ...func(*Options)) (*GetConformancePackComplianceDetailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetConformancePackComplianceDetails", params, optFns, addOperationGetConformancePackComplianceDetailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetConformancePackComplianceDetailsMiddleware(stack *middleware.Stack, options Options) (err error) {
