...
func (c *Client) PutAggregationAuthorization(ctx context.Context, params *PutAggregationAuthorizationInput, optFns ...func(*Options)) (*PutAggregationAuthorizationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutAggregationAuthorization", params, optFns, addOperationPutAggregationAuthorizationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutAggregationAuthorizationMiddleware(stack *middleware.Stack, options Options) (err error) {
