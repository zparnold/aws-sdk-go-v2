...
func (c *Client) GetAggregateResourceConfig(ctx context.Context, params *GetAggregateResourceConfigInput, optFns ...func(*Options)) (*GetAggregateResourceConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAggregateResourceConfig", params, optFns, addOperationGetAggregateResourceConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAggregateResourceConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
