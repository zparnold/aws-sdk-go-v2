...
func (c *Client) StartConfigRulesEvaluation(ctx context.Context, params *StartConfigRulesEvaluationInput, optFns ...func(*Options)) (*StartConfigRulesEvaluationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartConfigRulesEvaluation", params, optFns, addOperationStartConfigRulesEvaluationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartConfigRulesEvaluationMiddleware(stack *middleware.Stack, options Options) (err error) {
