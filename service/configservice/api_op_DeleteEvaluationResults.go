...
func (c *Client) DeleteEvaluationResults(ctx context.Context, params *DeleteEvaluationResultsInput, optFns ...func(*Options)) (*DeleteEvaluationResultsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEvaluationResults", params, optFns, addOperationDeleteEvaluationResultsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEvaluationResultsMiddleware(stack *middleware.Stack, options Options) (err error) {
