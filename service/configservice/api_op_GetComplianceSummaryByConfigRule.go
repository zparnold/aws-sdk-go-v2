...
func (c *Client) GetComplianceSummaryByConfigRule(ctx context.Context, params *GetComplianceSummaryByConfigRuleInput, optFns ...func(*Options)) (*GetComplianceSummaryByConfigRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComplianceSummaryByConfigRule", params, optFns, addOperationGetComplianceSummaryByConfigRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComplianceSummaryByConfigRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
