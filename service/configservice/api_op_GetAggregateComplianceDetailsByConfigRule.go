...
func (c *Client) GetAggregateComplianceDetailsByConfigRule(ctx context.Context, params *GetAggregateComplianceDetailsByConfigRuleInput, optFns ...func(*Options)) (*GetAggregateComplianceDetailsByConfigRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAggregateComplianceDetailsByConfigRule", params, optFns, addOperationGetAggregateComplianceDetailsByConfigRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAggregateComplianceDetailsByConfigRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
