...
func (c *Client) PutOrganizationConfigRule(ctx context.Context, params *PutOrganizationConfigRuleInput, optFns ...func(*Options)) (*PutOrganizationConfigRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutOrganizationConfigRule", params, optFns, addOperationPutOrganizationConfigRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutOrganizationConfigRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
