...
func (c *Client) DescribeOrganizationConformancePackStatuses(ctx context.Context, params *DescribeOrganizationConformancePackStatusesInput, optFns ...func(*Options)) (*DescribeOrganizationConformancePackStatusesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrganizationConformancePackStatuses", params, optFns, addOperationDescribeOrganizationConformancePackStatusesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrganizationConformancePackStatusesMiddleware(stack *middleware.Stack, options Options) (err error) {
