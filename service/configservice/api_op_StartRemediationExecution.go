...
func (c *Client) StartRemediationExecution(ctx context.Context, params *StartRemediationExecutionInput, optFns ...func(*Options)) (*StartRemediationExecutionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartRemediationExecution", params, optFns, addOperationStartRemediationExecutionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartRemediationExecutionMiddleware(stack *middleware.Stack, options Options) (err error) {
