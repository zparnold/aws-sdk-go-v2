...
func (c *Client) DescribeAggregationAuthorizations(ctx context.Context, params *DescribeAggregationAuthorizationsInput, optFns ...func(*Options)) (*DescribeAggregationAuthorizationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAggregationAuthorizations", params, optFns, addOperationDescribeAggregationAuthorizationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAggregationAuthorizationsMiddleware(stack *middleware.Stack, options Options) (err error) {
