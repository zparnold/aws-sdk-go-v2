...
func (c *Client) DeleteOrganizationConfigRule(ctx context.Context, params *DeleteOrganizationConfigRuleInput, optFns ...func(*Options)) (*DeleteOrganizationConfigRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteOrganizationConfigRule", params, optFns, addOperationDeleteOrganizationConfigRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteOrganizationConfigRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
