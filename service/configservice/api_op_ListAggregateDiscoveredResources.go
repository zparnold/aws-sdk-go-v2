...
func (c *Client) ListAggregateDiscoveredResources(ctx context.Context, params *ListAggregateDiscoveredResourcesInput, optFns ...func(*Options)) (*ListAggregateDiscoveredResourcesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAggregateDiscoveredResources", params, optFns, addOperationListAggregateDiscoveredResourcesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListAggregateDiscoveredResourcesMiddleware(stack *middleware.Stack, options Options) (err error) {
