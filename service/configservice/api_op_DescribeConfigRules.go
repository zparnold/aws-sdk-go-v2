...
func (c *Client) DescribeConfigRules(ctx context.Context, params *DescribeConfigRulesInput, optFns ...func(*Options)) (*DescribeConfigRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigRules", params, optFns, addOperationDescribeConfigRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
