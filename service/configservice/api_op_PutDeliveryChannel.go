...
func (c *Client) PutDeliveryChannel(ctx context.Context, params *PutDeliveryChannelInput, optFns ...func(*Options)) (*PutDeliveryChannelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutDeliveryChannel", params, optFns, addOperationPutDeliveryChannelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutDeliveryChannelMiddleware(stack *middleware.Stack, options Options) (err error) {
