...
func (c *Client) DescribeAggregateComplianceByConfigRules(ctx context.Context, params *DescribeAggregateComplianceByConfigRulesInput, optFns ...func(*Options)) (*DescribeAggregateComplianceByConfigRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeAggregateComplianceByConfigRules", params, optFns, addOperationDescribeAggregateComplianceByConfigRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeAggregateComplianceByConfigRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
