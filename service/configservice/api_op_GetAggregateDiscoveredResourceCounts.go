...
func (c *Client) GetAggregateDiscoveredResourceCounts(ctx context.Context, params *GetAggregateDiscoveredResourceCountsInput, optFns ...func(*Options)) (*GetAggregateDiscoveredResourceCountsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAggregateDiscoveredResourceCounts", params, optFns, addOperationGetAggregateDiscoveredResourceCountsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAggregateDiscoveredResourceCountsMiddleware(stack *middleware.Stack, options Options) (err error) {
