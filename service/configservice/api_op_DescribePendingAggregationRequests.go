...
func (c *Client) DescribePendingAggregationRequests(ctx context.Context, params *DescribePendingAggregationRequestsInput, optFns ...func(*Options)) (*DescribePendingAggregationRequestsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribePendingAggregationRequests", params, optFns, addOperationDescribePendingAggregationRequestsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribePendingAggregationRequestsMiddleware(stack *middleware.Stack, options Options) (err error) {
