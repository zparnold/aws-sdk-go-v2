...
func (c *Client) PutConfigRule(ctx context.Context, params *PutConfigRuleInput, optFns ...func(*Options)) (*PutConfigRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConfigRule", params, optFns, addOperationPutConfigRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConfigRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
