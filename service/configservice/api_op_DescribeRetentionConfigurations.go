...
func (c *Client) DescribeRetentionConfigurations(ctx context.Context, params *DescribeRetentionConfigurationsInput, optFns ...func(*Options)) (*DescribeRetentionConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRetentionConfigurations", params, optFns, addOperationDescribeRetentionConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRetentionConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
