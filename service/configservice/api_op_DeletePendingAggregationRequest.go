...
func (c *Client) DeletePendingAggregationRequest(ctx context.Context, params *DeletePendingAggregationRequestInput, optFns ...func(*Options)) (*DeletePendingAggregationRequestOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeletePendingAggregationRequest", params, optFns, addOperationDeletePendingAggregationRequestMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeletePendingAggregationRequestMiddleware(stack *middleware.Stack, options Options) (err error) {
