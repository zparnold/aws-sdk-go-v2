...
func (c *Client) GetOrganizationConfigRuleDetailedStatus(ctx context.Context, params *GetOrganizationConfigRuleDetailedStatusInput, optFns ...func(*Options)) (*GetOrganizationConfigRuleDetailedStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetOrganizationConfigRuleDetailedStatus", params, optFns, addOperationGetOrganizationConfigRuleDetailedStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetOrganizationConfigRuleDetailedStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
