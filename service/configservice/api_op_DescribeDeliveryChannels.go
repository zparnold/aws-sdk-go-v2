...
func (c *Client) DescribeDeliveryChannels(ctx context.Context, params *DescribeDeliveryChannelsInput, optFns ...func(*Options)) (*DescribeDeliveryChannelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDeliveryChannels", params, optFns, addOperationDescribeDeliveryChannelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDeliveryChannelsMiddleware(stack *middleware.Stack, options Options) (err error) {
