...
func (c *Client) DescribeComplianceByResource(ctx context.Context, params *DescribeComplianceByResourceInput, optFns ...func(*Options)) (*DescribeComplianceByResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeComplianceByResource", params, optFns, addOperationDescribeComplianceByResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeComplianceByResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
