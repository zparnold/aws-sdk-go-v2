...
func (c *Client) DescribeOrganizationConfigRuleStatuses(ctx context.Context, params *DescribeOrganizationConfigRuleStatusesInput, optFns ...func(*Options)) (*DescribeOrganizationConfigRuleStatusesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeOrganizationConfigRuleStatuses", params, optFns, addOperationDescribeOrganizationConfigRuleStatusesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeOrganizationConfigRuleStatusesMiddleware(stack *middleware.Stack, options Options) (err error) {
