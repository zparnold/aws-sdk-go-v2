...
func (c *Client) PutEvaluations(ctx context.Context, params *PutEvaluationsInput, optFns ...func(*Options)) (*PutEvaluationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEvaluations", params, optFns, addOperationPutEvaluationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEvaluationsMiddleware(stack *middleware.Stack, options Options) (err error) {
