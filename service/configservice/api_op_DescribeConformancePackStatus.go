...
func (c *Client) DescribeConformancePackStatus(ctx context.Context, params *DescribeConformancePackStatusInput, optFns ...func(*Options)) (*DescribeConformancePackStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConformancePackStatus", params, optFns, addOperationDescribeConformancePackStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConformancePackStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
