...
func (c *Client) DeleteResourceConfig(ctx context.Context, params *DeleteResourceConfigInput, optFns ...func(*Options)) (*DeleteResourceConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResourceConfig", params, optFns, addOperationDeleteResourceConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResourceConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
