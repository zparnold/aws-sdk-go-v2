...
func (c *Client) DescribeConformancePacks(ctx context.Context, params *DescribeConformancePacksInput, optFns ...func(*Options)) (*DescribeConformancePacksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConformancePacks", params, optFns, addOperationDescribeConformancePacksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConformancePacksMiddleware(stack *middleware.Stack, options Options) (err error) {
