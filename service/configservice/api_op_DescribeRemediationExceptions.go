...
func (c *Client) DescribeRemediationExceptions(ctx context.Context, params *DescribeRemediationExceptionsInput, optFns ...func(*Options)) (*DescribeRemediationExceptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRemediationExceptions", params, optFns, addOperationDescribeRemediationExceptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRemediationExceptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
