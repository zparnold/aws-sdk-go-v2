...
func (c *Client) SelectAggregateResourceConfig(ctx context.Context, params *SelectAggregateResourceConfigInput, optFns ...func(*Options)) (*SelectAggregateResourceConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "SelectAggregateResourceConfig", params, optFns, addOperationSelectAggregateResourceConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationSelectAggregateResourceConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
