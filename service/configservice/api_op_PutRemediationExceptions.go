...
func (c *Client) PutRemediationExceptions(ctx context.Context, params *PutRemediationExceptionsInput, optFns ...func(*Options)) (*PutRemediationExceptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRemediationExceptions", params, optFns, addOperationPutRemediationExceptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRemediationExceptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
