...
func (c *Client) DescribeConfigurationRecorderStatus(ctx context.Context, params *DescribeConfigurationRecorderStatusInput, optFns ...func(*Options)) (*DescribeConfigurationRecorderStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationRecorderStatus", params, optFns, addOperationDescribeConfigurationRecorderStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationRecorderStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
