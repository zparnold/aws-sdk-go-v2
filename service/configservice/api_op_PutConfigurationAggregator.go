...
func (c *Client) PutConfigurationAggregator(ctx context.Context, params *PutConfigurationAggregatorInput, optFns ...func(*Options)) (*PutConfigurationAggregatorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConfigurationAggregator", params, optFns, addOperationPutConfigurationAggregatorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConfigurationAggregatorMiddleware(stack *middleware.Stack, options Options) (err error) {
