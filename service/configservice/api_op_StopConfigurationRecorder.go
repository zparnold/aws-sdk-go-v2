...
func (c *Client) StopConfigurationRecorder(ctx context.Context, params *StopConfigurationRecorderInput, optFns ...func(*Options)) (*StopConfigurationRecorderOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopConfigurationRecorder", params, optFns, addOperationStopConfigurationRecorderMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopConfigurationRecorderMiddleware(stack *middleware.Stack, options Options) (err error) {
