...
func (c *Client) PutRemediationConfigurations(ctx context.Context, params *PutRemediationConfigurationsInput, optFns ...func(*Options)) (*PutRemediationConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRemediationConfigurations", params, optFns, addOperationPutRemediationConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRemediationConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
