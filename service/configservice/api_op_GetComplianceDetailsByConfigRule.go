...
func (c *Client) GetComplianceDetailsByConfigRule(ctx context.Context, params *GetComplianceDetailsByConfigRuleInput, optFns ...func(*Options)) (*GetComplianceDetailsByConfigRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetComplianceDetailsByConfigRule", params, optFns, addOperationGetComplianceDetailsByConfigRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetComplianceDetailsByConfigRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
