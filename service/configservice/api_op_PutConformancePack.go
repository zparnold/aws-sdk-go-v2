...
func (c *Client) PutConformancePack(ctx context.Context, params *PutConformancePackInput, optFns ...func(*Options)) (*PutConformancePackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutConformancePack", params, optFns, addOperationPutConformancePackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutConformancePackMiddleware(stack *middleware.Stack, options Options) (err error) {
