...
func (c *Client) PutOrganizationConformancePack(ctx context.Context, params *PutOrganizationConformancePackInput, optFns ...func(*Options)) (*PutOrganizationConformancePackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutOrganizationConformancePack", params, optFns, addOperationPutOrganizationConformancePackMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutOrganizationConformancePackMiddleware(stack *middleware.Stack, options Options) (err error) {
