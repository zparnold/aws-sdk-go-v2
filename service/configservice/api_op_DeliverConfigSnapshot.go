...
func (c *Client) DeliverConfigSnapshot(ctx context.Context, params *DeliverConfigSnapshotInput, optFns ...func(*Options)) (*DeliverConfigSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeliverConfigSnapshot", params, optFns, addOperationDeliverConfigSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeliverConfigSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
