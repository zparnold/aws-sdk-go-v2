...
func (c *Client) DescribeDeliveryChannelStatus(ctx context.Context, params *DescribeDeliveryChannelStatusInput, optFns ...func(*Options)) (*DescribeDeliveryChannelStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDeliveryChannelStatus", params, optFns, addOperationDescribeDeliveryChannelStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDeliveryChannelStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
