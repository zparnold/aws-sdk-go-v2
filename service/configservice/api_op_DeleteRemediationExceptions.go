...
func (c *Client) DeleteRemediationExceptions(ctx context.Context, params *DeleteRemediationExceptionsInput, optFns ...func(*Options)) (*DeleteRemediationExceptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRemediationExceptions", params, optFns, addOperationDeleteRemediationExceptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRemediationExceptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
