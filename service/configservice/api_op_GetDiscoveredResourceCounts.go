...
func (c *Client) GetDiscoveredResourceCounts(ctx context.Context, params *GetDiscoveredResourceCountsInput, optFns ...func(*Options)) (*GetDiscoveredResourceCountsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDiscoveredResourceCounts", params, optFns, addOperationGetDiscoveredResourceCountsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDiscoveredResourceCountsMiddleware(stack *middleware.Stack, options Options) (err error) {
