...
func (c *Client) DescribeConfigurationRecorders(ctx context.Context, params *DescribeConfigurationRecordersInput, optFns ...func(*Options)) (*DescribeConfigurationRecordersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeConfigurationRecorders", params, optFns, addOperationDescribeConfigurationRecordersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeConfigurationRecordersMiddleware(stack *middleware.Stack, options Options) (err error) {
