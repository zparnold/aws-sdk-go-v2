...
func (c *Client) DeleteRemediationConfiguration(ctx context.Context, params *DeleteRemediationConfigurationInput, optFns ...func(*Options)) (*DeleteRemediationConfigurationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRemediationConfiguration", params, optFns, addOperationDeleteRemediationConfigurationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRemediationConfigurationMiddleware(stack *middleware.Stack, options Options) (err error) {
