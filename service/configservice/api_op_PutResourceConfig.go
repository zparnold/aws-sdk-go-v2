...
func (c *Client) PutResourceConfig(ctx context.Context, params *PutResourceConfigInput, optFns ...func(*Options)) (*PutResourceConfigOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutResourceConfig", params, optFns, addOperationPutResourceConfigMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutResourceConfigMiddleware(stack *middleware.Stack, options Options) (err error) {
