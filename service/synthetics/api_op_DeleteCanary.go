...
func (c *Client) DeleteCanary(ctx context.Context, params *DeleteCanaryInput, optFns ...func(*Options)) (*DeleteCanaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteCanary", params, optFns, addOperationDeleteCanaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteCanaryMiddleware(stack *middleware.Stack, options Options) (err error) {
