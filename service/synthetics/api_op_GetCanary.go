...
func (c *Client) GetCanary(ctx context.Context, params *GetCanaryInput, optFns ...func(*Options)) (*GetCanaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCanary", params, optFns, addOperationGetCanaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCanaryMiddleware(stack *middleware.Stack, options Options) (err error) {
