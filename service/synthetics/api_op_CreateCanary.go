...
func (c *Client) CreateCanary(ctx context.Context, params *CreateCanaryInput, optFns ...func(*Options)) (*CreateCanaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateCanary", params, optFns, addOperationCreateCanaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateCanaryMiddleware(stack *middleware.Stack, options Options) (err error) {
