...
func (c *Client) StopCanary(ctx context.Context, params *StopCanaryInput, optFns ...func(*Options)) (*StopCanaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopCanary", params, optFns, addOperationStopCanaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopCanaryMiddleware(stack *middleware.Stack, options Options) (err error) {
