...
func (c *Client) StartCanary(ctx context.Context, params *StartCanaryInput, optFns ...func(*Options)) (*StartCanaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartCanary", params, optFns, addOperationStartCanaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartCanaryMiddleware(stack *middleware.Stack, options Options) (err error) {
