...
func (c *Client) DescribeCanariesLastRun(ctx context.Context, params *DescribeCanariesLastRunInput, optFns ...func(*Options)) (*DescribeCanariesLastRunOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCanariesLastRun", params, optFns, addOperationDescribeCanariesLastRunMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCanariesLastRunMiddleware(stack *middleware.Stack, options Options) (err error) {
