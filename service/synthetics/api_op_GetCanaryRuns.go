...
func (c *Client) GetCanaryRuns(ctx context.Context, params *GetCanaryRunsInput, optFns ...func(*Options)) (*GetCanaryRunsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetCanaryRuns", params, optFns, addOperationGetCanaryRunsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetCanaryRunsMiddleware(stack *middleware.Stack, options Options) (err error) {
