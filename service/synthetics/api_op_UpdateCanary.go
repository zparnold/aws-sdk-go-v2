...
func (c *Client) UpdateCanary(ctx context.Context, params *UpdateCanaryInput, optFns ...func(*Options)) (*UpdateCanaryOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateCanary", params, optFns, addOperationUpdateCanaryMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateCanaryMiddleware(stack *middleware.Stack, options Options) (err error) {
