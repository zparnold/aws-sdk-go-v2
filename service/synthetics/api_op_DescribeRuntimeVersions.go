...
func (c *Client) DescribeRuntimeVersions(ctx context.Context, params *DescribeRuntimeVersionsInput, optFns ...func(*Options)) (*DescribeRuntimeVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeRuntimeVersions", params, optFns, addOperationDescribeRuntimeVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeRuntimeVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
