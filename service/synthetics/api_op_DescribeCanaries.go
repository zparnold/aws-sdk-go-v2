...
func (c *Client) DescribeCanaries(ctx context.Context, params *DescribeCanariesInput, optFns ...func(*Options)) (*DescribeCanariesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeCanaries", params, optFns, addOperationDescribeCanariesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeCanariesMiddleware(stack *middleware.Stack, options Options) (err error) {
