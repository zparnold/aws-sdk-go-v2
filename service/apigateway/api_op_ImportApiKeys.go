...
func (c *Client) ImportApiKeys(ctx context.Context, params *ImportApiKeysInput, optFns ...func(*Options)) (*ImportApiKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportApiKeys", params, optFns, addOperationImportApiKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportApiKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
