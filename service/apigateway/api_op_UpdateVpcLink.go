...
func (c *Client) UpdateVpcLink(ctx context.Context, params *UpdateVpcLinkInput, optFns ...func(*Options)) (*UpdateVpcLinkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateVpcLink", params, optFns, addOperationUpdateVpcLinkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateVpcLinkMiddleware(stack *middleware.Stack, options Options) (err error) {
