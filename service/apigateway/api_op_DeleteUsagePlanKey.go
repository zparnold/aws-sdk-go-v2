...
func (c *Client) DeleteUsagePlanKey(ctx context.Context, params *DeleteUsagePlanKeyInput, optFns ...func(*Options)) (*DeleteUsagePlanKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUsagePlanKey", params, optFns, addOperationDeleteUsagePlanKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUsagePlanKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
