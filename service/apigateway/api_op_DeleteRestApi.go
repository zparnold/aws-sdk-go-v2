...
func (c *Client) DeleteRestApi(ctx context.Context, params *DeleteRestApiInput, optFns ...func(*Options)) (*DeleteRestApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRestApi", params, optFns, addOperationDeleteRestApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRestApiMiddleware(stack *middleware.Stack, options Options) (err error) {
