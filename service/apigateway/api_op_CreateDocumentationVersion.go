...
func (c *Client) CreateDocumentationVersion(ctx context.Context, params *CreateDocumentationVersionInput, optFns ...func(*Options)) (*CreateDocumentationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDocumentationVersion", params, optFns, addOperationCreateDocumentationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDocumentationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
