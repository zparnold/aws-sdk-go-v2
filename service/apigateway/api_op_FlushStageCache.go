...
func (c *Client) FlushStageCache(ctx context.Context, params *FlushStageCacheInput, optFns ...func(*Options)) (*FlushStageCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FlushStageCache", params, optFns, addOperationFlushStageCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFlushStageCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
