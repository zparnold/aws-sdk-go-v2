...
func (c *Client) UpdateGatewayResponse(ctx context.Context, params *UpdateGatewayResponseInput, optFns ...func(*Options)) (*UpdateGatewayResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateGatewayResponse", params, optFns, addOperationUpdateGatewayResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateGatewayResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
