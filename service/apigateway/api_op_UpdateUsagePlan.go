...
func (c *Client) UpdateUsagePlan(ctx context.Context, params *UpdateUsagePlanInput, optFns ...func(*Options)) (*UpdateUsagePlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUsagePlan", params, optFns, addOperationUpdateUsagePlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUsagePlanMiddleware(stack *middleware.Stack, options Options) (err error) {
