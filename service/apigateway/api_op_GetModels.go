...
func (c *Client) GetModels(ctx context.Context, params *GetModelsInput, optFns ...func(*Options)) (*GetModelsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetModels", params, optFns, addOperationGetModelsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetModelsMiddleware(stack *middleware.Stack, options Options) (err error) {
