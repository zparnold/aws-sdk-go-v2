...
func (c *Client) GetBasePathMappings(ctx context.Context, params *GetBasePathMappingsInput, optFns ...func(*Options)) (*GetBasePathMappingsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBasePathMappings", params, optFns, addOperationGetBasePathMappingsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBasePathMappingsMiddleware(stack *middleware.Stack, options Options) (err error) {
