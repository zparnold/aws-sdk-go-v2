...
func (c *Client) GetBasePathMapping(ctx context.Context, params *GetBasePathMappingInput, optFns ...func(*Options)) (*GetBasePathMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetBasePathMapping", params, optFns, addOperationGetBasePathMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetBasePathMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
