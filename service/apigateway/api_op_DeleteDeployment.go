...
func (c *Client) DeleteDeployment(ctx context.Context, params *DeleteDeploymentInput, optFns ...func(*Options)) (*DeleteDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDeployment", params, optFns, addOperationDeleteDeploymentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDeploymentMiddleware(stack *middleware.Stack, options Options) (err error) {
