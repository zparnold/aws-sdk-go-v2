...
func (c *Client) CreateBasePathMapping(ctx context.Context, params *CreateBasePathMappingInput, optFns ...func(*Options)) (*CreateBasePathMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateBasePathMapping", params, optFns, addOperationCreateBasePathMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateBasePathMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
