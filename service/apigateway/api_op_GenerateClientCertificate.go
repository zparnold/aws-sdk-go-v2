...
func (c *Client) GenerateClientCertificate(ctx context.Context, params *GenerateClientCertificateInput, optFns ...func(*Options)) (*GenerateClientCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GenerateClientCertificate", params, optFns, addOperationGenerateClientCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGenerateClientCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
