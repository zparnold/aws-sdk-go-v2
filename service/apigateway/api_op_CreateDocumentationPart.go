...
func (c *Client) CreateDocumentationPart(ctx context.Context, params *CreateDocumentationPartInput, optFns ...func(*Options)) (*CreateDocumentationPartOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDocumentationPart", params, optFns, addOperationCreateDocumentationPartMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDocumentationPartMiddleware(stack *middleware.Stack, options Options) (err error) {
