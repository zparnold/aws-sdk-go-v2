...
func (c *Client) DeleteRequestValidator(ctx context.Context, params *DeleteRequestValidatorInput, optFns ...func(*Options)) (*DeleteRequestValidatorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRequestValidator", params, optFns, addOperationDeleteRequestValidatorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRequestValidatorMiddleware(stack *middleware.Stack, options Options) (err error) {
