...
func (c *Client) CreateRestApi(ctx context.Context, params *CreateRestApiInput, optFns ...func(*Options)) (*CreateRestApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRestApi", params, optFns, addOperationCreateRestApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRestApiMiddleware(stack *middleware.Stack, options Options) (err error) {
