...
func (c *Client) PutGatewayResponse(ctx context.Context, params *PutGatewayResponseInput, optFns ...func(*Options)) (*PutGatewayResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutGatewayResponse", params, optFns, addOperationPutGatewayResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutGatewayResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
