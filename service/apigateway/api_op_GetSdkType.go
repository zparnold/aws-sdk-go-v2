...
func (c *Client) GetSdkType(ctx context.Context, params *GetSdkTypeInput, optFns ...func(*Options)) (*GetSdkTypeOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSdkType", params, optFns, addOperationGetSdkTypeMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSdkTypeMiddleware(stack *middleware.Stack, options Options) (err error) {
