...
func (c *Client) ImportRestApi(ctx context.Context, params *ImportRestApiInput, optFns ...func(*Options)) (*ImportRestApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportRestApi", params, optFns, addOperationImportRestApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportRestApiMiddleware(stack *middleware.Stack, options Options) (err error) {
