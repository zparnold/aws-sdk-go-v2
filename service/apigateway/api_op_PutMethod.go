...
func (c *Client) PutMethod(ctx context.Context, params *PutMethodInput, optFns ...func(*Options)) (*PutMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMethod", params, optFns, addOperationPutMethodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMethodMiddleware(stack *middleware.Stack, options Options) (err error) {
