...
func (c *Client) GetApiKey(ctx context.Context, params *GetApiKeyInput, optFns ...func(*Options)) (*GetApiKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApiKey", params, optFns, addOperationGetApiKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApiKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
