...
func (c *Client) PutMethodResponse(ctx context.Context, params *PutMethodResponseInput, optFns ...func(*Options)) (*PutMethodResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutMethodResponse", params, optFns, addOperationPutMethodResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutMethodResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
