...
func (c *Client) UpdateRestApi(ctx context.Context, params *UpdateRestApiInput, optFns ...func(*Options)) (*UpdateRestApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRestApi", params, optFns, addOperationUpdateRestApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRestApiMiddleware(stack *middleware.Stack, options Options) (err error) {
