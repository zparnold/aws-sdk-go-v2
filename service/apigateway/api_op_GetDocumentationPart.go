...
func (c *Client) GetDocumentationPart(ctx context.Context, params *GetDocumentationPartInput, optFns ...func(*Options)) (*GetDocumentationPartOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocumentationPart", params, optFns, addOperationGetDocumentationPartMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentationPartMiddleware(stack *middleware.Stack, options Options) (err error) {
