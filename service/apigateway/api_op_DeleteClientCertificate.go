...
func (c *Client) DeleteClientCertificate(ctx context.Context, params *DeleteClientCertificateInput, optFns ...func(*Options)) (*DeleteClientCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteClientCertificate", params, optFns, addOperationDeleteClientCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteClientCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
