...
func (c *Client) UpdateDeployment(ctx context.Context, params *UpdateDeploymentInput, optFns ...func(*Options)) (*UpdateDeploymentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDeployment", params, optFns, addOperationUpdateDeploymentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDeploymentMiddleware(stack *middleware.Stack, options Options) (err error) {
