...
func (c *Client) GetRequestValidator(ctx context.Context, params *GetRequestValidatorInput, optFns ...func(*Options)) (*GetRequestValidatorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRequestValidator", params, optFns, addOperationGetRequestValidatorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRequestValidatorMiddleware(stack *middleware.Stack, options Options) (err error) {
