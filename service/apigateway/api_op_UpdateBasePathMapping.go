...
func (c *Client) UpdateBasePathMapping(ctx context.Context, params *UpdateBasePathMappingInput, optFns ...func(*Options)) (*UpdateBasePathMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateBasePathMapping", params, optFns, addOperationUpdateBasePathMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateBasePathMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
