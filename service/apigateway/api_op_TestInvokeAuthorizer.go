...
func (c *Client) TestInvokeAuthorizer(ctx context.Context, params *TestInvokeAuthorizerInput, optFns ...func(*Options)) (*TestInvokeAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestInvokeAuthorizer", params, optFns, addOperationTestInvokeAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestInvokeAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
