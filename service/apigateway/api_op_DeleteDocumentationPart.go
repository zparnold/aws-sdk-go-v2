...
func (c *Client) DeleteDocumentationPart(ctx context.Context, params *DeleteDocumentationPartInput, optFns ...func(*Options)) (*DeleteDocumentationPartOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDocumentationPart", params, optFns, addOperationDeleteDocumentationPartMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDocumentationPartMiddleware(stack *middleware.Stack, options Options) (err error) {
