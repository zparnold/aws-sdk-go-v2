...
func (c *Client) UpdateMethod(ctx context.Context, params *UpdateMethodInput, optFns ...func(*Options)) (*UpdateMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMethod", params, optFns, addOperationUpdateMethodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMethodMiddleware(stack *middleware.Stack, options Options) (err error) {
