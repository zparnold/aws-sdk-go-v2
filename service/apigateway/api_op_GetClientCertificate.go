...
func (c *Client) GetClientCertificate(ctx context.Context, params *GetClientCertificateInput, optFns ...func(*Options)) (*GetClientCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetClientCertificate", params, optFns, addOperationGetClientCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetClientCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
