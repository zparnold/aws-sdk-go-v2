...
func (c *Client) GetSdkTypes(ctx context.Context, params *GetSdkTypesInput, optFns ...func(*Options)) (*GetSdkTypesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSdkTypes", params, optFns, addOperationGetSdkTypesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSdkTypesMiddleware(stack *middleware.Stack, options Options) (err error) {
