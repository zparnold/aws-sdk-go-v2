...
func (c *Client) GetUsagePlanKey(ctx context.Context, params *GetUsagePlanKeyInput, optFns ...func(*Options)) (*GetUsagePlanKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUsagePlanKey", params, optFns, addOperationGetUsagePlanKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUsagePlanKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
