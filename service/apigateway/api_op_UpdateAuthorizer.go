...
func (c *Client) UpdateAuthorizer(ctx context.Context, params *UpdateAuthorizerInput, optFns ...func(*Options)) (*UpdateAuthorizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateAuthorizer", params, optFns, addOperationUpdateAuthorizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateAuthorizerMiddleware(stack *middleware.Stack, options Options) (err error) {
