...
func (c *Client) GetDomainNames(ctx context.Context, params *GetDomainNamesInput, optFns ...func(*Options)) (*GetDomainNamesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainNames", params, optFns, addOperationGetDomainNamesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainNamesMiddleware(stack *middleware.Stack, options Options) (err error) {
