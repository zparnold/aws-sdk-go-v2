...
func (c *Client) GetDocumentationVersion(ctx context.Context, params *GetDocumentationVersionInput, optFns ...func(*Options)) (*GetDocumentationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocumentationVersion", params, optFns, addOperationGetDocumentationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
