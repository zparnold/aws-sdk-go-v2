...
func (c *Client) UpdateRequestValidator(ctx context.Context, params *UpdateRequestValidatorInput, optFns ...func(*Options)) (*UpdateRequestValidatorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRequestValidator", params, optFns, addOperationUpdateRequestValidatorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRequestValidatorMiddleware(stack *middleware.Stack, options Options) (err error) {
