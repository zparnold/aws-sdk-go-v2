...
func (c *Client) GetRestApis(ctx context.Context, params *GetRestApisInput, optFns ...func(*Options)) (*GetRestApisOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRestApis", params, optFns, addOperationGetRestApisMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRestApisMiddleware(stack *middleware.Stack, options Options) (err error) {
