...
func (c *Client) GetMethodResponse(ctx context.Context, params *GetMethodResponseInput, optFns ...func(*Options)) (*GetMethodResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMethodResponse", params, optFns, addOperationGetMethodResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMethodResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
