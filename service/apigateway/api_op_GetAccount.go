...
func (c *Client) GetAccount(ctx context.Context, params *GetAccountInput, optFns ...func(*Options)) (*GetAccountOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetAccount", params, optFns, addOperationGetAccountMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetAccountMiddleware(stack *middleware.Stack, options Options) (err error) {
