...
func (c *Client) DeleteUsagePlan(ctx context.Context, params *DeleteUsagePlanInput, optFns ...func(*Options)) (*DeleteUsagePlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteUsagePlan", params, optFns, addOperationDeleteUsagePlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteUsagePlanMiddleware(stack *middleware.Stack, options Options) (err error) {
