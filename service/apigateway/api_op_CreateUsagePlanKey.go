...
func (c *Client) CreateUsagePlanKey(ctx context.Context, params *CreateUsagePlanKeyInput, optFns ...func(*Options)) (*CreateUsagePlanKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateUsagePlanKey", params, optFns, addOperationCreateUsagePlanKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateUsagePlanKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
