...
func (c *Client) FlushStageAuthorizersCache(ctx context.Context, params *FlushStageAuthorizersCacheInput, optFns ...func(*Options)) (*FlushStageAuthorizersCacheOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "FlushStageAuthorizersCache", params, optFns, addOperationFlushStageAuthorizersCacheMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationFlushStageAuthorizersCacheMiddleware(stack *middleware.Stack, options Options) (err error) {
