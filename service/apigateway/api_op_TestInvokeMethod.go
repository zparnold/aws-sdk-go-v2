...
func (c *Client) TestInvokeMethod(ctx context.Context, params *TestInvokeMethodInput, optFns ...func(*Options)) (*TestInvokeMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "TestInvokeMethod", params, optFns, addOperationTestInvokeMethodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationTestInvokeMethodMiddleware(stack *middleware.Stack, options Options) (err error) {
