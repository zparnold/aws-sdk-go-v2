...
func (c *Client) DeleteMethodResponse(ctx context.Context, params *DeleteMethodResponseInput, optFns ...func(*Options)) (*DeleteMethodResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteMethodResponse", params, optFns, addOperationDeleteMethodResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteMethodResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
