...
func (c *Client) DeleteResource(ctx context.Context, params *DeleteResourceInput, optFns ...func(*Options)) (*DeleteResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteResource", params, optFns, addOperationDeleteResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
