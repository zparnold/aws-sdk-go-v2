...
func (c *Client) GetDocumentationParts(ctx context.Context, params *GetDocumentationPartsInput, optFns ...func(*Options)) (*GetDocumentationPartsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDocumentationParts", params, optFns, addOperationGetDocumentationPartsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDocumentationPartsMiddleware(stack *middleware.Stack, options Options) (err error) {
