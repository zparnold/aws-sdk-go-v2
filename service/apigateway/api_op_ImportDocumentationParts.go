...
func (c *Client) ImportDocumentationParts(ctx context.Context, params *ImportDocumentationPartsInput, optFns ...func(*Options)) (*ImportDocumentationPartsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ImportDocumentationParts", params, optFns, addOperationImportDocumentationPartsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationImportDocumentationPartsMiddleware(stack *middleware.Stack, options Options) (err error) {
