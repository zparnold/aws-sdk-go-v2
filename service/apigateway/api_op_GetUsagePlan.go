...
func (c *Client) GetUsagePlan(ctx context.Context, params *GetUsagePlanInput, optFns ...func(*Options)) (*GetUsagePlanOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUsagePlan", params, optFns, addOperationGetUsagePlanMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUsagePlanMiddleware(stack *middleware.Stack, options Options) (err error) {
