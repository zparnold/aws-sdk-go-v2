...
func (c *Client) GetSdk(ctx context.Context, params *GetSdkInput, optFns ...func(*Options)) (*GetSdkOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSdk", params, optFns, addOperationGetSdkMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSdkMiddleware(stack *middleware.Stack, options Options) (err error) {
