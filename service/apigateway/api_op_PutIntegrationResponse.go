...
func (c *Client) PutIntegrationResponse(ctx context.Context, params *PutIntegrationResponseInput, optFns ...func(*Options)) (*PutIntegrationResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutIntegrationResponse", params, optFns, addOperationPutIntegrationResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutIntegrationResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
