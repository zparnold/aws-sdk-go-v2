...
func (c *Client) UpdateDocumentationPart(ctx context.Context, params *UpdateDocumentationPartInput, optFns ...func(*Options)) (*UpdateDocumentationPartOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDocumentationPart", params, optFns, addOperationUpdateDocumentationPartMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDocumentationPartMiddleware(stack *middleware.Stack, options Options) (err error) {
