...
func (c *Client) GetDomainName(ctx context.Context, params *GetDomainNameInput, optFns ...func(*Options)) (*GetDomainNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetDomainName", params, optFns, addOperationGetDomainNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetDomainNameMiddleware(stack *middleware.Stack, options Options) (err error) {
