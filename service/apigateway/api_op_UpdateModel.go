...
func (c *Client) UpdateModel(ctx context.Context, params *UpdateModelInput, optFns ...func(*Options)) (*UpdateModelOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateModel", params, optFns, addOperationUpdateModelMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateModelMiddleware(stack *middleware.Stack, options Options) (err error) {
