...
func (c *Client) GetUsagePlans(ctx context.Context, params *GetUsagePlansInput, optFns ...func(*Options)) (*GetUsagePlansOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUsagePlans", params, optFns, addOperationGetUsagePlansMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUsagePlansMiddleware(stack *middleware.Stack, options Options) (err error) {
