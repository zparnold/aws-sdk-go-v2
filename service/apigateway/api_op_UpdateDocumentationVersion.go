...
func (c *Client) UpdateDocumentationVersion(ctx context.Context, params *UpdateDocumentationVersionInput, optFns ...func(*Options)) (*UpdateDocumentationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateDocumentationVersion", params, optFns, addOperationUpdateDocumentationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateDocumentationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
