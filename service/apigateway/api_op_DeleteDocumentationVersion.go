...
func (c *Client) DeleteDocumentationVersion(ctx context.Context, params *DeleteDocumentationVersionInput, optFns ...func(*Options)) (*DeleteDocumentationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDocumentationVersion", params, optFns, addOperationDeleteDocumentationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDocumentationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
