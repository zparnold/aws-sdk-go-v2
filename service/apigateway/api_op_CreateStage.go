...
func (c *Client) CreateStage(ctx context.Context, params *CreateStageInput, optFns ...func(*Options)) (*CreateStageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateStage", params, optFns, addOperationCreateStageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateStageMiddleware(stack *middleware.Stack, options Options) (err error) {
