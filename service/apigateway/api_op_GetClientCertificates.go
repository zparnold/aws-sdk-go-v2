...
func (c *Client) GetClientCertificates(ctx context.Context, params *GetClientCertificatesInput, optFns ...func(*Options)) (*GetClientCertificatesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetClientCertificates", params, optFns, addOperationGetClientCertificatesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetClientCertificatesMiddleware(stack *middleware.Stack, options Options) (err error) {
