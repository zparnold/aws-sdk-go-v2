...
func (c *Client) GetRequestValidators(ctx context.Context, params *GetRequestValidatorsInput, optFns ...func(*Options)) (*GetRequestValidatorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRequestValidators", params, optFns, addOperationGetRequestValidatorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRequestValidatorsMiddleware(stack *middleware.Stack, options Options) (err error) {
