...
func (c *Client) DeleteApiKey(ctx context.Context, params *DeleteApiKeyInput, optFns ...func(*Options)) (*DeleteApiKeyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteApiKey", params, optFns, addOperationDeleteApiKeyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteApiKeyMiddleware(stack *middleware.Stack, options Options) (err error) {
