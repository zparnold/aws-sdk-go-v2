...
func (c *Client) GetResource(ctx context.Context, params *GetResourceInput, optFns ...func(*Options)) (*GetResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetResource", params, optFns, addOperationGetResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
