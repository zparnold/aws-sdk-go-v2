...
func (c *Client) CreateDomainName(ctx context.Context, params *CreateDomainNameInput, optFns ...func(*Options)) (*CreateDomainNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDomainName", params, optFns, addOperationCreateDomainNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDomainNameMiddleware(stack *middleware.Stack, options Options) (err error) {
