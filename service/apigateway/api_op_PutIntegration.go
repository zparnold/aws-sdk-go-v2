...
func (c *Client) PutIntegration(ctx context.Context, params *PutIntegrationInput, optFns ...func(*Options)) (*PutIntegrationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutIntegration", params, optFns, addOperationPutIntegrationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutIntegrationMiddleware(stack *middleware.Stack, options Options) (err error) {
