...
func (c *Client) PutRestApi(ctx context.Context, params *PutRestApiInput, optFns ...func(*Options)) (*PutRestApiOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutRestApi", params, optFns, addOperationPutRestApiMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutRestApiMiddleware(stack *middleware.Stack, options Options) (err error) {
