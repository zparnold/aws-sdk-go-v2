...
func (c *Client) GetMethod(ctx context.Context, params *GetMethodInput, optFns ...func(*Options)) (*GetMethodOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetMethod", params, optFns, addOperationGetMethodMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetMethodMiddleware(stack *middleware.Stack, options Options) (err error) {
