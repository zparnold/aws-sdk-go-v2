...
func (c *Client) UpdateClientCertificate(ctx context.Context, params *UpdateClientCertificateInput, optFns ...func(*Options)) (*UpdateClientCertificateOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateClientCertificate", params, optFns, addOperationUpdateClientCertificateMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateClientCertificateMiddleware(stack *middleware.Stack, options Options) (err error) {
