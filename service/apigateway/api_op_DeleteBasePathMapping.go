...
func (c *Client) DeleteBasePathMapping(ctx context.Context, params *DeleteBasePathMappingInput, optFns ...func(*Options)) (*DeleteBasePathMappingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteBasePathMapping", params, optFns, addOperationDeleteBasePathMappingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteBasePathMappingMiddleware(stack *middleware.Stack, options Options) (err error) {
