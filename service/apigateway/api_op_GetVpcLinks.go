...
func (c *Client) GetVpcLinks(ctx context.Context, params *GetVpcLinksInput, optFns ...func(*Options)) (*GetVpcLinksOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetVpcLinks", params, optFns, addOperationGetVpcLinksMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetVpcLinksMiddleware(stack *middleware.Stack, options Options) (err error) {
