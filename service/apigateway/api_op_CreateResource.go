...
func (c *Client) CreateResource(ctx context.Context, params *CreateResourceInput, optFns ...func(*Options)) (*CreateResourceOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateResource", params, optFns, addOperationCreateResourceMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateResourceMiddleware(stack *middleware.Stack, options Options) (err error) {
