...
func (c *Client) GetUsagePlanKeys(ctx context.Context, params *GetUsagePlanKeysInput, optFns ...func(*Options)) (*GetUsagePlanKeysOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetUsagePlanKeys", params, optFns, addOperationGetUsagePlanKeysMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetUsagePlanKeysMiddleware(stack *middleware.Stack, options Options) (err error) {
