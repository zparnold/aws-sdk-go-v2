...
func (c *Client) GetGatewayResponse(ctx context.Context, params *GetGatewayResponseInput, optFns ...func(*Options)) (*GetGatewayResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGatewayResponse", params, optFns, addOperationGetGatewayResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGatewayResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
