...
func (c *Client) UpdateMethodResponse(ctx context.Context, params *UpdateMethodResponseInput, optFns ...func(*Options)) (*UpdateMethodResponseOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateMethodResponse", params, optFns, addOperationUpdateMethodResponseMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateMethodResponseMiddleware(stack *middleware.Stack, options Options) (err error) {
