...
func (c *Client) DeleteStage(ctx context.Context, params *DeleteStageInput, optFns ...func(*Options)) (*DeleteStageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteStage", params, optFns, addOperationDeleteStageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteStageMiddleware(stack *middleware.Stack, options Options) (err error) {
