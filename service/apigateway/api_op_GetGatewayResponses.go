...
func (c *Client) GetGatewayResponses(ctx context.Context, params *GetGatewayResponsesInput, optFns ...func(*Options)) (*GetGatewayResponsesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetGatewayResponses", params, optFns, addOperationGetGatewayResponsesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetGatewayResponsesMiddleware(stack *middleware.Stack, options Options) (err error) {
