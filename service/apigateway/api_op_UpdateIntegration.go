...
func (c *Client) UpdateIntegration(ctx context.Context, params *UpdateIntegrationInput, optFns ...func(*Options)) (*UpdateIntegrationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIntegration", params, optFns, addOperationUpdateIntegrationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIntegrationMiddleware(stack *middleware.Stack, options Options) (err error) {
