...
func (c *Client) UpdateUsage(ctx context.Context, params *UpdateUsageInput, optFns ...func(*Options)) (*UpdateUsageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateUsage", params, optFns, addOperationUpdateUsageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateUsageMiddleware(stack *middleware.Stack, options Options) (err error) {
