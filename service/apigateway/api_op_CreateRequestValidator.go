...
func (c *Client) CreateRequestValidator(ctx context.Context, params *CreateRequestValidatorInput, optFns ...func(*Options)) (*CreateRequestValidatorOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRequestValidator", params, optFns, addOperationCreateRequestValidatorMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRequestValidatorMiddleware(stack *middleware.Stack, options Options) (err error) {
