...
func (c *Client) DeleteDomainName(ctx context.Context, params *DeleteDomainNameInput, optFns ...func(*Options)) (*DeleteDomainNameOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDomainName", params, optFns, addOperationDeleteDomainNameMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDomainNameMiddleware(stack *middleware.Stack, options Options) (err error) {
