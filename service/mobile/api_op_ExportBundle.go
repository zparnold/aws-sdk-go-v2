...
func (c *Client) ExportBundle(ctx context.Context, params *ExportBundleInput, optFns ...func(*Options)) (*ExportBundleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportBundle", params, optFns, addOperationExportBundleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportBundleMiddleware(stack *middleware.Stack, options Options) (err error) {
