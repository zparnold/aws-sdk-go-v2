...
func (c *Client) ExportProject(ctx context.Context, params *ExportProjectInput, optFns ...func(*Options)) (*ExportProjectOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ExportProject", params, optFns, addOperationExportProjectMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationExportProjectMiddleware(stack *middleware.Stack, options Options) (err error) {
