...
func (c *Client) ListBundles(ctx context.Context, params *ListBundlesInput, optFns ...func(*Options)) (*ListBundlesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListBundles", params, optFns, addOperationListBundlesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListBundlesMiddleware(stack *middleware.Stack, options Options) (err error) {
