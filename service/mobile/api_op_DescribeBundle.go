...
func (c *Client) DescribeBundle(ctx context.Context, params *DescribeBundleInput, optFns ...func(*Options)) (*DescribeBundleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeBundle", params, optFns, addOperationDescribeBundleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeBundleMiddleware(stack *middleware.Stack, options Options) (err error) {
