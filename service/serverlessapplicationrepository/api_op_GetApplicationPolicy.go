...
func (c *Client) GetApplicationPolicy(ctx context.Context, params *GetApplicationPolicyInput, optFns ...func(*Options)) (*GetApplicationPolicyOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetApplicationPolicy", params, optFns, addOperationGetApplicationPolicyMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetApplicationPolicyMiddleware(stack *middleware.Stack, options Options) (err error) {
