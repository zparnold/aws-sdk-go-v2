...
func (c *Client) ListApplicationVersions(ctx context.Context, params *ListApplicationVersionsInput, optFns ...func(*Options)) (*ListApplicationVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListApplicationVersions", params, optFns, addOperationListApplicationVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListApplicationVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
