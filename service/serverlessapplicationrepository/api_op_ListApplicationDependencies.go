...
func (c *Client) ListApplicationDependencies(ctx context.Context, params *ListApplicationDependenciesInput, optFns ...func(*Options)) (*ListApplicationDependenciesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListApplicationDependencies", params, optFns, addOperationListApplicationDependenciesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListApplicationDependenciesMiddleware(stack *middleware.Stack, options Options) (err error) {
