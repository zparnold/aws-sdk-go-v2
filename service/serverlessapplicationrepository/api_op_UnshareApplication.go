...
func (c *Client) UnshareApplication(ctx context.Context, params *UnshareApplicationInput, optFns ...func(*Options)) (*UnshareApplicationOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UnshareApplication", params, optFns, addOperationUnshareApplicationMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUnshareApplicationMiddleware(stack *middleware.Stack, options Options) (err error) {
