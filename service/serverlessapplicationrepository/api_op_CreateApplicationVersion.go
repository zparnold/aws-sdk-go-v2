...
func (c *Client) CreateApplicationVersion(ctx context.Context, params *CreateApplicationVersionInput, optFns ...func(*Options)) (*CreateApplicationVersionOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateApplicationVersion", params, optFns, addOperationCreateApplicationVersionMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateApplicationVersionMiddleware(stack *middleware.Stack, options Options) (err error) {
