...
func (c *Client) DescribeKeyPhrasesDetectionJob(ctx context.Context, params *DescribeKeyPhrasesDetectionJobInput, optFns ...func(*Options)) (*DescribeKeyPhrasesDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeKeyPhrasesDetectionJob", params, optFns, addOperationDescribeKeyPhrasesDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeKeyPhrasesDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
