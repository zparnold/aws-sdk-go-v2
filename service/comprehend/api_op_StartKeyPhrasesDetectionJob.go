...
func (c *Client) StartKeyPhrasesDetectionJob(ctx context.Context, params *StartKeyPhrasesDetectionJobInput, optFns ...func(*Options)) (*StartKeyPhrasesDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartKeyPhrasesDetectionJob", params, optFns, addOperationStartKeyPhrasesDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartKeyPhrasesDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
