...
func (c *Client) DescribeDocumentClassificationJob(ctx context.Context, params *DescribeDocumentClassificationJobInput, optFns ...func(*Options)) (*DescribeDocumentClassificationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDocumentClassificationJob", params, optFns, addOperationDescribeDocumentClassificationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDocumentClassificationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
