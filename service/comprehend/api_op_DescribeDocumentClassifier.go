...
func (c *Client) DescribeDocumentClassifier(ctx context.Context, params *DescribeDocumentClassifierInput, optFns ...func(*Options)) (*DescribeDocumentClassifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDocumentClassifier", params, optFns, addOperationDescribeDocumentClassifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDocumentClassifierMiddleware(stack *middleware.Stack, options Options) (err error) {
