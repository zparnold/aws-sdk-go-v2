...
func (c *Client) ListDominantLanguageDetectionJobs(ctx context.Context, params *ListDominantLanguageDetectionJobsInput, optFns ...func(*Options)) (*ListDominantLanguageDetectionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDominantLanguageDetectionJobs", params, optFns, addOperationListDominantLanguageDetectionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDominantLanguageDetectionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
