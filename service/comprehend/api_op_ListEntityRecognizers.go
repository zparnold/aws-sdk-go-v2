...
func (c *Client) ListEntityRecognizers(ctx context.Context, params *ListEntityRecognizersInput, optFns ...func(*Options)) (*ListEntityRecognizersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEntityRecognizers", params, optFns, addOperationListEntityRecognizersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEntityRecognizersMiddleware(stack *middleware.Stack, options Options) (err error) {
