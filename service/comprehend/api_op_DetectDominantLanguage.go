...
func (c *Client) DetectDominantLanguage(ctx context.Context, params *DetectDominantLanguageInput, optFns ...func(*Options)) (*DetectDominantLanguageOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectDominantLanguage", params, optFns, addOperationDetectDominantLanguageMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectDominantLanguageMiddleware(stack *middleware.Stack, options Options) (err error) {
