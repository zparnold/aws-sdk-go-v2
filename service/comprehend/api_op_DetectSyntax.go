...
func (c *Client) DetectSyntax(ctx context.Context, params *DetectSyntaxInput, optFns ...func(*Options)) (*DetectSyntaxOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectSyntax", params, optFns, addOperationDetectSyntaxMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectSyntaxMiddleware(stack *middleware.Stack, options Options) (err error) {
