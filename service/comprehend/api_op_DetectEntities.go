...
func (c *Client) DetectEntities(ctx context.Context, params *DetectEntitiesInput, optFns ...func(*Options)) (*DetectEntitiesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectEntities", params, optFns, addOperationDetectEntitiesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectEntitiesMiddleware(stack *middleware.Stack, options Options) (err error) {
