...
func (c *Client) StartDocumentClassificationJob(ctx context.Context, params *StartDocumentClassificationJobInput, optFns ...func(*Options)) (*StartDocumentClassificationJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDocumentClassificationJob", params, optFns, addOperationStartDocumentClassificationJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDocumentClassificationJobMiddleware(stack *middleware.Stack, options Options) (err error) {
