...
func (c *Client) StopEntitiesDetectionJob(ctx context.Context, params *StopEntitiesDetectionJobInput, optFns ...func(*Options)) (*StopEntitiesDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopEntitiesDetectionJob", params, optFns, addOperationStopEntitiesDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopEntitiesDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
