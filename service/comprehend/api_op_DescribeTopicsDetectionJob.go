...
func (c *Client) DescribeTopicsDetectionJob(ctx context.Context, params *DescribeTopicsDetectionJobInput, optFns ...func(*Options)) (*DescribeTopicsDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTopicsDetectionJob", params, optFns, addOperationDescribeTopicsDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTopicsDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
