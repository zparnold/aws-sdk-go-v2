...
func (c *Client) DetectKeyPhrases(ctx context.Context, params *DetectKeyPhrasesInput, optFns ...func(*Options)) (*DetectKeyPhrasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DetectKeyPhrases", params, optFns, addOperationDetectKeyPhrasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDetectKeyPhrasesMiddleware(stack *middleware.Stack, options Options) (err error) {
