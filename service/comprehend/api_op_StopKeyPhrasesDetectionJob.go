...
func (c *Client) StopKeyPhrasesDetectionJob(ctx context.Context, params *StopKeyPhrasesDetectionJobInput, optFns ...func(*Options)) (*StopKeyPhrasesDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopKeyPhrasesDetectionJob", params, optFns, addOperationStopKeyPhrasesDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopKeyPhrasesDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
