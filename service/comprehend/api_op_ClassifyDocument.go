...
func (c *Client) ClassifyDocument(ctx context.Context, params *ClassifyDocumentInput, optFns ...func(*Options)) (*ClassifyDocumentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ClassifyDocument", params, optFns, addOperationClassifyDocumentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationClassifyDocumentMiddleware(stack *middleware.Stack, options Options) (err error) {
