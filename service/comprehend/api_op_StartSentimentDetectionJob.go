...
func (c *Client) StartSentimentDetectionJob(ctx context.Context, params *StartSentimentDetectionJobInput, optFns ...func(*Options)) (*StartSentimentDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartSentimentDetectionJob", params, optFns, addOperationStartSentimentDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartSentimentDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
