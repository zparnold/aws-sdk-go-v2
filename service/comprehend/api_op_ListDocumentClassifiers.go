...
func (c *Client) ListDocumentClassifiers(ctx context.Context, params *ListDocumentClassifiersInput, optFns ...func(*Options)) (*ListDocumentClassifiersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDocumentClassifiers", params, optFns, addOperationListDocumentClassifiersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDocumentClassifiersMiddleware(stack *middleware.Stack, options Options) (err error) {
