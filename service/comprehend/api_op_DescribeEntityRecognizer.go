...
func (c *Client) DescribeEntityRecognizer(ctx context.Context, params *DescribeEntityRecognizerInput, optFns ...func(*Options)) (*DescribeEntityRecognizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEntityRecognizer", params, optFns, addOperationDescribeEntityRecognizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEntityRecognizerMiddleware(stack *middleware.Stack, options Options) (err error) {
