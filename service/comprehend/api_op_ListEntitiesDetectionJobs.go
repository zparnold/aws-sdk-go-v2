...
func (c *Client) ListEntitiesDetectionJobs(ctx context.Context, params *ListEntitiesDetectionJobsInput, optFns ...func(*Options)) (*ListEntitiesDetectionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListEntitiesDetectionJobs", params, optFns, addOperationListEntitiesDetectionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListEntitiesDetectionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
