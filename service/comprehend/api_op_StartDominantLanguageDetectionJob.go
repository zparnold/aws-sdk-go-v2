...
func (c *Client) StartDominantLanguageDetectionJob(ctx context.Context, params *StartDominantLanguageDetectionJobInput, optFns ...func(*Options)) (*StartDominantLanguageDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDominantLanguageDetectionJob", params, optFns, addOperationStartDominantLanguageDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDominantLanguageDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
