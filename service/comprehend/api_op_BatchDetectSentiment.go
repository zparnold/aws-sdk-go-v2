...
func (c *Client) BatchDetectSentiment(ctx context.Context, params *BatchDetectSentimentInput, optFns ...func(*Options)) (*BatchDetectSentimentOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDetectSentiment", params, optFns, addOperationBatchDetectSentimentMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDetectSentimentMiddleware(stack *middleware.Stack, options Options) (err error) {
