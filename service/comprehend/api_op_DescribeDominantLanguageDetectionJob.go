...
func (c *Client) DescribeDominantLanguageDetectionJob(ctx context.Context, params *DescribeDominantLanguageDetectionJobInput, optFns ...func(*Options)) (*DescribeDominantLanguageDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDominantLanguageDetectionJob", params, optFns, addOperationDescribeDominantLanguageDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDominantLanguageDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
