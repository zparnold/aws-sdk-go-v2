...
func (c *Client) DeleteEntityRecognizer(ctx context.Context, params *DeleteEntityRecognizerInput, optFns ...func(*Options)) (*DeleteEntityRecognizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteEntityRecognizer", params, optFns, addOperationDeleteEntityRecognizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteEntityRecognizerMiddleware(stack *middleware.Stack, options Options) (err error) {
