...
func (c *Client) CreateEntityRecognizer(ctx context.Context, params *CreateEntityRecognizerInput, optFns ...func(*Options)) (*CreateEntityRecognizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateEntityRecognizer", params, optFns, addOperationCreateEntityRecognizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateEntityRecognizerMiddleware(stack *middleware.Stack, options Options) (err error) {
