...
func (c *Client) ListSentimentDetectionJobs(ctx context.Context, params *ListSentimentDetectionJobsInput, optFns ...func(*Options)) (*ListSentimentDetectionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSentimentDetectionJobs", params, optFns, addOperationListSentimentDetectionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSentimentDetectionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
