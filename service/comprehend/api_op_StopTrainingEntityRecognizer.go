...
func (c *Client) StopTrainingEntityRecognizer(ctx context.Context, params *StopTrainingEntityRecognizerInput, optFns ...func(*Options)) (*StopTrainingEntityRecognizerOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopTrainingEntityRecognizer", params, optFns, addOperationStopTrainingEntityRecognizerMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopTrainingEntityRecognizerMiddleware(stack *middleware.Stack, options Options) (err error) {
