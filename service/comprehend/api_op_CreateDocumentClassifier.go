...
func (c *Client) CreateDocumentClassifier(ctx context.Context, params *CreateDocumentClassifierInput, optFns ...func(*Options)) (*CreateDocumentClassifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDocumentClassifier", params, optFns, addOperationCreateDocumentClassifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDocumentClassifierMiddleware(stack *middleware.Stack, options Options) (err error) {
