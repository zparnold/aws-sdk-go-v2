...
func (c *Client) StartEntitiesDetectionJob(ctx context.Context, params *StartEntitiesDetectionJobInput, optFns ...func(*Options)) (*StartEntitiesDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartEntitiesDetectionJob", params, optFns, addOperationStartEntitiesDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartEntitiesDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
