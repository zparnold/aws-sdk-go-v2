...
func (c *Client) StopSentimentDetectionJob(ctx context.Context, params *StopSentimentDetectionJobInput, optFns ...func(*Options)) (*StopSentimentDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopSentimentDetectionJob", params, optFns, addOperationStopSentimentDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopSentimentDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
