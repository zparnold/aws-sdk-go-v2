...
func (c *Client) ListTopicsDetectionJobs(ctx context.Context, params *ListTopicsDetectionJobsInput, optFns ...func(*Options)) (*ListTopicsDetectionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTopicsDetectionJobs", params, optFns, addOperationListTopicsDetectionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTopicsDetectionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
