...
func (c *Client) DescribeSentimentDetectionJob(ctx context.Context, params *DescribeSentimentDetectionJobInput, optFns ...func(*Options)) (*DescribeSentimentDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeSentimentDetectionJob", params, optFns, addOperationDescribeSentimentDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeSentimentDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
