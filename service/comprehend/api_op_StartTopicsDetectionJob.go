...
func (c *Client) StartTopicsDetectionJob(ctx context.Context, params *StartTopicsDetectionJobInput, optFns ...func(*Options)) (*StartTopicsDetectionJobOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartTopicsDetectionJob", params, optFns, addOperationStartTopicsDetectionJobMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartTopicsDetectionJobMiddleware(stack *middleware.Stack, options Options) (err error) {
