...
func (c *Client) BatchDetectKeyPhrases(ctx context.Context, params *BatchDetectKeyPhrasesInput, optFns ...func(*Options)) (*BatchDetectKeyPhrasesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDetectKeyPhrases", params, optFns, addOperationBatchDetectKeyPhrasesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDetectKeyPhrasesMiddleware(stack *middleware.Stack, options Options) (err error) {
