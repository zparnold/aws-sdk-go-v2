...
func (c *Client) StopTrainingDocumentClassifier(ctx context.Context, params *StopTrainingDocumentClassifierInput, optFns ...func(*Options)) (*StopTrainingDocumentClassifierOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopTrainingDocumentClassifier", params, optFns, addOperationStopTrainingDocumentClassifierMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopTrainingDocumentClassifierMiddleware(stack *middleware.Stack, options Options) (err error) {
