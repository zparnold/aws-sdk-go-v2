...
func (c *Client) ListDocumentClassificationJobs(ctx context.Context, params *ListDocumentClassificationJobsInput, optFns ...func(*Options)) (*ListDocumentClassificationJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListDocumentClassificationJobs", params, optFns, addOperationListDocumentClassificationJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListDocumentClassificationJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
