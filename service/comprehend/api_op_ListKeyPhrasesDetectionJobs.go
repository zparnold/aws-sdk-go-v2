...
func (c *Client) ListKeyPhrasesDetectionJobs(ctx context.Context, params *ListKeyPhrasesDetectionJobsInput, optFns ...func(*Options)) (*ListKeyPhrasesDetectionJobsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListKeyPhrasesDetectionJobs", params, optFns, addOperationListKeyPhrasesDetectionJobsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListKeyPhrasesDetectionJobsMiddleware(stack *middleware.Stack, options Options) (err error) {
