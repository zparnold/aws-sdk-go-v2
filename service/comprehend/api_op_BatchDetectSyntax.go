...
func (c *Client) BatchDetectSyntax(ctx context.Context, params *BatchDetectSyntaxInput, optFns ...func(*Options)) (*BatchDetectSyntaxOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "BatchDetectSyntax", params, optFns, addOperationBatchDetectSyntaxMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationBatchDetectSyntaxMiddleware(stack *middleware.Stack, options Options) (err error) {
