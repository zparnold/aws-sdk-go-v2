...
func (c *Client) UpdateRule(ctx context.Context, params *UpdateRuleInput, optFns ...func(*Options)) (*UpdateRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRule", params, optFns, addOperationUpdateRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
