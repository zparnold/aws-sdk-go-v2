...
func (c *Client) DeleteRegexPatternSet(ctx context.Context, params *DeleteRegexPatternSetInput, optFns ...func(*Options)) (*DeleteRegexPatternSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteRegexPatternSet", params, optFns, addOperationDeleteRegexPatternSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteRegexPatternSetMiddleware(stack *middleware.Stack, options Options) (err error) {
