...
func (c *Client) ListIPSets(ctx context.Context, params *ListIPSetsInput, optFns ...func(*Options)) (*ListIPSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListIPSets", params, optFns, addOperationListIPSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListIPSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
