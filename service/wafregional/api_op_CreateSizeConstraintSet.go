...
func (c *Client) CreateSizeConstraintSet(ctx context.Context, params *CreateSizeConstraintSetInput, optFns ...func(*Options)) (*CreateSizeConstraintSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateSizeConstraintSet", params, optFns, addOperationCreateSizeConstraintSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateSizeConstraintSetMiddleware(stack *middleware.Stack, options Options) (err error) {
