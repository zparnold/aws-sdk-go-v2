...
func (c *Client) GetChangeToken(ctx context.Context, params *GetChangeTokenInput, optFns ...func(*Options)) (*GetChangeTokenOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetChangeToken", params, optFns, addOperationGetChangeTokenMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetChangeTokenMiddleware(stack *middleware.Stack, options Options) (err error) {
