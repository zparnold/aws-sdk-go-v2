...
func (c *Client) ListRegexMatchSets(ctx context.Context, params *ListRegexMatchSetsInput, optFns ...func(*Options)) (*ListRegexMatchSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRegexMatchSets", params, optFns, addOperationListRegexMatchSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRegexMatchSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
