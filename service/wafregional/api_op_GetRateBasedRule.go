...
func (c *Client) GetRateBasedRule(ctx context.Context, params *GetRateBasedRuleInput, optFns ...func(*Options)) (*GetRateBasedRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRateBasedRule", params, optFns, addOperationGetRateBasedRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRateBasedRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
