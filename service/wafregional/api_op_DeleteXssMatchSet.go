...
func (c *Client) DeleteXssMatchSet(ctx context.Context, params *DeleteXssMatchSetInput, optFns ...func(*Options)) (*DeleteXssMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteXssMatchSet", params, optFns, addOperationDeleteXssMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteXssMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
