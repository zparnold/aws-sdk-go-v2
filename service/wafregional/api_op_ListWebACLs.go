...
func (c *Client) ListWebACLs(ctx context.Context, params *ListWebACLsInput, optFns ...func(*Options)) (*ListWebACLsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListWebACLs", params, optFns, addOperationListWebACLsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListWebACLsMiddleware(stack *middleware.Stack, options Options) (err error) {
