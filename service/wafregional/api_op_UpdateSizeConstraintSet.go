...
func (c *Client) UpdateSizeConstraintSet(ctx context.Context, params *UpdateSizeConstraintSetInput, optFns ...func(*Options)) (*UpdateSizeConstraintSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSizeConstraintSet", params, optFns, addOperationUpdateSizeConstraintSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSizeConstraintSetMiddleware(stack *middleware.Stack, options Options) (err error) {
