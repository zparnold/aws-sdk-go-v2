...
func (c *Client) CreateRegexMatchSet(ctx context.Context, params *CreateRegexMatchSetInput, optFns ...func(*Options)) (*CreateRegexMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRegexMatchSet", params, optFns, addOperationCreateRegexMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRegexMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
