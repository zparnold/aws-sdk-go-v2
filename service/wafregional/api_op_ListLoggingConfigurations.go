...
func (c *Client) ListLoggingConfigurations(ctx context.Context, params *ListLoggingConfigurationsInput, optFns ...func(*Options)) (*ListLoggingConfigurationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListLoggingConfigurations", params, optFns, addOperationListLoggingConfigurationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListLoggingConfigurationsMiddleware(stack *middleware.Stack, options Options) (err error) {
