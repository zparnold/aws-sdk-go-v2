...
func (c *Client) DeleteWebACL(ctx context.Context, params *DeleteWebACLInput, optFns ...func(*Options)) (*DeleteWebACLOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteWebACL", params, optFns, addOperationDeleteWebACLMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteWebACLMiddleware(stack *middleware.Stack, options Options) (err error) {
