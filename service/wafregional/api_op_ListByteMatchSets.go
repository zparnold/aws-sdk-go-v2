...
func (c *Client) ListByteMatchSets(ctx context.Context, params *ListByteMatchSetsInput, optFns ...func(*Options)) (*ListByteMatchSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListByteMatchSets", params, optFns, addOperationListByteMatchSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListByteMatchSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
