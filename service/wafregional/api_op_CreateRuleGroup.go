...
func (c *Client) CreateRuleGroup(ctx context.Context, params *CreateRuleGroupInput, optFns ...func(*Options)) (*CreateRuleGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateRuleGroup", params, optFns, addOperationCreateRuleGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateRuleGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
