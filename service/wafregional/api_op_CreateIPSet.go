...
func (c *Client) CreateIPSet(ctx context.Context, params *CreateIPSetInput, optFns ...func(*Options)) (*CreateIPSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateIPSet", params, optFns, addOperationCreateIPSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateIPSetMiddleware(stack *middleware.Stack, options Options) (err error) {
