...
func (c *Client) ListRegexPatternSets(ctx context.Context, params *ListRegexPatternSetsInput, optFns ...func(*Options)) (*ListRegexPatternSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRegexPatternSets", params, optFns, addOperationListRegexPatternSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRegexPatternSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
