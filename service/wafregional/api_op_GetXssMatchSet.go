...
func (c *Client) GetXssMatchSet(ctx context.Context, params *GetXssMatchSetInput, optFns ...func(*Options)) (*GetXssMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetXssMatchSet", params, optFns, addOperationGetXssMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetXssMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
