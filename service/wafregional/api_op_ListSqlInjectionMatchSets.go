...
func (c *Client) ListSqlInjectionMatchSets(ctx context.Context, params *ListSqlInjectionMatchSetsInput, optFns ...func(*Options)) (*ListSqlInjectionMatchSetsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListSqlInjectionMatchSets", params, optFns, addOperationListSqlInjectionMatchSetsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListSqlInjectionMatchSetsMiddleware(stack *middleware.Stack, options Options) (err error) {
