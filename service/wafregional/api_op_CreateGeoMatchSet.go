...
func (c *Client) CreateGeoMatchSet(ctx context.Context, params *CreateGeoMatchSetInput, optFns ...func(*Options)) (*CreateGeoMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateGeoMatchSet", params, optFns, addOperationCreateGeoMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateGeoMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
