...
func (c *Client) UpdateIPSet(ctx context.Context, params *UpdateIPSetInput, optFns ...func(*Options)) (*UpdateIPSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateIPSet", params, optFns, addOperationUpdateIPSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateIPSetMiddleware(stack *middleware.Stack, options Options) (err error) {
