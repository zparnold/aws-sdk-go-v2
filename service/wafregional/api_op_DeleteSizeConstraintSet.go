...
func (c *Client) DeleteSizeConstraintSet(ctx context.Context, params *DeleteSizeConstraintSetInput, optFns ...func(*Options)) (*DeleteSizeConstraintSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSizeConstraintSet", params, optFns, addOperationDeleteSizeConstraintSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSizeConstraintSetMiddleware(stack *middleware.Stack, options Options) (err error) {
