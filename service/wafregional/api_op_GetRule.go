...
func (c *Client) GetRule(ctx context.Context, params *GetRuleInput, optFns ...func(*Options)) (*GetRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRule", params, optFns, addOperationGetRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
