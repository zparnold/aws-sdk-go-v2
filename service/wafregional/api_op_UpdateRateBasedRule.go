...
func (c *Client) UpdateRateBasedRule(ctx context.Context, params *UpdateRateBasedRuleInput, optFns ...func(*Options)) (*UpdateRateBasedRuleOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateRateBasedRule", params, optFns, addOperationUpdateRateBasedRuleMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateRateBasedRuleMiddleware(stack *middleware.Stack, options Options) (err error) {
