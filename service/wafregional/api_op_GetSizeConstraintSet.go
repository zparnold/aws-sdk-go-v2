...
func (c *Client) GetSizeConstraintSet(ctx context.Context, params *GetSizeConstraintSetInput, optFns ...func(*Options)) (*GetSizeConstraintSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetSizeConstraintSet", params, optFns, addOperationGetSizeConstraintSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetSizeConstraintSetMiddleware(stack *middleware.Stack, options Options) (err error) {
