...
func (c *Client) GetRegexMatchSet(ctx context.Context, params *GetRegexMatchSetInput, optFns ...func(*Options)) (*GetRegexMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRegexMatchSet", params, optFns, addOperationGetRegexMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRegexMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
