...
func (c *Client) ListRateBasedRules(ctx context.Context, params *ListRateBasedRulesInput, optFns ...func(*Options)) (*ListRateBasedRulesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListRateBasedRules", params, optFns, addOperationListRateBasedRulesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListRateBasedRulesMiddleware(stack *middleware.Stack, options Options) (err error) {
