...
func (c *Client) GetByteMatchSet(ctx context.Context, params *GetByteMatchSetInput, optFns ...func(*Options)) (*GetByteMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetByteMatchSet", params, optFns, addOperationGetByteMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetByteMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
