...
func (c *Client) UpdateSqlInjectionMatchSet(ctx context.Context, params *UpdateSqlInjectionMatchSetInput, optFns ...func(*Options)) (*UpdateSqlInjectionMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateSqlInjectionMatchSet", params, optFns, addOperationUpdateSqlInjectionMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateSqlInjectionMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
