...
func (c *Client) DeleteSqlInjectionMatchSet(ctx context.Context, params *DeleteSqlInjectionMatchSetInput, optFns ...func(*Options)) (*DeleteSqlInjectionMatchSetOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteSqlInjectionMatchSet", params, optFns, addOperationDeleteSqlInjectionMatchSetMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteSqlInjectionMatchSetMiddleware(stack *middleware.Stack, options Options) (err error) {
