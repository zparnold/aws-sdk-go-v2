...
func (c *Client) GetRecords(ctx context.Context, params *GetRecordsInput, optFns ...func(*Options)) (*GetRecordsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetRecords", params, optFns, addOperationGetRecordsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetRecordsMiddleware(stack *middleware.Stack, options Options) (err error) {
