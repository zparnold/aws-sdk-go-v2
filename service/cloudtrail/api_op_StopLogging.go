...
func (c *Client) StopLogging(ctx context.Context, params *StopLoggingInput, optFns ...func(*Options)) (*StopLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StopLogging", params, optFns, addOperationStopLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStopLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
