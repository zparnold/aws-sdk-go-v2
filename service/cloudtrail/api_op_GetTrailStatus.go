...
func (c *Client) GetTrailStatus(ctx context.Context, params *GetTrailStatusInput, optFns ...func(*Options)) (*GetTrailStatusOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTrailStatus", params, optFns, addOperationGetTrailStatusMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTrailStatusMiddleware(stack *middleware.Stack, options Options) (err error) {
