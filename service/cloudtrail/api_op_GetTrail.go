...
func (c *Client) GetTrail(ctx context.Context, params *GetTrailInput, optFns ...func(*Options)) (*GetTrailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetTrail", params, optFns, addOperationGetTrailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetTrailMiddleware(stack *middleware.Stack, options Options) (err error) {
