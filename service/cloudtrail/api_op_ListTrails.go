...
func (c *Client) ListTrails(ctx context.Context, params *ListTrailsInput, optFns ...func(*Options)) (*ListTrailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTrails", params, optFns, addOperationListTrailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTrailsMiddleware(stack *middleware.Stack, options Options) (err error) {
