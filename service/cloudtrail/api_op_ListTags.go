...
func (c *Client) ListTags(ctx context.Context, params *ListTagsInput, optFns ...func(*Options)) (*ListTagsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListTags", params, optFns, addOperationListTagsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationListTagsMiddleware(stack *middleware.Stack, options Options) (err error) {
