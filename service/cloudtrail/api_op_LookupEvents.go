...
func (c *Client) LookupEvents(ctx context.Context, params *LookupEventsInput, optFns ...func(*Options)) (*LookupEventsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "LookupEvents", params, optFns, addOperationLookupEventsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationLookupEventsMiddleware(stack *middleware.Stack, options Options) (err error) {
