...
func (c *Client) PutEventSelectors(ctx context.Context, params *PutEventSelectorsInput, optFns ...func(*Options)) (*PutEventSelectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutEventSelectors", params, optFns, addOperationPutEventSelectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutEventSelectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
