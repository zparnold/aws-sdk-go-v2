...
func (c *Client) DeleteTrail(ctx context.Context, params *DeleteTrailInput, optFns ...func(*Options)) (*DeleteTrailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteTrail", params, optFns, addOperationDeleteTrailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteTrailMiddleware(stack *middleware.Stack, options Options) (err error) {
