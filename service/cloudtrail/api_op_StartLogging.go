...
func (c *Client) StartLogging(ctx context.Context, params *StartLoggingInput, optFns ...func(*Options)) (*StartLoggingOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartLogging", params, optFns, addOperationStartLoggingMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartLoggingMiddleware(stack *middleware.Stack, options Options) (err error) {
