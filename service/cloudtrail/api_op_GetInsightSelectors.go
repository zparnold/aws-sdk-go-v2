...
func (c *Client) GetInsightSelectors(ctx context.Context, params *GetInsightSelectorsInput, optFns ...func(*Options)) (*GetInsightSelectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetInsightSelectors", params, optFns, addOperationGetInsightSelectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetInsightSelectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
