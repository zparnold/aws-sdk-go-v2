...
func (c *Client) DescribeTrails(ctx context.Context, params *DescribeTrailsInput, optFns ...func(*Options)) (*DescribeTrailsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeTrails", params, optFns, addOperationDescribeTrailsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeTrailsMiddleware(stack *middleware.Stack, options Options) (err error) {
