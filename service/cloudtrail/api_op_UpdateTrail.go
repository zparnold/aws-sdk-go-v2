...
func (c *Client) UpdateTrail(ctx context.Context, params *UpdateTrailInput, optFns ...func(*Options)) (*UpdateTrailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "UpdateTrail", params, optFns, addOperationUpdateTrailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationUpdateTrailMiddleware(stack *middleware.Stack, options Options) (err error) {
