...
func (c *Client) CreateTrail(ctx context.Context, params *CreateTrailInput, optFns ...func(*Options)) (*CreateTrailOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateTrail", params, optFns, addOperationCreateTrailMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateTrailMiddleware(stack *middleware.Stack, options Options) (err error) {
