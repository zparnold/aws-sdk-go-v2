...
func (c *Client) GetEventSelectors(ctx context.Context, params *GetEventSelectorsInput, optFns ...func(*Options)) (*GetEventSelectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "GetEventSelectors", params, optFns, addOperationGetEventSelectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationGetEventSelectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
