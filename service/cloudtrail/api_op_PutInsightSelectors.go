...
func (c *Client) PutInsightSelectors(ctx context.Context, params *PutInsightSelectorsInput, optFns ...func(*Options)) (*PutInsightSelectorsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "PutInsightSelectors", params, optFns, addOperationPutInsightSelectorsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationPutInsightSelectorsMiddleware(stack *middleware.Stack, options Options) (err error) {
