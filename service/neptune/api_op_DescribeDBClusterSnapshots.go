...
func (c *Client) DescribeDBClusterSnapshots(ctx context.Context, params *DescribeDBClusterSnapshotsInput, optFns ...func(*Options)) (*DescribeDBClusterSnapshotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBClusterSnapshots", params, optFns, addOperationDescribeDBClusterSnapshotsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBClusterSnapshotsMiddleware(stack *middleware.Stack, options Options) (err error) {
