...
func (c *Client) CreateDBParameterGroup(ctx context.Context, params *CreateDBParameterGroupInput, optFns ...func(*Options)) (*CreateDBParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBParameterGroup", params, optFns, addOperationCreateDBParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
