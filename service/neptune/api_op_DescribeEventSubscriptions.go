...
func (c *Client) DescribeEventSubscriptions(ctx context.Context, params *DescribeEventSubscriptionsInput, optFns ...func(*Options)) (*DescribeEventSubscriptionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEventSubscriptions", params, optFns, addOperationDescribeEventSubscriptionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEventSubscriptionsMiddleware(stack *middleware.Stack, options Options) (err error) {
