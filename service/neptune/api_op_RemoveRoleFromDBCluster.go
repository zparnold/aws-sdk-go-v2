...
func (c *Client) RemoveRoleFromDBCluster(ctx context.Context, params *RemoveRoleFromDBClusterInput, optFns ...func(*Options)) (*RemoveRoleFromDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RemoveRoleFromDBCluster", params, optFns, addOperationRemoveRoleFromDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRemoveRoleFromDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
