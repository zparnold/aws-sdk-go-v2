...
func (c *Client) RestoreDBClusterFromSnapshot(ctx context.Context, params *RestoreDBClusterFromSnapshotInput, optFns ...func(*Options)) (*RestoreDBClusterFromSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "RestoreDBClusterFromSnapshot", params, optFns, addOperationRestoreDBClusterFromSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationRestoreDBClusterFromSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
