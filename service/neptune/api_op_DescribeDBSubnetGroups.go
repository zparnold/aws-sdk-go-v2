...
func (c *Client) DescribeDBSubnetGroups(ctx context.Context, params *DescribeDBSubnetGroupsInput, optFns ...func(*Options)) (*DescribeDBSubnetGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBSubnetGroups", params, optFns, addOperationDescribeDBSubnetGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBSubnetGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
