...
func (c *Client) CreateDBClusterSnapshot(ctx context.Context, params *CreateDBClusterSnapshotInput, optFns ...func(*Options)) (*CreateDBClusterSnapshotOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CreateDBClusterSnapshot", params, optFns, addOperationCreateDBClusterSnapshotMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCreateDBClusterSnapshotMiddleware(stack *middleware.Stack, options Options) (err error) {
