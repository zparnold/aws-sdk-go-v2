...
func (c *Client) DescribeDBClusters(ctx context.Context, params *DescribeDBClustersInput, optFns ...func(*Options)) (*DescribeDBClustersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBClusters", params, optFns, addOperationDescribeDBClustersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBClustersMiddleware(stack *middleware.Stack, options Options) (err error) {
