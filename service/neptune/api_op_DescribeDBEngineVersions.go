...
func (c *Client) DescribeDBEngineVersions(ctx context.Context, params *DescribeDBEngineVersionsInput, optFns ...func(*Options)) (*DescribeDBEngineVersionsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBEngineVersions", params, optFns, addOperationDescribeDBEngineVersionsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBEngineVersionsMiddleware(stack *middleware.Stack, options Options) (err error) {
