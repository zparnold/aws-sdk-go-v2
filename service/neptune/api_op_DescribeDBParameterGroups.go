...
func (c *Client) DescribeDBParameterGroups(ctx context.Context, params *DescribeDBParameterGroupsInput, optFns ...func(*Options)) (*DescribeDBParameterGroupsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBParameterGroups", params, optFns, addOperationDescribeDBParameterGroupsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBParameterGroupsMiddleware(stack *middleware.Stack, options Options) (err error) {
