...
func (c *Client) DescribeDBInstances(ctx context.Context, params *DescribeDBInstancesInput, optFns ...func(*Options)) (*DescribeDBInstancesOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeDBInstances", params, optFns, addOperationDescribeDBInstancesMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeDBInstancesMiddleware(stack *middleware.Stack, options Options) (err error) {
