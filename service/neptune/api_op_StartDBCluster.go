...
func (c *Client) StartDBCluster(ctx context.Context, params *StartDBClusterInput, optFns ...func(*Options)) (*StartDBClusterOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "StartDBCluster", params, optFns, addOperationStartDBClusterMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationStartDBClusterMiddleware(stack *middleware.Stack, options Options) (err error) {
