...
func (c *Client) DeleteDBClusterParameterGroup(ctx context.Context, params *DeleteDBClusterParameterGroupInput, optFns ...func(*Options)) (*DeleteDBClusterParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DeleteDBClusterParameterGroup", params, optFns, addOperationDeleteDBClusterParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDeleteDBClusterParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
