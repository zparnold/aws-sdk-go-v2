...
func (c *Client) CopyDBParameterGroup(ctx context.Context, params *CopyDBParameterGroupInput, optFns ...func(*Options)) (*CopyDBParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "CopyDBParameterGroup", params, optFns, addOperationCopyDBParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationCopyDBParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
