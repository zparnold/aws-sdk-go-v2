...
func (c *Client) DescribeEngineDefaultParameters(ctx context.Context, params *DescribeEngineDefaultParametersInput, optFns ...func(*Options)) (*DescribeEngineDefaultParametersOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeEngineDefaultParameters", params, optFns, addOperationDescribeEngineDefaultParametersMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeEngineDefaultParametersMiddleware(stack *middleware.Stack, options Options) (err error) {
