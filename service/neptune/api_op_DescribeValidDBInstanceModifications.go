...
func (c *Client) DescribeValidDBInstanceModifications(ctx context.Context, params *DescribeValidDBInstanceModificationsInput, optFns ...func(*Options)) (*DescribeValidDBInstanceModificationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeValidDBInstanceModifications", params, optFns, addOperationDescribeValidDBInstanceModificationsMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationDescribeValidDBInstanceModificationsMiddleware(stack *middleware.Stack, options Options) (err error) {
