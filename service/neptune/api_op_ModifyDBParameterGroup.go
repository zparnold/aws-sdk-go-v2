...
func (c *Client) ModifyDBParameterGroup(ctx context.Context, params *ModifyDBParameterGroupInput, optFns ...func(*Options)) (*ModifyDBParameterGroupOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ModifyDBParameterGroup", params, optFns, addOperationModifyDBParameterGroupMiddleware)
	if err != nil {
		return nil, err
	}
...
func addOperationModifyDBParameterGroupMiddleware(stack *middleware.Stack, options Options) (err error) {
